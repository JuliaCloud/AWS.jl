...
AbortDocumentVersionUpload(DocumentId, VersionId, args::AbstractDict{String, <:Any}) = workdocs("DELETE", "/api/v1/documents/$(DocumentId)/versions/$(VersionId)", args)
...
ActivateUser(UserId, args::AbstractDict{String, <:Any}) = workdocs("POST", "/api/v1/users/$(UserId)/activation", args)
...
"""
AddResourcePermissions(Principals, ResourceId) = workdocs("POST", "/api/v1/resources/$(ResourceId)/permissions", Dict{String, Any}("Principals"=>Principals))
AddResourcePermissions(Principals, ResourceId, args::AbstractDict{String, <:Any}) = workdocs("POST", "/api/v1/resources/$(ResourceId)/permissions", Dict{String, Any}("Principals"=>Principals, args...))
...
"""
CreateComment(DocumentId, Text, VersionId) = workdocs("POST", "/api/v1/documents/$(DocumentId)/versions/$(VersionId)/comment", Dict{String, Any}("Text"=>Text))
CreateComment(DocumentId, Text, VersionId, args::AbstractDict{String, <:Any}) = workdocs("POST", "/api/v1/documents/$(DocumentId)/versions/$(VersionId)/comment", Dict{String, Any}("Text"=>Text, args...))
...
"""
CreateCustomMetadata(CustomMetadata, ResourceId) = workdocs("PUT", "/api/v1/resources/$(ResourceId)/customMetadata", Dict{String, Any}("CustomMetadata"=>CustomMetadata))
CreateCustomMetadata(CustomMetadata, ResourceId, args::AbstractDict{String, <:Any}) = workdocs("PUT", "/api/v1/resources/$(ResourceId)/customMetadata", Dict{String, Any}("CustomMetadata"=>CustomMetadata, args...))
...
"""
CreateFolder(ParentFolderId) = workdocs("POST", "/api/v1/folders", Dict{String, Any}("ParentFolderId"=>ParentFolderId))
CreateFolder(ParentFolderId, args::AbstractDict{String, <:Any}) = workdocs("POST", "/api/v1/folders", Dict{String, Any}("ParentFolderId"=>ParentFolderId, args...))
...
- `Authentication`: Amazon WorkDocs authentication token. Not required when using AWS administrator credentials to access the API.
"""
CreateLabels(Labels, ResourceId) = workdocs("PUT", "/api/v1/resources/$(ResourceId)/labels", Dict{String, Any}("Labels"=>Labels))
CreateLabels(Labels, ResourceId, args::AbstractDict{String, <:Any}) = workdocs("PUT", "/api/v1/resources/$(ResourceId)/labels", Dict{String, Any}("Labels"=>Labels, args...))
...
"""
CreateNotificationSubscription(Endpoint, OrganizationId, Protocol, SubscriptionType) = workdocs("POST", "/api/v1/organizations/$(OrganizationId)/subscriptions", Dict{String, Any}("Endpoint"=>Endpoint, "Protocol"=>Protocol, "SubscriptionType"=>SubscriptionType))
CreateNotificationSubscription(Endpoint, OrganizationId, Protocol, SubscriptionType, args::AbstractDict{String, <:Any}) = workdocs("POST", "/api/v1/organizations/$(OrganizationId)/subscriptions", Dict{String, Any}("Endpoint"=>Endpoint, "Protocol"=>Protocol, "SubscriptionType"=>SubscriptionType, args...))
...
"""
CreateUser(GivenName, Password, Surname, Username) = workdocs("POST", "/api/v1/users", Dict{String, Any}("GivenName"=>GivenName, "Password"=>Password, "Surname"=>Surname, "Username"=>Username))
CreateUser(GivenName, Password, Surname, Username, args::AbstractDict{String, <:Any}) = workdocs("POST", "/api/v1/users", Dict{String, Any}("GivenName"=>GivenName, "Password"=>Password, "Surname"=>Surname, "Username"=>Username, args...))
...
DeactivateUser(UserId, args::AbstractDict{String, <:Any}) = workdocs("DELETE", "/api/v1/users/$(UserId)/activation", args)
...
DeleteComment(CommentId, DocumentId, VersionId, args::AbstractDict{String, <:Any}) = workdocs("DELETE", "/api/v1/documents/$(DocumentId)/versions/$(VersionId)/comment/$(CommentId)", args)
...
DeleteCustomMetadata(ResourceId, args::AbstractDict{String, <:Any}) = workdocs("DELETE", "/api/v1/resources/$(ResourceId)/customMetadata", args)
...
DeleteDocument(DocumentId, args::AbstractDict{String, <:Any}) = workdocs("DELETE", "/api/v1/documents/$(DocumentId)", args)
...
DeleteFolder(FolderId, args::AbstractDict{String, <:Any}) = workdocs("DELETE", "/api/v1/folders/$(FolderId)", args)
...
DeleteFolderContents(FolderId, args::AbstractDict{String, <:Any}) = workdocs("DELETE", "/api/v1/folders/$(FolderId)/contents", args)
...
DeleteLabels(ResourceId, args::AbstractDict{String, <:Any}) = workdocs("DELETE", "/api/v1/resources/$(ResourceId)/labels", args)
...
DeleteNotificationSubscription(OrganizationId, SubscriptionId, args::AbstractDict{String, <:Any}) = workdocs("DELETE", "/api/v1/organizations/$(OrganizationId)/subscriptions/$(SubscriptionId)", args)
...
DeleteUser(UserId, args::AbstractDict{String, <:Any}) = workdocs("DELETE", "/api/v1/users/$(UserId)", args)
...
DescribeActivities(args::AbstractDict{String, Any}) = workdocs("GET", "/api/v1/activities", args)
...
DescribeComments(DocumentId, VersionId, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/documents/$(DocumentId)/versions/$(VersionId)/comments", args)
...
DescribeDocumentVersions(DocumentId, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/documents/$(DocumentId)/versions", args)
...
DescribeFolderContents(FolderId, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/folders/$(FolderId)/contents", args)
...
- `organizationId`: The ID of the organization.
"""
DescribeGroups(searchQuery) = workdocs("GET", "/api/v1/groups", Dict{String, Any}("searchQuery"=>searchQuery))
DescribeGroups(searchQuery, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/groups", Dict{String, Any}("searchQuery"=>searchQuery, args...))
...
DescribeNotificationSubscriptions(OrganizationId, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/organizations/$(OrganizationId)/subscriptions", args)
...
DescribeResourcePermissions(ResourceId, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/resources/$(ResourceId)/permissions", args)
...
- `marker`: The marker for the next set of results. (You received this marker from a previous call.)
"""
DescribeRootFolders(Authentication) = workdocs("GET", "/api/v1/me/root", Dict{String, Any}("headers"=>Dict{String, Any}("Authentication"=>Authentication)))
DescribeRootFolders(Authentication, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/me/root", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("Authentication"=>Authentication)), args...)))
...
DescribeUsers(args::AbstractDict{String, Any}) = workdocs("GET", "/api/v1/users", args)
...
"""
GetCurrentUser(Authentication) = workdocs("GET", "/api/v1/me", Dict{String, Any}("headers"=>Dict{String, Any}("Authentication"=>Authentication)))
GetCurrentUser(Authentication, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/me", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("Authentication"=>Authentication)), args...)))
...
GetDocument(DocumentId, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/documents/$(DocumentId)", args)
...
GetDocumentPath(DocumentId, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/documents/$(DocumentId)/path", args)
...
GetDocumentVersion(DocumentId, VersionId, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/documents/$(DocumentId)/versions/$(VersionId)", args)
...
GetFolder(FolderId, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/folders/$(FolderId)", args)
...
GetFolderPath(FolderId, args::AbstractDict{String, <:Any}) = workdocs("GET", "/api/v1/folders/$(FolderId)/path", args)
...
GetResources(args::AbstractDict{String, Any}) = workdocs("GET", "/api/v1/resources", args)
...
"""
InitiateDocumentVersionUpload(ParentFolderId) = workdocs("POST", "/api/v1/documents", Dict{String, Any}("ParentFolderId"=>ParentFolderId))
InitiateDocumentVersionUpload(ParentFolderId, args::AbstractDict{String, <:Any}) = workdocs("POST", "/api/v1/documents", Dict{String, Any}("ParentFolderId"=>ParentFolderId, args...))
...
RemoveAllResourcePermissions(ResourceId, args::AbstractDict{String, <:Any}) = workdocs("DELETE", "/api/v1/resources/$(ResourceId)/permissions", args)
...
RemoveResourcePermission(PrincipalId, ResourceId, args::AbstractDict{String, <:Any}) = workdocs("DELETE", "/api/v1/resources/$(ResourceId)/permissions/$(PrincipalId)", args)
...
UpdateDocument(DocumentId, args::AbstractDict{String, <:Any}) = workdocs("PATCH", "/api/v1/documents/$(DocumentId)", args)
...
UpdateDocumentVersion(DocumentId, VersionId, args::AbstractDict{String, <:Any}) = workdocs("PATCH", "/api/v1/documents/$(DocumentId)/versions/$(VersionId)", args)
...
UpdateFolder(FolderId, args::AbstractDict{String, <:Any}) = workdocs("PATCH", "/api/v1/folders/$(FolderId)", args)
...
UpdateUser(UserId, args::AbstractDict{String, <:Any}) = workdocs("PATCH", "/api/v1/users/$(UserId)", args)
