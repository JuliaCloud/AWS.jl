...
function delete_folder(FolderId; aws_config::AbstractAWSConfig=current_aws_config())
    return workdocs(
        "DELETE", "/api/v1/folders/$(FolderId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_user(UserId; aws_config::AbstractAWSConfig=current_aws_config())
    return workdocs(
        "DELETE", "/api/v1/users/$(UserId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_activities(; aws_config::AbstractAWSConfig=current_aws_config())
    return workdocs(
        "GET", "/api/v1/activities"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_activities(
    ...
    return workdocs(
        "GET", "/api/v1/activities", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_users(; aws_config::AbstractAWSConfig=current_aws_config())
    return workdocs("GET", "/api/v1/users"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_users(
    ...
    return workdocs(
        "GET", "/api/v1/users", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_folder(FolderId; aws_config::AbstractAWSConfig=current_aws_config())
    return workdocs(
        "GET", "/api/v1/folders/$(FolderId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_resources(; aws_config::AbstractAWSConfig=current_aws_config())
    return workdocs("GET", "/api/v1/resources"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_resources(
    ...
    return workdocs(
        "GET", "/api/v1/resources", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function initiate_document_version_upload(;
    ...
    return workdocs(
        "POST", "/api/v1/documents"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function initiate_document_version_upload(
    ...
    return workdocs(
        "POST", "/api/v1/documents", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function search_resources(; aws_config::AbstractAWSConfig=current_aws_config())
    return workdocs("POST", "/api/v1/search"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function search_resources(
    ...
    return workdocs(
        "POST", "/api/v1/search", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_folder(FolderId; aws_config::AbstractAWSConfig=current_aws_config())
    return workdocs(
        "PATCH", "/api/v1/folders/$(FolderId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_user(UserId; aws_config::AbstractAWSConfig=current_aws_config())
    return workdocs(
        "PATCH", "/api/v1/users/$(UserId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
