...
- **Targets**: A target can be a specific resource in your Amazon Web Services environment,
  or one or more resources that match criteria that you specify, for example, resources that
  have specific tags.
...
"""
    create_target_account_configuration(account_id, experiment_template_id, role_arn)
    create_target_account_configuration(account_id, experiment_template_id, role_arn, params::Dict{String,<:Any})
...
- `experiment_template_id`: The experiment template ID.
...
function delete_experiment_template(id; aws_config::AbstractAWSConfig=current_aws_config())
    return fis(
        "DELETE", "/experimentTemplates/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
    delete_target_account_configuration(account_id, experiment_template_id)
    delete_target_account_configuration(account_id, experiment_template_id, params::Dict{String,<:Any})
...
function delete_target_account_configuration(
    accountId, experimentTemplateId; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fis(
        "DELETE",
        "/experimentTemplates/$(experimentTemplateId)/targetAccountConfigurations/$(accountId)";
...
function get_action(id; aws_config::AbstractAWSConfig=current_aws_config())
    return fis("GET", "/actions/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_action(
    id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fis("GET", "/actions/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_experiment(id; aws_config::AbstractAWSConfig=current_aws_config())
    return fis("GET", "/experiments/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_experiment(
    ...
    return fis(
        "GET", "/experiments/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end

"""
    get_experiment_target_account_configuration(account_id, experiment_id)
    get_experiment_target_account_configuration(account_id, experiment_id, params::Dict{String,<:Any})
...
function get_experiment_target_account_configuration(
    accountId, experimentId; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fis(
        "GET",
...
function get_experiment_template(id; aws_config::AbstractAWSConfig=current_aws_config())
    return fis(
        "GET", "/experimentTemplates/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
    get_target_account_configuration(account_id, experiment_template_id)
    get_target_account_configuration(account_id, experiment_template_id, params::Dict{String,<:Any})
...
function list_actions(; aws_config::AbstractAWSConfig=current_aws_config())
    return fis("GET", "/actions"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_actions(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fis("GET", "/actions", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    list_experiment_resolved_targets(experiment_id)
    list_experiment_resolved_targets(experiment_id, params::Dict{String,<:Any})
...
function list_experiment_resolved_targets(
    experimentId; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fis(
        "GET",
...
"""
    list_experiment_target_account_configurations(experiment_id)
    list_experiment_target_account_configurations(experiment_id, params::Dict{String,<:Any})
...
function list_experiment_templates(; aws_config::AbstractAWSConfig=current_aws_config())
    return fis("GET", "/experimentTemplates"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_experiment_templates(
    ...
    return fis(
        "GET", "/experimentTemplates", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_experiments(; aws_config::AbstractAWSConfig=current_aws_config())
    return fis("GET", "/experiments"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_experiments(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fis("GET", "/experiments", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_tags_for_resource(
    ...
    return fis("GET", "/tags/$(resourceArn)"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
"""
    list_target_account_configurations(experiment_template_id)
    list_target_account_configurations(experiment_template_id, params::Dict{String,<:Any})
...
function list_target_account_configurations(
    experimentTemplateId; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fis(
        "GET",
...
function list_target_resource_types(; aws_config::AbstractAWSConfig=current_aws_config())
    return fis("GET", "/targetResourceTypes"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_target_resource_types(
    ...
    return fis(
        "GET", "/targetResourceTypes", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function stop_experiment(id; aws_config::AbstractAWSConfig=current_aws_config())
    return fis("DELETE", "/experiments/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function stop_experiment(
    ...
    return fis(
        "DELETE", "/experiments/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function untag_resource(resourceArn; aws_config::AbstractAWSConfig=current_aws_config())
    return fis(
        "DELETE", "/tags/$(resourceArn)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_experiment_template(id; aws_config::AbstractAWSConfig=current_aws_config())
    return fis(
        "PATCH", "/experimentTemplates/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
    update_target_account_configuration(account_id, experiment_template_id)
    update_target_account_configuration(account_id, experiment_template_id, params::Dict{String,<:Any})
