...
# Required Parameters
- `assessmentTargetName`: The user-defined name that identifies the assessment target that
...
# Required Parameters
- `assessmentTargetArn`: The ARN that specifies the assessment target for which you want to
  create the assessment template.
- `assessmentTemplateName`: The user-defined name that identifies the assessment template
...
- `rulesPackageArns`: The ARNs that specify the rules packages that you want to attach to
...
# Required Parameters
- `assessmentTemplateArn`: The ARN that specifies the assessment template for which you
...
# Required Parameters
- `assessmentTargetArn`: The ARN that specifies the assessment target that you want to
  delete.
...
# Required Parameters
- `assessmentTemplateArn`: The ARN that specifies the assessment template that you want to
  delete.
...
# Optional Parameters
- `locale`: The locale into which you want to translate the exclusion's title, description,
  and recommendation.
"""
...
# Required Parameters
- `assessmentRunArn`: The ARN that specifies the assessment run for which you want to
  generate a report.
- `reportFileFormat`: Specifies the file format (html or pdf) of the assessment report that
  you want to generate.
- `reportType`: Specifies the type of the assessment report that you want to generate.
...
# Required Parameters
- `assessmentTemplateArn`: The ARN that specifies the assessment template for which the
...
# Required Parameters
- `assessmentRunArn`: The ARN that specifies the assessment run that has the telemetry data
...
# Required Parameters
- `assessmentRunArn`: The ARN that specifies the assessment run whose agents you want to
  list.
...
# Optional Parameters
- `assessmentTemplateArns`: The ARNs that specify the assessment templates whose assessment
...
- `nextToken`: You can use this parameter when paginating results. Set the value of this
  ...
  to the action fill nextToken in the request with the value of NextToken from the previous
  response to continue listing data.
- `resourceArn`: The ARN of the assessment template for which you want to list the existing
  event subscriptions.
"""
...
# Required Parameters
- `assessmentRunArn`: The ARN of the assessment run that generated the exclusions that you
  want to list.
...
# Required Parameters
- `roleArn`: The ARN of the IAM role that grants Amazon Inspector access to AWS Services
...
# Required Parameters
- `assessmentTemplateArn`: The ARN of the assessment template of the assessment run that
  you want to start.
...
- `resourceArn`: The ARN of the assessment template that is used during the event for which
