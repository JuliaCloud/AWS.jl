...
Creates a new assessment target using the ARN of the resource group that is generated by [`create_resource_group`](@ref).
If resourceGroupArn is not specified, all EC2 instances in the current AWS account and
region are included in the assessment target. If the [service-linked role](https://docs.aws.amazon.com/inspector/latest/userguide/inspector_slr.html)
...
function describe_cross_account_access_role(;
    ...
    return inspector(
        "DescribeCrossAccountAccessRole"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_assessment_runs(; aws_config::AbstractAWSConfig=current_aws_config())
    return inspector("ListAssessmentRuns"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_assessment_runs(
    ...
    return inspector(
        "ListAssessmentRuns", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_assessment_targets(; aws_config::AbstractAWSConfig=current_aws_config())
    return inspector("ListAssessmentTargets"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_assessment_targets(
    ...
    return inspector(
        "ListAssessmentTargets", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_assessment_templates(; aws_config::AbstractAWSConfig=current_aws_config())
    return inspector("ListAssessmentTemplates"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_assessment_templates(
    ...
    return inspector(
        "ListAssessmentTemplates", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
of the assessment template. For more information, see [`subscribe_to_event`](@ref) and [`unsubscribe_from_event`](@ref).
...
function list_event_subscriptions(; aws_config::AbstractAWSConfig=current_aws_config())
    return inspector("ListEventSubscriptions"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_event_subscriptions(
    ...
    return inspector(
        "ListEventSubscriptions", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_findings(; aws_config::AbstractAWSConfig=current_aws_config())
    return inspector("ListFindings"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_findings(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return inspector("ListFindings", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_rules_packages(; aws_config::AbstractAWSConfig=current_aws_config())
    return inspector("ListRulesPackages"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_rules_packages(
    ...
    return inspector(
        "ListRulesPackages", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
