...
- `"serverSideEncryptionConfiguration"`: The configuration information for the customer
  ...
  IAM identity using the key to invoke Amazon Q. To use Amazon Q with chat, the key policy
  must also allow kms:Decrypt, kms:GenerateDataKey*, and kms:DescribeKey permissions to the
  connect.amazonaws.com service principal.  For more information about setting up a customer
  managed key for Amazon Q, see Enable Amazon Q in Connect for your instance.
- `"tags"`: The tags used to organize, track, or control access for this resource.
"""
create_assistant(name, type; aws_config::AbstractAWSConfig=global_aws_config()) = qconnect(
    "POST",
    "/assistants",
...
# Arguments
- `assistant_id`: The identifier of the Amazon Q assistant. Can be either the ID or the
...
Creates Amazon Q content. Before to calling this API, use StartContentUpload to upload an
asset.

# Arguments
- `knowledge_base_id`: The identifier of the knowledge base. This should not be a
  QUICK_RESPONSES type knowledge base if you're storing Amazon Q Content resource to it. Can
...
- `"metadata"`: A key/value map to store attributes without affecting tagging or
  ...
  Q, you can store an external version identifier as metadata to utilize for determining
  drift.
...
- `"serverSideEncryptionConfiguration"`: The configuration information for the customer
  ...
  kms:CreateGrant, kms:DescribeKey, kms:Decrypt, and kms:GenerateDataKey* permissions to the
  IAM identity using the key to invoke Amazon Q. For more information about setting up a
...
Amazon Connect creates a new Amazon Q session for each contact on which Amazon Q is enabled.
...
"""
delete_assistant(assistantId; aws_config::AbstractAWSConfig=global_aws_config()) = qconnect(
    "DELETE",
...
- `knowledge_base_id`: The identifier of the knowledge base. This should not be a
  QUICK_RESPONSES type knowledge base if you're storing Amazon Q Content resource to it.
...
"""
get_assistant(assistantId; aws_config::AbstractAWSConfig=global_aws_config()) = qconnect(
    "GET",
    "/assistants/$(assistantId)";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"nextToken"`: The token for the next set of results. Use the value returned in the
  previous response in the next request to retrieve the next set of results.
"""
list_contents(knowledgeBaseId; aws_config::AbstractAWSConfig=global_aws_config()) =
    qconnect(
        "GET",
        "/knowledgeBases/$(knowledgeBaseId)/contents";
        aws_config=aws_config,
...
- `"nextToken"`: The token for the next set of results. Use the value returned in the
  previous response in the next request to retrieve the next set of results.
"""
list_knowledge_bases(; aws_config::AbstractAWSConfig=global_aws_config()) = qconnect(
...
# Arguments
- `assistant_id`: The identifier of the Amazon Q assistant.
...
- `"sessionId"`: The identifier of the Amazon Q session. Can be either the ID or the ARN.
...
Start an asynchronous job to import Amazon Q resources from an uploaded source file. Before
calling this API, use StartContentUpload to upload an asset that contains the resource
data.   For importing Amazon Q quick responses, you need to upload a csv file including the
...
- `knowledge_base_id`: The identifier of the knowledge base. This should not be a
  QUICK_RESPONSES type knowledge base if you're storing Amazon Q Content resource to it. Can
  be either the ID or the ARN. URLs cannot contain the ARN.   For importing Amazon Q quick
...
Q using ingested content. For example, if you ingest a Salesforce article, it has an Id
