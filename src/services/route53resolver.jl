...
"""
AssociateResolverEndpointIpAddress(IpAddress, ResolverEndpointId) = route53resolver("AssociateResolverEndpointIpAddress", Dict{String, Any}("IpAddress"=>IpAddress, "ResolverEndpointId"=>ResolverEndpointId))
AssociateResolverEndpointIpAddress(IpAddress, ResolverEndpointId, args::AbstractDict{String, <:Any}) = route53resolver("AssociateResolverEndpointIpAddress", Dict{String, Any}("IpAddress"=>IpAddress, "ResolverEndpointId"=>ResolverEndpointId, args...))
...
"""
AssociateResolverRule(ResolverRuleId, VPCId) = route53resolver("AssociateResolverRule", Dict{String, Any}("ResolverRuleId"=>ResolverRuleId, "VPCId"=>VPCId))
AssociateResolverRule(ResolverRuleId, VPCId, args::AbstractDict{String, <:Any}) = route53resolver("AssociateResolverRule", Dict{String, Any}("ResolverRuleId"=>ResolverRuleId, "VPCId"=>VPCId, args...))
...
"""
CreateResolverEndpoint(CreatorRequestId, Direction, IpAddresses, SecurityGroupIds) = route53resolver("CreateResolverEndpoint", Dict{String, Any}("CreatorRequestId"=>CreatorRequestId, "Direction"=>Direction, "IpAddresses"=>IpAddresses, "SecurityGroupIds"=>SecurityGroupIds))
CreateResolverEndpoint(CreatorRequestId, Direction, IpAddresses, SecurityGroupIds, args::AbstractDict{String, <:Any}) = route53resolver("CreateResolverEndpoint", Dict{String, Any}("CreatorRequestId"=>CreatorRequestId, "Direction"=>Direction, "IpAddresses"=>IpAddresses, "SecurityGroupIds"=>SecurityGroupIds, args...))
...
"""
CreateResolverRule(CreatorRequestId, DomainName, RuleType) = route53resolver("CreateResolverRule", Dict{String, Any}("CreatorRequestId"=>CreatorRequestId, "DomainName"=>DomainName, "RuleType"=>RuleType))
CreateResolverRule(CreatorRequestId, DomainName, RuleType, args::AbstractDict{String, <:Any}) = route53resolver("CreateResolverRule", Dict{String, Any}("CreatorRequestId"=>CreatorRequestId, "DomainName"=>DomainName, "RuleType"=>RuleType, args...))
...
"""
DeleteResolverEndpoint(ResolverEndpointId) = route53resolver("DeleteResolverEndpoint", Dict{String, Any}("ResolverEndpointId"=>ResolverEndpointId))
DeleteResolverEndpoint(ResolverEndpointId, args::AbstractDict{String, <:Any}) = route53resolver("DeleteResolverEndpoint", Dict{String, Any}("ResolverEndpointId"=>ResolverEndpointId, args...))
...
"""
DeleteResolverRule(ResolverRuleId) = route53resolver("DeleteResolverRule", Dict{String, Any}("ResolverRuleId"=>ResolverRuleId))
DeleteResolverRule(ResolverRuleId, args::AbstractDict{String, <:Any}) = route53resolver("DeleteResolverRule", Dict{String, Any}("ResolverRuleId"=>ResolverRuleId, args...))
...
"""
DisassociateResolverEndpointIpAddress(IpAddress, ResolverEndpointId) = route53resolver("DisassociateResolverEndpointIpAddress", Dict{String, Any}("IpAddress"=>IpAddress, "ResolverEndpointId"=>ResolverEndpointId))
DisassociateResolverEndpointIpAddress(IpAddress, ResolverEndpointId, args::AbstractDict{String, <:Any}) = route53resolver("DisassociateResolverEndpointIpAddress", Dict{String, Any}("IpAddress"=>IpAddress, "ResolverEndpointId"=>ResolverEndpointId, args...))
...
"""
DisassociateResolverRule(ResolverRuleId, VPCId) = route53resolver("DisassociateResolverRule", Dict{String, Any}("ResolverRuleId"=>ResolverRuleId, "VPCId"=>VPCId))
DisassociateResolverRule(ResolverRuleId, VPCId, args::AbstractDict{String, <:Any}) = route53resolver("DisassociateResolverRule", Dict{String, Any}("ResolverRuleId"=>ResolverRuleId, "VPCId"=>VPCId, args...))
...
"""
GetResolverEndpoint(ResolverEndpointId) = route53resolver("GetResolverEndpoint", Dict{String, Any}("ResolverEndpointId"=>ResolverEndpointId))
GetResolverEndpoint(ResolverEndpointId, args::AbstractDict{String, <:Any}) = route53resolver("GetResolverEndpoint", Dict{String, Any}("ResolverEndpointId"=>ResolverEndpointId, args...))
...
"""
GetResolverRule(ResolverRuleId) = route53resolver("GetResolverRule", Dict{String, Any}("ResolverRuleId"=>ResolverRuleId))
GetResolverRule(ResolverRuleId, args::AbstractDict{String, <:Any}) = route53resolver("GetResolverRule", Dict{String, Any}("ResolverRuleId"=>ResolverRuleId, args...))
...
"""
GetResolverRuleAssociation(ResolverRuleAssociationId) = route53resolver("GetResolverRuleAssociation", Dict{String, Any}("ResolverRuleAssociationId"=>ResolverRuleAssociationId))
GetResolverRuleAssociation(ResolverRuleAssociationId, args::AbstractDict{String, <:Any}) = route53resolver("GetResolverRuleAssociation", Dict{String, Any}("ResolverRuleAssociationId"=>ResolverRuleAssociationId, args...))
...
"""
GetResolverRulePolicy(Arn) = route53resolver("GetResolverRulePolicy", Dict{String, Any}("Arn"=>Arn))
GetResolverRulePolicy(Arn, args::AbstractDict{String, <:Any}) = route53resolver("GetResolverRulePolicy", Dict{String, Any}("Arn"=>Arn, args...))
...
"""
ListResolverEndpointIpAddresses(ResolverEndpointId) = route53resolver("ListResolverEndpointIpAddresses", Dict{String, Any}("ResolverEndpointId"=>ResolverEndpointId))
ListResolverEndpointIpAddresses(ResolverEndpointId, args::AbstractDict{String, <:Any}) = route53resolver("ListResolverEndpointIpAddresses", Dict{String, Any}("ResolverEndpointId"=>ResolverEndpointId, args...))
...
ListResolverEndpoints(args::AbstractDict{String, <:Any}) = route53resolver("ListResolverEndpoints", args)
...
ListResolverRuleAssociations(args::AbstractDict{String, <:Any}) = route53resolver("ListResolverRuleAssociations", args)
...
ListResolverRules(args::AbstractDict{String, <:Any}) = route53resolver("ListResolverRules", args)
...
"""
ListTagsForResource(ResourceArn) = route53resolver("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn))
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}) = route53resolver("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
PutResolverRulePolicy(Arn, ResolverRulePolicy) = route53resolver("PutResolverRulePolicy", Dict{String, Any}("Arn"=>Arn, "ResolverRulePolicy"=>ResolverRulePolicy))
PutResolverRulePolicy(Arn, ResolverRulePolicy, args::AbstractDict{String, <:Any}) = route53resolver("PutResolverRulePolicy", Dict{String, Any}("Arn"=>Arn, "ResolverRulePolicy"=>ResolverRulePolicy, args...))
...
"""
TagResource(ResourceArn, Tags) = route53resolver("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags))
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}) = route53resolver("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceArn, TagKeys) = route53resolver("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys))
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}) = route53resolver("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys, args...))
...
"""
UpdateResolverEndpoint(ResolverEndpointId) = route53resolver("UpdateResolverEndpoint", Dict{String, Any}("ResolverEndpointId"=>ResolverEndpointId))
UpdateResolverEndpoint(ResolverEndpointId, args::AbstractDict{String, <:Any}) = route53resolver("UpdateResolverEndpoint", Dict{String, Any}("ResolverEndpointId"=>ResolverEndpointId, args...))
...
"""
UpdateResolverRule(Config, ResolverRuleId) = route53resolver("UpdateResolverRule", Dict{String, Any}("Config"=>Config, "ResolverRuleId"=>ResolverRuleId))
UpdateResolverRule(Config, ResolverRuleId, args::AbstractDict{String, <:Any}) = route53resolver("UpdateResolverRule", Dict{String, Any}("Config"=>Config, "ResolverRuleId"=>ResolverRuleId, args...))
