...
- `"Tags"`: A list of the tag keys and values that you want to associate with the rule group
  association.
"""
function associate_firewall_rule_group end
...
- `resolver_endpoint_id`: The ID of the Resolver endpoint that you want to associate IP
  addresses with.
"""
function associate_resolver_endpoint_ip_address end
...
submit one `AssociateResolverQueryLogConfig` request for each VPC.
...
- `resolver_query_log_config_id`: The ID of the query logging configuration that you want to
...
"""
function associate_resolver_query_log_config end
...
that are specified in the rule. For more information about rules, see [CreateResolverRule](https://docs.aws.amazon.com/Route53/latest/APIReference/API_route53resolver_CreateResolverRule.html).

# Arguments

- `resolver_rule_id`: The ID of the Resolver rule that you want to associate with the VPC.
  To list the existing Resolver rules, use [ListResolverRules](https://docs.aws.amazon.com/Route53/latest/APIReference/API_route53resolver_ListResolverRules.html).
...
- `priority`: The setting that determines the processing order of the rule in the rule
  ...
  insert rules later, leave space between the numbers, for example, use 100, 200, and so on.
  You can change the priority setting for the rules in a rule group at any time.
...
add rules to the new rule group by calling [`create_firewall_rule`](@ref).
...
- `"Tags"`: A list of the tag keys and values that you want to associate with the rule
  group.
"""
function create_firewall_rule_group end
...
- `"InstanceCount"`: Number of Amazon EC2 instances for the Resolver on Outpost. The default
  and minimal value is 4.
- `"Tags"`: A string that helps identify the Route 53 Resolvers on Outpost.
"""
function create_outpost_resolver end
...
- `"PreferredInstanceType"`: The instance type. If you specify this, you must also specify a
...
save DNS query logs that originate in your VPCs. Resolver can log queries only for VPCs that
are in the same Region as the query logging configuration.
...
configuration. The query logs that Resolver creates for a configuration include all DNS
queries that originate in all VPCs that are associated with the configuration.
...
"""
function create_resolver_query_log_config end
...
- `firewall_rule_group_id`: The unique identifier of the firewall rule group that you want
  to delete.
"""
function delete_firewall_rule_group end
...
"""
function delete_outpost_resolver end

function delete_outpost_resolver(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver(
...
- **Inbound**: DNS queries from your network are no longer routed to the DNS service for the
  specified VPC.
...
"""
function delete_resolver_endpoint end
...
from the configuration. See [DisassociateResolverQueryLogConfig](https://docs.aws.amazon.com/Route53/latest/APIReference/API_route53resolver_DisassociateResolverQueryLogConfig.html).
...
- `resolver_query_log_config_id`: The ID of the query logging configuration that you want to
  delete.
"""
function delete_resolver_query_log_config end
...
from all the VPCs that you associated the Resolver rule with. For more information, see [DisassociateResolverRule](https://docs.aws.amazon.com/Route53/latest/APIReference/API_route53resolver_DisassociateResolverRule.html).

# Arguments

- `resolver_rule_id`: The ID of the Resolver rule that you want to delete.
"""
function delete_resolver_rule end

function delete_resolver_rule(
    ResolverRuleId; aws_config::AbstractAWSConfig=current_aws_config()
)
    return route53resolver(
        "DeleteResolverRule",
...
- `resolver_endpoint_id`: The ID of the Resolver endpoint that you want to disassociate an
  IP address from.
"""
function disassociate_resolver_endpoint_ip_address end
...
"""
function disassociate_resolver_query_log_config end
...
"""
function disassociate_resolver_rule end
...
"""
function get_firewall_config end

function get_firewall_config(ResourceId; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver(
        "GetFirewallConfig",
...
- `firewall_rule_group_id`: The unique identifier of the firewall rule group.
"""
function get_firewall_rule_group end
...
"""
function get_firewall_rule_group_policy end
...
"""
function get_outpost_resolver end

function get_outpost_resolver(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver(
        "GetOutpostResolver",
        Dict{String,Any}("Id" => Id);
        aws_config,
...
"""
function get_resolver_config end

function get_resolver_config(ResourceId; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver(
        "GetResolverConfig",
        Dict{String,Any}("ResourceId" => ResourceId);
        aws_config,
...
"""
function get_resolver_dnssec_config end
...
- `resolver_endpoint_id`: The ID of the Resolver endpoint that you want to get information
  about.
"""
function get_resolver_endpoint end
...
"""
function get_resolver_query_log_config end
...
"""
function get_resolver_query_log_config_association end
...
- `arn`: The ARN of the query logging configuration that you want to get the query logging
  policy for.
"""
function get_resolver_query_log_config_policy end
...
"""
function get_resolver_rule end
...
associate a Resolver rule and a VPC using [AssociateResolverRule](https://docs.aws.amazon.com/Route53/latest/APIReference/API_route53resolver_AssociateResolverRule.html).
...
"""
function get_resolver_rule_association end
...
"""
function get_resolver_rule_policy end

function get_resolver_rule_policy(Arn; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver(
...
- `"NextToken"`: For the first call to this list request, omit this value.
  ...
  specified in `MaxResults`. If more objects are available for retrieval, Resolver returns a
...
"""
function list_firewall_configs end

function list_firewall_configs(; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver(
        "ListFirewallConfigs"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_firewall_configs(
    ...
    return route53resolver(
        "ListFirewallConfigs", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_firewall_domain_lists(; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver(
        "ListFirewallDomainLists"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_firewall_domain_lists(
    ...
    return route53resolver(
        "ListFirewallDomainLists", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"FirewallRuleGroupId"`: The unique identifier of the firewall rule group that you want to
  retrieve the associations for. Leave this blank to retrieve associations for any rule
  group.
...
"""
function list_firewall_rule_group_associations end

function list_firewall_rule_group_associations(;
    aws_config::AbstractAWSConfig=current_aws_config()
)
    return route53resolver(
        "ListFirewallRuleGroupAssociations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"NextToken"`: For the first call to this list request, omit this value.
  ...
  that was returned for the prior request in your next request.
"""
function list_firewall_rule_groups end

function list_firewall_rule_groups(; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver(
        "ListFirewallRuleGroups"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_firewall_rule_groups(
    ...
    return route53resolver(
        "ListFirewallRuleGroups", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function list_outpost_resolvers end

function list_outpost_resolvers(; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver(
        "ListOutpostResolvers"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_outpost_resolvers(
    ...
    return route53resolver(
        "ListOutpostResolvers", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"MaxResults"`: The maximum number of Resolver configurations that you want to return in
  the response to a `ListResolverConfigs` request. If you don't specify a value for
...
- `"NextToken"`: (Optional) If the current Amazon Web Services account has more than
  `MaxResults` Resolver configurations, use `NextToken` to get the second and subsequent
  pages of results.
...
"""
function list_resolver_configs end

function list_resolver_configs(; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver(
        "ListResolverConfigs"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_resolver_configs(
    ...
    return route53resolver(
        "ListResolverConfigs", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"NextToken"`: (Optional) If the current Amazon Web Services account has more than
  `MaxResults` DNSSEC configurations, use `NextToken` to get the second and subsequent pages
  of results.
  ...
  response and specify that value for `NextToken` in the request.
"""
function list_resolver_dnssec_configs end

function list_resolver_dnssec_configs(; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver(
        "ListResolverDnssecConfigs"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_resolver_dnssec_configs(
    ...
    return route53resolver(
        "ListResolverDnssecConfigs", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"MaxResults"`: The maximum number of IP addresses that you want to return in the response
  to a `ListResolverEndpointIpAddresses` request. If you don't specify a value for
...
- `"NextToken"`: For the first `ListResolverEndpointIpAddresses` request, omit this value.
  ...
  another `ListResolverEndpointIpAddresses` request to get the next group of IP addresses.
  In the next request, specify the value of `NextToken` from the previous response.
"""
function list_resolver_endpoint_ip_addresses end
...
"""
function list_resolver_endpoints end

function list_resolver_endpoints(; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver(
        "ListResolverEndpoints"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_resolver_endpoints(
    ...
    return route53resolver(
        "ListResolverEndpoints", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"NextToken"`: For the first `ListResolverQueryLogConfigAssociations` request, omit this
  ...
  you specify for `Filters`, you can submit another `ListResolverQueryLogConfigAssociations`
...
- `"SortBy"`: The element that you want Resolver to sort query logging associations by.
  ...
  !!! note
      If you submit a second or subsequent `ListResolverQueryLogConfigAssociations` request
      and specify the `NextToken` parameter, you must use the same value for `SortBy`, if
      any, as in the previous request.
  ...
  - `Error`: If the value of `Status` is `FAILED`, the value of `Error` indicates the cause:
    - `DESTINATION_NOT_FOUND`: The specified destination (for example, an Amazon S3 bucket)
      was deleted.
  ...
  - `Status`: The current status of the configuration. Valid values include the following:
    - `CREATING`: Resolver is creating an association between an Amazon VPC and a query
      logging configuration.
...
- `"SortOrder"`: If you specified a value for `SortBy`, the order that you want query
  ...
  !!! note
      ...
      any, as in the previous request.
"""
function list_resolver_query_log_config_associations end
...
- `"Filters"`: An optional specification to return a subset of query logging configurations.
  ...
  !!! note
      ...
      the `NextToken` parameter, you must use the same values for `Filters`, if any, as in
      the previous request.

- `"MaxResults"`: The maximum number of query logging configurations that you want to return
  in the response to a `ListResolverQueryLogConfigs` request. If you don't specify a value
  for `MaxResults`, Resolver returns up to 100 query logging configurations.
...
- `"SortOrder"`: If you specified a value for `SortBy`, the order that you want query
  ...
  !!! note
      If you submit a second or subsequent `ListResolverQueryLogConfigs` request and specify
      the `NextToken` parameter, you must use the same value for `SortOrder`, if any, as in
      the previous request.
"""
function list_resolver_query_log_configs end

function list_resolver_query_log_configs(;
    aws_config::AbstractAWSConfig=current_aws_config()
)
    return route53resolver(
        "ListResolverQueryLogConfigs"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_resolver_query_log_configs(
    ...
    return route53resolver(
        "ListResolverQueryLogConfigs", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"Filters"`: An optional specification to return a subset of Resolver rules, such as
  ...
  !!! note
      ...
      specify the `NextToken` parameter, you must use the same values for `Filters`, if any,
...
"""
function list_resolver_rule_associations end

function list_resolver_rule_associations(;
    aws_config::AbstractAWSConfig=current_aws_config()
)
    return route53resolver(
        "ListResolverRuleAssociations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_resolver_rule_associations(
    ...
    return route53resolver(
        "ListResolverRuleAssociations", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function list_resolver_rules end

function list_resolver_rules(; aws_config::AbstractAWSConfig=current_aws_config())
    return route53resolver("ListResolverRules"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_resolver_rules(
    ...
    return route53resolver(
        "ListResolverRules", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `resource_arn`: The Amazon Resource Name (ARN) for the resource that you want to list tags
  for.
...
- `firewall_rule_group_policy`: The Identity and Access Management (Amazon Web Services IAM)
  policy to attach to the rule group.
"""
function put_firewall_rule_group_policy end
...
"""
function put_resolver_query_log_config_policy end
...
"""
function put_resolver_rule_policy end
...
"""
function update_firewall_config end
...
- `"Priority"`: The setting that determines the processing order of the rule group among the
  ...
  association after you create it.
"""
function update_firewall_rule_group_association end
...
You can use `UpdateOutpostResolver` to update the instance count, type, or name of a
Resolver on an Outpost.
...
"""
function update_outpost_resolver end
...
- `autodefined_reverse_flag`: Indicates whether or not the Resolver will create autodefined
  ...
  affect EC2-Classic instances using ClassicLink. For more information, see [ClassicLink](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/vpc-classiclink.html)
...
- `validation`: The new value that you are specifying for DNSSEC validation for the VPC. The
  value can be `ENABLE` or `DISABLE`. Be aware that it can take time for a validation status
  change to be completed.
"""
function update_resolver_dnssec_config end
...
"""
function update_resolver_endpoint end
...
"""
function update_resolver_rule end
