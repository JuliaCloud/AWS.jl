...
"""
CreateSavingsPlan(commitment, savingsPlanOfferingId) = savingsplans("POST", "/CreateSavingsPlan", Dict{String, Any}("commitment"=>commitment, "savingsPlanOfferingId"=>savingsPlanOfferingId))
CreateSavingsPlan(commitment, savingsPlanOfferingId, args::AbstractDict{String, <: Any}) = savingsplans("POST", "/CreateSavingsPlan", Dict{String, Any}("commitment"=>commitment, "savingsPlanOfferingId"=>savingsPlanOfferingId, args...))
