...
"""
AddTagsToResource(ResourceName, Tag) = docdb("AddTagsToResource", Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag))
AddTagsToResource(ResourceName, Tag, args::AbstractDict{String, <: Any}) = docdb("AddTagsToResource", Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag, args...))
...
"""
ApplyPendingMaintenanceAction(ApplyAction, OptInType, ResourceIdentifier) = docdb("ApplyPendingMaintenanceAction", Dict{String, Any}("ApplyAction"=>ApplyAction, "OptInType"=>OptInType, "ResourceIdentifier"=>ResourceIdentifier))
ApplyPendingMaintenanceAction(ApplyAction, OptInType, ResourceIdentifier, args::AbstractDict{String, <: Any}) = docdb("ApplyPendingMaintenanceAction", Dict{String, Any}("ApplyAction"=>ApplyAction, "OptInType"=>OptInType, "ResourceIdentifier"=>ResourceIdentifier, args...))
...
CopyDBClusterParameterGroup(SourceDBClusterParameterGroupIdentifier, TargetDBClusterParameterGroupDescription, TargetDBClusterParameterGroupIdentifier, args::AbstractDict{String, <: Any}) = docdb("CopyDBClusterParameterGroup", Dict{String, Any}("SourceDBClusterParameterGroupIdentifier"=>SourceDBClusterParameterGroupIdentifier, "TargetDBClusterParameterGroupDescription"=>TargetDBClusterParameterGroupDescription, "TargetDBClusterParameterGroupIdentifier"=>TargetDBClusterParameterGroupIdentifier, args...))
...
"""
CopyDBClusterSnapshot(SourceDBClusterSnapshotIdentifier, TargetDBClusterSnapshotIdentifier) = docdb("CopyDBClusterSnapshot", Dict{String, Any}("SourceDBClusterSnapshotIdentifier"=>SourceDBClusterSnapshotIdentifier, "TargetDBClusterSnapshotIdentifier"=>TargetDBClusterSnapshotIdentifier))
CopyDBClusterSnapshot(SourceDBClusterSnapshotIdentifier, TargetDBClusterSnapshotIdentifier, args::AbstractDict{String, <: Any}) = docdb("CopyDBClusterSnapshot", Dict{String, Any}("SourceDBClusterSnapshotIdentifier"=>SourceDBClusterSnapshotIdentifier, "TargetDBClusterSnapshotIdentifier"=>TargetDBClusterSnapshotIdentifier, args...))
...
"""
CreateDBCluster(DBClusterIdentifier, Engine, MasterUserPassword, MasterUsername) = docdb("CreateDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "MasterUserPassword"=>MasterUserPassword, "MasterUsername"=>MasterUsername))
CreateDBCluster(DBClusterIdentifier, Engine, MasterUserPassword, MasterUsername, args::AbstractDict{String, <: Any}) = docdb("CreateDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "MasterUserPassword"=>MasterUserPassword, "MasterUsername"=>MasterUsername, args...))
...
"""
CreateDBClusterParameterGroup(DBClusterParameterGroupName, DBParameterGroupFamily, Description) = docdb("CreateDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "DBParameterGroupFamily"=>DBParameterGroupFamily, "Description"=>Description))
CreateDBClusterParameterGroup(DBClusterParameterGroupName, DBParameterGroupFamily, Description, args::AbstractDict{String, <: Any}) = docdb("CreateDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "DBParameterGroupFamily"=>DBParameterGroupFamily, "Description"=>Description, args...))
...
Tags => The tags to be assigned to the cluster snapshot.
"""
CreateDBClusterSnapshot(DBClusterIdentifier, DBClusterSnapshotIdentifier) = docdb("CreateDBClusterSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier))
CreateDBClusterSnapshot(DBClusterIdentifier, DBClusterSnapshotIdentifier, args::AbstractDict{String, <: Any}) = docdb("CreateDBClusterSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier, args...))
...
"""
CreateDBInstance(DBClusterIdentifier, DBInstanceClass, DBInstanceIdentifier, Engine) = docdb("CreateDBInstance", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "DBInstanceClass"=>DBInstanceClass, "DBInstanceIdentifier"=>DBInstanceIdentifier, "Engine"=>Engine))
CreateDBInstance(DBClusterIdentifier, DBInstanceClass, DBInstanceIdentifier, Engine, args::AbstractDict{String, <: Any}) = docdb("CreateDBInstance", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "DBInstanceClass"=>DBInstanceClass, "DBInstanceIdentifier"=>DBInstanceIdentifier, "Engine"=>Engine, args...))
...
"""
CreateDBSubnetGroup(DBSubnetGroupDescription, DBSubnetGroupName, SubnetIdentifier) = docdb("CreateDBSubnetGroup", Dict{String, Any}("DBSubnetGroupDescription"=>DBSubnetGroupDescription, "DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier))
CreateDBSubnetGroup(DBSubnetGroupDescription, DBSubnetGroupName, SubnetIdentifier, args::AbstractDict{String, <: Any}) = docdb("CreateDBSubnetGroup", Dict{String, Any}("DBSubnetGroupDescription"=>DBSubnetGroupDescription, "DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier, args...))
...
"""
DeleteDBCluster(DBClusterIdentifier) = docdb("DeleteDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
DeleteDBCluster(DBClusterIdentifier, args::AbstractDict{String, <: Any}) = docdb("DeleteDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
"""
DeleteDBClusterParameterGroup(DBClusterParameterGroupName) = docdb("DeleteDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName))
DeleteDBClusterParameterGroup(DBClusterParameterGroupName, args::AbstractDict{String, <: Any}) = docdb("DeleteDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, args...))
...
"""
DeleteDBClusterSnapshot(DBClusterSnapshotIdentifier) = docdb("DeleteDBClusterSnapshot", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier))
DeleteDBClusterSnapshot(DBClusterSnapshotIdentifier, args::AbstractDict{String, <: Any}) = docdb("DeleteDBClusterSnapshot", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier, args...))
...
"""
DeleteDBInstance(DBInstanceIdentifier) = docdb("DeleteDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
DeleteDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <: Any}) = docdb("DeleteDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
"""
DeleteDBSubnetGroup(DBSubnetGroupName) = docdb("DeleteDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName))
DeleteDBSubnetGroup(DBSubnetGroupName, args::AbstractDict{String, <: Any}) = docdb("DeleteDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName, args...))
...
DescribeCertificates(args::AbstractDict{String, <: Any}) = docdb("DescribeCertificates", args)
...
DescribeDBClusterParameterGroups(args::AbstractDict{String, <: Any}) = docdb("DescribeDBClusterParameterGroups", args)
...
"""
DescribeDBClusterParameters(DBClusterParameterGroupName) = docdb("DescribeDBClusterParameters", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName))
DescribeDBClusterParameters(DBClusterParameterGroupName, args::AbstractDict{String, <: Any}) = docdb("DescribeDBClusterParameters", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, args...))
...
"""
DescribeDBClusterSnapshotAttributes(DBClusterSnapshotIdentifier) = docdb("DescribeDBClusterSnapshotAttributes", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier))
DescribeDBClusterSnapshotAttributes(DBClusterSnapshotIdentifier, args::AbstractDict{String, <: Any}) = docdb("DescribeDBClusterSnapshotAttributes", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier, args...))
...
DescribeDBClusterSnapshots(args::AbstractDict{String, <: Any}) = docdb("DescribeDBClusterSnapshots", args)
...
DescribeDBClusters(args::AbstractDict{String, <: Any}) = docdb("DescribeDBClusters", args)
...
DescribeDBEngineVersions(args::AbstractDict{String, <: Any}) = docdb("DescribeDBEngineVersions", args)
...
DescribeDBInstances(args::AbstractDict{String, <: Any}) = docdb("DescribeDBInstances", args)
...
DescribeDBSubnetGroups(args::AbstractDict{String, <: Any}) = docdb("DescribeDBSubnetGroups", args)
...
MaxRecords =>  The maximum number of records to include in the response. If more records exist than the specified MaxRecords value, a pagination token (marker) is included in the response so that the remaining results can be retrieved. Default: 100 Constraints: Minimum 20, maximum 100.
"""
DescribeEngineDefaultClusterParameters(DBParameterGroupFamily) = docdb("DescribeEngineDefaultClusterParameters", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily))
DescribeEngineDefaultClusterParameters(DBParameterGroupFamily, args::AbstractDict{String, <: Any}) = docdb("DescribeEngineDefaultClusterParameters", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily, args...))
...
DescribeEventCategories(args::AbstractDict{String, <: Any}) = docdb("DescribeEventCategories", args)
...
DescribeEvents(args::AbstractDict{String, <: Any}) = docdb("DescribeEvents", args)
...
"""
DescribeOrderableDBInstanceOptions(Engine) = docdb("DescribeOrderableDBInstanceOptions", Dict{String, Any}("Engine"=>Engine))
DescribeOrderableDBInstanceOptions(Engine, args::AbstractDict{String, <: Any}) = docdb("DescribeOrderableDBInstanceOptions", Dict{String, Any}("Engine"=>Engine, args...))
...
DescribePendingMaintenanceActions(args::AbstractDict{String, <: Any}) = docdb("DescribePendingMaintenanceActions", args)
...
FailoverDBCluster(args::AbstractDict{String, <: Any}) = docdb("FailoverDBCluster", args)
...
Filters => This parameter is not currently supported.
"""
ListTagsForResource(ResourceName) = docdb("ListTagsForResource", Dict{String, Any}("ResourceName"=>ResourceName))
ListTagsForResource(ResourceName, args::AbstractDict{String, <: Any}) = docdb("ListTagsForResource", Dict{String, Any}("ResourceName"=>ResourceName, args...))
...
"""
ModifyDBCluster(DBClusterIdentifier) = docdb("ModifyDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
ModifyDBCluster(DBClusterIdentifier, args::AbstractDict{String, <: Any}) = docdb("ModifyDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
"""
ModifyDBClusterParameterGroup(DBClusterParameterGroupName, Parameter) = docdb("ModifyDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "Parameter"=>Parameter))
ModifyDBClusterParameterGroup(DBClusterParameterGroupName, Parameter, args::AbstractDict{String, <: Any}) = docdb("ModifyDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "Parameter"=>Parameter, args...))
...
"""
ModifyDBClusterSnapshotAttribute(AttributeName, DBClusterSnapshotIdentifier) = docdb("ModifyDBClusterSnapshotAttribute", Dict{String, Any}("AttributeName"=>AttributeName, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier))
ModifyDBClusterSnapshotAttribute(AttributeName, DBClusterSnapshotIdentifier, args::AbstractDict{String, <: Any}) = docdb("ModifyDBClusterSnapshotAttribute", Dict{String, Any}("AttributeName"=>AttributeName, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier, args...))
...
PromotionTier => A value that specifies the order in which an Amazon DocumentDB replica is promoted to the primary instance after a failure of the existing primary instance. Default: 1 Valid values: 0-15
"""
ModifyDBInstance(DBInstanceIdentifier) = docdb("ModifyDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
ModifyDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <: Any}) = docdb("ModifyDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
SubnetIds => The Amazon EC2 subnet IDs for the subnet group.
"""
ModifyDBSubnetGroup(DBSubnetGroupName, SubnetIdentifier) = docdb("ModifyDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier))
ModifyDBSubnetGroup(DBSubnetGroupName, SubnetIdentifier, args::AbstractDict{String, <: Any}) = docdb("ModifyDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier, args...))
...
"""
RebootDBInstance(DBInstanceIdentifier) = docdb("RebootDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
RebootDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <: Any}) = docdb("RebootDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
"""
RemoveTagsFromResource(ResourceName, TagKeys) = docdb("RemoveTagsFromResource", Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys))
RemoveTagsFromResource(ResourceName, TagKeys, args::AbstractDict{String, <: Any}) = docdb("RemoveTagsFromResource", Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys, args...))
...
"""
ResetDBClusterParameterGroup(DBClusterParameterGroupName) = docdb("ResetDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName))
ResetDBClusterParameterGroup(DBClusterParameterGroupName, args::AbstractDict{String, <: Any}) = docdb("ResetDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, args...))
...
"""
RestoreDBClusterFromSnapshot(DBClusterIdentifier, Engine, SnapshotIdentifier) = docdb("RestoreDBClusterFromSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "SnapshotIdentifier"=>SnapshotIdentifier))
RestoreDBClusterFromSnapshot(DBClusterIdentifier, Engine, SnapshotIdentifier, args::AbstractDict{String, <: Any}) = docdb("RestoreDBClusterFromSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "SnapshotIdentifier"=>SnapshotIdentifier, args...))
...
"""
RestoreDBClusterToPointInTime(DBClusterIdentifier, SourceDBClusterIdentifier) = docdb("RestoreDBClusterToPointInTime", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "SourceDBClusterIdentifier"=>SourceDBClusterIdentifier))
RestoreDBClusterToPointInTime(DBClusterIdentifier, SourceDBClusterIdentifier, args::AbstractDict{String, <: Any}) = docdb("RestoreDBClusterToPointInTime", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "SourceDBClusterIdentifier"=>SourceDBClusterIdentifier, args...))
...
"""
StartDBCluster(DBClusterIdentifier) = docdb("StartDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
StartDBCluster(DBClusterIdentifier, args::AbstractDict{String, <: Any}) = docdb("StartDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
"""
StopDBCluster(DBClusterIdentifier) = docdb("StopDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
StopDBCluster(DBClusterIdentifier, args::AbstractDict{String, <: Any}) = docdb("StopDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
