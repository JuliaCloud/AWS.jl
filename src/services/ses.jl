...
"""
CloneReceiptRuleSet(OriginalRuleSetName, RuleSetName) = ses("CloneReceiptRuleSet", Dict{String, Any}("OriginalRuleSetName"=>OriginalRuleSetName, "RuleSetName"=>RuleSetName))
CloneReceiptRuleSet(OriginalRuleSetName, RuleSetName, args::AbstractDict{String, <: Any}) = ses("CloneReceiptRuleSet", Dict{String, Any}("OriginalRuleSetName"=>OriginalRuleSetName, "RuleSetName"=>RuleSetName, args...))
...
"""
CreateConfigurationSet(ConfigurationSet) = ses("CreateConfigurationSet", Dict{String, Any}("ConfigurationSet"=>ConfigurationSet))
CreateConfigurationSet(ConfigurationSet, args::AbstractDict{String, <: Any}) = ses("CreateConfigurationSet", Dict{String, Any}("ConfigurationSet"=>ConfigurationSet, args...))
...
"""
CreateConfigurationSetEventDestination(ConfigurationSetName, EventDestination) = ses("CreateConfigurationSetEventDestination", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "EventDestination"=>EventDestination))
CreateConfigurationSetEventDestination(ConfigurationSetName, EventDestination, args::AbstractDict{String, <: Any}) = ses("CreateConfigurationSetEventDestination", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "EventDestination"=>EventDestination, args...))
...
"""
CreateConfigurationSetTrackingOptions(ConfigurationSetName, TrackingOptions) = ses("CreateConfigurationSetTrackingOptions", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "TrackingOptions"=>TrackingOptions))
CreateConfigurationSetTrackingOptions(ConfigurationSetName, TrackingOptions, args::AbstractDict{String, <: Any}) = ses("CreateConfigurationSetTrackingOptions", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "TrackingOptions"=>TrackingOptions, args...))
...
"""
CreateCustomVerificationEmailTemplate(FailureRedirectionURL, FromEmailAddress, SuccessRedirectionURL, TemplateContent, TemplateName, TemplateSubject) = ses("CreateCustomVerificationEmailTemplate", Dict{String, Any}("FailureRedirectionURL"=>FailureRedirectionURL, "FromEmailAddress"=>FromEmailAddress, "SuccessRedirectionURL"=>SuccessRedirectionURL, "TemplateContent"=>TemplateContent, "TemplateName"=>TemplateName, "TemplateSubject"=>TemplateSubject))
CreateCustomVerificationEmailTemplate(FailureRedirectionURL, FromEmailAddress, SuccessRedirectionURL, TemplateContent, TemplateName, TemplateSubject, args::AbstractDict{String, <: Any}) = ses("CreateCustomVerificationEmailTemplate", Dict{String, Any}("FailureRedirectionURL"=>FailureRedirectionURL, "FromEmailAddress"=>FromEmailAddress, "SuccessRedirectionURL"=>SuccessRedirectionURL, "TemplateContent"=>TemplateContent, "TemplateName"=>TemplateName, "TemplateSubject"=>TemplateSubject, args...))
...
"""
CreateReceiptFilter(Filter) = ses("CreateReceiptFilter", Dict{String, Any}("Filter"=>Filter))
CreateReceiptFilter(Filter, args::AbstractDict{String, <: Any}) = ses("CreateReceiptFilter", Dict{String, Any}("Filter"=>Filter, args...))
...
"""
CreateReceiptRule(Rule, RuleSetName) = ses("CreateReceiptRule", Dict{String, Any}("Rule"=>Rule, "RuleSetName"=>RuleSetName))
CreateReceiptRule(Rule, RuleSetName, args::AbstractDict{String, <: Any}) = ses("CreateReceiptRule", Dict{String, Any}("Rule"=>Rule, "RuleSetName"=>RuleSetName, args...))
...
"""
CreateReceiptRuleSet(RuleSetName) = ses("CreateReceiptRuleSet", Dict{String, Any}("RuleSetName"=>RuleSetName))
CreateReceiptRuleSet(RuleSetName, args::AbstractDict{String, <: Any}) = ses("CreateReceiptRuleSet", Dict{String, Any}("RuleSetName"=>RuleSetName, args...))
...
"""
CreateTemplate(Template) = ses("CreateTemplate", Dict{String, Any}("Template"=>Template))
CreateTemplate(Template, args::AbstractDict{String, <: Any}) = ses("CreateTemplate", Dict{String, Any}("Template"=>Template, args...))
...
"""
DeleteConfigurationSet(ConfigurationSetName) = ses("DeleteConfigurationSet", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName))
DeleteConfigurationSet(ConfigurationSetName, args::AbstractDict{String, <: Any}) = ses("DeleteConfigurationSet", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, args...))
...
"""
DeleteConfigurationSetEventDestination(ConfigurationSetName, EventDestinationName) = ses("DeleteConfigurationSetEventDestination", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "EventDestinationName"=>EventDestinationName))
DeleteConfigurationSetEventDestination(ConfigurationSetName, EventDestinationName, args::AbstractDict{String, <: Any}) = ses("DeleteConfigurationSetEventDestination", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "EventDestinationName"=>EventDestinationName, args...))
...
"""
DeleteConfigurationSetTrackingOptions(ConfigurationSetName) = ses("DeleteConfigurationSetTrackingOptions", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName))
DeleteConfigurationSetTrackingOptions(ConfigurationSetName, args::AbstractDict{String, <: Any}) = ses("DeleteConfigurationSetTrackingOptions", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, args...))
...
"""
DeleteCustomVerificationEmailTemplate(TemplateName) = ses("DeleteCustomVerificationEmailTemplate", Dict{String, Any}("TemplateName"=>TemplateName))
DeleteCustomVerificationEmailTemplate(TemplateName, args::AbstractDict{String, <: Any}) = ses("DeleteCustomVerificationEmailTemplate", Dict{String, Any}("TemplateName"=>TemplateName, args...))
...
"""
DeleteIdentity(Identity) = ses("DeleteIdentity", Dict{String, Any}("Identity"=>Identity))
DeleteIdentity(Identity, args::AbstractDict{String, <: Any}) = ses("DeleteIdentity", Dict{String, Any}("Identity"=>Identity, args...))
...
"""
DeleteIdentityPolicy(Identity, PolicyName) = ses("DeleteIdentityPolicy", Dict{String, Any}("Identity"=>Identity, "PolicyName"=>PolicyName))
DeleteIdentityPolicy(Identity, PolicyName, args::AbstractDict{String, <: Any}) = ses("DeleteIdentityPolicy", Dict{String, Any}("Identity"=>Identity, "PolicyName"=>PolicyName, args...))
...
"""
DeleteReceiptFilter(FilterName) = ses("DeleteReceiptFilter", Dict{String, Any}("FilterName"=>FilterName))
DeleteReceiptFilter(FilterName, args::AbstractDict{String, <: Any}) = ses("DeleteReceiptFilter", Dict{String, Any}("FilterName"=>FilterName, args...))
...
"""
DeleteReceiptRule(RuleName, RuleSetName) = ses("DeleteReceiptRule", Dict{String, Any}("RuleName"=>RuleName, "RuleSetName"=>RuleSetName))
DeleteReceiptRule(RuleName, RuleSetName, args::AbstractDict{String, <: Any}) = ses("DeleteReceiptRule", Dict{String, Any}("RuleName"=>RuleName, "RuleSetName"=>RuleSetName, args...))
...
"""
DeleteReceiptRuleSet(RuleSetName) = ses("DeleteReceiptRuleSet", Dict{String, Any}("RuleSetName"=>RuleSetName))
DeleteReceiptRuleSet(RuleSetName, args::AbstractDict{String, <: Any}) = ses("DeleteReceiptRuleSet", Dict{String, Any}("RuleSetName"=>RuleSetName, args...))
...
"""
DeleteTemplate(TemplateName) = ses("DeleteTemplate", Dict{String, Any}("TemplateName"=>TemplateName))
DeleteTemplate(TemplateName, args::AbstractDict{String, <: Any}) = ses("DeleteTemplate", Dict{String, Any}("TemplateName"=>TemplateName, args...))
...
"""
DeleteVerifiedEmailAddress(EmailAddress) = ses("DeleteVerifiedEmailAddress", Dict{String, Any}("EmailAddress"=>EmailAddress))
DeleteVerifiedEmailAddress(EmailAddress, args::AbstractDict{String, <: Any}) = ses("DeleteVerifiedEmailAddress", Dict{String, Any}("EmailAddress"=>EmailAddress, args...))
...
DescribeActiveReceiptRuleSet(args::AbstractDict{String, <: Any}) = ses("DescribeActiveReceiptRuleSet", args)
...
"""
DescribeConfigurationSet(ConfigurationSetName) = ses("DescribeConfigurationSet", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName))
DescribeConfigurationSet(ConfigurationSetName, args::AbstractDict{String, <: Any}) = ses("DescribeConfigurationSet", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, args...))
...
"""
DescribeReceiptRule(RuleName, RuleSetName) = ses("DescribeReceiptRule", Dict{String, Any}("RuleName"=>RuleName, "RuleSetName"=>RuleSetName))
DescribeReceiptRule(RuleName, RuleSetName, args::AbstractDict{String, <: Any}) = ses("DescribeReceiptRule", Dict{String, Any}("RuleName"=>RuleName, "RuleSetName"=>RuleSetName, args...))
...
"""
DescribeReceiptRuleSet(RuleSetName) = ses("DescribeReceiptRuleSet", Dict{String, Any}("RuleSetName"=>RuleSetName))
DescribeReceiptRuleSet(RuleSetName, args::AbstractDict{String, <: Any}) = ses("DescribeReceiptRuleSet", Dict{String, Any}("RuleSetName"=>RuleSetName, args...))
...
GetAccountSendingEnabled(args::AbstractDict{String, <: Any}) = ses("GetAccountSendingEnabled", args)
...
"""
GetCustomVerificationEmailTemplate(TemplateName) = ses("GetCustomVerificationEmailTemplate", Dict{String, Any}("TemplateName"=>TemplateName))
GetCustomVerificationEmailTemplate(TemplateName, args::AbstractDict{String, <: Any}) = ses("GetCustomVerificationEmailTemplate", Dict{String, Any}("TemplateName"=>TemplateName, args...))
...
"""
GetIdentityDkimAttributes(Identities) = ses("GetIdentityDkimAttributes", Dict{String, Any}("Identities"=>Identities))
GetIdentityDkimAttributes(Identities, args::AbstractDict{String, <: Any}) = ses("GetIdentityDkimAttributes", Dict{String, Any}("Identities"=>Identities, args...))
...
"""
GetIdentityMailFromDomainAttributes(Identities) = ses("GetIdentityMailFromDomainAttributes", Dict{String, Any}("Identities"=>Identities))
GetIdentityMailFromDomainAttributes(Identities, args::AbstractDict{String, <: Any}) = ses("GetIdentityMailFromDomainAttributes", Dict{String, Any}("Identities"=>Identities, args...))
...
"""
GetIdentityNotificationAttributes(Identities) = ses("GetIdentityNotificationAttributes", Dict{String, Any}("Identities"=>Identities))
GetIdentityNotificationAttributes(Identities, args::AbstractDict{String, <: Any}) = ses("GetIdentityNotificationAttributes", Dict{String, Any}("Identities"=>Identities, args...))
...
"""
GetIdentityPolicies(Identity, PolicyNames) = ses("GetIdentityPolicies", Dict{String, Any}("Identity"=>Identity, "PolicyNames"=>PolicyNames))
GetIdentityPolicies(Identity, PolicyNames, args::AbstractDict{String, <: Any}) = ses("GetIdentityPolicies", Dict{String, Any}("Identity"=>Identity, "PolicyNames"=>PolicyNames, args...))
...
"""
GetIdentityVerificationAttributes(Identities) = ses("GetIdentityVerificationAttributes", Dict{String, Any}("Identities"=>Identities))
GetIdentityVerificationAttributes(Identities, args::AbstractDict{String, <: Any}) = ses("GetIdentityVerificationAttributes", Dict{String, Any}("Identities"=>Identities, args...))
...
GetSendQuota(args::AbstractDict{String, <: Any}) = ses("GetSendQuota", args)
...
GetSendStatistics(args::AbstractDict{String, <: Any}) = ses("GetSendStatistics", args)
...
"""
GetTemplate(TemplateName) = ses("GetTemplate", Dict{String, Any}("TemplateName"=>TemplateName))
GetTemplate(TemplateName, args::AbstractDict{String, <: Any}) = ses("GetTemplate", Dict{String, Any}("TemplateName"=>TemplateName, args...))
...
ListConfigurationSets(args::AbstractDict{String, <: Any}) = ses("ListConfigurationSets", args)
...
ListCustomVerificationEmailTemplates(args::AbstractDict{String, <: Any}) = ses("ListCustomVerificationEmailTemplates", args)
...
ListIdentities(args::AbstractDict{String, <: Any}) = ses("ListIdentities", args)
...
"""
ListIdentityPolicies(Identity) = ses("ListIdentityPolicies", Dict{String, Any}("Identity"=>Identity))
ListIdentityPolicies(Identity, args::AbstractDict{String, <: Any}) = ses("ListIdentityPolicies", Dict{String, Any}("Identity"=>Identity, args...))
...
ListReceiptFilters(args::AbstractDict{String, <: Any}) = ses("ListReceiptFilters", args)
...
ListReceiptRuleSets(args::AbstractDict{String, <: Any}) = ses("ListReceiptRuleSets", args)
...
ListTemplates(args::AbstractDict{String, <: Any}) = ses("ListTemplates", args)
...
ListVerifiedEmailAddresses(args::AbstractDict{String, <: Any}) = ses("ListVerifiedEmailAddresses", args)
...
"""
PutConfigurationSetDeliveryOptions(ConfigurationSetName) = ses("PutConfigurationSetDeliveryOptions", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName))
PutConfigurationSetDeliveryOptions(ConfigurationSetName, args::AbstractDict{String, <: Any}) = ses("PutConfigurationSetDeliveryOptions", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, args...))
...
"""
PutIdentityPolicy(Identity, Policy, PolicyName) = ses("PutIdentityPolicy", Dict{String, Any}("Identity"=>Identity, "Policy"=>Policy, "PolicyName"=>PolicyName))
PutIdentityPolicy(Identity, Policy, PolicyName, args::AbstractDict{String, <: Any}) = ses("PutIdentityPolicy", Dict{String, Any}("Identity"=>Identity, "Policy"=>Policy, "PolicyName"=>PolicyName, args...))
...
"""
ReorderReceiptRuleSet(RuleNames, RuleSetName) = ses("ReorderReceiptRuleSet", Dict{String, Any}("RuleNames"=>RuleNames, "RuleSetName"=>RuleSetName))
ReorderReceiptRuleSet(RuleNames, RuleSetName, args::AbstractDict{String, <: Any}) = ses("ReorderReceiptRuleSet", Dict{String, Any}("RuleNames"=>RuleNames, "RuleSetName"=>RuleSetName, args...))
...
"""
SendBounce(BounceSender, BouncedRecipientInfoList, OriginalMessageId) = ses("SendBounce", Dict{String, Any}("BounceSender"=>BounceSender, "BouncedRecipientInfoList"=>BouncedRecipientInfoList, "OriginalMessageId"=>OriginalMessageId))
SendBounce(BounceSender, BouncedRecipientInfoList, OriginalMessageId, args::AbstractDict{String, <: Any}) = ses("SendBounce", Dict{String, Any}("BounceSender"=>BounceSender, "BouncedRecipientInfoList"=>BouncedRecipientInfoList, "OriginalMessageId"=>OriginalMessageId, args...))
...
"""
SendBulkTemplatedEmail(Destinations, Source, Template) = ses("SendBulkTemplatedEmail", Dict{String, Any}("Destinations"=>Destinations, "Source"=>Source, "Template"=>Template))
SendBulkTemplatedEmail(Destinations, Source, Template, args::AbstractDict{String, <: Any}) = ses("SendBulkTemplatedEmail", Dict{String, Any}("Destinations"=>Destinations, "Source"=>Source, "Template"=>Template, args...))
...
"""
SendCustomVerificationEmail(EmailAddress, TemplateName) = ses("SendCustomVerificationEmail", Dict{String, Any}("EmailAddress"=>EmailAddress, "TemplateName"=>TemplateName))
SendCustomVerificationEmail(EmailAddress, TemplateName, args::AbstractDict{String, <: Any}) = ses("SendCustomVerificationEmail", Dict{String, Any}("EmailAddress"=>EmailAddress, "TemplateName"=>TemplateName, args...))
...
"""
SendEmail(Destination, Message, Source) = ses("SendEmail", Dict{String, Any}("Destination"=>Destination, "Message"=>Message, "Source"=>Source))
SendEmail(Destination, Message, Source, args::AbstractDict{String, <: Any}) = ses("SendEmail", Dict{String, Any}("Destination"=>Destination, "Message"=>Message, "Source"=>Source, args...))
...
"""
SendRawEmail(RawMessage) = ses("SendRawEmail", Dict{String, Any}("RawMessage"=>RawMessage))
SendRawEmail(RawMessage, args::AbstractDict{String, <: Any}) = ses("SendRawEmail", Dict{String, Any}("RawMessage"=>RawMessage, args...))
...
TemplateArn => The ARN of the template to use when sending this email.
"""
SendTemplatedEmail(Destination, Source, Template, TemplateData) = ses("SendTemplatedEmail", Dict{String, Any}("Destination"=>Destination, "Source"=>Source, "Template"=>Template, "TemplateData"=>TemplateData))
SendTemplatedEmail(Destination, Source, Template, TemplateData, args::AbstractDict{String, <: Any}) = ses("SendTemplatedEmail", Dict{String, Any}("Destination"=>Destination, "Source"=>Source, "Template"=>Template, "TemplateData"=>TemplateData, args...))
...
SetActiveReceiptRuleSet(args::AbstractDict{String, <: Any}) = ses("SetActiveReceiptRuleSet", args)
...
"""
SetIdentityDkimEnabled(DkimEnabled, Identity) = ses("SetIdentityDkimEnabled", Dict{String, Any}("DkimEnabled"=>DkimEnabled, "Identity"=>Identity))
SetIdentityDkimEnabled(DkimEnabled, Identity, args::AbstractDict{String, <: Any}) = ses("SetIdentityDkimEnabled", Dict{String, Any}("DkimEnabled"=>DkimEnabled, "Identity"=>Identity, args...))
...
"""
SetIdentityFeedbackForwardingEnabled(ForwardingEnabled, Identity) = ses("SetIdentityFeedbackForwardingEnabled", Dict{String, Any}("ForwardingEnabled"=>ForwardingEnabled, "Identity"=>Identity))
SetIdentityFeedbackForwardingEnabled(ForwardingEnabled, Identity, args::AbstractDict{String, <: Any}) = ses("SetIdentityFeedbackForwardingEnabled", Dict{String, Any}("ForwardingEnabled"=>ForwardingEnabled, "Identity"=>Identity, args...))
...
"""
SetIdentityHeadersInNotificationsEnabled(Enabled, Identity, NotificationType) = ses("SetIdentityHeadersInNotificationsEnabled", Dict{String, Any}("Enabled"=>Enabled, "Identity"=>Identity, "NotificationType"=>NotificationType))
SetIdentityHeadersInNotificationsEnabled(Enabled, Identity, NotificationType, args::AbstractDict{String, <: Any}) = ses("SetIdentityHeadersInNotificationsEnabled", Dict{String, Any}("Enabled"=>Enabled, "Identity"=>Identity, "NotificationType"=>NotificationType, args...))
...
"""
SetIdentityMailFromDomain(Identity) = ses("SetIdentityMailFromDomain", Dict{String, Any}("Identity"=>Identity))
SetIdentityMailFromDomain(Identity, args::AbstractDict{String, <: Any}) = ses("SetIdentityMailFromDomain", Dict{String, Any}("Identity"=>Identity, args...))
...
"""
SetIdentityNotificationTopic(Identity, NotificationType) = ses("SetIdentityNotificationTopic", Dict{String, Any}("Identity"=>Identity, "NotificationType"=>NotificationType))
SetIdentityNotificationTopic(Identity, NotificationType, args::AbstractDict{String, <: Any}) = ses("SetIdentityNotificationTopic", Dict{String, Any}("Identity"=>Identity, "NotificationType"=>NotificationType, args...))
...
"""
SetReceiptRulePosition(RuleName, RuleSetName) = ses("SetReceiptRulePosition", Dict{String, Any}("RuleName"=>RuleName, "RuleSetName"=>RuleSetName))
SetReceiptRulePosition(RuleName, RuleSetName, args::AbstractDict{String, <: Any}) = ses("SetReceiptRulePosition", Dict{String, Any}("RuleName"=>RuleName, "RuleSetName"=>RuleSetName, args...))
...
"""
TestRenderTemplate(TemplateData, TemplateName) = ses("TestRenderTemplate", Dict{String, Any}("TemplateData"=>TemplateData, "TemplateName"=>TemplateName))
TestRenderTemplate(TemplateData, TemplateName, args::AbstractDict{String, <: Any}) = ses("TestRenderTemplate", Dict{String, Any}("TemplateData"=>TemplateData, "TemplateName"=>TemplateName, args...))
...
UpdateAccountSendingEnabled(args::AbstractDict{String, <: Any}) = ses("UpdateAccountSendingEnabled", args)
...
"""
UpdateConfigurationSetEventDestination(ConfigurationSetName, EventDestination) = ses("UpdateConfigurationSetEventDestination", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "EventDestination"=>EventDestination))
UpdateConfigurationSetEventDestination(ConfigurationSetName, EventDestination, args::AbstractDict{String, <: Any}) = ses("UpdateConfigurationSetEventDestination", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "EventDestination"=>EventDestination, args...))
...
"""
UpdateConfigurationSetReputationMetricsEnabled(ConfigurationSetName, Enabled) = ses("UpdateConfigurationSetReputationMetricsEnabled", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "Enabled"=>Enabled))
UpdateConfigurationSetReputationMetricsEnabled(ConfigurationSetName, Enabled, args::AbstractDict{String, <: Any}) = ses("UpdateConfigurationSetReputationMetricsEnabled", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "Enabled"=>Enabled, args...))
...
"""
UpdateConfigurationSetSendingEnabled(ConfigurationSetName, Enabled) = ses("UpdateConfigurationSetSendingEnabled", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "Enabled"=>Enabled))
UpdateConfigurationSetSendingEnabled(ConfigurationSetName, Enabled, args::AbstractDict{String, <: Any}) = ses("UpdateConfigurationSetSendingEnabled", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "Enabled"=>Enabled, args...))
...
"""
UpdateConfigurationSetTrackingOptions(ConfigurationSetName, TrackingOptions) = ses("UpdateConfigurationSetTrackingOptions", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "TrackingOptions"=>TrackingOptions))
UpdateConfigurationSetTrackingOptions(ConfigurationSetName, TrackingOptions, args::AbstractDict{String, <: Any}) = ses("UpdateConfigurationSetTrackingOptions", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "TrackingOptions"=>TrackingOptions, args...))
...
TemplateSubject => The subject line of the custom verification email.
"""
UpdateCustomVerificationEmailTemplate(TemplateName) = ses("UpdateCustomVerificationEmailTemplate", Dict{String, Any}("TemplateName"=>TemplateName))
UpdateCustomVerificationEmailTemplate(TemplateName, args::AbstractDict{String, <: Any}) = ses("UpdateCustomVerificationEmailTemplate", Dict{String, Any}("TemplateName"=>TemplateName, args...))
...
"""
UpdateReceiptRule(Rule, RuleSetName) = ses("UpdateReceiptRule", Dict{String, Any}("Rule"=>Rule, "RuleSetName"=>RuleSetName))
UpdateReceiptRule(Rule, RuleSetName, args::AbstractDict{String, <: Any}) = ses("UpdateReceiptRule", Dict{String, Any}("Rule"=>Rule, "RuleSetName"=>RuleSetName, args...))
...
"""
UpdateTemplate(Template) = ses("UpdateTemplate", Dict{String, Any}("Template"=>Template))
UpdateTemplate(Template, args::AbstractDict{String, <: Any}) = ses("UpdateTemplate", Dict{String, Any}("Template"=>Template, args...))
...
"""
VerifyDomainDkim(Domain) = ses("VerifyDomainDkim", Dict{String, Any}("Domain"=>Domain))
VerifyDomainDkim(Domain, args::AbstractDict{String, <: Any}) = ses("VerifyDomainDkim", Dict{String, Any}("Domain"=>Domain, args...))
...
"""
VerifyDomainIdentity(Domain) = ses("VerifyDomainIdentity", Dict{String, Any}("Domain"=>Domain))
VerifyDomainIdentity(Domain, args::AbstractDict{String, <: Any}) = ses("VerifyDomainIdentity", Dict{String, Any}("Domain"=>Domain, args...))
...
"""
VerifyEmailAddress(EmailAddress) = ses("VerifyEmailAddress", Dict{String, Any}("EmailAddress"=>EmailAddress))
VerifyEmailAddress(EmailAddress, args::AbstractDict{String, <: Any}) = ses("VerifyEmailAddress", Dict{String, Any}("EmailAddress"=>EmailAddress, args...))
...
"""
VerifyEmailIdentity(EmailAddress) = ses("VerifyEmailIdentity", Dict{String, Any}("EmailAddress"=>EmailAddress))
VerifyEmailIdentity(EmailAddress, args::AbstractDict{String, <: Any}) = ses("VerifyEmailIdentity", Dict{String, Any}("EmailAddress"=>EmailAddress, args...))
