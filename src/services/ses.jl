...
CloneReceiptRuleSet(OriginalRuleSetName, RuleSetName; aws_config::AWSConfig=AWS.aws_config) = ses("CloneReceiptRuleSet", Dict{String, Any}("OriginalRuleSetName"=>OriginalRuleSetName, "RuleSetName"=>RuleSetName); aws_config=aws_config)
CloneReceiptRuleSet(OriginalRuleSetName, RuleSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("CloneReceiptRuleSet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("OriginalRuleSetName"=>OriginalRuleSetName, "RuleSetName"=>RuleSetName), args)); aws_config=aws_config)
...
CreateConfigurationSet(ConfigurationSet; aws_config::AWSConfig=AWS.aws_config) = ses("CreateConfigurationSet", Dict{String, Any}("ConfigurationSet"=>ConfigurationSet); aws_config=aws_config)
CreateConfigurationSet(ConfigurationSet, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("CreateConfigurationSet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSet"=>ConfigurationSet), args)); aws_config=aws_config)
...
CreateConfigurationSetEventDestination(ConfigurationSetName, EventDestination; aws_config::AWSConfig=AWS.aws_config) = ses("CreateConfigurationSetEventDestination", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "EventDestination"=>EventDestination); aws_config=aws_config)
CreateConfigurationSetEventDestination(ConfigurationSetName, EventDestination, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("CreateConfigurationSetEventDestination", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "EventDestination"=>EventDestination), args)); aws_config=aws_config)
...
CreateConfigurationSetTrackingOptions(ConfigurationSetName, TrackingOptions; aws_config::AWSConfig=AWS.aws_config) = ses("CreateConfigurationSetTrackingOptions", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "TrackingOptions"=>TrackingOptions); aws_config=aws_config)
CreateConfigurationSetTrackingOptions(ConfigurationSetName, TrackingOptions, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("CreateConfigurationSetTrackingOptions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "TrackingOptions"=>TrackingOptions), args)); aws_config=aws_config)
...
CreateReceiptFilter(Filter; aws_config::AWSConfig=AWS.aws_config) = ses("CreateReceiptFilter", Dict{String, Any}("Filter"=>Filter); aws_config=aws_config)
CreateReceiptFilter(Filter, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("CreateReceiptFilter", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Filter"=>Filter), args)); aws_config=aws_config)
...
CreateReceiptRule(Rule, RuleSetName; aws_config::AWSConfig=AWS.aws_config) = ses("CreateReceiptRule", Dict{String, Any}("Rule"=>Rule, "RuleSetName"=>RuleSetName); aws_config=aws_config)
CreateReceiptRule(Rule, RuleSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("CreateReceiptRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Rule"=>Rule, "RuleSetName"=>RuleSetName), args)); aws_config=aws_config)
...
CreateReceiptRuleSet(RuleSetName; aws_config::AWSConfig=AWS.aws_config) = ses("CreateReceiptRuleSet", Dict{String, Any}("RuleSetName"=>RuleSetName); aws_config=aws_config)
CreateReceiptRuleSet(RuleSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("CreateReceiptRuleSet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RuleSetName"=>RuleSetName), args)); aws_config=aws_config)
...
CreateTemplate(Template; aws_config::AWSConfig=AWS.aws_config) = ses("CreateTemplate", Dict{String, Any}("Template"=>Template); aws_config=aws_config)
CreateTemplate(Template, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("CreateTemplate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Template"=>Template), args)); aws_config=aws_config)
...
DeleteConfigurationSet(ConfigurationSetName; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteConfigurationSet", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName); aws_config=aws_config)
DeleteConfigurationSet(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteConfigurationSet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName), args)); aws_config=aws_config)
...
DeleteConfigurationSetEventDestination(ConfigurationSetName, EventDestinationName; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteConfigurationSetEventDestination", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "EventDestinationName"=>EventDestinationName); aws_config=aws_config)
DeleteConfigurationSetEventDestination(ConfigurationSetName, EventDestinationName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteConfigurationSetEventDestination", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "EventDestinationName"=>EventDestinationName), args)); aws_config=aws_config)
...
DeleteConfigurationSetTrackingOptions(ConfigurationSetName; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteConfigurationSetTrackingOptions", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName); aws_config=aws_config)
DeleteConfigurationSetTrackingOptions(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteConfigurationSetTrackingOptions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName), args)); aws_config=aws_config)
...
DeleteCustomVerificationEmailTemplate(TemplateName; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteCustomVerificationEmailTemplate", Dict{String, Any}("TemplateName"=>TemplateName); aws_config=aws_config)
DeleteCustomVerificationEmailTemplate(TemplateName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteCustomVerificationEmailTemplate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TemplateName"=>TemplateName), args)); aws_config=aws_config)
...
DeleteIdentity(Identity; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteIdentity", Dict{String, Any}("Identity"=>Identity); aws_config=aws_config)
DeleteIdentity(Identity, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteIdentity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Identity"=>Identity), args)); aws_config=aws_config)
...
DeleteIdentityPolicy(Identity, PolicyName; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteIdentityPolicy", Dict{String, Any}("Identity"=>Identity, "PolicyName"=>PolicyName); aws_config=aws_config)
DeleteIdentityPolicy(Identity, PolicyName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteIdentityPolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Identity"=>Identity, "PolicyName"=>PolicyName), args)); aws_config=aws_config)
...
DeleteReceiptFilter(FilterName; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteReceiptFilter", Dict{String, Any}("FilterName"=>FilterName); aws_config=aws_config)
DeleteReceiptFilter(FilterName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteReceiptFilter", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FilterName"=>FilterName), args)); aws_config=aws_config)
...
DeleteReceiptRule(RuleName, RuleSetName; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteReceiptRule", Dict{String, Any}("RuleName"=>RuleName, "RuleSetName"=>RuleSetName); aws_config=aws_config)
DeleteReceiptRule(RuleName, RuleSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteReceiptRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RuleName"=>RuleName, "RuleSetName"=>RuleSetName), args)); aws_config=aws_config)
...
DeleteReceiptRuleSet(RuleSetName; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteReceiptRuleSet", Dict{String, Any}("RuleSetName"=>RuleSetName); aws_config=aws_config)
DeleteReceiptRuleSet(RuleSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteReceiptRuleSet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RuleSetName"=>RuleSetName), args)); aws_config=aws_config)
...
DeleteTemplate(TemplateName; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteTemplate", Dict{String, Any}("TemplateName"=>TemplateName); aws_config=aws_config)
DeleteTemplate(TemplateName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteTemplate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TemplateName"=>TemplateName), args)); aws_config=aws_config)
...
DeleteVerifiedEmailAddress(EmailAddress; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteVerifiedEmailAddress", Dict{String, Any}("EmailAddress"=>EmailAddress); aws_config=aws_config)
DeleteVerifiedEmailAddress(EmailAddress, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DeleteVerifiedEmailAddress", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EmailAddress"=>EmailAddress), args)); aws_config=aws_config)
...
DescribeActiveReceiptRuleSet(; aws_config::AWSConfig=AWS.aws_config) = ses("DescribeActiveReceiptRuleSet"; aws_config=aws_config)
DescribeActiveReceiptRuleSet(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DescribeActiveReceiptRuleSet", args; aws_config=aws_config)
...
DescribeConfigurationSet(ConfigurationSetName; aws_config::AWSConfig=AWS.aws_config) = ses("DescribeConfigurationSet", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName); aws_config=aws_config)
DescribeConfigurationSet(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DescribeConfigurationSet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName), args)); aws_config=aws_config)
...
DescribeReceiptRule(RuleName, RuleSetName; aws_config::AWSConfig=AWS.aws_config) = ses("DescribeReceiptRule", Dict{String, Any}("RuleName"=>RuleName, "RuleSetName"=>RuleSetName); aws_config=aws_config)
DescribeReceiptRule(RuleName, RuleSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DescribeReceiptRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RuleName"=>RuleName, "RuleSetName"=>RuleSetName), args)); aws_config=aws_config)
...
DescribeReceiptRuleSet(RuleSetName; aws_config::AWSConfig=AWS.aws_config) = ses("DescribeReceiptRuleSet", Dict{String, Any}("RuleSetName"=>RuleSetName); aws_config=aws_config)
DescribeReceiptRuleSet(RuleSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("DescribeReceiptRuleSet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RuleSetName"=>RuleSetName), args)); aws_config=aws_config)
...
GetAccountSendingEnabled(; aws_config::AWSConfig=AWS.aws_config) = ses("GetAccountSendingEnabled"; aws_config=aws_config)
GetAccountSendingEnabled(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("GetAccountSendingEnabled", args; aws_config=aws_config)
...
GetCustomVerificationEmailTemplate(TemplateName; aws_config::AWSConfig=AWS.aws_config) = ses("GetCustomVerificationEmailTemplate", Dict{String, Any}("TemplateName"=>TemplateName); aws_config=aws_config)
GetCustomVerificationEmailTemplate(TemplateName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("GetCustomVerificationEmailTemplate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TemplateName"=>TemplateName), args)); aws_config=aws_config)
...
GetIdentityDkimAttributes(Identities; aws_config::AWSConfig=AWS.aws_config) = ses("GetIdentityDkimAttributes", Dict{String, Any}("Identities"=>Identities); aws_config=aws_config)
GetIdentityDkimAttributes(Identities, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("GetIdentityDkimAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Identities"=>Identities), args)); aws_config=aws_config)
...
GetIdentityMailFromDomainAttributes(Identities; aws_config::AWSConfig=AWS.aws_config) = ses("GetIdentityMailFromDomainAttributes", Dict{String, Any}("Identities"=>Identities); aws_config=aws_config)
GetIdentityMailFromDomainAttributes(Identities, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("GetIdentityMailFromDomainAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Identities"=>Identities), args)); aws_config=aws_config)
...
GetIdentityNotificationAttributes(Identities; aws_config::AWSConfig=AWS.aws_config) = ses("GetIdentityNotificationAttributes", Dict{String, Any}("Identities"=>Identities); aws_config=aws_config)
GetIdentityNotificationAttributes(Identities, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("GetIdentityNotificationAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Identities"=>Identities), args)); aws_config=aws_config)
...
GetIdentityPolicies(Identity, PolicyNames; aws_config::AWSConfig=AWS.aws_config) = ses("GetIdentityPolicies", Dict{String, Any}("Identity"=>Identity, "PolicyNames"=>PolicyNames); aws_config=aws_config)
GetIdentityPolicies(Identity, PolicyNames, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("GetIdentityPolicies", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Identity"=>Identity, "PolicyNames"=>PolicyNames), args)); aws_config=aws_config)
...
GetIdentityVerificationAttributes(Identities; aws_config::AWSConfig=AWS.aws_config) = ses("GetIdentityVerificationAttributes", Dict{String, Any}("Identities"=>Identities); aws_config=aws_config)
GetIdentityVerificationAttributes(Identities, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("GetIdentityVerificationAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Identities"=>Identities), args)); aws_config=aws_config)
...
GetSendQuota(; aws_config::AWSConfig=AWS.aws_config) = ses("GetSendQuota"; aws_config=aws_config)
GetSendQuota(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("GetSendQuota", args; aws_config=aws_config)
...
GetSendStatistics(; aws_config::AWSConfig=AWS.aws_config) = ses("GetSendStatistics"; aws_config=aws_config)
GetSendStatistics(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("GetSendStatistics", args; aws_config=aws_config)
...
GetTemplate(TemplateName; aws_config::AWSConfig=AWS.aws_config) = ses("GetTemplate", Dict{String, Any}("TemplateName"=>TemplateName); aws_config=aws_config)
GetTemplate(TemplateName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("GetTemplate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TemplateName"=>TemplateName), args)); aws_config=aws_config)
...
ListConfigurationSets(; aws_config::AWSConfig=AWS.aws_config) = ses("ListConfigurationSets"; aws_config=aws_config)
ListConfigurationSets(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("ListConfigurationSets", args; aws_config=aws_config)
...
ListCustomVerificationEmailTemplates(; aws_config::AWSConfig=AWS.aws_config) = ses("ListCustomVerificationEmailTemplates"; aws_config=aws_config)
ListCustomVerificationEmailTemplates(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("ListCustomVerificationEmailTemplates", args; aws_config=aws_config)
...
ListIdentities(; aws_config::AWSConfig=AWS.aws_config) = ses("ListIdentities"; aws_config=aws_config)
ListIdentities(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("ListIdentities", args; aws_config=aws_config)
...
ListIdentityPolicies(Identity; aws_config::AWSConfig=AWS.aws_config) = ses("ListIdentityPolicies", Dict{String, Any}("Identity"=>Identity); aws_config=aws_config)
ListIdentityPolicies(Identity, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("ListIdentityPolicies", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Identity"=>Identity), args)); aws_config=aws_config)
...
ListReceiptFilters(; aws_config::AWSConfig=AWS.aws_config) = ses("ListReceiptFilters"; aws_config=aws_config)
ListReceiptFilters(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("ListReceiptFilters", args; aws_config=aws_config)
...
ListReceiptRuleSets(; aws_config::AWSConfig=AWS.aws_config) = ses("ListReceiptRuleSets"; aws_config=aws_config)
ListReceiptRuleSets(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("ListReceiptRuleSets", args; aws_config=aws_config)
...
ListTemplates(; aws_config::AWSConfig=AWS.aws_config) = ses("ListTemplates"; aws_config=aws_config)
ListTemplates(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("ListTemplates", args; aws_config=aws_config)
...
ListVerifiedEmailAddresses(; aws_config::AWSConfig=AWS.aws_config) = ses("ListVerifiedEmailAddresses"; aws_config=aws_config)
ListVerifiedEmailAddresses(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("ListVerifiedEmailAddresses", args; aws_config=aws_config)
...
PutConfigurationSetDeliveryOptions(ConfigurationSetName; aws_config::AWSConfig=AWS.aws_config) = ses("PutConfigurationSetDeliveryOptions", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName); aws_config=aws_config)
PutConfigurationSetDeliveryOptions(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("PutConfigurationSetDeliveryOptions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName), args)); aws_config=aws_config)
...
PutIdentityPolicy(Identity, Policy, PolicyName; aws_config::AWSConfig=AWS.aws_config) = ses("PutIdentityPolicy", Dict{String, Any}("Identity"=>Identity, "Policy"=>Policy, "PolicyName"=>PolicyName); aws_config=aws_config)
PutIdentityPolicy(Identity, Policy, PolicyName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("PutIdentityPolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Identity"=>Identity, "Policy"=>Policy, "PolicyName"=>PolicyName), args)); aws_config=aws_config)
...
ReorderReceiptRuleSet(RuleNames, RuleSetName; aws_config::AWSConfig=AWS.aws_config) = ses("ReorderReceiptRuleSet", Dict{String, Any}("RuleNames"=>RuleNames, "RuleSetName"=>RuleSetName); aws_config=aws_config)
ReorderReceiptRuleSet(RuleNames, RuleSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("ReorderReceiptRuleSet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RuleNames"=>RuleNames, "RuleSetName"=>RuleSetName), args)); aws_config=aws_config)
...
SendBounce(BounceSender, BouncedRecipientInfoList, OriginalMessageId; aws_config::AWSConfig=AWS.aws_config) = ses("SendBounce", Dict{String, Any}("BounceSender"=>BounceSender, "BouncedRecipientInfoList"=>BouncedRecipientInfoList, "OriginalMessageId"=>OriginalMessageId); aws_config=aws_config)
SendBounce(BounceSender, BouncedRecipientInfoList, OriginalMessageId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SendBounce", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BounceSender"=>BounceSender, "BouncedRecipientInfoList"=>BouncedRecipientInfoList, "OriginalMessageId"=>OriginalMessageId), args)); aws_config=aws_config)
...
SendBulkTemplatedEmail(Destinations, Source, Template; aws_config::AWSConfig=AWS.aws_config) = ses("SendBulkTemplatedEmail", Dict{String, Any}("Destinations"=>Destinations, "Source"=>Source, "Template"=>Template); aws_config=aws_config)
SendBulkTemplatedEmail(Destinations, Source, Template, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SendBulkTemplatedEmail", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Destinations"=>Destinations, "Source"=>Source, "Template"=>Template), args)); aws_config=aws_config)
...
SendCustomVerificationEmail(EmailAddress, TemplateName; aws_config::AWSConfig=AWS.aws_config) = ses("SendCustomVerificationEmail", Dict{String, Any}("EmailAddress"=>EmailAddress, "TemplateName"=>TemplateName); aws_config=aws_config)
SendCustomVerificationEmail(EmailAddress, TemplateName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SendCustomVerificationEmail", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EmailAddress"=>EmailAddress, "TemplateName"=>TemplateName), args)); aws_config=aws_config)
...
SendEmail(Destination, Message, Source; aws_config::AWSConfig=AWS.aws_config) = ses("SendEmail", Dict{String, Any}("Destination"=>Destination, "Message"=>Message, "Source"=>Source); aws_config=aws_config)
SendEmail(Destination, Message, Source, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SendEmail", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Destination"=>Destination, "Message"=>Message, "Source"=>Source), args)); aws_config=aws_config)
...
SendRawEmail(RawMessage; aws_config::AWSConfig=AWS.aws_config) = ses("SendRawEmail", Dict{String, Any}("RawMessage"=>RawMessage); aws_config=aws_config)
SendRawEmail(RawMessage, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SendRawEmail", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RawMessage"=>RawMessage), args)); aws_config=aws_config)
...
SendTemplatedEmail(Destination, Source, Template, TemplateData; aws_config::AWSConfig=AWS.aws_config) = ses("SendTemplatedEmail", Dict{String, Any}("Destination"=>Destination, "Source"=>Source, "Template"=>Template, "TemplateData"=>TemplateData); aws_config=aws_config)
SendTemplatedEmail(Destination, Source, Template, TemplateData, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SendTemplatedEmail", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Destination"=>Destination, "Source"=>Source, "Template"=>Template, "TemplateData"=>TemplateData), args)); aws_config=aws_config)
...
SetActiveReceiptRuleSet(; aws_config::AWSConfig=AWS.aws_config) = ses("SetActiveReceiptRuleSet"; aws_config=aws_config)
SetActiveReceiptRuleSet(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SetActiveReceiptRuleSet", args; aws_config=aws_config)
...
SetIdentityDkimEnabled(DkimEnabled, Identity; aws_config::AWSConfig=AWS.aws_config) = ses("SetIdentityDkimEnabled", Dict{String, Any}("DkimEnabled"=>DkimEnabled, "Identity"=>Identity); aws_config=aws_config)
SetIdentityDkimEnabled(DkimEnabled, Identity, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SetIdentityDkimEnabled", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DkimEnabled"=>DkimEnabled, "Identity"=>Identity), args)); aws_config=aws_config)
...
SetIdentityFeedbackForwardingEnabled(ForwardingEnabled, Identity; aws_config::AWSConfig=AWS.aws_config) = ses("SetIdentityFeedbackForwardingEnabled", Dict{String, Any}("ForwardingEnabled"=>ForwardingEnabled, "Identity"=>Identity); aws_config=aws_config)
SetIdentityFeedbackForwardingEnabled(ForwardingEnabled, Identity, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SetIdentityFeedbackForwardingEnabled", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ForwardingEnabled"=>ForwardingEnabled, "Identity"=>Identity), args)); aws_config=aws_config)
...
SetIdentityHeadersInNotificationsEnabled(Enabled, Identity, NotificationType; aws_config::AWSConfig=AWS.aws_config) = ses("SetIdentityHeadersInNotificationsEnabled", Dict{String, Any}("Enabled"=>Enabled, "Identity"=>Identity, "NotificationType"=>NotificationType); aws_config=aws_config)
SetIdentityHeadersInNotificationsEnabled(Enabled, Identity, NotificationType, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SetIdentityHeadersInNotificationsEnabled", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Enabled"=>Enabled, "Identity"=>Identity, "NotificationType"=>NotificationType), args)); aws_config=aws_config)
...
SetIdentityMailFromDomain(Identity; aws_config::AWSConfig=AWS.aws_config) = ses("SetIdentityMailFromDomain", Dict{String, Any}("Identity"=>Identity); aws_config=aws_config)
SetIdentityMailFromDomain(Identity, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SetIdentityMailFromDomain", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Identity"=>Identity), args)); aws_config=aws_config)
...
SetIdentityNotificationTopic(Identity, NotificationType; aws_config::AWSConfig=AWS.aws_config) = ses("SetIdentityNotificationTopic", Dict{String, Any}("Identity"=>Identity, "NotificationType"=>NotificationType); aws_config=aws_config)
SetIdentityNotificationTopic(Identity, NotificationType, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SetIdentityNotificationTopic", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Identity"=>Identity, "NotificationType"=>NotificationType), args)); aws_config=aws_config)
...
SetReceiptRulePosition(RuleName, RuleSetName; aws_config::AWSConfig=AWS.aws_config) = ses("SetReceiptRulePosition", Dict{String, Any}("RuleName"=>RuleName, "RuleSetName"=>RuleSetName); aws_config=aws_config)
SetReceiptRulePosition(RuleName, RuleSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("SetReceiptRulePosition", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RuleName"=>RuleName, "RuleSetName"=>RuleSetName), args)); aws_config=aws_config)
...
TestRenderTemplate(TemplateData, TemplateName; aws_config::AWSConfig=AWS.aws_config) = ses("TestRenderTemplate", Dict{String, Any}("TemplateData"=>TemplateData, "TemplateName"=>TemplateName); aws_config=aws_config)
TestRenderTemplate(TemplateData, TemplateName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("TestRenderTemplate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TemplateData"=>TemplateData, "TemplateName"=>TemplateName), args)); aws_config=aws_config)
...
UpdateAccountSendingEnabled(; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateAccountSendingEnabled"; aws_config=aws_config)
UpdateAccountSendingEnabled(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateAccountSendingEnabled", args; aws_config=aws_config)
...
UpdateConfigurationSetEventDestination(ConfigurationSetName, EventDestination; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateConfigurationSetEventDestination", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "EventDestination"=>EventDestination); aws_config=aws_config)
UpdateConfigurationSetEventDestination(ConfigurationSetName, EventDestination, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateConfigurationSetEventDestination", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "EventDestination"=>EventDestination), args)); aws_config=aws_config)
...
UpdateConfigurationSetReputationMetricsEnabled(ConfigurationSetName, Enabled; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateConfigurationSetReputationMetricsEnabled", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "Enabled"=>Enabled); aws_config=aws_config)
UpdateConfigurationSetReputationMetricsEnabled(ConfigurationSetName, Enabled, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateConfigurationSetReputationMetricsEnabled", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "Enabled"=>Enabled), args)); aws_config=aws_config)
...
UpdateConfigurationSetSendingEnabled(ConfigurationSetName, Enabled; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateConfigurationSetSendingEnabled", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "Enabled"=>Enabled); aws_config=aws_config)
UpdateConfigurationSetSendingEnabled(ConfigurationSetName, Enabled, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateConfigurationSetSendingEnabled", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "Enabled"=>Enabled), args)); aws_config=aws_config)
...
UpdateConfigurationSetTrackingOptions(ConfigurationSetName, TrackingOptions; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateConfigurationSetTrackingOptions", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "TrackingOptions"=>TrackingOptions); aws_config=aws_config)
UpdateConfigurationSetTrackingOptions(ConfigurationSetName, TrackingOptions, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateConfigurationSetTrackingOptions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, "TrackingOptions"=>TrackingOptions), args)); aws_config=aws_config)
...
UpdateCustomVerificationEmailTemplate(TemplateName; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateCustomVerificationEmailTemplate", Dict{String, Any}("TemplateName"=>TemplateName); aws_config=aws_config)
UpdateCustomVerificationEmailTemplate(TemplateName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateCustomVerificationEmailTemplate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TemplateName"=>TemplateName), args)); aws_config=aws_config)
...
UpdateReceiptRule(Rule, RuleSetName; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateReceiptRule", Dict{String, Any}("Rule"=>Rule, "RuleSetName"=>RuleSetName); aws_config=aws_config)
UpdateReceiptRule(Rule, RuleSetName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateReceiptRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Rule"=>Rule, "RuleSetName"=>RuleSetName), args)); aws_config=aws_config)
...
UpdateTemplate(Template; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateTemplate", Dict{String, Any}("Template"=>Template); aws_config=aws_config)
UpdateTemplate(Template, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("UpdateTemplate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Template"=>Template), args)); aws_config=aws_config)
...
VerifyDomainDkim(Domain; aws_config::AWSConfig=AWS.aws_config) = ses("VerifyDomainDkim", Dict{String, Any}("Domain"=>Domain); aws_config=aws_config)
VerifyDomainDkim(Domain, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("VerifyDomainDkim", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Domain"=>Domain), args)); aws_config=aws_config)
...
VerifyDomainIdentity(Domain; aws_config::AWSConfig=AWS.aws_config) = ses("VerifyDomainIdentity", Dict{String, Any}("Domain"=>Domain); aws_config=aws_config)
VerifyDomainIdentity(Domain, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("VerifyDomainIdentity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Domain"=>Domain), args)); aws_config=aws_config)
...
VerifyEmailAddress(EmailAddress; aws_config::AWSConfig=AWS.aws_config) = ses("VerifyEmailAddress", Dict{String, Any}("EmailAddress"=>EmailAddress); aws_config=aws_config)
VerifyEmailAddress(EmailAddress, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("VerifyEmailAddress", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EmailAddress"=>EmailAddress), args)); aws_config=aws_config)
...
VerifyEmailIdentity(EmailAddress; aws_config::AWSConfig=AWS.aws_config) = ses("VerifyEmailIdentity", Dict{String, Any}("EmailAddress"=>EmailAddress); aws_config=aws_config)
VerifyEmailIdentity(EmailAddress, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ses("VerifyEmailIdentity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EmailAddress"=>EmailAddress), args)); aws_config=aws_config)
