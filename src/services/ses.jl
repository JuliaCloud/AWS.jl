...
function create_configuration_set_tracking_options(
    ConfigurationSetName, TrackingOptions; aws_config::AbstractAWSConfig=current_aws_config()
)
    return ses(
...
"""
function list_identity_policies(Identity; aws_config::AbstractAWSConfig=current_aws_config())
    return ses(
...
"""
function update_account_sending_enabled(; aws_config::AbstractAWSConfig=current_aws_config())
    return ses(
