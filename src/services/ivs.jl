...
"""
function get_recording_configuration(arn; aws_config::AbstractAWSConfig=current_aws_config())
    return ivs(
        "POST",
...
- `"nextToken"`: The first stream to retrieve. This is used for pagination; see the
  nextToken response field.
"""
function list_stream_sessions(channelArn; aws_config::AbstractAWSConfig=current_aws_config())
    return ivs(
        "POST",
        "/ListStreamSessions",
        Dict{String,Any}("channelArn" => channelArn);
