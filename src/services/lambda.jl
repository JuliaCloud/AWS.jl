...
"""
AddLayerVersionPermission(Action, LayerName, Principal, StatementId, VersionNumber) = lambda("POST", "/2018-10-31/layers/$(LayerName)/versions/$(VersionNumber)/policy", Dict{String, Any}("Action"=>Action, "Principal"=>Principal, "StatementId"=>StatementId))
AddLayerVersionPermission(Action, LayerName, Principal, StatementId, VersionNumber, args::AbstractDict{String, <:Any}) = lambda("POST", "/2018-10-31/layers/$(LayerName)/versions/$(VersionNumber)/policy", Dict{String, Any}("Action"=>Action, "Principal"=>Principal, "StatementId"=>StatementId, args...))
...
"""
AddPermission(Action, FunctionName, Principal, StatementId) = lambda("POST", "/2015-03-31/functions/$(FunctionName)/policy", Dict{String, Any}("Action"=>Action, "Principal"=>Principal, "StatementId"=>StatementId))
AddPermission(Action, FunctionName, Principal, StatementId, args::AbstractDict{String, <:Any}) = lambda("POST", "/2015-03-31/functions/$(FunctionName)/policy", Dict{String, Any}("Action"=>Action, "Principal"=>Principal, "StatementId"=>StatementId, args...))
...
"""
CreateAlias(FunctionName, FunctionVersion, Name) = lambda("POST", "/2015-03-31/functions/$(FunctionName)/aliases", Dict{String, Any}("FunctionVersion"=>FunctionVersion, "Name"=>Name))
CreateAlias(FunctionName, FunctionVersion, Name, args::AbstractDict{String, <:Any}) = lambda("POST", "/2015-03-31/functions/$(FunctionName)/aliases", Dict{String, Any}("FunctionVersion"=>FunctionVersion, "Name"=>Name, args...))
...
"""
CreateEventSourceMapping(EventSourceArn, FunctionName) = lambda("POST", "/2015-03-31/event-source-mappings/", Dict{String, Any}("EventSourceArn"=>EventSourceArn, "FunctionName"=>FunctionName))
CreateEventSourceMapping(EventSourceArn, FunctionName, args::AbstractDict{String, <:Any}) = lambda("POST", "/2015-03-31/event-source-mappings/", Dict{String, Any}("EventSourceArn"=>EventSourceArn, "FunctionName"=>FunctionName, args...))
...
"""
CreateFunction(Code, FunctionName, Handler, Role, Runtime) = lambda("POST", "/2015-03-31/functions", Dict{String, Any}("Code"=>Code, "FunctionName"=>FunctionName, "Handler"=>Handler, "Role"=>Role, "Runtime"=>Runtime))
CreateFunction(Code, FunctionName, Handler, Role, Runtime, args::AbstractDict{String, <:Any}) = lambda("POST", "/2015-03-31/functions", Dict{String, Any}("Code"=>Code, "FunctionName"=>FunctionName, "Handler"=>Handler, "Role"=>Role, "Runtime"=>Runtime, args...))
...
DeleteAlias(FunctionName, Name, args::AbstractDict{String, <:Any}) = lambda("DELETE", "/2015-03-31/functions/$(FunctionName)/aliases/$(Name)", args)
...
DeleteEventSourceMapping(UUID, args::AbstractDict{String, <:Any}) = lambda("DELETE", "/2015-03-31/event-source-mappings/$(UUID)", args)
...
DeleteFunction(FunctionName, args::AbstractDict{String, <:Any}) = lambda("DELETE", "/2015-03-31/functions/$(FunctionName)", args)
...
DeleteFunctionConcurrency(FunctionName, args::AbstractDict{String, <:Any}) = lambda("DELETE", "/2017-10-31/functions/$(FunctionName)/concurrency", args)
...
DeleteFunctionEventInvokeConfig(FunctionName, args::AbstractDict{String, <:Any}) = lambda("DELETE", "/2019-09-25/functions/$(FunctionName)/event-invoke-config", args)
...
DeleteLayerVersion(LayerName, VersionNumber, args::AbstractDict{String, <:Any}) = lambda("DELETE", "/2018-10-31/layers/$(LayerName)/versions/$(VersionNumber)", args)
...
"""
DeleteProvisionedConcurrencyConfig(FunctionName, Qualifier) = lambda("DELETE", "/2019-09-30/functions/$(FunctionName)/provisioned-concurrency", Dict{String, Any}("Qualifier"=>Qualifier))
DeleteProvisionedConcurrencyConfig(FunctionName, Qualifier, args::AbstractDict{String, <:Any}) = lambda("DELETE", "/2019-09-30/functions/$(FunctionName)/provisioned-concurrency", Dict{String, Any}("Qualifier"=>Qualifier, args...))
...
GetAccountSettings(args::AbstractDict{String, Any}) = lambda("GET", "/2016-08-19/account-settings/", args)
...
GetAlias(FunctionName, Name, args::AbstractDict{String, <:Any}) = lambda("GET", "/2015-03-31/functions/$(FunctionName)/aliases/$(Name)", args)
...
GetEventSourceMapping(UUID, args::AbstractDict{String, <:Any}) = lambda("GET", "/2015-03-31/event-source-mappings/$(UUID)", args)
...
GetFunction(FunctionName, args::AbstractDict{String, <:Any}) = lambda("GET", "/2015-03-31/functions/$(FunctionName)", args)
...
GetFunctionConcurrency(FunctionName, args::AbstractDict{String, <:Any}) = lambda("GET", "/2019-09-30/functions/$(FunctionName)/concurrency", args)
...
GetFunctionConfiguration(FunctionName, args::AbstractDict{String, <:Any}) = lambda("GET", "/2015-03-31/functions/$(FunctionName)/configuration", args)
...
GetFunctionEventInvokeConfig(FunctionName, args::AbstractDict{String, <:Any}) = lambda("GET", "/2019-09-25/functions/$(FunctionName)/event-invoke-config", args)
...
GetLayerVersion(LayerName, VersionNumber, args::AbstractDict{String, <:Any}) = lambda("GET", "/2018-10-31/layers/$(LayerName)/versions/$(VersionNumber)", args)
...
"""
GetLayerVersionByArn(Arn) = lambda("GET", "/2018-10-31/layers?find=LayerVersion", Dict{String, Any}("Arn"=>Arn))
GetLayerVersionByArn(Arn, args::AbstractDict{String, <:Any}) = lambda("GET", "/2018-10-31/layers?find=LayerVersion", Dict{String, Any}("Arn"=>Arn, args...))
...
GetLayerVersionPolicy(LayerName, VersionNumber, args::AbstractDict{String, <:Any}) = lambda("GET", "/2018-10-31/layers/$(LayerName)/versions/$(VersionNumber)/policy", args)
...
GetPolicy(FunctionName, args::AbstractDict{String, <:Any}) = lambda("GET", "/2015-03-31/functions/$(FunctionName)/policy", args)
...
"""
GetProvisionedConcurrencyConfig(FunctionName, Qualifier) = lambda("GET", "/2019-09-30/functions/$(FunctionName)/provisioned-concurrency", Dict{String, Any}("Qualifier"=>Qualifier))
GetProvisionedConcurrencyConfig(FunctionName, Qualifier, args::AbstractDict{String, <:Any}) = lambda("GET", "/2019-09-30/functions/$(FunctionName)/provisioned-concurrency", Dict{String, Any}("Qualifier"=>Qualifier, args...))
...
Invoke(FunctionName, args::AbstractDict{String, <:Any}) = lambda("POST", "/2015-03-31/functions/$(FunctionName)/invocations", args)
...
"""
InvokeAsync(FunctionName, InvokeArgs) = lambda("POST", "/2014-11-13/functions/$(FunctionName)/invoke-async/", Dict{String, Any}("InvokeArgs"=>InvokeArgs))
InvokeAsync(FunctionName, InvokeArgs, args::AbstractDict{String, <:Any}) = lambda("POST", "/2014-11-13/functions/$(FunctionName)/invoke-async/", Dict{String, Any}("InvokeArgs"=>InvokeArgs, args...))
...
ListAliases(FunctionName, args::AbstractDict{String, <:Any}) = lambda("GET", "/2015-03-31/functions/$(FunctionName)/aliases", args)
...
ListEventSourceMappings(args::AbstractDict{String, Any}) = lambda("GET", "/2015-03-31/event-source-mappings/", args)
...
ListFunctionEventInvokeConfigs(FunctionName, args::AbstractDict{String, <:Any}) = lambda("GET", "/2019-09-25/functions/$(FunctionName)/event-invoke-config/list", args)
...
ListFunctions(args::AbstractDict{String, Any}) = lambda("GET", "/2015-03-31/functions/", args)
...
ListLayerVersions(LayerName, args::AbstractDict{String, <:Any}) = lambda("GET", "/2018-10-31/layers/$(LayerName)/versions", args)
...
ListLayers(args::AbstractDict{String, Any}) = lambda("GET", "/2018-10-31/layers", args)
...
ListProvisionedConcurrencyConfigs(FunctionName, args::AbstractDict{String, <:Any}) = lambda("GET", "/2019-09-30/functions/$(FunctionName)/provisioned-concurrency?List=ALL", args)
...
"""
ListTags(ARN) = lambda("GET", "/2017-03-31/tags/$(ARN)")
ListTags(ARN, args::AbstractDict{String, <:Any}) = lambda("GET", "/2017-03-31/tags/$(ARN)", args)
...
ListVersionsByFunction(FunctionName, args::AbstractDict{String, <:Any}) = lambda("GET", "/2015-03-31/functions/$(FunctionName)/versions", args)
...
"""
PublishLayerVersion(Content, LayerName) = lambda("POST", "/2018-10-31/layers/$(LayerName)/versions", Dict{String, Any}("Content"=>Content))
PublishLayerVersion(Content, LayerName, args::AbstractDict{String, <:Any}) = lambda("POST", "/2018-10-31/layers/$(LayerName)/versions", Dict{String, Any}("Content"=>Content, args...))
...
PublishVersion(FunctionName, args::AbstractDict{String, <:Any}) = lambda("POST", "/2015-03-31/functions/$(FunctionName)/versions", args)
...
"""
PutFunctionConcurrency(FunctionName, ReservedConcurrentExecutions) = lambda("PUT", "/2017-10-31/functions/$(FunctionName)/concurrency", Dict{String, Any}("ReservedConcurrentExecutions"=>ReservedConcurrentExecutions))
PutFunctionConcurrency(FunctionName, ReservedConcurrentExecutions, args::AbstractDict{String, <:Any}) = lambda("PUT", "/2017-10-31/functions/$(FunctionName)/concurrency", Dict{String, Any}("ReservedConcurrentExecutions"=>ReservedConcurrentExecutions, args...))
...
PutFunctionEventInvokeConfig(FunctionName, args::AbstractDict{String, <:Any}) = lambda("PUT", "/2019-09-25/functions/$(FunctionName)/event-invoke-config", args)
...
"""
PutProvisionedConcurrencyConfig(FunctionName, ProvisionedConcurrentExecutions, Qualifier) = lambda("PUT", "/2019-09-30/functions/$(FunctionName)/provisioned-concurrency", Dict{String, Any}("ProvisionedConcurrentExecutions"=>ProvisionedConcurrentExecutions, "Qualifier"=>Qualifier))
PutProvisionedConcurrencyConfig(FunctionName, ProvisionedConcurrentExecutions, Qualifier, args::AbstractDict{String, <:Any}) = lambda("PUT", "/2019-09-30/functions/$(FunctionName)/provisioned-concurrency", Dict{String, Any}("ProvisionedConcurrentExecutions"=>ProvisionedConcurrentExecutions, "Qualifier"=>Qualifier, args...))
...
RemoveLayerVersionPermission(LayerName, StatementId, VersionNumber, args::AbstractDict{String, <:Any}) = lambda("DELETE", "/2018-10-31/layers/$(LayerName)/versions/$(VersionNumber)/policy/$(StatementId)", args)
...
RemovePermission(FunctionName, StatementId, args::AbstractDict{String, <:Any}) = lambda("DELETE", "/2015-03-31/functions/$(FunctionName)/policy/$(StatementId)", args)
...
"""
TagResource(ARN, Tags) = lambda("POST", "/2017-03-31/tags/$(ARN)", Dict{String, Any}("Tags"=>Tags))
TagResource(ARN, Tags, args::AbstractDict{String, <:Any}) = lambda("POST", "/2017-03-31/tags/$(ARN)", Dict{String, Any}("Tags"=>Tags, args...))
...
"""
UntagResource(ARN, tagKeys) = lambda("DELETE", "/2017-03-31/tags/$(ARN)", Dict{String, Any}("tagKeys"=>tagKeys))
UntagResource(ARN, tagKeys, args::AbstractDict{String, <:Any}) = lambda("DELETE", "/2017-03-31/tags/$(ARN)", Dict{String, Any}("tagKeys"=>tagKeys, args...))
...
UpdateAlias(FunctionName, Name, args::AbstractDict{String, <:Any}) = lambda("PUT", "/2015-03-31/functions/$(FunctionName)/aliases/$(Name)", args)
...
UpdateEventSourceMapping(UUID, args::AbstractDict{String, <:Any}) = lambda("PUT", "/2015-03-31/event-source-mappings/$(UUID)", args)
...
UpdateFunctionCode(FunctionName, args::AbstractDict{String, <:Any}) = lambda("PUT", "/2015-03-31/functions/$(FunctionName)/code", args)
...
UpdateFunctionConfiguration(FunctionName, args::AbstractDict{String, <:Any}) = lambda("PUT", "/2015-03-31/functions/$(FunctionName)/configuration", args)
...
UpdateFunctionEventInvokeConfig(FunctionName, args::AbstractDict{String, <:Any}) = lambda("POST", "/2019-09-25/functions/$(FunctionName)/event-invoke-config", args)
