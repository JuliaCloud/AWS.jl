...
"""
AddTags(ResourceId) = cloudtrail("AddTags", Dict{String, Any}("ResourceId"=>ResourceId))
AddTags(ResourceId, args::AbstractDict{String, <:Any}) = cloudtrail("AddTags", Dict{String, Any}("ResourceId"=>ResourceId, args...))
...
- `TagsList`: 
"""
CreateTrail(Name, S3BucketName) = cloudtrail("CreateTrail", Dict{String, Any}("Name"=>Name, "S3BucketName"=>S3BucketName))
CreateTrail(Name, S3BucketName, args::AbstractDict{String, <:Any}) = cloudtrail("CreateTrail", Dict{String, Any}("Name"=>Name, "S3BucketName"=>S3BucketName, args...))
...
"""
DeleteTrail(Name) = cloudtrail("DeleteTrail", Dict{String, Any}("Name"=>Name))
DeleteTrail(Name, args::AbstractDict{String, <:Any}) = cloudtrail("DeleteTrail", Dict{String, Any}("Name"=>Name, args...))
...
DescribeTrails(args::AbstractDict{String, <:Any}) = cloudtrail("DescribeTrails", args)
...
"""
GetEventSelectors(TrailName) = cloudtrail("GetEventSelectors", Dict{String, Any}("TrailName"=>TrailName))
GetEventSelectors(TrailName, args::AbstractDict{String, <:Any}) = cloudtrail("GetEventSelectors", Dict{String, Any}("TrailName"=>TrailName, args...))
...
"""
GetInsightSelectors(TrailName) = cloudtrail("GetInsightSelectors", Dict{String, Any}("TrailName"=>TrailName))
GetInsightSelectors(TrailName, args::AbstractDict{String, <:Any}) = cloudtrail("GetInsightSelectors", Dict{String, Any}("TrailName"=>TrailName, args...))
...
"""
GetTrail(Name) = cloudtrail("GetTrail", Dict{String, Any}("Name"=>Name))
GetTrail(Name, args::AbstractDict{String, <:Any}) = cloudtrail("GetTrail", Dict{String, Any}("Name"=>Name, args...))
...
"""
GetTrailStatus(Name) = cloudtrail("GetTrailStatus", Dict{String, Any}("Name"=>Name))
GetTrailStatus(Name, args::AbstractDict{String, <:Any}) = cloudtrail("GetTrailStatus", Dict{String, Any}("Name"=>Name, args...))
...
ListPublicKeys(args::AbstractDict{String, <:Any}) = cloudtrail("ListPublicKeys", args)
...
- `NextToken`: Reserved for future use.
"""
ListTags(ResourceIdList) = cloudtrail("ListTags", Dict{String, Any}("ResourceIdList"=>ResourceIdList))
ListTags(ResourceIdList, args::AbstractDict{String, <:Any}) = cloudtrail("ListTags", Dict{String, Any}("ResourceIdList"=>ResourceIdList, args...))
...
ListTrails(args::AbstractDict{String, <:Any}) = cloudtrail("ListTrails", args)
...
LookupEvents(args::AbstractDict{String, <:Any}) = cloudtrail("LookupEvents", args)
...
"""
PutEventSelectors(EventSelectors, TrailName) = cloudtrail("PutEventSelectors", Dict{String, Any}("EventSelectors"=>EventSelectors, "TrailName"=>TrailName))
PutEventSelectors(EventSelectors, TrailName, args::AbstractDict{String, <:Any}) = cloudtrail("PutEventSelectors", Dict{String, Any}("EventSelectors"=>EventSelectors, "TrailName"=>TrailName, args...))
...
"""
PutInsightSelectors(InsightSelectors, TrailName) = cloudtrail("PutInsightSelectors", Dict{String, Any}("InsightSelectors"=>InsightSelectors, "TrailName"=>TrailName))
PutInsightSelectors(InsightSelectors, TrailName, args::AbstractDict{String, <:Any}) = cloudtrail("PutInsightSelectors", Dict{String, Any}("InsightSelectors"=>InsightSelectors, "TrailName"=>TrailName, args...))
...
"""
RemoveTags(ResourceId) = cloudtrail("RemoveTags", Dict{String, Any}("ResourceId"=>ResourceId))
RemoveTags(ResourceId, args::AbstractDict{String, <:Any}) = cloudtrail("RemoveTags", Dict{String, Any}("ResourceId"=>ResourceId, args...))
...
"""
StartLogging(Name) = cloudtrail("StartLogging", Dict{String, Any}("Name"=>Name))
StartLogging(Name, args::AbstractDict{String, <:Any}) = cloudtrail("StartLogging", Dict{String, Any}("Name"=>Name, args...))
...
"""
StopLogging(Name) = cloudtrail("StopLogging", Dict{String, Any}("Name"=>Name))
StopLogging(Name, args::AbstractDict{String, <:Any}) = cloudtrail("StopLogging", Dict{String, Any}("Name"=>Name, args...))
...
- `SnsTopicName`: Specifies the name of the Amazon SNS topic defined for notification of log file delivery. The maximum length is 256 characters.
"""
UpdateTrail(Name) = cloudtrail("UpdateTrail", Dict{String, Any}("Name"=>Name))
UpdateTrail(Name, args::AbstractDict{String, <:Any}) = cloudtrail("UpdateTrail", Dict{String, Any}("Name"=>Name, args...))
