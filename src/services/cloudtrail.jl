...
- `"TagsList"`:
"""
function create_trail(Name, S3BucketName; aws_config::AbstractAWSConfig=current_aws_config())
    return cloudtrail(
        "CreateTrail",
...
function delete_channel(
    Channel, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return cloudtrail(
        "DeleteChannel",
