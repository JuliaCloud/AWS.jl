...
"""
AddTags(ResourceId; aws::AWSConfig=AWSConfig()) = cloudtrail("AddTags", Dict{String, Any}("ResourceId"=>ResourceId); aws=aws)
AddTags(ResourceId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("AddTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceId"=>ResourceId), args)); aws=aws)
...
- `TagsList`: 
"""
CreateTrail(Name, S3BucketName; aws::AWSConfig=AWSConfig()) = cloudtrail("CreateTrail", Dict{String, Any}("Name"=>Name, "S3BucketName"=>S3BucketName); aws=aws)
CreateTrail(Name, S3BucketName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("CreateTrail", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name, "S3BucketName"=>S3BucketName), args)); aws=aws)
...
"""
DeleteTrail(Name; aws::AWSConfig=AWSConfig()) = cloudtrail("DeleteTrail", Dict{String, Any}("Name"=>Name); aws=aws)
DeleteTrail(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("DeleteTrail", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
DescribeTrails(; aws::AWSConfig=AWSConfig()) = cloudtrail("DescribeTrails"; aws=aws)
DescribeTrails(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("DescribeTrails", args; aws=aws)
...
"""
GetEventSelectors(TrailName; aws::AWSConfig=AWSConfig()) = cloudtrail("GetEventSelectors", Dict{String, Any}("TrailName"=>TrailName); aws=aws)
GetEventSelectors(TrailName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("GetEventSelectors", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TrailName"=>TrailName), args)); aws=aws)
...
"""
GetInsightSelectors(TrailName; aws::AWSConfig=AWSConfig()) = cloudtrail("GetInsightSelectors", Dict{String, Any}("TrailName"=>TrailName); aws=aws)
GetInsightSelectors(TrailName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("GetInsightSelectors", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TrailName"=>TrailName), args)); aws=aws)
...
"""
GetTrail(Name; aws::AWSConfig=AWSConfig()) = cloudtrail("GetTrail", Dict{String, Any}("Name"=>Name); aws=aws)
GetTrail(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("GetTrail", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
GetTrailStatus(Name; aws::AWSConfig=AWSConfig()) = cloudtrail("GetTrailStatus", Dict{String, Any}("Name"=>Name); aws=aws)
GetTrailStatus(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("GetTrailStatus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
ListPublicKeys(; aws::AWSConfig=AWSConfig()) = cloudtrail("ListPublicKeys"; aws=aws)
ListPublicKeys(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("ListPublicKeys", args; aws=aws)
...
- `NextToken`: Reserved for future use.
"""
ListTags(ResourceIdList; aws::AWSConfig=AWSConfig()) = cloudtrail("ListTags", Dict{String, Any}("ResourceIdList"=>ResourceIdList); aws=aws)
ListTags(ResourceIdList, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("ListTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceIdList"=>ResourceIdList), args)); aws=aws)
...
"""
ListTrails(; aws::AWSConfig=AWSConfig()) = cloudtrail("ListTrails"; aws=aws)
ListTrails(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("ListTrails", args; aws=aws)
...
"""
LookupEvents(; aws::AWSConfig=AWSConfig()) = cloudtrail("LookupEvents"; aws=aws)
LookupEvents(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("LookupEvents", args; aws=aws)
...
"""
PutEventSelectors(EventSelectors, TrailName; aws::AWSConfig=AWSConfig()) = cloudtrail("PutEventSelectors", Dict{String, Any}("EventSelectors"=>EventSelectors, "TrailName"=>TrailName); aws=aws)
PutEventSelectors(EventSelectors, TrailName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("PutEventSelectors", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EventSelectors"=>EventSelectors, "TrailName"=>TrailName), args)); aws=aws)
...
"""
PutInsightSelectors(InsightSelectors, TrailName; aws::AWSConfig=AWSConfig()) = cloudtrail("PutInsightSelectors", Dict{String, Any}("InsightSelectors"=>InsightSelectors, "TrailName"=>TrailName); aws=aws)
PutInsightSelectors(InsightSelectors, TrailName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("PutInsightSelectors", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InsightSelectors"=>InsightSelectors, "TrailName"=>TrailName), args)); aws=aws)
...
"""
RemoveTags(ResourceId; aws::AWSConfig=AWSConfig()) = cloudtrail("RemoveTags", Dict{String, Any}("ResourceId"=>ResourceId); aws=aws)
RemoveTags(ResourceId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("RemoveTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceId"=>ResourceId), args)); aws=aws)
...
"""
StartLogging(Name; aws::AWSConfig=AWSConfig()) = cloudtrail("StartLogging", Dict{String, Any}("Name"=>Name); aws=aws)
StartLogging(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("StartLogging", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
StopLogging(Name; aws::AWSConfig=AWSConfig()) = cloudtrail("StopLogging", Dict{String, Any}("Name"=>Name); aws=aws)
StopLogging(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("StopLogging", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
- `SnsTopicName`: Specifies the name of the Amazon SNS topic defined for notification of log file delivery. The maximum length is 256 characters.
"""
UpdateTrail(Name; aws::AWSConfig=AWSConfig()) = cloudtrail("UpdateTrail", Dict{String, Any}("Name"=>Name); aws=aws)
UpdateTrail(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = cloudtrail("UpdateTrail", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
