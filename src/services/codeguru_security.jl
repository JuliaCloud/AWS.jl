...
- `"clientToken"`: The idempotency token for the request. Amazon CodeGuru Security uses this
  value to prevent the accidental creation of duplicate scans if there are failures and
  retries.
...
function get_account_configuration(; aws_config::AbstractAWSConfig=current_aws_config())
    return codeguru_security(
        "GET", "/accountConfiguration/get"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_findings(scanName; aws_config::AbstractAWSConfig=current_aws_config())
    return codeguru_security(
        "GET", "/findings/$(scanName)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_findings(
    ...
    return codeguru_security(
        "GET", "/findings/$(scanName)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_scan(scanName; aws_config::AbstractAWSConfig=current_aws_config())
    return codeguru_security(
        "GET", "/scans/$(scanName)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_scan(
    ...
    return codeguru_security(
        "GET", "/scans/$(scanName)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `end_date`: The end date of the interval which you want to retrieve metrics from. Round to
  the nearest day.
...
function list_scans(; aws_config::AbstractAWSConfig=current_aws_config())
    return codeguru_security("GET", "/scans"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_scans(
    ...
    return codeguru_security(
        "GET", "/scans", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
