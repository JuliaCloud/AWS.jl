...
"""
function delete_hypervisor(HypervisorArn; aws_config::AbstractAWSConfig=current_aws_config())
    return backup_gateway(
        "DeleteHypervisor",
...
"""
function get_virtual_machine(ResourceArn; aws_config::AbstractAWSConfig=current_aws_config())
    return backup_gateway(
        "GetVirtualMachine",
...
"""
function update_hypervisor(HypervisorArn; aws_config::AbstractAWSConfig=current_aws_config())
    return backup_gateway(
        "UpdateHypervisor",
        Dict{String,Any}("HypervisorArn" => HypervisorArn);
        aws_config=aws_config,
