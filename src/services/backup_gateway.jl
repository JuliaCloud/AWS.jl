...
function list_gateways(; aws_config::AbstractAWSConfig=current_aws_config())
    return backup_gateway("ListGateways"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_hypervisors(; aws_config::AbstractAWSConfig=current_aws_config())
    return backup_gateway("ListHypervisors"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_hypervisors(
    ...
    return backup_gateway(
        "ListHypervisors", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_virtual_machines(; aws_config::AbstractAWSConfig=current_aws_config())
    return backup_gateway(
        "ListVirtualMachines"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_virtual_machines(
    ...
    return backup_gateway(
        "ListVirtualMachines", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
