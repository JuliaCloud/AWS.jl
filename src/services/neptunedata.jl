...
function cancel_gremlin_query(queryId; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "DELETE", "/gremlin/status/$(queryId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function cancel_loader_job(loadId; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "DELETE", "/loader/$(loadId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function cancel_loader_job(
    ...
    return neptunedata(
        "DELETE", "/loader/$(loadId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function cancel_mldata_processing_job(
    ...
    return neptunedata(
        "DELETE", "/ml/dataprocessing/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function cancel_mlmodel_training_job(id; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "DELETE", "/ml/modeltraining/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function cancel_mlmodel_transform_job(
    ...
    return neptunedata(
        "DELETE", "/ml/modeltransform/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"instanceCount"`: The minimum number of Amazon EC2 instances to deploy to an endpoint for
  prediction. The default is 1

- `"instanceType"`: The type of Neptune ML instance to use for online servicing. The default
  is `ml.m5.xlarge`. Choosing the ML instance for an inference endpoint depends on the task
  type, the graph size, and your budget.
...
- `"modelName"`: Model type for training. By default the Neptune ML model is automatically
  ...
  The only valid value for heterogeneous graphs is `rgcn`. Valid values for knowledge graphs
...
function create_mlendpoint(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata("POST", "/ml/endpoints"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function create_mlendpoint(
    ...
    return neptunedata(
        "POST", "/ml/endpoints", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_mlendpoint(id; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "DELETE", "/ml/endpoints/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_mlendpoint(
    ...
    return neptunedata(
        "DELETE", "/ml/endpoints/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_propertygraph_statistics(;
    ...
    return neptunedata(
        "DELETE", "/propertygraph/statistics"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_sparql_statistics(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "DELETE", "/sparql/statistics"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_sparql_statistics(
    ...
    return neptunedata(
        "DELETE", "/sparql/statistics", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
query. You invoke it by adding an `explain` parameter to an HTTP call that submits a Gremlin
query.
...
Neptune supports building graph applications using openCypher, which is currently one of the
most popular query languages among developers working with graph databases. Developers,
...
enabled, the IAM user or role making the request must have a policy attached that allows one
...
function get_engine_status(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata("GET", "/status"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_engine_status(
    ...
    return neptunedata(
        "GET", "/status", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_gremlin_query_status(
    ...
    return neptunedata(
        "GET", "/gremlin/status/$(queryId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_loader_job_status(loadId; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/loader/$(loadId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_loader_job_status(
    ...
    return neptunedata(
        "GET", "/loader/$(loadId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_mldata_processing_job(id; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/ml/dataprocessing/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_mlendpoint(id; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/ml/endpoints/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_mlendpoint(
    ...
    return neptunedata(
        "GET", "/ml/endpoints/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_mlmodel_training_job(id; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/ml/modeltraining/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_mlmodel_transform_job(id; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/ml/modeltransform/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_open_cypher_query_status(
    ...
    return neptunedata(
        "GET", "/opencypher/status/$(queryId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_propertygraph_statistics(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/propertygraph/statistics"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
With the Neptune Streams feature, you can generate a complete sequence of change-log entries
that record every change made to your graph data as it happens. `GetPropertygraphStream`
...
- `"iteratorType"`: Can be one of:
  ...
  - `AT_SEQUENCE_NUMBER` - Indicates that reading should start from the event sequence
...
- `"opNum"`: The operation sequence number within the specified commit to start reading from
...
function get_propertygraph_stream(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/propertygraph/stream"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_propertygraph_stream(
    ...
    return neptunedata(
        "GET", "/propertygraph/stream", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_rdfgraph_summary(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/rdf/statistics/summary"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_sparql_statistics(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/sparql/statistics"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_sparql_statistics(
    ...
    return neptunedata(
        "GET", "/sparql/statistics", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
With the Neptune Streams feature, you can generate a complete sequence of change-log entries
that record every change made to your graph data as it happens. `GetSparqlStream` lets you
collect these change-log entries for an RDF graph.
...
function get_sparql_stream(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata("GET", "/sparql/stream"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_sparql_stream(
    ...
    return neptunedata(
        "GET", "/sparql/stream", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_gremlin_queries(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/gremlin/status"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_gremlin_queries(
    ...
    return neptunedata(
        "GET", "/gremlin/status", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_loader_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata("GET", "/loader"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_loader_jobs(
    ...
    return neptunedata(
        "GET", "/loader", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_mldata_processing_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/ml/dataprocessing"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_mldata_processing_jobs(
    ...
    return neptunedata(
        "GET", "/ml/dataprocessing", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_mlendpoints(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata("GET", "/ml/endpoints"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_mlendpoints(
    ...
    return neptunedata(
        "GET", "/ml/endpoints", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_mlmodel_training_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/ml/modeltraining"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_mlmodel_training_jobs(
    ...
    return neptunedata(
        "GET", "/ml/modeltraining", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_mlmodel_transform_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/ml/modeltransform"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_mlmodel_transform_jobs(
    ...
    return neptunedata(
        "GET", "/ml/modeltransform", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_open_cypher_queries(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "GET", "/opencypher/status"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_open_cypher_queries(
    ...
    return neptunedata(
        "GET", "/opencypher/status", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function manage_propertygraph_statistics(;
    ...
    return neptunedata(
        "POST", "/propertygraph/statistics"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function manage_sparql_statistics(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "POST", "/sparql/statistics"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function manage_sparql_statistics(
    ...
    return neptunedata(
        "POST", "/sparql/statistics", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"dependencies"`: This is an optional parameter that can make a queued load request
  ...
  needs `Job-A` and `Job-B` to be finished before it begins, proceed as follows:
...
- `"edgeOnlyLoad"`: **`edgeOnlyLoad`** - A flag that controls file processing order during
  bulk loading.
  ...
  *Default value*: `"FALSE"`.
  ...
  When this parameter is set to "FALSE", the loader automatically loads vertex files first,
  then edge files afterwards. It does this by first scanning all files to determine their
  contents (vertices or edges). When this parameter is set to "TRUE", the loader skips the
  initial scanning phase and immediately loads all files in the order they appear.
...
- `"mode"`: The load job mode.
  ...
  *Default value*: `AUTO`. <p class="title"> <b/> </p>
  ...
  The loader avoids reloading files that were successfully loaded in a previous job. It only
  tries to process failed files. If you dropped previously loaded data from your Neptune
  cluster, that data is not reloaded in this mode. If a previous load job loaded all files
  from the same source successfully, nothing is reloaded, and the loader returns success.
  - `NEW` - In NEW mode, the creates a new load request regardless of any previous loads.
    You can use this mode to reload all the data from a source after dropping previously
    loaded data from your Neptune cluster, or to load new data available at the same source.
  - `AUTO` - In AUTO mode, the loader looks for a previous load job from the same source,
    and if it finds one, resumes that job, just as in `RESUME` mode.
...
- `"parallelism"`: The optional `parallelism` parameter can be set to reduce the number of
  ...
  *Allowed values*:
  ...
  - `OVERSUBSCRIBE` – The number of threads used is the number of available vCPUs multiplied
  ...
  *Default value*: `HIGH`
  ...
  openCypher data. When this happens, Neptune returns the `LOAD_DATA_DEADLOCK` error. You
  can generally fix the issue by setting `parallelism` to a lower setting and retrying the
  load command.

- `"parserConfiguration"`: **`parserConfiguration`** – An optional object with additional
  parser configuration values. Each of the child parameters is also optional: <p
  class="title"> <b/> </p>
  ...
  - **`allowEmptyStrings`** - Gremlin users need to be able to pass empty string values("")
    as node and edge properties when loading CSV data. If `allowEmptyStrings` is set to
...
- `"queueRequest"`: This is an optional flag parameter that indicates whether the load
  ...
  parameters are all set to `"TRUE"`. The queue order of the jobs will be first-in-first-out
  (FIFO).
...
- `"userProvidedEdgeIds"`: This parameter is required only when loading openCypher data that
  contains relationship IDs. It must be included and set to `True` when openCypher
...
- `data_processing_job_id`: The job ID of the completed data-processing job that has created
...
- `"maxHPONumberOfTrainingJobs"`: Maximum total number of training jobs to start for the
  ...
  at least 10 jobs (in other words, set `maxHPONumberOfTrainingJobs` to 10). In general, the
...
- `"previousModelTrainingJobId"`: The job ID of a completed model-training job that you want
...
- `"trainingInstanceVolumeSizeInGB"`: The disk volume size of the training instance. Both
  ...
  enough to hold both data sets. The default is 0. If not specified or 0, Neptune ML selects
...
- `"baseProcessingInstanceVolumeSizeInGB"`: The disk volume size of the training instance in
  gigabytes. The default is 0. Both input data and the output model are stored on disk, so
  the volume size must be large enough to hold both data sets. If not specified or 0,
