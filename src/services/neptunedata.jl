...
function cancel_gremlin_query(
    queryId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return neptunedata(
        "DELETE",
        "/gremlin/status/$(queryId)",
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  ...
  will occur.
"""
function cancel_mldata_processing_job(id; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "DELETE",
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  ...
  will occur.
"""
function cancel_mlmodel_transform_job(id; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "DELETE",
...
function execute_gremlin_explain_query(
    gremlin, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return neptunedata(
        "POST",
        "/gremlin/explain",
...
"""
function execute_open_cypher_query(query; aws_config::AbstractAWSConfig=current_aws_config())
    return neptunedata(
        "POST",
        "/opencypher",
