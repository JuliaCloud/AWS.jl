...
IAM user or role making the request must have a policy attached that allows the [neptune-db:CancelQuery](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#cancelquery)
...
"""
cancel_gremlin_query(queryId; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/gremlin/status/$(queryId)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
cancel_gremlin_query(queryId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/gremlin/status/$(queryId)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)

"""
    cancel_loader_job(load_id)
    cancel_loader_job(load_id, params::Dict{String,<:Any})

Cancels a specified load job. This is an HTTP `DELETE` request. See [Neptune Loader Get-Status API](https://docs.aws.amazon.com/neptune/latest/userguide/load-api-reference-status.htm)
for more information.

When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:CancelLoaderJob](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#cancelloaderjob)
IAM action in that cluster..
...
"""
cancel_loader_job(loadId; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/loader/$(loadId)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
cancel_loader_job(loadId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/loader/$(loadId)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:CancelMLDataProcessingJob](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#cancelmldataprocessingjob)
IAM action in that cluster.
...
- `"clean"`: If set to `TRUE`, this flag specifies that all Neptune ML S3 artifacts should
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  and Amazon S3 resources. This must be listed in your DB cluster parameter group or an
  error will occur.
"""
cancel_mldata_processing_job(id; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/ml/dataprocessing/$(id)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
cancel_mldata_processing_job(id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/ml/dataprocessing/$(id)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:CancelMLModelTrainingJob](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#cancelmlmodeltrainingjob)
IAM action in that cluster.
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  ...
  error will occur.
"""
cancel_mlmodel_training_job(id; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/ml/modeltraining/$(id)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
cancel_mlmodel_training_job(id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/ml/modeltraining/$(id)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:CancelMLModelTransformJob](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#cancelmlmodeltransformjob)
IAM action in that cluster.
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  ...
  error will occur.
"""
cancel_mlmodel_transform_job(id; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/ml/modeltransform/$(id)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
cancel_mlmodel_transform_job(id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/ml/modeltransform/$(id)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"silent"`: If set to `TRUE`, causes the cancelation of the openCypher query to happen
  silently.
"""
cancel_open_cypher_query(queryId; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/opencypher/status/$(queryId)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
cancel_open_cypher_query(queryId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/opencypher/status/$(queryId)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
model-training process constructed. See [Managing inference endpoints using the endpoints command](https://docs.aws.amazon.com/neptune/latest/userguide/machine-learning-api-endpoints.html).

When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:CreateMLEndpoint](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#createmlendpoint)
IAM action in that cluster.
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role providing Neptune access to SageMaker and
  ...
  will be thrown.
- `"update"`: If set to `true`, `update` indicates that this is an update request. The
...
"""
create_mlendpoint(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/ml/endpoints"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_mlendpoint(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/ml/endpoints", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:DeleteMLEndpoint](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#deletemlendpoint)
IAM action in that cluster.
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role providing Neptune access to SageMaker and
  ...
  will be thrown.
"""
delete_mlendpoint(id; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/ml/endpoints/$(id)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_mlendpoint(id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/ml/endpoints/$(id)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:DeleteStatistics](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#deletestatistics)
IAM action in that cluster.
"""
delete_propertygraph_statistics(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/propertygraph/statistics"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_propertygraph_statistics(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/propertygraph/statistics", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
IAM action in that cluster.
"""
delete_sparql_statistics(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/sparql/statistics"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_sparql_statistics(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("DELETE", "/sparql/statistics", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
set to `initiateDatabaseReset`. This returns a UUID token which you then include when
calling `ExecuteFastReset` again with `action` set to `performDatabaseReset`. See [Empty an Amazon Neptune DB cluster using the fast reset API](https://docs.aws.amazon.com/neptune/latest/userguide/manage-console-fast-reset.html).

When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:ResetDatabase](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#resetdatabase)
IAM action in that cluster.
...
"""
execute_fast_reset(action; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/system", Dict{String, Any}("action"=>action); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
execute_fast_reset(action, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/system", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("action"=>action), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Amazon Neptune has added a Gremlin feature named `explain` that provides is a self-service
tool for understanding the execution approach being taken by the Neptune engine for the
query. You invoke it by adding an `explain` parameter to an HTTP call that submits a
Gremlin query.
...
bottlenecks and to tune your query, as explained in [Tuning Gremlin queries](https://docs.aws.amazon.com/neptune/latest/userguide/gremlin-traversal-tuning.html).
...
"""
execute_gremlin_explain_query(gremlin; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/gremlin/explain", Dict{String, Any}("gremlin"=>gremlin); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
execute_gremlin_explain_query(gremlin, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/gremlin/explain", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("gremlin"=>gremlin), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
metrics about the run, and produces a profile report as output. See [Gremlin profile API in Neptune](https://docs.aws.amazon.com/neptune/latest/userguide/gremlin-profile-api.html)
for details.

When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:ReadDataViaQuery](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#readdataviaquery)
IAM action in that cluster.
...
- `"profile.indexOps"`: If this flag is set to `TRUE`, the results include a detailed
...
- `"profile.serializer"`: If non-null, the gathered results are returned in a serialized
  ...
  for more information.
"""
execute_gremlin_profile_query(gremlin; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/gremlin/profile", Dict{String, Any}("gremlin"=>gremlin); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
execute_gremlin_profile_query(gremlin, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/gremlin/profile", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("gremlin"=>gremlin), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
under [The Graph](https://tinkerpop.apache.org/docs/current/reference/#graph) in the Apache
TinkerPop3 documentation. More details can also be found in [Accessing a Neptune graph with Gremlin](https://docs.aws.amazon.com/neptune/latest/userguide/access-graph-gremlin.html).
...
- `gremlin`: Using this API, you can run Gremlin queries in string format much as you can
  using the HTTP endpoint. The interface is compatible with whatever Gremlin version your
  DB cluster is using (see the [Tinkerpop client section](https://docs.aws.amazon.com/neptune/latest/userguide/access-graph-gremlin-client.html#best-practices-gremlin-java-latest)
...
- `"accept"`: If non-null, the query results are returned in a serialized response message
  ...
  supported.
"""
execute_gremlin_query(gremlin; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/gremlin", Dict{String, Any}("gremlin"=>gremlin); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
execute_gremlin_query(gremlin, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/gremlin", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("gremlin"=>gremlin), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
execute_open_cypher_explain_query(explain, query; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/opencypher/explain", Dict{String, Any}("explain"=>explain, "query"=>query); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
execute_open_cypher_explain_query(explain, query, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/opencypher/explain", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("explain"=>explain, "query"=>query), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Neptune supports building graph applications using openCypher, which is currently one of
the most popular query languages among developers working with graph databases. Developers,
business analysts, and data scientists like openCypher's declarative, SQL-inspired syntax
because it provides a familiar structure in which to querying property graphs.

The openCypher language was originally developed by Neo4j, then open-sourced in 2015 and
contributed to the [openCypher project](https://opencypher.org/) under an Apache 2 open-
source license.
...
- `"parameters"`: The openCypher query parameters for query execution. See [Examples of openCypher parameterized queries](https://docs.aws.amazon.com/neptune/latest/userguide/opencypher-parameterized-queries.html)
  for more information.
"""
execute_open_cypher_query(query; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/opencypher", Dict{String, Any}("query"=>query); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
execute_open_cypher_query(query, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/opencypher", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("query"=>query), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:GetEngineStatus](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#getenginestatus)
IAM action in that cluster.
"""
get_engine_status(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/status"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_engine_status(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/status", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:GetQueryStatus](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#getquerystatus)
IAM action in that cluster.
...
"""
get_gremlin_query_status(queryId; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/gremlin/status/$(queryId)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_gremlin_query_status(queryId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/gremlin/status/$(queryId)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
1,024 bulk load jobs, and stores the last 10,000 error details per job.

See [Neptune Loader Get-Status API](https://docs.aws.amazon.com/neptune/latest/userguide/load-api-reference-status.htm)
for more information.

When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:GetLoaderJobStatus](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#getloaderjobstatus)
IAM action in that cluster..
...
"""
get_loader_job_status(loadId; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/loader/$(loadId)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_loader_job_status(loadId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/loader/$(loadId)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:neptune-db:GetMLDataProcessingJobStatus](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#getmldataprocessingjobstatus)
IAM action in that cluster.
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  ...
  error will occur.
"""
get_mldata_processing_job(id; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/dataprocessing/$(id)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_mldata_processing_job(id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/dataprocessing/$(id)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:GetMLEndpointStatus](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#getmlendpointstatus)
IAM action in that cluster.
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  ...
  error will occur.
"""
get_mlendpoint(id; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/endpoints/$(id)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_mlendpoint(id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/endpoints/$(id)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:GetMLModelTrainingJobStatus](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#getmlmodeltrainingjobstatus)
IAM action in that cluster.
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  ...
  error will occur.
"""
get_mlmodel_training_job(id; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/modeltraining/$(id)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_mlmodel_training_job(id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/modeltraining/$(id)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:GetMLModelTransformJobStatus](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#getmlmodeltransformjobstatus)
IAM action in that cluster.
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  ...
  error will occur.
"""
get_mlmodel_transform_job(id; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/modeltransform/$(id)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_mlmodel_transform_job(id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/modeltransform/$(id)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_open_cypher_query_status(queryId; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/opencypher/status/$(queryId)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_open_cypher_query_status(queryId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/opencypher/status/$(queryId)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:GetStatisticsStatus](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#getstatisticsstatus)
IAM action in that cluster.
"""
get_propertygraph_statistics(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/propertygraph/statistics"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_propertygraph_statistics(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/propertygraph/statistics", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
entries that record every change made to your graph data as it happens.
...
streams, set the [neptune_streams](https://docs.aws.amazon.com/neptune/latest/userguide/parameters.html#parameters-db-cluster-parameters-neptune_streams)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:GetStreamRecords](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#getstreamrecords)
IAM action in that cluster.
...
"""
get_propertygraph_stream(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/propertygraph/stream"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_propertygraph_stream(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/propertygraph/stream", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:GetGraphSummary](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#getgraphsummary)
IAM action in that cluster.
...
"""
get_propertygraph_summary(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/propertygraph/statistics/summary"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_propertygraph_summary(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/propertygraph/statistics/summary", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"mode"`: Mode can take one of two values: `BASIC` (the default), and `DETAILED`.
"""
get_rdfgraph_summary(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/rdf/statistics/summary"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_rdfgraph_summary(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/rdf/statistics/summary", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_sparql_statistics(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/sparql/statistics"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_sparql_statistics(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/sparql/statistics", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
IAM condition key can be used in the policy document to restrict the use of SPARQL queries
(see [Condition keys available in Neptune IAM data-access policy statements](https://docs.aws.amazon.com/neptune/latest/userguide/iam-data-condition-keys.html)).
...
- `"opNum"`: The operation sequence number within the specified commit to start reading
  from in the change-log stream data. The default is `1`.
"""
get_sparql_stream(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/sparql/stream"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_sparql_stream(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/sparql/stream", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"includeWaiting"`: If set to `TRUE`, the list returned includes waiting queries. The
  default is `FALSE`;
"""
list_gremlin_queries(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/gremlin/status"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_gremlin_queries(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/gremlin/status", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:ListLoaderJobs](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#listloaderjobs)
IAM action in that cluster..
...
- `"includeQueuedLoads"`: An optional parameter that can be used to exclude the load IDs of
  queued load requests when requesting a list of load IDs by setting the parameter to
...
"""
list_loader_jobs(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/loader"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_loader_jobs(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/loader", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:ListMLDataProcessingJobs](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#listmldataprocessingjobs)
IAM action in that cluster.
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  ...
  error will occur.
"""
list_mldata_processing_jobs(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/dataprocessing"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_mldata_processing_jobs(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/dataprocessing", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:ListMLEndpoints](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#listmlendpoints)
IAM action in that cluster.
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  ...
  error will occur.
"""
list_mlendpoints(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/endpoints"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_mlendpoints(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/endpoints", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:neptune-db:ListMLModelTrainingJobs](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#neptune-db:listmlmodeltrainingjobs)
IAM action in that cluster.
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  ...
  error will occur.
"""
list_mlmodel_training_jobs(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/modeltraining"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_mlmodel_training_jobs(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/modeltraining", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:ListMLModelTransformJobs](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#listmlmodeltransformjobs)
IAM action in that cluster.
...
- `"neptuneIamRoleArn"`: The ARN of an IAM role that provides Neptune access to SageMaker
  ...
  error will occur.
"""
list_mlmodel_transform_jobs(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/modeltransform"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_mlmodel_transform_jobs(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/ml/modeltransform", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_open_cypher_queries(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/opencypher/status"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_open_cypher_queries(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("GET", "/opencypher/status", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:ManageStatistics](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#managestatistics)
IAM action in that cluster.
...
- `"mode"`: The statistics generation mode. One of: `DISABLE_AUTOCOMPUTE`,
  ...
  generation.
"""
manage_propertygraph_statistics(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/propertygraph/statistics"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
manage_propertygraph_statistics(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/propertygraph/statistics", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"mode"`: The statistics generation mode. One of: `DISABLE_AUTOCOMPUTE`,
  ...
  generation.
"""
manage_sparql_statistics(; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/sparql/statistics"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
manage_sparql_statistics(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/sparql/statistics", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:StartLoaderJob](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#startloaderjob)
IAM action in that cluster.
...
- `"dependencies"`: This is an optional parameter that can make a queued load request
  contingent on the successful completion of one or more previous jobs in the queue.

  Neptune can queue up as many as 64 load requests at a time, if their `queueRequest`
  parameters are set to `"TRUE"`. The `dependencies` parameter lets you make execution of
...
- `"failOnError"`:  ** `failOnError` **   –   A flag to toggle a complete stop on an error.
  ...
  When this parameter is set to `"TRUE"`, the loader stops as soon as it encounters an
...
"""
start_loader_job(format, iamRoleArn, region, source; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/loader", Dict{String, Any}("format"=>format, "iamRoleArn"=>iamRoleArn, "region"=>region, "source"=>source); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_loader_job(format, iamRoleArn, region, source, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/loader", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("format"=>format, "iamRoleArn"=>iamRoleArn, "region"=>region, "source"=>source), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Neptune for training. See [The `dataprocessing` command](https://docs.aws.amazon.com/neptune/latest/userguide/machine-learning-api-dataprocessing.html).

When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:StartMLModelDataProcessingJob](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#startmlmodeldataprocessingjob)
IAM action in that cluster.
...
- `"configFileName"`: A data specification file that describes how to load the exported
  graph data for training. The file is automatically generated by the Neptune export
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:StartMLModelTrainingJob](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#startmlmodeltrainingjob)
IAM action in that cluster.
...
- `"trainingInstanceVolumeSizeInGB"`: The disk volume size of the training instance. Both
  ...
  enough to hold both data sets. The default is 0. If not specified or 0, Neptune ML
  selects a disk volume size based on the recommendation generated in the data processing
  step.
...
"""
start_mlmodel_training_job(dataProcessingJobId, trainModelS3Location; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/ml/modeltraining", Dict{String, Any}("dataProcessingJobId"=>dataProcessingJobId, "trainModelS3Location"=>trainModelS3Location); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_mlmodel_training_job(dataProcessingJobId, trainModelS3Location, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/ml/modeltraining", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("dataProcessingJobId"=>dataProcessingJobId, "trainModelS3Location"=>trainModelS3Location), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When invoking this operation in a Neptune cluster that has IAM authentication enabled, the
IAM user or role making the request must have a policy attached that allows the [neptune-db:StartMLModelTransformJob](https://docs.aws.amazon.com/neptune/latest/userguide/iam-dp-actions.html#startmlmodeltransformjob)
IAM action in that cluster.
...
- `"volumeEncryptionKMSKey"`: The Amazon Key Management Service (KMS) key that SageMaker
  ...
  the training job. The default is None.
"""
start_mlmodel_transform_job(modelTransformOutputS3Location; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/ml/modeltransform", Dict{String, Any}("modelTransformOutputS3Location"=>modelTransformOutputS3Location); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_mlmodel_transform_job(modelTransformOutputS3Location, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = neptunedata("POST", "/ml/modeltransform", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("modelTransformOutputS3Location"=>modelTransformOutputS3Location), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
