...
function list_tunnels(; aws_config::AbstractAWSConfig=current_aws_config())
    return iotsecuretunneling("ListTunnels"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_tunnels(
    ...
    return iotsecuretunneling(
        "ListTunnels", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function open_tunnel(; aws_config::AbstractAWSConfig=current_aws_config())
    return iotsecuretunneling("OpenTunnel"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function open_tunnel(
    ...
    return iotsecuretunneling(
        "OpenTunnel", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
