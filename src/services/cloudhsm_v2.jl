...
"""
CopyBackupToRegion(BackupId, DestinationRegion) = cloudhsm_v2("CopyBackupToRegion", Dict{String, Any}("BackupId"=>BackupId, "DestinationRegion"=>DestinationRegion))
CopyBackupToRegion(BackupId, DestinationRegion, args::AbstractDict{String, <: Any}) = cloudhsm_v2("CopyBackupToRegion", Dict{String, Any}("BackupId"=>BackupId, "DestinationRegion"=>DestinationRegion, args...))
...
"""
CreateCluster(HsmType, SubnetIds) = cloudhsm_v2("CreateCluster", Dict{String, Any}("HsmType"=>HsmType, "SubnetIds"=>SubnetIds))
CreateCluster(HsmType, SubnetIds, args::AbstractDict{String, <: Any}) = cloudhsm_v2("CreateCluster", Dict{String, Any}("HsmType"=>HsmType, "SubnetIds"=>SubnetIds, args...))
...
"""
CreateHsm(AvailabilityZone, ClusterId) = cloudhsm_v2("CreateHsm", Dict{String, Any}("AvailabilityZone"=>AvailabilityZone, "ClusterId"=>ClusterId))
CreateHsm(AvailabilityZone, ClusterId, args::AbstractDict{String, <: Any}) = cloudhsm_v2("CreateHsm", Dict{String, Any}("AvailabilityZone"=>AvailabilityZone, "ClusterId"=>ClusterId, args...))
...
"""
DeleteBackup(BackupId) = cloudhsm_v2("DeleteBackup", Dict{String, Any}("BackupId"=>BackupId))
DeleteBackup(BackupId, args::AbstractDict{String, <: Any}) = cloudhsm_v2("DeleteBackup", Dict{String, Any}("BackupId"=>BackupId, args...))
...
"""
DeleteCluster(ClusterId) = cloudhsm_v2("DeleteCluster", Dict{String, Any}("ClusterId"=>ClusterId))
DeleteCluster(ClusterId, args::AbstractDict{String, <: Any}) = cloudhsm_v2("DeleteCluster", Dict{String, Any}("ClusterId"=>ClusterId, args...))
...
"""
DeleteHsm(ClusterId) = cloudhsm_v2("DeleteHsm", Dict{String, Any}("ClusterId"=>ClusterId))
DeleteHsm(ClusterId, args::AbstractDict{String, <: Any}) = cloudhsm_v2("DeleteHsm", Dict{String, Any}("ClusterId"=>ClusterId, args...))
...
DescribeBackups(args::AbstractDict{String, <: Any}) = cloudhsm_v2("DescribeBackups", args)
...
DescribeClusters(args::AbstractDict{String, <: Any}) = cloudhsm_v2("DescribeClusters", args)
...
"""
InitializeCluster(ClusterId, SignedCert, TrustAnchor) = cloudhsm_v2("InitializeCluster", Dict{String, Any}("ClusterId"=>ClusterId, "SignedCert"=>SignedCert, "TrustAnchor"=>TrustAnchor))
InitializeCluster(ClusterId, SignedCert, TrustAnchor, args::AbstractDict{String, <: Any}) = cloudhsm_v2("InitializeCluster", Dict{String, Any}("ClusterId"=>ClusterId, "SignedCert"=>SignedCert, "TrustAnchor"=>TrustAnchor, args...))
...
"""
ListTags(ResourceId) = cloudhsm_v2("ListTags", Dict{String, Any}("ResourceId"=>ResourceId))
ListTags(ResourceId, args::AbstractDict{String, <: Any}) = cloudhsm_v2("ListTags", Dict{String, Any}("ResourceId"=>ResourceId, args...))
...
"""
RestoreBackup(BackupId) = cloudhsm_v2("RestoreBackup", Dict{String, Any}("BackupId"=>BackupId))
RestoreBackup(BackupId, args::AbstractDict{String, <: Any}) = cloudhsm_v2("RestoreBackup", Dict{String, Any}("BackupId"=>BackupId, args...))
...
"""
TagResource(ResourceId, TagList) = cloudhsm_v2("TagResource", Dict{String, Any}("ResourceId"=>ResourceId, "TagList"=>TagList))
TagResource(ResourceId, TagList, args::AbstractDict{String, <: Any}) = cloudhsm_v2("TagResource", Dict{String, Any}("ResourceId"=>ResourceId, "TagList"=>TagList, args...))
...
"""
UntagResource(ResourceId, TagKeyList) = cloudhsm_v2("UntagResource", Dict{String, Any}("ResourceId"=>ResourceId, "TagKeyList"=>TagKeyList))
UntagResource(ResourceId, TagKeyList, args::AbstractDict{String, <: Any}) = cloudhsm_v2("UntagResource", Dict{String, Any}("ResourceId"=>ResourceId, "TagKeyList"=>TagKeyList, args...))
