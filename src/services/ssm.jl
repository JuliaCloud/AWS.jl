...
"""
AddTagsToResource(ResourceId, ResourceType, Tags) = ssm("AddTagsToResource", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, "Tags"=>Tags))
AddTagsToResource(ResourceId, ResourceType, Tags, args::AbstractDict{String, <:Any}) = ssm("AddTagsToResource", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, "Tags"=>Tags, args...))
...
"""
CancelCommand(CommandId) = ssm("CancelCommand", Dict{String, Any}("CommandId"=>CommandId))
CancelCommand(CommandId, args::AbstractDict{String, <:Any}) = ssm("CancelCommand", Dict{String, Any}("CommandId"=>CommandId, args...))
...
"""
CancelMaintenanceWindowExecution(WindowExecutionId) = ssm("CancelMaintenanceWindowExecution", Dict{String, Any}("WindowExecutionId"=>WindowExecutionId))
CancelMaintenanceWindowExecution(WindowExecutionId, args::AbstractDict{String, <:Any}) = ssm("CancelMaintenanceWindowExecution", Dict{String, Any}("WindowExecutionId"=>WindowExecutionId, args...))
...
"""
CreateActivation(IamRole) = ssm("CreateActivation", Dict{String, Any}("IamRole"=>IamRole))
CreateActivation(IamRole, args::AbstractDict{String, <:Any}) = ssm("CreateActivation", Dict{String, Any}("IamRole"=>IamRole, args...))
...
"""
CreateAssociation(Name) = ssm("CreateAssociation", Dict{String, Any}("Name"=>Name))
CreateAssociation(Name, args::AbstractDict{String, <:Any}) = ssm("CreateAssociation", Dict{String, Any}("Name"=>Name, args...))
...
"""
CreateAssociationBatch(Entries) = ssm("CreateAssociationBatch", Dict{String, Any}("Entries"=>Entries))
CreateAssociationBatch(Entries, args::AbstractDict{String, <:Any}) = ssm("CreateAssociationBatch", Dict{String, Any}("Entries"=>Entries, args...))
...
"""
CreateDocument(Content, Name) = ssm("CreateDocument", Dict{String, Any}("Content"=>Content, "Name"=>Name))
CreateDocument(Content, Name, args::AbstractDict{String, <:Any}) = ssm("CreateDocument", Dict{String, Any}("Content"=>Content, "Name"=>Name, args...))
...
"""
CreateMaintenanceWindow(AllowUnassociatedTargets, Cutoff, Duration, Name, Schedule) = ssm("CreateMaintenanceWindow", Dict{String, Any}("AllowUnassociatedTargets"=>AllowUnassociatedTargets, "Cutoff"=>Cutoff, "Duration"=>Duration, "Name"=>Name, "Schedule"=>Schedule, "ClientToken"=>string(uuid4())))
CreateMaintenanceWindow(AllowUnassociatedTargets, Cutoff, Duration, Name, Schedule, args::AbstractDict{String, <:Any}) = ssm("CreateMaintenanceWindow", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AllowUnassociatedTargets"=>AllowUnassociatedTargets, "Cutoff"=>Cutoff, "Duration"=>Duration, "Name"=>Name, "Schedule"=>Schedule, "ClientToken"=>string(uuid4())), args)))
...
"""
CreateOpsItem(Description, Source, Title) = ssm("CreateOpsItem", Dict{String, Any}("Description"=>Description, "Source"=>Source, "Title"=>Title))
CreateOpsItem(Description, Source, Title, args::AbstractDict{String, <:Any}) = ssm("CreateOpsItem", Dict{String, Any}("Description"=>Description, "Source"=>Source, "Title"=>Title, args...))
...
"""
CreatePatchBaseline(Name) = ssm("CreatePatchBaseline", Dict{String, Any}("Name"=>Name, "ClientToken"=>string(uuid4())))
CreatePatchBaseline(Name, args::AbstractDict{String, <:Any}) = ssm("CreatePatchBaseline", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name, "ClientToken"=>string(uuid4())), args)))
...
"""
CreateResourceDataSync(SyncName) = ssm("CreateResourceDataSync", Dict{String, Any}("SyncName"=>SyncName))
CreateResourceDataSync(SyncName, args::AbstractDict{String, <:Any}) = ssm("CreateResourceDataSync", Dict{String, Any}("SyncName"=>SyncName, args...))
...
"""
DeleteActivation(ActivationId) = ssm("DeleteActivation", Dict{String, Any}("ActivationId"=>ActivationId))
DeleteActivation(ActivationId, args::AbstractDict{String, <:Any}) = ssm("DeleteActivation", Dict{String, Any}("ActivationId"=>ActivationId, args...))
...
DeleteAssociation(args::AbstractDict{String, <:Any}) = ssm("DeleteAssociation", args)
...
"""
DeleteDocument(Name) = ssm("DeleteDocument", Dict{String, Any}("Name"=>Name))
DeleteDocument(Name, args::AbstractDict{String, <:Any}) = ssm("DeleteDocument", Dict{String, Any}("Name"=>Name, args...))
...
"""
DeleteInventory(TypeName) = ssm("DeleteInventory", Dict{String, Any}("TypeName"=>TypeName, "ClientToken"=>string(uuid4())))
DeleteInventory(TypeName, args::AbstractDict{String, <:Any}) = ssm("DeleteInventory", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TypeName"=>TypeName, "ClientToken"=>string(uuid4())), args)))
...
"""
DeleteMaintenanceWindow(WindowId) = ssm("DeleteMaintenanceWindow", Dict{String, Any}("WindowId"=>WindowId))
DeleteMaintenanceWindow(WindowId, args::AbstractDict{String, <:Any}) = ssm("DeleteMaintenanceWindow", Dict{String, Any}("WindowId"=>WindowId, args...))
...
"""
DeleteParameter(Name) = ssm("DeleteParameter", Dict{String, Any}("Name"=>Name))
DeleteParameter(Name, args::AbstractDict{String, <:Any}) = ssm("DeleteParameter", Dict{String, Any}("Name"=>Name, args...))
...
"""
DeleteParameters(Names) = ssm("DeleteParameters", Dict{String, Any}("Names"=>Names))
DeleteParameters(Names, args::AbstractDict{String, <:Any}) = ssm("DeleteParameters", Dict{String, Any}("Names"=>Names, args...))
...
"""
DeletePatchBaseline(BaselineId) = ssm("DeletePatchBaseline", Dict{String, Any}("BaselineId"=>BaselineId))
DeletePatchBaseline(BaselineId, args::AbstractDict{String, <:Any}) = ssm("DeletePatchBaseline", Dict{String, Any}("BaselineId"=>BaselineId, args...))
...
"""
DeleteResourceDataSync(SyncName) = ssm("DeleteResourceDataSync", Dict{String, Any}("SyncName"=>SyncName))
DeleteResourceDataSync(SyncName, args::AbstractDict{String, <:Any}) = ssm("DeleteResourceDataSync", Dict{String, Any}("SyncName"=>SyncName, args...))
...
"""
DeregisterManagedInstance(InstanceId) = ssm("DeregisterManagedInstance", Dict{String, Any}("InstanceId"=>InstanceId))
DeregisterManagedInstance(InstanceId, args::AbstractDict{String, <:Any}) = ssm("DeregisterManagedInstance", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
"""
DeregisterPatchBaselineForPatchGroup(BaselineId, PatchGroup) = ssm("DeregisterPatchBaselineForPatchGroup", Dict{String, Any}("BaselineId"=>BaselineId, "PatchGroup"=>PatchGroup))
DeregisterPatchBaselineForPatchGroup(BaselineId, PatchGroup, args::AbstractDict{String, <:Any}) = ssm("DeregisterPatchBaselineForPatchGroup", Dict{String, Any}("BaselineId"=>BaselineId, "PatchGroup"=>PatchGroup, args...))
...
"""
DeregisterTargetFromMaintenanceWindow(WindowId, WindowTargetId) = ssm("DeregisterTargetFromMaintenanceWindow", Dict{String, Any}("WindowId"=>WindowId, "WindowTargetId"=>WindowTargetId))
DeregisterTargetFromMaintenanceWindow(WindowId, WindowTargetId, args::AbstractDict{String, <:Any}) = ssm("DeregisterTargetFromMaintenanceWindow", Dict{String, Any}("WindowId"=>WindowId, "WindowTargetId"=>WindowTargetId, args...))
...
"""
DeregisterTaskFromMaintenanceWindow(WindowId, WindowTaskId) = ssm("DeregisterTaskFromMaintenanceWindow", Dict{String, Any}("WindowId"=>WindowId, "WindowTaskId"=>WindowTaskId))
DeregisterTaskFromMaintenanceWindow(WindowId, WindowTaskId, args::AbstractDict{String, <:Any}) = ssm("DeregisterTaskFromMaintenanceWindow", Dict{String, Any}("WindowId"=>WindowId, "WindowTaskId"=>WindowTaskId, args...))
...
DescribeActivations(args::AbstractDict{String, <:Any}) = ssm("DescribeActivations", args)
...
DescribeAssociation(args::AbstractDict{String, <:Any}) = ssm("DescribeAssociation", args)
...
- `NextToken`: A token to start the list. Use this token to get the next set of results. 
"""
DescribeAssociationExecutionTargets(AssociationId, ExecutionId) = ssm("DescribeAssociationExecutionTargets", Dict{String, Any}("AssociationId"=>AssociationId, "ExecutionId"=>ExecutionId))
DescribeAssociationExecutionTargets(AssociationId, ExecutionId, args::AbstractDict{String, <:Any}) = ssm("DescribeAssociationExecutionTargets", Dict{String, Any}("AssociationId"=>AssociationId, "ExecutionId"=>ExecutionId, args...))
...
- `NextToken`: A token to start the list. Use this token to get the next set of results. 
"""
DescribeAssociationExecutions(AssociationId) = ssm("DescribeAssociationExecutions", Dict{String, Any}("AssociationId"=>AssociationId))
DescribeAssociationExecutions(AssociationId, args::AbstractDict{String, <:Any}) = ssm("DescribeAssociationExecutions", Dict{String, Any}("AssociationId"=>AssociationId, args...))
...
DescribeAutomationExecutions(args::AbstractDict{String, <:Any}) = ssm("DescribeAutomationExecutions", args)
...
"""
DescribeAutomationStepExecutions(AutomationExecutionId) = ssm("DescribeAutomationStepExecutions", Dict{String, Any}("AutomationExecutionId"=>AutomationExecutionId))
DescribeAutomationStepExecutions(AutomationExecutionId, args::AbstractDict{String, <:Any}) = ssm("DescribeAutomationStepExecutions", Dict{String, Any}("AutomationExecutionId"=>AutomationExecutionId, args...))
...
DescribeAvailablePatches(args::AbstractDict{String, <:Any}) = ssm("DescribeAvailablePatches", args)
...
"""
DescribeDocument(Name) = ssm("DescribeDocument", Dict{String, Any}("Name"=>Name))
DescribeDocument(Name, args::AbstractDict{String, <:Any}) = ssm("DescribeDocument", Dict{String, Any}("Name"=>Name, args...))
...
"""
DescribeDocumentPermission(Name, PermissionType) = ssm("DescribeDocumentPermission", Dict{String, Any}("Name"=>Name, "PermissionType"=>PermissionType))
DescribeDocumentPermission(Name, PermissionType, args::AbstractDict{String, <:Any}) = ssm("DescribeDocumentPermission", Dict{String, Any}("Name"=>Name, "PermissionType"=>PermissionType, args...))
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeEffectiveInstanceAssociations(InstanceId) = ssm("DescribeEffectiveInstanceAssociations", Dict{String, Any}("InstanceId"=>InstanceId))
DescribeEffectiveInstanceAssociations(InstanceId, args::AbstractDict{String, <:Any}) = ssm("DescribeEffectiveInstanceAssociations", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeEffectivePatchesForPatchBaseline(BaselineId) = ssm("DescribeEffectivePatchesForPatchBaseline", Dict{String, Any}("BaselineId"=>BaselineId))
DescribeEffectivePatchesForPatchBaseline(BaselineId, args::AbstractDict{String, <:Any}) = ssm("DescribeEffectivePatchesForPatchBaseline", Dict{String, Any}("BaselineId"=>BaselineId, args...))
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeInstanceAssociationsStatus(InstanceId) = ssm("DescribeInstanceAssociationsStatus", Dict{String, Any}("InstanceId"=>InstanceId))
DescribeInstanceAssociationsStatus(InstanceId, args::AbstractDict{String, <:Any}) = ssm("DescribeInstanceAssociationsStatus", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
DescribeInstanceInformation(args::AbstractDict{String, <:Any}) = ssm("DescribeInstanceInformation", args)
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeInstancePatchStates(InstanceIds) = ssm("DescribeInstancePatchStates", Dict{String, Any}("InstanceIds"=>InstanceIds))
DescribeInstancePatchStates(InstanceIds, args::AbstractDict{String, <:Any}) = ssm("DescribeInstancePatchStates", Dict{String, Any}("InstanceIds"=>InstanceIds, args...))
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeInstancePatchStatesForPatchGroup(PatchGroup) = ssm("DescribeInstancePatchStatesForPatchGroup", Dict{String, Any}("PatchGroup"=>PatchGroup))
DescribeInstancePatchStatesForPatchGroup(PatchGroup, args::AbstractDict{String, <:Any}) = ssm("DescribeInstancePatchStatesForPatchGroup", Dict{String, Any}("PatchGroup"=>PatchGroup, args...))
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeInstancePatches(InstanceId) = ssm("DescribeInstancePatches", Dict{String, Any}("InstanceId"=>InstanceId))
DescribeInstancePatches(InstanceId, args::AbstractDict{String, <:Any}) = ssm("DescribeInstancePatches", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
DescribeInventoryDeletions(args::AbstractDict{String, <:Any}) = ssm("DescribeInventoryDeletions", args)
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeMaintenanceWindowExecutionTaskInvocations(TaskId, WindowExecutionId) = ssm("DescribeMaintenanceWindowExecutionTaskInvocations", Dict{String, Any}("TaskId"=>TaskId, "WindowExecutionId"=>WindowExecutionId))
DescribeMaintenanceWindowExecutionTaskInvocations(TaskId, WindowExecutionId, args::AbstractDict{String, <:Any}) = ssm("DescribeMaintenanceWindowExecutionTaskInvocations", Dict{String, Any}("TaskId"=>TaskId, "WindowExecutionId"=>WindowExecutionId, args...))
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeMaintenanceWindowExecutionTasks(WindowExecutionId) = ssm("DescribeMaintenanceWindowExecutionTasks", Dict{String, Any}("WindowExecutionId"=>WindowExecutionId))
DescribeMaintenanceWindowExecutionTasks(WindowExecutionId, args::AbstractDict{String, <:Any}) = ssm("DescribeMaintenanceWindowExecutionTasks", Dict{String, Any}("WindowExecutionId"=>WindowExecutionId, args...))
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeMaintenanceWindowExecutions(WindowId) = ssm("DescribeMaintenanceWindowExecutions", Dict{String, Any}("WindowId"=>WindowId))
DescribeMaintenanceWindowExecutions(WindowId, args::AbstractDict{String, <:Any}) = ssm("DescribeMaintenanceWindowExecutions", Dict{String, Any}("WindowId"=>WindowId, args...))
...
DescribeMaintenanceWindowSchedule(args::AbstractDict{String, <:Any}) = ssm("DescribeMaintenanceWindowSchedule", args)
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeMaintenanceWindowTargets(WindowId) = ssm("DescribeMaintenanceWindowTargets", Dict{String, Any}("WindowId"=>WindowId))
DescribeMaintenanceWindowTargets(WindowId, args::AbstractDict{String, <:Any}) = ssm("DescribeMaintenanceWindowTargets", Dict{String, Any}("WindowId"=>WindowId, args...))
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeMaintenanceWindowTasks(WindowId) = ssm("DescribeMaintenanceWindowTasks", Dict{String, Any}("WindowId"=>WindowId))
DescribeMaintenanceWindowTasks(WindowId, args::AbstractDict{String, <:Any}) = ssm("DescribeMaintenanceWindowTasks", Dict{String, Any}("WindowId"=>WindowId, args...))
...
DescribeMaintenanceWindows(args::AbstractDict{String, <:Any}) = ssm("DescribeMaintenanceWindows", args)
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeMaintenanceWindowsForTarget(ResourceType, Targets) = ssm("DescribeMaintenanceWindowsForTarget", Dict{String, Any}("ResourceType"=>ResourceType, "Targets"=>Targets))
DescribeMaintenanceWindowsForTarget(ResourceType, Targets, args::AbstractDict{String, <:Any}) = ssm("DescribeMaintenanceWindowsForTarget", Dict{String, Any}("ResourceType"=>ResourceType, "Targets"=>Targets, args...))
...
DescribeOpsItems(args::AbstractDict{String, <:Any}) = ssm("DescribeOpsItems", args)
...
DescribeParameters(args::AbstractDict{String, <:Any}) = ssm("DescribeParameters", args)
...
DescribePatchBaselines(args::AbstractDict{String, <:Any}) = ssm("DescribePatchBaselines", args)
...
"""
DescribePatchGroupState(PatchGroup) = ssm("DescribePatchGroupState", Dict{String, Any}("PatchGroup"=>PatchGroup))
DescribePatchGroupState(PatchGroup, args::AbstractDict{String, <:Any}) = ssm("DescribePatchGroupState", Dict{String, Any}("PatchGroup"=>PatchGroup, args...))
...
DescribePatchGroups(args::AbstractDict{String, <:Any}) = ssm("DescribePatchGroups", args)
...
"""
DescribePatchProperties(OperatingSystem, Property) = ssm("DescribePatchProperties", Dict{String, Any}("OperatingSystem"=>OperatingSystem, "Property"=>Property))
DescribePatchProperties(OperatingSystem, Property, args::AbstractDict{String, <:Any}) = ssm("DescribePatchProperties", Dict{String, Any}("OperatingSystem"=>OperatingSystem, "Property"=>Property, args...))
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeSessions(State) = ssm("DescribeSessions", Dict{String, Any}("State"=>State))
DescribeSessions(State, args::AbstractDict{String, <:Any}) = ssm("DescribeSessions", Dict{String, Any}("State"=>State, args...))
...
"""
GetAutomationExecution(AutomationExecutionId) = ssm("GetAutomationExecution", Dict{String, Any}("AutomationExecutionId"=>AutomationExecutionId))
GetAutomationExecution(AutomationExecutionId, args::AbstractDict{String, <:Any}) = ssm("GetAutomationExecution", Dict{String, Any}("AutomationExecutionId"=>AutomationExecutionId, args...))
...
"""
GetCalendarState(CalendarNames) = ssm("GetCalendarState", Dict{String, Any}("CalendarNames"=>CalendarNames))
GetCalendarState(CalendarNames, args::AbstractDict{String, <:Any}) = ssm("GetCalendarState", Dict{String, Any}("CalendarNames"=>CalendarNames, args...))
...
"""
GetCommandInvocation(CommandId, InstanceId) = ssm("GetCommandInvocation", Dict{String, Any}("CommandId"=>CommandId, "InstanceId"=>InstanceId))
GetCommandInvocation(CommandId, InstanceId, args::AbstractDict{String, <:Any}) = ssm("GetCommandInvocation", Dict{String, Any}("CommandId"=>CommandId, "InstanceId"=>InstanceId, args...))
...
"""
GetConnectionStatus(Target) = ssm("GetConnectionStatus", Dict{String, Any}("Target"=>Target))
GetConnectionStatus(Target, args::AbstractDict{String, <:Any}) = ssm("GetConnectionStatus", Dict{String, Any}("Target"=>Target, args...))
...
GetDefaultPatchBaseline(args::AbstractDict{String, <:Any}) = ssm("GetDefaultPatchBaseline", args)
...
"""
GetDeployablePatchSnapshotForInstance(InstanceId, SnapshotId) = ssm("GetDeployablePatchSnapshotForInstance", Dict{String, Any}("InstanceId"=>InstanceId, "SnapshotId"=>SnapshotId))
GetDeployablePatchSnapshotForInstance(InstanceId, SnapshotId, args::AbstractDict{String, <:Any}) = ssm("GetDeployablePatchSnapshotForInstance", Dict{String, Any}("InstanceId"=>InstanceId, "SnapshotId"=>SnapshotId, args...))
...
"""
GetDocument(Name) = ssm("GetDocument", Dict{String, Any}("Name"=>Name))
GetDocument(Name, args::AbstractDict{String, <:Any}) = ssm("GetDocument", Dict{String, Any}("Name"=>Name, args...))
...
GetInventory(args::AbstractDict{String, <:Any}) = ssm("GetInventory", args)
...
GetInventorySchema(args::AbstractDict{String, <:Any}) = ssm("GetInventorySchema", args)
...
"""
GetMaintenanceWindow(WindowId) = ssm("GetMaintenanceWindow", Dict{String, Any}("WindowId"=>WindowId))
GetMaintenanceWindow(WindowId, args::AbstractDict{String, <:Any}) = ssm("GetMaintenanceWindow", Dict{String, Any}("WindowId"=>WindowId, args...))
...
"""
GetMaintenanceWindowExecution(WindowExecutionId) = ssm("GetMaintenanceWindowExecution", Dict{String, Any}("WindowExecutionId"=>WindowExecutionId))
GetMaintenanceWindowExecution(WindowExecutionId, args::AbstractDict{String, <:Any}) = ssm("GetMaintenanceWindowExecution", Dict{String, Any}("WindowExecutionId"=>WindowExecutionId, args...))
...
"""
GetMaintenanceWindowExecutionTask(TaskId, WindowExecutionId) = ssm("GetMaintenanceWindowExecutionTask", Dict{String, Any}("TaskId"=>TaskId, "WindowExecutionId"=>WindowExecutionId))
GetMaintenanceWindowExecutionTask(TaskId, WindowExecutionId, args::AbstractDict{String, <:Any}) = ssm("GetMaintenanceWindowExecutionTask", Dict{String, Any}("TaskId"=>TaskId, "WindowExecutionId"=>WindowExecutionId, args...))
...
"""
GetMaintenanceWindowExecutionTaskInvocation(InvocationId, TaskId, WindowExecutionId) = ssm("GetMaintenanceWindowExecutionTaskInvocation", Dict{String, Any}("InvocationId"=>InvocationId, "TaskId"=>TaskId, "WindowExecutionId"=>WindowExecutionId))
GetMaintenanceWindowExecutionTaskInvocation(InvocationId, TaskId, WindowExecutionId, args::AbstractDict{String, <:Any}) = ssm("GetMaintenanceWindowExecutionTaskInvocation", Dict{String, Any}("InvocationId"=>InvocationId, "TaskId"=>TaskId, "WindowExecutionId"=>WindowExecutionId, args...))
...
"""
GetMaintenanceWindowTask(WindowId, WindowTaskId) = ssm("GetMaintenanceWindowTask", Dict{String, Any}("WindowId"=>WindowId, "WindowTaskId"=>WindowTaskId))
GetMaintenanceWindowTask(WindowId, WindowTaskId, args::AbstractDict{String, <:Any}) = ssm("GetMaintenanceWindowTask", Dict{String, Any}("WindowId"=>WindowId, "WindowTaskId"=>WindowTaskId, args...))
...
"""
GetOpsItem(OpsItemId) = ssm("GetOpsItem", Dict{String, Any}("OpsItemId"=>OpsItemId))
GetOpsItem(OpsItemId, args::AbstractDict{String, <:Any}) = ssm("GetOpsItem", Dict{String, Any}("OpsItemId"=>OpsItemId, args...))
...
GetOpsSummary(args::AbstractDict{String, <:Any}) = ssm("GetOpsSummary", args)
...
"""
GetParameter(Name) = ssm("GetParameter", Dict{String, Any}("Name"=>Name))
GetParameter(Name, args::AbstractDict{String, <:Any}) = ssm("GetParameter", Dict{String, Any}("Name"=>Name, args...))
...
- `WithDecryption`: Return decrypted values for secure string parameters. This flag is ignored for String and StringList parameter types.
"""
GetParameterHistory(Name) = ssm("GetParameterHistory", Dict{String, Any}("Name"=>Name))
GetParameterHistory(Name, args::AbstractDict{String, <:Any}) = ssm("GetParameterHistory", Dict{String, Any}("Name"=>Name, args...))
...
"""
GetParameters(Names) = ssm("GetParameters", Dict{String, Any}("Names"=>Names))
GetParameters(Names, args::AbstractDict{String, <:Any}) = ssm("GetParameters", Dict{String, Any}("Names"=>Names, args...))
...
"""
GetParametersByPath(Path) = ssm("GetParametersByPath", Dict{String, Any}("Path"=>Path))
GetParametersByPath(Path, args::AbstractDict{String, <:Any}) = ssm("GetParametersByPath", Dict{String, Any}("Path"=>Path, args...))
...
"""
GetPatchBaseline(BaselineId) = ssm("GetPatchBaseline", Dict{String, Any}("BaselineId"=>BaselineId))
GetPatchBaseline(BaselineId, args::AbstractDict{String, <:Any}) = ssm("GetPatchBaseline", Dict{String, Any}("BaselineId"=>BaselineId, args...))
...
"""
GetPatchBaselineForPatchGroup(PatchGroup) = ssm("GetPatchBaselineForPatchGroup", Dict{String, Any}("PatchGroup"=>PatchGroup))
GetPatchBaselineForPatchGroup(PatchGroup, args::AbstractDict{String, <:Any}) = ssm("GetPatchBaselineForPatchGroup", Dict{String, Any}("PatchGroup"=>PatchGroup, args...))
...
"""
GetServiceSetting(SettingId) = ssm("GetServiceSetting", Dict{String, Any}("SettingId"=>SettingId))
GetServiceSetting(SettingId, args::AbstractDict{String, <:Any}) = ssm("GetServiceSetting", Dict{String, Any}("SettingId"=>SettingId, args...))
...
"""
LabelParameterVersion(Labels, Name) = ssm("LabelParameterVersion", Dict{String, Any}("Labels"=>Labels, "Name"=>Name))
LabelParameterVersion(Labels, Name, args::AbstractDict{String, <:Any}) = ssm("LabelParameterVersion", Dict{String, Any}("Labels"=>Labels, "Name"=>Name, args...))
...
- `NextToken`: A token to start the list. Use this token to get the next set of results. 
"""
ListAssociationVersions(AssociationId) = ssm("ListAssociationVersions", Dict{String, Any}("AssociationId"=>AssociationId))
ListAssociationVersions(AssociationId, args::AbstractDict{String, <:Any}) = ssm("ListAssociationVersions", Dict{String, Any}("AssociationId"=>AssociationId, args...))
...
ListAssociations(args::AbstractDict{String, <:Any}) = ssm("ListAssociations", args)
...
ListCommandInvocations(args::AbstractDict{String, <:Any}) = ssm("ListCommandInvocations", args)
...
ListCommands(args::AbstractDict{String, <:Any}) = ssm("ListCommands", args)
...
ListComplianceItems(args::AbstractDict{String, <:Any}) = ssm("ListComplianceItems", args)
...
ListComplianceSummaries(args::AbstractDict{String, <:Any}) = ssm("ListComplianceSummaries", args)
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
ListDocumentVersions(Name) = ssm("ListDocumentVersions", Dict{String, Any}("Name"=>Name))
ListDocumentVersions(Name, args::AbstractDict{String, <:Any}) = ssm("ListDocumentVersions", Dict{String, Any}("Name"=>Name, args...))
...
ListDocuments(args::AbstractDict{String, <:Any}) = ssm("ListDocuments", args)
...
- `NextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
ListInventoryEntries(InstanceId, TypeName) = ssm("ListInventoryEntries", Dict{String, Any}("InstanceId"=>InstanceId, "TypeName"=>TypeName))
ListInventoryEntries(InstanceId, TypeName, args::AbstractDict{String, <:Any}) = ssm("ListInventoryEntries", Dict{String, Any}("InstanceId"=>InstanceId, "TypeName"=>TypeName, args...))
...
ListResourceComplianceSummaries(args::AbstractDict{String, <:Any}) = ssm("ListResourceComplianceSummaries", args)
...
ListResourceDataSync(args::AbstractDict{String, <:Any}) = ssm("ListResourceDataSync", args)
...
"""
ListTagsForResource(ResourceId, ResourceType) = ssm("ListTagsForResource", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType))
ListTagsForResource(ResourceId, ResourceType, args::AbstractDict{String, <:Any}) = ssm("ListTagsForResource", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, args...))
...
"""
ModifyDocumentPermission(Name, PermissionType) = ssm("ModifyDocumentPermission", Dict{String, Any}("Name"=>Name, "PermissionType"=>PermissionType))
ModifyDocumentPermission(Name, PermissionType, args::AbstractDict{String, <:Any}) = ssm("ModifyDocumentPermission", Dict{String, Any}("Name"=>Name, "PermissionType"=>PermissionType, args...))
...
"""
PutComplianceItems(ComplianceType, ExecutionSummary, Items, ResourceId, ResourceType) = ssm("PutComplianceItems", Dict{String, Any}("ComplianceType"=>ComplianceType, "ExecutionSummary"=>ExecutionSummary, "Items"=>Items, "ResourceId"=>ResourceId, "ResourceType"=>ResourceType))
PutComplianceItems(ComplianceType, ExecutionSummary, Items, ResourceId, ResourceType, args::AbstractDict{String, <:Any}) = ssm("PutComplianceItems", Dict{String, Any}("ComplianceType"=>ComplianceType, "ExecutionSummary"=>ExecutionSummary, "Items"=>Items, "ResourceId"=>ResourceId, "ResourceType"=>ResourceType, args...))
...
"""
PutInventory(InstanceId, Items) = ssm("PutInventory", Dict{String, Any}("InstanceId"=>InstanceId, "Items"=>Items))
PutInventory(InstanceId, Items, args::AbstractDict{String, <:Any}) = ssm("PutInventory", Dict{String, Any}("InstanceId"=>InstanceId, "Items"=>Items, args...))
...
"""
PutParameter(Name, Value) = ssm("PutParameter", Dict{String, Any}("Name"=>Name, "Value"=>Value))
PutParameter(Name, Value, args::AbstractDict{String, <:Any}) = ssm("PutParameter", Dict{String, Any}("Name"=>Name, "Value"=>Value, args...))
...
"""
RegisterDefaultPatchBaseline(BaselineId) = ssm("RegisterDefaultPatchBaseline", Dict{String, Any}("BaselineId"=>BaselineId))
RegisterDefaultPatchBaseline(BaselineId, args::AbstractDict{String, <:Any}) = ssm("RegisterDefaultPatchBaseline", Dict{String, Any}("BaselineId"=>BaselineId, args...))
...
"""
RegisterPatchBaselineForPatchGroup(BaselineId, PatchGroup) = ssm("RegisterPatchBaselineForPatchGroup", Dict{String, Any}("BaselineId"=>BaselineId, "PatchGroup"=>PatchGroup))
RegisterPatchBaselineForPatchGroup(BaselineId, PatchGroup, args::AbstractDict{String, <:Any}) = ssm("RegisterPatchBaselineForPatchGroup", Dict{String, Any}("BaselineId"=>BaselineId, "PatchGroup"=>PatchGroup, args...))
...
"""
RegisterTargetWithMaintenanceWindow(ResourceType, Targets, WindowId) = ssm("RegisterTargetWithMaintenanceWindow", Dict{String, Any}("ResourceType"=>ResourceType, "Targets"=>Targets, "WindowId"=>WindowId, "ClientToken"=>string(uuid4())))
RegisterTargetWithMaintenanceWindow(ResourceType, Targets, WindowId, args::AbstractDict{String, <:Any}) = ssm("RegisterTargetWithMaintenanceWindow", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceType"=>ResourceType, "Targets"=>Targets, "WindowId"=>WindowId, "ClientToken"=>string(uuid4())), args)))
...
"""
RegisterTaskWithMaintenanceWindow(MaxConcurrency, MaxErrors, Targets, TaskArn, TaskType, WindowId) = ssm("RegisterTaskWithMaintenanceWindow", Dict{String, Any}("MaxConcurrency"=>MaxConcurrency, "MaxErrors"=>MaxErrors, "Targets"=>Targets, "TaskArn"=>TaskArn, "TaskType"=>TaskType, "WindowId"=>WindowId, "ClientToken"=>string(uuid4())))
RegisterTaskWithMaintenanceWindow(MaxConcurrency, MaxErrors, Targets, TaskArn, TaskType, WindowId, args::AbstractDict{String, <:Any}) = ssm("RegisterTaskWithMaintenanceWindow", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MaxConcurrency"=>MaxConcurrency, "MaxErrors"=>MaxErrors, "Targets"=>Targets, "TaskArn"=>TaskArn, "TaskType"=>TaskType, "WindowId"=>WindowId, "ClientToken"=>string(uuid4())), args)))
...
"""
RemoveTagsFromResource(ResourceId, ResourceType, TagKeys) = ssm("RemoveTagsFromResource", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, "TagKeys"=>TagKeys))
RemoveTagsFromResource(ResourceId, ResourceType, TagKeys, args::AbstractDict{String, <:Any}) = ssm("RemoveTagsFromResource", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, "TagKeys"=>TagKeys, args...))
...
"""
ResetServiceSetting(SettingId) = ssm("ResetServiceSetting", Dict{String, Any}("SettingId"=>SettingId))
ResetServiceSetting(SettingId, args::AbstractDict{String, <:Any}) = ssm("ResetServiceSetting", Dict{String, Any}("SettingId"=>SettingId, args...))
...
"""
ResumeSession(SessionId) = ssm("ResumeSession", Dict{String, Any}("SessionId"=>SessionId))
ResumeSession(SessionId, args::AbstractDict{String, <:Any}) = ssm("ResumeSession", Dict{String, Any}("SessionId"=>SessionId, args...))
...
"""
SendAutomationSignal(AutomationExecutionId, SignalType) = ssm("SendAutomationSignal", Dict{String, Any}("AutomationExecutionId"=>AutomationExecutionId, "SignalType"=>SignalType))
SendAutomationSignal(AutomationExecutionId, SignalType, args::AbstractDict{String, <:Any}) = ssm("SendAutomationSignal", Dict{String, Any}("AutomationExecutionId"=>AutomationExecutionId, "SignalType"=>SignalType, args...))
...
"""
SendCommand(DocumentName) = ssm("SendCommand", Dict{String, Any}("DocumentName"=>DocumentName))
SendCommand(DocumentName, args::AbstractDict{String, <:Any}) = ssm("SendCommand", Dict{String, Any}("DocumentName"=>DocumentName, args...))
...
"""
StartAssociationsOnce(AssociationIds) = ssm("StartAssociationsOnce", Dict{String, Any}("AssociationIds"=>AssociationIds))
StartAssociationsOnce(AssociationIds, args::AbstractDict{String, <:Any}) = ssm("StartAssociationsOnce", Dict{String, Any}("AssociationIds"=>AssociationIds, args...))
...
"""
StartAutomationExecution(DocumentName) = ssm("StartAutomationExecution", Dict{String, Any}("DocumentName"=>DocumentName))
StartAutomationExecution(DocumentName, args::AbstractDict{String, <:Any}) = ssm("StartAutomationExecution", Dict{String, Any}("DocumentName"=>DocumentName, args...))
...
"""
StartSession(Target) = ssm("StartSession", Dict{String, Any}("Target"=>Target))
StartSession(Target, args::AbstractDict{String, <:Any}) = ssm("StartSession", Dict{String, Any}("Target"=>Target, args...))
...
"""
StopAutomationExecution(AutomationExecutionId) = ssm("StopAutomationExecution", Dict{String, Any}("AutomationExecutionId"=>AutomationExecutionId))
StopAutomationExecution(AutomationExecutionId, args::AbstractDict{String, <:Any}) = ssm("StopAutomationExecution", Dict{String, Any}("AutomationExecutionId"=>AutomationExecutionId, args...))
...
"""
TerminateSession(SessionId) = ssm("TerminateSession", Dict{String, Any}("SessionId"=>SessionId))
TerminateSession(SessionId, args::AbstractDict{String, <:Any}) = ssm("TerminateSession", Dict{String, Any}("SessionId"=>SessionId, args...))
...
"""
UpdateAssociation(AssociationId) = ssm("UpdateAssociation", Dict{String, Any}("AssociationId"=>AssociationId))
UpdateAssociation(AssociationId, args::AbstractDict{String, <:Any}) = ssm("UpdateAssociation", Dict{String, Any}("AssociationId"=>AssociationId, args...))
...
"""
UpdateAssociationStatus(AssociationStatus, InstanceId, Name) = ssm("UpdateAssociationStatus", Dict{String, Any}("AssociationStatus"=>AssociationStatus, "InstanceId"=>InstanceId, "Name"=>Name))
UpdateAssociationStatus(AssociationStatus, InstanceId, Name, args::AbstractDict{String, <:Any}) = ssm("UpdateAssociationStatus", Dict{String, Any}("AssociationStatus"=>AssociationStatus, "InstanceId"=>InstanceId, "Name"=>Name, args...))
...
"""
UpdateDocument(Content, Name) = ssm("UpdateDocument", Dict{String, Any}("Content"=>Content, "Name"=>Name))
UpdateDocument(Content, Name, args::AbstractDict{String, <:Any}) = ssm("UpdateDocument", Dict{String, Any}("Content"=>Content, "Name"=>Name, args...))
...
"""
UpdateDocumentDefaultVersion(DocumentVersion, Name) = ssm("UpdateDocumentDefaultVersion", Dict{String, Any}("DocumentVersion"=>DocumentVersion, "Name"=>Name))
UpdateDocumentDefaultVersion(DocumentVersion, Name, args::AbstractDict{String, <:Any}) = ssm("UpdateDocumentDefaultVersion", Dict{String, Any}("DocumentVersion"=>DocumentVersion, "Name"=>Name, args...))
...
"""
UpdateMaintenanceWindow(WindowId) = ssm("UpdateMaintenanceWindow", Dict{String, Any}("WindowId"=>WindowId))
UpdateMaintenanceWindow(WindowId, args::AbstractDict{String, <:Any}) = ssm("UpdateMaintenanceWindow", Dict{String, Any}("WindowId"=>WindowId, args...))
...
"""
UpdateMaintenanceWindowTarget(WindowId, WindowTargetId) = ssm("UpdateMaintenanceWindowTarget", Dict{String, Any}("WindowId"=>WindowId, "WindowTargetId"=>WindowTargetId))
UpdateMaintenanceWindowTarget(WindowId, WindowTargetId, args::AbstractDict{String, <:Any}) = ssm("UpdateMaintenanceWindowTarget", Dict{String, Any}("WindowId"=>WindowId, "WindowTargetId"=>WindowTargetId, args...))
...
"""
UpdateMaintenanceWindowTask(WindowId, WindowTaskId) = ssm("UpdateMaintenanceWindowTask", Dict{String, Any}("WindowId"=>WindowId, "WindowTaskId"=>WindowTaskId))
UpdateMaintenanceWindowTask(WindowId, WindowTaskId, args::AbstractDict{String, <:Any}) = ssm("UpdateMaintenanceWindowTask", Dict{String, Any}("WindowId"=>WindowId, "WindowTaskId"=>WindowTaskId, args...))
...
"""
UpdateManagedInstanceRole(IamRole, InstanceId) = ssm("UpdateManagedInstanceRole", Dict{String, Any}("IamRole"=>IamRole, "InstanceId"=>InstanceId))
UpdateManagedInstanceRole(IamRole, InstanceId, args::AbstractDict{String, <:Any}) = ssm("UpdateManagedInstanceRole", Dict{String, Any}("IamRole"=>IamRole, "InstanceId"=>InstanceId, args...))
...
- `Title`: A short heading that describes the nature of the OpsItem and the impacted resource.
"""
UpdateOpsItem(OpsItemId) = ssm("UpdateOpsItem", Dict{String, Any}("OpsItemId"=>OpsItemId))
UpdateOpsItem(OpsItemId, args::AbstractDict{String, <:Any}) = ssm("UpdateOpsItem", Dict{String, Any}("OpsItemId"=>OpsItemId, args...))
...
- `Sources`: Information about the patches to use to update the instances, including target operating systems and source repositories. Applies to Linux instances only.
"""
UpdatePatchBaseline(BaselineId) = ssm("UpdatePatchBaseline", Dict{String, Any}("BaselineId"=>BaselineId))
UpdatePatchBaseline(BaselineId, args::AbstractDict{String, <:Any}) = ssm("UpdatePatchBaseline", Dict{String, Any}("BaselineId"=>BaselineId, args...))
...
"""
UpdateResourceDataSync(SyncName, SyncSource, SyncType) = ssm("UpdateResourceDataSync", Dict{String, Any}("SyncName"=>SyncName, "SyncSource"=>SyncSource, "SyncType"=>SyncType))
UpdateResourceDataSync(SyncName, SyncSource, SyncType, args::AbstractDict{String, <:Any}) = ssm("UpdateResourceDataSync", Dict{String, Any}("SyncName"=>SyncName, "SyncSource"=>SyncSource, "SyncType"=>SyncType, args...))
...
"""
UpdateServiceSetting(SettingId, SettingValue) = ssm("UpdateServiceSetting", Dict{String, Any}("SettingId"=>SettingId, "SettingValue"=>SettingValue))
UpdateServiceSetting(SettingId, SettingValue, args::AbstractDict{String, <:Any}) = ssm("UpdateServiceSetting", Dict{String, Any}("SettingId"=>SettingId, "SettingValue"=>SettingValue, args...))
