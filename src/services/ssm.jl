...
"""
CreateMaintenanceWindow(AllowUnassociatedTargets, Cutoff, Duration, Name, Schedule) = ssm("CreateMaintenanceWindow", Dict{String, Any}("AllowUnassociatedTargets"=>AllowUnassociatedTargets, "Cutoff"=>Cutoff, "Duration"=>Duration, "Name"=>Name, "Schedule"=>Schedule))
CreateMaintenanceWindow(AllowUnassociatedTargets, Cutoff, Duration, Name, Schedule, args::AbstractDict{String, <: Any}) = ssm("CreateMaintenanceWindow", Dict{String, Any}("AllowUnassociatedTargets"=>AllowUnassociatedTargets, "Cutoff"=>Cutoff, "Duration"=>Duration, "Name"=>Name, "Schedule"=>Schedule, args...))
...
"""
CreatePatchBaseline(Name) = ssm("CreatePatchBaseline", Dict{String, Any}("Name"=>Name))
CreatePatchBaseline(Name, args::AbstractDict{String, <: Any}) = ssm("CreatePatchBaseline", Dict{String, Any}("Name"=>Name, args...))
...
"""
DeleteInventory(TypeName) = ssm("DeleteInventory", Dict{String, Any}("TypeName"=>TypeName))
DeleteInventory(TypeName, args::AbstractDict{String, <: Any}) = ssm("DeleteInventory", Dict{String, Any}("TypeName"=>TypeName, args...))
...
"""
RegisterTargetWithMaintenanceWindow(ResourceType, Targets, WindowId) = ssm("RegisterTargetWithMaintenanceWindow", Dict{String, Any}("ResourceType"=>ResourceType, "Targets"=>Targets, "WindowId"=>WindowId))
RegisterTargetWithMaintenanceWindow(ResourceType, Targets, WindowId, args::AbstractDict{String, <: Any}) = ssm("RegisterTargetWithMaintenanceWindow", Dict{String, Any}("ResourceType"=>ResourceType, "Targets"=>Targets, "WindowId"=>WindowId, args...))
...
"""
RegisterTaskWithMaintenanceWindow(MaxConcurrency, MaxErrors, Targets, TaskArn, TaskType, WindowId) = ssm("RegisterTaskWithMaintenanceWindow", Dict{String, Any}("MaxConcurrency"=>MaxConcurrency, "MaxErrors"=>MaxErrors, "Targets"=>Targets, "TaskArn"=>TaskArn, "TaskType"=>TaskType, "WindowId"=>WindowId))
RegisterTaskWithMaintenanceWindow(MaxConcurrency, MaxErrors, Targets, TaskArn, TaskType, WindowId, args::AbstractDict{String, <: Any}) = ssm("RegisterTaskWithMaintenanceWindow", Dict{String, Any}("MaxConcurrency"=>MaxConcurrency, "MaxErrors"=>MaxErrors, "Targets"=>Targets, "TaskArn"=>TaskArn, "TaskType"=>TaskType, "WindowId"=>WindowId, args...))
