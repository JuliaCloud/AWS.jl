...
- `MaxResults`: The maximum number of results to return with a single call. To retrieve the
  remaining results, if any, make another call with the token returned from this call.
...
# Required Parameters
- `ResourceARN`: The Amazon Resource Name (ARN) for the applied quota for which you want to
  list tags. You can get this information by using the Service Quotas console, or by listing
  the quotas using the list-service-quotas AWS CLI command or the ListServiceQuotas AWS API
  operation.
...
# Required Parameters
- `ResourceARN`: The Amazon Resource Name (ARN) for the applied quota. You can get this
...
# Required Parameters
- `ResourceARN`: The Amazon Resource Name (ARN) for the applied quota that you want to
