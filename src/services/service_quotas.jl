...
AssociateServiceQuotaTemplate(args::AbstractDict{String, <: Any}) = service_quotas("AssociateServiceQuotaTemplate", args)
...
"""
DeleteServiceQuotaIncreaseRequestFromTemplate(AwsRegion, QuotaCode, ServiceCode) = service_quotas("DeleteServiceQuotaIncreaseRequestFromTemplate", Dict{String, Any}("AwsRegion"=>AwsRegion, "QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode))
DeleteServiceQuotaIncreaseRequestFromTemplate(AwsRegion, QuotaCode, ServiceCode, args::AbstractDict{String, <: Any}) = service_quotas("DeleteServiceQuotaIncreaseRequestFromTemplate", Dict{String, Any}("AwsRegion"=>AwsRegion, "QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode, args...))
...
DisassociateServiceQuotaTemplate(args::AbstractDict{String, <: Any}) = service_quotas("DisassociateServiceQuotaTemplate", args)
...
"""
GetAWSDefaultServiceQuota(QuotaCode, ServiceCode) = service_quotas("GetAWSDefaultServiceQuota", Dict{String, Any}("QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode))
GetAWSDefaultServiceQuota(QuotaCode, ServiceCode, args::AbstractDict{String, <: Any}) = service_quotas("GetAWSDefaultServiceQuota", Dict{String, Any}("QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode, args...))
...
GetAssociationForServiceQuotaTemplate(args::AbstractDict{String, <: Any}) = service_quotas("GetAssociationForServiceQuotaTemplate", args)
...
"""
GetRequestedServiceQuotaChange(RequestId) = service_quotas("GetRequestedServiceQuotaChange", Dict{String, Any}("RequestId"=>RequestId))
GetRequestedServiceQuotaChange(RequestId, args::AbstractDict{String, <: Any}) = service_quotas("GetRequestedServiceQuotaChange", Dict{String, Any}("RequestId"=>RequestId, args...))
...
"""
GetServiceQuota(QuotaCode, ServiceCode) = service_quotas("GetServiceQuota", Dict{String, Any}("QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode))
GetServiceQuota(QuotaCode, ServiceCode, args::AbstractDict{String, <: Any}) = service_quotas("GetServiceQuota", Dict{String, Any}("QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode, args...))
...
"""
GetServiceQuotaIncreaseRequestFromTemplate(AwsRegion, QuotaCode, ServiceCode) = service_quotas("GetServiceQuotaIncreaseRequestFromTemplate", Dict{String, Any}("AwsRegion"=>AwsRegion, "QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode))
GetServiceQuotaIncreaseRequestFromTemplate(AwsRegion, QuotaCode, ServiceCode, args::AbstractDict{String, <: Any}) = service_quotas("GetServiceQuotaIncreaseRequestFromTemplate", Dict{String, Any}("AwsRegion"=>AwsRegion, "QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode, args...))
...
"""
ListAWSDefaultServiceQuotas(ServiceCode) = service_quotas("ListAWSDefaultServiceQuotas", Dict{String, Any}("ServiceCode"=>ServiceCode))
ListAWSDefaultServiceQuotas(ServiceCode, args::AbstractDict{String, <: Any}) = service_quotas("ListAWSDefaultServiceQuotas", Dict{String, Any}("ServiceCode"=>ServiceCode, args...))
...
ListRequestedServiceQuotaChangeHistory(args::AbstractDict{String, <: Any}) = service_quotas("ListRequestedServiceQuotaChangeHistory", args)
...
Status => Specifies the status value of the quota increase request.
"""
ListRequestedServiceQuotaChangeHistoryByQuota(QuotaCode, ServiceCode) = service_quotas("ListRequestedServiceQuotaChangeHistoryByQuota", Dict{String, Any}("QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode))
ListRequestedServiceQuotaChangeHistoryByQuota(QuotaCode, ServiceCode, args::AbstractDict{String, <: Any}) = service_quotas("ListRequestedServiceQuotaChangeHistoryByQuota", Dict{String, Any}("QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode, args...))
...
ListServiceQuotaIncreaseRequestsInTemplate(args::AbstractDict{String, <: Any}) = service_quotas("ListServiceQuotaIncreaseRequestsInTemplate", args)
...
NextToken => (Optional) Use this parameter in a request if you receive a NextToken response in a previous request that indicates that there's more output available. In a subsequent call, set it to the value of the previous call's NextToken response to indicate where the output should continue from.
"""
ListServiceQuotas(ServiceCode) = service_quotas("ListServiceQuotas", Dict{String, Any}("ServiceCode"=>ServiceCode))
ListServiceQuotas(ServiceCode, args::AbstractDict{String, <: Any}) = service_quotas("ListServiceQuotas", Dict{String, Any}("ServiceCode"=>ServiceCode, args...))
...
ListServices(args::AbstractDict{String, <: Any}) = service_quotas("ListServices", args)
...
"""
PutServiceQuotaIncreaseRequestIntoTemplate(AwsRegion, DesiredValue, QuotaCode, ServiceCode) = service_quotas("PutServiceQuotaIncreaseRequestIntoTemplate", Dict{String, Any}("AwsRegion"=>AwsRegion, "DesiredValue"=>DesiredValue, "QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode))
PutServiceQuotaIncreaseRequestIntoTemplate(AwsRegion, DesiredValue, QuotaCode, ServiceCode, args::AbstractDict{String, <: Any}) = service_quotas("PutServiceQuotaIncreaseRequestIntoTemplate", Dict{String, Any}("AwsRegion"=>AwsRegion, "DesiredValue"=>DesiredValue, "QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode, args...))
...
"""
RequestServiceQuotaIncrease(DesiredValue, QuotaCode, ServiceCode) = service_quotas("RequestServiceQuotaIncrease", Dict{String, Any}("DesiredValue"=>DesiredValue, "QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode))
RequestServiceQuotaIncrease(DesiredValue, QuotaCode, ServiceCode, args::AbstractDict{String, <: Any}) = service_quotas("RequestServiceQuotaIncrease", Dict{String, Any}("DesiredValue"=>DesiredValue, "QuotaCode"=>QuotaCode, "ServiceCode"=>ServiceCode, args...))
