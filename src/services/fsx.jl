...
"""
CancelDataRepositoryTask(TaskId) = fsx("CancelDataRepositoryTask", Dict{String, Any}("TaskId"=>TaskId))
CancelDataRepositoryTask(TaskId, args::AbstractDict{String, <:Any}) = fsx("CancelDataRepositoryTask", Dict{String, Any}("TaskId"=>TaskId, args...))
...
"""
CreateBackup(FileSystemId) = fsx("CreateBackup", Dict{String, Any}("FileSystemId"=>FileSystemId, "ClientRequestToken"=>string(uuid4())))
CreateBackup(FileSystemId, args::AbstractDict{String, <:Any}) = fsx("CreateBackup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FileSystemId"=>FileSystemId, "ClientRequestToken"=>string(uuid4())), args)))
...
- `Tags`: 
"""
CreateDataRepositoryTask(FileSystemId, Report, Type) = fsx("CreateDataRepositoryTask", Dict{String, Any}("FileSystemId"=>FileSystemId, "Report"=>Report, "Type"=>Type, "ClientRequestToken"=>string(uuid4())))
CreateDataRepositoryTask(FileSystemId, Report, Type, args::AbstractDict{String, <:Any}) = fsx("CreateDataRepositoryTask", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FileSystemId"=>FileSystemId, "Report"=>Report, "Type"=>Type, "ClientRequestToken"=>string(uuid4())), args)))
...
"""
CreateFileSystem(FileSystemType, StorageCapacity, SubnetIds) = fsx("CreateFileSystem", Dict{String, Any}("FileSystemType"=>FileSystemType, "StorageCapacity"=>StorageCapacity, "SubnetIds"=>SubnetIds, "ClientRequestToken"=>string(uuid4())))
CreateFileSystem(FileSystemType, StorageCapacity, SubnetIds, args::AbstractDict{String, <:Any}) = fsx("CreateFileSystem", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FileSystemType"=>FileSystemType, "StorageCapacity"=>StorageCapacity, "SubnetIds"=>SubnetIds, "ClientRequestToken"=>string(uuid4())), args)))
...
"""
CreateFileSystemFromBackup(BackupId, SubnetIds) = fsx("CreateFileSystemFromBackup", Dict{String, Any}("BackupId"=>BackupId, "SubnetIds"=>SubnetIds, "ClientRequestToken"=>string(uuid4())))
CreateFileSystemFromBackup(BackupId, SubnetIds, args::AbstractDict{String, <:Any}) = fsx("CreateFileSystemFromBackup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BackupId"=>BackupId, "SubnetIds"=>SubnetIds, "ClientRequestToken"=>string(uuid4())), args)))
...
"""
DeleteBackup(BackupId) = fsx("DeleteBackup", Dict{String, Any}("BackupId"=>BackupId, "ClientRequestToken"=>string(uuid4())))
DeleteBackup(BackupId, args::AbstractDict{String, <:Any}) = fsx("DeleteBackup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BackupId"=>BackupId, "ClientRequestToken"=>string(uuid4())), args)))
...
"""
DeleteFileSystem(FileSystemId) = fsx("DeleteFileSystem", Dict{String, Any}("FileSystemId"=>FileSystemId, "ClientRequestToken"=>string(uuid4())))
DeleteFileSystem(FileSystemId, args::AbstractDict{String, <:Any}) = fsx("DeleteFileSystem", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FileSystemId"=>FileSystemId, "ClientRequestToken"=>string(uuid4())), args)))
...
DescribeBackups(args::AbstractDict{String, <:Any}) = fsx("DescribeBackups", args)
...
DescribeDataRepositoryTasks(args::AbstractDict{String, <:Any}) = fsx("DescribeDataRepositoryTasks", args)
...
DescribeFileSystems(args::AbstractDict{String, <:Any}) = fsx("DescribeFileSystems", args)
...
"""
ListTagsForResource(ResourceARN) = fsx("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN))
ListTagsForResource(ResourceARN, args::AbstractDict{String, <:Any}) = fsx("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN, args...))
...
"""
TagResource(ResourceARN, Tags) = fsx("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags))
TagResource(ResourceARN, Tags, args::AbstractDict{String, <:Any}) = fsx("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceARN, TagKeys) = fsx("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys))
UntagResource(ResourceARN, TagKeys, args::AbstractDict{String, <:Any}) = fsx("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys, args...))
...
"""
UpdateFileSystem(FileSystemId) = fsx("UpdateFileSystem", Dict{String, Any}("FileSystemId"=>FileSystemId, "ClientRequestToken"=>string(uuid4())))
UpdateFileSystem(FileSystemId, args::AbstractDict{String, <:Any}) = fsx("UpdateFileSystem", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FileSystemId"=>FileSystemId, "ClientRequestToken"=>string(uuid4())), args)))
