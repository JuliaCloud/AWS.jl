...
- `change_requests`: A list of change request objects that are run in order. A change
  ...
  `[ { "changeType": "PUT", "s3Path":"s3://bucket/db/2020.01.02/taq/", "dbPath":"/2020.01.02/taq/"}]`4. This request deletes the 2020.01.02 partition of the database.

`[{ "changeType": "DELETE", "dbPath": "/2020.01.02/"} ]`5. The *DELETE* request allows you to delete the existing files under the 2020.01.02 partition of the database, and the *PUT* request adds a new taq table under it.
