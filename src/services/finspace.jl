...
- `"nextToken"`: A token that indicates where a results page should begin.
"""
function list_kx_databases(environmentId; aws_config::AbstractAWSConfig=current_aws_config())
    return finspace(
        "GET",
        "/kx/environments/$(environmentId)/databases";
        aws_config=aws_config,
...
function update_kx_cluster_databases(
    clusterName, databases, environmentId; aws_config::AbstractAWSConfig=current_aws_config()
)
    return finspace(
        "PUT",
