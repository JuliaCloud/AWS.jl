...
"""
CreateHttpNamespace(Name) = servicediscovery("CreateHttpNamespace", Dict{String, Any}("Name"=>Name))
CreateHttpNamespace(Name, args::AbstractDict{String, <: Any}) = servicediscovery("CreateHttpNamespace", Dict{String, Any}("Name"=>Name, args...))
...
Tags => The tags to add to the namespace. Each tag consists of a key and an optional value, both of which you define. Tag keys can have a maximum character length of 128 characters, and tag values can have a maximum length of 256 characters.
"""
CreatePrivateDnsNamespace(Name, Vpc) = servicediscovery("CreatePrivateDnsNamespace", Dict{String, Any}("Name"=>Name, "Vpc"=>Vpc))
CreatePrivateDnsNamespace(Name, Vpc, args::AbstractDict{String, <: Any}) = servicediscovery("CreatePrivateDnsNamespace", Dict{String, Any}("Name"=>Name, "Vpc"=>Vpc, args...))
...
Tags => The tags to add to the namespace. Each tag consists of a key and an optional value, both of which you define. Tag keys can have a maximum character length of 128 characters, and tag values can have a maximum length of 256 characters.
"""
CreatePublicDnsNamespace(Name) = servicediscovery("CreatePublicDnsNamespace", Dict{String, Any}("Name"=>Name))
CreatePublicDnsNamespace(Name, args::AbstractDict{String, <: Any}) = servicediscovery("CreatePublicDnsNamespace", Dict{String, Any}("Name"=>Name, args...))
...
"""
CreateService(Name) = servicediscovery("CreateService", Dict{String, Any}("Name"=>Name))
CreateService(Name, args::AbstractDict{String, <: Any}) = servicediscovery("CreateService", Dict{String, Any}("Name"=>Name, args...))
...
"""
RegisterInstance(Attributes, InstanceId, ServiceId) = servicediscovery("RegisterInstance", Dict{String, Any}("Attributes"=>Attributes, "InstanceId"=>InstanceId, "ServiceId"=>ServiceId))
RegisterInstance(Attributes, InstanceId, ServiceId, args::AbstractDict{String, <: Any}) = servicediscovery("RegisterInstance", Dict{String, Any}("Attributes"=>Attributes, "InstanceId"=>InstanceId, "ServiceId"=>ServiceId, args...))
