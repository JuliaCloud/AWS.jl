...
"""
AcceptSharedDirectory(SharedDirectoryId) = directory_service("AcceptSharedDirectory", Dict{String, Any}("SharedDirectoryId"=>SharedDirectoryId))
AcceptSharedDirectory(SharedDirectoryId, args::AbstractDict{String, <:Any}) = directory_service("AcceptSharedDirectory", Dict{String, Any}("SharedDirectoryId"=>SharedDirectoryId, args...))
...
"""
AddIpRoutes(DirectoryId, IpRoutes) = directory_service("AddIpRoutes", Dict{String, Any}("DirectoryId"=>DirectoryId, "IpRoutes"=>IpRoutes))
AddIpRoutes(DirectoryId, IpRoutes, args::AbstractDict{String, <:Any}) = directory_service("AddIpRoutes", Dict{String, Any}("DirectoryId"=>DirectoryId, "IpRoutes"=>IpRoutes, args...))
...
"""
AddTagsToResource(ResourceId, Tags) = directory_service("AddTagsToResource", Dict{String, Any}("ResourceId"=>ResourceId, "Tags"=>Tags))
AddTagsToResource(ResourceId, Tags, args::AbstractDict{String, <:Any}) = directory_service("AddTagsToResource", Dict{String, Any}("ResourceId"=>ResourceId, "Tags"=>Tags, args...))
...
"""
CancelSchemaExtension(DirectoryId, SchemaExtensionId) = directory_service("CancelSchemaExtension", Dict{String, Any}("DirectoryId"=>DirectoryId, "SchemaExtensionId"=>SchemaExtensionId))
CancelSchemaExtension(DirectoryId, SchemaExtensionId, args::AbstractDict{String, <:Any}) = directory_service("CancelSchemaExtension", Dict{String, Any}("DirectoryId"=>DirectoryId, "SchemaExtensionId"=>SchemaExtensionId, args...))
...
"""
ConnectDirectory(ConnectSettings, Name, Password, Size) = directory_service("ConnectDirectory", Dict{String, Any}("ConnectSettings"=>ConnectSettings, "Name"=>Name, "Password"=>Password, "Size"=>Size))
ConnectDirectory(ConnectSettings, Name, Password, Size, args::AbstractDict{String, <:Any}) = directory_service("ConnectDirectory", Dict{String, Any}("ConnectSettings"=>ConnectSettings, "Name"=>Name, "Password"=>Password, "Size"=>Size, args...))
...
"""
CreateAlias(Alias, DirectoryId) = directory_service("CreateAlias", Dict{String, Any}("Alias"=>Alias, "DirectoryId"=>DirectoryId))
CreateAlias(Alias, DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("CreateAlias", Dict{String, Any}("Alias"=>Alias, "DirectoryId"=>DirectoryId, args...))
...
"""
CreateComputer(ComputerName, DirectoryId, Password) = directory_service("CreateComputer", Dict{String, Any}("ComputerName"=>ComputerName, "DirectoryId"=>DirectoryId, "Password"=>Password))
CreateComputer(ComputerName, DirectoryId, Password, args::AbstractDict{String, <:Any}) = directory_service("CreateComputer", Dict{String, Any}("ComputerName"=>ComputerName, "DirectoryId"=>DirectoryId, "Password"=>Password, args...))
...
"""
CreateConditionalForwarder(DirectoryId, DnsIpAddrs, RemoteDomainName) = directory_service("CreateConditionalForwarder", Dict{String, Any}("DirectoryId"=>DirectoryId, "DnsIpAddrs"=>DnsIpAddrs, "RemoteDomainName"=>RemoteDomainName))
CreateConditionalForwarder(DirectoryId, DnsIpAddrs, RemoteDomainName, args::AbstractDict{String, <:Any}) = directory_service("CreateConditionalForwarder", Dict{String, Any}("DirectoryId"=>DirectoryId, "DnsIpAddrs"=>DnsIpAddrs, "RemoteDomainName"=>RemoteDomainName, args...))
...
"""
CreateDirectory(Name, Password, Size) = directory_service("CreateDirectory", Dict{String, Any}("Name"=>Name, "Password"=>Password, "Size"=>Size))
CreateDirectory(Name, Password, Size, args::AbstractDict{String, <:Any}) = directory_service("CreateDirectory", Dict{String, Any}("Name"=>Name, "Password"=>Password, "Size"=>Size, args...))
...
"""
CreateLogSubscription(DirectoryId, LogGroupName) = directory_service("CreateLogSubscription", Dict{String, Any}("DirectoryId"=>DirectoryId, "LogGroupName"=>LogGroupName))
CreateLogSubscription(DirectoryId, LogGroupName, args::AbstractDict{String, <:Any}) = directory_service("CreateLogSubscription", Dict{String, Any}("DirectoryId"=>DirectoryId, "LogGroupName"=>LogGroupName, args...))
...
"""
CreateMicrosoftAD(Name, Password, VpcSettings) = directory_service("CreateMicrosoftAD", Dict{String, Any}("Name"=>Name, "Password"=>Password, "VpcSettings"=>VpcSettings))
CreateMicrosoftAD(Name, Password, VpcSettings, args::AbstractDict{String, <:Any}) = directory_service("CreateMicrosoftAD", Dict{String, Any}("Name"=>Name, "Password"=>Password, "VpcSettings"=>VpcSettings, args...))
...
"""
CreateSnapshot(DirectoryId) = directory_service("CreateSnapshot", Dict{String, Any}("DirectoryId"=>DirectoryId))
CreateSnapshot(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("CreateSnapshot", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
"""
CreateTrust(DirectoryId, RemoteDomainName, TrustDirection, TrustPassword) = directory_service("CreateTrust", Dict{String, Any}("DirectoryId"=>DirectoryId, "RemoteDomainName"=>RemoteDomainName, "TrustDirection"=>TrustDirection, "TrustPassword"=>TrustPassword))
CreateTrust(DirectoryId, RemoteDomainName, TrustDirection, TrustPassword, args::AbstractDict{String, <:Any}) = directory_service("CreateTrust", Dict{String, Any}("DirectoryId"=>DirectoryId, "RemoteDomainName"=>RemoteDomainName, "TrustDirection"=>TrustDirection, "TrustPassword"=>TrustPassword, args...))
...
"""
DeleteConditionalForwarder(DirectoryId, RemoteDomainName) = directory_service("DeleteConditionalForwarder", Dict{String, Any}("DirectoryId"=>DirectoryId, "RemoteDomainName"=>RemoteDomainName))
DeleteConditionalForwarder(DirectoryId, RemoteDomainName, args::AbstractDict{String, <:Any}) = directory_service("DeleteConditionalForwarder", Dict{String, Any}("DirectoryId"=>DirectoryId, "RemoteDomainName"=>RemoteDomainName, args...))
...
"""
DeleteDirectory(DirectoryId) = directory_service("DeleteDirectory", Dict{String, Any}("DirectoryId"=>DirectoryId))
DeleteDirectory(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("DeleteDirectory", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
"""
DeleteLogSubscription(DirectoryId) = directory_service("DeleteLogSubscription", Dict{String, Any}("DirectoryId"=>DirectoryId))
DeleteLogSubscription(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("DeleteLogSubscription", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
"""
DeleteSnapshot(SnapshotId) = directory_service("DeleteSnapshot", Dict{String, Any}("SnapshotId"=>SnapshotId))
DeleteSnapshot(SnapshotId, args::AbstractDict{String, <:Any}) = directory_service("DeleteSnapshot", Dict{String, Any}("SnapshotId"=>SnapshotId, args...))
...
"""
DeleteTrust(TrustId) = directory_service("DeleteTrust", Dict{String, Any}("TrustId"=>TrustId))
DeleteTrust(TrustId, args::AbstractDict{String, <:Any}) = directory_service("DeleteTrust", Dict{String, Any}("TrustId"=>TrustId, args...))
...
"""
DeregisterCertificate(CertificateId, DirectoryId) = directory_service("DeregisterCertificate", Dict{String, Any}("CertificateId"=>CertificateId, "DirectoryId"=>DirectoryId))
DeregisterCertificate(CertificateId, DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("DeregisterCertificate", Dict{String, Any}("CertificateId"=>CertificateId, "DirectoryId"=>DirectoryId, args...))
...
"""
DeregisterEventTopic(DirectoryId, TopicName) = directory_service("DeregisterEventTopic", Dict{String, Any}("DirectoryId"=>DirectoryId, "TopicName"=>TopicName))
DeregisterEventTopic(DirectoryId, TopicName, args::AbstractDict{String, <:Any}) = directory_service("DeregisterEventTopic", Dict{String, Any}("DirectoryId"=>DirectoryId, "TopicName"=>TopicName, args...))
...
"""
DescribeCertificate(CertificateId, DirectoryId) = directory_service("DescribeCertificate", Dict{String, Any}("CertificateId"=>CertificateId, "DirectoryId"=>DirectoryId))
DescribeCertificate(CertificateId, DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("DescribeCertificate", Dict{String, Any}("CertificateId"=>CertificateId, "DirectoryId"=>DirectoryId, args...))
...
"""
DescribeConditionalForwarders(DirectoryId) = directory_service("DescribeConditionalForwarders", Dict{String, Any}("DirectoryId"=>DirectoryId))
DescribeConditionalForwarders(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("DescribeConditionalForwarders", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
DescribeDirectories(args::AbstractDict{String, <:Any}) = directory_service("DescribeDirectories", args)
...
"""
DescribeDomainControllers(DirectoryId) = directory_service("DescribeDomainControllers", Dict{String, Any}("DirectoryId"=>DirectoryId))
DescribeDomainControllers(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("DescribeDomainControllers", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
DescribeEventTopics(args::AbstractDict{String, <:Any}) = directory_service("DescribeEventTopics", args)
...
"""
DescribeLDAPSSettings(DirectoryId) = directory_service("DescribeLDAPSSettings", Dict{String, Any}("DirectoryId"=>DirectoryId))
DescribeLDAPSSettings(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("DescribeLDAPSSettings", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
"""
DescribeSharedDirectories(OwnerDirectoryId) = directory_service("DescribeSharedDirectories", Dict{String, Any}("OwnerDirectoryId"=>OwnerDirectoryId))
DescribeSharedDirectories(OwnerDirectoryId, args::AbstractDict{String, <:Any}) = directory_service("DescribeSharedDirectories", Dict{String, Any}("OwnerDirectoryId"=>OwnerDirectoryId, args...))
...
DescribeSnapshots(args::AbstractDict{String, <:Any}) = directory_service("DescribeSnapshots", args)
...
DescribeTrusts(args::AbstractDict{String, <:Any}) = directory_service("DescribeTrusts", args)
...
"""
DisableLDAPS(DirectoryId, Type) = directory_service("DisableLDAPS", Dict{String, Any}("DirectoryId"=>DirectoryId, "Type"=>Type))
DisableLDAPS(DirectoryId, Type, args::AbstractDict{String, <:Any}) = directory_service("DisableLDAPS", Dict{String, Any}("DirectoryId"=>DirectoryId, "Type"=>Type, args...))
...
"""
DisableRadius(DirectoryId) = directory_service("DisableRadius", Dict{String, Any}("DirectoryId"=>DirectoryId))
DisableRadius(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("DisableRadius", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
"""
DisableSso(DirectoryId) = directory_service("DisableSso", Dict{String, Any}("DirectoryId"=>DirectoryId))
DisableSso(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("DisableSso", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
"""
EnableLDAPS(DirectoryId, Type) = directory_service("EnableLDAPS", Dict{String, Any}("DirectoryId"=>DirectoryId, "Type"=>Type))
EnableLDAPS(DirectoryId, Type, args::AbstractDict{String, <:Any}) = directory_service("EnableLDAPS", Dict{String, Any}("DirectoryId"=>DirectoryId, "Type"=>Type, args...))
...
"""
EnableRadius(DirectoryId, RadiusSettings) = directory_service("EnableRadius", Dict{String, Any}("DirectoryId"=>DirectoryId, "RadiusSettings"=>RadiusSettings))
EnableRadius(DirectoryId, RadiusSettings, args::AbstractDict{String, <:Any}) = directory_service("EnableRadius", Dict{String, Any}("DirectoryId"=>DirectoryId, "RadiusSettings"=>RadiusSettings, args...))
...
"""
EnableSso(DirectoryId) = directory_service("EnableSso", Dict{String, Any}("DirectoryId"=>DirectoryId))
EnableSso(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("EnableSso", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
GetDirectoryLimits(args::AbstractDict{String, <:Any}) = directory_service("GetDirectoryLimits", args)
...
"""
GetSnapshotLimits(DirectoryId) = directory_service("GetSnapshotLimits", Dict{String, Any}("DirectoryId"=>DirectoryId))
GetSnapshotLimits(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("GetSnapshotLimits", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
"""
ListCertificates(DirectoryId) = directory_service("ListCertificates", Dict{String, Any}("DirectoryId"=>DirectoryId))
ListCertificates(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("ListCertificates", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
"""
ListIpRoutes(DirectoryId) = directory_service("ListIpRoutes", Dict{String, Any}("DirectoryId"=>DirectoryId))
ListIpRoutes(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("ListIpRoutes", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
ListLogSubscriptions(args::AbstractDict{String, <:Any}) = directory_service("ListLogSubscriptions", args)
...
"""
ListSchemaExtensions(DirectoryId) = directory_service("ListSchemaExtensions", Dict{String, Any}("DirectoryId"=>DirectoryId))
ListSchemaExtensions(DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("ListSchemaExtensions", Dict{String, Any}("DirectoryId"=>DirectoryId, args...))
...
"""
ListTagsForResource(ResourceId) = directory_service("ListTagsForResource", Dict{String, Any}("ResourceId"=>ResourceId))
ListTagsForResource(ResourceId, args::AbstractDict{String, <:Any}) = directory_service("ListTagsForResource", Dict{String, Any}("ResourceId"=>ResourceId, args...))
...
"""
RegisterCertificate(CertificateData, DirectoryId) = directory_service("RegisterCertificate", Dict{String, Any}("CertificateData"=>CertificateData, "DirectoryId"=>DirectoryId))
RegisterCertificate(CertificateData, DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("RegisterCertificate", Dict{String, Any}("CertificateData"=>CertificateData, "DirectoryId"=>DirectoryId, args...))
...
"""
RegisterEventTopic(DirectoryId, TopicName) = directory_service("RegisterEventTopic", Dict{String, Any}("DirectoryId"=>DirectoryId, "TopicName"=>TopicName))
RegisterEventTopic(DirectoryId, TopicName, args::AbstractDict{String, <:Any}) = directory_service("RegisterEventTopic", Dict{String, Any}("DirectoryId"=>DirectoryId, "TopicName"=>TopicName, args...))
...
"""
RejectSharedDirectory(SharedDirectoryId) = directory_service("RejectSharedDirectory", Dict{String, Any}("SharedDirectoryId"=>SharedDirectoryId))
RejectSharedDirectory(SharedDirectoryId, args::AbstractDict{String, <:Any}) = directory_service("RejectSharedDirectory", Dict{String, Any}("SharedDirectoryId"=>SharedDirectoryId, args...))
...
"""
RemoveIpRoutes(CidrIps, DirectoryId) = directory_service("RemoveIpRoutes", Dict{String, Any}("CidrIps"=>CidrIps, "DirectoryId"=>DirectoryId))
RemoveIpRoutes(CidrIps, DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("RemoveIpRoutes", Dict{String, Any}("CidrIps"=>CidrIps, "DirectoryId"=>DirectoryId, args...))
...
"""
RemoveTagsFromResource(ResourceId, TagKeys) = directory_service("RemoveTagsFromResource", Dict{String, Any}("ResourceId"=>ResourceId, "TagKeys"=>TagKeys))
RemoveTagsFromResource(ResourceId, TagKeys, args::AbstractDict{String, <:Any}) = directory_service("RemoveTagsFromResource", Dict{String, Any}("ResourceId"=>ResourceId, "TagKeys"=>TagKeys, args...))
...
"""
ResetUserPassword(DirectoryId, NewPassword, UserName) = directory_service("ResetUserPassword", Dict{String, Any}("DirectoryId"=>DirectoryId, "NewPassword"=>NewPassword, "UserName"=>UserName))
ResetUserPassword(DirectoryId, NewPassword, UserName, args::AbstractDict{String, <:Any}) = directory_service("ResetUserPassword", Dict{String, Any}("DirectoryId"=>DirectoryId, "NewPassword"=>NewPassword, "UserName"=>UserName, args...))
...
"""
RestoreFromSnapshot(SnapshotId) = directory_service("RestoreFromSnapshot", Dict{String, Any}("SnapshotId"=>SnapshotId))
RestoreFromSnapshot(SnapshotId, args::AbstractDict{String, <:Any}) = directory_service("RestoreFromSnapshot", Dict{String, Any}("SnapshotId"=>SnapshotId, args...))
...
"""
ShareDirectory(DirectoryId, ShareMethod, ShareTarget) = directory_service("ShareDirectory", Dict{String, Any}("DirectoryId"=>DirectoryId, "ShareMethod"=>ShareMethod, "ShareTarget"=>ShareTarget))
ShareDirectory(DirectoryId, ShareMethod, ShareTarget, args::AbstractDict{String, <:Any}) = directory_service("ShareDirectory", Dict{String, Any}("DirectoryId"=>DirectoryId, "ShareMethod"=>ShareMethod, "ShareTarget"=>ShareTarget, args...))
...
"""
StartSchemaExtension(CreateSnapshotBeforeSchemaExtension, Description, DirectoryId, LdifContent) = directory_service("StartSchemaExtension", Dict{String, Any}("CreateSnapshotBeforeSchemaExtension"=>CreateSnapshotBeforeSchemaExtension, "Description"=>Description, "DirectoryId"=>DirectoryId, "LdifContent"=>LdifContent))
StartSchemaExtension(CreateSnapshotBeforeSchemaExtension, Description, DirectoryId, LdifContent, args::AbstractDict{String, <:Any}) = directory_service("StartSchemaExtension", Dict{String, Any}("CreateSnapshotBeforeSchemaExtension"=>CreateSnapshotBeforeSchemaExtension, "Description"=>Description, "DirectoryId"=>DirectoryId, "LdifContent"=>LdifContent, args...))
...
"""
UnshareDirectory(DirectoryId, UnshareTarget) = directory_service("UnshareDirectory", Dict{String, Any}("DirectoryId"=>DirectoryId, "UnshareTarget"=>UnshareTarget))
UnshareDirectory(DirectoryId, UnshareTarget, args::AbstractDict{String, <:Any}) = directory_service("UnshareDirectory", Dict{String, Any}("DirectoryId"=>DirectoryId, "UnshareTarget"=>UnshareTarget, args...))
...
"""
UpdateConditionalForwarder(DirectoryId, DnsIpAddrs, RemoteDomainName) = directory_service("UpdateConditionalForwarder", Dict{String, Any}("DirectoryId"=>DirectoryId, "DnsIpAddrs"=>DnsIpAddrs, "RemoteDomainName"=>RemoteDomainName))
UpdateConditionalForwarder(DirectoryId, DnsIpAddrs, RemoteDomainName, args::AbstractDict{String, <:Any}) = directory_service("UpdateConditionalForwarder", Dict{String, Any}("DirectoryId"=>DirectoryId, "DnsIpAddrs"=>DnsIpAddrs, "RemoteDomainName"=>RemoteDomainName, args...))
...
"""
UpdateNumberOfDomainControllers(DesiredNumber, DirectoryId) = directory_service("UpdateNumberOfDomainControllers", Dict{String, Any}("DesiredNumber"=>DesiredNumber, "DirectoryId"=>DirectoryId))
UpdateNumberOfDomainControllers(DesiredNumber, DirectoryId, args::AbstractDict{String, <:Any}) = directory_service("UpdateNumberOfDomainControllers", Dict{String, Any}("DesiredNumber"=>DesiredNumber, "DirectoryId"=>DirectoryId, args...))
...
"""
UpdateRadius(DirectoryId, RadiusSettings) = directory_service("UpdateRadius", Dict{String, Any}("DirectoryId"=>DirectoryId, "RadiusSettings"=>RadiusSettings))
UpdateRadius(DirectoryId, RadiusSettings, args::AbstractDict{String, <:Any}) = directory_service("UpdateRadius", Dict{String, Any}("DirectoryId"=>DirectoryId, "RadiusSettings"=>RadiusSettings, args...))
...
"""
UpdateTrust(TrustId) = directory_service("UpdateTrust", Dict{String, Any}("TrustId"=>TrustId))
UpdateTrust(TrustId, args::AbstractDict{String, <:Any}) = directory_service("UpdateTrust", Dict{String, Any}("TrustId"=>TrustId, args...))
...
"""
VerifyTrust(TrustId) = directory_service("VerifyTrust", Dict{String, Any}("TrustId"=>TrustId))
VerifyTrust(TrustId, args::AbstractDict{String, <:Any}) = directory_service("VerifyTrust", Dict{String, Any}("TrustId"=>TrustId, args...))
