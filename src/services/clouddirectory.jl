...
function list_attached_indices(
    TargetReference, x_amz_data_partition; aws_config::AbstractAWSConfig=current_aws_config()
)
    return clouddirectory(
        "POST",
...
function list_policy_attachments(
    PolicyReference, x_amz_data_partition; aws_config::AbstractAWSConfig=current_aws_config()
)
    return clouddirectory(
        "POST",
