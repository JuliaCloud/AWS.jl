...
- `"contents"`: ZIP or YAML file which contains configuration settings to be used when
  creating the project. This may be the contents of the file downloaded from the URL
...
function create_project(; aws_config::AbstractAWSConfig=current_aws_config())
    return mobile("POST", "/projects"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function create_project(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return mobile("POST", "/projects", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function delete_project(projectId; aws_config::AbstractAWSConfig=current_aws_config())
    return mobile(
        "DELETE", "/projects/$(projectId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function describe_bundle end

function describe_bundle(bundleId; aws_config::AbstractAWSConfig=current_aws_config())
    return mobile(
        "GET", "/bundles/$(bundleId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_bundle(
    ...
    return mobile(
        "GET", "/bundles/$(bundleId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function export_bundle end

function export_bundle(bundleId; aws_config::AbstractAWSConfig=current_aws_config())
    return mobile(
        "POST", "/bundles/$(bundleId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function export_bundle(
    ...
    return mobile(
        "POST", "/bundles/$(bundleId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `project_id`: Unique project identifier.
"""
function export_project end

function export_project(projectId; aws_config::AbstractAWSConfig=current_aws_config())
    return mobile(
        "POST", "/exports/$(projectId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function export_project(
    ...
    return mobile(
        "POST", "/exports/$(projectId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"nextToken"`: Pagination token. Set to null to start listing bundles from start. If non-
  null pagination token is returned in a result, then pass its value in here in another
  request to list more bundles.
"""
function list_bundles end

function list_bundles(; aws_config::AbstractAWSConfig=current_aws_config())
    return mobile("GET", "/bundles"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_bundles(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return mobile("GET", "/bundles", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"maxResults"`: Maximum number of records to list in a single response.
- `"nextToken"`: Pagination token. Set to null to start listing projects from start. If non-
  null pagination token is returned in a result, then pass its value in here in another
...
function list_projects(; aws_config::AbstractAWSConfig=current_aws_config())
    return mobile("GET", "/projects"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_projects(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return mobile("GET", "/projects", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function update_project(projectId; aws_config::AbstractAWSConfig=current_aws_config())
    return mobile(
        "POST",
        "/update",
        Dict{String,Any}("projectId" => projectId);
