...
function create_workspace(workspaceId; aws_config::AbstractAWSConfig=current_aws_config())
    return iottwinmaker(
        "POST", "/workspaces/$(workspaceId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_pricing_plan(; aws_config::AbstractAWSConfig=current_aws_config())
    return iottwinmaker("GET", "/pricingplan"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_pricing_plan(
    ...
    return iottwinmaker(
        "GET", "/pricingplan", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_sync_job(syncSource; aws_config::AbstractAWSConfig=current_aws_config())
    return iottwinmaker(
        "GET", "/sync-jobs/$(syncSource)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_workspaces(; aws_config::AbstractAWSConfig=current_aws_config())
    return iottwinmaker(
        "POST", "/workspaces-list"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_workspaces(
    ...
    return iottwinmaker(
        "POST", "/workspaces-list", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
