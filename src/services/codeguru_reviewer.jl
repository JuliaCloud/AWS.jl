...
# Optional Parameters
- `ClientRequestToken`: Amazon CodeGuru Reviewer uses this value to prevent the accidental
  creation of duplicate repository associations if there are failures and retries.
...
- `Name`:  The name of the code review. The name of each code review in your AWS account
  must be unique.
- `RepositoryAssociationArn`:  The Amazon Resource Name (ARN) of the  RepositoryAssociation
   object. You can retrieve this ARN by calling  ListRepositoryAssociations .   A code review
  can only be created on an associated repository. This is the ARN of the associated
  repository.
...
# Required Parameters
- `CodeReviewArn`: The Amazon Resource Name (ARN) of the  CodeReview  object.
- `RecommendationId`:  The recommendation ID that can be used to track the provided
...
- `RecommendationIds`:  Used to query the recommendation feedback for a given
  recommendation.
- `UserIds`:  An AWS user's account ID or Amazon Resource Name (ARN). Use this ID to query
  the recommendation feedback for a code review from that user.   The UserId is an IAM
...
# Required Parameters
- `resourceArn`:  The Amazon Resource Name (ARN) of the  RepositoryAssociation  object. You
...
- `resourceArn`:  The Amazon Resource Name (ARN) of the  RepositoryAssociation  object. You
  can retrieve this ARN by calling  ListRepositoryAssociations .
- `tagKeys`: A list of the keys for each tag you want to remove from an associated
  repository.
