...
"""
AssociateRepository(Repository; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("POST", "/associations", Dict{String, Any}("Repository"=>Repository, "ClientRequestToken"=>string(uuid4())); aws=aws)
AssociateRepository(Repository, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("POST", "/associations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Repository"=>Repository, "ClientRequestToken"=>string(uuid4())), args)); aws=aws)
...
"""
DescribeCodeReview(CodeReviewArn; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/codereviews/$(CodeReviewArn)"; aws=aws)
DescribeCodeReview(CodeReviewArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/codereviews/$(CodeReviewArn)", args; aws=aws)
...
"""
DescribeRecommendationFeedback(CodeReviewArn, RecommendationId; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/feedback/$(CodeReviewArn)", Dict{String, Any}("RecommendationId"=>RecommendationId))
DescribeRecommendationFeedback(CodeReviewArn, RecommendationId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/feedback/$(CodeReviewArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RecommendationId"=>RecommendationId), args)); aws=aws)
...
"""
DescribeRepositoryAssociation(AssociationArn; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/associations/$(AssociationArn)"; aws=aws)
DescribeRepositoryAssociation(AssociationArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/associations/$(AssociationArn)", args; aws=aws)
...
"""
DisassociateRepository(AssociationArn; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("DELETE", "/associations/$(AssociationArn)"; aws=aws)
DisassociateRepository(AssociationArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("DELETE", "/associations/$(AssociationArn)", args; aws=aws)
...
"""
ListCodeReviews(Type; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/codereviews", Dict{String, Any}("Type"=>Type))
ListCodeReviews(Type, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/codereviews", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Type"=>Type), args)); aws=aws)
...
"""
ListRecommendationFeedback(CodeReviewArn; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/feedback/$(CodeReviewArn)/RecommendationFeedback"; aws=aws)
ListRecommendationFeedback(CodeReviewArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/feedback/$(CodeReviewArn)/RecommendationFeedback", args; aws=aws)
...
"""
ListRecommendations(CodeReviewArn; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/codereviews/$(CodeReviewArn)/Recommendations"; aws=aws)
ListRecommendations(CodeReviewArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/codereviews/$(CodeReviewArn)/Recommendations", args; aws=aws)
...
"""
ListRepositoryAssociations(; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/associations"; aws=aws)
ListRepositoryAssociations(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("GET", "/associations", args; aws=aws)
...
"""
PutRecommendationFeedback(CodeReviewArn, Reactions, RecommendationId; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("PUT", "/feedback", Dict{String, Any}("CodeReviewArn"=>CodeReviewArn, "Reactions"=>Reactions, "RecommendationId"=>RecommendationId))
PutRecommendationFeedback(CodeReviewArn, Reactions, RecommendationId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguru_reviewer("PUT", "/feedback", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CodeReviewArn"=>CodeReviewArn, "Reactions"=>Reactions, "RecommendationId"=>RecommendationId), args)); aws=aws)
