...
AssociateRepository(Repository; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("POST", "/associations", Dict{String, Any}("Repository"=>Repository, "ClientRequestToken"=>string(uuid4())); aws_config=aws_config)
AssociateRepository(Repository, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("POST", "/associations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Repository"=>Repository, "ClientRequestToken"=>string(uuid4())), args)); aws_config=aws_config)
...
DescribeCodeReview(CodeReviewArn; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/codereviews/$(CodeReviewArn)"; aws_config=aws_config)
DescribeCodeReview(CodeReviewArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/codereviews/$(CodeReviewArn)", args; aws_config=aws_config)
...
DescribeRecommendationFeedback(CodeReviewArn, RecommendationId; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/feedback/$(CodeReviewArn)", Dict{String, Any}("RecommendationId"=>RecommendationId); aws_config=aws_config)
DescribeRecommendationFeedback(CodeReviewArn, RecommendationId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/feedback/$(CodeReviewArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RecommendationId"=>RecommendationId), args)); aws_config=aws_config)
...
DescribeRepositoryAssociation(AssociationArn; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/associations/$(AssociationArn)"; aws_config=aws_config)
DescribeRepositoryAssociation(AssociationArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/associations/$(AssociationArn)", args; aws_config=aws_config)
...
DisassociateRepository(AssociationArn; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("DELETE", "/associations/$(AssociationArn)"; aws_config=aws_config)
DisassociateRepository(AssociationArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("DELETE", "/associations/$(AssociationArn)", args; aws_config=aws_config)
...
ListCodeReviews(Type; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/codereviews", Dict{String, Any}("Type"=>Type); aws_config=aws_config)
ListCodeReviews(Type, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/codereviews", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Type"=>Type), args)); aws_config=aws_config)
...
ListRecommendationFeedback(CodeReviewArn; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/feedback/$(CodeReviewArn)/RecommendationFeedback"; aws_config=aws_config)
ListRecommendationFeedback(CodeReviewArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/feedback/$(CodeReviewArn)/RecommendationFeedback", args; aws_config=aws_config)
...
ListRecommendations(CodeReviewArn; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/codereviews/$(CodeReviewArn)/Recommendations"; aws_config=aws_config)
ListRecommendations(CodeReviewArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/codereviews/$(CodeReviewArn)/Recommendations", args; aws_config=aws_config)
...
ListRepositoryAssociations(; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/associations"; aws_config=aws_config)
ListRepositoryAssociations(args::AbstractDict{String, Any}; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("GET", "/associations", args; aws_config=aws_config)
...
PutRecommendationFeedback(CodeReviewArn, Reactions, RecommendationId; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("PUT", "/feedback", Dict{String, Any}("CodeReviewArn"=>CodeReviewArn, "Reactions"=>Reactions, "RecommendationId"=>RecommendationId); aws_config=aws_config)
PutRecommendationFeedback(CodeReviewArn, Reactions, RecommendationId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguru_reviewer("PUT", "/feedback", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CodeReviewArn"=>CodeReviewArn, "Reactions"=>Reactions, "RecommendationId"=>RecommendationId), args)); aws_config=aws_config)
