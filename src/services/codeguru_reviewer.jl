...
"""
AssociateRepository(Repository) = codeguru_reviewer("POST", "/associations", Dict{String, Any}("Repository"=>Repository, "ClientRequestToken"=>string(uuid4())))
AssociateRepository(Repository, args::AbstractDict{String, <:Any}) = codeguru_reviewer("POST", "/associations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Repository"=>Repository, "ClientRequestToken"=>string(uuid4())), args...)))
...
DescribeCodeReview(CodeReviewArn, args::AbstractDict{String, <:Any}) = codeguru_reviewer("GET", "/codereviews/$(CodeReviewArn)", args)
...
"""
DescribeRecommendationFeedback(CodeReviewArn, RecommendationId) = codeguru_reviewer("GET", "/feedback/$(CodeReviewArn)", Dict{String, Any}("RecommendationId"=>RecommendationId))
DescribeRecommendationFeedback(CodeReviewArn, RecommendationId, args::AbstractDict{String, <:Any}) = codeguru_reviewer("GET", "/feedback/$(CodeReviewArn)", Dict{String, Any}("RecommendationId"=>RecommendationId, args...))
...
DescribeRepositoryAssociation(AssociationArn, args::AbstractDict{String, <:Any}) = codeguru_reviewer("GET", "/associations/$(AssociationArn)", args)
...
DisassociateRepository(AssociationArn, args::AbstractDict{String, <:Any}) = codeguru_reviewer("DELETE", "/associations/$(AssociationArn)", args)
...
"""
ListCodeReviews(Type) = codeguru_reviewer("GET", "/codereviews", Dict{String, Any}("Type"=>Type))
ListCodeReviews(Type, args::AbstractDict{String, <:Any}) = codeguru_reviewer("GET", "/codereviews", Dict{String, Any}("Type"=>Type, args...))
...
ListRecommendationFeedback(CodeReviewArn, args::AbstractDict{String, <:Any}) = codeguru_reviewer("GET", "/feedback/$(CodeReviewArn)/RecommendationFeedback", args)
...
ListRecommendations(CodeReviewArn, args::AbstractDict{String, <:Any}) = codeguru_reviewer("GET", "/codereviews/$(CodeReviewArn)/Recommendations", args)
...
ListRepositoryAssociations(args::AbstractDict{String, Any}) = codeguru_reviewer("GET", "/associations", args)
...
"""
PutRecommendationFeedback(CodeReviewArn, Reactions, RecommendationId) = codeguru_reviewer("PUT", "/feedback", Dict{String, Any}("CodeReviewArn"=>CodeReviewArn, "Reactions"=>Reactions, "RecommendationId"=>RecommendationId))
PutRecommendationFeedback(CodeReviewArn, Reactions, RecommendationId, args::AbstractDict{String, <:Any}) = codeguru_reviewer("PUT", "/feedback", Dict{String, Any}("CodeReviewArn"=>CodeReviewArn, "Reactions"=>Reactions, "RecommendationId"=>RecommendationId, args...))
