...
DeleteSession(botAlias, botName, userId, args::AbstractDict{String, <:Any}) = lex_runtime_service("DELETE", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/session", args)
...
GetSession(botAlias, botName, userId, args::AbstractDict{String, <:Any}) = lex_runtime_service("GET", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/session/", args)
...
"""
PostContent(Content_Type, botAlias, botName, inputStream, userId) = lex_runtime_service("POST", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/content", Dict{String, Any}("inputStream"=>inputStream, "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)))
PostContent(Content_Type, botAlias, botName, inputStream, userId, args::AbstractDict{String, <:Any}) = lex_runtime_service("POST", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/content", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("inputStream"=>inputStream, "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)), args...)))
...
"""
PostText(botAlias, botName, inputText, userId) = lex_runtime_service("POST", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/text", Dict{String, Any}("inputText"=>inputText))
PostText(botAlias, botName, inputText, userId, args::AbstractDict{String, <:Any}) = lex_runtime_service("POST", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/text", Dict{String, Any}("inputText"=>inputText, args...))
...
PutSession(botAlias, botName, userId, args::AbstractDict{String, <:Any}) = lex_runtime_service("POST", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/session", args)
