...
"""
DeleteSession(botAlias, botName, userId; aws::AWSConfig=AWSConfig()) = lex_runtime_service("DELETE", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/session"; aws=aws)
DeleteSession(botAlias, botName, userId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lex_runtime_service("DELETE", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/session", args; aws=aws)
...
"""
GetSession(botAlias, botName, userId; aws::AWSConfig=AWSConfig()) = lex_runtime_service("GET", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/session/"; aws=aws)
GetSession(botAlias, botName, userId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lex_runtime_service("GET", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/session/", args; aws=aws)
...
"""
PostContent(Content_Type, botAlias, botName, inputStream, userId; aws::AWSConfig=AWSConfig()) = lex_runtime_service("POST", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/content", Dict{String, Any}("inputStream"=>inputStream, "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)); aws=aws)
PostContent(Content_Type, botAlias, botName, inputStream, userId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lex_runtime_service("POST", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/content", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("inputStream"=>inputStream, "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)), args)); aws=aws)
...
"""
PostText(botAlias, botName, inputText, userId; aws::AWSConfig=AWSConfig()) = lex_runtime_service("POST", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/text", Dict{String, Any}("inputText"=>inputText))
PostText(botAlias, botName, inputText, userId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lex_runtime_service("POST", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/text", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("inputText"=>inputText), args)); aws=aws)
...
"""
PutSession(botAlias, botName, userId; aws::AWSConfig=AWSConfig()) = lex_runtime_service("POST", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/session"; aws=aws)
PutSession(botAlias, botName, userId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lex_runtime_service("POST", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/session", args; aws=aws)
