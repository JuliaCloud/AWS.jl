...
PostContent(Content_Type, botAlias, botName, inputStream, userId, args::AbstractDict{String, <: Any}) = lex_runtime_service("POST", "/bot/$(botName)/alias/$(botAlias)/user/$(userId)/content", Dict{String, Any}(mergewith(merge, Dict{String, Any}("inputStream"=>inputStream, "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)), args...)))
