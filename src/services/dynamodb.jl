...
"""
TransactWriteItems(TransactItems) = dynamodb("TransactWriteItems", Dict{String, Any}("TransactItems"=>TransactItems))
TransactWriteItems(TransactItems, args::AbstractDict{String, <: Any}) = dynamodb("TransactWriteItems", Dict{String, Any}("TransactItems"=>TransactItems, args...))
