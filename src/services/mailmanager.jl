...
function list_addon_instances(; aws_config::AbstractAWSConfig=current_aws_config())
    return mailmanager("ListAddonInstances"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_addon_instances(
    ...
    return mailmanager(
        "ListAddonInstances", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_addon_subscriptions(; aws_config::AbstractAWSConfig=current_aws_config())
    return mailmanager(
        "ListAddonSubscriptions"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_addon_subscriptions(
    ...
    return mailmanager(
        "ListAddonSubscriptions", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_archives(; aws_config::AbstractAWSConfig=current_aws_config())
    return mailmanager("ListArchives"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_archives(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return mailmanager("ListArchives", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_ingress_points(; aws_config::AbstractAWSConfig=current_aws_config())
    return mailmanager("ListIngressPoints"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_ingress_points(
    ...
    return mailmanager(
        "ListIngressPoints", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_relays(; aws_config::AbstractAWSConfig=current_aws_config())
    return mailmanager("ListRelays"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_relays(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return mailmanager("ListRelays", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_rule_sets(; aws_config::AbstractAWSConfig=current_aws_config())
    return mailmanager("ListRuleSets"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_rule_sets(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return mailmanager("ListRuleSets", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_traffic_policies(; aws_config::AbstractAWSConfig=current_aws_config())
    return mailmanager("ListTrafficPolicies"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_traffic_policies(
    ...
    return mailmanager(
        "ListTrafficPolicies", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
