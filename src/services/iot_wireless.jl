...
function create_multicast_group(
    LoRaWAN, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return iot_wireless(
        "POST",
        "/multicast-groups",
...
- `"Tags"`: The tags to attach to the new wireless gateway. Tags are metadata that you can
  use to manage a resource.
"""
function create_wireless_gateway(LoRaWAN; aws_config::AbstractAWSConfig=current_aws_config())
    return iot_wireless(
        "POST",
        "/wireless-gateways",
        Dict{String,Any}("LoRaWAN" => LoRaWAN, "ClientRequestToken" => string(uuid4()));
...
"""
function delete_wireless_gateway_task(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return iot_wireless(
        "DELETE",
        "/wireless-gateways/$(Id)/tasks";
        aws_config=aws_config,
