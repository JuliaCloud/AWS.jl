...
function get_assessment(id; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhubstrategy(
        "GET", "/get-assessment/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_assessment(
    ...
    return migrationhubstrategy(
        "GET", "/get-assessment/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_import_file_task(id; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhubstrategy(
        "GET", "/get-import-file-task/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_latest_assessment_id(; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhubstrategy(
        "GET", "/get-latest-assessment-id"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_portfolio_preferences(; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhubstrategy(
        "GET", "/get-portfolio-preferences"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_portfolio_summary(; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhubstrategy(
        "GET", "/get-portfolio-summary"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_portfolio_summary(
    ...
    return migrationhubstrategy(
        "GET", "/get-portfolio-summary", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_analyzable_servers(; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhubstrategy(
        "POST", "/list-analyzable-servers"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_application_components(; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhubstrategy(
        "POST", "/list-applicationcomponents"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_collectors(; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhubstrategy(
        "GET", "/list-collectors"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_collectors(
    ...
    return migrationhubstrategy(
        "GET", "/list-collectors", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_import_file_task(; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhubstrategy(
        "GET", "/list-import-file-task"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_import_file_task(
    ...
    return migrationhubstrategy(
        "GET", "/list-import-file-task", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_servers(; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhubstrategy(
        "POST", "/list-servers"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_servers(
    ...
    return migrationhubstrategy(
        "POST", "/list-servers", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function put_portfolio_preferences(; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhubstrategy(
        "POST", "/put-portfolio-preferences"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"s3bucketForAnalysisData"`: The S3 bucket used by the collectors to send analysis data to
  the service. The bucket name must begin with `migrationhub-strategy-`.
...
function start_assessment(; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhubstrategy(
        "POST", "/start-assessment"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function start_assessment(
    ...
    return migrationhubstrategy(
        "POST", "/start-assessment", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"outputFormat"`: The output format for the recommendation report file. The default format
  is Microsoft Excel.
"""
