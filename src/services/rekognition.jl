...
CompareFaces(SourceImage, TargetImage; aws_config::AWSConfig=AWS.aws_config) = rekognition("CompareFaces", Dict{String, Any}("SourceImage"=>SourceImage, "TargetImage"=>TargetImage); aws_config=aws_config)
CompareFaces(SourceImage, TargetImage, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("CompareFaces", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SourceImage"=>SourceImage, "TargetImage"=>TargetImage), args)); aws_config=aws_config)
...
CreateCollection(CollectionId; aws_config::AWSConfig=AWS.aws_config) = rekognition("CreateCollection", Dict{String, Any}("CollectionId"=>CollectionId); aws_config=aws_config)
CreateCollection(CollectionId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("CreateCollection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CollectionId"=>CollectionId), args)); aws_config=aws_config)
...
CreateProject(ProjectName; aws_config::AWSConfig=AWS.aws_config) = rekognition("CreateProject", Dict{String, Any}("ProjectName"=>ProjectName); aws_config=aws_config)
CreateProject(ProjectName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("CreateProject", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProjectName"=>ProjectName), args)); aws_config=aws_config)
...
CreateProjectVersion(OutputConfig, ProjectArn, TestingData, TrainingData, VersionName; aws_config::AWSConfig=AWS.aws_config) = rekognition("CreateProjectVersion", Dict{String, Any}("OutputConfig"=>OutputConfig, "ProjectArn"=>ProjectArn, "TestingData"=>TestingData, "TrainingData"=>TrainingData, "VersionName"=>VersionName); aws_config=aws_config)
CreateProjectVersion(OutputConfig, ProjectArn, TestingData, TrainingData, VersionName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("CreateProjectVersion", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("OutputConfig"=>OutputConfig, "ProjectArn"=>ProjectArn, "TestingData"=>TestingData, "TrainingData"=>TrainingData, "VersionName"=>VersionName), args)); aws_config=aws_config)
...
CreateStreamProcessor(Input, Name, Output, RoleArn, Settings; aws_config::AWSConfig=AWS.aws_config) = rekognition("CreateStreamProcessor", Dict{String, Any}("Input"=>Input, "Name"=>Name, "Output"=>Output, "RoleArn"=>RoleArn, "Settings"=>Settings); aws_config=aws_config)
CreateStreamProcessor(Input, Name, Output, RoleArn, Settings, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("CreateStreamProcessor", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Input"=>Input, "Name"=>Name, "Output"=>Output, "RoleArn"=>RoleArn, "Settings"=>Settings), args)); aws_config=aws_config)
...
DeleteCollection(CollectionId; aws_config::AWSConfig=AWS.aws_config) = rekognition("DeleteCollection", Dict{String, Any}("CollectionId"=>CollectionId); aws_config=aws_config)
DeleteCollection(CollectionId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DeleteCollection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CollectionId"=>CollectionId), args)); aws_config=aws_config)
...
DeleteFaces(CollectionId, FaceIds; aws_config::AWSConfig=AWS.aws_config) = rekognition("DeleteFaces", Dict{String, Any}("CollectionId"=>CollectionId, "FaceIds"=>FaceIds); aws_config=aws_config)
DeleteFaces(CollectionId, FaceIds, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DeleteFaces", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CollectionId"=>CollectionId, "FaceIds"=>FaceIds), args)); aws_config=aws_config)
...
DeleteProject(ProjectArn; aws_config::AWSConfig=AWS.aws_config) = rekognition("DeleteProject", Dict{String, Any}("ProjectArn"=>ProjectArn); aws_config=aws_config)
DeleteProject(ProjectArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DeleteProject", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProjectArn"=>ProjectArn), args)); aws_config=aws_config)
...
DeleteProjectVersion(ProjectVersionArn; aws_config::AWSConfig=AWS.aws_config) = rekognition("DeleteProjectVersion", Dict{String, Any}("ProjectVersionArn"=>ProjectVersionArn); aws_config=aws_config)
DeleteProjectVersion(ProjectVersionArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DeleteProjectVersion", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProjectVersionArn"=>ProjectVersionArn), args)); aws_config=aws_config)
...
DeleteStreamProcessor(Name; aws_config::AWSConfig=AWS.aws_config) = rekognition("DeleteStreamProcessor", Dict{String, Any}("Name"=>Name); aws_config=aws_config)
DeleteStreamProcessor(Name, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DeleteStreamProcessor", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws_config=aws_config)
...
DescribeCollection(CollectionId; aws_config::AWSConfig=AWS.aws_config) = rekognition("DescribeCollection", Dict{String, Any}("CollectionId"=>CollectionId); aws_config=aws_config)
DescribeCollection(CollectionId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DescribeCollection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CollectionId"=>CollectionId), args)); aws_config=aws_config)
...
DescribeProjectVersions(ProjectArn; aws_config::AWSConfig=AWS.aws_config) = rekognition("DescribeProjectVersions", Dict{String, Any}("ProjectArn"=>ProjectArn); aws_config=aws_config)
DescribeProjectVersions(ProjectArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DescribeProjectVersions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProjectArn"=>ProjectArn), args)); aws_config=aws_config)
...
DescribeProjects(; aws_config::AWSConfig=AWS.aws_config) = rekognition("DescribeProjects"; aws_config=aws_config)
DescribeProjects(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DescribeProjects", args; aws_config=aws_config)
...
DescribeStreamProcessor(Name; aws_config::AWSConfig=AWS.aws_config) = rekognition("DescribeStreamProcessor", Dict{String, Any}("Name"=>Name); aws_config=aws_config)
DescribeStreamProcessor(Name, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DescribeStreamProcessor", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws_config=aws_config)
...
DetectCustomLabels(Image, ProjectVersionArn; aws_config::AWSConfig=AWS.aws_config) = rekognition("DetectCustomLabels", Dict{String, Any}("Image"=>Image, "ProjectVersionArn"=>ProjectVersionArn); aws_config=aws_config)
DetectCustomLabels(Image, ProjectVersionArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DetectCustomLabels", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Image"=>Image, "ProjectVersionArn"=>ProjectVersionArn), args)); aws_config=aws_config)
...
DetectFaces(Image; aws_config::AWSConfig=AWS.aws_config) = rekognition("DetectFaces", Dict{String, Any}("Image"=>Image); aws_config=aws_config)
DetectFaces(Image, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DetectFaces", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Image"=>Image), args)); aws_config=aws_config)
...
DetectLabels(Image; aws_config::AWSConfig=AWS.aws_config) = rekognition("DetectLabels", Dict{String, Any}("Image"=>Image); aws_config=aws_config)
DetectLabels(Image, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DetectLabels", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Image"=>Image), args)); aws_config=aws_config)
...
DetectModerationLabels(Image; aws_config::AWSConfig=AWS.aws_config) = rekognition("DetectModerationLabels", Dict{String, Any}("Image"=>Image); aws_config=aws_config)
DetectModerationLabels(Image, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DetectModerationLabels", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Image"=>Image), args)); aws_config=aws_config)
...
DetectText(Image; aws_config::AWSConfig=AWS.aws_config) = rekognition("DetectText", Dict{String, Any}("Image"=>Image); aws_config=aws_config)
DetectText(Image, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("DetectText", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Image"=>Image), args)); aws_config=aws_config)
...
GetCelebrityInfo(Id; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetCelebrityInfo", Dict{String, Any}("Id"=>Id); aws_config=aws_config)
GetCelebrityInfo(Id, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetCelebrityInfo", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Id"=>Id), args)); aws_config=aws_config)
...
GetCelebrityRecognition(JobId; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetCelebrityRecognition", Dict{String, Any}("JobId"=>JobId); aws_config=aws_config)
GetCelebrityRecognition(JobId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetCelebrityRecognition", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("JobId"=>JobId), args)); aws_config=aws_config)
...
GetContentModeration(JobId; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetContentModeration", Dict{String, Any}("JobId"=>JobId); aws_config=aws_config)
GetContentModeration(JobId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetContentModeration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("JobId"=>JobId), args)); aws_config=aws_config)
...
GetFaceDetection(JobId; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetFaceDetection", Dict{String, Any}("JobId"=>JobId); aws_config=aws_config)
GetFaceDetection(JobId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetFaceDetection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("JobId"=>JobId), args)); aws_config=aws_config)
...
GetFaceSearch(JobId; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetFaceSearch", Dict{String, Any}("JobId"=>JobId); aws_config=aws_config)
GetFaceSearch(JobId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetFaceSearch", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("JobId"=>JobId), args)); aws_config=aws_config)
...
GetLabelDetection(JobId; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetLabelDetection", Dict{String, Any}("JobId"=>JobId); aws_config=aws_config)
GetLabelDetection(JobId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetLabelDetection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("JobId"=>JobId), args)); aws_config=aws_config)
...
GetPersonTracking(JobId; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetPersonTracking", Dict{String, Any}("JobId"=>JobId); aws_config=aws_config)
GetPersonTracking(JobId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetPersonTracking", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("JobId"=>JobId), args)); aws_config=aws_config)
...
GetSegmentDetection(JobId; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetSegmentDetection", Dict{String, Any}("JobId"=>JobId); aws_config=aws_config)
GetSegmentDetection(JobId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetSegmentDetection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("JobId"=>JobId), args)); aws_config=aws_config)
...
GetTextDetection(JobId; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetTextDetection", Dict{String, Any}("JobId"=>JobId); aws_config=aws_config)
GetTextDetection(JobId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("GetTextDetection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("JobId"=>JobId), args)); aws_config=aws_config)
...
IndexFaces(CollectionId, Image; aws_config::AWSConfig=AWS.aws_config) = rekognition("IndexFaces", Dict{String, Any}("CollectionId"=>CollectionId, "Image"=>Image); aws_config=aws_config)
IndexFaces(CollectionId, Image, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("IndexFaces", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CollectionId"=>CollectionId, "Image"=>Image), args)); aws_config=aws_config)
...
ListCollections(; aws_config::AWSConfig=AWS.aws_config) = rekognition("ListCollections"; aws_config=aws_config)
ListCollections(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("ListCollections", args; aws_config=aws_config)
...
ListFaces(CollectionId; aws_config::AWSConfig=AWS.aws_config) = rekognition("ListFaces", Dict{String, Any}("CollectionId"=>CollectionId); aws_config=aws_config)
ListFaces(CollectionId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("ListFaces", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CollectionId"=>CollectionId), args)); aws_config=aws_config)
...
ListStreamProcessors(; aws_config::AWSConfig=AWS.aws_config) = rekognition("ListStreamProcessors"; aws_config=aws_config)
ListStreamProcessors(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("ListStreamProcessors", args; aws_config=aws_config)
...
RecognizeCelebrities(Image; aws_config::AWSConfig=AWS.aws_config) = rekognition("RecognizeCelebrities", Dict{String, Any}("Image"=>Image); aws_config=aws_config)
RecognizeCelebrities(Image, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("RecognizeCelebrities", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Image"=>Image), args)); aws_config=aws_config)
...
SearchFaces(CollectionId, FaceId; aws_config::AWSConfig=AWS.aws_config) = rekognition("SearchFaces", Dict{String, Any}("CollectionId"=>CollectionId, "FaceId"=>FaceId); aws_config=aws_config)
SearchFaces(CollectionId, FaceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("SearchFaces", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CollectionId"=>CollectionId, "FaceId"=>FaceId), args)); aws_config=aws_config)
...
SearchFacesByImage(CollectionId, Image; aws_config::AWSConfig=AWS.aws_config) = rekognition("SearchFacesByImage", Dict{String, Any}("CollectionId"=>CollectionId, "Image"=>Image); aws_config=aws_config)
SearchFacesByImage(CollectionId, Image, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("SearchFacesByImage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CollectionId"=>CollectionId, "Image"=>Image), args)); aws_config=aws_config)
...
StartCelebrityRecognition(Video; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartCelebrityRecognition", Dict{String, Any}("Video"=>Video); aws_config=aws_config)
StartCelebrityRecognition(Video, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartCelebrityRecognition", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Video"=>Video), args)); aws_config=aws_config)
...
StartContentModeration(Video; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartContentModeration", Dict{String, Any}("Video"=>Video); aws_config=aws_config)
StartContentModeration(Video, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartContentModeration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Video"=>Video), args)); aws_config=aws_config)
...
StartFaceDetection(Video; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartFaceDetection", Dict{String, Any}("Video"=>Video); aws_config=aws_config)
StartFaceDetection(Video, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartFaceDetection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Video"=>Video), args)); aws_config=aws_config)
...
StartFaceSearch(CollectionId, Video; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartFaceSearch", Dict{String, Any}("CollectionId"=>CollectionId, "Video"=>Video); aws_config=aws_config)
StartFaceSearch(CollectionId, Video, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartFaceSearch", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CollectionId"=>CollectionId, "Video"=>Video), args)); aws_config=aws_config)
...
StartLabelDetection(Video; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartLabelDetection", Dict{String, Any}("Video"=>Video); aws_config=aws_config)
StartLabelDetection(Video, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartLabelDetection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Video"=>Video), args)); aws_config=aws_config)
...
StartPersonTracking(Video; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartPersonTracking", Dict{String, Any}("Video"=>Video); aws_config=aws_config)
StartPersonTracking(Video, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartPersonTracking", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Video"=>Video), args)); aws_config=aws_config)
...
StartProjectVersion(MinInferenceUnits, ProjectVersionArn; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartProjectVersion", Dict{String, Any}("MinInferenceUnits"=>MinInferenceUnits, "ProjectVersionArn"=>ProjectVersionArn); aws_config=aws_config)
StartProjectVersion(MinInferenceUnits, ProjectVersionArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartProjectVersion", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MinInferenceUnits"=>MinInferenceUnits, "ProjectVersionArn"=>ProjectVersionArn), args)); aws_config=aws_config)
...
StartSegmentDetection(SegmentTypes, Video; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartSegmentDetection", Dict{String, Any}("SegmentTypes"=>SegmentTypes, "Video"=>Video); aws_config=aws_config)
StartSegmentDetection(SegmentTypes, Video, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartSegmentDetection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SegmentTypes"=>SegmentTypes, "Video"=>Video), args)); aws_config=aws_config)
...
StartStreamProcessor(Name; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartStreamProcessor", Dict{String, Any}("Name"=>Name); aws_config=aws_config)
StartStreamProcessor(Name, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartStreamProcessor", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws_config=aws_config)
...
StartTextDetection(Video; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartTextDetection", Dict{String, Any}("Video"=>Video); aws_config=aws_config)
StartTextDetection(Video, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("StartTextDetection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Video"=>Video), args)); aws_config=aws_config)
...
StopProjectVersion(ProjectVersionArn; aws_config::AWSConfig=AWS.aws_config) = rekognition("StopProjectVersion", Dict{String, Any}("ProjectVersionArn"=>ProjectVersionArn); aws_config=aws_config)
StopProjectVersion(ProjectVersionArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("StopProjectVersion", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProjectVersionArn"=>ProjectVersionArn), args)); aws_config=aws_config)
...
StopStreamProcessor(Name; aws_config::AWSConfig=AWS.aws_config) = rekognition("StopStreamProcessor", Dict{String, Any}("Name"=>Name); aws_config=aws_config)
StopStreamProcessor(Name, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rekognition("StopStreamProcessor", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws_config=aws_config)
