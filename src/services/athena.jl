...
"""
function create_notebook(Name, WorkGroup; aws_config::AbstractAWSConfig=current_aws_config())
    return athena(
        "CreateNotebook",
...
"""
function delete_named_query(NamedQueryId; aws_config::AbstractAWSConfig=current_aws_config())
    return athena(
        "DeleteNamedQuery",
