...
"""
CreateNamedQuery(Database, Name, QueryString) = athena("CreateNamedQuery", Dict{String, Any}("Database"=>Database, "Name"=>Name, "QueryString"=>QueryString))
CreateNamedQuery(Database, Name, QueryString, args::AbstractDict{String, <: Any}) = athena("CreateNamedQuery", Dict{String, Any}("Database"=>Database, "Name"=>Name, "QueryString"=>QueryString, args...))
...
"""
StartQueryExecution(QueryString) = athena("StartQueryExecution", Dict{String, Any}("QueryString"=>QueryString))
StartQueryExecution(QueryString, args::AbstractDict{String, <: Any}) = athena("StartQueryExecution", Dict{String, Any}("QueryString"=>QueryString, args...))
