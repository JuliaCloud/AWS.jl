...
function accept_share(
    shareId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return omics(
        "POST",
        "/share/$(shareId)",
...
"""
function cancel_variant_import_job(jobId; aws_config::AbstractAWSConfig=current_aws_config())
    return omics(
        "DELETE",
...
"""
function get_annotation_import_job(jobId; aws_config::AbstractAWSConfig=current_aws_config())
    return omics(
        "GET",
        "/import/annotation/$(jobId)";
        aws_config=aws_config,
...
function list_read_set_upload_parts(
    partSource, sequenceStoreId, uploadId; aws_config::AbstractAWSConfig=current_aws_config()
)
    return omics(
        "POST",
