...
AssociateConnectionWithLag(connectionId, lagId; aws_config::AWSConfig=global_aws_config()) = direct_connect("AssociateConnectionWithLag", Dict{String, Any}("connectionId"=>connectionId, "lagId"=>lagId); aws_config=aws_config)
AssociateConnectionWithLag(connectionId, lagId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("AssociateConnectionWithLag", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("connectionId"=>connectionId, "lagId"=>lagId), args)); aws_config=aws_config)
...
AssociateHostedConnection(connectionId, parentConnectionId; aws_config::AWSConfig=global_aws_config()) = direct_connect("AssociateHostedConnection", Dict{String, Any}("connectionId"=>connectionId, "parentConnectionId"=>parentConnectionId); aws_config=aws_config)
AssociateHostedConnection(connectionId, parentConnectionId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("AssociateHostedConnection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("connectionId"=>connectionId, "parentConnectionId"=>parentConnectionId), args)); aws_config=aws_config)
...
AssociateVirtualInterface(connectionId, virtualInterfaceId; aws_config::AWSConfig=global_aws_config()) = direct_connect("AssociateVirtualInterface", Dict{String, Any}("connectionId"=>connectionId, "virtualInterfaceId"=>virtualInterfaceId); aws_config=aws_config)
...
ConfirmConnection(connectionId; aws_config::AWSConfig=global_aws_config()) = direct_connect("ConfirmConnection", Dict{String, Any}("connectionId"=>connectionId); aws_config=aws_config)
ConfirmConnection(connectionId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("ConfirmConnection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("connectionId"=>connectionId), args)); aws_config=aws_config)
...
ConfirmPrivateVirtualInterface(virtualInterfaceId; aws_config::AWSConfig=global_aws_config()) = direct_connect("ConfirmPrivateVirtualInterface", Dict{String, Any}("virtualInterfaceId"=>virtualInterfaceId); aws_config=aws_config)
ConfirmPrivateVirtualInterface(virtualInterfaceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("ConfirmPrivateVirtualInterface", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("virtualInterfaceId"=>virtualInterfaceId), args)); aws_config=aws_config)
...
ConfirmPublicVirtualInterface(virtualInterfaceId; aws_config::AWSConfig=global_aws_config()) = direct_connect("ConfirmPublicVirtualInterface", Dict{String, Any}("virtualInterfaceId"=>virtualInterfaceId); aws_config=aws_config)
ConfirmPublicVirtualInterface(virtualInterfaceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("ConfirmPublicVirtualInterface", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("virtualInterfaceId"=>virtualInterfaceId), args)); aws_config=aws_config)
...
ConfirmTransitVirtualInterface(directConnectGatewayId, virtualInterfaceId; aws_config::AWSConfig=global_aws_config()) = direct_connect("ConfirmTransitVirtualInterface", Dict{String, Any}("directConnectGatewayId"=>directConnectGatewayId, "virtualInterfaceId"=>virtualInterfaceId); aws_config=aws_config)
...
CreateBGPPeer(; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateBGPPeer"; aws_config=aws_config)
CreateBGPPeer(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateBGPPeer", args; aws_config=aws_config)
...
CreateConnection(bandwidth, connectionName, location; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateConnection", Dict{String, Any}("bandwidth"=>bandwidth, "connectionName"=>connectionName, "location"=>location); aws_config=aws_config)
CreateConnection(bandwidth, connectionName, location, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateConnection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("bandwidth"=>bandwidth, "connectionName"=>connectionName, "location"=>location), args)); aws_config=aws_config)
...
CreateDirectConnectGateway(directConnectGatewayName; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateDirectConnectGateway", Dict{String, Any}("directConnectGatewayName"=>directConnectGatewayName); aws_config=aws_config)
CreateDirectConnectGateway(directConnectGatewayName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateDirectConnectGateway", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("directConnectGatewayName"=>directConnectGatewayName), args)); aws_config=aws_config)
...
CreateDirectConnectGatewayAssociation(directConnectGatewayId; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateDirectConnectGatewayAssociation", Dict{String, Any}("directConnectGatewayId"=>directConnectGatewayId); aws_config=aws_config)
CreateDirectConnectGatewayAssociation(directConnectGatewayId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateDirectConnectGatewayAssociation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("directConnectGatewayId"=>directConnectGatewayId), args)); aws_config=aws_config)
...
CreateInterconnect(bandwidth, interconnectName, location; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateInterconnect", Dict{String, Any}("bandwidth"=>bandwidth, "interconnectName"=>interconnectName, "location"=>location); aws_config=aws_config)
CreateInterconnect(bandwidth, interconnectName, location, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateInterconnect", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("bandwidth"=>bandwidth, "interconnectName"=>interconnectName, "location"=>location), args)); aws_config=aws_config)
...
CreateLag(connectionsBandwidth, lagName, location, numberOfConnections; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateLag", Dict{String, Any}("connectionsBandwidth"=>connectionsBandwidth, "lagName"=>lagName, "location"=>location, "numberOfConnections"=>numberOfConnections); aws_config=aws_config)
...
CreatePrivateVirtualInterface(connectionId, newPrivateVirtualInterface; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreatePrivateVirtualInterface", Dict{String, Any}("connectionId"=>connectionId, "newPrivateVirtualInterface"=>newPrivateVirtualInterface); aws_config=aws_config)
...
CreatePublicVirtualInterface(connectionId, newPublicVirtualInterface; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreatePublicVirtualInterface", Dict{String, Any}("connectionId"=>connectionId, "newPublicVirtualInterface"=>newPublicVirtualInterface); aws_config=aws_config)
CreatePublicVirtualInterface(connectionId, newPublicVirtualInterface, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreatePublicVirtualInterface", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("connectionId"=>connectionId, "newPublicVirtualInterface"=>newPublicVirtualInterface), args)); aws_config=aws_config)
...
CreateTransitVirtualInterface(connectionId, newTransitVirtualInterface; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateTransitVirtualInterface", Dict{String, Any}("connectionId"=>connectionId, "newTransitVirtualInterface"=>newTransitVirtualInterface); aws_config=aws_config)
CreateTransitVirtualInterface(connectionId, newTransitVirtualInterface, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("CreateTransitVirtualInterface", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("connectionId"=>connectionId, "newTransitVirtualInterface"=>newTransitVirtualInterface), args)); aws_config=aws_config)
...
DeleteBGPPeer(; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteBGPPeer"; aws_config=aws_config)
DeleteBGPPeer(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteBGPPeer", args; aws_config=aws_config)
...
DeleteConnection(connectionId; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteConnection", Dict{String, Any}("connectionId"=>connectionId); aws_config=aws_config)
DeleteConnection(connectionId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteConnection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("connectionId"=>connectionId), args)); aws_config=aws_config)
...
DeleteDirectConnectGateway(directConnectGatewayId; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteDirectConnectGateway", Dict{String, Any}("directConnectGatewayId"=>directConnectGatewayId); aws_config=aws_config)
DeleteDirectConnectGateway(directConnectGatewayId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteDirectConnectGateway", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("directConnectGatewayId"=>directConnectGatewayId), args)); aws_config=aws_config)
...
DeleteDirectConnectGatewayAssociation(; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteDirectConnectGatewayAssociation"; aws_config=aws_config)
DeleteDirectConnectGatewayAssociation(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteDirectConnectGatewayAssociation", args; aws_config=aws_config)
...
DeleteDirectConnectGatewayAssociationProposal(proposalId; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteDirectConnectGatewayAssociationProposal", Dict{String, Any}("proposalId"=>proposalId); aws_config=aws_config)
DeleteDirectConnectGatewayAssociationProposal(proposalId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteDirectConnectGatewayAssociationProposal", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("proposalId"=>proposalId), args)); aws_config=aws_config)
...
DeleteInterconnect(interconnectId; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteInterconnect", Dict{String, Any}("interconnectId"=>interconnectId); aws_config=aws_config)
DeleteInterconnect(interconnectId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteInterconnect", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("interconnectId"=>interconnectId), args)); aws_config=aws_config)
...
DeleteLag(lagId; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteLag", Dict{String, Any}("lagId"=>lagId); aws_config=aws_config)
DeleteLag(lagId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteLag", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("lagId"=>lagId), args)); aws_config=aws_config)
...
DeleteVirtualInterface(virtualInterfaceId; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteVirtualInterface", Dict{String, Any}("virtualInterfaceId"=>virtualInterfaceId); aws_config=aws_config)
DeleteVirtualInterface(virtualInterfaceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DeleteVirtualInterface", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("virtualInterfaceId"=>virtualInterfaceId), args)); aws_config=aws_config)
...
DescribeConnectionLoa(connectionId; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeConnectionLoa", Dict{String, Any}("connectionId"=>connectionId); aws_config=aws_config)
DescribeConnectionLoa(connectionId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeConnectionLoa", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("connectionId"=>connectionId), args)); aws_config=aws_config)
...
DescribeConnections(; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeConnections"; aws_config=aws_config)
DescribeConnections(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeConnections", args; aws_config=aws_config)
...
DescribeConnectionsOnInterconnect(interconnectId; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeConnectionsOnInterconnect", Dict{String, Any}("interconnectId"=>interconnectId); aws_config=aws_config)
DescribeConnectionsOnInterconnect(interconnectId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeConnectionsOnInterconnect", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("interconnectId"=>interconnectId), args)); aws_config=aws_config)
...
DescribeDirectConnectGatewayAssociationProposals(; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeDirectConnectGatewayAssociationProposals"; aws_config=aws_config)
DescribeDirectConnectGatewayAssociationProposals(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeDirectConnectGatewayAssociationProposals", args; aws_config=aws_config)
...
DescribeDirectConnectGatewayAssociations(; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeDirectConnectGatewayAssociations"; aws_config=aws_config)
DescribeDirectConnectGatewayAssociations(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeDirectConnectGatewayAssociations", args; aws_config=aws_config)
...
DescribeDirectConnectGatewayAttachments(; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeDirectConnectGatewayAttachments"; aws_config=aws_config)
DescribeDirectConnectGatewayAttachments(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeDirectConnectGatewayAttachments", args; aws_config=aws_config)
...
DescribeDirectConnectGateways(; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeDirectConnectGateways"; aws_config=aws_config)
DescribeDirectConnectGateways(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeDirectConnectGateways", args; aws_config=aws_config)
...
DescribeHostedConnections(connectionId; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeHostedConnections", Dict{String, Any}("connectionId"=>connectionId); aws_config=aws_config)
DescribeHostedConnections(connectionId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeHostedConnections", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("connectionId"=>connectionId), args)); aws_config=aws_config)
...
DescribeInterconnectLoa(interconnectId; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeInterconnectLoa", Dict{String, Any}("interconnectId"=>interconnectId); aws_config=aws_config)
DescribeInterconnectLoa(interconnectId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeInterconnectLoa", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("interconnectId"=>interconnectId), args)); aws_config=aws_config)
...
DescribeInterconnects(; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeInterconnects"; aws_config=aws_config)
DescribeInterconnects(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeInterconnects", args; aws_config=aws_config)
...
DescribeLags(; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeLags"; aws_config=aws_config)
DescribeLags(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeLags", args; aws_config=aws_config)
...
DescribeLoa(connectionId; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeLoa", Dict{String, Any}("connectionId"=>connectionId); aws_config=aws_config)
DescribeLoa(connectionId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeLoa", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("connectionId"=>connectionId), args)); aws_config=aws_config)
...
DescribeLocations(; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeLocations"; aws_config=aws_config)
DescribeLocations(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeLocations", args; aws_config=aws_config)
...
DescribeTags(resourceArns; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeTags", Dict{String, Any}("resourceArns"=>resourceArns); aws_config=aws_config)
DescribeTags(resourceArns, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceArns"=>resourceArns), args)); aws_config=aws_config)
...
DescribeVirtualGateways(; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeVirtualGateways"; aws_config=aws_config)
DescribeVirtualGateways(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeVirtualGateways", args; aws_config=aws_config)
...
DescribeVirtualInterfaces(; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeVirtualInterfaces"; aws_config=aws_config)
DescribeVirtualInterfaces(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DescribeVirtualInterfaces", args; aws_config=aws_config)
...
DisassociateConnectionFromLag(connectionId, lagId; aws_config::AWSConfig=global_aws_config()) = direct_connect("DisassociateConnectionFromLag", Dict{String, Any}("connectionId"=>connectionId, "lagId"=>lagId); aws_config=aws_config)
DisassociateConnectionFromLag(connectionId, lagId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("DisassociateConnectionFromLag", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("connectionId"=>connectionId, "lagId"=>lagId), args)); aws_config=aws_config)
...
ListVirtualInterfaceTestHistory(; aws_config::AWSConfig=global_aws_config()) = direct_connect("ListVirtualInterfaceTestHistory"; aws_config=aws_config)
ListVirtualInterfaceTestHistory(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("ListVirtualInterfaceTestHistory", args; aws_config=aws_config)
...
StartBgpFailoverTest(virtualInterfaceId; aws_config::AWSConfig=global_aws_config()) = direct_connect("StartBgpFailoverTest", Dict{String, Any}("virtualInterfaceId"=>virtualInterfaceId); aws_config=aws_config)
StartBgpFailoverTest(virtualInterfaceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("StartBgpFailoverTest", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("virtualInterfaceId"=>virtualInterfaceId), args)); aws_config=aws_config)
...
StopBgpFailoverTest(virtualInterfaceId; aws_config::AWSConfig=global_aws_config()) = direct_connect("StopBgpFailoverTest", Dict{String, Any}("virtualInterfaceId"=>virtualInterfaceId); aws_config=aws_config)
StopBgpFailoverTest(virtualInterfaceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("StopBgpFailoverTest", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("virtualInterfaceId"=>virtualInterfaceId), args)); aws_config=aws_config)
...
TagResource(resourceArn, tags; aws_config::AWSConfig=global_aws_config()) = direct_connect("TagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags); aws_config=aws_config)
TagResource(resourceArn, tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags), args)); aws_config=aws_config)
...
UntagResource(resourceArn, tagKeys; aws_config::AWSConfig=global_aws_config()) = direct_connect("UntagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys); aws_config=aws_config)
UntagResource(resourceArn, tagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys), args)); aws_config=aws_config)
...
UpdateDirectConnectGatewayAssociation(; aws_config::AWSConfig=global_aws_config()) = direct_connect("UpdateDirectConnectGatewayAssociation"; aws_config=aws_config)
UpdateDirectConnectGatewayAssociation(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("UpdateDirectConnectGatewayAssociation", args; aws_config=aws_config)
...
UpdateLag(lagId; aws_config::AWSConfig=global_aws_config()) = direct_connect("UpdateLag", Dict{String, Any}("lagId"=>lagId); aws_config=aws_config)
UpdateLag(lagId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("UpdateLag", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("lagId"=>lagId), args)); aws_config=aws_config)
...
UpdateVirtualInterfaceAttributes(virtualInterfaceId; aws_config::AWSConfig=global_aws_config()) = direct_connect("UpdateVirtualInterfaceAttributes", Dict{String, Any}("virtualInterfaceId"=>virtualInterfaceId); aws_config=aws_config)
UpdateVirtualInterfaceAttributes(virtualInterfaceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = direct_connect("UpdateVirtualInterfaceAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("virtualInterfaceId"=>virtualInterfaceId), args)); aws_config=aws_config)
