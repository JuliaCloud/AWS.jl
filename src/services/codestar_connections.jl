...
"""
create_connection(ConnectionName; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("CreateConnection", Dict{String, Any}("ConnectionName"=>ConnectionName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_connection(ConnectionName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("CreateConnection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConnectionName"=>ConnectionName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"VpcConfiguration"`: The VPC configuration to be provisioned for the host. A VPC must be
  ...
  to the VPC.
"""
create_host(Name, ProviderEndpoint, ProviderType; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("CreateHost", Dict{String, Any}("Name"=>Name, "ProviderEndpoint"=>ProviderEndpoint, "ProviderType"=>ProviderType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_repository_link(ConnectionArn, OwnerId, RepositoryName; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("CreateRepositoryLink", Dict{String, Any}("ConnectionArn"=>ConnectionArn, "OwnerId"=>OwnerId, "RepositoryName"=>RepositoryName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_connection(ConnectionArn; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("DeleteConnection", Dict{String, Any}("ConnectionArn"=>ConnectionArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_connection(ConnectionArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("DeleteConnection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConnectionArn"=>ConnectionArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_host(HostArn; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("DeleteHost", Dict{String, Any}("HostArn"=>HostArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_host(HostArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("DeleteHost", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HostArn"=>HostArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_repository_link(RepositoryLinkId; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("DeleteRepositoryLink", Dict{String, Any}("RepositoryLinkId"=>RepositoryLinkId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_repository_link(RepositoryLinkId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("DeleteRepositoryLink", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RepositoryLinkId"=>RepositoryLinkId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_sync_configuration(ResourceName, SyncType; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("DeleteSyncConfiguration", Dict{String, Any}("ResourceName"=>ResourceName, "SyncType"=>SyncType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_sync_configuration(ResourceName, SyncType, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("DeleteSyncConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceName"=>ResourceName, "SyncType"=>SyncType), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_connection(ConnectionArn; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("GetConnection", Dict{String, Any}("ConnectionArn"=>ConnectionArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_connection(ConnectionArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("GetConnection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConnectionArn"=>ConnectionArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_host(HostArn; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("GetHost", Dict{String, Any}("HostArn"=>HostArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_host(HostArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("GetHost", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HostArn"=>HostArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_repository_link(RepositoryLinkId; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("GetRepositoryLink", Dict{String, Any}("RepositoryLinkId"=>RepositoryLinkId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_repository_link(RepositoryLinkId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("GetRepositoryLink", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RepositoryLinkId"=>RepositoryLinkId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_repository_sync_status(Branch, RepositoryLinkId, SyncType; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("GetRepositorySyncStatus", Dict{String, Any}("Branch"=>Branch, "RepositoryLinkId"=>RepositoryLinkId, "SyncType"=>SyncType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_resource_sync_status(ResourceName, SyncType; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("GetResourceSyncStatus", Dict{String, Any}("ResourceName"=>ResourceName, "SyncType"=>SyncType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_sync_blocker_summary(ResourceName, SyncType; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("GetSyncBlockerSummary", Dict{String, Any}("ResourceName"=>ResourceName, "SyncType"=>SyncType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_sync_blocker_summary(ResourceName, SyncType, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("GetSyncBlockerSummary", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceName"=>ResourceName, "SyncType"=>SyncType), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `sync_type`: The sync type for the sync configuration for which you want to retrieve
  information.
"""
get_sync_configuration(ResourceName, SyncType; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("GetSyncConfiguration", Dict{String, Any}("ResourceName"=>ResourceName, "SyncType"=>SyncType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_connections(; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("ListConnections"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_connections(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("ListConnections", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_hosts(; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("ListHosts"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_hosts(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("ListHosts", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_repository_links(; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("ListRepositoryLinks"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_repository_links(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("ListRepositoryLinks", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_repository_sync_definitions(RepositoryLinkId, SyncType; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("ListRepositorySyncDefinitions", Dict{String, Any}("RepositoryLinkId"=>RepositoryLinkId, "SyncType"=>SyncType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_repository_sync_definitions(RepositoryLinkId, SyncType, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("ListRepositorySyncDefinitions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RepositoryLinkId"=>RepositoryLinkId, "SyncType"=>SyncType), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: An enumeration token that allows the operation to batch the results of the
  operation.
"""
list_sync_configurations(RepositoryLinkId, SyncType; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("ListSyncConfigurations", Dict{String, Any}("RepositoryLinkId"=>RepositoryLinkId, "SyncType"=>SyncType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_tags_for_resource(ResourceArn; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_tags_for_resource(ResourceArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
tag_resource(ResourceArn, Tags; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
tag_resource(ResourceArn, Tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
untag_resource(ResourceArn, TagKeys; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
untag_resource(ResourceArn, TagKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"VpcConfiguration"`: The VPC configuration of the host to be updated. A VPC must be
  ...
  to the VPC.
"""
update_host(HostArn; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("UpdateHost", Dict{String, Any}("HostArn"=>HostArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_host(HostArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("UpdateHost", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HostArn"=>HostArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_repository_link(RepositoryLinkId; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("UpdateRepositoryLink", Dict{String, Any}("RepositoryLinkId"=>RepositoryLinkId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_repository_link(RepositoryLinkId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("UpdateRepositoryLink", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RepositoryLinkId"=>RepositoryLinkId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_sync_blocker(Id, ResolvedReason, ResourceName, SyncType; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("UpdateSyncBlocker", Dict{String, Any}("Id"=>Id, "ResolvedReason"=>ResolvedReason, "ResourceName"=>ResourceName, "SyncType"=>SyncType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_sync_blocker(Id, ResolvedReason, ResourceName, SyncType, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("UpdateSyncBlocker", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Id"=>Id, "ResolvedReason"=>ResolvedReason, "ResourceName"=>ResourceName, "SyncType"=>SyncType), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"TriggerResourceUpdateOn"`: When to trigger Git sync to begin the stack update.
"""
update_sync_configuration(ResourceName, SyncType; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("UpdateSyncConfiguration", Dict{String, Any}("ResourceName"=>ResourceName, "SyncType"=>SyncType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_sync_configuration(ResourceName, SyncType, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections("UpdateSyncConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceName"=>ResourceName, "SyncType"=>SyncType), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
