...
"""
delete_host(HostArn; aws_config::AbstractAWSConfig=current_aws_config()) =
    codestar_connections(
        "DeleteHost",
...
"""
get_host(HostArn; aws_config::AbstractAWSConfig=current_aws_config()) =
    codestar_connections(
        "GetHost",
        Dict{String,Any}("HostArn" => HostArn);
        aws_config=aws_config,
...
"""
list_hosts(; aws_config::AbstractAWSConfig=current_aws_config()) = codestar_connections(
...
- `"VpcConfiguration"`: The VPC configuration of the host to be updated. A VPC must be
  ...
  to the VPC.
"""
update_host(HostArn; aws_config::AbstractAWSConfig=current_aws_config()) =
    codestar_connections(
        "UpdateHost",
        Dict{String,Any}("HostArn" => HostArn);
        aws_config=aws_config,
