...
function list_connections(; aws_config::AbstractAWSConfig=current_aws_config())
    return codestar_connections(
        "ListConnections"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_hosts(; aws_config::AbstractAWSConfig=current_aws_config())
    return codestar_connections("ListHosts"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_hosts(
    ...
    return codestar_connections(
        "ListHosts", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
