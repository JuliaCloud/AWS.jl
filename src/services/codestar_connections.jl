...
"""
CreateConnection(ConnectionName) = codestar_connections("CreateConnection", Dict{String, Any}("ConnectionName"=>ConnectionName))
CreateConnection(ConnectionName, args::AbstractDict{String, <:Any}) = codestar_connections("CreateConnection", Dict{String, Any}("ConnectionName"=>ConnectionName, args...))
...
"""
CreateHost(Name, ProviderEndpoint, ProviderType) = codestar_connections("CreateHost", Dict{String, Any}("Name"=>Name, "ProviderEndpoint"=>ProviderEndpoint, "ProviderType"=>ProviderType))
CreateHost(Name, ProviderEndpoint, ProviderType, args::AbstractDict{String, <:Any}) = codestar_connections("CreateHost", Dict{String, Any}("Name"=>Name, "ProviderEndpoint"=>ProviderEndpoint, "ProviderType"=>ProviderType, args...))
...
"""
DeleteConnection(ConnectionArn) = codestar_connections("DeleteConnection", Dict{String, Any}("ConnectionArn"=>ConnectionArn))
DeleteConnection(ConnectionArn, args::AbstractDict{String, <:Any}) = codestar_connections("DeleteConnection", Dict{String, Any}("ConnectionArn"=>ConnectionArn, args...))
...
"""
DeleteHost(HostArn) = codestar_connections("DeleteHost", Dict{String, Any}("HostArn"=>HostArn))
DeleteHost(HostArn, args::AbstractDict{String, <:Any}) = codestar_connections("DeleteHost", Dict{String, Any}("HostArn"=>HostArn, args...))
...
"""
GetConnection(ConnectionArn) = codestar_connections("GetConnection", Dict{String, Any}("ConnectionArn"=>ConnectionArn))
GetConnection(ConnectionArn, args::AbstractDict{String, <:Any}) = codestar_connections("GetConnection", Dict{String, Any}("ConnectionArn"=>ConnectionArn, args...))
...
"""
GetHost(HostArn) = codestar_connections("GetHost", Dict{String, Any}("HostArn"=>HostArn))
GetHost(HostArn, args::AbstractDict{String, <:Any}) = codestar_connections("GetHost", Dict{String, Any}("HostArn"=>HostArn, args...))
...
ListConnections(args::AbstractDict{String, <:Any}) = codestar_connections("ListConnections", args)
...
ListHosts(args::AbstractDict{String, <:Any}) = codestar_connections("ListHosts", args)
...
"""
ListTagsForResource(ResourceArn) = codestar_connections("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn))
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}) = codestar_connections("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
TagResource(ResourceArn, Tags) = codestar_connections("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags))
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}) = codestar_connections("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceArn, TagKeys) = codestar_connections("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys))
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}) = codestar_connections("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys, args...))
