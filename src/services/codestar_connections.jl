...
# Required Parameters
- `ConnectionName`: The name of the connection to be created. The name must be unique in
...
- `Name`: The name of the host to be created. The name must be unique in the calling AWS
  account.
- `ProviderEndpoint`: The endpoint of the infrastructure to be represented by the host
  after it is created.
- `ProviderType`: The name of the installed provider to be associated with your connection.
...
# Required Parameters
- `ConnectionArn`: The Amazon Resource Name (ARN) of the connection to be deleted.  The ARN
