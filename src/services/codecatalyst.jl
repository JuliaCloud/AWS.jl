...
"""
function list_dev_environments(spaceName; aws_config::AbstractAWSConfig=current_aws_config())
    return codecatalyst(
        "POST",
...
function stop_dev_environment_session(
    id, projectName, sessionId, spaceName; aws_config::AbstractAWSConfig=current_aws_config()
)
    return codecatalyst(
        "DELETE",
