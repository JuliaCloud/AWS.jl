...
"""
ActivateGateway(ActivationKey, GatewayName, GatewayRegion, GatewayTimezone) = storage_gateway("ActivateGateway", Dict{String, Any}("ActivationKey"=>ActivationKey, "GatewayName"=>GatewayName, "GatewayRegion"=>GatewayRegion, "GatewayTimezone"=>GatewayTimezone))
ActivateGateway(ActivationKey, GatewayName, GatewayRegion, GatewayTimezone, args::AbstractDict{String, <: Any}) = storage_gateway("ActivateGateway", Dict{String, Any}("ActivationKey"=>ActivationKey, "GatewayName"=>GatewayName, "GatewayRegion"=>GatewayRegion, "GatewayTimezone"=>GatewayTimezone, args...))
...
"""
AddCache(DiskIds, GatewayARN) = storage_gateway("AddCache", Dict{String, Any}("DiskIds"=>DiskIds, "GatewayARN"=>GatewayARN))
AddCache(DiskIds, GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("AddCache", Dict{String, Any}("DiskIds"=>DiskIds, "GatewayARN"=>GatewayARN, args...))
...
"""
AddTagsToResource(ResourceARN, Tags) = storage_gateway("AddTagsToResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags))
AddTagsToResource(ResourceARN, Tags, args::AbstractDict{String, <: Any}) = storage_gateway("AddTagsToResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags, args...))
...
"""
AddUploadBuffer(DiskIds, GatewayARN) = storage_gateway("AddUploadBuffer", Dict{String, Any}("DiskIds"=>DiskIds, "GatewayARN"=>GatewayARN))
AddUploadBuffer(DiskIds, GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("AddUploadBuffer", Dict{String, Any}("DiskIds"=>DiskIds, "GatewayARN"=>GatewayARN, args...))
...
"""
AddWorkingStorage(DiskIds, GatewayARN) = storage_gateway("AddWorkingStorage", Dict{String, Any}("DiskIds"=>DiskIds, "GatewayARN"=>GatewayARN))
AddWorkingStorage(DiskIds, GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("AddWorkingStorage", Dict{String, Any}("DiskIds"=>DiskIds, "GatewayARN"=>GatewayARN, args...))
...
"""
AssignTapePool(PoolId, TapeARN) = storage_gateway("AssignTapePool", Dict{String, Any}("PoolId"=>PoolId, "TapeARN"=>TapeARN))
AssignTapePool(PoolId, TapeARN, args::AbstractDict{String, <: Any}) = storage_gateway("AssignTapePool", Dict{String, Any}("PoolId"=>PoolId, "TapeARN"=>TapeARN, args...))
...
"""
AttachVolume(GatewayARN, NetworkInterfaceId, VolumeARN) = storage_gateway("AttachVolume", Dict{String, Any}("GatewayARN"=>GatewayARN, "NetworkInterfaceId"=>NetworkInterfaceId, "VolumeARN"=>VolumeARN))
AttachVolume(GatewayARN, NetworkInterfaceId, VolumeARN, args::AbstractDict{String, <: Any}) = storage_gateway("AttachVolume", Dict{String, Any}("GatewayARN"=>GatewayARN, "NetworkInterfaceId"=>NetworkInterfaceId, "VolumeARN"=>VolumeARN, args...))
...
"""
CancelArchival(GatewayARN, TapeARN) = storage_gateway("CancelArchival", Dict{String, Any}("GatewayARN"=>GatewayARN, "TapeARN"=>TapeARN))
CancelArchival(GatewayARN, TapeARN, args::AbstractDict{String, <: Any}) = storage_gateway("CancelArchival", Dict{String, Any}("GatewayARN"=>GatewayARN, "TapeARN"=>TapeARN, args...))
...
"""
CancelRetrieval(GatewayARN, TapeARN) = storage_gateway("CancelRetrieval", Dict{String, Any}("GatewayARN"=>GatewayARN, "TapeARN"=>TapeARN))
CancelRetrieval(GatewayARN, TapeARN, args::AbstractDict{String, <: Any}) = storage_gateway("CancelRetrieval", Dict{String, Any}("GatewayARN"=>GatewayARN, "TapeARN"=>TapeARN, args...))
...
"""
CreateCachediSCSIVolume(ClientToken, GatewayARN, NetworkInterfaceId, TargetName, VolumeSizeInBytes) = storage_gateway("CreateCachediSCSIVolume", Dict{String, Any}("ClientToken"=>ClientToken, "GatewayARN"=>GatewayARN, "NetworkInterfaceId"=>NetworkInterfaceId, "TargetName"=>TargetName, "VolumeSizeInBytes"=>VolumeSizeInBytes))
CreateCachediSCSIVolume(ClientToken, GatewayARN, NetworkInterfaceId, TargetName, VolumeSizeInBytes, args::AbstractDict{String, <: Any}) = storage_gateway("CreateCachediSCSIVolume", Dict{String, Any}("ClientToken"=>ClientToken, "GatewayARN"=>GatewayARN, "NetworkInterfaceId"=>NetworkInterfaceId, "TargetName"=>TargetName, "VolumeSizeInBytes"=>VolumeSizeInBytes, args...))
...
"""
CreateNFSFileShare(ClientToken, GatewayARN, LocationARN, Role) = storage_gateway("CreateNFSFileShare", Dict{String, Any}("ClientToken"=>ClientToken, "GatewayARN"=>GatewayARN, "LocationARN"=>LocationARN, "Role"=>Role))
CreateNFSFileShare(ClientToken, GatewayARN, LocationARN, Role, args::AbstractDict{String, <: Any}) = storage_gateway("CreateNFSFileShare", Dict{String, Any}("ClientToken"=>ClientToken, "GatewayARN"=>GatewayARN, "LocationARN"=>LocationARN, "Role"=>Role, args...))
...
"""
CreateSMBFileShare(ClientToken, GatewayARN, LocationARN, Role) = storage_gateway("CreateSMBFileShare", Dict{String, Any}("ClientToken"=>ClientToken, "GatewayARN"=>GatewayARN, "LocationARN"=>LocationARN, "Role"=>Role))
CreateSMBFileShare(ClientToken, GatewayARN, LocationARN, Role, args::AbstractDict{String, <: Any}) = storage_gateway("CreateSMBFileShare", Dict{String, Any}("ClientToken"=>ClientToken, "GatewayARN"=>GatewayARN, "LocationARN"=>LocationARN, "Role"=>Role, args...))
...
"""
CreateSnapshot(SnapshotDescription, VolumeARN) = storage_gateway("CreateSnapshot", Dict{String, Any}("SnapshotDescription"=>SnapshotDescription, "VolumeARN"=>VolumeARN))
CreateSnapshot(SnapshotDescription, VolumeARN, args::AbstractDict{String, <: Any}) = storage_gateway("CreateSnapshot", Dict{String, Any}("SnapshotDescription"=>SnapshotDescription, "VolumeARN"=>VolumeARN, args...))
...
Tags => A list of up to 50 tags that can be assigned to a snapshot. Each tag is a key-value pair.  Valid characters for key and value are letters, spaces, and numbers representable in UTF-8 format, and the following special characters: + - = . _ : / @. The maximum length of a tag's key is 128 characters, and the maximum length for a tag's value is 256. 
"""
CreateSnapshotFromVolumeRecoveryPoint(SnapshotDescription, VolumeARN) = storage_gateway("CreateSnapshotFromVolumeRecoveryPoint", Dict{String, Any}("SnapshotDescription"=>SnapshotDescription, "VolumeARN"=>VolumeARN))
CreateSnapshotFromVolumeRecoveryPoint(SnapshotDescription, VolumeARN, args::AbstractDict{String, <: Any}) = storage_gateway("CreateSnapshotFromVolumeRecoveryPoint", Dict{String, Any}("SnapshotDescription"=>SnapshotDescription, "VolumeARN"=>VolumeARN, args...))
...
"""
CreateStorediSCSIVolume(DiskId, GatewayARN, NetworkInterfaceId, PreserveExistingData, TargetName) = storage_gateway("CreateStorediSCSIVolume", Dict{String, Any}("DiskId"=>DiskId, "GatewayARN"=>GatewayARN, "NetworkInterfaceId"=>NetworkInterfaceId, "PreserveExistingData"=>PreserveExistingData, "TargetName"=>TargetName))
CreateStorediSCSIVolume(DiskId, GatewayARN, NetworkInterfaceId, PreserveExistingData, TargetName, args::AbstractDict{String, <: Any}) = storage_gateway("CreateStorediSCSIVolume", Dict{String, Any}("DiskId"=>DiskId, "GatewayARN"=>GatewayARN, "NetworkInterfaceId"=>NetworkInterfaceId, "PreserveExistingData"=>PreserveExistingData, "TargetName"=>TargetName, args...))
...
"""
CreateTapeWithBarcode(GatewayARN, TapeBarcode, TapeSizeInBytes) = storage_gateway("CreateTapeWithBarcode", Dict{String, Any}("GatewayARN"=>GatewayARN, "TapeBarcode"=>TapeBarcode, "TapeSizeInBytes"=>TapeSizeInBytes))
CreateTapeWithBarcode(GatewayARN, TapeBarcode, TapeSizeInBytes, args::AbstractDict{String, <: Any}) = storage_gateway("CreateTapeWithBarcode", Dict{String, Any}("GatewayARN"=>GatewayARN, "TapeBarcode"=>TapeBarcode, "TapeSizeInBytes"=>TapeSizeInBytes, args...))
...
"""
CreateTapes(ClientToken, GatewayARN, NumTapesToCreate, TapeBarcodePrefix, TapeSizeInBytes) = storage_gateway("CreateTapes", Dict{String, Any}("ClientToken"=>ClientToken, "GatewayARN"=>GatewayARN, "NumTapesToCreate"=>NumTapesToCreate, "TapeBarcodePrefix"=>TapeBarcodePrefix, "TapeSizeInBytes"=>TapeSizeInBytes))
CreateTapes(ClientToken, GatewayARN, NumTapesToCreate, TapeBarcodePrefix, TapeSizeInBytes, args::AbstractDict{String, <: Any}) = storage_gateway("CreateTapes", Dict{String, Any}("ClientToken"=>ClientToken, "GatewayARN"=>GatewayARN, "NumTapesToCreate"=>NumTapesToCreate, "TapeBarcodePrefix"=>TapeBarcodePrefix, "TapeSizeInBytes"=>TapeSizeInBytes, args...))
...
"""
DeleteAutomaticTapeCreationPolicy(GatewayARN) = storage_gateway("DeleteAutomaticTapeCreationPolicy", Dict{String, Any}("GatewayARN"=>GatewayARN))
DeleteAutomaticTapeCreationPolicy(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DeleteAutomaticTapeCreationPolicy", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DeleteBandwidthRateLimit(BandwidthType, GatewayARN) = storage_gateway("DeleteBandwidthRateLimit", Dict{String, Any}("BandwidthType"=>BandwidthType, "GatewayARN"=>GatewayARN))
DeleteBandwidthRateLimit(BandwidthType, GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DeleteBandwidthRateLimit", Dict{String, Any}("BandwidthType"=>BandwidthType, "GatewayARN"=>GatewayARN, args...))
...
"""
DeleteChapCredentials(InitiatorName, TargetARN) = storage_gateway("DeleteChapCredentials", Dict{String, Any}("InitiatorName"=>InitiatorName, "TargetARN"=>TargetARN))
DeleteChapCredentials(InitiatorName, TargetARN, args::AbstractDict{String, <: Any}) = storage_gateway("DeleteChapCredentials", Dict{String, Any}("InitiatorName"=>InitiatorName, "TargetARN"=>TargetARN, args...))
...
"""
DeleteFileShare(FileShareARN) = storage_gateway("DeleteFileShare", Dict{String, Any}("FileShareARN"=>FileShareARN))
DeleteFileShare(FileShareARN, args::AbstractDict{String, <: Any}) = storage_gateway("DeleteFileShare", Dict{String, Any}("FileShareARN"=>FileShareARN, args...))
...
"""
DeleteGateway(GatewayARN) = storage_gateway("DeleteGateway", Dict{String, Any}("GatewayARN"=>GatewayARN))
DeleteGateway(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DeleteGateway", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DeleteSnapshotSchedule(VolumeARN) = storage_gateway("DeleteSnapshotSchedule", Dict{String, Any}("VolumeARN"=>VolumeARN))
DeleteSnapshotSchedule(VolumeARN, args::AbstractDict{String, <: Any}) = storage_gateway("DeleteSnapshotSchedule", Dict{String, Any}("VolumeARN"=>VolumeARN, args...))
...
"""
DeleteTape(GatewayARN, TapeARN) = storage_gateway("DeleteTape", Dict{String, Any}("GatewayARN"=>GatewayARN, "TapeARN"=>TapeARN))
DeleteTape(GatewayARN, TapeARN, args::AbstractDict{String, <: Any}) = storage_gateway("DeleteTape", Dict{String, Any}("GatewayARN"=>GatewayARN, "TapeARN"=>TapeARN, args...))
...
"""
DeleteTapeArchive(TapeARN) = storage_gateway("DeleteTapeArchive", Dict{String, Any}("TapeARN"=>TapeARN))
DeleteTapeArchive(TapeARN, args::AbstractDict{String, <: Any}) = storage_gateway("DeleteTapeArchive", Dict{String, Any}("TapeARN"=>TapeARN, args...))
...
"""
DeleteVolume(VolumeARN) = storage_gateway("DeleteVolume", Dict{String, Any}("VolumeARN"=>VolumeARN))
DeleteVolume(VolumeARN, args::AbstractDict{String, <: Any}) = storage_gateway("DeleteVolume", Dict{String, Any}("VolumeARN"=>VolumeARN, args...))
...
"""
DescribeAvailabilityMonitorTest(GatewayARN) = storage_gateway("DescribeAvailabilityMonitorTest", Dict{String, Any}("GatewayARN"=>GatewayARN))
DescribeAvailabilityMonitorTest(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeAvailabilityMonitorTest", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DescribeBandwidthRateLimit(GatewayARN) = storage_gateway("DescribeBandwidthRateLimit", Dict{String, Any}("GatewayARN"=>GatewayARN))
DescribeBandwidthRateLimit(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeBandwidthRateLimit", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DescribeCache(GatewayARN) = storage_gateway("DescribeCache", Dict{String, Any}("GatewayARN"=>GatewayARN))
DescribeCache(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeCache", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DescribeCachediSCSIVolumes(VolumeARNs) = storage_gateway("DescribeCachediSCSIVolumes", Dict{String, Any}("VolumeARNs"=>VolumeARNs))
DescribeCachediSCSIVolumes(VolumeARNs, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeCachediSCSIVolumes", Dict{String, Any}("VolumeARNs"=>VolumeARNs, args...))
...
"""
DescribeChapCredentials(TargetARN) = storage_gateway("DescribeChapCredentials", Dict{String, Any}("TargetARN"=>TargetARN))
DescribeChapCredentials(TargetARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeChapCredentials", Dict{String, Any}("TargetARN"=>TargetARN, args...))
...
"""
DescribeGatewayInformation(GatewayARN) = storage_gateway("DescribeGatewayInformation", Dict{String, Any}("GatewayARN"=>GatewayARN))
DescribeGatewayInformation(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeGatewayInformation", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DescribeMaintenanceStartTime(GatewayARN) = storage_gateway("DescribeMaintenanceStartTime", Dict{String, Any}("GatewayARN"=>GatewayARN))
DescribeMaintenanceStartTime(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeMaintenanceStartTime", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DescribeNFSFileShares(FileShareARNList) = storage_gateway("DescribeNFSFileShares", Dict{String, Any}("FileShareARNList"=>FileShareARNList))
DescribeNFSFileShares(FileShareARNList, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeNFSFileShares", Dict{String, Any}("FileShareARNList"=>FileShareARNList, args...))
...
"""
DescribeSMBFileShares(FileShareARNList) = storage_gateway("DescribeSMBFileShares", Dict{String, Any}("FileShareARNList"=>FileShareARNList))
DescribeSMBFileShares(FileShareARNList, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeSMBFileShares", Dict{String, Any}("FileShareARNList"=>FileShareARNList, args...))
...
"""
DescribeSMBSettings(GatewayARN) = storage_gateway("DescribeSMBSettings", Dict{String, Any}("GatewayARN"=>GatewayARN))
DescribeSMBSettings(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeSMBSettings", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DescribeSnapshotSchedule(VolumeARN) = storage_gateway("DescribeSnapshotSchedule", Dict{String, Any}("VolumeARN"=>VolumeARN))
DescribeSnapshotSchedule(VolumeARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeSnapshotSchedule", Dict{String, Any}("VolumeARN"=>VolumeARN, args...))
...
"""
DescribeStorediSCSIVolumes(VolumeARNs) = storage_gateway("DescribeStorediSCSIVolumes", Dict{String, Any}("VolumeARNs"=>VolumeARNs))
DescribeStorediSCSIVolumes(VolumeARNs, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeStorediSCSIVolumes", Dict{String, Any}("VolumeARNs"=>VolumeARNs, args...))
...
DescribeTapeArchives(args::AbstractDict{String, <: Any}) = storage_gateway("DescribeTapeArchives", args)
...
"""
DescribeTapeRecoveryPoints(GatewayARN) = storage_gateway("DescribeTapeRecoveryPoints", Dict{String, Any}("GatewayARN"=>GatewayARN))
DescribeTapeRecoveryPoints(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeTapeRecoveryPoints", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DescribeTapes(GatewayARN) = storage_gateway("DescribeTapes", Dict{String, Any}("GatewayARN"=>GatewayARN))
DescribeTapes(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeTapes", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DescribeUploadBuffer(GatewayARN) = storage_gateway("DescribeUploadBuffer", Dict{String, Any}("GatewayARN"=>GatewayARN))
DescribeUploadBuffer(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeUploadBuffer", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DescribeVTLDevices(GatewayARN) = storage_gateway("DescribeVTLDevices", Dict{String, Any}("GatewayARN"=>GatewayARN))
DescribeVTLDevices(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeVTLDevices", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DescribeWorkingStorage(GatewayARN) = storage_gateway("DescribeWorkingStorage", Dict{String, Any}("GatewayARN"=>GatewayARN))
DescribeWorkingStorage(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DescribeWorkingStorage", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
DetachVolume(VolumeARN) = storage_gateway("DetachVolume", Dict{String, Any}("VolumeARN"=>VolumeARN))
DetachVolume(VolumeARN, args::AbstractDict{String, <: Any}) = storage_gateway("DetachVolume", Dict{String, Any}("VolumeARN"=>VolumeARN, args...))
...
"""
DisableGateway(GatewayARN) = storage_gateway("DisableGateway", Dict{String, Any}("GatewayARN"=>GatewayARN))
DisableGateway(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("DisableGateway", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
JoinDomain(DomainName, GatewayARN, Password, UserName) = storage_gateway("JoinDomain", Dict{String, Any}("DomainName"=>DomainName, "GatewayARN"=>GatewayARN, "Password"=>Password, "UserName"=>UserName))
JoinDomain(DomainName, GatewayARN, Password, UserName, args::AbstractDict{String, <: Any}) = storage_gateway("JoinDomain", Dict{String, Any}("DomainName"=>DomainName, "GatewayARN"=>GatewayARN, "Password"=>Password, "UserName"=>UserName, args...))
...
ListAutomaticTapeCreationPolicies(args::AbstractDict{String, <: Any}) = storage_gateway("ListAutomaticTapeCreationPolicies", args)
...
ListFileShares(args::AbstractDict{String, <: Any}) = storage_gateway("ListFileShares", args)
...
ListGateways(args::AbstractDict{String, <: Any}) = storage_gateway("ListGateways", args)
...
"""
ListLocalDisks(GatewayARN) = storage_gateway("ListLocalDisks", Dict{String, Any}("GatewayARN"=>GatewayARN))
ListLocalDisks(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("ListLocalDisks", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
ListTagsForResource(ResourceARN) = storage_gateway("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN))
ListTagsForResource(ResourceARN, args::AbstractDict{String, <: Any}) = storage_gateway("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN, args...))
...
ListTapes(args::AbstractDict{String, <: Any}) = storage_gateway("ListTapes", args)
...
"""
ListVolumeInitiators(VolumeARN) = storage_gateway("ListVolumeInitiators", Dict{String, Any}("VolumeARN"=>VolumeARN))
ListVolumeInitiators(VolumeARN, args::AbstractDict{String, <: Any}) = storage_gateway("ListVolumeInitiators", Dict{String, Any}("VolumeARN"=>VolumeARN, args...))
...
"""
ListVolumeRecoveryPoints(GatewayARN) = storage_gateway("ListVolumeRecoveryPoints", Dict{String, Any}("GatewayARN"=>GatewayARN))
ListVolumeRecoveryPoints(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("ListVolumeRecoveryPoints", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
ListVolumes(args::AbstractDict{String, <: Any}) = storage_gateway("ListVolumes", args)
...
"""
NotifyWhenUploaded(FileShareARN) = storage_gateway("NotifyWhenUploaded", Dict{String, Any}("FileShareARN"=>FileShareARN))
NotifyWhenUploaded(FileShareARN, args::AbstractDict{String, <: Any}) = storage_gateway("NotifyWhenUploaded", Dict{String, Any}("FileShareARN"=>FileShareARN, args...))
...
"""
RefreshCache(FileShareARN) = storage_gateway("RefreshCache", Dict{String, Any}("FileShareARN"=>FileShareARN))
RefreshCache(FileShareARN, args::AbstractDict{String, <: Any}) = storage_gateway("RefreshCache", Dict{String, Any}("FileShareARN"=>FileShareARN, args...))
...
"""
RemoveTagsFromResource(ResourceARN, TagKeys) = storage_gateway("RemoveTagsFromResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys))
RemoveTagsFromResource(ResourceARN, TagKeys, args::AbstractDict{String, <: Any}) = storage_gateway("RemoveTagsFromResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys, args...))
...
"""
ResetCache(GatewayARN) = storage_gateway("ResetCache", Dict{String, Any}("GatewayARN"=>GatewayARN))
ResetCache(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("ResetCache", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
RetrieveTapeArchive(GatewayARN, TapeARN) = storage_gateway("RetrieveTapeArchive", Dict{String, Any}("GatewayARN"=>GatewayARN, "TapeARN"=>TapeARN))
RetrieveTapeArchive(GatewayARN, TapeARN, args::AbstractDict{String, <: Any}) = storage_gateway("RetrieveTapeArchive", Dict{String, Any}("GatewayARN"=>GatewayARN, "TapeARN"=>TapeARN, args...))
...
"""
RetrieveTapeRecoveryPoint(GatewayARN, TapeARN) = storage_gateway("RetrieveTapeRecoveryPoint", Dict{String, Any}("GatewayARN"=>GatewayARN, "TapeARN"=>TapeARN))
RetrieveTapeRecoveryPoint(GatewayARN, TapeARN, args::AbstractDict{String, <: Any}) = storage_gateway("RetrieveTapeRecoveryPoint", Dict{String, Any}("GatewayARN"=>GatewayARN, "TapeARN"=>TapeARN, args...))
...
"""
SetLocalConsolePassword(GatewayARN, LocalConsolePassword) = storage_gateway("SetLocalConsolePassword", Dict{String, Any}("GatewayARN"=>GatewayARN, "LocalConsolePassword"=>LocalConsolePassword))
SetLocalConsolePassword(GatewayARN, LocalConsolePassword, args::AbstractDict{String, <: Any}) = storage_gateway("SetLocalConsolePassword", Dict{String, Any}("GatewayARN"=>GatewayARN, "LocalConsolePassword"=>LocalConsolePassword, args...))
...
"""
SetSMBGuestPassword(GatewayARN, Password) = storage_gateway("SetSMBGuestPassword", Dict{String, Any}("GatewayARN"=>GatewayARN, "Password"=>Password))
SetSMBGuestPassword(GatewayARN, Password, args::AbstractDict{String, <: Any}) = storage_gateway("SetSMBGuestPassword", Dict{String, Any}("GatewayARN"=>GatewayARN, "Password"=>Password, args...))
...
"""
ShutdownGateway(GatewayARN) = storage_gateway("ShutdownGateway", Dict{String, Any}("GatewayARN"=>GatewayARN))
ShutdownGateway(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("ShutdownGateway", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
StartAvailabilityMonitorTest(GatewayARN) = storage_gateway("StartAvailabilityMonitorTest", Dict{String, Any}("GatewayARN"=>GatewayARN))
StartAvailabilityMonitorTest(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("StartAvailabilityMonitorTest", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
StartGateway(GatewayARN) = storage_gateway("StartGateway", Dict{String, Any}("GatewayARN"=>GatewayARN))
StartGateway(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("StartGateway", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
UpdateAutomaticTapeCreationPolicy(AutomaticTapeCreationRules, GatewayARN) = storage_gateway("UpdateAutomaticTapeCreationPolicy", Dict{String, Any}("AutomaticTapeCreationRules"=>AutomaticTapeCreationRules, "GatewayARN"=>GatewayARN))
UpdateAutomaticTapeCreationPolicy(AutomaticTapeCreationRules, GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("UpdateAutomaticTapeCreationPolicy", Dict{String, Any}("AutomaticTapeCreationRules"=>AutomaticTapeCreationRules, "GatewayARN"=>GatewayARN, args...))
...
"""
UpdateBandwidthRateLimit(GatewayARN) = storage_gateway("UpdateBandwidthRateLimit", Dict{String, Any}("GatewayARN"=>GatewayARN))
UpdateBandwidthRateLimit(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("UpdateBandwidthRateLimit", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
UpdateChapCredentials(InitiatorName, SecretToAuthenticateInitiator, TargetARN) = storage_gateway("UpdateChapCredentials", Dict{String, Any}("InitiatorName"=>InitiatorName, "SecretToAuthenticateInitiator"=>SecretToAuthenticateInitiator, "TargetARN"=>TargetARN))
UpdateChapCredentials(InitiatorName, SecretToAuthenticateInitiator, TargetARN, args::AbstractDict{String, <: Any}) = storage_gateway("UpdateChapCredentials", Dict{String, Any}("InitiatorName"=>InitiatorName, "SecretToAuthenticateInitiator"=>SecretToAuthenticateInitiator, "TargetARN"=>TargetARN, args...))
...
"""
UpdateGatewayInformation(GatewayARN) = storage_gateway("UpdateGatewayInformation", Dict{String, Any}("GatewayARN"=>GatewayARN))
UpdateGatewayInformation(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("UpdateGatewayInformation", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
UpdateGatewaySoftwareNow(GatewayARN) = storage_gateway("UpdateGatewaySoftwareNow", Dict{String, Any}("GatewayARN"=>GatewayARN))
UpdateGatewaySoftwareNow(GatewayARN, args::AbstractDict{String, <: Any}) = storage_gateway("UpdateGatewaySoftwareNow", Dict{String, Any}("GatewayARN"=>GatewayARN, args...))
...
"""
UpdateMaintenanceStartTime(GatewayARN, HourOfDay, MinuteOfHour) = storage_gateway("UpdateMaintenanceStartTime", Dict{String, Any}("GatewayARN"=>GatewayARN, "HourOfDay"=>HourOfDay, "MinuteOfHour"=>MinuteOfHour))
UpdateMaintenanceStartTime(GatewayARN, HourOfDay, MinuteOfHour, args::AbstractDict{String, <: Any}) = storage_gateway("UpdateMaintenanceStartTime", Dict{String, Any}("GatewayARN"=>GatewayARN, "HourOfDay"=>HourOfDay, "MinuteOfHour"=>MinuteOfHour, args...))
...
"""
UpdateNFSFileShare(FileShareARN) = storage_gateway("UpdateNFSFileShare", Dict{String, Any}("FileShareARN"=>FileShareARN))
UpdateNFSFileShare(FileShareARN, args::AbstractDict{String, <: Any}) = storage_gateway("UpdateNFSFileShare", Dict{String, Any}("FileShareARN"=>FileShareARN, args...))
...
ValidUserList => A list of users or groups in the Active Directory that are allowed to access the file share. A group must be prefixed with the @ character. Acceptable formats include: DOMAIN User1, user1, @group1, and @DOMAIN group1. Can only be set if Authentication is set to ActiveDirectory.
"""
UpdateSMBFileShare(FileShareARN) = storage_gateway("UpdateSMBFileShare", Dict{String, Any}("FileShareARN"=>FileShareARN))
UpdateSMBFileShare(FileShareARN, args::AbstractDict{String, <: Any}) = storage_gateway("UpdateSMBFileShare", Dict{String, Any}("FileShareARN"=>FileShareARN, args...))
...
"""
UpdateSMBSecurityStrategy(GatewayARN, SMBSecurityStrategy) = storage_gateway("UpdateSMBSecurityStrategy", Dict{String, Any}("GatewayARN"=>GatewayARN, "SMBSecurityStrategy"=>SMBSecurityStrategy))
UpdateSMBSecurityStrategy(GatewayARN, SMBSecurityStrategy, args::AbstractDict{String, <: Any}) = storage_gateway("UpdateSMBSecurityStrategy", Dict{String, Any}("GatewayARN"=>GatewayARN, "SMBSecurityStrategy"=>SMBSecurityStrategy, args...))
...
Tags => A list of up to 50 tags that can be assigned to a snapshot. Each tag is a key-value pair.  Valid characters for key and value are letters, spaces, and numbers representable in UTF-8 format, and the following special characters: + - = . _ : / @. The maximum length of a tag's key is 128 characters, and the maximum length for a tag's value is 256. 
"""
UpdateSnapshotSchedule(RecurrenceInHours, StartAt, VolumeARN) = storage_gateway("UpdateSnapshotSchedule", Dict{String, Any}("RecurrenceInHours"=>RecurrenceInHours, "StartAt"=>StartAt, "VolumeARN"=>VolumeARN))
UpdateSnapshotSchedule(RecurrenceInHours, StartAt, VolumeARN, args::AbstractDict{String, <: Any}) = storage_gateway("UpdateSnapshotSchedule", Dict{String, Any}("RecurrenceInHours"=>RecurrenceInHours, "StartAt"=>StartAt, "VolumeARN"=>VolumeARN, args...))
...
"""
UpdateVTLDeviceType(DeviceType, VTLDeviceARN) = storage_gateway("UpdateVTLDeviceType", Dict{String, Any}("DeviceType"=>DeviceType, "VTLDeviceARN"=>VTLDeviceARN))
UpdateVTLDeviceType(DeviceType, VTLDeviceARN, args::AbstractDict{String, <: Any}) = storage_gateway("UpdateVTLDeviceType", Dict{String, Any}("DeviceType"=>DeviceType, "VTLDeviceARN"=>VTLDeviceARN, args...))
