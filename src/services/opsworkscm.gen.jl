...
"""
AssociateNode(EngineAttributes, NodeName, ServerName) = opsworkscm("AssociateNode", Dict{String, Any}("EngineAttributes"=>EngineAttributes, "NodeName"=>NodeName, "ServerName"=>ServerName))
AssociateNode(EngineAttributes, NodeName, ServerName, args::AbstractDict{String, <: Any}) = opsworkscm("AssociateNode", Dict{String, Any}("EngineAttributes"=>EngineAttributes, "NodeName"=>NodeName, "ServerName"=>ServerName, args...))
...
"""
CreateBackup(ServerName) = opsworkscm("CreateBackup", Dict{String, Any}("ServerName"=>ServerName))
CreateBackup(ServerName, args::AbstractDict{String, <: Any}) = opsworkscm("CreateBackup", Dict{String, Any}("ServerName"=>ServerName, args...))
...
"""
CreateServer(Engine, InstanceProfileArn, InstanceType, ServerName, ServiceRoleArn) = opsworkscm("CreateServer", Dict{String, Any}("Engine"=>Engine, "InstanceProfileArn"=>InstanceProfileArn, "InstanceType"=>InstanceType, "ServerName"=>ServerName, "ServiceRoleArn"=>ServiceRoleArn))
CreateServer(Engine, InstanceProfileArn, InstanceType, ServerName, ServiceRoleArn, args::AbstractDict{String, <: Any}) = opsworkscm("CreateServer", Dict{String, Any}("Engine"=>Engine, "InstanceProfileArn"=>InstanceProfileArn, "InstanceType"=>InstanceType, "ServerName"=>ServerName, "ServiceRoleArn"=>ServiceRoleArn, args...))
...
"""
DeleteBackup(BackupId) = opsworkscm("DeleteBackup", Dict{String, Any}("BackupId"=>BackupId))
DeleteBackup(BackupId, args::AbstractDict{String, <: Any}) = opsworkscm("DeleteBackup", Dict{String, Any}("BackupId"=>BackupId, args...))
...
"""
DeleteServer(ServerName) = opsworkscm("DeleteServer", Dict{String, Any}("ServerName"=>ServerName))
DeleteServer(ServerName, args::AbstractDict{String, <: Any}) = opsworkscm("DeleteServer", Dict{String, Any}("ServerName"=>ServerName, args...))
...
DescribeAccountAttributes(args::AbstractDict{String, <: Any}) = opsworkscm("DescribeAccountAttributes", args)
...
DescribeBackups(args::AbstractDict{String, <: Any}) = opsworkscm("DescribeBackups", args)
...
"""
DescribeEvents(ServerName) = opsworkscm("DescribeEvents", Dict{String, Any}("ServerName"=>ServerName))
DescribeEvents(ServerName, args::AbstractDict{String, <: Any}) = opsworkscm("DescribeEvents", Dict{String, Any}("ServerName"=>ServerName, args...))
...
"""
DescribeNodeAssociationStatus(NodeAssociationStatusToken, ServerName) = opsworkscm("DescribeNodeAssociationStatus", Dict{String, Any}("NodeAssociationStatusToken"=>NodeAssociationStatusToken, "ServerName"=>ServerName))
DescribeNodeAssociationStatus(NodeAssociationStatusToken, ServerName, args::AbstractDict{String, <: Any}) = opsworkscm("DescribeNodeAssociationStatus", Dict{String, Any}("NodeAssociationStatusToken"=>NodeAssociationStatusToken, "ServerName"=>ServerName, args...))
...
DescribeServers(args::AbstractDict{String, <: Any}) = opsworkscm("DescribeServers", args)
...
"""
DisassociateNode(NodeName, ServerName) = opsworkscm("DisassociateNode", Dict{String, Any}("NodeName"=>NodeName, "ServerName"=>ServerName))
DisassociateNode(NodeName, ServerName, args::AbstractDict{String, <: Any}) = opsworkscm("DisassociateNode", Dict{String, Any}("NodeName"=>NodeName, "ServerName"=>ServerName, args...))
...
"""
ExportServerEngineAttribute(ExportAttributeName, ServerName) = opsworkscm("ExportServerEngineAttribute", Dict{String, Any}("ExportAttributeName"=>ExportAttributeName, "ServerName"=>ServerName))
ExportServerEngineAttribute(ExportAttributeName, ServerName, args::AbstractDict{String, <: Any}) = opsworkscm("ExportServerEngineAttribute", Dict{String, Any}("ExportAttributeName"=>ExportAttributeName, "ServerName"=>ServerName, args...))
...
"""
ListTagsForResource(ResourceArn) = opsworkscm("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn))
ListTagsForResource(ResourceArn, args::AbstractDict{String, <: Any}) = opsworkscm("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
RestoreServer(BackupId, ServerName) = opsworkscm("RestoreServer", Dict{String, Any}("BackupId"=>BackupId, "ServerName"=>ServerName))
RestoreServer(BackupId, ServerName, args::AbstractDict{String, <: Any}) = opsworkscm("RestoreServer", Dict{String, Any}("BackupId"=>BackupId, "ServerName"=>ServerName, args...))
...
"""
StartMaintenance(ServerName) = opsworkscm("StartMaintenance", Dict{String, Any}("ServerName"=>ServerName))
StartMaintenance(ServerName, args::AbstractDict{String, <: Any}) = opsworkscm("StartMaintenance", Dict{String, Any}("ServerName"=>ServerName, args...))
...
"""
TagResource(ResourceArn, Tags) = opsworkscm("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags))
TagResource(ResourceArn, Tags, args::AbstractDict{String, <: Any}) = opsworkscm("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceArn, TagKeys) = opsworkscm("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys))
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <: Any}) = opsworkscm("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys, args...))
...
"""
UpdateServer(ServerName) = opsworkscm("UpdateServer", Dict{String, Any}("ServerName"=>ServerName))
UpdateServer(ServerName, args::AbstractDict{String, <: Any}) = opsworkscm("UpdateServer", Dict{String, Any}("ServerName"=>ServerName, args...))
...
"""
UpdateServerEngineAttributes(AttributeName, ServerName) = opsworkscm("UpdateServerEngineAttributes", Dict{String, Any}("AttributeName"=>AttributeName, "ServerName"=>ServerName))
UpdateServerEngineAttributes(AttributeName, ServerName, args::AbstractDict{String, <: Any}) = opsworkscm("UpdateServerEngineAttributes", Dict{String, Any}("AttributeName"=>AttributeName, "ServerName"=>ServerName, args...))
