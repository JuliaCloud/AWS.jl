...
"""
DescribeAffectedAccountsForOrganization(eventArn) = health("DescribeAffectedAccountsForOrganization", Dict{String, Any}("eventArn"=>eventArn))
DescribeAffectedAccountsForOrganization(eventArn, args::AbstractDict{String, <: Any}) = health("DescribeAffectedAccountsForOrganization", Dict{String, Any}("eventArn"=>eventArn, args...))
...
nextToken => If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
"""
DescribeAffectedEntities(filter) = health("DescribeAffectedEntities", Dict{String, Any}("filter"=>filter))
DescribeAffectedEntities(filter, args::AbstractDict{String, <: Any}) = health("DescribeAffectedEntities", Dict{String, Any}("filter"=>filter, args...))
...
nextToken => If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
"""
DescribeAffectedEntitiesForOrganization(organizationEntityFilters) = health("DescribeAffectedEntitiesForOrganization", Dict{String, Any}("organizationEntityFilters"=>organizationEntityFilters))
DescribeAffectedEntitiesForOrganization(organizationEntityFilters, args::AbstractDict{String, <: Any}) = health("DescribeAffectedEntitiesForOrganization", Dict{String, Any}("organizationEntityFilters"=>organizationEntityFilters, args...))
...
DescribeEntityAggregates(args::AbstractDict{String, <: Any}) = health("DescribeEntityAggregates", args)
...
nextToken => If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
"""
DescribeEventAggregates(aggregateField) = health("DescribeEventAggregates", Dict{String, Any}("aggregateField"=>aggregateField))
DescribeEventAggregates(aggregateField, args::AbstractDict{String, <: Any}) = health("DescribeEventAggregates", Dict{String, Any}("aggregateField"=>aggregateField, args...))
...
locale => The locale (language) to return information in. English (en) is the default and the only supported value at this time.
"""
DescribeEventDetails(eventArns) = health("DescribeEventDetails", Dict{String, Any}("eventArns"=>eventArns))
DescribeEventDetails(eventArns, args::AbstractDict{String, <: Any}) = health("DescribeEventDetails", Dict{String, Any}("eventArns"=>eventArns, args...))
...
locale => The locale (language) to return information in. English (en) is the default and the only supported value at this time.
"""
DescribeEventDetailsForOrganization(organizationEventDetailFilters) = health("DescribeEventDetailsForOrganization", Dict{String, Any}("organizationEventDetailFilters"=>organizationEventDetailFilters))
DescribeEventDetailsForOrganization(organizationEventDetailFilters, args::AbstractDict{String, <: Any}) = health("DescribeEventDetailsForOrganization", Dict{String, Any}("organizationEventDetailFilters"=>organizationEventDetailFilters, args...))
...
DescribeEventTypes(args::AbstractDict{String, <: Any}) = health("DescribeEventTypes", args)
...
DescribeEvents(args::AbstractDict{String, <: Any}) = health("DescribeEvents", args)
...
DescribeEventsForOrganization(args::AbstractDict{String, <: Any}) = health("DescribeEventsForOrganization", args)
...
DescribeHealthServiceStatusForOrganization(args::AbstractDict{String, <: Any}) = health("DescribeHealthServiceStatusForOrganization", args)
...
DisableHealthServiceAccessForOrganization(args::AbstractDict{String, <: Any}) = health("DisableHealthServiceAccessForOrganization", args)
...
EnableHealthServiceAccessForOrganization(args::AbstractDict{String, <: Any}) = health("EnableHealthServiceAccessForOrganization", args)
