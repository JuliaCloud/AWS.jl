...
"""
DescribeAffectedAccountsForOrganization(eventArn; aws::AWSConfig=AWSConfig()) = health("DescribeAffectedAccountsForOrganization", Dict{String, Any}("eventArn"=>eventArn); aws=aws)
DescribeAffectedAccountsForOrganization(eventArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("DescribeAffectedAccountsForOrganization", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("eventArn"=>eventArn), args)); aws=aws)
...
- `nextToken`: If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
"""
DescribeAffectedEntities(filter; aws::AWSConfig=AWSConfig()) = health("DescribeAffectedEntities", Dict{String, Any}("filter"=>filter); aws=aws)
DescribeAffectedEntities(filter, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("DescribeAffectedEntities", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("filter"=>filter), args)); aws=aws)
...
- `nextToken`: If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
"""
DescribeAffectedEntitiesForOrganization(organizationEntityFilters; aws::AWSConfig=AWSConfig()) = health("DescribeAffectedEntitiesForOrganization", Dict{String, Any}("organizationEntityFilters"=>organizationEntityFilters); aws=aws)
DescribeAffectedEntitiesForOrganization(organizationEntityFilters, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("DescribeAffectedEntitiesForOrganization", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("organizationEntityFilters"=>organizationEntityFilters), args)); aws=aws)
...
"""
DescribeEntityAggregates(; aws::AWSConfig=AWSConfig()) = health("DescribeEntityAggregates"; aws=aws)
DescribeEntityAggregates(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("DescribeEntityAggregates", args; aws=aws)
...
- `nextToken`: If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
"""
DescribeEventAggregates(aggregateField; aws::AWSConfig=AWSConfig()) = health("DescribeEventAggregates", Dict{String, Any}("aggregateField"=>aggregateField); aws=aws)
DescribeEventAggregates(aggregateField, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("DescribeEventAggregates", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("aggregateField"=>aggregateField), args)); aws=aws)
...
- `locale`: The locale (language) to return information in. English (en) is the default and the only supported value at this time.
"""
DescribeEventDetails(eventArns; aws::AWSConfig=AWSConfig()) = health("DescribeEventDetails", Dict{String, Any}("eventArns"=>eventArns); aws=aws)
DescribeEventDetails(eventArns, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("DescribeEventDetails", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("eventArns"=>eventArns), args)); aws=aws)
...
- `locale`: The locale (language) to return information in. English (en) is the default and the only supported value at this time.
"""
DescribeEventDetailsForOrganization(organizationEventDetailFilters; aws::AWSConfig=AWSConfig()) = health("DescribeEventDetailsForOrganization", Dict{String, Any}("organizationEventDetailFilters"=>organizationEventDetailFilters); aws=aws)
DescribeEventDetailsForOrganization(organizationEventDetailFilters, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("DescribeEventDetailsForOrganization", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("organizationEventDetailFilters"=>organizationEventDetailFilters), args)); aws=aws)
...
- `nextToken`: If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
"""
DescribeEventTypes(; aws::AWSConfig=AWSConfig()) = health("DescribeEventTypes"; aws=aws)
DescribeEventTypes(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("DescribeEventTypes", args; aws=aws)
...
- `nextToken`: If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
"""
DescribeEvents(; aws::AWSConfig=AWSConfig()) = health("DescribeEvents"; aws=aws)
DescribeEvents(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("DescribeEvents", args; aws=aws)
...
- `nextToken`: If the results of a search are large, only a portion of the results are returned, and a nextToken pagination token is returned in the response. To retrieve the next batch of results, reissue the search request and include the returned token. When all results have been returned, the response does not contain a pagination token value.
"""
DescribeEventsForOrganization(; aws::AWSConfig=AWSConfig()) = health("DescribeEventsForOrganization"; aws=aws)
DescribeEventsForOrganization(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("DescribeEventsForOrganization", args; aws=aws)
...
"""
DescribeHealthServiceStatusForOrganization(; aws::AWSConfig=AWSConfig()) = health("DescribeHealthServiceStatusForOrganization"; aws=aws)
DescribeHealthServiceStatusForOrganization(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("DescribeHealthServiceStatusForOrganization", args; aws=aws)
...
"""
DisableHealthServiceAccessForOrganization(; aws::AWSConfig=AWSConfig()) = health("DisableHealthServiceAccessForOrganization"; aws=aws)
DisableHealthServiceAccessForOrganization(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("DisableHealthServiceAccessForOrganization", args; aws=aws)
...
"""
EnableHealthServiceAccessForOrganization(; aws::AWSConfig=AWSConfig()) = health("EnableHealthServiceAccessForOrganization"; aws=aws)
EnableHealthServiceAccessForOrganization(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = health("EnableHealthServiceAccessForOrganization", args; aws=aws)
