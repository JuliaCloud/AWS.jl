...
- `"AllowClassicFlow"`: Enables or disables the Basic (Classic) authentication flow. For
  more information, see [Identity Pools (Federated Identities) Authentication Flow](https://docs.aws.amazon.com/cognito/latest/developerguide/authentication-flow.html)
...
- `"DeveloperProviderName"`: The "domain" by which Cognito will refer to your users. This
  name acts as a placeholder that allows your backend and the Cognito service to
...
"""
delete_identities(IdentityIdsToDelete; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("DeleteIdentities", Dict{String, Any}("IdentityIdsToDelete"=>IdentityIdsToDelete); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_identities(IdentityIdsToDelete, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("DeleteIdentities", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityIdsToDelete"=>IdentityIdsToDelete), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_identity_pool(IdentityPoolId; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("DeleteIdentityPool", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_identity_pool(IdentityPoolId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("DeleteIdentityPool", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_identity(IdentityId; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("DescribeIdentity", Dict{String, Any}("IdentityId"=>IdentityId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_identity(IdentityId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("DescribeIdentity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityId"=>IdentityId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `identity_pool_id`: An identity pool ID in the format REGION:GUID.
"""
describe_identity_pool(IdentityPoolId; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("DescribeIdentityPool", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_identity_pool(IdentityPoolId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("DescribeIdentityPool", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_credentials_for_identity(IdentityId; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("GetCredentialsForIdentity", Dict{String, Any}("IdentityId"=>IdentityId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_credentials_for_identity(IdentityId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("GetCredentialsForIdentity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityId"=>IdentityId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"Logins"`: A set of optional name-value pairs that map provider names to provider
 ...
 - Digits: `www.digits.com`
"""
get_id(IdentityPoolId; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("GetId", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_id(IdentityPoolId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("GetId", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `identity_pool_id`: An identity pool ID in the format REGION:GUID.
"""
get_identity_pool_roles(IdentityPoolId; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("GetIdentityPoolRoles", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_identity_pool_roles(IdentityPoolId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("GetIdentityPoolRoles", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"Logins"`: A set of optional name-value pairs that map provider names to provider
  tokens. When using graph.facebook.com and www.amazon.com, supply the access_token
  returned from the provider's authflow. For accounts.google.com, an Amazon Cognito user
  pool provider, or any other OpenID Connect provider, always include the `id_token`.
"""
get_open_id_token(IdentityId; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("GetOpenIdToken", Dict{String, Any}("IdentityId"=>IdentityId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_open_id_token(IdentityId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("GetOpenIdToken", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityId"=>IdentityId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
When you want to associate a new login with an existing authenticated/unauthenticated
...
- `logins`: A set of optional name-value pairs that map provider names to provider tokens.
  Each name-value pair represents a user from a public provider or developer provider. If
...
- `"TokenDuration"`: The expiration time of the token, in seconds. You can specify a custom
  ...
  for clock skew.
"""
get_open_id_token_for_developer_identity(IdentityPoolId, Logins; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("GetOpenIdTokenForDeveloperIdentity", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "Logins"=>Logins); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_open_id_token_for_developer_identity(IdentityPoolId, Logins, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("GetOpenIdTokenForDeveloperIdentity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "Logins"=>Logins), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_identities(IdentityPoolId, MaxResults; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("ListIdentities", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "MaxResults"=>MaxResults); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_identities(IdentityPoolId, MaxResults, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("ListIdentities", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "MaxResults"=>MaxResults), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: A pagination token.
"""
list_identity_pools(MaxResults; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("ListIdentityPools", Dict{String, Any}("MaxResults"=>MaxResults); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_identity_pools(MaxResults, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("ListIdentityPools", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MaxResults"=>MaxResults), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `resource_arn`: The Amazon Resource Name (ARN) of the identity pool that the tags are
  assigned to.
"""
list_tags_for_resource(ResourceArn; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_tags_for_resource(ResourceArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
of these values, the other value will be searched in the database and returned as a part of
...
"""
lookup_developer_identity(IdentityPoolId; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("LookupDeveloperIdentity", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
lookup_developer_identity(IdentityPoolId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("LookupDeveloperIdentity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
source user, `SourceUserIdentifier`, and the destination user, `DestinationUserIdentifier`,
...
"""
set_identity_pool_roles(IdentityPoolId, Roles; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("SetIdentityPoolRoles", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "Roles"=>Roles); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
set_identity_pool_roles(IdentityPoolId, Roles, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("SetIdentityPoolRoles", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "Roles"=>Roles), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
for more specific values. For example, if you have two versions of an identity pool, one
for testing and another for production, you might assign an `Environment` tag key to both
...
"""
tag_resource(ResourceArn, Tags; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
tag_resource(ResourceArn, Tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
will be considered new identities next time they are seen. If, for a given Cognito
identity, you remove all federated identities as well as the developer user identifier, the
...
"""
unlink_identity(IdentityId, Logins, LoginsToRemove; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("UnlinkIdentity", Dict{String, Any}("IdentityId"=>IdentityId, "Logins"=>Logins, "LoginsToRemove"=>LoginsToRemove); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
untag_resource(ResourceArn, TagKeys; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
untag_resource(ResourceArn, TagKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = cognito_identity("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"IdentityPoolTags"`: The tags that are assigned to the identity pool. A tag is a label
  that you can apply to identity pools to categorize and manage them in different ways,
