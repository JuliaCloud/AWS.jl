...
CreateIdentityPool(AllowUnauthenticatedIdentities, IdentityPoolName; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("CreateIdentityPool", Dict{String, Any}("AllowUnauthenticatedIdentities"=>AllowUnauthenticatedIdentities, "IdentityPoolName"=>IdentityPoolName); aws_config=aws_config)
CreateIdentityPool(AllowUnauthenticatedIdentities, IdentityPoolName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("CreateIdentityPool", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AllowUnauthenticatedIdentities"=>AllowUnauthenticatedIdentities, "IdentityPoolName"=>IdentityPoolName), args)); aws_config=aws_config)
...
DeleteIdentities(IdentityIdsToDelete; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("DeleteIdentities", Dict{String, Any}("IdentityIdsToDelete"=>IdentityIdsToDelete); aws_config=aws_config)
DeleteIdentities(IdentityIdsToDelete, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("DeleteIdentities", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityIdsToDelete"=>IdentityIdsToDelete), args)); aws_config=aws_config)
...
DeleteIdentityPool(IdentityPoolId; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("DeleteIdentityPool", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId); aws_config=aws_config)
DeleteIdentityPool(IdentityPoolId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("DeleteIdentityPool", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId), args)); aws_config=aws_config)
...
DescribeIdentity(IdentityId; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("DescribeIdentity", Dict{String, Any}("IdentityId"=>IdentityId); aws_config=aws_config)
DescribeIdentity(IdentityId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("DescribeIdentity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityId"=>IdentityId), args)); aws_config=aws_config)
...
DescribeIdentityPool(IdentityPoolId; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("DescribeIdentityPool", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId); aws_config=aws_config)
DescribeIdentityPool(IdentityPoolId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("DescribeIdentityPool", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId), args)); aws_config=aws_config)
...
GetCredentialsForIdentity(IdentityId; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("GetCredentialsForIdentity", Dict{String, Any}("IdentityId"=>IdentityId); aws_config=aws_config)
GetCredentialsForIdentity(IdentityId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("GetCredentialsForIdentity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityId"=>IdentityId), args)); aws_config=aws_config)
...
GetId(IdentityPoolId; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("GetId", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId); aws_config=aws_config)
GetId(IdentityPoolId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("GetId", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId), args)); aws_config=aws_config)
...
GetIdentityPoolRoles(IdentityPoolId; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("GetIdentityPoolRoles", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId); aws_config=aws_config)
GetIdentityPoolRoles(IdentityPoolId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("GetIdentityPoolRoles", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId), args)); aws_config=aws_config)
...
GetOpenIdToken(IdentityId; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("GetOpenIdToken", Dict{String, Any}("IdentityId"=>IdentityId); aws_config=aws_config)
GetOpenIdToken(IdentityId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("GetOpenIdToken", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityId"=>IdentityId), args)); aws_config=aws_config)
...
GetOpenIdTokenForDeveloperIdentity(IdentityPoolId, Logins; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("GetOpenIdTokenForDeveloperIdentity", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "Logins"=>Logins); aws_config=aws_config)
GetOpenIdTokenForDeveloperIdentity(IdentityPoolId, Logins, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("GetOpenIdTokenForDeveloperIdentity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "Logins"=>Logins), args)); aws_config=aws_config)
...
ListIdentities(IdentityPoolId, MaxResults; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("ListIdentities", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "MaxResults"=>MaxResults); aws_config=aws_config)
ListIdentities(IdentityPoolId, MaxResults, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("ListIdentities", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "MaxResults"=>MaxResults), args)); aws_config=aws_config)
...
ListIdentityPools(MaxResults; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("ListIdentityPools", Dict{String, Any}("MaxResults"=>MaxResults); aws_config=aws_config)
ListIdentityPools(MaxResults, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("ListIdentityPools", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MaxResults"=>MaxResults), args)); aws_config=aws_config)
...
ListTagsForResource(ResourceArn; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config)
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), args)); aws_config=aws_config)
...
LookupDeveloperIdentity(IdentityPoolId; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("LookupDeveloperIdentity", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId); aws_config=aws_config)
LookupDeveloperIdentity(IdentityPoolId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("LookupDeveloperIdentity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId), args)); aws_config=aws_config)
...
SetIdentityPoolRoles(IdentityPoolId, Roles; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("SetIdentityPoolRoles", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "Roles"=>Roles); aws_config=aws_config)
SetIdentityPoolRoles(IdentityPoolId, Roles, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("SetIdentityPoolRoles", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "Roles"=>Roles), args)); aws_config=aws_config)
...
TagResource(ResourceArn, Tags; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags); aws_config=aws_config)
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags), args)); aws_config=aws_config)
...
UnlinkIdentity(IdentityId, Logins, LoginsToRemove; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("UnlinkIdentity", Dict{String, Any}("IdentityId"=>IdentityId, "Logins"=>Logins, "LoginsToRemove"=>LoginsToRemove); aws_config=aws_config)
UnlinkIdentity(IdentityId, Logins, LoginsToRemove, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("UnlinkIdentity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IdentityId"=>IdentityId, "Logins"=>Logins, "LoginsToRemove"=>LoginsToRemove), args)); aws_config=aws_config)
...
UntagResource(ResourceArn, TagKeys; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys); aws_config=aws_config)
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), args)); aws_config=aws_config)
...
UpdateIdentityPool(AllowUnauthenticatedIdentities, IdentityPoolId, IdentityPoolName; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("UpdateIdentityPool", Dict{String, Any}("AllowUnauthenticatedIdentities"=>AllowUnauthenticatedIdentities, "IdentityPoolId"=>IdentityPoolId, "IdentityPoolName"=>IdentityPoolName); aws_config=aws_config)
UpdateIdentityPool(AllowUnauthenticatedIdentities, IdentityPoolId, IdentityPoolName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = cognito_identity("UpdateIdentityPool", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AllowUnauthenticatedIdentities"=>AllowUnauthenticatedIdentities, "IdentityPoolId"=>IdentityPoolId, "IdentityPoolName"=>IdentityPoolName), args)); aws_config=aws_config)
