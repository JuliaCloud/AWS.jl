...
"""
CreateIdentityPool(AllowUnauthenticatedIdentities, IdentityPoolName) = cognito_identity("CreateIdentityPool", Dict{String, Any}("AllowUnauthenticatedIdentities"=>AllowUnauthenticatedIdentities, "IdentityPoolName"=>IdentityPoolName))
CreateIdentityPool(AllowUnauthenticatedIdentities, IdentityPoolName, args::AbstractDict{String, <:Any}) = cognito_identity("CreateIdentityPool", Dict{String, Any}("AllowUnauthenticatedIdentities"=>AllowUnauthenticatedIdentities, "IdentityPoolName"=>IdentityPoolName, args...))
...
"""
DeleteIdentities(IdentityIdsToDelete) = cognito_identity("DeleteIdentities", Dict{String, Any}("IdentityIdsToDelete"=>IdentityIdsToDelete))
DeleteIdentities(IdentityIdsToDelete, args::AbstractDict{String, <:Any}) = cognito_identity("DeleteIdentities", Dict{String, Any}("IdentityIdsToDelete"=>IdentityIdsToDelete, args...))
...
"""
DeleteIdentityPool(IdentityPoolId) = cognito_identity("DeleteIdentityPool", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId))
DeleteIdentityPool(IdentityPoolId, args::AbstractDict{String, <:Any}) = cognito_identity("DeleteIdentityPool", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, args...))
...
"""
DescribeIdentity(IdentityId) = cognito_identity("DescribeIdentity", Dict{String, Any}("IdentityId"=>IdentityId))
DescribeIdentity(IdentityId, args::AbstractDict{String, <:Any}) = cognito_identity("DescribeIdentity", Dict{String, Any}("IdentityId"=>IdentityId, args...))
...
"""
DescribeIdentityPool(IdentityPoolId) = cognito_identity("DescribeIdentityPool", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId))
DescribeIdentityPool(IdentityPoolId, args::AbstractDict{String, <:Any}) = cognito_identity("DescribeIdentityPool", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, args...))
...
"""
GetCredentialsForIdentity(IdentityId) = cognito_identity("GetCredentialsForIdentity", Dict{String, Any}("IdentityId"=>IdentityId))
GetCredentialsForIdentity(IdentityId, args::AbstractDict{String, <:Any}) = cognito_identity("GetCredentialsForIdentity", Dict{String, Any}("IdentityId"=>IdentityId, args...))
...
"""
GetId(IdentityPoolId) = cognito_identity("GetId", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId))
GetId(IdentityPoolId, args::AbstractDict{String, <:Any}) = cognito_identity("GetId", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, args...))
...
"""
GetIdentityPoolRoles(IdentityPoolId) = cognito_identity("GetIdentityPoolRoles", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId))
GetIdentityPoolRoles(IdentityPoolId, args::AbstractDict{String, <:Any}) = cognito_identity("GetIdentityPoolRoles", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, args...))
...
"""
GetOpenIdToken(IdentityId) = cognito_identity("GetOpenIdToken", Dict{String, Any}("IdentityId"=>IdentityId))
GetOpenIdToken(IdentityId, args::AbstractDict{String, <:Any}) = cognito_identity("GetOpenIdToken", Dict{String, Any}("IdentityId"=>IdentityId, args...))
...
"""
GetOpenIdTokenForDeveloperIdentity(IdentityPoolId, Logins) = cognito_identity("GetOpenIdTokenForDeveloperIdentity", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "Logins"=>Logins))
GetOpenIdTokenForDeveloperIdentity(IdentityPoolId, Logins, args::AbstractDict{String, <:Any}) = cognito_identity("GetOpenIdTokenForDeveloperIdentity", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "Logins"=>Logins, args...))
...
"""
ListIdentities(IdentityPoolId, MaxResults) = cognito_identity("ListIdentities", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "MaxResults"=>MaxResults))
ListIdentities(IdentityPoolId, MaxResults, args::AbstractDict{String, <:Any}) = cognito_identity("ListIdentities", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "MaxResults"=>MaxResults, args...))
...
- `NextToken`: A pagination token.
"""
ListIdentityPools(MaxResults) = cognito_identity("ListIdentityPools", Dict{String, Any}("MaxResults"=>MaxResults))
ListIdentityPools(MaxResults, args::AbstractDict{String, <:Any}) = cognito_identity("ListIdentityPools", Dict{String, Any}("MaxResults"=>MaxResults, args...))
...
"""
ListTagsForResource(ResourceArn) = cognito_identity("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn))
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}) = cognito_identity("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
LookupDeveloperIdentity(IdentityPoolId) = cognito_identity("LookupDeveloperIdentity", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId))
LookupDeveloperIdentity(IdentityPoolId, args::AbstractDict{String, <:Any}) = cognito_identity("LookupDeveloperIdentity", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, args...))
...
"""
MergeDeveloperIdentities(DestinationUserIdentifier, DeveloperProviderName, IdentityPoolId, SourceUserIdentifier) = cognito_identity("MergeDeveloperIdentities", Dict{String, Any}("DestinationUserIdentifier"=>DestinationUserIdentifier, "DeveloperProviderName"=>DeveloperProviderName, "IdentityPoolId"=>IdentityPoolId, "SourceUserIdentifier"=>SourceUserIdentifier))
MergeDeveloperIdentities(DestinationUserIdentifier, DeveloperProviderName, IdentityPoolId, SourceUserIdentifier, args::AbstractDict{String, <:Any}) = cognito_identity("MergeDeveloperIdentities", Dict{String, Any}("DestinationUserIdentifier"=>DestinationUserIdentifier, "DeveloperProviderName"=>DeveloperProviderName, "IdentityPoolId"=>IdentityPoolId, "SourceUserIdentifier"=>SourceUserIdentifier, args...))
...
"""
SetIdentityPoolRoles(IdentityPoolId, Roles) = cognito_identity("SetIdentityPoolRoles", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "Roles"=>Roles))
SetIdentityPoolRoles(IdentityPoolId, Roles, args::AbstractDict{String, <:Any}) = cognito_identity("SetIdentityPoolRoles", Dict{String, Any}("IdentityPoolId"=>IdentityPoolId, "Roles"=>Roles, args...))
...
"""
TagResource(ResourceArn, Tags) = cognito_identity("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags))
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}) = cognito_identity("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags, args...))
...
"""
UnlinkDeveloperIdentity(DeveloperProviderName, DeveloperUserIdentifier, IdentityId, IdentityPoolId) = cognito_identity("UnlinkDeveloperIdentity", Dict{String, Any}("DeveloperProviderName"=>DeveloperProviderName, "DeveloperUserIdentifier"=>DeveloperUserIdentifier, "IdentityId"=>IdentityId, "IdentityPoolId"=>IdentityPoolId))
UnlinkDeveloperIdentity(DeveloperProviderName, DeveloperUserIdentifier, IdentityId, IdentityPoolId, args::AbstractDict{String, <:Any}) = cognito_identity("UnlinkDeveloperIdentity", Dict{String, Any}("DeveloperProviderName"=>DeveloperProviderName, "DeveloperUserIdentifier"=>DeveloperUserIdentifier, "IdentityId"=>IdentityId, "IdentityPoolId"=>IdentityPoolId, args...))
...
"""
UnlinkIdentity(IdentityId, Logins, LoginsToRemove) = cognito_identity("UnlinkIdentity", Dict{String, Any}("IdentityId"=>IdentityId, "Logins"=>Logins, "LoginsToRemove"=>LoginsToRemove))
UnlinkIdentity(IdentityId, Logins, LoginsToRemove, args::AbstractDict{String, <:Any}) = cognito_identity("UnlinkIdentity", Dict{String, Any}("IdentityId"=>IdentityId, "Logins"=>Logins, "LoginsToRemove"=>LoginsToRemove, args...))
...
"""
UntagResource(ResourceArn, TagKeys) = cognito_identity("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys))
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}) = cognito_identity("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys, args...))
...
- `SupportedLoginProviders`: Optional key:value pairs mapping provider names to provider app IDs.
"""
UpdateIdentityPool(AllowUnauthenticatedIdentities, IdentityPoolId, IdentityPoolName) = cognito_identity("UpdateIdentityPool", Dict{String, Any}("AllowUnauthenticatedIdentities"=>AllowUnauthenticatedIdentities, "IdentityPoolId"=>IdentityPoolId, "IdentityPoolName"=>IdentityPoolName))
UpdateIdentityPool(AllowUnauthenticatedIdentities, IdentityPoolId, IdentityPoolName, args::AbstractDict{String, <:Any}) = cognito_identity("UpdateIdentityPool", Dict{String, Any}("AllowUnauthenticatedIdentities"=>AllowUnauthenticatedIdentities, "IdentityPoolId"=>IdentityPoolId, "IdentityPoolName"=>IdentityPoolName, args...))
