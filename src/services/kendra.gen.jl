...
"""
CreateIndex(Name, RoleArn) = kendra("CreateIndex", Dict{String, Any}("Name"=>Name, "RoleArn"=>RoleArn))
CreateIndex(Name, RoleArn, args::AbstractDict{String, <: Any}) = kendra("CreateIndex", Dict{String, Any}("Name"=>Name, "RoleArn"=>RoleArn, args...))
