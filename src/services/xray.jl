...
!!! note
    You cannot find traces through this API if Transaction Search is enabled since trace is
    not indexed in X-Ray.
...
"""
    cancel_trace_retrieval(retrieval_token)
    cancel_trace_retrieval(retrieval_token, params::Dict{String,<:Any})
...
"""
function cancel_trace_retrieval end

function cancel_trace_retrieval(
    RetrievalToken; aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray(
        "POST",
        "/CancelTraceRetrieval",
        Dict{String,Any}("RetrievalToken" => RetrievalToken);
        aws_config,
        feature_set=SERVICE_FEATURE_SET,
    )
end
...
function cancel_trace_retrieval(
    ...
    return xray(
        ...
        "/CancelTraceRetrieval",
        Dict{String,Any}(
            mergewith(_merge, Dict{String,Any}("RetrievalToken" => RetrievalToken), params)
        );
        aws_config,
        feature_set=SERVICE_FEATURE_SET,
    )
...
function delete_group(; aws_config::AbstractAWSConfig=current_aws_config())
    return xray("POST", "/DeleteGroup"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function delete_group(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray("POST", "/DeleteGroup", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function delete_sampling_rule(; aws_config::AbstractAWSConfig=current_aws_config())
    return xray("POST", "/DeleteSamplingRule"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function delete_sampling_rule(
    ...
    return xray(
        "POST", "/DeleteSamplingRule", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function get_encryption_config end

function get_encryption_config(; aws_config::AbstractAWSConfig=current_aws_config())
    return xray("POST", "/EncryptionConfig"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_encryption_config(
    ...
    return xray(
        "POST", "/EncryptionConfig", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_group(; aws_config::AbstractAWSConfig=current_aws_config())
    return xray("POST", "/GetGroup"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_group(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray("POST", "/GetGroup", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_groups(; aws_config::AbstractAWSConfig=current_aws_config())
    return xray("POST", "/Groups"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_groups(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray("POST", "/Groups", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    get_indexing_rules()
    get_indexing_rules(params::Dict{String,<:Any})

Retrieves all indexing rules.

Indexing rules are used to determine the server-side sampling rate for spans ingested
through the CloudWatchLogs destination and indexed by X-Ray. For more information, see [Transaction Search](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Transaction-Search.html).
...
"""
function get_indexing_rules end

function get_indexing_rules(; aws_config::AbstractAWSConfig=current_aws_config())
    return xray("POST", "/GetIndexingRules"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_indexing_rules(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray(
        "POST", "/GetIndexingRules", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function get_insight_summaries end
...
"""
    get_retrieved_traces_graph(retrieval_token)
    get_retrieved_traces_graph(retrieval_token, params::Dict{String,<:Any})

Retrieves a service graph for traces based on the specified `RetrievalToken` from the
CloudWatch log group generated by Transaction Search. This API does not initiate a retrieval
job. You must first execute `StartTraceRetrieval` to obtain the required `RetrievalToken`.

The trace graph describes services that process incoming requests and any downstream
services they call, which may include Amazon Web Services resources, external APIs, or
databases.

The response is empty until the `RetrievalStatus` is *COMPLETE*. Retry the request after the
status changes from *RUNNING* or *SCHEDULED* to *COMPLETE* to access the full service graph.

When CloudWatch log is the destination, this API can support cross-account observability and
service graph retrieval across linked accounts.

For retrieving graphs from X-Ray directly as opposed to the Transaction-Search Log group,
see [GetTraceGraph](https://docs.aws.amazon.com/xray/latest/api/API_GetTraceGraph.html).
...
- `"NextToken"`: Specify the pagination token returned by a previous request to retrieve the
  next page of indexes.
"""
function get_retrieved_traces_graph end

function get_retrieved_traces_graph(
    RetrievalToken; aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray(
        "POST",
...
- `"NextToken"`: Pagination token.
"""
function get_sampling_rules end

function get_sampling_rules(; aws_config::AbstractAWSConfig=current_aws_config())
    return xray("POST", "/GetSamplingRules"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_sampling_rules(
    ...
    return xray(
        "POST", "/GetSamplingRules", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"NextToken"`: Pagination token.
"""
function get_sampling_statistic_summaries end

function get_sampling_statistic_summaries(;
    aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray(
        "POST", "/SamplingStatisticSummaries"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"SamplingBoostStatisticsDocuments"`: Information about rules that the service is using to
  boost sampling rate.
"""
function get_sampling_targets end
...
- `"NextToken"`: Pagination token.
"""
function get_service_graph end
...
"""
function get_time_series_service_statistics end
...
"""
    ...
    get_trace_segment_destination(params::Dict{String,<:Any})

Retrieves the current destination of data sent to `PutTraceSegments` and *OpenTelemetry
protocol (OTLP)* endpoint. The Transaction Search feature requires a CloudWatchLogs
destination. For more information, see [Transaction Search](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Transaction-Search.html)
and [OpenTelemetry](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-OpenTelemetry-Sections.html).
"""
function get_trace_segment_destination end

function get_trace_segment_destination(; aws_config::AbstractAWSConfig=current_aws_config())
    return xray(
        "POST", "/GetTraceSegmentDestination"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end

function get_trace_segment_destination(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray(
        "POST",
...
For a full list of indexed fields and keywords that you can use in filter expressions, see [Use filter expressions](https://docs.aws.amazon.com/xray/latest/devguide/aws-xray-interface-console.html#xray-console-filters)
...
- `"TimeRangeType"`: Query trace summaries by TraceId (trace start time), Event (trace
  update time), or Service (trace segment end time).
"""
function get_trace_summaries end
...
function list_resource_policies(; aws_config::AbstractAWSConfig=current_aws_config())
    return xray(
        "POST", "/ListResourcePolicies"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_resource_policies(
    ...
    return xray(
        "POST", "/ListResourcePolicies", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end

"""
    list_retrieved_traces(retrieval_token)
    list_retrieved_traces(retrieval_token, params::Dict{String,<:Any})

Retrieves a list of traces for a given `RetrievalToken` from the CloudWatch log group
generated by Transaction Search. For information on what each trace returns, see [BatchGetTraces](https://docs.aws.amazon.com/xray/latest/api/API_BatchGetTraces.html).
...
When the `RetrievalStatus` is not *COMPLETE*, the API will return an empty response. Retry
the request once the retrieval has completed to access the full list of traces.

For cross-account observability, this API can retrieve traces from linked accounts when
CloudWatch log is set as the destination across relevant accounts. For more details, see [CloudWatch cross-account observability](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Unified-Cross-Account.html).

For retrieving data from X-Ray directly as opposed to the Transaction Search generated log
group, see [BatchGetTraces](https://docs.aws.amazon.com/xray/latest/api/API_BatchGetTraces.html).
...
"""
function list_retrieved_traces end

function list_retrieved_traces(
    RetrievalToken; aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray(
        "POST",
...
Uploads segment documents to Amazon Web Services X-Ray. A segment document can be a
completed segment, an in-progress segment, or an array of subsegments.

Segments must include the following fields. For the full segment document schema, see [Amazon Web Services X-Ray Segment Documents](https://docs.aws.amazon.com/xray/latest/devguide/aws-xray-interface-api.html#xray-api-segmentdocuments.html)
in the *Amazon Web Services X-Ray Developer Guide*.
...
a006649127e371903a2de979. For trace IDs created by an X-Ray SDK, or by Amazon Web Services
services integrated with X-Ray, a trace ID includes:
...
!!! note
    Trace IDs created via OpenTelemetry have a different format based on the [W3C Trace Context specification](https://www.w3.org/TR/trace-context/).
    A W3C trace ID must be formatted in the X-Ray trace ID format when sending to X-Ray. For
    example, a W3C trace ID `4efaaf4d1e8720b39541901950019ee5` should be formatted as
    `1-4efaaf4d-1e8720b39541901950019ee5` when sending to X-Ray. While X-Ray trace IDs
    include the original request timestamp in Unix epoch time, this is not required or
    validated.
...
"""
function put_trace_segments end
...
"""
    start_trace_retrieval(end_time, start_time, trace_ids)
    start_trace_retrieval(end_time, start_time, trace_ids, params::Dict{String,<:Any})

Initiates a trace retrieval process using the specified time range and for the given trace
IDs in the Transaction Search generated CloudWatch log group. For more information, see [Transaction Search](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Transaction-Search.html).

API returns a `RetrievalToken`, which can be used with `ListRetrievedTraces` or
`GetRetrievedTracesGraph` to fetch results. Retrievals will time out after 60 minutes. To
execute long time ranges, consider segmenting into multiple retrievals.
...
you can use this operation in a monitoring account to retrieve data from a linked source
account, as long as both accounts have transaction search enabled.
...
- `end_time`: The end of the time range to retrieve traces. The range is inclusive, so the
  specified end time is included in the query. Specified as epoch time, the number of
  seconds since January 1, 1970, 00:00:00 UTC.
- `start_time`: The start of the time range to retrieve traces. The range is inclusive, so
  the specified start time is included in the query. Specified as epoch time, the number of
  seconds since January 1, 1970, 00:00:00 UTC.
- `trace_ids`: Specify the trace IDs of the traces to be retrieved.
"""
function start_trace_retrieval end

function start_trace_retrieval(
    EndTime, StartTime, TraceIds; aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray(
        "POST",
        "/StartTraceRetrieval",
        Dict{String,Any}(
            "EndTime" => EndTime, "StartTime" => StartTime, "TraceIds" => TraceIds
        );
        aws_config,
        feature_set=SERVICE_FEATURE_SET,
    )
...
function update_group(; aws_config::AbstractAWSConfig=current_aws_config())
    return xray("POST", "/UpdateGroup"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function update_group(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray("POST", "/UpdateGroup", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    update_indexing_rule(name, rule)
    update_indexing_rule(name, rule, params::Dict{String,<:Any})

Modifies an indexing rule’s configuration.

Indexing rules are used for determining the sampling rate for spans indexed from CloudWatch
Logs. For more information, see [Transaction Search](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Transaction-Search.html).
...
"""
function update_indexing_rule end

function update_indexing_rule(
    Name, Rule; aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray(
        "POST",
        "/UpdateIndexingRule",
...
"""
function update_sampling_rule end
...
"""
    ...
    update_trace_segment_destination(params::Dict{String,<:Any})

Modifies the destination of data sent to `PutTraceSegments`. The Transaction Search feature
requires the CloudWatchLogs destination. For more information, see [Transaction Search](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch-Transaction-Search.html).
...
"""
function update_trace_segment_destination end

function update_trace_segment_destination(;
    aws_config::AbstractAWSConfig=current_aws_config()
)
    return xray(
        "POST",
