...
function describe_group(
    GroupId, IdentityStoreId; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...
)
...
function describe_user(
    IdentityStoreId, UserId; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...
)
    params = amazonify(MAPPING, kwargs)
    return identitystore(
        "DescribeUser",
...
- `"next_token"`: The pagination token used for the ListUsers and ListGroups API
...
function list_groups(
    IdentityStoreId; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...
)
    params = amazonify(MAPPING, kwargs)
    return identitystore(
        "ListGroups",
