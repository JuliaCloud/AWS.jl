...
AllocateStaticIp(staticIpName; aws_config::AWSConfig=global_aws_config()) = lightsail("AllocateStaticIp", Dict{String, Any}("staticIpName"=>staticIpName); aws_config=aws_config)
AllocateStaticIp(staticIpName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("AllocateStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("staticIpName"=>staticIpName), args)); aws_config=aws_config)
...
AttachCertificateToDistribution(certificateName, distributionName; aws_config::AWSConfig=global_aws_config()) = lightsail("AttachCertificateToDistribution", Dict{String, Any}("certificateName"=>certificateName, "distributionName"=>distributionName); aws_config=aws_config)
AttachCertificateToDistribution(certificateName, distributionName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("AttachCertificateToDistribution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("certificateName"=>certificateName, "distributionName"=>distributionName), args)); aws_config=aws_config)
...
AttachDisk(diskName, diskPath, instanceName; aws_config::AWSConfig=global_aws_config()) = lightsail("AttachDisk", Dict{String, Any}("diskName"=>diskName, "diskPath"=>diskPath, "instanceName"=>instanceName); aws_config=aws_config)
AttachDisk(diskName, diskPath, instanceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("AttachDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskName"=>diskName, "diskPath"=>diskPath, "instanceName"=>instanceName), args)); aws_config=aws_config)
...
AttachInstancesToLoadBalancer(instanceNames, loadBalancerName; aws_config::AWSConfig=global_aws_config()) = lightsail("AttachInstancesToLoadBalancer", Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName); aws_config=aws_config)
AttachInstancesToLoadBalancer(instanceNames, loadBalancerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("AttachInstancesToLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName), args)); aws_config=aws_config)
...
AttachLoadBalancerTlsCertificate(certificateName, loadBalancerName; aws_config::AWSConfig=global_aws_config()) = lightsail("AttachLoadBalancerTlsCertificate", Dict{String, Any}("certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName); aws_config=aws_config)
...
AttachStaticIp(instanceName, staticIpName; aws_config::AWSConfig=global_aws_config()) = lightsail("AttachStaticIp", Dict{String, Any}("instanceName"=>instanceName, "staticIpName"=>staticIpName); aws_config=aws_config)
AttachStaticIp(instanceName, staticIpName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("AttachStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "staticIpName"=>staticIpName), args)); aws_config=aws_config)
...
CloseInstancePublicPorts(instanceName, portInfo; aws_config::AWSConfig=global_aws_config()) = lightsail("CloseInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo); aws_config=aws_config)
CloseInstancePublicPorts(instanceName, portInfo, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CloseInstancePublicPorts", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo), args)); aws_config=aws_config)
...
CopySnapshot(sourceRegion, targetSnapshotName; aws_config::AWSConfig=global_aws_config()) = lightsail("CopySnapshot", Dict{String, Any}("sourceRegion"=>sourceRegion, "targetSnapshotName"=>targetSnapshotName); aws_config=aws_config)
CopySnapshot(sourceRegion, targetSnapshotName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CopySnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("sourceRegion"=>sourceRegion, "targetSnapshotName"=>targetSnapshotName), args)); aws_config=aws_config)
...
CreateCertificate(certificateName, domainName; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateCertificate", Dict{String, Any}("certificateName"=>certificateName, "domainName"=>domainName); aws_config=aws_config)
CreateCertificate(certificateName, domainName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("certificateName"=>certificateName, "domainName"=>domainName), args)); aws_config=aws_config)
...
CreateCloudFormationStack(instances; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateCloudFormationStack", Dict{String, Any}("instances"=>instances); aws_config=aws_config)
CreateCloudFormationStack(instances, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateCloudFormationStack", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instances"=>instances), args)); aws_config=aws_config)
...
CreateContactMethod(contactEndpoint, protocol; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateContactMethod", Dict{String, Any}("contactEndpoint"=>contactEndpoint, "protocol"=>protocol); aws_config=aws_config)
CreateContactMethod(contactEndpoint, protocol, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateContactMethod", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("contactEndpoint"=>contactEndpoint, "protocol"=>protocol), args)); aws_config=aws_config)
...
CreateDisk(availabilityZone, diskName, sizeInGb; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateDisk", Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb); aws_config=aws_config)
CreateDisk(availabilityZone, diskName, sizeInGb, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb), args)); aws_config=aws_config)
...
CreateDiskFromSnapshot(availabilityZone, diskName, sizeInGb; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateDiskFromSnapshot", Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb); aws_config=aws_config)
CreateDiskFromSnapshot(availabilityZone, diskName, sizeInGb, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateDiskFromSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb), args)); aws_config=aws_config)
...
CreateDiskSnapshot(diskSnapshotName; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName); aws_config=aws_config)
CreateDiskSnapshot(diskSnapshotName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateDiskSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskSnapshotName"=>diskSnapshotName), args)); aws_config=aws_config)
...
CreateDistribution(bundleId, defaultCacheBehavior, distributionName, origin; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateDistribution", Dict{String, Any}("bundleId"=>bundleId, "defaultCacheBehavior"=>defaultCacheBehavior, "distributionName"=>distributionName, "origin"=>origin); aws_config=aws_config)
CreateDistribution(bundleId, defaultCacheBehavior, distributionName, origin, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateDistribution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("bundleId"=>bundleId, "defaultCacheBehavior"=>defaultCacheBehavior, "distributionName"=>distributionName, "origin"=>origin), args)); aws_config=aws_config)
...
CreateDomain(domainName; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateDomain", Dict{String, Any}("domainName"=>domainName); aws_config=aws_config)
CreateDomain(domainName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateDomain", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainName"=>domainName), args)); aws_config=aws_config)
...
CreateDomainEntry(domainEntry, domainName; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName); aws_config=aws_config)
CreateDomainEntry(domainEntry, domainName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateDomainEntry", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName), args)); aws_config=aws_config)
...
CreateInstanceSnapshot(instanceName, instanceSnapshotName; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateInstanceSnapshot", Dict{String, Any}("instanceName"=>instanceName, "instanceSnapshotName"=>instanceSnapshotName); aws_config=aws_config)
CreateInstanceSnapshot(instanceName, instanceSnapshotName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateInstanceSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "instanceSnapshotName"=>instanceSnapshotName), args)); aws_config=aws_config)
...
CreateInstances(availabilityZone, blueprintId, bundleId, instanceNames; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateInstances", Dict{String, Any}("availabilityZone"=>availabilityZone, "blueprintId"=>blueprintId, "bundleId"=>bundleId, "instanceNames"=>instanceNames); aws_config=aws_config)
CreateInstances(availabilityZone, blueprintId, bundleId, instanceNames, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateInstances", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("availabilityZone"=>availabilityZone, "blueprintId"=>blueprintId, "bundleId"=>bundleId, "instanceNames"=>instanceNames), args)); aws_config=aws_config)
...
CreateInstancesFromSnapshot(availabilityZone, bundleId, instanceNames; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateInstancesFromSnapshot", Dict{String, Any}("availabilityZone"=>availabilityZone, "bundleId"=>bundleId, "instanceNames"=>instanceNames); aws_config=aws_config)
CreateInstancesFromSnapshot(availabilityZone, bundleId, instanceNames, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateInstancesFromSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("availabilityZone"=>availabilityZone, "bundleId"=>bundleId, "instanceNames"=>instanceNames), args)); aws_config=aws_config)
...
CreateKeyPair(keyPairName; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateKeyPair", Dict{String, Any}("keyPairName"=>keyPairName); aws_config=aws_config)
CreateKeyPair(keyPairName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateKeyPair", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("keyPairName"=>keyPairName), args)); aws_config=aws_config)
...
CreateLoadBalancer(instancePort, loadBalancerName; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateLoadBalancer", Dict{String, Any}("instancePort"=>instancePort, "loadBalancerName"=>loadBalancerName); aws_config=aws_config)
CreateLoadBalancer(instancePort, loadBalancerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instancePort"=>instancePort, "loadBalancerName"=>loadBalancerName), args)); aws_config=aws_config)
...
CreateRelationalDatabaseFromSnapshot(relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateRelationalDatabaseFromSnapshot", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
CreateRelationalDatabaseFromSnapshot(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("CreateRelationalDatabaseFromSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws_config=aws_config)
...
DeleteAlarm(alarmName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteAlarm", Dict{String, Any}("alarmName"=>alarmName); aws_config=aws_config)
DeleteAlarm(alarmName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteAlarm", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("alarmName"=>alarmName), args)); aws_config=aws_config)
...
DeleteAutoSnapshot(date, resourceName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteAutoSnapshot", Dict{String, Any}("date"=>date, "resourceName"=>resourceName); aws_config=aws_config)
DeleteAutoSnapshot(date, resourceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteAutoSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("date"=>date, "resourceName"=>resourceName), args)); aws_config=aws_config)
...
DeleteCertificate(certificateName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteCertificate", Dict{String, Any}("certificateName"=>certificateName); aws_config=aws_config)
DeleteCertificate(certificateName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("certificateName"=>certificateName), args)); aws_config=aws_config)
...
DeleteContactMethod(protocol; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteContactMethod", Dict{String, Any}("protocol"=>protocol); aws_config=aws_config)
DeleteContactMethod(protocol, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteContactMethod", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("protocol"=>protocol), args)); aws_config=aws_config)
...
DeleteDisk(diskName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteDisk", Dict{String, Any}("diskName"=>diskName); aws_config=aws_config)
DeleteDisk(diskName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskName"=>diskName), args)); aws_config=aws_config)
...
DeleteDiskSnapshot(diskSnapshotName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName); aws_config=aws_config)
DeleteDiskSnapshot(diskSnapshotName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteDiskSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskSnapshotName"=>diskSnapshotName), args)); aws_config=aws_config)
...
DeleteDistribution(; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteDistribution"; aws_config=aws_config)
DeleteDistribution(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteDistribution", args; aws_config=aws_config)
...
DeleteDomain(domainName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteDomain", Dict{String, Any}("domainName"=>domainName); aws_config=aws_config)
DeleteDomain(domainName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteDomain", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainName"=>domainName), args)); aws_config=aws_config)
...
DeleteDomainEntry(domainEntry, domainName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName); aws_config=aws_config)
DeleteDomainEntry(domainEntry, domainName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteDomainEntry", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName), args)); aws_config=aws_config)
...
DeleteInstance(instanceName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteInstance", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config)
DeleteInstance(instanceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws_config=aws_config)
...
DeleteInstanceSnapshot(instanceSnapshotName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteInstanceSnapshot", Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName); aws_config=aws_config)
DeleteInstanceSnapshot(instanceSnapshotName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteInstanceSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName), args)); aws_config=aws_config)
...
DeleteKeyPair(keyPairName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteKeyPair", Dict{String, Any}("keyPairName"=>keyPairName); aws_config=aws_config)
DeleteKeyPair(keyPairName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteKeyPair", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("keyPairName"=>keyPairName), args)); aws_config=aws_config)
...
DeleteKnownHostKeys(instanceName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteKnownHostKeys", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config)
DeleteKnownHostKeys(instanceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteKnownHostKeys", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws_config=aws_config)
...
DeleteLoadBalancer(loadBalancerName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteLoadBalancer", Dict{String, Any}("loadBalancerName"=>loadBalancerName); aws_config=aws_config)
DeleteLoadBalancer(loadBalancerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("loadBalancerName"=>loadBalancerName), args)); aws_config=aws_config)
...
DeleteLoadBalancerTlsCertificate(certificateName, loadBalancerName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteLoadBalancerTlsCertificate", Dict{String, Any}("certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName); aws_config=aws_config)
...
DeleteRelationalDatabase(relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
DeleteRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws_config=aws_config)
...
DeleteRelationalDatabaseSnapshot(relationalDatabaseSnapshotName; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName); aws_config=aws_config)
DeleteRelationalDatabaseSnapshot(relationalDatabaseSnapshotName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DeleteRelationalDatabaseSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName), args)); aws_config=aws_config)
...
DetachCertificateFromDistribution(distributionName; aws_config::AWSConfig=global_aws_config()) = lightsail("DetachCertificateFromDistribution", Dict{String, Any}("distributionName"=>distributionName); aws_config=aws_config)
DetachCertificateFromDistribution(distributionName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DetachCertificateFromDistribution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("distributionName"=>distributionName), args)); aws_config=aws_config)
...
DetachDisk(diskName; aws_config::AWSConfig=global_aws_config()) = lightsail("DetachDisk", Dict{String, Any}("diskName"=>diskName); aws_config=aws_config)
DetachDisk(diskName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DetachDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskName"=>diskName), args)); aws_config=aws_config)
...
DetachInstancesFromLoadBalancer(instanceNames, loadBalancerName; aws_config::AWSConfig=global_aws_config()) = lightsail("DetachInstancesFromLoadBalancer", Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName); aws_config=aws_config)
DetachInstancesFromLoadBalancer(instanceNames, loadBalancerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DetachInstancesFromLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName), args)); aws_config=aws_config)
...
DetachStaticIp(staticIpName; aws_config::AWSConfig=global_aws_config()) = lightsail("DetachStaticIp", Dict{String, Any}("staticIpName"=>staticIpName); aws_config=aws_config)
DetachStaticIp(staticIpName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DetachStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("staticIpName"=>staticIpName), args)); aws_config=aws_config)
...
DisableAddOn(addOnType, resourceName; aws_config::AWSConfig=global_aws_config()) = lightsail("DisableAddOn", Dict{String, Any}("addOnType"=>addOnType, "resourceName"=>resourceName); aws_config=aws_config)
DisableAddOn(addOnType, resourceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DisableAddOn", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("addOnType"=>addOnType, "resourceName"=>resourceName), args)); aws_config=aws_config)
...
DownloadDefaultKeyPair(; aws_config::AWSConfig=global_aws_config()) = lightsail("DownloadDefaultKeyPair"; aws_config=aws_config)
DownloadDefaultKeyPair(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("DownloadDefaultKeyPair", args; aws_config=aws_config)
...
EnableAddOn(addOnRequest, resourceName; aws_config::AWSConfig=global_aws_config()) = lightsail("EnableAddOn", Dict{String, Any}("addOnRequest"=>addOnRequest, "resourceName"=>resourceName); aws_config=aws_config)
EnableAddOn(addOnRequest, resourceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("EnableAddOn", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("addOnRequest"=>addOnRequest, "resourceName"=>resourceName), args)); aws_config=aws_config)
...
ExportSnapshot(sourceSnapshotName; aws_config::AWSConfig=global_aws_config()) = lightsail("ExportSnapshot", Dict{String, Any}("sourceSnapshotName"=>sourceSnapshotName); aws_config=aws_config)
ExportSnapshot(sourceSnapshotName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("ExportSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("sourceSnapshotName"=>sourceSnapshotName), args)); aws_config=aws_config)
...
GetActiveNames(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetActiveNames"; aws_config=aws_config)
GetActiveNames(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetActiveNames", args; aws_config=aws_config)
...
GetAlarms(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetAlarms"; aws_config=aws_config)
GetAlarms(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetAlarms", args; aws_config=aws_config)
...
GetAutoSnapshots(resourceName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetAutoSnapshots", Dict{String, Any}("resourceName"=>resourceName); aws_config=aws_config)
GetAutoSnapshots(resourceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetAutoSnapshots", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName), args)); aws_config=aws_config)
...
GetBlueprints(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetBlueprints"; aws_config=aws_config)
GetBlueprints(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetBlueprints", args; aws_config=aws_config)
...
GetBundles(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetBundles"; aws_config=aws_config)
GetBundles(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetBundles", args; aws_config=aws_config)
...
GetCertificates(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetCertificates"; aws_config=aws_config)
GetCertificates(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetCertificates", args; aws_config=aws_config)
...
GetCloudFormationStackRecords(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetCloudFormationStackRecords"; aws_config=aws_config)
GetCloudFormationStackRecords(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetCloudFormationStackRecords", args; aws_config=aws_config)
...
GetContactMethods(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetContactMethods"; aws_config=aws_config)
GetContactMethods(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetContactMethods", args; aws_config=aws_config)
...
GetDisk(diskName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDisk", Dict{String, Any}("diskName"=>diskName); aws_config=aws_config)
GetDisk(diskName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskName"=>diskName), args)); aws_config=aws_config)
...
GetDiskSnapshot(diskSnapshotName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName); aws_config=aws_config)
GetDiskSnapshot(diskSnapshotName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDiskSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskSnapshotName"=>diskSnapshotName), args)); aws_config=aws_config)
...
GetDiskSnapshots(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDiskSnapshots"; aws_config=aws_config)
GetDiskSnapshots(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDiskSnapshots", args; aws_config=aws_config)
...
GetDisks(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDisks"; aws_config=aws_config)
GetDisks(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDisks", args; aws_config=aws_config)
...
GetDistributionBundles(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDistributionBundles"; aws_config=aws_config)
GetDistributionBundles(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDistributionBundles", args; aws_config=aws_config)
...
GetDistributionLatestCacheReset(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDistributionLatestCacheReset"; aws_config=aws_config)
GetDistributionLatestCacheReset(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDistributionLatestCacheReset", args; aws_config=aws_config)
...
GetDistributions(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDistributions"; aws_config=aws_config)
GetDistributions(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDistributions", args; aws_config=aws_config)
...
GetDomain(domainName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDomain", Dict{String, Any}("domainName"=>domainName); aws_config=aws_config)
GetDomain(domainName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDomain", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainName"=>domainName), args)); aws_config=aws_config)
...
GetDomains(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDomains"; aws_config=aws_config)
GetDomains(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetDomains", args; aws_config=aws_config)
...
GetExportSnapshotRecords(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetExportSnapshotRecords"; aws_config=aws_config)
GetExportSnapshotRecords(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetExportSnapshotRecords", args; aws_config=aws_config)
...
GetInstance(instanceName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstance", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config)
GetInstance(instanceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws_config=aws_config)
...
GetInstanceAccessDetails(instanceName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstanceAccessDetails", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config)
GetInstanceAccessDetails(instanceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstanceAccessDetails", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws_config=aws_config)
...
GetInstancePortStates(instanceName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstancePortStates", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config)
GetInstancePortStates(instanceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstancePortStates", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws_config=aws_config)
...
GetInstanceSnapshot(instanceSnapshotName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstanceSnapshot", Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName); aws_config=aws_config)
GetInstanceSnapshot(instanceSnapshotName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstanceSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName), args)); aws_config=aws_config)
...
GetInstanceSnapshots(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstanceSnapshots"; aws_config=aws_config)
GetInstanceSnapshots(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstanceSnapshots", args; aws_config=aws_config)
...
GetInstanceState(instanceName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstanceState", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config)
GetInstanceState(instanceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstanceState", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws_config=aws_config)
...
GetInstances(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstances"; aws_config=aws_config)
GetInstances(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetInstances", args; aws_config=aws_config)
...
GetKeyPair(keyPairName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetKeyPair", Dict{String, Any}("keyPairName"=>keyPairName); aws_config=aws_config)
GetKeyPair(keyPairName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetKeyPair", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("keyPairName"=>keyPairName), args)); aws_config=aws_config)
...
GetKeyPairs(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetKeyPairs"; aws_config=aws_config)
GetKeyPairs(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetKeyPairs", args; aws_config=aws_config)
...
GetLoadBalancer(loadBalancerName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetLoadBalancer", Dict{String, Any}("loadBalancerName"=>loadBalancerName); aws_config=aws_config)
GetLoadBalancer(loadBalancerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("loadBalancerName"=>loadBalancerName), args)); aws_config=aws_config)
...
GetLoadBalancerTlsCertificates(loadBalancerName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetLoadBalancerTlsCertificates", Dict{String, Any}("loadBalancerName"=>loadBalancerName); aws_config=aws_config)
GetLoadBalancerTlsCertificates(loadBalancerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetLoadBalancerTlsCertificates", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("loadBalancerName"=>loadBalancerName), args)); aws_config=aws_config)
...
GetLoadBalancers(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetLoadBalancers"; aws_config=aws_config)
GetLoadBalancers(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetLoadBalancers", args; aws_config=aws_config)
...
GetOperation(operationId; aws_config::AWSConfig=global_aws_config()) = lightsail("GetOperation", Dict{String, Any}("operationId"=>operationId); aws_config=aws_config)
GetOperation(operationId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetOperation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("operationId"=>operationId), args)); aws_config=aws_config)
...
GetOperations(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetOperations"; aws_config=aws_config)
GetOperations(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetOperations", args; aws_config=aws_config)
...
GetOperationsForResource(resourceName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetOperationsForResource", Dict{String, Any}("resourceName"=>resourceName); aws_config=aws_config)
GetOperationsForResource(resourceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetOperationsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName), args)); aws_config=aws_config)
...
GetRegions(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRegions"; aws_config=aws_config)
GetRegions(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRegions", args; aws_config=aws_config)
...
GetRelationalDatabase(relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
GetRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws_config=aws_config)
...
GetRelationalDatabaseBlueprints(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseBlueprints"; aws_config=aws_config)
GetRelationalDatabaseBlueprints(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseBlueprints", args; aws_config=aws_config)
...
GetRelationalDatabaseBundles(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseBundles"; aws_config=aws_config)
GetRelationalDatabaseBundles(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseBundles", args; aws_config=aws_config)
...
GetRelationalDatabaseEvents(relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseEvents", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
GetRelationalDatabaseEvents(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseEvents", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws_config=aws_config)
...
GetRelationalDatabaseLogEvents(logStreamName, relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseLogEvents", Dict{String, Any}("logStreamName"=>logStreamName, "relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
GetRelationalDatabaseLogEvents(logStreamName, relationalDatabaseName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseLogEvents", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("logStreamName"=>logStreamName, "relationalDatabaseName"=>relationalDatabaseName), args)); aws_config=aws_config)
...
GetRelationalDatabaseLogStreams(relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseLogStreams", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
GetRelationalDatabaseLogStreams(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseLogStreams", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws_config=aws_config)
...
GetRelationalDatabaseMasterUserPassword(relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseMasterUserPassword", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
GetRelationalDatabaseMasterUserPassword(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseMasterUserPassword", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws_config=aws_config)
...
GetRelationalDatabaseParameters(relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseParameters", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
GetRelationalDatabaseParameters(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseParameters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws_config=aws_config)
...
GetRelationalDatabaseSnapshot(relationalDatabaseSnapshotName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName); aws_config=aws_config)
GetRelationalDatabaseSnapshot(relationalDatabaseSnapshotName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName), args)); aws_config=aws_config)
...
GetRelationalDatabaseSnapshots(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseSnapshots"; aws_config=aws_config)
GetRelationalDatabaseSnapshots(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabaseSnapshots", args; aws_config=aws_config)
...
GetRelationalDatabases(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabases"; aws_config=aws_config)
GetRelationalDatabases(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetRelationalDatabases", args; aws_config=aws_config)
...
GetStaticIp(staticIpName; aws_config::AWSConfig=global_aws_config()) = lightsail("GetStaticIp", Dict{String, Any}("staticIpName"=>staticIpName); aws_config=aws_config)
GetStaticIp(staticIpName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("staticIpName"=>staticIpName), args)); aws_config=aws_config)
...
GetStaticIps(; aws_config::AWSConfig=global_aws_config()) = lightsail("GetStaticIps"; aws_config=aws_config)
GetStaticIps(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("GetStaticIps", args; aws_config=aws_config)
...
ImportKeyPair(keyPairName, publicKeyBase64; aws_config::AWSConfig=global_aws_config()) = lightsail("ImportKeyPair", Dict{String, Any}("keyPairName"=>keyPairName, "publicKeyBase64"=>publicKeyBase64); aws_config=aws_config)
ImportKeyPair(keyPairName, publicKeyBase64, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("ImportKeyPair", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("keyPairName"=>keyPairName, "publicKeyBase64"=>publicKeyBase64), args)); aws_config=aws_config)
...
IsVpcPeered(; aws_config::AWSConfig=global_aws_config()) = lightsail("IsVpcPeered"; aws_config=aws_config)
IsVpcPeered(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("IsVpcPeered", args; aws_config=aws_config)
...
OpenInstancePublicPorts(instanceName, portInfo; aws_config::AWSConfig=global_aws_config()) = lightsail("OpenInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo); aws_config=aws_config)
OpenInstancePublicPorts(instanceName, portInfo, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("OpenInstancePublicPorts", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo), args)); aws_config=aws_config)
...
PeerVpc(; aws_config::AWSConfig=global_aws_config()) = lightsail("PeerVpc"; aws_config=aws_config)
PeerVpc(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("PeerVpc", args; aws_config=aws_config)
...
PutInstancePublicPorts(instanceName, portInfos; aws_config::AWSConfig=global_aws_config()) = lightsail("PutInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfos"=>portInfos); aws_config=aws_config)
PutInstancePublicPorts(instanceName, portInfos, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("PutInstancePublicPorts", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "portInfos"=>portInfos), args)); aws_config=aws_config)
...
RebootInstance(instanceName; aws_config::AWSConfig=global_aws_config()) = lightsail("RebootInstance", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config)
RebootInstance(instanceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("RebootInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws_config=aws_config)
...
RebootRelationalDatabase(relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("RebootRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
RebootRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("RebootRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws_config=aws_config)
...
ReleaseStaticIp(staticIpName; aws_config::AWSConfig=global_aws_config()) = lightsail("ReleaseStaticIp", Dict{String, Any}("staticIpName"=>staticIpName); aws_config=aws_config)
ReleaseStaticIp(staticIpName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("ReleaseStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("staticIpName"=>staticIpName), args)); aws_config=aws_config)
...
ResetDistributionCache(; aws_config::AWSConfig=global_aws_config()) = lightsail("ResetDistributionCache"; aws_config=aws_config)
ResetDistributionCache(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("ResetDistributionCache", args; aws_config=aws_config)
...
SendContactMethodVerification(protocol; aws_config::AWSConfig=global_aws_config()) = lightsail("SendContactMethodVerification", Dict{String, Any}("protocol"=>protocol); aws_config=aws_config)
SendContactMethodVerification(protocol, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("SendContactMethodVerification", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("protocol"=>protocol), args)); aws_config=aws_config)
...
StartInstance(instanceName; aws_config::AWSConfig=global_aws_config()) = lightsail("StartInstance", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config)
StartInstance(instanceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("StartInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws_config=aws_config)
...
StartRelationalDatabase(relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("StartRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
StartRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("StartRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws_config=aws_config)
...
StopInstance(instanceName; aws_config::AWSConfig=global_aws_config()) = lightsail("StopInstance", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config)
StopInstance(instanceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("StopInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws_config=aws_config)
...
StopRelationalDatabase(relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("StopRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
StopRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("StopRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws_config=aws_config)
...
TagResource(resourceName, tags; aws_config::AWSConfig=global_aws_config()) = lightsail("TagResource", Dict{String, Any}("resourceName"=>resourceName, "tags"=>tags); aws_config=aws_config)
TagResource(resourceName, tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName, "tags"=>tags), args)); aws_config=aws_config)
...
TestAlarm(alarmName, state; aws_config::AWSConfig=global_aws_config()) = lightsail("TestAlarm", Dict{String, Any}("alarmName"=>alarmName, "state"=>state); aws_config=aws_config)
TestAlarm(alarmName, state, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("TestAlarm", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("alarmName"=>alarmName, "state"=>state), args)); aws_config=aws_config)
...
UnpeerVpc(; aws_config::AWSConfig=global_aws_config()) = lightsail("UnpeerVpc"; aws_config=aws_config)
UnpeerVpc(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("UnpeerVpc", args; aws_config=aws_config)
...
UntagResource(resourceName, tagKeys; aws_config::AWSConfig=global_aws_config()) = lightsail("UntagResource", Dict{String, Any}("resourceName"=>resourceName, "tagKeys"=>tagKeys); aws_config=aws_config)
UntagResource(resourceName, tagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName, "tagKeys"=>tagKeys), args)); aws_config=aws_config)
...
UpdateDistribution(distributionName; aws_config::AWSConfig=global_aws_config()) = lightsail("UpdateDistribution", Dict{String, Any}("distributionName"=>distributionName); aws_config=aws_config)
UpdateDistribution(distributionName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("UpdateDistribution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("distributionName"=>distributionName), args)); aws_config=aws_config)
...
UpdateDistributionBundle(; aws_config::AWSConfig=global_aws_config()) = lightsail("UpdateDistributionBundle"; aws_config=aws_config)
UpdateDistributionBundle(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("UpdateDistributionBundle", args; aws_config=aws_config)
...
UpdateDomainEntry(domainEntry, domainName; aws_config::AWSConfig=global_aws_config()) = lightsail("UpdateDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName); aws_config=aws_config)
UpdateDomainEntry(domainEntry, domainName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("UpdateDomainEntry", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName), args)); aws_config=aws_config)
...
UpdateLoadBalancerAttribute(attributeName, attributeValue, loadBalancerName; aws_config::AWSConfig=global_aws_config()) = lightsail("UpdateLoadBalancerAttribute", Dict{String, Any}("attributeName"=>attributeName, "attributeValue"=>attributeValue, "loadBalancerName"=>loadBalancerName); aws_config=aws_config)
UpdateLoadBalancerAttribute(attributeName, attributeValue, loadBalancerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("UpdateLoadBalancerAttribute", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("attributeName"=>attributeName, "attributeValue"=>attributeValue, "loadBalancerName"=>loadBalancerName), args)); aws_config=aws_config)
...
UpdateRelationalDatabase(relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("UpdateRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
UpdateRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = lightsail("UpdateRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws_config=aws_config)
...
UpdateRelationalDatabaseParameters(parameters, relationalDatabaseName; aws_config::AWSConfig=global_aws_config()) = lightsail("UpdateRelationalDatabaseParameters", Dict{String, Any}("parameters"=>parameters, "relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config)
