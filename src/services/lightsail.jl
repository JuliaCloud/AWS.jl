...
"""
function allocate_static_ip(staticIpName; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail(
        "AllocateStaticIp",
...
"""
function get_auto_snapshots(resourceName; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail(
        "GetAutoSnapshots",
        Dict{String,Any}("resourceName" => resourceName);
        aws_config=aws_config,
...
"""
function get_instance_state(instanceName; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail(
        "GetInstanceState",
        Dict{String,Any}("instanceName" => instanceName);
        aws_config=aws_config,
...
- `"pageToken"`: The token to advance to the next page of results from your request. To get
  ...
  token in a subsequent request.
"""
function get_load_balancer_tls_policies(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail(
...
- `"resourceArn"`: The Amazon Resource Name (ARN) of the resource to which you want to add
  a tag.
"""
function tag_resource(resourceName, tags; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail(
        "TagResource",
