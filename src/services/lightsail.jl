...
- `instance_names`: An array of strings representing the instance name(s) you want to attach
...
- `"useLatestRestorableAutoSnapshot"`: A Boolean value to indicate whether to use the latest
  available automatic snapshot of the specified source instance or disk.
...
- `contact_endpoint`: The destination of the contact method, such as an email address or a
  ...
  (+) and the country code. For example, a U.S. phone number in E.164 format would be
  specified as +1XXX5550100. For more information, see [E.164](https://en.wikipedia.org/wiki/E.164)
  on *Wikipedia*.
...
- `protocol`: The protocol of the contact method, such as `Email` or `SMS` (text messaging).
  ...
  For a list of countries/regions where SMS text messages can be sent, and the latest Amazon
...
- `power`: The power specification for the container service.
  ...
  container service. The `power` and `scale` of a container service makes up its configured
  capacity. To determine the monthly price of your container service, multiply the base
...
Lightsail account so that you can use them with your Lightsail container service. The log in
...
function create_container_service_registry_login(;
    ...
    return lightsail(
        "CreateContainerServiceRegistryLogin"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `availability_zone`: The Availability Zone where you want to create the disk
  (`us-east-2a`). Choose the same Availability Zone as the Lightsail instance where you want
  to create the disk.
...
- `"userData"`: A launch script you can create that configures a server with additional user
...
- `master_database_name`: The meaning of this parameter differs according to the database
  ...
  **PostgreSQL**
  ...
  for [PostgreSQL 9.6](https://www.postgresql.org/docs/9.6/sql-keywords-appendix.html), [PostgreSQL 10](https://www.postgresql.org/docs/10/sql-keywords-appendix.html), [PostgreSQL 11](https://www.postgresql.org/docs/11/sql-keywords-appendix.html),
...
- `master_username`: The name for the master user.
  ...
  **MySQL**
  ...
  Reserved Words articles for [MySQL 5.6](https://dev.mysql.com/doc/refman/5.6/en/keywords.html), [MySQL 5.7](https://dev.mysql.com/doc/refman/5.7/en/keywords.html),
  or [MySQL 8.0](https://dev.mysql.com/doc/refman/8.0/en/keywords.html).
  ...
  **PostgreSQL**
  ...
  For more information about reserved words in MySQL 5.6 or 5.7, see the Keywords and
  Reserved Words articles for [PostgreSQL 9.6](https://www.postgresql.org/docs/9.6/sql-keywords-appendix.html), [PostgreSQL 10](https://www.postgresql.org/docs/10/sql-keywords-appendix.html), [PostgreSQL 11](https://www.postgresql.org/docs/11/sql-keywords-appendix.html),
  and [PostgreSQL 12](https://www.postgresql.org/docs/12/sql-keywords-appendix.html).
...
- `"preferredBackupWindow"`: The daily time range during which automated backups are created
  ...
  region, see the [Working With Backups](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithAutomatedBackups.html#USER_WorkingWithAutomatedBackups.BackupWindow)
...
- `"relationalDatabaseSnapshotName"`: The name of the database snapshot from which to create
  your new database.
...
- `"restoreTime"`: The date and time to restore your database from.
  ...
  For example, if you wish to use a restore time of October 1, 2018, at 8 PM UTC, then you
  input `1538424000` as the restore time.
...
function delete_distribution(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("DeleteDistribution"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function delete_distribution(
    ...
    return lightsail(
        "DeleteDistribution", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"skipFinalSnapshot"`: Determines whether a final database snapshot is created before your
  database is deleted. If `true` is specified, no database snapshot is created. If `false`
...
function download_default_key_pair(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("DownloadDefaultKeyPair"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function download_default_key_pair(
    ...
    return lightsail(
        "DownloadDefaultKeyPair", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `source_snapshot_name`: The name of the instance or disk snapshot to be exported to Amazon
  EC2.
"""
...
function get_active_names(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetActiveNames"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_active_names(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetActiveNames", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_alarms(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetAlarms"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_alarms(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetAlarms", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_blueprints(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetBlueprints"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_blueprints(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetBlueprints", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_bucket_bundles(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetBucketBundles"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_bucket_bundles(
    ...
    return lightsail(
        "GetBucketBundles", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `metric_name`: The metric for which you want to return information.
  ...
  - **`BucketSizeBytes`** - The amount of data in bytes stored in a bucket. This value is
    calculated by summing the size of all objects in the bucket (including object versions),
    including the size of all parts for all incomplete multipart uploads to the bucket.
...
function get_buckets(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetBuckets"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_buckets(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetBuckets", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_bundles(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetBundles"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_bundles(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetBundles", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"includeCertificateDetails"`: Indicates whether to include detailed information about the
...
function get_certificates(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetCertificates"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_certificates(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetCertificates", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_cloud_formation_stack_records(;
    ...
    return lightsail(
        "GetCloudFormationStackRecords"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_cloud_formation_stack_records(
    ...
    return lightsail(
        "GetCloudFormationStackRecords", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
Returns information about the configured contact methods. Specify a protocol in your request
to return information about a specific contact method.
...
function get_contact_methods(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetContactMethods"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_contact_methods(
    ...
    return lightsail(
        "GetContactMethods", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_container_apimetadata(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetContainerAPIMetadata"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_container_apimetadata(
    ...
    return lightsail(
        "GetContainerAPIMetadata", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `service_name`: The name of the container service for which to return registered container
  images.
"""
...
function get_container_service_powers(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail(
        "GetContainerServicePowers"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_container_service_powers(
    ...
    return lightsail(
        "GetContainerServicePowers", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_container_services(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetContainerServices"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_container_services(
    ...
    return lightsail(
        "GetContainerServices", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_disk_snapshots(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetDiskSnapshots"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_disk_snapshots(
    ...
    return lightsail(
        "GetDiskSnapshots", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  To get a page token, perform an initial `GetDisks` request. If your results are paginated,
...
function get_disks(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetDisks"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_disks(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetDisks", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_distribution_bundles(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetDistributionBundles"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_distribution_bundles(
    ...
    return lightsail(
        "GetDistributionBundles", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_distribution_latest_cache_reset(;
    ...
    return lightsail(
        "GetDistributionLatestCacheReset"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `metric_name`: The metric for which you want to return information.
  ...
  - **`4xxErrorRate`** - The percentage of all viewer requests for which the response's HTTP
    status cod was 4xx. In these cases, the client or client viewer may have made an error.
    For example, a status code of 404 (Not Found) means that the client requested an object
  ...
  - **`5xxErrorRate`** - The percentage of all viewer requests for which the response's HTTP
    status code was 5xx. In these cases, the origin server did not satisfy the requests. For
    example, a status code of 503 (Service Unavailable) means that the origin server is
...
- `statistics`: The statistic for the metric.
  ...
  - `Sum` - All values submitted for the matching metric added together. You can use this
    statistic to determine the total volume of a metric.
  - `Average` - The value of Sum / SampleCount during the specified period. By comparing
    this statistic with the Minimum and Maximum values, you can determine the full scope of
    a metric and how close the average use is to the Minimum and Maximum values. This
    comparison helps you to know when to increase or decrease your resources.
  - `SampleCount` - The count, or number, of data points used for the statistical
    calculation.
...
function get_distributions(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetDistributions"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_distributions(
    ...
    return lightsail(
        "GetDistributions", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_domains(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetDomains"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_domains(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetDomains", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_export_snapshot_records(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail(
        "GetExportSnapshotRecords"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_export_snapshot_records(
    ...
    return lightsail(
        "GetExportSnapshotRecords", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
reaches 100%.
  ...
  - **`CPUUtilization`** - The percentage of allocated compute units that are currently in
    use on the instance. This metric identifies the processing power to run the applications
    on the instance. Tools in your operating system can show a lower percentage than
    Lightsail when the instance is not allocated a full processor core.
  ...
  - **`MetadataNoToken`** - Reports the number of times that the instance metadata service
    was successfully accessed without a token. This metric determines if there are any
    processes accessing instance metadata by using Instance Metadata Service Version 1,
...
- `period`: The granularity, in seconds, of the returned data points.
  ...
  instance metric data is available in 1-minute (60 seconds) granularity. All other instance
...
function get_instance_snapshots(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetInstanceSnapshots"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_instance_snapshots(
    ...
    return lightsail(
        "GetInstanceSnapshots", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_instances(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetInstances"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_instances(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetInstances", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_key_pairs(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetKeyPairs"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_key_pairs(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetKeyPairs", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `metric_name`: The metric for which you want to return information.
  ...
  - **`HTTPCode_LB_4XX_Count`** - The number of HTTP 4XX client error codes that originated
    ...
    incomplete. These requests were not received by the target instance. This count does not
  ...
  - **`HTTPCode_LB_5XX_Count`** - The number of HTTP 5XX server error codes that originated
    from the load balancer. This does not include any response codes generated by the target
    instance. This metric is reported if there are no healthy instances attached to the load
    balancer, or if the request rate exceeds the capacity of the instances (spillover) or
    the load balancer.
...
function get_load_balancer_tls_policies(;
    ...
    return lightsail(
        "GetLoadBalancerTlsPolicies"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_load_balancer_tls_policies(
    ...
    return lightsail(
        "GetLoadBalancerTlsPolicies", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_load_balancers(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetLoadBalancers"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_load_balancers(
    ...
    return lightsail(
        "GetLoadBalancers", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_operations(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetOperations"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_operations(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetOperations", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"includeAvailabilityZones"`: A Boolean value indicating whether to also include
  ...
  letter: `us-east-2a`.
- `"includeRelationalDatabaseAvailabilityZones"`: A Boolean value indicating whether to also
  include Availability Zones for databases in your get regions request. Availability Zones
...
function get_regions(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetRegions"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_regions(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetRegions", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  To get a page token, perform an initial `GetRelationalDatabaseBlueprints` request. If your
  results are paginated, the response will return a next page token that you can specify as
  the page token in a subsequent request.
"""
...
function get_relational_database_blueprints(;
    ...
    return lightsail(
        "GetRelationalDatabaseBlueprints"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_relational_database_bundles(;
    ...
    return lightsail(
        "GetRelationalDatabaseBundles"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_relational_database_bundles(
    ...
    return lightsail(
        "GetRelationalDatabaseBundles", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"passwordVersion"`: The password version to return.
  ...
  `CURRENT`. After the `PENDING` password rotates to `CURRENT`, the `PENDING` password is no
  longer available.
...
- `metric_name`: The metric for which you want to return information.
  ...
  - **`NetworkReceiveThroughput`** - The incoming (Receive) network traffic on the database,
    including both customer database traffic and AWS traffic used for monitoring and
    replication.
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  To get a page token, perform an initial `GetRelationalDatabaseParameters` request. If your
  results are paginated, the response will return a next page token that you can specify as
  the page token in a subsequent request.
"""
...
function get_relational_database_snapshots(;
    ...
    return lightsail(
        "GetRelationalDatabaseSnapshots"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_relational_databases(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetRelationalDatabases"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_relational_databases(
    ...
    return lightsail(
        "GetRelationalDatabases", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_static_ips(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("GetStaticIps"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_static_ips(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("GetStaticIps", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function is_vpc_peered(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("IsVpcPeered"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function is_vpc_peered(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("IsVpcPeered", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
Opens ports for a specific Amazon Lightsail instance, and specifies the IP addresses allowed
...
function peer_vpc(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("PeerVpc"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function peer_vpc(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("PeerVpc", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `alarm_name`: The name for the alarm. Specify the name of an existing alarm to update, and
...
- `evaluation_periods`: The number of most recent periods over which data is compared to the
...
Opens ports for a specific Amazon Lightsail instance, and specifies the IP addresses allowed
to connect to the instance through the ports, and the protocol. This action also closes all
...
function reset_distribution_cache(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("ResetDistributionCache"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function reset_distribution_cache(
    ...
    return lightsail(
        "ResetDistributionCache", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `resource_type`: The resource type.
  ...
  !!! note
      ...
      Web Services Region. Set your Amazon Web Services Region configuration to `us-east-1`
...
- `"acceptBundleUpdate"`: Required parameter to accept the instance bundle update when
  ...
  !!! note
      ...
      you switch from `dual-stack` to `ipv6`, the bundle will be updated, and billing for
      the IPv6-only instance bundle begins immediately.
"""
...
- `access`: The access setting.
  ...
  - `deny` - Denies access to the bucket and its objects. Use this setting to remove access
    for a resource previously set to `allow`.
...
- `"resourceArn"`: The Amazon Resource Name (ARN) of the resource to which you want to add a
  tag.
"""
...
function unpeer_vpc(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail("UnpeerVpc"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function unpeer_vpc(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return lightsail("UnpeerVpc", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"viewerMinimumTlsProtocolVersion"`: Use this parameter to update the minimum TLS protocol
  version for the SSL/TLS certificate that's attached to the distribution.
"""
...
function update_distribution_bundle(; aws_config::AbstractAWSConfig=current_aws_config())
    return lightsail(
        "UpdateDistributionBundle"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_distribution_bundle(
    ...
    return lightsail(
        "UpdateDistributionBundle", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"httpPutResponseHopLimit"`: The desired HTTP PUT response hop limit for instance metadata
  requests. A larger number means that the instance metadata requests can travel farther. If
...
- `attribute_value`: The value that you want to specify for the attribute name.
  ...
  The following values are supported depending on what you specify for the `attribute_name`
  request parameter:

  - If you specify `HealthCheckPath` for the `attribute_name` request parameter, then the
    `attribute_value` request parameter must be the path to ping on the target (for example,
  ...
  - If you specify `SessionStickiness_LB_CookieDurationSeconds` for the `attribute_name`
    request parameter, then the `attribute_value` request parameter must be an interger that
