...
"""
AllocateStaticIp(staticIpName) = lightsail("AllocateStaticIp", Dict{String, Any}("staticIpName"=>staticIpName))
AllocateStaticIp(staticIpName, args::AbstractDict{String, <:Any}) = lightsail("AllocateStaticIp", Dict{String, Any}("staticIpName"=>staticIpName, args...))
...
"""
AttachCertificateToDistribution(certificateName, distributionName) = lightsail("AttachCertificateToDistribution", Dict{String, Any}("certificateName"=>certificateName, "distributionName"=>distributionName))
AttachCertificateToDistribution(certificateName, distributionName, args::AbstractDict{String, <:Any}) = lightsail("AttachCertificateToDistribution", Dict{String, Any}("certificateName"=>certificateName, "distributionName"=>distributionName, args...))
...
"""
AttachDisk(diskName, diskPath, instanceName) = lightsail("AttachDisk", Dict{String, Any}("diskName"=>diskName, "diskPath"=>diskPath, "instanceName"=>instanceName))
AttachDisk(diskName, diskPath, instanceName, args::AbstractDict{String, <:Any}) = lightsail("AttachDisk", Dict{String, Any}("diskName"=>diskName, "diskPath"=>diskPath, "instanceName"=>instanceName, args...))
...
"""
AttachInstancesToLoadBalancer(instanceNames, loadBalancerName) = lightsail("AttachInstancesToLoadBalancer", Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName))
AttachInstancesToLoadBalancer(instanceNames, loadBalancerName, args::AbstractDict{String, <:Any}) = lightsail("AttachInstancesToLoadBalancer", Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName, args...))
...
"""
AttachLoadBalancerTlsCertificate(certificateName, loadBalancerName) = lightsail("AttachLoadBalancerTlsCertificate", Dict{String, Any}("certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName))
AttachLoadBalancerTlsCertificate(certificateName, loadBalancerName, args::AbstractDict{String, <:Any}) = lightsail("AttachLoadBalancerTlsCertificate", Dict{String, Any}("certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName, args...))
...
"""
AttachStaticIp(instanceName, staticIpName) = lightsail("AttachStaticIp", Dict{String, Any}("instanceName"=>instanceName, "staticIpName"=>staticIpName))
AttachStaticIp(instanceName, staticIpName, args::AbstractDict{String, <:Any}) = lightsail("AttachStaticIp", Dict{String, Any}("instanceName"=>instanceName, "staticIpName"=>staticIpName, args...))
...
"""
CloseInstancePublicPorts(instanceName, portInfo) = lightsail("CloseInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo))
CloseInstancePublicPorts(instanceName, portInfo, args::AbstractDict{String, <:Any}) = lightsail("CloseInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo, args...))
...
"""
CopySnapshot(sourceRegion, targetSnapshotName) = lightsail("CopySnapshot", Dict{String, Any}("sourceRegion"=>sourceRegion, "targetSnapshotName"=>targetSnapshotName))
CopySnapshot(sourceRegion, targetSnapshotName, args::AbstractDict{String, <:Any}) = lightsail("CopySnapshot", Dict{String, Any}("sourceRegion"=>sourceRegion, "targetSnapshotName"=>targetSnapshotName, args...))
...
"""
CreateCertificate(certificateName, domainName) = lightsail("CreateCertificate", Dict{String, Any}("certificateName"=>certificateName, "domainName"=>domainName))
CreateCertificate(certificateName, domainName, args::AbstractDict{String, <:Any}) = lightsail("CreateCertificate", Dict{String, Any}("certificateName"=>certificateName, "domainName"=>domainName, args...))
...
"""
CreateCloudFormationStack(instances) = lightsail("CreateCloudFormationStack", Dict{String, Any}("instances"=>instances))
CreateCloudFormationStack(instances, args::AbstractDict{String, <:Any}) = lightsail("CreateCloudFormationStack", Dict{String, Any}("instances"=>instances, args...))
...
"""
CreateContactMethod(contactEndpoint, protocol) = lightsail("CreateContactMethod", Dict{String, Any}("contactEndpoint"=>contactEndpoint, "protocol"=>protocol))
CreateContactMethod(contactEndpoint, protocol, args::AbstractDict{String, <:Any}) = lightsail("CreateContactMethod", Dict{String, Any}("contactEndpoint"=>contactEndpoint, "protocol"=>protocol, args...))
...
"""
CreateDisk(availabilityZone, diskName, sizeInGb) = lightsail("CreateDisk", Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb))
CreateDisk(availabilityZone, diskName, sizeInGb, args::AbstractDict{String, <:Any}) = lightsail("CreateDisk", Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb, args...))
...
"""
CreateDiskFromSnapshot(availabilityZone, diskName, sizeInGb) = lightsail("CreateDiskFromSnapshot", Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb))
CreateDiskFromSnapshot(availabilityZone, diskName, sizeInGb, args::AbstractDict{String, <:Any}) = lightsail("CreateDiskFromSnapshot", Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb, args...))
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateDiskSnapshot(diskSnapshotName) = lightsail("CreateDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName))
CreateDiskSnapshot(diskSnapshotName, args::AbstractDict{String, <:Any}) = lightsail("CreateDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName, args...))
...
"""
CreateDistribution(bundleId, defaultCacheBehavior, distributionName, origin) = lightsail("CreateDistribution", Dict{String, Any}("bundleId"=>bundleId, "defaultCacheBehavior"=>defaultCacheBehavior, "distributionName"=>distributionName, "origin"=>origin))
CreateDistribution(bundleId, defaultCacheBehavior, distributionName, origin, args::AbstractDict{String, <:Any}) = lightsail("CreateDistribution", Dict{String, Any}("bundleId"=>bundleId, "defaultCacheBehavior"=>defaultCacheBehavior, "distributionName"=>distributionName, "origin"=>origin, args...))
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateDomain(domainName) = lightsail("CreateDomain", Dict{String, Any}("domainName"=>domainName))
CreateDomain(domainName, args::AbstractDict{String, <:Any}) = lightsail("CreateDomain", Dict{String, Any}("domainName"=>domainName, args...))
...
"""
CreateDomainEntry(domainEntry, domainName) = lightsail("CreateDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName))
CreateDomainEntry(domainEntry, domainName, args::AbstractDict{String, <:Any}) = lightsail("CreateDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName, args...))
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateInstanceSnapshot(instanceName, instanceSnapshotName) = lightsail("CreateInstanceSnapshot", Dict{String, Any}("instanceName"=>instanceName, "instanceSnapshotName"=>instanceSnapshotName))
CreateInstanceSnapshot(instanceName, instanceSnapshotName, args::AbstractDict{String, <:Any}) = lightsail("CreateInstanceSnapshot", Dict{String, Any}("instanceName"=>instanceName, "instanceSnapshotName"=>instanceSnapshotName, args...))
...
"""
CreateInstances(availabilityZone, blueprintId, bundleId, instanceNames) = lightsail("CreateInstances", Dict{String, Any}("availabilityZone"=>availabilityZone, "blueprintId"=>blueprintId, "bundleId"=>bundleId, "instanceNames"=>instanceNames))
CreateInstances(availabilityZone, blueprintId, bundleId, instanceNames, args::AbstractDict{String, <:Any}) = lightsail("CreateInstances", Dict{String, Any}("availabilityZone"=>availabilityZone, "blueprintId"=>blueprintId, "bundleId"=>bundleId, "instanceNames"=>instanceNames, args...))
...
"""
CreateInstancesFromSnapshot(availabilityZone, bundleId, instanceNames) = lightsail("CreateInstancesFromSnapshot", Dict{String, Any}("availabilityZone"=>availabilityZone, "bundleId"=>bundleId, "instanceNames"=>instanceNames))
CreateInstancesFromSnapshot(availabilityZone, bundleId, instanceNames, args::AbstractDict{String, <:Any}) = lightsail("CreateInstancesFromSnapshot", Dict{String, Any}("availabilityZone"=>availabilityZone, "bundleId"=>bundleId, "instanceNames"=>instanceNames, args...))
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateKeyPair(keyPairName) = lightsail("CreateKeyPair", Dict{String, Any}("keyPairName"=>keyPairName))
CreateKeyPair(keyPairName, args::AbstractDict{String, <:Any}) = lightsail("CreateKeyPair", Dict{String, Any}("keyPairName"=>keyPairName, args...))
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateLoadBalancer(instancePort, loadBalancerName) = lightsail("CreateLoadBalancer", Dict{String, Any}("instancePort"=>instancePort, "loadBalancerName"=>loadBalancerName))
CreateLoadBalancer(instancePort, loadBalancerName, args::AbstractDict{String, <:Any}) = lightsail("CreateLoadBalancer", Dict{String, Any}("instancePort"=>instancePort, "loadBalancerName"=>loadBalancerName, args...))
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateLoadBalancerTlsCertificate(certificateDomainName, certificateName, loadBalancerName) = lightsail("CreateLoadBalancerTlsCertificate", Dict{String, Any}("certificateDomainName"=>certificateDomainName, "certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName))
CreateLoadBalancerTlsCertificate(certificateDomainName, certificateName, loadBalancerName, args::AbstractDict{String, <:Any}) = lightsail("CreateLoadBalancerTlsCertificate", Dict{String, Any}("certificateDomainName"=>certificateDomainName, "certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName, args...))
...
CreateRelationalDatabase(masterDatabaseName, masterUsername, relationalDatabaseBlueprintId, relationalDatabaseBundleId, relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("CreateRelationalDatabase", Dict{String, Any}("masterDatabaseName"=>masterDatabaseName, "masterUsername"=>masterUsername, "relationalDatabaseBlueprintId"=>relationalDatabaseBlueprintId, "relationalDatabaseBundleId"=>relationalDatabaseBundleId, "relationalDatabaseName"=>relationalDatabaseName, args...))
...
"""
CreateRelationalDatabaseFromSnapshot(relationalDatabaseName) = lightsail("CreateRelationalDatabaseFromSnapshot", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName))
CreateRelationalDatabaseFromSnapshot(relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("CreateRelationalDatabaseFromSnapshot", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, args...))
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateRelationalDatabaseSnapshot(relationalDatabaseName, relationalDatabaseSnapshotName) = lightsail("CreateRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, "relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName))
CreateRelationalDatabaseSnapshot(relationalDatabaseName, relationalDatabaseSnapshotName, args::AbstractDict{String, <:Any}) = lightsail("CreateRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, "relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName, args...))
...
"""
DeleteAlarm(alarmName) = lightsail("DeleteAlarm", Dict{String, Any}("alarmName"=>alarmName))
DeleteAlarm(alarmName, args::AbstractDict{String, <:Any}) = lightsail("DeleteAlarm", Dict{String, Any}("alarmName"=>alarmName, args...))
...
"""
DeleteAutoSnapshot(date, resourceName) = lightsail("DeleteAutoSnapshot", Dict{String, Any}("date"=>date, "resourceName"=>resourceName))
DeleteAutoSnapshot(date, resourceName, args::AbstractDict{String, <:Any}) = lightsail("DeleteAutoSnapshot", Dict{String, Any}("date"=>date, "resourceName"=>resourceName, args...))
...
"""
DeleteCertificate(certificateName) = lightsail("DeleteCertificate", Dict{String, Any}("certificateName"=>certificateName))
DeleteCertificate(certificateName, args::AbstractDict{String, <:Any}) = lightsail("DeleteCertificate", Dict{String, Any}("certificateName"=>certificateName, args...))
...
"""
DeleteContactMethod(protocol) = lightsail("DeleteContactMethod", Dict{String, Any}("protocol"=>protocol))
DeleteContactMethod(protocol, args::AbstractDict{String, <:Any}) = lightsail("DeleteContactMethod", Dict{String, Any}("protocol"=>protocol, args...))
...
"""
DeleteDisk(diskName) = lightsail("DeleteDisk", Dict{String, Any}("diskName"=>diskName))
DeleteDisk(diskName, args::AbstractDict{String, <:Any}) = lightsail("DeleteDisk", Dict{String, Any}("diskName"=>diskName, args...))
...
"""
DeleteDiskSnapshot(diskSnapshotName) = lightsail("DeleteDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName))
DeleteDiskSnapshot(diskSnapshotName, args::AbstractDict{String, <:Any}) = lightsail("DeleteDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName, args...))
...
DeleteDistribution(args::AbstractDict{String, <:Any}) = lightsail("DeleteDistribution", args)
...
"""
DeleteDomain(domainName) = lightsail("DeleteDomain", Dict{String, Any}("domainName"=>domainName))
DeleteDomain(domainName, args::AbstractDict{String, <:Any}) = lightsail("DeleteDomain", Dict{String, Any}("domainName"=>domainName, args...))
...
"""
DeleteDomainEntry(domainEntry, domainName) = lightsail("DeleteDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName))
DeleteDomainEntry(domainEntry, domainName, args::AbstractDict{String, <:Any}) = lightsail("DeleteDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName, args...))
...
- `forceDeleteAddOns`: A Boolean value to indicate whether to delete the enabled add-ons for the disk.
"""
DeleteInstance(instanceName) = lightsail("DeleteInstance", Dict{String, Any}("instanceName"=>instanceName))
DeleteInstance(instanceName, args::AbstractDict{String, <:Any}) = lightsail("DeleteInstance", Dict{String, Any}("instanceName"=>instanceName, args...))
...
"""
DeleteInstanceSnapshot(instanceSnapshotName) = lightsail("DeleteInstanceSnapshot", Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName))
DeleteInstanceSnapshot(instanceSnapshotName, args::AbstractDict{String, <:Any}) = lightsail("DeleteInstanceSnapshot", Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName, args...))
...
"""
DeleteKeyPair(keyPairName) = lightsail("DeleteKeyPair", Dict{String, Any}("keyPairName"=>keyPairName))
DeleteKeyPair(keyPairName, args::AbstractDict{String, <:Any}) = lightsail("DeleteKeyPair", Dict{String, Any}("keyPairName"=>keyPairName, args...))
...
"""
DeleteKnownHostKeys(instanceName) = lightsail("DeleteKnownHostKeys", Dict{String, Any}("instanceName"=>instanceName))
DeleteKnownHostKeys(instanceName, args::AbstractDict{String, <:Any}) = lightsail("DeleteKnownHostKeys", Dict{String, Any}("instanceName"=>instanceName, args...))
...
"""
DeleteLoadBalancer(loadBalancerName) = lightsail("DeleteLoadBalancer", Dict{String, Any}("loadBalancerName"=>loadBalancerName))
DeleteLoadBalancer(loadBalancerName, args::AbstractDict{String, <:Any}) = lightsail("DeleteLoadBalancer", Dict{String, Any}("loadBalancerName"=>loadBalancerName, args...))
...
"""
DeleteLoadBalancerTlsCertificate(certificateName, loadBalancerName) = lightsail("DeleteLoadBalancerTlsCertificate", Dict{String, Any}("certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName))
DeleteLoadBalancerTlsCertificate(certificateName, loadBalancerName, args::AbstractDict{String, <:Any}) = lightsail("DeleteLoadBalancerTlsCertificate", Dict{String, Any}("certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName, args...))
...
"""
DeleteRelationalDatabase(relationalDatabaseName) = lightsail("DeleteRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName))
DeleteRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("DeleteRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, args...))
...
"""
DeleteRelationalDatabaseSnapshot(relationalDatabaseSnapshotName) = lightsail("DeleteRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName))
DeleteRelationalDatabaseSnapshot(relationalDatabaseSnapshotName, args::AbstractDict{String, <:Any}) = lightsail("DeleteRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName, args...))
...
"""
DetachCertificateFromDistribution(distributionName) = lightsail("DetachCertificateFromDistribution", Dict{String, Any}("distributionName"=>distributionName))
DetachCertificateFromDistribution(distributionName, args::AbstractDict{String, <:Any}) = lightsail("DetachCertificateFromDistribution", Dict{String, Any}("distributionName"=>distributionName, args...))
...
"""
DetachDisk(diskName) = lightsail("DetachDisk", Dict{String, Any}("diskName"=>diskName))
DetachDisk(diskName, args::AbstractDict{String, <:Any}) = lightsail("DetachDisk", Dict{String, Any}("diskName"=>diskName, args...))
...
"""
DetachInstancesFromLoadBalancer(instanceNames, loadBalancerName) = lightsail("DetachInstancesFromLoadBalancer", Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName))
DetachInstancesFromLoadBalancer(instanceNames, loadBalancerName, args::AbstractDict{String, <:Any}) = lightsail("DetachInstancesFromLoadBalancer", Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName, args...))
...
"""
DetachStaticIp(staticIpName) = lightsail("DetachStaticIp", Dict{String, Any}("staticIpName"=>staticIpName))
DetachStaticIp(staticIpName, args::AbstractDict{String, <:Any}) = lightsail("DetachStaticIp", Dict{String, Any}("staticIpName"=>staticIpName, args...))
...
"""
DisableAddOn(addOnType, resourceName) = lightsail("DisableAddOn", Dict{String, Any}("addOnType"=>addOnType, "resourceName"=>resourceName))
DisableAddOn(addOnType, resourceName, args::AbstractDict{String, <:Any}) = lightsail("DisableAddOn", Dict{String, Any}("addOnType"=>addOnType, "resourceName"=>resourceName, args...))
...
DownloadDefaultKeyPair(args::AbstractDict{String, <:Any}) = lightsail("DownloadDefaultKeyPair", args)
...
"""
EnableAddOn(addOnRequest, resourceName) = lightsail("EnableAddOn", Dict{String, Any}("addOnRequest"=>addOnRequest, "resourceName"=>resourceName))
EnableAddOn(addOnRequest, resourceName, args::AbstractDict{String, <:Any}) = lightsail("EnableAddOn", Dict{String, Any}("addOnRequest"=>addOnRequest, "resourceName"=>resourceName, args...))
...
"""
ExportSnapshot(sourceSnapshotName) = lightsail("ExportSnapshot", Dict{String, Any}("sourceSnapshotName"=>sourceSnapshotName))
ExportSnapshot(sourceSnapshotName, args::AbstractDict{String, <:Any}) = lightsail("ExportSnapshot", Dict{String, Any}("sourceSnapshotName"=>sourceSnapshotName, args...))
...
GetActiveNames(args::AbstractDict{String, <:Any}) = lightsail("GetActiveNames", args)
...
GetAlarms(args::AbstractDict{String, <:Any}) = lightsail("GetAlarms", args)
...
"""
GetAutoSnapshots(resourceName) = lightsail("GetAutoSnapshots", Dict{String, Any}("resourceName"=>resourceName))
GetAutoSnapshots(resourceName, args::AbstractDict{String, <:Any}) = lightsail("GetAutoSnapshots", Dict{String, Any}("resourceName"=>resourceName, args...))
...
GetBlueprints(args::AbstractDict{String, <:Any}) = lightsail("GetBlueprints", args)
...
GetBundles(args::AbstractDict{String, <:Any}) = lightsail("GetBundles", args)
...
GetCertificates(args::AbstractDict{String, <:Any}) = lightsail("GetCertificates", args)
...
GetCloudFormationStackRecords(args::AbstractDict{String, <:Any}) = lightsail("GetCloudFormationStackRecords", args)
...
GetContactMethods(args::AbstractDict{String, <:Any}) = lightsail("GetContactMethods", args)
...
"""
GetDisk(diskName) = lightsail("GetDisk", Dict{String, Any}("diskName"=>diskName))
GetDisk(diskName, args::AbstractDict{String, <:Any}) = lightsail("GetDisk", Dict{String, Any}("diskName"=>diskName, args...))
...
"""
GetDiskSnapshot(diskSnapshotName) = lightsail("GetDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName))
GetDiskSnapshot(diskSnapshotName, args::AbstractDict{String, <:Any}) = lightsail("GetDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName, args...))
...
GetDiskSnapshots(args::AbstractDict{String, <:Any}) = lightsail("GetDiskSnapshots", args)
...
GetDisks(args::AbstractDict{String, <:Any}) = lightsail("GetDisks", args)
...
GetDistributionBundles(args::AbstractDict{String, <:Any}) = lightsail("GetDistributionBundles", args)
...
GetDistributionLatestCacheReset(args::AbstractDict{String, <:Any}) = lightsail("GetDistributionLatestCacheReset", args)
...
"""
GetDistributionMetricData(distributionName, endTime, metricName, period, startTime, statistics, unit) = lightsail("GetDistributionMetricData", Dict{String, Any}("distributionName"=>distributionName, "endTime"=>endTime, "metricName"=>metricName, "period"=>period, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit))
GetDistributionMetricData(distributionName, endTime, metricName, period, startTime, statistics, unit, args::AbstractDict{String, <:Any}) = lightsail("GetDistributionMetricData", Dict{String, Any}("distributionName"=>distributionName, "endTime"=>endTime, "metricName"=>metricName, "period"=>period, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit, args...))
...
GetDistributions(args::AbstractDict{String, <:Any}) = lightsail("GetDistributions", args)
...
"""
GetDomain(domainName) = lightsail("GetDomain", Dict{String, Any}("domainName"=>domainName))
GetDomain(domainName, args::AbstractDict{String, <:Any}) = lightsail("GetDomain", Dict{String, Any}("domainName"=>domainName, args...))
...
GetDomains(args::AbstractDict{String, <:Any}) = lightsail("GetDomains", args)
...
GetExportSnapshotRecords(args::AbstractDict{String, <:Any}) = lightsail("GetExportSnapshotRecords", args)
...
"""
GetInstance(instanceName) = lightsail("GetInstance", Dict{String, Any}("instanceName"=>instanceName))
GetInstance(instanceName, args::AbstractDict{String, <:Any}) = lightsail("GetInstance", Dict{String, Any}("instanceName"=>instanceName, args...))
...
"""
GetInstanceAccessDetails(instanceName) = lightsail("GetInstanceAccessDetails", Dict{String, Any}("instanceName"=>instanceName))
GetInstanceAccessDetails(instanceName, args::AbstractDict{String, <:Any}) = lightsail("GetInstanceAccessDetails", Dict{String, Any}("instanceName"=>instanceName, args...))
...
"""
GetInstanceMetricData(endTime, instanceName, metricName, period, startTime, statistics, unit) = lightsail("GetInstanceMetricData", Dict{String, Any}("endTime"=>endTime, "instanceName"=>instanceName, "metricName"=>metricName, "period"=>period, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit))
GetInstanceMetricData(endTime, instanceName, metricName, period, startTime, statistics, unit, args::AbstractDict{String, <:Any}) = lightsail("GetInstanceMetricData", Dict{String, Any}("endTime"=>endTime, "instanceName"=>instanceName, "metricName"=>metricName, "period"=>period, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit, args...))
...
"""
GetInstancePortStates(instanceName) = lightsail("GetInstancePortStates", Dict{String, Any}("instanceName"=>instanceName))
GetInstancePortStates(instanceName, args::AbstractDict{String, <:Any}) = lightsail("GetInstancePortStates", Dict{String, Any}("instanceName"=>instanceName, args...))
...
"""
GetInstanceSnapshot(instanceSnapshotName) = lightsail("GetInstanceSnapshot", Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName))
GetInstanceSnapshot(instanceSnapshotName, args::AbstractDict{String, <:Any}) = lightsail("GetInstanceSnapshot", Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName, args...))
...
GetInstanceSnapshots(args::AbstractDict{String, <:Any}) = lightsail("GetInstanceSnapshots", args)
...
"""
GetInstanceState(instanceName) = lightsail("GetInstanceState", Dict{String, Any}("instanceName"=>instanceName))
GetInstanceState(instanceName, args::AbstractDict{String, <:Any}) = lightsail("GetInstanceState", Dict{String, Any}("instanceName"=>instanceName, args...))
...
GetInstances(args::AbstractDict{String, <:Any}) = lightsail("GetInstances", args)
...
"""
GetKeyPair(keyPairName) = lightsail("GetKeyPair", Dict{String, Any}("keyPairName"=>keyPairName))
GetKeyPair(keyPairName, args::AbstractDict{String, <:Any}) = lightsail("GetKeyPair", Dict{String, Any}("keyPairName"=>keyPairName, args...))
...
GetKeyPairs(args::AbstractDict{String, <:Any}) = lightsail("GetKeyPairs", args)
...
"""
GetLoadBalancer(loadBalancerName) = lightsail("GetLoadBalancer", Dict{String, Any}("loadBalancerName"=>loadBalancerName))
GetLoadBalancer(loadBalancerName, args::AbstractDict{String, <:Any}) = lightsail("GetLoadBalancer", Dict{String, Any}("loadBalancerName"=>loadBalancerName, args...))
...
"""
GetLoadBalancerMetricData(endTime, loadBalancerName, metricName, period, startTime, statistics, unit) = lightsail("GetLoadBalancerMetricData", Dict{String, Any}("endTime"=>endTime, "loadBalancerName"=>loadBalancerName, "metricName"=>metricName, "period"=>period, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit))
GetLoadBalancerMetricData(endTime, loadBalancerName, metricName, period, startTime, statistics, unit, args::AbstractDict{String, <:Any}) = lightsail("GetLoadBalancerMetricData", Dict{String, Any}("endTime"=>endTime, "loadBalancerName"=>loadBalancerName, "metricName"=>metricName, "period"=>period, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit, args...))
...
"""
GetLoadBalancerTlsCertificates(loadBalancerName) = lightsail("GetLoadBalancerTlsCertificates", Dict{String, Any}("loadBalancerName"=>loadBalancerName))
GetLoadBalancerTlsCertificates(loadBalancerName, args::AbstractDict{String, <:Any}) = lightsail("GetLoadBalancerTlsCertificates", Dict{String, Any}("loadBalancerName"=>loadBalancerName, args...))
...
GetLoadBalancers(args::AbstractDict{String, <:Any}) = lightsail("GetLoadBalancers", args)
...
"""
GetOperation(operationId) = lightsail("GetOperation", Dict{String, Any}("operationId"=>operationId))
GetOperation(operationId, args::AbstractDict{String, <:Any}) = lightsail("GetOperation", Dict{String, Any}("operationId"=>operationId, args...))
...
GetOperations(args::AbstractDict{String, <:Any}) = lightsail("GetOperations", args)
...
"""
GetOperationsForResource(resourceName) = lightsail("GetOperationsForResource", Dict{String, Any}("resourceName"=>resourceName))
GetOperationsForResource(resourceName, args::AbstractDict{String, <:Any}) = lightsail("GetOperationsForResource", Dict{String, Any}("resourceName"=>resourceName, args...))
...
GetRegions(args::AbstractDict{String, <:Any}) = lightsail("GetRegions", args)
...
"""
GetRelationalDatabase(relationalDatabaseName) = lightsail("GetRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName))
GetRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("GetRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, args...))
...
GetRelationalDatabaseBlueprints(args::AbstractDict{String, <:Any}) = lightsail("GetRelationalDatabaseBlueprints", args)
...
GetRelationalDatabaseBundles(args::AbstractDict{String, <:Any}) = lightsail("GetRelationalDatabaseBundles", args)
...
"""
GetRelationalDatabaseEvents(relationalDatabaseName) = lightsail("GetRelationalDatabaseEvents", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName))
GetRelationalDatabaseEvents(relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("GetRelationalDatabaseEvents", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, args...))
...
"""
GetRelationalDatabaseLogEvents(logStreamName, relationalDatabaseName) = lightsail("GetRelationalDatabaseLogEvents", Dict{String, Any}("logStreamName"=>logStreamName, "relationalDatabaseName"=>relationalDatabaseName))
GetRelationalDatabaseLogEvents(logStreamName, relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("GetRelationalDatabaseLogEvents", Dict{String, Any}("logStreamName"=>logStreamName, "relationalDatabaseName"=>relationalDatabaseName, args...))
...
"""
GetRelationalDatabaseLogStreams(relationalDatabaseName) = lightsail("GetRelationalDatabaseLogStreams", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName))
GetRelationalDatabaseLogStreams(relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("GetRelationalDatabaseLogStreams", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, args...))
...
"""
GetRelationalDatabaseMasterUserPassword(relationalDatabaseName) = lightsail("GetRelationalDatabaseMasterUserPassword", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName))
GetRelationalDatabaseMasterUserPassword(relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("GetRelationalDatabaseMasterUserPassword", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, args...))
...
"""
GetRelationalDatabaseMetricData(endTime, metricName, period, relationalDatabaseName, startTime, statistics, unit) = lightsail("GetRelationalDatabaseMetricData", Dict{String, Any}("endTime"=>endTime, "metricName"=>metricName, "period"=>period, "relationalDatabaseName"=>relationalDatabaseName, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit))
GetRelationalDatabaseMetricData(endTime, metricName, period, relationalDatabaseName, startTime, statistics, unit, args::AbstractDict{String, <:Any}) = lightsail("GetRelationalDatabaseMetricData", Dict{String, Any}("endTime"=>endTime, "metricName"=>metricName, "period"=>period, "relationalDatabaseName"=>relationalDatabaseName, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit, args...))
...
"""
GetRelationalDatabaseParameters(relationalDatabaseName) = lightsail("GetRelationalDatabaseParameters", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName))
GetRelationalDatabaseParameters(relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("GetRelationalDatabaseParameters", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, args...))
...
"""
GetRelationalDatabaseSnapshot(relationalDatabaseSnapshotName) = lightsail("GetRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName))
GetRelationalDatabaseSnapshot(relationalDatabaseSnapshotName, args::AbstractDict{String, <:Any}) = lightsail("GetRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName, args...))
...
GetRelationalDatabaseSnapshots(args::AbstractDict{String, <:Any}) = lightsail("GetRelationalDatabaseSnapshots", args)
...
GetRelationalDatabases(args::AbstractDict{String, <:Any}) = lightsail("GetRelationalDatabases", args)
...
"""
GetStaticIp(staticIpName) = lightsail("GetStaticIp", Dict{String, Any}("staticIpName"=>staticIpName))
GetStaticIp(staticIpName, args::AbstractDict{String, <:Any}) = lightsail("GetStaticIp", Dict{String, Any}("staticIpName"=>staticIpName, args...))
...
GetStaticIps(args::AbstractDict{String, <:Any}) = lightsail("GetStaticIps", args)
...
"""
ImportKeyPair(keyPairName, publicKeyBase64) = lightsail("ImportKeyPair", Dict{String, Any}("keyPairName"=>keyPairName, "publicKeyBase64"=>publicKeyBase64))
ImportKeyPair(keyPairName, publicKeyBase64, args::AbstractDict{String, <:Any}) = lightsail("ImportKeyPair", Dict{String, Any}("keyPairName"=>keyPairName, "publicKeyBase64"=>publicKeyBase64, args...))
...
IsVpcPeered(args::AbstractDict{String, <:Any}) = lightsail("IsVpcPeered", args)
...
"""
OpenInstancePublicPorts(instanceName, portInfo) = lightsail("OpenInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo))
OpenInstancePublicPorts(instanceName, portInfo, args::AbstractDict{String, <:Any}) = lightsail("OpenInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo, args...))
...
PeerVpc(args::AbstractDict{String, <:Any}) = lightsail("PeerVpc", args)
...
PutAlarm(alarmName, comparisonOperator, evaluationPeriods, metricName, monitoredResourceName, threshold, args::AbstractDict{String, <:Any}) = lightsail("PutAlarm", Dict{String, Any}("alarmName"=>alarmName, "comparisonOperator"=>comparisonOperator, "evaluationPeriods"=>evaluationPeriods, "metricName"=>metricName, "monitoredResourceName"=>monitoredResourceName, "threshold"=>threshold, args...))
...
"""
PutInstancePublicPorts(instanceName, portInfos) = lightsail("PutInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfos"=>portInfos))
PutInstancePublicPorts(instanceName, portInfos, args::AbstractDict{String, <:Any}) = lightsail("PutInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfos"=>portInfos, args...))
...
"""
RebootInstance(instanceName) = lightsail("RebootInstance", Dict{String, Any}("instanceName"=>instanceName))
RebootInstance(instanceName, args::AbstractDict{String, <:Any}) = lightsail("RebootInstance", Dict{String, Any}("instanceName"=>instanceName, args...))
...
"""
RebootRelationalDatabase(relationalDatabaseName) = lightsail("RebootRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName))
RebootRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("RebootRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, args...))
...
"""
ReleaseStaticIp(staticIpName) = lightsail("ReleaseStaticIp", Dict{String, Any}("staticIpName"=>staticIpName))
ReleaseStaticIp(staticIpName, args::AbstractDict{String, <:Any}) = lightsail("ReleaseStaticIp", Dict{String, Any}("staticIpName"=>staticIpName, args...))
...
ResetDistributionCache(args::AbstractDict{String, <:Any}) = lightsail("ResetDistributionCache", args)
...
"""
SendContactMethodVerification(protocol) = lightsail("SendContactMethodVerification", Dict{String, Any}("protocol"=>protocol))
SendContactMethodVerification(protocol, args::AbstractDict{String, <:Any}) = lightsail("SendContactMethodVerification", Dict{String, Any}("protocol"=>protocol, args...))
...
"""
StartInstance(instanceName) = lightsail("StartInstance", Dict{String, Any}("instanceName"=>instanceName))
StartInstance(instanceName, args::AbstractDict{String, <:Any}) = lightsail("StartInstance", Dict{String, Any}("instanceName"=>instanceName, args...))
...
"""
StartRelationalDatabase(relationalDatabaseName) = lightsail("StartRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName))
StartRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("StartRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, args...))
...
"""
StopInstance(instanceName) = lightsail("StopInstance", Dict{String, Any}("instanceName"=>instanceName))
StopInstance(instanceName, args::AbstractDict{String, <:Any}) = lightsail("StopInstance", Dict{String, Any}("instanceName"=>instanceName, args...))
...
"""
StopRelationalDatabase(relationalDatabaseName) = lightsail("StopRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName))
StopRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("StopRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, args...))
...
"""
TagResource(resourceName, tags) = lightsail("TagResource", Dict{String, Any}("resourceName"=>resourceName, "tags"=>tags))
TagResource(resourceName, tags, args::AbstractDict{String, <:Any}) = lightsail("TagResource", Dict{String, Any}("resourceName"=>resourceName, "tags"=>tags, args...))
...
"""
TestAlarm(alarmName, state) = lightsail("TestAlarm", Dict{String, Any}("alarmName"=>alarmName, "state"=>state))
TestAlarm(alarmName, state, args::AbstractDict{String, <:Any}) = lightsail("TestAlarm", Dict{String, Any}("alarmName"=>alarmName, "state"=>state, args...))
...
UnpeerVpc(args::AbstractDict{String, <:Any}) = lightsail("UnpeerVpc", args)
...
"""
UntagResource(resourceName, tagKeys) = lightsail("UntagResource", Dict{String, Any}("resourceName"=>resourceName, "tagKeys"=>tagKeys))
UntagResource(resourceName, tagKeys, args::AbstractDict{String, <:Any}) = lightsail("UntagResource", Dict{String, Any}("resourceName"=>resourceName, "tagKeys"=>tagKeys, args...))
...
- `origin`: An object that describes the origin resource for the distribution, such as a Lightsail instance or load balancer. The distribution pulls, caches, and serves content from the origin.
"""
UpdateDistribution(distributionName) = lightsail("UpdateDistribution", Dict{String, Any}("distributionName"=>distributionName))
UpdateDistribution(distributionName, args::AbstractDict{String, <:Any}) = lightsail("UpdateDistribution", Dict{String, Any}("distributionName"=>distributionName, args...))
...
UpdateDistributionBundle(args::AbstractDict{String, <:Any}) = lightsail("UpdateDistributionBundle", args)
...
"""
UpdateDomainEntry(domainEntry, domainName) = lightsail("UpdateDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName))
UpdateDomainEntry(domainEntry, domainName, args::AbstractDict{String, <:Any}) = lightsail("UpdateDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName, args...))
...
"""
UpdateLoadBalancerAttribute(attributeName, attributeValue, loadBalancerName) = lightsail("UpdateLoadBalancerAttribute", Dict{String, Any}("attributeName"=>attributeName, "attributeValue"=>attributeValue, "loadBalancerName"=>loadBalancerName))
UpdateLoadBalancerAttribute(attributeName, attributeValue, loadBalancerName, args::AbstractDict{String, <:Any}) = lightsail("UpdateLoadBalancerAttribute", Dict{String, Any}("attributeName"=>attributeName, "attributeValue"=>attributeValue, "loadBalancerName"=>loadBalancerName, args...))
...
"""
UpdateRelationalDatabase(relationalDatabaseName) = lightsail("UpdateRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName))
UpdateRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("UpdateRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, args...))
...
"""
UpdateRelationalDatabaseParameters(parameters, relationalDatabaseName) = lightsail("UpdateRelationalDatabaseParameters", Dict{String, Any}("parameters"=>parameters, "relationalDatabaseName"=>relationalDatabaseName))
UpdateRelationalDatabaseParameters(parameters, relationalDatabaseName, args::AbstractDict{String, <:Any}) = lightsail("UpdateRelationalDatabaseParameters", Dict{String, Any}("parameters"=>parameters, "relationalDatabaseName"=>relationalDatabaseName, args...))
