...
"""
allocate_static_ip(staticIpName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("AllocateStaticIp", Dict{String, Any}("staticIpName"=>staticIpName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
allocate_static_ip(staticIpName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("AllocateStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("staticIpName"=>staticIpName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `certificate_name`: The name of the certificate to attach to a distribution.
...
- `distribution_name`: The name of the distribution that the certificate will be attached
  ...
  specify.
"""
attach_certificate_to_distribution(certificateName, distributionName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("AttachCertificateToDistribution", Dict{String, Any}("certificateName"=>certificateName, "distributionName"=>distributionName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
attach_certificate_to_distribution(certificateName, distributionName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("AttachCertificateToDistribution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("certificateName"=>certificateName, "distributionName"=>distributionName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
attach_disk(diskName, diskPath, instanceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("AttachDisk", Dict{String, Any}("diskName"=>diskName, "diskPath"=>diskPath, "instanceName"=>instanceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
attach_disk(diskName, diskPath, instanceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("AttachDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskName"=>diskName, "diskPath"=>diskPath, "instanceName"=>instanceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
attach_instances_to_load_balancer(instanceNames, loadBalancerName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("AttachInstancesToLoadBalancer", Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
attach_instances_to_load_balancer(instanceNames, loadBalancerName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("AttachInstancesToLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `load_balancer_name`: The name of the load balancer to which you want to associate the
  SSL/TLS certificate.
"""
attach_load_balancer_tls_certificate(certificateName, loadBalancerName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("AttachLoadBalancerTlsCertificate", Dict{String, Any}("certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
attach_static_ip(instanceName, staticIpName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("AttachStaticIp", Dict{String, Any}("instanceName"=>instanceName, "staticIpName"=>staticIpName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
attach_static_ip(instanceName, staticIpName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("AttachStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "staticIpName"=>staticIpName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
close_instance_public_ports(instanceName, portInfo; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CloseInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
close_instance_public_ports(instanceName, portInfo, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CloseInstancePublicPorts", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"useLatestRestorableAutoSnapshot"`: A Boolean value to indicate whether to use the
  ...
  For more information, see the [Amazon Lightsail Developer Guide](https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-keeping-automatic-snapshots).
"""
copy_snapshot(sourceRegion, targetSnapshotName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CopySnapshot", Dict{String, Any}("sourceRegion"=>sourceRegion, "targetSnapshotName"=>targetSnapshotName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
copy_snapshot(sourceRegion, targetSnapshotName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CopySnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("sourceRegion"=>sourceRegion, "targetSnapshotName"=>targetSnapshotName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_bucket(bucketName, bundleId; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateBucket", Dict{String, Any}("bucketName"=>bucketName, "bundleId"=>bundleId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_bucket(bucketName, bundleId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateBucket", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("bucketName"=>bucketName, "bundleId"=>bundleId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `bucket_name`: The name of the bucket that the new access key will belong to, and grant
  access to.
"""
create_bucket_access_key(bucketName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateBucketAccessKey", Dict{String, Any}("bucketName"=>bucketName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_bucket_access_key(bucketName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateBucketAccessKey", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("bucketName"=>bucketName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"subjectAlternativeNames"`: An array of strings that specify the alternate domains
  (`example2.com`) and subdomains (`blog.example.com`) for the certificate.
...
"""
create_certificate(certificateName, domainName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateCertificate", Dict{String, Any}("certificateName"=>certificateName, "domainName"=>domainName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_certificate(certificateName, domainName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("certificateName"=>certificateName, "domainName"=>domainName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_cloud_formation_stack(instances; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateCloudFormationStack", Dict{String, Any}("instances"=>instances); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_cloud_formation_stack(instances, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateCloudFormationStack", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instances"=>instances), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `contact_endpoint`: The destination of the contact method, such as an email address or a
  ...
  would be specified as +1XXX5550100. For more information, see [E.164](https://en.wikipedia.org/wiki/E.164)
  on *Wikipedia*.
...
"""
create_contact_method(contactEndpoint, protocol; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateContactMethod", Dict{String, Any}("contactEndpoint"=>contactEndpoint, "protocol"=>protocol); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_contact_method(contactEndpoint, protocol, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateContactMethod", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("contactEndpoint"=>contactEndpoint, "protocol"=>protocol), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_container_service(power, scale, serviceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateContainerService", Dict{String, Any}("power"=>power, "scale"=>scale, "serviceName"=>serviceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_container_service(power, scale, serviceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateContainerService", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("power"=>power, "scale"=>scale, "serviceName"=>serviceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"publicEndpoint"`: An object that describes the settings of the public endpoint for the
  container service.
"""
create_container_service_deployment(serviceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateContainerServiceDeployment", Dict{String, Any}("serviceName"=>serviceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_container_service_deployment(serviceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateContainerServiceDeployment", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("serviceName"=>serviceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
in the *Amazon Lightsail Developer Guide*.
"""
create_container_service_registry_login(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateContainerServiceRegistryLogin"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_container_service_registry_login(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateContainerServiceRegistryLogin", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Use the `TagResource` action to tag a resource after it's created.
"""
create_disk(availabilityZone, diskName, sizeInGb; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateDisk", Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_disk(availabilityZone, diskName, sizeInGb, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"useLatestRestorableAutoSnapshot"`: A Boolean value to indicate whether to use the
  ...
  more information, see the [Amazon Lightsail Developer Guide](https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-configuring-automatic-snapshots).
"""
create_disk_from_snapshot(availabilityZone, diskName, sizeInGb; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateDiskFromSnapshot", Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
data that has been written to your disk at the time the snapshot command is issued. This
may exclude any data that has been cached by any applications or the operating system. If
you can pause any file systems on the disk long enough to take a snapshot, your snapshot
should be complete. Nevertheless, if you cannot pause all file writes to the disk, you
should unmount the disk from within the Lightsail instance, issue the create disk snapshot
command, and then remount the disk to ensure a consistent and complete snapshot. You may
...
instance or to create a backup of the system volume like you would for a block storage
disk. To create a snapshot of a system volume, just define the `instance name` parameter
when issuing the snapshot command, and a snapshot of the defined instance's system volume
...
- `disk_snapshot_name`: The name of the destination disk snapshot (`my-disk-snapshot`)
...
Use the `TagResource` action to tag a resource after it's created.
"""
create_disk_snapshot(diskSnapshotName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_disk_snapshot(diskSnapshotName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateDiskSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskSnapshotName"=>diskSnapshotName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `bundle_id`: The bundle ID to use for the distribution.
...
Use the `TagResource` action to tag a resource after it's created.
"""
create_domain(domainName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateDomain", Dict{String, Any}("domainName"=>domainName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_domain(domainName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateDomain", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainName"=>domainName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `domain_name`: The domain name (`example.com`) for which you want to create the domain
  entry.
"""
create_domain_entry(domainEntry, domainName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_domain_entry(domainEntry, domainName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateDomainEntry", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_guisession_access_details(resourceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateGUISessionAccessDetails", Dict{String, Any}("resourceName"=>resourceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_guisession_access_details(resourceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateGUISessionAccessDetails", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Use the `TagResource` action to tag a resource after it's created.
"""
create_instance_snapshot(instanceName, instanceSnapshotName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateInstanceSnapshot", Dict{String, Any}("instanceName"=>instanceName, "instanceSnapshotName"=>instanceSnapshotName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_instance_snapshot(instanceName, instanceSnapshotName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateInstanceSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "instanceSnapshotName"=>instanceSnapshotName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `availability_zone`: The Availability Zone where you want to create your instances. Use
  the following formatting: `us-east-2a` (case sensitive). You can get a list of
...
Use the `TagResource` action to tag a resource after it's created.
"""
create_key_pair(keyPairName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateKeyPair", Dict{String, Any}("keyPairName"=>keyPairName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_key_pair(keyPairName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateKeyPair", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("keyPairName"=>keyPairName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"certificateDomainName"`: The domain name with which your certificate is associated
  ...
  If you specify `certificateDomainName`, then `certificateName` is required (and vice-
  versa).
- `"certificateName"`: The name of the SSL/TLS certificate.

  If you specify `certificateName`, then `certificateDomainName` is required (and vice-
  versa).
...
- `"tlsPolicyName"`: The name of the TLS policy to apply to the load balancer.
  ...
  in the *Amazon Lightsail Developer Guide*.
"""
create_load_balancer(instancePort, loadBalancerName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateLoadBalancer", Dict{String, Any}("instancePort"=>instancePort, "loadBalancerName"=>loadBalancerName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_load_balancer(instancePort, loadBalancerName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instancePort"=>instancePort, "loadBalancerName"=>loadBalancerName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `certificate_name`: The SSL/TLS certificate name.
  ...
  more information, see [Limits](http://docs.aws.amazon.com/acm/latest/userguide/acm-limits.html).
...
- `"certificateAlternativeNames"`: An array of strings listing alternative domains and
  subdomains for your SSL/TLS certificate. Lightsail will de-dupe the names for you. You
  can have a maximum of 9 alternative names (in addition to the 1 primary domain). We do
...
"""
create_relational_database_from_snapshot(relationalDatabaseName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateRelationalDatabaseFromSnapshot", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_relational_database_from_snapshot(relationalDatabaseName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("CreateRelationalDatabaseFromSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_alarm(alarmName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteAlarm", Dict{String, Any}("alarmName"=>alarmName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_alarm(alarmName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteAlarm", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("alarmName"=>alarmName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `resource_name`: The name of the source instance or disk from which to delete the
  automatic snapshot.
"""
delete_auto_snapshot(date, resourceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteAutoSnapshot", Dict{String, Any}("date"=>date, "resourceName"=>resourceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_auto_snapshot(date, resourceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteAutoSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("date"=>date, "resourceName"=>resourceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_bucket(bucketName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteBucket", Dict{String, Any}("bucketName"=>bucketName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_bucket(bucketName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteBucket", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("bucketName"=>bucketName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_bucket_access_key(accessKeyId, bucketName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteBucketAccessKey", Dict{String, Any}("accessKeyId"=>accessKeyId, "bucketName"=>bucketName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_bucket_access_key(accessKeyId, bucketName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteBucketAccessKey", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("accessKeyId"=>accessKeyId, "bucketName"=>bucketName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Use the `GetCertificates` action to get a list of certificate names that you can specify.
"""
delete_certificate(certificateName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteCertificate", Dict{String, Any}("certificateName"=>certificateName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_certificate(certificateName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("certificateName"=>certificateName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_contact_method(protocol; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteContactMethod", Dict{String, Any}("protocol"=>protocol); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_contact_method(protocol, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteContactMethod", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("protocol"=>protocol), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `service_name`: The name of the container service for which to delete a registered
  container image.
"""
delete_container_image(image, serviceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteContainerImage", Dict{String, Any}("image"=>image, "serviceName"=>serviceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_container_image(image, serviceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteContainerImage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("image"=>image, "serviceName"=>serviceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_container_service(serviceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteContainerService", Dict{String, Any}("serviceName"=>serviceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_container_service(serviceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteContainerService", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("serviceName"=>serviceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"forceDeleteAddOns"`: A Boolean value to indicate whether to delete all add-ons for the
  disk.
"""
delete_disk(diskName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteDisk", Dict{String, Any}("diskName"=>diskName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_disk(diskName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskName"=>diskName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `disk_snapshot_name`: The name of the disk snapshot you want to delete (`my-disk-
  snapshot`).
"""
delete_disk_snapshot(diskSnapshotName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_disk_snapshot(diskSnapshotName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteDiskSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskSnapshotName"=>diskSnapshotName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"distributionName"`: The name of the distribution to delete.
  ...
  specify.
"""
delete_distribution(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteDistribution"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_distribution(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteDistribution", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_domain(domainName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteDomain", Dict{String, Any}("domainName"=>domainName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_domain(domainName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteDomain", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainName"=>domainName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_domain_entry(domainEntry, domainName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_domain_entry(domainEntry, domainName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteDomainEntry", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"forceDeleteAddOns"`: A Boolean value to indicate whether to delete all add-ons for the
  instance.
"""
delete_instance(instanceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteInstance", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_instance(instanceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_instance_snapshot(instanceSnapshotName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteInstanceSnapshot", Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_instance_snapshot(instanceSnapshotName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteInstanceSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
actions, as well as the Lightsail default key pair. A new default key pair will not be
created unless you launch an instance without specifying a custom key pair, or you call the
...
"""
delete_key_pair(keyPairName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteKeyPair", Dict{String, Any}("keyPairName"=>keyPairName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_key_pair(keyPairName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteKeyPair", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("keyPairName"=>keyPairName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `instance_name`: The name of the instance for which you want to reset the host key or
  certificate.
"""
delete_known_host_keys(instanceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteKnownHostKeys", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_known_host_keys(instanceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteKnownHostKeys", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_load_balancer(loadBalancerName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteLoadBalancer", Dict{String, Any}("loadBalancerName"=>loadBalancerName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_load_balancer(loadBalancerName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("loadBalancerName"=>loadBalancerName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_load_balancer_tls_certificate(certificateName, loadBalancerName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteLoadBalancerTlsCertificate", Dict{String, Any}("certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Default: `false`
"""
delete_relational_database(relationalDatabaseName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_relational_database(relationalDatabaseName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `relational_database_snapshot_name`: The name of the database snapshot that you are
  deleting.
"""
delete_relational_database_snapshot(relationalDatabaseSnapshotName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_relational_database_snapshot(relationalDatabaseSnapshotName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DeleteRelationalDatabaseSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `distribution_name`: The name of the distribution from which to detach the certificate.
  ...
  specify.
"""
detach_certificate_from_distribution(distributionName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DetachCertificateFromDistribution", Dict{String, Any}("distributionName"=>distributionName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
detach_certificate_from_distribution(distributionName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DetachCertificateFromDistribution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("distributionName"=>distributionName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `disk_name`: The unique name of the disk you want to detach from your instance (`my-
  disk`).
"""
detach_disk(diskName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DetachDisk", Dict{String, Any}("diskName"=>diskName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
detach_disk(diskName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DetachDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskName"=>diskName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
detach_instances_from_load_balancer(instanceNames, loadBalancerName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DetachInstancesFromLoadBalancer", Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
detach_instances_from_load_balancer(instanceNames, loadBalancerName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DetachInstancesFromLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
detach_static_ip(staticIpName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DetachStaticIp", Dict{String, Any}("staticIpName"=>staticIpName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
detach_static_ip(staticIpName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DetachStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("staticIpName"=>staticIpName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
disable_add_on(addOnType, resourceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DisableAddOn", Dict{String, Any}("addOnType"=>addOnType, "resourceName"=>resourceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
disable_add_on(addOnType, resourceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DisableAddOn", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("addOnType"=>addOnType, "resourceName"=>resourceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
download_default_key_pair(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DownloadDefaultKeyPair"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
download_default_key_pair(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("DownloadDefaultKeyPair", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
enable_add_on(addOnRequest, resourceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("EnableAddOn", Dict{String, Any}("addOnRequest"=>addOnRequest, "resourceName"=>resourceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
enable_add_on(addOnRequest, resourceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("EnableAddOn", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("addOnRequest"=>addOnRequest, "resourceName"=>resourceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `source_snapshot_name`: The name of the instance or disk snapshot to be exported to
  Amazon EC2.
"""
export_snapshot(sourceSnapshotName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("ExportSnapshot", Dict{String, Any}("sourceSnapshotName"=>sourceSnapshotName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
export_snapshot(sourceSnapshotName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("ExportSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("sourceSnapshotName"=>sourceSnapshotName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_active_names(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetActiveNames"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_active_names(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetActiveNames", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_alarms(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetAlarms"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_alarms(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetAlarms", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_auto_snapshots(resourceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetAutoSnapshots", Dict{String, Any}("resourceName"=>resourceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_auto_snapshots(resourceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetAutoSnapshots", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_blueprints(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetBlueprints"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_blueprints(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetBlueprints", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_bucket_access_keys(bucketName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetBucketAccessKeys", Dict{String, Any}("bucketName"=>bucketName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_bucket_access_keys(bucketName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetBucketAccessKeys", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("bucketName"=>bucketName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_bucket_bundles(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetBucketBundles"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_bucket_bundles(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetBucketBundles", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
monitor the number of objects stored in a bucket (including object versions) and the
storage space used by those objects.
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_buckets(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetBuckets"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_buckets(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetBuckets", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_bundles(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetBundles"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_bundles(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetBundles", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"includeCertificateDetails"`: Indicates whether to include detailed information about
  the certificates in the response.
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_certificates(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetCertificates"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_certificates(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetCertificates", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_cloud_formation_stack_records(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetCloudFormationStackRecords"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_cloud_formation_stack_records(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetCloudFormationStackRecords", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"protocols"`: The protocols used to send notifications, such as `Email`, or `SMS` (text
  ...
  protocol.
"""
get_contact_methods(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContactMethods"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_contact_methods(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContactMethods", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_container_apimetadata(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContainerAPIMetadata"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_container_apimetadata(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContainerAPIMetadata", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `service_name`: The name of the container service for which to return registered
  container images.
"""
get_container_images(serviceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContainerImages", Dict{String, Any}("serviceName"=>serviceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_container_images(serviceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContainerImages", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("serviceName"=>serviceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"startTime"`: The start of the time interval for which to get log data.
  ...
  You can convert a human-friendly time to Unix time format using a converter like [Epoch converter](https://www.epochconverter.com/).
"""
get_container_log(containerName, serviceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContainerLog", Dict{String, Any}("containerName"=>containerName, "serviceName"=>serviceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_container_log(containerName, serviceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContainerLog", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("containerName"=>containerName, "serviceName"=>serviceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_container_service_deployments(serviceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContainerServiceDeployments", Dict{String, Any}("serviceName"=>serviceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_container_service_deployments(serviceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContainerServiceDeployments", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("serviceName"=>serviceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
container service.
"""
get_container_service_powers(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContainerServicePowers"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_container_service_powers(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContainerServicePowers", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_container_services(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContainerServices"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_container_services(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetContainerServices", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `start_time`: The cost estimate start time.
  ...
  You can convert a human-friendly time to Unix time format using a converter like [Epoch converter](https://www.epochconverter.com/).
"""
get_cost_estimate(endTime, resourceName, startTime; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetCostEstimate", Dict{String, Any}("endTime"=>endTime, "resourceName"=>resourceName, "startTime"=>startTime); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_cost_estimate(endTime, resourceName, startTime, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetCostEstimate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("endTime"=>endTime, "resourceName"=>resourceName, "startTime"=>startTime), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_disk(diskName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDisk", Dict{String, Any}("diskName"=>diskName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_disk(diskName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskName"=>diskName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_disk_snapshot(diskSnapshotName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_disk_snapshot(diskSnapshotName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDiskSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskSnapshotName"=>diskSnapshotName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_disk_snapshots(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDiskSnapshots"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_disk_snapshots(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDiskSnapshots", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_disks(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDisks"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_disks(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDisks", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
distribution.
"""
get_distribution_bundles(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDistributionBundles"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_distribution_bundles(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDistributionBundles", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"distributionName"`: The name of the distribution for which to return the timestamp of
  ...
  distributions.
"""
get_distribution_latest_cache_reset(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDistributionLatestCacheReset"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_distribution_latest_cache_reset(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDistributionLatestCacheReset", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `distribution_name`: The name of the distribution for which to get metric data.
...
- `unit`: The unit for the metric data request.
  ...
  available metric, see the `metricName` parameter.
"""
get_distribution_metric_data(distributionName, endTime, metricName, period, startTime, statistics, unit; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDistributionMetricData", Dict{String, Any}("distributionName"=>distributionName, "endTime"=>endTime, "metricName"=>metricName, "period"=>period, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_distribution_metric_data(distributionName, endTime, metricName, period, startTime, statistics, unit, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDistributionMetricData", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("distributionName"=>distributionName, "endTime"=>endTime, "metricName"=>metricName, "period"=>period, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_distributions(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDistributions"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_distributions(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDistributions", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_domain(domainName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDomain", Dict{String, Any}("domainName"=>domainName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_domain(domainName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDomain", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainName"=>domainName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_domains(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDomains"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_domains(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetDomains", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  the page token in a subsequent request.
"""
get_export_snapshot_records(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetExportSnapshotRecords"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_export_snapshot_records(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetExportSnapshotRecords", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_instance(instanceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstance", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_instance(instanceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_instance_access_details(instanceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstanceAccessDetails", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_instance_access_details(instanceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstanceAccessDetails", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_instance_port_states(instanceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstancePortStates", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_instance_port_states(instanceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstancePortStates", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `instance_snapshot_name`: The name of the snapshot for which you are requesting
  information.
"""
get_instance_snapshot(instanceSnapshotName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstanceSnapshot", Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_instance_snapshot(instanceSnapshotName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstanceSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_instance_snapshots(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstanceSnapshots"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_instance_snapshots(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstanceSnapshots", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_instance_state(instanceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstanceState", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_instance_state(instanceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstanceState", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_instances(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstances"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_instances(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetInstances", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_key_pair(keyPairName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetKeyPair", Dict{String, Any}("keyPairName"=>keyPairName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_key_pair(keyPairName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetKeyPair", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("keyPairName"=>keyPairName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_key_pairs(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetKeyPairs"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_key_pairs(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetKeyPairs", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `load_balancer_name`: The name of the load balancer.
"""
get_load_balancer(loadBalancerName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetLoadBalancer", Dict{String, Any}("loadBalancerName"=>loadBalancerName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_load_balancer(loadBalancerName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("loadBalancerName"=>loadBalancerName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `load_balancer_name`: The name of the load balancer you associated with your SSL/TLS
  certificate.
"""
get_load_balancer_tls_certificates(loadBalancerName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetLoadBalancerTlsCertificates", Dict{String, Any}("loadBalancerName"=>loadBalancerName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  the page token in a subsequent request.
"""
get_load_balancer_tls_policies(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetLoadBalancerTlsPolicies"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_load_balancer_tls_policies(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetLoadBalancerTlsPolicies", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_load_balancers(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetLoadBalancers"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_load_balancers(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetLoadBalancers", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_operation(operationId; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetOperation", Dict{String, Any}("operationId"=>operationId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_operation(operationId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetOperation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("operationId"=>operationId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_operations(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetOperations"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_operations(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetOperations", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  the page token in a subsequent request.
"""
get_operations_for_resource(resourceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetOperationsForResource", Dict{String, Any}("resourceName"=>resourceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_operations_for_resource(resourceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetOperationsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_regions(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRegions"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_regions(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRegions", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_relational_database(relationalDatabaseName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_relational_database(relationalDatabaseName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_relational_database_blueprints(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseBlueprints"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_relational_database_blueprints(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseBlueprints", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  the page token in a subsequent request.
"""
get_relational_database_bundles(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseBundles"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_relational_database_bundles(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseBundles", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  the page token in a subsequent request.
"""
get_relational_database_events(relationalDatabaseName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseEvents", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_relational_database_events(relationalDatabaseName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseEvents", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_relational_database_log_streams(relationalDatabaseName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseLogStreams", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_relational_database_log_streams(relationalDatabaseName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseLogStreams", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Default: `CURRENT`
"""
get_relational_database_master_user_password(relationalDatabaseName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseMasterUserPassword", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_relational_database_master_user_password(relationalDatabaseName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseMasterUserPassword", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  specify as the page token in a subsequent request.
"""
get_relational_database_parameters(relationalDatabaseName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseParameters", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `relational_database_snapshot_name`: The name of the database snapshot for which to get
  information.
"""
get_relational_database_snapshot(relationalDatabaseSnapshotName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_relational_database_snapshot(relationalDatabaseSnapshotName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  the page token in a subsequent request.
"""
get_relational_database_snapshots(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseSnapshots"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_relational_database_snapshots(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabaseSnapshots", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  page token in a subsequent request.
"""
get_relational_databases(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabases"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_relational_databases(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetRelationalDatabases", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_setup_history(resourceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetSetupHistory", Dict{String, Any}("resourceName"=>resourceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_setup_history(resourceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetSetupHistory", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_static_ip(staticIpName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetStaticIp", Dict{String, Any}("staticIpName"=>staticIpName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_static_ip(staticIpName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("staticIpName"=>staticIpName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"pageToken"`: The token to advance to the next page of results from your request.
  ...
  token in a subsequent request.
"""
get_static_ips(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetStaticIps"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_static_ips(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("GetStaticIps", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
import_key_pair(keyPairName, publicKeyBase64; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("ImportKeyPair", Dict{String, Any}("keyPairName"=>keyPairName, "publicKeyBase64"=>publicKeyBase64); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
import_key_pair(keyPairName, publicKeyBase64, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("ImportKeyPair", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("keyPairName"=>keyPairName, "publicKeyBase64"=>publicKeyBase64), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
is_vpc_peered(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("IsVpcPeered"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
is_vpc_peered(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("IsVpcPeered", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
open_instance_public_ports(instanceName, portInfo; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("OpenInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
open_instance_public_ports(instanceName, portInfo, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("OpenInstancePublicPorts", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
peer_vpc(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("PeerVpc"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
peer_vpc(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("PeerVpc", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `metric_name`: The name of the metric to associate with the alarm.
...
ports and the protocols you want to open in your `PutInstancePublicPorts`request. Or use
the `OpenInstancePublicPorts` action to open ports without closing currently open ports.
...
- `port_infos`: An array of objects to describe the ports to open for the specified
  instance.
"""
put_instance_public_ports(instanceName, portInfos; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("PutInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfos"=>portInfos); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_instance_public_ports(instanceName, portInfos, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("PutInstancePublicPorts", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "portInfos"=>portInfos), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
reboot_instance(instanceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("RebootInstance", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
reboot_instance(instanceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("RebootInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
reboot_relational_database(relationalDatabaseName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("RebootRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
reboot_relational_database(relationalDatabaseName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("RebootRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
register_container_image(digest, label, serviceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("RegisterContainerImage", Dict{String, Any}("digest"=>digest, "label"=>label, "serviceName"=>serviceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
register_container_image(digest, label, serviceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("RegisterContainerImage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("digest"=>digest, "label"=>label, "serviceName"=>serviceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
release_static_ip(staticIpName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("ReleaseStaticIp", Dict{String, Any}("staticIpName"=>staticIpName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
release_static_ip(staticIpName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("ReleaseStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("staticIpName"=>staticIpName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"distributionName"`: The name of the distribution for which to reset cache.
  ...
  specify.
"""
reset_distribution_cache(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("ResetDistributionCache"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
reset_distribution_cache(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("ResetDistributionCache", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
send_contact_method_verification(protocol; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("SendContactMethodVerification", Dict{String, Any}("protocol"=>protocol); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
send_contact_method_verification(protocol, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("SendContactMethodVerification", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("protocol"=>protocol), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `ip_address_type`: The IP address type to set for the specified resource.
...
"""
set_ip_address_type(ipAddressType, resourceName, resourceType; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("SetIpAddressType", Dict{String, Any}("ipAddressType"=>ipAddressType, "resourceName"=>resourceName, "resourceType"=>resourceType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
set_resource_access_for_bucket(access, bucketName, resourceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("SetResourceAccessForBucket", Dict{String, Any}("access"=>access, "bucketName"=>bucketName, "resourceName"=>resourceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `resource_name`: The resource name.
"""
start_guisession(resourceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("StartGUISession", Dict{String, Any}("resourceName"=>resourceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_guisession(resourceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("StartGUISession", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
start_instance(instanceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("StartInstance", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_instance(instanceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("StartInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
start_relational_database(relationalDatabaseName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("StartRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_relational_database(relationalDatabaseName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("StartRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `resource_name`: The resource name.
"""
stop_guisession(resourceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("StopGUISession", Dict{String, Any}("resourceName"=>resourceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
stop_guisession(resourceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("StopGUISession", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"force"`: When set to `True`, forces a Lightsail instance that is stuck in a `stopping`
  ...
  API request.
"""
stop_instance(instanceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("StopInstance", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
stop_instance(instanceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("StopInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
stop_relational_database(relationalDatabaseName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("StopRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"resourceArn"`: The Amazon Resource Name (ARN) of the resource to which you want to add
  a tag.
"""
tag_resource(resourceName, tags; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("TagResource", Dict{String, Any}("resourceName"=>resourceName, "tags"=>tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
tag_resource(resourceName, tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName, "tags"=>tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `state`: The alarm state to test.
  ...
  enough data is available for the metric to determine the alarm state.
   - `OK` - The metric is within the defined threshold.
"""
test_alarm(alarmName, state; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("TestAlarm", Dict{String, Any}("alarmName"=>alarmName, "state"=>state); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
test_alarm(alarmName, state, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("TestAlarm", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("alarmName"=>alarmName, "state"=>state), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
unpeer_vpc(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UnpeerVpc"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
unpeer_vpc(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UnpeerVpc", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"resourceArn"`: The Amazon Resource Name (ARN) of the resource from which you want to
  remove a tag.
"""
untag_resource(resourceName, tagKeys; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UntagResource", Dict{String, Any}("resourceName"=>resourceName, "tagKeys"=>tagKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
untag_resource(resourceName, tagKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName, "tagKeys"=>tagKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_bucket(bucketName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateBucket", Dict{String, Any}("bucketName"=>bucketName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_bucket(bucketName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateBucket", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("bucketName"=>bucketName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
billing cycle. To determine if you can update a bucket's bundle, use the [GetBuckets](https://docs.aws.amazon.com/lightsail/2016-11-28/api-reference/API_GetBuckets.html)
...
- `bundle_id`: The ID of the new bundle to apply to the bucket.

  Use the [GetBucketBundles](https://docs.aws.amazon.com/lightsail/2016-11-28/api-reference/API_GetBucketBundles.html)
  action to get a list of bundle IDs that you can specify.
"""
update_bucket_bundle(bucketName, bundleId; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateBucketBundle", Dict{String, Any}("bucketName"=>bucketName, "bundleId"=>bundleId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_bucket_bundle(bucketName, bundleId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateBucketBundle", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("bucketName"=>bucketName, "bundleId"=>bundleId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"scale"`: The scale for the container service.
  ...
  (the number of nodes) of the service.
"""
update_container_service(serviceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateContainerService", Dict{String, Any}("serviceName"=>serviceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_container_service(serviceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateContainerService", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("serviceName"=>serviceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `distribution_name`: The name of the distribution to update.
...
"""
update_distribution(distributionName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateDistribution", Dict{String, Any}("distributionName"=>distributionName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_distribution(distributionName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateDistribution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("distributionName"=>distributionName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"distributionName"`: The name of the distribution for which to update the bundle.
  ...
  specify.
"""
update_distribution_bundle(; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateDistributionBundle"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_distribution_bundle(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateDistributionBundle", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_domain_entry(domainEntry, domainName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_domain_entry(domainEntry, domainName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateDomainEntry", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
`GetInstances` API operation initially responds with a state of `pending`. After the
parameter modifications are successfully applied, the state changes to `applied` in
subsequent `GetInstance` or `GetInstances` API calls. For more information, see [Use IMDSv2 with an Amazon Lightsail instance](https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-configuring-instance-metadata-service)
in the *Amazon Lightsail Developer Guide*.
...
"""
update_instance_metadata_options(instanceName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateInstanceMetadataOptions", Dict{String, Any}("instanceName"=>instanceName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_instance_metadata_options(instanceName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateInstanceMetadataOptions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_relational_database(relationalDatabaseName; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_relational_database(relationalDatabaseName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = lightsail("UpdateRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
