...
"""
AllocateStaticIp(staticIpName; aws::AWSConfig=AWSConfig()) = lightsail("AllocateStaticIp", Dict{String, Any}("staticIpName"=>staticIpName); aws=aws)
AllocateStaticIp(staticIpName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("AllocateStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("staticIpName"=>staticIpName), args)); aws=aws)
...
"""
AttachCertificateToDistribution(certificateName, distributionName; aws::AWSConfig=AWSConfig()) = lightsail("AttachCertificateToDistribution", Dict{String, Any}("certificateName"=>certificateName, "distributionName"=>distributionName); aws=aws)
AttachCertificateToDistribution(certificateName, distributionName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("AttachCertificateToDistribution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("certificateName"=>certificateName, "distributionName"=>distributionName), args)); aws=aws)
...
"""
AttachDisk(diskName, diskPath, instanceName; aws::AWSConfig=AWSConfig()) = lightsail("AttachDisk", Dict{String, Any}("diskName"=>diskName, "diskPath"=>diskPath, "instanceName"=>instanceName); aws=aws)
AttachDisk(diskName, diskPath, instanceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("AttachDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskName"=>diskName, "diskPath"=>diskPath, "instanceName"=>instanceName), args)); aws=aws)
...
"""
AttachInstancesToLoadBalancer(instanceNames, loadBalancerName; aws::AWSConfig=AWSConfig()) = lightsail("AttachInstancesToLoadBalancer", Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName); aws=aws)
AttachInstancesToLoadBalancer(instanceNames, loadBalancerName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("AttachInstancesToLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName), args)); aws=aws)
...
"""
AttachLoadBalancerTlsCertificate(certificateName, loadBalancerName; aws::AWSConfig=AWSConfig()) = lightsail("AttachLoadBalancerTlsCertificate", Dict{String, Any}("certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName); aws=aws)
AttachLoadBalancerTlsCertificate(certificateName, loadBalancerName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("AttachLoadBalancerTlsCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName), args)); aws=aws)
...
"""
AttachStaticIp(instanceName, staticIpName; aws::AWSConfig=AWSConfig()) = lightsail("AttachStaticIp", Dict{String, Any}("instanceName"=>instanceName, "staticIpName"=>staticIpName); aws=aws)
AttachStaticIp(instanceName, staticIpName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("AttachStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "staticIpName"=>staticIpName), args)); aws=aws)
...
"""
CloseInstancePublicPorts(instanceName, portInfo; aws::AWSConfig=AWSConfig()) = lightsail("CloseInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo); aws=aws)
CloseInstancePublicPorts(instanceName, portInfo, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CloseInstancePublicPorts", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo), args)); aws=aws)
...
"""
CopySnapshot(sourceRegion, targetSnapshotName; aws::AWSConfig=AWSConfig()) = lightsail("CopySnapshot", Dict{String, Any}("sourceRegion"=>sourceRegion, "targetSnapshotName"=>targetSnapshotName); aws=aws)
CopySnapshot(sourceRegion, targetSnapshotName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CopySnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("sourceRegion"=>sourceRegion, "targetSnapshotName"=>targetSnapshotName), args)); aws=aws)
...
"""
CreateCertificate(certificateName, domainName; aws::AWSConfig=AWSConfig()) = lightsail("CreateCertificate", Dict{String, Any}("certificateName"=>certificateName, "domainName"=>domainName); aws=aws)
CreateCertificate(certificateName, domainName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("certificateName"=>certificateName, "domainName"=>domainName), args)); aws=aws)
...
"""
CreateCloudFormationStack(instances; aws::AWSConfig=AWSConfig()) = lightsail("CreateCloudFormationStack", Dict{String, Any}("instances"=>instances); aws=aws)
CreateCloudFormationStack(instances, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateCloudFormationStack", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instances"=>instances), args)); aws=aws)
...
"""
CreateContactMethod(contactEndpoint, protocol; aws::AWSConfig=AWSConfig()) = lightsail("CreateContactMethod", Dict{String, Any}("contactEndpoint"=>contactEndpoint, "protocol"=>protocol); aws=aws)
CreateContactMethod(contactEndpoint, protocol, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateContactMethod", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("contactEndpoint"=>contactEndpoint, "protocol"=>protocol), args)); aws=aws)
...
"""
CreateDisk(availabilityZone, diskName, sizeInGb; aws::AWSConfig=AWSConfig()) = lightsail("CreateDisk", Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb); aws=aws)
CreateDisk(availabilityZone, diskName, sizeInGb, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb), args)); aws=aws)
...
"""
CreateDiskFromSnapshot(availabilityZone, diskName, sizeInGb; aws::AWSConfig=AWSConfig()) = lightsail("CreateDiskFromSnapshot", Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb); aws=aws)
CreateDiskFromSnapshot(availabilityZone, diskName, sizeInGb, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateDiskFromSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("availabilityZone"=>availabilityZone, "diskName"=>diskName, "sizeInGb"=>sizeInGb), args)); aws=aws)
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateDiskSnapshot(diskSnapshotName; aws::AWSConfig=AWSConfig()) = lightsail("CreateDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName); aws=aws)
CreateDiskSnapshot(diskSnapshotName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateDiskSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskSnapshotName"=>diskSnapshotName), args)); aws=aws)
...
"""
CreateDistribution(bundleId, defaultCacheBehavior, distributionName, origin; aws::AWSConfig=AWSConfig()) = lightsail("CreateDistribution", Dict{String, Any}("bundleId"=>bundleId, "defaultCacheBehavior"=>defaultCacheBehavior, "distributionName"=>distributionName, "origin"=>origin); aws=aws)
CreateDistribution(bundleId, defaultCacheBehavior, distributionName, origin, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateDistribution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("bundleId"=>bundleId, "defaultCacheBehavior"=>defaultCacheBehavior, "distributionName"=>distributionName, "origin"=>origin), args)); aws=aws)
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateDomain(domainName; aws::AWSConfig=AWSConfig()) = lightsail("CreateDomain", Dict{String, Any}("domainName"=>domainName); aws=aws)
CreateDomain(domainName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateDomain", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainName"=>domainName), args)); aws=aws)
...
"""
CreateDomainEntry(domainEntry, domainName; aws::AWSConfig=AWSConfig()) = lightsail("CreateDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName); aws=aws)
CreateDomainEntry(domainEntry, domainName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateDomainEntry", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName), args)); aws=aws)
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateInstanceSnapshot(instanceName, instanceSnapshotName; aws::AWSConfig=AWSConfig()) = lightsail("CreateInstanceSnapshot", Dict{String, Any}("instanceName"=>instanceName, "instanceSnapshotName"=>instanceSnapshotName); aws=aws)
CreateInstanceSnapshot(instanceName, instanceSnapshotName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateInstanceSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "instanceSnapshotName"=>instanceSnapshotName), args)); aws=aws)
...
"""
CreateInstances(availabilityZone, blueprintId, bundleId, instanceNames; aws::AWSConfig=AWSConfig()) = lightsail("CreateInstances", Dict{String, Any}("availabilityZone"=>availabilityZone, "blueprintId"=>blueprintId, "bundleId"=>bundleId, "instanceNames"=>instanceNames); aws=aws)
CreateInstances(availabilityZone, blueprintId, bundleId, instanceNames, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateInstances", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("availabilityZone"=>availabilityZone, "blueprintId"=>blueprintId, "bundleId"=>bundleId, "instanceNames"=>instanceNames), args)); aws=aws)
...
"""
CreateInstancesFromSnapshot(availabilityZone, bundleId, instanceNames; aws::AWSConfig=AWSConfig()) = lightsail("CreateInstancesFromSnapshot", Dict{String, Any}("availabilityZone"=>availabilityZone, "bundleId"=>bundleId, "instanceNames"=>instanceNames); aws=aws)
CreateInstancesFromSnapshot(availabilityZone, bundleId, instanceNames, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateInstancesFromSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("availabilityZone"=>availabilityZone, "bundleId"=>bundleId, "instanceNames"=>instanceNames), args)); aws=aws)
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateKeyPair(keyPairName; aws::AWSConfig=AWSConfig()) = lightsail("CreateKeyPair", Dict{String, Any}("keyPairName"=>keyPairName); aws=aws)
CreateKeyPair(keyPairName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateKeyPair", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("keyPairName"=>keyPairName), args)); aws=aws)
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateLoadBalancer(instancePort, loadBalancerName; aws::AWSConfig=AWSConfig()) = lightsail("CreateLoadBalancer", Dict{String, Any}("instancePort"=>instancePort, "loadBalancerName"=>loadBalancerName); aws=aws)
CreateLoadBalancer(instancePort, loadBalancerName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instancePort"=>instancePort, "loadBalancerName"=>loadBalancerName), args)); aws=aws)
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateLoadBalancerTlsCertificate(certificateDomainName, certificateName, loadBalancerName; aws::AWSConfig=AWSConfig()) = lightsail("CreateLoadBalancerTlsCertificate", Dict{String, Any}("certificateDomainName"=>certificateDomainName, "certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName); aws=aws)
CreateLoadBalancerTlsCertificate(certificateDomainName, certificateName, loadBalancerName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateLoadBalancerTlsCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("certificateDomainName"=>certificateDomainName, "certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName), args)); aws=aws)
...
"""
CreateRelationalDatabaseFromSnapshot(relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("CreateRelationalDatabaseFromSnapshot", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws=aws)
CreateRelationalDatabaseFromSnapshot(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateRelationalDatabaseFromSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
...
- `tags`: The tag keys and optional values to add to the resource during create. Use the TagResource action to tag a resource after it's created.
"""
CreateRelationalDatabaseSnapshot(relationalDatabaseName, relationalDatabaseSnapshotName; aws::AWSConfig=AWSConfig()) = lightsail("CreateRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, "relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName); aws=aws)
CreateRelationalDatabaseSnapshot(relationalDatabaseName, relationalDatabaseSnapshotName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("CreateRelationalDatabaseSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName, "relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName), args)); aws=aws)
...
"""
DeleteAlarm(alarmName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteAlarm", Dict{String, Any}("alarmName"=>alarmName); aws=aws)
DeleteAlarm(alarmName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteAlarm", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("alarmName"=>alarmName), args)); aws=aws)
...
"""
DeleteAutoSnapshot(date, resourceName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteAutoSnapshot", Dict{String, Any}("date"=>date, "resourceName"=>resourceName); aws=aws)
DeleteAutoSnapshot(date, resourceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteAutoSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("date"=>date, "resourceName"=>resourceName), args)); aws=aws)
...
"""
DeleteCertificate(certificateName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteCertificate", Dict{String, Any}("certificateName"=>certificateName); aws=aws)
DeleteCertificate(certificateName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("certificateName"=>certificateName), args)); aws=aws)
...
"""
DeleteContactMethod(protocol; aws::AWSConfig=AWSConfig()) = lightsail("DeleteContactMethod", Dict{String, Any}("protocol"=>protocol); aws=aws)
DeleteContactMethod(protocol, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteContactMethod", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("protocol"=>protocol), args)); aws=aws)
...
"""
DeleteDisk(diskName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteDisk", Dict{String, Any}("diskName"=>diskName); aws=aws)
DeleteDisk(diskName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskName"=>diskName), args)); aws=aws)
...
"""
DeleteDiskSnapshot(diskSnapshotName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName); aws=aws)
DeleteDiskSnapshot(diskSnapshotName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteDiskSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskSnapshotName"=>diskSnapshotName), args)); aws=aws)
...
"""
DeleteDistribution(; aws::AWSConfig=AWSConfig()) = lightsail("DeleteDistribution"; aws=aws)
DeleteDistribution(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteDistribution", args; aws=aws)
...
"""
DeleteDomain(domainName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteDomain", Dict{String, Any}("domainName"=>domainName); aws=aws)
DeleteDomain(domainName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteDomain", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainName"=>domainName), args)); aws=aws)
...
"""
DeleteDomainEntry(domainEntry, domainName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName); aws=aws)
DeleteDomainEntry(domainEntry, domainName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteDomainEntry", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName), args)); aws=aws)
...
- `forceDeleteAddOns`: A Boolean value to indicate whether to delete the enabled add-ons for the disk.
"""
DeleteInstance(instanceName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteInstance", Dict{String, Any}("instanceName"=>instanceName); aws=aws)
DeleteInstance(instanceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws=aws)
...
"""
DeleteInstanceSnapshot(instanceSnapshotName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteInstanceSnapshot", Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName); aws=aws)
DeleteInstanceSnapshot(instanceSnapshotName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteInstanceSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName), args)); aws=aws)
...
"""
DeleteKeyPair(keyPairName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteKeyPair", Dict{String, Any}("keyPairName"=>keyPairName); aws=aws)
DeleteKeyPair(keyPairName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteKeyPair", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("keyPairName"=>keyPairName), args)); aws=aws)
...
"""
DeleteKnownHostKeys(instanceName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteKnownHostKeys", Dict{String, Any}("instanceName"=>instanceName); aws=aws)
DeleteKnownHostKeys(instanceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteKnownHostKeys", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws=aws)
...
"""
DeleteLoadBalancer(loadBalancerName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteLoadBalancer", Dict{String, Any}("loadBalancerName"=>loadBalancerName); aws=aws)
DeleteLoadBalancer(loadBalancerName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("loadBalancerName"=>loadBalancerName), args)); aws=aws)
...
"""
DeleteLoadBalancerTlsCertificate(certificateName, loadBalancerName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteLoadBalancerTlsCertificate", Dict{String, Any}("certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName); aws=aws)
DeleteLoadBalancerTlsCertificate(certificateName, loadBalancerName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteLoadBalancerTlsCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("certificateName"=>certificateName, "loadBalancerName"=>loadBalancerName), args)); aws=aws)
...
"""
DeleteRelationalDatabase(relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws=aws)
DeleteRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
...
"""
DeleteRelationalDatabaseSnapshot(relationalDatabaseSnapshotName; aws::AWSConfig=AWSConfig()) = lightsail("DeleteRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName); aws=aws)
DeleteRelationalDatabaseSnapshot(relationalDatabaseSnapshotName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DeleteRelationalDatabaseSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName), args)); aws=aws)
...
"""
DetachCertificateFromDistribution(distributionName; aws::AWSConfig=AWSConfig()) = lightsail("DetachCertificateFromDistribution", Dict{String, Any}("distributionName"=>distributionName); aws=aws)
DetachCertificateFromDistribution(distributionName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DetachCertificateFromDistribution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("distributionName"=>distributionName), args)); aws=aws)
...
"""
DetachDisk(diskName; aws::AWSConfig=AWSConfig()) = lightsail("DetachDisk", Dict{String, Any}("diskName"=>diskName); aws=aws)
DetachDisk(diskName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DetachDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskName"=>diskName), args)); aws=aws)
...
"""
DetachInstancesFromLoadBalancer(instanceNames, loadBalancerName; aws::AWSConfig=AWSConfig()) = lightsail("DetachInstancesFromLoadBalancer", Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName); aws=aws)
DetachInstancesFromLoadBalancer(instanceNames, loadBalancerName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DetachInstancesFromLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceNames"=>instanceNames, "loadBalancerName"=>loadBalancerName), args)); aws=aws)
...
"""
DetachStaticIp(staticIpName; aws::AWSConfig=AWSConfig()) = lightsail("DetachStaticIp", Dict{String, Any}("staticIpName"=>staticIpName); aws=aws)
DetachStaticIp(staticIpName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DetachStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("staticIpName"=>staticIpName), args)); aws=aws)
...
"""
DisableAddOn(addOnType, resourceName; aws::AWSConfig=AWSConfig()) = lightsail("DisableAddOn", Dict{String, Any}("addOnType"=>addOnType, "resourceName"=>resourceName); aws=aws)
DisableAddOn(addOnType, resourceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DisableAddOn", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("addOnType"=>addOnType, "resourceName"=>resourceName), args)); aws=aws)
...
"""
DownloadDefaultKeyPair(; aws::AWSConfig=AWSConfig()) = lightsail("DownloadDefaultKeyPair"; aws=aws)
DownloadDefaultKeyPair(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("DownloadDefaultKeyPair", args; aws=aws)
...
"""
EnableAddOn(addOnRequest, resourceName; aws::AWSConfig=AWSConfig()) = lightsail("EnableAddOn", Dict{String, Any}("addOnRequest"=>addOnRequest, "resourceName"=>resourceName); aws=aws)
EnableAddOn(addOnRequest, resourceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("EnableAddOn", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("addOnRequest"=>addOnRequest, "resourceName"=>resourceName), args)); aws=aws)
...
"""
ExportSnapshot(sourceSnapshotName; aws::AWSConfig=AWSConfig()) = lightsail("ExportSnapshot", Dict{String, Any}("sourceSnapshotName"=>sourceSnapshotName); aws=aws)
ExportSnapshot(sourceSnapshotName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("ExportSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("sourceSnapshotName"=>sourceSnapshotName), args)); aws=aws)
...
"""
GetActiveNames(; aws::AWSConfig=AWSConfig()) = lightsail("GetActiveNames"; aws=aws)
GetActiveNames(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetActiveNames", args; aws=aws)
...
"""
GetAlarms(; aws::AWSConfig=AWSConfig()) = lightsail("GetAlarms"; aws=aws)
GetAlarms(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetAlarms", args; aws=aws)
...
"""
GetAutoSnapshots(resourceName; aws::AWSConfig=AWSConfig()) = lightsail("GetAutoSnapshots", Dict{String, Any}("resourceName"=>resourceName); aws=aws)
GetAutoSnapshots(resourceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetAutoSnapshots", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName), args)); aws=aws)
...
"""
GetBlueprints(; aws::AWSConfig=AWSConfig()) = lightsail("GetBlueprints"; aws=aws)
GetBlueprints(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetBlueprints", args; aws=aws)
...
"""
GetBundles(; aws::AWSConfig=AWSConfig()) = lightsail("GetBundles"; aws=aws)
GetBundles(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetBundles", args; aws=aws)
...
"""
GetCertificates(; aws::AWSConfig=AWSConfig()) = lightsail("GetCertificates"; aws=aws)
GetCertificates(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetCertificates", args; aws=aws)
...
"""
GetCloudFormationStackRecords(; aws::AWSConfig=AWSConfig()) = lightsail("GetCloudFormationStackRecords"; aws=aws)
GetCloudFormationStackRecords(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetCloudFormationStackRecords", args; aws=aws)
...
"""
GetContactMethods(; aws::AWSConfig=AWSConfig()) = lightsail("GetContactMethods"; aws=aws)
GetContactMethods(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetContactMethods", args; aws=aws)
...
"""
GetDisk(diskName; aws::AWSConfig=AWSConfig()) = lightsail("GetDisk", Dict{String, Any}("diskName"=>diskName); aws=aws)
GetDisk(diskName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetDisk", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskName"=>diskName), args)); aws=aws)
...
"""
GetDiskSnapshot(diskSnapshotName; aws::AWSConfig=AWSConfig()) = lightsail("GetDiskSnapshot", Dict{String, Any}("diskSnapshotName"=>diskSnapshotName); aws=aws)
GetDiskSnapshot(diskSnapshotName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetDiskSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("diskSnapshotName"=>diskSnapshotName), args)); aws=aws)
...
"""
GetDiskSnapshots(; aws::AWSConfig=AWSConfig()) = lightsail("GetDiskSnapshots"; aws=aws)
GetDiskSnapshots(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetDiskSnapshots", args; aws=aws)
...
"""
GetDisks(; aws::AWSConfig=AWSConfig()) = lightsail("GetDisks"; aws=aws)
GetDisks(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetDisks", args; aws=aws)
...
"""
GetDistributionBundles(; aws::AWSConfig=AWSConfig()) = lightsail("GetDistributionBundles"; aws=aws)
GetDistributionBundles(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetDistributionBundles", args; aws=aws)
...
"""
GetDistributionLatestCacheReset(; aws::AWSConfig=AWSConfig()) = lightsail("GetDistributionLatestCacheReset"; aws=aws)
GetDistributionLatestCacheReset(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetDistributionLatestCacheReset", args; aws=aws)
...
"""
GetDistributions(; aws::AWSConfig=AWSConfig()) = lightsail("GetDistributions"; aws=aws)
GetDistributions(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetDistributions", args; aws=aws)
...
"""
GetDomain(domainName; aws::AWSConfig=AWSConfig()) = lightsail("GetDomain", Dict{String, Any}("domainName"=>domainName); aws=aws)
GetDomain(domainName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetDomain", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainName"=>domainName), args)); aws=aws)
...
"""
GetDomains(; aws::AWSConfig=AWSConfig()) = lightsail("GetDomains"; aws=aws)
GetDomains(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetDomains", args; aws=aws)
...
"""
GetExportSnapshotRecords(; aws::AWSConfig=AWSConfig()) = lightsail("GetExportSnapshotRecords"; aws=aws)
GetExportSnapshotRecords(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetExportSnapshotRecords", args; aws=aws)
...
"""
GetInstance(instanceName; aws::AWSConfig=AWSConfig()) = lightsail("GetInstance", Dict{String, Any}("instanceName"=>instanceName); aws=aws)
GetInstance(instanceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws=aws)
...
"""
GetInstanceAccessDetails(instanceName; aws::AWSConfig=AWSConfig()) = lightsail("GetInstanceAccessDetails", Dict{String, Any}("instanceName"=>instanceName); aws=aws)
GetInstanceAccessDetails(instanceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetInstanceAccessDetails", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws=aws)
...
"""
GetInstanceMetricData(endTime, instanceName, metricName, period, startTime, statistics, unit; aws::AWSConfig=AWSConfig()) = lightsail("GetInstanceMetricData", Dict{String, Any}("endTime"=>endTime, "instanceName"=>instanceName, "metricName"=>metricName, "period"=>period, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit); aws=aws)
GetInstanceMetricData(endTime, instanceName, metricName, period, startTime, statistics, unit, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetInstanceMetricData", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("endTime"=>endTime, "instanceName"=>instanceName, "metricName"=>metricName, "period"=>period, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit), args)); aws=aws)
...
"""
GetInstancePortStates(instanceName; aws::AWSConfig=AWSConfig()) = lightsail("GetInstancePortStates", Dict{String, Any}("instanceName"=>instanceName); aws=aws)
GetInstancePortStates(instanceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetInstancePortStates", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws=aws)
...
"""
GetInstanceSnapshot(instanceSnapshotName; aws::AWSConfig=AWSConfig()) = lightsail("GetInstanceSnapshot", Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName); aws=aws)
GetInstanceSnapshot(instanceSnapshotName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetInstanceSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceSnapshotName"=>instanceSnapshotName), args)); aws=aws)
...
"""
GetInstanceSnapshots(; aws::AWSConfig=AWSConfig()) = lightsail("GetInstanceSnapshots"; aws=aws)
GetInstanceSnapshots(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetInstanceSnapshots", args; aws=aws)
...
"""
GetInstanceState(instanceName; aws::AWSConfig=AWSConfig()) = lightsail("GetInstanceState", Dict{String, Any}("instanceName"=>instanceName); aws=aws)
GetInstanceState(instanceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetInstanceState", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws=aws)
...
"""
GetInstances(; aws::AWSConfig=AWSConfig()) = lightsail("GetInstances"; aws=aws)
GetInstances(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetInstances", args; aws=aws)
...
"""
GetKeyPair(keyPairName; aws::AWSConfig=AWSConfig()) = lightsail("GetKeyPair", Dict{String, Any}("keyPairName"=>keyPairName); aws=aws)
GetKeyPair(keyPairName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetKeyPair", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("keyPairName"=>keyPairName), args)); aws=aws)
...
"""
GetKeyPairs(; aws::AWSConfig=AWSConfig()) = lightsail("GetKeyPairs"; aws=aws)
GetKeyPairs(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetKeyPairs", args; aws=aws)
...
"""
GetLoadBalancer(loadBalancerName; aws::AWSConfig=AWSConfig()) = lightsail("GetLoadBalancer", Dict{String, Any}("loadBalancerName"=>loadBalancerName); aws=aws)
GetLoadBalancer(loadBalancerName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("loadBalancerName"=>loadBalancerName), args)); aws=aws)
...
"""
GetLoadBalancerMetricData(endTime, loadBalancerName, metricName, period, startTime, statistics, unit; aws::AWSConfig=AWSConfig()) = lightsail("GetLoadBalancerMetricData", Dict{String, Any}("endTime"=>endTime, "loadBalancerName"=>loadBalancerName, "metricName"=>metricName, "period"=>period, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit); aws=aws)
GetLoadBalancerMetricData(endTime, loadBalancerName, metricName, period, startTime, statistics, unit, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetLoadBalancerMetricData", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("endTime"=>endTime, "loadBalancerName"=>loadBalancerName, "metricName"=>metricName, "period"=>period, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit), args)); aws=aws)
...
"""
GetLoadBalancerTlsCertificates(loadBalancerName; aws::AWSConfig=AWSConfig()) = lightsail("GetLoadBalancerTlsCertificates", Dict{String, Any}("loadBalancerName"=>loadBalancerName); aws=aws)
GetLoadBalancerTlsCertificates(loadBalancerName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetLoadBalancerTlsCertificates", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("loadBalancerName"=>loadBalancerName), args)); aws=aws)
...
"""
GetLoadBalancers(; aws::AWSConfig=AWSConfig()) = lightsail("GetLoadBalancers"; aws=aws)
GetLoadBalancers(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetLoadBalancers", args; aws=aws)
...
"""
GetOperation(operationId; aws::AWSConfig=AWSConfig()) = lightsail("GetOperation", Dict{String, Any}("operationId"=>operationId); aws=aws)
GetOperation(operationId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetOperation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("operationId"=>operationId), args)); aws=aws)
...
"""
GetOperations(; aws::AWSConfig=AWSConfig()) = lightsail("GetOperations"; aws=aws)
GetOperations(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetOperations", args; aws=aws)
...
"""
GetOperationsForResource(resourceName; aws::AWSConfig=AWSConfig()) = lightsail("GetOperationsForResource", Dict{String, Any}("resourceName"=>resourceName); aws=aws)
GetOperationsForResource(resourceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetOperationsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName), args)); aws=aws)
...
"""
GetRegions(; aws::AWSConfig=AWSConfig()) = lightsail("GetRegions"; aws=aws)
GetRegions(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRegions", args; aws=aws)
...
"""
GetRelationalDatabase(relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws=aws)
GetRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
...
"""
GetRelationalDatabaseBlueprints(; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseBlueprints"; aws=aws)
GetRelationalDatabaseBlueprints(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseBlueprints", args; aws=aws)
...
"""
GetRelationalDatabaseBundles(; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseBundles"; aws=aws)
GetRelationalDatabaseBundles(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseBundles", args; aws=aws)
...
"""
GetRelationalDatabaseEvents(relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseEvents", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws=aws)
GetRelationalDatabaseEvents(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseEvents", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
...
"""
GetRelationalDatabaseLogEvents(logStreamName, relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseLogEvents", Dict{String, Any}("logStreamName"=>logStreamName, "relationalDatabaseName"=>relationalDatabaseName); aws=aws)
GetRelationalDatabaseLogEvents(logStreamName, relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseLogEvents", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("logStreamName"=>logStreamName, "relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
...
"""
GetRelationalDatabaseLogStreams(relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseLogStreams", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws=aws)
GetRelationalDatabaseLogStreams(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseLogStreams", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
...
"""
GetRelationalDatabaseMasterUserPassword(relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseMasterUserPassword", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws=aws)
GetRelationalDatabaseMasterUserPassword(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseMasterUserPassword", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
...
"""
GetRelationalDatabaseMetricData(endTime, metricName, period, relationalDatabaseName, startTime, statistics, unit; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseMetricData", Dict{String, Any}("endTime"=>endTime, "metricName"=>metricName, "period"=>period, "relationalDatabaseName"=>relationalDatabaseName, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit); aws=aws)
GetRelationalDatabaseMetricData(endTime, metricName, period, relationalDatabaseName, startTime, statistics, unit, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseMetricData", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("endTime"=>endTime, "metricName"=>metricName, "period"=>period, "relationalDatabaseName"=>relationalDatabaseName, "startTime"=>startTime, "statistics"=>statistics, "unit"=>unit), args)); aws=aws)
...
"""
GetRelationalDatabaseParameters(relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseParameters", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws=aws)
GetRelationalDatabaseParameters(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseParameters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
...
"""
GetRelationalDatabaseSnapshot(relationalDatabaseSnapshotName; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseSnapshot", Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName); aws=aws)
GetRelationalDatabaseSnapshot(relationalDatabaseSnapshotName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseSnapshotName"=>relationalDatabaseSnapshotName), args)); aws=aws)
...
"""
GetRelationalDatabaseSnapshots(; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseSnapshots"; aws=aws)
GetRelationalDatabaseSnapshots(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabaseSnapshots", args; aws=aws)
...
"""
GetRelationalDatabases(; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabases"; aws=aws)
GetRelationalDatabases(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetRelationalDatabases", args; aws=aws)
...
"""
GetStaticIp(staticIpName; aws::AWSConfig=AWSConfig()) = lightsail("GetStaticIp", Dict{String, Any}("staticIpName"=>staticIpName); aws=aws)
GetStaticIp(staticIpName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("staticIpName"=>staticIpName), args)); aws=aws)
...
"""
GetStaticIps(; aws::AWSConfig=AWSConfig()) = lightsail("GetStaticIps"; aws=aws)
GetStaticIps(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("GetStaticIps", args; aws=aws)
...
"""
ImportKeyPair(keyPairName, publicKeyBase64; aws::AWSConfig=AWSConfig()) = lightsail("ImportKeyPair", Dict{String, Any}("keyPairName"=>keyPairName, "publicKeyBase64"=>publicKeyBase64); aws=aws)
ImportKeyPair(keyPairName, publicKeyBase64, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("ImportKeyPair", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("keyPairName"=>keyPairName, "publicKeyBase64"=>publicKeyBase64), args)); aws=aws)
...
"""
IsVpcPeered(; aws::AWSConfig=AWSConfig()) = lightsail("IsVpcPeered"; aws=aws)
IsVpcPeered(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("IsVpcPeered", args; aws=aws)
...
"""
OpenInstancePublicPorts(instanceName, portInfo; aws::AWSConfig=AWSConfig()) = lightsail("OpenInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo); aws=aws)
OpenInstancePublicPorts(instanceName, portInfo, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("OpenInstancePublicPorts", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "portInfo"=>portInfo), args)); aws=aws)
...
"""
PeerVpc(; aws::AWSConfig=AWSConfig()) = lightsail("PeerVpc"; aws=aws)
PeerVpc(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("PeerVpc", args; aws=aws)
...
"""
PutAlarm(alarmName, comparisonOperator, evaluationPeriods, metricName, monitoredResourceName, threshold; aws::AWSConfig=AWSConfig()) = lightsail("PutAlarm", Dict{String, Any}("alarmName"=>alarmName, "comparisonOperator"=>comparisonOperator, "evaluationPeriods"=>evaluationPeriods, "metricName"=>metricName, "monitoredResourceName"=>monitoredResourceName, "threshold"=>threshold); aws=aws)
PutAlarm(alarmName, comparisonOperator, evaluationPeriods, metricName, monitoredResourceName, threshold, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("PutAlarm", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("alarmName"=>alarmName, "comparisonOperator"=>comparisonOperator, "evaluationPeriods"=>evaluationPeriods, "metricName"=>metricName, "monitoredResourceName"=>monitoredResourceName, "threshold"=>threshold), args)); aws=aws)
...
"""
PutInstancePublicPorts(instanceName, portInfos; aws::AWSConfig=AWSConfig()) = lightsail("PutInstancePublicPorts", Dict{String, Any}("instanceName"=>instanceName, "portInfos"=>portInfos); aws=aws)
PutInstancePublicPorts(instanceName, portInfos, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("PutInstancePublicPorts", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName, "portInfos"=>portInfos), args)); aws=aws)
...
"""
RebootInstance(instanceName; aws::AWSConfig=AWSConfig()) = lightsail("RebootInstance", Dict{String, Any}("instanceName"=>instanceName); aws=aws)
RebootInstance(instanceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("RebootInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws=aws)
...
"""
RebootRelationalDatabase(relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("RebootRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws=aws)
RebootRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("RebootRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
...
"""
ReleaseStaticIp(staticIpName; aws::AWSConfig=AWSConfig()) = lightsail("ReleaseStaticIp", Dict{String, Any}("staticIpName"=>staticIpName); aws=aws)
ReleaseStaticIp(staticIpName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("ReleaseStaticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("staticIpName"=>staticIpName), args)); aws=aws)
...
"""
ResetDistributionCache(; aws::AWSConfig=AWSConfig()) = lightsail("ResetDistributionCache"; aws=aws)
ResetDistributionCache(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("ResetDistributionCache", args; aws=aws)
...
"""
SendContactMethodVerification(protocol; aws::AWSConfig=AWSConfig()) = lightsail("SendContactMethodVerification", Dict{String, Any}("protocol"=>protocol); aws=aws)
SendContactMethodVerification(protocol, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("SendContactMethodVerification", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("protocol"=>protocol), args)); aws=aws)
...
"""
StartInstance(instanceName; aws::AWSConfig=AWSConfig()) = lightsail("StartInstance", Dict{String, Any}("instanceName"=>instanceName); aws=aws)
StartInstance(instanceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("StartInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws=aws)
...
"""
StartRelationalDatabase(relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("StartRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws=aws)
StartRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("StartRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
...
"""
StopInstance(instanceName; aws::AWSConfig=AWSConfig()) = lightsail("StopInstance", Dict{String, Any}("instanceName"=>instanceName); aws=aws)
StopInstance(instanceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("StopInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("instanceName"=>instanceName), args)); aws=aws)
...
"""
StopRelationalDatabase(relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("StopRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws=aws)
StopRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("StopRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
...
"""
TagResource(resourceName, tags; aws::AWSConfig=AWSConfig()) = lightsail("TagResource", Dict{String, Any}("resourceName"=>resourceName, "tags"=>tags); aws=aws)
TagResource(resourceName, tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName, "tags"=>tags), args)); aws=aws)
...
"""
TestAlarm(alarmName, state; aws::AWSConfig=AWSConfig()) = lightsail("TestAlarm", Dict{String, Any}("alarmName"=>alarmName, "state"=>state); aws=aws)
TestAlarm(alarmName, state, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("TestAlarm", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("alarmName"=>alarmName, "state"=>state), args)); aws=aws)
...
"""
UnpeerVpc(; aws::AWSConfig=AWSConfig()) = lightsail("UnpeerVpc"; aws=aws)
UnpeerVpc(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("UnpeerVpc", args; aws=aws)
...
"""
UntagResource(resourceName, tagKeys; aws::AWSConfig=AWSConfig()) = lightsail("UntagResource", Dict{String, Any}("resourceName"=>resourceName, "tagKeys"=>tagKeys); aws=aws)
UntagResource(resourceName, tagKeys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceName"=>resourceName, "tagKeys"=>tagKeys), args)); aws=aws)
...
- `origin`: An object that describes the origin resource for the distribution, such as a Lightsail instance or load balancer. The distribution pulls, caches, and serves content from the origin.
"""
UpdateDistribution(distributionName; aws::AWSConfig=AWSConfig()) = lightsail("UpdateDistribution", Dict{String, Any}("distributionName"=>distributionName); aws=aws)
UpdateDistribution(distributionName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("UpdateDistribution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("distributionName"=>distributionName), args)); aws=aws)
...
"""
UpdateDistributionBundle(; aws::AWSConfig=AWSConfig()) = lightsail("UpdateDistributionBundle"; aws=aws)
UpdateDistributionBundle(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("UpdateDistributionBundle", args; aws=aws)
...
"""
UpdateDomainEntry(domainEntry, domainName; aws::AWSConfig=AWSConfig()) = lightsail("UpdateDomainEntry", Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName); aws=aws)
UpdateDomainEntry(domainEntry, domainName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("UpdateDomainEntry", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("domainEntry"=>domainEntry, "domainName"=>domainName), args)); aws=aws)
...
"""
UpdateLoadBalancerAttribute(attributeName, attributeValue, loadBalancerName; aws::AWSConfig=AWSConfig()) = lightsail("UpdateLoadBalancerAttribute", Dict{String, Any}("attributeName"=>attributeName, "attributeValue"=>attributeValue, "loadBalancerName"=>loadBalancerName); aws=aws)
UpdateLoadBalancerAttribute(attributeName, attributeValue, loadBalancerName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("UpdateLoadBalancerAttribute", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("attributeName"=>attributeName, "attributeValue"=>attributeValue, "loadBalancerName"=>loadBalancerName), args)); aws=aws)
...
"""
UpdateRelationalDatabase(relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("UpdateRelationalDatabase", Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName); aws=aws)
UpdateRelationalDatabase(relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("UpdateRelationalDatabase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
...
"""
UpdateRelationalDatabaseParameters(parameters, relationalDatabaseName; aws::AWSConfig=AWSConfig()) = lightsail("UpdateRelationalDatabaseParameters", Dict{String, Any}("parameters"=>parameters, "relationalDatabaseName"=>relationalDatabaseName); aws=aws)
UpdateRelationalDatabaseParameters(parameters, relationalDatabaseName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = lightsail("UpdateRelationalDatabaseParameters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("parameters"=>parameters, "relationalDatabaseName"=>relationalDatabaseName), args)); aws=aws)
