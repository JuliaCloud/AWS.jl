...
"""
AddListenerCertificates(Certificates, ListenerArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("AddListenerCertificates", Dict{String, Any}("Certificates"=>Certificates, "ListenerArn"=>ListenerArn); aws=aws)
AddListenerCertificates(Certificates, ListenerArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("AddListenerCertificates", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Certificates"=>Certificates, "ListenerArn"=>ListenerArn), args)); aws=aws)
...
"""
AddTags(ResourceArns, Tags; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("AddTags", Dict{String, Any}("ResourceArns"=>ResourceArns, "Tags"=>Tags); aws=aws)
AddTags(ResourceArns, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("AddTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArns"=>ResourceArns, "Tags"=>Tags), args)); aws=aws)
...
"""
CreateListener(DefaultActions, LoadBalancerArn, Port, Protocol; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("CreateListener", Dict{String, Any}("DefaultActions"=>DefaultActions, "LoadBalancerArn"=>LoadBalancerArn, "Port"=>Port, "Protocol"=>Protocol); aws=aws)
CreateListener(DefaultActions, LoadBalancerArn, Port, Protocol, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("CreateListener", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DefaultActions"=>DefaultActions, "LoadBalancerArn"=>LoadBalancerArn, "Port"=>Port, "Protocol"=>Protocol), args)); aws=aws)
...
"""
CreateLoadBalancer(Name; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("CreateLoadBalancer", Dict{String, Any}("Name"=>Name); aws=aws)
CreateLoadBalancer(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("CreateLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
CreateRule(Actions, Conditions, ListenerArn, Priority; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("CreateRule", Dict{String, Any}("Actions"=>Actions, "Conditions"=>Conditions, "ListenerArn"=>ListenerArn, "Priority"=>Priority); aws=aws)
CreateRule(Actions, Conditions, ListenerArn, Priority, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("CreateRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Actions"=>Actions, "Conditions"=>Conditions, "ListenerArn"=>ListenerArn, "Priority"=>Priority), args)); aws=aws)
...
"""
CreateTargetGroup(Name; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("CreateTargetGroup", Dict{String, Any}("Name"=>Name); aws=aws)
CreateTargetGroup(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("CreateTargetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
DeleteListener(ListenerArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DeleteListener", Dict{String, Any}("ListenerArn"=>ListenerArn); aws=aws)
DeleteListener(ListenerArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DeleteListener", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ListenerArn"=>ListenerArn), args)); aws=aws)
...
"""
DeleteLoadBalancer(LoadBalancerArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DeleteLoadBalancer", Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn); aws=aws)
DeleteLoadBalancer(LoadBalancerArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DeleteLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn), args)); aws=aws)
...
"""
DeleteRule(RuleArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DeleteRule", Dict{String, Any}("RuleArn"=>RuleArn); aws=aws)
DeleteRule(RuleArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DeleteRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RuleArn"=>RuleArn), args)); aws=aws)
...
"""
DeleteTargetGroup(TargetGroupArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DeleteTargetGroup", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn); aws=aws)
DeleteTargetGroup(TargetGroupArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DeleteTargetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TargetGroupArn"=>TargetGroupArn), args)); aws=aws)
...
"""
DeregisterTargets(TargetGroupArn, Targets; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DeregisterTargets", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn, "Targets"=>Targets); aws=aws)
DeregisterTargets(TargetGroupArn, Targets, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DeregisterTargets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TargetGroupArn"=>TargetGroupArn, "Targets"=>Targets), args)); aws=aws)
...
"""
DescribeAccountLimits(; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeAccountLimits"; aws=aws)
DescribeAccountLimits(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeAccountLimits", args; aws=aws)
...
- `PageSize`: The maximum number of results to return with this call.
"""
DescribeListenerCertificates(ListenerArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeListenerCertificates", Dict{String, Any}("ListenerArn"=>ListenerArn); aws=aws)
DescribeListenerCertificates(ListenerArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeListenerCertificates", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ListenerArn"=>ListenerArn), args)); aws=aws)
...
- `PageSize`: The maximum number of results to return with this call.
"""
DescribeListeners(; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeListeners"; aws=aws)
DescribeListeners(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeListeners", args; aws=aws)
...
"""
DescribeLoadBalancerAttributes(LoadBalancerArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeLoadBalancerAttributes", Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn); aws=aws)
DescribeLoadBalancerAttributes(LoadBalancerArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeLoadBalancerAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn), args)); aws=aws)
...
- `PageSize`: The maximum number of results to return with this call.
"""
DescribeLoadBalancers(; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeLoadBalancers"; aws=aws)
DescribeLoadBalancers(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeLoadBalancers", args; aws=aws)
...
"""
DescribeRules(; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeRules"; aws=aws)
DescribeRules(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeRules", args; aws=aws)
...
- `PageSize`: The maximum number of results to return with this call.
"""
DescribeSSLPolicies(; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeSSLPolicies"; aws=aws)
DescribeSSLPolicies(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeSSLPolicies", args; aws=aws)
...
"""
DescribeTags(ResourceArns; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeTags", Dict{String, Any}("ResourceArns"=>ResourceArns); aws=aws)
DescribeTags(ResourceArns, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArns"=>ResourceArns), args)); aws=aws)
...
"""
DescribeTargetGroupAttributes(TargetGroupArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeTargetGroupAttributes", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn); aws=aws)
DescribeTargetGroupAttributes(TargetGroupArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeTargetGroupAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TargetGroupArn"=>TargetGroupArn), args)); aws=aws)
...
"""
DescribeTargetGroups(; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeTargetGroups"; aws=aws)
DescribeTargetGroups(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeTargetGroups", args; aws=aws)
...
- `Targets`: The targets.
"""
DescribeTargetHealth(TargetGroupArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeTargetHealth", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn); aws=aws)
DescribeTargetHealth(TargetGroupArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("DescribeTargetHealth", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TargetGroupArn"=>TargetGroupArn), args)); aws=aws)
...
- `SslPolicy`: [HTTPS and TLS listeners] The security policy that defines which protocols and ciphers are supported. The following are the possible values:    ELBSecurityPolicy-2016-08     ELBSecurityPolicy-TLS-1-0-2015-04     ELBSecurityPolicy-TLS-1-1-2017-01     ELBSecurityPolicy-TLS-1-2-2017-01     ELBSecurityPolicy-TLS-1-2-Ext-2018-06     ELBSecurityPolicy-FS-2018-06     ELBSecurityPolicy-FS-1-1-2019-08     ELBSecurityPolicy-FS-1-2-2019-08     ELBSecurityPolicy-FS-1-2-Res-2019-08    For more information, see Security Policies in the Application Load Balancers Guide and Security Policies in the Network Load Balancers Guide.
"""
ModifyListener(ListenerArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("ModifyListener", Dict{String, Any}("ListenerArn"=>ListenerArn); aws=aws)
ModifyListener(ListenerArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("ModifyListener", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ListenerArn"=>ListenerArn), args)); aws=aws)
...
"""
ModifyLoadBalancerAttributes(Attributes, LoadBalancerArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("ModifyLoadBalancerAttributes", Dict{String, Any}("Attributes"=>Attributes, "LoadBalancerArn"=>LoadBalancerArn); aws=aws)
ModifyLoadBalancerAttributes(Attributes, LoadBalancerArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("ModifyLoadBalancerAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Attributes"=>Attributes, "LoadBalancerArn"=>LoadBalancerArn), args)); aws=aws)
...
- `Conditions`: The conditions. Each rule can include zero or one of the following conditions: http-request-method, host-header, path-pattern, and source-ip, and zero or more of the following conditions: http-header and query-string.
"""
ModifyRule(RuleArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("ModifyRule", Dict{String, Any}("RuleArn"=>RuleArn); aws=aws)
ModifyRule(RuleArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("ModifyRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RuleArn"=>RuleArn), args)); aws=aws)
...
"""
ModifyTargetGroup(TargetGroupArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("ModifyTargetGroup", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn); aws=aws)
ModifyTargetGroup(TargetGroupArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("ModifyTargetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TargetGroupArn"=>TargetGroupArn), args)); aws=aws)
...
"""
ModifyTargetGroupAttributes(Attributes, TargetGroupArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("ModifyTargetGroupAttributes", Dict{String, Any}("Attributes"=>Attributes, "TargetGroupArn"=>TargetGroupArn); aws=aws)
ModifyTargetGroupAttributes(Attributes, TargetGroupArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("ModifyTargetGroupAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Attributes"=>Attributes, "TargetGroupArn"=>TargetGroupArn), args)); aws=aws)
...
"""
RegisterTargets(TargetGroupArn, Targets; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("RegisterTargets", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn, "Targets"=>Targets); aws=aws)
RegisterTargets(TargetGroupArn, Targets, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("RegisterTargets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TargetGroupArn"=>TargetGroupArn, "Targets"=>Targets), args)); aws=aws)
...
"""
RemoveListenerCertificates(Certificates, ListenerArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("RemoveListenerCertificates", Dict{String, Any}("Certificates"=>Certificates, "ListenerArn"=>ListenerArn); aws=aws)
RemoveListenerCertificates(Certificates, ListenerArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("RemoveListenerCertificates", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Certificates"=>Certificates, "ListenerArn"=>ListenerArn), args)); aws=aws)
...
"""
RemoveTags(ResourceArns, TagKeys; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("RemoveTags", Dict{String, Any}("ResourceArns"=>ResourceArns, "TagKeys"=>TagKeys); aws=aws)
RemoveTags(ResourceArns, TagKeys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("RemoveTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArns"=>ResourceArns, "TagKeys"=>TagKeys), args)); aws=aws)
...
"""
SetIpAddressType(IpAddressType, LoadBalancerArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("SetIpAddressType", Dict{String, Any}("IpAddressType"=>IpAddressType, "LoadBalancerArn"=>LoadBalancerArn); aws=aws)
SetIpAddressType(IpAddressType, LoadBalancerArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("SetIpAddressType", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IpAddressType"=>IpAddressType, "LoadBalancerArn"=>LoadBalancerArn), args)); aws=aws)
...
"""
SetRulePriorities(RulePriorities; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("SetRulePriorities", Dict{String, Any}("RulePriorities"=>RulePriorities); aws=aws)
SetRulePriorities(RulePriorities, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("SetRulePriorities", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RulePriorities"=>RulePriorities), args)); aws=aws)
...
"""
SetSecurityGroups(LoadBalancerArn, SecurityGroups; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("SetSecurityGroups", Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn, "SecurityGroups"=>SecurityGroups); aws=aws)
SetSecurityGroups(LoadBalancerArn, SecurityGroups, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("SetSecurityGroups", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn, "SecurityGroups"=>SecurityGroups), args)); aws=aws)
...
"""
SetSubnets(LoadBalancerArn; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("SetSubnets", Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn); aws=aws)
SetSubnets(LoadBalancerArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_load_balancing_v2("SetSubnets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn), args)); aws=aws)
