...
"""
AddListenerCertificates(Certificates, ListenerArn) = elastic_load_balancing_v2("AddListenerCertificates", Dict{String, Any}("Certificates"=>Certificates, "ListenerArn"=>ListenerArn))
AddListenerCertificates(Certificates, ListenerArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("AddListenerCertificates", Dict{String, Any}("Certificates"=>Certificates, "ListenerArn"=>ListenerArn, args...))
...
"""
AddTags(ResourceArns, Tags) = elastic_load_balancing_v2("AddTags", Dict{String, Any}("ResourceArns"=>ResourceArns, "Tags"=>Tags))
AddTags(ResourceArns, Tags, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("AddTags", Dict{String, Any}("ResourceArns"=>ResourceArns, "Tags"=>Tags, args...))
...
"""
CreateListener(DefaultActions, LoadBalancerArn, Port, Protocol) = elastic_load_balancing_v2("CreateListener", Dict{String, Any}("DefaultActions"=>DefaultActions, "LoadBalancerArn"=>LoadBalancerArn, "Port"=>Port, "Protocol"=>Protocol))
CreateListener(DefaultActions, LoadBalancerArn, Port, Protocol, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("CreateListener", Dict{String, Any}("DefaultActions"=>DefaultActions, "LoadBalancerArn"=>LoadBalancerArn, "Port"=>Port, "Protocol"=>Protocol, args...))
...
"""
CreateLoadBalancer(Name) = elastic_load_balancing_v2("CreateLoadBalancer", Dict{String, Any}("Name"=>Name))
CreateLoadBalancer(Name, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("CreateLoadBalancer", Dict{String, Any}("Name"=>Name, args...))
...
"""
CreateRule(Actions, Conditions, ListenerArn, Priority) = elastic_load_balancing_v2("CreateRule", Dict{String, Any}("Actions"=>Actions, "Conditions"=>Conditions, "ListenerArn"=>ListenerArn, "Priority"=>Priority))
CreateRule(Actions, Conditions, ListenerArn, Priority, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("CreateRule", Dict{String, Any}("Actions"=>Actions, "Conditions"=>Conditions, "ListenerArn"=>ListenerArn, "Priority"=>Priority, args...))
...
"""
CreateTargetGroup(Name) = elastic_load_balancing_v2("CreateTargetGroup", Dict{String, Any}("Name"=>Name))
CreateTargetGroup(Name, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("CreateTargetGroup", Dict{String, Any}("Name"=>Name, args...))
...
"""
DeleteListener(ListenerArn) = elastic_load_balancing_v2("DeleteListener", Dict{String, Any}("ListenerArn"=>ListenerArn))
DeleteListener(ListenerArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DeleteListener", Dict{String, Any}("ListenerArn"=>ListenerArn, args...))
...
"""
DeleteLoadBalancer(LoadBalancerArn) = elastic_load_balancing_v2("DeleteLoadBalancer", Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn))
DeleteLoadBalancer(LoadBalancerArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DeleteLoadBalancer", Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn, args...))
...
"""
DeleteRule(RuleArn) = elastic_load_balancing_v2("DeleteRule", Dict{String, Any}("RuleArn"=>RuleArn))
DeleteRule(RuleArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DeleteRule", Dict{String, Any}("RuleArn"=>RuleArn, args...))
...
"""
DeleteTargetGroup(TargetGroupArn) = elastic_load_balancing_v2("DeleteTargetGroup", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn))
DeleteTargetGroup(TargetGroupArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DeleteTargetGroup", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn, args...))
...
"""
DeregisterTargets(TargetGroupArn, Targets) = elastic_load_balancing_v2("DeregisterTargets", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn, "Targets"=>Targets))
DeregisterTargets(TargetGroupArn, Targets, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DeregisterTargets", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn, "Targets"=>Targets, args...))
...
DescribeAccountLimits(args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DescribeAccountLimits", args)
...
- `PageSize`: The maximum number of results to return with this call.
"""
DescribeListenerCertificates(ListenerArn) = elastic_load_balancing_v2("DescribeListenerCertificates", Dict{String, Any}("ListenerArn"=>ListenerArn))
DescribeListenerCertificates(ListenerArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DescribeListenerCertificates", Dict{String, Any}("ListenerArn"=>ListenerArn, args...))
...
DescribeListeners(args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DescribeListeners", args)
...
"""
DescribeLoadBalancerAttributes(LoadBalancerArn) = elastic_load_balancing_v2("DescribeLoadBalancerAttributes", Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn))
DescribeLoadBalancerAttributes(LoadBalancerArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DescribeLoadBalancerAttributes", Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn, args...))
...
DescribeLoadBalancers(args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DescribeLoadBalancers", args)
...
DescribeRules(args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DescribeRules", args)
...
DescribeSSLPolicies(args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DescribeSSLPolicies", args)
...
"""
DescribeTags(ResourceArns) = elastic_load_balancing_v2("DescribeTags", Dict{String, Any}("ResourceArns"=>ResourceArns))
DescribeTags(ResourceArns, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DescribeTags", Dict{String, Any}("ResourceArns"=>ResourceArns, args...))
...
"""
DescribeTargetGroupAttributes(TargetGroupArn) = elastic_load_balancing_v2("DescribeTargetGroupAttributes", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn))
DescribeTargetGroupAttributes(TargetGroupArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DescribeTargetGroupAttributes", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn, args...))
...
DescribeTargetGroups(args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DescribeTargetGroups", args)
...
- `Targets`: The targets.
"""
DescribeTargetHealth(TargetGroupArn) = elastic_load_balancing_v2("DescribeTargetHealth", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn))
DescribeTargetHealth(TargetGroupArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("DescribeTargetHealth", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn, args...))
...
- `SslPolicy`: [HTTPS and TLS listeners] The security policy that defines which protocols and ciphers are supported. The following are the possible values:    ELBSecurityPolicy-2016-08     ELBSecurityPolicy-TLS-1-0-2015-04     ELBSecurityPolicy-TLS-1-1-2017-01     ELBSecurityPolicy-TLS-1-2-2017-01     ELBSecurityPolicy-TLS-1-2-Ext-2018-06     ELBSecurityPolicy-FS-2018-06     ELBSecurityPolicy-FS-1-1-2019-08     ELBSecurityPolicy-FS-1-2-2019-08     ELBSecurityPolicy-FS-1-2-Res-2019-08    For more information, see Security Policies in the Application Load Balancers Guide and Security Policies in the Network Load Balancers Guide.
"""
ModifyListener(ListenerArn) = elastic_load_balancing_v2("ModifyListener", Dict{String, Any}("ListenerArn"=>ListenerArn))
ModifyListener(ListenerArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("ModifyListener", Dict{String, Any}("ListenerArn"=>ListenerArn, args...))
...
"""
ModifyLoadBalancerAttributes(Attributes, LoadBalancerArn) = elastic_load_balancing_v2("ModifyLoadBalancerAttributes", Dict{String, Any}("Attributes"=>Attributes, "LoadBalancerArn"=>LoadBalancerArn))
ModifyLoadBalancerAttributes(Attributes, LoadBalancerArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("ModifyLoadBalancerAttributes", Dict{String, Any}("Attributes"=>Attributes, "LoadBalancerArn"=>LoadBalancerArn, args...))
...
- `Conditions`: The conditions. Each rule can include zero or one of the following conditions: http-request-method, host-header, path-pattern, and source-ip, and zero or more of the following conditions: http-header and query-string.
"""
ModifyRule(RuleArn) = elastic_load_balancing_v2("ModifyRule", Dict{String, Any}("RuleArn"=>RuleArn))
ModifyRule(RuleArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("ModifyRule", Dict{String, Any}("RuleArn"=>RuleArn, args...))
...
"""
ModifyTargetGroup(TargetGroupArn) = elastic_load_balancing_v2("ModifyTargetGroup", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn))
ModifyTargetGroup(TargetGroupArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("ModifyTargetGroup", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn, args...))
...
"""
ModifyTargetGroupAttributes(Attributes, TargetGroupArn) = elastic_load_balancing_v2("ModifyTargetGroupAttributes", Dict{String, Any}("Attributes"=>Attributes, "TargetGroupArn"=>TargetGroupArn))
ModifyTargetGroupAttributes(Attributes, TargetGroupArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("ModifyTargetGroupAttributes", Dict{String, Any}("Attributes"=>Attributes, "TargetGroupArn"=>TargetGroupArn, args...))
...
"""
RegisterTargets(TargetGroupArn, Targets) = elastic_load_balancing_v2("RegisterTargets", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn, "Targets"=>Targets))
RegisterTargets(TargetGroupArn, Targets, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("RegisterTargets", Dict{String, Any}("TargetGroupArn"=>TargetGroupArn, "Targets"=>Targets, args...))
...
"""
RemoveListenerCertificates(Certificates, ListenerArn) = elastic_load_balancing_v2("RemoveListenerCertificates", Dict{String, Any}("Certificates"=>Certificates, "ListenerArn"=>ListenerArn))
RemoveListenerCertificates(Certificates, ListenerArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("RemoveListenerCertificates", Dict{String, Any}("Certificates"=>Certificates, "ListenerArn"=>ListenerArn, args...))
...
"""
RemoveTags(ResourceArns, TagKeys) = elastic_load_balancing_v2("RemoveTags", Dict{String, Any}("ResourceArns"=>ResourceArns, "TagKeys"=>TagKeys))
RemoveTags(ResourceArns, TagKeys, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("RemoveTags", Dict{String, Any}("ResourceArns"=>ResourceArns, "TagKeys"=>TagKeys, args...))
...
"""
SetIpAddressType(IpAddressType, LoadBalancerArn) = elastic_load_balancing_v2("SetIpAddressType", Dict{String, Any}("IpAddressType"=>IpAddressType, "LoadBalancerArn"=>LoadBalancerArn))
SetIpAddressType(IpAddressType, LoadBalancerArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("SetIpAddressType", Dict{String, Any}("IpAddressType"=>IpAddressType, "LoadBalancerArn"=>LoadBalancerArn, args...))
...
"""
SetRulePriorities(RulePriorities) = elastic_load_balancing_v2("SetRulePriorities", Dict{String, Any}("RulePriorities"=>RulePriorities))
SetRulePriorities(RulePriorities, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("SetRulePriorities", Dict{String, Any}("RulePriorities"=>RulePriorities, args...))
...
"""
SetSecurityGroups(LoadBalancerArn, SecurityGroups) = elastic_load_balancing_v2("SetSecurityGroups", Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn, "SecurityGroups"=>SecurityGroups))
SetSecurityGroups(LoadBalancerArn, SecurityGroups, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("SetSecurityGroups", Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn, "SecurityGroups"=>SecurityGroups, args...))
...
"""
SetSubnets(LoadBalancerArn) = elastic_load_balancing_v2("SetSubnets", Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn))
SetSubnets(LoadBalancerArn, args::AbstractDict{String, <:Any}) = elastic_load_balancing_v2("SetSubnets", Dict{String, Any}("LoadBalancerArn"=>LoadBalancerArn, args...))
