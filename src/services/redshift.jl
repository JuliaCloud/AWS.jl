...
"""
AcceptReservedNodeExchange(ReservedNodeId, TargetReservedNodeOfferingId) = redshift("AcceptReservedNodeExchange", Dict{String, Any}("ReservedNodeId"=>ReservedNodeId, "TargetReservedNodeOfferingId"=>TargetReservedNodeOfferingId))
AcceptReservedNodeExchange(ReservedNodeId, TargetReservedNodeOfferingId, args::AbstractDict{String, <:Any}) = redshift("AcceptReservedNodeExchange", Dict{String, Any}("ReservedNodeId"=>ReservedNodeId, "TargetReservedNodeOfferingId"=>TargetReservedNodeOfferingId, args...))
...
"""
AuthorizeClusterSecurityGroupIngress(ClusterSecurityGroupName) = redshift("AuthorizeClusterSecurityGroupIngress", Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName))
AuthorizeClusterSecurityGroupIngress(ClusterSecurityGroupName, args::AbstractDict{String, <:Any}) = redshift("AuthorizeClusterSecurityGroupIngress", Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName, args...))
...
"""
AuthorizeSnapshotAccess(AccountWithRestoreAccess, SnapshotIdentifier) = redshift("AuthorizeSnapshotAccess", Dict{String, Any}("AccountWithRestoreAccess"=>AccountWithRestoreAccess, "SnapshotIdentifier"=>SnapshotIdentifier))
AuthorizeSnapshotAccess(AccountWithRestoreAccess, SnapshotIdentifier, args::AbstractDict{String, <:Any}) = redshift("AuthorizeSnapshotAccess", Dict{String, Any}("AccountWithRestoreAccess"=>AccountWithRestoreAccess, "SnapshotIdentifier"=>SnapshotIdentifier, args...))
...
"""
BatchDeleteClusterSnapshots(DeleteClusterSnapshotMessage) = redshift("BatchDeleteClusterSnapshots", Dict{String, Any}("DeleteClusterSnapshotMessage"=>DeleteClusterSnapshotMessage))
BatchDeleteClusterSnapshots(DeleteClusterSnapshotMessage, args::AbstractDict{String, <:Any}) = redshift("BatchDeleteClusterSnapshots", Dict{String, Any}("DeleteClusterSnapshotMessage"=>DeleteClusterSnapshotMessage, args...))
...
"""
BatchModifyClusterSnapshots(String) = redshift("BatchModifyClusterSnapshots", Dict{String, Any}("String"=>String))
BatchModifyClusterSnapshots(String, args::AbstractDict{String, <:Any}) = redshift("BatchModifyClusterSnapshots", Dict{String, Any}("String"=>String, args...))
...
"""
CancelResize(ClusterIdentifier) = redshift("CancelResize", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
CancelResize(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("CancelResize", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
CopyClusterSnapshot(SourceSnapshotIdentifier, TargetSnapshotIdentifier) = redshift("CopyClusterSnapshot", Dict{String, Any}("SourceSnapshotIdentifier"=>SourceSnapshotIdentifier, "TargetSnapshotIdentifier"=>TargetSnapshotIdentifier))
CopyClusterSnapshot(SourceSnapshotIdentifier, TargetSnapshotIdentifier, args::AbstractDict{String, <:Any}) = redshift("CopyClusterSnapshot", Dict{String, Any}("SourceSnapshotIdentifier"=>SourceSnapshotIdentifier, "TargetSnapshotIdentifier"=>TargetSnapshotIdentifier, args...))
...
"""
CreateCluster(ClusterIdentifier, MasterUserPassword, MasterUsername, NodeType) = redshift("CreateCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "MasterUserPassword"=>MasterUserPassword, "MasterUsername"=>MasterUsername, "NodeType"=>NodeType))
CreateCluster(ClusterIdentifier, MasterUserPassword, MasterUsername, NodeType, args::AbstractDict{String, <:Any}) = redshift("CreateCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "MasterUserPassword"=>MasterUserPassword, "MasterUsername"=>MasterUsername, "NodeType"=>NodeType, args...))
...
- `Tags`: A list of tag instances.
"""
CreateClusterParameterGroup(Description, ParameterGroupFamily, ParameterGroupName) = redshift("CreateClusterParameterGroup", Dict{String, Any}("Description"=>Description, "ParameterGroupFamily"=>ParameterGroupFamily, "ParameterGroupName"=>ParameterGroupName))
CreateClusterParameterGroup(Description, ParameterGroupFamily, ParameterGroupName, args::AbstractDict{String, <:Any}) = redshift("CreateClusterParameterGroup", Dict{String, Any}("Description"=>Description, "ParameterGroupFamily"=>ParameterGroupFamily, "ParameterGroupName"=>ParameterGroupName, args...))
...
- `Tags`: A list of tag instances.
"""
CreateClusterSecurityGroup(ClusterSecurityGroupName, Description) = redshift("CreateClusterSecurityGroup", Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName, "Description"=>Description))
CreateClusterSecurityGroup(ClusterSecurityGroupName, Description, args::AbstractDict{String, <:Any}) = redshift("CreateClusterSecurityGroup", Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName, "Description"=>Description, args...))
...
- `Tags`: A list of tag instances.
"""
CreateClusterSnapshot(ClusterIdentifier, SnapshotIdentifier) = redshift("CreateClusterSnapshot", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "SnapshotIdentifier"=>SnapshotIdentifier))
CreateClusterSnapshot(ClusterIdentifier, SnapshotIdentifier, args::AbstractDict{String, <:Any}) = redshift("CreateClusterSnapshot", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "SnapshotIdentifier"=>SnapshotIdentifier, args...))
...
- `Tags`: A list of tag instances.
"""
CreateClusterSubnetGroup(ClusterSubnetGroupName, Description, SubnetIdentifier) = redshift("CreateClusterSubnetGroup", Dict{String, Any}("ClusterSubnetGroupName"=>ClusterSubnetGroupName, "Description"=>Description, "SubnetIdentifier"=>SubnetIdentifier))
CreateClusterSubnetGroup(ClusterSubnetGroupName, Description, SubnetIdentifier, args::AbstractDict{String, <:Any}) = redshift("CreateClusterSubnetGroup", Dict{String, Any}("ClusterSubnetGroupName"=>ClusterSubnetGroupName, "Description"=>Description, "SubnetIdentifier"=>SubnetIdentifier, args...))
...
- `Tags`: A list of tag instances.
"""
CreateEventSubscription(SnsTopicArn, SubscriptionName) = redshift("CreateEventSubscription", Dict{String, Any}("SnsTopicArn"=>SnsTopicArn, "SubscriptionName"=>SubscriptionName))
CreateEventSubscription(SnsTopicArn, SubscriptionName, args::AbstractDict{String, <:Any}) = redshift("CreateEventSubscription", Dict{String, Any}("SnsTopicArn"=>SnsTopicArn, "SubscriptionName"=>SubscriptionName, args...))
...
- `Tags`: A list of tag instances.
"""
CreateHsmClientCertificate(HsmClientCertificateIdentifier) = redshift("CreateHsmClientCertificate", Dict{String, Any}("HsmClientCertificateIdentifier"=>HsmClientCertificateIdentifier))
CreateHsmClientCertificate(HsmClientCertificateIdentifier, args::AbstractDict{String, <:Any}) = redshift("CreateHsmClientCertificate", Dict{String, Any}("HsmClientCertificateIdentifier"=>HsmClientCertificateIdentifier, args...))
...
CreateHsmConfiguration(Description, HsmConfigurationIdentifier, HsmIpAddress, HsmPartitionName, HsmPartitionPassword, HsmServerPublicCertificate, args::AbstractDict{String, <:Any}) = redshift("CreateHsmConfiguration", Dict{String, Any}("Description"=>Description, "HsmConfigurationIdentifier"=>HsmConfigurationIdentifier, "HsmIpAddress"=>HsmIpAddress, "HsmPartitionName"=>HsmPartitionName, "HsmPartitionPassword"=>HsmPartitionPassword, "HsmServerPublicCertificate"=>HsmServerPublicCertificate, args...))
...
"""
CreateScheduledAction(IamRole, Schedule, ScheduledActionName, TargetAction) = redshift("CreateScheduledAction", Dict{String, Any}("IamRole"=>IamRole, "Schedule"=>Schedule, "ScheduledActionName"=>ScheduledActionName, "TargetAction"=>TargetAction))
CreateScheduledAction(IamRole, Schedule, ScheduledActionName, TargetAction, args::AbstractDict{String, <:Any}) = redshift("CreateScheduledAction", Dict{String, Any}("IamRole"=>IamRole, "Schedule"=>Schedule, "ScheduledActionName"=>ScheduledActionName, "TargetAction"=>TargetAction, args...))
...
- `Tags`: A list of tag instances.
"""
CreateSnapshotCopyGrant(SnapshotCopyGrantName) = redshift("CreateSnapshotCopyGrant", Dict{String, Any}("SnapshotCopyGrantName"=>SnapshotCopyGrantName))
CreateSnapshotCopyGrant(SnapshotCopyGrantName, args::AbstractDict{String, <:Any}) = redshift("CreateSnapshotCopyGrant", Dict{String, Any}("SnapshotCopyGrantName"=>SnapshotCopyGrantName, args...))
...
CreateSnapshotSchedule(args::AbstractDict{String, <:Any}) = redshift("CreateSnapshotSchedule", args)
...
"""
CreateTags(ResourceName, Tag) = redshift("CreateTags", Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag))
CreateTags(ResourceName, Tag, args::AbstractDict{String, <:Any}) = redshift("CreateTags", Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag, args...))
...
- `Tags`: A list of tag instances.
"""
CreateUsageLimit(Amount, ClusterIdentifier, FeatureType, LimitType) = redshift("CreateUsageLimit", Dict{String, Any}("Amount"=>Amount, "ClusterIdentifier"=>ClusterIdentifier, "FeatureType"=>FeatureType, "LimitType"=>LimitType))
CreateUsageLimit(Amount, ClusterIdentifier, FeatureType, LimitType, args::AbstractDict{String, <:Any}) = redshift("CreateUsageLimit", Dict{String, Any}("Amount"=>Amount, "ClusterIdentifier"=>ClusterIdentifier, "FeatureType"=>FeatureType, "LimitType"=>LimitType, args...))
...
"""
DeleteCluster(ClusterIdentifier) = redshift("DeleteCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
DeleteCluster(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("DeleteCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
DeleteClusterParameterGroup(ParameterGroupName) = redshift("DeleteClusterParameterGroup", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName))
DeleteClusterParameterGroup(ParameterGroupName, args::AbstractDict{String, <:Any}) = redshift("DeleteClusterParameterGroup", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName, args...))
...
"""
DeleteClusterSecurityGroup(ClusterSecurityGroupName) = redshift("DeleteClusterSecurityGroup", Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName))
DeleteClusterSecurityGroup(ClusterSecurityGroupName, args::AbstractDict{String, <:Any}) = redshift("DeleteClusterSecurityGroup", Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName, args...))
...
"""
DeleteClusterSnapshot(SnapshotIdentifier) = redshift("DeleteClusterSnapshot", Dict{String, Any}("SnapshotIdentifier"=>SnapshotIdentifier))
DeleteClusterSnapshot(SnapshotIdentifier, args::AbstractDict{String, <:Any}) = redshift("DeleteClusterSnapshot", Dict{String, Any}("SnapshotIdentifier"=>SnapshotIdentifier, args...))
...
"""
DeleteClusterSubnetGroup(ClusterSubnetGroupName) = redshift("DeleteClusterSubnetGroup", Dict{String, Any}("ClusterSubnetGroupName"=>ClusterSubnetGroupName))
DeleteClusterSubnetGroup(ClusterSubnetGroupName, args::AbstractDict{String, <:Any}) = redshift("DeleteClusterSubnetGroup", Dict{String, Any}("ClusterSubnetGroupName"=>ClusterSubnetGroupName, args...))
...
"""
DeleteEventSubscription(SubscriptionName) = redshift("DeleteEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName))
DeleteEventSubscription(SubscriptionName, args::AbstractDict{String, <:Any}) = redshift("DeleteEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName, args...))
...
"""
DeleteHsmClientCertificate(HsmClientCertificateIdentifier) = redshift("DeleteHsmClientCertificate", Dict{String, Any}("HsmClientCertificateIdentifier"=>HsmClientCertificateIdentifier))
DeleteHsmClientCertificate(HsmClientCertificateIdentifier, args::AbstractDict{String, <:Any}) = redshift("DeleteHsmClientCertificate", Dict{String, Any}("HsmClientCertificateIdentifier"=>HsmClientCertificateIdentifier, args...))
...
"""
DeleteHsmConfiguration(HsmConfigurationIdentifier) = redshift("DeleteHsmConfiguration", Dict{String, Any}("HsmConfigurationIdentifier"=>HsmConfigurationIdentifier))
DeleteHsmConfiguration(HsmConfigurationIdentifier, args::AbstractDict{String, <:Any}) = redshift("DeleteHsmConfiguration", Dict{String, Any}("HsmConfigurationIdentifier"=>HsmConfigurationIdentifier, args...))
...
"""
DeleteScheduledAction(ScheduledActionName) = redshift("DeleteScheduledAction", Dict{String, Any}("ScheduledActionName"=>ScheduledActionName))
DeleteScheduledAction(ScheduledActionName, args::AbstractDict{String, <:Any}) = redshift("DeleteScheduledAction", Dict{String, Any}("ScheduledActionName"=>ScheduledActionName, args...))
...
"""
DeleteSnapshotCopyGrant(SnapshotCopyGrantName) = redshift("DeleteSnapshotCopyGrant", Dict{String, Any}("SnapshotCopyGrantName"=>SnapshotCopyGrantName))
DeleteSnapshotCopyGrant(SnapshotCopyGrantName, args::AbstractDict{String, <:Any}) = redshift("DeleteSnapshotCopyGrant", Dict{String, Any}("SnapshotCopyGrantName"=>SnapshotCopyGrantName, args...))
...
"""
DeleteSnapshotSchedule(ScheduleIdentifier) = redshift("DeleteSnapshotSchedule", Dict{String, Any}("ScheduleIdentifier"=>ScheduleIdentifier))
DeleteSnapshotSchedule(ScheduleIdentifier, args::AbstractDict{String, <:Any}) = redshift("DeleteSnapshotSchedule", Dict{String, Any}("ScheduleIdentifier"=>ScheduleIdentifier, args...))
...
"""
DeleteTags(ResourceName, TagKey) = redshift("DeleteTags", Dict{String, Any}("ResourceName"=>ResourceName, "TagKey"=>TagKey))
DeleteTags(ResourceName, TagKey, args::AbstractDict{String, <:Any}) = redshift("DeleteTags", Dict{String, Any}("ResourceName"=>ResourceName, "TagKey"=>TagKey, args...))
...
"""
DeleteUsageLimit(UsageLimitId) = redshift("DeleteUsageLimit", Dict{String, Any}("UsageLimitId"=>UsageLimitId))
DeleteUsageLimit(UsageLimitId, args::AbstractDict{String, <:Any}) = redshift("DeleteUsageLimit", Dict{String, Any}("UsageLimitId"=>UsageLimitId, args...))
...
DescribeAccountAttributes(args::AbstractDict{String, <:Any}) = redshift("DescribeAccountAttributes", args)
...
DescribeClusterDbRevisions(args::AbstractDict{String, <:Any}) = redshift("DescribeClusterDbRevisions", args)
...
DescribeClusterParameterGroups(args::AbstractDict{String, <:Any}) = redshift("DescribeClusterParameterGroups", args)
...
"""
DescribeClusterParameters(ParameterGroupName) = redshift("DescribeClusterParameters", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName))
DescribeClusterParameters(ParameterGroupName, args::AbstractDict{String, <:Any}) = redshift("DescribeClusterParameters", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName, args...))
...
DescribeClusterSecurityGroups(args::AbstractDict{String, <:Any}) = redshift("DescribeClusterSecurityGroups", args)
...
DescribeClusterSnapshots(args::AbstractDict{String, <:Any}) = redshift("DescribeClusterSnapshots", args)
...
DescribeClusterSubnetGroups(args::AbstractDict{String, <:Any}) = redshift("DescribeClusterSubnetGroups", args)
...
DescribeClusterTracks(args::AbstractDict{String, <:Any}) = redshift("DescribeClusterTracks", args)
...
DescribeClusterVersions(args::AbstractDict{String, <:Any}) = redshift("DescribeClusterVersions", args)
...
DescribeClusters(args::AbstractDict{String, <:Any}) = redshift("DescribeClusters", args)
...
- `MaxRecords`: The maximum number of response records to return in each call. If the number of remaining response records exceeds the specified MaxRecords value, a value is returned in a marker field of the response. You can retrieve the next set of records by retrying the command with the returned marker value.  Default: 100  Constraints: minimum 20, maximum 100.
"""
DescribeDefaultClusterParameters(ParameterGroupFamily) = redshift("DescribeDefaultClusterParameters", Dict{String, Any}("ParameterGroupFamily"=>ParameterGroupFamily))
DescribeDefaultClusterParameters(ParameterGroupFamily, args::AbstractDict{String, <:Any}) = redshift("DescribeDefaultClusterParameters", Dict{String, Any}("ParameterGroupFamily"=>ParameterGroupFamily, args...))
...
DescribeEventCategories(args::AbstractDict{String, <:Any}) = redshift("DescribeEventCategories", args)
...
DescribeEventSubscriptions(args::AbstractDict{String, <:Any}) = redshift("DescribeEventSubscriptions", args)
...
DescribeEvents(args::AbstractDict{String, <:Any}) = redshift("DescribeEvents", args)
...
DescribeHsmClientCertificates(args::AbstractDict{String, <:Any}) = redshift("DescribeHsmClientCertificates", args)
...
DescribeHsmConfigurations(args::AbstractDict{String, <:Any}) = redshift("DescribeHsmConfigurations", args)
...
"""
DescribeLoggingStatus(ClusterIdentifier) = redshift("DescribeLoggingStatus", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
DescribeLoggingStatus(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("DescribeLoggingStatus", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
DescribeNodeConfigurationOptions(ActionType) = redshift("DescribeNodeConfigurationOptions", Dict{String, Any}("ActionType"=>ActionType))
DescribeNodeConfigurationOptions(ActionType, args::AbstractDict{String, <:Any}) = redshift("DescribeNodeConfigurationOptions", Dict{String, Any}("ActionType"=>ActionType, args...))
...
DescribeOrderableClusterOptions(args::AbstractDict{String, <:Any}) = redshift("DescribeOrderableClusterOptions", args)
...
DescribeReservedNodeOfferings(args::AbstractDict{String, <:Any}) = redshift("DescribeReservedNodeOfferings", args)
...
DescribeReservedNodes(args::AbstractDict{String, <:Any}) = redshift("DescribeReservedNodes", args)
...
"""
DescribeResize(ClusterIdentifier) = redshift("DescribeResize", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
DescribeResize(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("DescribeResize", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
DescribeScheduledActions(args::AbstractDict{String, <:Any}) = redshift("DescribeScheduledActions", args)
...
DescribeSnapshotCopyGrants(args::AbstractDict{String, <:Any}) = redshift("DescribeSnapshotCopyGrants", args)
...
DescribeSnapshotSchedules(args::AbstractDict{String, <:Any}) = redshift("DescribeSnapshotSchedules", args)
...
DescribeStorage(args::AbstractDict{String, <:Any}) = redshift("DescribeStorage", args)
...
DescribeTableRestoreStatus(args::AbstractDict{String, <:Any}) = redshift("DescribeTableRestoreStatus", args)
...
DescribeTags(args::AbstractDict{String, <:Any}) = redshift("DescribeTags", args)
...
DescribeUsageLimits(args::AbstractDict{String, <:Any}) = redshift("DescribeUsageLimits", args)
...
"""
DisableLogging(ClusterIdentifier) = redshift("DisableLogging", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
DisableLogging(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("DisableLogging", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
DisableSnapshotCopy(ClusterIdentifier) = redshift("DisableSnapshotCopy", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
DisableSnapshotCopy(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("DisableSnapshotCopy", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
EnableLogging(BucketName, ClusterIdentifier) = redshift("EnableLogging", Dict{String, Any}("BucketName"=>BucketName, "ClusterIdentifier"=>ClusterIdentifier))
EnableLogging(BucketName, ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("EnableLogging", Dict{String, Any}("BucketName"=>BucketName, "ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
EnableSnapshotCopy(ClusterIdentifier, DestinationRegion) = redshift("EnableSnapshotCopy", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "DestinationRegion"=>DestinationRegion))
EnableSnapshotCopy(ClusterIdentifier, DestinationRegion, args::AbstractDict{String, <:Any}) = redshift("EnableSnapshotCopy", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "DestinationRegion"=>DestinationRegion, args...))
...
"""
GetClusterCredentials(ClusterIdentifier, DbUser) = redshift("GetClusterCredentials", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "DbUser"=>DbUser))
GetClusterCredentials(ClusterIdentifier, DbUser, args::AbstractDict{String, <:Any}) = redshift("GetClusterCredentials", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "DbUser"=>DbUser, args...))
...
"""
GetReservedNodeExchangeOfferings(ReservedNodeId) = redshift("GetReservedNodeExchangeOfferings", Dict{String, Any}("ReservedNodeId"=>ReservedNodeId))
GetReservedNodeExchangeOfferings(ReservedNodeId, args::AbstractDict{String, <:Any}) = redshift("GetReservedNodeExchangeOfferings", Dict{String, Any}("ReservedNodeId"=>ReservedNodeId, args...))
...
"""
ModifyCluster(ClusterIdentifier) = redshift("ModifyCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
ModifyCluster(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("ModifyCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
ModifyClusterDbRevision(ClusterIdentifier, RevisionTarget) = redshift("ModifyClusterDbRevision", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "RevisionTarget"=>RevisionTarget))
ModifyClusterDbRevision(ClusterIdentifier, RevisionTarget, args::AbstractDict{String, <:Any}) = redshift("ModifyClusterDbRevision", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "RevisionTarget"=>RevisionTarget, args...))
...
"""
ModifyClusterIamRoles(ClusterIdentifier) = redshift("ModifyClusterIamRoles", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
ModifyClusterIamRoles(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("ModifyClusterIamRoles", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
ModifyClusterMaintenance(ClusterIdentifier) = redshift("ModifyClusterMaintenance", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
ModifyClusterMaintenance(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("ModifyClusterMaintenance", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
ModifyClusterParameterGroup(Parameter, ParameterGroupName) = redshift("ModifyClusterParameterGroup", Dict{String, Any}("Parameter"=>Parameter, "ParameterGroupName"=>ParameterGroupName))
ModifyClusterParameterGroup(Parameter, ParameterGroupName, args::AbstractDict{String, <:Any}) = redshift("ModifyClusterParameterGroup", Dict{String, Any}("Parameter"=>Parameter, "ParameterGroupName"=>ParameterGroupName, args...))
...
"""
ModifyClusterSnapshot(SnapshotIdentifier) = redshift("ModifyClusterSnapshot", Dict{String, Any}("SnapshotIdentifier"=>SnapshotIdentifier))
ModifyClusterSnapshot(SnapshotIdentifier, args::AbstractDict{String, <:Any}) = redshift("ModifyClusterSnapshot", Dict{String, Any}("SnapshotIdentifier"=>SnapshotIdentifier, args...))
...
"""
ModifyClusterSnapshotSchedule(ClusterIdentifier) = redshift("ModifyClusterSnapshotSchedule", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
ModifyClusterSnapshotSchedule(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("ModifyClusterSnapshotSchedule", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
- `SubnetIds`: An array of VPC subnet IDs. A maximum of 20 subnets can be modified in a single request.
"""
ModifyClusterSubnetGroup(ClusterSubnetGroupName, SubnetIdentifier) = redshift("ModifyClusterSubnetGroup", Dict{String, Any}("ClusterSubnetGroupName"=>ClusterSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier))
ModifyClusterSubnetGroup(ClusterSubnetGroupName, SubnetIdentifier, args::AbstractDict{String, <:Any}) = redshift("ModifyClusterSubnetGroup", Dict{String, Any}("ClusterSubnetGroupName"=>ClusterSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier, args...))
...
- `SourceType`: The type of source that will be generating the events. For example, if you want to be notified of events generated by a cluster, you would set this parameter to cluster. If this value is not specified, events are returned for all Amazon Redshift objects in your AWS account. You must specify a source type in order to specify source IDs. Valid values: cluster, cluster-parameter-group, cluster-security-group, cluster-snapshot, and scheduled-action.
"""
ModifyEventSubscription(SubscriptionName) = redshift("ModifyEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName))
ModifyEventSubscription(SubscriptionName, args::AbstractDict{String, <:Any}) = redshift("ModifyEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName, args...))
...
"""
ModifyScheduledAction(ScheduledActionName) = redshift("ModifyScheduledAction", Dict{String, Any}("ScheduledActionName"=>ScheduledActionName))
ModifyScheduledAction(ScheduledActionName, args::AbstractDict{String, <:Any}) = redshift("ModifyScheduledAction", Dict{String, Any}("ScheduledActionName"=>ScheduledActionName, args...))
...
"""
ModifySnapshotCopyRetentionPeriod(ClusterIdentifier, RetentionPeriod) = redshift("ModifySnapshotCopyRetentionPeriod", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "RetentionPeriod"=>RetentionPeriod))
ModifySnapshotCopyRetentionPeriod(ClusterIdentifier, RetentionPeriod, args::AbstractDict{String, <:Any}) = redshift("ModifySnapshotCopyRetentionPeriod", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "RetentionPeriod"=>RetentionPeriod, args...))
...
"""
ModifySnapshotSchedule(ScheduleDefinition, ScheduleIdentifier) = redshift("ModifySnapshotSchedule", Dict{String, Any}("ScheduleDefinition"=>ScheduleDefinition, "ScheduleIdentifier"=>ScheduleIdentifier))
ModifySnapshotSchedule(ScheduleDefinition, ScheduleIdentifier, args::AbstractDict{String, <:Any}) = redshift("ModifySnapshotSchedule", Dict{String, Any}("ScheduleDefinition"=>ScheduleDefinition, "ScheduleIdentifier"=>ScheduleIdentifier, args...))
...
"""
ModifyUsageLimit(UsageLimitId) = redshift("ModifyUsageLimit", Dict{String, Any}("UsageLimitId"=>UsageLimitId))
ModifyUsageLimit(UsageLimitId, args::AbstractDict{String, <:Any}) = redshift("ModifyUsageLimit", Dict{String, Any}("UsageLimitId"=>UsageLimitId, args...))
...
"""
PauseCluster(ClusterIdentifier) = redshift("PauseCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
PauseCluster(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("PauseCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
PurchaseReservedNodeOffering(ReservedNodeOfferingId) = redshift("PurchaseReservedNodeOffering", Dict{String, Any}("ReservedNodeOfferingId"=>ReservedNodeOfferingId))
PurchaseReservedNodeOffering(ReservedNodeOfferingId, args::AbstractDict{String, <:Any}) = redshift("PurchaseReservedNodeOffering", Dict{String, Any}("ReservedNodeOfferingId"=>ReservedNodeOfferingId, args...))
...
"""
RebootCluster(ClusterIdentifier) = redshift("RebootCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
RebootCluster(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("RebootCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
ResetClusterParameterGroup(ParameterGroupName) = redshift("ResetClusterParameterGroup", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName))
ResetClusterParameterGroup(ParameterGroupName, args::AbstractDict{String, <:Any}) = redshift("ResetClusterParameterGroup", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName, args...))
...
"""
ResizeCluster(ClusterIdentifier) = redshift("ResizeCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
ResizeCluster(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("ResizeCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
RestoreFromClusterSnapshot(ClusterIdentifier, SnapshotIdentifier) = redshift("RestoreFromClusterSnapshot", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "SnapshotIdentifier"=>SnapshotIdentifier))
RestoreFromClusterSnapshot(ClusterIdentifier, SnapshotIdentifier, args::AbstractDict{String, <:Any}) = redshift("RestoreFromClusterSnapshot", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "SnapshotIdentifier"=>SnapshotIdentifier, args...))
...
"""
RestoreTableFromClusterSnapshot(ClusterIdentifier, NewTableName, SnapshotIdentifier, SourceDatabaseName, SourceTableName) = redshift("RestoreTableFromClusterSnapshot", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "NewTableName"=>NewTableName, "SnapshotIdentifier"=>SnapshotIdentifier, "SourceDatabaseName"=>SourceDatabaseName, "SourceTableName"=>SourceTableName))
RestoreTableFromClusterSnapshot(ClusterIdentifier, NewTableName, SnapshotIdentifier, SourceDatabaseName, SourceTableName, args::AbstractDict{String, <:Any}) = redshift("RestoreTableFromClusterSnapshot", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "NewTableName"=>NewTableName, "SnapshotIdentifier"=>SnapshotIdentifier, "SourceDatabaseName"=>SourceDatabaseName, "SourceTableName"=>SourceTableName, args...))
...
"""
ResumeCluster(ClusterIdentifier) = redshift("ResumeCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
ResumeCluster(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("ResumeCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
...
"""
RevokeClusterSecurityGroupIngress(ClusterSecurityGroupName) = redshift("RevokeClusterSecurityGroupIngress", Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName))
RevokeClusterSecurityGroupIngress(ClusterSecurityGroupName, args::AbstractDict{String, <:Any}) = redshift("RevokeClusterSecurityGroupIngress", Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName, args...))
...
- `SnapshotClusterIdentifier`: The identifier of the cluster the snapshot was created from. This parameter is required if your IAM user has a policy containing a snapshot resource element that specifies anything other than * for the cluster name.
"""
RevokeSnapshotAccess(AccountWithRestoreAccess, SnapshotIdentifier) = redshift("RevokeSnapshotAccess", Dict{String, Any}("AccountWithRestoreAccess"=>AccountWithRestoreAccess, "SnapshotIdentifier"=>SnapshotIdentifier))
RevokeSnapshotAccess(AccountWithRestoreAccess, SnapshotIdentifier, args::AbstractDict{String, <:Any}) = redshift("RevokeSnapshotAccess", Dict{String, Any}("AccountWithRestoreAccess"=>AccountWithRestoreAccess, "SnapshotIdentifier"=>SnapshotIdentifier, args...))
...
"""
RotateEncryptionKey(ClusterIdentifier) = redshift("RotateEncryptionKey", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier))
RotateEncryptionKey(ClusterIdentifier, args::AbstractDict{String, <:Any}) = redshift("RotateEncryptionKey", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, args...))
