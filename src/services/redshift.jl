...
"""
AcceptReservedNodeExchange(ReservedNodeId, TargetReservedNodeOfferingId; aws::AWSConfig=AWSConfig()) = redshift("AcceptReservedNodeExchange", Dict{String, Any}("ReservedNodeId"=>ReservedNodeId, "TargetReservedNodeOfferingId"=>TargetReservedNodeOfferingId); aws=aws)
AcceptReservedNodeExchange(ReservedNodeId, TargetReservedNodeOfferingId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("AcceptReservedNodeExchange", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ReservedNodeId"=>ReservedNodeId, "TargetReservedNodeOfferingId"=>TargetReservedNodeOfferingId), args)); aws=aws)
...
"""
AuthorizeClusterSecurityGroupIngress(ClusterSecurityGroupName; aws::AWSConfig=AWSConfig()) = redshift("AuthorizeClusterSecurityGroupIngress", Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName); aws=aws)
AuthorizeClusterSecurityGroupIngress(ClusterSecurityGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("AuthorizeClusterSecurityGroupIngress", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName), args)); aws=aws)
...
"""
AuthorizeSnapshotAccess(AccountWithRestoreAccess, SnapshotIdentifier; aws::AWSConfig=AWSConfig()) = redshift("AuthorizeSnapshotAccess", Dict{String, Any}("AccountWithRestoreAccess"=>AccountWithRestoreAccess, "SnapshotIdentifier"=>SnapshotIdentifier); aws=aws)
AuthorizeSnapshotAccess(AccountWithRestoreAccess, SnapshotIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("AuthorizeSnapshotAccess", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountWithRestoreAccess"=>AccountWithRestoreAccess, "SnapshotIdentifier"=>SnapshotIdentifier), args)); aws=aws)
...
"""
BatchDeleteClusterSnapshots(DeleteClusterSnapshotMessage; aws::AWSConfig=AWSConfig()) = redshift("BatchDeleteClusterSnapshots", Dict{String, Any}("DeleteClusterSnapshotMessage"=>DeleteClusterSnapshotMessage); aws=aws)
BatchDeleteClusterSnapshots(DeleteClusterSnapshotMessage, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("BatchDeleteClusterSnapshots", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeleteClusterSnapshotMessage"=>DeleteClusterSnapshotMessage), args)); aws=aws)
...
"""
BatchModifyClusterSnapshots(String; aws::AWSConfig=AWSConfig()) = redshift("BatchModifyClusterSnapshots", Dict{String, Any}("String"=>String); aws=aws)
BatchModifyClusterSnapshots(String, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("BatchModifyClusterSnapshots", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("String"=>String), args)); aws=aws)
...
"""
CancelResize(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("CancelResize", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
CancelResize(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CancelResize", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
CopyClusterSnapshot(SourceSnapshotIdentifier, TargetSnapshotIdentifier; aws::AWSConfig=AWSConfig()) = redshift("CopyClusterSnapshot", Dict{String, Any}("SourceSnapshotIdentifier"=>SourceSnapshotIdentifier, "TargetSnapshotIdentifier"=>TargetSnapshotIdentifier); aws=aws)
CopyClusterSnapshot(SourceSnapshotIdentifier, TargetSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CopyClusterSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SourceSnapshotIdentifier"=>SourceSnapshotIdentifier, "TargetSnapshotIdentifier"=>TargetSnapshotIdentifier), args)); aws=aws)
...
"""
CreateCluster(ClusterIdentifier, MasterUserPassword, MasterUsername, NodeType; aws::AWSConfig=AWSConfig()) = redshift("CreateCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "MasterUserPassword"=>MasterUserPassword, "MasterUsername"=>MasterUsername, "NodeType"=>NodeType); aws=aws)
CreateCluster(ClusterIdentifier, MasterUserPassword, MasterUsername, NodeType, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CreateCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "MasterUserPassword"=>MasterUserPassword, "MasterUsername"=>MasterUsername, "NodeType"=>NodeType), args)); aws=aws)
...
- `Tags`: A list of tag instances.
"""
CreateClusterParameterGroup(Description, ParameterGroupFamily, ParameterGroupName; aws::AWSConfig=AWSConfig()) = redshift("CreateClusterParameterGroup", Dict{String, Any}("Description"=>Description, "ParameterGroupFamily"=>ParameterGroupFamily, "ParameterGroupName"=>ParameterGroupName); aws=aws)
CreateClusterParameterGroup(Description, ParameterGroupFamily, ParameterGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CreateClusterParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Description"=>Description, "ParameterGroupFamily"=>ParameterGroupFamily, "ParameterGroupName"=>ParameterGroupName), args)); aws=aws)
...
- `Tags`: A list of tag instances.
"""
CreateClusterSecurityGroup(ClusterSecurityGroupName, Description; aws::AWSConfig=AWSConfig()) = redshift("CreateClusterSecurityGroup", Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName, "Description"=>Description); aws=aws)
CreateClusterSecurityGroup(ClusterSecurityGroupName, Description, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CreateClusterSecurityGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName, "Description"=>Description), args)); aws=aws)
...
- `Tags`: A list of tag instances.
"""
CreateClusterSnapshot(ClusterIdentifier, SnapshotIdentifier; aws::AWSConfig=AWSConfig()) = redshift("CreateClusterSnapshot", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "SnapshotIdentifier"=>SnapshotIdentifier); aws=aws)
CreateClusterSnapshot(ClusterIdentifier, SnapshotIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CreateClusterSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "SnapshotIdentifier"=>SnapshotIdentifier), args)); aws=aws)
...
- `Tags`: A list of tag instances.
"""
CreateClusterSubnetGroup(ClusterSubnetGroupName, Description, SubnetIdentifier; aws::AWSConfig=AWSConfig()) = redshift("CreateClusterSubnetGroup", Dict{String, Any}("ClusterSubnetGroupName"=>ClusterSubnetGroupName, "Description"=>Description, "SubnetIdentifier"=>SubnetIdentifier); aws=aws)
CreateClusterSubnetGroup(ClusterSubnetGroupName, Description, SubnetIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CreateClusterSubnetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterSubnetGroupName"=>ClusterSubnetGroupName, "Description"=>Description, "SubnetIdentifier"=>SubnetIdentifier), args)); aws=aws)
...
- `Tags`: A list of tag instances.
"""
CreateEventSubscription(SnsTopicArn, SubscriptionName; aws::AWSConfig=AWSConfig()) = redshift("CreateEventSubscription", Dict{String, Any}("SnsTopicArn"=>SnsTopicArn, "SubscriptionName"=>SubscriptionName); aws=aws)
CreateEventSubscription(SnsTopicArn, SubscriptionName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CreateEventSubscription", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SnsTopicArn"=>SnsTopicArn, "SubscriptionName"=>SubscriptionName), args)); aws=aws)
...
- `Tags`: A list of tag instances.
"""
CreateHsmClientCertificate(HsmClientCertificateIdentifier; aws::AWSConfig=AWSConfig()) = redshift("CreateHsmClientCertificate", Dict{String, Any}("HsmClientCertificateIdentifier"=>HsmClientCertificateIdentifier); aws=aws)
CreateHsmClientCertificate(HsmClientCertificateIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CreateHsmClientCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HsmClientCertificateIdentifier"=>HsmClientCertificateIdentifier), args)); aws=aws)
...
"""
CreateScheduledAction(IamRole, Schedule, ScheduledActionName, TargetAction; aws::AWSConfig=AWSConfig()) = redshift("CreateScheduledAction", Dict{String, Any}("IamRole"=>IamRole, "Schedule"=>Schedule, "ScheduledActionName"=>ScheduledActionName, "TargetAction"=>TargetAction); aws=aws)
CreateScheduledAction(IamRole, Schedule, ScheduledActionName, TargetAction, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CreateScheduledAction", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IamRole"=>IamRole, "Schedule"=>Schedule, "ScheduledActionName"=>ScheduledActionName, "TargetAction"=>TargetAction), args)); aws=aws)
...
- `Tags`: A list of tag instances.
"""
CreateSnapshotCopyGrant(SnapshotCopyGrantName; aws::AWSConfig=AWSConfig()) = redshift("CreateSnapshotCopyGrant", Dict{String, Any}("SnapshotCopyGrantName"=>SnapshotCopyGrantName); aws=aws)
CreateSnapshotCopyGrant(SnapshotCopyGrantName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CreateSnapshotCopyGrant", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SnapshotCopyGrantName"=>SnapshotCopyGrantName), args)); aws=aws)
...
"""
CreateSnapshotSchedule(; aws::AWSConfig=AWSConfig()) = redshift("CreateSnapshotSchedule"; aws=aws)
CreateSnapshotSchedule(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CreateSnapshotSchedule", args; aws=aws)
...
"""
CreateTags(ResourceName, Tag; aws::AWSConfig=AWSConfig()) = redshift("CreateTags", Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag); aws=aws)
CreateTags(ResourceName, Tag, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CreateTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag), args)); aws=aws)
...
- `Tags`: A list of tag instances.
"""
CreateUsageLimit(Amount, ClusterIdentifier, FeatureType, LimitType; aws::AWSConfig=AWSConfig()) = redshift("CreateUsageLimit", Dict{String, Any}("Amount"=>Amount, "ClusterIdentifier"=>ClusterIdentifier, "FeatureType"=>FeatureType, "LimitType"=>LimitType); aws=aws)
CreateUsageLimit(Amount, ClusterIdentifier, FeatureType, LimitType, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("CreateUsageLimit", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Amount"=>Amount, "ClusterIdentifier"=>ClusterIdentifier, "FeatureType"=>FeatureType, "LimitType"=>LimitType), args)); aws=aws)
...
"""
DeleteCluster(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("DeleteCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
DeleteCluster(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
DeleteClusterParameterGroup(ParameterGroupName; aws::AWSConfig=AWSConfig()) = redshift("DeleteClusterParameterGroup", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName); aws=aws)
DeleteClusterParameterGroup(ParameterGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteClusterParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ParameterGroupName"=>ParameterGroupName), args)); aws=aws)
...
"""
DeleteClusterSecurityGroup(ClusterSecurityGroupName; aws::AWSConfig=AWSConfig()) = redshift("DeleteClusterSecurityGroup", Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName); aws=aws)
DeleteClusterSecurityGroup(ClusterSecurityGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteClusterSecurityGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName), args)); aws=aws)
...
"""
DeleteClusterSnapshot(SnapshotIdentifier; aws::AWSConfig=AWSConfig()) = redshift("DeleteClusterSnapshot", Dict{String, Any}("SnapshotIdentifier"=>SnapshotIdentifier); aws=aws)
DeleteClusterSnapshot(SnapshotIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteClusterSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SnapshotIdentifier"=>SnapshotIdentifier), args)); aws=aws)
...
"""
DeleteClusterSubnetGroup(ClusterSubnetGroupName; aws::AWSConfig=AWSConfig()) = redshift("DeleteClusterSubnetGroup", Dict{String, Any}("ClusterSubnetGroupName"=>ClusterSubnetGroupName); aws=aws)
DeleteClusterSubnetGroup(ClusterSubnetGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteClusterSubnetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterSubnetGroupName"=>ClusterSubnetGroupName), args)); aws=aws)
...
"""
DeleteEventSubscription(SubscriptionName; aws::AWSConfig=AWSConfig()) = redshift("DeleteEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName); aws=aws)
DeleteEventSubscription(SubscriptionName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteEventSubscription", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SubscriptionName"=>SubscriptionName), args)); aws=aws)
...
"""
DeleteHsmClientCertificate(HsmClientCertificateIdentifier; aws::AWSConfig=AWSConfig()) = redshift("DeleteHsmClientCertificate", Dict{String, Any}("HsmClientCertificateIdentifier"=>HsmClientCertificateIdentifier); aws=aws)
DeleteHsmClientCertificate(HsmClientCertificateIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteHsmClientCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HsmClientCertificateIdentifier"=>HsmClientCertificateIdentifier), args)); aws=aws)
...
"""
DeleteHsmConfiguration(HsmConfigurationIdentifier; aws::AWSConfig=AWSConfig()) = redshift("DeleteHsmConfiguration", Dict{String, Any}("HsmConfigurationIdentifier"=>HsmConfigurationIdentifier); aws=aws)
DeleteHsmConfiguration(HsmConfigurationIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteHsmConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HsmConfigurationIdentifier"=>HsmConfigurationIdentifier), args)); aws=aws)
...
"""
DeleteScheduledAction(ScheduledActionName; aws::AWSConfig=AWSConfig()) = redshift("DeleteScheduledAction", Dict{String, Any}("ScheduledActionName"=>ScheduledActionName); aws=aws)
DeleteScheduledAction(ScheduledActionName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteScheduledAction", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ScheduledActionName"=>ScheduledActionName), args)); aws=aws)
...
"""
DeleteSnapshotCopyGrant(SnapshotCopyGrantName; aws::AWSConfig=AWSConfig()) = redshift("DeleteSnapshotCopyGrant", Dict{String, Any}("SnapshotCopyGrantName"=>SnapshotCopyGrantName); aws=aws)
DeleteSnapshotCopyGrant(SnapshotCopyGrantName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteSnapshotCopyGrant", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SnapshotCopyGrantName"=>SnapshotCopyGrantName), args)); aws=aws)
...
"""
DeleteSnapshotSchedule(ScheduleIdentifier; aws::AWSConfig=AWSConfig()) = redshift("DeleteSnapshotSchedule", Dict{String, Any}("ScheduleIdentifier"=>ScheduleIdentifier); aws=aws)
DeleteSnapshotSchedule(ScheduleIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteSnapshotSchedule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ScheduleIdentifier"=>ScheduleIdentifier), args)); aws=aws)
...
"""
DeleteTags(ResourceName, TagKey; aws::AWSConfig=AWSConfig()) = redshift("DeleteTags", Dict{String, Any}("ResourceName"=>ResourceName, "TagKey"=>TagKey); aws=aws)
DeleteTags(ResourceName, TagKey, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceName"=>ResourceName, "TagKey"=>TagKey), args)); aws=aws)
...
"""
DeleteUsageLimit(UsageLimitId; aws::AWSConfig=AWSConfig()) = redshift("DeleteUsageLimit", Dict{String, Any}("UsageLimitId"=>UsageLimitId); aws=aws)
DeleteUsageLimit(UsageLimitId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DeleteUsageLimit", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("UsageLimitId"=>UsageLimitId), args)); aws=aws)
...
"""
DescribeAccountAttributes(; aws::AWSConfig=AWSConfig()) = redshift("DescribeAccountAttributes"; aws=aws)
DescribeAccountAttributes(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeAccountAttributes", args; aws=aws)
...
"""
DescribeClusterDbRevisions(; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterDbRevisions"; aws=aws)
DescribeClusterDbRevisions(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterDbRevisions", args; aws=aws)
...
"""
DescribeClusterParameterGroups(; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterParameterGroups"; aws=aws)
DescribeClusterParameterGroups(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterParameterGroups", args; aws=aws)
...
"""
DescribeClusterParameters(ParameterGroupName; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterParameters", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName); aws=aws)
DescribeClusterParameters(ParameterGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterParameters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ParameterGroupName"=>ParameterGroupName), args)); aws=aws)
...
"""
DescribeClusterSecurityGroups(; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterSecurityGroups"; aws=aws)
DescribeClusterSecurityGroups(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterSecurityGroups", args; aws=aws)
...
"""
DescribeClusterSnapshots(; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterSnapshots"; aws=aws)
DescribeClusterSnapshots(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterSnapshots", args; aws=aws)
...
"""
DescribeClusterSubnetGroups(; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterSubnetGroups"; aws=aws)
DescribeClusterSubnetGroups(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterSubnetGroups", args; aws=aws)
...
"""
DescribeClusterTracks(; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterTracks"; aws=aws)
DescribeClusterTracks(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterTracks", args; aws=aws)
...
- `MaxRecords`: The maximum number of response records to return in each call. If the number of remaining response records exceeds the specified MaxRecords value, a value is returned in a marker field of the response. You can retrieve the next set of records by retrying the command with the returned marker value.  Default: 100  Constraints: minimum 20, maximum 100.
"""
DescribeClusterVersions(; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterVersions"; aws=aws)
DescribeClusterVersions(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusterVersions", args; aws=aws)
...
"""
DescribeClusters(; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusters"; aws=aws)
DescribeClusters(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeClusters", args; aws=aws)
...
- `MaxRecords`: The maximum number of response records to return in each call. If the number of remaining response records exceeds the specified MaxRecords value, a value is returned in a marker field of the response. You can retrieve the next set of records by retrying the command with the returned marker value.  Default: 100  Constraints: minimum 20, maximum 100.
"""
DescribeDefaultClusterParameters(ParameterGroupFamily; aws::AWSConfig=AWSConfig()) = redshift("DescribeDefaultClusterParameters", Dict{String, Any}("ParameterGroupFamily"=>ParameterGroupFamily); aws=aws)
DescribeDefaultClusterParameters(ParameterGroupFamily, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeDefaultClusterParameters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ParameterGroupFamily"=>ParameterGroupFamily), args)); aws=aws)
...
"""
DescribeEventCategories(; aws::AWSConfig=AWSConfig()) = redshift("DescribeEventCategories"; aws=aws)
DescribeEventCategories(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeEventCategories", args; aws=aws)
...
"""
DescribeEventSubscriptions(; aws::AWSConfig=AWSConfig()) = redshift("DescribeEventSubscriptions"; aws=aws)
DescribeEventSubscriptions(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeEventSubscriptions", args; aws=aws)
...
"""
DescribeEvents(; aws::AWSConfig=AWSConfig()) = redshift("DescribeEvents"; aws=aws)
DescribeEvents(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeEvents", args; aws=aws)
...
"""
DescribeHsmClientCertificates(; aws::AWSConfig=AWSConfig()) = redshift("DescribeHsmClientCertificates"; aws=aws)
DescribeHsmClientCertificates(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeHsmClientCertificates", args; aws=aws)
...
"""
DescribeHsmConfigurations(; aws::AWSConfig=AWSConfig()) = redshift("DescribeHsmConfigurations"; aws=aws)
DescribeHsmConfigurations(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeHsmConfigurations", args; aws=aws)
...
"""
DescribeLoggingStatus(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("DescribeLoggingStatus", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
DescribeLoggingStatus(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeLoggingStatus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
DescribeNodeConfigurationOptions(ActionType; aws::AWSConfig=AWSConfig()) = redshift("DescribeNodeConfigurationOptions", Dict{String, Any}("ActionType"=>ActionType); aws=aws)
DescribeNodeConfigurationOptions(ActionType, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeNodeConfigurationOptions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ActionType"=>ActionType), args)); aws=aws)
...
"""
DescribeOrderableClusterOptions(; aws::AWSConfig=AWSConfig()) = redshift("DescribeOrderableClusterOptions"; aws=aws)
DescribeOrderableClusterOptions(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeOrderableClusterOptions", args; aws=aws)
...
"""
DescribeReservedNodeOfferings(; aws::AWSConfig=AWSConfig()) = redshift("DescribeReservedNodeOfferings"; aws=aws)
DescribeReservedNodeOfferings(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeReservedNodeOfferings", args; aws=aws)
...
"""
DescribeReservedNodes(; aws::AWSConfig=AWSConfig()) = redshift("DescribeReservedNodes"; aws=aws)
DescribeReservedNodes(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeReservedNodes", args; aws=aws)
...
"""
DescribeResize(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("DescribeResize", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
DescribeResize(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeResize", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
DescribeScheduledActions(; aws::AWSConfig=AWSConfig()) = redshift("DescribeScheduledActions"; aws=aws)
DescribeScheduledActions(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeScheduledActions", args; aws=aws)
...
"""
DescribeSnapshotCopyGrants(; aws::AWSConfig=AWSConfig()) = redshift("DescribeSnapshotCopyGrants"; aws=aws)
DescribeSnapshotCopyGrants(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeSnapshotCopyGrants", args; aws=aws)
...
"""
DescribeSnapshotSchedules(; aws::AWSConfig=AWSConfig()) = redshift("DescribeSnapshotSchedules"; aws=aws)
DescribeSnapshotSchedules(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeSnapshotSchedules", args; aws=aws)
...
"""
DescribeStorage(; aws::AWSConfig=AWSConfig()) = redshift("DescribeStorage"; aws=aws)
DescribeStorage(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeStorage", args; aws=aws)
...
"""
DescribeTableRestoreStatus(; aws::AWSConfig=AWSConfig()) = redshift("DescribeTableRestoreStatus"; aws=aws)
DescribeTableRestoreStatus(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeTableRestoreStatus", args; aws=aws)
...
- `TagValues`: A tag value or values for which you want to return all matching resources that are associated with the specified value or values. For example, suppose that you have resources tagged with values called admin and test. If you specify both of these tag values in the request, Amazon Redshift returns a response with all resources that have either or both of these tag values associated with them.
"""
DescribeTags(; aws::AWSConfig=AWSConfig()) = redshift("DescribeTags"; aws=aws)
DescribeTags(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeTags", args; aws=aws)
...
"""
DescribeUsageLimits(; aws::AWSConfig=AWSConfig()) = redshift("DescribeUsageLimits"; aws=aws)
DescribeUsageLimits(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DescribeUsageLimits", args; aws=aws)
...
"""
DisableLogging(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("DisableLogging", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
DisableLogging(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DisableLogging", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
DisableSnapshotCopy(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("DisableSnapshotCopy", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
DisableSnapshotCopy(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("DisableSnapshotCopy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
EnableLogging(BucketName, ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("EnableLogging", Dict{String, Any}("BucketName"=>BucketName, "ClusterIdentifier"=>ClusterIdentifier); aws=aws)
EnableLogging(BucketName, ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("EnableLogging", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BucketName"=>BucketName, "ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
EnableSnapshotCopy(ClusterIdentifier, DestinationRegion; aws::AWSConfig=AWSConfig()) = redshift("EnableSnapshotCopy", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "DestinationRegion"=>DestinationRegion); aws=aws)
EnableSnapshotCopy(ClusterIdentifier, DestinationRegion, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("EnableSnapshotCopy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "DestinationRegion"=>DestinationRegion), args)); aws=aws)
...
"""
GetClusterCredentials(ClusterIdentifier, DbUser; aws::AWSConfig=AWSConfig()) = redshift("GetClusterCredentials", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "DbUser"=>DbUser); aws=aws)
GetClusterCredentials(ClusterIdentifier, DbUser, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("GetClusterCredentials", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "DbUser"=>DbUser), args)); aws=aws)
...
"""
GetReservedNodeExchangeOfferings(ReservedNodeId; aws::AWSConfig=AWSConfig()) = redshift("GetReservedNodeExchangeOfferings", Dict{String, Any}("ReservedNodeId"=>ReservedNodeId); aws=aws)
GetReservedNodeExchangeOfferings(ReservedNodeId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("GetReservedNodeExchangeOfferings", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ReservedNodeId"=>ReservedNodeId), args)); aws=aws)
...
"""
ModifyCluster(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("ModifyCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
ModifyCluster(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifyCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
ModifyClusterDbRevision(ClusterIdentifier, RevisionTarget; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterDbRevision", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "RevisionTarget"=>RevisionTarget); aws=aws)
ModifyClusterDbRevision(ClusterIdentifier, RevisionTarget, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterDbRevision", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "RevisionTarget"=>RevisionTarget), args)); aws=aws)
...
"""
ModifyClusterIamRoles(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterIamRoles", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
ModifyClusterIamRoles(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterIamRoles", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
ModifyClusterMaintenance(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterMaintenance", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
ModifyClusterMaintenance(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterMaintenance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
ModifyClusterParameterGroup(Parameter, ParameterGroupName; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterParameterGroup", Dict{String, Any}("Parameter"=>Parameter, "ParameterGroupName"=>ParameterGroupName); aws=aws)
ModifyClusterParameterGroup(Parameter, ParameterGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Parameter"=>Parameter, "ParameterGroupName"=>ParameterGroupName), args)); aws=aws)
...
"""
ModifyClusterSnapshot(SnapshotIdentifier; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterSnapshot", Dict{String, Any}("SnapshotIdentifier"=>SnapshotIdentifier); aws=aws)
ModifyClusterSnapshot(SnapshotIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SnapshotIdentifier"=>SnapshotIdentifier), args)); aws=aws)
...
"""
ModifyClusterSnapshotSchedule(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterSnapshotSchedule", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
ModifyClusterSnapshotSchedule(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterSnapshotSchedule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
- `SubnetIds`: An array of VPC subnet IDs. A maximum of 20 subnets can be modified in a single request.
"""
ModifyClusterSubnetGroup(ClusterSubnetGroupName, SubnetIdentifier; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterSubnetGroup", Dict{String, Any}("ClusterSubnetGroupName"=>ClusterSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier); aws=aws)
ModifyClusterSubnetGroup(ClusterSubnetGroupName, SubnetIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifyClusterSubnetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterSubnetGroupName"=>ClusterSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier), args)); aws=aws)
...
- `SourceType`: The type of source that will be generating the events. For example, if you want to be notified of events generated by a cluster, you would set this parameter to cluster. If this value is not specified, events are returned for all Amazon Redshift objects in your AWS account. You must specify a source type in order to specify source IDs. Valid values: cluster, cluster-parameter-group, cluster-security-group, cluster-snapshot, and scheduled-action.
"""
ModifyEventSubscription(SubscriptionName; aws::AWSConfig=AWSConfig()) = redshift("ModifyEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName); aws=aws)
ModifyEventSubscription(SubscriptionName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifyEventSubscription", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SubscriptionName"=>SubscriptionName), args)); aws=aws)
...
"""
ModifyScheduledAction(ScheduledActionName; aws::AWSConfig=AWSConfig()) = redshift("ModifyScheduledAction", Dict{String, Any}("ScheduledActionName"=>ScheduledActionName); aws=aws)
ModifyScheduledAction(ScheduledActionName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifyScheduledAction", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ScheduledActionName"=>ScheduledActionName), args)); aws=aws)
...
"""
ModifySnapshotCopyRetentionPeriod(ClusterIdentifier, RetentionPeriod; aws::AWSConfig=AWSConfig()) = redshift("ModifySnapshotCopyRetentionPeriod", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "RetentionPeriod"=>RetentionPeriod); aws=aws)
ModifySnapshotCopyRetentionPeriod(ClusterIdentifier, RetentionPeriod, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifySnapshotCopyRetentionPeriod", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "RetentionPeriod"=>RetentionPeriod), args)); aws=aws)
...
"""
ModifySnapshotSchedule(ScheduleDefinition, ScheduleIdentifier; aws::AWSConfig=AWSConfig()) = redshift("ModifySnapshotSchedule", Dict{String, Any}("ScheduleDefinition"=>ScheduleDefinition, "ScheduleIdentifier"=>ScheduleIdentifier); aws=aws)
ModifySnapshotSchedule(ScheduleDefinition, ScheduleIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifySnapshotSchedule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ScheduleDefinition"=>ScheduleDefinition, "ScheduleIdentifier"=>ScheduleIdentifier), args)); aws=aws)
...
"""
ModifyUsageLimit(UsageLimitId; aws::AWSConfig=AWSConfig()) = redshift("ModifyUsageLimit", Dict{String, Any}("UsageLimitId"=>UsageLimitId); aws=aws)
ModifyUsageLimit(UsageLimitId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ModifyUsageLimit", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("UsageLimitId"=>UsageLimitId), args)); aws=aws)
...
"""
PauseCluster(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("PauseCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
PauseCluster(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("PauseCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
PurchaseReservedNodeOffering(ReservedNodeOfferingId; aws::AWSConfig=AWSConfig()) = redshift("PurchaseReservedNodeOffering", Dict{String, Any}("ReservedNodeOfferingId"=>ReservedNodeOfferingId); aws=aws)
PurchaseReservedNodeOffering(ReservedNodeOfferingId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("PurchaseReservedNodeOffering", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ReservedNodeOfferingId"=>ReservedNodeOfferingId), args)); aws=aws)
...
"""
RebootCluster(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("RebootCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
RebootCluster(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("RebootCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
ResetClusterParameterGroup(ParameterGroupName; aws::AWSConfig=AWSConfig()) = redshift("ResetClusterParameterGroup", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName); aws=aws)
ResetClusterParameterGroup(ParameterGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ResetClusterParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ParameterGroupName"=>ParameterGroupName), args)); aws=aws)
...
"""
ResizeCluster(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("ResizeCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
ResizeCluster(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ResizeCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
RestoreFromClusterSnapshot(ClusterIdentifier, SnapshotIdentifier; aws::AWSConfig=AWSConfig()) = redshift("RestoreFromClusterSnapshot", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "SnapshotIdentifier"=>SnapshotIdentifier); aws=aws)
RestoreFromClusterSnapshot(ClusterIdentifier, SnapshotIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("RestoreFromClusterSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier, "SnapshotIdentifier"=>SnapshotIdentifier), args)); aws=aws)
...
"""
ResumeCluster(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("ResumeCluster", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
ResumeCluster(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("ResumeCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
...
"""
RevokeClusterSecurityGroupIngress(ClusterSecurityGroupName; aws::AWSConfig=AWSConfig()) = redshift("RevokeClusterSecurityGroupIngress", Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName); aws=aws)
RevokeClusterSecurityGroupIngress(ClusterSecurityGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("RevokeClusterSecurityGroupIngress", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterSecurityGroupName"=>ClusterSecurityGroupName), args)); aws=aws)
...
- `SnapshotClusterIdentifier`: The identifier of the cluster the snapshot was created from. This parameter is required if your IAM user has a policy containing a snapshot resource element that specifies anything other than * for the cluster name.
"""
RevokeSnapshotAccess(AccountWithRestoreAccess, SnapshotIdentifier; aws::AWSConfig=AWSConfig()) = redshift("RevokeSnapshotAccess", Dict{String, Any}("AccountWithRestoreAccess"=>AccountWithRestoreAccess, "SnapshotIdentifier"=>SnapshotIdentifier); aws=aws)
RevokeSnapshotAccess(AccountWithRestoreAccess, SnapshotIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("RevokeSnapshotAccess", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountWithRestoreAccess"=>AccountWithRestoreAccess, "SnapshotIdentifier"=>SnapshotIdentifier), args)); aws=aws)
...
"""
RotateEncryptionKey(ClusterIdentifier; aws::AWSConfig=AWSConfig()) = redshift("RotateEncryptionKey", Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier); aws=aws)
RotateEncryptionKey(ClusterIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = redshift("RotateEncryptionKey", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterIdentifier"=>ClusterIdentifier), args)); aws=aws)
