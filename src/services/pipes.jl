...
function delete_pipe(Name; aws_config::AbstractAWSConfig=current_aws_config())
    return pipes("DELETE", "/v1/pipes/$(Name)"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function delete_pipe(
    ...
    return pipes(
        "DELETE", "/v1/pipes/$(Name)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_pipe(Name; aws_config::AbstractAWSConfig=current_aws_config())
    return pipes("GET", "/v1/pipes/$(Name)"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_pipe(
    ...
    return pipes(
        "GET", "/v1/pipes/$(Name)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_pipes(; aws_config::AbstractAWSConfig=current_aws_config())
    return pipes("GET", "/v1/pipes"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_pipes(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return pipes("GET", "/v1/pipes", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_tags_for_resource(
    ...
    return pipes("GET", "/tags/$(resourceArn)"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function start_pipe(Name; aws_config::AbstractAWSConfig=current_aws_config())
    return pipes(
        "POST", "/v1/pipes/$(Name)/start"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function stop_pipe(Name; aws_config::AbstractAWSConfig=current_aws_config())
    return pipes(
        "POST", "/v1/pipes/$(Name)/stop"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
