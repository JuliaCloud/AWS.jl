...
"""
CreateAccessPoint(Bucket, name, x_amz_account_id) = s3_control("PUT", "/v20180820/accesspoint/$(name)", Dict{String, Any}("Bucket"=>Bucket, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
CreateAccessPoint(Bucket, name, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("PUT", "/v20180820/accesspoint/$(name)", Dict{String, Any}(mergewith(merge, Dict{String, Any}("Bucket"=>Bucket, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
CreateJob(ClientRequestToken, Manifest, Operation, Priority, Report, RoleArn, x_amz_account_id) = s3_control("POST", "/v20180820/jobs", Dict{String, Any}("ClientRequestToken"=>ClientRequestToken, "Manifest"=>Manifest, "Operation"=>Operation, "Priority"=>Priority, "Report"=>Report, "RoleArn"=>RoleArn, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
CreateJob(ClientRequestToken, Manifest, Operation, Priority, Report, RoleArn, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("POST", "/v20180820/jobs", Dict{String, Any}(mergewith(merge, Dict{String, Any}("ClientRequestToken"=>ClientRequestToken, "Manifest"=>Manifest, "Operation"=>Operation, "Priority"=>Priority, "Report"=>Report, "RoleArn"=>RoleArn, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
DeleteAccessPoint(name, x_amz_account_id) = s3_control("DELETE", "/v20180820/accesspoint/$(name)", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
DeleteAccessPoint(name, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("DELETE", "/v20180820/accesspoint/$(name)", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
DeleteAccessPointPolicy(name, x_amz_account_id) = s3_control("DELETE", "/v20180820/accesspoint/$(name)/policy", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
DeleteAccessPointPolicy(name, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("DELETE", "/v20180820/accesspoint/$(name)/policy", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
DeleteJobTagging(id, x_amz_account_id) = s3_control("DELETE", "/v20180820/jobs/$(id)/tagging", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
DeleteJobTagging(id, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("DELETE", "/v20180820/jobs/$(id)/tagging", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
DeletePublicAccessBlock(x_amz_account_id) = s3_control("DELETE", "/v20180820/configuration/publicAccessBlock", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
DeletePublicAccessBlock(x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("DELETE", "/v20180820/configuration/publicAccessBlock", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
DescribeJob(id, x_amz_account_id) = s3_control("GET", "/v20180820/jobs/$(id)", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
DescribeJob(id, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("GET", "/v20180820/jobs/$(id)", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
GetAccessPoint(name, x_amz_account_id) = s3_control("GET", "/v20180820/accesspoint/$(name)", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
GetAccessPoint(name, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("GET", "/v20180820/accesspoint/$(name)", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
GetAccessPointPolicy(name, x_amz_account_id) = s3_control("GET", "/v20180820/accesspoint/$(name)/policy", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
GetAccessPointPolicy(name, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("GET", "/v20180820/accesspoint/$(name)/policy", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
GetAccessPointPolicyStatus(name, x_amz_account_id) = s3_control("GET", "/v20180820/accesspoint/$(name)/policyStatus", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
GetAccessPointPolicyStatus(name, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("GET", "/v20180820/accesspoint/$(name)/policyStatus", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
GetJobTagging(id, x_amz_account_id) = s3_control("GET", "/v20180820/jobs/$(id)/tagging", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
GetJobTagging(id, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("GET", "/v20180820/jobs/$(id)/tagging", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
GetPublicAccessBlock(x_amz_account_id) = s3_control("GET", "/v20180820/configuration/publicAccessBlock", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
GetPublicAccessBlock(x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("GET", "/v20180820/configuration/publicAccessBlock", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
ListAccessPoints(x_amz_account_id) = s3_control("GET", "/v20180820/accesspoint", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
ListAccessPoints(x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("GET", "/v20180820/accesspoint", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
ListJobs(x_amz_account_id) = s3_control("GET", "/v20180820/jobs", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
ListJobs(x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("GET", "/v20180820/jobs", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
PutAccessPointPolicy(Policy, name, x_amz_account_id) = s3_control("PUT", "/v20180820/accesspoint/$(name)/policy", Dict{String, Any}("Policy"=>Policy, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
PutAccessPointPolicy(Policy, name, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("PUT", "/v20180820/accesspoint/$(name)/policy", Dict{String, Any}(mergewith(merge, Dict{String, Any}("Policy"=>Policy, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
PutJobTagging(Tags, id, x_amz_account_id) = s3_control("PUT", "/v20180820/jobs/$(id)/tagging", Dict{String, Any}("Tags"=>Tags, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
PutJobTagging(Tags, id, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("PUT", "/v20180820/jobs/$(id)/tagging", Dict{String, Any}(mergewith(merge, Dict{String, Any}("Tags"=>Tags, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
PutPublicAccessBlock(PublicAccessBlockConfiguration, x_amz_account_id) = s3_control("PUT", "/v20180820/configuration/publicAccessBlock", Dict{String, Any}("PublicAccessBlockConfiguration"=>PublicAccessBlockConfiguration, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
PutPublicAccessBlock(PublicAccessBlockConfiguration, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("PUT", "/v20180820/configuration/publicAccessBlock", Dict{String, Any}(mergewith(merge, Dict{String, Any}("PublicAccessBlockConfiguration"=>PublicAccessBlockConfiguration, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
UpdateJobPriority(id, priority, x_amz_account_id) = s3_control("POST", "/v20180820/jobs/$(id)/priority", Dict{String, Any}("priority"=>priority, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
UpdateJobPriority(id, priority, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("POST", "/v20180820/jobs/$(id)/priority", Dict{String, Any}(mergewith(merge, Dict{String, Any}("priority"=>priority, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
...
"""
UpdateJobStatus(id, requestedJobStatus, x_amz_account_id) = s3_control("POST", "/v20180820/jobs/$(id)/status", Dict{String, Any}("requestedJobStatus"=>requestedJobStatus, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)))
UpdateJobStatus(id, requestedJobStatus, x_amz_account_id, args::AbstractDict{String, <: Any}) = s3_control("POST", "/v20180820/jobs/$(id)/status", Dict{String, Any}(mergewith(merge, Dict{String, Any}("requestedJobStatus"=>requestedJobStatus, "headers"=>Dict{String, Any}("x-amz-account-id"=>x_amz_account_id)), args...)))
