...
function cancel_task(taskId; aws_config::AbstractAWSConfig=current_aws_config())
    return snow_device_management(
        "POST", "/task/$(taskId)/cancel"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_task(taskId; aws_config::AbstractAWSConfig=current_aws_config())
    return snow_device_management(
        "POST", "/task/$(taskId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_task(
    ...
    return snow_device_management(
        "POST", "/task/$(taskId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_devices(; aws_config::AbstractAWSConfig=current_aws_config())
    return snow_device_management(
        "GET", "/managed-devices"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_devices(
    ...
    return snow_device_management(
        "GET", "/managed-devices", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_tasks(; aws_config::AbstractAWSConfig=current_aws_config())
    return snow_device_management(
        "GET", "/tasks"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_tasks(
    ...
    return snow_device_management(
        "GET", "/tasks", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
