...
"""
function get_agent_configuration(agentId; aws_config::AbstractAWSConfig=current_aws_config())
    return groundstation(
        "GET",
...
function get_agent_configuration(
    agentId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return groundstation(
        "GET",
        "/agent/$(agentId)/configuration",
...
"""
function get_config(configId, configType; aws_config::AbstractAWSConfig=current_aws_config())
    return groundstation(
        "GET",
        "/config/$(configType)/$(configId)";
        aws_config=aws_config,
