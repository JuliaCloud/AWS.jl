...
"""
function delete_model(modelId, modelType; aws_config::AbstractAWSConfig=current_aws_config())
    return frauddetector(
        "DeleteModel",
...
function update_detector_version_status(
    detectorId, detectorVersionId, status; aws_config::AbstractAWSConfig=current_aws_config()
)
    return frauddetector(
...
"""
function update_model(modelId, modelType; aws_config::AbstractAWSConfig=current_aws_config())
    return frauddetector(
        "UpdateModel",
        Dict{String,Any}("modelId" => modelId, "modelType" => modelType);
        aws_config=aws_config,
