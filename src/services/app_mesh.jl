...
"""
CreateGatewayRoute(gatewayRouteName, meshName, spec, virtualGatewayName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualGateway/$(virtualGatewayName)/gatewayRoutes", Dict{String, Any}("gatewayRouteName"=>gatewayRouteName, "spec"=>spec, "clientToken"=>string(uuid4())))
CreateGatewayRoute(gatewayRouteName, meshName, spec, virtualGatewayName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualGateway/$(virtualGatewayName)/gatewayRoutes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("gatewayRouteName"=>gatewayRouteName, "spec"=>spec, "clientToken"=>string(uuid4())), args...)))
...
- `tags`: Optional metadata that you can apply to the service mesh to assist with categorization
         ...
         define. Tag keys can have a maximum character length of 128 characters, and tag values can have
            a maximum length of 256 characters.
"""
CreateMesh(meshName) = app_mesh("PUT", "/v20190125/meshes", Dict{String, Any}("meshName"=>meshName, "clientToken"=>string(uuid4())))
CreateMesh(meshName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("meshName"=>meshName, "clientToken"=>string(uuid4())), args...)))
...
- `tags`: Optional metadata that you can apply to the route to assist with categorization and
         ...
         Tag keys can have a maximum character length of 128 characters, and tag values can have
            a maximum length of 256 characters.
"""
CreateRoute(meshName, routeName, spec, virtualRouterName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualRouter/$(virtualRouterName)/routes", Dict{String, Any}("routeName"=>routeName, "spec"=>spec, "clientToken"=>string(uuid4())))
CreateRoute(meshName, routeName, spec, virtualRouterName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualRouter/$(virtualRouterName)/routes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("routeName"=>routeName, "spec"=>spec, "clientToken"=>string(uuid4())), args...)))
...
- `tags`: Optional metadata that you can apply to the virtual gateway to assist with
         ...
         which you define. Tag keys can have a maximum character length of 128 characters, and tag values can have
            a maximum length of 256 characters.
"""
CreateVirtualGateway(meshName, spec, virtualGatewayName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualGateways", Dict{String, Any}("spec"=>spec, "virtualGatewayName"=>virtualGatewayName, "clientToken"=>string(uuid4())))
CreateVirtualGateway(meshName, spec, virtualGatewayName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualGateways", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("spec"=>spec, "virtualGatewayName"=>virtualGatewayName, "clientToken"=>string(uuid4())), args...)))
...
- `tags`: Optional metadata that you can apply to the virtual node to assist with categorization
         ...
         define. Tag keys can have a maximum character length of 128 characters, and tag values can have
            a maximum length of 256 characters.
"""
CreateVirtualNode(meshName, spec, virtualNodeName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualNodes", Dict{String, Any}("spec"=>spec, "virtualNodeName"=>virtualNodeName, "clientToken"=>string(uuid4())))
CreateVirtualNode(meshName, spec, virtualNodeName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualNodes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("spec"=>spec, "virtualNodeName"=>virtualNodeName, "clientToken"=>string(uuid4())), args...)))
...
- `tags`: Optional metadata that you can apply to the virtual router to assist with categorization
         ...
         define. Tag keys can have a maximum character length of 128 characters, and tag values can have
            a maximum length of 256 characters.
"""
CreateVirtualRouter(meshName, spec, virtualRouterName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualRouters", Dict{String, Any}("spec"=>spec, "virtualRouterName"=>virtualRouterName, "clientToken"=>string(uuid4())))
CreateVirtualRouter(meshName, spec, virtualRouterName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualRouters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("spec"=>spec, "virtualRouterName"=>virtualRouterName, "clientToken"=>string(uuid4())), args...)))
...
- `tags`: Optional metadata that you can apply to the virtual service to assist with
         ...
         which you define. Tag keys can have a maximum character length of 128 characters, and tag values can have
            a maximum length of 256 characters.
"""
CreateVirtualService(meshName, spec, virtualServiceName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualServices", Dict{String, Any}("spec"=>spec, "virtualServiceName"=>virtualServiceName, "clientToken"=>string(uuid4())))
CreateVirtualService(meshName, spec, virtualServiceName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualServices", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("spec"=>spec, "virtualServiceName"=>virtualServiceName, "clientToken"=>string(uuid4())), args...)))
...
- `meshOwner`: The AWS IAM account ID of the service mesh owner. If the account ID is not your own, then it's
               the ID of the account that shared the mesh with your account. For more information about mesh sharing, see Working with shared meshes.
"""
UpdateGatewayRoute(gatewayRouteName, meshName, spec, virtualGatewayName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualGateway/$(virtualGatewayName)/gatewayRoutes/$(gatewayRouteName)", Dict{String, Any}("spec"=>spec, "clientToken"=>string(uuid4())))
UpdateGatewayRoute(gatewayRouteName, meshName, spec, virtualGatewayName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualGateway/$(virtualGatewayName)/gatewayRoutes/$(gatewayRouteName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("spec"=>spec, "clientToken"=>string(uuid4())), args...)))
...
- `spec`: The service mesh specification to apply.
"""
UpdateMesh(meshName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)", Dict{String, Any}("clientToken"=>string(uuid4())))
UpdateMesh(meshName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientToken"=>string(uuid4())), args...)))
...
- `meshOwner`: The AWS IAM account ID of the service mesh owner. If the account ID is not your own, then it's
               the ID of the account that shared the mesh with your account. For more information about mesh sharing, see Working with shared meshes.
"""
UpdateRoute(meshName, routeName, spec, virtualRouterName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualRouter/$(virtualRouterName)/routes/$(routeName)", Dict{String, Any}("spec"=>spec, "clientToken"=>string(uuid4())))
UpdateRoute(meshName, routeName, spec, virtualRouterName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualRouter/$(virtualRouterName)/routes/$(routeName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("spec"=>spec, "clientToken"=>string(uuid4())), args...)))
...
- `meshOwner`: The AWS IAM account ID of the service mesh owner. If the account ID is not your own, then it's
               the ID of the account that shared the mesh with your account. For more information about mesh sharing, see Working with shared meshes.
"""
UpdateVirtualGateway(meshName, spec, virtualGatewayName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualGateways/$(virtualGatewayName)", Dict{String, Any}("spec"=>spec, "clientToken"=>string(uuid4())))
UpdateVirtualGateway(meshName, spec, virtualGatewayName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualGateways/$(virtualGatewayName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("spec"=>spec, "clientToken"=>string(uuid4())), args...)))
...
- `meshOwner`: The AWS IAM account ID of the service mesh owner. If the account ID is not your own, then it's
               the ID of the account that shared the mesh with your account. For more information about mesh sharing, see Working with shared meshes.
"""
UpdateVirtualNode(meshName, spec, virtualNodeName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualNodes/$(virtualNodeName)", Dict{String, Any}("spec"=>spec, "clientToken"=>string(uuid4())))
UpdateVirtualNode(meshName, spec, virtualNodeName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualNodes/$(virtualNodeName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("spec"=>spec, "clientToken"=>string(uuid4())), args...)))
...
- `meshOwner`: The AWS IAM account ID of the service mesh owner. If the account ID is not your own, then it's
               the ID of the account that shared the mesh with your account. For more information about mesh sharing, see Working with shared meshes.
"""
UpdateVirtualRouter(meshName, spec, virtualRouterName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualRouters/$(virtualRouterName)", Dict{String, Any}("spec"=>spec, "clientToken"=>string(uuid4())))
UpdateVirtualRouter(meshName, spec, virtualRouterName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualRouters/$(virtualRouterName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("spec"=>spec, "clientToken"=>string(uuid4())), args...)))
...
- `meshOwner`: The AWS IAM account ID of the service mesh owner. If the account ID is not your own, then it's
               the ID of the account that shared the mesh with your account. For more information about mesh sharing, see Working with shared meshes.
"""
UpdateVirtualService(meshName, spec, virtualServiceName) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualServices/$(virtualServiceName)", Dict{String, Any}("spec"=>spec, "clientToken"=>string(uuid4())))
UpdateVirtualService(meshName, spec, virtualServiceName, args::AbstractDict{String, <:Any}) = app_mesh("PUT", "/v20190125/meshes/$(meshName)/virtualServices/$(virtualServiceName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("spec"=>spec, "clientToken"=>string(uuid4())), args...)))
