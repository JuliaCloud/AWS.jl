...
"""
AddTags(LoadBalancerNames, Tags) = elastic_load_balancing("AddTags", Dict{String, Any}("LoadBalancerNames"=>LoadBalancerNames, "Tags"=>Tags))
AddTags(LoadBalancerNames, Tags, args::AbstractDict{String, <: Any}) = elastic_load_balancing("AddTags", Dict{String, Any}("LoadBalancerNames"=>LoadBalancerNames, "Tags"=>Tags, args...))
...
"""
ApplySecurityGroupsToLoadBalancer(LoadBalancerName, SecurityGroups) = elastic_load_balancing("ApplySecurityGroupsToLoadBalancer", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "SecurityGroups"=>SecurityGroups))
ApplySecurityGroupsToLoadBalancer(LoadBalancerName, SecurityGroups, args::AbstractDict{String, <: Any}) = elastic_load_balancing("ApplySecurityGroupsToLoadBalancer", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "SecurityGroups"=>SecurityGroups, args...))
...
"""
AttachLoadBalancerToSubnets(LoadBalancerName, Subnets) = elastic_load_balancing("AttachLoadBalancerToSubnets", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "Subnets"=>Subnets))
AttachLoadBalancerToSubnets(LoadBalancerName, Subnets, args::AbstractDict{String, <: Any}) = elastic_load_balancing("AttachLoadBalancerToSubnets", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "Subnets"=>Subnets, args...))
...
"""
ConfigureHealthCheck(HealthCheck, LoadBalancerName) = elastic_load_balancing("ConfigureHealthCheck", Dict{String, Any}("HealthCheck"=>HealthCheck, "LoadBalancerName"=>LoadBalancerName))
ConfigureHealthCheck(HealthCheck, LoadBalancerName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("ConfigureHealthCheck", Dict{String, Any}("HealthCheck"=>HealthCheck, "LoadBalancerName"=>LoadBalancerName, args...))
...
"""
CreateAppCookieStickinessPolicy(CookieName, LoadBalancerName, PolicyName) = elastic_load_balancing("CreateAppCookieStickinessPolicy", Dict{String, Any}("CookieName"=>CookieName, "LoadBalancerName"=>LoadBalancerName, "PolicyName"=>PolicyName))
CreateAppCookieStickinessPolicy(CookieName, LoadBalancerName, PolicyName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("CreateAppCookieStickinessPolicy", Dict{String, Any}("CookieName"=>CookieName, "LoadBalancerName"=>LoadBalancerName, "PolicyName"=>PolicyName, args...))
...
"""
CreateLBCookieStickinessPolicy(LoadBalancerName, PolicyName) = elastic_load_balancing("CreateLBCookieStickinessPolicy", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "PolicyName"=>PolicyName))
CreateLBCookieStickinessPolicy(LoadBalancerName, PolicyName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("CreateLBCookieStickinessPolicy", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "PolicyName"=>PolicyName, args...))
...
"""
CreateLoadBalancer(Listeners, LoadBalancerName) = elastic_load_balancing("CreateLoadBalancer", Dict{String, Any}("Listeners"=>Listeners, "LoadBalancerName"=>LoadBalancerName))
CreateLoadBalancer(Listeners, LoadBalancerName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("CreateLoadBalancer", Dict{String, Any}("Listeners"=>Listeners, "LoadBalancerName"=>LoadBalancerName, args...))
...
"""
CreateLoadBalancerListeners(Listeners, LoadBalancerName) = elastic_load_balancing("CreateLoadBalancerListeners", Dict{String, Any}("Listeners"=>Listeners, "LoadBalancerName"=>LoadBalancerName))
CreateLoadBalancerListeners(Listeners, LoadBalancerName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("CreateLoadBalancerListeners", Dict{String, Any}("Listeners"=>Listeners, "LoadBalancerName"=>LoadBalancerName, args...))
...
"""
CreateLoadBalancerPolicy(LoadBalancerName, PolicyName, PolicyTypeName) = elastic_load_balancing("CreateLoadBalancerPolicy", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "PolicyName"=>PolicyName, "PolicyTypeName"=>PolicyTypeName))
CreateLoadBalancerPolicy(LoadBalancerName, PolicyName, PolicyTypeName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("CreateLoadBalancerPolicy", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "PolicyName"=>PolicyName, "PolicyTypeName"=>PolicyTypeName, args...))
...
"""
DeleteLoadBalancer(LoadBalancerName) = elastic_load_balancing("DeleteLoadBalancer", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName))
DeleteLoadBalancer(LoadBalancerName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("DeleteLoadBalancer", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, args...))
...
"""
DeleteLoadBalancerListeners(LoadBalancerName, LoadBalancerPorts) = elastic_load_balancing("DeleteLoadBalancerListeners", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "LoadBalancerPorts"=>LoadBalancerPorts))
DeleteLoadBalancerListeners(LoadBalancerName, LoadBalancerPorts, args::AbstractDict{String, <: Any}) = elastic_load_balancing("DeleteLoadBalancerListeners", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "LoadBalancerPorts"=>LoadBalancerPorts, args...))
...
"""
DeleteLoadBalancerPolicy(LoadBalancerName, PolicyName) = elastic_load_balancing("DeleteLoadBalancerPolicy", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "PolicyName"=>PolicyName))
DeleteLoadBalancerPolicy(LoadBalancerName, PolicyName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("DeleteLoadBalancerPolicy", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "PolicyName"=>PolicyName, args...))
...
"""
DeregisterInstancesFromLoadBalancer(Instances, LoadBalancerName) = elastic_load_balancing("DeregisterInstancesFromLoadBalancer", Dict{String, Any}("Instances"=>Instances, "LoadBalancerName"=>LoadBalancerName))
DeregisterInstancesFromLoadBalancer(Instances, LoadBalancerName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("DeregisterInstancesFromLoadBalancer", Dict{String, Any}("Instances"=>Instances, "LoadBalancerName"=>LoadBalancerName, args...))
...
DescribeAccountLimits(args::AbstractDict{String, <: Any}) = elastic_load_balancing("DescribeAccountLimits", args)
...
Instances => The IDs of the instances.
"""
DescribeInstanceHealth(LoadBalancerName) = elastic_load_balancing("DescribeInstanceHealth", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName))
DescribeInstanceHealth(LoadBalancerName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("DescribeInstanceHealth", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, args...))
...
"""
DescribeLoadBalancerAttributes(LoadBalancerName) = elastic_load_balancing("DescribeLoadBalancerAttributes", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName))
DescribeLoadBalancerAttributes(LoadBalancerName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("DescribeLoadBalancerAttributes", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, args...))
...
DescribeLoadBalancerPolicies(args::AbstractDict{String, <: Any}) = elastic_load_balancing("DescribeLoadBalancerPolicies", args)
...
DescribeLoadBalancerPolicyTypes(args::AbstractDict{String, <: Any}) = elastic_load_balancing("DescribeLoadBalancerPolicyTypes", args)
...
DescribeLoadBalancers(args::AbstractDict{String, <: Any}) = elastic_load_balancing("DescribeLoadBalancers", args)
...
"""
DescribeTags(LoadBalancerNames) = elastic_load_balancing("DescribeTags", Dict{String, Any}("LoadBalancerNames"=>LoadBalancerNames))
DescribeTags(LoadBalancerNames, args::AbstractDict{String, <: Any}) = elastic_load_balancing("DescribeTags", Dict{String, Any}("LoadBalancerNames"=>LoadBalancerNames, args...))
...
"""
DetachLoadBalancerFromSubnets(LoadBalancerName, Subnets) = elastic_load_balancing("DetachLoadBalancerFromSubnets", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "Subnets"=>Subnets))
DetachLoadBalancerFromSubnets(LoadBalancerName, Subnets, args::AbstractDict{String, <: Any}) = elastic_load_balancing("DetachLoadBalancerFromSubnets", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "Subnets"=>Subnets, args...))
...
"""
DisableAvailabilityZonesForLoadBalancer(AvailabilityZones, LoadBalancerName) = elastic_load_balancing("DisableAvailabilityZonesForLoadBalancer", Dict{String, Any}("AvailabilityZones"=>AvailabilityZones, "LoadBalancerName"=>LoadBalancerName))
DisableAvailabilityZonesForLoadBalancer(AvailabilityZones, LoadBalancerName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("DisableAvailabilityZonesForLoadBalancer", Dict{String, Any}("AvailabilityZones"=>AvailabilityZones, "LoadBalancerName"=>LoadBalancerName, args...))
...
"""
EnableAvailabilityZonesForLoadBalancer(AvailabilityZones, LoadBalancerName) = elastic_load_balancing("EnableAvailabilityZonesForLoadBalancer", Dict{String, Any}("AvailabilityZones"=>AvailabilityZones, "LoadBalancerName"=>LoadBalancerName))
EnableAvailabilityZonesForLoadBalancer(AvailabilityZones, LoadBalancerName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("EnableAvailabilityZonesForLoadBalancer", Dict{String, Any}("AvailabilityZones"=>AvailabilityZones, "LoadBalancerName"=>LoadBalancerName, args...))
...
"""
ModifyLoadBalancerAttributes(LoadBalancerAttributes, LoadBalancerName) = elastic_load_balancing("ModifyLoadBalancerAttributes", Dict{String, Any}("LoadBalancerAttributes"=>LoadBalancerAttributes, "LoadBalancerName"=>LoadBalancerName))
ModifyLoadBalancerAttributes(LoadBalancerAttributes, LoadBalancerName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("ModifyLoadBalancerAttributes", Dict{String, Any}("LoadBalancerAttributes"=>LoadBalancerAttributes, "LoadBalancerName"=>LoadBalancerName, args...))
...
"""
RegisterInstancesWithLoadBalancer(Instances, LoadBalancerName) = elastic_load_balancing("RegisterInstancesWithLoadBalancer", Dict{String, Any}("Instances"=>Instances, "LoadBalancerName"=>LoadBalancerName))
RegisterInstancesWithLoadBalancer(Instances, LoadBalancerName, args::AbstractDict{String, <: Any}) = elastic_load_balancing("RegisterInstancesWithLoadBalancer", Dict{String, Any}("Instances"=>Instances, "LoadBalancerName"=>LoadBalancerName, args...))
...
"""
RemoveTags(LoadBalancerNames, Tags) = elastic_load_balancing("RemoveTags", Dict{String, Any}("LoadBalancerNames"=>LoadBalancerNames, "Tags"=>Tags))
RemoveTags(LoadBalancerNames, Tags, args::AbstractDict{String, <: Any}) = elastic_load_balancing("RemoveTags", Dict{String, Any}("LoadBalancerNames"=>LoadBalancerNames, "Tags"=>Tags, args...))
...
"""
SetLoadBalancerListenerSSLCertificate(LoadBalancerName, LoadBalancerPort, SSLCertificateId) = elastic_load_balancing("SetLoadBalancerListenerSSLCertificate", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "LoadBalancerPort"=>LoadBalancerPort, "SSLCertificateId"=>SSLCertificateId))
SetLoadBalancerListenerSSLCertificate(LoadBalancerName, LoadBalancerPort, SSLCertificateId, args::AbstractDict{String, <: Any}) = elastic_load_balancing("SetLoadBalancerListenerSSLCertificate", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "LoadBalancerPort"=>LoadBalancerPort, "SSLCertificateId"=>SSLCertificateId, args...))
...
"""
SetLoadBalancerPoliciesForBackendServer(InstancePort, LoadBalancerName, PolicyNames) = elastic_load_balancing("SetLoadBalancerPoliciesForBackendServer", Dict{String, Any}("InstancePort"=>InstancePort, "LoadBalancerName"=>LoadBalancerName, "PolicyNames"=>PolicyNames))
SetLoadBalancerPoliciesForBackendServer(InstancePort, LoadBalancerName, PolicyNames, args::AbstractDict{String, <: Any}) = elastic_load_balancing("SetLoadBalancerPoliciesForBackendServer", Dict{String, Any}("InstancePort"=>InstancePort, "LoadBalancerName"=>LoadBalancerName, "PolicyNames"=>PolicyNames, args...))
...
"""
SetLoadBalancerPoliciesOfListener(LoadBalancerName, LoadBalancerPort, PolicyNames) = elastic_load_balancing("SetLoadBalancerPoliciesOfListener", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "LoadBalancerPort"=>LoadBalancerPort, "PolicyNames"=>PolicyNames))
SetLoadBalancerPoliciesOfListener(LoadBalancerName, LoadBalancerPort, PolicyNames, args::AbstractDict{String, <: Any}) = elastic_load_balancing("SetLoadBalancerPoliciesOfListener", Dict{String, Any}("LoadBalancerName"=>LoadBalancerName, "LoadBalancerPort"=>LoadBalancerPort, "PolicyNames"=>PolicyNames, args...))
