...
AddTagsToStream(StreamName, Tags; aws_config::AWSConfig=AWS.aws_config) = kinesis("AddTagsToStream", Dict{String, Any}("StreamName"=>StreamName, "Tags"=>Tags); aws_config=aws_config)
AddTagsToStream(StreamName, Tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("AddTagsToStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamName"=>StreamName, "Tags"=>Tags), args)); aws_config=aws_config)
...
CreateStream(ShardCount, StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("CreateStream", Dict{String, Any}("ShardCount"=>ShardCount, "StreamName"=>StreamName); aws_config=aws_config)
CreateStream(ShardCount, StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("CreateStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ShardCount"=>ShardCount, "StreamName"=>StreamName), args)); aws_config=aws_config)
...
DecreaseStreamRetentionPeriod(RetentionPeriodHours, StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("DecreaseStreamRetentionPeriod", Dict{String, Any}("RetentionPeriodHours"=>RetentionPeriodHours, "StreamName"=>StreamName); aws_config=aws_config)
DecreaseStreamRetentionPeriod(RetentionPeriodHours, StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("DecreaseStreamRetentionPeriod", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RetentionPeriodHours"=>RetentionPeriodHours, "StreamName"=>StreamName), args)); aws_config=aws_config)
...
DeleteStream(StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("DeleteStream", Dict{String, Any}("StreamName"=>StreamName); aws_config=aws_config)
DeleteStream(StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("DeleteStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamName"=>StreamName), args)); aws_config=aws_config)
...
DeregisterStreamConsumer(; aws_config::AWSConfig=AWS.aws_config) = kinesis("DeregisterStreamConsumer"; aws_config=aws_config)
DeregisterStreamConsumer(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("DeregisterStreamConsumer", args; aws_config=aws_config)
...
DescribeLimits(; aws_config::AWSConfig=AWS.aws_config) = kinesis("DescribeLimits"; aws_config=aws_config)
DescribeLimits(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("DescribeLimits", args; aws_config=aws_config)
...
DescribeStream(StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("DescribeStream", Dict{String, Any}("StreamName"=>StreamName); aws_config=aws_config)
DescribeStream(StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("DescribeStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamName"=>StreamName), args)); aws_config=aws_config)
...
DescribeStreamConsumer(; aws_config::AWSConfig=AWS.aws_config) = kinesis("DescribeStreamConsumer"; aws_config=aws_config)
DescribeStreamConsumer(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("DescribeStreamConsumer", args; aws_config=aws_config)
...
DescribeStreamSummary(StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("DescribeStreamSummary", Dict{String, Any}("StreamName"=>StreamName); aws_config=aws_config)
DescribeStreamSummary(StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("DescribeStreamSummary", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamName"=>StreamName), args)); aws_config=aws_config)
...
DisableEnhancedMonitoring(ShardLevelMetrics, StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("DisableEnhancedMonitoring", Dict{String, Any}("ShardLevelMetrics"=>ShardLevelMetrics, "StreamName"=>StreamName); aws_config=aws_config)
DisableEnhancedMonitoring(ShardLevelMetrics, StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("DisableEnhancedMonitoring", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ShardLevelMetrics"=>ShardLevelMetrics, "StreamName"=>StreamName), args)); aws_config=aws_config)
...
EnableEnhancedMonitoring(ShardLevelMetrics, StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("EnableEnhancedMonitoring", Dict{String, Any}("ShardLevelMetrics"=>ShardLevelMetrics, "StreamName"=>StreamName); aws_config=aws_config)
EnableEnhancedMonitoring(ShardLevelMetrics, StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("EnableEnhancedMonitoring", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ShardLevelMetrics"=>ShardLevelMetrics, "StreamName"=>StreamName), args)); aws_config=aws_config)
...
GetRecords(ShardIterator; aws_config::AWSConfig=AWS.aws_config) = kinesis("GetRecords", Dict{String, Any}("ShardIterator"=>ShardIterator); aws_config=aws_config)
GetRecords(ShardIterator, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("GetRecords", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ShardIterator"=>ShardIterator), args)); aws_config=aws_config)
...
GetShardIterator(ShardId, ShardIteratorType, StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("GetShardIterator", Dict{String, Any}("ShardId"=>ShardId, "ShardIteratorType"=>ShardIteratorType, "StreamName"=>StreamName); aws_config=aws_config)
GetShardIterator(ShardId, ShardIteratorType, StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("GetShardIterator", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ShardId"=>ShardId, "ShardIteratorType"=>ShardIteratorType, "StreamName"=>StreamName), args)); aws_config=aws_config)
...
IncreaseStreamRetentionPeriod(RetentionPeriodHours, StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("IncreaseStreamRetentionPeriod", Dict{String, Any}("RetentionPeriodHours"=>RetentionPeriodHours, "StreamName"=>StreamName); aws_config=aws_config)
IncreaseStreamRetentionPeriod(RetentionPeriodHours, StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("IncreaseStreamRetentionPeriod", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RetentionPeriodHours"=>RetentionPeriodHours, "StreamName"=>StreamName), args)); aws_config=aws_config)
...
ListShards(; aws_config::AWSConfig=AWS.aws_config) = kinesis("ListShards"; aws_config=aws_config)
ListShards(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("ListShards", args; aws_config=aws_config)
...
ListStreamConsumers(StreamARN; aws_config::AWSConfig=AWS.aws_config) = kinesis("ListStreamConsumers", Dict{String, Any}("StreamARN"=>StreamARN); aws_config=aws_config)
ListStreamConsumers(StreamARN, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("ListStreamConsumers", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamARN"=>StreamARN), args)); aws_config=aws_config)
...
ListStreams(; aws_config::AWSConfig=AWS.aws_config) = kinesis("ListStreams"; aws_config=aws_config)
ListStreams(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("ListStreams", args; aws_config=aws_config)
...
ListTagsForStream(StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("ListTagsForStream", Dict{String, Any}("StreamName"=>StreamName); aws_config=aws_config)
ListTagsForStream(StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("ListTagsForStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamName"=>StreamName), args)); aws_config=aws_config)
...
MergeShards(AdjacentShardToMerge, ShardToMerge, StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("MergeShards", Dict{String, Any}("AdjacentShardToMerge"=>AdjacentShardToMerge, "ShardToMerge"=>ShardToMerge, "StreamName"=>StreamName); aws_config=aws_config)
MergeShards(AdjacentShardToMerge, ShardToMerge, StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("MergeShards", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AdjacentShardToMerge"=>AdjacentShardToMerge, "ShardToMerge"=>ShardToMerge, "StreamName"=>StreamName), args)); aws_config=aws_config)
...
PutRecord(Data, PartitionKey, StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("PutRecord", Dict{String, Any}("Data"=>Data, "PartitionKey"=>PartitionKey, "StreamName"=>StreamName); aws_config=aws_config)
PutRecord(Data, PartitionKey, StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("PutRecord", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Data"=>Data, "PartitionKey"=>PartitionKey, "StreamName"=>StreamName), args)); aws_config=aws_config)
...
PutRecords(Records, StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("PutRecords", Dict{String, Any}("Records"=>Records, "StreamName"=>StreamName); aws_config=aws_config)
PutRecords(Records, StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("PutRecords", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Records"=>Records, "StreamName"=>StreamName), args)); aws_config=aws_config)
...
RegisterStreamConsumer(ConsumerName, StreamARN; aws_config::AWSConfig=AWS.aws_config) = kinesis("RegisterStreamConsumer", Dict{String, Any}("ConsumerName"=>ConsumerName, "StreamARN"=>StreamARN); aws_config=aws_config)
RegisterStreamConsumer(ConsumerName, StreamARN, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("RegisterStreamConsumer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConsumerName"=>ConsumerName, "StreamARN"=>StreamARN), args)); aws_config=aws_config)
...
RemoveTagsFromStream(StreamName, TagKeys; aws_config::AWSConfig=AWS.aws_config) = kinesis("RemoveTagsFromStream", Dict{String, Any}("StreamName"=>StreamName, "TagKeys"=>TagKeys); aws_config=aws_config)
RemoveTagsFromStream(StreamName, TagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("RemoveTagsFromStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamName"=>StreamName, "TagKeys"=>TagKeys), args)); aws_config=aws_config)
...
SplitShard(NewStartingHashKey, ShardToSplit, StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("SplitShard", Dict{String, Any}("NewStartingHashKey"=>NewStartingHashKey, "ShardToSplit"=>ShardToSplit, "StreamName"=>StreamName); aws_config=aws_config)
SplitShard(NewStartingHashKey, ShardToSplit, StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("SplitShard", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("NewStartingHashKey"=>NewStartingHashKey, "ShardToSplit"=>ShardToSplit, "StreamName"=>StreamName), args)); aws_config=aws_config)
...
StartStreamEncryption(EncryptionType, KeyId, StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("StartStreamEncryption", Dict{String, Any}("EncryptionType"=>EncryptionType, "KeyId"=>KeyId, "StreamName"=>StreamName); aws_config=aws_config)
StartStreamEncryption(EncryptionType, KeyId, StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("StartStreamEncryption", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EncryptionType"=>EncryptionType, "KeyId"=>KeyId, "StreamName"=>StreamName), args)); aws_config=aws_config)
...
StopStreamEncryption(EncryptionType, KeyId, StreamName; aws_config::AWSConfig=AWS.aws_config) = kinesis("StopStreamEncryption", Dict{String, Any}("EncryptionType"=>EncryptionType, "KeyId"=>KeyId, "StreamName"=>StreamName); aws_config=aws_config)
StopStreamEncryption(EncryptionType, KeyId, StreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("StopStreamEncryption", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EncryptionType"=>EncryptionType, "KeyId"=>KeyId, "StreamName"=>StreamName), args)); aws_config=aws_config)
...
UpdateShardCount(ScalingType, StreamName, TargetShardCount; aws_config::AWSConfig=AWS.aws_config) = kinesis("UpdateShardCount", Dict{String, Any}("ScalingType"=>ScalingType, "StreamName"=>StreamName, "TargetShardCount"=>TargetShardCount); aws_config=aws_config)
UpdateShardCount(ScalingType, StreamName, TargetShardCount, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = kinesis("UpdateShardCount", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ScalingType"=>ScalingType, "StreamName"=>StreamName, "TargetShardCount"=>TargetShardCount), args)); aws_config=aws_config)
