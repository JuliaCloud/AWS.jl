...
overwrites any existing tags that correspond to the specified tag keys.
 ...
 <p> <a>AddTagsToStream</a> has a limit of five transactions per second per account.
...
"""
add_tags_to_stream(Tags; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("AddTagsToStream", Dict{String, Any}("Tags"=>Tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
add_tags_to_stream(Tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("AddTagsToStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Tags"=>Tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
records per second, up to a maximum data write total of 1 MiB per second. If the amount of
...
account used by the application. It is also scoped by Amazon Web Services Region. That is,
two streams in two different accounts can have the same name, and two streams in the same
...
the stream is created, Kinesis Data Streams sets the stream status to `ACTIVE`. You should
...
do one of the following:</p> - Have more than five streams in the `CREATING` state at any
point in time.
...
`StreamStatus`.
 ...
 <p> <a>CreateStream</a> has a limit of five transactions per second per account.
...
- `stream_name`: A name to identify the stream. The stream name is scoped to the Amazon Web
  ...
  accounts can have the same name. Two streams in the same Amazon Web Services account but
...
"""
create_stream(StreamName; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("CreateStream", Dict{String, Any}("StreamName"=>StreamName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_stream(StreamName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("CreateStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamName"=>StreamName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.This operation may result in lost data. For example, if the stream's
retention period is 48 hours and is decreased to 24 hours, any data already in the stream
...
"""
decrease_stream_retention_period(RetentionPeriodHours; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DecreaseStreamRetentionPeriod", Dict{String, Any}("RetentionPeriodHours"=>RetentionPeriodHours); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
decrease_stream_retention_period(RetentionPeriodHours, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DecreaseStreamRetentionPeriod", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RetentionPeriodHours"=>RetentionPeriodHours), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
the following: - Data stream pattern: `arn:aws.*:kinesis:.*:\d{12}:.*stream/\S+`
...
"""
delete_resource_policy(ResourceARN; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DeleteResourcePolicy", Dict{String, Any}("ResourceARN"=>ResourceARN); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_resource_policy(ResourceARN, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DeleteResourcePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.If the stream is in the `ACTIVE` state, you can delete it. After a
...
such as <a>PutRecord</a>, <a>PutRecords</a>, and <a>GetRecords</a>, on a stream in the
...
which is returned in `StreamStatus`.
 ...
 <p> <a>DeleteStream</a> has a limit of five transactions per second per account.

# Optional Parameters

Optional parameters can be passed as a `params::Dict{String,<:Any}`. Valid keys are:

- `"EnforceConsumerDeletion"`: If this parameter is unset (`null`) or if you set it to
...
"""
delete_stream(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DeleteStream"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_stream(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DeleteStream", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
<a>ListStreamConsumers</a> operation to get a list of the descriptions of all the consumers
...
"""
deregister_stream_consumer(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DeregisterStreamConsumer"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
deregister_stream_consumer(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DeregisterStreamConsumer", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_limits(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DescribeLimits"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_limits(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DescribeLimits", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)

"""
    describe_stream()
    describe_stream(params::Dict{String,<:Any})

Describes the specified Kinesis data stream.</p>

!!! note
    This API has been revised. It's highly recommended that you use the
<a>DescribeStreamSummary</a> API to get a summarized description of the specified Kinesis
data stream and the <a>ListShards</a> API to list the shards in a specified data stream and
...
(ARN), creation time, enhanced metric configuration, and shard map. The shard map is an
array of shard objects. For each shard object, there is the hash key and sequence number
ranges that the shard spans, and the IDs of any earlier shards that played in a role in
creating the shard. Every record ingested in the stream is identified by a sequence number,
which is assigned when the record is put into the stream.

You can limit the number of shards returned by each call. For more information, see [Retrieving Shards from a Stream](https://docs.aws.amazon.com/kinesis/latest/dev/kinesis-using-sdk-java-retrieve-shards.html)
...
shard.
 ...
 <p>This operation has a limit of 10 transactions per second per account.
...
- `"ExclusiveStartShardId"`: The shard ID of the shard to start with.
  ...
  Specify this parameter to indicate that you want to describe the stream starting with the
...
"""
describe_stream(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DescribeStream"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_stream(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DescribeStream", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
want to describe, you can use the <a>ListStreamConsumers</a> operation to get a list of the
descriptions of all the consumers that are currently registered with a given data stream.

This operation has a limit of 20 transactions per second per stream.

!!! note
    When making a cross-account call with `DescribeStreamConsumer`, make sure to provide
...
- `"StreamARN"`: The ARN of the Kinesis data stream that the consumer is registered with.
  For more information, see [Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams).
"""
describe_stream_consumer(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DescribeStreamConsumer"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_stream_consumer(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DescribeStreamConsumer", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
details, and open shard count.
 ...
 <p> <a>DescribeStreamSummary</a> has a limit of 20 transactions per second per account.
...
- `"StreamName"`: The name of the stream to describe.
"""
describe_stream_summary(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DescribeStreamSummary"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_stream_summary(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DescribeStreamSummary", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `shard_level_metrics`: List of shard-level metrics to disable.
  ...
  - `IncomingBytes`
   ...
   - `ALL`
  For more information, see [Monitoring the Amazon Kinesis Data Streams Service with Amazon CloudWatch](https://docs.aws.amazon.com/kinesis/latest/dev/monitoring-with-cloudwatch.html)
  in the *Amazon Kinesis Data Streams Developer Guide*.
...
- `"StreamName"`: The name of the Kinesis data stream for which to disable enhanced
  monitoring.
"""
disable_enhanced_monitoring(ShardLevelMetrics; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DisableEnhancedMonitoring", Dict{String, Any}("ShardLevelMetrics"=>ShardLevelMetrics); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
disable_enhanced_monitoring(ShardLevelMetrics, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("DisableEnhancedMonitoring", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ShardLevelMetrics"=>ShardLevelMetrics), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `shard_level_metrics`: List of shard-level metrics to enable.
...
"""
enable_enhanced_monitoring(ShardLevelMetrics; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("EnableEnhancedMonitoring", Dict{String, Any}("ShardLevelMetrics"=>ShardLevelMetrics); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
enable_enhanced_monitoring(ShardLevelMetrics, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("EnableEnhancedMonitoring", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ShardLevelMetrics"=>ShardLevelMetrics), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)

"""
    get_records(shard_iterator)
    get_records(shard_iterator, params::Dict{String,<:Any})

Gets data records from a Kinesis data stream's shard.</p>

!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.Specify a shard iterator using the `ShardIterator` parameter. The shard
...
the iterator points to, <a>GetRecords</a> returns an empty list. It might take multiple
...
(for more information, see [Amazon Kinesis Data Streams Limits](https://docs.aws.amazon.com/kinesis/latest/dev/service-sizes-and-limits.html)
in the *Amazon Kinesis Data Streams Developer Guide*). Your application should have one
thread per shard, each reading continuously from its stream. To read from a stream
continually, call <a>GetRecords</a> in a loop. Use <a>GetShardIterator</a> to get the shard
iterator to specify in the first <a>GetRecords</a> call. <a>GetRecords</a> returns a new
shard iterator in `NextShardIterator`. Specify the shard iterator returned in
`NextShardIterator` in subsequent calls to <a>GetRecords</a>. If the shard has been closed,
the shard iterator can't return more data and <a>GetRecords</a> returns `null` in
...
throughput by using the `Limit` parameter to specify the maximum number of records that
<a>GetRecords</a> can return. Consider your average record size when determining this
limit. The maximum number of records that can be returned per call is 10,000.

The size of the data returned by <a>GetRecords</a> varies depending on the utilization of
the shard. It is recommended that consumer applications retrieve records via the
`GetRecords` command using the 5 TPS limit to remain caught up. Retrieving records less
frequently can lead to consumer applications falling behind. The maximum size of data that
<a>GetRecords</a> can return is 10 MiB. If a call returns this amount of data, subsequent
...
the next 1 second throw `ProvisionedThroughputExceededException`. <a>GetRecords</a> doesn't
return any data when it throws an exception. For this reason, we recommend that you wait 1
second between calls to <a>GetRecords</a>. However, it's possible that the application will
...
metrics and other mechanisms (see [Monitoring](https://docs.aws.amazon.com/kinesis/latest/dev/monitoring.html)
in the *Amazon Kinesis Data Streams Developer Guide*).
...
server-side time stamp, whereas a client-side time stamp is set when a data producer
creates or sends the record to a stream (a data producer is any data source putting data
records into a stream, for example with <a>PutRecords</a>). The time stamp has millisecond
...
stamps that are out of order.
 ...
 <p>This operation has a limit of five transactions per second per shard.

# Arguments

- `shard_iterator`: The position in the shard from which you want to start sequentially
  reading data records. A shard iterator specifies this position using the sequence number
...
- `"StreamARN"`: The ARN of the stream.
"""
get_records(ShardIterator; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("GetRecords", Dict{String, Any}("ShardIterator"=>ShardIterator); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_records(ShardIterator, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("GetRecords", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ShardIterator"=>ShardIterator), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `resource_arn`: The Amazon Resource Name (ARN) of the data stream or consumer.
"""
get_resource_policy(ResourceARN; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("GetResourcePolicy", Dict{String, Any}("ResourceARN"=>ResourceARN); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_resource_policy(ResourceARN, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("GetResourcePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.A shard iterator specifies the shard position from which to start reading
data records sequentially. The position is specified using the sequence number of a data
record in a shard. A sequence number is the identifier associated with every record
ingested in the stream, and is assigned when a record is put into the stream. Each stream
has one or more shards.
...
sequence numbers returned by earlier calls to <a>PutRecord</a>, <a>PutRecords</a>,
...
in the system (the oldest data record in the shard), or `LATEST` so that you always read
the most recent data in the shard.

When you read repeatedly from a stream, use a <a>GetShardIterator</a> request to get the
...
`NextShardIterator`. A new shard iterator is returned by every <a>GetRecords</a> request in
...
<a>GetRecords</a>, and [Streams Limits](https://docs.aws.amazon.com/kinesis/latest/dev/service-sizes-and-limits.html)
in the *Amazon Kinesis Data Streams Developer Guide*.
...
or <a>MergeShards</a>.
 ...
 <p> <a>GetShardIterator</a> has a limit of five transactions per second per account per
open shard.
...
- `shard_iterator_type`: Determines how the shard iterator is used to start reading data
  ...
  The following are the valid Amazon Kinesis shard iterator types: - AT_SEQUENCE_NUMBER -
  Start reading from the position denoted by a specific sequence number, provided in the
...
- `"Timestamp"`: The time stamp of the data record from which to start reading. Used with
  ...
  milliseconds. For example, `2016-04-04T19:58:46.480-00:00` or `1459799926.480`. If a
  record with this exact time stamp does not exist, the iterator returned is for the next
  (later) record. If the time stamp is older than the current trim horizon, the iterator
  returned is for the oldest untrimmed data record (TRIM_HORIZON).
"""
get_shard_iterator(ShardId, ShardIteratorType; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("GetShardIterator", Dict{String, Any}("ShardId"=>ShardId, "ShardIteratorType"=>ShardIteratorType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_shard_iterator(ShardId, ShardIteratorType, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("GetShardIterator", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ShardId"=>ShardId, "ShardIteratorType"=>ShardIteratorType), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
retention period is 8760 hours (365 days).

!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.If you choose a longer stream retention period, this operation increases
the time period during which records that have not yet expired are accessible. However, it
does not make previous, expired data (older than the stream's previous retention period)
accessible after the operation has been called. For example, if a stream's retention period
is set to 24 hours and is increased to 168 hours, any data that is older than 24 hours
...
- `"StreamName"`: The name of the stream to modify.
"""
increase_stream_retention_period(RetentionPeriodHours; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("IncreaseStreamRetentionPeriod", Dict{String, Any}("RetentionPeriodHours"=>RetentionPeriodHours); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
increase_stream_retention_period(RetentionPeriodHours, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("IncreaseStreamRetentionPeriod", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RetentionPeriodHours"=>RetentionPeriodHours), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
a limit of 1000 transactions per second per data stream.

!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.This action does not list expired shards. For information about expired
shards, see [Data Routing, Data Persistence, and Shard State after a Reshard](https://docs.aws.amazon.com/streams/latest/dev/kinesis-using-sdk-java-after-resharding.html#kinesis-using-sdk-java-resharding-data-routing).
...
your policy to allow calls to this API. For more information, see [Controlling Access to Amazon Kinesis Data Streams Resources Using IAM](https://docs.aws.amazon.com/streams/latest/dev/controlling-access.html).
...
- `"ExclusiveStartShardId"`: Specify this parameter to indicate that you want to list the
  shards starting with the shard whose ID immediately follows `ExclusiveStartShardId`.
...
- `"NextToken"`: When the number of shards in the data stream is greater than the default
  ...
  `MaxResults` that is less than the number of shards in the data stream, the response
...
- `"ShardFilter"`: Enables you to filter out the response of the `ListShards` API. You can
  ...
  value for the optional `Timestamp` property. If you specify the AT_TIMESTAMP type, then
  all shards that were open at the provided timestamp are returned. If you specify the
...
You cannot specify this parameter if you specify the `NextToken` parameter.
"""
list_shards(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("ListShards"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_shards(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("ListShards", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `stream_arn`: The ARN of the Kinesis data stream for which you want to list the
  registered consumers. For more information, see [Amazon Resource Names (ARNs) and Amazon Web Services Service Namespaces](https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams).
...
- `"NextToken"`: When the number of consumers that are registered with the data stream is
  ...
  specify a value for `MaxResults` that is less than the number of consumers that are
  registered with the data stream, the response includes a pagination token named
...
"""
list_stream_consumers(StreamARN; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("ListStreamConsumers", Dict{String, Any}("StreamARN"=>StreamARN); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_stream_consumers(StreamARN, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("ListStreamConsumers", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamARN"=>StreamARN), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
can limit the number of returned streams using the `Limit` parameter. If you do not specify
a value for the `Limit` parameter, Kinesis Data Streams uses the default limit, which is
currently 100.
...
- `"NextToken"`: <p/>
"""
list_streams(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("ListStreams"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_streams(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("ListStreams", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"StreamName"`: The name of the stream.
"""
list_tags_for_stream(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("ListTagsForStream"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_tags_for_stream(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("ListTagsForStream", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
shard receives data for all hash key values covered by the two parent shards.</p>

!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API. `MergeShards` is called when there is a need to reduce the overall
capacity of a stream because of excess capacity that is not being used. You must specify
the shard to be merged and the adjacent shard for a stream. For more information about
...
You use <a>DescribeStreamSummary</a> and the <a>ListShards</a> APIs to determine the shard
IDs that are specified in the `MergeShards` request.

If you try to operate on too many streams in parallel using <a>CreateStream</a>,
<a>DeleteStream</a>, `MergeShards`, or <a>SplitShard</a>, you receive a
`LimitExceededException`.

 <p> `MergeShards` has a limit of five transactions per second per account.
...
"""
merge_shards(AdjacentShardToMerge, ShardToMerge; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("MergeShards", Dict{String, Any}("AdjacentShardToMerge"=>AdjacentShardToMerge, "ShardToMerge"=>ShardToMerge); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
merge_shards(AdjacentShardToMerge, ShardToMerge, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("MergeShards", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AdjacentShardToMerge"=>AdjacentShardToMerge, "ShardToMerge"=>ShardToMerge), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
write total of 1 MiB per second.</p>

!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.You must specify the name of the stream that captures, stores, and
...
Data Streams segregates the data records that belong to a stream into multiple shards,
...
key. An MD5 hash function is used to map partition keys to 128-bit integer values and to
map associated data records to shards using the hash key ranges of the shards. You can
override hashing the partition key to determine the shard by explicitly specifying a hash
value using the `ExplicitHashKey` parameter. For more information, see [Adding Data to a Stream](https://docs.aws.amazon.com/kinesis/latest/dev/developing-producers-with-sdk.html#kinesis-using-sdk-java-add-data-to-stream)
in the *Amazon Kinesis Data Streams Developer Guide*.
...
shard and use the `SequenceNumberForOrdering` parameter. For more information, see [Adding Data to a Stream](https://docs.aws.amazon.com/kinesis/latest/dev/developing-producers-with-sdk.html#kinesis-using-sdk-java-add-data-to-stream)
in the *Amazon Kinesis Data Streams Developer Guide*.

!!! important
    After you write a record to a stream, you cannot modify that record or its order within
the stream.If a `PutRecord` request cannot be processed because of insufficient provisioned
...
to a stream. You can use <a>IncreaseStreamRetentionPeriod</a> or
...
- `"SequenceNumberForOrdering"`: Guarantees strictly increasing sequence numbers, for puts
  ...
  `SequenceNumberForOrdering` of record *n* to the sequence number of record *n-1* (as
  returned in the result when putting record *n-1*). If this parameter is not set, records
  are coarsely ordered based on arrival time.
- `"StreamARN"`: The ARN of the stream.
- `"StreamName"`: The name of the stream to put the data record into.
"""
put_record(Data, PartitionKey; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("PutRecord", Dict{String, Any}("Data"=>Data, "PartitionKey"=>PartitionKey); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_record(Data, PartitionKey, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("PutRecord", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Data"=>Data, "PartitionKey"=>PartitionKey), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.Each `PutRecords` request can support up to 500 records. Each record in the
request can be as large as 1 MiB, up to a limit of 5 MiB for the entire request, including
partition keys. Each shard can support writes up to 1,000 records per second, up to a
...
data blob. The record size limit applies to the total size of the partition key and data
blob.
...
same shard within the stream. For more information, see [Adding Data to a Stream](https://docs.aws.amazon.com/kinesis/latest/dev/developing-producers-with-sdk.html#kinesis-using-sdk-java-add-data-to-stream)
in the *Amazon Kinesis Data Streams Developer Guide*.
...
to determine explicitly the shard where the record is stored. For more information, see [Adding Multiple Records with PutRecords](https://docs.aws.amazon.com/kinesis/latest/dev/developing-producers-with-sdk.html#kinesis-using-sdk-java-putrecords)
in the *Amazon Kinesis Data Streams Developer Guide*.
...
records. Kinesis Data Streams attempts to process all records in each `PutRecords` request.
A single record failure does not stop the processing of subsequent records. As a result,
PutRecords doesn't guarantee the ordering of records. If you need to read records in the
same order they are written to the stream, use <a>PutRecord</a> instead of `PutRecords`,
...
records in the stream.
 ...
 <p>An unsuccessfully processed record includes `ErrorCode` and `ErrorMessage` values.
...
information about partially successful responses, see [Adding Multiple Records with PutRecords](https://docs.aws.amazon.com/kinesis/latest/dev/kinesis-using-sdk-java-add-data-to-stream.html#kinesis-using-sdk-java-putrecords)
in the *Amazon Kinesis Data Streams Developer Guide*.

!!! important
    After you write a record to a stream, you cannot modify that record or its order within
the stream.By default, data records are accessible for 24 hours from the time that they are
...
"""
put_records(Records; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("PutRecords", Dict{String, Any}("Records"=>Records); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_records(Records, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("PutRecords", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Records"=>Records), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
resource, the calling identity must have the `PutResourcePolicy` permissions on the
specified Kinesis Data Streams resource and belong to the owner's account in order to use
this operation. If you don't have `PutResourcePolicy` permissions, Amazon Kinesis Data
Streams returns a `403 Access Denied error`. If you receive a `ResourceNotFoundException`,
check to see if you passed a valid stream or consumer resource.

 Request patterns can be one of the following: - Data stream pattern:
...
- `resource_arn`: The Amazon Resource Name (ARN) of the data stream or consumer.
"""
put_resource_policy(Policy, ResourceARN; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("PutResourcePolicy", Dict{String, Any}("Policy"=>Policy, "ResourceARN"=>ResourceARN); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_resource_policy(Policy, ResourceARN, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("PutResourcePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Policy"=>Policy, "ResourceARN"=>ResourceARN), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
you register can then call <a>SubscribeToShard</a> to receive data from the stream using
enhanced fan-out, at a rate of up to 2 MiB per second for every shard you subscribe to.
...
consumers in a `CREATING` status at the same time. Registering a 6th consumer while there
are 5 in a `CREATING` status results in a `LimitExceededException`.
...
"""
register_stream_consumer(ConsumerName, StreamARN; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("RegisterStreamConsumer", Dict{String, Any}("ConsumerName"=>ConsumerName, "StreamARN"=>StreamARN); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
register_stream_consumer(ConsumerName, StreamARN, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("RegisterStreamConsumer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConsumerName"=>ConsumerName, "StreamARN"=>StreamARN), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
recovered after this operation successfully completes.</p>

!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.If you specify a tag that does not exist, it is ignored.

 <p> <a>RemoveTagsFromStream</a> has a limit of five transactions per second per account.
...
- `"StreamName"`: The name of the stream.
"""
remove_tags_from_stream(TagKeys; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("RemoveTagsFromStream", Dict{String, Any}("TagKeys"=>TagKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
remove_tags_from_stream(TagKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("RemoveTagsFromStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TagKeys"=>TagKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.You can also use `SplitShard` when a shard appears to be approaching its
maximum utilization; for example, the producers sending data into the specific shard are
suddenly sending more than previously anticipated. You can also call `SplitShard` to
increase stream capacity, so that more Kinesis Data Streams applications can simultaneously
...
being mapped into the shard. For more information, see [Split a Shard](https://docs.aws.amazon.com/kinesis/latest/dev/kinesis-using-sdk-java-resharding-split.html)
in the *Amazon Kinesis Data Streams Developer Guide*.

You can use <a>DescribeStreamSummary</a> and the <a>ListShards</a> APIs to determine the
shard ID and hash key values for the `ShardToSplit` and `NewStartingHashKey` parameters
...
Data Streams immediately returns a response and sets the stream status to `UPDATING`. After
the operation is completed, Kinesis Data Streams sets the stream status to `ACTIVE`. Read
and write operations continue to work while the stream is in the `UPDATING` state.

You can use <a>DescribeStreamSummary</a> to check the status of the stream, which is
...
For the default shard limit for an Amazon Web Services account, see [Kinesis Data Streams Limits](https://docs.aws.amazon.com/kinesis/latest/dev/service-sizes-and-limits.html)
in the *Amazon Kinesis Data Streams Developer Guide*. To increase this limit, [contact Amazon Web Services Support](https://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html).
...
`LimitExceededException`.
 ...
 <p> `SplitShard` has a limit of five transactions per second per account.
...
- `new_starting_hash_key`: A hash key value for the starting hash key of one of the child
  ...
  ordered contiguous positive integers. The value for `NewStartingHashKey` must be in the
  range of hash keys being mapped into the shard. The `NewStartingHashKey` hash key value
...
"""
split_shard(NewStartingHashKey, ShardToSplit; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("SplitShard", Dict{String, Any}("NewStartingHashKey"=>NewStartingHashKey, "ShardToSplit"=>ShardToSplit); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
split_shard(NewStartingHashKey, ShardToSplit, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("SplitShard", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("NewStartingHashKey"=>NewStartingHashKey, "ShardToSplit"=>ShardToSplit), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.Starting encryption is an asynchronous operation. Upon receiving the
request, Kinesis Data Streams returns immediately and sets the status of the stream to
`UPDATING`. After the update is complete, Kinesis Data Streams sets the status of the
stream back to `ACTIVE`. Updating or applying encryption normally takes a few seconds to
complete, but it can take minutes. You can continue to read and write data to your stream
...
encryption 25 times in a rolling 24-hour period.
 ...
 <p>Note: It can take up to 5 seconds after the stream is in an `ACTIVE` status before all
records written to the stream are encrypted. After you enable encryption, you can verify
that encryption is applied by inspecting the API response from `PutRecord` or `PutRecords`.
...
- `key_id`: The GUID for the customer-managed Amazon Web Services KMS key to use for
  ...
  alias `aws/kinesis`. - Key ARN example: `arn:aws:kms:us-east-1:123456789012:key/12345678-
...
"""
start_stream_encryption(EncryptionType, KeyId; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("StartStreamEncryption", Dict{String, Any}("EncryptionType"=>EncryptionType, "KeyId"=>KeyId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_stream_encryption(EncryptionType, KeyId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("StartStreamEncryption", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EncryptionType"=>EncryptionType, "KeyId"=>KeyId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)

"""
    stop_stream_encryption(encryption_type, key_id)
    stop_stream_encryption(encryption_type, key_id, params::Dict{String,<:Any})

Disables server-side encryption for a specified stream. </p>

!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.Stopping encryption is an asynchronous operation. Upon receiving the
request, Kinesis Data Streams returns immediately and sets the status of the stream to
`UPDATING`. After the update is complete, Kinesis Data Streams sets the status of the
stream back to `ACTIVE`. Stopping encryption normally takes a few seconds to complete, but
it can take minutes. You can continue to read and write data to your stream while its
...
API Limits: You can successfully disable server-side encryption 25 times in a rolling 24-
hour period.
...
"""
stop_stream_encryption(EncryptionType, KeyId; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("StopStreamEncryption", Dict{String, Any}("EncryptionType"=>EncryptionType, "KeyId"=>KeyId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
stop_stream_encryption(EncryptionType, KeyId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("StopStreamEncryption", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EncryptionType"=>EncryptionType, "KeyId"=>KeyId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
!!! note
    When invoking this API, you must use either the `StreamARN` or the `StreamName`
parameter, or both. It is recommended that you use the `StreamARN` input parameter when you
invoke this API.Updating the shard count is an asynchronous operation. Upon receiving the
request, Kinesis Data Streams returns immediately and sets the status of the stream to
`UPDATING`. After the update is complete, Kinesis Data Streams sets the status of the
stream back to `ACTIVE`. Depending on the size of the stream, the scaling action could take
a few minutes to complete. You can continue to read and write data to your stream while its
status is `UPDATING`.

To update the shard count, Kinesis Data Streams performs splits or merges on individual
shards. This can cause short-lived shards to be created, in addition to the final shards.
These short-lived shards count towards your total shard limit for your account in the
Region.
...
limit. However, if you specify a target that isn't a multiple of 25%, the scaling action
might take longer to complete.

 <p>This operation has the following default limits. By default, you cannot do the
following: - Scale more than ten times per rolling 24-hour period per stream
...
- `target_shard_count`: The new number of shards. This value has the following default
  limits. By default, you cannot do the following:  - Set this value to more than double
  ...
  count per stream is 10000 per account per region), unless you request a limit increase.
   - Scale a stream with more than 10000 shards down unless you set this value to less than
  10000 shards.
...
- `"StreamName"`: The name of the stream.
"""
update_shard_count(ScalingType, TargetShardCount; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("UpdateShardCount", Dict{String, Any}("ScalingType"=>ScalingType, "TargetShardCount"=>TargetShardCount); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_shard_count(ScalingType, TargetShardCount, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("UpdateShardCount", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ScalingType"=>ScalingType, "TargetShardCount"=>TargetShardCount), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_stream_mode(StreamARN, StreamModeDetails; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("UpdateStreamMode", Dict{String, Any}("StreamARN"=>StreamARN, "StreamModeDetails"=>StreamModeDetails); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_stream_mode(StreamARN, StreamModeDetails, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis("UpdateStreamMode", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamARN"=>StreamARN, "StreamModeDetails"=>StreamModeDetails), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
