...
- `"StreamCreationTimestamp"`: Specify this input parameter to distinguish data streams
  ...
  this parameter if you specify the NextToken parameter.
"""
function list_stream_consumers(StreamARN; aws_config::AbstractAWSConfig=current_aws_config())
    return kinesis(
        "ListStreamConsumers",
...
function put_records(
    Records, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return kinesis(
        "PutRecords",
...
- `"StreamName"`: The name of the stream.
"""
function remove_tags_from_stream(TagKeys; aws_config::AbstractAWSConfig=current_aws_config())
    return kinesis(
...
function remove_tags_from_stream(
    TagKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return kinesis(
        "RemoveTagsFromStream",
