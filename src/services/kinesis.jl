...
"""
AddTagsToStream(StreamName, Tags) = kinesis("AddTagsToStream", Dict{String, Any}("StreamName"=>StreamName, "Tags"=>Tags))
AddTagsToStream(StreamName, Tags, args::AbstractDict{String, <: Any}) = kinesis("AddTagsToStream", Dict{String, Any}("StreamName"=>StreamName, "Tags"=>Tags, args...))
...
"""
CreateStream(ShardCount, StreamName) = kinesis("CreateStream", Dict{String, Any}("ShardCount"=>ShardCount, "StreamName"=>StreamName))
CreateStream(ShardCount, StreamName, args::AbstractDict{String, <: Any}) = kinesis("CreateStream", Dict{String, Any}("ShardCount"=>ShardCount, "StreamName"=>StreamName, args...))
...
"""
DecreaseStreamRetentionPeriod(RetentionPeriodHours, StreamName) = kinesis("DecreaseStreamRetentionPeriod", Dict{String, Any}("RetentionPeriodHours"=>RetentionPeriodHours, "StreamName"=>StreamName))
DecreaseStreamRetentionPeriod(RetentionPeriodHours, StreamName, args::AbstractDict{String, <: Any}) = kinesis("DecreaseStreamRetentionPeriod", Dict{String, Any}("RetentionPeriodHours"=>RetentionPeriodHours, "StreamName"=>StreamName, args...))
...
"""
DeleteStream(StreamName) = kinesis("DeleteStream", Dict{String, Any}("StreamName"=>StreamName))
DeleteStream(StreamName, args::AbstractDict{String, <: Any}) = kinesis("DeleteStream", Dict{String, Any}("StreamName"=>StreamName, args...))
...
DeregisterStreamConsumer(args::AbstractDict{String, <: Any}) = kinesis("DeregisterStreamConsumer", args)
...
DescribeLimits(args::AbstractDict{String, <: Any}) = kinesis("DescribeLimits", args)
...
"""
DescribeStream(StreamName) = kinesis("DescribeStream", Dict{String, Any}("StreamName"=>StreamName))
DescribeStream(StreamName, args::AbstractDict{String, <: Any}) = kinesis("DescribeStream", Dict{String, Any}("StreamName"=>StreamName, args...))
...
DescribeStreamConsumer(args::AbstractDict{String, <: Any}) = kinesis("DescribeStreamConsumer", args)
...
"""
DescribeStreamSummary(StreamName) = kinesis("DescribeStreamSummary", Dict{String, Any}("StreamName"=>StreamName))
DescribeStreamSummary(StreamName, args::AbstractDict{String, <: Any}) = kinesis("DescribeStreamSummary", Dict{String, Any}("StreamName"=>StreamName, args...))
...
"""
DisableEnhancedMonitoring(ShardLevelMetrics, StreamName) = kinesis("DisableEnhancedMonitoring", Dict{String, Any}("ShardLevelMetrics"=>ShardLevelMetrics, "StreamName"=>StreamName))
DisableEnhancedMonitoring(ShardLevelMetrics, StreamName, args::AbstractDict{String, <: Any}) = kinesis("DisableEnhancedMonitoring", Dict{String, Any}("ShardLevelMetrics"=>ShardLevelMetrics, "StreamName"=>StreamName, args...))
...
"""
EnableEnhancedMonitoring(ShardLevelMetrics, StreamName) = kinesis("EnableEnhancedMonitoring", Dict{String, Any}("ShardLevelMetrics"=>ShardLevelMetrics, "StreamName"=>StreamName))
EnableEnhancedMonitoring(ShardLevelMetrics, StreamName, args::AbstractDict{String, <: Any}) = kinesis("EnableEnhancedMonitoring", Dict{String, Any}("ShardLevelMetrics"=>ShardLevelMetrics, "StreamName"=>StreamName, args...))
...
"""
GetRecords(ShardIterator) = kinesis("GetRecords", Dict{String, Any}("ShardIterator"=>ShardIterator))
GetRecords(ShardIterator, args::AbstractDict{String, <: Any}) = kinesis("GetRecords", Dict{String, Any}("ShardIterator"=>ShardIterator, args...))
...
"""
GetShardIterator(ShardId, ShardIteratorType, StreamName) = kinesis("GetShardIterator", Dict{String, Any}("ShardId"=>ShardId, "ShardIteratorType"=>ShardIteratorType, "StreamName"=>StreamName))
GetShardIterator(ShardId, ShardIteratorType, StreamName, args::AbstractDict{String, <: Any}) = kinesis("GetShardIterator", Dict{String, Any}("ShardId"=>ShardId, "ShardIteratorType"=>ShardIteratorType, "StreamName"=>StreamName, args...))
...
"""
IncreaseStreamRetentionPeriod(RetentionPeriodHours, StreamName) = kinesis("IncreaseStreamRetentionPeriod", Dict{String, Any}("RetentionPeriodHours"=>RetentionPeriodHours, "StreamName"=>StreamName))
IncreaseStreamRetentionPeriod(RetentionPeriodHours, StreamName, args::AbstractDict{String, <: Any}) = kinesis("IncreaseStreamRetentionPeriod", Dict{String, Any}("RetentionPeriodHours"=>RetentionPeriodHours, "StreamName"=>StreamName, args...))
...
ListShards(args::AbstractDict{String, <: Any}) = kinesis("ListShards", args)
...
"""
ListStreamConsumers(StreamARN) = kinesis("ListStreamConsumers", Dict{String, Any}("StreamARN"=>StreamARN))
ListStreamConsumers(StreamARN, args::AbstractDict{String, <: Any}) = kinesis("ListStreamConsumers", Dict{String, Any}("StreamARN"=>StreamARN, args...))
...
ListStreams(args::AbstractDict{String, <: Any}) = kinesis("ListStreams", args)
...
"""
ListTagsForStream(StreamName) = kinesis("ListTagsForStream", Dict{String, Any}("StreamName"=>StreamName))
ListTagsForStream(StreamName, args::AbstractDict{String, <: Any}) = kinesis("ListTagsForStream", Dict{String, Any}("StreamName"=>StreamName, args...))
...
"""
MergeShards(AdjacentShardToMerge, ShardToMerge, StreamName) = kinesis("MergeShards", Dict{String, Any}("AdjacentShardToMerge"=>AdjacentShardToMerge, "ShardToMerge"=>ShardToMerge, "StreamName"=>StreamName))
MergeShards(AdjacentShardToMerge, ShardToMerge, StreamName, args::AbstractDict{String, <: Any}) = kinesis("MergeShards", Dict{String, Any}("AdjacentShardToMerge"=>AdjacentShardToMerge, "ShardToMerge"=>ShardToMerge, "StreamName"=>StreamName, args...))
...
"""
PutRecord(Data, PartitionKey, StreamName) = kinesis("PutRecord", Dict{String, Any}("Data"=>Data, "PartitionKey"=>PartitionKey, "StreamName"=>StreamName))
PutRecord(Data, PartitionKey, StreamName, args::AbstractDict{String, <: Any}) = kinesis("PutRecord", Dict{String, Any}("Data"=>Data, "PartitionKey"=>PartitionKey, "StreamName"=>StreamName, args...))
...
"""
PutRecords(Records, StreamName) = kinesis("PutRecords", Dict{String, Any}("Records"=>Records, "StreamName"=>StreamName))
PutRecords(Records, StreamName, args::AbstractDict{String, <: Any}) = kinesis("PutRecords", Dict{String, Any}("Records"=>Records, "StreamName"=>StreamName, args...))
...
"""
RegisterStreamConsumer(ConsumerName, StreamARN) = kinesis("RegisterStreamConsumer", Dict{String, Any}("ConsumerName"=>ConsumerName, "StreamARN"=>StreamARN))
RegisterStreamConsumer(ConsumerName, StreamARN, args::AbstractDict{String, <: Any}) = kinesis("RegisterStreamConsumer", Dict{String, Any}("ConsumerName"=>ConsumerName, "StreamARN"=>StreamARN, args...))
...
"""
RemoveTagsFromStream(StreamName, TagKeys) = kinesis("RemoveTagsFromStream", Dict{String, Any}("StreamName"=>StreamName, "TagKeys"=>TagKeys))
RemoveTagsFromStream(StreamName, TagKeys, args::AbstractDict{String, <: Any}) = kinesis("RemoveTagsFromStream", Dict{String, Any}("StreamName"=>StreamName, "TagKeys"=>TagKeys, args...))
...
"""
SplitShard(NewStartingHashKey, ShardToSplit, StreamName) = kinesis("SplitShard", Dict{String, Any}("NewStartingHashKey"=>NewStartingHashKey, "ShardToSplit"=>ShardToSplit, "StreamName"=>StreamName))
SplitShard(NewStartingHashKey, ShardToSplit, StreamName, args::AbstractDict{String, <: Any}) = kinesis("SplitShard", Dict{String, Any}("NewStartingHashKey"=>NewStartingHashKey, "ShardToSplit"=>ShardToSplit, "StreamName"=>StreamName, args...))
...
"""
StartStreamEncryption(EncryptionType, KeyId, StreamName) = kinesis("StartStreamEncryption", Dict{String, Any}("EncryptionType"=>EncryptionType, "KeyId"=>KeyId, "StreamName"=>StreamName))
StartStreamEncryption(EncryptionType, KeyId, StreamName, args::AbstractDict{String, <: Any}) = kinesis("StartStreamEncryption", Dict{String, Any}("EncryptionType"=>EncryptionType, "KeyId"=>KeyId, "StreamName"=>StreamName, args...))
...
"""
StopStreamEncryption(EncryptionType, KeyId, StreamName) = kinesis("StopStreamEncryption", Dict{String, Any}("EncryptionType"=>EncryptionType, "KeyId"=>KeyId, "StreamName"=>StreamName))
StopStreamEncryption(EncryptionType, KeyId, StreamName, args::AbstractDict{String, <: Any}) = kinesis("StopStreamEncryption", Dict{String, Any}("EncryptionType"=>EncryptionType, "KeyId"=>KeyId, "StreamName"=>StreamName, args...))
...
"""
UpdateShardCount(ScalingType, StreamName, TargetShardCount) = kinesis("UpdateShardCount", Dict{String, Any}("ScalingType"=>ScalingType, "StreamName"=>StreamName, "TargetShardCount"=>TargetShardCount))
UpdateShardCount(ScalingType, StreamName, TargetShardCount, args::AbstractDict{String, <: Any}) = kinesis("UpdateShardCount", Dict{String, Any}("ScalingType"=>ScalingType, "StreamName"=>StreamName, "TargetShardCount"=>TargetShardCount, args...))
