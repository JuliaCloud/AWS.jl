...
CreateApiKey(args::AbstractDict{String, Any}) = api_gateway("POST", "/apikeys", args)
...
"""
CreateAuthorizer(name, restapi_id, type) = api_gateway("POST", "/restapis/$(restapi_id)/authorizers", Dict{String, Any}("name"=>name, "type"=>type))
CreateAuthorizer(name, restapi_id, type, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/restapis/$(restapi_id)/authorizers", Dict{String, Any}("name"=>name, "type"=>type, args...))
...
"""
CreateBasePathMapping(domain_name, restApiId) = api_gateway("POST", "/domainnames/$(domain_name)/basepathmappings", Dict{String, Any}("restApiId"=>restApiId))
CreateBasePathMapping(domain_name, restApiId, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/domainnames/$(domain_name)/basepathmappings", Dict{String, Any}("restApiId"=>restApiId, args...))
...
"""
CreateDeployment(restapi_id) = api_gateway("POST", "/restapis/$(restapi_id)/deployments")
CreateDeployment(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/restapis/$(restapi_id)/deployments", args)
...
"""
CreateDocumentationPart(location, properties, restapi_id) = api_gateway("POST", "/restapis/$(restapi_id)/documentation/parts", Dict{String, Any}("location"=>location, "properties"=>properties))
CreateDocumentationPart(location, properties, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/restapis/$(restapi_id)/documentation/parts", Dict{String, Any}("location"=>location, "properties"=>properties, args...))
...
"""
CreateDocumentationVersion(documentationVersion, restapi_id) = api_gateway("POST", "/restapis/$(restapi_id)/documentation/versions", Dict{String, Any}("documentationVersion"=>documentationVersion))
CreateDocumentationVersion(documentationVersion, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/restapis/$(restapi_id)/documentation/versions", Dict{String, Any}("documentationVersion"=>documentationVersion, args...))
...
- `tags`: The key-value map of strings. The valid character set is [a-zA-Z+-=._:/]. The tag key can be up to 128 characters and must not start with aws:. The tag value can be up to 256 characters.
"""
CreateDomainName(domainName) = api_gateway("POST", "/domainnames", Dict{String, Any}("domainName"=>domainName))
CreateDomainName(domainName, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/domainnames", Dict{String, Any}("domainName"=>domainName, args...))
...
"""
CreateModel(contentType, name, restapi_id) = api_gateway("POST", "/restapis/$(restapi_id)/models", Dict{String, Any}("contentType"=>contentType, "name"=>name))
CreateModel(contentType, name, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/restapis/$(restapi_id)/models", Dict{String, Any}("contentType"=>contentType, "name"=>name, args...))
...
"""
CreateRequestValidator(restapi_id) = api_gateway("POST", "/restapis/$(restapi_id)/requestvalidators")
CreateRequestValidator(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/restapis/$(restapi_id)/requestvalidators", args)
...
"""
CreateResource(parent_id, pathPart, restapi_id) = api_gateway("POST", "/restapis/$(restapi_id)/resources/$(parent_id)", Dict{String, Any}("pathPart"=>pathPart))
CreateResource(parent_id, pathPart, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/restapis/$(restapi_id)/resources/$(parent_id)", Dict{String, Any}("pathPart"=>pathPart, args...))
...
"""
CreateRestApi(name) = api_gateway("POST", "/restapis", Dict{String, Any}("name"=>name))
CreateRestApi(name, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/restapis", Dict{String, Any}("name"=>name, args...))
...
"""
CreateStage(deploymentId, restapi_id, stageName) = api_gateway("POST", "/restapis/$(restapi_id)/stages", Dict{String, Any}("deploymentId"=>deploymentId, "stageName"=>stageName))
CreateStage(deploymentId, restapi_id, stageName, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/restapis/$(restapi_id)/stages", Dict{String, Any}("deploymentId"=>deploymentId, "stageName"=>stageName, args...))
...
"""
CreateUsagePlan(name) = api_gateway("POST", "/usageplans", Dict{String, Any}("name"=>name))
CreateUsagePlan(name, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/usageplans", Dict{String, Any}("name"=>name, args...))
...
"""
CreateUsagePlanKey(keyId, keyType, usageplanId) = api_gateway("POST", "/usageplans/$(usageplanId)/keys", Dict{String, Any}("keyId"=>keyId, "keyType"=>keyType))
CreateUsagePlanKey(keyId, keyType, usageplanId, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/usageplans/$(usageplanId)/keys", Dict{String, Any}("keyId"=>keyId, "keyType"=>keyType, args...))
...
- `tags`: The key-value map of strings. The valid character set is [a-zA-Z+-=._:/]. The tag key can be up to 128 characters and must not start with aws:. The tag value can be up to 256 characters.
"""
CreateVpcLink(name, targetArns) = api_gateway("POST", "/vpclinks", Dict{String, Any}("name"=>name, "targetArns"=>targetArns))
CreateVpcLink(name, targetArns, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/vpclinks", Dict{String, Any}("name"=>name, "targetArns"=>targetArns, args...))
...
"""
DeleteApiKey(api_Key) = api_gateway("DELETE", "/apikeys/$(api_Key)")
DeleteApiKey(api_Key, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/apikeys/$(api_Key)", args)
...
"""
DeleteAuthorizer(authorizer_id, restapi_id) = api_gateway("DELETE", "/restapis/$(restapi_id)/authorizers/$(authorizer_id)")
DeleteAuthorizer(authorizer_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/authorizers/$(authorizer_id)", args)
...
"""
DeleteBasePathMapping(base_path, domain_name) = api_gateway("DELETE", "/domainnames/$(domain_name)/basepathmappings/$(base_path)")
DeleteBasePathMapping(base_path, domain_name, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/domainnames/$(domain_name)/basepathmappings/$(base_path)", args)
...
"""
DeleteClientCertificate(clientcertificate_id) = api_gateway("DELETE", "/clientcertificates/$(clientcertificate_id)")
DeleteClientCertificate(clientcertificate_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/clientcertificates/$(clientcertificate_id)", args)
...
"""
DeleteDeployment(deployment_id, restapi_id) = api_gateway("DELETE", "/restapis/$(restapi_id)/deployments/$(deployment_id)")
DeleteDeployment(deployment_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/deployments/$(deployment_id)", args)
...
"""
DeleteDocumentationPart(part_id, restapi_id) = api_gateway("DELETE", "/restapis/$(restapi_id)/documentation/parts/$(part_id)")
DeleteDocumentationPart(part_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/documentation/parts/$(part_id)", args)
...
"""
DeleteDocumentationVersion(doc_version, restapi_id) = api_gateway("DELETE", "/restapis/$(restapi_id)/documentation/versions/$(doc_version)")
DeleteDocumentationVersion(doc_version, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/documentation/versions/$(doc_version)", args)
...
"""
DeleteDomainName(domain_name) = api_gateway("DELETE", "/domainnames/$(domain_name)")
DeleteDomainName(domain_name, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/domainnames/$(domain_name)", args)
...
"""
DeleteGatewayResponse(response_type, restapi_id) = api_gateway("DELETE", "/restapis/$(restapi_id)/gatewayresponses/$(response_type)")
DeleteGatewayResponse(response_type, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/gatewayresponses/$(response_type)", args)
...
"""
DeleteIntegration(http_method, resource_id, restapi_id) = api_gateway("DELETE", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration")
DeleteIntegration(http_method, resource_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration", args)
...
"""
DeleteIntegrationResponse(http_method, resource_id, restapi_id, status_code) = api_gateway("DELETE", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration/responses/$(status_code)")
DeleteIntegrationResponse(http_method, resource_id, restapi_id, status_code, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration/responses/$(status_code)", args)
...
"""
DeleteMethod(http_method, resource_id, restapi_id) = api_gateway("DELETE", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)")
DeleteMethod(http_method, resource_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)", args)
...
"""
DeleteMethodResponse(http_method, resource_id, restapi_id, status_code) = api_gateway("DELETE", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/responses/$(status_code)")
DeleteMethodResponse(http_method, resource_id, restapi_id, status_code, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/responses/$(status_code)", args)
...
"""
DeleteModel(model_name, restapi_id) = api_gateway("DELETE", "/restapis/$(restapi_id)/models/$(model_name)")
DeleteModel(model_name, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/models/$(model_name)", args)
...
"""
DeleteRequestValidator(requestvalidator_id, restapi_id) = api_gateway("DELETE", "/restapis/$(restapi_id)/requestvalidators/$(requestvalidator_id)")
DeleteRequestValidator(requestvalidator_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/requestvalidators/$(requestvalidator_id)", args)
...
"""
DeleteResource(resource_id, restapi_id) = api_gateway("DELETE", "/restapis/$(restapi_id)/resources/$(resource_id)")
DeleteResource(resource_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/resources/$(resource_id)", args)
...
"""
DeleteRestApi(restapi_id) = api_gateway("DELETE", "/restapis/$(restapi_id)")
DeleteRestApi(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)", args)
...
"""
DeleteStage(restapi_id, stage_name) = api_gateway("DELETE", "/restapis/$(restapi_id)/stages/$(stage_name)")
DeleteStage(restapi_id, stage_name, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/stages/$(stage_name)", args)
...
DeleteUsagePlan(usageplanId, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/usageplans/$(usageplanId)", args)
...
DeleteUsagePlanKey(keyId, usageplanId, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/usageplans/$(usageplanId)/keys/$(keyId)", args)
...
"""
DeleteVpcLink(vpclink_id) = api_gateway("DELETE", "/vpclinks/$(vpclink_id)")
DeleteVpcLink(vpclink_id, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/vpclinks/$(vpclink_id)", args)
...
"""
FlushStageAuthorizersCache(restapi_id, stage_name) = api_gateway("DELETE", "/restapis/$(restapi_id)/stages/$(stage_name)/cache/authorizers")
FlushStageAuthorizersCache(restapi_id, stage_name, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/stages/$(stage_name)/cache/authorizers", args)
...
"""
FlushStageCache(restapi_id, stage_name) = api_gateway("DELETE", "/restapis/$(restapi_id)/stages/$(stage_name)/cache/data")
FlushStageCache(restapi_id, stage_name, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/restapis/$(restapi_id)/stages/$(stage_name)/cache/data", args)
...
GenerateClientCertificate(args::AbstractDict{String, Any}) = api_gateway("POST", "/clientcertificates", args)
...
GetAccount(args::AbstractDict{String, Any}) = api_gateway("GET", "/account", args)
...
"""
GetApiKey(api_Key) = api_gateway("GET", "/apikeys/$(api_Key)")
GetApiKey(api_Key, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/apikeys/$(api_Key)", args)
...
GetApiKeys(args::AbstractDict{String, Any}) = api_gateway("GET", "/apikeys", args)
...
"""
GetAuthorizer(authorizer_id, restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/authorizers/$(authorizer_id)")
GetAuthorizer(authorizer_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/authorizers/$(authorizer_id)", args)
...
- `position`: The current pagination position in the paged result set.
"""
GetAuthorizers(restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/authorizers")
GetAuthorizers(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/authorizers", args)
...
"""
GetBasePathMapping(base_path, domain_name) = api_gateway("GET", "/domainnames/$(domain_name)/basepathmappings/$(base_path)")
GetBasePathMapping(base_path, domain_name, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/domainnames/$(domain_name)/basepathmappings/$(base_path)", args)
...
- `position`: The current pagination position in the paged result set.
"""
GetBasePathMappings(domain_name) = api_gateway("GET", "/domainnames/$(domain_name)/basepathmappings")
GetBasePathMappings(domain_name, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/domainnames/$(domain_name)/basepathmappings", args)
...
"""
GetClientCertificate(clientcertificate_id) = api_gateway("GET", "/clientcertificates/$(clientcertificate_id)")
GetClientCertificate(clientcertificate_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/clientcertificates/$(clientcertificate_id)", args)
...
GetClientCertificates(args::AbstractDict{String, Any}) = api_gateway("GET", "/clientcertificates", args)
...
"""
GetDeployment(deployment_id, restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/deployments/$(deployment_id)")
GetDeployment(deployment_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/deployments/$(deployment_id)", args)
...
- `position`: The current pagination position in the paged result set.
"""
GetDeployments(restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/deployments")
GetDeployments(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/deployments", args)
...
"""
GetDocumentationPart(part_id, restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/documentation/parts/$(part_id)")
GetDocumentationPart(part_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/documentation/parts/$(part_id)", args)
...
"""
GetDocumentationParts(restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/documentation/parts")
GetDocumentationParts(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/documentation/parts", args)
...
"""
GetDocumentationVersion(doc_version, restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/documentation/versions/$(doc_version)")
GetDocumentationVersion(doc_version, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/documentation/versions/$(doc_version)", args)
...
- `position`: The current pagination position in the paged result set.
"""
GetDocumentationVersions(restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/documentation/versions")
GetDocumentationVersions(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/documentation/versions", args)
...
"""
GetDomainName(domain_name) = api_gateway("GET", "/domainnames/$(domain_name)")
GetDomainName(domain_name, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/domainnames/$(domain_name)", args)
...
GetDomainNames(args::AbstractDict{String, Any}) = api_gateway("GET", "/domainnames", args)
...
"""
GetExport(export_type, restapi_id, stage_name) = api_gateway("GET", "/restapis/$(restapi_id)/stages/$(stage_name)/exports/$(export_type)")
GetExport(export_type, restapi_id, stage_name, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/stages/$(stage_name)/exports/$(export_type)", args)
...
"""
GetGatewayResponse(response_type, restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/gatewayresponses/$(response_type)")
GetGatewayResponse(response_type, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/gatewayresponses/$(response_type)", args)
...
"""
GetGatewayResponses(restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/gatewayresponses")
GetGatewayResponses(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/gatewayresponses", args)
...
"""
GetIntegration(http_method, resource_id, restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration")
GetIntegration(http_method, resource_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration", args)
...
"""
GetIntegrationResponse(http_method, resource_id, restapi_id, status_code) = api_gateway("GET", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration/responses/$(status_code)")
GetIntegrationResponse(http_method, resource_id, restapi_id, status_code, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration/responses/$(status_code)", args)
...
"""
GetMethod(http_method, resource_id, restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)")
GetMethod(http_method, resource_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)", args)
...
"""
GetMethodResponse(http_method, resource_id, restapi_id, status_code) = api_gateway("GET", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/responses/$(status_code)")
GetMethodResponse(http_method, resource_id, restapi_id, status_code, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/responses/$(status_code)", args)
...
"""
GetModel(model_name, restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/models/$(model_name)")
GetModel(model_name, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/models/$(model_name)", args)
...
"""
GetModelTemplate(model_name, restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/models/$(model_name)/default_template")
GetModelTemplate(model_name, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/models/$(model_name)/default_template", args)
...
- `position`: The current pagination position in the paged result set.
"""
GetModels(restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/models")
GetModels(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/models", args)
...
"""
GetRequestValidator(requestvalidator_id, restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/requestvalidators/$(requestvalidator_id)")
GetRequestValidator(requestvalidator_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/requestvalidators/$(requestvalidator_id)", args)
...
- `position`: The current pagination position in the paged result set.
"""
GetRequestValidators(restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/requestvalidators")
GetRequestValidators(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/requestvalidators", args)
...
"""
GetResource(resource_id, restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/resources/$(resource_id)")
GetResource(resource_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/resources/$(resource_id)", args)
...
- `position`: The current pagination position in the paged result set.
"""
GetResources(restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/resources")
GetResources(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/resources", args)
...
"""
GetRestApi(restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)")
GetRestApi(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)", args)
...
GetRestApis(args::AbstractDict{String, Any}) = api_gateway("GET", "/restapis", args)
...
"""
GetSdk(restapi_id, sdk_type, stage_name) = api_gateway("GET", "/restapis/$(restapi_id)/stages/$(stage_name)/sdks/$(sdk_type)")
GetSdk(restapi_id, sdk_type, stage_name, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/stages/$(stage_name)/sdks/$(sdk_type)", args)
...
"""
GetSdkType(sdktype_id) = api_gateway("GET", "/sdktypes/$(sdktype_id)")
GetSdkType(sdktype_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/sdktypes/$(sdktype_id)", args)
...
GetSdkTypes(args::AbstractDict{String, Any}) = api_gateway("GET", "/sdktypes", args)
...
"""
GetStage(restapi_id, stage_name) = api_gateway("GET", "/restapis/$(restapi_id)/stages/$(stage_name)")
GetStage(restapi_id, stage_name, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/stages/$(stage_name)", args)
...
"""
GetStages(restapi_id) = api_gateway("GET", "/restapis/$(restapi_id)/stages")
GetStages(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/restapis/$(restapi_id)/stages", args)
...
"""
GetTags(resource_arn) = api_gateway("GET", "/tags/$(resource_arn)")
GetTags(resource_arn, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/tags/$(resource_arn)", args)
...
- `position`: The current pagination position in the paged result set.
"""
GetUsage(endDate, startDate, usageplanId) = api_gateway("GET", "/usageplans/$(usageplanId)/usage", Dict{String, Any}("endDate"=>endDate, "startDate"=>startDate))
GetUsage(endDate, startDate, usageplanId, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/usageplans/$(usageplanId)/usage", Dict{String, Any}("endDate"=>endDate, "startDate"=>startDate, args...))
...
GetUsagePlan(usageplanId, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/usageplans/$(usageplanId)", args)
...
GetUsagePlanKey(keyId, usageplanId, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/usageplans/$(usageplanId)/keys/$(keyId)", args)
...
GetUsagePlanKeys(usageplanId, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/usageplans/$(usageplanId)/keys", args)
...
GetUsagePlans(args::AbstractDict{String, Any}) = api_gateway("GET", "/usageplans", args)
...
"""
GetVpcLink(vpclink_id) = api_gateway("GET", "/vpclinks/$(vpclink_id)")
GetVpcLink(vpclink_id, args::AbstractDict{String, <:Any}) = api_gateway("GET", "/vpclinks/$(vpclink_id)", args)
...
GetVpcLinks(args::AbstractDict{String, Any}) = api_gateway("GET", "/vpclinks", args)
...
"""
ImportApiKeys(body, format) = api_gateway("POST", "/apikeys?mode=import", Dict{String, Any}("body"=>body, "format"=>format))
ImportApiKeys(body, format, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/apikeys?mode=import", Dict{String, Any}("body"=>body, "format"=>format, args...))
...
"""
ImportDocumentationParts(body, restapi_id) = api_gateway("PUT", "/restapis/$(restapi_id)/documentation/parts", Dict{String, Any}("body"=>body))
ImportDocumentationParts(body, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PUT", "/restapis/$(restapi_id)/documentation/parts", Dict{String, Any}("body"=>body, args...))
...
"""
ImportRestApi(body) = api_gateway("POST", "/restapis?mode=import", Dict{String, Any}("body"=>body))
ImportRestApi(body, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/restapis?mode=import", Dict{String, Any}("body"=>body, args...))
...
"""
PutGatewayResponse(response_type, restapi_id) = api_gateway("PUT", "/restapis/$(restapi_id)/gatewayresponses/$(response_type)")
PutGatewayResponse(response_type, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PUT", "/restapis/$(restapi_id)/gatewayresponses/$(response_type)", args)
...
"""
PutIntegration(http_method, resource_id, restapi_id, type) = api_gateway("PUT", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration", Dict{String, Any}("type"=>type))
PutIntegration(http_method, resource_id, restapi_id, type, args::AbstractDict{String, <:Any}) = api_gateway("PUT", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration", Dict{String, Any}("type"=>type, args...))
...
"""
PutIntegrationResponse(http_method, resource_id, restapi_id, status_code) = api_gateway("PUT", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration/responses/$(status_code)")
PutIntegrationResponse(http_method, resource_id, restapi_id, status_code, args::AbstractDict{String, <:Any}) = api_gateway("PUT", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration/responses/$(status_code)", args)
...
"""
PutMethod(authorizationType, http_method, resource_id, restapi_id) = api_gateway("PUT", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)", Dict{String, Any}("authorizationType"=>authorizationType))
PutMethod(authorizationType, http_method, resource_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PUT", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)", Dict{String, Any}("authorizationType"=>authorizationType, args...))
...
"""
PutMethodResponse(http_method, resource_id, restapi_id, status_code) = api_gateway("PUT", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/responses/$(status_code)")
PutMethodResponse(http_method, resource_id, restapi_id, status_code, args::AbstractDict{String, <:Any}) = api_gateway("PUT", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/responses/$(status_code)", args)
...
"""
PutRestApi(body, restapi_id) = api_gateway("PUT", "/restapis/$(restapi_id)", Dict{String, Any}("body"=>body))
PutRestApi(body, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PUT", "/restapis/$(restapi_id)", Dict{String, Any}("body"=>body, args...))
...
"""
TagResource(resource_arn, tags) = api_gateway("PUT", "/tags/$(resource_arn)", Dict{String, Any}("tags"=>tags))
TagResource(resource_arn, tags, args::AbstractDict{String, <:Any}) = api_gateway("PUT", "/tags/$(resource_arn)", Dict{String, Any}("tags"=>tags, args...))
...
"""
TestInvokeAuthorizer(authorizer_id, restapi_id) = api_gateway("POST", "/restapis/$(restapi_id)/authorizers/$(authorizer_id)")
TestInvokeAuthorizer(authorizer_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/restapis/$(restapi_id)/authorizers/$(authorizer_id)", args)
...
- `stageVariables`: A key-value map of stage variables to simulate an invocation on a deployed Stage.
"""
TestInvokeMethod(http_method, resource_id, restapi_id) = api_gateway("POST", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)")
TestInvokeMethod(http_method, resource_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("POST", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)", args)
...
"""
UntagResource(resource_arn, tagKeys) = api_gateway("DELETE", "/tags/$(resource_arn)", Dict{String, Any}("tagKeys"=>tagKeys))
UntagResource(resource_arn, tagKeys, args::AbstractDict{String, <:Any}) = api_gateway("DELETE", "/tags/$(resource_arn)", Dict{String, Any}("tagKeys"=>tagKeys, args...))
...
UpdateAccount(args::AbstractDict{String, Any}) = api_gateway("PATCH", "/account", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateApiKey(api_Key) = api_gateway("PATCH", "/apikeys/$(api_Key)")
UpdateApiKey(api_Key, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/apikeys/$(api_Key)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateAuthorizer(authorizer_id, restapi_id) = api_gateway("PATCH", "/restapis/$(restapi_id)/authorizers/$(authorizer_id)")
UpdateAuthorizer(authorizer_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/authorizers/$(authorizer_id)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateBasePathMapping(base_path, domain_name) = api_gateway("PATCH", "/domainnames/$(domain_name)/basepathmappings/$(base_path)")
UpdateBasePathMapping(base_path, domain_name, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/domainnames/$(domain_name)/basepathmappings/$(base_path)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateClientCertificate(clientcertificate_id) = api_gateway("PATCH", "/clientcertificates/$(clientcertificate_id)")
UpdateClientCertificate(clientcertificate_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/clientcertificates/$(clientcertificate_id)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateDeployment(deployment_id, restapi_id) = api_gateway("PATCH", "/restapis/$(restapi_id)/deployments/$(deployment_id)")
UpdateDeployment(deployment_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/deployments/$(deployment_id)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateDocumentationPart(part_id, restapi_id) = api_gateway("PATCH", "/restapis/$(restapi_id)/documentation/parts/$(part_id)")
UpdateDocumentationPart(part_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/documentation/parts/$(part_id)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateDocumentationVersion(doc_version, restapi_id) = api_gateway("PATCH", "/restapis/$(restapi_id)/documentation/versions/$(doc_version)")
UpdateDocumentationVersion(doc_version, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/documentation/versions/$(doc_version)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateDomainName(domain_name) = api_gateway("PATCH", "/domainnames/$(domain_name)")
UpdateDomainName(domain_name, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/domainnames/$(domain_name)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateGatewayResponse(response_type, restapi_id) = api_gateway("PATCH", "/restapis/$(restapi_id)/gatewayresponses/$(response_type)")
UpdateGatewayResponse(response_type, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/gatewayresponses/$(response_type)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateIntegration(http_method, resource_id, restapi_id) = api_gateway("PATCH", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration")
UpdateIntegration(http_method, resource_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateIntegrationResponse(http_method, resource_id, restapi_id, status_code) = api_gateway("PATCH", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration/responses/$(status_code)")
UpdateIntegrationResponse(http_method, resource_id, restapi_id, status_code, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/integration/responses/$(status_code)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateMethod(http_method, resource_id, restapi_id) = api_gateway("PATCH", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)")
UpdateMethod(http_method, resource_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateMethodResponse(http_method, resource_id, restapi_id, status_code) = api_gateway("PATCH", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/responses/$(status_code)")
UpdateMethodResponse(http_method, resource_id, restapi_id, status_code, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/resources/$(resource_id)/methods/$(http_method)/responses/$(status_code)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateModel(model_name, restapi_id) = api_gateway("PATCH", "/restapis/$(restapi_id)/models/$(model_name)")
UpdateModel(model_name, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/models/$(model_name)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateRequestValidator(requestvalidator_id, restapi_id) = api_gateway("PATCH", "/restapis/$(restapi_id)/requestvalidators/$(requestvalidator_id)")
UpdateRequestValidator(requestvalidator_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/requestvalidators/$(requestvalidator_id)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateResource(resource_id, restapi_id) = api_gateway("PATCH", "/restapis/$(restapi_id)/resources/$(resource_id)")
UpdateResource(resource_id, restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/resources/$(resource_id)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateRestApi(restapi_id) = api_gateway("PATCH", "/restapis/$(restapi_id)")
UpdateRestApi(restapi_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateStage(restapi_id, stage_name) = api_gateway("PATCH", "/restapis/$(restapi_id)/stages/$(stage_name)")
UpdateStage(restapi_id, stage_name, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/restapis/$(restapi_id)/stages/$(stage_name)", args)
...
UpdateUsage(keyId, usageplanId, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/usageplans/$(usageplanId)/keys/$(keyId)/usage", args)
...
UpdateUsagePlan(usageplanId, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/usageplans/$(usageplanId)", args)
...
- `patchOperations`: A list of update operations to be applied to the specified resource and in the order specified in this list.
"""
UpdateVpcLink(vpclink_id) = api_gateway("PATCH", "/vpclinks/$(vpclink_id)")
UpdateVpcLink(vpclink_id, args::AbstractDict{String, <:Any}) = api_gateway("PATCH", "/vpclinks/$(vpclink_id)", args)
