...
"""
AddPermission(AWSAccountId, ActionName, Label, QueueUrl) = sqs("AddPermission", Dict{String, Any}("AWSAccountId"=>AWSAccountId, "ActionName"=>ActionName, "Label"=>Label, "QueueUrl"=>QueueUrl))
AddPermission(AWSAccountId, ActionName, Label, QueueUrl, args::AbstractDict{String, <:Any}) = sqs("AddPermission", Dict{String, Any}("AWSAccountId"=>AWSAccountId, "ActionName"=>ActionName, "Label"=>Label, "QueueUrl"=>QueueUrl, args...))
...
"""
ChangeMessageVisibility(QueueUrl, ReceiptHandle, VisibilityTimeout) = sqs("ChangeMessageVisibility", Dict{String, Any}("QueueUrl"=>QueueUrl, "ReceiptHandle"=>ReceiptHandle, "VisibilityTimeout"=>VisibilityTimeout))
ChangeMessageVisibility(QueueUrl, ReceiptHandle, VisibilityTimeout, args::AbstractDict{String, <:Any}) = sqs("ChangeMessageVisibility", Dict{String, Any}("QueueUrl"=>QueueUrl, "ReceiptHandle"=>ReceiptHandle, "VisibilityTimeout"=>VisibilityTimeout, args...))
...
"""
ChangeMessageVisibilityBatch(ChangeMessageVisibilityBatchRequestEntry, QueueUrl) = sqs("ChangeMessageVisibilityBatch", Dict{String, Any}("ChangeMessageVisibilityBatchRequestEntry"=>ChangeMessageVisibilityBatchRequestEntry, "QueueUrl"=>QueueUrl))
ChangeMessageVisibilityBatch(ChangeMessageVisibilityBatchRequestEntry, QueueUrl, args::AbstractDict{String, <:Any}) = sqs("ChangeMessageVisibilityBatch", Dict{String, Any}("ChangeMessageVisibilityBatchRequestEntry"=>ChangeMessageVisibilityBatchRequestEntry, "QueueUrl"=>QueueUrl, args...))
...
"""
CreateQueue(QueueName) = sqs("CreateQueue", Dict{String, Any}("QueueName"=>QueueName))
CreateQueue(QueueName, args::AbstractDict{String, <:Any}) = sqs("CreateQueue", Dict{String, Any}("QueueName"=>QueueName, args...))
...
"""
DeleteMessage(QueueUrl, ReceiptHandle) = sqs("DeleteMessage", Dict{String, Any}("QueueUrl"=>QueueUrl, "ReceiptHandle"=>ReceiptHandle))
DeleteMessage(QueueUrl, ReceiptHandle, args::AbstractDict{String, <:Any}) = sqs("DeleteMessage", Dict{String, Any}("QueueUrl"=>QueueUrl, "ReceiptHandle"=>ReceiptHandle, args...))
...
"""
DeleteMessageBatch(DeleteMessageBatchRequestEntry, QueueUrl) = sqs("DeleteMessageBatch", Dict{String, Any}("DeleteMessageBatchRequestEntry"=>DeleteMessageBatchRequestEntry, "QueueUrl"=>QueueUrl))
DeleteMessageBatch(DeleteMessageBatchRequestEntry, QueueUrl, args::AbstractDict{String, <:Any}) = sqs("DeleteMessageBatch", Dict{String, Any}("DeleteMessageBatchRequestEntry"=>DeleteMessageBatchRequestEntry, "QueueUrl"=>QueueUrl, args...))
...
"""
DeleteQueue(QueueUrl) = sqs("DeleteQueue", Dict{String, Any}("QueueUrl"=>QueueUrl))
DeleteQueue(QueueUrl, args::AbstractDict{String, <:Any}) = sqs("DeleteQueue", Dict{String, Any}("QueueUrl"=>QueueUrl, args...))
...
"""
GetQueueAttributes(QueueUrl) = sqs("GetQueueAttributes", Dict{String, Any}("QueueUrl"=>QueueUrl))
GetQueueAttributes(QueueUrl, args::AbstractDict{String, <:Any}) = sqs("GetQueueAttributes", Dict{String, Any}("QueueUrl"=>QueueUrl, args...))
...
"""
GetQueueUrl(QueueName) = sqs("GetQueueUrl", Dict{String, Any}("QueueName"=>QueueName))
GetQueueUrl(QueueName, args::AbstractDict{String, <:Any}) = sqs("GetQueueUrl", Dict{String, Any}("QueueName"=>QueueName, args...))
...
"""
ListDeadLetterSourceQueues(QueueUrl) = sqs("ListDeadLetterSourceQueues", Dict{String, Any}("QueueUrl"=>QueueUrl))
ListDeadLetterSourceQueues(QueueUrl, args::AbstractDict{String, <:Any}) = sqs("ListDeadLetterSourceQueues", Dict{String, Any}("QueueUrl"=>QueueUrl, args...))
...
"""
ListQueueTags(QueueUrl) = sqs("ListQueueTags", Dict{String, Any}("QueueUrl"=>QueueUrl))
ListQueueTags(QueueUrl, args::AbstractDict{String, <:Any}) = sqs("ListQueueTags", Dict{String, Any}("QueueUrl"=>QueueUrl, args...))
...
ListQueues(args::AbstractDict{String, <:Any}) = sqs("ListQueues", args)
...
"""
PurgeQueue(QueueUrl) = sqs("PurgeQueue", Dict{String, Any}("QueueUrl"=>QueueUrl))
PurgeQueue(QueueUrl, args::AbstractDict{String, <:Any}) = sqs("PurgeQueue", Dict{String, Any}("QueueUrl"=>QueueUrl, args...))
...
"""
ReceiveMessage(QueueUrl) = sqs("ReceiveMessage", Dict{String, Any}("QueueUrl"=>QueueUrl))
ReceiveMessage(QueueUrl, args::AbstractDict{String, <:Any}) = sqs("ReceiveMessage", Dict{String, Any}("QueueUrl"=>QueueUrl, args...))
...
"""
RemovePermission(Label, QueueUrl) = sqs("RemovePermission", Dict{String, Any}("Label"=>Label, "QueueUrl"=>QueueUrl))
RemovePermission(Label, QueueUrl, args::AbstractDict{String, <:Any}) = sqs("RemovePermission", Dict{String, Any}("Label"=>Label, "QueueUrl"=>QueueUrl, args...))
...
"""
SendMessage(MessageBody, QueueUrl) = sqs("SendMessage", Dict{String, Any}("MessageBody"=>MessageBody, "QueueUrl"=>QueueUrl))
SendMessage(MessageBody, QueueUrl, args::AbstractDict{String, <:Any}) = sqs("SendMessage", Dict{String, Any}("MessageBody"=>MessageBody, "QueueUrl"=>QueueUrl, args...))
...
"""
SendMessageBatch(QueueUrl, SendMessageBatchRequestEntry) = sqs("SendMessageBatch", Dict{String, Any}("QueueUrl"=>QueueUrl, "SendMessageBatchRequestEntry"=>SendMessageBatchRequestEntry))
SendMessageBatch(QueueUrl, SendMessageBatchRequestEntry, args::AbstractDict{String, <:Any}) = sqs("SendMessageBatch", Dict{String, Any}("QueueUrl"=>QueueUrl, "SendMessageBatchRequestEntry"=>SendMessageBatchRequestEntry, args...))
...
"""
SetQueueAttributes(Attribute, QueueUrl) = sqs("SetQueueAttributes", Dict{String, Any}("Attribute"=>Attribute, "QueueUrl"=>QueueUrl))
SetQueueAttributes(Attribute, QueueUrl, args::AbstractDict{String, <:Any}) = sqs("SetQueueAttributes", Dict{String, Any}("Attribute"=>Attribute, "QueueUrl"=>QueueUrl, args...))
...
"""
TagQueue(QueueUrl, Tags) = sqs("TagQueue", Dict{String, Any}("QueueUrl"=>QueueUrl, "Tags"=>Tags))
TagQueue(QueueUrl, Tags, args::AbstractDict{String, <:Any}) = sqs("TagQueue", Dict{String, Any}("QueueUrl"=>QueueUrl, "Tags"=>Tags, args...))
...
"""
UntagQueue(QueueUrl, TagKey) = sqs("UntagQueue", Dict{String, Any}("QueueUrl"=>QueueUrl, "TagKey"=>TagKey))
UntagQueue(QueueUrl, TagKey, args::AbstractDict{String, <:Any}) = sqs("UntagQueue", Dict{String, Any}("QueueUrl"=>QueueUrl, "TagKey"=>TagKey, args...))
