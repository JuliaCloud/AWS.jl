...
"""
function create_application_instance end
...
"""
function create_node_from_template_job end
...
function delete_device(DeviceId; aws_config::AbstractAWSConfig=current_aws_config())
    return panorama(
        "DELETE", "/devices/$(DeviceId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_package(PackageId; aws_config::AbstractAWSConfig=current_aws_config())
    return panorama(
        "DELETE", "/packages/$(PackageId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"UpdatedLatestPatchVersion"`: If the version was marked latest, the new version to maker
  as latest.
"""
function deregister_package_version end
...
function describe_device_job(JobId; aws_config::AbstractAWSConfig=current_aws_config())
    return panorama("GET", "/jobs/$(JobId)"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_node(NodeId; aws_config::AbstractAWSConfig=current_aws_config())
    return panorama("GET", "/nodes/$(NodeId)"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_node(
    ...
    return panorama(
        "GET", "/nodes/$(NodeId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_package_import_job(
    ...
    return panorama(
        "GET", "/packages/import-jobs/$(JobId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"nextToken"`: Specify the pagination token from a previous request to retrieve the next
  page of results.
"""
function list_application_instance_dependencies end
...
- `"nextToken"`: Specify the pagination token from a previous request to retrieve the next
  page of results.
"""
function list_application_instance_node_instances end
...
"""
function list_application_instances end

function list_application_instances(; aws_config::AbstractAWSConfig=current_aws_config())
    return panorama(
        "GET", "/application-instances"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_application_instances(
    ...
    return panorama(
        "GET", "/application-instances", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_devices(; aws_config::AbstractAWSConfig=current_aws_config())
    return panorama("GET", "/devices"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_devices(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return panorama("GET", "/devices", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"NextToken"`: Specify the pagination token from a previous request to retrieve the next
  page of results.
"""
function list_devices_jobs end

function list_devices_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return panorama("GET", "/jobs"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_devices_jobs(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return panorama("GET", "/jobs", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"NextToken"`: Specify the pagination token from a previous request to retrieve the next
  page of results.
"""
function list_node_from_template_jobs end

function list_node_from_template_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return panorama(
        "GET", "/packages/template-job"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_node_from_template_jobs(
    ...
    return panorama(
        "GET", "/packages/template-job", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_nodes(; aws_config::AbstractAWSConfig=current_aws_config())
    return panorama("GET", "/nodes"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_nodes(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return panorama("GET", "/nodes", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"NextToken"`: Specify the pagination token from a previous request to retrieve the next
  page of results.
"""
function list_package_import_jobs end

function list_package_import_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return panorama(
        "GET", "/packages/import-jobs"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_package_import_jobs(
    ...
    return panorama(
        "GET", "/packages/import-jobs", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_packages(; aws_config::AbstractAWSConfig=current_aws_config())
    return panorama("GET", "/packages"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_packages(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return panorama("GET", "/packages", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"OwnerAccount"`: An owner account.
"""
function register_package_version end
...
function update_device_metadata(
    ...
    return panorama(
        "PUT", "/devices/$(DeviceId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_device_metadata(
    ...
    return panorama(
        "PUT", "/devices/$(DeviceId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
