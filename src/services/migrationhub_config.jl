...
"""
CreateHomeRegionControl(HomeRegion, Target; aws::AWSConfig=AWSConfig()) = migrationhub_config("CreateHomeRegionControl", Dict{String, Any}("HomeRegion"=>HomeRegion, "Target"=>Target); aws=aws)
CreateHomeRegionControl(HomeRegion, Target, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = migrationhub_config("CreateHomeRegionControl", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HomeRegion"=>HomeRegion, "Target"=>Target), args)); aws=aws)
...
"""
DescribeHomeRegionControls(; aws::AWSConfig=AWSConfig()) = migrationhub_config("DescribeHomeRegionControls"; aws=aws)
DescribeHomeRegionControls(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = migrationhub_config("DescribeHomeRegionControls", args; aws=aws)
...
"""
GetHomeRegion(; aws::AWSConfig=AWSConfig()) = migrationhub_config("GetHomeRegion"; aws=aws)
GetHomeRegion(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = migrationhub_config("GetHomeRegion", args; aws=aws)
