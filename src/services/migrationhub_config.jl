...
function describe_home_region_controls(; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhub_config(
        "DescribeHomeRegionControls"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_home_region_controls(
    ...
    return migrationhub_config(
        "DescribeHomeRegionControls", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_home_region(; aws_config::AbstractAWSConfig=current_aws_config())
    return migrationhub_config("GetHomeRegion"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_home_region(
    ...
    return migrationhub_config(
        "GetHomeRegion", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
