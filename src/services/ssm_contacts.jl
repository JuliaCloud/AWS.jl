...
"""
function list_contact_channels(ContactId; aws_config::AbstractAWSConfig=current_aws_config())
    return ssm_contacts(
        "ListContactChannels",
        Dict{String,Any}("ContactId" => ContactId);
        aws_config=aws_config,
...
- `"NextToken"`: The pagination token to continue to the next page of results.
"""
function list_pages_by_contact(ContactId; aws_config::AbstractAWSConfig=current_aws_config())
    return ssm_contacts(
        "ListPagesByContact",
        Dict{String,Any}("ContactId" => ContactId);
        aws_config=aws_config,
