...
"""
function delete_connection_alias(AliasId; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces(
...
"""
function delete_tags(ResourceId, TagKeys; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces(
        "DeleteTags",
...
"""
function describe_account_modifications(; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces(
...
- `"NextToken"`: If you received a NextToken from a previous call that was paginated,
  provide this token to receive the next set of results.
"""
function describe_workspace_directories(; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces(
