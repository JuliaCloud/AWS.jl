...
- `originEndpointId`: The ID of the OriginEndpoint that the HarvestJob will harvest
  from.
...
# Optional Parameters
- `channelId`: When specified, the request will return only OriginEndpoints associated with
