...
- `"ingressAccessLogs"`:
"""
configure_logs(id; aws_config::AbstractAWSConfig=global_aws_config()) = mediapackage(
    "PUT",
...
- `"tags"`:
"""
create_channel(id; aws_config::AbstractAWSConfig=global_aws_config()) = mediapackage(
    "POST",
    "/channels",
...
- `"whitelist"`: A list of source IP CIDR blocks that will be allowed to access the
  OriginEndpoint.
"""
create_origin_endpoint(channelId, id; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediapackage(
        "POST",
        "/origin_endpoints",
...
"""
delete_channel(id; aws_config::AbstractAWSConfig=global_aws_config()) = mediapackage(
...
"""
delete_origin_endpoint(id; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediapackage(
        "DELETE",
        "/origin_endpoints/$(id)";
        aws_config=aws_config,
...
"""
describe_channel(id; aws_config::AbstractAWSConfig=global_aws_config()) = mediapackage(
...
"""
describe_harvest_job(id; aws_config::AbstractAWSConfig=global_aws_config()) = mediapackage(
...
"""
describe_origin_endpoint(id; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediapackage(
        "GET",
        "/origin_endpoints/$(id)";
        aws_config=aws_config,
...
list_channels(; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediapackage("GET", "/channels"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"nextToken"`: A token used to resume pagination from the end of a previous request.
"""
list_harvest_jobs(; aws_config::AbstractAWSConfig=global_aws_config()) = mediapackage(
...
- `"nextToken"`: A token used to resume pagination from the end of a previous request.
"""
list_origin_endpoints(; aws_config::AbstractAWSConfig=global_aws_config()) = mediapackage(
...
"""
rotate_channel_credentials(id; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediapackage(
        "PUT",
...
- `"description"`: A short text description of the Channel.
"""
update_channel(id; aws_config::AbstractAWSConfig=global_aws_config()) = mediapackage(
...
- `"whitelist"`: A list of source IP CIDR blocks that will be allowed to access the
  OriginEndpoint.
"""
update_origin_endpoint(id; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediapackage(
        "PUT",
        "/origin_endpoints/$(id)";
        aws_config=aws_config,
