...
"""
CancelJob(jobId, reason) = batch("POST", "/v1/canceljob", Dict{String, Any}("jobId"=>jobId, "reason"=>reason))
CancelJob(jobId, reason, args::AbstractDict{String, <: Any}) = batch("POST", "/v1/canceljob", Dict{String, Any}("jobId"=>jobId, "reason"=>reason, args...))
...
"""
CreateComputeEnvironment(computeEnvironmentName, serviceRole, type) = batch("POST", "/v1/createcomputeenvironment", Dict{String, Any}("computeEnvironmentName"=>computeEnvironmentName, "serviceRole"=>serviceRole, "type"=>type))
CreateComputeEnvironment(computeEnvironmentName, serviceRole, type, args::AbstractDict{String, <: Any}) = batch("POST", "/v1/createcomputeenvironment", Dict{String, Any}("computeEnvironmentName"=>computeEnvironmentName, "serviceRole"=>serviceRole, "type"=>type, args...))
...
"""
CreateJobQueue(computeEnvironmentOrder, jobQueueName, priority) = batch("POST", "/v1/createjobqueue", Dict{String, Any}("computeEnvironmentOrder"=>computeEnvironmentOrder, "jobQueueName"=>jobQueueName, "priority"=>priority))
CreateJobQueue(computeEnvironmentOrder, jobQueueName, priority, args::AbstractDict{String, <: Any}) = batch("POST", "/v1/createjobqueue", Dict{String, Any}("computeEnvironmentOrder"=>computeEnvironmentOrder, "jobQueueName"=>jobQueueName, "priority"=>priority, args...))
...
"""
DeleteComputeEnvironment(computeEnvironment) = batch("POST", "/v1/deletecomputeenvironment", Dict{String, Any}("computeEnvironment"=>computeEnvironment))
DeleteComputeEnvironment(computeEnvironment, args::AbstractDict{String, <: Any}) = batch("POST", "/v1/deletecomputeenvironment", Dict{String, Any}("computeEnvironment"=>computeEnvironment, args...))
...
"""
DeleteJobQueue(jobQueue) = batch("POST", "/v1/deletejobqueue", Dict{String, Any}("jobQueue"=>jobQueue))
DeleteJobQueue(jobQueue, args::AbstractDict{String, <: Any}) = batch("POST", "/v1/deletejobqueue", Dict{String, Any}("jobQueue"=>jobQueue, args...))
...
"""
DeregisterJobDefinition(jobDefinition) = batch("POST", "/v1/deregisterjobdefinition", Dict{String, Any}("jobDefinition"=>jobDefinition))
DeregisterJobDefinition(jobDefinition, args::AbstractDict{String, <: Any}) = batch("POST", "/v1/deregisterjobdefinition", Dict{String, Any}("jobDefinition"=>jobDefinition, args...))
...
DescribeComputeEnvironments(args::AbstractDict{String, Any}) = batch("POST", "/v1/describecomputeenvironments", args)
...
DescribeJobDefinitions(args::AbstractDict{String, Any}) = batch("POST", "/v1/describejobdefinitions", args)
...
DescribeJobQueues(args::AbstractDict{String, Any}) = batch("POST", "/v1/describejobqueues", args)
...
"""
DescribeJobs(jobs) = batch("POST", "/v1/describejobs", Dict{String, Any}("jobs"=>jobs))
DescribeJobs(jobs, args::AbstractDict{String, <: Any}) = batch("POST", "/v1/describejobs", Dict{String, Any}("jobs"=>jobs, args...))
...
ListJobs(args::AbstractDict{String, Any}) = batch("POST", "/v1/listjobs", args)
...
"""
RegisterJobDefinition(jobDefinitionName, type) = batch("POST", "/v1/registerjobdefinition", Dict{String, Any}("jobDefinitionName"=>jobDefinitionName, "type"=>type))
RegisterJobDefinition(jobDefinitionName, type, args::AbstractDict{String, <: Any}) = batch("POST", "/v1/registerjobdefinition", Dict{String, Any}("jobDefinitionName"=>jobDefinitionName, "type"=>type, args...))
...
"""
SubmitJob(jobDefinition, jobName, jobQueue) = batch("POST", "/v1/submitjob", Dict{String, Any}("jobDefinition"=>jobDefinition, "jobName"=>jobName, "jobQueue"=>jobQueue))
SubmitJob(jobDefinition, jobName, jobQueue, args::AbstractDict{String, <: Any}) = batch("POST", "/v1/submitjob", Dict{String, Any}("jobDefinition"=>jobDefinition, "jobName"=>jobName, "jobQueue"=>jobQueue, args...))
...
"""
TerminateJob(jobId, reason) = batch("POST", "/v1/terminatejob", Dict{String, Any}("jobId"=>jobId, "reason"=>reason))
TerminateJob(jobId, reason, args::AbstractDict{String, <: Any}) = batch("POST", "/v1/terminatejob", Dict{String, Any}("jobId"=>jobId, "reason"=>reason, args...))
...
"""
UpdateComputeEnvironment(computeEnvironment) = batch("POST", "/v1/updatecomputeenvironment", Dict{String, Any}("computeEnvironment"=>computeEnvironment))
UpdateComputeEnvironment(computeEnvironment, args::AbstractDict{String, <: Any}) = batch("POST", "/v1/updatecomputeenvironment", Dict{String, Any}("computeEnvironment"=>computeEnvironment, args...))
...
"""
UpdateJobQueue(jobQueue) = batch("POST", "/v1/updatejobqueue", Dict{String, Any}("jobQueue"=>jobQueue))
UpdateJobQueue(jobQueue, args::AbstractDict{String, <: Any}) = batch("POST", "/v1/updatejobqueue", Dict{String, Any}("jobQueue"=>jobQueue, args...))
