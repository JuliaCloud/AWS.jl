...
"""
DeleteLexicon(LexiconName) = polly("DELETE", "/v1/lexicons/$(LexiconName)")
DeleteLexicon(LexiconName, args::AbstractDict{String, <:Any}) = polly("DELETE", "/v1/lexicons/$(LexiconName)", args)
...
DescribeVoices(args::AbstractDict{String, Any}) = polly("GET", "/v1/voices", args)
...
"""
GetLexicon(LexiconName) = polly("GET", "/v1/lexicons/$(LexiconName)")
GetLexicon(LexiconName, args::AbstractDict{String, <:Any}) = polly("GET", "/v1/lexicons/$(LexiconName)", args)
...
GetSpeechSynthesisTask(TaskId, args::AbstractDict{String, <:Any}) = polly("GET", "/v1/synthesisTasks/$(TaskId)", args)
...
ListLexicons(args::AbstractDict{String, Any}) = polly("GET", "/v1/lexicons", args)
...
ListSpeechSynthesisTasks(args::AbstractDict{String, Any}) = polly("GET", "/v1/synthesisTasks", args)
...
"""
PutLexicon(Content, LexiconName) = polly("PUT", "/v1/lexicons/$(LexiconName)", Dict{String, Any}("Content"=>Content))
PutLexicon(Content, LexiconName, args::AbstractDict{String, <:Any}) = polly("PUT", "/v1/lexicons/$(LexiconName)", Dict{String, Any}("Content"=>Content, args...))
...
"""
StartSpeechSynthesisTask(OutputFormat, OutputS3BucketName, Text, VoiceId) = polly("POST", "/v1/synthesisTasks", Dict{String, Any}("OutputFormat"=>OutputFormat, "OutputS3BucketName"=>OutputS3BucketName, "Text"=>Text, "VoiceId"=>VoiceId))
StartSpeechSynthesisTask(OutputFormat, OutputS3BucketName, Text, VoiceId, args::AbstractDict{String, <:Any}) = polly("POST", "/v1/synthesisTasks", Dict{String, Any}("OutputFormat"=>OutputFormat, "OutputS3BucketName"=>OutputS3BucketName, "Text"=>Text, "VoiceId"=>VoiceId, args...))
...
"""
SynthesizeSpeech(OutputFormat, Text, VoiceId) = polly("POST", "/v1/speech", Dict{String, Any}("OutputFormat"=>OutputFormat, "Text"=>Text, "VoiceId"=>VoiceId))
SynthesizeSpeech(OutputFormat, Text, VoiceId, args::AbstractDict{String, <:Any}) = polly("POST", "/v1/speech", Dict{String, Any}("OutputFormat"=>OutputFormat, "Text"=>Text, "VoiceId"=>VoiceId, args...))
