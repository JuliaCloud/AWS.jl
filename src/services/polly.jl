...
# Required Parameters
- `LexiconName`: The name of the lexicon to delete. Must be an existing lexicon in the
  region.
...
# Optional Parameters
- `NextToken`: An opaque pagination token returned from previous ListLexicons operation. If
...
- `LexiconName`: Name of the lexicon. The name must follow the regular express format
...
# Required Parameters
- `OutputFormat`: The format in which the returned output will be encoded. For audio
...
- `VoiceId`:  Voice ID to use for the synthesis. You can get a list of available voice IDs
