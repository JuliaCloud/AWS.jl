...
"""
AcceptDomainTransferFromAnotherAwsAccount(DomainName, Password) = route_53_domains("AcceptDomainTransferFromAnotherAwsAccount", Dict{String, Any}("DomainName"=>DomainName, "Password"=>Password))
AcceptDomainTransferFromAnotherAwsAccount(DomainName, Password, args::AbstractDict{String, <:Any}) = route_53_domains("AcceptDomainTransferFromAnotherAwsAccount", Dict{String, Any}("DomainName"=>DomainName, "Password"=>Password, args...))
...
"""
CancelDomainTransferToAnotherAwsAccount(DomainName) = route_53_domains("CancelDomainTransferToAnotherAwsAccount", Dict{String, Any}("DomainName"=>DomainName))
CancelDomainTransferToAnotherAwsAccount(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("CancelDomainTransferToAnotherAwsAccount", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
CheckDomainAvailability(DomainName) = route_53_domains("CheckDomainAvailability", Dict{String, Any}("DomainName"=>DomainName))
CheckDomainAvailability(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("CheckDomainAvailability", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
CheckDomainTransferability(DomainName) = route_53_domains("CheckDomainTransferability", Dict{String, Any}("DomainName"=>DomainName))
CheckDomainTransferability(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("CheckDomainTransferability", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
DeleteTagsForDomain(DomainName, TagsToDelete) = route_53_domains("DeleteTagsForDomain", Dict{String, Any}("DomainName"=>DomainName, "TagsToDelete"=>TagsToDelete))
DeleteTagsForDomain(DomainName, TagsToDelete, args::AbstractDict{String, <:Any}) = route_53_domains("DeleteTagsForDomain", Dict{String, Any}("DomainName"=>DomainName, "TagsToDelete"=>TagsToDelete, args...))
...
"""
DisableDomainAutoRenew(DomainName) = route_53_domains("DisableDomainAutoRenew", Dict{String, Any}("DomainName"=>DomainName))
DisableDomainAutoRenew(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("DisableDomainAutoRenew", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
DisableDomainTransferLock(DomainName) = route_53_domains("DisableDomainTransferLock", Dict{String, Any}("DomainName"=>DomainName))
DisableDomainTransferLock(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("DisableDomainTransferLock", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
EnableDomainAutoRenew(DomainName) = route_53_domains("EnableDomainAutoRenew", Dict{String, Any}("DomainName"=>DomainName))
EnableDomainAutoRenew(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("EnableDomainAutoRenew", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
EnableDomainTransferLock(DomainName) = route_53_domains("EnableDomainTransferLock", Dict{String, Any}("DomainName"=>DomainName))
EnableDomainTransferLock(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("EnableDomainTransferLock", Dict{String, Any}("DomainName"=>DomainName, args...))
...
GetContactReachabilityStatus(args::AbstractDict{String, <:Any}) = route_53_domains("GetContactReachabilityStatus", args)
...
"""
GetDomainDetail(DomainName) = route_53_domains("GetDomainDetail", Dict{String, Any}("DomainName"=>DomainName))
GetDomainDetail(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("GetDomainDetail", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
GetDomainSuggestions(DomainName, OnlyAvailable, SuggestionCount) = route_53_domains("GetDomainSuggestions", Dict{String, Any}("DomainName"=>DomainName, "OnlyAvailable"=>OnlyAvailable, "SuggestionCount"=>SuggestionCount))
GetDomainSuggestions(DomainName, OnlyAvailable, SuggestionCount, args::AbstractDict{String, <:Any}) = route_53_domains("GetDomainSuggestions", Dict{String, Any}("DomainName"=>DomainName, "OnlyAvailable"=>OnlyAvailable, "SuggestionCount"=>SuggestionCount, args...))
...
"""
GetOperationDetail(OperationId) = route_53_domains("GetOperationDetail", Dict{String, Any}("OperationId"=>OperationId))
GetOperationDetail(OperationId, args::AbstractDict{String, <:Any}) = route_53_domains("GetOperationDetail", Dict{String, Any}("OperationId"=>OperationId, args...))
...
ListDomains(args::AbstractDict{String, <:Any}) = route_53_domains("ListDomains", args)
...
ListOperations(args::AbstractDict{String, <:Any}) = route_53_domains("ListOperations", args)
...
"""
ListTagsForDomain(DomainName) = route_53_domains("ListTagsForDomain", Dict{String, Any}("DomainName"=>DomainName))
ListTagsForDomain(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("ListTagsForDomain", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
RegisterDomain(AdminContact, DomainName, DurationInYears, RegistrantContact, TechContact) = route_53_domains("RegisterDomain", Dict{String, Any}("AdminContact"=>AdminContact, "DomainName"=>DomainName, "DurationInYears"=>DurationInYears, "RegistrantContact"=>RegistrantContact, "TechContact"=>TechContact))
RegisterDomain(AdminContact, DomainName, DurationInYears, RegistrantContact, TechContact, args::AbstractDict{String, <:Any}) = route_53_domains("RegisterDomain", Dict{String, Any}("AdminContact"=>AdminContact, "DomainName"=>DomainName, "DurationInYears"=>DurationInYears, "RegistrantContact"=>RegistrantContact, "TechContact"=>TechContact, args...))
...
"""
RejectDomainTransferFromAnotherAwsAccount(DomainName) = route_53_domains("RejectDomainTransferFromAnotherAwsAccount", Dict{String, Any}("DomainName"=>DomainName))
RejectDomainTransferFromAnotherAwsAccount(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("RejectDomainTransferFromAnotherAwsAccount", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
RenewDomain(CurrentExpiryYear, DomainName) = route_53_domains("RenewDomain", Dict{String, Any}("CurrentExpiryYear"=>CurrentExpiryYear, "DomainName"=>DomainName))
RenewDomain(CurrentExpiryYear, DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("RenewDomain", Dict{String, Any}("CurrentExpiryYear"=>CurrentExpiryYear, "DomainName"=>DomainName, args...))
...
ResendContactReachabilityEmail(args::AbstractDict{String, <:Any}) = route_53_domains("ResendContactReachabilityEmail", args)
...
"""
RetrieveDomainAuthCode(DomainName) = route_53_domains("RetrieveDomainAuthCode", Dict{String, Any}("DomainName"=>DomainName))
RetrieveDomainAuthCode(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("RetrieveDomainAuthCode", Dict{String, Any}("DomainName"=>DomainName, args...))
...
- `PrivacyProtectTechContact`: Whether you want to conceal contact information from WHOIS queries. If you specify true, WHOIS (\"who is\") queries return contact information either for Amazon Registrar (for .com, .net, and .org domains) or for our registrar associate, Gandi (for all other TLDs). If you specify false, WHOIS queries return the information that you entered for the technical contact. Default: true 
"""
TransferDomain(AdminContact, DomainName, DurationInYears, RegistrantContact, TechContact) = route_53_domains("TransferDomain", Dict{String, Any}("AdminContact"=>AdminContact, "DomainName"=>DomainName, "DurationInYears"=>DurationInYears, "RegistrantContact"=>RegistrantContact, "TechContact"=>TechContact))
TransferDomain(AdminContact, DomainName, DurationInYears, RegistrantContact, TechContact, args::AbstractDict{String, <:Any}) = route_53_domains("TransferDomain", Dict{String, Any}("AdminContact"=>AdminContact, "DomainName"=>DomainName, "DurationInYears"=>DurationInYears, "RegistrantContact"=>RegistrantContact, "TechContact"=>TechContact, args...))
...
"""
TransferDomainToAnotherAwsAccount(AccountId, DomainName) = route_53_domains("TransferDomainToAnotherAwsAccount", Dict{String, Any}("AccountId"=>AccountId, "DomainName"=>DomainName))
TransferDomainToAnotherAwsAccount(AccountId, DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("TransferDomainToAnotherAwsAccount", Dict{String, Any}("AccountId"=>AccountId, "DomainName"=>DomainName, args...))
...
- `TechContact`: Provides detailed contact information.
"""
UpdateDomainContact(DomainName) = route_53_domains("UpdateDomainContact", Dict{String, Any}("DomainName"=>DomainName))
UpdateDomainContact(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("UpdateDomainContact", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
UpdateDomainContactPrivacy(DomainName) = route_53_domains("UpdateDomainContactPrivacy", Dict{String, Any}("DomainName"=>DomainName))
UpdateDomainContactPrivacy(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("UpdateDomainContactPrivacy", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
UpdateDomainNameservers(DomainName, Nameservers) = route_53_domains("UpdateDomainNameservers", Dict{String, Any}("DomainName"=>DomainName, "Nameservers"=>Nameservers))
UpdateDomainNameservers(DomainName, Nameservers, args::AbstractDict{String, <:Any}) = route_53_domains("UpdateDomainNameservers", Dict{String, Any}("DomainName"=>DomainName, "Nameservers"=>Nameservers, args...))
...
"""
UpdateTagsForDomain(DomainName) = route_53_domains("UpdateTagsForDomain", Dict{String, Any}("DomainName"=>DomainName))
UpdateTagsForDomain(DomainName, args::AbstractDict{String, <:Any}) = route_53_domains("UpdateTagsForDomain", Dict{String, Any}("DomainName"=>DomainName, args...))
...
ViewBilling(args::AbstractDict{String, <:Any}) = route_53_domains("ViewBilling", args)
