...
"""
BatchDeleteAttributes(DomainName, Item) = simpledb("BatchDeleteAttributes", Dict{String, Any}("DomainName"=>DomainName, "Item"=>Item))
BatchDeleteAttributes(DomainName, Item, args::AbstractDict{String, <: Any}) = simpledb("BatchDeleteAttributes", Dict{String, Any}("DomainName"=>DomainName, "Item"=>Item, args...))
...
Items => A list of items on which to perform the operation.
"""
BatchPutAttributes(DomainName, Item) = simpledb("BatchPutAttributes", Dict{String, Any}("DomainName"=>DomainName, "Item"=>Item))
BatchPutAttributes(DomainName, Item, args::AbstractDict{String, <: Any}) = simpledb("BatchPutAttributes", Dict{String, Any}("DomainName"=>DomainName, "Item"=>Item, args...))
...
"""
CreateDomain(DomainName) = simpledb("CreateDomain", Dict{String, Any}("DomainName"=>DomainName))
CreateDomain(DomainName, args::AbstractDict{String, <: Any}) = simpledb("CreateDomain", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
DeleteAttributes(DomainName, ItemName) = simpledb("DeleteAttributes", Dict{String, Any}("DomainName"=>DomainName, "ItemName"=>ItemName))
DeleteAttributes(DomainName, ItemName, args::AbstractDict{String, <: Any}) = simpledb("DeleteAttributes", Dict{String, Any}("DomainName"=>DomainName, "ItemName"=>ItemName, args...))
...
"""
DeleteDomain(DomainName) = simpledb("DeleteDomain", Dict{String, Any}("DomainName"=>DomainName))
DeleteDomain(DomainName, args::AbstractDict{String, <: Any}) = simpledb("DeleteDomain", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
DomainMetadata(DomainName) = simpledb("DomainMetadata", Dict{String, Any}("DomainName"=>DomainName))
DomainMetadata(DomainName, args::AbstractDict{String, <: Any}) = simpledb("DomainMetadata", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
GetAttributes(DomainName, ItemName) = simpledb("GetAttributes", Dict{String, Any}("DomainName"=>DomainName, "ItemName"=>ItemName))
GetAttributes(DomainName, ItemName, args::AbstractDict{String, <: Any}) = simpledb("GetAttributes", Dict{String, Any}("DomainName"=>DomainName, "ItemName"=>ItemName, args...))
...
ListDomains(args::AbstractDict{String, <: Any}) = simpledb("ListDomains", args)
...
"""
PutAttributes(Attribute, DomainName, ItemName) = simpledb("PutAttributes", Dict{String, Any}("Attribute"=>Attribute, "DomainName"=>DomainName, "ItemName"=>ItemName))
PutAttributes(Attribute, DomainName, ItemName, args::AbstractDict{String, <: Any}) = simpledb("PutAttributes", Dict{String, Any}("Attribute"=>Attribute, "DomainName"=>DomainName, "ItemName"=>ItemName, args...))
...
"""
Select(SelectExpression) = simpledb("Select", Dict{String, Any}("SelectExpression"=>SelectExpression))
Select(SelectExpression, args::AbstractDict{String, <: Any}) = simpledb("Select", Dict{String, Any}("SelectExpression"=>SelectExpression, args...))
