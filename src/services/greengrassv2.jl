...
# Required Parameters
- `coreDeviceThingName`: The name of the core device. This is also the name of the AWS IoT
  thing.
...
- `artifactName`: The name of the artifact. You can use the GetComponent operation to
