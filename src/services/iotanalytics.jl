...
- `"versionId"`: The version of the dataset whose contents are retrieved. You can also use
  ...
  default.
"""
function get_dataset_content(datasetName; aws_config::AbstractAWSConfig=current_aws_config())
    return iotanalytics(
        "GET",
        "/datasets/$(datasetName)/content";
        aws_config=aws_config,
...
"""
function sample_channel_data(channelName; aws_config::AbstractAWSConfig=current_aws_config())
    return iotanalytics(
        "GET",
