...
"""
AcceptHandshake(HandshakeId) = organizations("AcceptHandshake", Dict{String, Any}("HandshakeId"=>HandshakeId))
AcceptHandshake(HandshakeId, args::AbstractDict{String, <: Any}) = organizations("AcceptHandshake", Dict{String, Any}("HandshakeId"=>HandshakeId, args...))
...
"""
AttachPolicy(PolicyId, TargetId) = organizations("AttachPolicy", Dict{String, Any}("PolicyId"=>PolicyId, "TargetId"=>TargetId))
AttachPolicy(PolicyId, TargetId, args::AbstractDict{String, <: Any}) = organizations("AttachPolicy", Dict{String, Any}("PolicyId"=>PolicyId, "TargetId"=>TargetId, args...))
...
"""
CancelHandshake(HandshakeId) = organizations("CancelHandshake", Dict{String, Any}("HandshakeId"=>HandshakeId))
CancelHandshake(HandshakeId, args::AbstractDict{String, <: Any}) = organizations("CancelHandshake", Dict{String, Any}("HandshakeId"=>HandshakeId, args...))
...
"""
CreateAccount(AccountName, Email) = organizations("CreateAccount", Dict{String, Any}("AccountName"=>AccountName, "Email"=>Email))
CreateAccount(AccountName, Email, args::AbstractDict{String, <: Any}) = organizations("CreateAccount", Dict{String, Any}("AccountName"=>AccountName, "Email"=>Email, args...))
...
"""
CreateGovCloudAccount(AccountName, Email) = organizations("CreateGovCloudAccount", Dict{String, Any}("AccountName"=>AccountName, "Email"=>Email))
CreateGovCloudAccount(AccountName, Email, args::AbstractDict{String, <: Any}) = organizations("CreateGovCloudAccount", Dict{String, Any}("AccountName"=>AccountName, "Email"=>Email, args...))
...
CreateOrganization(args::AbstractDict{String, <: Any}) = organizations("CreateOrganization", args)
...
"""
CreateOrganizationalUnit(Name, ParentId) = organizations("CreateOrganizationalUnit", Dict{String, Any}("Name"=>Name, "ParentId"=>ParentId))
CreateOrganizationalUnit(Name, ParentId, args::AbstractDict{String, <: Any}) = organizations("CreateOrganizationalUnit", Dict{String, Any}("Name"=>Name, "ParentId"=>ParentId, args...))
...
"""
CreatePolicy(Content, Description, Name, Type) = organizations("CreatePolicy", Dict{String, Any}("Content"=>Content, "Description"=>Description, "Name"=>Name, "Type"=>Type))
CreatePolicy(Content, Description, Name, Type, args::AbstractDict{String, <: Any}) = organizations("CreatePolicy", Dict{String, Any}("Content"=>Content, "Description"=>Description, "Name"=>Name, "Type"=>Type, args...))
...
"""
DeclineHandshake(HandshakeId) = organizations("DeclineHandshake", Dict{String, Any}("HandshakeId"=>HandshakeId))
DeclineHandshake(HandshakeId, args::AbstractDict{String, <: Any}) = organizations("DeclineHandshake", Dict{String, Any}("HandshakeId"=>HandshakeId, args...))
...
DeleteOrganization(args::AbstractDict{String, <: Any}) = organizations("DeleteOrganization", args)
...
"""
DeleteOrganizationalUnit(OrganizationalUnitId) = organizations("DeleteOrganizationalUnit", Dict{String, Any}("OrganizationalUnitId"=>OrganizationalUnitId))
DeleteOrganizationalUnit(OrganizationalUnitId, args::AbstractDict{String, <: Any}) = organizations("DeleteOrganizationalUnit", Dict{String, Any}("OrganizationalUnitId"=>OrganizationalUnitId, args...))
...
"""
DeletePolicy(PolicyId) = organizations("DeletePolicy", Dict{String, Any}("PolicyId"=>PolicyId))
DeletePolicy(PolicyId, args::AbstractDict{String, <: Any}) = organizations("DeletePolicy", Dict{String, Any}("PolicyId"=>PolicyId, args...))
...
"""
DeregisterDelegatedAdministrator(AccountId, ServicePrincipal) = organizations("DeregisterDelegatedAdministrator", Dict{String, Any}("AccountId"=>AccountId, "ServicePrincipal"=>ServicePrincipal))
DeregisterDelegatedAdministrator(AccountId, ServicePrincipal, args::AbstractDict{String, <: Any}) = organizations("DeregisterDelegatedAdministrator", Dict{String, Any}("AccountId"=>AccountId, "ServicePrincipal"=>ServicePrincipal, args...))
...
"""
DescribeAccount(AccountId) = organizations("DescribeAccount", Dict{String, Any}("AccountId"=>AccountId))
DescribeAccount(AccountId, args::AbstractDict{String, <: Any}) = organizations("DescribeAccount", Dict{String, Any}("AccountId"=>AccountId, args...))
...
"""
DescribeCreateAccountStatus(CreateAccountRequestId) = organizations("DescribeCreateAccountStatus", Dict{String, Any}("CreateAccountRequestId"=>CreateAccountRequestId))
DescribeCreateAccountStatus(CreateAccountRequestId, args::AbstractDict{String, <: Any}) = organizations("DescribeCreateAccountStatus", Dict{String, Any}("CreateAccountRequestId"=>CreateAccountRequestId, args...))
...
"""
DescribeEffectivePolicy(PolicyType) = organizations("DescribeEffectivePolicy", Dict{String, Any}("PolicyType"=>PolicyType))
DescribeEffectivePolicy(PolicyType, args::AbstractDict{String, <: Any}) = organizations("DescribeEffectivePolicy", Dict{String, Any}("PolicyType"=>PolicyType, args...))
...
"""
DescribeHandshake(HandshakeId) = organizations("DescribeHandshake", Dict{String, Any}("HandshakeId"=>HandshakeId))
DescribeHandshake(HandshakeId, args::AbstractDict{String, <: Any}) = organizations("DescribeHandshake", Dict{String, Any}("HandshakeId"=>HandshakeId, args...))
...
DescribeOrganization(args::AbstractDict{String, <: Any}) = organizations("DescribeOrganization", args)
...
"""
DescribeOrganizationalUnit(OrganizationalUnitId) = organizations("DescribeOrganizationalUnit", Dict{String, Any}("OrganizationalUnitId"=>OrganizationalUnitId))
DescribeOrganizationalUnit(OrganizationalUnitId, args::AbstractDict{String, <: Any}) = organizations("DescribeOrganizationalUnit", Dict{String, Any}("OrganizationalUnitId"=>OrganizationalUnitId, args...))
...
"""
DescribePolicy(PolicyId) = organizations("DescribePolicy", Dict{String, Any}("PolicyId"=>PolicyId))
DescribePolicy(PolicyId, args::AbstractDict{String, <: Any}) = organizations("DescribePolicy", Dict{String, Any}("PolicyId"=>PolicyId, args...))
...
"""
DetachPolicy(PolicyId, TargetId) = organizations("DetachPolicy", Dict{String, Any}("PolicyId"=>PolicyId, "TargetId"=>TargetId))
DetachPolicy(PolicyId, TargetId, args::AbstractDict{String, <: Any}) = organizations("DetachPolicy", Dict{String, Any}("PolicyId"=>PolicyId, "TargetId"=>TargetId, args...))
...
"""
DisableAWSServiceAccess(ServicePrincipal) = organizations("DisableAWSServiceAccess", Dict{String, Any}("ServicePrincipal"=>ServicePrincipal))
DisableAWSServiceAccess(ServicePrincipal, args::AbstractDict{String, <: Any}) = organizations("DisableAWSServiceAccess", Dict{String, Any}("ServicePrincipal"=>ServicePrincipal, args...))
...
"""
DisablePolicyType(PolicyType, RootId) = organizations("DisablePolicyType", Dict{String, Any}("PolicyType"=>PolicyType, "RootId"=>RootId))
DisablePolicyType(PolicyType, RootId, args::AbstractDict{String, <: Any}) = organizations("DisablePolicyType", Dict{String, Any}("PolicyType"=>PolicyType, "RootId"=>RootId, args...))
...
"""
EnableAWSServiceAccess(ServicePrincipal) = organizations("EnableAWSServiceAccess", Dict{String, Any}("ServicePrincipal"=>ServicePrincipal))
EnableAWSServiceAccess(ServicePrincipal, args::AbstractDict{String, <: Any}) = organizations("EnableAWSServiceAccess", Dict{String, Any}("ServicePrincipal"=>ServicePrincipal, args...))
...
EnableAllFeatures(args::AbstractDict{String, <: Any}) = organizations("EnableAllFeatures", args)
...
"""
EnablePolicyType(PolicyType, RootId) = organizations("EnablePolicyType", Dict{String, Any}("PolicyType"=>PolicyType, "RootId"=>RootId))
EnablePolicyType(PolicyType, RootId, args::AbstractDict{String, <: Any}) = organizations("EnablePolicyType", Dict{String, Any}("PolicyType"=>PolicyType, "RootId"=>RootId, args...))
...
"""
InviteAccountToOrganization(Target) = organizations("InviteAccountToOrganization", Dict{String, Any}("Target"=>Target))
InviteAccountToOrganization(Target, args::AbstractDict{String, <: Any}) = organizations("InviteAccountToOrganization", Dict{String, Any}("Target"=>Target, args...))
...
LeaveOrganization(args::AbstractDict{String, <: Any}) = organizations("LeaveOrganization", args)
...
ListAWSServiceAccessForOrganization(args::AbstractDict{String, <: Any}) = organizations("ListAWSServiceAccessForOrganization", args)
...
ListAccounts(args::AbstractDict{String, <: Any}) = organizations("ListAccounts", args)
...
NextToken => The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value of the previous call's NextToken response to indicate where the output should continue from.
"""
ListAccountsForParent(ParentId) = organizations("ListAccountsForParent", Dict{String, Any}("ParentId"=>ParentId))
ListAccountsForParent(ParentId, args::AbstractDict{String, <: Any}) = organizations("ListAccountsForParent", Dict{String, Any}("ParentId"=>ParentId, args...))
...
NextToken => The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value of the previous call's NextToken response to indicate where the output should continue from.
"""
ListChildren(ChildType, ParentId) = organizations("ListChildren", Dict{String, Any}("ChildType"=>ChildType, "ParentId"=>ParentId))
ListChildren(ChildType, ParentId, args::AbstractDict{String, <: Any}) = organizations("ListChildren", Dict{String, Any}("ChildType"=>ChildType, "ParentId"=>ParentId, args...))
...
ListCreateAccountStatus(args::AbstractDict{String, <: Any}) = organizations("ListCreateAccountStatus", args)
...
ListDelegatedAdministrators(args::AbstractDict{String, <: Any}) = organizations("ListDelegatedAdministrators", args)
...
NextToken => The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value of the previous call's NextToken response to indicate where the output should continue from.
"""
ListDelegatedServicesForAccount(AccountId) = organizations("ListDelegatedServicesForAccount", Dict{String, Any}("AccountId"=>AccountId))
ListDelegatedServicesForAccount(AccountId, args::AbstractDict{String, <: Any}) = organizations("ListDelegatedServicesForAccount", Dict{String, Any}("AccountId"=>AccountId, args...))
...
ListHandshakesForAccount(args::AbstractDict{String, <: Any}) = organizations("ListHandshakesForAccount", args)
...
ListHandshakesForOrganization(args::AbstractDict{String, <: Any}) = organizations("ListHandshakesForOrganization", args)
...
NextToken => The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value of the previous call's NextToken response to indicate where the output should continue from.
"""
ListOrganizationalUnitsForParent(ParentId) = organizations("ListOrganizationalUnitsForParent", Dict{String, Any}("ParentId"=>ParentId))
ListOrganizationalUnitsForParent(ParentId, args::AbstractDict{String, <: Any}) = organizations("ListOrganizationalUnitsForParent", Dict{String, Any}("ParentId"=>ParentId, args...))
...
NextToken => The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value of the previous call's NextToken response to indicate where the output should continue from.
"""
ListParents(ChildId) = organizations("ListParents", Dict{String, Any}("ChildId"=>ChildId))
ListParents(ChildId, args::AbstractDict{String, <: Any}) = organizations("ListParents", Dict{String, Any}("ChildId"=>ChildId, args...))
...
NextToken => The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value of the previous call's NextToken response to indicate where the output should continue from.
"""
ListPolicies(Filter) = organizations("ListPolicies", Dict{String, Any}("Filter"=>Filter))
ListPolicies(Filter, args::AbstractDict{String, <: Any}) = organizations("ListPolicies", Dict{String, Any}("Filter"=>Filter, args...))
...
NextToken => The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value of the previous call's NextToken response to indicate where the output should continue from.
"""
ListPoliciesForTarget(Filter, TargetId) = organizations("ListPoliciesForTarget", Dict{String, Any}("Filter"=>Filter, "TargetId"=>TargetId))
ListPoliciesForTarget(Filter, TargetId, args::AbstractDict{String, <: Any}) = organizations("ListPoliciesForTarget", Dict{String, Any}("Filter"=>Filter, "TargetId"=>TargetId, args...))
...
ListRoots(args::AbstractDict{String, <: Any}) = organizations("ListRoots", args)
...
NextToken => The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value of the previous call's NextToken response to indicate where the output should continue from.
"""
ListTagsForResource(ResourceId) = organizations("ListTagsForResource", Dict{String, Any}("ResourceId"=>ResourceId))
ListTagsForResource(ResourceId, args::AbstractDict{String, <: Any}) = organizations("ListTagsForResource", Dict{String, Any}("ResourceId"=>ResourceId, args...))
...
NextToken => The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value of the previous call's NextToken response to indicate where the output should continue from.
"""
ListTargetsForPolicy(PolicyId) = organizations("ListTargetsForPolicy", Dict{String, Any}("PolicyId"=>PolicyId))
ListTargetsForPolicy(PolicyId, args::AbstractDict{String, <: Any}) = organizations("ListTargetsForPolicy", Dict{String, Any}("PolicyId"=>PolicyId, args...))
...
"""
MoveAccount(AccountId, DestinationParentId, SourceParentId) = organizations("MoveAccount", Dict{String, Any}("AccountId"=>AccountId, "DestinationParentId"=>DestinationParentId, "SourceParentId"=>SourceParentId))
MoveAccount(AccountId, DestinationParentId, SourceParentId, args::AbstractDict{String, <: Any}) = organizations("MoveAccount", Dict{String, Any}("AccountId"=>AccountId, "DestinationParentId"=>DestinationParentId, "SourceParentId"=>SourceParentId, args...))
...
"""
RegisterDelegatedAdministrator(AccountId, ServicePrincipal) = organizations("RegisterDelegatedAdministrator", Dict{String, Any}("AccountId"=>AccountId, "ServicePrincipal"=>ServicePrincipal))
RegisterDelegatedAdministrator(AccountId, ServicePrincipal, args::AbstractDict{String, <: Any}) = organizations("RegisterDelegatedAdministrator", Dict{String, Any}("AccountId"=>AccountId, "ServicePrincipal"=>ServicePrincipal, args...))
...
"""
RemoveAccountFromOrganization(AccountId) = organizations("RemoveAccountFromOrganization", Dict{String, Any}("AccountId"=>AccountId))
RemoveAccountFromOrganization(AccountId, args::AbstractDict{String, <: Any}) = organizations("RemoveAccountFromOrganization", Dict{String, Any}("AccountId"=>AccountId, args...))
...
"""
TagResource(ResourceId, Tags) = organizations("TagResource", Dict{String, Any}("ResourceId"=>ResourceId, "Tags"=>Tags))
TagResource(ResourceId, Tags, args::AbstractDict{String, <: Any}) = organizations("TagResource", Dict{String, Any}("ResourceId"=>ResourceId, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceId, TagKeys) = organizations("UntagResource", Dict{String, Any}("ResourceId"=>ResourceId, "TagKeys"=>TagKeys))
UntagResource(ResourceId, TagKeys, args::AbstractDict{String, <: Any}) = organizations("UntagResource", Dict{String, Any}("ResourceId"=>ResourceId, "TagKeys"=>TagKeys, args...))
...
"""
UpdateOrganizationalUnit(OrganizationalUnitId) = organizations("UpdateOrganizationalUnit", Dict{String, Any}("OrganizationalUnitId"=>OrganizationalUnitId))
UpdateOrganizationalUnit(OrganizationalUnitId, args::AbstractDict{String, <: Any}) = organizations("UpdateOrganizationalUnit", Dict{String, Any}("OrganizationalUnitId"=>OrganizationalUnitId, args...))
...
"""
UpdatePolicy(PolicyId) = organizations("UpdatePolicy", Dict{String, Any}("PolicyId"=>PolicyId))
UpdatePolicy(PolicyId, args::AbstractDict{String, <: Any}) = organizations("UpdatePolicy", Dict{String, Any}("PolicyId"=>PolicyId, args...))
