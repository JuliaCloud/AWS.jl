...
function list_capabilities(; aws_config::AbstractAWSConfig=current_aws_config())
    return b2bi("ListCapabilities"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_capabilities(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return b2bi("ListCapabilities", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_partnerships(; aws_config::AbstractAWSConfig=current_aws_config())
    return b2bi("ListPartnerships"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_partnerships(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return b2bi("ListPartnerships", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_profiles(; aws_config::AbstractAWSConfig=current_aws_config())
    return b2bi("ListProfiles"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_profiles(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return b2bi("ListProfiles", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_transformers(; aws_config::AbstractAWSConfig=current_aws_config())
    return b2bi("ListTransformers"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_transformers(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return b2bi("ListTransformers", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
