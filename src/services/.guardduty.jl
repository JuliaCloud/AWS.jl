...
"""
CreateDetector(enable) = guardduty("POST", "/detector", Dict{String, Any}("enable"=>enable))
CreateDetector(enable, args::AbstractDict{String, <: Any}) = guardduty("POST", "/detector", Dict{String, Any}("enable"=>enable, args...))
...
"""
CreateFilter(detectorId, findingCriteria, name) = guardduty("POST", "/detector/$(detectorId)/filter", Dict{String, Any}("findingCriteria"=>findingCriteria, "name"=>name))
CreateFilter(detectorId, findingCriteria, name, args::AbstractDict{String, <: Any}) = guardduty("POST", "/detector/$(detectorId)/filter", Dict{String, Any}("findingCriteria"=>findingCriteria, "name"=>name, args...))
...
"""
CreateIPSet(activate, detectorId, format, location, name) = guardduty("POST", "/detector/$(detectorId)/ipset", Dict{String, Any}("activate"=>activate, "format"=>format, "location"=>location, "name"=>name))
CreateIPSet(activate, detectorId, format, location, name, args::AbstractDict{String, <: Any}) = guardduty("POST", "/detector/$(detectorId)/ipset", Dict{String, Any}("activate"=>activate, "format"=>format, "location"=>location, "name"=>name, args...))
...
"""
CreatePublishingDestination(destinationProperties, destinationType, detectorId) = guardduty("POST", "/detector/$(detectorId)/publishingDestination", Dict{String, Any}("destinationProperties"=>destinationProperties, "destinationType"=>destinationType))
CreatePublishingDestination(destinationProperties, destinationType, detectorId, args::AbstractDict{String, <: Any}) = guardduty("POST", "/detector/$(detectorId)/publishingDestination", Dict{String, Any}("destinationProperties"=>destinationProperties, "destinationType"=>destinationType, args...))
...
"""
CreateThreatIntelSet(activate, detectorId, format, location, name) = guardduty("POST", "/detector/$(detectorId)/threatintelset", Dict{String, Any}("activate"=>activate, "format"=>format, "location"=>location, "name"=>name))
CreateThreatIntelSet(activate, detectorId, format, location, name, args::AbstractDict{String, <: Any}) = guardduty("POST", "/detector/$(detectorId)/threatintelset", Dict{String, Any}("activate"=>activate, "format"=>format, "location"=>location, "name"=>name, args...))
