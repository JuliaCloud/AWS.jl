...
"""
function get_signing_platform(platformId; aws_config::AbstractAWSConfig=current_aws_config())
    return signer(
        "GET",
...
"""
function get_signing_profile(profileName; aws_config::AbstractAWSConfig=current_aws_config())
    return signer(
        "GET",
        "/signing-profiles/$(profileName)";
        aws_config=aws_config,
