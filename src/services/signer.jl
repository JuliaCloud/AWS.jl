...
`jobId` value that is returned by the [`start_signing_job`](@ref) operation.
...
function describe_signing_job(jobId; aws_config::AbstractAWSConfig=current_aws_config())
    return signer(
        "GET", "/signing-jobs/$(jobId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_signing_job(
    ...
    return signer(
        "GET", "/signing-jobs/$(jobId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_signing_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return signer("GET", "/signing-jobs"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_signing_jobs(
    ...
    return signer(
        "GET", "/signing-jobs", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_signing_platforms(; aws_config::AbstractAWSConfig=current_aws_config())
    return signer("GET", "/signing-platforms"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_signing_platforms(
    ...
    return signer(
        "GET", "/signing-platforms", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_signing_profiles(; aws_config::AbstractAWSConfig=current_aws_config())
    return signer("GET", "/signing-profiles"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_signing_profiles(
    ...
    return signer(
        "GET", "/signing-profiles", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- You specify the name of the source and destination buckets when calling the [`start_signing_job`](@ref)
  operation.
...
You can call the [`describe_signing_job`](@ref) and the [`list_signing_jobs`](@ref) actions
