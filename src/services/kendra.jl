...
- `IndexId`: The identifier of the index to add the documents to. You need to create the
...
- `RoleArn`: The Amazon Resource Name (ARN) of a role with permission to access the S3
...
# Optional Parameters
- `ClientToken`: A token that you provide to identify the request to create a FAQ. Multiple
  calls to the CreateFaqRequest operation with the same client token will create only one
  FAQ.
- `Description`: A description of the FAQ.
- `FileFormat`: The format of the input file. You can choose between a basic CSV format, a
...
- `RoleArn`: An AWS Identity and Access Management (IAM) role that gives Amazon Kendra
...
delete_thesaurus(Id, IndexId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kendra("DeleteThesaurus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId), args)); aws_config=aws_config)
...
describe_thesaurus(Id, IndexId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kendra("DescribeThesaurus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId), args)); aws_config=aws_config)
...
# Required Parameters
- `ResourceARN`: The Amazon Resource Name (ARN) of the index, FAQ, or data source to get a
  list of tags for.
...
list_thesauri(IndexId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kendra("ListThesauri", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IndexId"=>IndexId), args)); aws_config=aws_config)
...
# Required Parameters
- `IndexId`: The unique identifier of the index to search. The identifier is returned in
...
- `Facets`: An array of documents attributes. Amazon Kendra returns a count for each
  ...
  user.
- `PageNumber`: Query results are returned in pages the size of the PageSize parameter. By
...
- `SortingConfiguration`: Provides information that determines how the results of the query
  are sorted. You can set the field that Amazon Kendra should sort the results on, and
...
- `VisitorId`: Provides an identifier for a specific user. The VisitorId should be a unique
...
- `QueryId`: The identifier of the specific query for which you are submitting feedback.
  The query ID is returned in the response to the operation.

# Optional Parameters
- `ClickFeedbackItems`: Tells Amazon Kendra that a particular search result link was chosen
  by the user.
...
# Required Parameters
- `ResourceARN`: The Amazon Resource Name (ARN) of the index, FAQ, or data source to remove
  the tag from.
- `TagKeys`: A list of tag keys to remove from the index, FAQ, or data source. If a tag key
...
- `RoleArn`: The Amazon Resource Name (ARN) of the new role to use when the data source is
...
update_thesaurus(Id, IndexId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kendra("UpdateThesaurus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId), args)); aws_config=aws_config)
