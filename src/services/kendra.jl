...
"""
function clear_query_suggestions(IndexId; aws_config::AbstractAWSConfig=current_aws_config())
    return kendra(
...
function clear_query_suggestions(
    IndexId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return kendra(
        "ClearQuerySuggestions",
...
"""
function create_experience(IndexId, Name; aws_config::AbstractAWSConfig=current_aws_config())
    return kendra(
        "CreateExperience",
        Dict{String,Any}(
            "IndexId" => IndexId, "Name" => Name, "ClientToken" => string(uuid4())
...
"""
function describe_experience(Id, IndexId; aws_config::AbstractAWSConfig=current_aws_config())
    return kendra(
        "DescribeExperience",
        Dict{String,Any}("Id" => Id, "IndexId" => IndexId);
        aws_config=aws_config,
