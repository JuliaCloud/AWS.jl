...
"""
BatchDeleteDocument(DocumentIdList, IndexId) = kendra("BatchDeleteDocument", Dict{String, Any}("DocumentIdList"=>DocumentIdList, "IndexId"=>IndexId))
BatchDeleteDocument(DocumentIdList, IndexId, args::AbstractDict{String, <:Any}) = kendra("BatchDeleteDocument", Dict{String, Any}("DocumentIdList"=>DocumentIdList, "IndexId"=>IndexId, args...))
...
"""
BatchPutDocument(Documents, IndexId) = kendra("BatchPutDocument", Dict{String, Any}("Documents"=>Documents, "IndexId"=>IndexId))
BatchPutDocument(Documents, IndexId, args::AbstractDict{String, <:Any}) = kendra("BatchPutDocument", Dict{String, Any}("Documents"=>Documents, "IndexId"=>IndexId, args...))
...
"""
CreateDataSource(Configuration, IndexId, Name, RoleArn, Type) = kendra("CreateDataSource", Dict{String, Any}("Configuration"=>Configuration, "IndexId"=>IndexId, "Name"=>Name, "RoleArn"=>RoleArn, "Type"=>Type))
CreateDataSource(Configuration, IndexId, Name, RoleArn, Type, args::AbstractDict{String, <:Any}) = kendra("CreateDataSource", Dict{String, Any}("Configuration"=>Configuration, "IndexId"=>IndexId, "Name"=>Name, "RoleArn"=>RoleArn, "Type"=>Type, args...))
...
"""
CreateFaq(IndexId, Name, RoleArn, S3Path) = kendra("CreateFaq", Dict{String, Any}("IndexId"=>IndexId, "Name"=>Name, "RoleArn"=>RoleArn, "S3Path"=>S3Path))
CreateFaq(IndexId, Name, RoleArn, S3Path, args::AbstractDict{String, <:Any}) = kendra("CreateFaq", Dict{String, Any}("IndexId"=>IndexId, "Name"=>Name, "RoleArn"=>RoleArn, "S3Path"=>S3Path, args...))
...
"""
CreateIndex(Name, RoleArn) = kendra("CreateIndex", Dict{String, Any}("Name"=>Name, "RoleArn"=>RoleArn, "ClientToken"=>string(uuid4())))
CreateIndex(Name, RoleArn, args::AbstractDict{String, <:Any}) = kendra("CreateIndex", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name, "RoleArn"=>RoleArn, "ClientToken"=>string(uuid4())), args)))
...
"""
DeleteDataSource(Id, IndexId) = kendra("DeleteDataSource", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId))
DeleteDataSource(Id, IndexId, args::AbstractDict{String, <:Any}) = kendra("DeleteDataSource", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId, args...))
...
"""
DeleteFaq(Id, IndexId) = kendra("DeleteFaq", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId))
DeleteFaq(Id, IndexId, args::AbstractDict{String, <:Any}) = kendra("DeleteFaq", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId, args...))
...
"""
DeleteIndex(Id) = kendra("DeleteIndex", Dict{String, Any}("Id"=>Id))
DeleteIndex(Id, args::AbstractDict{String, <:Any}) = kendra("DeleteIndex", Dict{String, Any}("Id"=>Id, args...))
...
"""
DescribeDataSource(Id, IndexId) = kendra("DescribeDataSource", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId))
DescribeDataSource(Id, IndexId, args::AbstractDict{String, <:Any}) = kendra("DescribeDataSource", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId, args...))
...
"""
DescribeFaq(Id, IndexId) = kendra("DescribeFaq", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId))
DescribeFaq(Id, IndexId, args::AbstractDict{String, <:Any}) = kendra("DescribeFaq", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId, args...))
...
"""
DescribeIndex(Id) = kendra("DescribeIndex", Dict{String, Any}("Id"=>Id))
DescribeIndex(Id, args::AbstractDict{String, <:Any}) = kendra("DescribeIndex", Dict{String, Any}("Id"=>Id, args...))
...
"""
ListDataSourceSyncJobs(Id, IndexId) = kendra("ListDataSourceSyncJobs", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId))
ListDataSourceSyncJobs(Id, IndexId, args::AbstractDict{String, <:Any}) = kendra("ListDataSourceSyncJobs", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId, args...))
...
"""
ListDataSources(IndexId) = kendra("ListDataSources", Dict{String, Any}("IndexId"=>IndexId))
ListDataSources(IndexId, args::AbstractDict{String, <:Any}) = kendra("ListDataSources", Dict{String, Any}("IndexId"=>IndexId, args...))
...
"""
ListFaqs(IndexId) = kendra("ListFaqs", Dict{String, Any}("IndexId"=>IndexId))
ListFaqs(IndexId, args::AbstractDict{String, <:Any}) = kendra("ListFaqs", Dict{String, Any}("IndexId"=>IndexId, args...))
...
ListIndices(args::AbstractDict{String, <:Any}) = kendra("ListIndices", args)
...
"""
ListTagsForResource(ResourceARN) = kendra("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN))
ListTagsForResource(ResourceARN, args::AbstractDict{String, <:Any}) = kendra("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN, args...))
...
"""
Query(IndexId, QueryText) = kendra("Query", Dict{String, Any}("IndexId"=>IndexId, "QueryText"=>QueryText))
Query(IndexId, QueryText, args::AbstractDict{String, <:Any}) = kendra("Query", Dict{String, Any}("IndexId"=>IndexId, "QueryText"=>QueryText, args...))
...
"""
StartDataSourceSyncJob(Id, IndexId) = kendra("StartDataSourceSyncJob", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId))
StartDataSourceSyncJob(Id, IndexId, args::AbstractDict{String, <:Any}) = kendra("StartDataSourceSyncJob", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId, args...))
...
"""
StopDataSourceSyncJob(Id, IndexId) = kendra("StopDataSourceSyncJob", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId))
StopDataSourceSyncJob(Id, IndexId, args::AbstractDict{String, <:Any}) = kendra("StopDataSourceSyncJob", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId, args...))
...
"""
SubmitFeedback(IndexId, QueryId) = kendra("SubmitFeedback", Dict{String, Any}("IndexId"=>IndexId, "QueryId"=>QueryId))
SubmitFeedback(IndexId, QueryId, args::AbstractDict{String, <:Any}) = kendra("SubmitFeedback", Dict{String, Any}("IndexId"=>IndexId, "QueryId"=>QueryId, args...))
...
"""
TagResource(ResourceARN, Tags) = kendra("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags))
TagResource(ResourceARN, Tags, args::AbstractDict{String, <:Any}) = kendra("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceARN, TagKeys) = kendra("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys))
UntagResource(ResourceARN, TagKeys, args::AbstractDict{String, <:Any}) = kendra("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys, args...))
...
"""
UpdateDataSource(Id, IndexId) = kendra("UpdateDataSource", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId))
UpdateDataSource(Id, IndexId, args::AbstractDict{String, <:Any}) = kendra("UpdateDataSource", Dict{String, Any}("Id"=>Id, "IndexId"=>IndexId, args...))
...
"""
UpdateIndex(Id) = kendra("UpdateIndex", Dict{String, Any}("Id"=>Id))
UpdateIndex(Id, args::AbstractDict{String, <:Any}) = kendra("UpdateIndex", Dict{String, Any}("Id"=>Id, args...))
