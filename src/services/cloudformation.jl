...
"""
function delete_change_set(ChangeSetName; aws_config::AbstractAWSConfig=current_aws_config())
    return cloudformation(
        "DeleteChangeSet",
...
- `"CallAs"`: [Service-managed permissions] Specifies whether you are acting as an account
  ...
  Guide.
"""
function describe_stack_set(StackSetName; aws_config::AbstractAWSConfig=current_aws_config())
    return cloudformation(
        "DescribeStackSet",
        Dict{String,Any}("StackSetName" => StackSetName);
        aws_config=aws_config,
