...
"""
CreateStackInstances(Regions, StackSetName) = cloudformation("CreateStackInstances", Dict{String, Any}("Regions"=>Regions, "StackSetName"=>StackSetName, "OperationId"=>string(uuid4())))
CreateStackInstances(Regions, StackSetName, args::AbstractDict{String, <:Any}) = cloudformation("CreateStackInstances", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Regions"=>Regions, "StackSetName"=>StackSetName, "OperationId"=>string(uuid4())), args)))
...
"""
CreateStackSet(StackSetName) = cloudformation("CreateStackSet", Dict{String, Any}("StackSetName"=>StackSetName, "ClientRequestToken"=>string(uuid4())))
CreateStackSet(StackSetName, args::AbstractDict{String, <:Any}) = cloudformation("CreateStackSet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StackSetName"=>StackSetName, "ClientRequestToken"=>string(uuid4())), args)))
...
- `OperationPreferences`: Preferences for how AWS CloudFormation performs this stack set operation.
"""
DeleteStackInstances(Regions, RetainStacks, StackSetName) = cloudformation("DeleteStackInstances", Dict{String, Any}("Regions"=>Regions, "RetainStacks"=>RetainStacks, "StackSetName"=>StackSetName, "OperationId"=>string(uuid4())))
DeleteStackInstances(Regions, RetainStacks, StackSetName, args::AbstractDict{String, <:Any}) = cloudformation("DeleteStackInstances", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Regions"=>Regions, "RetainStacks"=>RetainStacks, "StackSetName"=>StackSetName, "OperationId"=>string(uuid4())), args)))
...
"""
DetectStackSetDrift(StackSetName) = cloudformation("DetectStackSetDrift", Dict{String, Any}("StackSetName"=>StackSetName, "OperationId"=>string(uuid4())))
DetectStackSetDrift(StackSetName, args::AbstractDict{String, <:Any}) = cloudformation("DetectStackSetDrift", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StackSetName"=>StackSetName, "OperationId"=>string(uuid4())), args)))
...
"""
UpdateStackInstances(Regions, StackSetName) = cloudformation("UpdateStackInstances", Dict{String, Any}("Regions"=>Regions, "StackSetName"=>StackSetName, "OperationId"=>string(uuid4())))
UpdateStackInstances(Regions, StackSetName, args::AbstractDict{String, <:Any}) = cloudformation("UpdateStackInstances", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Regions"=>Regions, "StackSetName"=>StackSetName, "OperationId"=>string(uuid4())), args)))
...
"""
UpdateStackSet(StackSetName) = cloudformation("UpdateStackSet", Dict{String, Any}("StackSetName"=>StackSetName, "OperationId"=>string(uuid4())))
UpdateStackSet(StackSetName, args::AbstractDict{String, <:Any}) = cloudformation("UpdateStackSet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StackSetName"=>StackSetName, "OperationId"=>string(uuid4())), args)))
