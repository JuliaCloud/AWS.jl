...
"""
CancelReplicationTaskAssessmentRun(ReplicationTaskAssessmentRunArn) = database_migration_service("CancelReplicationTaskAssessmentRun", Dict{String, Any}("ReplicationTaskAssessmentRunArn"=>ReplicationTaskAssessmentRunArn))
CancelReplicationTaskAssessmentRun(ReplicationTaskAssessmentRunArn, args::AbstractDict{String, <:Any}) = database_migration_service("CancelReplicationTaskAssessmentRun", Dict{String, Any}("ReplicationTaskAssessmentRunArn"=>ReplicationTaskAssessmentRunArn, args...))
...
"""
DeleteReplicationTaskAssessmentRun(ReplicationTaskAssessmentRunArn) = database_migration_service("DeleteReplicationTaskAssessmentRun", Dict{String, Any}("ReplicationTaskAssessmentRunArn"=>ReplicationTaskAssessmentRunArn))
DeleteReplicationTaskAssessmentRun(ReplicationTaskAssessmentRunArn, args::AbstractDict{String, <:Any}) = database_migration_service("DeleteReplicationTaskAssessmentRun", Dict{String, Any}("ReplicationTaskAssessmentRunArn"=>ReplicationTaskAssessmentRunArn, args...))
...
DescribeApplicableIndividualAssessments(args::AbstractDict{String, <:Any}) = database_migration_service("DescribeApplicableIndividualAssessments", args)
...
DescribeReplicationTaskAssessmentRuns(args::AbstractDict{String, <:Any}) = database_migration_service("DescribeReplicationTaskAssessmentRuns", args)
...
DescribeReplicationTaskIndividualAssessments(args::AbstractDict{String, <:Any}) = database_migration_service("DescribeReplicationTaskIndividualAssessments", args)
...
"""
StartReplicationTaskAssessmentRun(AssessmentRunName, ReplicationTaskArn, ResultLocationBucket, ServiceAccessRoleArn) = database_migration_service("StartReplicationTaskAssessmentRun", Dict{String, Any}("AssessmentRunName"=>AssessmentRunName, "ReplicationTaskArn"=>ReplicationTaskArn, "ResultLocationBucket"=>ResultLocationBucket, "ServiceAccessRoleArn"=>ServiceAccessRoleArn))
StartReplicationTaskAssessmentRun(AssessmentRunName, ReplicationTaskArn, ResultLocationBucket, ServiceAccessRoleArn, args::AbstractDict{String, <:Any}) = database_migration_service("StartReplicationTaskAssessmentRun", Dict{String, Any}("AssessmentRunName"=>AssessmentRunName, "ReplicationTaskArn"=>ReplicationTaskArn, "ResultLocationBucket"=>ResultLocationBucket, "ServiceAccessRoleArn"=>ServiceAccessRoleArn, args...))
