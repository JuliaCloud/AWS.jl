...
- `sessionId`: The session ID associated with the user's visit. Your application generates
...
- `trackingId`: The tracking ID for the event. The ID is generated by a call to the
...
# Required Parameters
- `datasetArn`: The Amazon Resource Name (ARN) of the Items dataset you are adding the item
  or items to.
...
# Required Parameters
- `datasetArn`: The Amazon Resource Name (ARN) of the Users dataset you are adding the user
  or users to.
