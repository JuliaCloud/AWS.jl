...
const SERVICE_PARAMETER_MAP = AWS.LittleDict("limit" => "Limit", "next_marker" => "NextMarker", "tags" => "Tags", "default_action" => "DefaultAction", "updates" => "Updates", "rule_group_id" => "RuleGroupId")
