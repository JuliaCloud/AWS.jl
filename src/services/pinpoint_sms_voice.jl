...
"""
create_configuration_set(; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_sms_voice("POST", "/v1/sms-voice/configuration-sets"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_configuration_set(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_sms_voice("POST", "/v1/sms-voice/configuration-sets", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_configuration_set_event_destination(ConfigurationSetName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_sms_voice("POST", "/v1/sms-voice/configuration-sets/$(ConfigurationSetName)/event-destinations"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_configuration_set_event_destination(ConfigurationSetName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_sms_voice("POST", "/v1/sms-voice/configuration-sets/$(ConfigurationSetName)/event-destinations", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `configuration_set_name`: ConfigurationSetName
"""
delete_configuration_set(ConfigurationSetName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_sms_voice("DELETE", "/v1/sms-voice/configuration-sets/$(ConfigurationSetName)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_configuration_set(ConfigurationSetName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_sms_voice("DELETE", "/v1/sms-voice/configuration-sets/$(ConfigurationSetName)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `configuration_set_name`: ConfigurationSetName
"""
get_configuration_set_event_destinations(ConfigurationSetName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_sms_voice("GET", "/v1/sms-voice/configuration-sets/$(ConfigurationSetName)/event-destinations"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_configuration_set_event_destinations(ConfigurationSetName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_sms_voice("GET", "/v1/sms-voice/configuration-sets/$(ConfigurationSetName)/event-destinations", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_configuration_sets(; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_sms_voice("GET", "/v1/sms-voice/configuration-sets"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_configuration_sets(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_sms_voice("GET", "/v1/sms-voice/configuration-sets", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"OriginationPhoneNumber"`: The phone number that Amazon Pinpoint should use to send the
  ...
  the request.
"""
send_voice_message(; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_sms_voice("POST", "/v1/sms-voice/voice/message"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
send_voice_message(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_sms_voice("POST", "/v1/sms-voice/voice/message", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
