...
CreateConfigurationSet(args::AbstractDict{String, Any}) = pinpoint_sms_voice("POST", "/v1/sms-voice/configuration-sets", args)
...
CreateConfigurationSetEventDestination(ConfigurationSetName, args::AbstractDict{String, <:Any}) = pinpoint_sms_voice("POST", "/v1/sms-voice/configuration-sets/$(ConfigurationSetName)/event-destinations", args)
...
DeleteConfigurationSet(ConfigurationSetName, args::AbstractDict{String, <:Any}) = pinpoint_sms_voice("DELETE", "/v1/sms-voice/configuration-sets/$(ConfigurationSetName)", args)
...
DeleteConfigurationSetEventDestination(ConfigurationSetName, EventDestinationName, args::AbstractDict{String, <:Any}) = pinpoint_sms_voice("DELETE", "/v1/sms-voice/configuration-sets/$(ConfigurationSetName)/event-destinations/$(EventDestinationName)", args)
...
GetConfigurationSetEventDestinations(ConfigurationSetName, args::AbstractDict{String, <:Any}) = pinpoint_sms_voice("GET", "/v1/sms-voice/configuration-sets/$(ConfigurationSetName)/event-destinations", args)
...
ListConfigurationSets(args::AbstractDict{String, Any}) = pinpoint_sms_voice("GET", "/v1/sms-voice/configuration-sets", args)
...
SendVoiceMessage(args::AbstractDict{String, Any}) = pinpoint_sms_voice("POST", "/v1/sms-voice/voice/message", args)
...
UpdateConfigurationSetEventDestination(ConfigurationSetName, EventDestinationName, args::AbstractDict{String, <:Any}) = pinpoint_sms_voice("PUT", "/v1/sms-voice/configuration-sets/$(ConfigurationSetName)/event-destinations/$(EventDestinationName)", args)
