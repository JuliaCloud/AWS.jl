...
"""
AddNotificationChannels(channels, profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/notificationConfiguration", Dict{String, Any}("channels"=>channels))
AddNotificationChannels(channels, profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/notificationConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("channels"=>channels), args)); aws=aws)
...
"""
BatchGetFrameMetricData(profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/frames/-/metrics"; aws=aws)
BatchGetFrameMetricData(profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/frames/-/metrics", args; aws=aws)
...
"""
ConfigureAgent(profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/configureAgent"; aws=aws)
ConfigureAgent(profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/configureAgent", args; aws=aws)
...
"""
CreateProfilingGroup(clientToken, profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/profilingGroups", Dict{String, Any}("clientToken"=>clientToken, "profilingGroupName"=>profilingGroupName))
CreateProfilingGroup(clientToken, profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/profilingGroups", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientToken"=>clientToken, "profilingGroupName"=>profilingGroupName), args)); aws=aws)
...
"""
DeleteProfilingGroup(profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)"; aws=aws)
DeleteProfilingGroup(profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)", args; aws=aws)
...
"""
DescribeProfilingGroup(profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)"; aws=aws)
DescribeProfilingGroup(profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)", args; aws=aws)
...
"""
GetFindingsReportAccountSummary(; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/internal/findingsReports"; aws=aws)
GetFindingsReportAccountSummary(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/internal/findingsReports", args; aws=aws)
...
"""
GetNotificationConfiguration(profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/notificationConfiguration"; aws=aws)
GetNotificationConfiguration(profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/notificationConfiguration", args; aws=aws)
...
"""
GetPolicy(profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/policy"; aws=aws)
GetPolicy(profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/policy", args; aws=aws)
...
"""
GetProfile(profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/profile"; aws=aws)
GetProfile(profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/profile", args; aws=aws)
...
"""
GetRecommendations(endTime, profilingGroupName, startTime; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/internal/profilingGroups/$(profilingGroupName)/recommendations", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime))
GetRecommendations(endTime, profilingGroupName, startTime, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/internal/profilingGroups/$(profilingGroupName)/recommendations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime), args)); aws=aws)
...
"""
ListFindingsReports(endTime, profilingGroupName, startTime; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/internal/profilingGroups/$(profilingGroupName)/findingsReports", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime))
ListFindingsReports(endTime, profilingGroupName, startTime, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/internal/profilingGroups/$(profilingGroupName)/findingsReports", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime), args)); aws=aws)
...
"""
ListProfileTimes(endTime, period, profilingGroupName, startTime; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/profileTimes", Dict{String, Any}("endTime"=>endTime, "period"=>period, "startTime"=>startTime))
ListProfileTimes(endTime, period, profilingGroupName, startTime, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/profileTimes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("endTime"=>endTime, "period"=>period, "startTime"=>startTime), args)); aws=aws)
...
"""
ListProfilingGroups(; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/profilingGroups"; aws=aws)
ListProfilingGroups(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/profilingGroups", args; aws=aws)
...
"""
ListTagsForResource(resourceArn; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/tags/$(resourceArn)"; aws=aws)
ListTagsForResource(resourceArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("GET", "/tags/$(resourceArn)", args; aws=aws)
...
"""
PostAgentProfile(Content_Type, agentProfile, profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/agentProfile", Dict{String, Any}("agentProfile"=>agentProfile, "profileToken"=>string(uuid4()), "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)); aws=aws)
PostAgentProfile(Content_Type, agentProfile, profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/agentProfile", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("agentProfile"=>agentProfile, "profileToken"=>string(uuid4()), "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)), args)); aws=aws)
...
"""
PutPermission(actionGroup, principals, profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("PUT", "/profilingGroups/$(profilingGroupName)/policy/$(actionGroup)", Dict{String, Any}("principals"=>principals))
PutPermission(actionGroup, principals, profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("PUT", "/profilingGroups/$(profilingGroupName)/policy/$(actionGroup)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("principals"=>principals), args)); aws=aws)
...
"""
RemoveNotificationChannel(channelId, profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)/notificationConfiguration/$(channelId)"; aws=aws)
RemoveNotificationChannel(channelId, profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)/notificationConfiguration/$(channelId)", args; aws=aws)
...
"""
RemovePermission(actionGroup, profilingGroupName, revisionId; aws::AWSConfig=AWSConfig()) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)/policy/$(actionGroup)", Dict{String, Any}("revisionId"=>revisionId))
RemovePermission(actionGroup, profilingGroupName, revisionId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)/policy/$(actionGroup)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("revisionId"=>revisionId), args)); aws=aws)
...
"""
SubmitFeedback(anomalyInstanceId, profilingGroupName, type; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/internal/profilingGroups/$(profilingGroupName)/anomalies/$(anomalyInstanceId)/feedback", Dict{String, Any}("type"=>type))
SubmitFeedback(anomalyInstanceId, profilingGroupName, type, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/internal/profilingGroups/$(profilingGroupName)/anomalies/$(anomalyInstanceId)/feedback", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("type"=>type), args)); aws=aws)
...
"""
TagResource(resourceArn, tags; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/tags/$(resourceArn)", Dict{String, Any}("tags"=>tags))
TagResource(resourceArn, tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("POST", "/tags/$(resourceArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("tags"=>tags), args)); aws=aws)
...
"""
UntagResource(resourceArn, tagKeys; aws::AWSConfig=AWSConfig()) = codeguruprofiler("DELETE", "/tags/$(resourceArn)", Dict{String, Any}("tagKeys"=>tagKeys))
UntagResource(resourceArn, tagKeys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("DELETE", "/tags/$(resourceArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("tagKeys"=>tagKeys), args)); aws=aws)
...
"""
UpdateProfilingGroup(agentOrchestrationConfig, profilingGroupName; aws::AWSConfig=AWSConfig()) = codeguruprofiler("PUT", "/profilingGroups/$(profilingGroupName)", Dict{String, Any}("agentOrchestrationConfig"=>agentOrchestrationConfig))
UpdateProfilingGroup(agentOrchestrationConfig, profilingGroupName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = codeguruprofiler("PUT", "/profilingGroups/$(profilingGroupName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("agentOrchestrationConfig"=>agentOrchestrationConfig), args)); aws=aws)
