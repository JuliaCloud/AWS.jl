...
AddNotificationChannels(channels, profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/notificationConfiguration", Dict{String, Any}("channels"=>channels); aws_config=aws_config)
AddNotificationChannels(channels, profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/notificationConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("channels"=>channels), args)); aws_config=aws_config)
...
BatchGetFrameMetricData(profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/frames/-/metrics"; aws_config=aws_config)
BatchGetFrameMetricData(profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/frames/-/metrics", args; aws_config=aws_config)
...
ConfigureAgent(profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/configureAgent"; aws_config=aws_config)
ConfigureAgent(profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/configureAgent", args; aws_config=aws_config)
...
CreateProfilingGroup(clientToken, profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/profilingGroups", Dict{String, Any}("clientToken"=>clientToken, "profilingGroupName"=>profilingGroupName); aws_config=aws_config)
CreateProfilingGroup(clientToken, profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/profilingGroups", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientToken"=>clientToken, "profilingGroupName"=>profilingGroupName), args)); aws_config=aws_config)
...
DeleteProfilingGroup(profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)"; aws_config=aws_config)
DeleteProfilingGroup(profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)", args; aws_config=aws_config)
...
DescribeProfilingGroup(profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)"; aws_config=aws_config)
DescribeProfilingGroup(profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)", args; aws_config=aws_config)
...
GetFindingsReportAccountSummary(; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/internal/findingsReports"; aws_config=aws_config)
GetFindingsReportAccountSummary(args::AbstractDict{String, Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/internal/findingsReports", args; aws_config=aws_config)
...
GetNotificationConfiguration(profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/notificationConfiguration"; aws_config=aws_config)
GetNotificationConfiguration(profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/notificationConfiguration", args; aws_config=aws_config)
...
GetPolicy(profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/policy"; aws_config=aws_config)
GetPolicy(profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/policy", args; aws_config=aws_config)
...
GetProfile(profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/profile"; aws_config=aws_config)
GetProfile(profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/profile", args; aws_config=aws_config)
...
GetRecommendations(endTime, profilingGroupName, startTime; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/internal/profilingGroups/$(profilingGroupName)/recommendations", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime); aws_config=aws_config)
GetRecommendations(endTime, profilingGroupName, startTime, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/internal/profilingGroups/$(profilingGroupName)/recommendations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime), args)); aws_config=aws_config)
...
ListFindingsReports(endTime, profilingGroupName, startTime; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/internal/profilingGroups/$(profilingGroupName)/findingsReports", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime); aws_config=aws_config)
ListFindingsReports(endTime, profilingGroupName, startTime, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/internal/profilingGroups/$(profilingGroupName)/findingsReports", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime), args)); aws_config=aws_config)
...
ListProfileTimes(endTime, period, profilingGroupName, startTime; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/profileTimes", Dict{String, Any}("endTime"=>endTime, "period"=>period, "startTime"=>startTime); aws_config=aws_config)
ListProfileTimes(endTime, period, profilingGroupName, startTime, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/profileTimes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("endTime"=>endTime, "period"=>period, "startTime"=>startTime), args)); aws_config=aws_config)
...
ListProfilingGroups(; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/profilingGroups"; aws_config=aws_config)
ListProfilingGroups(args::AbstractDict{String, Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/profilingGroups", args; aws_config=aws_config)
...
ListTagsForResource(resourceArn; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/tags/$(resourceArn)"; aws_config=aws_config)
ListTagsForResource(resourceArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("GET", "/tags/$(resourceArn)", args; aws_config=aws_config)
...
PostAgentProfile(Content_Type, agentProfile, profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/agentProfile", Dict{String, Any}("agentProfile"=>agentProfile, "profileToken"=>string(uuid4()), "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)); aws_config=aws_config)
PostAgentProfile(Content_Type, agentProfile, profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/agentProfile", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("agentProfile"=>agentProfile, "profileToken"=>string(uuid4()), "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)), args)); aws_config=aws_config)
...
PutPermission(actionGroup, principals, profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("PUT", "/profilingGroups/$(profilingGroupName)/policy/$(actionGroup)", Dict{String, Any}("principals"=>principals); aws_config=aws_config)
PutPermission(actionGroup, principals, profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("PUT", "/profilingGroups/$(profilingGroupName)/policy/$(actionGroup)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("principals"=>principals), args)); aws_config=aws_config)
...
RemoveNotificationChannel(channelId, profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)/notificationConfiguration/$(channelId)"; aws_config=aws_config)
RemoveNotificationChannel(channelId, profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)/notificationConfiguration/$(channelId)", args; aws_config=aws_config)
...
RemovePermission(actionGroup, profilingGroupName, revisionId; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)/policy/$(actionGroup)", Dict{String, Any}("revisionId"=>revisionId); aws_config=aws_config)
RemovePermission(actionGroup, profilingGroupName, revisionId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)/policy/$(actionGroup)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("revisionId"=>revisionId), args)); aws_config=aws_config)
...
SubmitFeedback(anomalyInstanceId, profilingGroupName, type; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/internal/profilingGroups/$(profilingGroupName)/anomalies/$(anomalyInstanceId)/feedback", Dict{String, Any}("type"=>type); aws_config=aws_config)
SubmitFeedback(anomalyInstanceId, profilingGroupName, type, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/internal/profilingGroups/$(profilingGroupName)/anomalies/$(anomalyInstanceId)/feedback", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("type"=>type), args)); aws_config=aws_config)
...
TagResource(resourceArn, tags; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/tags/$(resourceArn)", Dict{String, Any}("tags"=>tags); aws_config=aws_config)
TagResource(resourceArn, tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("POST", "/tags/$(resourceArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("tags"=>tags), args)); aws_config=aws_config)
...
UntagResource(resourceArn, tagKeys; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("DELETE", "/tags/$(resourceArn)", Dict{String, Any}("tagKeys"=>tagKeys); aws_config=aws_config)
UntagResource(resourceArn, tagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("DELETE", "/tags/$(resourceArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("tagKeys"=>tagKeys), args)); aws_config=aws_config)
...
UpdateProfilingGroup(agentOrchestrationConfig, profilingGroupName; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("PUT", "/profilingGroups/$(profilingGroupName)", Dict{String, Any}("agentOrchestrationConfig"=>agentOrchestrationConfig); aws_config=aws_config)
UpdateProfilingGroup(agentOrchestrationConfig, profilingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = codeguruprofiler("PUT", "/profilingGroups/$(profilingGroupName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("agentOrchestrationConfig"=>agentOrchestrationConfig), args)); aws_config=aws_config)
