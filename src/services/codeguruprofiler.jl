...
"""
AddNotificationChannels(channels, profilingGroupName) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/notificationConfiguration", Dict{String, Any}("channels"=>channels))
AddNotificationChannels(channels, profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/notificationConfiguration", Dict{String, Any}("channels"=>channels, args...))
AddNotificationChannels(a...; b...) = AddNotificationChannels(a..., b)
...
"""
BatchGetFrameMetricData(profilingGroupName) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/frames/-/metrics")
BatchGetFrameMetricData(profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/frames/-/metrics", args)
BatchGetFrameMetricData(a...; b...) = BatchGetFrameMetricData(a..., b)
...
ConfigureAgent(profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/configureAgent", args)
...
"""
CreateProfilingGroup(clientToken, profilingGroupName) = codeguruprofiler("POST", "/profilingGroups", Dict{String, Any}("clientToken"=>clientToken, "profilingGroupName"=>profilingGroupName))
CreateProfilingGroup(clientToken, profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("POST", "/profilingGroups", Dict{String, Any}("clientToken"=>clientToken, "profilingGroupName"=>profilingGroupName, args...))
...
DeleteProfilingGroup(profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)", args)
...
DescribeProfilingGroup(profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)", args)
...
GetFindingsReportAccountSummary(args::AbstractDict{String, Any}) = codeguruprofiler("GET", "/internal/findingsReports", args)
GetFindingsReportAccountSummary(a...; b...) = GetFindingsReportAccountSummary(a..., b)
...
"""
GetNotificationConfiguration(profilingGroupName) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/notificationConfiguration")
GetNotificationConfiguration(profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/notificationConfiguration", args)
GetNotificationConfiguration(a...; b...) = GetNotificationConfiguration(a..., b)
...
GetPolicy(profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/policy", args)
...
GetProfile(profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/profile", args)
...
"""
GetRecommendations(endTime, profilingGroupName, startTime) = codeguruprofiler("GET", "/internal/profilingGroups/$(profilingGroupName)/recommendations", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime))
GetRecommendations(endTime, profilingGroupName, startTime, args::AbstractDict{String, <: Any}) = codeguruprofiler("GET", "/internal/profilingGroups/$(profilingGroupName)/recommendations", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime, args...))
...
"""
ListFindingsReports(endTime, profilingGroupName, startTime) = codeguruprofiler("GET", "/internal/profilingGroups/$(profilingGroupName)/findingsReports", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime))
ListFindingsReports(endTime, profilingGroupName, startTime, args::AbstractDict{String, <: Any}) = codeguruprofiler("GET", "/internal/profilingGroups/$(profilingGroupName)/findingsReports", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime, args...))
ListFindingsReports(a...; b...) = ListFindingsReports(a..., b)
...
"""
ListProfileTimes(endTime, period, profilingGroupName, startTime) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/profileTimes", Dict{String, Any}("endTime"=>endTime, "period"=>period, "startTime"=>startTime))
ListProfileTimes(endTime, period, profilingGroupName, startTime, args::AbstractDict{String, <: Any}) = codeguruprofiler("GET", "/profilingGroups/$(profilingGroupName)/profileTimes", Dict{String, Any}("endTime"=>endTime, "period"=>period, "startTime"=>startTime, args...))
...
ListProfilingGroups(args::AbstractDict{String, Any}) = codeguruprofiler("GET", "/profilingGroups", args)
...
"""
ListTagsForResource(resourceArn) = codeguruprofiler("GET", "/tags/$(resourceArn)")
ListTagsForResource(resourceArn, args::AbstractDict{String, <: Any}) = codeguruprofiler("GET", "/tags/$(resourceArn)", args)
...
"""
PostAgentProfile(Content_Type, agentProfile, profilingGroupName) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/agentProfile", Dict{String, Any}("agentProfile"=>agentProfile, "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)))
PostAgentProfile(Content_Type, agentProfile, profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("POST", "/profilingGroups/$(profilingGroupName)/agentProfile", Dict{String, Any}(mergewith(merge, Dict{String, Any}("agentProfile"=>agentProfile, "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)), args...)))
...
"""
PutPermission(actionGroup, principals, profilingGroupName) = codeguruprofiler("PUT", "/profilingGroups/$(profilingGroupName)/policy/$(actionGroup)", Dict{String, Any}("principals"=>principals))
PutPermission(actionGroup, principals, profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("PUT", "/profilingGroups/$(profilingGroupName)/policy/$(actionGroup)", Dict{String, Any}("principals"=>principals, args...))
...
"""
RemoveNotificationChannel(channelId, profilingGroupName) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)/notificationConfiguration/$(channelId)")
RemoveNotificationChannel(channelId, profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)/notificationConfiguration/$(channelId)", args)
RemoveNotificationChannel(a...; b...) = RemoveNotificationChannel(a..., b)
...
"""
RemovePermission(actionGroup, profilingGroupName, revisionId) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)/policy/$(actionGroup)", Dict{String, Any}("revisionId"=>revisionId))
RemovePermission(actionGroup, profilingGroupName, revisionId, args::AbstractDict{String, <: Any}) = codeguruprofiler("DELETE", "/profilingGroups/$(profilingGroupName)/policy/$(actionGroup)", Dict{String, Any}("revisionId"=>revisionId, args...))
...
"""
SubmitFeedback(anomalyInstanceId, profilingGroupName, type) = codeguruprofiler("POST", "/internal/profilingGroups/$(profilingGroupName)/anomalies/$(anomalyInstanceId)/feedback", Dict{String, Any}("type"=>type))
SubmitFeedback(anomalyInstanceId, profilingGroupName, type, args::AbstractDict{String, <: Any}) = codeguruprofiler("POST", "/internal/profilingGroups/$(profilingGroupName)/anomalies/$(anomalyInstanceId)/feedback", Dict{String, Any}("type"=>type, args...))
SubmitFeedback(a...; b...) = SubmitFeedback(a..., b)
...
"""
TagResource(resourceArn, tags) = codeguruprofiler("POST", "/tags/$(resourceArn)", Dict{String, Any}("tags"=>tags))
TagResource(resourceArn, tags, args::AbstractDict{String, <: Any}) = codeguruprofiler("POST", "/tags/$(resourceArn)", Dict{String, Any}("tags"=>tags, args...))
...
"""
UntagResource(resourceArn, tagKeys) = codeguruprofiler("DELETE", "/tags/$(resourceArn)", Dict{String, Any}("tagKeys"=>tagKeys))
UntagResource(resourceArn, tagKeys, args::AbstractDict{String, <: Any}) = codeguruprofiler("DELETE", "/tags/$(resourceArn)", Dict{String, Any}("tagKeys"=>tagKeys, args...))
...
"""
UpdateProfilingGroup(agentOrchestrationConfig, profilingGroupName) = codeguruprofiler("PUT", "/profilingGroups/$(profilingGroupName)", Dict{String, Any}("agentOrchestrationConfig"=>agentOrchestrationConfig))
UpdateProfilingGroup(agentOrchestrationConfig, profilingGroupName, args::AbstractDict{String, <: Any}) = codeguruprofiler("PUT", "/profilingGroups/$(profilingGroupName)", Dict{String, Any}("agentOrchestrationConfig"=>agentOrchestrationConfig, args...))
