...
# Keyword Parameters
- `auto_enable_controls`: Whether to automatically enable new controls when they are added
...
- `disabled_reason`: A description of the reason why you are disabling a security standard
