...
"""
AcceptInvitation(InvitationId, MasterId; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/master", Dict{String, Any}("InvitationId"=>InvitationId, "MasterId"=>MasterId))
AcceptInvitation(InvitationId, MasterId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/master", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InvitationId"=>InvitationId, "MasterId"=>MasterId), args)); aws=aws)
...
"""
BatchDisableStandards(StandardsSubscriptionArns; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/standards/deregister", Dict{String, Any}("StandardsSubscriptionArns"=>StandardsSubscriptionArns))
BatchDisableStandards(StandardsSubscriptionArns, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/standards/deregister", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StandardsSubscriptionArns"=>StandardsSubscriptionArns), args)); aws=aws)
...
"""
BatchEnableStandards(StandardsSubscriptionRequests; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/standards/register", Dict{String, Any}("StandardsSubscriptionRequests"=>StandardsSubscriptionRequests))
BatchEnableStandards(StandardsSubscriptionRequests, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/standards/register", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StandardsSubscriptionRequests"=>StandardsSubscriptionRequests), args)); aws=aws)
...
"""
BatchImportFindings(Findings; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/findings/import", Dict{String, Any}("Findings"=>Findings))
BatchImportFindings(Findings, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/findings/import", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Findings"=>Findings), args)); aws=aws)
...
"""
BatchUpdateFindings(FindingIdentifiers; aws::AWSConfig=AWSConfig()) = securityhub("PATCH", "/findings/batchupdate", Dict{String, Any}("FindingIdentifiers"=>FindingIdentifiers))
BatchUpdateFindings(FindingIdentifiers, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("PATCH", "/findings/batchupdate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FindingIdentifiers"=>FindingIdentifiers), args)); aws=aws)
...
"""
CreateActionTarget(Description, Id, Name; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/actionTargets", Dict{String, Any}("Description"=>Description, "Id"=>Id, "Name"=>Name))
CreateActionTarget(Description, Id, Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/actionTargets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Description"=>Description, "Id"=>Id, "Name"=>Name), args)); aws=aws)
...
"""
CreateInsight(Filters, GroupByAttribute, Name; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/insights", Dict{String, Any}("Filters"=>Filters, "GroupByAttribute"=>GroupByAttribute, "Name"=>Name))
CreateInsight(Filters, GroupByAttribute, Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/insights", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Filters"=>Filters, "GroupByAttribute"=>GroupByAttribute, "Name"=>Name), args)); aws=aws)
...
"""
CreateMembers(; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/members"; aws=aws)
CreateMembers(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/members", args; aws=aws)
...
"""
DeclineInvitations(AccountIds; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/invitations/decline", Dict{String, Any}("AccountIds"=>AccountIds))
DeclineInvitations(AccountIds, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/invitations/decline", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds), args)); aws=aws)
...
"""
DeleteActionTarget(ActionTargetArn; aws::AWSConfig=AWSConfig()) = securityhub("DELETE", "/actionTargets/$(ActionTargetArn)"; aws=aws)
DeleteActionTarget(ActionTargetArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("DELETE", "/actionTargets/$(ActionTargetArn)", args; aws=aws)
...
"""
DeleteInsight(InsightArn; aws::AWSConfig=AWSConfig()) = securityhub("DELETE", "/insights/$(InsightArn)"; aws=aws)
DeleteInsight(InsightArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("DELETE", "/insights/$(InsightArn)", args; aws=aws)
...
"""
DeleteInvitations(AccountIds; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/invitations/delete", Dict{String, Any}("AccountIds"=>AccountIds))
DeleteInvitations(AccountIds, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/invitations/delete", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds), args)); aws=aws)
...
"""
DeleteMembers(; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/members/delete"; aws=aws)
DeleteMembers(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/members/delete", args; aws=aws)
...
"""
DescribeActionTargets(; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/actionTargets/get"; aws=aws)
DescribeActionTargets(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/actionTargets/get", args; aws=aws)
...
"""
DescribeHub(; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/accounts"; aws=aws)
DescribeHub(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/accounts", args; aws=aws)
...
"""
DescribeProducts(; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/products"; aws=aws)
DescribeProducts(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/products", args; aws=aws)
...
"""
DescribeStandards(; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/standards"; aws=aws)
DescribeStandards(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/standards", args; aws=aws)
...
"""
DescribeStandardsControls(StandardsSubscriptionArn; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/standards/controls/$(StandardsSubscriptionArn)"; aws=aws)
DescribeStandardsControls(StandardsSubscriptionArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/standards/controls/$(StandardsSubscriptionArn)", args; aws=aws)
...
"""
DisableImportFindingsForProduct(ProductSubscriptionArn; aws::AWSConfig=AWSConfig()) = securityhub("DELETE", "/productSubscriptions/$(ProductSubscriptionArn)"; aws=aws)
DisableImportFindingsForProduct(ProductSubscriptionArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("DELETE", "/productSubscriptions/$(ProductSubscriptionArn)", args; aws=aws)
...
"""
DisableSecurityHub(; aws::AWSConfig=AWSConfig()) = securityhub("DELETE", "/accounts"; aws=aws)
DisableSecurityHub(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("DELETE", "/accounts", args; aws=aws)
...
"""
DisassociateFromMasterAccount(; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/master/disassociate"; aws=aws)
DisassociateFromMasterAccount(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/master/disassociate", args; aws=aws)
...
"""
DisassociateMembers(; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/members/disassociate"; aws=aws)
DisassociateMembers(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/members/disassociate", args; aws=aws)
...
"""
EnableImportFindingsForProduct(ProductArn; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/productSubscriptions", Dict{String, Any}("ProductArn"=>ProductArn))
EnableImportFindingsForProduct(ProductArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/productSubscriptions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProductArn"=>ProductArn), args)); aws=aws)
...
"""
EnableSecurityHub(; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/accounts"; aws=aws)
EnableSecurityHub(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/accounts", args; aws=aws)
...
"""
GetEnabledStandards(; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/standards/get"; aws=aws)
GetEnabledStandards(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/standards/get", args; aws=aws)
...
"""
GetFindings(; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/findings"; aws=aws)
GetFindings(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/findings", args; aws=aws)
...
"""
GetInsightResults(InsightArn; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/insights/results/$(InsightArn)"; aws=aws)
GetInsightResults(InsightArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/insights/results/$(InsightArn)", args; aws=aws)
...
"""
GetInsights(; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/insights/get"; aws=aws)
GetInsights(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/insights/get", args; aws=aws)
...
"""
GetInvitationsCount(; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/invitations/count"; aws=aws)
GetInvitationsCount(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/invitations/count", args; aws=aws)
...
"""
GetMasterAccount(; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/master"; aws=aws)
GetMasterAccount(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/master", args; aws=aws)
...
"""
GetMembers(AccountIds; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/members/get", Dict{String, Any}("AccountIds"=>AccountIds))
GetMembers(AccountIds, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/members/get", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds), args)); aws=aws)
...
"""
InviteMembers(; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/members/invite"; aws=aws)
InviteMembers(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/members/invite", args; aws=aws)
...
"""
ListEnabledProductsForImport(; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/productSubscriptions"; aws=aws)
ListEnabledProductsForImport(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/productSubscriptions", args; aws=aws)
...
"""
ListInvitations(; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/invitations"; aws=aws)
ListInvitations(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/invitations", args; aws=aws)
...
"""
ListMembers(; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/members"; aws=aws)
ListMembers(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/members", args; aws=aws)
...
"""
ListTagsForResource(ResourceArn; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/tags/$(ResourceArn)"; aws=aws)
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("GET", "/tags/$(ResourceArn)", args; aws=aws)
...
"""
TagResource(ResourceArn, Tags; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/tags/$(ResourceArn)", Dict{String, Any}("Tags"=>Tags))
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("POST", "/tags/$(ResourceArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Tags"=>Tags), args)); aws=aws)
...
"""
UntagResource(ResourceArn, tagKeys; aws::AWSConfig=AWSConfig()) = securityhub("DELETE", "/tags/$(ResourceArn)", Dict{String, Any}("tagKeys"=>tagKeys))
UntagResource(ResourceArn, tagKeys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("DELETE", "/tags/$(ResourceArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("tagKeys"=>tagKeys), args)); aws=aws)
...
"""
UpdateActionTarget(ActionTargetArn; aws::AWSConfig=AWSConfig()) = securityhub("PATCH", "/actionTargets/$(ActionTargetArn)"; aws=aws)
UpdateActionTarget(ActionTargetArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("PATCH", "/actionTargets/$(ActionTargetArn)", args; aws=aws)
...
"""
UpdateFindings(Filters; aws::AWSConfig=AWSConfig()) = securityhub("PATCH", "/findings", Dict{String, Any}("Filters"=>Filters))
UpdateFindings(Filters, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("PATCH", "/findings", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Filters"=>Filters), args)); aws=aws)
...
"""
UpdateInsight(InsightArn; aws::AWSConfig=AWSConfig()) = securityhub("PATCH", "/insights/$(InsightArn)"; aws=aws)
UpdateInsight(InsightArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("PATCH", "/insights/$(InsightArn)", args; aws=aws)
...
"""
UpdateSecurityHubConfiguration(; aws::AWSConfig=AWSConfig()) = securityhub("PATCH", "/accounts"; aws=aws)
UpdateSecurityHubConfiguration(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = securityhub("PATCH", "/accounts", args; aws=aws)
...
"""
UpdateStandardsControl(StandardsControlArn; aws::AWSConfig=AWSConfig()) = securityhub("PATCH", "/standards/control/$(StandardsControlArn)"; aws=aws)
UpdateStandardsControl(StandardsControlArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = securityhub("PATCH", "/standards/control/$(StandardsControlArn)", args; aws=aws)
