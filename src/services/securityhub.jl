...
"""
accept_administrator_invitation(AdministratorId, InvitationId; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/administrator", Dict{String, Any}("AdministratorId"=>AdministratorId, "InvitationId"=>InvitationId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
accept_administrator_invitation(AdministratorId, InvitationId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/administrator", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AdministratorId"=>AdministratorId, "InvitationId"=>InvitationId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `master_id`: The account ID of the Security Hub administrator account that sent the
  invitation.
"""
accept_invitation(InvitationId, MasterId; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/master", Dict{String, Any}("InvitationId"=>InvitationId, "MasterId"=>MasterId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
accept_invitation(InvitationId, MasterId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/master", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InvitationId"=>InvitationId, "MasterId"=>MasterId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `automation_rules_arns`:  A list of Amazon Resource Names (ARNs) for the rules that are
  to be deleted.
"""
batch_delete_automation_rules(AutomationRulesArns; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/automationrules/delete", Dict{String, Any}("AutomationRulesArns"=>AutomationRulesArns); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_delete_automation_rules(AutomationRulesArns, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/automationrules/delete", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutomationRulesArns"=>AutomationRulesArns), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
batch_disable_standards(StandardsSubscriptionArns; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/standards/deregister", Dict{String, Any}("StandardsSubscriptionArns"=>StandardsSubscriptionArns); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_disable_standards(StandardsSubscriptionArns, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/standards/deregister", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StandardsSubscriptionArns"=>StandardsSubscriptionArns), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
standard, use the `DescribeStandards` operation.
...
"""
batch_enable_standards(StandardsSubscriptionRequests; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/standards/register", Dict{String, Any}("StandardsSubscriptionRequests"=>StandardsSubscriptionRequests); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_enable_standards(StandardsSubscriptionRequests, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/standards/register", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StandardsSubscriptionRequests"=>StandardsSubscriptionRequests), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
batch_get_automation_rules(AutomationRulesArns; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/automationrules/get", Dict{String, Any}("AutomationRulesArns"=>AutomationRulesArns); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_get_automation_rules(AutomationRulesArns, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/automationrules/get", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutomationRulesArns"=>AutomationRulesArns), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
batch_get_configuration_policy_associations(ConfigurationPolicyAssociationIdentifiers, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/configurationPolicyAssociation/batchget", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationPolicyAssociationIdentifiers"=>ConfigurationPolicyAssociationIdentifiers), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `security_control_ids`:  A list of security controls (identified with
...
"""
batch_get_security_controls(SecurityControlIds; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/securityControls/batchGet", Dict{String, Any}("SecurityControlIds"=>SecurityControlIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_get_security_controls(SecurityControlIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/securityControls/batchGet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SecurityControlIds"=>SecurityControlIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
batch_get_standards_control_associations(StandardsControlAssociationIds; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/associations/batchGet", Dict{String, Any}("StandardsControlAssociationIds"=>StandardsControlAssociationIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_get_standards_control_associations(StandardsControlAssociationIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/associations/batchGet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StandardsControlAssociationIds"=>StandardsControlAssociationIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
requested by the finding provider to import its findings into Security Hub.
 ...
 `BatchImportFindings` must be called by one of the following:</p> - The Amazon Web
Services account that is associated with a finding if you are using the [default product ARN](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-custom-providers.html#securityhub-custom-providers-bfi-reqs)
...
partner integration. In this case, you can call `BatchImportFindings` from the allow-listed
...
larger than 240 Kb.
 ...
 <p>After a finding is created, `BatchImportFindings` cannot be used to update the
following finding fields and objects, which Security Hub customers use to manage their
investigation workflow. - `Note`
 - `UserDefinedFields`
 - `VerificationState`
 - `Workflow`
...
"""
batch_import_findings(Findings; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/findings/import", Dict{String, Any}("Findings"=>Findings); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_import_findings(Findings, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/findings/import", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Findings"=>Findings), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
batch_update_automation_rules(UpdateAutomationRulesRequestItems; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/automationrules/update", Dict{String, Any}("UpdateAutomationRulesRequestItems"=>UpdateAutomationRulesRequestItems); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_update_automation_rules(UpdateAutomationRulesRequestItems, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/automationrules/update", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("UpdateAutomationRulesRequestItems"=>UpdateAutomationRulesRequestItems), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
finding fields and objects. - `Confidence`
 - `Criticality`
 - `Note`
 - `RelatedFindings`
 - `Severity`
...
- `"Types"`: One or more finding types in the format of namespace/category/classifier that
  ...
  Valid namespace values are as follows. - Software and Configuration Checks
   - TTPs
 - Effects
 - Unusual Behaviors
...
- `"VerificationState"`: Indicates the veracity of a finding.
  ...
  The available values for `VerificationState` are as follows. - `UNKNOWN` – The default
...
"""
batch_update_findings(FindingIdentifiers; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/findings/batchupdate", Dict{String, Any}("FindingIdentifiers"=>FindingIdentifiers); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_update_findings(FindingIdentifiers, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/findings/batchupdate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FindingIdentifiers"=>FindingIdentifiers), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
batch_update_standards_control_associations(StandardsControlAssociationUpdates; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/associations", Dict{String, Any}("StandardsControlAssociationUpdates"=>StandardsControlAssociationUpdates); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_update_standards_control_associations(StandardsControlAssociationUpdates, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/associations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StandardsControlAssociationUpdates"=>StandardsControlAssociationUpdates), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_action_target(Description, Id, Name; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/actionTargets", Dict{String, Any}("Description"=>Description, "Id"=>Id, "Name"=>Name); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_action_target(Description, Id, Name, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/actionTargets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Description"=>Description, "Id"=>Id, "Name"=>Name), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"IsTerminal"`: Specifies whether a rule is the last to be applied with respect to a
  ...
  criteria for multiple rules, and each rule has different actions. If a rule is terminal,
  Security Hub applies the rule action to a finding that matches the rule criteria and
...
- `configuration_policy`:  An object that defines how Security Hub is configured. It
  ...
  parameter values for specified controls. If you provide a list of security controls that
  are enabled in the configuration policy, Security Hub disables all other controls
  (including newly released controls). If you provide a list of security controls that are
  disabled in the configuration policy, Security Hub enables all other controls (including
...
- `"Tags"`:  User-defined tags associated with a configuration policy. For more
  ...
  in the *Security Hub user guide*.
"""
create_configuration_policy(ConfigurationPolicy, Name; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/configurationPolicy/create", Dict{String, Any}("ConfigurationPolicy"=>ConfigurationPolicy, "Name"=>Name); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_configuration_policy(ConfigurationPolicy, Name, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/configurationPolicy/create", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationPolicy"=>ConfigurationPolicy, "Name"=>Name), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `region_linking_mode`: Indicates whether to aggregate findings from all of the available
  ...
  The options are as follows: - `ALL_REGIONS` - Aggregates findings from all of the Regions
  where Security Hub is enabled. When you choose this option, Security Hub also
  automatically aggregates findings from new Regions as Security Hub supports them and you
  opt into them.
...
"""
create_finding_aggregator(RegionLinkingMode; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/findingAggregator/create", Dict{String, Any}("RegionLinkingMode"=>RegionLinkingMode); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_finding_aggregator(RegionLinkingMode, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/findingAggregator/create", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RegionLinkingMode"=>RegionLinkingMode), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_insight(Filters, GroupByAttribute, Name; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/insights", Dict{String, Any}("Filters"=>Filters, "GroupByAttribute"=>GroupByAttribute, "Name"=>Name); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_insight(Filters, GroupByAttribute, Name, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/insights", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Filters"=>Filters, "GroupByAttribute"=>GroupByAttribute, "Name"=>Name), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
following cases:</p> - Security Hub is not configured to automatically add new organization
accounts.
...
a member account in Security Hub.

Accounts that are managed using Organizations do not receive an invitation. They
automatically become a member account in Security Hub. - If the organization account does
not have Security Hub enabled, then Security Hub and the default standards are
automatically enabled. Note that Security Hub cannot be enabled automatically for the
...
generated in the member account.
 ...
 <p>To remove the association between the administrator and member accounts, use the
...
- `account_details`: The list of accounts to associate with the Security Hub administrator
  ...
  address.
"""
create_members(AccountDetails; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/members", Dict{String, Any}("AccountDetails"=>AccountDetails); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_members(AccountDetails, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/members", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountDetails"=>AccountDetails), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `account_ids`: The list of prospective member account IDs for which to decline an
  invitation.
"""
decline_invitations(AccountIds; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/invitations/decline", Dict{String, Any}("AccountIds"=>AccountIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
decline_invitations(AccountIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/invitations/decline", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_action_target(ActionTargetArn; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/actionTargets/$(ActionTargetArn)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_action_target(ActionTargetArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/actionTargets/$(ActionTargetArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_configuration_policy(Identifier; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/configurationPolicy/$(Identifier)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_configuration_policy(Identifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/configurationPolicy/$(Identifier)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_finding_aggregator(FindingAggregatorArn; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/findingAggregator/delete/$(FindingAggregatorArn)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_finding_aggregator(FindingAggregatorArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/findingAggregator/delete/$(FindingAggregatorArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_insight(InsightArn; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/insights/$(InsightArn)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_insight(InsightArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/insights/$(InsightArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `account_ids`: The list of member account IDs that received the invitations you want to
  delete.
"""
delete_invitations(AccountIds; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/invitations/delete", Dict{String, Any}("AccountIds"=>AccountIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_invitations(AccountIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/invitations/delete", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_members(AccountIds; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/members/delete", Dict{String, Any}("AccountIds"=>AccountIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_members(AccountIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/members/delete", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_action_targets(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/actionTargets/get"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_action_targets(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/actionTargets/get", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_hub(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/accounts"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_hub(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/accounts", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_organization_configuration(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/organization/configuration"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_organization_configuration(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/organization/configuration", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_products(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/products"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_products(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/products", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The token that is required for pagination. On your first call to the
  ...
  parameter to the value returned from the previous response.
"""
describe_standards(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/standards"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_standards(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/standards", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The token that is required for pagination. On your first call to the
  ...
  parameter to the value returned from the previous response.
"""
describe_standards_controls(StandardsSubscriptionArn; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/standards/controls/$(StandardsSubscriptionArn)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_standards_controls(StandardsSubscriptionArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/standards/controls/$(StandardsSubscriptionArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `product_subscription_arn`: The ARN of the integrated product to disable the integration
  for.
"""
disable_import_findings_for_product(ProductSubscriptionArn; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/productSubscriptions/$(ProductSubscriptionArn)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
disable_import_findings_for_product(ProductSubscriptionArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/productSubscriptions/$(ProductSubscriptionArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `admin_account_id`: The Amazon Web Services account identifier of the Security Hub
  administrator account.
"""
disable_organization_admin_account(AdminAccountId; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/organization/admin/disable", Dict{String, Any}("AdminAccountId"=>AdminAccountId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
disable_organization_admin_account(AdminAccountId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/organization/admin/disable", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AdminAccountId"=>AdminAccountId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Security Hub.
"""
disable_security_hub(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/accounts"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
disable_security_hub(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/accounts", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
disassociate_from_administrator_account(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/administrator/disassociate"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
disassociate_from_administrator_account(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/administrator/disassociate", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
organization accounts, only the administrator account can disassociate a member account.
"""
disassociate_from_master_account(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/master/disassociate"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
disassociate_from_master_account(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/master/disassociate", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `account_ids`: The account IDs of the member accounts to disassociate from the
  administrator account.
"""
disassociate_members(AccountIds; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/members/disassociate", Dict{String, Any}("AccountIds"=>AccountIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
disassociate_members(AccountIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/members/disassociate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
enable_import_findings_for_product(ProductArn; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/productSubscriptions", Dict{String, Any}("ProductArn"=>ProductArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
enable_import_findings_for_product(ProductArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/productSubscriptions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProductArn"=>ProductArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
enable_organization_admin_account(AdminAccountId; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/organization/admin/enable", Dict{String, Any}("AdminAccountId"=>AdminAccountId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
enable_organization_admin_account(AdminAccountId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/organization/admin/enable", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AdminAccountId"=>AdminAccountId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
automatically enable the following standards:</p> - Center for Internet Security (CIS)
Amazon Web Services Foundations Benchmark v1.2.0
...
operation. To disable a standard, use the `BatchDisableStandards` operation.
 ...
 <p>To learn more, see the [setup information](https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-settingup.html)
in the *Security Hub User Guide*.
...
"""
enable_security_hub(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/accounts"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
enable_security_hub(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/accounts", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_administrator_account(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/administrator"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_administrator_account(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/administrator", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `identifier`:  The Amazon Resource Name (ARN) or universally unique identifier (UUID) of
  the configuration policy.
"""
get_configuration_policy(Identifier; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/configurationPolicy/get/$(Identifier)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_configuration_policy(Identifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/configurationPolicy/get/$(Identifier)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `target`:  The target account ID, organizational unit ID, or the root ID to retrieve the
  association for.
"""
get_configuration_policy_association(Target; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/configurationPolicyAssociation/get", Dict{String, Any}("Target"=>Target); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_configuration_policy_association(Target, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/configurationPolicyAssociation/get", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Target"=>Target), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_enabled_standards(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/standards/get"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_enabled_standards(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/standards/get", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_finding_aggregator(FindingAggregatorArn; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/findingAggregator/get/$(FindingAggregatorArn)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_finding_aggregator(FindingAggregatorArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/findingAggregator/get/$(FindingAggregatorArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"EndTime"`:  An ISO 8601-formatted timestamp that indicates the end time of the
  ...
  ") time-hour [":" time-minute]`. The time-secfrac after seconds is limited to a maximum of 9 digits. The offset is bounded by +/-18:00. Here are valid timestamp formats with examples: - `YYYY-MM-DDTHH:MM:SSZ` (for example, `2019-01-31T23:00:00Z`)
...
- `"NextToken"`:  A token for pagination purposes. Provide `NULL` as the initial value. In
  ...
  additional 100 results of finding history. If you don’t provide `NextToken`, Security Hub
...
- `"StartTime"`: A timestamp that indicates the start time of the requested finding
  ...
  04T15:25:10.123456789+17:59`)
"""
get_finding_history(FindingIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/findingHistory/get", Dict{String, Any}("FindingIdentifier"=>FindingIdentifier); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_finding_history(FindingIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/findingHistory/get", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FindingIdentifier"=>FindingIdentifier), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_findings(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/findings"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_findings(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/findings", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_insight_results(InsightArn; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/insights/results/$(InsightArn)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_insight_results(InsightArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/insights/results/$(InsightArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The token that is required for pagination. On your first call to the
  ...
  parameter to the value returned from the previous response.
"""
get_insights(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/insights/get"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_insights(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/insights/get", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_invitations_count(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/invitations/count"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_invitations_count(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/invitations/count", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
were invited manually.
"""
get_master_account(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/master"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_master_account(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/master", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `account_ids`: The list of account IDs for the Security Hub member accounts to return the
  details for.
"""
get_members(AccountIds; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/members/get", Dict{String, Any}("AccountIds"=>AccountIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_members(AccountIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/members/get", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_security_control_definition(SecurityControlId; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/securityControl/definition", Dict{String, Any}("SecurityControlId"=>SecurityControlId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_security_control_definition(SecurityControlId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/securityControl/definition", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SecurityControlId"=>SecurityControlId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
invite_members(AccountIds; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/members/invite", Dict{String, Any}("AccountIds"=>AccountIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
invite_members(AccountIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/members/invite", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_automation_rules(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/automationrules/list"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_automation_rules(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/automationrules/list", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"MaxResults"`:  The maximum number of results that's returned by
  ...
  `ListConfigurationPolicies` returns the specified number of results in a single page and
...
"""
list_configuration_policies(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/configurationPolicy/list"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_configuration_policies(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/configurationPolicy/list", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"Filters"`:  Options for filtering the `ListConfigurationPolicyAssociations` response.
  You can filter by the Amazon Resource Name (ARN) or universally unique identifier (UUID)
...
- `"MaxResults"`:  The maximum number of results that's returned by
  ...
  request by sending another `ListConfigurationPolicyAssociations` request with the
...
- `"NextToken"`:  The `NextToken` value that's returned from a previous paginated
  ...
  results to return.
"""
list_configuration_policy_associations(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/configurationPolicyAssociation/list"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_configuration_policy_associations(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/configurationPolicyAssociation/list", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The token that is required for pagination. On your first call to the
  ...
  parameter to the value returned from the previous response.
"""
list_enabled_products_for_import(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/productSubscriptions"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_enabled_products_for_import(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/productSubscriptions", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_finding_aggregators(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/findingAggregator/list"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_finding_aggregators(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/findingAggregator/list", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The token that is required for pagination. On your first call to the
  ...
  parameter to the value returned from the previous response.
"""
list_invitations(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/invitations"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_invitations(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/invitations", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"OnlyAssociated"`: Specifies which member accounts to include in the response based on
  ...
  accounts.
"""
list_members(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/members"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_members(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/members", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The token that is required for pagination. On your first call to the
  ...
  parameter to the value returned from the previous response.
"""
list_organization_admin_accounts(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/organization/admin"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_organization_admin_accounts(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/organization/admin", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"StandardsArn"`:  The Amazon Resource Name (ARN) of the standard that you want to view
  controls for.
"""
list_security_control_definitions(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/securityControls/definitions"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_security_control_definitions(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/securityControls/definitions", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `security_control_id`:  The identifier of the control (identified with
  `SecurityControlId`, `SecurityControlArn`, or a mix of both parameters) that you want to
...
- `"NextToken"`:  Optional pagination parameter.
"""
list_standards_control_associations(SecurityControlId; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/associations", Dict{String, Any}("SecurityControlId"=>SecurityControlId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_standards_control_associations(SecurityControlId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/associations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SecurityControlId"=>SecurityControlId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_tags_for_resource(ResourceArn; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/tags/$(ResourceArn)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_tags_for_resource(ResourceArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("GET", "/tags/$(ResourceArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
start_configuration_policy_disassociation(ConfigurationPolicyIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/configurationPolicyAssociation/disassociate", Dict{String, Any}("ConfigurationPolicyIdentifier"=>ConfigurationPolicyIdentifier); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_configuration_policy_disassociation(ConfigurationPolicyIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/configurationPolicyAssociation/disassociate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationPolicyIdentifier"=>ConfigurationPolicyIdentifier), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `tags`: The tags to add to the resource. You can add up to 50 tags at a time. The tag
  ...
  characters.
"""
tag_resource(ResourceArn, Tags; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/tags/$(ResourceArn)", Dict{String, Any}("Tags"=>Tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
tag_resource(ResourceArn, Tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/tags/$(ResourceArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Tags"=>Tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
untag_resource(ResourceArn, tagKeys; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/tags/$(ResourceArn)", Dict{String, Any}("tagKeys"=>tagKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
untag_resource(ResourceArn, tagKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("DELETE", "/tags/$(ResourceArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("tagKeys"=>tagKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_action_target(ActionTargetArn; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/actionTargets/$(ActionTargetArn)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_action_target(ActionTargetArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/actionTargets/$(ActionTargetArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_configuration_policy(Identifier; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/configurationPolicy/$(Identifier)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_configuration_policy(Identifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/configurationPolicy/$(Identifier)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"Regions"`: If `RegionLinkingMode` is `ALL_REGIONS_EXCEPT_SPECIFIED`, then this is a
  ...
  `RegionLinkingMode` is `NO_REGIONS`.
"""
update_finding_aggregator(FindingAggregatorArn, RegionLinkingMode; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/findingAggregator/update", Dict{String, Any}("FindingAggregatorArn"=>FindingAggregatorArn, "RegionLinkingMode"=>RegionLinkingMode); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_finding_aggregator(FindingAggregatorArn, RegionLinkingMode, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/findingAggregator/update", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FindingAggregatorArn"=>FindingAggregatorArn, "RegionLinkingMode"=>RegionLinkingMode), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
The `UpdateFindings` operation updates the `Note` and `RecordState` of the Security Hub
aggregated findings that the filter attributes specify. Any member account that can view
...
updated by the finding provider through the `BatchImportFindings` operation. In addition,
Security Hub doesn't record updates made with `UpdateFindings` in the finding history.
...
"""
update_findings(Filters; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/findings", Dict{String, Any}("Filters"=>Filters); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_findings(Filters, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/findings", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Filters"=>Filters), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_insight(InsightArn; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/insights/$(InsightArn)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_insight(InsightArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/insights/$(InsightArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_organization_configuration(AutoEnable; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/organization/configuration", Dict{String, Any}("AutoEnable"=>AutoEnable); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_organization_configuration(AutoEnable, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("POST", "/organization/configuration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoEnable"=>AutoEnable), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"LastUpdateReason"`:  The most recent reason for updating the properties of the security
  ...
  and underscores.
"""
update_security_control(Parameters, SecurityControlId; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/securityControl/update", Dict{String, Any}("Parameters"=>Parameters, "SecurityControlId"=>SecurityControlId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_security_control(Parameters, SecurityControlId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/securityControl/update", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Parameters"=>Parameters, "SecurityControlId"=>SecurityControlId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"ControlFindingGenerator"`: Updates whether the calling account has consolidated control
  ...
  administrator account.
"""
update_security_hub_configuration(; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/accounts"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_security_hub_configuration(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/accounts", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_standards_control(StandardsControlArn; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/standards/control/$(StandardsControlArn)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_standards_control(StandardsControlArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = securityhub("PATCH", "/standards/control/$(StandardsControlArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
