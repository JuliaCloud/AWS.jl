...
Required Parameters
{
  ...
  "name": "A custom name for the job. The name must contain at least 3 characters and can contain as many as 64 characters.",
...
Optional Parameters
{
  ...
  "description": "A custom description of the job. The description can contain as many as 512 characters.",
