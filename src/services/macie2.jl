...
"""
CreateCustomDataIdentifier() = macie2("POST", "/custom-data-identifiers", Dict{String, Any}("clientToken"=>string(uuid4())))
CreateCustomDataIdentifier(args::AbstractDict{String, <:Any}) = macie2("POST", "/custom-data-identifiers", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientToken"=>string(uuid4())), args...)))
...
"""
CreateFindingsFilter(action, findingCriteria, name) = macie2("POST", "/findingsfilters", Dict{String, Any}("action"=>action, "findingCriteria"=>findingCriteria, "name"=>name, "clientToken"=>string(uuid4())))
CreateFindingsFilter(action, findingCriteria, name, args::AbstractDict{String, <:Any}) = macie2("POST", "/findingsfilters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("action"=>action, "findingCriteria"=>findingCriteria, "name"=>name, "clientToken"=>string(uuid4())), args...)))
...
"""
EnableMacie() = macie2("POST", "/macie", Dict{String, Any}("clientToken"=>string(uuid4())))
EnableMacie(args::AbstractDict{String, <:Any}) = macie2("POST", "/macie", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientToken"=>string(uuid4())), args...)))
...
- `clientToken`: A unique, case-sensitive token that you provide to ensure the idempotency of the request.
"""
EnableOrganizationAdminAccount(adminAccountId) = macie2("POST", "/admin", Dict{String, Any}("adminAccountId"=>adminAccountId, "clientToken"=>string(uuid4())))
EnableOrganizationAdminAccount(adminAccountId, args::AbstractDict{String, <:Any}) = macie2("POST", "/admin", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("adminAccountId"=>adminAccountId, "clientToken"=>string(uuid4())), args...)))
