...
"""
GetIceServerConfig(ChannelARN) = kinesis_video_signaling("POST", "/v1/get-ice-server-config", Dict{String, Any}("ChannelARN"=>ChannelARN))
GetIceServerConfig(ChannelARN, args::AbstractDict{String, <: Any}) = kinesis_video_signaling("POST", "/v1/get-ice-server-config", Dict{String, Any}("ChannelARN"=>ChannelARN, args...))
...
"""
SendAlexaOfferToMaster(ChannelARN, MessagePayload, SenderClientId) = kinesis_video_signaling("POST", "/v1/send-alexa-offer-to-master", Dict{String, Any}("ChannelARN"=>ChannelARN, "MessagePayload"=>MessagePayload, "SenderClientId"=>SenderClientId))
SendAlexaOfferToMaster(ChannelARN, MessagePayload, SenderClientId, args::AbstractDict{String, <: Any}) = kinesis_video_signaling("POST", "/v1/send-alexa-offer-to-master", Dict{String, Any}("ChannelARN"=>ChannelARN, "MessagePayload"=>MessagePayload, "SenderClientId"=>SenderClientId, args...))
