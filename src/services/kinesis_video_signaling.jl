...
"""
GetIceServerConfig(ChannelARN; aws::AWSConfig=AWSConfig()) = kinesis_video_signaling("POST", "/v1/get-ice-server-config", Dict{String, Any}("ChannelARN"=>ChannelARN))
GetIceServerConfig(ChannelARN, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video_signaling("POST", "/v1/get-ice-server-config", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelARN"=>ChannelARN), args)); aws=aws)
...
"""
SendAlexaOfferToMaster(ChannelARN, MessagePayload, SenderClientId; aws::AWSConfig=AWSConfig()) = kinesis_video_signaling("POST", "/v1/send-alexa-offer-to-master", Dict{String, Any}("ChannelARN"=>ChannelARN, "MessagePayload"=>MessagePayload, "SenderClientId"=>SenderClientId))
SendAlexaOfferToMaster(ChannelARN, MessagePayload, SenderClientId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video_signaling("POST", "/v1/send-alexa-offer-to-master", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelARN"=>ChannelARN, "MessagePayload"=>MessagePayload, "SenderClientId"=>SenderClientId), args)); aws=aws)
