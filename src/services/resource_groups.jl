...
"""
CreateGroup(Name; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/groups", Dict{String, Any}("Name"=>Name))
CreateGroup(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/groups", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
DeleteGroup(; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/delete-group"; aws=aws)
DeleteGroup(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/delete-group", args; aws=aws)
...
- `GroupName`: Don't use this parameter. Use Group instead.
"""
GetGroup(; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/get-group"; aws=aws)
GetGroup(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/get-group", args; aws=aws)
...
"""
GetGroupConfiguration(; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/get-group-configuration"; aws=aws)
GetGroupConfiguration(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/get-group-configuration", args; aws=aws)
...
- `GroupName`: Don't use this parameter. Use Group instead.
"""
GetGroupQuery(; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/get-group-query"; aws=aws)
GetGroupQuery(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/get-group-query", args; aws=aws)
...
"""
GetTags(Arn; aws::AWSConfig=AWSConfig()) = resource_groups("GET", "/resources/$(Arn)/tags"; aws=aws)
GetTags(Arn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups("GET", "/resources/$(Arn)/tags", args; aws=aws)
...
"""
GroupResources(Group, ResourceArns; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/group-resources", Dict{String, Any}("Group"=>Group, "ResourceArns"=>ResourceArns))
GroupResources(Group, ResourceArns, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/group-resources", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Group"=>Group, "ResourceArns"=>ResourceArns), args)); aws=aws)
...
"""
ListGroupResources(; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/list-group-resources"; aws=aws)
ListGroupResources(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/list-group-resources", args; aws=aws)
...
- `nextToken`: The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value provided by a previous call's NextToken response to indicate where the output should continue from.
"""
ListGroups(; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/groups-list"; aws=aws)
ListGroups(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/groups-list", args; aws=aws)
...
- `NextToken`: The parameter for receiving additional results if you receive a NextToken response in a previous request. A NextToken response indicates that more output is available. Set this parameter to the value provided by a previous call's NextToken response to indicate where the output should continue from.
"""
SearchResources(ResourceQuery; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/resources/search", Dict{String, Any}("ResourceQuery"=>ResourceQuery))
SearchResources(ResourceQuery, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/resources/search", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceQuery"=>ResourceQuery), args)); aws=aws)
...
"""
Tag(Arn, Tags; aws::AWSConfig=AWSConfig()) = resource_groups("PUT", "/resources/$(Arn)/tags", Dict{String, Any}("Tags"=>Tags))
Tag(Arn, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups("PUT", "/resources/$(Arn)/tags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Tags"=>Tags), args)); aws=aws)
...
"""
UngroupResources(Group, ResourceArns; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/ungroup-resources", Dict{String, Any}("Group"=>Group, "ResourceArns"=>ResourceArns))
UngroupResources(Group, ResourceArns, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/ungroup-resources", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Group"=>Group, "ResourceArns"=>ResourceArns), args)); aws=aws)
...
"""
Untag(Arn, Keys; aws::AWSConfig=AWSConfig()) = resource_groups("PATCH", "/resources/$(Arn)/tags", Dict{String, Any}("Keys"=>Keys))
Untag(Arn, Keys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups("PATCH", "/resources/$(Arn)/tags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Keys"=>Keys), args)); aws=aws)
...
- `GroupName`: Don't use this parameter. Use Group instead.
"""
UpdateGroup(; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/update-group"; aws=aws)
UpdateGroup(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/update-group", args; aws=aws)
...
- `GroupName`: Don't use this parameter. Use Group instead.
"""
UpdateGroupQuery(ResourceQuery; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/update-group-query", Dict{String, Any}("ResourceQuery"=>ResourceQuery))
UpdateGroupQuery(ResourceQuery, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups("POST", "/update-group-query", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceQuery"=>ResourceQuery), args)); aws=aws)
