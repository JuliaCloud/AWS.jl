...
"""
function associate_merged_graphql_api end
...
- `"sourceApiAssociationConfig"`: The `SourceApiAssociationConfig` object data.
"""
function associate_source_graphql_api end
...
- `"transitEncryptionEnabled"`: Transit encryption flag when connecting to cache. You cannot
  update this setting after creation.
"""
function create_api_cache end
...
- `"expires"`: From the creation time, the time after which the API key expires. The date is
  represented as seconds since the epoch, rounded down to the nearest hour. The default
...
function create_api_key(apiId; aws_config::AbstractAWSConfig=current_aws_config())
    return appsync(
        "POST", "/v1/apis/$(apiId)/apikeys"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"requestMappingTemplate"`: The `Function` request mapping template. Functions support
...
- `"introspectionConfig"`: Sets the value of the GraphQL API to enable (`ENABLED`) or
...
- `"queryDepthLimit"`: The maximum depth a query can have in a single request. Depth refers
  ...
  between `1` and `75` nested levels. This field will produce a limit error if the operation
  falls out of bounds.
...
- `"visibility"`: Sets the value of the GraphQL API to public (`GLOBAL`) or private
  (`PRIVATE`). If no value is provided, the visibility will be set to `GLOBAL` by default.
...
"""
function create_graphql_api end
...
- `api_id`: The API ID.
"""
function delete_api_cache end

function delete_api_cache(apiId; aws_config::AbstractAWSConfig=current_aws_config())
    return appsync(
        "DELETE", "/v1/apis/$(apiId)/ApiCaches"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `api_id`: The API ID.
"""
function delete_graphql_api end

function delete_graphql_api(apiId; aws_config::AbstractAWSConfig=current_aws_config())
    return appsync(
        "DELETE", "/v1/apis/$(apiId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_graphql_api(
    ...
    return appsync(
        "DELETE", "/v1/apis/$(apiId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
Deletes an association between a Merged API and source API using the source API's identifier
...
- `source_api_identifier`: The identifier of the AppSync Source API. This is generated by
  ...
  (cross-account use cases) strictly require the full resource ARN of the source API.
"""
function disassociate_merged_graphql_api end
...
Deletes an association between a Merged API and source API using the Merged API's identifier
and the association ID.
...
- `merged_api_identifier`: The identifier of the AppSync Merged API. This is generated by
  ...
  account use cases) strictly require the full resource ARN of the merged API.
"""
function disassociate_source_graphql_api end
...
Request templates take the incoming request after a GraphQL operation is parsed and convert
it into a request configuration for the selected data source operation. Response templates
interpret responses from the data source and map it to the shape of the GraphQL field output
type.
...
"""
function evaluate_mapping_template end
...
- `domain_name`: The domain name.
"""
function get_api_association end
...
- `api_id`: The API ID.
"""
function get_api_cache end

function get_api_cache(apiId; aws_config::AbstractAWSConfig=current_aws_config())
    return appsync(
        "GET", "/v1/apis/$(apiId)/ApiCaches"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
result of the instrospection will also be returned. If the retrieval fails the operation, an
error message will be returned instead.

# Arguments

- `introspection_id`: The introspection ID. Each introspection contains a unique ID that can
...
- `"nextToken"`: Determines the number of types to be returned in a single response before
  ...
  response.
"""
function get_data_source_introspection end
...
function get_domain_name(domainName; aws_config::AbstractAWSConfig=current_aws_config())
    return appsync(
        "GET", "/v1/domainnames/$(domainName)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function get_graphql_api end

function get_graphql_api(apiId; aws_config::AbstractAWSConfig=current_aws_config())
    return appsync("GET", "/v1/apis/$(apiId)"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_graphql_api(
    ...
    return appsync(
        "GET", "/v1/apis/$(apiId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function get_graphql_api_environment_variables end
...
- `"includeDirectives"`: A flag that specifies whether the schema introspection should
  contain directives.
"""
function get_introspection_schema end
...
- `api_id`: The API ID.
"""
function get_schema_creation_status end
...
- `merged_api_identifier`: The identifier of the AppSync Merged API. This is generated by
  ...
  account use cases) strictly require the full resource ARN of the merged API.
"""
function get_source_api_association end
...
!!! note
    API keys are deleted automatically 60 days after they expire. However, they may still be
...
"""
function list_api_keys end

function list_api_keys(apiId; aws_config::AbstractAWSConfig=current_aws_config())
    return appsync(
        "GET", "/v1/apis/$(apiId)/apikeys"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_data_sources(apiId; aws_config::AbstractAWSConfig=current_aws_config())
    return appsync(
        "GET", "/v1/apis/$(apiId)/datasources"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_domain_names(; aws_config::AbstractAWSConfig=current_aws_config())
    return appsync("GET", "/v1/domainnames"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_domain_names(
    ...
    return appsync(
        "GET", "/v1/domainnames", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_functions(apiId; aws_config::AbstractAWSConfig=current_aws_config())
    return appsync(
        "GET", "/v1/apis/$(apiId)/functions"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function list_graphql_apis end

function list_graphql_apis(; aws_config::AbstractAWSConfig=current_aws_config())
    return appsync("GET", "/v1/apis"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_graphql_apis(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return appsync("GET", "/v1/apis", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"nextToken"`: An identifier that was returned from the previous call to this operation,
  which you can use to return the next set of items in the list.
"""
function list_resolvers_by_function end
...
- `"nextToken"`: An identifier that was returned from the previous call to this operation,
  which you can use to return the next set of items in the list.
"""
function list_source_api_associations end
...
- `"nextToken"`: An identifier that was returned from the previous call to this operation,
  which you can use to return the next set of items in the list.
"""
function list_types_by_association end
...
payload as a list in the format `{"key1":"value1","key2":"value2", …}`. Note that each call
...
- `environment_variables`: The list of environmental variables to add to the API.
...
"""
function put_graphql_api_environment_variables end
...
Creates a new introspection. Returns the `introspectionId` of the new introspection after
its creation.
...
"""
function start_data_source_introspection end
...
"""
function start_schema_creation end
...
- `merged_api_identifier`: The identifier of the AppSync Merged API. This is generated by
  ...
  account use cases) strictly require the full resource ARN of the merged API.
"""
function start_schema_merge end
...
function update_domain_name(domainName; aws_config::AbstractAWSConfig=current_aws_config())
    return appsync(
        "POST", "/v1/domainnames/$(domainName)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"xrayEnabled"`: A flag indicating whether to use X-Ray tracing for the `GraphqlApi`.
"""
function update_graphql_api end
...
- `"sourceApiAssociationConfig"`: The `SourceApiAssociationConfig` object data.
"""
function update_source_api_association end
