...
- `"TemplateName"`: The name of the configuration template whose configuration options you
  want to describe.
"""
function describe_configuration_options(; aws_config::AbstractAWSConfig=current_aws_config())
    return elastic_beanstalk(
...
"""
function describe_environment_resources(; aws_config::AbstractAWSConfig=current_aws_config())
    return elastic_beanstalk(
...
"""
function list_available_solution_stacks(; aws_config::AbstractAWSConfig=current_aws_config())
    return elastic_beanstalk(
        "ListAvailableSolutionStacks";
        aws_config=aws_config,
        feature_set=SERVICE_FEATURE_SET,
