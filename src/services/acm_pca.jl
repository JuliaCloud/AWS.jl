...
"""
CreateCertificateAuthority(CertificateAuthorityConfiguration, CertificateAuthorityType) = acm_pca("CreateCertificateAuthority", Dict{String, Any}("CertificateAuthorityConfiguration"=>CertificateAuthorityConfiguration, "CertificateAuthorityType"=>CertificateAuthorityType))
CreateCertificateAuthority(CertificateAuthorityConfiguration, CertificateAuthorityType, args::AbstractDict{String, <:Any}) = acm_pca("CreateCertificateAuthority", Dict{String, Any}("CertificateAuthorityConfiguration"=>CertificateAuthorityConfiguration, "CertificateAuthorityType"=>CertificateAuthorityType, args...))
...
"""
CreateCertificateAuthorityAuditReport(AuditReportResponseFormat, CertificateAuthorityArn, S3BucketName) = acm_pca("CreateCertificateAuthorityAuditReport", Dict{String, Any}("AuditReportResponseFormat"=>AuditReportResponseFormat, "CertificateAuthorityArn"=>CertificateAuthorityArn, "S3BucketName"=>S3BucketName))
CreateCertificateAuthorityAuditReport(AuditReportResponseFormat, CertificateAuthorityArn, S3BucketName, args::AbstractDict{String, <:Any}) = acm_pca("CreateCertificateAuthorityAuditReport", Dict{String, Any}("AuditReportResponseFormat"=>AuditReportResponseFormat, "CertificateAuthorityArn"=>CertificateAuthorityArn, "S3BucketName"=>S3BucketName, args...))
...
"""
CreatePermission(Actions, CertificateAuthorityArn, Principal) = acm_pca("CreatePermission", Dict{String, Any}("Actions"=>Actions, "CertificateAuthorityArn"=>CertificateAuthorityArn, "Principal"=>Principal))
CreatePermission(Actions, CertificateAuthorityArn, Principal, args::AbstractDict{String, <:Any}) = acm_pca("CreatePermission", Dict{String, Any}("Actions"=>Actions, "CertificateAuthorityArn"=>CertificateAuthorityArn, "Principal"=>Principal, args...))
...
"""
DeleteCertificateAuthority(CertificateAuthorityArn) = acm_pca("DeleteCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn))
DeleteCertificateAuthority(CertificateAuthorityArn, args::AbstractDict{String, <:Any}) = acm_pca("DeleteCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, args...))
...
"""
DeletePermission(CertificateAuthorityArn, Principal) = acm_pca("DeletePermission", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Principal"=>Principal))
DeletePermission(CertificateAuthorityArn, Principal, args::AbstractDict{String, <:Any}) = acm_pca("DeletePermission", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Principal"=>Principal, args...))
...
"""
DescribeCertificateAuthority(CertificateAuthorityArn) = acm_pca("DescribeCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn))
DescribeCertificateAuthority(CertificateAuthorityArn, args::AbstractDict{String, <:Any}) = acm_pca("DescribeCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, args...))
...
"""
DescribeCertificateAuthorityAuditReport(AuditReportId, CertificateAuthorityArn) = acm_pca("DescribeCertificateAuthorityAuditReport", Dict{String, Any}("AuditReportId"=>AuditReportId, "CertificateAuthorityArn"=>CertificateAuthorityArn))
DescribeCertificateAuthorityAuditReport(AuditReportId, CertificateAuthorityArn, args::AbstractDict{String, <:Any}) = acm_pca("DescribeCertificateAuthorityAuditReport", Dict{String, Any}("AuditReportId"=>AuditReportId, "CertificateAuthorityArn"=>CertificateAuthorityArn, args...))
...
"""
GetCertificate(CertificateArn, CertificateAuthorityArn) = acm_pca("GetCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, "CertificateAuthorityArn"=>CertificateAuthorityArn))
GetCertificate(CertificateArn, CertificateAuthorityArn, args::AbstractDict{String, <:Any}) = acm_pca("GetCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, "CertificateAuthorityArn"=>CertificateAuthorityArn, args...))
...
"""
GetCertificateAuthorityCertificate(CertificateAuthorityArn) = acm_pca("GetCertificateAuthorityCertificate", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn))
GetCertificateAuthorityCertificate(CertificateAuthorityArn, args::AbstractDict{String, <:Any}) = acm_pca("GetCertificateAuthorityCertificate", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, args...))
...
"""
GetCertificateAuthorityCsr(CertificateAuthorityArn) = acm_pca("GetCertificateAuthorityCsr", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn))
GetCertificateAuthorityCsr(CertificateAuthorityArn, args::AbstractDict{String, <:Any}) = acm_pca("GetCertificateAuthorityCsr", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, args...))
...
"""
ImportCertificateAuthorityCertificate(Certificate, CertificateAuthorityArn) = acm_pca("ImportCertificateAuthorityCertificate", Dict{String, Any}("Certificate"=>Certificate, "CertificateAuthorityArn"=>CertificateAuthorityArn))
ImportCertificateAuthorityCertificate(Certificate, CertificateAuthorityArn, args::AbstractDict{String, <:Any}) = acm_pca("ImportCertificateAuthorityCertificate", Dict{String, Any}("Certificate"=>Certificate, "CertificateAuthorityArn"=>CertificateAuthorityArn, args...))
...
"""
IssueCertificate(CertificateAuthorityArn, Csr, SigningAlgorithm, Validity) = acm_pca("IssueCertificate", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Csr"=>Csr, "SigningAlgorithm"=>SigningAlgorithm, "Validity"=>Validity))
IssueCertificate(CertificateAuthorityArn, Csr, SigningAlgorithm, Validity, args::AbstractDict{String, <:Any}) = acm_pca("IssueCertificate", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Csr"=>Csr, "SigningAlgorithm"=>SigningAlgorithm, "Validity"=>Validity, args...))
...
ListCertificateAuthorities(args::AbstractDict{String, <:Any}) = acm_pca("ListCertificateAuthorities", args)
...
"""
ListPermissions(CertificateAuthorityArn) = acm_pca("ListPermissions", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn))
ListPermissions(CertificateAuthorityArn, args::AbstractDict{String, <:Any}) = acm_pca("ListPermissions", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, args...))
...
"""
ListTags(CertificateAuthorityArn) = acm_pca("ListTags", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn))
ListTags(CertificateAuthorityArn, args::AbstractDict{String, <:Any}) = acm_pca("ListTags", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, args...))
...
"""
RestoreCertificateAuthority(CertificateAuthorityArn) = acm_pca("RestoreCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn))
RestoreCertificateAuthority(CertificateAuthorityArn, args::AbstractDict{String, <:Any}) = acm_pca("RestoreCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, args...))
...
"""
RevokeCertificate(CertificateAuthorityArn, CertificateSerial, RevocationReason) = acm_pca("RevokeCertificate", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "CertificateSerial"=>CertificateSerial, "RevocationReason"=>RevocationReason))
RevokeCertificate(CertificateAuthorityArn, CertificateSerial, RevocationReason, args::AbstractDict{String, <:Any}) = acm_pca("RevokeCertificate", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "CertificateSerial"=>CertificateSerial, "RevocationReason"=>RevocationReason, args...))
...
"""
TagCertificateAuthority(CertificateAuthorityArn, Tags) = acm_pca("TagCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Tags"=>Tags))
TagCertificateAuthority(CertificateAuthorityArn, Tags, args::AbstractDict{String, <:Any}) = acm_pca("TagCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Tags"=>Tags, args...))
...
"""
UntagCertificateAuthority(CertificateAuthorityArn, Tags) = acm_pca("UntagCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Tags"=>Tags))
UntagCertificateAuthority(CertificateAuthorityArn, Tags, args::AbstractDict{String, <:Any}) = acm_pca("UntagCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Tags"=>Tags, args...))
...
"""
UpdateCertificateAuthority(CertificateAuthorityArn) = acm_pca("UpdateCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn))
UpdateCertificateAuthority(CertificateAuthorityArn, args::AbstractDict{String, <:Any}) = acm_pca("UpdateCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, args...))
