...
"""
CreateCertificateAuthority(CertificateAuthorityConfiguration, CertificateAuthorityType; aws::AWSConfig=AWSConfig()) = acm_pca("CreateCertificateAuthority", Dict{String, Any}("CertificateAuthorityConfiguration"=>CertificateAuthorityConfiguration, "CertificateAuthorityType"=>CertificateAuthorityType); aws=aws)
CreateCertificateAuthority(CertificateAuthorityConfiguration, CertificateAuthorityType, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("CreateCertificateAuthority", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityConfiguration"=>CertificateAuthorityConfiguration, "CertificateAuthorityType"=>CertificateAuthorityType), args)); aws=aws)
...
"""
CreatePermission(Actions, CertificateAuthorityArn, Principal; aws::AWSConfig=AWSConfig()) = acm_pca("CreatePermission", Dict{String, Any}("Actions"=>Actions, "CertificateAuthorityArn"=>CertificateAuthorityArn, "Principal"=>Principal); aws=aws)
CreatePermission(Actions, CertificateAuthorityArn, Principal, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("CreatePermission", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Actions"=>Actions, "CertificateAuthorityArn"=>CertificateAuthorityArn, "Principal"=>Principal), args)); aws=aws)
...
"""
DeleteCertificateAuthority(CertificateAuthorityArn; aws::AWSConfig=AWSConfig()) = acm_pca("DeleteCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn); aws=aws)
DeleteCertificateAuthority(CertificateAuthorityArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("DeleteCertificateAuthority", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn), args)); aws=aws)
...
"""
DeletePermission(CertificateAuthorityArn, Principal; aws::AWSConfig=AWSConfig()) = acm_pca("DeletePermission", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Principal"=>Principal); aws=aws)
DeletePermission(CertificateAuthorityArn, Principal, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("DeletePermission", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Principal"=>Principal), args)); aws=aws)
...
"""
DescribeCertificateAuthority(CertificateAuthorityArn; aws::AWSConfig=AWSConfig()) = acm_pca("DescribeCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn); aws=aws)
DescribeCertificateAuthority(CertificateAuthorityArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("DescribeCertificateAuthority", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn), args)); aws=aws)
...
"""
DescribeCertificateAuthorityAuditReport(AuditReportId, CertificateAuthorityArn; aws::AWSConfig=AWSConfig()) = acm_pca("DescribeCertificateAuthorityAuditReport", Dict{String, Any}("AuditReportId"=>AuditReportId, "CertificateAuthorityArn"=>CertificateAuthorityArn); aws=aws)
DescribeCertificateAuthorityAuditReport(AuditReportId, CertificateAuthorityArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("DescribeCertificateAuthorityAuditReport", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AuditReportId"=>AuditReportId, "CertificateAuthorityArn"=>CertificateAuthorityArn), args)); aws=aws)
...
"""
GetCertificate(CertificateArn, CertificateAuthorityArn; aws::AWSConfig=AWSConfig()) = acm_pca("GetCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, "CertificateAuthorityArn"=>CertificateAuthorityArn); aws=aws)
GetCertificate(CertificateArn, CertificateAuthorityArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("GetCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateArn"=>CertificateArn, "CertificateAuthorityArn"=>CertificateAuthorityArn), args)); aws=aws)
...
"""
GetCertificateAuthorityCertificate(CertificateAuthorityArn; aws::AWSConfig=AWSConfig()) = acm_pca("GetCertificateAuthorityCertificate", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn); aws=aws)
GetCertificateAuthorityCertificate(CertificateAuthorityArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("GetCertificateAuthorityCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn), args)); aws=aws)
...
"""
GetCertificateAuthorityCsr(CertificateAuthorityArn; aws::AWSConfig=AWSConfig()) = acm_pca("GetCertificateAuthorityCsr", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn); aws=aws)
GetCertificateAuthorityCsr(CertificateAuthorityArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("GetCertificateAuthorityCsr", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn), args)); aws=aws)
...
"""
ImportCertificateAuthorityCertificate(Certificate, CertificateAuthorityArn; aws::AWSConfig=AWSConfig()) = acm_pca("ImportCertificateAuthorityCertificate", Dict{String, Any}("Certificate"=>Certificate, "CertificateAuthorityArn"=>CertificateAuthorityArn); aws=aws)
ImportCertificateAuthorityCertificate(Certificate, CertificateAuthorityArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("ImportCertificateAuthorityCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Certificate"=>Certificate, "CertificateAuthorityArn"=>CertificateAuthorityArn), args)); aws=aws)
...
"""
IssueCertificate(CertificateAuthorityArn, Csr, SigningAlgorithm, Validity; aws::AWSConfig=AWSConfig()) = acm_pca("IssueCertificate", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Csr"=>Csr, "SigningAlgorithm"=>SigningAlgorithm, "Validity"=>Validity); aws=aws)
IssueCertificate(CertificateAuthorityArn, Csr, SigningAlgorithm, Validity, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("IssueCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Csr"=>Csr, "SigningAlgorithm"=>SigningAlgorithm, "Validity"=>Validity), args)); aws=aws)
...
"""
ListCertificateAuthorities(; aws::AWSConfig=AWSConfig()) = acm_pca("ListCertificateAuthorities"; aws=aws)
ListCertificateAuthorities(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("ListCertificateAuthorities", args; aws=aws)
...
"""
ListPermissions(CertificateAuthorityArn; aws::AWSConfig=AWSConfig()) = acm_pca("ListPermissions", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn); aws=aws)
ListPermissions(CertificateAuthorityArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("ListPermissions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn), args)); aws=aws)
...
"""
ListTags(CertificateAuthorityArn; aws::AWSConfig=AWSConfig()) = acm_pca("ListTags", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn); aws=aws)
ListTags(CertificateAuthorityArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("ListTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn), args)); aws=aws)
...
"""
RestoreCertificateAuthority(CertificateAuthorityArn; aws::AWSConfig=AWSConfig()) = acm_pca("RestoreCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn); aws=aws)
RestoreCertificateAuthority(CertificateAuthorityArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("RestoreCertificateAuthority", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn), args)); aws=aws)
...
"""
RevokeCertificate(CertificateAuthorityArn, CertificateSerial, RevocationReason; aws::AWSConfig=AWSConfig()) = acm_pca("RevokeCertificate", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "CertificateSerial"=>CertificateSerial, "RevocationReason"=>RevocationReason); aws=aws)
RevokeCertificate(CertificateAuthorityArn, CertificateSerial, RevocationReason, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("RevokeCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "CertificateSerial"=>CertificateSerial, "RevocationReason"=>RevocationReason), args)); aws=aws)
...
"""
TagCertificateAuthority(CertificateAuthorityArn, Tags; aws::AWSConfig=AWSConfig()) = acm_pca("TagCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Tags"=>Tags); aws=aws)
TagCertificateAuthority(CertificateAuthorityArn, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("TagCertificateAuthority", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Tags"=>Tags), args)); aws=aws)
...
"""
UntagCertificateAuthority(CertificateAuthorityArn, Tags; aws::AWSConfig=AWSConfig()) = acm_pca("UntagCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Tags"=>Tags); aws=aws)
UntagCertificateAuthority(CertificateAuthorityArn, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("UntagCertificateAuthority", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn, "Tags"=>Tags), args)); aws=aws)
...
"""
UpdateCertificateAuthority(CertificateAuthorityArn; aws::AWSConfig=AWSConfig()) = acm_pca("UpdateCertificateAuthority", Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn); aws=aws)
UpdateCertificateAuthority(CertificateAuthorityArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = acm_pca("UpdateCertificateAuthority", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CertificateAuthorityArn"=>CertificateAuthorityArn), args)); aws=aws)
