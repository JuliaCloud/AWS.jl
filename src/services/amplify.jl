...
# Optional Parameters
- `accessToken`:  The personal access token for a third-party source control system for an
...
- `appId`:  The unique ID for an Amplify app.
- `branchName`:  The branch name for the job.
- `jobType`:  Describes the type for the job. The job type RELEASE starts a new job with
