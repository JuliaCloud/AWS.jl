...
"""
function create_branch(appId, branchName; aws_config::AbstractAWSConfig=current_aws_config())
    return amplify(
        "POST",
        "/apps/$(appId)/branches",
...
"""
function delete_branch(appId, branchName; aws_config::AbstractAWSConfig=current_aws_config())
    return amplify(
        "DELETE",
...
"""
function list_backend_environments(appId; aws_config::AbstractAWSConfig=current_aws_config())
    return amplify(
        "GET",
        "/apps/$(appId)/backendenvironments";
        aws_config=aws_config,
...
- `"ttl"`:  The content Time to Live (TTL) for the website in seconds.
"""
function update_branch(appId, branchName; aws_config::AbstractAWSConfig=current_aws_config())
    return amplify(
        "POST",
        "/apps/$(appId)/branches/$(branchName)";
        aws_config=aws_config,
