...
using Compat
using UUIDs
using .AWSServices: forecastquery
...
"""
QueryForecast(Filters, ForecastArn) = forecastquery("QueryForecast", Dict{String, Any}("Filters"=>Filters, "ForecastArn"=>ForecastArn))
QueryForecast(Filters, ForecastArn, args::AbstractDict{String, <:Any}) = forecastquery("QueryForecast", Dict{String, Any}("Filters"=>Filters, "ForecastArn"=>ForecastArn, args...))
