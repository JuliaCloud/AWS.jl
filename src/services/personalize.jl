...
"""
CreateBatchInferenceJob(jobInput, jobName, jobOutput, roleArn, solutionVersionArn; aws::AWSConfig=AWSConfig()) = personalize("CreateBatchInferenceJob", Dict{String, Any}("jobInput"=>jobInput, "jobName"=>jobName, "jobOutput"=>jobOutput, "roleArn"=>roleArn, "solutionVersionArn"=>solutionVersionArn); aws=aws)
CreateBatchInferenceJob(jobInput, jobName, jobOutput, roleArn, solutionVersionArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("CreateBatchInferenceJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("jobInput"=>jobInput, "jobName"=>jobName, "jobOutput"=>jobOutput, "roleArn"=>roleArn, "solutionVersionArn"=>solutionVersionArn), args)); aws=aws)
...
"""
CreateCampaign(minProvisionedTPS, name, solutionVersionArn; aws::AWSConfig=AWSConfig()) = personalize("CreateCampaign", Dict{String, Any}("minProvisionedTPS"=>minProvisionedTPS, "name"=>name, "solutionVersionArn"=>solutionVersionArn); aws=aws)
CreateCampaign(minProvisionedTPS, name, solutionVersionArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("CreateCampaign", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("minProvisionedTPS"=>minProvisionedTPS, "name"=>name, "solutionVersionArn"=>solutionVersionArn), args)); aws=aws)
...
"""
CreateDataset(datasetGroupArn, datasetType, name, schemaArn; aws::AWSConfig=AWSConfig()) = personalize("CreateDataset", Dict{String, Any}("datasetGroupArn"=>datasetGroupArn, "datasetType"=>datasetType, "name"=>name, "schemaArn"=>schemaArn); aws=aws)
CreateDataset(datasetGroupArn, datasetType, name, schemaArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("CreateDataset", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("datasetGroupArn"=>datasetGroupArn, "datasetType"=>datasetType, "name"=>name, "schemaArn"=>schemaArn), args)); aws=aws)
...
"""
CreateDatasetGroup(name; aws::AWSConfig=AWSConfig()) = personalize("CreateDatasetGroup", Dict{String, Any}("name"=>name); aws=aws)
CreateDatasetGroup(name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("CreateDatasetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("name"=>name), args)); aws=aws)
...
"""
CreateDatasetImportJob(dataSource, datasetArn, jobName, roleArn; aws::AWSConfig=AWSConfig()) = personalize("CreateDatasetImportJob", Dict{String, Any}("dataSource"=>dataSource, "datasetArn"=>datasetArn, "jobName"=>jobName, "roleArn"=>roleArn); aws=aws)
CreateDatasetImportJob(dataSource, datasetArn, jobName, roleArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("CreateDatasetImportJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("dataSource"=>dataSource, "datasetArn"=>datasetArn, "jobName"=>jobName, "roleArn"=>roleArn), args)); aws=aws)
...
"""
CreateEventTracker(datasetGroupArn, name; aws::AWSConfig=AWSConfig()) = personalize("CreateEventTracker", Dict{String, Any}("datasetGroupArn"=>datasetGroupArn, "name"=>name); aws=aws)
CreateEventTracker(datasetGroupArn, name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("CreateEventTracker", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("datasetGroupArn"=>datasetGroupArn, "name"=>name), args)); aws=aws)
...
"""
CreateFilter(datasetGroupArn, filterExpression, name; aws::AWSConfig=AWSConfig()) = personalize("CreateFilter", Dict{String, Any}("datasetGroupArn"=>datasetGroupArn, "filterExpression"=>filterExpression, "name"=>name); aws=aws)
CreateFilter(datasetGroupArn, filterExpression, name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("CreateFilter", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("datasetGroupArn"=>datasetGroupArn, "filterExpression"=>filterExpression, "name"=>name), args)); aws=aws)
...
"""
CreateSchema(name, schema; aws::AWSConfig=AWSConfig()) = personalize("CreateSchema", Dict{String, Any}("name"=>name, "schema"=>schema); aws=aws)
CreateSchema(name, schema, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("CreateSchema", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("name"=>name, "schema"=>schema), args)); aws=aws)
...
"""
CreateSolution(datasetGroupArn, name; aws::AWSConfig=AWSConfig()) = personalize("CreateSolution", Dict{String, Any}("datasetGroupArn"=>datasetGroupArn, "name"=>name); aws=aws)
CreateSolution(datasetGroupArn, name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("CreateSolution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("datasetGroupArn"=>datasetGroupArn, "name"=>name), args)); aws=aws)
...
"""
CreateSolutionVersion(solutionArn; aws::AWSConfig=AWSConfig()) = personalize("CreateSolutionVersion", Dict{String, Any}("solutionArn"=>solutionArn); aws=aws)
CreateSolutionVersion(solutionArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("CreateSolutionVersion", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("solutionArn"=>solutionArn), args)); aws=aws)
...
"""
DeleteCampaign(campaignArn; aws::AWSConfig=AWSConfig()) = personalize("DeleteCampaign", Dict{String, Any}("campaignArn"=>campaignArn); aws=aws)
DeleteCampaign(campaignArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DeleteCampaign", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("campaignArn"=>campaignArn), args)); aws=aws)
...
"""
DeleteDataset(datasetArn; aws::AWSConfig=AWSConfig()) = personalize("DeleteDataset", Dict{String, Any}("datasetArn"=>datasetArn); aws=aws)
DeleteDataset(datasetArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DeleteDataset", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("datasetArn"=>datasetArn), args)); aws=aws)
...
"""
DeleteDatasetGroup(datasetGroupArn; aws::AWSConfig=AWSConfig()) = personalize("DeleteDatasetGroup", Dict{String, Any}("datasetGroupArn"=>datasetGroupArn); aws=aws)
DeleteDatasetGroup(datasetGroupArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DeleteDatasetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("datasetGroupArn"=>datasetGroupArn), args)); aws=aws)
...
"""
DeleteEventTracker(eventTrackerArn; aws::AWSConfig=AWSConfig()) = personalize("DeleteEventTracker", Dict{String, Any}("eventTrackerArn"=>eventTrackerArn); aws=aws)
DeleteEventTracker(eventTrackerArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DeleteEventTracker", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("eventTrackerArn"=>eventTrackerArn), args)); aws=aws)
...
"""
DeleteFilter(filterArn; aws::AWSConfig=AWSConfig()) = personalize("DeleteFilter", Dict{String, Any}("filterArn"=>filterArn); aws=aws)
DeleteFilter(filterArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DeleteFilter", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("filterArn"=>filterArn), args)); aws=aws)
...
"""
DeleteSchema(schemaArn; aws::AWSConfig=AWSConfig()) = personalize("DeleteSchema", Dict{String, Any}("schemaArn"=>schemaArn); aws=aws)
DeleteSchema(schemaArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DeleteSchema", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("schemaArn"=>schemaArn), args)); aws=aws)
...
"""
DeleteSolution(solutionArn; aws::AWSConfig=AWSConfig()) = personalize("DeleteSolution", Dict{String, Any}("solutionArn"=>solutionArn); aws=aws)
DeleteSolution(solutionArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DeleteSolution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("solutionArn"=>solutionArn), args)); aws=aws)
...
"""
DescribeAlgorithm(algorithmArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeAlgorithm", Dict{String, Any}("algorithmArn"=>algorithmArn); aws=aws)
DescribeAlgorithm(algorithmArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeAlgorithm", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("algorithmArn"=>algorithmArn), args)); aws=aws)
...
"""
DescribeBatchInferenceJob(batchInferenceJobArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeBatchInferenceJob", Dict{String, Any}("batchInferenceJobArn"=>batchInferenceJobArn); aws=aws)
DescribeBatchInferenceJob(batchInferenceJobArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeBatchInferenceJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("batchInferenceJobArn"=>batchInferenceJobArn), args)); aws=aws)
...
"""
DescribeCampaign(campaignArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeCampaign", Dict{String, Any}("campaignArn"=>campaignArn); aws=aws)
DescribeCampaign(campaignArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeCampaign", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("campaignArn"=>campaignArn), args)); aws=aws)
...
"""
DescribeDataset(datasetArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeDataset", Dict{String, Any}("datasetArn"=>datasetArn); aws=aws)
DescribeDataset(datasetArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeDataset", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("datasetArn"=>datasetArn), args)); aws=aws)
...
"""
DescribeDatasetGroup(datasetGroupArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeDatasetGroup", Dict{String, Any}("datasetGroupArn"=>datasetGroupArn); aws=aws)
DescribeDatasetGroup(datasetGroupArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeDatasetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("datasetGroupArn"=>datasetGroupArn), args)); aws=aws)
...
"""
DescribeDatasetImportJob(datasetImportJobArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeDatasetImportJob", Dict{String, Any}("datasetImportJobArn"=>datasetImportJobArn); aws=aws)
DescribeDatasetImportJob(datasetImportJobArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeDatasetImportJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("datasetImportJobArn"=>datasetImportJobArn), args)); aws=aws)
...
"""
DescribeEventTracker(eventTrackerArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeEventTracker", Dict{String, Any}("eventTrackerArn"=>eventTrackerArn); aws=aws)
DescribeEventTracker(eventTrackerArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeEventTracker", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("eventTrackerArn"=>eventTrackerArn), args)); aws=aws)
...
"""
DescribeFeatureTransformation(featureTransformationArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeFeatureTransformation", Dict{String, Any}("featureTransformationArn"=>featureTransformationArn); aws=aws)
DescribeFeatureTransformation(featureTransformationArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeFeatureTransformation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("featureTransformationArn"=>featureTransformationArn), args)); aws=aws)
...
"""
DescribeFilter(filterArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeFilter", Dict{String, Any}("filterArn"=>filterArn); aws=aws)
DescribeFilter(filterArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeFilter", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("filterArn"=>filterArn), args)); aws=aws)
...
"""
DescribeRecipe(recipeArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeRecipe", Dict{String, Any}("recipeArn"=>recipeArn); aws=aws)
DescribeRecipe(recipeArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeRecipe", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("recipeArn"=>recipeArn), args)); aws=aws)
...
"""
DescribeSchema(schemaArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeSchema", Dict{String, Any}("schemaArn"=>schemaArn); aws=aws)
DescribeSchema(schemaArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeSchema", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("schemaArn"=>schemaArn), args)); aws=aws)
...
"""
DescribeSolution(solutionArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeSolution", Dict{String, Any}("solutionArn"=>solutionArn); aws=aws)
DescribeSolution(solutionArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeSolution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("solutionArn"=>solutionArn), args)); aws=aws)
...
"""
DescribeSolutionVersion(solutionVersionArn; aws::AWSConfig=AWSConfig()) = personalize("DescribeSolutionVersion", Dict{String, Any}("solutionVersionArn"=>solutionVersionArn); aws=aws)
DescribeSolutionVersion(solutionVersionArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("DescribeSolutionVersion", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("solutionVersionArn"=>solutionVersionArn), args)); aws=aws)
...
"""
GetSolutionMetrics(solutionVersionArn; aws::AWSConfig=AWSConfig()) = personalize("GetSolutionMetrics", Dict{String, Any}("solutionVersionArn"=>solutionVersionArn); aws=aws)
GetSolutionMetrics(solutionVersionArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("GetSolutionMetrics", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("solutionVersionArn"=>solutionVersionArn), args)); aws=aws)
...
"""
ListBatchInferenceJobs(; aws::AWSConfig=AWSConfig()) = personalize("ListBatchInferenceJobs"; aws=aws)
ListBatchInferenceJobs(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("ListBatchInferenceJobs", args; aws=aws)
...
"""
ListCampaigns(; aws::AWSConfig=AWSConfig()) = personalize("ListCampaigns"; aws=aws)
ListCampaigns(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("ListCampaigns", args; aws=aws)
...
"""
ListDatasetGroups(; aws::AWSConfig=AWSConfig()) = personalize("ListDatasetGroups"; aws=aws)
ListDatasetGroups(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("ListDatasetGroups", args; aws=aws)
...
"""
ListDatasetImportJobs(; aws::AWSConfig=AWSConfig()) = personalize("ListDatasetImportJobs"; aws=aws)
ListDatasetImportJobs(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("ListDatasetImportJobs", args; aws=aws)
...
- `nextToken`: A token returned from the previous call to ListDatasetImportJobs for getting the next set of dataset import jobs (if they exist).
"""
ListDatasets(; aws::AWSConfig=AWSConfig()) = personalize("ListDatasets"; aws=aws)
ListDatasets(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("ListDatasets", args; aws=aws)
...
"""
ListEventTrackers(; aws::AWSConfig=AWSConfig()) = personalize("ListEventTrackers"; aws=aws)
ListEventTrackers(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("ListEventTrackers", args; aws=aws)
...
"""
ListFilters(; aws::AWSConfig=AWSConfig()) = personalize("ListFilters"; aws=aws)
ListFilters(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("ListFilters", args; aws=aws)
...
"""
ListRecipes(; aws::AWSConfig=AWSConfig()) = personalize("ListRecipes"; aws=aws)
ListRecipes(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("ListRecipes", args; aws=aws)
...
"""
ListSchemas(; aws::AWSConfig=AWSConfig()) = personalize("ListSchemas"; aws=aws)
ListSchemas(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("ListSchemas", args; aws=aws)
...
"""
ListSolutionVersions(; aws::AWSConfig=AWSConfig()) = personalize("ListSolutionVersions"; aws=aws)
ListSolutionVersions(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("ListSolutionVersions", args; aws=aws)
...
"""
ListSolutions(; aws::AWSConfig=AWSConfig()) = personalize("ListSolutions"; aws=aws)
ListSolutions(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("ListSolutions", args; aws=aws)
...
"""
UpdateCampaign(campaignArn; aws::AWSConfig=AWSConfig()) = personalize("UpdateCampaign", Dict{String, Any}("campaignArn"=>campaignArn); aws=aws)
UpdateCampaign(campaignArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = personalize("UpdateCampaign", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("campaignArn"=>campaignArn), args)); aws=aws)
