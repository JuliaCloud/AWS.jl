...
"""
function describe_algorithm(algorithmArn; aws_config::AbstractAWSConfig=current_aws_config())
    return personalize(
        "DescribeAlgorithm",
...
"""
function stop_recommender(recommenderArn; aws_config::AbstractAWSConfig=current_aws_config())
    return personalize(
        "StopRecommender",
        Dict{String,Any}("recommenderArn" => recommenderArn);
        aws_config=aws_config,
