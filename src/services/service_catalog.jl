...
"""
function describe_provisioning_artifact(; aws_config::AbstractAWSConfig=current_aws_config())
    return service_catalog(
...
"""
function enable_awsorganizations_access(; aws_config::AbstractAWSConfig=current_aws_config())
    return service_catalog(
...
"""
function list_accepted_portfolio_shares(; aws_config::AbstractAWSConfig=current_aws_config())
    return service_catalog(
...
"""
function list_provisioned_product_plans(; aws_config::AbstractAWSConfig=current_aws_config())
    return service_catalog(
