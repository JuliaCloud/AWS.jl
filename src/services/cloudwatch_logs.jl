...
"""
AssociateKmsKey(kmsKeyId, logGroupName) = cloudwatch_logs("AssociateKmsKey", Dict{String, Any}("kmsKeyId"=>kmsKeyId, "logGroupName"=>logGroupName))
AssociateKmsKey(kmsKeyId, logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("AssociateKmsKey", Dict{String, Any}("kmsKeyId"=>kmsKeyId, "logGroupName"=>logGroupName, args...))
...
"""
CancelExportTask(taskId) = cloudwatch_logs("CancelExportTask", Dict{String, Any}("taskId"=>taskId))
CancelExportTask(taskId, args::AbstractDict{String, <:Any}) = cloudwatch_logs("CancelExportTask", Dict{String, Any}("taskId"=>taskId, args...))
...
"""
CreateExportTask(destination, from, logGroupName, to) = cloudwatch_logs("CreateExportTask", Dict{String, Any}("destination"=>destination, "from"=>from, "logGroupName"=>logGroupName, "to"=>to))
CreateExportTask(destination, from, logGroupName, to, args::AbstractDict{String, <:Any}) = cloudwatch_logs("CreateExportTask", Dict{String, Any}("destination"=>destination, "from"=>from, "logGroupName"=>logGroupName, "to"=>to, args...))
...
"""
CreateLogGroup(logGroupName) = cloudwatch_logs("CreateLogGroup", Dict{String, Any}("logGroupName"=>logGroupName))
CreateLogGroup(logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("CreateLogGroup", Dict{String, Any}("logGroupName"=>logGroupName, args...))
...
"""
CreateLogStream(logGroupName, logStreamName) = cloudwatch_logs("CreateLogStream", Dict{String, Any}("logGroupName"=>logGroupName, "logStreamName"=>logStreamName))
CreateLogStream(logGroupName, logStreamName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("CreateLogStream", Dict{String, Any}("logGroupName"=>logGroupName, "logStreamName"=>logStreamName, args...))
...
"""
DeleteDestination(destinationName) = cloudwatch_logs("DeleteDestination", Dict{String, Any}("destinationName"=>destinationName))
DeleteDestination(destinationName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("DeleteDestination", Dict{String, Any}("destinationName"=>destinationName, args...))
...
"""
DeleteLogGroup(logGroupName) = cloudwatch_logs("DeleteLogGroup", Dict{String, Any}("logGroupName"=>logGroupName))
DeleteLogGroup(logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("DeleteLogGroup", Dict{String, Any}("logGroupName"=>logGroupName, args...))
...
"""
DeleteLogStream(logGroupName, logStreamName) = cloudwatch_logs("DeleteLogStream", Dict{String, Any}("logGroupName"=>logGroupName, "logStreamName"=>logStreamName))
DeleteLogStream(logGroupName, logStreamName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("DeleteLogStream", Dict{String, Any}("logGroupName"=>logGroupName, "logStreamName"=>logStreamName, args...))
...
"""
DeleteMetricFilter(filterName, logGroupName) = cloudwatch_logs("DeleteMetricFilter", Dict{String, Any}("filterName"=>filterName, "logGroupName"=>logGroupName))
DeleteMetricFilter(filterName, logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("DeleteMetricFilter", Dict{String, Any}("filterName"=>filterName, "logGroupName"=>logGroupName, args...))
...
"""
DeleteQueryDefinition(queryDefinitionId) = cloudwatch_logs("DeleteQueryDefinition", Dict{String, Any}("queryDefinitionId"=>queryDefinitionId))
DeleteQueryDefinition(queryDefinitionId, args::AbstractDict{String, <:Any}) = cloudwatch_logs("DeleteQueryDefinition", Dict{String, Any}("queryDefinitionId"=>queryDefinitionId, args...))
...
DeleteResourcePolicy(args::AbstractDict{String, <:Any}) = cloudwatch_logs("DeleteResourcePolicy", args)
...
"""
DeleteRetentionPolicy(logGroupName) = cloudwatch_logs("DeleteRetentionPolicy", Dict{String, Any}("logGroupName"=>logGroupName))
DeleteRetentionPolicy(logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("DeleteRetentionPolicy", Dict{String, Any}("logGroupName"=>logGroupName, args...))
...
"""
DeleteSubscriptionFilter(filterName, logGroupName) = cloudwatch_logs("DeleteSubscriptionFilter", Dict{String, Any}("filterName"=>filterName, "logGroupName"=>logGroupName))
DeleteSubscriptionFilter(filterName, logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("DeleteSubscriptionFilter", Dict{String, Any}("filterName"=>filterName, "logGroupName"=>logGroupName, args...))
...
DescribeDestinations(args::AbstractDict{String, <:Any}) = cloudwatch_logs("DescribeDestinations", args)
...
DescribeExportTasks(args::AbstractDict{String, <:Any}) = cloudwatch_logs("DescribeExportTasks", args)
...
DescribeLogGroups(args::AbstractDict{String, <:Any}) = cloudwatch_logs("DescribeLogGroups", args)
...
"""
DescribeLogStreams(logGroupName) = cloudwatch_logs("DescribeLogStreams", Dict{String, Any}("logGroupName"=>logGroupName))
DescribeLogStreams(logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("DescribeLogStreams", Dict{String, Any}("logGroupName"=>logGroupName, args...))
...
DescribeMetricFilters(args::AbstractDict{String, <:Any}) = cloudwatch_logs("DescribeMetricFilters", args)
...
DescribeQueries(args::AbstractDict{String, <:Any}) = cloudwatch_logs("DescribeQueries", args)
...
DescribeQueryDefinitions(args::AbstractDict{String, <:Any}) = cloudwatch_logs("DescribeQueryDefinitions", args)
...
DescribeResourcePolicies(args::AbstractDict{String, <:Any}) = cloudwatch_logs("DescribeResourcePolicies", args)
...
- `nextToken`: The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeSubscriptionFilters(logGroupName) = cloudwatch_logs("DescribeSubscriptionFilters", Dict{String, Any}("logGroupName"=>logGroupName))
DescribeSubscriptionFilters(logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("DescribeSubscriptionFilters", Dict{String, Any}("logGroupName"=>logGroupName, args...))
...
"""
DisassociateKmsKey(logGroupName) = cloudwatch_logs("DisassociateKmsKey", Dict{String, Any}("logGroupName"=>logGroupName))
DisassociateKmsKey(logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("DisassociateKmsKey", Dict{String, Any}("logGroupName"=>logGroupName, args...))
...
"""
FilterLogEvents(logGroupName) = cloudwatch_logs("FilterLogEvents", Dict{String, Any}("logGroupName"=>logGroupName))
FilterLogEvents(logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("FilterLogEvents", Dict{String, Any}("logGroupName"=>logGroupName, args...))
...
"""
GetLogEvents(logGroupName, logStreamName) = cloudwatch_logs("GetLogEvents", Dict{String, Any}("logGroupName"=>logGroupName, "logStreamName"=>logStreamName))
GetLogEvents(logGroupName, logStreamName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("GetLogEvents", Dict{String, Any}("logGroupName"=>logGroupName, "logStreamName"=>logStreamName, args...))
...
"""
GetLogGroupFields(logGroupName) = cloudwatch_logs("GetLogGroupFields", Dict{String, Any}("logGroupName"=>logGroupName))
GetLogGroupFields(logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("GetLogGroupFields", Dict{String, Any}("logGroupName"=>logGroupName, args...))
...
"""
GetLogRecord(logRecordPointer) = cloudwatch_logs("GetLogRecord", Dict{String, Any}("logRecordPointer"=>logRecordPointer))
GetLogRecord(logRecordPointer, args::AbstractDict{String, <:Any}) = cloudwatch_logs("GetLogRecord", Dict{String, Any}("logRecordPointer"=>logRecordPointer, args...))
...
"""
GetQueryResults(queryId) = cloudwatch_logs("GetQueryResults", Dict{String, Any}("queryId"=>queryId))
GetQueryResults(queryId, args::AbstractDict{String, <:Any}) = cloudwatch_logs("GetQueryResults", Dict{String, Any}("queryId"=>queryId, args...))
...
"""
ListTagsLogGroup(logGroupName) = cloudwatch_logs("ListTagsLogGroup", Dict{String, Any}("logGroupName"=>logGroupName))
ListTagsLogGroup(logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("ListTagsLogGroup", Dict{String, Any}("logGroupName"=>logGroupName, args...))
...
"""
PutDestination(destinationName, roleArn, targetArn) = cloudwatch_logs("PutDestination", Dict{String, Any}("destinationName"=>destinationName, "roleArn"=>roleArn, "targetArn"=>targetArn))
PutDestination(destinationName, roleArn, targetArn, args::AbstractDict{String, <:Any}) = cloudwatch_logs("PutDestination", Dict{String, Any}("destinationName"=>destinationName, "roleArn"=>roleArn, "targetArn"=>targetArn, args...))
...
"""
PutDestinationPolicy(accessPolicy, destinationName) = cloudwatch_logs("PutDestinationPolicy", Dict{String, Any}("accessPolicy"=>accessPolicy, "destinationName"=>destinationName))
PutDestinationPolicy(accessPolicy, destinationName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("PutDestinationPolicy", Dict{String, Any}("accessPolicy"=>accessPolicy, "destinationName"=>destinationName, args...))
...
"""
PutLogEvents(logEvents, logGroupName, logStreamName) = cloudwatch_logs("PutLogEvents", Dict{String, Any}("logEvents"=>logEvents, "logGroupName"=>logGroupName, "logStreamName"=>logStreamName))
PutLogEvents(logEvents, logGroupName, logStreamName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("PutLogEvents", Dict{String, Any}("logEvents"=>logEvents, "logGroupName"=>logGroupName, "logStreamName"=>logStreamName, args...))
...
"""
PutMetricFilter(filterName, filterPattern, logGroupName, metricTransformations) = cloudwatch_logs("PutMetricFilter", Dict{String, Any}("filterName"=>filterName, "filterPattern"=>filterPattern, "logGroupName"=>logGroupName, "metricTransformations"=>metricTransformations))
PutMetricFilter(filterName, filterPattern, logGroupName, metricTransformations, args::AbstractDict{String, <:Any}) = cloudwatch_logs("PutMetricFilter", Dict{String, Any}("filterName"=>filterName, "filterPattern"=>filterPattern, "logGroupName"=>logGroupName, "metricTransformations"=>metricTransformations, args...))
...
- `queryDefinitionId`: 
"""
PutQueryDefinition(name, queryString) = cloudwatch_logs("PutQueryDefinition", Dict{String, Any}("name"=>name, "queryString"=>queryString))
PutQueryDefinition(name, queryString, args::AbstractDict{String, <:Any}) = cloudwatch_logs("PutQueryDefinition", Dict{String, Any}("name"=>name, "queryString"=>queryString, args...))
...
PutResourcePolicy(args::AbstractDict{String, <:Any}) = cloudwatch_logs("PutResourcePolicy", args)
...
"""
PutRetentionPolicy(logGroupName, retentionInDays) = cloudwatch_logs("PutRetentionPolicy", Dict{String, Any}("logGroupName"=>logGroupName, "retentionInDays"=>retentionInDays))
PutRetentionPolicy(logGroupName, retentionInDays, args::AbstractDict{String, <:Any}) = cloudwatch_logs("PutRetentionPolicy", Dict{String, Any}("logGroupName"=>logGroupName, "retentionInDays"=>retentionInDays, args...))
...
"""
PutSubscriptionFilter(destinationArn, filterName, filterPattern, logGroupName) = cloudwatch_logs("PutSubscriptionFilter", Dict{String, Any}("destinationArn"=>destinationArn, "filterName"=>filterName, "filterPattern"=>filterPattern, "logGroupName"=>logGroupName))
PutSubscriptionFilter(destinationArn, filterName, filterPattern, logGroupName, args::AbstractDict{String, <:Any}) = cloudwatch_logs("PutSubscriptionFilter", Dict{String, Any}("destinationArn"=>destinationArn, "filterName"=>filterName, "filterPattern"=>filterPattern, "logGroupName"=>logGroupName, args...))
...
"""
StartQuery(endTime, queryString, startTime) = cloudwatch_logs("StartQuery", Dict{String, Any}("endTime"=>endTime, "queryString"=>queryString, "startTime"=>startTime))
StartQuery(endTime, queryString, startTime, args::AbstractDict{String, <:Any}) = cloudwatch_logs("StartQuery", Dict{String, Any}("endTime"=>endTime, "queryString"=>queryString, "startTime"=>startTime, args...))
...
"""
StopQuery(queryId) = cloudwatch_logs("StopQuery", Dict{String, Any}("queryId"=>queryId))
StopQuery(queryId, args::AbstractDict{String, <:Any}) = cloudwatch_logs("StopQuery", Dict{String, Any}("queryId"=>queryId, args...))
...
"""
TagLogGroup(logGroupName, tags) = cloudwatch_logs("TagLogGroup", Dict{String, Any}("logGroupName"=>logGroupName, "tags"=>tags))
TagLogGroup(logGroupName, tags, args::AbstractDict{String, <:Any}) = cloudwatch_logs("TagLogGroup", Dict{String, Any}("logGroupName"=>logGroupName, "tags"=>tags, args...))
...
"""
TestMetricFilter(filterPattern, logEventMessages) = cloudwatch_logs("TestMetricFilter", Dict{String, Any}("filterPattern"=>filterPattern, "logEventMessages"=>logEventMessages))
TestMetricFilter(filterPattern, logEventMessages, args::AbstractDict{String, <:Any}) = cloudwatch_logs("TestMetricFilter", Dict{String, Any}("filterPattern"=>filterPattern, "logEventMessages"=>logEventMessages, args...))
...
"""
UntagLogGroup(logGroupName, tags) = cloudwatch_logs("UntagLogGroup", Dict{String, Any}("logGroupName"=>logGroupName, "tags"=>tags))
UntagLogGroup(logGroupName, tags, args::AbstractDict{String, <:Any}) = cloudwatch_logs("UntagLogGroup", Dict{String, Any}("logGroupName"=>logGroupName, "tags"=>tags, args...))
