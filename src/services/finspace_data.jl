...
- `application_permissions`: The option to indicate FinSpace application permissions that
  ...
  !!! important
      ...
      functionality in their FinSpace environment's application. It should only be granted
      to trusted users.
...
function get_dataset(datasetId; aws_config::AbstractAWSConfig=current_aws_config())
    return finspace_data(
        "GET", "/datasetsv2/$(datasetId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_user(userId; aws_config::AbstractAWSConfig=current_aws_config())
    return finspace_data(
        "GET", "/user/$(userId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_user(
    ...
    return finspace_data(
        "GET", "/user/$(userId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"locationType"`: Specify the type of the working location.
  ...
  - `SAGEMAKER` – Use the Amazon S3 location as a temporary location to store data content
...
function get_working_location(; aws_config::AbstractAWSConfig=current_aws_config())
    return finspace_data(
        "POST", "/workingLocationV1"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_working_location(
    ...
    return finspace_data(
        "POST", "/workingLocationV1", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_datasets(; aws_config::AbstractAWSConfig=current_aws_config())
    return finspace_data("GET", "/datasetsv2"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_datasets(
    ...
    return finspace_data(
        "GET", "/datasetsv2", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
