...
"""
AddAttachmentsToSet(attachments) = support("AddAttachmentsToSet", Dict{String, Any}("attachments"=>attachments))
AddAttachmentsToSet(attachments, args::AbstractDict{String, <: Any}) = support("AddAttachmentsToSet", Dict{String, Any}("attachments"=>attachments, args...))
...
"""
AddCommunicationToCase(communicationBody) = support("AddCommunicationToCase", Dict{String, Any}("communicationBody"=>communicationBody))
AddCommunicationToCase(communicationBody, args::AbstractDict{String, <: Any}) = support("AddCommunicationToCase", Dict{String, Any}("communicationBody"=>communicationBody, args...))
...
"""
CreateCase(communicationBody, subject) = support("CreateCase", Dict{String, Any}("communicationBody"=>communicationBody, "subject"=>subject))
CreateCase(communicationBody, subject, args::AbstractDict{String, <: Any}) = support("CreateCase", Dict{String, Any}("communicationBody"=>communicationBody, "subject"=>subject, args...))
...
"""
DescribeAttachment(attachmentId) = support("DescribeAttachment", Dict{String, Any}("attachmentId"=>attachmentId))
DescribeAttachment(attachmentId, args::AbstractDict{String, <: Any}) = support("DescribeAttachment", Dict{String, Any}("attachmentId"=>attachmentId, args...))
...
DescribeCases(args::AbstractDict{String, <: Any}) = support("DescribeCases", args)
...
nextToken => A resumption point for pagination.
"""
DescribeCommunications(caseId) = support("DescribeCommunications", Dict{String, Any}("caseId"=>caseId))
DescribeCommunications(caseId, args::AbstractDict{String, <: Any}) = support("DescribeCommunications", Dict{String, Any}("caseId"=>caseId, args...))
...
DescribeServices(args::AbstractDict{String, <: Any}) = support("DescribeServices", args)
...
DescribeSeverityLevels(args::AbstractDict{String, <: Any}) = support("DescribeSeverityLevels", args)
...
"""
DescribeTrustedAdvisorCheckRefreshStatuses(checkIds) = support("DescribeTrustedAdvisorCheckRefreshStatuses", Dict{String, Any}("checkIds"=>checkIds))
DescribeTrustedAdvisorCheckRefreshStatuses(checkIds, args::AbstractDict{String, <: Any}) = support("DescribeTrustedAdvisorCheckRefreshStatuses", Dict{String, Any}("checkIds"=>checkIds, args...))
...
language => The ISO 639-1 code for the language in which AWS provides support. AWS Support currently supports English ("en") and Japanese ("ja"). Language parameters must be passed explicitly for operations that take them.
"""
DescribeTrustedAdvisorCheckResult(checkId) = support("DescribeTrustedAdvisorCheckResult", Dict{String, Any}("checkId"=>checkId))
DescribeTrustedAdvisorCheckResult(checkId, args::AbstractDict{String, <: Any}) = support("DescribeTrustedAdvisorCheckResult", Dict{String, Any}("checkId"=>checkId, args...))
...
"""
DescribeTrustedAdvisorCheckSummaries(checkIds) = support("DescribeTrustedAdvisorCheckSummaries", Dict{String, Any}("checkIds"=>checkIds))
DescribeTrustedAdvisorCheckSummaries(checkIds, args::AbstractDict{String, <: Any}) = support("DescribeTrustedAdvisorCheckSummaries", Dict{String, Any}("checkIds"=>checkIds, args...))
...
"""
DescribeTrustedAdvisorChecks(language) = support("DescribeTrustedAdvisorChecks", Dict{String, Any}("language"=>language))
DescribeTrustedAdvisorChecks(language, args::AbstractDict{String, <: Any}) = support("DescribeTrustedAdvisorChecks", Dict{String, Any}("language"=>language, args...))
...
"""
RefreshTrustedAdvisorCheck(checkId) = support("RefreshTrustedAdvisorCheck", Dict{String, Any}("checkId"=>checkId))
RefreshTrustedAdvisorCheck(checkId, args::AbstractDict{String, <: Any}) = support("RefreshTrustedAdvisorCheck", Dict{String, Any}("checkId"=>checkId, args...))
...
ResolveCase(args::AbstractDict{String, <: Any}) = support("ResolveCase", args)
