...
- `"ccEmailAddresses"`: The email addresses in the CC line of an email to be added to the
  support case.
"""
function add_communication_to_case end

function add_communication_to_case(
    communicationBody; aws_config::AbstractAWSConfig=current_aws_config()
)
    return support(
...
- `"categoryCode"`: The category of problem for the support case. You also use the
  `DescribeServices` operation to get the category code for a service. Each Amazon Web
...
are returned in the `AttachmentDetails` objects that are returned by the [`describe_communications`](@ref)
operation.
...
"""
function describe_attachment end
...
"""
function describe_cases end

function describe_cases(; aws_config::AbstractAWSConfig=current_aws_config())
    return support("DescribeCases"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function describe_cases(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return support("DescribeCases", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"nextToken"`: A resumption point for pagination.
"""
function describe_communications end

function describe_communications(caseId; aws_config::AbstractAWSConfig=current_aws_config())
    return support(
...
- `service_code`: The code for the Amazon Web Services service. You can use the
  `DescribeServices` operation to get the possible `serviceCode` values.
"""
function describe_create_case_options end
...
function describe_services(; aws_config::AbstractAWSConfig=current_aws_config())
    return support("DescribeServices"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function describe_services(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return support("DescribeServices", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
level for a case is also a field in the `CaseDetails` data type that you include for a [`create_case`](@ref)
request.
...
function describe_severity_levels(; aws_config::AbstractAWSConfig=current_aws_config())
    return support("DescribeSeverityLevels"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_severity_levels(
    ...
    return support(
        "DescribeSeverityLevels", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `service_code`: The code for the Amazon Web Services service. You can use the
  `DescribeServices` operation to get the possible `serviceCode` values.
"""
function describe_supported_languages end
...
"""
function describe_trusted_advisor_check_summaries end
...
- `"caseId"`: The support case ID requested or returned in the call. The case ID is an
  ...
  c4c1d2bf33c5cf47*
"""
function resolve_case end

function resolve_case(; aws_config::AbstractAWSConfig=current_aws_config())
    return support("ResolveCase"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function resolve_case(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return support("ResolveCase", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
