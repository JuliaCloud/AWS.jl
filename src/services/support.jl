...
AddAttachmentsToSet(attachments; aws_config::AWSConfig=global_aws_config()) = support("AddAttachmentsToSet", Dict{String, Any}("attachments"=>attachments); aws_config=aws_config)
AddAttachmentsToSet(attachments, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("AddAttachmentsToSet", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("attachments"=>attachments), args)); aws_config=aws_config)
...
AddCommunicationToCase(communicationBody; aws_config::AWSConfig=global_aws_config()) = support("AddCommunicationToCase", Dict{String, Any}("communicationBody"=>communicationBody); aws_config=aws_config)
AddCommunicationToCase(communicationBody, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("AddCommunicationToCase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("communicationBody"=>communicationBody), args)); aws_config=aws_config)
...
CreateCase(communicationBody, subject; aws_config::AWSConfig=global_aws_config()) = support("CreateCase", Dict{String, Any}("communicationBody"=>communicationBody, "subject"=>subject); aws_config=aws_config)
CreateCase(communicationBody, subject, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("CreateCase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("communicationBody"=>communicationBody, "subject"=>subject), args)); aws_config=aws_config)
...
DescribeAttachment(attachmentId; aws_config::AWSConfig=global_aws_config()) = support("DescribeAttachment", Dict{String, Any}("attachmentId"=>attachmentId); aws_config=aws_config)
DescribeAttachment(attachmentId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("DescribeAttachment", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("attachmentId"=>attachmentId), args)); aws_config=aws_config)
...
DescribeCases(; aws_config::AWSConfig=global_aws_config()) = support("DescribeCases"; aws_config=aws_config)
DescribeCases(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("DescribeCases", args; aws_config=aws_config)
...
DescribeCommunications(caseId; aws_config::AWSConfig=global_aws_config()) = support("DescribeCommunications", Dict{String, Any}("caseId"=>caseId); aws_config=aws_config)
DescribeCommunications(caseId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("DescribeCommunications", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("caseId"=>caseId), args)); aws_config=aws_config)
...
DescribeServices(; aws_config::AWSConfig=global_aws_config()) = support("DescribeServices"; aws_config=aws_config)
DescribeServices(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("DescribeServices", args; aws_config=aws_config)
...
DescribeSeverityLevels(; aws_config::AWSConfig=global_aws_config()) = support("DescribeSeverityLevels"; aws_config=aws_config)
DescribeSeverityLevels(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("DescribeSeverityLevels", args; aws_config=aws_config)
...
DescribeTrustedAdvisorCheckRefreshStatuses(checkIds; aws_config::AWSConfig=global_aws_config()) = support("DescribeTrustedAdvisorCheckRefreshStatuses", Dict{String, Any}("checkIds"=>checkIds); aws_config=aws_config)
DescribeTrustedAdvisorCheckRefreshStatuses(checkIds, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("DescribeTrustedAdvisorCheckRefreshStatuses", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("checkIds"=>checkIds), args)); aws_config=aws_config)
...
DescribeTrustedAdvisorCheckResult(checkId; aws_config::AWSConfig=global_aws_config()) = support("DescribeTrustedAdvisorCheckResult", Dict{String, Any}("checkId"=>checkId); aws_config=aws_config)
DescribeTrustedAdvisorCheckResult(checkId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("DescribeTrustedAdvisorCheckResult", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("checkId"=>checkId), args)); aws_config=aws_config)
...
DescribeTrustedAdvisorCheckSummaries(checkIds; aws_config::AWSConfig=global_aws_config()) = support("DescribeTrustedAdvisorCheckSummaries", Dict{String, Any}("checkIds"=>checkIds); aws_config=aws_config)
DescribeTrustedAdvisorCheckSummaries(checkIds, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("DescribeTrustedAdvisorCheckSummaries", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("checkIds"=>checkIds), args)); aws_config=aws_config)
...
DescribeTrustedAdvisorChecks(language; aws_config::AWSConfig=global_aws_config()) = support("DescribeTrustedAdvisorChecks", Dict{String, Any}("language"=>language); aws_config=aws_config)
DescribeTrustedAdvisorChecks(language, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("DescribeTrustedAdvisorChecks", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("language"=>language), args)); aws_config=aws_config)
...
RefreshTrustedAdvisorCheck(checkId; aws_config::AWSConfig=global_aws_config()) = support("RefreshTrustedAdvisorCheck", Dict{String, Any}("checkId"=>checkId); aws_config=aws_config)
RefreshTrustedAdvisorCheck(checkId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("RefreshTrustedAdvisorCheck", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("checkId"=>checkId), args)); aws_config=aws_config)
...
ResolveCase(; aws_config::AWSConfig=global_aws_config()) = support("ResolveCase"; aws_config=aws_config)
ResolveCase(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = support("ResolveCase", args; aws_config=aws_config)
