...
"""
CreateSignalingChannel(ChannelName) = kinesis_video("POST", "/createSignalingChannel", Dict{String, Any}("ChannelName"=>ChannelName))
CreateSignalingChannel(ChannelName, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/createSignalingChannel", Dict{String, Any}("ChannelName"=>ChannelName, args...))
...
"""
CreateStream(StreamName) = kinesis_video("POST", "/createStream", Dict{String, Any}("StreamName"=>StreamName))
CreateStream(StreamName, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/createStream", Dict{String, Any}("StreamName"=>StreamName, args...))
...
"""
DeleteSignalingChannel(ChannelARN) = kinesis_video("POST", "/deleteSignalingChannel", Dict{String, Any}("ChannelARN"=>ChannelARN))
DeleteSignalingChannel(ChannelARN, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/deleteSignalingChannel", Dict{String, Any}("ChannelARN"=>ChannelARN, args...))
...
"""
DeleteStream(StreamARN) = kinesis_video("POST", "/deleteStream", Dict{String, Any}("StreamARN"=>StreamARN))
DeleteStream(StreamARN, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/deleteStream", Dict{String, Any}("StreamARN"=>StreamARN, args...))
...
DescribeSignalingChannel(args::AbstractDict{String, Any}) = kinesis_video("POST", "/describeSignalingChannel", args)
...
DescribeStream(args::AbstractDict{String, Any}) = kinesis_video("POST", "/describeStream", args)
...
"""
GetDataEndpoint(APIName) = kinesis_video("POST", "/getDataEndpoint", Dict{String, Any}("APIName"=>APIName))
GetDataEndpoint(APIName, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/getDataEndpoint", Dict{String, Any}("APIName"=>APIName, args...))
...
"""
GetSignalingChannelEndpoint(ChannelARN) = kinesis_video("POST", "/getSignalingChannelEndpoint", Dict{String, Any}("ChannelARN"=>ChannelARN))
GetSignalingChannelEndpoint(ChannelARN, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/getSignalingChannelEndpoint", Dict{String, Any}("ChannelARN"=>ChannelARN, args...))
...
ListSignalingChannels(args::AbstractDict{String, Any}) = kinesis_video("POST", "/listSignalingChannels", args)
...
ListStreams(args::AbstractDict{String, Any}) = kinesis_video("POST", "/listStreams", args)
...
"""
ListTagsForResource(ResourceARN) = kinesis_video("POST", "/ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN))
ListTagsForResource(ResourceARN, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN, args...))
...
ListTagsForStream(args::AbstractDict{String, Any}) = kinesis_video("POST", "/listTagsForStream", args)
...
"""
TagResource(ResourceARN, Tags) = kinesis_video("POST", "/TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags))
TagResource(ResourceARN, Tags, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags, args...))
...
"""
TagStream(Tags) = kinesis_video("POST", "/tagStream", Dict{String, Any}("Tags"=>Tags))
TagStream(Tags, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/tagStream", Dict{String, Any}("Tags"=>Tags, args...))
...
"""
UntagResource(ResourceARN, TagKeyList) = kinesis_video("POST", "/UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeyList"=>TagKeyList))
UntagResource(ResourceARN, TagKeyList, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeyList"=>TagKeyList, args...))
...
"""
UntagStream(TagKeyList) = kinesis_video("POST", "/untagStream", Dict{String, Any}("TagKeyList"=>TagKeyList))
UntagStream(TagKeyList, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/untagStream", Dict{String, Any}("TagKeyList"=>TagKeyList, args...))
...
"""
UpdateDataRetention(CurrentVersion, DataRetentionChangeInHours, Operation) = kinesis_video("POST", "/updateDataRetention", Dict{String, Any}("CurrentVersion"=>CurrentVersion, "DataRetentionChangeInHours"=>DataRetentionChangeInHours, "Operation"=>Operation))
UpdateDataRetention(CurrentVersion, DataRetentionChangeInHours, Operation, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/updateDataRetention", Dict{String, Any}("CurrentVersion"=>CurrentVersion, "DataRetentionChangeInHours"=>DataRetentionChangeInHours, "Operation"=>Operation, args...))
...
"""
UpdateSignalingChannel(ChannelARN, CurrentVersion) = kinesis_video("POST", "/updateSignalingChannel", Dict{String, Any}("ChannelARN"=>ChannelARN, "CurrentVersion"=>CurrentVersion))
UpdateSignalingChannel(ChannelARN, CurrentVersion, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/updateSignalingChannel", Dict{String, Any}("ChannelARN"=>ChannelARN, "CurrentVersion"=>CurrentVersion, args...))
...
"""
UpdateStream(CurrentVersion) = kinesis_video("POST", "/updateStream", Dict{String, Any}("CurrentVersion"=>CurrentVersion))
UpdateStream(CurrentVersion, args::AbstractDict{String, <: Any}) = kinesis_video("POST", "/updateStream", Dict{String, Any}("CurrentVersion"=>CurrentVersion, args...))
