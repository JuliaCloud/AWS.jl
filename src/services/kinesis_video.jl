...
# Required Parameters
- `ChannelName`: A name for the signaling channel that you are creating. It must be unique
...
"""
create_signaling_channel(ChannelName; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/createSignalingChannel", Dict{String, Any}("ChannelName"=>ChannelName); aws_config=aws_config)
create_signaling_channel(ChannelName, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/createSignalingChannel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelName"=>ChannelName), args)); aws_config=aws_config)
...
# Required Parameters
- `StreamName`: A name for the stream that you are creating. The stream name is an
...
- `KmsKeyId`: The ID of the AWS Key Management Service (AWS KMS) key that you want Kinesis
  Video Streams to use to encrypt stream data. If no key ID is specified, the default,
...
"""
create_stream(StreamName; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/createStream", Dict{String, Any}("StreamName"=>StreamName); aws_config=aws_config)
create_stream(StreamName, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/createStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamName"=>StreamName), args)); aws_config=aws_config)
...
# Required Parameters
- `ChannelARN`: The Amazon Resource Name (ARN) of the signaling channel that you want to
  delete.
...
"""
delete_signaling_channel(ChannelARN; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/deleteSignalingChannel", Dict{String, Any}("ChannelARN"=>ChannelARN); aws_config=aws_config)
delete_signaling_channel(ChannelARN, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/deleteSignalingChannel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelARN"=>ChannelARN), args)); aws_config=aws_config)
...
"""
delete_stream(StreamARN; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/deleteStream", Dict{String, Any}("StreamARN"=>StreamARN); aws_config=aws_config)
delete_stream(StreamARN, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/deleteStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamARN"=>StreamARN), args)); aws_config=aws_config)
...
describe_signaling_channel(args::AbstractDict{String, Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/describeSignalingChannel", args; aws_config=aws_config)
...
describe_stream(args::AbstractDict{String, Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/describeStream", args; aws_config=aws_config)
...
"""
get_data_endpoint(APIName; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/getDataEndpoint", Dict{String, Any}("APIName"=>APIName); aws_config=aws_config)
get_data_endpoint(APIName, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/getDataEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("APIName"=>APIName), args)); aws_config=aws_config)
...
# Required Parameters
- `ChannelARN`: The Amazon Resource Name (ARN) of the signalling channel for which you want
  to get an endpoint.
...
"""
get_signaling_channel_endpoint(ChannelARN; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/getSignalingChannelEndpoint", Dict{String, Any}("ChannelARN"=>ChannelARN); aws_config=aws_config)
get_signaling_channel_endpoint(ChannelARN, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/getSignalingChannelEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelARN"=>ChannelARN), args)); aws_config=aws_config)
...
list_signaling_channels(args::AbstractDict{String, Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/listSignalingChannels", args; aws_config=aws_config)
...
- `MaxResults`: The maximum number of streams to return in the response. The default is
  10,000.
- `NextToken`: If you specify this parameter, when the result of a ListStreams operation is
  truncated, the call returns the NextToken in the response. To get another batch of streams,
...
list_streams(args::AbstractDict{String, Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/listStreams", args; aws_config=aws_config)
...
# Required Parameters
- `ResourceARN`: The Amazon Resource Name (ARN) of the signaling channel for which you want
  to list tags.
...
"""
list_tags_for_resource(ResourceARN; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN); aws_config=aws_config)
list_tags_for_resource(ResourceARN, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN), args)); aws_config=aws_config)
...
# Optional Parameters
- `NextToken`: If you specify this parameter and the result of a ListTagsForStream call is
...
list_tags_for_stream(args::AbstractDict{String, Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/listTagsForStream", args; aws_config=aws_config)
...
# Required Parameters
- `ResourceARN`: The Amazon Resource Name (ARN) of the signaling channel to which you want
  to add tags.
- `Tags`: A list of tags to associate with the specified signaling channel. Each tag is a
  key-value pair.

"""
tag_resource(ResourceARN, Tags; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags); aws_config=aws_config)
tag_resource(ResourceARN, Tags, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags), args)); aws_config=aws_config)
...
"""
tag_stream(Tags; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/tagStream", Dict{String, Any}("Tags"=>Tags); aws_config=aws_config)
tag_stream(Tags, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/tagStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Tags"=>Tags), args)); aws_config=aws_config)
...
# Required Parameters
- `ResourceARN`: The Amazon Resource Name (ARN) of the signaling channel from which you
  want to remove tags.
- `TagKeyList`: A list of the keys of the tags that you want to remove.

"""
untag_resource(ResourceARN, TagKeyList; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeyList"=>TagKeyList); aws_config=aws_config)
untag_resource(ResourceARN, TagKeyList, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeyList"=>TagKeyList), args)); aws_config=aws_config)
...
"""
untag_stream(TagKeyList; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/untagStream", Dict{String, Any}("TagKeyList"=>TagKeyList); aws_config=aws_config)
untag_stream(TagKeyList, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/untagStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TagKeyList"=>TagKeyList), args)); aws_config=aws_config)
...
# Required Parameters
- `CurrentVersion`: The version of the stream whose retention period you want to change. To
  get the version, call either the DescribeStream or the ListStreams API.
- `DataRetentionChangeInHours`: The retention period, in hours. The value you specify
...
"""
update_signaling_channel(ChannelARN, CurrentVersion; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/updateSignalingChannel", Dict{String, Any}("ChannelARN"=>ChannelARN, "CurrentVersion"=>CurrentVersion); aws_config=aws_config)
update_signaling_channel(ChannelARN, CurrentVersion, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/updateSignalingChannel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelARN"=>ChannelARN, "CurrentVersion"=>CurrentVersion), args)); aws_config=aws_config)
...
"""
update_stream(CurrentVersion; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/updateStream", Dict{String, Any}("CurrentVersion"=>CurrentVersion); aws_config=aws_config)
update_stream(CurrentVersion, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = kinesis_video("POST", "/updateStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CurrentVersion"=>CurrentVersion), args)); aws_config=aws_config)
