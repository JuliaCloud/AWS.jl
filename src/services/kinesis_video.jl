...
"""
CreateSignalingChannel(ChannelName; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/createSignalingChannel", Dict{String, Any}("ChannelName"=>ChannelName))
CreateSignalingChannel(ChannelName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/createSignalingChannel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelName"=>ChannelName), args)); aws=aws)
...
"""
CreateStream(StreamName; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/createStream", Dict{String, Any}("StreamName"=>StreamName))
CreateStream(StreamName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/createStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamName"=>StreamName), args)); aws=aws)
...
"""
DeleteSignalingChannel(ChannelARN; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/deleteSignalingChannel", Dict{String, Any}("ChannelARN"=>ChannelARN))
DeleteSignalingChannel(ChannelARN, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/deleteSignalingChannel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelARN"=>ChannelARN), args)); aws=aws)
...
"""
DeleteStream(StreamARN; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/deleteStream", Dict{String, Any}("StreamARN"=>StreamARN))
DeleteStream(StreamARN, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/deleteStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamARN"=>StreamARN), args)); aws=aws)
...
"""
DescribeSignalingChannel(; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/describeSignalingChannel"; aws=aws)
DescribeSignalingChannel(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/describeSignalingChannel", args; aws=aws)
...
"""
DescribeStream(; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/describeStream"; aws=aws)
DescribeStream(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/describeStream", args; aws=aws)
...
"""
GetDataEndpoint(APIName; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/getDataEndpoint", Dict{String, Any}("APIName"=>APIName))
GetDataEndpoint(APIName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/getDataEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("APIName"=>APIName), args)); aws=aws)
...
"""
GetSignalingChannelEndpoint(ChannelARN; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/getSignalingChannelEndpoint", Dict{String, Any}("ChannelARN"=>ChannelARN))
GetSignalingChannelEndpoint(ChannelARN, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/getSignalingChannelEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelARN"=>ChannelARN), args)); aws=aws)
...
"""
ListSignalingChannels(; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/listSignalingChannels"; aws=aws)
ListSignalingChannels(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/listSignalingChannels", args; aws=aws)
...
"""
ListStreams(; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/listStreams"; aws=aws)
ListStreams(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/listStreams", args; aws=aws)
...
"""
ListTagsForResource(ResourceARN; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN))
ListTagsForResource(ResourceARN, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN), args)); aws=aws)
...
"""
ListTagsForStream(; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/listTagsForStream"; aws=aws)
ListTagsForStream(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/listTagsForStream", args; aws=aws)
...
"""
TagResource(ResourceARN, Tags; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags))
TagResource(ResourceARN, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags), args)); aws=aws)
...
"""
TagStream(Tags; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/tagStream", Dict{String, Any}("Tags"=>Tags))
TagStream(Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/tagStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Tags"=>Tags), args)); aws=aws)
...
"""
UntagResource(ResourceARN, TagKeyList; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeyList"=>TagKeyList))
UntagResource(ResourceARN, TagKeyList, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeyList"=>TagKeyList), args)); aws=aws)
...
"""
UntagStream(TagKeyList; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/untagStream", Dict{String, Any}("TagKeyList"=>TagKeyList))
UntagStream(TagKeyList, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/untagStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TagKeyList"=>TagKeyList), args)); aws=aws)
...
"""
UpdateDataRetention(CurrentVersion, DataRetentionChangeInHours, Operation; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/updateDataRetention", Dict{String, Any}("CurrentVersion"=>CurrentVersion, "DataRetentionChangeInHours"=>DataRetentionChangeInHours, "Operation"=>Operation))
UpdateDataRetention(CurrentVersion, DataRetentionChangeInHours, Operation, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/updateDataRetention", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CurrentVersion"=>CurrentVersion, "DataRetentionChangeInHours"=>DataRetentionChangeInHours, "Operation"=>Operation), args)); aws=aws)
...
"""
UpdateSignalingChannel(ChannelARN, CurrentVersion; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/updateSignalingChannel", Dict{String, Any}("ChannelARN"=>ChannelARN, "CurrentVersion"=>CurrentVersion))
UpdateSignalingChannel(ChannelARN, CurrentVersion, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/updateSignalingChannel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelARN"=>ChannelARN, "CurrentVersion"=>CurrentVersion), args)); aws=aws)
...
"""
UpdateStream(CurrentVersion; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/updateStream", Dict{String, Any}("CurrentVersion"=>CurrentVersion))
UpdateStream(CurrentVersion, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_video("POST", "/updateStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CurrentVersion"=>CurrentVersion), args)); aws=aws)
