...
"""
create_signaling_channel(ChannelName; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/createSignalingChannel", Dict{String, Any}("ChannelName"=>ChannelName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_signaling_channel(ChannelName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/createSignalingChannel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelName"=>ChannelName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_stream(StreamName; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/createStream", Dict{String, Any}("StreamName"=>StreamName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_stream(StreamName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/createStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamName"=>StreamName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
corresponding media from the Edge Agent.

When you invoke this API, the sync status is set to `DELETING`. A deletion process starts,
in which active edge jobs are stopped and all media is deleted from the edge device. The
time to delete varies, depending on the total amount of stored media. If the deletion
process fails, the sync status changes to `DELETE_FAILED`. You will need to re-try the
deletion.

When the deletion process has completed successfully, the edge configuration is no longer
accessible.
...
"""
delete_edge_configuration(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/deleteEdgeConfiguration"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_edge_configuration(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/deleteEdgeConfiguration", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
operation. If you don't specify the channel's current version, the most recent version is
deleted.
...
"""
delete_signaling_channel(ChannelARN; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/deleteSignalingChannel", Dict{String, Any}("ChannelARN"=>ChannelARN); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_signaling_channel(ChannelARN, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/deleteSignalingChannel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelARN"=>ChannelARN), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_stream(StreamARN; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/deleteStream", Dict{String, Any}("StreamARN"=>StreamARN); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_stream(StreamARN, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/deleteStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StreamARN"=>StreamARN), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"StreamName"`: The name of the stream whose edge configuration you want to update.
  Specify either the `StreamName` or the `StreamARN`.
"""
describe_edge_configuration(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeEdgeConfiguration"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_edge_configuration(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeEdgeConfiguration", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_image_generation_configuration(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeImageGenerationConfiguration"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_image_generation_configuration(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeImageGenerationConfiguration", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_mapped_resource_configuration(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeMappedResourceConfiguration"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_mapped_resource_configuration(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeMappedResourceConfiguration", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_media_storage_configuration(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeMediaStorageConfiguration"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_media_storage_configuration(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeMediaStorageConfiguration", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"StreamName"`: The name of the stream from which to retrieve the notification
  configuration. You must specify either the `StreamName` or the `StreamARN`.
"""
describe_notification_configuration(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeNotificationConfiguration"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_notification_configuration(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeNotificationConfiguration", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_signaling_channel(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeSignalingChannel"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_signaling_channel(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeSignalingChannel", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"StreamName"`: The name of the stream.
"""
describe_stream(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeStream"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_stream(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/describeStream", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_data_endpoint(APIName; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/getDataEndpoint", Dict{String, Any}("APIName"=>APIName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_data_endpoint(APIName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/getDataEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("APIName"=>APIName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_signaling_channel_endpoint(ChannelARN; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/getSignalingChannelEndpoint", Dict{String, Any}("ChannelARN"=>ChannelARN); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_signaling_channel_endpoint(ChannelARN, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/getSignalingChannelEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelARN"=>ChannelARN), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: If you specify this parameter, when the result of a
  ...
  next request.
"""
list_edge_agent_configurations(HubDeviceArn; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/listEdgeAgentConfigurations", Dict{String, Any}("HubDeviceArn"=>HubDeviceArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_edge_agent_configurations(HubDeviceArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/listEdgeAgentConfigurations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HubDeviceArn"=>HubDeviceArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_signaling_channels(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/listSignalingChannels"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_signaling_channels(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/listSignalingChannels", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_streams(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/listStreams"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_streams(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/listStreams", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_tags_for_resource(ResourceARN; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_tags_for_resource(ResourceARN, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_tags_for_stream(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/listTagsForStream"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_tags_for_stream(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/listTagsForStream", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)

"""
    start_edge_configuration_update(edge_config)
    start_edge_configuration_update(edge_config, params::Dict{String,<:Any})

An asynchronous API that updates a stream’s existing edge configuration. The Kinesis Video
Stream will sync the stream’s edge configuration with the Edge Agent IoT Greengrass
...
- `"StreamName"`: The name of the stream whose edge configuration you want to update.
  Specify either the `StreamName` or the `StreamARN`.
"""
start_edge_configuration_update(EdgeConfig; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/startEdgeConfigurationUpdate", Dict{String, Any}("EdgeConfig"=>EdgeConfig); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_edge_configuration_update(EdgeConfig, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/startEdgeConfigurationUpdate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EdgeConfig"=>EdgeConfig), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `tags`: A list of tags to associate with the specified signaling channel. Each tag is a
  key-value pair.
"""
tag_resource(ResourceARN, Tags; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
tag_resource(ResourceARN, Tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
tag_stream(Tags; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/tagStream", Dict{String, Any}("Tags"=>Tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
tag_stream(Tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/tagStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Tags"=>Tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
untag_resource(ResourceARN, TagKeyList; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeyList"=>TagKeyList); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
untag_resource(ResourceARN, TagKeyList, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeyList"=>TagKeyList), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
untag_stream(TagKeyList; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/untagStream", Dict{String, Any}("TagKeyList"=>TagKeyList); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
untag_stream(TagKeyList, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/untagStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TagKeyList"=>TagKeyList), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_data_retention(CurrentVersion, DataRetentionChangeInHours, Operation; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/updateDataRetention", Dict{String, Any}("CurrentVersion"=>CurrentVersion, "DataRetentionChangeInHours"=>DataRetentionChangeInHours, "Operation"=>Operation); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_data_retention(CurrentVersion, DataRetentionChangeInHours, Operation, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/updateDataRetention", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CurrentVersion"=>CurrentVersion, "DataRetentionChangeInHours"=>DataRetentionChangeInHours, "Operation"=>Operation), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"StreamName"`: The name of the stream from which to update the image generation
  configuration. You must specify either the `StreamName` or the `StreamARN`.
"""
update_image_generation_configuration(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/updateImageGenerationConfiguration"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_image_generation_configuration(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/updateImageGenerationConfiguration", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"StreamName"`: The name of the stream from which to update the notification
  configuration. You must specify either the `StreamName` or the `StreamARN`.
"""
update_notification_configuration(; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/updateNotificationConfiguration"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_notification_configuration(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/updateNotificationConfiguration", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
If the `MessageTtlSeconds` value is updated (either increased or reduced), it only applies
to new messages sent via this channel after it's been updated. Existing messages are still
expired as per the previous `MessageTtlSeconds` value.
...
"""
update_signaling_channel(ChannelARN, CurrentVersion; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/updateSignalingChannel", Dict{String, Any}("ChannelARN"=>ChannelARN, "CurrentVersion"=>CurrentVersion); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_signaling_channel(ChannelARN, CurrentVersion, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/updateSignalingChannel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChannelARN"=>ChannelARN, "CurrentVersion"=>CurrentVersion), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"StreamName"`: The name of the stream whose metadata you want to update.
  ...
  region.
"""
update_stream(CurrentVersion; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/updateStream", Dict{String, Any}("CurrentVersion"=>CurrentVersion); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_stream(CurrentVersion, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = kinesis_video("POST", "/updateStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CurrentVersion"=>CurrentVersion), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
