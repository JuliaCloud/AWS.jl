...
"""
CreateCluster(name, resourcesVpcConfig, roleArn) = eks("POST", "/clusters", Dict{String, Any}("name"=>name, "resourcesVpcConfig"=>resourcesVpcConfig, "roleArn"=>roleArn))
CreateCluster(name, resourcesVpcConfig, roleArn, args::AbstractDict{String, <: Any}) = eks("POST", "/clusters", Dict{String, Any}("name"=>name, "resourcesVpcConfig"=>resourcesVpcConfig, "roleArn"=>roleArn, args...))
...
"""
CreateFargateProfile(fargateProfileName, name, podExecutionRoleArn) = eks("POST", "/clusters/$(name)/fargate-profiles", Dict{String, Any}("fargateProfileName"=>fargateProfileName, "podExecutionRoleArn"=>podExecutionRoleArn))
CreateFargateProfile(fargateProfileName, name, podExecutionRoleArn, args::AbstractDict{String, <: Any}) = eks("POST", "/clusters/$(name)/fargate-profiles", Dict{String, Any}("fargateProfileName"=>fargateProfileName, "podExecutionRoleArn"=>podExecutionRoleArn, args...))
...
"""
CreateNodegroup(name, nodeRole, nodegroupName, subnets) = eks("POST", "/clusters/$(name)/node-groups", Dict{String, Any}("nodeRole"=>nodeRole, "nodegroupName"=>nodegroupName, "subnets"=>subnets))
CreateNodegroup(name, nodeRole, nodegroupName, subnets, args::AbstractDict{String, <: Any}) = eks("POST", "/clusters/$(name)/node-groups", Dict{String, Any}("nodeRole"=>nodeRole, "nodegroupName"=>nodegroupName, "subnets"=>subnets, args...))
...
UpdateClusterConfig(name, args::AbstractDict{String, <: Any}) = eks("POST", "/clusters/$(name)/update-config", args)
...
clientRequestToken => Unique, case-sensitive identifier that you provide to ensure the idempotency of the request.
"""
UpdateClusterVersion(name, version) = eks("POST", "/clusters/$(name)/updates", Dict{String, Any}("version"=>version))
UpdateClusterVersion(name, version, args::AbstractDict{String, <: Any}) = eks("POST", "/clusters/$(name)/updates", Dict{String, Any}("version"=>version, args...))
...
"""
UpdateNodegroupConfig(name, nodegroupName) = eks("POST", "/clusters/$(name)/node-groups/$(nodegroupName)/update-config")
UpdateNodegroupConfig(name, nodegroupName, args::AbstractDict{String, <: Any}) = eks("POST", "/clusters/$(name)/node-groups/$(nodegroupName)/update-config", args)
...
"""
UpdateNodegroupVersion(name, nodegroupName) = eks("POST", "/clusters/$(name)/node-groups/$(nodegroupName)/update-version")
UpdateNodegroupVersion(name, nodegroupName, args::AbstractDict{String, <: Any}) = eks("POST", "/clusters/$(name)/node-groups/$(nodegroupName)/update-version", args)
