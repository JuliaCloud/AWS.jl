...
"""
CreateCluster(name, resourcesVpcConfig, roleArn) = eks("POST", "/clusters", Dict{String, Any}("name"=>name, "resourcesVpcConfig"=>resourcesVpcConfig, "roleArn"=>roleArn, "clientRequestToken"=>string(uuid4())))
CreateCluster(name, resourcesVpcConfig, roleArn, args::AbstractDict{String, <:Any}) = eks("POST", "/clusters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("name"=>name, "resourcesVpcConfig"=>resourcesVpcConfig, "roleArn"=>roleArn, "clientRequestToken"=>string(uuid4())), args...)))
...
"""
CreateFargateProfile(fargateProfileName, name, podExecutionRoleArn) = eks("POST", "/clusters/$(name)/fargate-profiles", Dict{String, Any}("fargateProfileName"=>fargateProfileName, "podExecutionRoleArn"=>podExecutionRoleArn, "clientRequestToken"=>string(uuid4())))
CreateFargateProfile(fargateProfileName, name, podExecutionRoleArn, args::AbstractDict{String, <:Any}) = eks("POST", "/clusters/$(name)/fargate-profiles", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("fargateProfileName"=>fargateProfileName, "podExecutionRoleArn"=>podExecutionRoleArn, "clientRequestToken"=>string(uuid4())), args...)))
...
"""
CreateNodegroup(name, nodeRole, nodegroupName, subnets) = eks("POST", "/clusters/$(name)/node-groups", Dict{String, Any}("nodeRole"=>nodeRole, "nodegroupName"=>nodegroupName, "subnets"=>subnets, "clientRequestToken"=>string(uuid4())))
CreateNodegroup(name, nodeRole, nodegroupName, subnets, args::AbstractDict{String, <:Any}) = eks("POST", "/clusters/$(name)/node-groups", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("nodeRole"=>nodeRole, "nodegroupName"=>nodegroupName, "subnets"=>subnets, "clientRequestToken"=>string(uuid4())), args...)))
...
DeleteCluster(name, args::AbstractDict{String, <:Any}) = eks("DELETE", "/clusters/$(name)", args)
...
"""
DeleteFargateProfile(fargateProfileName, name) = eks("DELETE", "/clusters/$(name)/fargate-profiles/$(fargateProfileName)")
DeleteFargateProfile(fargateProfileName, name, args::AbstractDict{String, <:Any}) = eks("DELETE", "/clusters/$(name)/fargate-profiles/$(fargateProfileName)", args)
...
"""
DeleteNodegroup(name, nodegroupName) = eks("DELETE", "/clusters/$(name)/node-groups/$(nodegroupName)")
DeleteNodegroup(name, nodegroupName, args::AbstractDict{String, <:Any}) = eks("DELETE", "/clusters/$(name)/node-groups/$(nodegroupName)", args)
...
DescribeCluster(name, args::AbstractDict{String, <:Any}) = eks("GET", "/clusters/$(name)", args)
...
"""
DescribeFargateProfile(fargateProfileName, name) = eks("GET", "/clusters/$(name)/fargate-profiles/$(fargateProfileName)")
DescribeFargateProfile(fargateProfileName, name, args::AbstractDict{String, <:Any}) = eks("GET", "/clusters/$(name)/fargate-profiles/$(fargateProfileName)", args)
...
"""
DescribeNodegroup(name, nodegroupName) = eks("GET", "/clusters/$(name)/node-groups/$(nodegroupName)")
DescribeNodegroup(name, nodegroupName, args::AbstractDict{String, <:Any}) = eks("GET", "/clusters/$(name)/node-groups/$(nodegroupName)", args)
...
DescribeUpdate(name, updateId, args::AbstractDict{String, <:Any}) = eks("GET", "/clusters/$(name)/updates/$(updateId)", args)
...
ListClusters(args::AbstractDict{String, Any}) = eks("GET", "/clusters", args)
...
"""
ListFargateProfiles(name) = eks("GET", "/clusters/$(name)/fargate-profiles")
ListFargateProfiles(name, args::AbstractDict{String, <:Any}) = eks("GET", "/clusters/$(name)/fargate-profiles", args)
...
"""
ListNodegroups(name) = eks("GET", "/clusters/$(name)/node-groups")
ListNodegroups(name, args::AbstractDict{String, <:Any}) = eks("GET", "/clusters/$(name)/node-groups", args)
...
ListTagsForResource(resourceArn, args::AbstractDict{String, <:Any}) = eks("GET", "/tags/$(resourceArn)", args)
...
ListUpdates(name, args::AbstractDict{String, <:Any}) = eks("GET", "/clusters/$(name)/updates", args)
...
"""
TagResource(resourceArn, tags) = eks("POST", "/tags/$(resourceArn)", Dict{String, Any}("tags"=>tags))
TagResource(resourceArn, tags, args::AbstractDict{String, <:Any}) = eks("POST", "/tags/$(resourceArn)", Dict{String, Any}("tags"=>tags, args...))
...
"""
UntagResource(resourceArn, tagKeys) = eks("DELETE", "/tags/$(resourceArn)", Dict{String, Any}("tagKeys"=>tagKeys))
UntagResource(resourceArn, tagKeys, args::AbstractDict{String, <:Any}) = eks("DELETE", "/tags/$(resourceArn)", Dict{String, Any}("tagKeys"=>tagKeys, args...))
...
- `resourcesVpcConfig`: 
"""
UpdateClusterConfig(name) = eks("POST", "/clusters/$(name)/update-config", Dict{String, Any}("clientRequestToken"=>string(uuid4())))
UpdateClusterConfig(name, args::AbstractDict{String, <:Any}) = eks("POST", "/clusters/$(name)/update-config", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientRequestToken"=>string(uuid4())), args...)))
...
- `clientRequestToken`: Unique, case-sensitive identifier that you provide to ensure the idempotency of the request.
"""
UpdateClusterVersion(name, version) = eks("POST", "/clusters/$(name)/updates", Dict{String, Any}("version"=>version, "clientRequestToken"=>string(uuid4())))
UpdateClusterVersion(name, version, args::AbstractDict{String, <:Any}) = eks("POST", "/clusters/$(name)/updates", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("version"=>version, "clientRequestToken"=>string(uuid4())), args...)))
...
"""
UpdateNodegroupConfig(name, nodegroupName) = eks("POST", "/clusters/$(name)/node-groups/$(nodegroupName)/update-config", Dict{String, Any}("clientRequestToken"=>string(uuid4())))
UpdateNodegroupConfig(name, nodegroupName, args::AbstractDict{String, <:Any}) = eks("POST", "/clusters/$(name)/node-groups/$(nodegroupName)/update-config", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientRequestToken"=>string(uuid4())), args...)))
...
"""
UpdateNodegroupVersion(name, nodegroupName) = eks("POST", "/clusters/$(name)/node-groups/$(nodegroupName)/update-version", Dict{String, Any}("clientRequestToken"=>string(uuid4())))
UpdateNodegroupVersion(name, nodegroupName, args::AbstractDict{String, <:Any}) = eks("POST", "/clusters/$(name)/node-groups/$(nodegroupName)/update-version", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientRequestToken"=>string(uuid4())), args...)))
