...
function get_rate_based_statement_managed_keys(
    RuleName, Scope, WebACLId, WebACLName; aws_config::AbstractAWSConfig=current_aws_config()
)
    return wafv2(
...
function update_ipset(
    Addresses, Id, LockToken, Name, Scope; aws_config::AbstractAWSConfig=current_aws_config()
)
    return wafv2(
        "UpdateIPSet",
        Dict{String,Any}(
