...
"""
AddRoleToDBCluster(DBClusterIdentifier, RoleArn) = neptune("AddRoleToDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "RoleArn"=>RoleArn))
AddRoleToDBCluster(DBClusterIdentifier, RoleArn, args::AbstractDict{String, <: Any}) = neptune("AddRoleToDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "RoleArn"=>RoleArn, args...))
...
"""
AddSourceIdentifierToSubscription(SourceIdentifier, SubscriptionName) = neptune("AddSourceIdentifierToSubscription", Dict{String, Any}("SourceIdentifier"=>SourceIdentifier, "SubscriptionName"=>SubscriptionName))
AddSourceIdentifierToSubscription(SourceIdentifier, SubscriptionName, args::AbstractDict{String, <: Any}) = neptune("AddSourceIdentifierToSubscription", Dict{String, Any}("SourceIdentifier"=>SourceIdentifier, "SubscriptionName"=>SubscriptionName, args...))
...
"""
AddTagsToResource(ResourceName, Tag) = neptune("AddTagsToResource", Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag))
AddTagsToResource(ResourceName, Tag, args::AbstractDict{String, <: Any}) = neptune("AddTagsToResource", Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag, args...))
...
"""
ApplyPendingMaintenanceAction(ApplyAction, OptInType, ResourceIdentifier) = neptune("ApplyPendingMaintenanceAction", Dict{String, Any}("ApplyAction"=>ApplyAction, "OptInType"=>OptInType, "ResourceIdentifier"=>ResourceIdentifier))
ApplyPendingMaintenanceAction(ApplyAction, OptInType, ResourceIdentifier, args::AbstractDict{String, <: Any}) = neptune("ApplyPendingMaintenanceAction", Dict{String, Any}("ApplyAction"=>ApplyAction, "OptInType"=>OptInType, "ResourceIdentifier"=>ResourceIdentifier, args...))
...
CopyDBClusterParameterGroup(SourceDBClusterParameterGroupIdentifier, TargetDBClusterParameterGroupDescription, TargetDBClusterParameterGroupIdentifier, args::AbstractDict{String, <: Any}) = neptune("CopyDBClusterParameterGroup", Dict{String, Any}("SourceDBClusterParameterGroupIdentifier"=>SourceDBClusterParameterGroupIdentifier, "TargetDBClusterParameterGroupDescription"=>TargetDBClusterParameterGroupDescription, "TargetDBClusterParameterGroupIdentifier"=>TargetDBClusterParameterGroupIdentifier, args...))
...
"""
CopyDBClusterSnapshot(SourceDBClusterSnapshotIdentifier, TargetDBClusterSnapshotIdentifier) = neptune("CopyDBClusterSnapshot", Dict{String, Any}("SourceDBClusterSnapshotIdentifier"=>SourceDBClusterSnapshotIdentifier, "TargetDBClusterSnapshotIdentifier"=>TargetDBClusterSnapshotIdentifier))
CopyDBClusterSnapshot(SourceDBClusterSnapshotIdentifier, TargetDBClusterSnapshotIdentifier, args::AbstractDict{String, <: Any}) = neptune("CopyDBClusterSnapshot", Dict{String, Any}("SourceDBClusterSnapshotIdentifier"=>SourceDBClusterSnapshotIdentifier, "TargetDBClusterSnapshotIdentifier"=>TargetDBClusterSnapshotIdentifier, args...))
...
"""
CopyDBParameterGroup(SourceDBParameterGroupIdentifier, TargetDBParameterGroupDescription, TargetDBParameterGroupIdentifier) = neptune("CopyDBParameterGroup", Dict{String, Any}("SourceDBParameterGroupIdentifier"=>SourceDBParameterGroupIdentifier, "TargetDBParameterGroupDescription"=>TargetDBParameterGroupDescription, "TargetDBParameterGroupIdentifier"=>TargetDBParameterGroupIdentifier))
CopyDBParameterGroup(SourceDBParameterGroupIdentifier, TargetDBParameterGroupDescription, TargetDBParameterGroupIdentifier, args::AbstractDict{String, <: Any}) = neptune("CopyDBParameterGroup", Dict{String, Any}("SourceDBParameterGroupIdentifier"=>SourceDBParameterGroupIdentifier, "TargetDBParameterGroupDescription"=>TargetDBParameterGroupDescription, "TargetDBParameterGroupIdentifier"=>TargetDBParameterGroupIdentifier, args...))
...
"""
CreateDBCluster(DBClusterIdentifier, Engine) = neptune("CreateDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine))
CreateDBCluster(DBClusterIdentifier, Engine, args::AbstractDict{String, <: Any}) = neptune("CreateDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, args...))
...
"""
CreateDBClusterParameterGroup(DBClusterParameterGroupName, DBParameterGroupFamily, Description) = neptune("CreateDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "DBParameterGroupFamily"=>DBParameterGroupFamily, "Description"=>Description))
CreateDBClusterParameterGroup(DBClusterParameterGroupName, DBParameterGroupFamily, Description, args::AbstractDict{String, <: Any}) = neptune("CreateDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "DBParameterGroupFamily"=>DBParameterGroupFamily, "Description"=>Description, args...))
...
"""
CreateDBClusterSnapshot(DBClusterIdentifier, DBClusterSnapshotIdentifier) = neptune("CreateDBClusterSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier))
CreateDBClusterSnapshot(DBClusterIdentifier, DBClusterSnapshotIdentifier, args::AbstractDict{String, <: Any}) = neptune("CreateDBClusterSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier, args...))
...
"""
CreateDBInstance(DBInstanceClass, DBInstanceIdentifier, Engine) = neptune("CreateDBInstance", Dict{String, Any}("DBInstanceClass"=>DBInstanceClass, "DBInstanceIdentifier"=>DBInstanceIdentifier, "Engine"=>Engine))
CreateDBInstance(DBInstanceClass, DBInstanceIdentifier, Engine, args::AbstractDict{String, <: Any}) = neptune("CreateDBInstance", Dict{String, Any}("DBInstanceClass"=>DBInstanceClass, "DBInstanceIdentifier"=>DBInstanceIdentifier, "Engine"=>Engine, args...))
...
"""
CreateDBParameterGroup(DBParameterGroupFamily, DBParameterGroupName, Description) = neptune("CreateDBParameterGroup", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily, "DBParameterGroupName"=>DBParameterGroupName, "Description"=>Description))
CreateDBParameterGroup(DBParameterGroupFamily, DBParameterGroupName, Description, args::AbstractDict{String, <: Any}) = neptune("CreateDBParameterGroup", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily, "DBParameterGroupName"=>DBParameterGroupName, "Description"=>Description, args...))
...
"""
CreateDBSubnetGroup(DBSubnetGroupDescription, DBSubnetGroupName, SubnetIdentifier) = neptune("CreateDBSubnetGroup", Dict{String, Any}("DBSubnetGroupDescription"=>DBSubnetGroupDescription, "DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier))
CreateDBSubnetGroup(DBSubnetGroupDescription, DBSubnetGroupName, SubnetIdentifier, args::AbstractDict{String, <: Any}) = neptune("CreateDBSubnetGroup", Dict{String, Any}("DBSubnetGroupDescription"=>DBSubnetGroupDescription, "DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier, args...))
...
"""
CreateEventSubscription(SnsTopicArn, SubscriptionName) = neptune("CreateEventSubscription", Dict{String, Any}("SnsTopicArn"=>SnsTopicArn, "SubscriptionName"=>SubscriptionName))
CreateEventSubscription(SnsTopicArn, SubscriptionName, args::AbstractDict{String, <: Any}) = neptune("CreateEventSubscription", Dict{String, Any}("SnsTopicArn"=>SnsTopicArn, "SubscriptionName"=>SubscriptionName, args...))
...
"""
DeleteDBCluster(DBClusterIdentifier) = neptune("DeleteDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
DeleteDBCluster(DBClusterIdentifier, args::AbstractDict{String, <: Any}) = neptune("DeleteDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
"""
DeleteDBClusterParameterGroup(DBClusterParameterGroupName) = neptune("DeleteDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName))
DeleteDBClusterParameterGroup(DBClusterParameterGroupName, args::AbstractDict{String, <: Any}) = neptune("DeleteDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, args...))
...
"""
DeleteDBClusterSnapshot(DBClusterSnapshotIdentifier) = neptune("DeleteDBClusterSnapshot", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier))
DeleteDBClusterSnapshot(DBClusterSnapshotIdentifier, args::AbstractDict{String, <: Any}) = neptune("DeleteDBClusterSnapshot", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier, args...))
...
"""
DeleteDBInstance(DBInstanceIdentifier) = neptune("DeleteDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
DeleteDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <: Any}) = neptune("DeleteDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
"""
DeleteDBParameterGroup(DBParameterGroupName) = neptune("DeleteDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName))
DeleteDBParameterGroup(DBParameterGroupName, args::AbstractDict{String, <: Any}) = neptune("DeleteDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName, args...))
...
"""
DeleteDBSubnetGroup(DBSubnetGroupName) = neptune("DeleteDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName))
DeleteDBSubnetGroup(DBSubnetGroupName, args::AbstractDict{String, <: Any}) = neptune("DeleteDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName, args...))
...
"""
DeleteEventSubscription(SubscriptionName) = neptune("DeleteEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName))
DeleteEventSubscription(SubscriptionName, args::AbstractDict{String, <: Any}) = neptune("DeleteEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName, args...))
...
DescribeDBClusterParameterGroups(args::AbstractDict{String, <: Any}) = neptune("DescribeDBClusterParameterGroups", args)
...
"""
DescribeDBClusterParameters(DBClusterParameterGroupName) = neptune("DescribeDBClusterParameters", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName))
DescribeDBClusterParameters(DBClusterParameterGroupName, args::AbstractDict{String, <: Any}) = neptune("DescribeDBClusterParameters", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, args...))
...
"""
DescribeDBClusterSnapshotAttributes(DBClusterSnapshotIdentifier) = neptune("DescribeDBClusterSnapshotAttributes", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier))
DescribeDBClusterSnapshotAttributes(DBClusterSnapshotIdentifier, args::AbstractDict{String, <: Any}) = neptune("DescribeDBClusterSnapshotAttributes", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier, args...))
...
DescribeDBClusterSnapshots(args::AbstractDict{String, <: Any}) = neptune("DescribeDBClusterSnapshots", args)
...
DescribeDBClusters(args::AbstractDict{String, <: Any}) = neptune("DescribeDBClusters", args)
...
DescribeDBEngineVersions(args::AbstractDict{String, <: Any}) = neptune("DescribeDBEngineVersions", args)
...
DescribeDBInstances(args::AbstractDict{String, <: Any}) = neptune("DescribeDBInstances", args)
...
DescribeDBParameterGroups(args::AbstractDict{String, <: Any}) = neptune("DescribeDBParameterGroups", args)
...
"""
DescribeDBParameters(DBParameterGroupName) = neptune("DescribeDBParameters", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName))
DescribeDBParameters(DBParameterGroupName, args::AbstractDict{String, <: Any}) = neptune("DescribeDBParameters", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName, args...))
...
DescribeDBSubnetGroups(args::AbstractDict{String, <: Any}) = neptune("DescribeDBSubnetGroups", args)
...
MaxRecords =>  The maximum number of records to include in the response. If more records exist than the specified MaxRecords value, a pagination token called a marker is included in the response so that the remaining results can be retrieved. Default: 100 Constraints: Minimum 20, maximum 100.
"""
DescribeEngineDefaultClusterParameters(DBParameterGroupFamily) = neptune("DescribeEngineDefaultClusterParameters", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily))
DescribeEngineDefaultClusterParameters(DBParameterGroupFamily, args::AbstractDict{String, <: Any}) = neptune("DescribeEngineDefaultClusterParameters", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily, args...))
...
MaxRecords =>  The maximum number of records to include in the response. If more records exist than the specified MaxRecords value, a pagination token called a marker is included in the response so that the remaining results can be retrieved. Default: 100 Constraints: Minimum 20, maximum 100.
"""
DescribeEngineDefaultParameters(DBParameterGroupFamily) = neptune("DescribeEngineDefaultParameters", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily))
DescribeEngineDefaultParameters(DBParameterGroupFamily, args::AbstractDict{String, <: Any}) = neptune("DescribeEngineDefaultParameters", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily, args...))
...
DescribeEventCategories(args::AbstractDict{String, <: Any}) = neptune("DescribeEventCategories", args)
...
DescribeEventSubscriptions(args::AbstractDict{String, <: Any}) = neptune("DescribeEventSubscriptions", args)
...
DescribeEvents(args::AbstractDict{String, <: Any}) = neptune("DescribeEvents", args)
...
"""
DescribeOrderableDBInstanceOptions(Engine) = neptune("DescribeOrderableDBInstanceOptions", Dict{String, Any}("Engine"=>Engine))
DescribeOrderableDBInstanceOptions(Engine, args::AbstractDict{String, <: Any}) = neptune("DescribeOrderableDBInstanceOptions", Dict{String, Any}("Engine"=>Engine, args...))
...
DescribePendingMaintenanceActions(args::AbstractDict{String, <: Any}) = neptune("DescribePendingMaintenanceActions", args)
...
"""
DescribeValidDBInstanceModifications(DBInstanceIdentifier) = neptune("DescribeValidDBInstanceModifications", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
DescribeValidDBInstanceModifications(DBInstanceIdentifier, args::AbstractDict{String, <: Any}) = neptune("DescribeValidDBInstanceModifications", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
FailoverDBCluster(args::AbstractDict{String, <: Any}) = neptune("FailoverDBCluster", args)
...
Filters => This parameter is not currently supported.
"""
ListTagsForResource(ResourceName) = neptune("ListTagsForResource", Dict{String, Any}("ResourceName"=>ResourceName))
ListTagsForResource(ResourceName, args::AbstractDict{String, <: Any}) = neptune("ListTagsForResource", Dict{String, Any}("ResourceName"=>ResourceName, args...))
...
"""
ModifyDBCluster(DBClusterIdentifier) = neptune("ModifyDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
ModifyDBCluster(DBClusterIdentifier, args::AbstractDict{String, <: Any}) = neptune("ModifyDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
"""
ModifyDBClusterParameterGroup(DBClusterParameterGroupName, Parameter) = neptune("ModifyDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "Parameter"=>Parameter))
ModifyDBClusterParameterGroup(DBClusterParameterGroupName, Parameter, args::AbstractDict{String, <: Any}) = neptune("ModifyDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "Parameter"=>Parameter, args...))
...
"""
ModifyDBClusterSnapshotAttribute(AttributeName, DBClusterSnapshotIdentifier) = neptune("ModifyDBClusterSnapshotAttribute", Dict{String, Any}("AttributeName"=>AttributeName, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier))
ModifyDBClusterSnapshotAttribute(AttributeName, DBClusterSnapshotIdentifier, args::AbstractDict{String, <: Any}) = neptune("ModifyDBClusterSnapshotAttribute", Dict{String, Any}("AttributeName"=>AttributeName, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier, args...))
...
"""
ModifyDBInstance(DBInstanceIdentifier) = neptune("ModifyDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
ModifyDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <: Any}) = neptune("ModifyDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
"""
ModifyDBParameterGroup(DBParameterGroupName, Parameter) = neptune("ModifyDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName, "Parameter"=>Parameter))
ModifyDBParameterGroup(DBParameterGroupName, Parameter, args::AbstractDict{String, <: Any}) = neptune("ModifyDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName, "Parameter"=>Parameter, args...))
...
SubnetIds => The EC2 subnet IDs for the DB subnet group.
"""
ModifyDBSubnetGroup(DBSubnetGroupName, SubnetIdentifier) = neptune("ModifyDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier))
ModifyDBSubnetGroup(DBSubnetGroupName, SubnetIdentifier, args::AbstractDict{String, <: Any}) = neptune("ModifyDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier, args...))
...
"""
ModifyEventSubscription(SubscriptionName) = neptune("ModifyEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName))
ModifyEventSubscription(SubscriptionName, args::AbstractDict{String, <: Any}) = neptune("ModifyEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName, args...))
...
"""
PromoteReadReplicaDBCluster(DBClusterIdentifier) = neptune("PromoteReadReplicaDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
PromoteReadReplicaDBCluster(DBClusterIdentifier, args::AbstractDict{String, <: Any}) = neptune("PromoteReadReplicaDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
"""
RebootDBInstance(DBInstanceIdentifier) = neptune("RebootDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
RebootDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <: Any}) = neptune("RebootDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
"""
RemoveRoleFromDBCluster(DBClusterIdentifier, RoleArn) = neptune("RemoveRoleFromDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "RoleArn"=>RoleArn))
RemoveRoleFromDBCluster(DBClusterIdentifier, RoleArn, args::AbstractDict{String, <: Any}) = neptune("RemoveRoleFromDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "RoleArn"=>RoleArn, args...))
...
"""
RemoveSourceIdentifierFromSubscription(SourceIdentifier, SubscriptionName) = neptune("RemoveSourceIdentifierFromSubscription", Dict{String, Any}("SourceIdentifier"=>SourceIdentifier, "SubscriptionName"=>SubscriptionName))
RemoveSourceIdentifierFromSubscription(SourceIdentifier, SubscriptionName, args::AbstractDict{String, <: Any}) = neptune("RemoveSourceIdentifierFromSubscription", Dict{String, Any}("SourceIdentifier"=>SourceIdentifier, "SubscriptionName"=>SubscriptionName, args...))
...
"""
RemoveTagsFromResource(ResourceName, TagKeys) = neptune("RemoveTagsFromResource", Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys))
RemoveTagsFromResource(ResourceName, TagKeys, args::AbstractDict{String, <: Any}) = neptune("RemoveTagsFromResource", Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys, args...))
...
"""
ResetDBClusterParameterGroup(DBClusterParameterGroupName) = neptune("ResetDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName))
ResetDBClusterParameterGroup(DBClusterParameterGroupName, args::AbstractDict{String, <: Any}) = neptune("ResetDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, args...))
...
"""
ResetDBParameterGroup(DBParameterGroupName) = neptune("ResetDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName))
ResetDBParameterGroup(DBParameterGroupName, args::AbstractDict{String, <: Any}) = neptune("ResetDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName, args...))
...
"""
RestoreDBClusterFromSnapshot(DBClusterIdentifier, Engine, SnapshotIdentifier) = neptune("RestoreDBClusterFromSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "SnapshotIdentifier"=>SnapshotIdentifier))
RestoreDBClusterFromSnapshot(DBClusterIdentifier, Engine, SnapshotIdentifier, args::AbstractDict{String, <: Any}) = neptune("RestoreDBClusterFromSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "SnapshotIdentifier"=>SnapshotIdentifier, args...))
...
"""
RestoreDBClusterToPointInTime(DBClusterIdentifier, SourceDBClusterIdentifier) = neptune("RestoreDBClusterToPointInTime", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "SourceDBClusterIdentifier"=>SourceDBClusterIdentifier))
RestoreDBClusterToPointInTime(DBClusterIdentifier, SourceDBClusterIdentifier, args::AbstractDict{String, <: Any}) = neptune("RestoreDBClusterToPointInTime", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "SourceDBClusterIdentifier"=>SourceDBClusterIdentifier, args...))
...
"""
StartDBCluster(DBClusterIdentifier) = neptune("StartDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
StartDBCluster(DBClusterIdentifier, args::AbstractDict{String, <: Any}) = neptune("StartDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
"""
StopDBCluster(DBClusterIdentifier) = neptune("StopDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
StopDBCluster(DBClusterIdentifier, args::AbstractDict{String, <: Any}) = neptune("StopDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
