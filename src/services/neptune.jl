...
without failover for the new DB cluster parameter group and associated settings to take
effect.
...
!!! important
    ...
    Amazon Neptune console or the *DescribeDBParameters* command to verify that your DB
    parameter group has been created or modified.
...
function describe_dbcluster_endpoints(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptune(
        "DescribeDBClusterEndpoints"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
snapshot, or to make the manual DB cluster snapshot public or private, use the [`modify_dbcluster_snapshot_attribute`](@ref)
API action.
...
- `"SnapshotType"`: The type of DB cluster snapshots to be returned. You can specify one of
  ...
  - `automated` - Return all DB cluster snapshots that have been automatically taken by
    Amazon Neptune for my Amazon account.
...
function describe_dbcluster_snapshots(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptune(
        "DescribeDBClusterSnapshots"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_dbclusters(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptune("DescribeDBClusters"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_dbclusters(
    ...
    return neptune(
        "DescribeDBClusters", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_dbengine_versions(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptune("DescribeDBEngineVersions"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_dbinstances(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptune("DescribeDBInstances"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_dbinstances(
    ...
    return neptune(
        "DescribeDBInstances", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_dbparameter_groups(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptune("DescribeDBParameterGroups"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_dbsubnet_groups(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptune("DescribeDBSubnetGroups"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_event_categories(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptune("DescribeEventCategories"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_events(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptune("DescribeEvents"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function describe_events(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return neptune("DescribeEvents", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_global_clusters(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptune("DescribeGlobalClusters"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
You can call [`describe_valid_dbinstance_modifications`](@ref) to learn what modifications
you can make to your DB instance. You can use this information when you call [`modify_dbinstance`](@ref).
...
function failover_dbcluster(; aws_config::AbstractAWSConfig=current_aws_config())
    return neptune("FailoverDBCluster"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function failover_dbcluster(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return neptune("FailoverDBCluster", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"DBInstanceParameterGroupName"`: The name of the DB parameter group to apply to all
  ...
  - The DB parameter group must be in the same DB parameter group family as the target DB
    cluster version.
...
modifications you can make to your DB instance, call [`describe_valid_dbinstance_modifications`](@ref)
before you call [`modify_dbinstance`](@ref).
...
!!! important
    ...
    creating your first DB instance that uses that DB parameter group as the default
    parameter group. This allows Amazon Neptune to fully complete the modify action before
    the parameter group is used as the default for a new DB instance. This is especially
    important for parameters that are critical when creating the default database for a DB
    instance, such as the character set for the default database defined by the
    `character_set_database` parameter. You can use the *Parameter Groups* option of the
...
identifiers using this call; to change source identifiers for a subscription, use the [`add_source_identifier_to_subscription`](@ref)
and [`remove_source_identifier_from_subscription`](@ref) calls.
...
parameters are set to `pending-reboot` to take effect on the next DB instance restart or [`reboot_dbinstance`](@ref)
request. You must call [`reboot_dbinstance`](@ref) for every DB instance in your DB cluster
...
!!! note
    ...
    must invoke the [`create_dbinstance`](@ref) action to create DB instances for the
