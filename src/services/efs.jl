...
"""
CreateAccessPoint(ClientToken, FileSystemId; aws::AWSConfig=AWS.aws_config) = efs("POST", "/2015-02-01/access-points", Dict{String, Any}("ClientToken"=>ClientToken, "FileSystemId"=>FileSystemId); aws=aws)
CreateAccessPoint(ClientToken, FileSystemId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("POST", "/2015-02-01/access-points", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClientToken"=>ClientToken, "FileSystemId"=>FileSystemId), args)); aws=aws)
...
"""
CreateFileSystem(CreationToken; aws::AWSConfig=AWS.aws_config) = efs("POST", "/2015-02-01/file-systems", Dict{String, Any}("CreationToken"=>CreationToken); aws=aws)
CreateFileSystem(CreationToken, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("POST", "/2015-02-01/file-systems", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CreationToken"=>CreationToken), args)); aws=aws)
...
"""
CreateMountTarget(FileSystemId, SubnetId; aws::AWSConfig=AWS.aws_config) = efs("POST", "/2015-02-01/mount-targets", Dict{String, Any}("FileSystemId"=>FileSystemId, "SubnetId"=>SubnetId); aws=aws)
CreateMountTarget(FileSystemId, SubnetId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("POST", "/2015-02-01/mount-targets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FileSystemId"=>FileSystemId, "SubnetId"=>SubnetId), args)); aws=aws)
...
"""
CreateTags(FileSystemId, Tags; aws::AWSConfig=AWS.aws_config) = efs("POST", "/2015-02-01/create-tags/$(FileSystemId)", Dict{String, Any}("Tags"=>Tags); aws=aws)
CreateTags(FileSystemId, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("POST", "/2015-02-01/create-tags/$(FileSystemId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Tags"=>Tags), args)); aws=aws)
...
"""
DeleteAccessPoint(AccessPointId; aws::AWSConfig=AWS.aws_config) = efs("DELETE", "/2015-02-01/access-points/$(AccessPointId)"; aws=aws)
DeleteAccessPoint(AccessPointId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("DELETE", "/2015-02-01/access-points/$(AccessPointId)", args; aws=aws)
...
"""
DeleteFileSystem(FileSystemId; aws::AWSConfig=AWS.aws_config) = efs("DELETE", "/2015-02-01/file-systems/$(FileSystemId)"; aws=aws)
DeleteFileSystem(FileSystemId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("DELETE", "/2015-02-01/file-systems/$(FileSystemId)", args; aws=aws)
...
"""
DeleteFileSystemPolicy(FileSystemId; aws::AWSConfig=AWS.aws_config) = efs("DELETE", "/2015-02-01/file-systems/$(FileSystemId)/policy"; aws=aws)
DeleteFileSystemPolicy(FileSystemId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("DELETE", "/2015-02-01/file-systems/$(FileSystemId)/policy", args; aws=aws)
...
"""
DeleteMountTarget(MountTargetId; aws::AWSConfig=AWS.aws_config) = efs("DELETE", "/2015-02-01/mount-targets/$(MountTargetId)"; aws=aws)
DeleteMountTarget(MountTargetId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("DELETE", "/2015-02-01/mount-targets/$(MountTargetId)", args; aws=aws)
...
"""
DeleteTags(FileSystemId, TagKeys; aws::AWSConfig=AWS.aws_config) = efs("POST", "/2015-02-01/delete-tags/$(FileSystemId)", Dict{String, Any}("TagKeys"=>TagKeys); aws=aws)
DeleteTags(FileSystemId, TagKeys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("POST", "/2015-02-01/delete-tags/$(FileSystemId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TagKeys"=>TagKeys), args)); aws=aws)
...
"""
DescribeAccessPoints(; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/access-points"; aws=aws)
DescribeAccessPoints(args::AbstractDict{String, Any}; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/access-points", args; aws=aws)
...
"""
DescribeBackupPolicy(FileSystemId; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/file-systems/$(FileSystemId)/backup-policy"; aws=aws)
DescribeBackupPolicy(FileSystemId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/file-systems/$(FileSystemId)/backup-policy", args; aws=aws)
...
"""
DescribeFileSystemPolicy(FileSystemId; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/file-systems/$(FileSystemId)/policy"; aws=aws)
DescribeFileSystemPolicy(FileSystemId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/file-systems/$(FileSystemId)/policy", args; aws=aws)
...
"""
DescribeFileSystems(; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/file-systems"; aws=aws)
DescribeFileSystems(args::AbstractDict{String, Any}; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/file-systems", args; aws=aws)
...
"""
DescribeLifecycleConfiguration(FileSystemId; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/file-systems/$(FileSystemId)/lifecycle-configuration"; aws=aws)
DescribeLifecycleConfiguration(FileSystemId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/file-systems/$(FileSystemId)/lifecycle-configuration", args; aws=aws)
...
"""
DescribeMountTargetSecurityGroups(MountTargetId; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/mount-targets/$(MountTargetId)/security-groups"; aws=aws)
DescribeMountTargetSecurityGroups(MountTargetId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/mount-targets/$(MountTargetId)/security-groups", args; aws=aws)
...
"""
DescribeMountTargets(; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/mount-targets"; aws=aws)
DescribeMountTargets(args::AbstractDict{String, Any}; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/mount-targets", args; aws=aws)
...
"""
DescribeTags(FileSystemId; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/tags/$(FileSystemId)/"; aws=aws)
DescribeTags(FileSystemId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/tags/$(FileSystemId)/", args; aws=aws)
...
"""
ListTagsForResource(ResourceId; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/resource-tags/$(ResourceId)"; aws=aws)
ListTagsForResource(ResourceId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("GET", "/2015-02-01/resource-tags/$(ResourceId)", args; aws=aws)
...
"""
ModifyMountTargetSecurityGroups(MountTargetId; aws::AWSConfig=AWS.aws_config) = efs("PUT", "/2015-02-01/mount-targets/$(MountTargetId)/security-groups"; aws=aws)
ModifyMountTargetSecurityGroups(MountTargetId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("PUT", "/2015-02-01/mount-targets/$(MountTargetId)/security-groups", args; aws=aws)
...
"""
PutBackupPolicy(BackupPolicy, FileSystemId; aws::AWSConfig=AWS.aws_config) = efs("PUT", "/2015-02-01/file-systems/$(FileSystemId)/backup-policy", Dict{String, Any}("BackupPolicy"=>BackupPolicy); aws=aws)
PutBackupPolicy(BackupPolicy, FileSystemId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("PUT", "/2015-02-01/file-systems/$(FileSystemId)/backup-policy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BackupPolicy"=>BackupPolicy), args)); aws=aws)
...
"""
PutFileSystemPolicy(FileSystemId, Policy; aws::AWSConfig=AWS.aws_config) = efs("PUT", "/2015-02-01/file-systems/$(FileSystemId)/policy", Dict{String, Any}("Policy"=>Policy); aws=aws)
PutFileSystemPolicy(FileSystemId, Policy, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("PUT", "/2015-02-01/file-systems/$(FileSystemId)/policy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Policy"=>Policy), args)); aws=aws)
...
"""
PutLifecycleConfiguration(FileSystemId, LifecyclePolicies; aws::AWSConfig=AWS.aws_config) = efs("PUT", "/2015-02-01/file-systems/$(FileSystemId)/lifecycle-configuration", Dict{String, Any}("LifecyclePolicies"=>LifecyclePolicies); aws=aws)
PutLifecycleConfiguration(FileSystemId, LifecyclePolicies, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("PUT", "/2015-02-01/file-systems/$(FileSystemId)/lifecycle-configuration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LifecyclePolicies"=>LifecyclePolicies), args)); aws=aws)
...
"""
TagResource(ResourceId, Tags; aws::AWSConfig=AWS.aws_config) = efs("POST", "/2015-02-01/resource-tags/$(ResourceId)", Dict{String, Any}("Tags"=>Tags); aws=aws)
TagResource(ResourceId, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("POST", "/2015-02-01/resource-tags/$(ResourceId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Tags"=>Tags), args)); aws=aws)
...
"""
UntagResource(ResourceId, tagKeys; aws::AWSConfig=AWS.aws_config) = efs("DELETE", "/2015-02-01/resource-tags/$(ResourceId)", Dict{String, Any}("tagKeys"=>tagKeys); aws=aws)
UntagResource(ResourceId, tagKeys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("DELETE", "/2015-02-01/resource-tags/$(ResourceId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("tagKeys"=>tagKeys), args)); aws=aws)
...
"""
UpdateFileSystem(FileSystemId; aws::AWSConfig=AWS.aws_config) = efs("PUT", "/2015-02-01/file-systems/$(FileSystemId)"; aws=aws)
UpdateFileSystem(FileSystemId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = efs("PUT", "/2015-02-01/file-systems/$(FileSystemId)", args; aws=aws)
