...
"""
function cancel_zonal_shift(zonalShiftId; aws_config::AbstractAWSConfig=current_aws_config())
...
"""
function update_zonal_shift(zonalShiftId; aws_config::AbstractAWSConfig=current_aws_config())
    return arc_zonal_shift(
        "PATCH",
        "/zonalshifts/$(zonalShiftId)";
        aws_config=aws_config,
