...
"""
function delete_rule(ChangeToken, RuleId; aws_config::AbstractAWSConfig=current_aws_config())
    return waf_regional(
        "DeleteRule",
        Dict{String,Any}("ChangeToken" => ChangeToken, "RuleId" => RuleId);
        aws_config=aws_config,
...
"""
function get_geo_match_set(GeoMatchSetId; aws_config::AbstractAWSConfig=current_aws_config())
    return waf_regional(
        "GetGeoMatchSet",
...
function get_ipset(
    IPSetId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return waf_regional(
        "GetIPSet",
...
"""
function get_xss_match_set(XssMatchSetId; aws_config::AbstractAWSConfig=current_aws_config())
    return waf_regional(
        "GetXssMatchSet",
