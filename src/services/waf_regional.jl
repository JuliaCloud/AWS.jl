...
"""
AssociateWebACL(ResourceArn, WebACLId) = waf_regional("AssociateWebACL", Dict{String, Any}("ResourceArn"=>ResourceArn, "WebACLId"=>WebACLId))
AssociateWebACL(ResourceArn, WebACLId, args::AbstractDict{String, <: Any}) = waf_regional("AssociateWebACL", Dict{String, Any}("ResourceArn"=>ResourceArn, "WebACLId"=>WebACLId, args...))
...
"""
CreateByteMatchSet(ChangeToken, Name) = waf_regional("CreateByteMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name))
CreateByteMatchSet(ChangeToken, Name, args::AbstractDict{String, <: Any}) = waf_regional("CreateByteMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name, args...))
...
"""
CreateGeoMatchSet(ChangeToken, Name) = waf_regional("CreateGeoMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name))
CreateGeoMatchSet(ChangeToken, Name, args::AbstractDict{String, <: Any}) = waf_regional("CreateGeoMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name, args...))
...
"""
CreateIPSet(ChangeToken, Name) = waf_regional("CreateIPSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name))
CreateIPSet(ChangeToken, Name, args::AbstractDict{String, <: Any}) = waf_regional("CreateIPSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name, args...))
...
Tags => 
"""
CreateRateBasedRule(ChangeToken, MetricName, Name, RateKey, RateLimit) = waf_regional("CreateRateBasedRule", Dict{String, Any}("ChangeToken"=>ChangeToken, "MetricName"=>MetricName, "Name"=>Name, "RateKey"=>RateKey, "RateLimit"=>RateLimit))
CreateRateBasedRule(ChangeToken, MetricName, Name, RateKey, RateLimit, args::AbstractDict{String, <: Any}) = waf_regional("CreateRateBasedRule", Dict{String, Any}("ChangeToken"=>ChangeToken, "MetricName"=>MetricName, "Name"=>Name, "RateKey"=>RateKey, "RateLimit"=>RateLimit, args...))
...
"""
CreateRegexMatchSet(ChangeToken, Name) = waf_regional("CreateRegexMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name))
CreateRegexMatchSet(ChangeToken, Name, args::AbstractDict{String, <: Any}) = waf_regional("CreateRegexMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name, args...))
...
"""
CreateRegexPatternSet(ChangeToken, Name) = waf_regional("CreateRegexPatternSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name))
CreateRegexPatternSet(ChangeToken, Name, args::AbstractDict{String, <: Any}) = waf_regional("CreateRegexPatternSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name, args...))
...
Tags => 
"""
CreateRule(ChangeToken, MetricName, Name) = waf_regional("CreateRule", Dict{String, Any}("ChangeToken"=>ChangeToken, "MetricName"=>MetricName, "Name"=>Name))
CreateRule(ChangeToken, MetricName, Name, args::AbstractDict{String, <: Any}) = waf_regional("CreateRule", Dict{String, Any}("ChangeToken"=>ChangeToken, "MetricName"=>MetricName, "Name"=>Name, args...))
...
Tags => 
"""
CreateRuleGroup(ChangeToken, MetricName, Name) = waf_regional("CreateRuleGroup", Dict{String, Any}("ChangeToken"=>ChangeToken, "MetricName"=>MetricName, "Name"=>Name))
CreateRuleGroup(ChangeToken, MetricName, Name, args::AbstractDict{String, <: Any}) = waf_regional("CreateRuleGroup", Dict{String, Any}("ChangeToken"=>ChangeToken, "MetricName"=>MetricName, "Name"=>Name, args...))
...
"""
CreateSizeConstraintSet(ChangeToken, Name) = waf_regional("CreateSizeConstraintSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name))
CreateSizeConstraintSet(ChangeToken, Name, args::AbstractDict{String, <: Any}) = waf_regional("CreateSizeConstraintSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name, args...))
...
"""
CreateSqlInjectionMatchSet(ChangeToken, Name) = waf_regional("CreateSqlInjectionMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name))
CreateSqlInjectionMatchSet(ChangeToken, Name, args::AbstractDict{String, <: Any}) = waf_regional("CreateSqlInjectionMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name, args...))
...
Tags => 
"""
CreateWebACL(ChangeToken, DefaultAction, MetricName, Name) = waf_regional("CreateWebACL", Dict{String, Any}("ChangeToken"=>ChangeToken, "DefaultAction"=>DefaultAction, "MetricName"=>MetricName, "Name"=>Name))
CreateWebACL(ChangeToken, DefaultAction, MetricName, Name, args::AbstractDict{String, <: Any}) = waf_regional("CreateWebACL", Dict{String, Any}("ChangeToken"=>ChangeToken, "DefaultAction"=>DefaultAction, "MetricName"=>MetricName, "Name"=>Name, args...))
...
"""
CreateWebACLMigrationStack(IgnoreUnsupportedType, S3BucketName, WebACLId) = waf_regional("CreateWebACLMigrationStack", Dict{String, Any}("IgnoreUnsupportedType"=>IgnoreUnsupportedType, "S3BucketName"=>S3BucketName, "WebACLId"=>WebACLId))
CreateWebACLMigrationStack(IgnoreUnsupportedType, S3BucketName, WebACLId, args::AbstractDict{String, <: Any}) = waf_regional("CreateWebACLMigrationStack", Dict{String, Any}("IgnoreUnsupportedType"=>IgnoreUnsupportedType, "S3BucketName"=>S3BucketName, "WebACLId"=>WebACLId, args...))
...
"""
CreateXssMatchSet(ChangeToken, Name) = waf_regional("CreateXssMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name))
CreateXssMatchSet(ChangeToken, Name, args::AbstractDict{String, <: Any}) = waf_regional("CreateXssMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Name"=>Name, args...))
...
"""
DeleteByteMatchSet(ByteMatchSetId, ChangeToken) = waf_regional("DeleteByteMatchSet", Dict{String, Any}("ByteMatchSetId"=>ByteMatchSetId, "ChangeToken"=>ChangeToken))
DeleteByteMatchSet(ByteMatchSetId, ChangeToken, args::AbstractDict{String, <: Any}) = waf_regional("DeleteByteMatchSet", Dict{String, Any}("ByteMatchSetId"=>ByteMatchSetId, "ChangeToken"=>ChangeToken, args...))
...
"""
DeleteGeoMatchSet(ChangeToken, GeoMatchSetId) = waf_regional("DeleteGeoMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "GeoMatchSetId"=>GeoMatchSetId))
DeleteGeoMatchSet(ChangeToken, GeoMatchSetId, args::AbstractDict{String, <: Any}) = waf_regional("DeleteGeoMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "GeoMatchSetId"=>GeoMatchSetId, args...))
...
"""
DeleteIPSet(ChangeToken, IPSetId) = waf_regional("DeleteIPSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "IPSetId"=>IPSetId))
DeleteIPSet(ChangeToken, IPSetId, args::AbstractDict{String, <: Any}) = waf_regional("DeleteIPSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "IPSetId"=>IPSetId, args...))
...
"""
DeleteLoggingConfiguration(ResourceArn) = waf_regional("DeleteLoggingConfiguration", Dict{String, Any}("ResourceArn"=>ResourceArn))
DeleteLoggingConfiguration(ResourceArn, args::AbstractDict{String, <: Any}) = waf_regional("DeleteLoggingConfiguration", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
DeletePermissionPolicy(ResourceArn) = waf_regional("DeletePermissionPolicy", Dict{String, Any}("ResourceArn"=>ResourceArn))
DeletePermissionPolicy(ResourceArn, args::AbstractDict{String, <: Any}) = waf_regional("DeletePermissionPolicy", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
DeleteRateBasedRule(ChangeToken, RuleId) = waf_regional("DeleteRateBasedRule", Dict{String, Any}("ChangeToken"=>ChangeToken, "RuleId"=>RuleId))
DeleteRateBasedRule(ChangeToken, RuleId, args::AbstractDict{String, <: Any}) = waf_regional("DeleteRateBasedRule", Dict{String, Any}("ChangeToken"=>ChangeToken, "RuleId"=>RuleId, args...))
...
"""
DeleteRegexMatchSet(ChangeToken, RegexMatchSetId) = waf_regional("DeleteRegexMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "RegexMatchSetId"=>RegexMatchSetId))
DeleteRegexMatchSet(ChangeToken, RegexMatchSetId, args::AbstractDict{String, <: Any}) = waf_regional("DeleteRegexMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "RegexMatchSetId"=>RegexMatchSetId, args...))
...
"""
DeleteRegexPatternSet(ChangeToken, RegexPatternSetId) = waf_regional("DeleteRegexPatternSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "RegexPatternSetId"=>RegexPatternSetId))
DeleteRegexPatternSet(ChangeToken, RegexPatternSetId, args::AbstractDict{String, <: Any}) = waf_regional("DeleteRegexPatternSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "RegexPatternSetId"=>RegexPatternSetId, args...))
...
"""
DeleteRule(ChangeToken, RuleId) = waf_regional("DeleteRule", Dict{String, Any}("ChangeToken"=>ChangeToken, "RuleId"=>RuleId))
DeleteRule(ChangeToken, RuleId, args::AbstractDict{String, <: Any}) = waf_regional("DeleteRule", Dict{String, Any}("ChangeToken"=>ChangeToken, "RuleId"=>RuleId, args...))
...
"""
DeleteRuleGroup(ChangeToken, RuleGroupId) = waf_regional("DeleteRuleGroup", Dict{String, Any}("ChangeToken"=>ChangeToken, "RuleGroupId"=>RuleGroupId))
DeleteRuleGroup(ChangeToken, RuleGroupId, args::AbstractDict{String, <: Any}) = waf_regional("DeleteRuleGroup", Dict{String, Any}("ChangeToken"=>ChangeToken, "RuleGroupId"=>RuleGroupId, args...))
...
"""
DeleteSizeConstraintSet(ChangeToken, SizeConstraintSetId) = waf_regional("DeleteSizeConstraintSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "SizeConstraintSetId"=>SizeConstraintSetId))
DeleteSizeConstraintSet(ChangeToken, SizeConstraintSetId, args::AbstractDict{String, <: Any}) = waf_regional("DeleteSizeConstraintSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "SizeConstraintSetId"=>SizeConstraintSetId, args...))
...
"""
DeleteSqlInjectionMatchSet(ChangeToken, SqlInjectionMatchSetId) = waf_regional("DeleteSqlInjectionMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "SqlInjectionMatchSetId"=>SqlInjectionMatchSetId))
DeleteSqlInjectionMatchSet(ChangeToken, SqlInjectionMatchSetId, args::AbstractDict{String, <: Any}) = waf_regional("DeleteSqlInjectionMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "SqlInjectionMatchSetId"=>SqlInjectionMatchSetId, args...))
...
"""
DeleteWebACL(ChangeToken, WebACLId) = waf_regional("DeleteWebACL", Dict{String, Any}("ChangeToken"=>ChangeToken, "WebACLId"=>WebACLId))
DeleteWebACL(ChangeToken, WebACLId, args::AbstractDict{String, <: Any}) = waf_regional("DeleteWebACL", Dict{String, Any}("ChangeToken"=>ChangeToken, "WebACLId"=>WebACLId, args...))
...
"""
DeleteXssMatchSet(ChangeToken, XssMatchSetId) = waf_regional("DeleteXssMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "XssMatchSetId"=>XssMatchSetId))
DeleteXssMatchSet(ChangeToken, XssMatchSetId, args::AbstractDict{String, <: Any}) = waf_regional("DeleteXssMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "XssMatchSetId"=>XssMatchSetId, args...))
...
"""
DisassociateWebACL(ResourceArn) = waf_regional("DisassociateWebACL", Dict{String, Any}("ResourceArn"=>ResourceArn))
DisassociateWebACL(ResourceArn, args::AbstractDict{String, <: Any}) = waf_regional("DisassociateWebACL", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
GetByteMatchSet(ByteMatchSetId) = waf_regional("GetByteMatchSet", Dict{String, Any}("ByteMatchSetId"=>ByteMatchSetId))
GetByteMatchSet(ByteMatchSetId, args::AbstractDict{String, <: Any}) = waf_regional("GetByteMatchSet", Dict{String, Any}("ByteMatchSetId"=>ByteMatchSetId, args...))
...
GetChangeToken(args::AbstractDict{String, <: Any}) = waf_regional("GetChangeToken", args)
...
"""
GetChangeTokenStatus(ChangeToken) = waf_regional("GetChangeTokenStatus", Dict{String, Any}("ChangeToken"=>ChangeToken))
GetChangeTokenStatus(ChangeToken, args::AbstractDict{String, <: Any}) = waf_regional("GetChangeTokenStatus", Dict{String, Any}("ChangeToken"=>ChangeToken, args...))
...
"""
GetGeoMatchSet(GeoMatchSetId) = waf_regional("GetGeoMatchSet", Dict{String, Any}("GeoMatchSetId"=>GeoMatchSetId))
GetGeoMatchSet(GeoMatchSetId, args::AbstractDict{String, <: Any}) = waf_regional("GetGeoMatchSet", Dict{String, Any}("GeoMatchSetId"=>GeoMatchSetId, args...))
...
"""
GetIPSet(IPSetId) = waf_regional("GetIPSet", Dict{String, Any}("IPSetId"=>IPSetId))
GetIPSet(IPSetId, args::AbstractDict{String, <: Any}) = waf_regional("GetIPSet", Dict{String, Any}("IPSetId"=>IPSetId, args...))
...
"""
GetLoggingConfiguration(ResourceArn) = waf_regional("GetLoggingConfiguration", Dict{String, Any}("ResourceArn"=>ResourceArn))
GetLoggingConfiguration(ResourceArn, args::AbstractDict{String, <: Any}) = waf_regional("GetLoggingConfiguration", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
GetPermissionPolicy(ResourceArn) = waf_regional("GetPermissionPolicy", Dict{String, Any}("ResourceArn"=>ResourceArn))
GetPermissionPolicy(ResourceArn, args::AbstractDict{String, <: Any}) = waf_regional("GetPermissionPolicy", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
GetRateBasedRule(RuleId) = waf_regional("GetRateBasedRule", Dict{String, Any}("RuleId"=>RuleId))
GetRateBasedRule(RuleId, args::AbstractDict{String, <: Any}) = waf_regional("GetRateBasedRule", Dict{String, Any}("RuleId"=>RuleId, args...))
...
"""
GetRateBasedRuleManagedKeys(RuleId) = waf_regional("GetRateBasedRuleManagedKeys", Dict{String, Any}("RuleId"=>RuleId))
GetRateBasedRuleManagedKeys(RuleId, args::AbstractDict{String, <: Any}) = waf_regional("GetRateBasedRuleManagedKeys", Dict{String, Any}("RuleId"=>RuleId, args...))
...
"""
GetRegexMatchSet(RegexMatchSetId) = waf_regional("GetRegexMatchSet", Dict{String, Any}("RegexMatchSetId"=>RegexMatchSetId))
GetRegexMatchSet(RegexMatchSetId, args::AbstractDict{String, <: Any}) = waf_regional("GetRegexMatchSet", Dict{String, Any}("RegexMatchSetId"=>RegexMatchSetId, args...))
...
"""
GetRegexPatternSet(RegexPatternSetId) = waf_regional("GetRegexPatternSet", Dict{String, Any}("RegexPatternSetId"=>RegexPatternSetId))
GetRegexPatternSet(RegexPatternSetId, args::AbstractDict{String, <: Any}) = waf_regional("GetRegexPatternSet", Dict{String, Any}("RegexPatternSetId"=>RegexPatternSetId, args...))
...
"""
GetRule(RuleId) = waf_regional("GetRule", Dict{String, Any}("RuleId"=>RuleId))
GetRule(RuleId, args::AbstractDict{String, <: Any}) = waf_regional("GetRule", Dict{String, Any}("RuleId"=>RuleId, args...))
...
"""
GetRuleGroup(RuleGroupId) = waf_regional("GetRuleGroup", Dict{String, Any}("RuleGroupId"=>RuleGroupId))
GetRuleGroup(RuleGroupId, args::AbstractDict{String, <: Any}) = waf_regional("GetRuleGroup", Dict{String, Any}("RuleGroupId"=>RuleGroupId, args...))
...
"""
GetSampledRequests(MaxItems, RuleId, TimeWindow, WebAclId) = waf_regional("GetSampledRequests", Dict{String, Any}("MaxItems"=>MaxItems, "RuleId"=>RuleId, "TimeWindow"=>TimeWindow, "WebAclId"=>WebAclId))
GetSampledRequests(MaxItems, RuleId, TimeWindow, WebAclId, args::AbstractDict{String, <: Any}) = waf_regional("GetSampledRequests", Dict{String, Any}("MaxItems"=>MaxItems, "RuleId"=>RuleId, "TimeWindow"=>TimeWindow, "WebAclId"=>WebAclId, args...))
...
"""
GetSizeConstraintSet(SizeConstraintSetId) = waf_regional("GetSizeConstraintSet", Dict{String, Any}("SizeConstraintSetId"=>SizeConstraintSetId))
GetSizeConstraintSet(SizeConstraintSetId, args::AbstractDict{String, <: Any}) = waf_regional("GetSizeConstraintSet", Dict{String, Any}("SizeConstraintSetId"=>SizeConstraintSetId, args...))
...
"""
GetSqlInjectionMatchSet(SqlInjectionMatchSetId) = waf_regional("GetSqlInjectionMatchSet", Dict{String, Any}("SqlInjectionMatchSetId"=>SqlInjectionMatchSetId))
GetSqlInjectionMatchSet(SqlInjectionMatchSetId, args::AbstractDict{String, <: Any}) = waf_regional("GetSqlInjectionMatchSet", Dict{String, Any}("SqlInjectionMatchSetId"=>SqlInjectionMatchSetId, args...))
...
"""
GetWebACL(WebACLId) = waf_regional("GetWebACL", Dict{String, Any}("WebACLId"=>WebACLId))
GetWebACL(WebACLId, args::AbstractDict{String, <: Any}) = waf_regional("GetWebACL", Dict{String, Any}("WebACLId"=>WebACLId, args...))
...
"""
GetWebACLForResource(ResourceArn) = waf_regional("GetWebACLForResource", Dict{String, Any}("ResourceArn"=>ResourceArn))
GetWebACLForResource(ResourceArn, args::AbstractDict{String, <: Any}) = waf_regional("GetWebACLForResource", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
GetXssMatchSet(XssMatchSetId) = waf_regional("GetXssMatchSet", Dict{String, Any}("XssMatchSetId"=>XssMatchSetId))
GetXssMatchSet(XssMatchSetId, args::AbstractDict{String, <: Any}) = waf_regional("GetXssMatchSet", Dict{String, Any}("XssMatchSetId"=>XssMatchSetId, args...))
...
ListActivatedRulesInRuleGroup(args::AbstractDict{String, <: Any}) = waf_regional("ListActivatedRulesInRuleGroup", args)
...
ListByteMatchSets(args::AbstractDict{String, <: Any}) = waf_regional("ListByteMatchSets", args)
...
ListGeoMatchSets(args::AbstractDict{String, <: Any}) = waf_regional("ListGeoMatchSets", args)
...
ListIPSets(args::AbstractDict{String, <: Any}) = waf_regional("ListIPSets", args)
...
ListLoggingConfigurations(args::AbstractDict{String, <: Any}) = waf_regional("ListLoggingConfigurations", args)
...
ListRateBasedRules(args::AbstractDict{String, <: Any}) = waf_regional("ListRateBasedRules", args)
...
ListRegexMatchSets(args::AbstractDict{String, <: Any}) = waf_regional("ListRegexMatchSets", args)
...
ListRegexPatternSets(args::AbstractDict{String, <: Any}) = waf_regional("ListRegexPatternSets", args)
...
"""
ListResourcesForWebACL(WebACLId) = waf_regional("ListResourcesForWebACL", Dict{String, Any}("WebACLId"=>WebACLId))
ListResourcesForWebACL(WebACLId, args::AbstractDict{String, <: Any}) = waf_regional("ListResourcesForWebACL", Dict{String, Any}("WebACLId"=>WebACLId, args...))
...
ListRuleGroups(args::AbstractDict{String, <: Any}) = waf_regional("ListRuleGroups", args)
...
ListRules(args::AbstractDict{String, <: Any}) = waf_regional("ListRules", args)
...
ListSizeConstraintSets(args::AbstractDict{String, <: Any}) = waf_regional("ListSizeConstraintSets", args)
...
ListSqlInjectionMatchSets(args::AbstractDict{String, <: Any}) = waf_regional("ListSqlInjectionMatchSets", args)
...
ListSubscribedRuleGroups(args::AbstractDict{String, <: Any}) = waf_regional("ListSubscribedRuleGroups", args)
...
NextMarker => 
"""
ListTagsForResource(ResourceARN) = waf_regional("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN))
ListTagsForResource(ResourceARN, args::AbstractDict{String, <: Any}) = waf_regional("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN, args...))
...
ListWebACLs(args::AbstractDict{String, <: Any}) = waf_regional("ListWebACLs", args)
...
ListXssMatchSets(args::AbstractDict{String, <: Any}) = waf_regional("ListXssMatchSets", args)
...
"""
PutLoggingConfiguration(LoggingConfiguration) = waf_regional("PutLoggingConfiguration", Dict{String, Any}("LoggingConfiguration"=>LoggingConfiguration))
PutLoggingConfiguration(LoggingConfiguration, args::AbstractDict{String, <: Any}) = waf_regional("PutLoggingConfiguration", Dict{String, Any}("LoggingConfiguration"=>LoggingConfiguration, args...))
...
"""
PutPermissionPolicy(Policy, ResourceArn) = waf_regional("PutPermissionPolicy", Dict{String, Any}("Policy"=>Policy, "ResourceArn"=>ResourceArn))
PutPermissionPolicy(Policy, ResourceArn, args::AbstractDict{String, <: Any}) = waf_regional("PutPermissionPolicy", Dict{String, Any}("Policy"=>Policy, "ResourceArn"=>ResourceArn, args...))
...
"""
TagResource(ResourceARN, Tags) = waf_regional("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags))
TagResource(ResourceARN, Tags, args::AbstractDict{String, <: Any}) = waf_regional("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceARN, TagKeys) = waf_regional("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys))
UntagResource(ResourceARN, TagKeys, args::AbstractDict{String, <: Any}) = waf_regional("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys, args...))
...
"""
UpdateByteMatchSet(ByteMatchSetId, ChangeToken, Updates) = waf_regional("UpdateByteMatchSet", Dict{String, Any}("ByteMatchSetId"=>ByteMatchSetId, "ChangeToken"=>ChangeToken, "Updates"=>Updates))
UpdateByteMatchSet(ByteMatchSetId, ChangeToken, Updates, args::AbstractDict{String, <: Any}) = waf_regional("UpdateByteMatchSet", Dict{String, Any}("ByteMatchSetId"=>ByteMatchSetId, "ChangeToken"=>ChangeToken, "Updates"=>Updates, args...))
...
"""
UpdateGeoMatchSet(ChangeToken, GeoMatchSetId, Updates) = waf_regional("UpdateGeoMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "GeoMatchSetId"=>GeoMatchSetId, "Updates"=>Updates))
UpdateGeoMatchSet(ChangeToken, GeoMatchSetId, Updates, args::AbstractDict{String, <: Any}) = waf_regional("UpdateGeoMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "GeoMatchSetId"=>GeoMatchSetId, "Updates"=>Updates, args...))
...
"""
UpdateIPSet(ChangeToken, IPSetId, Updates) = waf_regional("UpdateIPSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "IPSetId"=>IPSetId, "Updates"=>Updates))
UpdateIPSet(ChangeToken, IPSetId, Updates, args::AbstractDict{String, <: Any}) = waf_regional("UpdateIPSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "IPSetId"=>IPSetId, "Updates"=>Updates, args...))
...
"""
UpdateRateBasedRule(ChangeToken, RateLimit, RuleId, Updates) = waf_regional("UpdateRateBasedRule", Dict{String, Any}("ChangeToken"=>ChangeToken, "RateLimit"=>RateLimit, "RuleId"=>RuleId, "Updates"=>Updates))
UpdateRateBasedRule(ChangeToken, RateLimit, RuleId, Updates, args::AbstractDict{String, <: Any}) = waf_regional("UpdateRateBasedRule", Dict{String, Any}("ChangeToken"=>ChangeToken, "RateLimit"=>RateLimit, "RuleId"=>RuleId, "Updates"=>Updates, args...))
...
"""
UpdateRegexMatchSet(ChangeToken, RegexMatchSetId, Updates) = waf_regional("UpdateRegexMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "RegexMatchSetId"=>RegexMatchSetId, "Updates"=>Updates))
UpdateRegexMatchSet(ChangeToken, RegexMatchSetId, Updates, args::AbstractDict{String, <: Any}) = waf_regional("UpdateRegexMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "RegexMatchSetId"=>RegexMatchSetId, "Updates"=>Updates, args...))
...
"""
UpdateRegexPatternSet(ChangeToken, RegexPatternSetId, Updates) = waf_regional("UpdateRegexPatternSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "RegexPatternSetId"=>RegexPatternSetId, "Updates"=>Updates))
UpdateRegexPatternSet(ChangeToken, RegexPatternSetId, Updates, args::AbstractDict{String, <: Any}) = waf_regional("UpdateRegexPatternSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "RegexPatternSetId"=>RegexPatternSetId, "Updates"=>Updates, args...))
...
"""
UpdateRule(ChangeToken, RuleId, Updates) = waf_regional("UpdateRule", Dict{String, Any}("ChangeToken"=>ChangeToken, "RuleId"=>RuleId, "Updates"=>Updates))
UpdateRule(ChangeToken, RuleId, Updates, args::AbstractDict{String, <: Any}) = waf_regional("UpdateRule", Dict{String, Any}("ChangeToken"=>ChangeToken, "RuleId"=>RuleId, "Updates"=>Updates, args...))
...
"""
UpdateRuleGroup(ChangeToken, RuleGroupId, Updates) = waf_regional("UpdateRuleGroup", Dict{String, Any}("ChangeToken"=>ChangeToken, "RuleGroupId"=>RuleGroupId, "Updates"=>Updates))
UpdateRuleGroup(ChangeToken, RuleGroupId, Updates, args::AbstractDict{String, <: Any}) = waf_regional("UpdateRuleGroup", Dict{String, Any}("ChangeToken"=>ChangeToken, "RuleGroupId"=>RuleGroupId, "Updates"=>Updates, args...))
...
"""
UpdateSizeConstraintSet(ChangeToken, SizeConstraintSetId, Updates) = waf_regional("UpdateSizeConstraintSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "SizeConstraintSetId"=>SizeConstraintSetId, "Updates"=>Updates))
UpdateSizeConstraintSet(ChangeToken, SizeConstraintSetId, Updates, args::AbstractDict{String, <: Any}) = waf_regional("UpdateSizeConstraintSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "SizeConstraintSetId"=>SizeConstraintSetId, "Updates"=>Updates, args...))
...
"""
UpdateSqlInjectionMatchSet(ChangeToken, SqlInjectionMatchSetId, Updates) = waf_regional("UpdateSqlInjectionMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "SqlInjectionMatchSetId"=>SqlInjectionMatchSetId, "Updates"=>Updates))
UpdateSqlInjectionMatchSet(ChangeToken, SqlInjectionMatchSetId, Updates, args::AbstractDict{String, <: Any}) = waf_regional("UpdateSqlInjectionMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "SqlInjectionMatchSetId"=>SqlInjectionMatchSetId, "Updates"=>Updates, args...))
...
"""
UpdateWebACL(ChangeToken, WebACLId) = waf_regional("UpdateWebACL", Dict{String, Any}("ChangeToken"=>ChangeToken, "WebACLId"=>WebACLId))
UpdateWebACL(ChangeToken, WebACLId, args::AbstractDict{String, <: Any}) = waf_regional("UpdateWebACL", Dict{String, Any}("ChangeToken"=>ChangeToken, "WebACLId"=>WebACLId, args...))
...
"""
UpdateXssMatchSet(ChangeToken, Updates, XssMatchSetId) = waf_regional("UpdateXssMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Updates"=>Updates, "XssMatchSetId"=>XssMatchSetId))
UpdateXssMatchSet(ChangeToken, Updates, XssMatchSetId, args::AbstractDict{String, <: Any}) = waf_regional("UpdateXssMatchSet", Dict{String, Any}("ChangeToken"=>ChangeToken, "Updates"=>Updates, "XssMatchSetId"=>XssMatchSetId, args...))
