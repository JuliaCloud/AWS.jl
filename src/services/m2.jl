...
- `"authSecretsManagerArn"`: The Amazon Web Services Secrets Manager containing user's
  credentials for authentication and authorization for Cancel Batch Job Execution operation.
"""
...
- `"clientToken"`: A client token is a unique, case-sensitive string of up to 128 ASCII
  characters with ASCII values of 33-126 inclusive. It's generated by the client to ensure
  idempotent operations, allowing for safe retries without unintended side effects.
...
"""
    create_data_set_export_task(application_id, export_config)
    create_data_set_export_task(application_id, export_config, params::Dict{String,<:Any})

Starts a data set export task for a specific application.

# Arguments

- `application_id`: The unique identifier of the application for which you want to export
  data sets.
- `export_config`: The data set export task configuration.
...
- `"clientToken"`: Unique, case-sensitive identifier you provide to ensure the idempotency
  of the request to create a data set export. The service generates the clientToken when the
...
- `"kmsKeyId"`: The identifier of a customer managed key.
"""
function create_data_set_export_task end

function create_data_set_export_task(
    applicationId, exportConfig; aws_config::AbstractAWSConfig=current_aws_config()
)
    return m2(
        "POST",
        "/applications/$(applicationId)/dataset-export-task",
        Dict{String,Any}("exportConfig" => exportConfig, "clientToken" => string(uuid4()));
        aws_config,
        feature_set=SERVICE_FEATURE_SET,
    )
end
    ...
    return m2(
        ...
        Dict{String,Any}(
            mergewith(
                _merge,
                Dict{String,Any}(
                    "exportConfig" => exportConfig, "clientToken" => string(uuid4())
                ),
                params,
            ),
        );
...
"""
    get_data_set_export_task(application_id, task_id)
    get_data_set_export_task(application_id, task_id, params::Dict{String,<:Any})

Gets the status of a data set import task initiated with the [`create_data_set_export_task`](@ref)
operation.

# Arguments

- `application_id`: The application identifier.
- `task_id`: The task identifier returned by the `CreateDataSetExportTask` operation.
"""
function get_data_set_export_task end

function get_data_set_export_task(
...
function get_environment(environmentId; aws_config::AbstractAWSConfig=current_aws_config())
    return m2(
        "GET", "/environments/$(environmentId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_signed_bluinsights_url(; aws_config::AbstractAWSConfig=current_aws_config())
    return m2("GET", "/signed-bi-url"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_signed_bluinsights_url(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return m2("GET", "/signed-bi-url", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_applications(; aws_config::AbstractAWSConfig=current_aws_config())
    return m2("GET", "/applications"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_applications(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return m2("GET", "/applications", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
Lists all the job steps for a JCL file to restart a batch job. This is only applicable for
...
- `"authSecretsManagerArn"`: The Amazon Web Services Secrets Manager containing user's
  credentials for authentication and authorization for List Batch Job Restart Points
  operation.
"""
...
"""
    list_data_set_export_history(application_id)
    list_data_set_export_history(application_id, params::Dict{String,<:Any})
...
- `"nextToken"`: A pagination token returned from a previous call to this operation. This
  ...
  parameter.
"""
function list_data_set_export_history end

function list_data_set_export_history(
    applicationId; aws_config::AbstractAWSConfig=current_aws_config()
)
    return m2(
        "GET",
...
function list_engine_versions(; aws_config::AbstractAWSConfig=current_aws_config())
    return m2("GET", "/engine-versions"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_engine_versions(
    ...
    return m2(
        "GET", "/engine-versions", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_environments(; aws_config::AbstractAWSConfig=current_aws_config())
    return m2("GET", "/environments"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_environments(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return m2("GET", "/environments", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_tags_for_resource(
    ...
    return m2("GET", "/tags/$(resourceArn)"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"authSecretsManagerArn"`: The Amazon Web Services Secrets Manager containing user's
  credentials for authentication and authorization for Start Batch Job execution operation.
