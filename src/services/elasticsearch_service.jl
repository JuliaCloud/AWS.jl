...
- `domain_endpoint_options`: Options to specify configuration that will be applied to the
  domain endpoint.
- `dry_run`:  This flag, when set to True, specifies whether the UpdateElasticsearchDomain
