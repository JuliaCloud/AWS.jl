...
- `PackageID`: Internal ID of the package that you want to associate with a domain. Use
...
# Required Parameters
- `DomainName`: The name of the domain that you want to stop the latest service software
  update on.
...
# Required Parameters
- `DomainName`: The name of the Elasticsearch domain that you are creating. Domain names
...
# Required Parameters
- `ConnectionAlias`: Specifies the connection alias that will be used by the customer for
  this connection.
- `DestinationDomainInfo`: Specifies the DomainInformation for the destination
...
# Required Parameters
- `PackageID`: Internal ID of the package that you want to delete. Use DescribePackages to
  find this value.
...
- `InstanceType`:  The instance type for an Elasticsearch cluster for which Elasticsearch
  Limits  are needed.
...
# Required Parameters
- `ElasticsearchVersion`: Version of Elasticsearch for which list of supported
...
- `ReservedElasticsearchInstanceOfferingId`: The ID of the reserved Elasticsearch instance
...
- `ARN`: Specifies the ARN for the Elasticsearch domain from which you want to delete the
  specified tags.
- `TagKeys`: Specifies the TagKey list which you want to remove from the Elasticsearch
  domain.
...
# Required Parameters
- `DomainName`: The name of the domain that you want to update to the latest service
  software.
...
# Optional Parameters
- `AccessPolicies`: IAM access policy as a JSON-formatted string.
- `AdvancedOptions`: Modifies the advanced option to allow references to indices in an HTTP
  request body. Must be false when configuring access to individual sub-resources. By
