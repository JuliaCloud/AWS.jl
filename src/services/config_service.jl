...
rule per request. After you delete the evaluation results, you can call the [`start_config_rules_evaluation`](@ref)
...
function describe_aggregation_authorizations(;
    ...
    return config_service(
        "DescribeAggregationAuthorizations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- The rule's Lambda function has returned `NOT_APPLICABLE` for all evaluation results. This
...
function describe_compliance_by_config_rule(;
    ...
    return config_service(
        "DescribeComplianceByConfigRule"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_compliance_by_resource(;
    ...
    return config_service(
        "DescribeComplianceByResource"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_compliance_by_resource(
    ...
    return config_service(
        "DescribeComplianceByResource", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_config_rule_evaluation_status(;
    ...
    return config_service(
        "DescribeConfigRuleEvaluationStatus"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_config_rules(; aws_config::AbstractAWSConfig=current_aws_config())
    return config_service(
        "DescribeConfigRules"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_config_rules(
    ...
    return config_service(
        "DescribeConfigRules", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_configuration_aggregators(;
    ...
    return config_service(
        "DescribeConfigurationAggregators"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_configuration_recorder_status(;
    ...
    return config_service(
        "DescribeConfigurationRecorderStatus"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_configuration_recorders(;
    ...
    return config_service(
        "DescribeConfigurationRecorders"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_conformance_pack_status(;
    ...
    return config_service(
        "DescribeConformancePackStatus"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_conformance_pack_status(
    ...
    return config_service(
        "DescribeConformancePackStatus", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_conformance_packs(; aws_config::AbstractAWSConfig=current_aws_config())
    return config_service(
        "DescribeConformancePacks"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_conformance_packs(
    ...
    return config_service(
        "DescribeConformancePacks", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_delivery_channel_status(;
    ...
    return config_service(
        "DescribeDeliveryChannelStatus"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_delivery_channel_status(
    ...
    return config_service(
        "DescribeDeliveryChannelStatus", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_delivery_channels(; aws_config::AbstractAWSConfig=current_aws_config())
    return config_service(
        "DescribeDeliveryChannels"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_delivery_channels(
    ...
    return config_service(
        "DescribeDeliveryChannels", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
!!! note
    ...
    and next token are not applicable if you specify organization Config rule names. It is
...
function describe_organization_config_rules(;
    ...
    return config_service(
        "DescribeOrganizationConfigRules"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_organization_conformance_packs(;
    ...
    return config_service(
        "DescribeOrganizationConformancePacks"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_pending_aggregation_requests(;
    ...
    return config_service(
        "DescribePendingAggregationRequests"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_retention_configurations(;
    ...
    return config_service(
        "DescribeRetentionConfigurations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_compliance_details_by_resource(;
    ...
    return config_service(
        "GetComplianceDetailsByResource"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_compliance_summary_by_config_rule(;
    ...
    return config_service(
        "GetComplianceSummaryByConfigRule"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_compliance_summary_by_resource_type(;
    ...
    return config_service(
        "GetComplianceSummaryByResourceType"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_custom_rule_policy(; aws_config::AbstractAWSConfig=current_aws_config())
    return config_service(
        "GetCustomRulePolicy"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_custom_rule_policy(
    ...
    return config_service(
        "GetCustomRulePolicy", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_discovered_resource_counts(;
    ...
    return config_service(
        "GetDiscoveredResourceCounts"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_discovered_resource_counts(
    ...
    return config_service(
        "GetDiscoveredResourceCounts", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_conformance_pack_compliance_scores(;
    ...
    return config_service(
        "ListConformancePackComplianceScores"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_resource_evaluations(; aws_config::AbstractAWSConfig=current_aws_config())
    return config_service(
        "ListResourceEvaluations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_resource_evaluations(
    ...
    return config_service(
        "ListResourceEvaluations", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_stored_queries(; aws_config::AbstractAWSConfig=current_aws_config())
    return config_service("ListStoredQueries"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_stored_queries(
    ...
    return config_service(
        "ListStoredQueries", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
!!! note
    ...
    `EnableAwsServiceAccess` API to enable integration between Config and Organizations. If
    the caller is a registered delegated administrator, Config calls
...
!!! note
    **Be aware of backward incompatible changes**
    ...
    to ensure the remediations can run.

    This API does not support adding remediation configurations for service-linked Config
    Rules such as Organization Config rules, the rules deployed by conformance packs, and
    rules deployed by Amazon Web Services Security Hub.
...
!!! note
    **Required fields**
    ...
    value is `AutomationAssumeRole` and you need to provide a value for
...
!!! note
    ...
    and do not specify the `MaxResults` or the `Limit` query parameters, the default page
    size is set to 500.

    If you run a non-aggregation query (i.e., not using `GROUP BY` or aggregate function;
    e.g., `SELECT * WHERE resourceType = 'AWS::IAM::Role'`) and do not specify the
    `MaxResults` or the `Limit` query parameters, the default page size is set to 25.
...
function start_config_rules_evaluation(; aws_config::AbstractAWSConfig=current_aws_config())
    return config_service(
        "StartConfigRulesEvaluation"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function start_config_rules_evaluation(
    ...
    return config_service(
        "StartConfigRulesEvaluation", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
!!! note
    ...
    in "*Amazon Web Services public extensions*" within the CloudFormation registry or with
    the following CLI commmand:
