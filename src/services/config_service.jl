...
"""
batch_get_resource_config(resourceKeys; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("BatchGetResourceConfig", Dict{String, Any}("resourceKeys"=>resourceKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_get_resource_config(resourceKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("BatchGetResourceConfig", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceKeys"=>resourceKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_config_rule(ConfigRuleName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteConfigRule", Dict{String, Any}("ConfigRuleName"=>ConfigRuleName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_config_rule(ConfigRuleName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteConfigRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigRuleName"=>ConfigRuleName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `configuration_aggregator_name`: The name of the configuration aggregator.
"""
delete_configuration_aggregator(ConfigurationAggregatorName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteConfigurationAggregator", Dict{String, Any}("ConfigurationAggregatorName"=>ConfigurationAggregatorName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_configuration_recorder(ConfigurationRecorderName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteConfigurationRecorder", Dict{String, Any}("ConfigurationRecorderName"=>ConfigurationRecorderName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_conformance_pack(ConformancePackName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteConformancePack", Dict{String, Any}("ConformancePackName"=>ConformancePackName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_conformance_pack(ConformancePackName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteConformancePack", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConformancePackName"=>ConformancePackName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_delivery_channel(DeliveryChannelName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteDeliveryChannel", Dict{String, Any}("DeliveryChannelName"=>DeliveryChannelName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_delivery_channel(DeliveryChannelName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteDeliveryChannel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeliveryChannelName"=>DeliveryChannelName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `config_rule_name`: The name of the Config rule for which you want to delete the
  evaluation results.
"""
delete_evaluation_results(ConfigRuleName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteEvaluationResults", Dict{String, Any}("ConfigRuleName"=>ConfigRuleName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_evaluation_results(ConfigRuleName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteEvaluationResults", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigRuleName"=>ConfigRuleName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `organization_config_rule_name`: The name of organization Config rule that you want to
  delete.
"""
delete_organization_config_rule(OrganizationConfigRuleName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteOrganizationConfigRule", Dict{String, Any}("OrganizationConfigRuleName"=>OrganizationConfigRuleName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `organization_conformance_pack_name`: The name of organization conformance pack that you
  want to delete.
"""
delete_organization_conformance_pack(OrganizationConformancePackName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteOrganizationConformancePack", Dict{String, Any}("OrganizationConformancePackName"=>OrganizationConformancePackName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_remediation_configuration(ConfigRuleName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteRemediationConfiguration", Dict{String, Any}("ConfigRuleName"=>ConfigRuleName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_remediation_configuration(ConfigRuleName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteRemediationConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigRuleName"=>ConfigRuleName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
action to a specific resource. Remediation exceptions blocks auto-remediation until the
...
"""
delete_remediation_exceptions(ConfigRuleName, ResourceKeys; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteRemediationExceptions", Dict{String, Any}("ConfigRuleName"=>ConfigRuleName, "ResourceKeys"=>ResourceKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_resource_config(ResourceId, ResourceType; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteResourceConfig", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_resource_config(ResourceId, ResourceType, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteResourceConfig", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_retention_configuration(RetentionConfigurationName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteRetentionConfiguration", Dict{String, Any}("RetentionConfigurationName"=>RetentionConfigurationName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_stored_query(QueryName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteStoredQuery", Dict{String, Any}("QueryName"=>QueryName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_stored_query(QueryName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeleteStoredQuery", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QueryName"=>QueryName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `delivery_channel_name`: The name of the delivery channel through which the snapshot is
  delivered.
"""
deliver_config_snapshot(deliveryChannelName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeliverConfigSnapshot", Dict{String, Any}("deliveryChannelName"=>deliveryChannelName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
deliver_config_snapshot(deliveryChannelName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DeliverConfigSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("deliveryChannelName"=>deliveryChannelName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
describe_aggregation_authorizations(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeAggregationAuthorizations"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_aggregation_authorizations(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeAggregationAuthorizations", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
This result might indicate one of the following conditions: - Config has never invoked an
...
`LastFailedInvocationTime`.
 - The rule's Lambda function is failing to send evaluation results to Config. Verify that
...
the `config:PutEvaluations` permission.
 - The rule's Lambda function has returned `NOT_APPLICABLE` for all evaluation results.
...
- `"NextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
describe_compliance_by_config_rule(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeComplianceByConfigRule"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_compliance_by_config_rule(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeComplianceByConfigRule", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
rules that evaluate the resource: - Config has never invoked an evaluation for the rule. To
check whether it has, use the `DescribeConfigRuleEvaluationStatus` action to get the
...
- `"ResourceType"`: The types of Amazon Web Services resources for which you want
  ...
  `AWS::::Account`.
"""
describe_compliance_by_resource(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeComplianceByResource"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_compliance_by_resource(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeComplianceByResource", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
describe_config_rule_evaluation_status(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConfigRuleEvaluationStatus"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_config_rule_evaluation_status(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConfigRuleEvaluationStatus", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
describe_config_rules(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConfigRules"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_config_rules(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConfigRules", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
describe_configuration_aggregators(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConfigurationAggregators"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_configuration_aggregators(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConfigurationAggregators", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_configuration_recorder_status(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConfigurationRecorderStatus"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_configuration_recorder_status(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConfigurationRecorderStatus", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_configuration_recorders(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConfigurationRecorders"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_configuration_recorders(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConfigurationRecorders", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_conformance_pack_compliance(ConformancePackName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConformancePackCompliance", Dict{String, Any}("ConformancePackName"=>ConformancePackName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_conformance_pack_compliance(ConformancePackName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConformancePackCompliance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConformancePackName"=>ConformancePackName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned in a previous request that you use to
  request the next page of results in a paginated response.
"""
describe_conformance_pack_status(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConformancePackStatus"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_conformance_pack_status(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConformancePackStatus", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned in a previous request that you use to
  request the next page of results in a paginated response.
"""
describe_conformance_packs(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConformancePacks"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_conformance_packs(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeConformancePacks", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_delivery_channel_status(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeDeliveryChannelStatus"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_delivery_channel_status(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeDeliveryChannelStatus", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"DeliveryChannelNames"`: A list of delivery channel names.
"""
describe_delivery_channels(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeDeliveryChannels"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_delivery_channels(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeDeliveryChannels", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)

"""
    describe_organization_config_rule_statuses()
    describe_organization_config_rule_statuses(params::Dict{String,<:Any})

Provides organization Config rule deployment status for an organization.</p>
...
deployed in all the member accounts with an exception of excluded accounts.
 ...
 <p>When you specify the limit and the next token, you receive a paginated response. Limit
and next token are not applicable if you specify organization Config rule names. It is only
...
- `"Limit"`: The maximum number of `OrganizationConfigRuleStatuses` returned on each page.
...
"""
describe_organization_config_rule_statuses(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeOrganizationConfigRuleStatuses"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_organization_config_rule_statuses(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeOrganizationConfigRuleStatuses", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)

"""
    describe_organization_config_rules()
    describe_organization_config_rules(params::Dict{String,<:Any})

Returns a list of organization Config rules. </p>

!!! note
    When you specify the limit and the next token, you receive a paginated response.

Limit and next token are not applicable if you specify organization Config rule names. It
...
organizational rule or conformance pack in the delegated administrator account, you won't
be able to see the organizational rule or conformance pack in the organization
...
`DescribeOrganizationConformancePacks` APIs can only see and interact with the organization-
related resource that were deployed from within the account calling those APIs.
...
- `"OrganizationConfigRuleNames"`: The names of organization Config rules for which you
  ...
  organization Config rules.
"""
describe_organization_config_rules(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeOrganizationConfigRules"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_organization_config_rules(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeOrganizationConfigRules", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)

"""
    describe_organization_conformance_pack_statuses()
    describe_organization_conformance_pack_statuses(params::Dict{String,<:Any})

Provides organization conformance pack deployment status for an organization. </p>
...
successfully deployed in all the member accounts with an exception of excluded accounts.
 ...
 <p>When you specify the limit and the next token, you receive a paginated response. Limit
and next token are not applicable if you specify organization conformance pack names. They
...
"""
describe_organization_conformance_pack_statuses(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeOrganizationConformancePackStatuses"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_organization_conformance_pack_statuses(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeOrganizationConformancePackStatuses", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)

"""
    describe_organization_conformance_packs()
    describe_organization_conformance_packs(params::Dict{String,<:Any})

Returns a list of organization conformance packs. </p>
...
- `"OrganizationConformancePackNames"`: The name that you assign to an organization
  conformance pack.
"""
describe_organization_conformance_packs(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeOrganizationConformancePacks"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_organization_conformance_packs(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeOrganizationConformancePacks", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
describe_pending_aggregation_requests(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribePendingAggregationRequests"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_pending_aggregation_requests(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribePendingAggregationRequests", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `config_rule_names`: A list of Config rule names of remediation configurations for which
  you want details.
"""
describe_remediation_configurations(ConfigRuleNames; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeRemediationConfigurations", Dict{String, Any}("ConfigRuleNames"=>ConfigRuleNames); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_remediation_configurations(ConfigRuleNames, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeRemediationConfigurations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigRuleNames"=>ConfigRuleNames), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
receive a paginated response. </p>
...
When you specify the limit and the next token, you receive a paginated response.
 ...
 <p>Limit and next token are not applicable if you request resources in batch. It is only
...
- `"ResourceKeys"`: An exception list of resource exception keys to be processed with the
  ...
  exceptions for 3 resource keys.
"""
describe_remediation_exceptions(ConfigRuleName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeRemediationExceptions", Dict{String, Any}("ConfigRuleName"=>ConfigRuleName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_remediation_exceptions(ConfigRuleName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeRemediationExceptions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigRuleName"=>ConfigRuleName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"ResourceKeys"`: A list of resource keys to be processed with the current request. Each
  element in the list consists of the resource type and resource ID.
"""
describe_remediation_execution_status(ConfigRuleName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeRemediationExecutionStatus", Dict{String, Any}("ConfigRuleName"=>ConfigRuleName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_remediation_execution_status(ConfigRuleName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeRemediationExecutionStatus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigRuleName"=>ConfigRuleName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"RetentionConfigurationNames"`: A list of names of retention configurations for which
  ...
  account.
"""
describe_retention_configurations(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeRetentionConfigurations"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_retention_configurations(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("DescribeRetentionConfigurations", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
get_aggregate_conformance_pack_compliance_summary(ConfigurationAggregatorName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetAggregateConformancePackComplianceSummary", Dict{String, Any}("ConfigurationAggregatorName"=>ConfigurationAggregatorName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"Limit"`: The maximum number of <a>GroupedResourceCount</a> objects returned on each
  page. The default is 1000. You cannot specify a number greater than 1000. If you specify
  0, Config uses the default.
- `"NextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
get_aggregate_discovered_resource_counts(ConfigurationAggregatorName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetAggregateDiscoveredResourceCounts", Dict{String, Any}("ConfigurationAggregatorName"=>ConfigurationAggregatorName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
get_compliance_details_by_config_rule(ConfigRuleName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetComplianceDetailsByConfigRule", Dict{String, Any}("ConfigRuleName"=>ConfigRuleName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_compliance_details_by_config_rule(ConfigRuleName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetComplianceDetailsByConfigRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigRuleName"=>ConfigRuleName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_compliance_details_by_resource(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetComplianceDetailsByResource"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_compliance_details_by_resource(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetComplianceDetailsByResource", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
25 for each.
"""
get_compliance_summary_by_config_rule(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetComplianceSummaryByConfigRule"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_compliance_summary_by_config_rule(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetComplianceSummaryByConfigRule", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"ResourceTypes"`: Specify one or more resource types to get the number of resources that
  are compliant and the number that are noncompliant for each resource type.
...
"""
get_compliance_summary_by_resource_type(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetComplianceSummaryByResourceType"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_compliance_summary_by_resource_type(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetComplianceSummaryByResourceType", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned in a previous request that you use to
  request the next page of results in a paginated response.
"""
get_conformance_pack_compliance_details(ConformancePackName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetConformancePackComplianceDetails", Dict{String, Any}("ConformancePackName"=>ConformancePackName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The nextToken string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
get_conformance_pack_compliance_summary(ConformancePackNames; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetConformancePackComplianceSummary", Dict{String, Any}("ConformancePackNames"=>ConformancePackNames); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_custom_rule_policy(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetCustomRulePolicy"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_custom_rule_policy(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetCustomRulePolicy", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
25 EC2 instances, 20 IAM users, and 15 S3 buckets.
 2. You make a call to the `GetDiscoveredResourceCounts` action and specify that you want
all resource types.
 3. Config returns the following: - The resource types (EC2 instances, IAM users, and S3
buckets).
 - The number of each resource type (25, 20, and 15).
 - The total number of all resources (60).
The response is paginated. By default, Config lists 100 <a>ResourceCount</a> objects on
...
not immediately receive resource counts in the following situations: - You are a new Config
customer.
 - You just enabled resource recording.
It might take a few minutes for Config to record and count your resources. Wait a few
minutes and then retry the [`get_discovered_resource_counts`](@ref) action.

# Optional Parameters

Optional parameters can be passed as a `params::Dict{String,<:Any}`. Valid keys are:

- `"limit"`: The maximum number of <a>ResourceCount</a> objects returned on each page. The
...
- `"resourceTypes"`: The comma-separated list that specifies the resource types that you
  ...
  <a>ResourceCount</a> objects. If the configuration recorder is not recording a specific
  resource type (for example, S3 buckets), that resource type is not returned in the list
  of <a>ResourceCount</a> objects.
"""
get_discovered_resource_counts(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetDiscoveredResourceCounts"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_discovered_resource_counts(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetDiscoveredResourceCounts", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
get_organization_config_rule_detailed_status(OrganizationConfigRuleName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetOrganizationConfigRuleDetailedStatus", Dict{String, Any}("OrganizationConfigRuleName"=>OrganizationConfigRuleName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_organization_custom_rule_policy(OrganizationConfigRuleName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetOrganizationCustomRulePolicy", Dict{String, Any}("OrganizationConfigRuleName"=>OrganizationConfigRuleName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_organization_custom_rule_policy(OrganizationConfigRuleName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetOrganizationCustomRulePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("OrganizationConfigRuleName"=>OrganizationConfigRuleName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
`AWS::Config::ResourceCompliance` resource type. For more information, see [Selecting Which Resources Config Records](https://docs.aws.amazon.com/config/latest/developerguide/select-resources.html).</p>Returns
a list of `ConfigurationItems` for the specified resource. The list contains details about
each state of the resource during the specified time interval. If you specified a retention
period to retain your `ConfigurationItems` between a minimum of 30 days and a maximum of 7
years (2557 days), Config returns the `ConfigurationItems` for the specified retention
period.

 <p>The response is paginated. By default, Config returns a limit of 10 configuration items
...
- `"nextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
get_resource_config_history(resourceId, resourceType; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetResourceConfigHistory", Dict{String, Any}("resourceId"=>resourceId, "resourceType"=>resourceType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_resource_config_history(resourceId, resourceType, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetResourceConfigHistory", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceId"=>resourceId, "resourceType"=>resourceType), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
resource as NON_COMPLIANT, use the [GetComplianceDetailsByResource](https://docs.aws.amazon.com/config/latest/APIReference/API_GetComplianceDetailsByResource.html)
...
- `resource_evaluation_id`: The unique `ResourceEvaluationId` of Amazon Web Services
  resource execution for which you want to retrieve the evaluation summary.
"""
get_resource_evaluation_summary(ResourceEvaluationId; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetResourceEvaluationSummary", Dict{String, Any}("ResourceEvaluationId"=>ResourceEvaluationId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_resource_evaluation_summary(ResourceEvaluationId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetResourceEvaluationSummary", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceEvaluationId"=>ResourceEvaluationId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_stored_query(QueryName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetStoredQuery", Dict{String, Any}("QueryName"=>QueryName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_stored_query(QueryName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("GetStoredQuery", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QueryName"=>QueryName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_conformance_pack_compliance_scores(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("ListConformancePackComplianceScores"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_conformance_pack_compliance_scores(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("ListConformancePackComplianceScores", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
request.The response is paginated. By default, Config lists 100 resource identifiers on
each page. You can customize this number with the `limit` parameter. The response includes
a `nextToken` string. To get the next page of results, run the request again and specify
the string for the `nextToken` parameter.
...
- `"resourceIds"`: The IDs of only those resources that you want Config to list in the
  response. If you do not specify this parameter, Config lists all resources of the
  specified type that it has discovered. You can list a minimum of 1 resourceID and a
...
"""
list_discovered_resources(resourceType; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("ListDiscoveredResources", Dict{String, Any}("resourceType"=>resourceType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_discovered_resources(resourceType, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("ListDiscoveredResources", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceType"=>resourceType), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
list_resource_evaluations(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("ListResourceEvaluations"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_resource_evaluations(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("ListResourceEvaluations", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The nextToken string returned in a previous request that you use to
  request the next page of results in a paginated response.
"""
list_stored_queries(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("ListStoredQueries"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_stored_queries(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("ListStoredQueries", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The `nextToken` string returned on a previous page that you use to get the
  next page of results in a paginated response.
"""
list_tags_for_resource(ResourceArn; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_tags_for_resource(ResourceArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
managed rules, see [List of Config Managed Rules](https://docs.aws.amazon.com/config/latest/developerguide/managed-rules-by-aws-config.html).
If you are adding an Config managed rule, you must specify the rule's identifier for the
...
add a Custom Lambda rule to Config, you must specify the Amazon Resource Name (ARN) that
Lambda assigns to the function. You specify the ARN in the `SourceIdentifier` key. This key
...
For more information about developing and using Config rules, see [Evaluating Resources with Config Rules](https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config.html)
in the *Config Developer Guide*.
...
Config will ignore these differences and treat it as an idempotent request of the previous.
...
- `"Tags"`: An array of tag object.
"""
put_config_rule(ConfigRule; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutConfigRule", Dict{String, Any}("ConfigRule"=>ConfigRule); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_config_rule(ConfigRule, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutConfigRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigRule"=>ConfigRule), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
previous accounts and then append new ones.</p>

!!! note
    Config should be enabled in source accounts and regions you want to aggregate.

If your source type is an organization, you must be signed in to the management account or
a registered delegated administrator and all the features must be enabled in your
...
delegated administrator, Config calls `ListDelegatedAdministrators` API to verify whether
the caller is a valid delegated administrator.

 <p>To register a delegated administrator, see [Register a Delegated Administrator](https://docs.aws.amazon.com/config/latest/developerguide/set-up-aggregator-cli.html#register-a-delegated-administrator-cli)
in the *Config developer guide*.
...
- `"Tags"`: An array of tag object.
"""
put_configuration_aggregator(ConfigurationAggregatorName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutConfigurationAggregator", Dict{String, Any}("ConfigurationAggregatorName"=>ConfigurationAggregatorName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
in the *Config Developer Guide*.</p>

!!! note
    You can specify only one configuration recorder for each Amazon Web Services Region for
each account.

 <p>If the configuration recorder does not have the `recordingGroup` field specified, the
...
"""
put_configuration_recorder(ConfigurationRecorder; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutConfigurationRecorder", Dict{String, Any}("ConfigurationRecorder"=>ConfigurationRecorder); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_configuration_recorder(ConfigurationRecorder, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutConfigurationRecorder", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationRecorder"=>ConfigurationRecorder), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"TemplateS3Uri"`: The location of the file containing the template body
  ...
  300 KB) that is located in an Amazon S3 bucket in the same Region as the conformance
  pack.
...
"""
put_conformance_pack(ConformancePackName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutConformancePack", Dict{String, Any}("ConformancePackName"=>ConformancePackName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_conformance_pack(ConformancePackName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutConformancePack", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConformancePackName"=>ConformancePackName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
put_delivery_channel(DeliveryChannel; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutDeliveryChannel", Dict{String, Any}("DeliveryChannel"=>DeliveryChannel); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_delivery_channel(DeliveryChannel, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutDeliveryChannel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeliveryChannel"=>DeliveryChannel), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
put_evaluations(ResultToken; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutEvaluations", Dict{String, Any}("ResultToken"=>ResultToken); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_evaluations(ResultToken, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutEvaluations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResultToken"=>ResultToken), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `external_evaluation`: An `ExternalEvaluation` object that provides details about
  compliance.
"""
put_external_evaluation(ConfigRuleName, ExternalEvaluation; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutExternalEvaluation", Dict{String, Any}("ConfigRuleName"=>ConfigRuleName, "ExternalEvaluation"=>ExternalEvaluation); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Amazon Web Services Organization `register-delegated-administrator` for `config-
...
assigns to the function.</p>

!!! note
    Prerequisite: Ensure you call `EnableAllFeatures` API to enable all features in an
organization.

 <p>Make sure to specify one of either `OrganizationCustomPolicyRuleMetadata` for Custom
...
- `"OrganizationManagedRuleMetadata"`: An `OrganizationManagedRuleMetadata` object. This
  ...
  frequency with which you want Config to run evaluations for the rule if the trigger type
  is periodic.
"""
put_organization_config_rule(OrganizationConfigRuleName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutOrganizationConfigRule", Dict{String, Any}("OrganizationConfigRuleName"=>OrganizationConfigRuleName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
delegated administrator by calling Amazon Web Services Organization `register-delegate-
admin` for `config-multiaccountsetup.amazonaws.com`.</p>
...
`TemplateBody` parameter.
 ...
 <p>Config sets the state of a conformance pack to CREATE_IN_PROGRESS and
...
- `"TemplateS3Uri"`: Location of file containing the template body. The uri must point to
  ...
  if this parameter is passed.
"""
put_organization_conformance_pack(OrganizationConformancePackName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutOrganizationConformancePack", Dict{String, Any}("OrganizationConformancePackName"=>OrganizationConformancePackName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
such as Organization Config rules, the rules deployed by conformance packs, and rules
...
`automationAssumeRole` or use a value in the `assumeRole`field to remediate your resources.
The SSM automation document can use either as long as it maps to a valid parameter.

However, for automatic remediation configuration, the only valid `assumeRole` field value
is `AutomationAssumeRole` and you need to provide a value for `AutomationAssumeRole` to
remediate your resources.

!!! note
    **Auto remediation can be initiated even for compliant resources**

If you enable auto remediation for a specific Config rule using the [PutRemediationConfigurations](https://docs.aws.amazon.com/config/latest/APIReference/emAPI_PutRemediationConfigurations.html)
...
data snapshot which is captured on a periodic basis. Any non-compliant resource that is
updated between the snapshot schedule will continue to be remediated based on the last
known compliance data snapshot.

 <p>This means that in some cases auto remediation can be initiated even for compliant
...
"""
put_remediation_configurations(RemediationConfigurations; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutRemediationConfigurations", Dict{String, Any}("RemediationConfigurations"=>RemediationConfigurations); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
A remediation exception is when a specified resource is no longer considered for auto-
remediation. This API adds a new exception or updates an existing exception for a specified
resource with a specified Config rule. </p>
...
resource evaluates the resource as `NON_COMPLIANT`. Once the resource has been evaluated as
`NON_COMPLIANT`, you can add remediation exceptions and change the remediation type back
from Manual to Auto if you want to use auto-remediation. Otherwise, using auto-remediation
...
"""
put_remediation_exceptions(ConfigRuleName, ResourceKeys; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutRemediationExceptions", Dict{String, Any}("ConfigRuleName"=>ConfigRuleName, "ResourceKeys"=>ResourceKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
resource type using existing Config APIs. </p>
...
the request. This API does not change or remediate the configuration of the resource.
 ...
 <p>Write-only schema properites are not recorded as part of the published configuration
item.
...
"""
put_retention_configuration(RetentionPeriodInDays; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutRetentionConfiguration", Dict{String, Any}("RetentionPeriodInDays"=>RetentionPeriodInDays); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_retention_configuration(RetentionPeriodInDays, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutRetentionConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RetentionPeriodInDays"=>RetentionPeriodInDays), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
put_stored_query(StoredQuery; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutStoredQuery", Dict{String, Any}("StoredQuery"=>StoredQuery); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_stored_query(StoredQuery, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("PutStoredQuery", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StoredQuery"=>StoredQuery), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
section in the *Config Developer Guide*.</p>

!!! note
    If you run an aggregation query (i.e., using `GROUP BY` or using aggregate functions
such as `COUNT`; e.g., `SELECT resourceId, COUNT(*) WHERE resourceType = 'AWS::IAM::Role'
GROUP BY resourceId`) and do not specify the `MaxResults` or the `Limit` query parameters,
the default page size is set to 500.

 <p>If you run a non-aggregation query (i.e., not using `GROUP BY` or aggregate function;
e.g., `SELECT * WHERE resourceType = 'AWS::IAM::Role'`) and do not specify the `MaxResults`
or the `Limit` query parameters, the default page size is set to 25.
...
- `"NextToken"`: The `nextToken` string returned in a previous request that you use to
  request the next page of results in a paginated response.
"""
select_resource_config(Expression; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("SelectResourceConfig", Dict{String, Any}("Expression"=>Expression); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
select_resource_config(Expression, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("SelectResourceConfig", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Expression"=>Expression), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
you can call the API again. If you chose to have Config stream to an Amazon SNS topic, you
will receive a `ConfigRuleEvaluationStarted` notification when the evaluation starts.

!!! note
    You don't need to call the `StartConfigRulesEvaluation` API to run an evaluation for a
new rule. When you create a rule, Config evaluates your resources against the rule
automatically.The `StartConfigRulesEvaluation` API is useful if you want to run on-demand
evaluations, such as the following example: 1. You have a custom rule that evaluates your
IAM resources every 24 hours.
...
- `"ConfigRuleNames"`: The list of names of Config rules that you want to run evaluations
  for.
"""
start_config_rules_evaluation(; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("StartConfigRulesEvaluation"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_config_rules_evaluation(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("StartConfigRulesEvaluation", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
start_configuration_recorder(ConfigurationRecorderName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("StartConfigurationRecorder", Dict{String, Any}("ConfigurationRecorderName"=>ConfigurationRecorderName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_configuration_recorder(ConfigurationRecorderName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("StartConfigurationRecorder", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationRecorderName"=>ConfigurationRecorderName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `resource_keys`: A list of resource keys to be processed with the current request. Each
  element in the list consists of the resource type and resource ID.
"""
start_remediation_execution(ConfigRuleName, ResourceKeys; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("StartRemediationExecution", Dict{String, Any}("ConfigRuleName"=>ConfigRuleName, "ResourceKeys"=>ResourceKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
proactive mode and resource type.</p>

!!! note
    Ensure you have the `cloudformation:DescribeType` role setup to validate the resource
type schema.
...
in "*Amazon Web Services public extensions*" within the CloudFormation registry or with the
following CLI commmand: `aws cloudformation describe-type --type-name "AWS::S3::Bucket" --
type RESOURCE`.

 <p>For more information, see [Managing extensions through the CloudFormation registry](https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/registry.html#registry-view)
...
- `"ClientToken"`: A client token is a unique, case-sensitive string of up to 64 ASCII
  ...
  using the same client token, but one or more of the parameters are different, other than
  the Region or Availability Zone, the retry fails with an IdempotentParameterMismatch
  error.
...
"""
start_resource_evaluation(EvaluationMode, ResourceDetails; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("StartResourceEvaluation", Dict{String, Any}("EvaluationMode"=>EvaluationMode, "ResourceDetails"=>ResourceDetails); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_resource_evaluation(EvaluationMode, ResourceDetails, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("StartResourceEvaluation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EvaluationMode"=>EvaluationMode, "ResourceDetails"=>ResourceDetails), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `configuration_recorder_name`: The name of the recorder object that records each
  configuration change made to the resources.
"""
stop_configuration_recorder(ConfigurationRecorderName; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("StopConfigurationRecorder", Dict{String, Any}("ConfigurationRecorderName"=>ConfigurationRecorderName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `tags`: An array of tag object.
"""
tag_resource(ResourceArn, Tags; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
tag_resource(ResourceArn, Tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
untag_resource(ResourceArn, TagKeys; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
untag_resource(ResourceArn, TagKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = config_service("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
