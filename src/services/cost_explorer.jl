...
"""
CreateCostCategoryDefinition(Name, RuleVersion, Rules) = cost_explorer("CreateCostCategoryDefinition", Dict{String, Any}("Name"=>Name, "RuleVersion"=>RuleVersion, "Rules"=>Rules))
CreateCostCategoryDefinition(Name, RuleVersion, Rules, args::AbstractDict{String, <:Any}) = cost_explorer("CreateCostCategoryDefinition", Dict{String, Any}("Name"=>Name, "RuleVersion"=>RuleVersion, "Rules"=>Rules, args...))
...
"""
DeleteCostCategoryDefinition(CostCategoryArn) = cost_explorer("DeleteCostCategoryDefinition", Dict{String, Any}("CostCategoryArn"=>CostCategoryArn))
DeleteCostCategoryDefinition(CostCategoryArn, args::AbstractDict{String, <:Any}) = cost_explorer("DeleteCostCategoryDefinition", Dict{String, Any}("CostCategoryArn"=>CostCategoryArn, args...))
...
"""
DescribeCostCategoryDefinition(CostCategoryArn) = cost_explorer("DescribeCostCategoryDefinition", Dict{String, Any}("CostCategoryArn"=>CostCategoryArn))
DescribeCostCategoryDefinition(CostCategoryArn, args::AbstractDict{String, <:Any}) = cost_explorer("DescribeCostCategoryDefinition", Dict{String, Any}("CostCategoryArn"=>CostCategoryArn, args...))
...
"""
GetCostAndUsage(TimePeriod) = cost_explorer("GetCostAndUsage", Dict{String, Any}("TimePeriod"=>TimePeriod))
GetCostAndUsage(TimePeriod, args::AbstractDict{String, <:Any}) = cost_explorer("GetCostAndUsage", Dict{String, Any}("TimePeriod"=>TimePeriod, args...))
...
- `NextPageToken`: The token to retrieve the next set of results. AWS provides the token when the response from a previous call has more results than the maximum page size.
"""
GetCostAndUsageWithResources(TimePeriod) = cost_explorer("GetCostAndUsageWithResources", Dict{String, Any}("TimePeriod"=>TimePeriod))
GetCostAndUsageWithResources(TimePeriod, args::AbstractDict{String, <:Any}) = cost_explorer("GetCostAndUsageWithResources", Dict{String, Any}("TimePeriod"=>TimePeriod, args...))
...
"""
GetCostForecast(Granularity, Metric, TimePeriod) = cost_explorer("GetCostForecast", Dict{String, Any}("Granularity"=>Granularity, "Metric"=>Metric, "TimePeriod"=>TimePeriod))
GetCostForecast(Granularity, Metric, TimePeriod, args::AbstractDict{String, <:Any}) = cost_explorer("GetCostForecast", Dict{String, Any}("Granularity"=>Granularity, "Metric"=>Metric, "TimePeriod"=>TimePeriod, args...))
...
"""
GetDimensionValues(Dimension, TimePeriod) = cost_explorer("GetDimensionValues", Dict{String, Any}("Dimension"=>Dimension, "TimePeriod"=>TimePeriod))
GetDimensionValues(Dimension, TimePeriod, args::AbstractDict{String, <:Any}) = cost_explorer("GetDimensionValues", Dict{String, Any}("Dimension"=>Dimension, "TimePeriod"=>TimePeriod, args...))
...
- `NextPageToken`: The token to retrieve the next set of results. AWS provides the token when the response from a previous call has more results than the maximum page size.
"""
GetReservationCoverage(TimePeriod) = cost_explorer("GetReservationCoverage", Dict{String, Any}("TimePeriod"=>TimePeriod))
GetReservationCoverage(TimePeriod, args::AbstractDict{String, <:Any}) = cost_explorer("GetReservationCoverage", Dict{String, Any}("TimePeriod"=>TimePeriod, args...))
...
"""
GetReservationPurchaseRecommendation(Service) = cost_explorer("GetReservationPurchaseRecommendation", Dict{String, Any}("Service"=>Service))
GetReservationPurchaseRecommendation(Service, args::AbstractDict{String, <:Any}) = cost_explorer("GetReservationPurchaseRecommendation", Dict{String, Any}("Service"=>Service, args...))
...
- `NextPageToken`: The token to retrieve the next set of results. AWS provides the token when the response from a previous call has more results than the maximum page size.
"""
GetReservationUtilization(TimePeriod) = cost_explorer("GetReservationUtilization", Dict{String, Any}("TimePeriod"=>TimePeriod))
GetReservationUtilization(TimePeriod, args::AbstractDict{String, <:Any}) = cost_explorer("GetReservationUtilization", Dict{String, Any}("TimePeriod"=>TimePeriod, args...))
...
- `PageSize`: The number of recommendations that you want returned in a single response object.
"""
GetRightsizingRecommendation(Service) = cost_explorer("GetRightsizingRecommendation", Dict{String, Any}("Service"=>Service))
GetRightsizingRecommendation(Service, args::AbstractDict{String, <:Any}) = cost_explorer("GetRightsizingRecommendation", Dict{String, Any}("Service"=>Service, args...))
...
"""
GetSavingsPlansCoverage(TimePeriod) = cost_explorer("GetSavingsPlansCoverage", Dict{String, Any}("TimePeriod"=>TimePeriod))
GetSavingsPlansCoverage(TimePeriod, args::AbstractDict{String, <:Any}) = cost_explorer("GetSavingsPlansCoverage", Dict{String, Any}("TimePeriod"=>TimePeriod, args...))
...
- `PageSize`: The number of recommendations that you want returned in a single response object.
"""
GetSavingsPlansPurchaseRecommendation(LookbackPeriodInDays, PaymentOption, SavingsPlansType, TermInYears) = cost_explorer("GetSavingsPlansPurchaseRecommendation", Dict{String, Any}("LookbackPeriodInDays"=>LookbackPeriodInDays, "PaymentOption"=>PaymentOption, "SavingsPlansType"=>SavingsPlansType, "TermInYears"=>TermInYears))
GetSavingsPlansPurchaseRecommendation(LookbackPeriodInDays, PaymentOption, SavingsPlansType, TermInYears, args::AbstractDict{String, <:Any}) = cost_explorer("GetSavingsPlansPurchaseRecommendation", Dict{String, Any}("LookbackPeriodInDays"=>LookbackPeriodInDays, "PaymentOption"=>PaymentOption, "SavingsPlansType"=>SavingsPlansType, "TermInYears"=>TermInYears, args...))
...
"""
GetSavingsPlansUtilization(TimePeriod) = cost_explorer("GetSavingsPlansUtilization", Dict{String, Any}("TimePeriod"=>TimePeriod))
GetSavingsPlansUtilization(TimePeriod, args::AbstractDict{String, <:Any}) = cost_explorer("GetSavingsPlansUtilization", Dict{String, Any}("TimePeriod"=>TimePeriod, args...))
...
- `NextToken`: The token to retrieve the next set of results. Amazon Web Services provides the token when the response from a previous call has more results than the maximum page size.
"""
GetSavingsPlansUtilizationDetails(TimePeriod) = cost_explorer("GetSavingsPlansUtilizationDetails", Dict{String, Any}("TimePeriod"=>TimePeriod))
GetSavingsPlansUtilizationDetails(TimePeriod, args::AbstractDict{String, <:Any}) = cost_explorer("GetSavingsPlansUtilizationDetails", Dict{String, Any}("TimePeriod"=>TimePeriod, args...))
...
"""
GetTags(TimePeriod) = cost_explorer("GetTags", Dict{String, Any}("TimePeriod"=>TimePeriod))
GetTags(TimePeriod, args::AbstractDict{String, <:Any}) = cost_explorer("GetTags", Dict{String, Any}("TimePeriod"=>TimePeriod, args...))
...
- `PredictionIntervalLevel`: Cost Explorer always returns the mean forecast as a single point. You can request a prediction interval around the mean by specifying a confidence level. The higher the confidence level, the more confident Cost Explorer is about the actual value falling in the prediction interval. Higher confidence levels result in wider prediction intervals.
"""
GetUsageForecast(Granularity, Metric, TimePeriod) = cost_explorer("GetUsageForecast", Dict{String, Any}("Granularity"=>Granularity, "Metric"=>Metric, "TimePeriod"=>TimePeriod))
GetUsageForecast(Granularity, Metric, TimePeriod, args::AbstractDict{String, <:Any}) = cost_explorer("GetUsageForecast", Dict{String, Any}("Granularity"=>Granularity, "Metric"=>Metric, "TimePeriod"=>TimePeriod, args...))
...
ListCostCategoryDefinitions(args::AbstractDict{String, <:Any}) = cost_explorer("ListCostCategoryDefinitions", args)
...
"""
UpdateCostCategoryDefinition(CostCategoryArn, RuleVersion, Rules) = cost_explorer("UpdateCostCategoryDefinition", Dict{String, Any}("CostCategoryArn"=>CostCategoryArn, "RuleVersion"=>RuleVersion, "Rules"=>Rules))
UpdateCostCategoryDefinition(CostCategoryArn, RuleVersion, Rules, args::AbstractDict{String, <:Any}) = cost_explorer("UpdateCostCategoryDefinition", Dict{String, Any}("CostCategoryArn"=>CostCategoryArn, "RuleVersion"=>RuleVersion, "Rules"=>Rules, args...))
