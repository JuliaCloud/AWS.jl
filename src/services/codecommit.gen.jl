...
"""
CreatePullRequest(targets, title) = codecommit("CreatePullRequest", Dict{String, Any}("targets"=>targets, "title"=>title))
CreatePullRequest(targets, title, args::AbstractDict{String, <: Any}) = codecommit("CreatePullRequest", Dict{String, Any}("targets"=>targets, "title"=>title, args...))
...
"""
PostCommentForComparedCommit(afterCommitId, content, repositoryName) = codecommit("PostCommentForComparedCommit", Dict{String, Any}("afterCommitId"=>afterCommitId, "content"=>content, "repositoryName"=>repositoryName))
PostCommentForComparedCommit(afterCommitId, content, repositoryName, args::AbstractDict{String, <: Any}) = codecommit("PostCommentForComparedCommit", Dict{String, Any}("afterCommitId"=>afterCommitId, "content"=>content, "repositoryName"=>repositoryName, args...))
...
"""
PostCommentForPullRequest(afterCommitId, beforeCommitId, content, pullRequestId, repositoryName) = codecommit("PostCommentForPullRequest", Dict{String, Any}("afterCommitId"=>afterCommitId, "beforeCommitId"=>beforeCommitId, "content"=>content, "pullRequestId"=>pullRequestId, "repositoryName"=>repositoryName))
PostCommentForPullRequest(afterCommitId, beforeCommitId, content, pullRequestId, repositoryName, args::AbstractDict{String, <: Any}) = codecommit("PostCommentForPullRequest", Dict{String, Any}("afterCommitId"=>afterCommitId, "beforeCommitId"=>beforeCommitId, "content"=>content, "pullRequestId"=>pullRequestId, "repositoryName"=>repositoryName, args...))
...
clientRequestToken => A unique, client-generated idempotency token that, when provided in a request, ensures the request cannot be repeated with a changed parameter. If a request is received with the same parameters and a token is included, the request returns information about the initial request that used that token.
"""
PostCommentReply(content, inReplyTo) = codecommit("PostCommentReply", Dict{String, Any}("content"=>content, "inReplyTo"=>inReplyTo))
PostCommentReply(content, inReplyTo, args::AbstractDict{String, <: Any}) = codecommit("PostCommentReply", Dict{String, Any}("content"=>content, "inReplyTo"=>inReplyTo, args...))
