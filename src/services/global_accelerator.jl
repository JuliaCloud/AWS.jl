...
"""
AdvertiseByoipCidr(Cidr) = global_accelerator("AdvertiseByoipCidr", Dict{String, Any}("Cidr"=>Cidr))
AdvertiseByoipCidr(Cidr, args::AbstractDict{String, <:Any}) = global_accelerator("AdvertiseByoipCidr", Dict{String, Any}("Cidr"=>Cidr, args...))
...
"""
CreateAccelerator(IdempotencyToken, Name) = global_accelerator("CreateAccelerator", Dict{String, Any}("IdempotencyToken"=>IdempotencyToken, "Name"=>Name))
CreateAccelerator(IdempotencyToken, Name, args::AbstractDict{String, <:Any}) = global_accelerator("CreateAccelerator", Dict{String, Any}("IdempotencyToken"=>IdempotencyToken, "Name"=>Name, args...))
...
"""
CreateEndpointGroup(EndpointGroupRegion, IdempotencyToken, ListenerArn) = global_accelerator("CreateEndpointGroup", Dict{String, Any}("EndpointGroupRegion"=>EndpointGroupRegion, "IdempotencyToken"=>IdempotencyToken, "ListenerArn"=>ListenerArn))
CreateEndpointGroup(EndpointGroupRegion, IdempotencyToken, ListenerArn, args::AbstractDict{String, <:Any}) = global_accelerator("CreateEndpointGroup", Dict{String, Any}("EndpointGroupRegion"=>EndpointGroupRegion, "IdempotencyToken"=>IdempotencyToken, "ListenerArn"=>ListenerArn, args...))
...
"""
CreateListener(AcceleratorArn, IdempotencyToken, PortRanges, Protocol) = global_accelerator("CreateListener", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn, "IdempotencyToken"=>IdempotencyToken, "PortRanges"=>PortRanges, "Protocol"=>Protocol))
CreateListener(AcceleratorArn, IdempotencyToken, PortRanges, Protocol, args::AbstractDict{String, <:Any}) = global_accelerator("CreateListener", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn, "IdempotencyToken"=>IdempotencyToken, "PortRanges"=>PortRanges, "Protocol"=>Protocol, args...))
...
"""
DeleteAccelerator(AcceleratorArn) = global_accelerator("DeleteAccelerator", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn))
DeleteAccelerator(AcceleratorArn, args::AbstractDict{String, <:Any}) = global_accelerator("DeleteAccelerator", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn, args...))
...
"""
DeleteEndpointGroup(EndpointGroupArn) = global_accelerator("DeleteEndpointGroup", Dict{String, Any}("EndpointGroupArn"=>EndpointGroupArn))
DeleteEndpointGroup(EndpointGroupArn, args::AbstractDict{String, <:Any}) = global_accelerator("DeleteEndpointGroup", Dict{String, Any}("EndpointGroupArn"=>EndpointGroupArn, args...))
...
"""
DeleteListener(ListenerArn) = global_accelerator("DeleteListener", Dict{String, Any}("ListenerArn"=>ListenerArn))
DeleteListener(ListenerArn, args::AbstractDict{String, <:Any}) = global_accelerator("DeleteListener", Dict{String, Any}("ListenerArn"=>ListenerArn, args...))
...
"""
DeprovisionByoipCidr(Cidr) = global_accelerator("DeprovisionByoipCidr", Dict{String, Any}("Cidr"=>Cidr))
DeprovisionByoipCidr(Cidr, args::AbstractDict{String, <:Any}) = global_accelerator("DeprovisionByoipCidr", Dict{String, Any}("Cidr"=>Cidr, args...))
...
"""
DescribeAccelerator(AcceleratorArn) = global_accelerator("DescribeAccelerator", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn))
DescribeAccelerator(AcceleratorArn, args::AbstractDict{String, <:Any}) = global_accelerator("DescribeAccelerator", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn, args...))
...
"""
DescribeAcceleratorAttributes(AcceleratorArn) = global_accelerator("DescribeAcceleratorAttributes", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn))
DescribeAcceleratorAttributes(AcceleratorArn, args::AbstractDict{String, <:Any}) = global_accelerator("DescribeAcceleratorAttributes", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn, args...))
...
"""
DescribeEndpointGroup(EndpointGroupArn) = global_accelerator("DescribeEndpointGroup", Dict{String, Any}("EndpointGroupArn"=>EndpointGroupArn))
DescribeEndpointGroup(EndpointGroupArn, args::AbstractDict{String, <:Any}) = global_accelerator("DescribeEndpointGroup", Dict{String, Any}("EndpointGroupArn"=>EndpointGroupArn, args...))
...
"""
DescribeListener(ListenerArn) = global_accelerator("DescribeListener", Dict{String, Any}("ListenerArn"=>ListenerArn))
DescribeListener(ListenerArn, args::AbstractDict{String, <:Any}) = global_accelerator("DescribeListener", Dict{String, Any}("ListenerArn"=>ListenerArn, args...))
...
ListAccelerators(args::AbstractDict{String, <:Any}) = global_accelerator("ListAccelerators", args)
...
ListByoipCidrs(args::AbstractDict{String, <:Any}) = global_accelerator("ListByoipCidrs", args)
...
- `NextToken`: The token for the next set of results. You receive this token from a previous call.
"""
ListEndpointGroups(ListenerArn) = global_accelerator("ListEndpointGroups", Dict{String, Any}("ListenerArn"=>ListenerArn))
ListEndpointGroups(ListenerArn, args::AbstractDict{String, <:Any}) = global_accelerator("ListEndpointGroups", Dict{String, Any}("ListenerArn"=>ListenerArn, args...))
...
- `NextToken`: The token for the next set of results. You receive this token from a previous call.
"""
ListListeners(AcceleratorArn) = global_accelerator("ListListeners", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn))
ListListeners(AcceleratorArn, args::AbstractDict{String, <:Any}) = global_accelerator("ListListeners", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn, args...))
...
"""
ListTagsForResource(ResourceArn) = global_accelerator("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn))
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}) = global_accelerator("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
ProvisionByoipCidr(Cidr, CidrAuthorizationContext) = global_accelerator("ProvisionByoipCidr", Dict{String, Any}("Cidr"=>Cidr, "CidrAuthorizationContext"=>CidrAuthorizationContext))
ProvisionByoipCidr(Cidr, CidrAuthorizationContext, args::AbstractDict{String, <:Any}) = global_accelerator("ProvisionByoipCidr", Dict{String, Any}("Cidr"=>Cidr, "CidrAuthorizationContext"=>CidrAuthorizationContext, args...))
...
"""
TagResource(ResourceArn, Tags) = global_accelerator("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags))
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}) = global_accelerator("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceArn, TagKeys) = global_accelerator("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys))
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}) = global_accelerator("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys, args...))
...
"""
UpdateAccelerator(AcceleratorArn) = global_accelerator("UpdateAccelerator", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn))
UpdateAccelerator(AcceleratorArn, args::AbstractDict{String, <:Any}) = global_accelerator("UpdateAccelerator", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn, args...))
...
"""
UpdateAcceleratorAttributes(AcceleratorArn) = global_accelerator("UpdateAcceleratorAttributes", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn))
UpdateAcceleratorAttributes(AcceleratorArn, args::AbstractDict{String, <:Any}) = global_accelerator("UpdateAcceleratorAttributes", Dict{String, Any}("AcceleratorArn"=>AcceleratorArn, args...))
...
- `TrafficDialPercentage`: The percentage of traffic to send to an AWS Region. Additional traffic is distributed to other endpoint groups for this listener.  Use this action to increase (dial up) or decrease (dial down) traffic to a specific Region. The percentage is applied to the traffic that would otherwise have been routed to the Region based on optimal routing. The default value is 100.
"""
UpdateEndpointGroup(EndpointGroupArn) = global_accelerator("UpdateEndpointGroup", Dict{String, Any}("EndpointGroupArn"=>EndpointGroupArn))
UpdateEndpointGroup(EndpointGroupArn, args::AbstractDict{String, <:Any}) = global_accelerator("UpdateEndpointGroup", Dict{String, Any}("EndpointGroupArn"=>EndpointGroupArn, args...))
...
"""
UpdateListener(ListenerArn) = global_accelerator("UpdateListener", Dict{String, Any}("ListenerArn"=>ListenerArn))
UpdateListener(ListenerArn, args::AbstractDict{String, <:Any}) = global_accelerator("UpdateListener", Dict{String, Any}("ListenerArn"=>ListenerArn, args...))
...
"""
WithdrawByoipCidr(Cidr) = global_accelerator("WithdrawByoipCidr", Dict{String, Any}("Cidr"=>Cidr))
WithdrawByoipCidr(Cidr, args::AbstractDict{String, <:Any}) = global_accelerator("WithdrawByoipCidr", Dict{String, Any}("Cidr"=>Cidr, args...))
