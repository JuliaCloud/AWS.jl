...
- `"NextToken"`: The token for the next set of results. You receive this token from a
  previous call.
"""
function list_cross_account_attachments(; aws_config::AbstractAWSConfig=current_aws_config())
    return global_accelerator(
...
function remove_endpoints(
    EndpointGroupArn, EndpointIdentifiers; aws_config::AbstractAWSConfig=current_aws_config()
)
    return global_accelerator(
        "RemoveEndpoints",
        Dict{String,Any}(
