...
"""
function batch_delete_detector(detectors; aws_config::AbstractAWSConfig=current_aws_config())
    return iot_events_data(
        "POST",
        "/detectors/delete",
...
"""
function batch_update_detector(detectors; aws_config::AbstractAWSConfig=current_aws_config())
    return iot_events_data(
        "POST",
        "/detectors",
        Dict{String,Any}("detectors" => detectors);
