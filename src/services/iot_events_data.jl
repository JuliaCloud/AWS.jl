...
"""
batch_delete_detector(detectors; aws_config::AbstractAWSConfig=global_aws_config()) =
    iot_events_data(
        "POST",
        "/detectors/delete",
...
"""
batch_put_message(messages; aws_config::AbstractAWSConfig=global_aws_config()) =
    iot_events_data(
        "POST",
        "/inputs/messages",
...
"""
batch_update_detector(detectors; aws_config::AbstractAWSConfig=global_aws_config()) =
    iot_events_data(
        "POST",
        "/detectors",
        Dict{String,Any}("detectors" => detectors);
...
- `"keyValue"`: The value of the key used as a filter to select only the alarms associated
  with the key.
"""
describe_alarm(alarmModelName; aws_config::AbstractAWSConfig=global_aws_config()) =
    iot_events_data(
        "GET",
...
- `"keyValue"`: A filter used to limit results to detectors (instances) created because of
  the given key ID.
"""
describe_detector(detectorModelName; aws_config::AbstractAWSConfig=global_aws_config()) =
    iot_events_data(
        "GET",
...
"""
list_alarms(alarmModelName; aws_config::AbstractAWSConfig=global_aws_config()) =
    iot_events_data(
        "GET",
...
- `"stateName"`: A filter that limits results to those detectors (instances) in the given
  state.
"""
list_detectors(detectorModelName; aws_config::AbstractAWSConfig=global_aws_config()) =
    iot_events_data(
        "GET",
