...
function get_service(serviceIdentifier; aws_config::AbstractAWSConfig=current_aws_config())
    return vpc_lattice(
        "GET", "/services/$(serviceIdentifier)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function list_access_log_subscriptions end
...
function list_service_network_vpc_associations(;
    ...
    return vpc_lattice(
        "GET", "/servicenetworkvpcassociations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"nextToken"`: A pagination token for the next page of results.
"""
function list_service_networks end

function list_service_networks(; aws_config::AbstractAWSConfig=current_aws_config())
    return vpc_lattice(
        "GET", "/servicenetworks"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_service_networks(
    ...
    return vpc_lattice(
        "GET", "/servicenetworks", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_services(; aws_config::AbstractAWSConfig=current_aws_config())
    return vpc_lattice("GET", "/services"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_target_groups(; aws_config::AbstractAWSConfig=current_aws_config())
    return vpc_lattice("GET", "/targetgroups"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_target_groups(
    ...
    return vpc_lattice(
        "GET", "/targetgroups", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
