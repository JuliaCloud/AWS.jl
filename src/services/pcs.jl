...
- `"clientToken"`: A unique, case-sensitive identifier that you provide to ensure the
  ...
  automatically generate 1 for you.
"""
delete_cluster(clusterIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = pcs(
    "DeleteCluster",
    Dict{String,Any}(
...
"""
get_cluster(clusterIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = pcs(
    "GetCluster",
...
- `"nextToken"`: The value of nextToken is a unique pagination token for each page of
  ...
  returns an HTTP 400 InvalidToken error.
"""
list_queues(clusterIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = pcs(
    "ListQueues",
    Dict{String,Any}("clusterIdentifier" => clusterIdentifier);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
tag_resource(resourceArn, tags; aws_config::AbstractAWSConfig=current_aws_config()) = pcs(
    "TagResource",
