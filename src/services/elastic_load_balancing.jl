...
function describe_load_balancer_policies(;
    ...
    return elastic_load_balancing(
        "DescribeLoadBalancerPolicies"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_load_balancer_policies(
    ...
    return elastic_load_balancing(
        "DescribeLoadBalancerPolicies", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_load_balancer_policy_types(;
    ...
    return elastic_load_balancing(
        "DescribeLoadBalancerPolicyTypes"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
