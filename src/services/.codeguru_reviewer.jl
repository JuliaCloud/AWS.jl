...
"""
AssociateRepository(Repository) = codeguru_reviewer("POST", "/associations", Dict{String, Any}("Repository"=>Repository))
AssociateRepository(Repository, args::AbstractDict{String, <: Any}) = codeguru_reviewer("POST", "/associations", Dict{String, Any}("Repository"=>Repository, args...))
