...
CompleteSnapshot(snapshotId, x_amz_ChangedBlocksCount, args::AbstractDict{String, <:Any}) = ebs("POST", "/snapshots/completion/$(snapshotId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-ChangedBlocksCount"=>x_amz_ChangedBlocksCount)), args...)))
...
"""
StartSnapshot(VolumeSize) = ebs("POST", "/snapshots", Dict{String, Any}("VolumeSize"=>VolumeSize, "ClientToken"=>string(uuid4())))
StartSnapshot(VolumeSize, args::AbstractDict{String, <:Any}) = ebs("POST", "/snapshots", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VolumeSize"=>VolumeSize, "ClientToken"=>string(uuid4())), args...)))
