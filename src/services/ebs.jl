...
"""
<<<<<<< HEAD
complete_snapshot(snapshotId, x_amz_ChangedBlocksCount; aws_config::AWSConfig=global_aws_config()) = ebs("POST", "/snapshots/completion/$(snapshotId)", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-ChangedBlocksCount"=>x_amz_ChangedBlocksCount)); aws_config=aws_config)
complete_snapshot(snapshotId, x_amz_ChangedBlocksCount, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = ebs("POST", "/snapshots/completion/$(snapshotId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-ChangedBlocksCount"=>x_amz_ChangedBlocksCount)), args)); aws_config=aws_config)
=======
...
"""
<<<<<<< HEAD
get_snapshot_block(blockIndex, blockToken, snapshotId; aws_config::AWSConfig=global_aws_config()) = ebs("GET", "/snapshots/$(snapshotId)/blocks/$(blockIndex)", Dict{String, Any}("blockToken"=>blockToken); aws_config=aws_config)
get_snapshot_block(blockIndex, blockToken, snapshotId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = ebs("GET", "/snapshots/$(snapshotId)/blocks/$(blockIndex)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("blockToken"=>blockToken), args)); aws_config=aws_config)
=======
...
"""
<<<<<<< HEAD
list_changed_blocks(secondSnapshotId; aws_config::AWSConfig=global_aws_config()) = ebs("GET", "/snapshots/$(secondSnapshotId)/changedblocks"; aws_config=aws_config)
list_changed_blocks(secondSnapshotId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = ebs("GET", "/snapshots/$(secondSnapshotId)/changedblocks", args; aws_config=aws_config)
=======
...
"""
<<<<<<< HEAD
list_snapshot_blocks(snapshotId; aws_config::AWSConfig=global_aws_config()) = ebs("GET", "/snapshots/$(snapshotId)/blocks"; aws_config=aws_config)
list_snapshot_blocks(snapshotId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = ebs("GET", "/snapshots/$(snapshotId)/blocks", args; aws_config=aws_config)
=======
...
"""
<<<<<<< HEAD
put_snapshot_block(BlockData, blockIndex, snapshotId, x_amz_Checksum, x_amz_Checksum_Algorithm, x_amz_Data_Length; aws_config::AWSConfig=global_aws_config()) = ebs("PUT", "/snapshots/$(snapshotId)/blocks/$(blockIndex)", Dict{String, Any}("BlockData"=>BlockData, "headers"=>Dict{String, Any}("x-amz-Checksum"=>x_amz_Checksum, "x-amz-Checksum-Algorithm"=>x_amz_Checksum_Algorithm, "x-amz-Data-Length"=>x_amz_Data_Length)); aws_config=aws_config)
put_snapshot_block(BlockData, blockIndex, snapshotId, x_amz_Checksum, x_amz_Checksum_Algorithm, x_amz_Data_Length, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = ebs("PUT", "/snapshots/$(snapshotId)/blocks/$(blockIndex)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BlockData"=>BlockData, "headers"=>Dict{String, Any}("x-amz-Checksum"=>x_amz_Checksum, "x-amz-Checksum-Algorithm"=>x_amz_Checksum_Algorithm, "x-amz-Data-Length"=>x_amz_Data_Length)), args)); aws_config=aws_config)
=======
...
"""
<<<<<<< HEAD
start_snapshot(VolumeSize; aws_config::AWSConfig=global_aws_config()) = ebs("POST", "/snapshots", Dict{String, Any}("VolumeSize"=>VolumeSize, "ClientToken"=>string(uuid4())); aws_config=aws_config)
start_snapshot(VolumeSize, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = ebs("POST", "/snapshots", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VolumeSize"=>VolumeSize, "ClientToken"=>string(uuid4())), args)); aws_config=aws_config)
=======
