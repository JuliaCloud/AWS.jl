...
"""
CompleteSnapshot(snapshotId, x_amz_ChangedBlocksCount) = ebs("POST", "/snapshots/completion/$(snapshotId)", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-ChangedBlocksCount"=>x_amz_ChangedBlocksCount)))
CompleteSnapshot(snapshotId, x_amz_ChangedBlocksCount, args::AbstractDict{String, <: Any}) = ebs("POST", "/snapshots/completion/$(snapshotId)", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-ChangedBlocksCount"=>x_amz_ChangedBlocksCount)), args...)))
CompleteSnapshot(a...; b...) = CompleteSnapshot(a..., b)
...
"""
GetSnapshotBlock(blockIndex, blockToken, snapshotId) = ebs("GET", "/snapshots/$(snapshotId)/blocks/$(blockIndex)", Dict{String, Any}("blockToken"=>blockToken))
GetSnapshotBlock(blockIndex, blockToken, snapshotId, args::AbstractDict{String, <: Any}) = ebs("GET", "/snapshots/$(snapshotId)/blocks/$(blockIndex)", Dict{String, Any}("blockToken"=>blockToken, args...))
...
ListChangedBlocks(secondSnapshotId, args::AbstractDict{String, <: Any}) = ebs("GET", "/snapshots/$(secondSnapshotId)/changedblocks", args)
...
ListSnapshotBlocks(snapshotId, args::AbstractDict{String, <: Any}) = ebs("GET", "/snapshots/$(snapshotId)/blocks", args)
...
"""
PutSnapshotBlock(BlockData, blockIndex, snapshotId, x_amz_Checksum, x_amz_Checksum_Algorithm, x_amz_Data_Length) = ebs("PUT", "/snapshots/$(snapshotId)/blocks/$(blockIndex)", Dict{String, Any}("BlockData"=>BlockData, "headers"=>Dict{String, Any}("x-amz-Checksum"=>x_amz_Checksum, "x-amz-Checksum-Algorithm"=>x_amz_Checksum_Algorithm, "x-amz-Data-Length"=>x_amz_Data_Length)))
PutSnapshotBlock(BlockData, blockIndex, snapshotId, x_amz_Checksum, x_amz_Checksum_Algorithm, x_amz_Data_Length, args::AbstractDict{String, <: Any}) = ebs("PUT", "/snapshots/$(snapshotId)/blocks/$(blockIndex)", Dict{String, Any}(mergewith(merge, Dict{String, Any}("BlockData"=>BlockData, "headers"=>Dict{String, Any}("x-amz-Checksum"=>x_amz_Checksum, "x-amz-Checksum-Algorithm"=>x_amz_Checksum_Algorithm, "x-amz-Data-Length"=>x_amz_Data_Length)), args...)))
PutSnapshotBlock(a...; b...) = PutSnapshotBlock(a..., b)
...
"""
StartSnapshot(VolumeSize) = ebs("POST", "/snapshots", Dict{String, Any}("VolumeSize"=>VolumeSize))
StartSnapshot(VolumeSize, args::AbstractDict{String, <: Any}) = ebs("POST", "/snapshots", Dict{String, Any}("VolumeSize"=>VolumeSize, args...))
StartSnapshot(a...; b...) = StartSnapshot(a..., b)
