...
create_progress_update_stream(ProgressUpdateStreamName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()) = migration_hub("CreateProgressUpdateStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProgressUpdateStreamName"=>ProgressUpdateStreamName), params)); aws_config=aws_config)
...
delete_progress_update_stream(ProgressUpdateStreamName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()) = migration_hub("DeleteProgressUpdateStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProgressUpdateStreamName"=>ProgressUpdateStreamName), params)); aws_config=aws_config)
...
describe_application_state(ApplicationId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()) = migration_hub("DescribeApplicationState", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationId"=>ApplicationId), params)); aws_config=aws_config)
...
list_application_states(params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()) = migration_hub("ListApplicationStates", params; aws_config=aws_config)
...
list_migration_tasks(params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()) = migration_hub("ListMigrationTasks", params; aws_config=aws_config)
...
list_progress_update_streams(params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()) = migration_hub("ListProgressUpdateStreams", params; aws_config=aws_config)
...
notify_application_state(ApplicationId, Status, params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()) = migration_hub("NotifyApplicationState", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationId"=>ApplicationId, "Status"=>Status), params)); aws_config=aws_config)
