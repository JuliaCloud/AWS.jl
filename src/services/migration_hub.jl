...
# Required Parameters
- `CreatedArtifact`: An ARN of the AWS resource related to the migration (e.g., AMI, EC2
  instance, RDS instance, etc.)
- `MigrationTaskName`: Unique identifier that references the migration task. Do not store
  personal data in this field.
- `ProgressUpdateStream`: The name of the ProgressUpdateStream.

# Optional Parameters
- `DryRun`: Optional boolean flag to indicate whether any effect should take place. Used to
...
- `MigrationTaskName`: The identifier given to the MigrationTask. Do not store personal
  data in this field.
- `ProgressUpdateStream`: The name of the ProgressUpdateStream.
...
# Required Parameters
- `ProgressUpdateStreamName`: The name of the ProgressUpdateStream. Do not store personal
  data in this field.
...
# Required Parameters
- `ApplicationId`: The configurationId in Application Discovery Service that uniquely
...
# Required Parameters
- `CreatedArtifactName`: An ARN of the AWS resource related to the migration (e.g., AMI,
  EC2 instance, RDS instance, etc.)
- `MigrationTaskName`: Unique identifier that references the migration task to be
...
# Required Parameters
- `ConfigurationId`: ConfigurationId of the Application Discovery Service resource to be
  disassociated.
- `MigrationTaskName`: The identifier given to the MigrationTask. Do not store personal
  data in this field.
- `ProgressUpdateStream`: The name of the ProgressUpdateStream.
...
# Required Parameters
- `MigrationTaskName`: The name of the MigrationTask. Do not store personal data in this
  field.
- `ProgressUpdateStream`: The name of the ProgressUpdateStream.
...
- `MigrationTaskName`: Unique identifier that references the migration task. Do not store
  personal data in this field.
- `NextUpdateSeconds`: Number of seconds after the UpdateDateTime within which the
...
- `MigrationTaskName`: Unique identifier that references the migration task. Do not store
  personal data in this field.
- `ProgressUpdateStream`: The name of the ProgressUpdateStream.
- `ResourceAttributeList`: Information about the resource that is being migrated. This data
  will be used to map the task to a resource in the Application Discovery Service repository.
  ...
  the identifying value can be a string up to 256 characters.     If any \"VM\" related value
  is set for a ResourceAttribute object, it is required that VM_MANAGER_ID, as a minimum, is
  always set. If VM_MANAGER_ID is not set, then all \"VM\" fields will be discarded and
  \"VM\" fields will not be used for matching the migration task to a server in Application
  Discovery Service repository. See the Example section below for a use case of specifying
  \"VM\" related values.    If a server you are trying to match has multiple IP or MAC
  addresses, you should provide as many as you know in separate type/value pairs passed to
