...
function delete_event_integration(Name; aws_config::AbstractAWSConfig=current_aws_config())
    return appintegrations(
        "DELETE", "/eventIntegrations/$(Name)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_event_integration(Name; aws_config::AbstractAWSConfig=current_aws_config())
    return appintegrations(
        "GET", "/eventIntegrations/$(Name)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_data_integrations(; aws_config::AbstractAWSConfig=current_aws_config())
    return appintegrations(
        "GET", "/dataIntegrations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_data_integrations(
    ...
    return appintegrations(
        "GET", "/dataIntegrations", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_event_integrations(; aws_config::AbstractAWSConfig=current_aws_config())
    return appintegrations(
        "GET", "/eventIntegrations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_event_integrations(
    ...
    return appintegrations(
        "GET", "/eventIntegrations", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_event_integration(Name; aws_config::AbstractAWSConfig=current_aws_config())
    return appintegrations(
        "PATCH", "/eventIntegrations/$(Name)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
