...
that allows administration of all policy types, accounts, organizational units, and Regions.
This account must be a member account of the organization in Organizations whose resources
you want to protect.
...
"""
function associate_admin_account end
...
"""
function associate_third_party_firewall end

function associate_third_party_firewall(
    ThirdPartyFirewall; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fms(
...
- `items`: The uniform resource identifiers (URIs) of resources that should be associated to
...
"""
function batch_associate_resource end

function batch_associate_resource(
    Items, ResourceSetIdentifier; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fms(
...
- `resource_set_identifier`: A unique identifier for the resource set, used in a request to
  refer to the resource set.
"""
function batch_disassociate_resource end
...
"""
function delete_apps_list end

function delete_apps_list(ListId; aws_config::AbstractAWSConfig=current_aws_config())
    return fms(
        "DeleteAppsList",
...
"""
function delete_notification_channel end

function delete_notification_channel(; aws_config::AbstractAWSConfig=current_aws_config())
    return fms("DeleteNotificationChannel"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function delete_notification_channel(
    ...
    return fms(
        "DeleteNotificationChannel", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function delete_protocols_list end

function delete_protocols_list(ListId; aws_config::AbstractAWSConfig=current_aws_config())
    return fms(
        "DeleteProtocolsList",
        Dict{String,Any}("ListId" => ListId);
        aws_config,
...
function delete_resource_set(Identifier; aws_config::AbstractAWSConfig=current_aws_config())
    return fms(
        "DeleteResourceSet",
...
account.
"""
function disassociate_admin_account end

function disassociate_admin_account(; aws_config::AbstractAWSConfig=current_aws_config())
    return fms("DisassociateAdminAccount"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function disassociate_admin_account(
    ...
    return fms(
        "DisassociateAdminAccount", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `third_party_firewall`: The name of the third-party firewall vendor.
"""
function disassociate_third_party_firewall end
...
"""
function get_admin_account end

function get_admin_account(; aws_config::AbstractAWSConfig=current_aws_config())
    return fms("GetAdminAccount"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_admin_account(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fms("GetAdminAccount", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
"""
function get_admin_scope end

function get_admin_scope(AdminAccount; aws_config::AbstractAWSConfig=current_aws_config())
    return fms(
        "GetAdminScope",
        Dict{String,Any}("AdminAccount" => AdminAccount);
        aws_config,
...
- `"DefaultList"`: Specifies whether the list to retrieve is a default list owned by
  Firewall Manager.
"""
function get_apps_list end

function get_apps_list(ListId; aws_config::AbstractAWSConfig=current_aws_config())
    return fms(
        "GetAppsList",
        Dict{String,Any}("ListId" => ListId);
        aws_config,
...
- `member_account`: The Amazon Web Services account that owns the resources that you want to
  get the details for.
- `policy_id`: The ID of the policy that you want to get the details for. `PolicyId` is
  returned by `PutPolicy` and by `ListPolicies`.
"""
function get_compliance_detail end

function get_compliance_detail(
    MemberAccount, PolicyId; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fms(
        "GetComplianceDetail",
...
"""
function get_notification_channel end

function get_notification_channel(; aws_config::AbstractAWSConfig=current_aws_config())
    return fms("GetNotificationChannel"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function get_notification_channel(
    ...
    return fms(
        "GetNotificationChannel", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_policy(PolicyId; aws_config::AbstractAWSConfig=current_aws_config())
    return fms(
        "GetPolicy",
        Dict{String,Any}("PolicyId" => PolicyId);
        aws_config,
...
- `"StartTime"`: The start of the time period to query for the attacks. This is a
  `timestamp` type. The request syntax listing indicates a `number` type because the default
  used by Firewall Manager is Unix time in seconds. However, any valid `timestamp` format is
  allowed.
"""
function get_protection_status end
...
- `"DefaultList"`: Specifies whether the list to retrieve is a default list owned by
  Firewall Manager.
"""
function get_protocols_list end

function get_protocols_list(ListId; aws_config::AbstractAWSConfig=current_aws_config())
    return fms(
        "GetProtocolsList",
        Dict{String,Any}("ListId" => ListId);
        aws_config,
...
function get_resource_set(Identifier; aws_config::AbstractAWSConfig=current_aws_config())
    return fms(
        "GetResourceSet",
        Dict{String,Any}("Identifier" => Identifier);
        aws_config,
...
- `third_party_firewall`: The name of the third-party firewall vendor.
"""
function get_third_party_firewall_association_status end
...
- `"MaxResults"`: The maximum number of objects that you want Firewall Manager to return for
...
"""
function list_admin_accounts_for_organization end

function list_admin_accounts_for_organization(;
    aws_config::AbstractAWSConfig=current_aws_config()
)
    return fms(
        "ListAdminAccountsForOrganization"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"NextToken"`: When you request a list of objects with a `MaxResults` setting, if the
  ...
  next batch of objects, use the token returned from the prior request in your next request.
"""
function list_admins_managing_account end

function list_admins_managing_account(; aws_config::AbstractAWSConfig=current_aws_config())
    return fms("ListAdminsManagingAccount"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_admins_managing_account(
    ...
    return fms(
        "ListAdminsManagingAccount", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function list_apps_lists end

function list_apps_lists(MaxResults; aws_config::AbstractAWSConfig=current_aws_config())
    return fms(
        "ListAppsLists",
...
"""
function list_compliance_status end
...
- `"NextToken"`: If you specify a value for `MaxResults` and you have more account IDs than
  the number that you specify for `MaxResults`, Firewall Manager returns a `NextToken` value
  in the response that allows you to list another group of IDs. For the second and
  subsequent `ListMemberAccountsRequest` requests, specify the value of `NextToken` from the
...
function list_member_accounts(; aws_config::AbstractAWSConfig=current_aws_config())
    return fms("ListMemberAccounts"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_member_accounts(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fms("ListMemberAccounts", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_policies(; aws_config::AbstractAWSConfig=current_aws_config())
    return fms("ListPolicies"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_policies(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fms("ListPolicies", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"NextToken"`: If you specify a value for `MaxResults` in your list request, and you have
  ...
  request parameters, to retrieve the next batch of objects.
"""
function list_protocols_lists end
...
- `"NextToken"`: When you request a list of objects with a `MaxResults` setting, if the
  ...
  next batch of objects, use the token returned from the prior request in your next request.
"""
function list_resource_set_resources end
...
function list_resource_sets(; aws_config::AbstractAWSConfig=current_aws_config())
    return fms("ListResourceSets"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function list_resource_sets(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fms("ListResourceSets", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"NextToken"`: If the previous response included a `NextToken` element, the specified
  ...
  If the previous response didn't include a `NextToken` element, there are no more third-
  party firewall policies to get.
"""
function list_third_party_firewall_firewall_policies end

function list_third_party_firewall_firewall_policies(
    MaxResults, ThirdPartyFirewall; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fms(
...
see if the account is already a delegated administrator within Organizations. If the account
isn't a delegated administrator, Firewall Manager calls Organizations to delegate the
account within Organizations. For more information about administrator accounts within
...
- `"AdminScope"`: Configures the resources that the specified Firewall Manager administrator
  can manage. As a best practice, set the administrative scope according to the principles
  of least privilege. Only grant the administrator the specific resources or permissions
  that they need to perform the duties of their role.
"""
function put_admin_account end
...
"""
function put_apps_list end

function put_apps_list(AppsList; aws_config::AbstractAWSConfig=current_aws_config())
    return fms(
        "PutAppsList",
...
"""
function put_notification_channel end

function put_notification_channel(
    SnsRoleName, SnsTopicArn; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fms(
...
- **Third-party firewall policy** - This policy applies third-party firewall protections.
  ...
  - **Palo Alto Networks Cloud NGFW policy** - This policy applies Palo Alto Networks Cloud
    Next Generation Firewall (NGFW) protections and Palo Alto Networks Cloud NGFW rulestacks
  ...
  - **Fortigate CNF policy** - This policy applies Fortigate Cloud Native Firewall (CNF)
    ...
    secures cloud infrastructures with industry-leading advanced threat prevention, smart
...
- `"TagList"`: The tags associated with the resource.
"""
function put_protocols_list end

function put_protocols_list(
    ProtocolsList; aws_config::AbstractAWSConfig=current_aws_config()
)
    return fms(
        "PutProtocolsList",
