...
# Required Parameters
- `AdminAccount`: The AWS account ID to associate with AWS Firewall Manager as the AWS
...
associate_admin_account(AdminAccount, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("AssociateAdminAccount", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AdminAccount"=>AdminAccount), args)); aws_config=aws_config)
...
# Required Parameters
- `ListId`: The ID of the applications list that you want to delete. You can retrieve this
...
delete_apps_list(ListId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("DeleteAppsList", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ListId"=>ListId), args)); aws_config=aws_config)
...
delete_notification_channel(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("DeleteNotificationChannel", args; aws_config=aws_config)
...
# Required Parameters
- `PolicyId`: The ID of the policy that you want to delete. You can retrieve this ID from
  PutPolicy and ListPolicies.

# Optional Parameters
- `DeleteAllPolicyResources`: If True, the request performs cleanup according to the policy
  type.  For AWS WAF and Shield Advanced policies, the cleanup does the following:   Deletes
  rule groups created by AWS Firewall Manager   Removes web ACLs from in-scope resources
...
delete_policy(PolicyId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("DeletePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PolicyId"=>PolicyId), args)); aws_config=aws_config)
...
# Required Parameters
- `ListId`: The ID of the protocols list that you want to delete. You can retrieve this ID
...
delete_protocols_list(ListId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("DeleteProtocolsList", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ListId"=>ListId), args)); aws_config=aws_config)
...
disassociate_admin_account(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("DisassociateAdminAccount", args; aws_config=aws_config)
...
get_admin_account(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("GetAdminAccount", args; aws_config=aws_config)
...
# Required Parameters
- `ListId`: The ID of the AWS Firewall Manager applications list that you want the details
  for.
...
get_apps_list(ListId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("GetAppsList", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ListId"=>ListId), args)); aws_config=aws_config)
...
# Required Parameters
- `MemberAccount`: The AWS account that owns the resources that you want to get the details
  for.
- `PolicyId`: The ID of the policy that you want to get the details for. PolicyId is
...
get_compliance_detail(MemberAccount, PolicyId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("GetComplianceDetail", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MemberAccount"=>MemberAccount, "PolicyId"=>PolicyId), args)); aws_config=aws_config)
...
get_notification_channel(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("GetNotificationChannel", args; aws_config=aws_config)
...
get_policy(PolicyId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("GetPolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PolicyId"=>PolicyId), args)); aws_config=aws_config)
...
# Optional Parameters
- `EndTime`: The end of the time period to query for the attacks. This is a timestamp type.
  The request syntax listing indicates a number type because the default used by AWS Firewall
...
get_protection_status(PolicyId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("GetProtectionStatus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PolicyId"=>PolicyId), args)); aws_config=aws_config)
...
get_protocols_list(ListId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("GetProtocolsList", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ListId"=>ListId), args)); aws_config=aws_config)
...
- `PolicyId`: The ID of the AWS Firewall Manager policy that you want the details for. This
  currently only supports security group content audit policies.
- `ResourceId`: The ID of the resource that has violations.
- `ResourceType`: The resource type. This is in the format shown in the AWS Resource Types
...
# Required Parameters
- `MaxResults`: The maximum number of objects that you want AWS Firewall Manager to return
...
list_apps_lists(MaxResults, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("ListAppsLists", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MaxResults"=>MaxResults), args)); aws_config=aws_config)
...
list_compliance_status(PolicyId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("ListComplianceStatus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PolicyId"=>PolicyId), args)); aws_config=aws_config)
...
- `NextToken`: If you specify a value for MaxResults and you have more account IDs than the
  number that you specify for MaxResults, AWS Firewall Manager returns a NextToken value in
...
list_member_accounts(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("ListMemberAccounts", args; aws_config=aws_config)
...
list_policies(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("ListPolicies", args; aws_config=aws_config)
...
list_protocols_lists(MaxResults, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("ListProtocolsLists", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MaxResults"=>MaxResults), args)); aws_config=aws_config)
...
# Required Parameters
- `ResourceArn`: The Amazon Resource Name (ARN) of the resource to return tags for. The AWS
...
list_tags_for_resource(ResourceArn, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), args)); aws_config=aws_config)
...
put_apps_list(AppsList, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("PutAppsList", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AppsList"=>AppsList), args)); aws_config=aws_config)
...
# Required Parameters
- `SnsRoleName`: The Amazon Resource Name (ARN) of the IAM role that allows Amazon SNS to
  record AWS Firewall Manager activity.
- `SnsTopicArn`: The Amazon Resource Name (ARN) of the SNS topic that collects
...
put_notification_channel(SnsRoleName, SnsTopicArn, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("PutNotificationChannel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SnsRoleName"=>SnsRoleName, "SnsTopicArn"=>SnsTopicArn), args)); aws_config=aws_config)
...
put_policy(Policy, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("PutPolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Policy"=>Policy), args)); aws_config=aws_config)
...
put_protocols_list(ProtocolsList, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("PutProtocolsList", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProtocolsList"=>ProtocolsList), args)); aws_config=aws_config)
...
tag_resource(ResourceArn, TagList, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagList"=>TagList), args)); aws_config=aws_config)
...
untag_resource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = fms("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), args)); aws_config=aws_config)
