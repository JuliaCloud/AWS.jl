...
"""
function list_compliance_status(PolicyId; aws_config::AbstractAWSConfig=current_aws_config())
    return fms(
...
- `"NextToken"`: If you specify a value for MaxResults in your list request, and you have
  ...
  parameters, to retrieve the next batch of objects.
"""
function list_protocols_lists(MaxResults; aws_config::AbstractAWSConfig=current_aws_config())
    return fms(
        "ListProtocolsLists",
        Dict{String,Any}("MaxResults" => MaxResults);
        aws_config=aws_config,
