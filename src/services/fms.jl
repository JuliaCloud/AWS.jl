...
"""
AssociateAdminAccount(AdminAccount) = fms("AssociateAdminAccount", Dict{String, Any}("AdminAccount"=>AdminAccount))
AssociateAdminAccount(AdminAccount, args::AbstractDict{String, <: Any}) = fms("AssociateAdminAccount", Dict{String, Any}("AdminAccount"=>AdminAccount, args...))
...
"""
DeleteAppsList(ListId) = fms("DeleteAppsList", Dict{String, Any}("ListId"=>ListId))
DeleteAppsList(ListId, args::AbstractDict{String, <: Any}) = fms("DeleteAppsList", Dict{String, Any}("ListId"=>ListId, args...))
...
DeleteNotificationChannel(args::AbstractDict{String, <: Any}) = fms("DeleteNotificationChannel", args)
...
"""
DeletePolicy(PolicyId) = fms("DeletePolicy", Dict{String, Any}("PolicyId"=>PolicyId))
DeletePolicy(PolicyId, args::AbstractDict{String, <: Any}) = fms("DeletePolicy", Dict{String, Any}("PolicyId"=>PolicyId, args...))
...
"""
DeleteProtocolsList(ListId) = fms("DeleteProtocolsList", Dict{String, Any}("ListId"=>ListId))
DeleteProtocolsList(ListId, args::AbstractDict{String, <: Any}) = fms("DeleteProtocolsList", Dict{String, Any}("ListId"=>ListId, args...))
...
DisassociateAdminAccount(args::AbstractDict{String, <: Any}) = fms("DisassociateAdminAccount", args)
...
GetAdminAccount(args::AbstractDict{String, <: Any}) = fms("GetAdminAccount", args)
...
"""
GetAppsList(ListId) = fms("GetAppsList", Dict{String, Any}("ListId"=>ListId))
GetAppsList(ListId, args::AbstractDict{String, <: Any}) = fms("GetAppsList", Dict{String, Any}("ListId"=>ListId, args...))
...
"""
GetComplianceDetail(MemberAccount, PolicyId) = fms("GetComplianceDetail", Dict{String, Any}("MemberAccount"=>MemberAccount, "PolicyId"=>PolicyId))
GetComplianceDetail(MemberAccount, PolicyId, args::AbstractDict{String, <: Any}) = fms("GetComplianceDetail", Dict{String, Any}("MemberAccount"=>MemberAccount, "PolicyId"=>PolicyId, args...))
...
GetNotificationChannel(args::AbstractDict{String, <: Any}) = fms("GetNotificationChannel", args)
...
"""
GetPolicy(PolicyId) = fms("GetPolicy", Dict{String, Any}("PolicyId"=>PolicyId))
GetPolicy(PolicyId, args::AbstractDict{String, <: Any}) = fms("GetPolicy", Dict{String, Any}("PolicyId"=>PolicyId, args...))
...
"""
GetProtectionStatus(PolicyId) = fms("GetProtectionStatus", Dict{String, Any}("PolicyId"=>PolicyId))
GetProtectionStatus(PolicyId, args::AbstractDict{String, <: Any}) = fms("GetProtectionStatus", Dict{String, Any}("PolicyId"=>PolicyId, args...))
...
DefaultList => Specifies whether the list to retrieve is a default list owned by AWS Firewall Manager.
"""
GetProtocolsList(ListId) = fms("GetProtocolsList", Dict{String, Any}("ListId"=>ListId))
GetProtocolsList(ListId, args::AbstractDict{String, <: Any}) = fms("GetProtocolsList", Dict{String, Any}("ListId"=>ListId, args...))
...
"""
GetViolationDetails(MemberAccount, PolicyId, ResourceId, ResourceType) = fms("GetViolationDetails", Dict{String, Any}("MemberAccount"=>MemberAccount, "PolicyId"=>PolicyId, "ResourceId"=>ResourceId, "ResourceType"=>ResourceType))
GetViolationDetails(MemberAccount, PolicyId, ResourceId, ResourceType, args::AbstractDict{String, <: Any}) = fms("GetViolationDetails", Dict{String, Any}("MemberAccount"=>MemberAccount, "PolicyId"=>PolicyId, "ResourceId"=>ResourceId, "ResourceType"=>ResourceType, args...))
...
"""
ListAppsLists(MaxResults) = fms("ListAppsLists", Dict{String, Any}("MaxResults"=>MaxResults))
ListAppsLists(MaxResults, args::AbstractDict{String, <: Any}) = fms("ListAppsLists", Dict{String, Any}("MaxResults"=>MaxResults, args...))
...
"""
ListComplianceStatus(PolicyId) = fms("ListComplianceStatus", Dict{String, Any}("PolicyId"=>PolicyId))
ListComplianceStatus(PolicyId, args::AbstractDict{String, <: Any}) = fms("ListComplianceStatus", Dict{String, Any}("PolicyId"=>PolicyId, args...))
...
ListMemberAccounts(args::AbstractDict{String, <: Any}) = fms("ListMemberAccounts", args)
...
ListPolicies(args::AbstractDict{String, <: Any}) = fms("ListPolicies", args)
...
NextToken => If you specify a value for MaxResults in your list request, and you have more objects than the maximum, AWS Firewall Manager returns this token in the response. For all but the first request, you provide the token returned by the prior request in the request parameters, to retrieve the next batch of objects.
"""
ListProtocolsLists(MaxResults) = fms("ListProtocolsLists", Dict{String, Any}("MaxResults"=>MaxResults))
ListProtocolsLists(MaxResults, args::AbstractDict{String, <: Any}) = fms("ListProtocolsLists", Dict{String, Any}("MaxResults"=>MaxResults, args...))
...
"""
ListTagsForResource(ResourceArn) = fms("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn))
ListTagsForResource(ResourceArn, args::AbstractDict{String, <: Any}) = fms("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
PutAppsList(AppsList) = fms("PutAppsList", Dict{String, Any}("AppsList"=>AppsList))
PutAppsList(AppsList, args::AbstractDict{String, <: Any}) = fms("PutAppsList", Dict{String, Any}("AppsList"=>AppsList, args...))
...
"""
PutNotificationChannel(SnsRoleName, SnsTopicArn) = fms("PutNotificationChannel", Dict{String, Any}("SnsRoleName"=>SnsRoleName, "SnsTopicArn"=>SnsTopicArn))
PutNotificationChannel(SnsRoleName, SnsTopicArn, args::AbstractDict{String, <: Any}) = fms("PutNotificationChannel", Dict{String, Any}("SnsRoleName"=>SnsRoleName, "SnsTopicArn"=>SnsTopicArn, args...))
...
"""
PutPolicy(Policy) = fms("PutPolicy", Dict{String, Any}("Policy"=>Policy))
PutPolicy(Policy, args::AbstractDict{String, <: Any}) = fms("PutPolicy", Dict{String, Any}("Policy"=>Policy, args...))
...
TagList => The tags associated with the resource.
"""
PutProtocolsList(ProtocolsList) = fms("PutProtocolsList", Dict{String, Any}("ProtocolsList"=>ProtocolsList))
PutProtocolsList(ProtocolsList, args::AbstractDict{String, <: Any}) = fms("PutProtocolsList", Dict{String, Any}("ProtocolsList"=>ProtocolsList, args...))
...
"""
TagResource(ResourceArn, TagList) = fms("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagList"=>TagList))
TagResource(ResourceArn, TagList, args::AbstractDict{String, <: Any}) = fms("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagList"=>TagList, args...))
...
"""
UntagResource(ResourceArn, TagKeys) = fms("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys))
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <: Any}) = fms("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys, args...))
