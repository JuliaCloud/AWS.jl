...
"""
AssociateMemberAccount(memberAccountId; aws::AWSConfig=AWSConfig()) = macie("AssociateMemberAccount", Dict{String, Any}("memberAccountId"=>memberAccountId); aws=aws)
AssociateMemberAccount(memberAccountId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = macie("AssociateMemberAccount", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("memberAccountId"=>memberAccountId), args)); aws=aws)
...
"""
AssociateS3Resources(s3Resources; aws::AWSConfig=AWSConfig()) = macie("AssociateS3Resources", Dict{String, Any}("s3Resources"=>s3Resources); aws=aws)
AssociateS3Resources(s3Resources, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = macie("AssociateS3Resources", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("s3Resources"=>s3Resources), args)); aws=aws)
...
"""
DisassociateMemberAccount(memberAccountId; aws::AWSConfig=AWSConfig()) = macie("DisassociateMemberAccount", Dict{String, Any}("memberAccountId"=>memberAccountId); aws=aws)
DisassociateMemberAccount(memberAccountId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = macie("DisassociateMemberAccount", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("memberAccountId"=>memberAccountId), args)); aws=aws)
...
"""
DisassociateS3Resources(associatedS3Resources; aws::AWSConfig=AWSConfig()) = macie("DisassociateS3Resources", Dict{String, Any}("associatedS3Resources"=>associatedS3Resources); aws=aws)
DisassociateS3Resources(associatedS3Resources, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = macie("DisassociateS3Resources", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("associatedS3Resources"=>associatedS3Resources), args)); aws=aws)
...
"""
ListMemberAccounts(; aws::AWSConfig=AWSConfig()) = macie("ListMemberAccounts"; aws=aws)
ListMemberAccounts(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = macie("ListMemberAccounts", args; aws=aws)
...
"""
ListS3Resources(; aws::AWSConfig=AWSConfig()) = macie("ListS3Resources"; aws=aws)
ListS3Resources(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = macie("ListS3Resources", args; aws=aws)
...
"""
UpdateS3Resources(s3ResourcesUpdate; aws::AWSConfig=AWSConfig()) = macie("UpdateS3Resources", Dict{String, Any}("s3ResourcesUpdate"=>s3ResourcesUpdate); aws=aws)
UpdateS3Resources(s3ResourcesUpdate, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = macie("UpdateS3Resources", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("s3ResourcesUpdate"=>s3ResourcesUpdate), args)); aws=aws)
