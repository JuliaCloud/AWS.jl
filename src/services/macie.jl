...
# Required Parameters
- `memberAccountId`: The ID of the AWS account that you want to associate with Amazon Macie
...
# Required Parameters
- `s3Resources`: The S3 resources that you want to associate with Amazon Macie Classic for
  monitoring and data classification.

# Optional Parameters
- `memberAccountId`: The ID of the Amazon Macie Classic member account whose resources you
...
# Required Parameters
- `associatedS3Resources`: The S3 resources (buckets or prefixes) that you want to remove
...
# Optional Parameters
- `maxResults`: Use this parameter to indicate the maximum number of items that you want in
  the response. The default value is 250.
- `nextToken`: Use this parameter when paginating results. Set the value of this parameter
