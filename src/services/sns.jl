...
"""
AddPermission(AWSAccountId, ActionName, Label, TopicArn) = sns("AddPermission", Dict{String, Any}("AWSAccountId"=>AWSAccountId, "ActionName"=>ActionName, "Label"=>Label, "TopicArn"=>TopicArn))
AddPermission(AWSAccountId, ActionName, Label, TopicArn, args::AbstractDict{String, <:Any}) = sns("AddPermission", Dict{String, Any}("AWSAccountId"=>AWSAccountId, "ActionName"=>ActionName, "Label"=>Label, "TopicArn"=>TopicArn, args...))
...
"""
CheckIfPhoneNumberIsOptedOut(phoneNumber) = sns("CheckIfPhoneNumberIsOptedOut", Dict{String, Any}("phoneNumber"=>phoneNumber))
CheckIfPhoneNumberIsOptedOut(phoneNumber, args::AbstractDict{String, <:Any}) = sns("CheckIfPhoneNumberIsOptedOut", Dict{String, Any}("phoneNumber"=>phoneNumber, args...))
...
"""
ConfirmSubscription(Token, TopicArn) = sns("ConfirmSubscription", Dict{String, Any}("Token"=>Token, "TopicArn"=>TopicArn))
ConfirmSubscription(Token, TopicArn, args::AbstractDict{String, <:Any}) = sns("ConfirmSubscription", Dict{String, Any}("Token"=>Token, "TopicArn"=>TopicArn, args...))
...
"""
CreatePlatformApplication(Attributes, Name, Platform) = sns("CreatePlatformApplication", Dict{String, Any}("Attributes"=>Attributes, "Name"=>Name, "Platform"=>Platform))
CreatePlatformApplication(Attributes, Name, Platform, args::AbstractDict{String, <:Any}) = sns("CreatePlatformApplication", Dict{String, Any}("Attributes"=>Attributes, "Name"=>Name, "Platform"=>Platform, args...))
...
"""
CreatePlatformEndpoint(PlatformApplicationArn, Token) = sns("CreatePlatformEndpoint", Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn, "Token"=>Token))
CreatePlatformEndpoint(PlatformApplicationArn, Token, args::AbstractDict{String, <:Any}) = sns("CreatePlatformEndpoint", Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn, "Token"=>Token, args...))
...
"""
CreateTopic(Name) = sns("CreateTopic", Dict{String, Any}("Name"=>Name))
CreateTopic(Name, args::AbstractDict{String, <:Any}) = sns("CreateTopic", Dict{String, Any}("Name"=>Name, args...))
...
"""
DeleteEndpoint(EndpointArn) = sns("DeleteEndpoint", Dict{String, Any}("EndpointArn"=>EndpointArn))
DeleteEndpoint(EndpointArn, args::AbstractDict{String, <:Any}) = sns("DeleteEndpoint", Dict{String, Any}("EndpointArn"=>EndpointArn, args...))
...
"""
DeletePlatformApplication(PlatformApplicationArn) = sns("DeletePlatformApplication", Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn))
DeletePlatformApplication(PlatformApplicationArn, args::AbstractDict{String, <:Any}) = sns("DeletePlatformApplication", Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn, args...))
...
"""
DeleteTopic(TopicArn) = sns("DeleteTopic", Dict{String, Any}("TopicArn"=>TopicArn))
DeleteTopic(TopicArn, args::AbstractDict{String, <:Any}) = sns("DeleteTopic", Dict{String, Any}("TopicArn"=>TopicArn, args...))
...
"""
GetEndpointAttributes(EndpointArn) = sns("GetEndpointAttributes", Dict{String, Any}("EndpointArn"=>EndpointArn))
GetEndpointAttributes(EndpointArn, args::AbstractDict{String, <:Any}) = sns("GetEndpointAttributes", Dict{String, Any}("EndpointArn"=>EndpointArn, args...))
...
"""
GetPlatformApplicationAttributes(PlatformApplicationArn) = sns("GetPlatformApplicationAttributes", Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn))
GetPlatformApplicationAttributes(PlatformApplicationArn, args::AbstractDict{String, <:Any}) = sns("GetPlatformApplicationAttributes", Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn, args...))
...
GetSMSAttributes(args::AbstractDict{String, <:Any}) = sns("GetSMSAttributes", args)
...
"""
GetSubscriptionAttributes(SubscriptionArn) = sns("GetSubscriptionAttributes", Dict{String, Any}("SubscriptionArn"=>SubscriptionArn))
GetSubscriptionAttributes(SubscriptionArn, args::AbstractDict{String, <:Any}) = sns("GetSubscriptionAttributes", Dict{String, Any}("SubscriptionArn"=>SubscriptionArn, args...))
...
"""
GetTopicAttributes(TopicArn) = sns("GetTopicAttributes", Dict{String, Any}("TopicArn"=>TopicArn))
GetTopicAttributes(TopicArn, args::AbstractDict{String, <:Any}) = sns("GetTopicAttributes", Dict{String, Any}("TopicArn"=>TopicArn, args...))
...
"""
ListEndpointsByPlatformApplication(PlatformApplicationArn) = sns("ListEndpointsByPlatformApplication", Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn))
ListEndpointsByPlatformApplication(PlatformApplicationArn, args::AbstractDict{String, <:Any}) = sns("ListEndpointsByPlatformApplication", Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn, args...))
...
ListPhoneNumbersOptedOut(args::AbstractDict{String, <:Any}) = sns("ListPhoneNumbersOptedOut", args)
...
ListPlatformApplications(args::AbstractDict{String, <:Any}) = sns("ListPlatformApplications", args)
...
ListSubscriptions(args::AbstractDict{String, <:Any}) = sns("ListSubscriptions", args)
...
"""
ListSubscriptionsByTopic(TopicArn) = sns("ListSubscriptionsByTopic", Dict{String, Any}("TopicArn"=>TopicArn))
ListSubscriptionsByTopic(TopicArn, args::AbstractDict{String, <:Any}) = sns("ListSubscriptionsByTopic", Dict{String, Any}("TopicArn"=>TopicArn, args...))
...
"""
ListTagsForResource(ResourceArn) = sns("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn))
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}) = sns("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
ListTopics(args::AbstractDict{String, <:Any}) = sns("ListTopics", args)
...
"""
OptInPhoneNumber(phoneNumber) = sns("OptInPhoneNumber", Dict{String, Any}("phoneNumber"=>phoneNumber))
OptInPhoneNumber(phoneNumber, args::AbstractDict{String, <:Any}) = sns("OptInPhoneNumber", Dict{String, Any}("phoneNumber"=>phoneNumber, args...))
...
"""
Publish(Message) = sns("Publish", Dict{String, Any}("Message"=>Message))
Publish(Message, args::AbstractDict{String, <:Any}) = sns("Publish", Dict{String, Any}("Message"=>Message, args...))
...
"""
RemovePermission(Label, TopicArn) = sns("RemovePermission", Dict{String, Any}("Label"=>Label, "TopicArn"=>TopicArn))
RemovePermission(Label, TopicArn, args::AbstractDict{String, <:Any}) = sns("RemovePermission", Dict{String, Any}("Label"=>Label, "TopicArn"=>TopicArn, args...))
...
"""
SetEndpointAttributes(Attributes, EndpointArn) = sns("SetEndpointAttributes", Dict{String, Any}("Attributes"=>Attributes, "EndpointArn"=>EndpointArn))
SetEndpointAttributes(Attributes, EndpointArn, args::AbstractDict{String, <:Any}) = sns("SetEndpointAttributes", Dict{String, Any}("Attributes"=>Attributes, "EndpointArn"=>EndpointArn, args...))
...
"""
SetPlatformApplicationAttributes(Attributes, PlatformApplicationArn) = sns("SetPlatformApplicationAttributes", Dict{String, Any}("Attributes"=>Attributes, "PlatformApplicationArn"=>PlatformApplicationArn))
SetPlatformApplicationAttributes(Attributes, PlatformApplicationArn, args::AbstractDict{String, <:Any}) = sns("SetPlatformApplicationAttributes", Dict{String, Any}("Attributes"=>Attributes, "PlatformApplicationArn"=>PlatformApplicationArn, args...))
...
"""
SetSMSAttributes(attributes) = sns("SetSMSAttributes", Dict{String, Any}("attributes"=>attributes))
SetSMSAttributes(attributes, args::AbstractDict{String, <:Any}) = sns("SetSMSAttributes", Dict{String, Any}("attributes"=>attributes, args...))
...
"""
SetSubscriptionAttributes(AttributeName, SubscriptionArn) = sns("SetSubscriptionAttributes", Dict{String, Any}("AttributeName"=>AttributeName, "SubscriptionArn"=>SubscriptionArn))
SetSubscriptionAttributes(AttributeName, SubscriptionArn, args::AbstractDict{String, <:Any}) = sns("SetSubscriptionAttributes", Dict{String, Any}("AttributeName"=>AttributeName, "SubscriptionArn"=>SubscriptionArn, args...))
...
"""
SetTopicAttributes(AttributeName, TopicArn) = sns("SetTopicAttributes", Dict{String, Any}("AttributeName"=>AttributeName, "TopicArn"=>TopicArn))
SetTopicAttributes(AttributeName, TopicArn, args::AbstractDict{String, <:Any}) = sns("SetTopicAttributes", Dict{String, Any}("AttributeName"=>AttributeName, "TopicArn"=>TopicArn, args...))
...
"""
Subscribe(Protocol, TopicArn) = sns("Subscribe", Dict{String, Any}("Protocol"=>Protocol, "TopicArn"=>TopicArn))
Subscribe(Protocol, TopicArn, args::AbstractDict{String, <:Any}) = sns("Subscribe", Dict{String, Any}("Protocol"=>Protocol, "TopicArn"=>TopicArn, args...))
...
"""
TagResource(ResourceArn, Tags) = sns("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags))
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}) = sns("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags, args...))
...
"""
Unsubscribe(SubscriptionArn) = sns("Unsubscribe", Dict{String, Any}("SubscriptionArn"=>SubscriptionArn))
Unsubscribe(SubscriptionArn, args::AbstractDict{String, <:Any}) = sns("Unsubscribe", Dict{String, Any}("SubscriptionArn"=>SubscriptionArn, args...))
...
"""
UntagResource(ResourceArn, TagKeys) = sns("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys))
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}) = sns("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys, args...))
