...
AddPermission(AWSAccountId, ActionName, Label, TopicArn; aws_config::AWSConfig=AWS.aws_config) = sns("AddPermission", Dict{String, Any}("AWSAccountId"=>AWSAccountId, "ActionName"=>ActionName, "Label"=>Label, "TopicArn"=>TopicArn); aws_config=aws_config)
AddPermission(AWSAccountId, ActionName, Label, TopicArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("AddPermission", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AWSAccountId"=>AWSAccountId, "ActionName"=>ActionName, "Label"=>Label, "TopicArn"=>TopicArn), args)); aws_config=aws_config)
...
CheckIfPhoneNumberIsOptedOut(phoneNumber; aws_config::AWSConfig=AWS.aws_config) = sns("CheckIfPhoneNumberIsOptedOut", Dict{String, Any}("phoneNumber"=>phoneNumber); aws_config=aws_config)
CheckIfPhoneNumberIsOptedOut(phoneNumber, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("CheckIfPhoneNumberIsOptedOut", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("phoneNumber"=>phoneNumber), args)); aws_config=aws_config)
...
ConfirmSubscription(Token, TopicArn; aws_config::AWSConfig=AWS.aws_config) = sns("ConfirmSubscription", Dict{String, Any}("Token"=>Token, "TopicArn"=>TopicArn); aws_config=aws_config)
ConfirmSubscription(Token, TopicArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("ConfirmSubscription", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Token"=>Token, "TopicArn"=>TopicArn), args)); aws_config=aws_config)
...
CreatePlatformApplication(Attributes, Name, Platform; aws_config::AWSConfig=AWS.aws_config) = sns("CreatePlatformApplication", Dict{String, Any}("Attributes"=>Attributes, "Name"=>Name, "Platform"=>Platform); aws_config=aws_config)
CreatePlatformApplication(Attributes, Name, Platform, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("CreatePlatformApplication", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Attributes"=>Attributes, "Name"=>Name, "Platform"=>Platform), args)); aws_config=aws_config)
...
CreatePlatformEndpoint(PlatformApplicationArn, Token; aws_config::AWSConfig=AWS.aws_config) = sns("CreatePlatformEndpoint", Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn, "Token"=>Token); aws_config=aws_config)
CreatePlatformEndpoint(PlatformApplicationArn, Token, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("CreatePlatformEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn, "Token"=>Token), args)); aws_config=aws_config)
...
CreateTopic(Name; aws_config::AWSConfig=AWS.aws_config) = sns("CreateTopic", Dict{String, Any}("Name"=>Name); aws_config=aws_config)
CreateTopic(Name, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("CreateTopic", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws_config=aws_config)
...
DeleteEndpoint(EndpointArn; aws_config::AWSConfig=AWS.aws_config) = sns("DeleteEndpoint", Dict{String, Any}("EndpointArn"=>EndpointArn); aws_config=aws_config)
DeleteEndpoint(EndpointArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("DeleteEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EndpointArn"=>EndpointArn), args)); aws_config=aws_config)
...
DeletePlatformApplication(PlatformApplicationArn; aws_config::AWSConfig=AWS.aws_config) = sns("DeletePlatformApplication", Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn); aws_config=aws_config)
DeletePlatformApplication(PlatformApplicationArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("DeletePlatformApplication", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn), args)); aws_config=aws_config)
...
DeleteTopic(TopicArn; aws_config::AWSConfig=AWS.aws_config) = sns("DeleteTopic", Dict{String, Any}("TopicArn"=>TopicArn); aws_config=aws_config)
DeleteTopic(TopicArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("DeleteTopic", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TopicArn"=>TopicArn), args)); aws_config=aws_config)
...
GetEndpointAttributes(EndpointArn; aws_config::AWSConfig=AWS.aws_config) = sns("GetEndpointAttributes", Dict{String, Any}("EndpointArn"=>EndpointArn); aws_config=aws_config)
GetEndpointAttributes(EndpointArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("GetEndpointAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EndpointArn"=>EndpointArn), args)); aws_config=aws_config)
...
GetPlatformApplicationAttributes(PlatformApplicationArn; aws_config::AWSConfig=AWS.aws_config) = sns("GetPlatformApplicationAttributes", Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn); aws_config=aws_config)
GetPlatformApplicationAttributes(PlatformApplicationArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("GetPlatformApplicationAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn), args)); aws_config=aws_config)
...
GetSMSAttributes(; aws_config::AWSConfig=AWS.aws_config) = sns("GetSMSAttributes"; aws_config=aws_config)
GetSMSAttributes(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("GetSMSAttributes", args; aws_config=aws_config)
...
GetSubscriptionAttributes(SubscriptionArn; aws_config::AWSConfig=AWS.aws_config) = sns("GetSubscriptionAttributes", Dict{String, Any}("SubscriptionArn"=>SubscriptionArn); aws_config=aws_config)
GetSubscriptionAttributes(SubscriptionArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("GetSubscriptionAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SubscriptionArn"=>SubscriptionArn), args)); aws_config=aws_config)
...
GetTopicAttributes(TopicArn; aws_config::AWSConfig=AWS.aws_config) = sns("GetTopicAttributes", Dict{String, Any}("TopicArn"=>TopicArn); aws_config=aws_config)
GetTopicAttributes(TopicArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("GetTopicAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TopicArn"=>TopicArn), args)); aws_config=aws_config)
...
ListEndpointsByPlatformApplication(PlatformApplicationArn; aws_config::AWSConfig=AWS.aws_config) = sns("ListEndpointsByPlatformApplication", Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn); aws_config=aws_config)
ListEndpointsByPlatformApplication(PlatformApplicationArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("ListEndpointsByPlatformApplication", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PlatformApplicationArn"=>PlatformApplicationArn), args)); aws_config=aws_config)
...
ListPhoneNumbersOptedOut(; aws_config::AWSConfig=AWS.aws_config) = sns("ListPhoneNumbersOptedOut"; aws_config=aws_config)
ListPhoneNumbersOptedOut(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("ListPhoneNumbersOptedOut", args; aws_config=aws_config)
...
ListPlatformApplications(; aws_config::AWSConfig=AWS.aws_config) = sns("ListPlatformApplications"; aws_config=aws_config)
ListPlatformApplications(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("ListPlatformApplications", args; aws_config=aws_config)
...
ListSubscriptions(; aws_config::AWSConfig=AWS.aws_config) = sns("ListSubscriptions"; aws_config=aws_config)
ListSubscriptions(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("ListSubscriptions", args; aws_config=aws_config)
...
ListSubscriptionsByTopic(TopicArn; aws_config::AWSConfig=AWS.aws_config) = sns("ListSubscriptionsByTopic", Dict{String, Any}("TopicArn"=>TopicArn); aws_config=aws_config)
ListSubscriptionsByTopic(TopicArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("ListSubscriptionsByTopic", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TopicArn"=>TopicArn), args)); aws_config=aws_config)
...
ListTagsForResource(ResourceArn; aws_config::AWSConfig=AWS.aws_config) = sns("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config)
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), args)); aws_config=aws_config)
...
ListTopics(; aws_config::AWSConfig=AWS.aws_config) = sns("ListTopics"; aws_config=aws_config)
ListTopics(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("ListTopics", args; aws_config=aws_config)
...
OptInPhoneNumber(phoneNumber; aws_config::AWSConfig=AWS.aws_config) = sns("OptInPhoneNumber", Dict{String, Any}("phoneNumber"=>phoneNumber); aws_config=aws_config)
OptInPhoneNumber(phoneNumber, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("OptInPhoneNumber", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("phoneNumber"=>phoneNumber), args)); aws_config=aws_config)
...
Publish(Message; aws_config::AWSConfig=AWS.aws_config) = sns("Publish", Dict{String, Any}("Message"=>Message); aws_config=aws_config)
Publish(Message, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("Publish", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Message"=>Message), args)); aws_config=aws_config)
...
RemovePermission(Label, TopicArn; aws_config::AWSConfig=AWS.aws_config) = sns("RemovePermission", Dict{String, Any}("Label"=>Label, "TopicArn"=>TopicArn); aws_config=aws_config)
RemovePermission(Label, TopicArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("RemovePermission", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Label"=>Label, "TopicArn"=>TopicArn), args)); aws_config=aws_config)
...
SetEndpointAttributes(Attributes, EndpointArn; aws_config::AWSConfig=AWS.aws_config) = sns("SetEndpointAttributes", Dict{String, Any}("Attributes"=>Attributes, "EndpointArn"=>EndpointArn); aws_config=aws_config)
SetEndpointAttributes(Attributes, EndpointArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("SetEndpointAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Attributes"=>Attributes, "EndpointArn"=>EndpointArn), args)); aws_config=aws_config)
...
SetPlatformApplicationAttributes(Attributes, PlatformApplicationArn; aws_config::AWSConfig=AWS.aws_config) = sns("SetPlatformApplicationAttributes", Dict{String, Any}("Attributes"=>Attributes, "PlatformApplicationArn"=>PlatformApplicationArn); aws_config=aws_config)
SetPlatformApplicationAttributes(Attributes, PlatformApplicationArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("SetPlatformApplicationAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Attributes"=>Attributes, "PlatformApplicationArn"=>PlatformApplicationArn), args)); aws_config=aws_config)
...
SetSMSAttributes(attributes; aws_config::AWSConfig=AWS.aws_config) = sns("SetSMSAttributes", Dict{String, Any}("attributes"=>attributes); aws_config=aws_config)
SetSMSAttributes(attributes, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("SetSMSAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("attributes"=>attributes), args)); aws_config=aws_config)
...
SetSubscriptionAttributes(AttributeName, SubscriptionArn; aws_config::AWSConfig=AWS.aws_config) = sns("SetSubscriptionAttributes", Dict{String, Any}("AttributeName"=>AttributeName, "SubscriptionArn"=>SubscriptionArn); aws_config=aws_config)
SetSubscriptionAttributes(AttributeName, SubscriptionArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("SetSubscriptionAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AttributeName"=>AttributeName, "SubscriptionArn"=>SubscriptionArn), args)); aws_config=aws_config)
...
SetTopicAttributes(AttributeName, TopicArn; aws_config::AWSConfig=AWS.aws_config) = sns("SetTopicAttributes", Dict{String, Any}("AttributeName"=>AttributeName, "TopicArn"=>TopicArn); aws_config=aws_config)
SetTopicAttributes(AttributeName, TopicArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("SetTopicAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AttributeName"=>AttributeName, "TopicArn"=>TopicArn), args)); aws_config=aws_config)
...
Subscribe(Protocol, TopicArn; aws_config::AWSConfig=AWS.aws_config) = sns("Subscribe", Dict{String, Any}("Protocol"=>Protocol, "TopicArn"=>TopicArn); aws_config=aws_config)
Subscribe(Protocol, TopicArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("Subscribe", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Protocol"=>Protocol, "TopicArn"=>TopicArn), args)); aws_config=aws_config)
...
TagResource(ResourceArn, Tags; aws_config::AWSConfig=AWS.aws_config) = sns("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags); aws_config=aws_config)
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags), args)); aws_config=aws_config)
...
Unsubscribe(SubscriptionArn; aws_config::AWSConfig=AWS.aws_config) = sns("Unsubscribe", Dict{String, Any}("SubscriptionArn"=>SubscriptionArn); aws_config=aws_config)
Unsubscribe(SubscriptionArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("Unsubscribe", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SubscriptionArn"=>SubscriptionArn), args)); aws_config=aws_config)
...
UntagResource(ResourceArn, TagKeys; aws_config::AWSConfig=AWS.aws_config) = sns("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys); aws_config=aws_config)
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = sns("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), args)); aws_config=aws_config)
