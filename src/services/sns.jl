...
"""
function opt_in_phone_number(phoneNumber; aws_config::AbstractAWSConfig=current_aws_config())
    return sns(
        "OptInPhoneNumber",
        Dict{String,Any}("phoneNumber" => phoneNumber);
        aws_config=aws_config,
...
function publish(
    Message, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return sns(
        "Publish",
