...
AddRoleToDBCluster(DBClusterIdentifier, RoleArn; aws_config::AWSConfig=AWS.aws_config) = rds("AddRoleToDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "RoleArn"=>RoleArn); aws_config=aws_config)
AddRoleToDBCluster(DBClusterIdentifier, RoleArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("AddRoleToDBCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "RoleArn"=>RoleArn), args)); aws_config=aws_config)
...
AddRoleToDBInstance(DBInstanceIdentifier, FeatureName, RoleArn; aws_config::AWSConfig=AWS.aws_config) = rds("AddRoleToDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "FeatureName"=>FeatureName, "RoleArn"=>RoleArn); aws_config=aws_config)
AddRoleToDBInstance(DBInstanceIdentifier, FeatureName, RoleArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("AddRoleToDBInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "FeatureName"=>FeatureName, "RoleArn"=>RoleArn), args)); aws_config=aws_config)
...
AddSourceIdentifierToSubscription(SourceIdentifier, SubscriptionName; aws_config::AWSConfig=AWS.aws_config) = rds("AddSourceIdentifierToSubscription", Dict{String, Any}("SourceIdentifier"=>SourceIdentifier, "SubscriptionName"=>SubscriptionName); aws_config=aws_config)
AddSourceIdentifierToSubscription(SourceIdentifier, SubscriptionName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("AddSourceIdentifierToSubscription", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SourceIdentifier"=>SourceIdentifier, "SubscriptionName"=>SubscriptionName), args)); aws_config=aws_config)
...
AddTagsToResource(ResourceName, Tag; aws_config::AWSConfig=AWS.aws_config) = rds("AddTagsToResource", Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag); aws_config=aws_config)
AddTagsToResource(ResourceName, Tag, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("AddTagsToResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag), args)); aws_config=aws_config)
...
ApplyPendingMaintenanceAction(ApplyAction, OptInType, ResourceIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("ApplyPendingMaintenanceAction", Dict{String, Any}("ApplyAction"=>ApplyAction, "OptInType"=>OptInType, "ResourceIdentifier"=>ResourceIdentifier); aws_config=aws_config)
ApplyPendingMaintenanceAction(ApplyAction, OptInType, ResourceIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ApplyPendingMaintenanceAction", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplyAction"=>ApplyAction, "OptInType"=>OptInType, "ResourceIdentifier"=>ResourceIdentifier), args)); aws_config=aws_config)
...
AuthorizeDBSecurityGroupIngress(DBSecurityGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("AuthorizeDBSecurityGroupIngress", Dict{String, Any}("DBSecurityGroupName"=>DBSecurityGroupName); aws_config=aws_config)
AuthorizeDBSecurityGroupIngress(DBSecurityGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("AuthorizeDBSecurityGroupIngress", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBSecurityGroupName"=>DBSecurityGroupName), args)); aws_config=aws_config)
...
BacktrackDBCluster(BacktrackTo, DBClusterIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("BacktrackDBCluster", Dict{String, Any}("BacktrackTo"=>BacktrackTo, "DBClusterIdentifier"=>DBClusterIdentifier); aws_config=aws_config)
BacktrackDBCluster(BacktrackTo, DBClusterIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("BacktrackDBCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BacktrackTo"=>BacktrackTo, "DBClusterIdentifier"=>DBClusterIdentifier), args)); aws_config=aws_config)
...
CancelExportTask(ExportTaskIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("CancelExportTask", Dict{String, Any}("ExportTaskIdentifier"=>ExportTaskIdentifier); aws_config=aws_config)
CancelExportTask(ExportTaskIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CancelExportTask", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ExportTaskIdentifier"=>ExportTaskIdentifier), args)); aws_config=aws_config)
...
CopyDBClusterParameterGroup(SourceDBClusterParameterGroupIdentifier, TargetDBClusterParameterGroupDescription, TargetDBClusterParameterGroupIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("CopyDBClusterParameterGroup", Dict{String, Any}("SourceDBClusterParameterGroupIdentifier"=>SourceDBClusterParameterGroupIdentifier, "TargetDBClusterParameterGroupDescription"=>TargetDBClusterParameterGroupDescription, "TargetDBClusterParameterGroupIdentifier"=>TargetDBClusterParameterGroupIdentifier); aws_config=aws_config)
CopyDBClusterParameterGroup(SourceDBClusterParameterGroupIdentifier, TargetDBClusterParameterGroupDescription, TargetDBClusterParameterGroupIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CopyDBClusterParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SourceDBClusterParameterGroupIdentifier"=>SourceDBClusterParameterGroupIdentifier, "TargetDBClusterParameterGroupDescription"=>TargetDBClusterParameterGroupDescription, "TargetDBClusterParameterGroupIdentifier"=>TargetDBClusterParameterGroupIdentifier), args)); aws_config=aws_config)
...
CopyDBClusterSnapshot(SourceDBClusterSnapshotIdentifier, TargetDBClusterSnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("CopyDBClusterSnapshot", Dict{String, Any}("SourceDBClusterSnapshotIdentifier"=>SourceDBClusterSnapshotIdentifier, "TargetDBClusterSnapshotIdentifier"=>TargetDBClusterSnapshotIdentifier); aws_config=aws_config)
CopyDBClusterSnapshot(SourceDBClusterSnapshotIdentifier, TargetDBClusterSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CopyDBClusterSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SourceDBClusterSnapshotIdentifier"=>SourceDBClusterSnapshotIdentifier, "TargetDBClusterSnapshotIdentifier"=>TargetDBClusterSnapshotIdentifier), args)); aws_config=aws_config)
...
CopyDBParameterGroup(SourceDBParameterGroupIdentifier, TargetDBParameterGroupDescription, TargetDBParameterGroupIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("CopyDBParameterGroup", Dict{String, Any}("SourceDBParameterGroupIdentifier"=>SourceDBParameterGroupIdentifier, "TargetDBParameterGroupDescription"=>TargetDBParameterGroupDescription, "TargetDBParameterGroupIdentifier"=>TargetDBParameterGroupIdentifier); aws_config=aws_config)
CopyDBParameterGroup(SourceDBParameterGroupIdentifier, TargetDBParameterGroupDescription, TargetDBParameterGroupIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CopyDBParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SourceDBParameterGroupIdentifier"=>SourceDBParameterGroupIdentifier, "TargetDBParameterGroupDescription"=>TargetDBParameterGroupDescription, "TargetDBParameterGroupIdentifier"=>TargetDBParameterGroupIdentifier), args)); aws_config=aws_config)
...
CopyDBSnapshot(SourceDBSnapshotIdentifier, TargetDBSnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("CopyDBSnapshot", Dict{String, Any}("SourceDBSnapshotIdentifier"=>SourceDBSnapshotIdentifier, "TargetDBSnapshotIdentifier"=>TargetDBSnapshotIdentifier); aws_config=aws_config)
CopyDBSnapshot(SourceDBSnapshotIdentifier, TargetDBSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CopyDBSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SourceDBSnapshotIdentifier"=>SourceDBSnapshotIdentifier, "TargetDBSnapshotIdentifier"=>TargetDBSnapshotIdentifier), args)); aws_config=aws_config)
...
CopyOptionGroup(SourceOptionGroupIdentifier, TargetOptionGroupDescription, TargetOptionGroupIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("CopyOptionGroup", Dict{String, Any}("SourceOptionGroupIdentifier"=>SourceOptionGroupIdentifier, "TargetOptionGroupDescription"=>TargetOptionGroupDescription, "TargetOptionGroupIdentifier"=>TargetOptionGroupIdentifier); aws_config=aws_config)
CopyOptionGroup(SourceOptionGroupIdentifier, TargetOptionGroupDescription, TargetOptionGroupIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CopyOptionGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SourceOptionGroupIdentifier"=>SourceOptionGroupIdentifier, "TargetOptionGroupDescription"=>TargetOptionGroupDescription, "TargetOptionGroupIdentifier"=>TargetOptionGroupIdentifier), args)); aws_config=aws_config)
...
CreateCustomAvailabilityZone(CustomAvailabilityZoneName; aws_config::AWSConfig=AWS.aws_config) = rds("CreateCustomAvailabilityZone", Dict{String, Any}("CustomAvailabilityZoneName"=>CustomAvailabilityZoneName); aws_config=aws_config)
CreateCustomAvailabilityZone(CustomAvailabilityZoneName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateCustomAvailabilityZone", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CustomAvailabilityZoneName"=>CustomAvailabilityZoneName), args)); aws_config=aws_config)
...
CreateDBCluster(DBClusterIdentifier, Engine; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine); aws_config=aws_config)
CreateDBCluster(DBClusterIdentifier, Engine, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine), args)); aws_config=aws_config)
...
CreateDBClusterEndpoint(DBClusterEndpointIdentifier, DBClusterIdentifier, EndpointType; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBClusterEndpoint", Dict{String, Any}("DBClusterEndpointIdentifier"=>DBClusterEndpointIdentifier, "DBClusterIdentifier"=>DBClusterIdentifier, "EndpointType"=>EndpointType); aws_config=aws_config)
CreateDBClusterEndpoint(DBClusterEndpointIdentifier, DBClusterIdentifier, EndpointType, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBClusterEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterEndpointIdentifier"=>DBClusterEndpointIdentifier, "DBClusterIdentifier"=>DBClusterIdentifier, "EndpointType"=>EndpointType), args)); aws_config=aws_config)
...
CreateDBClusterParameterGroup(DBClusterParameterGroupName, DBParameterGroupFamily, Description; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "DBParameterGroupFamily"=>DBParameterGroupFamily, "Description"=>Description); aws_config=aws_config)
CreateDBClusterParameterGroup(DBClusterParameterGroupName, DBParameterGroupFamily, Description, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBClusterParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "DBParameterGroupFamily"=>DBParameterGroupFamily, "Description"=>Description), args)); aws_config=aws_config)
...
CreateDBClusterSnapshot(DBClusterIdentifier, DBClusterSnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBClusterSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier); aws_config=aws_config)
CreateDBClusterSnapshot(DBClusterIdentifier, DBClusterSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBClusterSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier), args)); aws_config=aws_config)
...
CreateDBInstance(DBInstanceClass, DBInstanceIdentifier, Engine; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBInstance", Dict{String, Any}("DBInstanceClass"=>DBInstanceClass, "DBInstanceIdentifier"=>DBInstanceIdentifier, "Engine"=>Engine); aws_config=aws_config)
CreateDBInstance(DBInstanceClass, DBInstanceIdentifier, Engine, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceClass"=>DBInstanceClass, "DBInstanceIdentifier"=>DBInstanceIdentifier, "Engine"=>Engine), args)); aws_config=aws_config)
...
CreateDBInstanceReadReplica(DBInstanceIdentifier, SourceDBInstanceIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBInstanceReadReplica", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "SourceDBInstanceIdentifier"=>SourceDBInstanceIdentifier); aws_config=aws_config)
CreateDBInstanceReadReplica(DBInstanceIdentifier, SourceDBInstanceIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBInstanceReadReplica", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "SourceDBInstanceIdentifier"=>SourceDBInstanceIdentifier), args)); aws_config=aws_config)
...
CreateDBParameterGroup(DBParameterGroupFamily, DBParameterGroupName, Description; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBParameterGroup", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily, "DBParameterGroupName"=>DBParameterGroupName, "Description"=>Description); aws_config=aws_config)
CreateDBParameterGroup(DBParameterGroupFamily, DBParameterGroupName, Description, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily, "DBParameterGroupName"=>DBParameterGroupName, "Description"=>Description), args)); aws_config=aws_config)
...
CreateDBProxy(Auth, DBProxyName, EngineFamily, RoleArn, VpcSubnetIds; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBProxy", Dict{String, Any}("Auth"=>Auth, "DBProxyName"=>DBProxyName, "EngineFamily"=>EngineFamily, "RoleArn"=>RoleArn, "VpcSubnetIds"=>VpcSubnetIds); aws_config=aws_config)
CreateDBProxy(Auth, DBProxyName, EngineFamily, RoleArn, VpcSubnetIds, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBProxy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Auth"=>Auth, "DBProxyName"=>DBProxyName, "EngineFamily"=>EngineFamily, "RoleArn"=>RoleArn, "VpcSubnetIds"=>VpcSubnetIds), args)); aws_config=aws_config)
...
CreateDBSecurityGroup(DBSecurityGroupDescription, DBSecurityGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBSecurityGroup", Dict{String, Any}("DBSecurityGroupDescription"=>DBSecurityGroupDescription, "DBSecurityGroupName"=>DBSecurityGroupName); aws_config=aws_config)
CreateDBSecurityGroup(DBSecurityGroupDescription, DBSecurityGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBSecurityGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBSecurityGroupDescription"=>DBSecurityGroupDescription, "DBSecurityGroupName"=>DBSecurityGroupName), args)); aws_config=aws_config)
...
CreateDBSnapshot(DBInstanceIdentifier, DBSnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBSnapshot", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "DBSnapshotIdentifier"=>DBSnapshotIdentifier); aws_config=aws_config)
CreateDBSnapshot(DBInstanceIdentifier, DBSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "DBSnapshotIdentifier"=>DBSnapshotIdentifier), args)); aws_config=aws_config)
...
CreateDBSubnetGroup(DBSubnetGroupDescription, DBSubnetGroupName, SubnetIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBSubnetGroup", Dict{String, Any}("DBSubnetGroupDescription"=>DBSubnetGroupDescription, "DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier); aws_config=aws_config)
CreateDBSubnetGroup(DBSubnetGroupDescription, DBSubnetGroupName, SubnetIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateDBSubnetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBSubnetGroupDescription"=>DBSubnetGroupDescription, "DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier), args)); aws_config=aws_config)
...
CreateEventSubscription(SnsTopicArn, SubscriptionName; aws_config::AWSConfig=AWS.aws_config) = rds("CreateEventSubscription", Dict{String, Any}("SnsTopicArn"=>SnsTopicArn, "SubscriptionName"=>SubscriptionName); aws_config=aws_config)
CreateEventSubscription(SnsTopicArn, SubscriptionName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateEventSubscription", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SnsTopicArn"=>SnsTopicArn, "SubscriptionName"=>SubscriptionName), args)); aws_config=aws_config)
...
CreateGlobalCluster(; aws_config::AWSConfig=AWS.aws_config) = rds("CreateGlobalCluster"; aws_config=aws_config)
CreateGlobalCluster(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("CreateGlobalCluster", args; aws_config=aws_config)
...
DeleteCustomAvailabilityZone(CustomAvailabilityZoneId; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteCustomAvailabilityZone", Dict{String, Any}("CustomAvailabilityZoneId"=>CustomAvailabilityZoneId); aws_config=aws_config)
DeleteCustomAvailabilityZone(CustomAvailabilityZoneId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteCustomAvailabilityZone", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CustomAvailabilityZoneId"=>CustomAvailabilityZoneId), args)); aws_config=aws_config)
...
DeleteDBCluster(DBClusterIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier); aws_config=aws_config)
DeleteDBCluster(DBClusterIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier), args)); aws_config=aws_config)
...
DeleteDBClusterEndpoint(DBClusterEndpointIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBClusterEndpoint", Dict{String, Any}("DBClusterEndpointIdentifier"=>DBClusterEndpointIdentifier); aws_config=aws_config)
DeleteDBClusterEndpoint(DBClusterEndpointIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBClusterEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterEndpointIdentifier"=>DBClusterEndpointIdentifier), args)); aws_config=aws_config)
...
DeleteDBClusterParameterGroup(DBClusterParameterGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName); aws_config=aws_config)
DeleteDBClusterParameterGroup(DBClusterParameterGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBClusterParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName), args)); aws_config=aws_config)
...
DeleteDBClusterSnapshot(DBClusterSnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBClusterSnapshot", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier); aws_config=aws_config)
DeleteDBClusterSnapshot(DBClusterSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBClusterSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier), args)); aws_config=aws_config)
...
DeleteDBInstance(DBInstanceIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier); aws_config=aws_config)
DeleteDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier), args)); aws_config=aws_config)
...
DeleteDBInstanceAutomatedBackup(DbiResourceId; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBInstanceAutomatedBackup", Dict{String, Any}("DbiResourceId"=>DbiResourceId); aws_config=aws_config)
DeleteDBInstanceAutomatedBackup(DbiResourceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBInstanceAutomatedBackup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DbiResourceId"=>DbiResourceId), args)); aws_config=aws_config)
...
DeleteDBParameterGroup(DBParameterGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName); aws_config=aws_config)
DeleteDBParameterGroup(DBParameterGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName), args)); aws_config=aws_config)
...
DeleteDBProxy(DBProxyName; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBProxy", Dict{String, Any}("DBProxyName"=>DBProxyName); aws_config=aws_config)
DeleteDBProxy(DBProxyName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBProxy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBProxyName"=>DBProxyName), args)); aws_config=aws_config)
...
DeleteDBSecurityGroup(DBSecurityGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBSecurityGroup", Dict{String, Any}("DBSecurityGroupName"=>DBSecurityGroupName); aws_config=aws_config)
DeleteDBSecurityGroup(DBSecurityGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBSecurityGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBSecurityGroupName"=>DBSecurityGroupName), args)); aws_config=aws_config)
...
DeleteDBSnapshot(DBSnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBSnapshot", Dict{String, Any}("DBSnapshotIdentifier"=>DBSnapshotIdentifier); aws_config=aws_config)
DeleteDBSnapshot(DBSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBSnapshotIdentifier"=>DBSnapshotIdentifier), args)); aws_config=aws_config)
...
DeleteDBSubnetGroup(DBSubnetGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName); aws_config=aws_config)
DeleteDBSubnetGroup(DBSubnetGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteDBSubnetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName), args)); aws_config=aws_config)
...
DeleteEventSubscription(SubscriptionName; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName); aws_config=aws_config)
DeleteEventSubscription(SubscriptionName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteEventSubscription", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SubscriptionName"=>SubscriptionName), args)); aws_config=aws_config)
...
DeleteGlobalCluster(GlobalClusterIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteGlobalCluster", Dict{String, Any}("GlobalClusterIdentifier"=>GlobalClusterIdentifier); aws_config=aws_config)
DeleteGlobalCluster(GlobalClusterIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteGlobalCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("GlobalClusterIdentifier"=>GlobalClusterIdentifier), args)); aws_config=aws_config)
...
DeleteInstallationMedia(InstallationMediaId; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteInstallationMedia", Dict{String, Any}("InstallationMediaId"=>InstallationMediaId); aws_config=aws_config)
DeleteInstallationMedia(InstallationMediaId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteInstallationMedia", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstallationMediaId"=>InstallationMediaId), args)); aws_config=aws_config)
...
DeleteOptionGroup(OptionGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteOptionGroup", Dict{String, Any}("OptionGroupName"=>OptionGroupName); aws_config=aws_config)
DeleteOptionGroup(OptionGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeleteOptionGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("OptionGroupName"=>OptionGroupName), args)); aws_config=aws_config)
...
DeregisterDBProxyTargets(DBProxyName; aws_config::AWSConfig=AWS.aws_config) = rds("DeregisterDBProxyTargets", Dict{String, Any}("DBProxyName"=>DBProxyName); aws_config=aws_config)
DeregisterDBProxyTargets(DBProxyName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DeregisterDBProxyTargets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBProxyName"=>DBProxyName), args)); aws_config=aws_config)
...
DescribeAccountAttributes(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeAccountAttributes"; aws_config=aws_config)
DescribeAccountAttributes(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeAccountAttributes", args; aws_config=aws_config)
...
DescribeCertificates(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeCertificates"; aws_config=aws_config)
DescribeCertificates(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeCertificates", args; aws_config=aws_config)
...
DescribeCustomAvailabilityZones(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeCustomAvailabilityZones"; aws_config=aws_config)
DescribeCustomAvailabilityZones(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeCustomAvailabilityZones", args; aws_config=aws_config)
...
DescribeDBClusterBacktracks(DBClusterIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusterBacktracks", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier); aws_config=aws_config)
DescribeDBClusterBacktracks(DBClusterIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusterBacktracks", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier), args)); aws_config=aws_config)
...
DescribeDBClusterEndpoints(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusterEndpoints"; aws_config=aws_config)
DescribeDBClusterEndpoints(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusterEndpoints", args; aws_config=aws_config)
...
DescribeDBClusterParameterGroups(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusterParameterGroups"; aws_config=aws_config)
DescribeDBClusterParameterGroups(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusterParameterGroups", args; aws_config=aws_config)
...
DescribeDBClusterParameters(DBClusterParameterGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusterParameters", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName); aws_config=aws_config)
DescribeDBClusterParameters(DBClusterParameterGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusterParameters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName), args)); aws_config=aws_config)
...
DescribeDBClusterSnapshotAttributes(DBClusterSnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusterSnapshotAttributes", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier); aws_config=aws_config)
DescribeDBClusterSnapshotAttributes(DBClusterSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusterSnapshotAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier), args)); aws_config=aws_config)
...
DescribeDBClusterSnapshots(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusterSnapshots"; aws_config=aws_config)
DescribeDBClusterSnapshots(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusterSnapshots", args; aws_config=aws_config)
...
DescribeDBClusters(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusters"; aws_config=aws_config)
DescribeDBClusters(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBClusters", args; aws_config=aws_config)
...
DescribeDBEngineVersions(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBEngineVersions"; aws_config=aws_config)
DescribeDBEngineVersions(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBEngineVersions", args; aws_config=aws_config)
...
DescribeDBInstanceAutomatedBackups(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBInstanceAutomatedBackups"; aws_config=aws_config)
DescribeDBInstanceAutomatedBackups(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBInstanceAutomatedBackups", args; aws_config=aws_config)
...
DescribeDBInstances(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBInstances"; aws_config=aws_config)
DescribeDBInstances(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBInstances", args; aws_config=aws_config)
...
DescribeDBLogFiles(DBInstanceIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBLogFiles", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier); aws_config=aws_config)
DescribeDBLogFiles(DBInstanceIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBLogFiles", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier), args)); aws_config=aws_config)
...
DescribeDBParameterGroups(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBParameterGroups"; aws_config=aws_config)
DescribeDBParameterGroups(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBParameterGroups", args; aws_config=aws_config)
...
DescribeDBParameters(DBParameterGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBParameters", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName); aws_config=aws_config)
DescribeDBParameters(DBParameterGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBParameters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName), args)); aws_config=aws_config)
...
DescribeDBProxies(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBProxies"; aws_config=aws_config)
DescribeDBProxies(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBProxies", args; aws_config=aws_config)
...
DescribeDBProxyTargetGroups(DBProxyName; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBProxyTargetGroups", Dict{String, Any}("DBProxyName"=>DBProxyName); aws_config=aws_config)
DescribeDBProxyTargetGroups(DBProxyName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBProxyTargetGroups", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBProxyName"=>DBProxyName), args)); aws_config=aws_config)
...
DescribeDBProxyTargets(DBProxyName; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBProxyTargets", Dict{String, Any}("DBProxyName"=>DBProxyName); aws_config=aws_config)
DescribeDBProxyTargets(DBProxyName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBProxyTargets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBProxyName"=>DBProxyName), args)); aws_config=aws_config)
...
DescribeDBSecurityGroups(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBSecurityGroups"; aws_config=aws_config)
DescribeDBSecurityGroups(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBSecurityGroups", args; aws_config=aws_config)
...
DescribeDBSnapshotAttributes(DBSnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBSnapshotAttributes", Dict{String, Any}("DBSnapshotIdentifier"=>DBSnapshotIdentifier); aws_config=aws_config)
DescribeDBSnapshotAttributes(DBSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBSnapshotAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBSnapshotIdentifier"=>DBSnapshotIdentifier), args)); aws_config=aws_config)
...
DescribeDBSnapshots(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBSnapshots"; aws_config=aws_config)
DescribeDBSnapshots(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBSnapshots", args; aws_config=aws_config)
...
DescribeDBSubnetGroups(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBSubnetGroups"; aws_config=aws_config)
DescribeDBSubnetGroups(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeDBSubnetGroups", args; aws_config=aws_config)
...
DescribeEngineDefaultClusterParameters(DBParameterGroupFamily; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeEngineDefaultClusterParameters", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily); aws_config=aws_config)
DescribeEngineDefaultClusterParameters(DBParameterGroupFamily, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeEngineDefaultClusterParameters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily), args)); aws_config=aws_config)
...
DescribeEngineDefaultParameters(DBParameterGroupFamily; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeEngineDefaultParameters", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily); aws_config=aws_config)
DescribeEngineDefaultParameters(DBParameterGroupFamily, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeEngineDefaultParameters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily), args)); aws_config=aws_config)
...
DescribeEventCategories(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeEventCategories"; aws_config=aws_config)
DescribeEventCategories(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeEventCategories", args; aws_config=aws_config)
...
DescribeEventSubscriptions(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeEventSubscriptions"; aws_config=aws_config)
DescribeEventSubscriptions(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeEventSubscriptions", args; aws_config=aws_config)
...
DescribeEvents(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeEvents"; aws_config=aws_config)
DescribeEvents(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeEvents", args; aws_config=aws_config)
...
DescribeExportTasks(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeExportTasks"; aws_config=aws_config)
DescribeExportTasks(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeExportTasks", args; aws_config=aws_config)
...
DescribeGlobalClusters(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeGlobalClusters"; aws_config=aws_config)
DescribeGlobalClusters(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeGlobalClusters", args; aws_config=aws_config)
...
DescribeInstallationMedia(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeInstallationMedia"; aws_config=aws_config)
DescribeInstallationMedia(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeInstallationMedia", args; aws_config=aws_config)
...
DescribeOptionGroupOptions(EngineName; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeOptionGroupOptions", Dict{String, Any}("EngineName"=>EngineName); aws_config=aws_config)
DescribeOptionGroupOptions(EngineName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeOptionGroupOptions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EngineName"=>EngineName), args)); aws_config=aws_config)
...
DescribeOptionGroups(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeOptionGroups"; aws_config=aws_config)
DescribeOptionGroups(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeOptionGroups", args; aws_config=aws_config)
...
DescribeOrderableDBInstanceOptions(Engine; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeOrderableDBInstanceOptions", Dict{String, Any}("Engine"=>Engine); aws_config=aws_config)
DescribeOrderableDBInstanceOptions(Engine, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeOrderableDBInstanceOptions", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Engine"=>Engine), args)); aws_config=aws_config)
...
DescribePendingMaintenanceActions(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribePendingMaintenanceActions"; aws_config=aws_config)
DescribePendingMaintenanceActions(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribePendingMaintenanceActions", args; aws_config=aws_config)
...
DescribeReservedDBInstances(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeReservedDBInstances"; aws_config=aws_config)
DescribeReservedDBInstances(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeReservedDBInstances", args; aws_config=aws_config)
...
DescribeReservedDBInstancesOfferings(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeReservedDBInstancesOfferings"; aws_config=aws_config)
DescribeReservedDBInstancesOfferings(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeReservedDBInstancesOfferings", args; aws_config=aws_config)
...
DescribeSourceRegions(; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeSourceRegions"; aws_config=aws_config)
DescribeSourceRegions(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeSourceRegions", args; aws_config=aws_config)
...
DescribeValidDBInstanceModifications(DBInstanceIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeValidDBInstanceModifications", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier); aws_config=aws_config)
DescribeValidDBInstanceModifications(DBInstanceIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DescribeValidDBInstanceModifications", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier), args)); aws_config=aws_config)
...
DownloadDBLogFilePortion(DBInstanceIdentifier, LogFileName; aws_config::AWSConfig=AWS.aws_config) = rds("DownloadDBLogFilePortion", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "LogFileName"=>LogFileName); aws_config=aws_config)
DownloadDBLogFilePortion(DBInstanceIdentifier, LogFileName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("DownloadDBLogFilePortion", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "LogFileName"=>LogFileName), args)); aws_config=aws_config)
...
FailoverDBCluster(DBClusterIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("FailoverDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier); aws_config=aws_config)
FailoverDBCluster(DBClusterIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("FailoverDBCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier), args)); aws_config=aws_config)
...
ListTagsForResource(ResourceName; aws_config::AWSConfig=AWS.aws_config) = rds("ListTagsForResource", Dict{String, Any}("ResourceName"=>ResourceName); aws_config=aws_config)
ListTagsForResource(ResourceName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceName"=>ResourceName), args)); aws_config=aws_config)
...
ModifyCertificates(; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyCertificates"; aws_config=aws_config)
ModifyCertificates(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyCertificates", args; aws_config=aws_config)
...
ModifyCurrentDBClusterCapacity(DBClusterIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyCurrentDBClusterCapacity", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier); aws_config=aws_config)
ModifyCurrentDBClusterCapacity(DBClusterIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyCurrentDBClusterCapacity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier), args)); aws_config=aws_config)
...
ModifyDBCluster(DBClusterIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier); aws_config=aws_config)
ModifyDBCluster(DBClusterIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier), args)); aws_config=aws_config)
...
ModifyDBClusterEndpoint(DBClusterEndpointIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBClusterEndpoint", Dict{String, Any}("DBClusterEndpointIdentifier"=>DBClusterEndpointIdentifier); aws_config=aws_config)
ModifyDBClusterEndpoint(DBClusterEndpointIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBClusterEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterEndpointIdentifier"=>DBClusterEndpointIdentifier), args)); aws_config=aws_config)
...
ModifyDBClusterParameterGroup(DBClusterParameterGroupName, Parameter; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "Parameter"=>Parameter); aws_config=aws_config)
ModifyDBClusterParameterGroup(DBClusterParameterGroupName, Parameter, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBClusterParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "Parameter"=>Parameter), args)); aws_config=aws_config)
...
ModifyDBClusterSnapshotAttribute(AttributeName, DBClusterSnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBClusterSnapshotAttribute", Dict{String, Any}("AttributeName"=>AttributeName, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier); aws_config=aws_config)
ModifyDBClusterSnapshotAttribute(AttributeName, DBClusterSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBClusterSnapshotAttribute", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AttributeName"=>AttributeName, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier), args)); aws_config=aws_config)
...
ModifyDBInstance(DBInstanceIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier); aws_config=aws_config)
ModifyDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier), args)); aws_config=aws_config)
...
ModifyDBParameterGroup(DBParameterGroupName, Parameter; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName, "Parameter"=>Parameter); aws_config=aws_config)
ModifyDBParameterGroup(DBParameterGroupName, Parameter, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName, "Parameter"=>Parameter), args)); aws_config=aws_config)
...
ModifyDBProxy(DBProxyName; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBProxy", Dict{String, Any}("DBProxyName"=>DBProxyName); aws_config=aws_config)
ModifyDBProxy(DBProxyName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBProxy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBProxyName"=>DBProxyName), args)); aws_config=aws_config)
...
ModifyDBProxyTargetGroup(DBProxyName, TargetGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBProxyTargetGroup", Dict{String, Any}("DBProxyName"=>DBProxyName, "TargetGroupName"=>TargetGroupName); aws_config=aws_config)
ModifyDBProxyTargetGroup(DBProxyName, TargetGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBProxyTargetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBProxyName"=>DBProxyName, "TargetGroupName"=>TargetGroupName), args)); aws_config=aws_config)
...
ModifyDBSnapshot(DBSnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBSnapshot", Dict{String, Any}("DBSnapshotIdentifier"=>DBSnapshotIdentifier); aws_config=aws_config)
ModifyDBSnapshot(DBSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBSnapshotIdentifier"=>DBSnapshotIdentifier), args)); aws_config=aws_config)
...
ModifyDBSnapshotAttribute(AttributeName, DBSnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBSnapshotAttribute", Dict{String, Any}("AttributeName"=>AttributeName, "DBSnapshotIdentifier"=>DBSnapshotIdentifier); aws_config=aws_config)
ModifyDBSnapshotAttribute(AttributeName, DBSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBSnapshotAttribute", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AttributeName"=>AttributeName, "DBSnapshotIdentifier"=>DBSnapshotIdentifier), args)); aws_config=aws_config)
...
ModifyDBSubnetGroup(DBSubnetGroupName, SubnetIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier); aws_config=aws_config)
ModifyDBSubnetGroup(DBSubnetGroupName, SubnetIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyDBSubnetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier), args)); aws_config=aws_config)
...
ModifyEventSubscription(SubscriptionName; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName); aws_config=aws_config)
ModifyEventSubscription(SubscriptionName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyEventSubscription", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SubscriptionName"=>SubscriptionName), args)); aws_config=aws_config)
...
ModifyGlobalCluster(; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyGlobalCluster"; aws_config=aws_config)
ModifyGlobalCluster(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyGlobalCluster", args; aws_config=aws_config)
...
ModifyOptionGroup(OptionGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyOptionGroup", Dict{String, Any}("OptionGroupName"=>OptionGroupName); aws_config=aws_config)
ModifyOptionGroup(OptionGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ModifyOptionGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("OptionGroupName"=>OptionGroupName), args)); aws_config=aws_config)
...
PromoteReadReplica(DBInstanceIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("PromoteReadReplica", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier); aws_config=aws_config)
PromoteReadReplica(DBInstanceIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("PromoteReadReplica", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier), args)); aws_config=aws_config)
...
PromoteReadReplicaDBCluster(DBClusterIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("PromoteReadReplicaDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier); aws_config=aws_config)
PromoteReadReplicaDBCluster(DBClusterIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("PromoteReadReplicaDBCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier), args)); aws_config=aws_config)
...
PurchaseReservedDBInstancesOffering(ReservedDBInstancesOfferingId; aws_config::AWSConfig=AWS.aws_config) = rds("PurchaseReservedDBInstancesOffering", Dict{String, Any}("ReservedDBInstancesOfferingId"=>ReservedDBInstancesOfferingId); aws_config=aws_config)
PurchaseReservedDBInstancesOffering(ReservedDBInstancesOfferingId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("PurchaseReservedDBInstancesOffering", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ReservedDBInstancesOfferingId"=>ReservedDBInstancesOfferingId), args)); aws_config=aws_config)
...
RebootDBInstance(DBInstanceIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("RebootDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier); aws_config=aws_config)
RebootDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RebootDBInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier), args)); aws_config=aws_config)
...
RegisterDBProxyTargets(DBProxyName; aws_config::AWSConfig=AWS.aws_config) = rds("RegisterDBProxyTargets", Dict{String, Any}("DBProxyName"=>DBProxyName); aws_config=aws_config)
RegisterDBProxyTargets(DBProxyName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RegisterDBProxyTargets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBProxyName"=>DBProxyName), args)); aws_config=aws_config)
...
RemoveFromGlobalCluster(; aws_config::AWSConfig=AWS.aws_config) = rds("RemoveFromGlobalCluster"; aws_config=aws_config)
RemoveFromGlobalCluster(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RemoveFromGlobalCluster", args; aws_config=aws_config)
...
RemoveRoleFromDBCluster(DBClusterIdentifier, RoleArn; aws_config::AWSConfig=AWS.aws_config) = rds("RemoveRoleFromDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "RoleArn"=>RoleArn); aws_config=aws_config)
RemoveRoleFromDBCluster(DBClusterIdentifier, RoleArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RemoveRoleFromDBCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "RoleArn"=>RoleArn), args)); aws_config=aws_config)
...
RemoveRoleFromDBInstance(DBInstanceIdentifier, FeatureName, RoleArn; aws_config::AWSConfig=AWS.aws_config) = rds("RemoveRoleFromDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "FeatureName"=>FeatureName, "RoleArn"=>RoleArn); aws_config=aws_config)
RemoveRoleFromDBInstance(DBInstanceIdentifier, FeatureName, RoleArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RemoveRoleFromDBInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "FeatureName"=>FeatureName, "RoleArn"=>RoleArn), args)); aws_config=aws_config)
...
RemoveSourceIdentifierFromSubscription(SourceIdentifier, SubscriptionName; aws_config::AWSConfig=AWS.aws_config) = rds("RemoveSourceIdentifierFromSubscription", Dict{String, Any}("SourceIdentifier"=>SourceIdentifier, "SubscriptionName"=>SubscriptionName); aws_config=aws_config)
RemoveSourceIdentifierFromSubscription(SourceIdentifier, SubscriptionName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RemoveSourceIdentifierFromSubscription", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SourceIdentifier"=>SourceIdentifier, "SubscriptionName"=>SubscriptionName), args)); aws_config=aws_config)
...
RemoveTagsFromResource(ResourceName, TagKeys; aws_config::AWSConfig=AWS.aws_config) = rds("RemoveTagsFromResource", Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys); aws_config=aws_config)
RemoveTagsFromResource(ResourceName, TagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RemoveTagsFromResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys), args)); aws_config=aws_config)
...
ResetDBClusterParameterGroup(DBClusterParameterGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("ResetDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName); aws_config=aws_config)
ResetDBClusterParameterGroup(DBClusterParameterGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ResetDBClusterParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName), args)); aws_config=aws_config)
...
ResetDBParameterGroup(DBParameterGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("ResetDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName); aws_config=aws_config)
ResetDBParameterGroup(DBParameterGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("ResetDBParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName), args)); aws_config=aws_config)
...
RestoreDBClusterFromS3(DBClusterIdentifier, Engine, MasterUserPassword, MasterUsername, S3BucketName, S3IngestionRoleArn, SourceEngine, SourceEngineVersion; aws_config::AWSConfig=AWS.aws_config) = rds("RestoreDBClusterFromS3", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "MasterUserPassword"=>MasterUserPassword, "MasterUsername"=>MasterUsername, "S3BucketName"=>S3BucketName, "S3IngestionRoleArn"=>S3IngestionRoleArn, "SourceEngine"=>SourceEngine, "SourceEngineVersion"=>SourceEngineVersion); aws_config=aws_config)
RestoreDBClusterFromS3(DBClusterIdentifier, Engine, MasterUserPassword, MasterUsername, S3BucketName, S3IngestionRoleArn, SourceEngine, SourceEngineVersion, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RestoreDBClusterFromS3", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "MasterUserPassword"=>MasterUserPassword, "MasterUsername"=>MasterUsername, "S3BucketName"=>S3BucketName, "S3IngestionRoleArn"=>S3IngestionRoleArn, "SourceEngine"=>SourceEngine, "SourceEngineVersion"=>SourceEngineVersion), args)); aws_config=aws_config)
...
RestoreDBClusterFromSnapshot(DBClusterIdentifier, Engine, SnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("RestoreDBClusterFromSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "SnapshotIdentifier"=>SnapshotIdentifier); aws_config=aws_config)
RestoreDBClusterFromSnapshot(DBClusterIdentifier, Engine, SnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RestoreDBClusterFromSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "SnapshotIdentifier"=>SnapshotIdentifier), args)); aws_config=aws_config)
...
RestoreDBClusterToPointInTime(DBClusterIdentifier, SourceDBClusterIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("RestoreDBClusterToPointInTime", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "SourceDBClusterIdentifier"=>SourceDBClusterIdentifier); aws_config=aws_config)
RestoreDBClusterToPointInTime(DBClusterIdentifier, SourceDBClusterIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RestoreDBClusterToPointInTime", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "SourceDBClusterIdentifier"=>SourceDBClusterIdentifier), args)); aws_config=aws_config)
...
RestoreDBInstanceFromDBSnapshot(DBInstanceIdentifier, DBSnapshotIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("RestoreDBInstanceFromDBSnapshot", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "DBSnapshotIdentifier"=>DBSnapshotIdentifier); aws_config=aws_config)
RestoreDBInstanceFromDBSnapshot(DBInstanceIdentifier, DBSnapshotIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RestoreDBInstanceFromDBSnapshot", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "DBSnapshotIdentifier"=>DBSnapshotIdentifier), args)); aws_config=aws_config)
...
RestoreDBInstanceFromS3(DBInstanceClass, DBInstanceIdentifier, Engine, S3BucketName, S3IngestionRoleArn, SourceEngine, SourceEngineVersion; aws_config::AWSConfig=AWS.aws_config) = rds("RestoreDBInstanceFromS3", Dict{String, Any}("DBInstanceClass"=>DBInstanceClass, "DBInstanceIdentifier"=>DBInstanceIdentifier, "Engine"=>Engine, "S3BucketName"=>S3BucketName, "S3IngestionRoleArn"=>S3IngestionRoleArn, "SourceEngine"=>SourceEngine, "SourceEngineVersion"=>SourceEngineVersion); aws_config=aws_config)
RestoreDBInstanceFromS3(DBInstanceClass, DBInstanceIdentifier, Engine, S3BucketName, S3IngestionRoleArn, SourceEngine, SourceEngineVersion, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RestoreDBInstanceFromS3", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceClass"=>DBInstanceClass, "DBInstanceIdentifier"=>DBInstanceIdentifier, "Engine"=>Engine, "S3BucketName"=>S3BucketName, "S3IngestionRoleArn"=>S3IngestionRoleArn, "SourceEngine"=>SourceEngine, "SourceEngineVersion"=>SourceEngineVersion), args)); aws_config=aws_config)
...
RestoreDBInstanceToPointInTime(TargetDBInstanceIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("RestoreDBInstanceToPointInTime", Dict{String, Any}("TargetDBInstanceIdentifier"=>TargetDBInstanceIdentifier); aws_config=aws_config)
RestoreDBInstanceToPointInTime(TargetDBInstanceIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RestoreDBInstanceToPointInTime", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TargetDBInstanceIdentifier"=>TargetDBInstanceIdentifier), args)); aws_config=aws_config)
...
RevokeDBSecurityGroupIngress(DBSecurityGroupName; aws_config::AWSConfig=AWS.aws_config) = rds("RevokeDBSecurityGroupIngress", Dict{String, Any}("DBSecurityGroupName"=>DBSecurityGroupName); aws_config=aws_config)
RevokeDBSecurityGroupIngress(DBSecurityGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("RevokeDBSecurityGroupIngress", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBSecurityGroupName"=>DBSecurityGroupName), args)); aws_config=aws_config)
...
StartActivityStream(KmsKeyId, Mode, ResourceArn; aws_config::AWSConfig=AWS.aws_config) = rds("StartActivityStream", Dict{String, Any}("KmsKeyId"=>KmsKeyId, "Mode"=>Mode, "ResourceArn"=>ResourceArn); aws_config=aws_config)
StartActivityStream(KmsKeyId, Mode, ResourceArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("StartActivityStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("KmsKeyId"=>KmsKeyId, "Mode"=>Mode, "ResourceArn"=>ResourceArn), args)); aws_config=aws_config)
...
StartDBCluster(DBClusterIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("StartDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier); aws_config=aws_config)
StartDBCluster(DBClusterIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("StartDBCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier), args)); aws_config=aws_config)
...
StartDBInstance(DBInstanceIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("StartDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier); aws_config=aws_config)
StartDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("StartDBInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier), args)); aws_config=aws_config)
...
StartExportTask(ExportTaskIdentifier, IamRoleArn, KmsKeyId, S3BucketName, SourceArn; aws_config::AWSConfig=AWS.aws_config) = rds("StartExportTask", Dict{String, Any}("ExportTaskIdentifier"=>ExportTaskIdentifier, "IamRoleArn"=>IamRoleArn, "KmsKeyId"=>KmsKeyId, "S3BucketName"=>S3BucketName, "SourceArn"=>SourceArn); aws_config=aws_config)
StartExportTask(ExportTaskIdentifier, IamRoleArn, KmsKeyId, S3BucketName, SourceArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("StartExportTask", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ExportTaskIdentifier"=>ExportTaskIdentifier, "IamRoleArn"=>IamRoleArn, "KmsKeyId"=>KmsKeyId, "S3BucketName"=>S3BucketName, "SourceArn"=>SourceArn), args)); aws_config=aws_config)
...
StopActivityStream(ResourceArn; aws_config::AWSConfig=AWS.aws_config) = rds("StopActivityStream", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config)
StopActivityStream(ResourceArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("StopActivityStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), args)); aws_config=aws_config)
...
StopDBCluster(DBClusterIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("StopDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier); aws_config=aws_config)
StopDBCluster(DBClusterIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("StopDBCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier), args)); aws_config=aws_config)
...
StopDBInstance(DBInstanceIdentifier; aws_config::AWSConfig=AWS.aws_config) = rds("StopDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier); aws_config=aws_config)
StopDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = rds("StopDBInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier), args)); aws_config=aws_config)
