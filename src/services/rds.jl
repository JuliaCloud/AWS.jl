...
"""
AddRoleToDBCluster(DBClusterIdentifier, RoleArn) = rds("AddRoleToDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "RoleArn"=>RoleArn))
AddRoleToDBCluster(DBClusterIdentifier, RoleArn, args::AbstractDict{String, <:Any}) = rds("AddRoleToDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "RoleArn"=>RoleArn, args...))
...
"""
AddRoleToDBInstance(DBInstanceIdentifier, FeatureName, RoleArn) = rds("AddRoleToDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "FeatureName"=>FeatureName, "RoleArn"=>RoleArn))
AddRoleToDBInstance(DBInstanceIdentifier, FeatureName, RoleArn, args::AbstractDict{String, <:Any}) = rds("AddRoleToDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "FeatureName"=>FeatureName, "RoleArn"=>RoleArn, args...))
...
"""
AddSourceIdentifierToSubscription(SourceIdentifier, SubscriptionName) = rds("AddSourceIdentifierToSubscription", Dict{String, Any}("SourceIdentifier"=>SourceIdentifier, "SubscriptionName"=>SubscriptionName))
AddSourceIdentifierToSubscription(SourceIdentifier, SubscriptionName, args::AbstractDict{String, <:Any}) = rds("AddSourceIdentifierToSubscription", Dict{String, Any}("SourceIdentifier"=>SourceIdentifier, "SubscriptionName"=>SubscriptionName, args...))
...
"""
AddTagsToResource(ResourceName, Tag) = rds("AddTagsToResource", Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag))
AddTagsToResource(ResourceName, Tag, args::AbstractDict{String, <:Any}) = rds("AddTagsToResource", Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag, args...))
...
"""
ApplyPendingMaintenanceAction(ApplyAction, OptInType, ResourceIdentifier) = rds("ApplyPendingMaintenanceAction", Dict{String, Any}("ApplyAction"=>ApplyAction, "OptInType"=>OptInType, "ResourceIdentifier"=>ResourceIdentifier))
ApplyPendingMaintenanceAction(ApplyAction, OptInType, ResourceIdentifier, args::AbstractDict{String, <:Any}) = rds("ApplyPendingMaintenanceAction", Dict{String, Any}("ApplyAction"=>ApplyAction, "OptInType"=>OptInType, "ResourceIdentifier"=>ResourceIdentifier, args...))
...
"""
AuthorizeDBSecurityGroupIngress(DBSecurityGroupName) = rds("AuthorizeDBSecurityGroupIngress", Dict{String, Any}("DBSecurityGroupName"=>DBSecurityGroupName))
AuthorizeDBSecurityGroupIngress(DBSecurityGroupName, args::AbstractDict{String, <:Any}) = rds("AuthorizeDBSecurityGroupIngress", Dict{String, Any}("DBSecurityGroupName"=>DBSecurityGroupName, args...))
...
"""
BacktrackDBCluster(BacktrackTo, DBClusterIdentifier) = rds("BacktrackDBCluster", Dict{String, Any}("BacktrackTo"=>BacktrackTo, "DBClusterIdentifier"=>DBClusterIdentifier))
BacktrackDBCluster(BacktrackTo, DBClusterIdentifier, args::AbstractDict{String, <:Any}) = rds("BacktrackDBCluster", Dict{String, Any}("BacktrackTo"=>BacktrackTo, "DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
"""
CancelExportTask(ExportTaskIdentifier) = rds("CancelExportTask", Dict{String, Any}("ExportTaskIdentifier"=>ExportTaskIdentifier))
CancelExportTask(ExportTaskIdentifier, args::AbstractDict{String, <:Any}) = rds("CancelExportTask", Dict{String, Any}("ExportTaskIdentifier"=>ExportTaskIdentifier, args...))
...
CopyDBClusterParameterGroup(SourceDBClusterParameterGroupIdentifier, TargetDBClusterParameterGroupDescription, TargetDBClusterParameterGroupIdentifier, args::AbstractDict{String, <:Any}) = rds("CopyDBClusterParameterGroup", Dict{String, Any}("SourceDBClusterParameterGroupIdentifier"=>SourceDBClusterParameterGroupIdentifier, "TargetDBClusterParameterGroupDescription"=>TargetDBClusterParameterGroupDescription, "TargetDBClusterParameterGroupIdentifier"=>TargetDBClusterParameterGroupIdentifier, args...))
...
- `Tags`: 
"""
CopyDBClusterSnapshot(SourceDBClusterSnapshotIdentifier, TargetDBClusterSnapshotIdentifier) = rds("CopyDBClusterSnapshot", Dict{String, Any}("SourceDBClusterSnapshotIdentifier"=>SourceDBClusterSnapshotIdentifier, "TargetDBClusterSnapshotIdentifier"=>TargetDBClusterSnapshotIdentifier))
CopyDBClusterSnapshot(SourceDBClusterSnapshotIdentifier, TargetDBClusterSnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("CopyDBClusterSnapshot", Dict{String, Any}("SourceDBClusterSnapshotIdentifier"=>SourceDBClusterSnapshotIdentifier, "TargetDBClusterSnapshotIdentifier"=>TargetDBClusterSnapshotIdentifier, args...))
...
- `Tags`: 
"""
CopyDBParameterGroup(SourceDBParameterGroupIdentifier, TargetDBParameterGroupDescription, TargetDBParameterGroupIdentifier) = rds("CopyDBParameterGroup", Dict{String, Any}("SourceDBParameterGroupIdentifier"=>SourceDBParameterGroupIdentifier, "TargetDBParameterGroupDescription"=>TargetDBParameterGroupDescription, "TargetDBParameterGroupIdentifier"=>TargetDBParameterGroupIdentifier))
CopyDBParameterGroup(SourceDBParameterGroupIdentifier, TargetDBParameterGroupDescription, TargetDBParameterGroupIdentifier, args::AbstractDict{String, <:Any}) = rds("CopyDBParameterGroup", Dict{String, Any}("SourceDBParameterGroupIdentifier"=>SourceDBParameterGroupIdentifier, "TargetDBParameterGroupDescription"=>TargetDBParameterGroupDescription, "TargetDBParameterGroupIdentifier"=>TargetDBParameterGroupIdentifier, args...))
...
- `Tags`: 
"""
CopyDBSnapshot(SourceDBSnapshotIdentifier, TargetDBSnapshotIdentifier) = rds("CopyDBSnapshot", Dict{String, Any}("SourceDBSnapshotIdentifier"=>SourceDBSnapshotIdentifier, "TargetDBSnapshotIdentifier"=>TargetDBSnapshotIdentifier))
CopyDBSnapshot(SourceDBSnapshotIdentifier, TargetDBSnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("CopyDBSnapshot", Dict{String, Any}("SourceDBSnapshotIdentifier"=>SourceDBSnapshotIdentifier, "TargetDBSnapshotIdentifier"=>TargetDBSnapshotIdentifier, args...))
...
- `Tags`: 
"""
CopyOptionGroup(SourceOptionGroupIdentifier, TargetOptionGroupDescription, TargetOptionGroupIdentifier) = rds("CopyOptionGroup", Dict{String, Any}("SourceOptionGroupIdentifier"=>SourceOptionGroupIdentifier, "TargetOptionGroupDescription"=>TargetOptionGroupDescription, "TargetOptionGroupIdentifier"=>TargetOptionGroupIdentifier))
CopyOptionGroup(SourceOptionGroupIdentifier, TargetOptionGroupDescription, TargetOptionGroupIdentifier, args::AbstractDict{String, <:Any}) = rds("CopyOptionGroup", Dict{String, Any}("SourceOptionGroupIdentifier"=>SourceOptionGroupIdentifier, "TargetOptionGroupDescription"=>TargetOptionGroupDescription, "TargetOptionGroupIdentifier"=>TargetOptionGroupIdentifier, args...))
...
"""
CreateCustomAvailabilityZone(CustomAvailabilityZoneName) = rds("CreateCustomAvailabilityZone", Dict{String, Any}("CustomAvailabilityZoneName"=>CustomAvailabilityZoneName))
CreateCustomAvailabilityZone(CustomAvailabilityZoneName, args::AbstractDict{String, <:Any}) = rds("CreateCustomAvailabilityZone", Dict{String, Any}("CustomAvailabilityZoneName"=>CustomAvailabilityZoneName, args...))
...
"""
CreateDBCluster(DBClusterIdentifier, Engine) = rds("CreateDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine))
CreateDBCluster(DBClusterIdentifier, Engine, args::AbstractDict{String, <:Any}) = rds("CreateDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, args...))
...
- `Tags`: The tags to be assigned to the Amazon RDS resource.
"""
CreateDBClusterEndpoint(DBClusterEndpointIdentifier, DBClusterIdentifier, EndpointType) = rds("CreateDBClusterEndpoint", Dict{String, Any}("DBClusterEndpointIdentifier"=>DBClusterEndpointIdentifier, "DBClusterIdentifier"=>DBClusterIdentifier, "EndpointType"=>EndpointType))
CreateDBClusterEndpoint(DBClusterEndpointIdentifier, DBClusterIdentifier, EndpointType, args::AbstractDict{String, <:Any}) = rds("CreateDBClusterEndpoint", Dict{String, Any}("DBClusterEndpointIdentifier"=>DBClusterEndpointIdentifier, "DBClusterIdentifier"=>DBClusterIdentifier, "EndpointType"=>EndpointType, args...))
...
"""
CreateDBClusterParameterGroup(DBClusterParameterGroupName, DBParameterGroupFamily, Description) = rds("CreateDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "DBParameterGroupFamily"=>DBParameterGroupFamily, "Description"=>Description))
CreateDBClusterParameterGroup(DBClusterParameterGroupName, DBParameterGroupFamily, Description, args::AbstractDict{String, <:Any}) = rds("CreateDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "DBParameterGroupFamily"=>DBParameterGroupFamily, "Description"=>Description, args...))
...
"""
CreateDBClusterSnapshot(DBClusterIdentifier, DBClusterSnapshotIdentifier) = rds("CreateDBClusterSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier))
CreateDBClusterSnapshot(DBClusterIdentifier, DBClusterSnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("CreateDBClusterSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier, args...))
...
"""
CreateDBInstance(DBInstanceClass, DBInstanceIdentifier, Engine) = rds("CreateDBInstance", Dict{String, Any}("DBInstanceClass"=>DBInstanceClass, "DBInstanceIdentifier"=>DBInstanceIdentifier, "Engine"=>Engine))
CreateDBInstance(DBInstanceClass, DBInstanceIdentifier, Engine, args::AbstractDict{String, <:Any}) = rds("CreateDBInstance", Dict{String, Any}("DBInstanceClass"=>DBInstanceClass, "DBInstanceIdentifier"=>DBInstanceIdentifier, "Engine"=>Engine, args...))
...
"""
CreateDBInstanceReadReplica(DBInstanceIdentifier, SourceDBInstanceIdentifier) = rds("CreateDBInstanceReadReplica", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "SourceDBInstanceIdentifier"=>SourceDBInstanceIdentifier))
CreateDBInstanceReadReplica(DBInstanceIdentifier, SourceDBInstanceIdentifier, args::AbstractDict{String, <:Any}) = rds("CreateDBInstanceReadReplica", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "SourceDBInstanceIdentifier"=>SourceDBInstanceIdentifier, args...))
...
"""
CreateDBParameterGroup(DBParameterGroupFamily, DBParameterGroupName, Description) = rds("CreateDBParameterGroup", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily, "DBParameterGroupName"=>DBParameterGroupName, "Description"=>Description))
CreateDBParameterGroup(DBParameterGroupFamily, DBParameterGroupName, Description, args::AbstractDict{String, <:Any}) = rds("CreateDBParameterGroup", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily, "DBParameterGroupName"=>DBParameterGroupName, "Description"=>Description, args...))
...
"""
CreateDBProxy(Auth, DBProxyName, EngineFamily, RoleArn, VpcSubnetIds) = rds("CreateDBProxy", Dict{String, Any}("Auth"=>Auth, "DBProxyName"=>DBProxyName, "EngineFamily"=>EngineFamily, "RoleArn"=>RoleArn, "VpcSubnetIds"=>VpcSubnetIds))
CreateDBProxy(Auth, DBProxyName, EngineFamily, RoleArn, VpcSubnetIds, args::AbstractDict{String, <:Any}) = rds("CreateDBProxy", Dict{String, Any}("Auth"=>Auth, "DBProxyName"=>DBProxyName, "EngineFamily"=>EngineFamily, "RoleArn"=>RoleArn, "VpcSubnetIds"=>VpcSubnetIds, args...))
...
"""
CreateDBSecurityGroup(DBSecurityGroupDescription, DBSecurityGroupName) = rds("CreateDBSecurityGroup", Dict{String, Any}("DBSecurityGroupDescription"=>DBSecurityGroupDescription, "DBSecurityGroupName"=>DBSecurityGroupName))
CreateDBSecurityGroup(DBSecurityGroupDescription, DBSecurityGroupName, args::AbstractDict{String, <:Any}) = rds("CreateDBSecurityGroup", Dict{String, Any}("DBSecurityGroupDescription"=>DBSecurityGroupDescription, "DBSecurityGroupName"=>DBSecurityGroupName, args...))
...
- `Tags`: 
"""
CreateDBSnapshot(DBInstanceIdentifier, DBSnapshotIdentifier) = rds("CreateDBSnapshot", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "DBSnapshotIdentifier"=>DBSnapshotIdentifier))
CreateDBSnapshot(DBInstanceIdentifier, DBSnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("CreateDBSnapshot", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "DBSnapshotIdentifier"=>DBSnapshotIdentifier, args...))
...
"""
CreateDBSubnetGroup(DBSubnetGroupDescription, DBSubnetGroupName, SubnetIdentifier) = rds("CreateDBSubnetGroup", Dict{String, Any}("DBSubnetGroupDescription"=>DBSubnetGroupDescription, "DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier))
CreateDBSubnetGroup(DBSubnetGroupDescription, DBSubnetGroupName, SubnetIdentifier, args::AbstractDict{String, <:Any}) = rds("CreateDBSubnetGroup", Dict{String, Any}("DBSubnetGroupDescription"=>DBSubnetGroupDescription, "DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier, args...))
...
- `Tags`: 
"""
CreateEventSubscription(SnsTopicArn, SubscriptionName) = rds("CreateEventSubscription", Dict{String, Any}("SnsTopicArn"=>SnsTopicArn, "SubscriptionName"=>SubscriptionName))
CreateEventSubscription(SnsTopicArn, SubscriptionName, args::AbstractDict{String, <:Any}) = rds("CreateEventSubscription", Dict{String, Any}("SnsTopicArn"=>SnsTopicArn, "SubscriptionName"=>SubscriptionName, args...))
...
CreateGlobalCluster(args::AbstractDict{String, <:Any}) = rds("CreateGlobalCluster", args)
...
"""
CreateOptionGroup(EngineName, MajorEngineVersion, OptionGroupDescription, OptionGroupName) = rds("CreateOptionGroup", Dict{String, Any}("EngineName"=>EngineName, "MajorEngineVersion"=>MajorEngineVersion, "OptionGroupDescription"=>OptionGroupDescription, "OptionGroupName"=>OptionGroupName))
CreateOptionGroup(EngineName, MajorEngineVersion, OptionGroupDescription, OptionGroupName, args::AbstractDict{String, <:Any}) = rds("CreateOptionGroup", Dict{String, Any}("EngineName"=>EngineName, "MajorEngineVersion"=>MajorEngineVersion, "OptionGroupDescription"=>OptionGroupDescription, "OptionGroupName"=>OptionGroupName, args...))
...
"""
DeleteCustomAvailabilityZone(CustomAvailabilityZoneId) = rds("DeleteCustomAvailabilityZone", Dict{String, Any}("CustomAvailabilityZoneId"=>CustomAvailabilityZoneId))
DeleteCustomAvailabilityZone(CustomAvailabilityZoneId, args::AbstractDict{String, <:Any}) = rds("DeleteCustomAvailabilityZone", Dict{String, Any}("CustomAvailabilityZoneId"=>CustomAvailabilityZoneId, args...))
...
"""
DeleteDBCluster(DBClusterIdentifier) = rds("DeleteDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
DeleteDBCluster(DBClusterIdentifier, args::AbstractDict{String, <:Any}) = rds("DeleteDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
"""
DeleteDBClusterEndpoint(DBClusterEndpointIdentifier) = rds("DeleteDBClusterEndpoint", Dict{String, Any}("DBClusterEndpointIdentifier"=>DBClusterEndpointIdentifier))
DeleteDBClusterEndpoint(DBClusterEndpointIdentifier, args::AbstractDict{String, <:Any}) = rds("DeleteDBClusterEndpoint", Dict{String, Any}("DBClusterEndpointIdentifier"=>DBClusterEndpointIdentifier, args...))
...
"""
DeleteDBClusterParameterGroup(DBClusterParameterGroupName) = rds("DeleteDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName))
DeleteDBClusterParameterGroup(DBClusterParameterGroupName, args::AbstractDict{String, <:Any}) = rds("DeleteDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, args...))
...
"""
DeleteDBClusterSnapshot(DBClusterSnapshotIdentifier) = rds("DeleteDBClusterSnapshot", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier))
DeleteDBClusterSnapshot(DBClusterSnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("DeleteDBClusterSnapshot", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier, args...))
...
"""
DeleteDBInstance(DBInstanceIdentifier) = rds("DeleteDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
DeleteDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <:Any}) = rds("DeleteDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
"""
DeleteDBInstanceAutomatedBackup(DbiResourceId) = rds("DeleteDBInstanceAutomatedBackup", Dict{String, Any}("DbiResourceId"=>DbiResourceId))
DeleteDBInstanceAutomatedBackup(DbiResourceId, args::AbstractDict{String, <:Any}) = rds("DeleteDBInstanceAutomatedBackup", Dict{String, Any}("DbiResourceId"=>DbiResourceId, args...))
...
"""
DeleteDBParameterGroup(DBParameterGroupName) = rds("DeleteDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName))
DeleteDBParameterGroup(DBParameterGroupName, args::AbstractDict{String, <:Any}) = rds("DeleteDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName, args...))
...
"""
DeleteDBProxy(DBProxyName) = rds("DeleteDBProxy", Dict{String, Any}("DBProxyName"=>DBProxyName))
DeleteDBProxy(DBProxyName, args::AbstractDict{String, <:Any}) = rds("DeleteDBProxy", Dict{String, Any}("DBProxyName"=>DBProxyName, args...))
...
"""
DeleteDBSecurityGroup(DBSecurityGroupName) = rds("DeleteDBSecurityGroup", Dict{String, Any}("DBSecurityGroupName"=>DBSecurityGroupName))
DeleteDBSecurityGroup(DBSecurityGroupName, args::AbstractDict{String, <:Any}) = rds("DeleteDBSecurityGroup", Dict{String, Any}("DBSecurityGroupName"=>DBSecurityGroupName, args...))
...
"""
DeleteDBSnapshot(DBSnapshotIdentifier) = rds("DeleteDBSnapshot", Dict{String, Any}("DBSnapshotIdentifier"=>DBSnapshotIdentifier))
DeleteDBSnapshot(DBSnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("DeleteDBSnapshot", Dict{String, Any}("DBSnapshotIdentifier"=>DBSnapshotIdentifier, args...))
...
"""
DeleteDBSubnetGroup(DBSubnetGroupName) = rds("DeleteDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName))
DeleteDBSubnetGroup(DBSubnetGroupName, args::AbstractDict{String, <:Any}) = rds("DeleteDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName, args...))
...
"""
DeleteEventSubscription(SubscriptionName) = rds("DeleteEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName))
DeleteEventSubscription(SubscriptionName, args::AbstractDict{String, <:Any}) = rds("DeleteEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName, args...))
...
"""
DeleteGlobalCluster(GlobalClusterIdentifier) = rds("DeleteGlobalCluster", Dict{String, Any}("GlobalClusterIdentifier"=>GlobalClusterIdentifier))
DeleteGlobalCluster(GlobalClusterIdentifier, args::AbstractDict{String, <:Any}) = rds("DeleteGlobalCluster", Dict{String, Any}("GlobalClusterIdentifier"=>GlobalClusterIdentifier, args...))
...
"""
DeleteInstallationMedia(InstallationMediaId) = rds("DeleteInstallationMedia", Dict{String, Any}("InstallationMediaId"=>InstallationMediaId))
DeleteInstallationMedia(InstallationMediaId, args::AbstractDict{String, <:Any}) = rds("DeleteInstallationMedia", Dict{String, Any}("InstallationMediaId"=>InstallationMediaId, args...))
...
"""
DeleteOptionGroup(OptionGroupName) = rds("DeleteOptionGroup", Dict{String, Any}("OptionGroupName"=>OptionGroupName))
DeleteOptionGroup(OptionGroupName, args::AbstractDict{String, <:Any}) = rds("DeleteOptionGroup", Dict{String, Any}("OptionGroupName"=>OptionGroupName, args...))
...
"""
DeregisterDBProxyTargets(DBProxyName) = rds("DeregisterDBProxyTargets", Dict{String, Any}("DBProxyName"=>DBProxyName))
DeregisterDBProxyTargets(DBProxyName, args::AbstractDict{String, <:Any}) = rds("DeregisterDBProxyTargets", Dict{String, Any}("DBProxyName"=>DBProxyName, args...))
...
DescribeAccountAttributes(args::AbstractDict{String, <:Any}) = rds("DescribeAccountAttributes", args)
...
DescribeCertificates(args::AbstractDict{String, <:Any}) = rds("DescribeCertificates", args)
...
DescribeCustomAvailabilityZones(args::AbstractDict{String, <:Any}) = rds("DescribeCustomAvailabilityZones", args)
...
- `MaxRecords`: The maximum number of records to include in the response. If more records exist than the specified MaxRecords value, a pagination token called a marker is included in the response so you can retrieve the remaining results.  Default: 100 Constraints: Minimum 20, maximum 100.
"""
DescribeDBClusterBacktracks(DBClusterIdentifier) = rds("DescribeDBClusterBacktracks", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
DescribeDBClusterBacktracks(DBClusterIdentifier, args::AbstractDict{String, <:Any}) = rds("DescribeDBClusterBacktracks", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
DescribeDBClusterEndpoints(args::AbstractDict{String, <:Any}) = rds("DescribeDBClusterEndpoints", args)
...
DescribeDBClusterParameterGroups(args::AbstractDict{String, <:Any}) = rds("DescribeDBClusterParameterGroups", args)
...
"""
DescribeDBClusterParameters(DBClusterParameterGroupName) = rds("DescribeDBClusterParameters", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName))
DescribeDBClusterParameters(DBClusterParameterGroupName, args::AbstractDict{String, <:Any}) = rds("DescribeDBClusterParameters", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, args...))
...
"""
DescribeDBClusterSnapshotAttributes(DBClusterSnapshotIdentifier) = rds("DescribeDBClusterSnapshotAttributes", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier))
DescribeDBClusterSnapshotAttributes(DBClusterSnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("DescribeDBClusterSnapshotAttributes", Dict{String, Any}("DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier, args...))
...
DescribeDBClusterSnapshots(args::AbstractDict{String, <:Any}) = rds("DescribeDBClusterSnapshots", args)
...
DescribeDBClusters(args::AbstractDict{String, <:Any}) = rds("DescribeDBClusters", args)
...
DescribeDBEngineVersions(args::AbstractDict{String, <:Any}) = rds("DescribeDBEngineVersions", args)
...
DescribeDBInstanceAutomatedBackups(args::AbstractDict{String, <:Any}) = rds("DescribeDBInstanceAutomatedBackups", args)
...
DescribeDBInstances(args::AbstractDict{String, <:Any}) = rds("DescribeDBInstances", args)
...
"""
DescribeDBLogFiles(DBInstanceIdentifier) = rds("DescribeDBLogFiles", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
DescribeDBLogFiles(DBInstanceIdentifier, args::AbstractDict{String, <:Any}) = rds("DescribeDBLogFiles", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
DescribeDBParameterGroups(args::AbstractDict{String, <:Any}) = rds("DescribeDBParameterGroups", args)
...
"""
DescribeDBParameters(DBParameterGroupName) = rds("DescribeDBParameters", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName))
DescribeDBParameters(DBParameterGroupName, args::AbstractDict{String, <:Any}) = rds("DescribeDBParameters", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName, args...))
...
DescribeDBProxies(args::AbstractDict{String, <:Any}) = rds("DescribeDBProxies", args)
...
"""
DescribeDBProxyTargetGroups(DBProxyName) = rds("DescribeDBProxyTargetGroups", Dict{String, Any}("DBProxyName"=>DBProxyName))
DescribeDBProxyTargetGroups(DBProxyName, args::AbstractDict{String, <:Any}) = rds("DescribeDBProxyTargetGroups", Dict{String, Any}("DBProxyName"=>DBProxyName, args...))
...
- `TargetGroupName`: The identifier of the DBProxyTargetGroup to describe.
"""
DescribeDBProxyTargets(DBProxyName) = rds("DescribeDBProxyTargets", Dict{String, Any}("DBProxyName"=>DBProxyName))
DescribeDBProxyTargets(DBProxyName, args::AbstractDict{String, <:Any}) = rds("DescribeDBProxyTargets", Dict{String, Any}("DBProxyName"=>DBProxyName, args...))
...
DescribeDBSecurityGroups(args::AbstractDict{String, <:Any}) = rds("DescribeDBSecurityGroups", args)
...
"""
DescribeDBSnapshotAttributes(DBSnapshotIdentifier) = rds("DescribeDBSnapshotAttributes", Dict{String, Any}("DBSnapshotIdentifier"=>DBSnapshotIdentifier))
DescribeDBSnapshotAttributes(DBSnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("DescribeDBSnapshotAttributes", Dict{String, Any}("DBSnapshotIdentifier"=>DBSnapshotIdentifier, args...))
...
DescribeDBSnapshots(args::AbstractDict{String, <:Any}) = rds("DescribeDBSnapshots", args)
...
DescribeDBSubnetGroups(args::AbstractDict{String, <:Any}) = rds("DescribeDBSubnetGroups", args)
...
- `MaxRecords`:  The maximum number of records to include in the response. If more records exist than the specified MaxRecords value, a pagination token called a marker is included in the response so you can retrieve the remaining results.  Default: 100 Constraints: Minimum 20, maximum 100.
"""
DescribeEngineDefaultClusterParameters(DBParameterGroupFamily) = rds("DescribeEngineDefaultClusterParameters", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily))
DescribeEngineDefaultClusterParameters(DBParameterGroupFamily, args::AbstractDict{String, <:Any}) = rds("DescribeEngineDefaultClusterParameters", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily, args...))
...
- `MaxRecords`:  The maximum number of records to include in the response. If more records exist than the specified MaxRecords value, a pagination token called a marker is included in the response so you can retrieve the remaining results.  Default: 100 Constraints: Minimum 20, maximum 100.
"""
DescribeEngineDefaultParameters(DBParameterGroupFamily) = rds("DescribeEngineDefaultParameters", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily))
DescribeEngineDefaultParameters(DBParameterGroupFamily, args::AbstractDict{String, <:Any}) = rds("DescribeEngineDefaultParameters", Dict{String, Any}("DBParameterGroupFamily"=>DBParameterGroupFamily, args...))
...
DescribeEventCategories(args::AbstractDict{String, <:Any}) = rds("DescribeEventCategories", args)
...
DescribeEventSubscriptions(args::AbstractDict{String, <:Any}) = rds("DescribeEventSubscriptions", args)
...
DescribeEvents(args::AbstractDict{String, <:Any}) = rds("DescribeEvents", args)
...
DescribeExportTasks(args::AbstractDict{String, <:Any}) = rds("DescribeExportTasks", args)
...
DescribeGlobalClusters(args::AbstractDict{String, <:Any}) = rds("DescribeGlobalClusters", args)
...
DescribeInstallationMedia(args::AbstractDict{String, <:Any}) = rds("DescribeInstallationMedia", args)
...
- `MaxRecords`:  The maximum number of records to include in the response. If more records exist than the specified MaxRecords value, a pagination token called a marker is included in the response so that you can retrieve the remaining results.  Default: 100 Constraints: Minimum 20, maximum 100.
"""
DescribeOptionGroupOptions(EngineName) = rds("DescribeOptionGroupOptions", Dict{String, Any}("EngineName"=>EngineName))
DescribeOptionGroupOptions(EngineName, args::AbstractDict{String, <:Any}) = rds("DescribeOptionGroupOptions", Dict{String, Any}("EngineName"=>EngineName, args...))
...
DescribeOptionGroups(args::AbstractDict{String, <:Any}) = rds("DescribeOptionGroups", args)
...
"""
DescribeOrderableDBInstanceOptions(Engine) = rds("DescribeOrderableDBInstanceOptions", Dict{String, Any}("Engine"=>Engine))
DescribeOrderableDBInstanceOptions(Engine, args::AbstractDict{String, <:Any}) = rds("DescribeOrderableDBInstanceOptions", Dict{String, Any}("Engine"=>Engine, args...))
...
DescribePendingMaintenanceActions(args::AbstractDict{String, <:Any}) = rds("DescribePendingMaintenanceActions", args)
...
DescribeReservedDBInstances(args::AbstractDict{String, <:Any}) = rds("DescribeReservedDBInstances", args)
...
DescribeReservedDBInstancesOfferings(args::AbstractDict{String, <:Any}) = rds("DescribeReservedDBInstancesOfferings", args)
...
DescribeSourceRegions(args::AbstractDict{String, <:Any}) = rds("DescribeSourceRegions", args)
...
"""
DescribeValidDBInstanceModifications(DBInstanceIdentifier) = rds("DescribeValidDBInstanceModifications", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
DescribeValidDBInstanceModifications(DBInstanceIdentifier, args::AbstractDict{String, <:Any}) = rds("DescribeValidDBInstanceModifications", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
"""
DownloadDBLogFilePortion(DBInstanceIdentifier, LogFileName) = rds("DownloadDBLogFilePortion", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "LogFileName"=>LogFileName))
DownloadDBLogFilePortion(DBInstanceIdentifier, LogFileName, args::AbstractDict{String, <:Any}) = rds("DownloadDBLogFilePortion", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "LogFileName"=>LogFileName, args...))
...
"""
FailoverDBCluster(DBClusterIdentifier) = rds("FailoverDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
FailoverDBCluster(DBClusterIdentifier, args::AbstractDict{String, <:Any}) = rds("FailoverDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
ImportInstallationMedia(CustomAvailabilityZoneId, Engine, EngineInstallationMediaPath, EngineVersion, OSInstallationMediaPath, args::AbstractDict{String, <:Any}) = rds("ImportInstallationMedia", Dict{String, Any}("CustomAvailabilityZoneId"=>CustomAvailabilityZoneId, "Engine"=>Engine, "EngineInstallationMediaPath"=>EngineInstallationMediaPath, "EngineVersion"=>EngineVersion, "OSInstallationMediaPath"=>OSInstallationMediaPath, args...))
...
- `Filters`: This parameter isn't currently supported.
"""
ListTagsForResource(ResourceName) = rds("ListTagsForResource", Dict{String, Any}("ResourceName"=>ResourceName))
ListTagsForResource(ResourceName, args::AbstractDict{String, <:Any}) = rds("ListTagsForResource", Dict{String, Any}("ResourceName"=>ResourceName, args...))
...
ModifyCertificates(args::AbstractDict{String, <:Any}) = rds("ModifyCertificates", args)
...
"""
ModifyCurrentDBClusterCapacity(DBClusterIdentifier) = rds("ModifyCurrentDBClusterCapacity", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
ModifyCurrentDBClusterCapacity(DBClusterIdentifier, args::AbstractDict{String, <:Any}) = rds("ModifyCurrentDBClusterCapacity", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
"""
ModifyDBCluster(DBClusterIdentifier) = rds("ModifyDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
ModifyDBCluster(DBClusterIdentifier, args::AbstractDict{String, <:Any}) = rds("ModifyDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
- `StaticMembers`: List of DB instance identifiers that are part of the custom endpoint group.
"""
ModifyDBClusterEndpoint(DBClusterEndpointIdentifier) = rds("ModifyDBClusterEndpoint", Dict{String, Any}("DBClusterEndpointIdentifier"=>DBClusterEndpointIdentifier))
ModifyDBClusterEndpoint(DBClusterEndpointIdentifier, args::AbstractDict{String, <:Any}) = rds("ModifyDBClusterEndpoint", Dict{String, Any}("DBClusterEndpointIdentifier"=>DBClusterEndpointIdentifier, args...))
...
"""
ModifyDBClusterParameterGroup(DBClusterParameterGroupName, Parameter) = rds("ModifyDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "Parameter"=>Parameter))
ModifyDBClusterParameterGroup(DBClusterParameterGroupName, Parameter, args::AbstractDict{String, <:Any}) = rds("ModifyDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, "Parameter"=>Parameter, args...))
...
"""
ModifyDBClusterSnapshotAttribute(AttributeName, DBClusterSnapshotIdentifier) = rds("ModifyDBClusterSnapshotAttribute", Dict{String, Any}("AttributeName"=>AttributeName, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier))
ModifyDBClusterSnapshotAttribute(AttributeName, DBClusterSnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("ModifyDBClusterSnapshotAttribute", Dict{String, Any}("AttributeName"=>AttributeName, "DBClusterSnapshotIdentifier"=>DBClusterSnapshotIdentifier, args...))
...
"""
ModifyDBInstance(DBInstanceIdentifier) = rds("ModifyDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
ModifyDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <:Any}) = rds("ModifyDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
"""
ModifyDBParameterGroup(DBParameterGroupName, Parameter) = rds("ModifyDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName, "Parameter"=>Parameter))
ModifyDBParameterGroup(DBParameterGroupName, Parameter, args::AbstractDict{String, <:Any}) = rds("ModifyDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName, "Parameter"=>Parameter, args...))
...
"""
ModifyDBProxy(DBProxyName) = rds("ModifyDBProxy", Dict{String, Any}("DBProxyName"=>DBProxyName))
ModifyDBProxy(DBProxyName, args::AbstractDict{String, <:Any}) = rds("ModifyDBProxy", Dict{String, Any}("DBProxyName"=>DBProxyName, args...))
...
"""
ModifyDBProxyTargetGroup(DBProxyName, TargetGroupName) = rds("ModifyDBProxyTargetGroup", Dict{String, Any}("DBProxyName"=>DBProxyName, "TargetGroupName"=>TargetGroupName))
ModifyDBProxyTargetGroup(DBProxyName, TargetGroupName, args::AbstractDict{String, <:Any}) = rds("ModifyDBProxyTargetGroup", Dict{String, Any}("DBProxyName"=>DBProxyName, "TargetGroupName"=>TargetGroupName, args...))
...
"""
ModifyDBSnapshot(DBSnapshotIdentifier) = rds("ModifyDBSnapshot", Dict{String, Any}("DBSnapshotIdentifier"=>DBSnapshotIdentifier))
ModifyDBSnapshot(DBSnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("ModifyDBSnapshot", Dict{String, Any}("DBSnapshotIdentifier"=>DBSnapshotIdentifier, args...))
...
"""
ModifyDBSnapshotAttribute(AttributeName, DBSnapshotIdentifier) = rds("ModifyDBSnapshotAttribute", Dict{String, Any}("AttributeName"=>AttributeName, "DBSnapshotIdentifier"=>DBSnapshotIdentifier))
ModifyDBSnapshotAttribute(AttributeName, DBSnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("ModifyDBSnapshotAttribute", Dict{String, Any}("AttributeName"=>AttributeName, "DBSnapshotIdentifier"=>DBSnapshotIdentifier, args...))
...
- `SubnetIds`: The EC2 subnet IDs for the DB subnet group.
"""
ModifyDBSubnetGroup(DBSubnetGroupName, SubnetIdentifier) = rds("ModifyDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier))
ModifyDBSubnetGroup(DBSubnetGroupName, SubnetIdentifier, args::AbstractDict{String, <:Any}) = rds("ModifyDBSubnetGroup", Dict{String, Any}("DBSubnetGroupName"=>DBSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier, args...))
...
"""
ModifyEventSubscription(SubscriptionName) = rds("ModifyEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName))
ModifyEventSubscription(SubscriptionName, args::AbstractDict{String, <:Any}) = rds("ModifyEventSubscription", Dict{String, Any}("SubscriptionName"=>SubscriptionName, args...))
...
ModifyGlobalCluster(args::AbstractDict{String, <:Any}) = rds("ModifyGlobalCluster", args)
...
"""
ModifyOptionGroup(OptionGroupName) = rds("ModifyOptionGroup", Dict{String, Any}("OptionGroupName"=>OptionGroupName))
ModifyOptionGroup(OptionGroupName, args::AbstractDict{String, <:Any}) = rds("ModifyOptionGroup", Dict{String, Any}("OptionGroupName"=>OptionGroupName, args...))
...
"""
PromoteReadReplica(DBInstanceIdentifier) = rds("PromoteReadReplica", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
PromoteReadReplica(DBInstanceIdentifier, args::AbstractDict{String, <:Any}) = rds("PromoteReadReplica", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
"""
PromoteReadReplicaDBCluster(DBClusterIdentifier) = rds("PromoteReadReplicaDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
PromoteReadReplicaDBCluster(DBClusterIdentifier, args::AbstractDict{String, <:Any}) = rds("PromoteReadReplicaDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
- `Tags`: 
"""
PurchaseReservedDBInstancesOffering(ReservedDBInstancesOfferingId) = rds("PurchaseReservedDBInstancesOffering", Dict{String, Any}("ReservedDBInstancesOfferingId"=>ReservedDBInstancesOfferingId))
PurchaseReservedDBInstancesOffering(ReservedDBInstancesOfferingId, args::AbstractDict{String, <:Any}) = rds("PurchaseReservedDBInstancesOffering", Dict{String, Any}("ReservedDBInstancesOfferingId"=>ReservedDBInstancesOfferingId, args...))
...
"""
RebootDBInstance(DBInstanceIdentifier) = rds("RebootDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
RebootDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <:Any}) = rds("RebootDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
- `TargetGroupName`: The identifier of the DBProxyTargetGroup.
"""
RegisterDBProxyTargets(DBProxyName) = rds("RegisterDBProxyTargets", Dict{String, Any}("DBProxyName"=>DBProxyName))
RegisterDBProxyTargets(DBProxyName, args::AbstractDict{String, <:Any}) = rds("RegisterDBProxyTargets", Dict{String, Any}("DBProxyName"=>DBProxyName, args...))
...
RemoveFromGlobalCluster(args::AbstractDict{String, <:Any}) = rds("RemoveFromGlobalCluster", args)
...
"""
RemoveRoleFromDBCluster(DBClusterIdentifier, RoleArn) = rds("RemoveRoleFromDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "RoleArn"=>RoleArn))
RemoveRoleFromDBCluster(DBClusterIdentifier, RoleArn, args::AbstractDict{String, <:Any}) = rds("RemoveRoleFromDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "RoleArn"=>RoleArn, args...))
...
"""
RemoveRoleFromDBInstance(DBInstanceIdentifier, FeatureName, RoleArn) = rds("RemoveRoleFromDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "FeatureName"=>FeatureName, "RoleArn"=>RoleArn))
RemoveRoleFromDBInstance(DBInstanceIdentifier, FeatureName, RoleArn, args::AbstractDict{String, <:Any}) = rds("RemoveRoleFromDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "FeatureName"=>FeatureName, "RoleArn"=>RoleArn, args...))
...
"""
RemoveSourceIdentifierFromSubscription(SourceIdentifier, SubscriptionName) = rds("RemoveSourceIdentifierFromSubscription", Dict{String, Any}("SourceIdentifier"=>SourceIdentifier, "SubscriptionName"=>SubscriptionName))
RemoveSourceIdentifierFromSubscription(SourceIdentifier, SubscriptionName, args::AbstractDict{String, <:Any}) = rds("RemoveSourceIdentifierFromSubscription", Dict{String, Any}("SourceIdentifier"=>SourceIdentifier, "SubscriptionName"=>SubscriptionName, args...))
...
"""
RemoveTagsFromResource(ResourceName, TagKeys) = rds("RemoveTagsFromResource", Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys))
RemoveTagsFromResource(ResourceName, TagKeys, args::AbstractDict{String, <:Any}) = rds("RemoveTagsFromResource", Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys, args...))
...
"""
ResetDBClusterParameterGroup(DBClusterParameterGroupName) = rds("ResetDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName))
ResetDBClusterParameterGroup(DBClusterParameterGroupName, args::AbstractDict{String, <:Any}) = rds("ResetDBClusterParameterGroup", Dict{String, Any}("DBClusterParameterGroupName"=>DBClusterParameterGroupName, args...))
...
"""
ResetDBParameterGroup(DBParameterGroupName) = rds("ResetDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName))
ResetDBParameterGroup(DBParameterGroupName, args::AbstractDict{String, <:Any}) = rds("ResetDBParameterGroup", Dict{String, Any}("DBParameterGroupName"=>DBParameterGroupName, args...))
...
"""
RestoreDBClusterFromS3(DBClusterIdentifier, Engine, MasterUserPassword, MasterUsername, S3BucketName, S3IngestionRoleArn, SourceEngine, SourceEngineVersion) = rds("RestoreDBClusterFromS3", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "MasterUserPassword"=>MasterUserPassword, "MasterUsername"=>MasterUsername, "S3BucketName"=>S3BucketName, "S3IngestionRoleArn"=>S3IngestionRoleArn, "SourceEngine"=>SourceEngine, "SourceEngineVersion"=>SourceEngineVersion))
RestoreDBClusterFromS3(DBClusterIdentifier, Engine, MasterUserPassword, MasterUsername, S3BucketName, S3IngestionRoleArn, SourceEngine, SourceEngineVersion, args::AbstractDict{String, <:Any}) = rds("RestoreDBClusterFromS3", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "MasterUserPassword"=>MasterUserPassword, "MasterUsername"=>MasterUsername, "S3BucketName"=>S3BucketName, "S3IngestionRoleArn"=>S3IngestionRoleArn, "SourceEngine"=>SourceEngine, "SourceEngineVersion"=>SourceEngineVersion, args...))
...
"""
RestoreDBClusterFromSnapshot(DBClusterIdentifier, Engine, SnapshotIdentifier) = rds("RestoreDBClusterFromSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "SnapshotIdentifier"=>SnapshotIdentifier))
RestoreDBClusterFromSnapshot(DBClusterIdentifier, Engine, SnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("RestoreDBClusterFromSnapshot", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "Engine"=>Engine, "SnapshotIdentifier"=>SnapshotIdentifier, args...))
...
"""
RestoreDBClusterToPointInTime(DBClusterIdentifier, SourceDBClusterIdentifier) = rds("RestoreDBClusterToPointInTime", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "SourceDBClusterIdentifier"=>SourceDBClusterIdentifier))
RestoreDBClusterToPointInTime(DBClusterIdentifier, SourceDBClusterIdentifier, args::AbstractDict{String, <:Any}) = rds("RestoreDBClusterToPointInTime", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, "SourceDBClusterIdentifier"=>SourceDBClusterIdentifier, args...))
...
"""
RestoreDBInstanceFromDBSnapshot(DBInstanceIdentifier, DBSnapshotIdentifier) = rds("RestoreDBInstanceFromDBSnapshot", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "DBSnapshotIdentifier"=>DBSnapshotIdentifier))
RestoreDBInstanceFromDBSnapshot(DBInstanceIdentifier, DBSnapshotIdentifier, args::AbstractDict{String, <:Any}) = rds("RestoreDBInstanceFromDBSnapshot", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, "DBSnapshotIdentifier"=>DBSnapshotIdentifier, args...))
...
"""
RestoreDBInstanceFromS3(DBInstanceClass, DBInstanceIdentifier, Engine, S3BucketName, S3IngestionRoleArn, SourceEngine, SourceEngineVersion) = rds("RestoreDBInstanceFromS3", Dict{String, Any}("DBInstanceClass"=>DBInstanceClass, "DBInstanceIdentifier"=>DBInstanceIdentifier, "Engine"=>Engine, "S3BucketName"=>S3BucketName, "S3IngestionRoleArn"=>S3IngestionRoleArn, "SourceEngine"=>SourceEngine, "SourceEngineVersion"=>SourceEngineVersion))
RestoreDBInstanceFromS3(DBInstanceClass, DBInstanceIdentifier, Engine, S3BucketName, S3IngestionRoleArn, SourceEngine, SourceEngineVersion, args::AbstractDict{String, <:Any}) = rds("RestoreDBInstanceFromS3", Dict{String, Any}("DBInstanceClass"=>DBInstanceClass, "DBInstanceIdentifier"=>DBInstanceIdentifier, "Engine"=>Engine, "S3BucketName"=>S3BucketName, "S3IngestionRoleArn"=>S3IngestionRoleArn, "SourceEngine"=>SourceEngine, "SourceEngineVersion"=>SourceEngineVersion, args...))
...
- `VpcSecurityGroupIds`:  A list of EC2 VPC security groups to associate with this DB instance.   Default: The default EC2 VPC security group for the DB subnet group's VPC. 
"""
RestoreDBInstanceToPointInTime(TargetDBInstanceIdentifier) = rds("RestoreDBInstanceToPointInTime", Dict{String, Any}("TargetDBInstanceIdentifier"=>TargetDBInstanceIdentifier))
RestoreDBInstanceToPointInTime(TargetDBInstanceIdentifier, args::AbstractDict{String, <:Any}) = rds("RestoreDBInstanceToPointInTime", Dict{String, Any}("TargetDBInstanceIdentifier"=>TargetDBInstanceIdentifier, args...))
...
"""
RevokeDBSecurityGroupIngress(DBSecurityGroupName) = rds("RevokeDBSecurityGroupIngress", Dict{String, Any}("DBSecurityGroupName"=>DBSecurityGroupName))
RevokeDBSecurityGroupIngress(DBSecurityGroupName, args::AbstractDict{String, <:Any}) = rds("RevokeDBSecurityGroupIngress", Dict{String, Any}("DBSecurityGroupName"=>DBSecurityGroupName, args...))
...
"""
StartActivityStream(KmsKeyId, Mode, ResourceArn) = rds("StartActivityStream", Dict{String, Any}("KmsKeyId"=>KmsKeyId, "Mode"=>Mode, "ResourceArn"=>ResourceArn))
StartActivityStream(KmsKeyId, Mode, ResourceArn, args::AbstractDict{String, <:Any}) = rds("StartActivityStream", Dict{String, Any}("KmsKeyId"=>KmsKeyId, "Mode"=>Mode, "ResourceArn"=>ResourceArn, args...))
...
"""
StartDBCluster(DBClusterIdentifier) = rds("StartDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
StartDBCluster(DBClusterIdentifier, args::AbstractDict{String, <:Any}) = rds("StartDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
"""
StartDBInstance(DBInstanceIdentifier) = rds("StartDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
StartDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <:Any}) = rds("StartDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
...
"""
StartExportTask(ExportTaskIdentifier, IamRoleArn, KmsKeyId, S3BucketName, SourceArn) = rds("StartExportTask", Dict{String, Any}("ExportTaskIdentifier"=>ExportTaskIdentifier, "IamRoleArn"=>IamRoleArn, "KmsKeyId"=>KmsKeyId, "S3BucketName"=>S3BucketName, "SourceArn"=>SourceArn))
StartExportTask(ExportTaskIdentifier, IamRoleArn, KmsKeyId, S3BucketName, SourceArn, args::AbstractDict{String, <:Any}) = rds("StartExportTask", Dict{String, Any}("ExportTaskIdentifier"=>ExportTaskIdentifier, "IamRoleArn"=>IamRoleArn, "KmsKeyId"=>KmsKeyId, "S3BucketName"=>S3BucketName, "SourceArn"=>SourceArn, args...))
...
"""
StopActivityStream(ResourceArn) = rds("StopActivityStream", Dict{String, Any}("ResourceArn"=>ResourceArn))
StopActivityStream(ResourceArn, args::AbstractDict{String, <:Any}) = rds("StopActivityStream", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
StopDBCluster(DBClusterIdentifier) = rds("StopDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier))
StopDBCluster(DBClusterIdentifier, args::AbstractDict{String, <:Any}) = rds("StopDBCluster", Dict{String, Any}("DBClusterIdentifier"=>DBClusterIdentifier, args...))
...
"""
StopDBInstance(DBInstanceIdentifier) = rds("StopDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier))
StopDBInstance(DBInstanceIdentifier, args::AbstractDict{String, <:Any}) = rds("StopDBInstance", Dict{String, Any}("DBInstanceIdentifier"=>DBInstanceIdentifier, args...))
