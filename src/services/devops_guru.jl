...
- `config`:  A `NotificationChannelConfig` object that specifies what type of notification
  ...
  Service (Amazon SNS).
"""
add_notification_channel(Config; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("PUT", "/channels", Dict{String, Any}("Config"=>Config); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
add_notification_channel(Config, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("PUT", "/channels", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Config"=>Config), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_insight(Id; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("DELETE", "/insights/$(Id)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_insight(Id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("DELETE", "/insights/$(Id)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_account_health(; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/accounts/health"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_account_health(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/accounts/health", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_account_overview(FromTime; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/accounts/overview", Dict{String, Any}("FromTime"=>FromTime); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_account_overview(FromTime, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/accounts/overview", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FromTime"=>FromTime), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_anomaly(Id; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/anomalies/$(Id)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_anomaly(Id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/anomalies/$(Id)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
DevOps Guru.
"""
describe_event_sources_config(; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/event-sources"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_event_sources_config(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/event-sources", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_feedback(; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/feedback"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_feedback(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/feedback", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_insight(Id; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/insights/$(Id)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_insight(Id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/insights/$(Id)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_organization_health(; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/organization/health"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_organization_health(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/organization/health", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"ToTime"`:  The end of the time range passed in. The start time granularity is at the
  ...
  day. If this is not specified, then the current day is used.
"""
describe_organization_overview(FromTime; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/organization/overview", Dict{String, Any}("FromTime"=>FromTime); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_organization_overview(FromTime, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/organization/overview", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FromTime"=>FromTime), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The pagination token to use to retrieve the next page of results for this
  operation. If this value is null, it retrieves the first page.
"""
describe_resource_collection_health(ResourceCollectionType; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/accounts/health/resource-collection/$(ResourceCollectionType)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_resource_collection_health(ResourceCollectionType, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/accounts/health/resource-collection/$(ResourceCollectionType)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_service_integration(; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/service-integrations"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_service_integration(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/service-integrations", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The pagination token to use to retrieve the next page of results for this
  operation. If this value is null, it retrieves the first page.
"""
get_cost_estimation(; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/cost-estimation"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_cost_estimation(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/cost-estimation", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The pagination token to use to retrieve the next page of results for this
  operation. If this value is null, it retrieves the first page.
"""
get_resource_collection(ResourceCollectionType; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/resource-collections/$(ResourceCollectionType)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_resource_collection(ResourceCollectionType, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("GET", "/resource-collections/$(ResourceCollectionType)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_anomalies_for_insight(InsightId; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/anomalies/insight/$(InsightId)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_anomalies_for_insight(InsightId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/anomalies/insight/$(InsightId)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The pagination token to use to retrieve the next page of results for this
  operation. If this value is null, it retrieves the first page.
"""
list_anomalous_log_groups(InsightId; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/list-log-anomalies", Dict{String, Any}("InsightId"=>InsightId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_anomalous_log_groups(InsightId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/list-log-anomalies", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InsightId"=>InsightId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The pagination token to use to retrieve the next page of results for this
  operation. If this value is null, it retrieves the first page.
"""
list_events(Filters; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/events", Dict{String, Any}("Filters"=>Filters); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_events(Filters, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/events", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Filters"=>Filters), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The pagination token to use to retrieve the next page of results for this
  operation. If this value is null, it retrieves the first page.
"""
list_insights(StatusFilter; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/insights", Dict{String, Any}("StatusFilter"=>StatusFilter); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_insights(StatusFilter, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/insights", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StatusFilter"=>StatusFilter), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The pagination token to use to retrieve the next page of results for this
  operation. If this value is null, it retrieves the first page.
"""
list_monitored_resources(; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/monitoredResources"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_monitored_resources(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/monitoredResources", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The pagination token to use to retrieve the next page of results for this
  operation. If this value is null, it retrieves the first page.
"""
list_notification_channels(; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/channels"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_notification_channels(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/channels", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"OrganizationalUnitIds"`: The ID of the organizational unit.
"""
list_organization_insights(StatusFilter; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/organization/insights", Dict{String, Any}("StatusFilter"=>StatusFilter); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_organization_insights(StatusFilter, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/organization/insights", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StatusFilter"=>StatusFilter), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The pagination token to use to retrieve the next page of results for this
  operation. If this value is null, it retrieves the first page.
"""
list_recommendations(InsightId; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/recommendations", Dict{String, Any}("InsightId"=>InsightId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_recommendations(InsightId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/recommendations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InsightId"=>InsightId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"InsightFeedback"`:  The feedback from customers is about the recommendations in this
  insight.
"""
put_feedback(; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("PUT", "/feedback"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_feedback(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("PUT", "/feedback", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
remove_notification_channel(Id; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("DELETE", "/channels/$(Id)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
remove_notification_channel(Id, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("DELETE", "/channels/$(Id)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The pagination token to use to retrieve the next page of results for this
  operation. If this value is null, it retrieves the first page.
"""
search_insights(StartTimeRange, Type; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/insights/search", Dict{String, Any}("StartTimeRange"=>StartTimeRange, "Type"=>Type); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
search_insights(StartTimeRange, Type, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/insights/search", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StartTimeRange"=>StartTimeRange, "Type"=>Type), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: The pagination token to use to retrieve the next page of results for this
  operation. If this value is null, it retrieves the first page.
"""
search_organization_insights(AccountIds, StartTimeRange, Type; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("POST", "/organization/insights/search", Dict{String, Any}("AccountIds"=>AccountIds, "StartTimeRange"=>StartTimeRange, "Type"=>Type); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
start_cost_estimation(ResourceCollection; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("PUT", "/cost-estimation", Dict{String, Any}("ResourceCollection"=>ResourceCollection, "ClientToken"=>string(uuid4())); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_cost_estimation(ResourceCollection, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("PUT", "/cost-estimation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceCollection"=>ResourceCollection, "ClientToken"=>string(uuid4())), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_event_sources_config(; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("PUT", "/event-sources"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_event_sources_config(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("PUT", "/event-sources", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `resource_collection`:
"""
update_resource_collection(Action, ResourceCollection; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("PUT", "/resource-collections", Dict{String, Any}("Action"=>Action, "ResourceCollection"=>ResourceCollection); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_resource_collection(Action, ResourceCollection, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("PUT", "/resource-collections", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Action"=>Action, "ResourceCollection"=>ResourceCollection), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `service_integration`:  An `IntegratedServiceConfig` object used to specify the
  integrated service you want to update, and whether you want to update it to enabled or
  disabled.
"""
update_service_integration(ServiceIntegration; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("PUT", "/service-integrations", Dict{String, Any}("ServiceIntegration"=>ServiceIntegration); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_service_integration(ServiceIntegration, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = devops_guru("PUT", "/service-integrations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ServiceIntegration"=>ServiceIntegration), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
