...
"""
function add_notification_channel(Config; aws_config::AbstractAWSConfig=current_aws_config())
    return devops_guru(
        "PUT",
        "/channels",
...
function list_events(
    Filters, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return devops_guru(
        "POST",
        "/events",
