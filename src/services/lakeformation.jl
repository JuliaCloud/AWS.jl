...
- `"CatalogId"`: The identifier for the Data Catalog. By default, the account ID. The Data
  ...
  definitions, and other control information to manage your Lake Formation environment.
"""
function batch_grant_permissions(Entries; aws_config::AbstractAWSConfig=current_aws_config())
    return lakeformation(
        "POST",
...
"""
function deregister_resource(ResourceArn; aws_config::AbstractAWSConfig=current_aws_config())
    return lakeformation(
        "POST",
        "/DeregisterResource",
