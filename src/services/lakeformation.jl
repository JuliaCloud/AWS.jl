...
function delete_data_cells_filter(; aws_config::AbstractAWSConfig=current_aws_config())
    return lakeformation(
        "POST", "/DeleteDataCellsFilter"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function extend_transaction(; aws_config::AbstractAWSConfig=current_aws_config())
    return lakeformation(
        "POST", "/ExtendTransaction"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function extend_transaction(
    ...
    return lakeformation(
        "POST", "/ExtendTransaction", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_data_lake_principal(; aws_config::AbstractAWSConfig=current_aws_config())
    return lakeformation(
        "POST", "/GetDataLakePrincipal"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_data_lake_principal(
    ...
    return lakeformation(
        "POST", "/GetDataLakePrincipal", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_data_lake_settings(; aws_config::AbstractAWSConfig=current_aws_config())
    return lakeformation(
        "POST", "/GetDataLakeSettings"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_data_lake_settings(
    ...
    return lakeformation(
        "POST", "/GetDataLakeSettings", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_data_cells_filter(; aws_config::AbstractAWSConfig=current_aws_config())
    return lakeformation(
        "POST", "/ListDataCellsFilter"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_data_cells_filter(
    ...
    return lakeformation(
        "POST", "/ListDataCellsFilter", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_lake_formation_opt_ins(; aws_config::AbstractAWSConfig=current_aws_config())
    return lakeformation(
        "POST", "/ListLakeFormationOptIns"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_lftags(; aws_config::AbstractAWSConfig=current_aws_config())
    return lakeformation("POST", "/ListLFTags"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_lftags(
    ...
    return lakeformation(
        "POST", "/ListLFTags", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_permissions(; aws_config::AbstractAWSConfig=current_aws_config())
    return lakeformation(
        "POST", "/ListPermissions"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_transactions(; aws_config::AbstractAWSConfig=current_aws_config())
    return lakeformation(
        "POST", "/ListTransactions"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_transactions(
    ...
    return lakeformation(
        "POST", "/ListTransactions", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function start_transaction(; aws_config::AbstractAWSConfig=current_aws_config())
    return lakeformation(
        "POST", "/StartTransaction"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function start_transaction(
    ...
    return lakeformation(
        "POST", "/StartTransaction", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
