...
"""
CreateScalingPlan(ApplicationSource, ScalingInstructions, ScalingPlanName; aws::AWSConfig=AWSConfig()) = auto_scaling_plans("CreateScalingPlan", Dict{String, Any}("ApplicationSource"=>ApplicationSource, "ScalingInstructions"=>ScalingInstructions, "ScalingPlanName"=>ScalingPlanName); aws=aws)
CreateScalingPlan(ApplicationSource, ScalingInstructions, ScalingPlanName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = auto_scaling_plans("CreateScalingPlan", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationSource"=>ApplicationSource, "ScalingInstructions"=>ScalingInstructions, "ScalingPlanName"=>ScalingPlanName), args)); aws=aws)
...
"""
DeleteScalingPlan(ScalingPlanName, ScalingPlanVersion; aws::AWSConfig=AWSConfig()) = auto_scaling_plans("DeleteScalingPlan", Dict{String, Any}("ScalingPlanName"=>ScalingPlanName, "ScalingPlanVersion"=>ScalingPlanVersion); aws=aws)
DeleteScalingPlan(ScalingPlanName, ScalingPlanVersion, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = auto_scaling_plans("DeleteScalingPlan", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ScalingPlanName"=>ScalingPlanName, "ScalingPlanVersion"=>ScalingPlanVersion), args)); aws=aws)
...
"""
DescribeScalingPlanResources(ScalingPlanName, ScalingPlanVersion; aws::AWSConfig=AWSConfig()) = auto_scaling_plans("DescribeScalingPlanResources", Dict{String, Any}("ScalingPlanName"=>ScalingPlanName, "ScalingPlanVersion"=>ScalingPlanVersion); aws=aws)
DescribeScalingPlanResources(ScalingPlanName, ScalingPlanVersion, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = auto_scaling_plans("DescribeScalingPlanResources", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ScalingPlanName"=>ScalingPlanName, "ScalingPlanVersion"=>ScalingPlanVersion), args)); aws=aws)
...
"""
DescribeScalingPlans(; aws::AWSConfig=AWSConfig()) = auto_scaling_plans("DescribeScalingPlans"; aws=aws)
DescribeScalingPlans(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = auto_scaling_plans("DescribeScalingPlans", args; aws=aws)
...
"""
GetScalingPlanResourceForecastData(EndTime, ForecastDataType, ResourceId, ScalableDimension, ScalingPlanName, ScalingPlanVersion, ServiceNamespace, StartTime; aws::AWSConfig=AWSConfig()) = auto_scaling_plans("GetScalingPlanResourceForecastData", Dict{String, Any}("EndTime"=>EndTime, "ForecastDataType"=>ForecastDataType, "ResourceId"=>ResourceId, "ScalableDimension"=>ScalableDimension, "ScalingPlanName"=>ScalingPlanName, "ScalingPlanVersion"=>ScalingPlanVersion, "ServiceNamespace"=>ServiceNamespace, "StartTime"=>StartTime); aws=aws)
GetScalingPlanResourceForecastData(EndTime, ForecastDataType, ResourceId, ScalableDimension, ScalingPlanName, ScalingPlanVersion, ServiceNamespace, StartTime, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = auto_scaling_plans("GetScalingPlanResourceForecastData", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EndTime"=>EndTime, "ForecastDataType"=>ForecastDataType, "ResourceId"=>ResourceId, "ScalableDimension"=>ScalableDimension, "ScalingPlanName"=>ScalingPlanName, "ScalingPlanVersion"=>ScalingPlanVersion, "ServiceNamespace"=>ServiceNamespace, "StartTime"=>StartTime), args)); aws=aws)
...
- `ScalingInstructions`: The scaling instructions.
"""
UpdateScalingPlan(ScalingPlanName, ScalingPlanVersion; aws::AWSConfig=AWSConfig()) = auto_scaling_plans("UpdateScalingPlan", Dict{String, Any}("ScalingPlanName"=>ScalingPlanName, "ScalingPlanVersion"=>ScalingPlanVersion); aws=aws)
UpdateScalingPlan(ScalingPlanName, ScalingPlanVersion, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = auto_scaling_plans("UpdateScalingPlan", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ScalingPlanName"=>ScalingPlanName, "ScalingPlanVersion"=>ScalingPlanVersion), args)); aws=aws)
