...
describe_scaling_plans(params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()) = auto_scaling_plans("DescribeScalingPlans", params; aws_config=aws_config)
