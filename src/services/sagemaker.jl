...
"""
AddTags(ResourceArn, Tags) = sagemaker("AddTags", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags))
AddTags(ResourceArn, Tags, args::AbstractDict{String, <:Any}) = sagemaker("AddTags", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags, args...))
...
"""
AssociateTrialComponent(TrialComponentName, TrialName) = sagemaker("AssociateTrialComponent", Dict{String, Any}("TrialComponentName"=>TrialComponentName, "TrialName"=>TrialName))
AssociateTrialComponent(TrialComponentName, TrialName, args::AbstractDict{String, <:Any}) = sagemaker("AssociateTrialComponent", Dict{String, Any}("TrialComponentName"=>TrialComponentName, "TrialName"=>TrialName, args...))
...
"""
CreateAlgorithm(AlgorithmName, TrainingSpecification) = sagemaker("CreateAlgorithm", Dict{String, Any}("AlgorithmName"=>AlgorithmName, "TrainingSpecification"=>TrainingSpecification))
CreateAlgorithm(AlgorithmName, TrainingSpecification, args::AbstractDict{String, <:Any}) = sagemaker("CreateAlgorithm", Dict{String, Any}("AlgorithmName"=>AlgorithmName, "TrainingSpecification"=>TrainingSpecification, args...))
...
"""
CreateApp(AppName, AppType, DomainId, UserProfileName) = sagemaker("CreateApp", Dict{String, Any}("AppName"=>AppName, "AppType"=>AppType, "DomainId"=>DomainId, "UserProfileName"=>UserProfileName))
CreateApp(AppName, AppType, DomainId, UserProfileName, args::AbstractDict{String, <:Any}) = sagemaker("CreateApp", Dict{String, Any}("AppName"=>AppName, "AppType"=>AppType, "DomainId"=>DomainId, "UserProfileName"=>UserProfileName, args...))
...
- `Tags`: Each tag consists of a key and an optional value. Tag keys must be unique per resource.
"""
CreateAutoMLJob(AutoMLJobName, InputDataConfig, OutputDataConfig, RoleArn) = sagemaker("CreateAutoMLJob", Dict{String, Any}("AutoMLJobName"=>AutoMLJobName, "InputDataConfig"=>InputDataConfig, "OutputDataConfig"=>OutputDataConfig, "RoleArn"=>RoleArn))
CreateAutoMLJob(AutoMLJobName, InputDataConfig, OutputDataConfig, RoleArn, args::AbstractDict{String, <:Any}) = sagemaker("CreateAutoMLJob", Dict{String, Any}("AutoMLJobName"=>AutoMLJobName, "InputDataConfig"=>InputDataConfig, "OutputDataConfig"=>OutputDataConfig, "RoleArn"=>RoleArn, args...))
...
"""
CreateCodeRepository(CodeRepositoryName, GitConfig) = sagemaker("CreateCodeRepository", Dict{String, Any}("CodeRepositoryName"=>CodeRepositoryName, "GitConfig"=>GitConfig))
CreateCodeRepository(CodeRepositoryName, GitConfig, args::AbstractDict{String, <:Any}) = sagemaker("CreateCodeRepository", Dict{String, Any}("CodeRepositoryName"=>CodeRepositoryName, "GitConfig"=>GitConfig, args...))
...
"""
CreateCompilationJob(CompilationJobName, InputConfig, OutputConfig, RoleArn, StoppingCondition) = sagemaker("CreateCompilationJob", Dict{String, Any}("CompilationJobName"=>CompilationJobName, "InputConfig"=>InputConfig, "OutputConfig"=>OutputConfig, "RoleArn"=>RoleArn, "StoppingCondition"=>StoppingCondition))
CreateCompilationJob(CompilationJobName, InputConfig, OutputConfig, RoleArn, StoppingCondition, args::AbstractDict{String, <:Any}) = sagemaker("CreateCompilationJob", Dict{String, Any}("CompilationJobName"=>CompilationJobName, "InputConfig"=>InputConfig, "OutputConfig"=>OutputConfig, "RoleArn"=>RoleArn, "StoppingCondition"=>StoppingCondition, args...))
...
"""
CreateDomain(AuthMode, DefaultUserSettings, DomainName, SubnetIds, VpcId) = sagemaker("CreateDomain", Dict{String, Any}("AuthMode"=>AuthMode, "DefaultUserSettings"=>DefaultUserSettings, "DomainName"=>DomainName, "SubnetIds"=>SubnetIds, "VpcId"=>VpcId))
CreateDomain(AuthMode, DefaultUserSettings, DomainName, SubnetIds, VpcId, args::AbstractDict{String, <:Any}) = sagemaker("CreateDomain", Dict{String, Any}("AuthMode"=>AuthMode, "DefaultUserSettings"=>DefaultUserSettings, "DomainName"=>DomainName, "SubnetIds"=>SubnetIds, "VpcId"=>VpcId, args...))
...
"""
CreateEndpoint(EndpointConfigName, EndpointName) = sagemaker("CreateEndpoint", Dict{String, Any}("EndpointConfigName"=>EndpointConfigName, "EndpointName"=>EndpointName))
CreateEndpoint(EndpointConfigName, EndpointName, args::AbstractDict{String, <:Any}) = sagemaker("CreateEndpoint", Dict{String, Any}("EndpointConfigName"=>EndpointConfigName, "EndpointName"=>EndpointName, args...))
...
"""
CreateEndpointConfig(EndpointConfigName, ProductionVariants) = sagemaker("CreateEndpointConfig", Dict{String, Any}("EndpointConfigName"=>EndpointConfigName, "ProductionVariants"=>ProductionVariants))
CreateEndpointConfig(EndpointConfigName, ProductionVariants, args::AbstractDict{String, <:Any}) = sagemaker("CreateEndpointConfig", Dict{String, Any}("EndpointConfigName"=>EndpointConfigName, "ProductionVariants"=>ProductionVariants, args...))
...
"""
CreateExperiment(ExperimentName) = sagemaker("CreateExperiment", Dict{String, Any}("ExperimentName"=>ExperimentName))
CreateExperiment(ExperimentName, args::AbstractDict{String, <:Any}) = sagemaker("CreateExperiment", Dict{String, Any}("ExperimentName"=>ExperimentName, args...))
...
"""
CreateFlowDefinition(FlowDefinitionName, HumanLoopConfig, OutputConfig, RoleArn) = sagemaker("CreateFlowDefinition", Dict{String, Any}("FlowDefinitionName"=>FlowDefinitionName, "HumanLoopConfig"=>HumanLoopConfig, "OutputConfig"=>OutputConfig, "RoleArn"=>RoleArn))
CreateFlowDefinition(FlowDefinitionName, HumanLoopConfig, OutputConfig, RoleArn, args::AbstractDict{String, <:Any}) = sagemaker("CreateFlowDefinition", Dict{String, Any}("FlowDefinitionName"=>FlowDefinitionName, "HumanLoopConfig"=>HumanLoopConfig, "OutputConfig"=>OutputConfig, "RoleArn"=>RoleArn, args...))
...
"""
CreateHumanTaskUi(HumanTaskUiName, UiTemplate) = sagemaker("CreateHumanTaskUi", Dict{String, Any}("HumanTaskUiName"=>HumanTaskUiName, "UiTemplate"=>UiTemplate))
CreateHumanTaskUi(HumanTaskUiName, UiTemplate, args::AbstractDict{String, <:Any}) = sagemaker("CreateHumanTaskUi", Dict{String, Any}("HumanTaskUiName"=>HumanTaskUiName, "UiTemplate"=>UiTemplate, args...))
...
"""
CreateHyperParameterTuningJob(HyperParameterTuningJobConfig, HyperParameterTuningJobName) = sagemaker("CreateHyperParameterTuningJob", Dict{String, Any}("HyperParameterTuningJobConfig"=>HyperParameterTuningJobConfig, "HyperParameterTuningJobName"=>HyperParameterTuningJobName))
CreateHyperParameterTuningJob(HyperParameterTuningJobConfig, HyperParameterTuningJobName, args::AbstractDict{String, <:Any}) = sagemaker("CreateHyperParameterTuningJob", Dict{String, Any}("HyperParameterTuningJobConfig"=>HyperParameterTuningJobConfig, "HyperParameterTuningJobName"=>HyperParameterTuningJobName, args...))
...
"""
CreateLabelingJob(HumanTaskConfig, InputConfig, LabelAttributeName, LabelingJobName, OutputConfig, RoleArn) = sagemaker("CreateLabelingJob", Dict{String, Any}("HumanTaskConfig"=>HumanTaskConfig, "InputConfig"=>InputConfig, "LabelAttributeName"=>LabelAttributeName, "LabelingJobName"=>LabelingJobName, "OutputConfig"=>OutputConfig, "RoleArn"=>RoleArn))
CreateLabelingJob(HumanTaskConfig, InputConfig, LabelAttributeName, LabelingJobName, OutputConfig, RoleArn, args::AbstractDict{String, <:Any}) = sagemaker("CreateLabelingJob", Dict{String, Any}("HumanTaskConfig"=>HumanTaskConfig, "InputConfig"=>InputConfig, "LabelAttributeName"=>LabelAttributeName, "LabelingJobName"=>LabelingJobName, "OutputConfig"=>OutputConfig, "RoleArn"=>RoleArn, args...))
...
"""
CreateModel(ExecutionRoleArn, ModelName) = sagemaker("CreateModel", Dict{String, Any}("ExecutionRoleArn"=>ExecutionRoleArn, "ModelName"=>ModelName))
CreateModel(ExecutionRoleArn, ModelName, args::AbstractDict{String, <:Any}) = sagemaker("CreateModel", Dict{String, Any}("ExecutionRoleArn"=>ExecutionRoleArn, "ModelName"=>ModelName, args...))
...
"""
CreateModelPackage(ModelPackageName) = sagemaker("CreateModelPackage", Dict{String, Any}("ModelPackageName"=>ModelPackageName))
CreateModelPackage(ModelPackageName, args::AbstractDict{String, <:Any}) = sagemaker("CreateModelPackage", Dict{String, Any}("ModelPackageName"=>ModelPackageName, args...))
...
"""
CreateMonitoringSchedule(MonitoringScheduleConfig, MonitoringScheduleName) = sagemaker("CreateMonitoringSchedule", Dict{String, Any}("MonitoringScheduleConfig"=>MonitoringScheduleConfig, "MonitoringScheduleName"=>MonitoringScheduleName))
CreateMonitoringSchedule(MonitoringScheduleConfig, MonitoringScheduleName, args::AbstractDict{String, <:Any}) = sagemaker("CreateMonitoringSchedule", Dict{String, Any}("MonitoringScheduleConfig"=>MonitoringScheduleConfig, "MonitoringScheduleName"=>MonitoringScheduleName, args...))
...
"""
CreateNotebookInstance(InstanceType, NotebookInstanceName, RoleArn) = sagemaker("CreateNotebookInstance", Dict{String, Any}("InstanceType"=>InstanceType, "NotebookInstanceName"=>NotebookInstanceName, "RoleArn"=>RoleArn))
CreateNotebookInstance(InstanceType, NotebookInstanceName, RoleArn, args::AbstractDict{String, <:Any}) = sagemaker("CreateNotebookInstance", Dict{String, Any}("InstanceType"=>InstanceType, "NotebookInstanceName"=>NotebookInstanceName, "RoleArn"=>RoleArn, args...))
...
"""
CreateNotebookInstanceLifecycleConfig(NotebookInstanceLifecycleConfigName) = sagemaker("CreateNotebookInstanceLifecycleConfig", Dict{String, Any}("NotebookInstanceLifecycleConfigName"=>NotebookInstanceLifecycleConfigName))
CreateNotebookInstanceLifecycleConfig(NotebookInstanceLifecycleConfigName, args::AbstractDict{String, <:Any}) = sagemaker("CreateNotebookInstanceLifecycleConfig", Dict{String, Any}("NotebookInstanceLifecycleConfigName"=>NotebookInstanceLifecycleConfigName, args...))
...
"""
CreatePresignedDomainUrl(DomainId, UserProfileName) = sagemaker("CreatePresignedDomainUrl", Dict{String, Any}("DomainId"=>DomainId, "UserProfileName"=>UserProfileName))
CreatePresignedDomainUrl(DomainId, UserProfileName, args::AbstractDict{String, <:Any}) = sagemaker("CreatePresignedDomainUrl", Dict{String, Any}("DomainId"=>DomainId, "UserProfileName"=>UserProfileName, args...))
...
"""
CreatePresignedNotebookInstanceUrl(NotebookInstanceName) = sagemaker("CreatePresignedNotebookInstanceUrl", Dict{String, Any}("NotebookInstanceName"=>NotebookInstanceName))
CreatePresignedNotebookInstanceUrl(NotebookInstanceName, args::AbstractDict{String, <:Any}) = sagemaker("CreatePresignedNotebookInstanceUrl", Dict{String, Any}("NotebookInstanceName"=>NotebookInstanceName, args...))
...
- `Tags`: (Optional) An array of key-value pairs. For more information, see Using Cost Allocation Tags in the AWS Billing and Cost Management User Guide.
"""
CreateProcessingJob(AppSpecification, ProcessingJobName, ProcessingResources, RoleArn) = sagemaker("CreateProcessingJob", Dict{String, Any}("AppSpecification"=>AppSpecification, "ProcessingJobName"=>ProcessingJobName, "ProcessingResources"=>ProcessingResources, "RoleArn"=>RoleArn))
CreateProcessingJob(AppSpecification, ProcessingJobName, ProcessingResources, RoleArn, args::AbstractDict{String, <:Any}) = sagemaker("CreateProcessingJob", Dict{String, Any}("AppSpecification"=>AppSpecification, "ProcessingJobName"=>ProcessingJobName, "ProcessingResources"=>ProcessingResources, "RoleArn"=>RoleArn, args...))
...
"""
CreateTrainingJob(AlgorithmSpecification, OutputDataConfig, ResourceConfig, RoleArn, StoppingCondition, TrainingJobName) = sagemaker("CreateTrainingJob", Dict{String, Any}("AlgorithmSpecification"=>AlgorithmSpecification, "OutputDataConfig"=>OutputDataConfig, "ResourceConfig"=>ResourceConfig, "RoleArn"=>RoleArn, "StoppingCondition"=>StoppingCondition, "TrainingJobName"=>TrainingJobName))
CreateTrainingJob(AlgorithmSpecification, OutputDataConfig, ResourceConfig, RoleArn, StoppingCondition, TrainingJobName, args::AbstractDict{String, <:Any}) = sagemaker("CreateTrainingJob", Dict{String, Any}("AlgorithmSpecification"=>AlgorithmSpecification, "OutputDataConfig"=>OutputDataConfig, "ResourceConfig"=>ResourceConfig, "RoleArn"=>RoleArn, "StoppingCondition"=>StoppingCondition, "TrainingJobName"=>TrainingJobName, args...))
...
- `Tags`: (Optional) An array of key-value pairs. For more information, see Using Cost Allocation Tags in the AWS Billing and Cost Management User Guide.
"""
CreateTransformJob(ModelName, TransformInput, TransformJobName, TransformOutput, TransformResources) = sagemaker("CreateTransformJob", Dict{String, Any}("ModelName"=>ModelName, "TransformInput"=>TransformInput, "TransformJobName"=>TransformJobName, "TransformOutput"=>TransformOutput, "TransformResources"=>TransformResources))
CreateTransformJob(ModelName, TransformInput, TransformJobName, TransformOutput, TransformResources, args::AbstractDict{String, <:Any}) = sagemaker("CreateTransformJob", Dict{String, Any}("ModelName"=>ModelName, "TransformInput"=>TransformInput, "TransformJobName"=>TransformJobName, "TransformOutput"=>TransformOutput, "TransformResources"=>TransformResources, args...))
...
"""
CreateTrial(ExperimentName, TrialName) = sagemaker("CreateTrial", Dict{String, Any}("ExperimentName"=>ExperimentName, "TrialName"=>TrialName))
CreateTrial(ExperimentName, TrialName, args::AbstractDict{String, <:Any}) = sagemaker("CreateTrial", Dict{String, Any}("ExperimentName"=>ExperimentName, "TrialName"=>TrialName, args...))
...
"""
CreateTrialComponent(TrialComponentName) = sagemaker("CreateTrialComponent", Dict{String, Any}("TrialComponentName"=>TrialComponentName))
CreateTrialComponent(TrialComponentName, args::AbstractDict{String, <:Any}) = sagemaker("CreateTrialComponent", Dict{String, Any}("TrialComponentName"=>TrialComponentName, args...))
...
"""
CreateUserProfile(DomainId, UserProfileName) = sagemaker("CreateUserProfile", Dict{String, Any}("DomainId"=>DomainId, "UserProfileName"=>UserProfileName))
CreateUserProfile(DomainId, UserProfileName, args::AbstractDict{String, <:Any}) = sagemaker("CreateUserProfile", Dict{String, Any}("DomainId"=>DomainId, "UserProfileName"=>UserProfileName, args...))
...
"""
CreateWorkforce(WorkforceName) = sagemaker("CreateWorkforce", Dict{String, Any}("WorkforceName"=>WorkforceName))
CreateWorkforce(WorkforceName, args::AbstractDict{String, <:Any}) = sagemaker("CreateWorkforce", Dict{String, Any}("WorkforceName"=>WorkforceName, args...))
...
"""
CreateWorkteam(Description, MemberDefinitions, WorkteamName) = sagemaker("CreateWorkteam", Dict{String, Any}("Description"=>Description, "MemberDefinitions"=>MemberDefinitions, "WorkteamName"=>WorkteamName))
CreateWorkteam(Description, MemberDefinitions, WorkteamName, args::AbstractDict{String, <:Any}) = sagemaker("CreateWorkteam", Dict{String, Any}("Description"=>Description, "MemberDefinitions"=>MemberDefinitions, "WorkteamName"=>WorkteamName, args...))
...
"""
DeleteAlgorithm(AlgorithmName) = sagemaker("DeleteAlgorithm", Dict{String, Any}("AlgorithmName"=>AlgorithmName))
DeleteAlgorithm(AlgorithmName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteAlgorithm", Dict{String, Any}("AlgorithmName"=>AlgorithmName, args...))
...
"""
DeleteApp(AppName, AppType, DomainId, UserProfileName) = sagemaker("DeleteApp", Dict{String, Any}("AppName"=>AppName, "AppType"=>AppType, "DomainId"=>DomainId, "UserProfileName"=>UserProfileName))
DeleteApp(AppName, AppType, DomainId, UserProfileName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteApp", Dict{String, Any}("AppName"=>AppName, "AppType"=>AppType, "DomainId"=>DomainId, "UserProfileName"=>UserProfileName, args...))
...
"""
DeleteCodeRepository(CodeRepositoryName) = sagemaker("DeleteCodeRepository", Dict{String, Any}("CodeRepositoryName"=>CodeRepositoryName))
DeleteCodeRepository(CodeRepositoryName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteCodeRepository", Dict{String, Any}("CodeRepositoryName"=>CodeRepositoryName, args...))
...
"""
DeleteDomain(DomainId) = sagemaker("DeleteDomain", Dict{String, Any}("DomainId"=>DomainId))
DeleteDomain(DomainId, args::AbstractDict{String, <:Any}) = sagemaker("DeleteDomain", Dict{String, Any}("DomainId"=>DomainId, args...))
...
"""
DeleteEndpoint(EndpointName) = sagemaker("DeleteEndpoint", Dict{String, Any}("EndpointName"=>EndpointName))
DeleteEndpoint(EndpointName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteEndpoint", Dict{String, Any}("EndpointName"=>EndpointName, args...))
...
"""
DeleteEndpointConfig(EndpointConfigName) = sagemaker("DeleteEndpointConfig", Dict{String, Any}("EndpointConfigName"=>EndpointConfigName))
DeleteEndpointConfig(EndpointConfigName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteEndpointConfig", Dict{String, Any}("EndpointConfigName"=>EndpointConfigName, args...))
...
"""
DeleteExperiment(ExperimentName) = sagemaker("DeleteExperiment", Dict{String, Any}("ExperimentName"=>ExperimentName))
DeleteExperiment(ExperimentName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteExperiment", Dict{String, Any}("ExperimentName"=>ExperimentName, args...))
...
"""
DeleteFlowDefinition(FlowDefinitionName) = sagemaker("DeleteFlowDefinition", Dict{String, Any}("FlowDefinitionName"=>FlowDefinitionName))
DeleteFlowDefinition(FlowDefinitionName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteFlowDefinition", Dict{String, Any}("FlowDefinitionName"=>FlowDefinitionName, args...))
...
"""
DeleteHumanTaskUi(HumanTaskUiName) = sagemaker("DeleteHumanTaskUi", Dict{String, Any}("HumanTaskUiName"=>HumanTaskUiName))
DeleteHumanTaskUi(HumanTaskUiName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteHumanTaskUi", Dict{String, Any}("HumanTaskUiName"=>HumanTaskUiName, args...))
...
"""
DeleteModel(ModelName) = sagemaker("DeleteModel", Dict{String, Any}("ModelName"=>ModelName))
DeleteModel(ModelName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteModel", Dict{String, Any}("ModelName"=>ModelName, args...))
...
"""
DeleteModelPackage(ModelPackageName) = sagemaker("DeleteModelPackage", Dict{String, Any}("ModelPackageName"=>ModelPackageName))
DeleteModelPackage(ModelPackageName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteModelPackage", Dict{String, Any}("ModelPackageName"=>ModelPackageName, args...))
...
"""
DeleteMonitoringSchedule(MonitoringScheduleName) = sagemaker("DeleteMonitoringSchedule", Dict{String, Any}("MonitoringScheduleName"=>MonitoringScheduleName))
DeleteMonitoringSchedule(MonitoringScheduleName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteMonitoringSchedule", Dict{String, Any}("MonitoringScheduleName"=>MonitoringScheduleName, args...))
...
"""
DeleteNotebookInstance(NotebookInstanceName) = sagemaker("DeleteNotebookInstance", Dict{String, Any}("NotebookInstanceName"=>NotebookInstanceName))
DeleteNotebookInstance(NotebookInstanceName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteNotebookInstance", Dict{String, Any}("NotebookInstanceName"=>NotebookInstanceName, args...))
...
"""
DeleteNotebookInstanceLifecycleConfig(NotebookInstanceLifecycleConfigName) = sagemaker("DeleteNotebookInstanceLifecycleConfig", Dict{String, Any}("NotebookInstanceLifecycleConfigName"=>NotebookInstanceLifecycleConfigName))
DeleteNotebookInstanceLifecycleConfig(NotebookInstanceLifecycleConfigName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteNotebookInstanceLifecycleConfig", Dict{String, Any}("NotebookInstanceLifecycleConfigName"=>NotebookInstanceLifecycleConfigName, args...))
...
"""
DeleteTags(ResourceArn, TagKeys) = sagemaker("DeleteTags", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys))
DeleteTags(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}) = sagemaker("DeleteTags", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys, args...))
...
"""
DeleteTrial(TrialName) = sagemaker("DeleteTrial", Dict{String, Any}("TrialName"=>TrialName))
DeleteTrial(TrialName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteTrial", Dict{String, Any}("TrialName"=>TrialName, args...))
...
"""
DeleteTrialComponent(TrialComponentName) = sagemaker("DeleteTrialComponent", Dict{String, Any}("TrialComponentName"=>TrialComponentName))
DeleteTrialComponent(TrialComponentName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteTrialComponent", Dict{String, Any}("TrialComponentName"=>TrialComponentName, args...))
...
"""
DeleteUserProfile(DomainId, UserProfileName) = sagemaker("DeleteUserProfile", Dict{String, Any}("DomainId"=>DomainId, "UserProfileName"=>UserProfileName))
DeleteUserProfile(DomainId, UserProfileName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteUserProfile", Dict{String, Any}("DomainId"=>DomainId, "UserProfileName"=>UserProfileName, args...))
...
"""
DeleteWorkforce(WorkforceName) = sagemaker("DeleteWorkforce", Dict{String, Any}("WorkforceName"=>WorkforceName))
DeleteWorkforce(WorkforceName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteWorkforce", Dict{String, Any}("WorkforceName"=>WorkforceName, args...))
...
"""
DeleteWorkteam(WorkteamName) = sagemaker("DeleteWorkteam", Dict{String, Any}("WorkteamName"=>WorkteamName))
DeleteWorkteam(WorkteamName, args::AbstractDict{String, <:Any}) = sagemaker("DeleteWorkteam", Dict{String, Any}("WorkteamName"=>WorkteamName, args...))
...
"""
DescribeAlgorithm(AlgorithmName) = sagemaker("DescribeAlgorithm", Dict{String, Any}("AlgorithmName"=>AlgorithmName))
DescribeAlgorithm(AlgorithmName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeAlgorithm", Dict{String, Any}("AlgorithmName"=>AlgorithmName, args...))
...
"""
DescribeApp(AppName, AppType, DomainId, UserProfileName) = sagemaker("DescribeApp", Dict{String, Any}("AppName"=>AppName, "AppType"=>AppType, "DomainId"=>DomainId, "UserProfileName"=>UserProfileName))
DescribeApp(AppName, AppType, DomainId, UserProfileName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeApp", Dict{String, Any}("AppName"=>AppName, "AppType"=>AppType, "DomainId"=>DomainId, "UserProfileName"=>UserProfileName, args...))
...
"""
DescribeAutoMLJob(AutoMLJobName) = sagemaker("DescribeAutoMLJob", Dict{String, Any}("AutoMLJobName"=>AutoMLJobName))
DescribeAutoMLJob(AutoMLJobName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeAutoMLJob", Dict{String, Any}("AutoMLJobName"=>AutoMLJobName, args...))
...
"""
DescribeCodeRepository(CodeRepositoryName) = sagemaker("DescribeCodeRepository", Dict{String, Any}("CodeRepositoryName"=>CodeRepositoryName))
DescribeCodeRepository(CodeRepositoryName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeCodeRepository", Dict{String, Any}("CodeRepositoryName"=>CodeRepositoryName, args...))
...
"""
DescribeCompilationJob(CompilationJobName) = sagemaker("DescribeCompilationJob", Dict{String, Any}("CompilationJobName"=>CompilationJobName))
DescribeCompilationJob(CompilationJobName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeCompilationJob", Dict{String, Any}("CompilationJobName"=>CompilationJobName, args...))
...
"""
DescribeDomain(DomainId) = sagemaker("DescribeDomain", Dict{String, Any}("DomainId"=>DomainId))
DescribeDomain(DomainId, args::AbstractDict{String, <:Any}) = sagemaker("DescribeDomain", Dict{String, Any}("DomainId"=>DomainId, args...))
...
"""
DescribeEndpoint(EndpointName) = sagemaker("DescribeEndpoint", Dict{String, Any}("EndpointName"=>EndpointName))
DescribeEndpoint(EndpointName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeEndpoint", Dict{String, Any}("EndpointName"=>EndpointName, args...))
...
"""
DescribeEndpointConfig(EndpointConfigName) = sagemaker("DescribeEndpointConfig", Dict{String, Any}("EndpointConfigName"=>EndpointConfigName))
DescribeEndpointConfig(EndpointConfigName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeEndpointConfig", Dict{String, Any}("EndpointConfigName"=>EndpointConfigName, args...))
...
"""
DescribeExperiment(ExperimentName) = sagemaker("DescribeExperiment", Dict{String, Any}("ExperimentName"=>ExperimentName))
DescribeExperiment(ExperimentName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeExperiment", Dict{String, Any}("ExperimentName"=>ExperimentName, args...))
...
"""
DescribeFlowDefinition(FlowDefinitionName) = sagemaker("DescribeFlowDefinition", Dict{String, Any}("FlowDefinitionName"=>FlowDefinitionName))
DescribeFlowDefinition(FlowDefinitionName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeFlowDefinition", Dict{String, Any}("FlowDefinitionName"=>FlowDefinitionName, args...))
...
"""
DescribeHumanTaskUi(HumanTaskUiName) = sagemaker("DescribeHumanTaskUi", Dict{String, Any}("HumanTaskUiName"=>HumanTaskUiName))
DescribeHumanTaskUi(HumanTaskUiName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeHumanTaskUi", Dict{String, Any}("HumanTaskUiName"=>HumanTaskUiName, args...))
...
"""
DescribeHyperParameterTuningJob(HyperParameterTuningJobName) = sagemaker("DescribeHyperParameterTuningJob", Dict{String, Any}("HyperParameterTuningJobName"=>HyperParameterTuningJobName))
DescribeHyperParameterTuningJob(HyperParameterTuningJobName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeHyperParameterTuningJob", Dict{String, Any}("HyperParameterTuningJobName"=>HyperParameterTuningJobName, args...))
...
"""
DescribeLabelingJob(LabelingJobName) = sagemaker("DescribeLabelingJob", Dict{String, Any}("LabelingJobName"=>LabelingJobName))
DescribeLabelingJob(LabelingJobName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeLabelingJob", Dict{String, Any}("LabelingJobName"=>LabelingJobName, args...))
...
"""
DescribeModel(ModelName) = sagemaker("DescribeModel", Dict{String, Any}("ModelName"=>ModelName))
DescribeModel(ModelName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeModel", Dict{String, Any}("ModelName"=>ModelName, args...))
...
"""
DescribeModelPackage(ModelPackageName) = sagemaker("DescribeModelPackage", Dict{String, Any}("ModelPackageName"=>ModelPackageName))
DescribeModelPackage(ModelPackageName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeModelPackage", Dict{String, Any}("ModelPackageName"=>ModelPackageName, args...))
...
"""
DescribeMonitoringSchedule(MonitoringScheduleName) = sagemaker("DescribeMonitoringSchedule", Dict{String, Any}("MonitoringScheduleName"=>MonitoringScheduleName))
DescribeMonitoringSchedule(MonitoringScheduleName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeMonitoringSchedule", Dict{String, Any}("MonitoringScheduleName"=>MonitoringScheduleName, args...))
...
"""
DescribeNotebookInstance(NotebookInstanceName) = sagemaker("DescribeNotebookInstance", Dict{String, Any}("NotebookInstanceName"=>NotebookInstanceName))
DescribeNotebookInstance(NotebookInstanceName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeNotebookInstance", Dict{String, Any}("NotebookInstanceName"=>NotebookInstanceName, args...))
...
"""
DescribeNotebookInstanceLifecycleConfig(NotebookInstanceLifecycleConfigName) = sagemaker("DescribeNotebookInstanceLifecycleConfig", Dict{String, Any}("NotebookInstanceLifecycleConfigName"=>NotebookInstanceLifecycleConfigName))
DescribeNotebookInstanceLifecycleConfig(NotebookInstanceLifecycleConfigName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeNotebookInstanceLifecycleConfig", Dict{String, Any}("NotebookInstanceLifecycleConfigName"=>NotebookInstanceLifecycleConfigName, args...))
...
"""
DescribeProcessingJob(ProcessingJobName) = sagemaker("DescribeProcessingJob", Dict{String, Any}("ProcessingJobName"=>ProcessingJobName))
DescribeProcessingJob(ProcessingJobName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeProcessingJob", Dict{String, Any}("ProcessingJobName"=>ProcessingJobName, args...))
...
"""
DescribeSubscribedWorkteam(WorkteamArn) = sagemaker("DescribeSubscribedWorkteam", Dict{String, Any}("WorkteamArn"=>WorkteamArn))
DescribeSubscribedWorkteam(WorkteamArn, args::AbstractDict{String, <:Any}) = sagemaker("DescribeSubscribedWorkteam", Dict{String, Any}("WorkteamArn"=>WorkteamArn, args...))
...
"""
DescribeTrainingJob(TrainingJobName) = sagemaker("DescribeTrainingJob", Dict{String, Any}("TrainingJobName"=>TrainingJobName))
DescribeTrainingJob(TrainingJobName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeTrainingJob", Dict{String, Any}("TrainingJobName"=>TrainingJobName, args...))
...
"""
DescribeTransformJob(TransformJobName) = sagemaker("DescribeTransformJob", Dict{String, Any}("TransformJobName"=>TransformJobName))
DescribeTransformJob(TransformJobName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeTransformJob", Dict{String, Any}("TransformJobName"=>TransformJobName, args...))
...
"""
DescribeTrial(TrialName) = sagemaker("DescribeTrial", Dict{String, Any}("TrialName"=>TrialName))
DescribeTrial(TrialName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeTrial", Dict{String, Any}("TrialName"=>TrialName, args...))
...
"""
DescribeTrialComponent(TrialComponentName) = sagemaker("DescribeTrialComponent", Dict{String, Any}("TrialComponentName"=>TrialComponentName))
DescribeTrialComponent(TrialComponentName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeTrialComponent", Dict{String, Any}("TrialComponentName"=>TrialComponentName, args...))
...
"""
DescribeUserProfile(DomainId, UserProfileName) = sagemaker("DescribeUserProfile", Dict{String, Any}("DomainId"=>DomainId, "UserProfileName"=>UserProfileName))
DescribeUserProfile(DomainId, UserProfileName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeUserProfile", Dict{String, Any}("DomainId"=>DomainId, "UserProfileName"=>UserProfileName, args...))
...
"""
DescribeWorkforce(WorkforceName) = sagemaker("DescribeWorkforce", Dict{String, Any}("WorkforceName"=>WorkforceName))
DescribeWorkforce(WorkforceName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeWorkforce", Dict{String, Any}("WorkforceName"=>WorkforceName, args...))
...
"""
DescribeWorkteam(WorkteamName) = sagemaker("DescribeWorkteam", Dict{String, Any}("WorkteamName"=>WorkteamName))
DescribeWorkteam(WorkteamName, args::AbstractDict{String, <:Any}) = sagemaker("DescribeWorkteam", Dict{String, Any}("WorkteamName"=>WorkteamName, args...))
...
"""
DisassociateTrialComponent(TrialComponentName, TrialName) = sagemaker("DisassociateTrialComponent", Dict{String, Any}("TrialComponentName"=>TrialComponentName, "TrialName"=>TrialName))
DisassociateTrialComponent(TrialComponentName, TrialName, args::AbstractDict{String, <:Any}) = sagemaker("DisassociateTrialComponent", Dict{String, Any}("TrialComponentName"=>TrialComponentName, "TrialName"=>TrialName, args...))
...
"""
GetSearchSuggestions(Resource) = sagemaker("GetSearchSuggestions", Dict{String, Any}("Resource"=>Resource))
GetSearchSuggestions(Resource, args::AbstractDict{String, <:Any}) = sagemaker("GetSearchSuggestions", Dict{String, Any}("Resource"=>Resource, args...))
...
ListAlgorithms(args::AbstractDict{String, <:Any}) = sagemaker("ListAlgorithms", args)
...
ListApps(args::AbstractDict{String, <:Any}) = sagemaker("ListApps", args)
...
ListAutoMLJobs(args::AbstractDict{String, <:Any}) = sagemaker("ListAutoMLJobs", args)
...
"""
ListCandidatesForAutoMLJob(AutoMLJobName) = sagemaker("ListCandidatesForAutoMLJob", Dict{String, Any}("AutoMLJobName"=>AutoMLJobName))
ListCandidatesForAutoMLJob(AutoMLJobName, args::AbstractDict{String, <:Any}) = sagemaker("ListCandidatesForAutoMLJob", Dict{String, Any}("AutoMLJobName"=>AutoMLJobName, args...))
...
ListCodeRepositories(args::AbstractDict{String, <:Any}) = sagemaker("ListCodeRepositories", args)
...
ListCompilationJobs(args::AbstractDict{String, <:Any}) = sagemaker("ListCompilationJobs", args)
...
ListDomains(args::AbstractDict{String, <:Any}) = sagemaker("ListDomains", args)
...
ListEndpointConfigs(args::AbstractDict{String, <:Any}) = sagemaker("ListEndpointConfigs", args)
...
ListEndpoints(args::AbstractDict{String, <:Any}) = sagemaker("ListEndpoints", args)
...
ListExperiments(args::AbstractDict{String, <:Any}) = sagemaker("ListExperiments", args)
...
ListFlowDefinitions(args::AbstractDict{String, <:Any}) = sagemaker("ListFlowDefinitions", args)
...
ListHumanTaskUis(args::AbstractDict{String, <:Any}) = sagemaker("ListHumanTaskUis", args)
...
ListHyperParameterTuningJobs(args::AbstractDict{String, <:Any}) = sagemaker("ListHyperParameterTuningJobs", args)
...
ListLabelingJobs(args::AbstractDict{String, <:Any}) = sagemaker("ListLabelingJobs", args)
...
- `SortOrder`: The sort order for results. The default is Ascending.
"""
ListLabelingJobsForWorkteam(WorkteamArn) = sagemaker("ListLabelingJobsForWorkteam", Dict{String, Any}("WorkteamArn"=>WorkteamArn))
ListLabelingJobsForWorkteam(WorkteamArn, args::AbstractDict{String, <:Any}) = sagemaker("ListLabelingJobsForWorkteam", Dict{String, Any}("WorkteamArn"=>WorkteamArn, args...))
...
ListModelPackages(args::AbstractDict{String, <:Any}) = sagemaker("ListModelPackages", args)
...
ListModels(args::AbstractDict{String, <:Any}) = sagemaker("ListModels", args)
...
ListMonitoringExecutions(args::AbstractDict{String, <:Any}) = sagemaker("ListMonitoringExecutions", args)
...
ListMonitoringSchedules(args::AbstractDict{String, <:Any}) = sagemaker("ListMonitoringSchedules", args)
...
ListNotebookInstanceLifecycleConfigs(args::AbstractDict{String, <:Any}) = sagemaker("ListNotebookInstanceLifecycleConfigs", args)
...
ListNotebookInstances(args::AbstractDict{String, <:Any}) = sagemaker("ListNotebookInstances", args)
...
ListProcessingJobs(args::AbstractDict{String, <:Any}) = sagemaker("ListProcessingJobs", args)
...
ListSubscribedWorkteams(args::AbstractDict{String, <:Any}) = sagemaker("ListSubscribedWorkteams", args)
...
"""
ListTags(ResourceArn) = sagemaker("ListTags", Dict{String, Any}("ResourceArn"=>ResourceArn))
ListTags(ResourceArn, args::AbstractDict{String, <:Any}) = sagemaker("ListTags", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
ListTrainingJobs(args::AbstractDict{String, <:Any}) = sagemaker("ListTrainingJobs", args)
...
"""
ListTrainingJobsForHyperParameterTuningJob(HyperParameterTuningJobName) = sagemaker("ListTrainingJobsForHyperParameterTuningJob", Dict{String, Any}("HyperParameterTuningJobName"=>HyperParameterTuningJobName))
ListTrainingJobsForHyperParameterTuningJob(HyperParameterTuningJobName, args::AbstractDict{String, <:Any}) = sagemaker("ListTrainingJobsForHyperParameterTuningJob", Dict{String, Any}("HyperParameterTuningJobName"=>HyperParameterTuningJobName, args...))
...
ListTransformJobs(args::AbstractDict{String, <:Any}) = sagemaker("ListTransformJobs", args)
...
ListTrialComponents(args::AbstractDict{String, <:Any}) = sagemaker("ListTrialComponents", args)
...
ListTrials(args::AbstractDict{String, <:Any}) = sagemaker("ListTrials", args)
...
ListUserProfiles(args::AbstractDict{String, <:Any}) = sagemaker("ListUserProfiles", args)
...
ListWorkforces(args::AbstractDict{String, <:Any}) = sagemaker("ListWorkforces", args)
...
ListWorkteams(args::AbstractDict{String, <:Any}) = sagemaker("ListWorkteams", args)
...
"""
RenderUiTemplate(RoleArn, Task) = sagemaker("RenderUiTemplate", Dict{String, Any}("RoleArn"=>RoleArn, "Task"=>Task))
RenderUiTemplate(RoleArn, Task, args::AbstractDict{String, <:Any}) = sagemaker("RenderUiTemplate", Dict{String, Any}("RoleArn"=>RoleArn, "Task"=>Task, args...))
...
"""
Search(Resource) = sagemaker("Search", Dict{String, Any}("Resource"=>Resource))
Search(Resource, args::AbstractDict{String, <:Any}) = sagemaker("Search", Dict{String, Any}("Resource"=>Resource, args...))
...
"""
StartMonitoringSchedule(MonitoringScheduleName) = sagemaker("StartMonitoringSchedule", Dict{String, Any}("MonitoringScheduleName"=>MonitoringScheduleName))
StartMonitoringSchedule(MonitoringScheduleName, args::AbstractDict{String, <:Any}) = sagemaker("StartMonitoringSchedule", Dict{String, Any}("MonitoringScheduleName"=>MonitoringScheduleName, args...))
...
"""
StartNotebookInstance(NotebookInstanceName) = sagemaker("StartNotebookInstance", Dict{String, Any}("NotebookInstanceName"=>NotebookInstanceName))
StartNotebookInstance(NotebookInstanceName, args::AbstractDict{String, <:Any}) = sagemaker("StartNotebookInstance", Dict{String, Any}("NotebookInstanceName"=>NotebookInstanceName, args...))
...
"""
StopAutoMLJob(AutoMLJobName) = sagemaker("StopAutoMLJob", Dict{String, Any}("AutoMLJobName"=>AutoMLJobName))
StopAutoMLJob(AutoMLJobName, args::AbstractDict{String, <:Any}) = sagemaker("StopAutoMLJob", Dict{String, Any}("AutoMLJobName"=>AutoMLJobName, args...))
...
"""
StopCompilationJob(CompilationJobName) = sagemaker("StopCompilationJob", Dict{String, Any}("CompilationJobName"=>CompilationJobName))
StopCompilationJob(CompilationJobName, args::AbstractDict{String, <:Any}) = sagemaker("StopCompilationJob", Dict{String, Any}("CompilationJobName"=>CompilationJobName, args...))
...
"""
StopHyperParameterTuningJob(HyperParameterTuningJobName) = sagemaker("StopHyperParameterTuningJob", Dict{String, Any}("HyperParameterTuningJobName"=>HyperParameterTuningJobName))
StopHyperParameterTuningJob(HyperParameterTuningJobName, args::AbstractDict{String, <:Any}) = sagemaker("StopHyperParameterTuningJob", Dict{String, Any}("HyperParameterTuningJobName"=>HyperParameterTuningJobName, args...))
...
"""
StopLabelingJob(LabelingJobName) = sagemaker("StopLabelingJob", Dict{String, Any}("LabelingJobName"=>LabelingJobName))
StopLabelingJob(LabelingJobName, args::AbstractDict{String, <:Any}) = sagemaker("StopLabelingJob", Dict{String, Any}("LabelingJobName"=>LabelingJobName, args...))
...
"""
StopMonitoringSchedule(MonitoringScheduleName) = sagemaker("StopMonitoringSchedule", Dict{String, Any}("MonitoringScheduleName"=>MonitoringScheduleName))
StopMonitoringSchedule(MonitoringScheduleName, args::AbstractDict{String, <:Any}) = sagemaker("StopMonitoringSchedule", Dict{String, Any}("MonitoringScheduleName"=>MonitoringScheduleName, args...))
...
"""
StopNotebookInstance(NotebookInstanceName) = sagemaker("StopNotebookInstance", Dict{String, Any}("NotebookInstanceName"=>NotebookInstanceName))
StopNotebookInstance(NotebookInstanceName, args::AbstractDict{String, <:Any}) = sagemaker("StopNotebookInstance", Dict{String, Any}("NotebookInstanceName"=>NotebookInstanceName, args...))
...
"""
StopProcessingJob(ProcessingJobName) = sagemaker("StopProcessingJob", Dict{String, Any}("ProcessingJobName"=>ProcessingJobName))
StopProcessingJob(ProcessingJobName, args::AbstractDict{String, <:Any}) = sagemaker("StopProcessingJob", Dict{String, Any}("ProcessingJobName"=>ProcessingJobName, args...))
...
"""
StopTrainingJob(TrainingJobName) = sagemaker("StopTrainingJob", Dict{String, Any}("TrainingJobName"=>TrainingJobName))
StopTrainingJob(TrainingJobName, args::AbstractDict{String, <:Any}) = sagemaker("StopTrainingJob", Dict{String, Any}("TrainingJobName"=>TrainingJobName, args...))
...
"""
StopTransformJob(TransformJobName) = sagemaker("StopTransformJob", Dict{String, Any}("TransformJobName"=>TransformJobName))
StopTransformJob(TransformJobName, args::AbstractDict{String, <:Any}) = sagemaker("StopTransformJob", Dict{String, Any}("TransformJobName"=>TransformJobName, args...))
...
"""
UpdateCodeRepository(CodeRepositoryName) = sagemaker("UpdateCodeRepository", Dict{String, Any}("CodeRepositoryName"=>CodeRepositoryName))
UpdateCodeRepository(CodeRepositoryName, args::AbstractDict{String, <:Any}) = sagemaker("UpdateCodeRepository", Dict{String, Any}("CodeRepositoryName"=>CodeRepositoryName, args...))
...
"""
UpdateDomain(DomainId) = sagemaker("UpdateDomain", Dict{String, Any}("DomainId"=>DomainId))
UpdateDomain(DomainId, args::AbstractDict{String, <:Any}) = sagemaker("UpdateDomain", Dict{String, Any}("DomainId"=>DomainId, args...))
...
"""
UpdateEndpoint(EndpointConfigName, EndpointName) = sagemaker("UpdateEndpoint", Dict{String, Any}("EndpointConfigName"=>EndpointConfigName, "EndpointName"=>EndpointName))
UpdateEndpoint(EndpointConfigName, EndpointName, args::AbstractDict{String, <:Any}) = sagemaker("UpdateEndpoint", Dict{String, Any}("EndpointConfigName"=>EndpointConfigName, "EndpointName"=>EndpointName, args...))
...
"""
UpdateEndpointWeightsAndCapacities(DesiredWeightsAndCapacities, EndpointName) = sagemaker("UpdateEndpointWeightsAndCapacities", Dict{String, Any}("DesiredWeightsAndCapacities"=>DesiredWeightsAndCapacities, "EndpointName"=>EndpointName))
UpdateEndpointWeightsAndCapacities(DesiredWeightsAndCapacities, EndpointName, args::AbstractDict{String, <:Any}) = sagemaker("UpdateEndpointWeightsAndCapacities", Dict{String, Any}("DesiredWeightsAndCapacities"=>DesiredWeightsAndCapacities, "EndpointName"=>EndpointName, args...))
...
"""
UpdateExperiment(ExperimentName) = sagemaker("UpdateExperiment", Dict{String, Any}("ExperimentName"=>ExperimentName))
UpdateExperiment(ExperimentName, args::AbstractDict{String, <:Any}) = sagemaker("UpdateExperiment", Dict{String, Any}("ExperimentName"=>ExperimentName, args...))
...
"""
UpdateMonitoringSchedule(MonitoringScheduleConfig, MonitoringScheduleName) = sagemaker("UpdateMonitoringSchedule", Dict{String, Any}("MonitoringScheduleConfig"=>MonitoringScheduleConfig, "MonitoringScheduleName"=>MonitoringScheduleName))
UpdateMonitoringSchedule(MonitoringScheduleConfig, MonitoringScheduleName, args::AbstractDict{String, <:Any}) = sagemaker("UpdateMonitoringSchedule", Dict{String, Any}("MonitoringScheduleConfig"=>MonitoringScheduleConfig, "MonitoringScheduleName"=>MonitoringScheduleName, args...))
...
"""
UpdateNotebookInstance(NotebookInstanceName) = sagemaker("UpdateNotebookInstance", Dict{String, Any}("NotebookInstanceName"=>NotebookInstanceName))
UpdateNotebookInstance(NotebookInstanceName, args::AbstractDict{String, <:Any}) = sagemaker("UpdateNotebookInstance", Dict{String, Any}("NotebookInstanceName"=>NotebookInstanceName, args...))
...
"""
UpdateNotebookInstanceLifecycleConfig(NotebookInstanceLifecycleConfigName) = sagemaker("UpdateNotebookInstanceLifecycleConfig", Dict{String, Any}("NotebookInstanceLifecycleConfigName"=>NotebookInstanceLifecycleConfigName))
UpdateNotebookInstanceLifecycleConfig(NotebookInstanceLifecycleConfigName, args::AbstractDict{String, <:Any}) = sagemaker("UpdateNotebookInstanceLifecycleConfig", Dict{String, Any}("NotebookInstanceLifecycleConfigName"=>NotebookInstanceLifecycleConfigName, args...))
...
- `DisplayName`: The name of the trial as displayed. The name doesn't need to be unique. If DisplayName isn't specified, TrialName is displayed.
"""
UpdateTrial(TrialName) = sagemaker("UpdateTrial", Dict{String, Any}("TrialName"=>TrialName))
UpdateTrial(TrialName, args::AbstractDict{String, <:Any}) = sagemaker("UpdateTrial", Dict{String, Any}("TrialName"=>TrialName, args...))
...
"""
UpdateTrialComponent(TrialComponentName) = sagemaker("UpdateTrialComponent", Dict{String, Any}("TrialComponentName"=>TrialComponentName))
UpdateTrialComponent(TrialComponentName, args::AbstractDict{String, <:Any}) = sagemaker("UpdateTrialComponent", Dict{String, Any}("TrialComponentName"=>TrialComponentName, args...))
...
- `UserSettings`: A collection of settings.
"""
UpdateUserProfile(DomainId, UserProfileName) = sagemaker("UpdateUserProfile", Dict{String, Any}("DomainId"=>DomainId, "UserProfileName"=>UserProfileName))
UpdateUserProfile(DomainId, UserProfileName, args::AbstractDict{String, <:Any}) = sagemaker("UpdateUserProfile", Dict{String, Any}("DomainId"=>DomainId, "UserProfileName"=>UserProfileName, args...))
...
"""
UpdateWorkforce(WorkforceName) = sagemaker("UpdateWorkforce", Dict{String, Any}("WorkforceName"=>WorkforceName))
UpdateWorkforce(WorkforceName, args::AbstractDict{String, <:Any}) = sagemaker("UpdateWorkforce", Dict{String, Any}("WorkforceName"=>WorkforceName, args...))
...
"""
UpdateWorkteam(WorkteamName) = sagemaker("UpdateWorkteam", Dict{String, Any}("WorkteamName"=>WorkteamName))
UpdateWorkteam(WorkteamName, args::AbstractDict{String, <:Any}) = sagemaker("UpdateWorkteam", Dict{String, Any}("WorkteamName"=>WorkteamName, args...))
