...
function create_hub_content_reference(
    HubName, SageMakerPublicHubContentArn; aws_config::AbstractAWSConfig=current_aws_config()
)
    return sagemaker(
...
"""
function create_image(ImageName, RoleArn; aws_config::AbstractAWSConfig=current_aws_config())
    return sagemaker(
        "CreateImage",
...
function delete_hub(
    HubName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return sagemaker(
        "DeleteHub",
...
"""
function delete_model_card(ModelCardName; aws_config::AbstractAWSConfig=current_aws_config())
    return sagemaker(
        "DeleteModelCard",
...
"""
function get_search_suggestions(Resource; aws_config::AbstractAWSConfig=current_aws_config())
    return sagemaker(
...
function put_model_package_group_policy(
    ModelPackageGroupName, ResourcePolicy; aws_config::AbstractAWSConfig=current_aws_config()
)
    return sagemaker(
...
"""
function start_inference_experiment(Name; aws_config::AbstractAWSConfig=current_aws_config())
    return sagemaker(
...
- `"ModelCardStatus"`: The approval status of the model card within your organization.
  ...
  No more updates should be made to the model card, but it can still be exported.
"""
function update_model_card(ModelCardName; aws_config::AbstractAWSConfig=current_aws_config())
    return sagemaker(
        "UpdateModelCard",
        Dict{String,Any}("ModelCardName" => ModelCardName);
        aws_config=aws_config,
