...
"""
CreateBackup(FileSystemId) = fsx("CreateBackup", Dict{String, Any}("FileSystemId"=>FileSystemId))
CreateBackup(FileSystemId, args::AbstractDict{String, <: Any}) = fsx("CreateBackup", Dict{String, Any}("FileSystemId"=>FileSystemId, args...))
...
Tags => 
"""
CreateDataRepositoryTask(FileSystemId, Report, Type) = fsx("CreateDataRepositoryTask", Dict{String, Any}("FileSystemId"=>FileSystemId, "Report"=>Report, "Type"=>Type))
CreateDataRepositoryTask(FileSystemId, Report, Type, args::AbstractDict{String, <: Any}) = fsx("CreateDataRepositoryTask", Dict{String, Any}("FileSystemId"=>FileSystemId, "Report"=>Report, "Type"=>Type, args...))
...
"""
CreateFileSystem(FileSystemType, StorageCapacity, SubnetIds) = fsx("CreateFileSystem", Dict{String, Any}("FileSystemType"=>FileSystemType, "StorageCapacity"=>StorageCapacity, "SubnetIds"=>SubnetIds))
CreateFileSystem(FileSystemType, StorageCapacity, SubnetIds, args::AbstractDict{String, <: Any}) = fsx("CreateFileSystem", Dict{String, Any}("FileSystemType"=>FileSystemType, "StorageCapacity"=>StorageCapacity, "SubnetIds"=>SubnetIds, args...))
...
"""
CreateFileSystemFromBackup(BackupId, SubnetIds) = fsx("CreateFileSystemFromBackup", Dict{String, Any}("BackupId"=>BackupId, "SubnetIds"=>SubnetIds))
CreateFileSystemFromBackup(BackupId, SubnetIds, args::AbstractDict{String, <: Any}) = fsx("CreateFileSystemFromBackup", Dict{String, Any}("BackupId"=>BackupId, "SubnetIds"=>SubnetIds, args...))
...
"""
DeleteBackup(BackupId) = fsx("DeleteBackup", Dict{String, Any}("BackupId"=>BackupId))
DeleteBackup(BackupId, args::AbstractDict{String, <: Any}) = fsx("DeleteBackup", Dict{String, Any}("BackupId"=>BackupId, args...))
...
"""
DeleteFileSystem(FileSystemId) = fsx("DeleteFileSystem", Dict{String, Any}("FileSystemId"=>FileSystemId))
DeleteFileSystem(FileSystemId, args::AbstractDict{String, <: Any}) = fsx("DeleteFileSystem", Dict{String, Any}("FileSystemId"=>FileSystemId, args...))
...
"""
UpdateFileSystem(FileSystemId) = fsx("UpdateFileSystem", Dict{String, Any}("FileSystemId"=>FileSystemId))
UpdateFileSystem(FileSystemId, args::AbstractDict{String, <: Any}) = fsx("UpdateFileSystem", Dict{String, Any}("FileSystemId"=>FileSystemId, args...))
