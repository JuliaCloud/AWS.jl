...
"""
AddTagsToResource(ResourceName, Tag) = elasticache("AddTagsToResource", Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag))
AddTagsToResource(ResourceName, Tag, args::AbstractDict{String, <:Any}) = elasticache("AddTagsToResource", Dict{String, Any}("ResourceName"=>ResourceName, "Tag"=>Tag, args...))
...
"""
AuthorizeCacheSecurityGroupIngress(CacheSecurityGroupName, EC2SecurityGroupName, EC2SecurityGroupOwnerId) = elasticache("AuthorizeCacheSecurityGroupIngress", Dict{String, Any}("CacheSecurityGroupName"=>CacheSecurityGroupName, "EC2SecurityGroupName"=>EC2SecurityGroupName, "EC2SecurityGroupOwnerId"=>EC2SecurityGroupOwnerId))
AuthorizeCacheSecurityGroupIngress(CacheSecurityGroupName, EC2SecurityGroupName, EC2SecurityGroupOwnerId, args::AbstractDict{String, <:Any}) = elasticache("AuthorizeCacheSecurityGroupIngress", Dict{String, Any}("CacheSecurityGroupName"=>CacheSecurityGroupName, "EC2SecurityGroupName"=>EC2SecurityGroupName, "EC2SecurityGroupOwnerId"=>EC2SecurityGroupOwnerId, args...))
...
"""
BatchApplyUpdateAction(ServiceUpdateName) = elasticache("BatchApplyUpdateAction", Dict{String, Any}("ServiceUpdateName"=>ServiceUpdateName))
BatchApplyUpdateAction(ServiceUpdateName, args::AbstractDict{String, <:Any}) = elasticache("BatchApplyUpdateAction", Dict{String, Any}("ServiceUpdateName"=>ServiceUpdateName, args...))
...
- `ReplicationGroupIds`: The replication group IDs
"""
BatchStopUpdateAction(ServiceUpdateName) = elasticache("BatchStopUpdateAction", Dict{String, Any}("ServiceUpdateName"=>ServiceUpdateName))
BatchStopUpdateAction(ServiceUpdateName, args::AbstractDict{String, <:Any}) = elasticache("BatchStopUpdateAction", Dict{String, Any}("ServiceUpdateName"=>ServiceUpdateName, args...))
...
"""
CompleteMigration(ReplicationGroupId) = elasticache("CompleteMigration", Dict{String, Any}("ReplicationGroupId"=>ReplicationGroupId))
CompleteMigration(ReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("CompleteMigration", Dict{String, Any}("ReplicationGroupId"=>ReplicationGroupId, args...))
...
"""
CopySnapshot(SourceSnapshotName, TargetSnapshotName) = elasticache("CopySnapshot", Dict{String, Any}("SourceSnapshotName"=>SourceSnapshotName, "TargetSnapshotName"=>TargetSnapshotName))
CopySnapshot(SourceSnapshotName, TargetSnapshotName, args::AbstractDict{String, <:Any}) = elasticache("CopySnapshot", Dict{String, Any}("SourceSnapshotName"=>SourceSnapshotName, "TargetSnapshotName"=>TargetSnapshotName, args...))
...
"""
CreateCacheCluster(CacheClusterId) = elasticache("CreateCacheCluster", Dict{String, Any}("CacheClusterId"=>CacheClusterId))
CreateCacheCluster(CacheClusterId, args::AbstractDict{String, <:Any}) = elasticache("CreateCacheCluster", Dict{String, Any}("CacheClusterId"=>CacheClusterId, args...))
...
"""
CreateCacheParameterGroup(CacheParameterGroupFamily, CacheParameterGroupName, Description) = elasticache("CreateCacheParameterGroup", Dict{String, Any}("CacheParameterGroupFamily"=>CacheParameterGroupFamily, "CacheParameterGroupName"=>CacheParameterGroupName, "Description"=>Description))
CreateCacheParameterGroup(CacheParameterGroupFamily, CacheParameterGroupName, Description, args::AbstractDict{String, <:Any}) = elasticache("CreateCacheParameterGroup", Dict{String, Any}("CacheParameterGroupFamily"=>CacheParameterGroupFamily, "CacheParameterGroupName"=>CacheParameterGroupName, "Description"=>Description, args...))
...
"""
CreateCacheSecurityGroup(CacheSecurityGroupName, Description) = elasticache("CreateCacheSecurityGroup", Dict{String, Any}("CacheSecurityGroupName"=>CacheSecurityGroupName, "Description"=>Description))
CreateCacheSecurityGroup(CacheSecurityGroupName, Description, args::AbstractDict{String, <:Any}) = elasticache("CreateCacheSecurityGroup", Dict{String, Any}("CacheSecurityGroupName"=>CacheSecurityGroupName, "Description"=>Description, args...))
...
"""
CreateCacheSubnetGroup(CacheSubnetGroupDescription, CacheSubnetGroupName, SubnetIdentifier) = elasticache("CreateCacheSubnetGroup", Dict{String, Any}("CacheSubnetGroupDescription"=>CacheSubnetGroupDescription, "CacheSubnetGroupName"=>CacheSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier))
CreateCacheSubnetGroup(CacheSubnetGroupDescription, CacheSubnetGroupName, SubnetIdentifier, args::AbstractDict{String, <:Any}) = elasticache("CreateCacheSubnetGroup", Dict{String, Any}("CacheSubnetGroupDescription"=>CacheSubnetGroupDescription, "CacheSubnetGroupName"=>CacheSubnetGroupName, "SubnetIdentifier"=>SubnetIdentifier, args...))
...
"""
CreateGlobalReplicationGroup(GlobalReplicationGroupIdSuffix, PrimaryReplicationGroupId) = elasticache("CreateGlobalReplicationGroup", Dict{String, Any}("GlobalReplicationGroupIdSuffix"=>GlobalReplicationGroupIdSuffix, "PrimaryReplicationGroupId"=>PrimaryReplicationGroupId))
CreateGlobalReplicationGroup(GlobalReplicationGroupIdSuffix, PrimaryReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("CreateGlobalReplicationGroup", Dict{String, Any}("GlobalReplicationGroupIdSuffix"=>GlobalReplicationGroupIdSuffix, "PrimaryReplicationGroupId"=>PrimaryReplicationGroupId, args...))
...
"""
CreateReplicationGroup(ReplicationGroupDescription, ReplicationGroupId) = elasticache("CreateReplicationGroup", Dict{String, Any}("ReplicationGroupDescription"=>ReplicationGroupDescription, "ReplicationGroupId"=>ReplicationGroupId))
CreateReplicationGroup(ReplicationGroupDescription, ReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("CreateReplicationGroup", Dict{String, Any}("ReplicationGroupDescription"=>ReplicationGroupDescription, "ReplicationGroupId"=>ReplicationGroupId, args...))
...
"""
CreateSnapshot(SnapshotName) = elasticache("CreateSnapshot", Dict{String, Any}("SnapshotName"=>SnapshotName))
CreateSnapshot(SnapshotName, args::AbstractDict{String, <:Any}) = elasticache("CreateSnapshot", Dict{String, Any}("SnapshotName"=>SnapshotName, args...))
...
"""
DecreaseNodeGroupsInGlobalReplicationGroup(ApplyImmediately, GlobalReplicationGroupId, NodeGroupCount) = elasticache("DecreaseNodeGroupsInGlobalReplicationGroup", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "GlobalReplicationGroupId"=>GlobalReplicationGroupId, "NodeGroupCount"=>NodeGroupCount))
DecreaseNodeGroupsInGlobalReplicationGroup(ApplyImmediately, GlobalReplicationGroupId, NodeGroupCount, args::AbstractDict{String, <:Any}) = elasticache("DecreaseNodeGroupsInGlobalReplicationGroup", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "GlobalReplicationGroupId"=>GlobalReplicationGroupId, "NodeGroupCount"=>NodeGroupCount, args...))
...
"""
DecreaseReplicaCount(ApplyImmediately, ReplicationGroupId) = elasticache("DecreaseReplicaCount", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "ReplicationGroupId"=>ReplicationGroupId))
DecreaseReplicaCount(ApplyImmediately, ReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("DecreaseReplicaCount", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "ReplicationGroupId"=>ReplicationGroupId, args...))
...
"""
DeleteCacheCluster(CacheClusterId) = elasticache("DeleteCacheCluster", Dict{String, Any}("CacheClusterId"=>CacheClusterId))
DeleteCacheCluster(CacheClusterId, args::AbstractDict{String, <:Any}) = elasticache("DeleteCacheCluster", Dict{String, Any}("CacheClusterId"=>CacheClusterId, args...))
...
"""
DeleteCacheParameterGroup(CacheParameterGroupName) = elasticache("DeleteCacheParameterGroup", Dict{String, Any}("CacheParameterGroupName"=>CacheParameterGroupName))
DeleteCacheParameterGroup(CacheParameterGroupName, args::AbstractDict{String, <:Any}) = elasticache("DeleteCacheParameterGroup", Dict{String, Any}("CacheParameterGroupName"=>CacheParameterGroupName, args...))
...
"""
DeleteCacheSecurityGroup(CacheSecurityGroupName) = elasticache("DeleteCacheSecurityGroup", Dict{String, Any}("CacheSecurityGroupName"=>CacheSecurityGroupName))
DeleteCacheSecurityGroup(CacheSecurityGroupName, args::AbstractDict{String, <:Any}) = elasticache("DeleteCacheSecurityGroup", Dict{String, Any}("CacheSecurityGroupName"=>CacheSecurityGroupName, args...))
...
"""
DeleteCacheSubnetGroup(CacheSubnetGroupName) = elasticache("DeleteCacheSubnetGroup", Dict{String, Any}("CacheSubnetGroupName"=>CacheSubnetGroupName))
DeleteCacheSubnetGroup(CacheSubnetGroupName, args::AbstractDict{String, <:Any}) = elasticache("DeleteCacheSubnetGroup", Dict{String, Any}("CacheSubnetGroupName"=>CacheSubnetGroupName, args...))
...
"""
DeleteGlobalReplicationGroup(GlobalReplicationGroupId, RetainPrimaryReplicationGroup) = elasticache("DeleteGlobalReplicationGroup", Dict{String, Any}("GlobalReplicationGroupId"=>GlobalReplicationGroupId, "RetainPrimaryReplicationGroup"=>RetainPrimaryReplicationGroup))
DeleteGlobalReplicationGroup(GlobalReplicationGroupId, RetainPrimaryReplicationGroup, args::AbstractDict{String, <:Any}) = elasticache("DeleteGlobalReplicationGroup", Dict{String, Any}("GlobalReplicationGroupId"=>GlobalReplicationGroupId, "RetainPrimaryReplicationGroup"=>RetainPrimaryReplicationGroup, args...))
...
"""
DeleteReplicationGroup(ReplicationGroupId) = elasticache("DeleteReplicationGroup", Dict{String, Any}("ReplicationGroupId"=>ReplicationGroupId))
DeleteReplicationGroup(ReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("DeleteReplicationGroup", Dict{String, Any}("ReplicationGroupId"=>ReplicationGroupId, args...))
...
"""
DeleteSnapshot(SnapshotName) = elasticache("DeleteSnapshot", Dict{String, Any}("SnapshotName"=>SnapshotName))
DeleteSnapshot(SnapshotName, args::AbstractDict{String, <:Any}) = elasticache("DeleteSnapshot", Dict{String, Any}("SnapshotName"=>SnapshotName, args...))
...
DescribeCacheClusters(args::AbstractDict{String, <:Any}) = elasticache("DescribeCacheClusters", args)
...
DescribeCacheEngineVersions(args::AbstractDict{String, <:Any}) = elasticache("DescribeCacheEngineVersions", args)
...
DescribeCacheParameterGroups(args::AbstractDict{String, <:Any}) = elasticache("DescribeCacheParameterGroups", args)
...
"""
DescribeCacheParameters(CacheParameterGroupName) = elasticache("DescribeCacheParameters", Dict{String, Any}("CacheParameterGroupName"=>CacheParameterGroupName))
DescribeCacheParameters(CacheParameterGroupName, args::AbstractDict{String, <:Any}) = elasticache("DescribeCacheParameters", Dict{String, Any}("CacheParameterGroupName"=>CacheParameterGroupName, args...))
...
DescribeCacheSecurityGroups(args::AbstractDict{String, <:Any}) = elasticache("DescribeCacheSecurityGroups", args)
...
DescribeCacheSubnetGroups(args::AbstractDict{String, <:Any}) = elasticache("DescribeCacheSubnetGroups", args)
...
- `MaxRecords`: The maximum number of records to include in the response. If more records exist than the specified MaxRecords value, a marker is included in the response so that the remaining results can be retrieved. Default: 100 Constraints: minimum 20; maximum 100.
"""
DescribeEngineDefaultParameters(CacheParameterGroupFamily) = elasticache("DescribeEngineDefaultParameters", Dict{String, Any}("CacheParameterGroupFamily"=>CacheParameterGroupFamily))
DescribeEngineDefaultParameters(CacheParameterGroupFamily, args::AbstractDict{String, <:Any}) = elasticache("DescribeEngineDefaultParameters", Dict{String, Any}("CacheParameterGroupFamily"=>CacheParameterGroupFamily, args...))
...
DescribeEvents(args::AbstractDict{String, <:Any}) = elasticache("DescribeEvents", args)
...
DescribeGlobalReplicationGroups(args::AbstractDict{String, <:Any}) = elasticache("DescribeGlobalReplicationGroups", args)
...
DescribeReplicationGroups(args::AbstractDict{String, <:Any}) = elasticache("DescribeReplicationGroups", args)
...
DescribeReservedCacheNodes(args::AbstractDict{String, <:Any}) = elasticache("DescribeReservedCacheNodes", args)
...
DescribeReservedCacheNodesOfferings(args::AbstractDict{String, <:Any}) = elasticache("DescribeReservedCacheNodesOfferings", args)
...
DescribeServiceUpdates(args::AbstractDict{String, <:Any}) = elasticache("DescribeServiceUpdates", args)
...
DescribeSnapshots(args::AbstractDict{String, <:Any}) = elasticache("DescribeSnapshots", args)
...
DescribeUpdateActions(args::AbstractDict{String, <:Any}) = elasticache("DescribeUpdateActions", args)
...
"""
DisassociateGlobalReplicationGroup(GlobalReplicationGroupId, ReplicationGroupId, ReplicationGroupRegion) = elasticache("DisassociateGlobalReplicationGroup", Dict{String, Any}("GlobalReplicationGroupId"=>GlobalReplicationGroupId, "ReplicationGroupId"=>ReplicationGroupId, "ReplicationGroupRegion"=>ReplicationGroupRegion))
DisassociateGlobalReplicationGroup(GlobalReplicationGroupId, ReplicationGroupId, ReplicationGroupRegion, args::AbstractDict{String, <:Any}) = elasticache("DisassociateGlobalReplicationGroup", Dict{String, Any}("GlobalReplicationGroupId"=>GlobalReplicationGroupId, "ReplicationGroupId"=>ReplicationGroupId, "ReplicationGroupRegion"=>ReplicationGroupRegion, args...))
...
"""
FailoverGlobalReplicationGroup(GlobalReplicationGroupId, PrimaryRegion, PrimaryReplicationGroupId) = elasticache("FailoverGlobalReplicationGroup", Dict{String, Any}("GlobalReplicationGroupId"=>GlobalReplicationGroupId, "PrimaryRegion"=>PrimaryRegion, "PrimaryReplicationGroupId"=>PrimaryReplicationGroupId))
FailoverGlobalReplicationGroup(GlobalReplicationGroupId, PrimaryRegion, PrimaryReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("FailoverGlobalReplicationGroup", Dict{String, Any}("GlobalReplicationGroupId"=>GlobalReplicationGroupId, "PrimaryRegion"=>PrimaryRegion, "PrimaryReplicationGroupId"=>PrimaryReplicationGroupId, args...))
...
"""
IncreaseNodeGroupsInGlobalReplicationGroup(ApplyImmediately, GlobalReplicationGroupId, NodeGroupCount) = elasticache("IncreaseNodeGroupsInGlobalReplicationGroup", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "GlobalReplicationGroupId"=>GlobalReplicationGroupId, "NodeGroupCount"=>NodeGroupCount))
...
- `ReplicaConfiguration`: A list of ConfigureShard objects that can be used to configure each shard in a Redis (cluster mode enabled) replication group. The ConfigureShard has three members: NewReplicaCount, NodeGroupId, and PreferredAvailabilityZones.
"""
IncreaseReplicaCount(ApplyImmediately, ReplicationGroupId) = elasticache("IncreaseReplicaCount", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "ReplicationGroupId"=>ReplicationGroupId))
IncreaseReplicaCount(ApplyImmediately, ReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("IncreaseReplicaCount", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "ReplicationGroupId"=>ReplicationGroupId, args...))
...
ListAllowedNodeTypeModifications(args::AbstractDict{String, <:Any}) = elasticache("ListAllowedNodeTypeModifications", args)
...
"""
ListTagsForResource(ResourceName) = elasticache("ListTagsForResource", Dict{String, Any}("ResourceName"=>ResourceName))
ListTagsForResource(ResourceName, args::AbstractDict{String, <:Any}) = elasticache("ListTagsForResource", Dict{String, Any}("ResourceName"=>ResourceName, args...))
...
"""
ModifyCacheCluster(CacheClusterId) = elasticache("ModifyCacheCluster", Dict{String, Any}("CacheClusterId"=>CacheClusterId))
ModifyCacheCluster(CacheClusterId, args::AbstractDict{String, <:Any}) = elasticache("ModifyCacheCluster", Dict{String, Any}("CacheClusterId"=>CacheClusterId, args...))
...
"""
ModifyCacheParameterGroup(CacheParameterGroupName, ParameterNameValue) = elasticache("ModifyCacheParameterGroup", Dict{String, Any}("CacheParameterGroupName"=>CacheParameterGroupName, "ParameterNameValue"=>ParameterNameValue))
ModifyCacheParameterGroup(CacheParameterGroupName, ParameterNameValue, args::AbstractDict{String, <:Any}) = elasticache("ModifyCacheParameterGroup", Dict{String, Any}("CacheParameterGroupName"=>CacheParameterGroupName, "ParameterNameValue"=>ParameterNameValue, args...))
...
"""
ModifyCacheSubnetGroup(CacheSubnetGroupName) = elasticache("ModifyCacheSubnetGroup", Dict{String, Any}("CacheSubnetGroupName"=>CacheSubnetGroupName))
ModifyCacheSubnetGroup(CacheSubnetGroupName, args::AbstractDict{String, <:Any}) = elasticache("ModifyCacheSubnetGroup", Dict{String, Any}("CacheSubnetGroupName"=>CacheSubnetGroupName, args...))
...
"""
ModifyGlobalReplicationGroup(ApplyImmediately, GlobalReplicationGroupId) = elasticache("ModifyGlobalReplicationGroup", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "GlobalReplicationGroupId"=>GlobalReplicationGroupId))
ModifyGlobalReplicationGroup(ApplyImmediately, GlobalReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("ModifyGlobalReplicationGroup", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "GlobalReplicationGroupId"=>GlobalReplicationGroupId, args...))
...
"""
ModifyReplicationGroup(ReplicationGroupId) = elasticache("ModifyReplicationGroup", Dict{String, Any}("ReplicationGroupId"=>ReplicationGroupId))
ModifyReplicationGroup(ReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("ModifyReplicationGroup", Dict{String, Any}("ReplicationGroupId"=>ReplicationGroupId, args...))
...
"""
ModifyReplicationGroupShardConfiguration(ApplyImmediately, NodeGroupCount, ReplicationGroupId) = elasticache("ModifyReplicationGroupShardConfiguration", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "NodeGroupCount"=>NodeGroupCount, "ReplicationGroupId"=>ReplicationGroupId))
ModifyReplicationGroupShardConfiguration(ApplyImmediately, NodeGroupCount, ReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("ModifyReplicationGroupShardConfiguration", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "NodeGroupCount"=>NodeGroupCount, "ReplicationGroupId"=>ReplicationGroupId, args...))
...
"""
PurchaseReservedCacheNodesOffering(ReservedCacheNodesOfferingId) = elasticache("PurchaseReservedCacheNodesOffering", Dict{String, Any}("ReservedCacheNodesOfferingId"=>ReservedCacheNodesOfferingId))
PurchaseReservedCacheNodesOffering(ReservedCacheNodesOfferingId, args::AbstractDict{String, <:Any}) = elasticache("PurchaseReservedCacheNodesOffering", Dict{String, Any}("ReservedCacheNodesOfferingId"=>ReservedCacheNodesOfferingId, args...))
...
"""
RebalanceSlotsInGlobalReplicationGroup(ApplyImmediately, GlobalReplicationGroupId) = elasticache("RebalanceSlotsInGlobalReplicationGroup", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "GlobalReplicationGroupId"=>GlobalReplicationGroupId))
RebalanceSlotsInGlobalReplicationGroup(ApplyImmediately, GlobalReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("RebalanceSlotsInGlobalReplicationGroup", Dict{String, Any}("ApplyImmediately"=>ApplyImmediately, "GlobalReplicationGroupId"=>GlobalReplicationGroupId, args...))
...
"""
RebootCacheCluster(CacheClusterId, CacheNodeId) = elasticache("RebootCacheCluster", Dict{String, Any}("CacheClusterId"=>CacheClusterId, "CacheNodeId"=>CacheNodeId))
RebootCacheCluster(CacheClusterId, CacheNodeId, args::AbstractDict{String, <:Any}) = elasticache("RebootCacheCluster", Dict{String, Any}("CacheClusterId"=>CacheClusterId, "CacheNodeId"=>CacheNodeId, args...))
...
"""
RemoveTagsFromResource(ResourceName, TagKeys) = elasticache("RemoveTagsFromResource", Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys))
RemoveTagsFromResource(ResourceName, TagKeys, args::AbstractDict{String, <:Any}) = elasticache("RemoveTagsFromResource", Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys, args...))
...
"""
ResetCacheParameterGroup(CacheParameterGroupName) = elasticache("ResetCacheParameterGroup", Dict{String, Any}("CacheParameterGroupName"=>CacheParameterGroupName))
ResetCacheParameterGroup(CacheParameterGroupName, args::AbstractDict{String, <:Any}) = elasticache("ResetCacheParameterGroup", Dict{String, Any}("CacheParameterGroupName"=>CacheParameterGroupName, args...))
...
"""
RevokeCacheSecurityGroupIngress(CacheSecurityGroupName, EC2SecurityGroupName, EC2SecurityGroupOwnerId) = elasticache("RevokeCacheSecurityGroupIngress", Dict{String, Any}("CacheSecurityGroupName"=>CacheSecurityGroupName, "EC2SecurityGroupName"=>EC2SecurityGroupName, "EC2SecurityGroupOwnerId"=>EC2SecurityGroupOwnerId))
RevokeCacheSecurityGroupIngress(CacheSecurityGroupName, EC2SecurityGroupName, EC2SecurityGroupOwnerId, args::AbstractDict{String, <:Any}) = elasticache("RevokeCacheSecurityGroupIngress", Dict{String, Any}("CacheSecurityGroupName"=>CacheSecurityGroupName, "EC2SecurityGroupName"=>EC2SecurityGroupName, "EC2SecurityGroupOwnerId"=>EC2SecurityGroupOwnerId, args...))
...
"""
StartMigration(CustomerNodeEndpointList, ReplicationGroupId) = elasticache("StartMigration", Dict{String, Any}("CustomerNodeEndpointList"=>CustomerNodeEndpointList, "ReplicationGroupId"=>ReplicationGroupId))
StartMigration(CustomerNodeEndpointList, ReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("StartMigration", Dict{String, Any}("CustomerNodeEndpointList"=>CustomerNodeEndpointList, "ReplicationGroupId"=>ReplicationGroupId, args...))
...
"""
TestFailover(NodeGroupId, ReplicationGroupId) = elasticache("TestFailover", Dict{String, Any}("NodeGroupId"=>NodeGroupId, "ReplicationGroupId"=>ReplicationGroupId))
TestFailover(NodeGroupId, ReplicationGroupId, args::AbstractDict{String, <:Any}) = elasticache("TestFailover", Dict{String, Any}("NodeGroupId"=>NodeGroupId, "ReplicationGroupId"=>ReplicationGroupId, args...))
