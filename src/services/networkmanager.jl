...
- `"nextToken"`: The token for the next page of results.
"""
function get_connections(globalNetworkId; aws_config::AbstractAWSConfig=current_aws_config())
    return networkmanager(
        "GET",
        "/global-networks/$(globalNetworkId)/connections";
        aws_config=aws_config,
...
function get_network_routes(
    RouteTableIdentifier, globalNetworkId; aws_config::AbstractAWSConfig=current_aws_config()
)
    return networkmanager(
        "POST",
...
"""
function get_vpc_attachment(attachmentId; aws_config::AbstractAWSConfig=current_aws_config())
    return networkmanager(
        "GET",
