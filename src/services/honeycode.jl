...
GetScreenData(appId, screenId, workbookId; aws_config::AWSConfig=AWS.aws_config) = honeycode("POST", "/screendata", Dict{String, Any}("appId"=>appId, "screenId"=>screenId, "workbookId"=>workbookId); aws_config=aws_config)
GetScreenData(appId, screenId, workbookId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = honeycode("POST", "/screendata", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("appId"=>appId, "screenId"=>screenId, "workbookId"=>workbookId), args)); aws_config=aws_config)
...
InvokeScreenAutomation(appId, automationId, screenId, workbookId; aws_config::AWSConfig=AWS.aws_config) = honeycode("POST", "/workbooks/$(workbookId)/apps/$(appId)/screens/$(screenId)/automations/$(automationId)"; aws_config=aws_config)
InvokeScreenAutomation(appId, automationId, screenId, workbookId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = honeycode("POST", "/workbooks/$(workbookId)/apps/$(appId)/screens/$(screenId)/automations/$(automationId)", args; aws_config=aws_config)
