...
# Optional Parameters
- `BackupOptions`: Specifies the backup option for a selected resource. This option is only available for Windows VSS backup jobs. Valid value: \"WindowsVSS”:“enabled\". If enabled, creates a VSS Windows backup; otherwise, creates a regular backup.
