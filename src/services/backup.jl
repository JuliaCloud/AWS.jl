...
"""
function delete_backup_plan(backupPlanId; aws_config::AbstractAWSConfig=current_aws_config())
    return backup(
        "DELETE",
...
"""
function describe_backup_job(backupJobId; aws_config::AbstractAWSConfig=current_aws_config())
    return backup(
        "GET",
...
"""
function describe_report_job(reportJobId; aws_config::AbstractAWSConfig=current_aws_config())
    return backup(
        "GET",
...
- `"IdempotencyToken"`: A customer-chosen string that you can use to distinguish between
  ...
  same idempotency token results in a success message with no action taken.
"""
function start_report_job(reportPlanName; aws_config::AbstractAWSConfig=current_aws_config())
    return backup(
        "POST",
