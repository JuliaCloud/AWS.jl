...
"""
add_bridge_outputs(bridgeArn, outputs; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "POST",
...
"""
add_bridge_sources(bridgeArn, sources; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "POST",
...
"""
add_flow_outputs(flowArn, outputs; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "POST",
...
"""
add_flow_sources(flowArn, sources; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "POST",
...
create_bridge(
    ...
    "POST",
    "/v1/bridges",
    Dict{String,Any}("name" => name, "placementArn" => placementArn, "sources" => sources);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
)
...
"""
create_flow(name; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
    "POST",
    "/v1/flows",
...
"""
delete_bridge(bridgeArn; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
    "DELETE",
...
"""
delete_flow(flowArn; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
    "DELETE",
    "/v1/flows/$(flowArn)";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
describe_bridge(bridgeArn; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "GET",
        "/v1/bridges/$(bridgeArn)";
        aws_config=aws_config,
...
"""
describe_flow(flowArn; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
    "GET",
    "/v1/flows/$(flowArn)";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
describe_flow_source_metadata(flowArn; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "GET",
...
"""
describe_flow_source_thumbnail(flowArn; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "GET",
...
"""
describe_gateway(gatewayArn; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "GET",
        "/v1/gateways/$(gatewayArn)";
        aws_config=aws_config,
...
"""
describe_offering(offeringArn; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "GET",
...
"""
describe_reservation(reservationArn; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "GET",
...
"""
list_bridges(; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
...
- `"nextToken"`: The token that identifies which batch of results that you want to see. For
  ...
  NextToken value.
"""
list_entitlements(; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
...
list_flows(; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect("GET", "/v1/flows"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
function list_flows(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
    return mediaconnect(
...
- `"nextToken"`: The token that identifies which batch of results that you want to see. For
  ...
  value.
"""
list_gateway_instances(; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
    "GET",
...
- `"nextToken"`: The token that identifies which batch of results that you want to see. For
  ...
  value.
"""
list_gateways(; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
...
- `"nextToken"`: The token that identifies which batch of results that you want to see. For
  ...
  value.
"""
list_offerings(; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
...
- `"nextToken"`: The token that identifies which batch of results that you want to see. For
  ...
  NextToken value.
"""
list_reservations(; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
...
"""
remove_flow_output(flowArn, outputArn; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "DELETE",
...
"""
remove_flow_source(flowArn, sourceArn; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "DELETE",
...
"""
start_flow(flowArn; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
    "POST",
...
"""
stop_flow(flowArn; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
    "POST",
...
- `"sourceFailoverConfig"`:
"""
update_bridge(bridgeArn; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
    "PUT",
    "/v1/bridges/$(bridgeArn)";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"sourceMonitoringConfig"`:
"""
update_flow(flowArn; aws_config::AbstractAWSConfig=global_aws_config()) = mediaconnect(
    "PUT",
    "/v1/flows/$(flowArn)";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"vpcInterfaceAttachment"`: The name of the VPC interface attachment to use for this
  output.
"""
update_flow_output(flowArn, outputArn; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "PUT",
        "/v1/flows/$(flowArn)/outputs/$(outputArn)";
        aws_config=aws_config,
...
- `"whitelistCidr"`: The range of IP addresses that should be allowed to contribute content
  ...
  Routing (CIDR) block; for example, 10.0.0.0/16.
"""
update_flow_source(flowArn, sourceArn; aws_config::AbstractAWSConfig=global_aws_config()) =
    mediaconnect(
        "PUT",
        "/v1/flows/$(flowArn)/source/$(sourceArn)";
        aws_config=aws_config,
