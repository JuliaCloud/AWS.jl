...
- `ClusterName`: The cluster identifier. This parameter is stored as a lowercase string.
  ...
  consecutive hyphens.
- `IamRoleArn`: A valid Amazon Resource Name (ARN) that identifies an IAM role. At runtime,
...
- `ReplicationFactor`: The number of nodes in the DAX cluster. A replication factor of 1
...
# Optional Parameters
- `AvailabilityZones`: The Availability Zones (AZs) in which the cluster nodes will reside
...
- `PreferredMaintenanceWindow`: Specifies the weekly time range during which maintenance on
  the DAX cluster is performed. It is specified as a range in the format
...
# Required Parameters
- `ParameterGroupName`: The name of the parameter group to apply to all of the clusters in
...
create_parameter_group(ParameterGroupName, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("CreateParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ParameterGroupName"=>ParameterGroupName), args)); aws_config=aws_config)
...
# Required Parameters
- `SubnetGroupName`: A name for the subnet group. This value is stored as a lowercase
  string.
...
create_subnet_group(SubnetGroupName, SubnetIds, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("CreateSubnetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SubnetGroupName"=>SubnetGroupName, "SubnetIds"=>SubnetIds), args)); aws_config=aws_config)
...
delete_cluster(ClusterName, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("DeleteCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterName"=>ClusterName), args)); aws_config=aws_config)
...
delete_parameter_group(ParameterGroupName, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("DeleteParameterGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ParameterGroupName"=>ParameterGroupName), args)); aws_config=aws_config)
...
delete_subnet_group(SubnetGroupName, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("DeleteSubnetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SubnetGroupName"=>SubnetGroupName), args)); aws_config=aws_config)
...
describe_clusters(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("DescribeClusters", args; aws_config=aws_config)
...
describe_default_parameters(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("DescribeDefaultParameters", args; aws_config=aws_config)
...
describe_events(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("DescribeEvents", args; aws_config=aws_config)
...
describe_parameter_groups(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("DescribeParameterGroups", args; aws_config=aws_config)
...
describe_parameters(ParameterGroupName, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("DescribeParameters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ParameterGroupName"=>ParameterGroupName), args)); aws_config=aws_config)
...
describe_subnet_groups(args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("DescribeSubnetGroups", args; aws_config=aws_config)
...
list_tags(ResourceName, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("ListTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceName"=>ResourceName), args)); aws_config=aws_config)
...
reboot_node(ClusterName, NodeId, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("RebootNode", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterName"=>ClusterName, "NodeId"=>NodeId), args)); aws_config=aws_config)
...
tag_resource(ResourceName, Tags, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceName"=>ResourceName, "Tags"=>Tags), args)); aws_config=aws_config)
...
- `TagKeys`: A list of tag keys. If the DAX cluster has any tags with these keys, then the
...
untag_resource(ResourceName, TagKeys, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys), args)); aws_config=aws_config)
...
update_cluster(ClusterName, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("UpdateCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ClusterName"=>ClusterName), args)); aws_config=aws_config)
...
# Required Parameters
- `ParameterGroupName`: The name of the parameter group.
- `ParameterNameValues`: An array of name-value pairs for the parameters in the group. Each
...
update_subnet_group(SubnetGroupName, args::AbstractDict{String, <:Any}; aws_config::AbstractAWSConfig=global_aws_config()) = dax("UpdateSubnetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SubnetGroupName"=>SubnetGroupName), args)); aws_config=aws_config)
