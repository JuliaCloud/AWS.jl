...
"""
CreateCluster(ClusterName, IamRoleArn, NodeType, ReplicationFactor) = dax("CreateCluster", Dict{String, Any}("ClusterName"=>ClusterName, "IamRoleArn"=>IamRoleArn, "NodeType"=>NodeType, "ReplicationFactor"=>ReplicationFactor))
CreateCluster(ClusterName, IamRoleArn, NodeType, ReplicationFactor, args::AbstractDict{String, <:Any}) = dax("CreateCluster", Dict{String, Any}("ClusterName"=>ClusterName, "IamRoleArn"=>IamRoleArn, "NodeType"=>NodeType, "ReplicationFactor"=>ReplicationFactor, args...))
...
"""
CreateParameterGroup(ParameterGroupName) = dax("CreateParameterGroup", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName))
CreateParameterGroup(ParameterGroupName, args::AbstractDict{String, <:Any}) = dax("CreateParameterGroup", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName, args...))
...
"""
CreateSubnetGroup(SubnetGroupName, SubnetIds) = dax("CreateSubnetGroup", Dict{String, Any}("SubnetGroupName"=>SubnetGroupName, "SubnetIds"=>SubnetIds))
CreateSubnetGroup(SubnetGroupName, SubnetIds, args::AbstractDict{String, <:Any}) = dax("CreateSubnetGroup", Dict{String, Any}("SubnetGroupName"=>SubnetGroupName, "SubnetIds"=>SubnetIds, args...))
...
"""
DecreaseReplicationFactor(ClusterName, NewReplicationFactor) = dax("DecreaseReplicationFactor", Dict{String, Any}("ClusterName"=>ClusterName, "NewReplicationFactor"=>NewReplicationFactor))
DecreaseReplicationFactor(ClusterName, NewReplicationFactor, args::AbstractDict{String, <:Any}) = dax("DecreaseReplicationFactor", Dict{String, Any}("ClusterName"=>ClusterName, "NewReplicationFactor"=>NewReplicationFactor, args...))
...
"""
DeleteCluster(ClusterName) = dax("DeleteCluster", Dict{String, Any}("ClusterName"=>ClusterName))
DeleteCluster(ClusterName, args::AbstractDict{String, <:Any}) = dax("DeleteCluster", Dict{String, Any}("ClusterName"=>ClusterName, args...))
...
"""
DeleteParameterGroup(ParameterGroupName) = dax("DeleteParameterGroup", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName))
DeleteParameterGroup(ParameterGroupName, args::AbstractDict{String, <:Any}) = dax("DeleteParameterGroup", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName, args...))
...
"""
DeleteSubnetGroup(SubnetGroupName) = dax("DeleteSubnetGroup", Dict{String, Any}("SubnetGroupName"=>SubnetGroupName))
DeleteSubnetGroup(SubnetGroupName, args::AbstractDict{String, <:Any}) = dax("DeleteSubnetGroup", Dict{String, Any}("SubnetGroupName"=>SubnetGroupName, args...))
...
DescribeClusters(args::AbstractDict{String, <:Any}) = dax("DescribeClusters", args)
...
DescribeDefaultParameters(args::AbstractDict{String, <:Any}) = dax("DescribeDefaultParameters", args)
...
DescribeEvents(args::AbstractDict{String, <:Any}) = dax("DescribeEvents", args)
...
DescribeParameterGroups(args::AbstractDict{String, <:Any}) = dax("DescribeParameterGroups", args)
...
"""
DescribeParameters(ParameterGroupName) = dax("DescribeParameters", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName))
DescribeParameters(ParameterGroupName, args::AbstractDict{String, <:Any}) = dax("DescribeParameters", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName, args...))
...
DescribeSubnetGroups(args::AbstractDict{String, <:Any}) = dax("DescribeSubnetGroups", args)
...
"""
IncreaseReplicationFactor(ClusterName, NewReplicationFactor) = dax("IncreaseReplicationFactor", Dict{String, Any}("ClusterName"=>ClusterName, "NewReplicationFactor"=>NewReplicationFactor))
IncreaseReplicationFactor(ClusterName, NewReplicationFactor, args::AbstractDict{String, <:Any}) = dax("IncreaseReplicationFactor", Dict{String, Any}("ClusterName"=>ClusterName, "NewReplicationFactor"=>NewReplicationFactor, args...))
...
"""
ListTags(ResourceName) = dax("ListTags", Dict{String, Any}("ResourceName"=>ResourceName))
ListTags(ResourceName, args::AbstractDict{String, <:Any}) = dax("ListTags", Dict{String, Any}("ResourceName"=>ResourceName, args...))
...
"""
RebootNode(ClusterName, NodeId) = dax("RebootNode", Dict{String, Any}("ClusterName"=>ClusterName, "NodeId"=>NodeId))
RebootNode(ClusterName, NodeId, args::AbstractDict{String, <:Any}) = dax("RebootNode", Dict{String, Any}("ClusterName"=>ClusterName, "NodeId"=>NodeId, args...))
...
"""
TagResource(ResourceName, Tags) = dax("TagResource", Dict{String, Any}("ResourceName"=>ResourceName, "Tags"=>Tags))
TagResource(ResourceName, Tags, args::AbstractDict{String, <:Any}) = dax("TagResource", Dict{String, Any}("ResourceName"=>ResourceName, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceName, TagKeys) = dax("UntagResource", Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys))
UntagResource(ResourceName, TagKeys, args::AbstractDict{String, <:Any}) = dax("UntagResource", Dict{String, Any}("ResourceName"=>ResourceName, "TagKeys"=>TagKeys, args...))
...
"""
UpdateCluster(ClusterName) = dax("UpdateCluster", Dict{String, Any}("ClusterName"=>ClusterName))
UpdateCluster(ClusterName, args::AbstractDict{String, <:Any}) = dax("UpdateCluster", Dict{String, Any}("ClusterName"=>ClusterName, args...))
...
"""
UpdateParameterGroup(ParameterGroupName, ParameterNameValues) = dax("UpdateParameterGroup", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName, "ParameterNameValues"=>ParameterNameValues))
UpdateParameterGroup(ParameterGroupName, ParameterNameValues, args::AbstractDict{String, <:Any}) = dax("UpdateParameterGroup", Dict{String, Any}("ParameterGroupName"=>ParameterGroupName, "ParameterNameValues"=>ParameterNameValues, args...))
...
"""
UpdateSubnetGroup(SubnetGroupName) = dax("UpdateSubnetGroup", Dict{String, Any}("SubnetGroupName"=>SubnetGroupName))
UpdateSubnetGroup(SubnetGroupName, args::AbstractDict{String, <:Any}) = dax("UpdateSubnetGroup", Dict{String, Any}("SubnetGroupName"=>SubnetGroupName, args...))
