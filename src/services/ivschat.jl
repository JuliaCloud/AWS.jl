...
function create_room(; aws_config::AbstractAWSConfig=current_aws_config())
    return ivschat("POST", "/CreateRoom"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function create_room(
    ...
    return ivschat(
        "POST", "/CreateRoom", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_logging_configurations(; aws_config::AbstractAWSConfig=current_aws_config())
    return ivschat(
        "POST", "/ListLoggingConfigurations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_rooms(; aws_config::AbstractAWSConfig=current_aws_config())
    return ivschat("POST", "/ListRooms"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_rooms(
    ...
    return ivschat(
        "POST", "/ListRooms", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
