...
"""
function delete_language_model(ModelName; aws_config::AbstractAWSConfig=current_aws_config())
    return transcribe(
        "DeleteLanguageModel",
...
"""
function list_call_analytics_categories(; aws_config::AbstractAWSConfig=current_aws_config())
    return transcribe(
