...
"""
CreateMedicalVocabulary(LanguageCode, VocabularyFileUri, VocabularyName) = transcribe("CreateMedicalVocabulary", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyFileUri"=>VocabularyFileUri, "VocabularyName"=>VocabularyName))
CreateMedicalVocabulary(LanguageCode, VocabularyFileUri, VocabularyName, args::AbstractDict{String, <:Any}) = transcribe("CreateMedicalVocabulary", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyFileUri"=>VocabularyFileUri, "VocabularyName"=>VocabularyName, args...))
...
"""
CreateVocabulary(LanguageCode, VocabularyName) = transcribe("CreateVocabulary", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyName"=>VocabularyName))
CreateVocabulary(LanguageCode, VocabularyName, args::AbstractDict{String, <:Any}) = transcribe("CreateVocabulary", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyName"=>VocabularyName, args...))
...
"""
CreateVocabularyFilter(LanguageCode, VocabularyFilterName) = transcribe("CreateVocabularyFilter", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyFilterName"=>VocabularyFilterName))
CreateVocabularyFilter(LanguageCode, VocabularyFilterName, args::AbstractDict{String, <:Any}) = transcribe("CreateVocabularyFilter", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyFilterName"=>VocabularyFilterName, args...))
...
"""
DeleteMedicalTranscriptionJob(MedicalTranscriptionJobName) = transcribe("DeleteMedicalTranscriptionJob", Dict{String, Any}("MedicalTranscriptionJobName"=>MedicalTranscriptionJobName))
DeleteMedicalTranscriptionJob(MedicalTranscriptionJobName, args::AbstractDict{String, <:Any}) = transcribe("DeleteMedicalTranscriptionJob", Dict{String, Any}("MedicalTranscriptionJobName"=>MedicalTranscriptionJobName, args...))
...
"""
DeleteMedicalVocabulary(VocabularyName) = transcribe("DeleteMedicalVocabulary", Dict{String, Any}("VocabularyName"=>VocabularyName))
DeleteMedicalVocabulary(VocabularyName, args::AbstractDict{String, <:Any}) = transcribe("DeleteMedicalVocabulary", Dict{String, Any}("VocabularyName"=>VocabularyName, args...))
...
"""
DeleteTranscriptionJob(TranscriptionJobName) = transcribe("DeleteTranscriptionJob", Dict{String, Any}("TranscriptionJobName"=>TranscriptionJobName))
DeleteTranscriptionJob(TranscriptionJobName, args::AbstractDict{String, <:Any}) = transcribe("DeleteTranscriptionJob", Dict{String, Any}("TranscriptionJobName"=>TranscriptionJobName, args...))
...
"""
DeleteVocabulary(VocabularyName) = transcribe("DeleteVocabulary", Dict{String, Any}("VocabularyName"=>VocabularyName))
DeleteVocabulary(VocabularyName, args::AbstractDict{String, <:Any}) = transcribe("DeleteVocabulary", Dict{String, Any}("VocabularyName"=>VocabularyName, args...))
...
"""
DeleteVocabularyFilter(VocabularyFilterName) = transcribe("DeleteVocabularyFilter", Dict{String, Any}("VocabularyFilterName"=>VocabularyFilterName))
DeleteVocabularyFilter(VocabularyFilterName, args::AbstractDict{String, <:Any}) = transcribe("DeleteVocabularyFilter", Dict{String, Any}("VocabularyFilterName"=>VocabularyFilterName, args...))
...
"""
GetMedicalTranscriptionJob(MedicalTranscriptionJobName) = transcribe("GetMedicalTranscriptionJob", Dict{String, Any}("MedicalTranscriptionJobName"=>MedicalTranscriptionJobName))
GetMedicalTranscriptionJob(MedicalTranscriptionJobName, args::AbstractDict{String, <:Any}) = transcribe("GetMedicalTranscriptionJob", Dict{String, Any}("MedicalTranscriptionJobName"=>MedicalTranscriptionJobName, args...))
...
"""
GetMedicalVocabulary(VocabularyName) = transcribe("GetMedicalVocabulary", Dict{String, Any}("VocabularyName"=>VocabularyName))
GetMedicalVocabulary(VocabularyName, args::AbstractDict{String, <:Any}) = transcribe("GetMedicalVocabulary", Dict{String, Any}("VocabularyName"=>VocabularyName, args...))
...
"""
GetTranscriptionJob(TranscriptionJobName) = transcribe("GetTranscriptionJob", Dict{String, Any}("TranscriptionJobName"=>TranscriptionJobName))
GetTranscriptionJob(TranscriptionJobName, args::AbstractDict{String, <:Any}) = transcribe("GetTranscriptionJob", Dict{String, Any}("TranscriptionJobName"=>TranscriptionJobName, args...))
...
"""
GetVocabulary(VocabularyName) = transcribe("GetVocabulary", Dict{String, Any}("VocabularyName"=>VocabularyName))
GetVocabulary(VocabularyName, args::AbstractDict{String, <:Any}) = transcribe("GetVocabulary", Dict{String, Any}("VocabularyName"=>VocabularyName, args...))
...
"""
GetVocabularyFilter(VocabularyFilterName) = transcribe("GetVocabularyFilter", Dict{String, Any}("VocabularyFilterName"=>VocabularyFilterName))
GetVocabularyFilter(VocabularyFilterName, args::AbstractDict{String, <:Any}) = transcribe("GetVocabularyFilter", Dict{String, Any}("VocabularyFilterName"=>VocabularyFilterName, args...))
...
ListMedicalTranscriptionJobs(args::AbstractDict{String, <:Any}) = transcribe("ListMedicalTranscriptionJobs", args)
...
ListMedicalVocabularies(args::AbstractDict{String, <:Any}) = transcribe("ListMedicalVocabularies", args)
...
ListTranscriptionJobs(args::AbstractDict{String, <:Any}) = transcribe("ListTranscriptionJobs", args)
...
ListVocabularies(args::AbstractDict{String, <:Any}) = transcribe("ListVocabularies", args)
...
ListVocabularyFilters(args::AbstractDict{String, <:Any}) = transcribe("ListVocabularyFilters", args)
...
"""
StartMedicalTranscriptionJob(LanguageCode, Media, MedicalTranscriptionJobName, OutputBucketName, Specialty, Type) = transcribe("StartMedicalTranscriptionJob", Dict{String, Any}("LanguageCode"=>LanguageCode, "Media"=>Media, "MedicalTranscriptionJobName"=>MedicalTranscriptionJobName, "OutputBucketName"=>OutputBucketName, "Specialty"=>Specialty, "Type"=>Type))
StartMedicalTranscriptionJob(LanguageCode, Media, MedicalTranscriptionJobName, OutputBucketName, Specialty, Type, args::AbstractDict{String, <:Any}) = transcribe("StartMedicalTranscriptionJob", Dict{String, Any}("LanguageCode"=>LanguageCode, "Media"=>Media, "MedicalTranscriptionJobName"=>MedicalTranscriptionJobName, "OutputBucketName"=>OutputBucketName, "Specialty"=>Specialty, "Type"=>Type, args...))
...
"""
StartTranscriptionJob(LanguageCode, Media, TranscriptionJobName) = transcribe("StartTranscriptionJob", Dict{String, Any}("LanguageCode"=>LanguageCode, "Media"=>Media, "TranscriptionJobName"=>TranscriptionJobName))
StartTranscriptionJob(LanguageCode, Media, TranscriptionJobName, args::AbstractDict{String, <:Any}) = transcribe("StartTranscriptionJob", Dict{String, Any}("LanguageCode"=>LanguageCode, "Media"=>Media, "TranscriptionJobName"=>TranscriptionJobName, args...))
...
"""
UpdateMedicalVocabulary(LanguageCode, VocabularyName) = transcribe("UpdateMedicalVocabulary", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyName"=>VocabularyName))
UpdateMedicalVocabulary(LanguageCode, VocabularyName, args::AbstractDict{String, <:Any}) = transcribe("UpdateMedicalVocabulary", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyName"=>VocabularyName, args...))
...
"""
UpdateVocabulary(LanguageCode, VocabularyName) = transcribe("UpdateVocabulary", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyName"=>VocabularyName))
UpdateVocabulary(LanguageCode, VocabularyName, args::AbstractDict{String, <:Any}) = transcribe("UpdateVocabulary", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyName"=>VocabularyName, args...))
...
- `Words`: The words to use in the vocabulary filter. Only use characters from the character set defined for custom vocabularies. For a list of character sets, see Character Sets for Custom Vocabularies. If you provide a list of words in the Words parameter, you can't use the VocabularyFilterFileUri parameter.
"""
UpdateVocabularyFilter(VocabularyFilterName) = transcribe("UpdateVocabularyFilter", Dict{String, Any}("VocabularyFilterName"=>VocabularyFilterName))
UpdateVocabularyFilter(VocabularyFilterName, args::AbstractDict{String, <:Any}) = transcribe("UpdateVocabularyFilter", Dict{String, Any}("VocabularyFilterName"=>VocabularyFilterName, args...))
