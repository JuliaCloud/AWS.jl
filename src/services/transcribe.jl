...
All categories are automatically applied to your Call Analytics transcriptions. Note that
in order to apply categories to your transcriptions, you must create them before submitting
your transcription request, as categories cannot be applied retroactively.

When creating a new category, you can use the `InputType` parameter to label the category
as a `POST_CALL` or a `REAL_TIME` category. `POST_CALL` categories can only be applied to
...
To learn more about Call Analytics categories, see [Creating categories for post-call transcriptions](https://docs.aws.amazon.com/transcribe/latest/dg/tca-categories-batch.html)
...
- `"InputType"`: Choose whether you want to create a real-time or a post-call category for
  ...
  default.
"""
create_call_analytics_category(CategoryName, Rules; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("CreateCallAnalyticsCategory", Dict{String, Any}("CategoryName"=>CategoryName, "Rules"=>Rules); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_call_analytics_category(CategoryName, Rules, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("CreateCallAnalyticsCategory", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CategoryName"=>CategoryName, "Rules"=>Rules), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `input_data_config`: Contains the Amazon S3 location of the training data you want to use
  to create a new custom language model, and permissions to access this location.
...
contains your vocabulary table into an Amazon S3 bucket. Note that this differs from ,
where you can include a list of terms within your request using the `Phrases` flag;
`CreateMedicalVocabulary` does not support the `Phrases` flag and only accepts vocabularies
in table format.
...
request. Or you can include a list of terms directly in your request using the `Phrases`
flag.
...
"""
create_vocabulary(LanguageCode, VocabularyName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("CreateVocabulary", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyName"=>VocabularyName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_vocabulary(LanguageCode, VocabularyName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("CreateVocabulary", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyName"=>VocabularyName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"Words"`: Use this parameter if you want to create your custom vocabulary filter by
  ...
  to get the character set for your language.
"""
create_vocabulary_filter(LanguageCode, VocabularyFilterName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("CreateVocabularyFilter", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyFilterName"=>VocabularyFilterName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_call_analytics_category(CategoryName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteCallAnalyticsCategory", Dict{String, Any}("CategoryName"=>CategoryName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_call_analytics_category(CategoryName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteCallAnalyticsCategory", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CategoryName"=>CategoryName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `call_analytics_job_name`: The name of the Call Analytics job you want to delete. Job
  names are case sensitive.
"""
delete_call_analytics_job(CallAnalyticsJobName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteCallAnalyticsJob", Dict{String, Any}("CallAnalyticsJobName"=>CallAnalyticsJobName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_call_analytics_job(CallAnalyticsJobName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteCallAnalyticsJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CallAnalyticsJobName"=>CallAnalyticsJobName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `model_name`: The name of the custom language model you want to delete. Model names are
  case sensitive.
"""
delete_language_model(ModelName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteLanguageModel", Dict{String, Any}("ModelName"=>ModelName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_language_model(ModelName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteLanguageModel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ModelName"=>ModelName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `medical_scribe_job_name`: The name of the Medical Scribe job you want to delete. Job
  names are case sensitive.
"""
delete_medical_scribe_job(MedicalScribeJobName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteMedicalScribeJob", Dict{String, Any}("MedicalScribeJobName"=>MedicalScribeJobName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_medical_scribe_job(MedicalScribeJobName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteMedicalScribeJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MedicalScribeJobName"=>MedicalScribeJobName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_medical_transcription_job(MedicalTranscriptionJobName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteMedicalTranscriptionJob", Dict{String, Any}("MedicalTranscriptionJobName"=>MedicalTranscriptionJobName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_medical_vocabulary(VocabularyName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteMedicalVocabulary", Dict{String, Any}("VocabularyName"=>VocabularyName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_medical_vocabulary(VocabularyName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteMedicalVocabulary", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VocabularyName"=>VocabularyName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `transcription_job_name`: The name of the transcription job you want to delete. Job names
  are case sensitive.
"""
delete_transcription_job(TranscriptionJobName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteTranscriptionJob", Dict{String, Any}("TranscriptionJobName"=>TranscriptionJobName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_transcription_job(TranscriptionJobName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteTranscriptionJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TranscriptionJobName"=>TranscriptionJobName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_vocabulary(VocabularyName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteVocabulary", Dict{String, Any}("VocabularyName"=>VocabularyName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_vocabulary(VocabularyName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteVocabulary", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VocabularyName"=>VocabularyName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_vocabulary_filter(VocabularyFilterName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteVocabularyFilter", Dict{String, Any}("VocabularyFilterName"=>VocabularyFilterName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_vocabulary_filter(VocabularyFilterName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DeleteVocabularyFilter", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VocabularyFilterName"=>VocabularyFilterName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
If you tried to create a new custom language model and the request wasn't successful, you
can use `DescribeLanguageModel` to help identify the reason for this failure.
...
- `model_name`: The name of the custom language model you want information about. Model
  names are case sensitive.
"""
describe_language_model(ModelName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DescribeLanguageModel", Dict{String, Any}("ModelName"=>ModelName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_language_model(ModelName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("DescribeLanguageModel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ModelName"=>ModelName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `category_name`: The name of the Call Analytics category you want information about.
  Category names are case sensitive.
"""
get_call_analytics_category(CategoryName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetCallAnalyticsCategory", Dict{String, Any}("CategoryName"=>CategoryName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_call_analytics_category(CategoryName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetCallAnalyticsCategory", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CategoryName"=>CategoryName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
`TranscriptFileUri`. If the status is `FAILED`, `FailureReason` provides details on why
...
"""
get_call_analytics_job(CallAnalyticsJobName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetCallAnalyticsJob", Dict{String, Any}("CallAnalyticsJobName"=>CallAnalyticsJobName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_call_analytics_job(CallAnalyticsJobName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetCallAnalyticsJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CallAnalyticsJobName"=>CallAnalyticsJobName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
`MedicalScribeJobStatus` field. If the status is `COMPLETED`, the job is finished. You can
find the results at the location specified in `MedicalScribeOutput`. If the status is
...
- `medical_scribe_job_name`: The name of the Medical Scribe job you want information about.
  Job names are case sensitive.
"""
get_medical_scribe_job(MedicalScribeJobName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetMedicalScribeJob", Dict{String, Any}("MedicalScribeJobName"=>MedicalScribeJobName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
To view the status of the specified medical transcription job, check the
`TranscriptionJobStatus` field. If the status is `COMPLETED`, the job is finished. You can
find the results at the location specified in `TranscriptFileUri`. If the status is
...
"""
get_medical_transcription_job(MedicalTranscriptionJobName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetMedicalTranscriptionJob", Dict{String, Any}("MedicalTranscriptionJobName"=>MedicalTranscriptionJobName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
field. If the status is `READY`, your custom vocabulary is available to use. If the status
is `FAILED`, `FailureReason` provides details on why your vocabulary failed.
...
"""
get_medical_vocabulary(VocabularyName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetMedicalVocabulary", Dict{String, Any}("VocabularyName"=>VocabularyName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_medical_vocabulary(VocabularyName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetMedicalVocabulary", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VocabularyName"=>VocabularyName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `transcription_job_name`: The name of the transcription job you want information about.
  Job names are case sensitive.
"""
get_transcription_job(TranscriptionJobName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetTranscriptionJob", Dict{String, Any}("TranscriptionJobName"=>TranscriptionJobName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_transcription_job(TranscriptionJobName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetTranscriptionJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TranscriptionJobName"=>TranscriptionJobName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
To view the status of the specified custom vocabulary, check the `VocabularyState` field.
If the status is `READY`, your custom vocabulary is available to use. If the status is
...
- `vocabulary_name`: The name of the custom vocabulary you want information about. Custom
  vocabulary names are case sensitive.
"""
get_vocabulary(VocabularyName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetVocabulary", Dict{String, Any}("VocabularyName"=>VocabularyName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_vocabulary(VocabularyName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetVocabulary", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VocabularyName"=>VocabularyName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_vocabulary_filter(VocabularyFilterName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetVocabularyFilter", Dict{String, Any}("VocabularyFilterName"=>VocabularyFilterName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_vocabulary_filter(VocabularyFilterName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("GetVocabularyFilter", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VocabularyFilterName"=>VocabularyFilterName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: If your `ListCallAnalyticsCategories` request returns more results than
  ...
  results.
"""
list_call_analytics_categories(; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListCallAnalyticsCategories"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_call_analytics_categories(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListCallAnalyticsCategories", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_call_analytics_jobs(; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListCallAnalyticsJobs"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_call_analytics_jobs(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListCallAnalyticsJobs", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
are specified, all custom language models are returned.
...
"""
list_language_models(; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListLanguageModels"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_language_models(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListLanguageModels", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_medical_scribe_jobs(; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListMedicalScribeJobs"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_medical_scribe_jobs(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListMedicalScribeJobs", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_medical_transcription_jobs(; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListMedicalTranscriptionJobs"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_medical_transcription_jobs(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListMedicalTranscriptionJobs", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_medical_vocabularies(; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListMedicalVocabularies"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_medical_vocabularies(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListMedicalVocabularies", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_tags_for_resource(ResourceArn; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_tags_for_resource(ResourceArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_transcription_jobs(; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListTranscriptionJobs"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_transcription_jobs(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListTranscriptionJobs", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_vocabularies(; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListVocabularies"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_vocabularies(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListVocabularies", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: If your `ListVocabularyFilters` request returns more results than can be
  ...
  with the value of the copied string. Repeat as needed to view all your results.
"""
list_vocabulary_filters(; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListVocabularyFilters"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_vocabulary_filters(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("ListVocabularyFilters", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
conditions. To learn more about these features and insights, refer to [Analyzing call center audio with Call Analytics](https://docs.aws.amazon.com/transcribe/latest/dg/call-analytics.html).

If you want to apply categories to your Call Analytics job, you must create them before
submitting your job request. Categories cannot be retroactively applied to a job. To create
a new category, use the operation. To learn more about Call Analytics categories, see [Creating categories for post-call transcriptions](https://docs.aws.amazon.com/transcribe/latest/dg/tca-categories-batch.html)
and [Creating categories for real-time transcriptions](https://docs.aws.amazon.com/transcribe/latest/dg/tca-categories-stream.html).
...
"""
start_call_analytics_job(CallAnalyticsJobName, Media; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("StartCallAnalyticsJob", Dict{String, Any}("CallAnalyticsJobName"=>CallAnalyticsJobName, "Media"=>Media); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_call_analytics_job(CallAnalyticsJobName, Media, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("StartCallAnalyticsJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CallAnalyticsJobName"=>CallAnalyticsJobName, "Media"=>Media), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
preliminary clinical notes. To learn more about these features, refer to [Amazon Web Services HealthScribe](https://docs.aws.amazon.com/transcribe/latest/dg/health-scribe.html).
...
- `"ChannelDefinitions"`: Makes it possible to specify which speaker is on which channel.
  For example, if the clinician is the first participant to speak, you would set
  `ChannelId` of the first `ChannelDefinition` in the list to `0` (to indicate the first
  channel) and `ParticipantRole` to `CLINICIAN` (to indicate that it's the clinician
  speaking). Then you would set the `ChannelId` of the second `ChannelDefinition` in the
...
with a robust medical vocabulary and, optionally, content identification, which adds flags
to personal health information (PHI). To learn more about these features, refer to [How Amazon Transcribe Medical works](https://docs.aws.amazon.com/transcribe/latest/dg/how-it-works-med.html).

To make a `StartMedicalTranscriptionJob` request, you must first upload your media file
...
- `language_code`: The language code that represents the language spoken in the input media
  file. US English (`en-US`) is the only valid value for medical transcription jobs. Any
...
- `output_bucket_name`: The name of the Amazon S3 bucket where you want your medical
  transcription output stored. Do not include the `S3://` prefix of the specified bucket.
...
- `type`: Specify whether your input media contains only one person (`DICTATION`) or
...
- `"ContentRedaction"`: Makes it possible to redact or flag specified personally
  identifiable information (PII) in your transcript. If you use `ContentRedaction`, you
  must also include the sub-parameters: `RedactionOutput` and `RedactionType`. You can
...
- `"JobExecutionSettings"`: Makes it possible to control how your transcription job is
  processed. Currently, the only `JobExecutionSettings` modification you can choose is
...
- `"OutputKey"`: Use in combination with `OutputBucketName` to specify the output location
  ...
  created for you.
- `"Settings"`: Specify additional optional settings in your request, including channel
  identification, alternative transcriptions, speaker partitioning. You can use that to
...
"""
start_transcription_job(Media, TranscriptionJobName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("StartTranscriptionJob", Dict{String, Any}("Media"=>Media, "TranscriptionJobName"=>TranscriptionJobName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_transcription_job(Media, TranscriptionJobName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("StartTranscriptionJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Media"=>Media, "TranscriptionJobName"=>TranscriptionJobName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `tags`: Adds one or more custom tags, each in the form of a key:value pair, to the
  ...
  To learn more about using tags with Amazon Transcribe, refer to [Tagging resources](https://docs.aws.amazon.com/transcribe/latest/dg/tagging.html).
"""
tag_resource(ResourceArn, Tags; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
tag_resource(ResourceArn, Tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
untag_resource(ResourceArn, TagKeys; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
untag_resource(ResourceArn, TagKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_call_analytics_category(CategoryName, Rules; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("UpdateCallAnalyticsCategory", Dict{String, Any}("CategoryName"=>CategoryName, "Rules"=>Rules); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_call_analytics_category(CategoryName, Rules, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("UpdateCallAnalyticsCategory", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CategoryName"=>CategoryName, "Rules"=>Rules), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
update_medical_vocabulary(LanguageCode, VocabularyFileUri, VocabularyName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("UpdateMedicalVocabulary", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyFileUri"=>VocabularyFileUri, "VocabularyName"=>VocabularyName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `language_code`: The language code that represents the language of the entries in the
  custom vocabulary you want to update. Each custom vocabulary must contain terms in only
  one language.
...
- `"VocabularyFileUri"`: The Amazon S3 location of the text file that contains your custom
  ...
  `Phrases` flag; you must choose one or the other.
"""
update_vocabulary(LanguageCode, VocabularyName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("UpdateVocabulary", Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyName"=>VocabularyName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_vocabulary(LanguageCode, VocabularyName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("UpdateVocabulary", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LanguageCode"=>LanguageCode, "VocabularyName"=>VocabularyName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"Words"`: Use this parameter if you want to update your custom vocabulary filter by
  ...
  to get the character set for your language.
"""
update_vocabulary_filter(VocabularyFilterName; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("UpdateVocabularyFilter", Dict{String, Any}("VocabularyFilterName"=>VocabularyFilterName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_vocabulary_filter(VocabularyFilterName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = transcribe("UpdateVocabularyFilter", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VocabularyFilterName"=>VocabularyFilterName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
