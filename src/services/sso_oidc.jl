...
# Required Parameters
- `clientId`: The unique identifier string for each client. This value should come from the
  persisted result of the RegisterClient API.
- `clientSecret`: A secret string generated for the client. This value should come from the
  persisted result of the RegisterClient API.
...
- `grantType`: Supports grant types for authorization code, refresh token, and device code
  request.
...
- `redirectUri`: The location of the application that will receive the authorization code.
...
# Required Parameters
- `clientId`: The unique identifier string for the client that is registered with AWS SSO.
  This value should come from the persisted result of the RegisterClient API operation.
- `clientSecret`: A secret string that is generated for the client. This value should come
