...
- `client_id`: The unique identifier string for the client or application. This value comes
  from the result of the [`register_client`](@ref) API.

- `client_secret`: A secret string generated for the client. This value should come from the
  persisted result of the [`register_client`](@ref) API.
...
- `grant_type`: Supports the following OAuth grant types: Device Code and Refresh Token.
  ...
  * Refresh Token - `refresh_token`
  ...
  For information about how to obtain the device code, see the [`start_device_authorization`](@ref)
  topic.
...
- `"code"`: Used only when calling this API for the Authorization Code grant type. The
  ...
  currently unsupported for the [`create_token`](@ref) API.
...
- `"deviceCode"`: Used only when calling this API for the Device Code grant type. This
  ...
  of the [`start_device_authorization`](@ref) API.
...
- `client_id`: The unique identifier string for the client that is registered with IAM
  Identity Center. This value should come from the persisted result of the [`register_client`](@ref)
  API operation.
- `client_secret`: A secret string that is generated for the client. This value should come
  from the persisted result of the [`register_client`](@ref) API operation.
