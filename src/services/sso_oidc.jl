...
"""
CreateToken(clientId, clientSecret, deviceCode, grantType; aws::AWSConfig=AWS.aws_config) = sso_oidc("POST", "/token", Dict{String, Any}("clientId"=>clientId, "clientSecret"=>clientSecret, "deviceCode"=>deviceCode, "grantType"=>grantType); aws=aws)
CreateToken(clientId, clientSecret, deviceCode, grantType, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = sso_oidc("POST", "/token", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientId"=>clientId, "clientSecret"=>clientSecret, "deviceCode"=>deviceCode, "grantType"=>grantType), args)); aws=aws)
...
"""
RegisterClient(clientName, clientType; aws::AWSConfig=AWS.aws_config) = sso_oidc("POST", "/client/register", Dict{String, Any}("clientName"=>clientName, "clientType"=>clientType); aws=aws)
RegisterClient(clientName, clientType, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = sso_oidc("POST", "/client/register", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientName"=>clientName, "clientType"=>clientType), args)); aws=aws)
...
"""
StartDeviceAuthorization(clientId, clientSecret, startUrl; aws::AWSConfig=AWS.aws_config) = sso_oidc("POST", "/device_authorization", Dict{String, Any}("clientId"=>clientId, "clientSecret"=>clientSecret, "startUrl"=>startUrl); aws=aws)
StartDeviceAuthorization(clientId, clientSecret, startUrl, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWS.aws_config) = sso_oidc("POST", "/device_authorization", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientId"=>clientId, "clientSecret"=>clientSecret, "startUrl"=>startUrl), args)); aws=aws)
