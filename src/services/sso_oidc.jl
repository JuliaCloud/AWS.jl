...
"""
CreateToken(clientId, clientSecret, deviceCode, grantType) = sso_oidc("POST", "/token", Dict{String, Any}("clientId"=>clientId, "clientSecret"=>clientSecret, "deviceCode"=>deviceCode, "grantType"=>grantType))
CreateToken(clientId, clientSecret, deviceCode, grantType, args::AbstractDict{String, <: Any}) = sso_oidc("POST", "/token", Dict{String, Any}("clientId"=>clientId, "clientSecret"=>clientSecret, "deviceCode"=>deviceCode, "grantType"=>grantType, args...))
...
"""
RegisterClient(clientName, clientType) = sso_oidc("POST", "/client/register", Dict{String, Any}("clientName"=>clientName, "clientType"=>clientType))
RegisterClient(clientName, clientType, args::AbstractDict{String, <: Any}) = sso_oidc("POST", "/client/register", Dict{String, Any}("clientName"=>clientName, "clientType"=>clientType, args...))
...
"""
StartDeviceAuthorization(clientId, clientSecret, startUrl) = sso_oidc("POST", "/device_authorization", Dict{String, Any}("clientId"=>clientId, "clientSecret"=>clientSecret, "startUrl"=>startUrl))
StartDeviceAuthorization(clientId, clientSecret, startUrl, args::AbstractDict{String, <: Any}) = sso_oidc("POST", "/device_authorization", Dict{String, Any}("clientId"=>clientId, "clientSecret"=>clientSecret, "startUrl"=>startUrl, args...))
