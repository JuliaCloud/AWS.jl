...
"""
GetPersonalizedRanking(campaignArn, inputList, userId) = personalize_runtime("POST", "/personalize-ranking", Dict{String, Any}("campaignArn"=>campaignArn, "inputList"=>inputList, "userId"=>userId))
GetPersonalizedRanking(campaignArn, inputList, userId, args::AbstractDict{String, <: Any}) = personalize_runtime("POST", "/personalize-ranking", Dict{String, Any}("campaignArn"=>campaignArn, "inputList"=>inputList, "userId"=>userId, args...))
...
"""
GetRecommendations(campaignArn) = personalize_runtime("POST", "/recommendations", Dict{String, Any}("campaignArn"=>campaignArn))
GetRecommendations(campaignArn, args::AbstractDict{String, <: Any}) = personalize_runtime("POST", "/recommendations", Dict{String, Any}("campaignArn"=>campaignArn, args...))
