...
# Required Parameters
- `AccountCustomization`: The QuickSight customizations you're adding in the current AWS
...
# Required Parameters
- `AnalysisId`: The ID for the analysis that you're creating. This ID displays in the URL
  of the analysis.
...
# Required Parameters
- `AwsAccountId`: The AWS account ID.
- `DataSetId`: An ID for the dataset that you want to create. This ID is unique per AWS
...
- `PhysicalTableMap`: Declares the physical tables that are available in the underlying
  data sources.
...
# Required Parameters
- `AwsAccountId`: The AWS account ID.
- `DataSourceId`: An ID for the data source. This ID is unique per AWS Region for each AWS
  account.
- `Name`: A display name for the data source.
- `Type`: The type of the data source. Currently, the supported types for this operation
  are: ATHENA, AURORA, AURORA_POSTGRESQL, MARIADB, MYSQL, POSTGRESQL, PRESTO, REDSHIFT, S3,
  SNOWFLAKE, SPARK, SQLSERVER, TERADATA. Use ListDataSources to return a list of all data
  sources.

# Optional Parameters
- `Credentials`: The credentials QuickSight that uses to connect to your underlying source.
  Currently, only credentials based on user name and password are supported.
- `DataSourceParameters`: The parameters that QuickSight uses to connect to your underlying
  source.
- `Permissions`: A list of resource permissions on the data source.
- `SslProperties`: Secure Socket Layer (SSL) properties that apply when QuickSight connects
  to your underlying source.
- `Tags`: Contains a map of the key-value pairs for the resource tag or tags assigned to
  the data source.
- `VpcConnectionProperties`: Use this parameter only when you want QuickSight to use a VPC
...
# Required Parameters
- `AwsAccountId`: The ID for the AWS account that the group is in. Currently, you use the
...
# Required Parameters
- `AssignmentName`: The name of the assignment, also called a rule. It must be unique
...
- `AwsAccountId`: The ID of the AWS account where you want to assign an IAM policy to
...
# Required Parameters
- `AwsAccountId`: The ID for the AWS account that you want to create the QuickSight
  namespace in.
- `IdentityStore`: Specifies the type of your user identity directory. Currently, this
...
- `TemplateId`: An ID for the template that you want to create. This template is unique per
...
# Required Parameters
- `AliasName`: The name that you want to give to the template alias that you're creating.
  Don't start the alias name with the  character. Alias names that start with  are reserved
  by QuickSight.
- `AwsAccountId`: The ID of the AWS account that contains the template that you creating an
  alias for.
...
- `BaseThemeId`: The ID of the theme that a custom theme will inherit from. All themes
...
- `ThemeId`: An ID for the theme that you want to create. The theme ID is unique per AWS
...
- `AliasName`: The name that you want to give to the theme alias that you are creating. The
  alias name can't begin with a . Alias names that start with  are reserved by Amazon
  QuickSight.
...
# Required Parameters
- `AwsAccountId`: The ID for the AWS account that you want to delete QuickSight
...
# Required Parameters
- `AwsAccountId`: The ID of the AWS account that contains the dashboard that you're
  deleting.
...
# Required Parameters
- `AwsAccountId`: The AWS account ID.
- `DataSetId`: The ID for the dataset that you want to create. This ID is unique per AWS
  Region for each AWS account.
...
# Required Parameters
- `AwsAccountId`: The AWS account ID.
- `DataSourceId`: The ID of the data source. This ID is unique per AWS Region for each AWS
  account.
...
# Required Parameters
- `AwsAccountId`: The ID for the AWS account that you want to delete the QuickSight
  namespace from.
...
# Required Parameters
- `AliasName`: The name for the template alias. To delete a specific alias, you delete the
...
# Optional Parameters
- `version-number`: The version of the theme that you want to delete.   Note: If you don't
...
# Required Parameters
- `AwsAccountId`: The ID for the AWS account that the user is in. Currently, you use the ID
...
# Required Parameters
- `AwsAccountId`: The ID for the AWS account that you want to describe QuickSight
  customizations for.

# Optional Parameters
- `namespace`: The QuickSight namespace that you want to describe QuickSight customizations
  for.
- `resolved`: The Resolved flag works with the other parameters to determine which view of
  QuickSight customizations is returned. You can add this flag to your command to use the
...
# Required Parameters
- `AwsAccountId`: The ID for the AWS account that contains the settings that you want to
  list.
...
# Required Parameters
- `AnalysisId`: The ID of the analysis that you're describing. The ID is part of the URL of
  the analysis.
- `AwsAccountId`: The ID of the AWS account that contains the analysis. You must be using
...
# Required Parameters
- `AnalysisId`: The ID of the analysis whose permissions you're describing. The ID is part
  of the analysis URL.
- `AwsAccountId`: The ID of the AWS account that contains the analysis whose permissions
...
- `version-number`: The version number for the dashboard. If a version number isn't passed,
...
- `AwsAccountId`: The ID of the AWS account that contains the assignment that you want to
  describe.
- `Namespace`: The namespace that contains the assignment.
...
# Required Parameters
- `AwsAccountId`: The ID for the AWS account that contains the QuickSight namespace that
...
# Required Parameters
- `AwsAccountId`: The ID of the AWS account that contains the template that you're
  describing.
- `TemplateId`: The ID for the template.

# Optional Parameters
- `alias-name`: The alias of the template that you want to describe. If you name a specific
...
# Required Parameters
- `AliasName`: The name of the template alias that you want to describe. If you name a
...
- `AwsAccountId`: The ID of the AWS account that contains the template alias that you're
  describing.
- `TemplateId`: The ID for the template.
...
- `AwsAccountId`: The ID of the AWS account that contains the theme alias that you're
  describing.
- `ThemeId`: The ID for the theme.
...
# Required Parameters
- `AwsAccountId`: The ID for the AWS account that contains the dashboard that you're
  embedding.
- `DashboardId`: The ID for the dashboard, also added to the AWS Identity and Access
  Management (IAM) policy.
- `creds-type`: The authentication method that the user uses to sign in.

# Optional Parameters
- `additional-dashboard-ids`: A list of one or more dashboard IDs that you want to add to a
  session that includes anonymous users. The IdentityType parameter must be set to ANONYMOUS
  for this to work, because other identity types authenticate as QuickSight or IAM users. For
...
- `namespace`: The QuickSight namespace that contains the dashboard IDs in this request. If
...
# Required Parameters
- `AwsAccountId`: The ID of the AWS account that contains the dashboard that you're listing
  versions for.
- `DashboardId`: The ID for the dashboard.
...
# Required Parameters
- `AwsAccountId`: The ID of the AWS account that contains the dashboards that you're
  listing.
...
# Required Parameters
- `AwsAccountId`: The ID for the AWS account that contains the QuickSight namespaces that
  you want to list.
...
# Required Parameters
- `ResourceArn`: The Amazon Resource Name (ARN) of the resource that you want a list of
  tags for.
...
# Required Parameters
- `AwsAccountId`: The ID of the AWS account that contains the template aliases that you're
  listing.
- `TemplateId`: The ID for the template.
...
# Required Parameters
- `AwsAccountId`: The ID of the AWS account that contains the theme aliases that you're
  listing.
- `ThemeId`: The ID for the theme.
...
# Required Parameters
- `AwsAccountId`: The AWS account ID that the user is in. Currently, you use the ID for the
...
- `IdentityType`: Amazon QuickSight supports several ways of managing the identity of
...
# Required Parameters
- `AwsAccountId`: The ID of the AWS account that contains the analyses that you're
  searching for.
...
# Required Parameters
- `AwsAccountId`: The ID of the AWS account that contains the user whose dashboards you're
  searching for.
...
# Required Parameters
- `AccountCustomization`: The QuickSight customizations you're updating in the current AWS
  Region.
- `AwsAccountId`: The ID for the AWS account that you want to update QuickSight
  customizations for.
...
# Required Parameters
- `AwsAccountId`: The ID for the AWS account that contains the QuickSight settings that you
  want to list.
- `DefaultNamespace`: The default namespace for this AWS account. Currently, the default is
  default. AWS Identity and Access Management (IAM) users that register for the first time
  with QuickSight provide an email that becomes associated with the default namespace.

# Optional Parameters
- `NotificationEmail`: The email address that you want QuickSight to send notifications to
...
# Required Parameters
- `AnalysisId`: The ID for the analysis that you're updating. This ID displays in the URL
  of the analysis.
...
# Required Parameters
- `AnalysisId`: The ID of the analysis whose permissions you're updating. The ID is part of
  the analysis URL.
- `AwsAccountId`: The ID of the AWS account that contains the analysis whose permissions
...
# Required Parameters
- `AwsAccountId`: The ID of the AWS account that contains the dashboard whose permissions
  you're updating.
- `DashboardId`: The ID for the dashboard.
...
# Required Parameters
- `AwsAccountId`: The AWS account ID.
- `DataSetId`: The ID for the dataset that you want to update. This ID is unique per AWS
  Region for each AWS account.
- `ImportMode`: Indicates whether you want to import the data into SPICE.
- `Name`: The display name for the dataset.
- `PhysicalTableMap`: Declares the physical tables that are available in the underlying
...
# Required Parameters
- `AwsAccountId`: The AWS account ID.
- `DataSetId`: The ID for the dataset whose permissions you want to update. This ID is
...
# Required Parameters
- `AssignmentName`: The name of the assignment, also called a rule. This name must be
...
# Required Parameters
- `AliasName`: The alias of the template that you want to update. If you name a specific
...
- `BaseThemeId`: The theme ID, defined by Amazon QuickSight, that a custom theme inherits
