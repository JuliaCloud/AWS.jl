...
function create_parallel_data(
    ClientToken, Name, ParallelDataConfig; aws_config::AbstractAWSConfig=current_aws_config()
)
    return translate(
        "CreateParallelData",
        Dict{String,Any}(
...
"""
function stop_text_translation_job(JobId; aws_config::AbstractAWSConfig=current_aws_config())
    return translate(
