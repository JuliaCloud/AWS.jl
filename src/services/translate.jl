...
"""
DeleteTerminology(Name) = translate("DeleteTerminology", Dict{String, Any}("Name"=>Name))
DeleteTerminology(Name, args::AbstractDict{String, <:Any}) = translate("DeleteTerminology", Dict{String, Any}("Name"=>Name, args...))
...
"""
DescribeTextTranslationJob(JobId) = translate("DescribeTextTranslationJob", Dict{String, Any}("JobId"=>JobId))
DescribeTextTranslationJob(JobId, args::AbstractDict{String, <:Any}) = translate("DescribeTextTranslationJob", Dict{String, Any}("JobId"=>JobId, args...))
...
"""
GetTerminology(Name, TerminologyDataFormat) = translate("GetTerminology", Dict{String, Any}("Name"=>Name, "TerminologyDataFormat"=>TerminologyDataFormat))
GetTerminology(Name, TerminologyDataFormat, args::AbstractDict{String, <:Any}) = translate("GetTerminology", Dict{String, Any}("Name"=>Name, "TerminologyDataFormat"=>TerminologyDataFormat, args...))
...
"""
ImportTerminology(MergeStrategy, Name, TerminologyData) = translate("ImportTerminology", Dict{String, Any}("MergeStrategy"=>MergeStrategy, "Name"=>Name, "TerminologyData"=>TerminologyData))
ImportTerminology(MergeStrategy, Name, TerminologyData, args::AbstractDict{String, <:Any}) = translate("ImportTerminology", Dict{String, Any}("MergeStrategy"=>MergeStrategy, "Name"=>Name, "TerminologyData"=>TerminologyData, args...))
...
ListTerminologies(args::AbstractDict{String, <:Any}) = translate("ListTerminologies", args)
...
ListTextTranslationJobs(args::AbstractDict{String, <:Any}) = translate("ListTextTranslationJobs", args)
...
StartTextTranslationJob(ClientToken, DataAccessRoleArn, InputDataConfig, OutputDataConfig, SourceLanguageCode, TargetLanguageCodes, args::AbstractDict{String, <:Any}) = translate("StartTextTranslationJob", Dict{String, Any}("ClientToken"=>ClientToken, "DataAccessRoleArn"=>DataAccessRoleArn, "InputDataConfig"=>InputDataConfig, "OutputDataConfig"=>OutputDataConfig, "SourceLanguageCode"=>SourceLanguageCode, "TargetLanguageCodes"=>TargetLanguageCodes, args...))
...
"""
StopTextTranslationJob(JobId) = translate("StopTextTranslationJob", Dict{String, Any}("JobId"=>JobId))
StopTextTranslationJob(JobId, args::AbstractDict{String, <:Any}) = translate("StopTextTranslationJob", Dict{String, Any}("JobId"=>JobId, args...))
...
"""
TranslateText(SourceLanguageCode, TargetLanguageCode, Text) = translate("TranslateText", Dict{String, Any}("SourceLanguageCode"=>SourceLanguageCode, "TargetLanguageCode"=>TargetLanguageCode, "Text"=>Text))
TranslateText(SourceLanguageCode, TargetLanguageCode, Text, args::AbstractDict{String, <:Any}) = translate("TranslateText", Dict{String, Any}("SourceLanguageCode"=>SourceLanguageCode, "TargetLanguageCode"=>TargetLanguageCode, "Text"=>Text, args...))
