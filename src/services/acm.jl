...
"""
AddTagsToCertificate(CertificateArn, Tags) = acm("AddTagsToCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, "Tags"=>Tags))
AddTagsToCertificate(CertificateArn, Tags, args::AbstractDict{String, <: Any}) = acm("AddTagsToCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, "Tags"=>Tags, args...))
...
"""
DeleteCertificate(CertificateArn) = acm("DeleteCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn))
DeleteCertificate(CertificateArn, args::AbstractDict{String, <: Any}) = acm("DeleteCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, args...))
...
"""
DescribeCertificate(CertificateArn) = acm("DescribeCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn))
DescribeCertificate(CertificateArn, args::AbstractDict{String, <: Any}) = acm("DescribeCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, args...))
...
"""
ExportCertificate(CertificateArn, Passphrase) = acm("ExportCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, "Passphrase"=>Passphrase))
ExportCertificate(CertificateArn, Passphrase, args::AbstractDict{String, <: Any}) = acm("ExportCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, "Passphrase"=>Passphrase, args...))
...
"""
GetCertificate(CertificateArn) = acm("GetCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn))
GetCertificate(CertificateArn, args::AbstractDict{String, <: Any}) = acm("GetCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, args...))
...
"""
ImportCertificate(Certificate, PrivateKey) = acm("ImportCertificate", Dict{String, Any}("Certificate"=>Certificate, "PrivateKey"=>PrivateKey))
ImportCertificate(Certificate, PrivateKey, args::AbstractDict{String, <: Any}) = acm("ImportCertificate", Dict{String, Any}("Certificate"=>Certificate, "PrivateKey"=>PrivateKey, args...))
...
ListCertificates(args::AbstractDict{String, <: Any}) = acm("ListCertificates", args)
...
"""
ListTagsForCertificate(CertificateArn) = acm("ListTagsForCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn))
ListTagsForCertificate(CertificateArn, args::AbstractDict{String, <: Any}) = acm("ListTagsForCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, args...))
...
"""
RemoveTagsFromCertificate(CertificateArn, Tags) = acm("RemoveTagsFromCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, "Tags"=>Tags))
RemoveTagsFromCertificate(CertificateArn, Tags, args::AbstractDict{String, <: Any}) = acm("RemoveTagsFromCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, "Tags"=>Tags, args...))
...
"""
RenewCertificate(CertificateArn) = acm("RenewCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn))
RenewCertificate(CertificateArn, args::AbstractDict{String, <: Any}) = acm("RenewCertificate", Dict{String, Any}("CertificateArn"=>CertificateArn, args...))
...
"""
RequestCertificate(DomainName) = acm("RequestCertificate", Dict{String, Any}("DomainName"=>DomainName))
RequestCertificate(DomainName, args::AbstractDict{String, <: Any}) = acm("RequestCertificate", Dict{String, Any}("DomainName"=>DomainName, args...))
...
"""
ResendValidationEmail(CertificateArn, Domain, ValidationDomain) = acm("ResendValidationEmail", Dict{String, Any}("CertificateArn"=>CertificateArn, "Domain"=>Domain, "ValidationDomain"=>ValidationDomain))
ResendValidationEmail(CertificateArn, Domain, ValidationDomain, args::AbstractDict{String, <: Any}) = acm("ResendValidationEmail", Dict{String, Any}("CertificateArn"=>CertificateArn, "Domain"=>Domain, "ValidationDomain"=>ValidationDomain, args...))
...
"""
UpdateCertificateOptions(CertificateArn, Options) = acm("UpdateCertificateOptions", Dict{String, Any}("CertificateArn"=>CertificateArn, "Options"=>Options))
UpdateCertificateOptions(CertificateArn, Options, args::AbstractDict{String, <: Any}) = acm("UpdateCertificateOptions", Dict{String, Any}("CertificateArn"=>CertificateArn, "Options"=>Options, args...))
