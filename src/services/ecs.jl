...
function delete_cluster(
    cluster, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return ecs(
        "DeleteCluster",
...
function delete_service(
    service, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return ecs(
        "DeleteService",
