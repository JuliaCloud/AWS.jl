...
DescribeServices(args::AbstractDict{String, <: Any}) = pricing("DescribeServices", args)
...
NextToken => The pagination token that indicates the next set of results that you want to retrieve.
"""
GetAttributeValues(AttributeName, ServiceCode) = pricing("GetAttributeValues", Dict{String, Any}("AttributeName"=>AttributeName, "ServiceCode"=>ServiceCode))
GetAttributeValues(AttributeName, ServiceCode, args::AbstractDict{String, <: Any}) = pricing("GetAttributeValues", Dict{String, Any}("AttributeName"=>AttributeName, "ServiceCode"=>ServiceCode, args...))
...
GetProducts(args::AbstractDict{String, <: Any}) = pricing("GetProducts", args)
