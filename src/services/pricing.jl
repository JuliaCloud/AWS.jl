...
function describe_services(; aws_config::AbstractAWSConfig=current_aws_config())
    return pricing("DescribeServices"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function describe_services(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return pricing("DescribeServices", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `service_code`: The service code or the Savings Plans service code for the attributes that
