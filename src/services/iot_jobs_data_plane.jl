...
DescribeJobExecution(jobId, thingName, args::AbstractDict{String, <:Any}) = iot_jobs_data_plane("GET", "/things/$(thingName)/jobs/$(jobId)", args)
...
GetPendingJobExecutions(thingName, args::AbstractDict{String, <:Any}) = iot_jobs_data_plane("GET", "/things/$(thingName)/jobs", args)
...
StartNextPendingJobExecution(thingName, args::AbstractDict{String, <:Any}) = iot_jobs_data_plane("PUT", "/things/$(thingName)/jobs/$next", args)
...
"""
UpdateJobExecution(jobId, status, thingName) = iot_jobs_data_plane("POST", "/things/$(thingName)/jobs/$(jobId)", Dict{String, Any}("status"=>status))
UpdateJobExecution(jobId, status, thingName, args::AbstractDict{String, <:Any}) = iot_jobs_data_plane("POST", "/things/$(thingName)/jobs/$(jobId)", Dict{String, Any}("status"=>status, args...))
