...
"""
StartPipelineExecution(name) = codepipeline("StartPipelineExecution", Dict{String, Any}("name"=>name))
StartPipelineExecution(name, args::AbstractDict{String, <: Any}) = codepipeline("StartPipelineExecution", Dict{String, Any}("name"=>name, args...))
