...
"""
AcknowledgeJob(jobId, nonce) = codepipeline("AcknowledgeJob", Dict{String, Any}("jobId"=>jobId, "nonce"=>nonce))
AcknowledgeJob(jobId, nonce, args::AbstractDict{String, <:Any}) = codepipeline("AcknowledgeJob", Dict{String, Any}("jobId"=>jobId, "nonce"=>nonce, args...))
...
"""
AcknowledgeThirdPartyJob(clientToken, jobId, nonce) = codepipeline("AcknowledgeThirdPartyJob", Dict{String, Any}("clientToken"=>clientToken, "jobId"=>jobId, "nonce"=>nonce))
AcknowledgeThirdPartyJob(clientToken, jobId, nonce, args::AbstractDict{String, <:Any}) = codepipeline("AcknowledgeThirdPartyJob", Dict{String, Any}("clientToken"=>clientToken, "jobId"=>jobId, "nonce"=>nonce, args...))
...
"""
CreateCustomActionType(category, inputArtifactDetails, outputArtifactDetails, provider, version) = codepipeline("CreateCustomActionType", Dict{String, Any}("category"=>category, "inputArtifactDetails"=>inputArtifactDetails, "outputArtifactDetails"=>outputArtifactDetails, "provider"=>provider, "version"=>version))
CreateCustomActionType(category, inputArtifactDetails, outputArtifactDetails, provider, version, args::AbstractDict{String, <:Any}) = codepipeline("CreateCustomActionType", Dict{String, Any}("category"=>category, "inputArtifactDetails"=>inputArtifactDetails, "outputArtifactDetails"=>outputArtifactDetails, "provider"=>provider, "version"=>version, args...))
...
"""
CreatePipeline(pipeline) = codepipeline("CreatePipeline", Dict{String, Any}("pipeline"=>pipeline))
CreatePipeline(pipeline, args::AbstractDict{String, <:Any}) = codepipeline("CreatePipeline", Dict{String, Any}("pipeline"=>pipeline, args...))
...
"""
DeleteCustomActionType(category, provider, version) = codepipeline("DeleteCustomActionType", Dict{String, Any}("category"=>category, "provider"=>provider, "version"=>version))
DeleteCustomActionType(category, provider, version, args::AbstractDict{String, <:Any}) = codepipeline("DeleteCustomActionType", Dict{String, Any}("category"=>category, "provider"=>provider, "version"=>version, args...))
...
"""
DeletePipeline(name) = codepipeline("DeletePipeline", Dict{String, Any}("name"=>name))
DeletePipeline(name, args::AbstractDict{String, <:Any}) = codepipeline("DeletePipeline", Dict{String, Any}("name"=>name, args...))
...
"""
DeleteWebhook(name) = codepipeline("DeleteWebhook", Dict{String, Any}("name"=>name))
DeleteWebhook(name, args::AbstractDict{String, <:Any}) = codepipeline("DeleteWebhook", Dict{String, Any}("name"=>name, args...))
...
DeregisterWebhookWithThirdParty(args::AbstractDict{String, <:Any}) = codepipeline("DeregisterWebhookWithThirdParty", args)
...
"""
DisableStageTransition(pipelineName, reason, stageName, transitionType) = codepipeline("DisableStageTransition", Dict{String, Any}("pipelineName"=>pipelineName, "reason"=>reason, "stageName"=>stageName, "transitionType"=>transitionType))
DisableStageTransition(pipelineName, reason, stageName, transitionType, args::AbstractDict{String, <:Any}) = codepipeline("DisableStageTransition", Dict{String, Any}("pipelineName"=>pipelineName, "reason"=>reason, "stageName"=>stageName, "transitionType"=>transitionType, args...))
...
"""
EnableStageTransition(pipelineName, stageName, transitionType) = codepipeline("EnableStageTransition", Dict{String, Any}("pipelineName"=>pipelineName, "stageName"=>stageName, "transitionType"=>transitionType))
EnableStageTransition(pipelineName, stageName, transitionType, args::AbstractDict{String, <:Any}) = codepipeline("EnableStageTransition", Dict{String, Any}("pipelineName"=>pipelineName, "stageName"=>stageName, "transitionType"=>transitionType, args...))
...
"""
GetJobDetails(jobId) = codepipeline("GetJobDetails", Dict{String, Any}("jobId"=>jobId))
GetJobDetails(jobId, args::AbstractDict{String, <:Any}) = codepipeline("GetJobDetails", Dict{String, Any}("jobId"=>jobId, args...))
...
"""
GetPipeline(name) = codepipeline("GetPipeline", Dict{String, Any}("name"=>name))
GetPipeline(name, args::AbstractDict{String, <:Any}) = codepipeline("GetPipeline", Dict{String, Any}("name"=>name, args...))
...
"""
GetPipelineExecution(pipelineExecutionId, pipelineName) = codepipeline("GetPipelineExecution", Dict{String, Any}("pipelineExecutionId"=>pipelineExecutionId, "pipelineName"=>pipelineName))
GetPipelineExecution(pipelineExecutionId, pipelineName, args::AbstractDict{String, <:Any}) = codepipeline("GetPipelineExecution", Dict{String, Any}("pipelineExecutionId"=>pipelineExecutionId, "pipelineName"=>pipelineName, args...))
...
"""
GetPipelineState(name) = codepipeline("GetPipelineState", Dict{String, Any}("name"=>name))
GetPipelineState(name, args::AbstractDict{String, <:Any}) = codepipeline("GetPipelineState", Dict{String, Any}("name"=>name, args...))
...
"""
GetThirdPartyJobDetails(clientToken, jobId) = codepipeline("GetThirdPartyJobDetails", Dict{String, Any}("clientToken"=>clientToken, "jobId"=>jobId))
GetThirdPartyJobDetails(clientToken, jobId, args::AbstractDict{String, <:Any}) = codepipeline("GetThirdPartyJobDetails", Dict{String, Any}("clientToken"=>clientToken, "jobId"=>jobId, args...))
...
"""
ListActionExecutions(pipelineName) = codepipeline("ListActionExecutions", Dict{String, Any}("pipelineName"=>pipelineName))
ListActionExecutions(pipelineName, args::AbstractDict{String, <:Any}) = codepipeline("ListActionExecutions", Dict{String, Any}("pipelineName"=>pipelineName, args...))
...
ListActionTypes(args::AbstractDict{String, <:Any}) = codepipeline("ListActionTypes", args)
...
"""
ListPipelineExecutions(pipelineName) = codepipeline("ListPipelineExecutions", Dict{String, Any}("pipelineName"=>pipelineName))
ListPipelineExecutions(pipelineName, args::AbstractDict{String, <:Any}) = codepipeline("ListPipelineExecutions", Dict{String, Any}("pipelineName"=>pipelineName, args...))
...
ListPipelines(args::AbstractDict{String, <:Any}) = codepipeline("ListPipelines", args)
...
"""
ListTagsForResource(resourceArn) = codepipeline("ListTagsForResource", Dict{String, Any}("resourceArn"=>resourceArn))
ListTagsForResource(resourceArn, args::AbstractDict{String, <:Any}) = codepipeline("ListTagsForResource", Dict{String, Any}("resourceArn"=>resourceArn, args...))
...
ListWebhooks(args::AbstractDict{String, <:Any}) = codepipeline("ListWebhooks", args)
...
"""
PollForJobs(actionTypeId) = codepipeline("PollForJobs", Dict{String, Any}("actionTypeId"=>actionTypeId))
PollForJobs(actionTypeId, args::AbstractDict{String, <:Any}) = codepipeline("PollForJobs", Dict{String, Any}("actionTypeId"=>actionTypeId, args...))
...
- `maxBatchSize`: The maximum number of jobs to return in a poll for jobs call.
"""
PollForThirdPartyJobs(actionTypeId) = codepipeline("PollForThirdPartyJobs", Dict{String, Any}("actionTypeId"=>actionTypeId))
PollForThirdPartyJobs(actionTypeId, args::AbstractDict{String, <:Any}) = codepipeline("PollForThirdPartyJobs", Dict{String, Any}("actionTypeId"=>actionTypeId, args...))
...
"""
PutActionRevision(actionName, actionRevision, pipelineName, stageName) = codepipeline("PutActionRevision", Dict{String, Any}("actionName"=>actionName, "actionRevision"=>actionRevision, "pipelineName"=>pipelineName, "stageName"=>stageName))
PutActionRevision(actionName, actionRevision, pipelineName, stageName, args::AbstractDict{String, <:Any}) = codepipeline("PutActionRevision", Dict{String, Any}("actionName"=>actionName, "actionRevision"=>actionRevision, "pipelineName"=>pipelineName, "stageName"=>stageName, args...))
...
"""
PutApprovalResult(actionName, pipelineName, result, stageName, token) = codepipeline("PutApprovalResult", Dict{String, Any}("actionName"=>actionName, "pipelineName"=>pipelineName, "result"=>result, "stageName"=>stageName, "token"=>token))
PutApprovalResult(actionName, pipelineName, result, stageName, token, args::AbstractDict{String, <:Any}) = codepipeline("PutApprovalResult", Dict{String, Any}("actionName"=>actionName, "pipelineName"=>pipelineName, "result"=>result, "stageName"=>stageName, "token"=>token, args...))
...
"""
PutJobFailureResult(failureDetails, jobId) = codepipeline("PutJobFailureResult", Dict{String, Any}("failureDetails"=>failureDetails, "jobId"=>jobId))
PutJobFailureResult(failureDetails, jobId, args::AbstractDict{String, <:Any}) = codepipeline("PutJobFailureResult", Dict{String, Any}("failureDetails"=>failureDetails, "jobId"=>jobId, args...))
...
"""
PutJobSuccessResult(jobId) = codepipeline("PutJobSuccessResult", Dict{String, Any}("jobId"=>jobId))
PutJobSuccessResult(jobId, args::AbstractDict{String, <:Any}) = codepipeline("PutJobSuccessResult", Dict{String, Any}("jobId"=>jobId, args...))
...
"""
PutThirdPartyJobFailureResult(clientToken, failureDetails, jobId) = codepipeline("PutThirdPartyJobFailureResult", Dict{String, Any}("clientToken"=>clientToken, "failureDetails"=>failureDetails, "jobId"=>jobId))
PutThirdPartyJobFailureResult(clientToken, failureDetails, jobId, args::AbstractDict{String, <:Any}) = codepipeline("PutThirdPartyJobFailureResult", Dict{String, Any}("clientToken"=>clientToken, "failureDetails"=>failureDetails, "jobId"=>jobId, args...))
...
"""
PutThirdPartyJobSuccessResult(clientToken, jobId) = codepipeline("PutThirdPartyJobSuccessResult", Dict{String, Any}("clientToken"=>clientToken, "jobId"=>jobId))
PutThirdPartyJobSuccessResult(clientToken, jobId, args::AbstractDict{String, <:Any}) = codepipeline("PutThirdPartyJobSuccessResult", Dict{String, Any}("clientToken"=>clientToken, "jobId"=>jobId, args...))
...
"""
PutWebhook(webhook) = codepipeline("PutWebhook", Dict{String, Any}("webhook"=>webhook))
PutWebhook(webhook, args::AbstractDict{String, <:Any}) = codepipeline("PutWebhook", Dict{String, Any}("webhook"=>webhook, args...))
...
RegisterWebhookWithThirdParty(args::AbstractDict{String, <:Any}) = codepipeline("RegisterWebhookWithThirdParty", args)
...
"""
RetryStageExecution(pipelineExecutionId, pipelineName, retryMode, stageName) = codepipeline("RetryStageExecution", Dict{String, Any}("pipelineExecutionId"=>pipelineExecutionId, "pipelineName"=>pipelineName, "retryMode"=>retryMode, "stageName"=>stageName))
RetryStageExecution(pipelineExecutionId, pipelineName, retryMode, stageName, args::AbstractDict{String, <:Any}) = codepipeline("RetryStageExecution", Dict{String, Any}("pipelineExecutionId"=>pipelineExecutionId, "pipelineName"=>pipelineName, "retryMode"=>retryMode, "stageName"=>stageName, args...))
...
"""
StartPipelineExecution(name) = codepipeline("StartPipelineExecution", Dict{String, Any}("name"=>name, "clientRequestToken"=>string(uuid4())))
StartPipelineExecution(name, args::AbstractDict{String, <:Any}) = codepipeline("StartPipelineExecution", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("name"=>name, "clientRequestToken"=>string(uuid4())), args)))
...
"""
StopPipelineExecution(pipelineExecutionId, pipelineName) = codepipeline("StopPipelineExecution", Dict{String, Any}("pipelineExecutionId"=>pipelineExecutionId, "pipelineName"=>pipelineName))
StopPipelineExecution(pipelineExecutionId, pipelineName, args::AbstractDict{String, <:Any}) = codepipeline("StopPipelineExecution", Dict{String, Any}("pipelineExecutionId"=>pipelineExecutionId, "pipelineName"=>pipelineName, args...))
...
"""
TagResource(resourceArn, tags) = codepipeline("TagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags))
TagResource(resourceArn, tags, args::AbstractDict{String, <:Any}) = codepipeline("TagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags, args...))
...
"""
UntagResource(resourceArn, tagKeys) = codepipeline("UntagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys))
UntagResource(resourceArn, tagKeys, args::AbstractDict{String, <:Any}) = codepipeline("UntagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys, args...))
...
"""
UpdatePipeline(pipeline) = codepipeline("UpdatePipeline", Dict{String, Any}("pipeline"=>pipeline))
UpdatePipeline(pipeline, args::AbstractDict{String, <:Any}) = codepipeline("UpdatePipeline", Dict{String, Any}("pipeline"=>pipeline, args...))
