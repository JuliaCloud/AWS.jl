...
"""
DeleteAlarms(AlarmNames) = cloudwatch("DeleteAlarms", Dict{String, Any}("AlarmNames"=>AlarmNames))
DeleteAlarms(AlarmNames, args::AbstractDict{String, <: Any}) = cloudwatch("DeleteAlarms", Dict{String, Any}("AlarmNames"=>AlarmNames, args...))
...
"""
DeleteAnomalyDetector(MetricName, Namespace, Stat) = cloudwatch("DeleteAnomalyDetector", Dict{String, Any}("MetricName"=>MetricName, "Namespace"=>Namespace, "Stat"=>Stat))
DeleteAnomalyDetector(MetricName, Namespace, Stat, args::AbstractDict{String, <: Any}) = cloudwatch("DeleteAnomalyDetector", Dict{String, Any}("MetricName"=>MetricName, "Namespace"=>Namespace, "Stat"=>Stat, args...))
...
"""
DeleteDashboards(DashboardNames) = cloudwatch("DeleteDashboards", Dict{String, Any}("DashboardNames"=>DashboardNames))
DeleteDashboards(DashboardNames, args::AbstractDict{String, <: Any}) = cloudwatch("DeleteDashboards", Dict{String, Any}("DashboardNames"=>DashboardNames, args...))
...
"""
DeleteInsightRules(RuleNames) = cloudwatch("DeleteInsightRules", Dict{String, Any}("RuleNames"=>RuleNames))
DeleteInsightRules(RuleNames, args::AbstractDict{String, <: Any}) = cloudwatch("DeleteInsightRules", Dict{String, Any}("RuleNames"=>RuleNames, args...))
...
DescribeAlarmHistory(args::AbstractDict{String, <: Any}) = cloudwatch("DescribeAlarmHistory", args)
...
DescribeAlarms(args::AbstractDict{String, <: Any}) = cloudwatch("DescribeAlarms", args)
...
"""
DescribeAlarmsForMetric(MetricName, Namespace) = cloudwatch("DescribeAlarmsForMetric", Dict{String, Any}("MetricName"=>MetricName, "Namespace"=>Namespace))
DescribeAlarmsForMetric(MetricName, Namespace, args::AbstractDict{String, <: Any}) = cloudwatch("DescribeAlarmsForMetric", Dict{String, Any}("MetricName"=>MetricName, "Namespace"=>Namespace, args...))
...
DescribeAnomalyDetectors(args::AbstractDict{String, <: Any}) = cloudwatch("DescribeAnomalyDetectors", args)
...
DescribeInsightRules(args::AbstractDict{String, <: Any}) = cloudwatch("DescribeInsightRules", args)
...
"""
DisableAlarmActions(AlarmNames) = cloudwatch("DisableAlarmActions", Dict{String, Any}("AlarmNames"=>AlarmNames))
DisableAlarmActions(AlarmNames, args::AbstractDict{String, <: Any}) = cloudwatch("DisableAlarmActions", Dict{String, Any}("AlarmNames"=>AlarmNames, args...))
...
"""
DisableInsightRules(RuleNames) = cloudwatch("DisableInsightRules", Dict{String, Any}("RuleNames"=>RuleNames))
DisableInsightRules(RuleNames, args::AbstractDict{String, <: Any}) = cloudwatch("DisableInsightRules", Dict{String, Any}("RuleNames"=>RuleNames, args...))
...
"""
EnableAlarmActions(AlarmNames) = cloudwatch("EnableAlarmActions", Dict{String, Any}("AlarmNames"=>AlarmNames))
EnableAlarmActions(AlarmNames, args::AbstractDict{String, <: Any}) = cloudwatch("EnableAlarmActions", Dict{String, Any}("AlarmNames"=>AlarmNames, args...))
...
"""
EnableInsightRules(RuleNames) = cloudwatch("EnableInsightRules", Dict{String, Any}("RuleNames"=>RuleNames))
EnableInsightRules(RuleNames, args::AbstractDict{String, <: Any}) = cloudwatch("EnableInsightRules", Dict{String, Any}("RuleNames"=>RuleNames, args...))
...
"""
GetDashboard(DashboardName) = cloudwatch("GetDashboard", Dict{String, Any}("DashboardName"=>DashboardName))
GetDashboard(DashboardName, args::AbstractDict{String, <: Any}) = cloudwatch("GetDashboard", Dict{String, Any}("DashboardName"=>DashboardName, args...))
...
"""
GetInsightRuleReport(EndTime, Period, RuleName, StartTime) = cloudwatch("GetInsightRuleReport", Dict{String, Any}("EndTime"=>EndTime, "Period"=>Period, "RuleName"=>RuleName, "StartTime"=>StartTime))
GetInsightRuleReport(EndTime, Period, RuleName, StartTime, args::AbstractDict{String, <: Any}) = cloudwatch("GetInsightRuleReport", Dict{String, Any}("EndTime"=>EndTime, "Period"=>Period, "RuleName"=>RuleName, "StartTime"=>StartTime, args...))
...
"""
GetMetricData(EndTime, MetricDataQueries, StartTime) = cloudwatch("GetMetricData", Dict{String, Any}("EndTime"=>EndTime, "MetricDataQueries"=>MetricDataQueries, "StartTime"=>StartTime))
GetMetricData(EndTime, MetricDataQueries, StartTime, args::AbstractDict{String, <: Any}) = cloudwatch("GetMetricData", Dict{String, Any}("EndTime"=>EndTime, "MetricDataQueries"=>MetricDataQueries, "StartTime"=>StartTime, args...))
...
"""
GetMetricStatistics(EndTime, MetricName, Namespace, Period, StartTime) = cloudwatch("GetMetricStatistics", Dict{String, Any}("EndTime"=>EndTime, "MetricName"=>MetricName, "Namespace"=>Namespace, "Period"=>Period, "StartTime"=>StartTime))
GetMetricStatistics(EndTime, MetricName, Namespace, Period, StartTime, args::AbstractDict{String, <: Any}) = cloudwatch("GetMetricStatistics", Dict{String, Any}("EndTime"=>EndTime, "MetricName"=>MetricName, "Namespace"=>Namespace, "Period"=>Period, "StartTime"=>StartTime, args...))
...
"""
GetMetricWidgetImage(MetricWidget) = cloudwatch("GetMetricWidgetImage", Dict{String, Any}("MetricWidget"=>MetricWidget))
GetMetricWidgetImage(MetricWidget, args::AbstractDict{String, <: Any}) = cloudwatch("GetMetricWidgetImage", Dict{String, Any}("MetricWidget"=>MetricWidget, args...))
...
ListDashboards(args::AbstractDict{String, <: Any}) = cloudwatch("ListDashboards", args)
...
ListMetrics(args::AbstractDict{String, <: Any}) = cloudwatch("ListMetrics", args)
...
Required Parameters
ResourceARN => The ARN of the CloudWatch resource that you want to view tags for. The ARN format of an alarm is arn:aws:cloudwatch:Region:account-id:alarm:alarm-name   The ARN format of a Contributor Insights rule is arn:aws:cloudwatch:Region:account-id:insight-rule:insight-rule-name   For more information on ARN format, see  Resource Types Defined by Amazon CloudWatch in the Amazon Web Services General Reference.

"""
ListTagsForResource(ResourceARN) = cloudwatch("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN))
ListTagsForResource(ResourceARN, args::AbstractDict{String, <: Any}) = cloudwatch("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN, args...))
...
"""
PutAnomalyDetector(MetricName, Namespace, Stat) = cloudwatch("PutAnomalyDetector", Dict{String, Any}("MetricName"=>MetricName, "Namespace"=>Namespace, "Stat"=>Stat))
PutAnomalyDetector(MetricName, Namespace, Stat, args::AbstractDict{String, <: Any}) = cloudwatch("PutAnomalyDetector", Dict{String, Any}("MetricName"=>MetricName, "Namespace"=>Namespace, "Stat"=>Stat, args...))
...
"""
PutCompositeAlarm(AlarmName, AlarmRule) = cloudwatch("PutCompositeAlarm", Dict{String, Any}("AlarmName"=>AlarmName, "AlarmRule"=>AlarmRule))
PutCompositeAlarm(AlarmName, AlarmRule, args::AbstractDict{String, <: Any}) = cloudwatch("PutCompositeAlarm", Dict{String, Any}("AlarmName"=>AlarmName, "AlarmRule"=>AlarmRule, args...))
...
"""
PutDashboard(DashboardBody, DashboardName) = cloudwatch("PutDashboard", Dict{String, Any}("DashboardBody"=>DashboardBody, "DashboardName"=>DashboardName))
PutDashboard(DashboardBody, DashboardName, args::AbstractDict{String, <: Any}) = cloudwatch("PutDashboard", Dict{String, Any}("DashboardBody"=>DashboardBody, "DashboardName"=>DashboardName, args...))
...
"""
PutInsightRule(RuleDefinition, RuleName) = cloudwatch("PutInsightRule", Dict{String, Any}("RuleDefinition"=>RuleDefinition, "RuleName"=>RuleName))
PutInsightRule(RuleDefinition, RuleName, args::AbstractDict{String, <: Any}) = cloudwatch("PutInsightRule", Dict{String, Any}("RuleDefinition"=>RuleDefinition, "RuleName"=>RuleName, args...))
...
"""
PutMetricAlarm(AlarmName, ComparisonOperator, EvaluationPeriods) = cloudwatch("PutMetricAlarm", Dict{String, Any}("AlarmName"=>AlarmName, "ComparisonOperator"=>ComparisonOperator, "EvaluationPeriods"=>EvaluationPeriods))
PutMetricAlarm(AlarmName, ComparisonOperator, EvaluationPeriods, args::AbstractDict{String, <: Any}) = cloudwatch("PutMetricAlarm", Dict{String, Any}("AlarmName"=>AlarmName, "ComparisonOperator"=>ComparisonOperator, "EvaluationPeriods"=>EvaluationPeriods, args...))
...
"""
PutMetricData(MetricData, Namespace) = cloudwatch("PutMetricData", Dict{String, Any}("MetricData"=>MetricData, "Namespace"=>Namespace))
PutMetricData(MetricData, Namespace, args::AbstractDict{String, <: Any}) = cloudwatch("PutMetricData", Dict{String, Any}("MetricData"=>MetricData, "Namespace"=>Namespace, args...))
...
"""
SetAlarmState(AlarmName, StateReason, StateValue) = cloudwatch("SetAlarmState", Dict{String, Any}("AlarmName"=>AlarmName, "StateReason"=>StateReason, "StateValue"=>StateValue))
SetAlarmState(AlarmName, StateReason, StateValue, args::AbstractDict{String, <: Any}) = cloudwatch("SetAlarmState", Dict{String, Any}("AlarmName"=>AlarmName, "StateReason"=>StateReason, "StateValue"=>StateValue, args...))
...
Required Parameters
ResourceARN => The ARN of the CloudWatch resource that you're adding tags to. The ARN format of an alarm is arn:aws:cloudwatch:Region:account-id:alarm:alarm-name   The ARN format of a Contributor Insights rule is arn:aws:cloudwatch:Region:account-id:insight-rule:insight-rule-name   For more information on ARN format, see  Resource Types Defined by Amazon CloudWatch in the Amazon Web Services General Reference.
Tags => The list of key-value pairs to associate with the alarm.

"""
TagResource(ResourceARN, Tags) = cloudwatch("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags))
TagResource(ResourceARN, Tags, args::AbstractDict{String, <: Any}) = cloudwatch("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags, args...))
...
Required Parameters
ResourceARN => The ARN of the CloudWatch resource that you're removing tags from. The ARN format of an alarm is arn:aws:cloudwatch:Region:account-id:alarm:alarm-name   The ARN format of a Contributor Insights rule is arn:aws:cloudwatch:Region:account-id:insight-rule:insight-rule-name   For more information on ARN format, see  Resource Types Defined by Amazon CloudWatch in the Amazon Web Services General Reference.
TagKeys => The list of tag keys to remove from the resource.

"""
UntagResource(ResourceARN, TagKeys) = cloudwatch("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys))
UntagResource(ResourceARN, TagKeys, args::AbstractDict{String, <: Any}) = cloudwatch("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys, args...))
