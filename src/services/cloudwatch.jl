...
"""
function disable_insight_rules(RuleNames; aws_config::AbstractAWSConfig=current_aws_config())
    return cloudwatch(
        "DisableInsightRules",
        Dict{String,Any}("RuleNames" => RuleNames);
        aws_config=aws_config,
...
"""
function enable_alarm_actions(AlarmNames; aws_config::AbstractAWSConfig=current_aws_config())
    return cloudwatch(
        "EnableAlarmActions",
        Dict{String,Any}("AlarmNames" => AlarmNames);
        aws_config=aws_config,
...
function get_metric_data(
    EndTime, MetricDataQueries, StartTime; aws_config::AbstractAWSConfig=current_aws_config()
)
    return cloudwatch(
        "GetMetricData",
        Dict{String,Any}(
