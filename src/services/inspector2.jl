...
"""
function cancel_findings_report(reportId; aws_config::AbstractAWSConfig=current_aws_config())
    return inspector2(
        "POST",
        "/reporting/cancel",
...
function get_cis_scan_report(
    scanArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return inspector2(
        "POST",
        "/cis/scan/report/get",
