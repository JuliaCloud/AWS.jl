...
function delete_alias(
    AliasId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return gamelift(
        "DeleteAlias",
...
function delete_build(
    BuildId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return gamelift(
        "DeleteBuild",
...
- `"NextToken"`: A token that indicates the start of the next sequential page of results.
  ...
  beginning of the result set, do not specify a value.
"""
function describe_matchmaking_rule_sets(; aws_config::AbstractAWSConfig=current_aws_config())
    return gamelift(
