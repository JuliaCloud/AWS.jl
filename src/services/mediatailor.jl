...
- `playback_mode`: The type of playback mode to use for this channel.
  ...
  program in the schedule stops playing, playback loops back to the first program in the
  schedule.
...
function delete_channel(ChannelName; aws_config::AbstractAWSConfig=current_aws_config())
    return mediatailor(
        "DELETE", "/channel/$(ChannelName)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_channel(ChannelName; aws_config::AbstractAWSConfig=current_aws_config())
    return mediatailor(
        "GET", "/channel/$(ChannelName)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_channel_policy(ChannelName; aws_config::AbstractAWSConfig=current_aws_config())
    return mediatailor(
        "GET", "/channel/$(ChannelName)/policy"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_playback_configuration(
    ...
    return mediatailor(
        "GET", "/playbackConfiguration/$(Name)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_channels(; aws_config::AbstractAWSConfig=current_aws_config())
    return mediatailor("GET", "/channels"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"MaxResults"`: The maximum number of playback configurations that you want MediaTailor to
...
function list_playback_configurations(; aws_config::AbstractAWSConfig=current_aws_config())
    return mediatailor(
        "GET", "/playbackConfigurations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_source_locations(; aws_config::AbstractAWSConfig=current_aws_config())
    return mediatailor(
        "GET", "/sourceLocations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_source_locations(
    ...
    return mediatailor(
        "GET", "/sourceLocations", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"InsertionMode"`: The setting that controls whether players can use stitched or guided ad
  insertion. The default, `STITCHED_ONLY`, forces all player sessions to use stitched
...
function start_channel(ChannelName; aws_config::AbstractAWSConfig=current_aws_config())
    return mediatailor(
        "PUT", "/channel/$(ChannelName)/start"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function stop_channel(ChannelName; aws_config::AbstractAWSConfig=current_aws_config())
    return mediatailor(
        "PUT", "/channel/$(ChannelName)/stop"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `http_package_configurations`: A list of HTTP package configurations for the VOD source on
  this account.
- `source_location_name`: The name of the source location associated with this VOD Source.
- `vod_source_name`: The name of the VOD source.
"""
