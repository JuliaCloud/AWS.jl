...
DescribeRootFolders(Authentication, args::AbstractDict{String, <: Any}) = workdocs("GET", "/api/v1/me/root", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("Authentication"=>Authentication)), args...)))
...
GetCurrentUser(Authentication, args::AbstractDict{String, <: Any}) = workdocs("GET", "/api/v1/me", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("Authentication"=>Authentication)), args...)))
