...
DescribeReportCreation(; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("DescribeReportCreation"; aws_config=aws_config)
DescribeReportCreation(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("DescribeReportCreation", args; aws_config=aws_config)
...
GetComplianceSummary(; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("GetComplianceSummary"; aws_config=aws_config)
GetComplianceSummary(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("GetComplianceSummary", args; aws_config=aws_config)
...
GetResources(; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("GetResources"; aws_config=aws_config)
GetResources(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("GetResources", args; aws_config=aws_config)
...
GetTagKeys(; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("GetTagKeys"; aws_config=aws_config)
GetTagKeys(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("GetTagKeys", args; aws_config=aws_config)
...
GetTagValues(Key; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("GetTagValues", Dict{String, Any}("Key"=>Key); aws_config=aws_config)
GetTagValues(Key, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("GetTagValues", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Key"=>Key), args)); aws_config=aws_config)
...
StartReportCreation(S3Bucket; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("StartReportCreation", Dict{String, Any}("S3Bucket"=>S3Bucket); aws_config=aws_config)
StartReportCreation(S3Bucket, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("StartReportCreation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("S3Bucket"=>S3Bucket), args)); aws_config=aws_config)
...
TagResources(ResourceARNList, Tags; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("TagResources", Dict{String, Any}("ResourceARNList"=>ResourceARNList, "Tags"=>Tags); aws_config=aws_config)
TagResources(ResourceARNList, Tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("TagResources", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARNList"=>ResourceARNList, "Tags"=>Tags), args)); aws_config=aws_config)
...
UntagResources(ResourceARNList, TagKeys; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("UntagResources", Dict{String, Any}("ResourceARNList"=>ResourceARNList, "TagKeys"=>TagKeys); aws_config=aws_config)
UntagResources(ResourceARNList, TagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = resource_groups_tagging_api("UntagResources", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARNList"=>ResourceARNList, "TagKeys"=>TagKeys), args)); aws_config=aws_config)
