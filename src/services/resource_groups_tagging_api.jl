...
DescribeReportCreation(args::AbstractDict{String, <:Any}) = resource_groups_tagging_api("DescribeReportCreation", args)
...
GetComplianceSummary(args::AbstractDict{String, <:Any}) = resource_groups_tagging_api("GetComplianceSummary", args)
...
GetResources(args::AbstractDict{String, <:Any}) = resource_groups_tagging_api("GetResources", args)
...
GetTagKeys(args::AbstractDict{String, <:Any}) = resource_groups_tagging_api("GetTagKeys", args)
...
- `PaginationToken`: A string that indicates that additional data is available. Leave this value empty for your initial request. If the response includes a PaginationToken, use that string for this value to request an additional page of data.
"""
GetTagValues(Key) = resource_groups_tagging_api("GetTagValues", Dict{String, Any}("Key"=>Key))
GetTagValues(Key, args::AbstractDict{String, <:Any}) = resource_groups_tagging_api("GetTagValues", Dict{String, Any}("Key"=>Key, args...))
...
"""
StartReportCreation(S3Bucket) = resource_groups_tagging_api("StartReportCreation", Dict{String, Any}("S3Bucket"=>S3Bucket))
StartReportCreation(S3Bucket, args::AbstractDict{String, <:Any}) = resource_groups_tagging_api("StartReportCreation", Dict{String, Any}("S3Bucket"=>S3Bucket, args...))
...
"""
TagResources(ResourceARNList, Tags) = resource_groups_tagging_api("TagResources", Dict{String, Any}("ResourceARNList"=>ResourceARNList, "Tags"=>Tags))
TagResources(ResourceARNList, Tags, args::AbstractDict{String, <:Any}) = resource_groups_tagging_api("TagResources", Dict{String, Any}("ResourceARNList"=>ResourceARNList, "Tags"=>Tags, args...))
...
"""
UntagResources(ResourceARNList, TagKeys) = resource_groups_tagging_api("UntagResources", Dict{String, Any}("ResourceARNList"=>ResourceARNList, "TagKeys"=>TagKeys))
UntagResources(ResourceARNList, TagKeys, args::AbstractDict{String, <:Any}) = resource_groups_tagging_api("UntagResources", Dict{String, Any}("ResourceARNList"=>ResourceARNList, "TagKeys"=>TagKeys, args...))
