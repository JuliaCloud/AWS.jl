...
"""
DescribeReportCreation(; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("DescribeReportCreation"; aws=aws)
DescribeReportCreation(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("DescribeReportCreation", args; aws=aws)
...
"""
GetComplianceSummary(; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("GetComplianceSummary"; aws=aws)
GetComplianceSummary(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("GetComplianceSummary", args; aws=aws)
...
"""
GetResources(; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("GetResources"; aws=aws)
GetResources(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("GetResources", args; aws=aws)
...
- `PaginationToken`: A string that indicates that additional data is available. Leave this value empty for your initial request. If the response includes a PaginationToken, use that string for this value to request an additional page of data.
"""
GetTagKeys(; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("GetTagKeys"; aws=aws)
GetTagKeys(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("GetTagKeys", args; aws=aws)
...
- `PaginationToken`: A string that indicates that additional data is available. Leave this value empty for your initial request. If the response includes a PaginationToken, use that string for this value to request an additional page of data.
"""
GetTagValues(Key; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("GetTagValues", Dict{String, Any}("Key"=>Key); aws=aws)
GetTagValues(Key, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("GetTagValues", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Key"=>Key), args)); aws=aws)
...
"""
StartReportCreation(S3Bucket; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("StartReportCreation", Dict{String, Any}("S3Bucket"=>S3Bucket); aws=aws)
StartReportCreation(S3Bucket, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("StartReportCreation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("S3Bucket"=>S3Bucket), args)); aws=aws)
...
"""
TagResources(ResourceARNList, Tags; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("TagResources", Dict{String, Any}("ResourceARNList"=>ResourceARNList, "Tags"=>Tags); aws=aws)
TagResources(ResourceARNList, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("TagResources", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARNList"=>ResourceARNList, "Tags"=>Tags), args)); aws=aws)
...
"""
UntagResources(ResourceARNList, TagKeys; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("UntagResources", Dict{String, Any}("ResourceARNList"=>ResourceARNList, "TagKeys"=>TagKeys); aws=aws)
UntagResources(ResourceARNList, TagKeys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = resource_groups_tagging_api("UntagResources", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARNList"=>ResourceARNList, "TagKeys"=>TagKeys), args)); aws=aws)
