...
"""
delete_qapp(appId, instance_id; aws_config::AbstractAWSConfig=current_aws_config()) = qapps(
    "POST",
    "/apps.delete",
    Dict{String,Any}(
        "appId" => appId, "headers" => Dict{String,Any}("instance-id" => instance_id)
...
"""
get_qapp(appId, instance_id; aws_config::AbstractAWSConfig=current_aws_config()) = qapps(
    "GET",
    "/apps.get",
    Dict{String,Any}(
        "appId" => appId, "headers" => Dict{String,Any}("instance-id" => instance_id)
...
"""
list_library_items(instance_id; aws_config::AbstractAWSConfig=current_aws_config()) = qapps(
    "GET",
    "/catalog.list",
...
- `"nextToken"`: The token to request the next page of results.
"""
list_qapps(instance_id; aws_config::AbstractAWSConfig=current_aws_config()) = qapps(
    "GET",
    "/apps.list",
    Dict{String,Any}("headers" => Dict{String,Any}("instance-id" => instance_id));
    aws_config=aws_config,
...
- `"options"`: The input to generate the Q App definition from, either a conversation or
  problem statement.
"""
predict_qapp(instance_id; aws_config::AbstractAWSConfig=current_aws_config()) = qapps(
    "POST",
    "/apps.predictQApp",
    Dict{String,Any}("headers" => Dict{String,Any}("instance-id" => instance_id));
    aws_config=aws_config,
...
"""
tag_resource(resourceARN, tags; aws_config::AbstractAWSConfig=current_aws_config()) = qapps(
    "POST",
    "/tags/$(resourceARN)",
...
"""
update_qapp(appId, instance_id; aws_config::AbstractAWSConfig=current_aws_config()) = qapps(
    "POST",
    "/apps.update",
    Dict{String,Any}(
        "appId" => appId, "headers" => Dict{String,Any}("instance-id" => instance_id)
