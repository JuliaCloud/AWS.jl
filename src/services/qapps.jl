...
"""
function delete_qapp(appId, instance_id; aws_config::AbstractAWSConfig=global_aws_config())
    return qapps(
        "POST",
        "/apps.delete",
        Dict{String,Any}(
...
"""
function get_qapp(appId, instance_id; aws_config::AbstractAWSConfig=global_aws_config())
    return qapps(
        "GET",
        "/apps.get",
        Dict{String,Any}(
...
"""
function list_library_items(instance_id; aws_config::AbstractAWSConfig=global_aws_config())
    return qapps(
        "GET",
        "/catalog.list",
...
- `"nextToken"`: The token to request the next page of results.
"""
function list_qapps(instance_id; aws_config::AbstractAWSConfig=global_aws_config())
    return qapps(
        "GET",
        "/apps.list",
        Dict{String,Any}("headers" => Dict{String,Any}("instance-id" => instance_id));
...
- `"options"`: The input to generate the Q App definition from, either a conversation or
  problem statement.
"""
function predict_qapp(instance_id; aws_config::AbstractAWSConfig=global_aws_config())
    return qapps(
        "POST",
        "/apps.predictQApp",
        Dict{String,Any}("headers" => Dict{String,Any}("instance-id" => instance_id));
...
"""
function update_qapp(appId, instance_id; aws_config::AbstractAWSConfig=global_aws_config())
    return qapps(
        "POST",
        "/apps.update",
        Dict{String,Any}(
