...
AssociateNode(EngineAttributes, NodeName, ServerName; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("AssociateNode", Dict{String, Any}("EngineAttributes"=>EngineAttributes, "NodeName"=>NodeName, "ServerName"=>ServerName); aws_config=aws_config)
AssociateNode(EngineAttributes, NodeName, ServerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("AssociateNode", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EngineAttributes"=>EngineAttributes, "NodeName"=>NodeName, "ServerName"=>ServerName), args)); aws_config=aws_config)
...
CreateBackup(ServerName; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("CreateBackup", Dict{String, Any}("ServerName"=>ServerName); aws_config=aws_config)
CreateBackup(ServerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("CreateBackup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ServerName"=>ServerName), args)); aws_config=aws_config)
...
CreateServer(Engine, InstanceProfileArn, InstanceType, ServerName, ServiceRoleArn; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("CreateServer", Dict{String, Any}("Engine"=>Engine, "InstanceProfileArn"=>InstanceProfileArn, "InstanceType"=>InstanceType, "ServerName"=>ServerName, "ServiceRoleArn"=>ServiceRoleArn); aws_config=aws_config)
CreateServer(Engine, InstanceProfileArn, InstanceType, ServerName, ServiceRoleArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("CreateServer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Engine"=>Engine, "InstanceProfileArn"=>InstanceProfileArn, "InstanceType"=>InstanceType, "ServerName"=>ServerName, "ServiceRoleArn"=>ServiceRoleArn), args)); aws_config=aws_config)
...
DeleteBackup(BackupId; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DeleteBackup", Dict{String, Any}("BackupId"=>BackupId); aws_config=aws_config)
DeleteBackup(BackupId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DeleteBackup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BackupId"=>BackupId), args)); aws_config=aws_config)
...
DeleteServer(ServerName; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DeleteServer", Dict{String, Any}("ServerName"=>ServerName); aws_config=aws_config)
DeleteServer(ServerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DeleteServer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ServerName"=>ServerName), args)); aws_config=aws_config)
...
DescribeAccountAttributes(; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DescribeAccountAttributes"; aws_config=aws_config)
DescribeAccountAttributes(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DescribeAccountAttributes", args; aws_config=aws_config)
...
DescribeBackups(; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DescribeBackups"; aws_config=aws_config)
DescribeBackups(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DescribeBackups", args; aws_config=aws_config)
...
DescribeEvents(ServerName; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DescribeEvents", Dict{String, Any}("ServerName"=>ServerName); aws_config=aws_config)
DescribeEvents(ServerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DescribeEvents", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ServerName"=>ServerName), args)); aws_config=aws_config)
...
DescribeNodeAssociationStatus(NodeAssociationStatusToken, ServerName; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DescribeNodeAssociationStatus", Dict{String, Any}("NodeAssociationStatusToken"=>NodeAssociationStatusToken, "ServerName"=>ServerName); aws_config=aws_config)
DescribeNodeAssociationStatus(NodeAssociationStatusToken, ServerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DescribeNodeAssociationStatus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("NodeAssociationStatusToken"=>NodeAssociationStatusToken, "ServerName"=>ServerName), args)); aws_config=aws_config)
...
DescribeServers(; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DescribeServers"; aws_config=aws_config)
DescribeServers(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DescribeServers", args; aws_config=aws_config)
...
DisassociateNode(NodeName, ServerName; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DisassociateNode", Dict{String, Any}("NodeName"=>NodeName, "ServerName"=>ServerName); aws_config=aws_config)
DisassociateNode(NodeName, ServerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("DisassociateNode", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("NodeName"=>NodeName, "ServerName"=>ServerName), args)); aws_config=aws_config)
...
ExportServerEngineAttribute(ExportAttributeName, ServerName; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("ExportServerEngineAttribute", Dict{String, Any}("ExportAttributeName"=>ExportAttributeName, "ServerName"=>ServerName); aws_config=aws_config)
ExportServerEngineAttribute(ExportAttributeName, ServerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("ExportServerEngineAttribute", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ExportAttributeName"=>ExportAttributeName, "ServerName"=>ServerName), args)); aws_config=aws_config)
...
ListTagsForResource(ResourceArn; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config)
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), args)); aws_config=aws_config)
...
RestoreServer(BackupId, ServerName; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("RestoreServer", Dict{String, Any}("BackupId"=>BackupId, "ServerName"=>ServerName); aws_config=aws_config)
RestoreServer(BackupId, ServerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("RestoreServer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BackupId"=>BackupId, "ServerName"=>ServerName), args)); aws_config=aws_config)
...
StartMaintenance(ServerName; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("StartMaintenance", Dict{String, Any}("ServerName"=>ServerName); aws_config=aws_config)
StartMaintenance(ServerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("StartMaintenance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ServerName"=>ServerName), args)); aws_config=aws_config)
...
TagResource(ResourceArn, Tags; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags); aws_config=aws_config)
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags), args)); aws_config=aws_config)
...
UntagResource(ResourceArn, TagKeys; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys); aws_config=aws_config)
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), args)); aws_config=aws_config)
...
UpdateServer(ServerName; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("UpdateServer", Dict{String, Any}("ServerName"=>ServerName); aws_config=aws_config)
UpdateServer(ServerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("UpdateServer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ServerName"=>ServerName), args)); aws_config=aws_config)
...
UpdateServerEngineAttributes(AttributeName, ServerName; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("UpdateServerEngineAttributes", Dict{String, Any}("AttributeName"=>AttributeName, "ServerName"=>ServerName); aws_config=aws_config)
UpdateServerEngineAttributes(AttributeName, ServerName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworkscm("UpdateServerEngineAttributes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AttributeName"=>AttributeName, "ServerName"=>ServerName), args)); aws_config=aws_config)
