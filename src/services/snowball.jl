...
# Required Parameters
- `ClusterId`: The 39-character ID for the cluster that you want to cancel, for example
...
# Required Parameters
- `JobId`: The 39-character job ID for the job that you want to cancel, for example
...
- `JobType`: The type of job for this cluster. Currently, the only job type supported for
...
- `ShippingOption`: The shipping speed for each node in this cluster. This speed doesn't
...
- `KmsKeyARN`: The KmsKeyARN value that you want to associate with this cluster. KmsKeyARN
  values are created by using the CreateKey API action in AWS Key Management Service (AWS
  KMS).
- `Notification`: The Amazon Simple Notification Service (Amazon SNS) notification settings
  for this cluster.
- `SnowballType`: The type of AWS Snow Family device to use for this cluster.   For cluster
  jobs, AWS Snow Family currently supports only the EDGE device type.
...
# Required Parameters
- `JobId`: The ID for a job that you want to create the return shipping label for. For
  example JID123e4567-e89b-12d3-a456-426655440000.

# Optional Parameters
- `ShippingOption`: The shipping speed for a particular job. This speed doesn't dictate how
  soon the device is returned to AWS. This speed represents how quickly it moves to its
...
# Required Parameters
- `JobId`: The ID for a job that you want to get the manifest file for, for example
  JID123e4567-e89b-12d3-a456-426655440000.
...
# Required Parameters
- `JobId`: The ID for a job that you want to get the software update file for, for example
  JID123e4567-e89b-12d3-a456-426655440000.
...
# Required Parameters
- `ClusterId`: The 39-character ID for the cluster that you want to list, for example
  CID123e4567-e89b-12d3-a456-426655440000.
...
# Optional Parameters
- `MaxResults`: The maximum number of results for the list of compatible images. Currently,
...
- `ForwardingAddressId`: The updated ID for the forwarding address for a job. This field is
...
- `JobId`: The job ID of the job whose shipment date you want to update, for example
  JID123e4567-e89b-12d3-a456-426655440000.
- `ShipmentState`: The state of a device when it is being shipped.  Set to RECEIVED when
