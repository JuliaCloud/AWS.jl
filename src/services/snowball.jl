...
"""
CancelCluster(ClusterId) = snowball("CancelCluster", Dict{String, Any}("ClusterId"=>ClusterId))
CancelCluster(ClusterId, args::AbstractDict{String, <:Any}) = snowball("CancelCluster", Dict{String, Any}("ClusterId"=>ClusterId, args...))
...
"""
CancelJob(JobId) = snowball("CancelJob", Dict{String, Any}("JobId"=>JobId))
CancelJob(JobId, args::AbstractDict{String, <:Any}) = snowball("CancelJob", Dict{String, Any}("JobId"=>JobId, args...))
...
"""
CreateAddress(Address) = snowball("CreateAddress", Dict{String, Any}("Address"=>Address))
CreateAddress(Address, args::AbstractDict{String, <:Any}) = snowball("CreateAddress", Dict{String, Any}("Address"=>Address, args...))
...
"""
CreateCluster(AddressId, JobType, Resources, RoleARN, ShippingOption) = snowball("CreateCluster", Dict{String, Any}("AddressId"=>AddressId, "JobType"=>JobType, "Resources"=>Resources, "RoleARN"=>RoleARN, "ShippingOption"=>ShippingOption))
CreateCluster(AddressId, JobType, Resources, RoleARN, ShippingOption, args::AbstractDict{String, <:Any}) = snowball("CreateCluster", Dict{String, Any}("AddressId"=>AddressId, "JobType"=>JobType, "Resources"=>Resources, "RoleARN"=>RoleARN, "ShippingOption"=>ShippingOption, args...))
...
CreateJob(args::AbstractDict{String, <:Any}) = snowball("CreateJob", args)
...
"""
DescribeAddress(AddressId) = snowball("DescribeAddress", Dict{String, Any}("AddressId"=>AddressId))
DescribeAddress(AddressId, args::AbstractDict{String, <:Any}) = snowball("DescribeAddress", Dict{String, Any}("AddressId"=>AddressId, args...))
...
DescribeAddresses(args::AbstractDict{String, <:Any}) = snowball("DescribeAddresses", args)
...
"""
DescribeCluster(ClusterId) = snowball("DescribeCluster", Dict{String, Any}("ClusterId"=>ClusterId))
DescribeCluster(ClusterId, args::AbstractDict{String, <:Any}) = snowball("DescribeCluster", Dict{String, Any}("ClusterId"=>ClusterId, args...))
...
"""
DescribeJob(JobId) = snowball("DescribeJob", Dict{String, Any}("JobId"=>JobId))
DescribeJob(JobId, args::AbstractDict{String, <:Any}) = snowball("DescribeJob", Dict{String, Any}("JobId"=>JobId, args...))
...
"""
GetJobManifest(JobId) = snowball("GetJobManifest", Dict{String, Any}("JobId"=>JobId))
GetJobManifest(JobId, args::AbstractDict{String, <:Any}) = snowball("GetJobManifest", Dict{String, Any}("JobId"=>JobId, args...))
...
"""
GetJobUnlockCode(JobId) = snowball("GetJobUnlockCode", Dict{String, Any}("JobId"=>JobId))
GetJobUnlockCode(JobId, args::AbstractDict{String, <:Any}) = snowball("GetJobUnlockCode", Dict{String, Any}("JobId"=>JobId, args...))
...
GetSnowballUsage(args::AbstractDict{String, <:Any}) = snowball("GetSnowballUsage", args)
...
"""
GetSoftwareUpdates(JobId) = snowball("GetSoftwareUpdates", Dict{String, Any}("JobId"=>JobId))
GetSoftwareUpdates(JobId, args::AbstractDict{String, <:Any}) = snowball("GetSoftwareUpdates", Dict{String, Any}("JobId"=>JobId, args...))
...
"""
ListClusterJobs(ClusterId) = snowball("ListClusterJobs", Dict{String, Any}("ClusterId"=>ClusterId))
ListClusterJobs(ClusterId, args::AbstractDict{String, <:Any}) = snowball("ListClusterJobs", Dict{String, Any}("ClusterId"=>ClusterId, args...))
...
ListClusters(args::AbstractDict{String, <:Any}) = snowball("ListClusters", args)
...
ListCompatibleImages(args::AbstractDict{String, <:Any}) = snowball("ListCompatibleImages", args)
...
ListJobs(args::AbstractDict{String, <:Any}) = snowball("ListJobs", args)
...
"""
UpdateCluster(ClusterId) = snowball("UpdateCluster", Dict{String, Any}("ClusterId"=>ClusterId))
UpdateCluster(ClusterId, args::AbstractDict{String, <:Any}) = snowball("UpdateCluster", Dict{String, Any}("ClusterId"=>ClusterId, args...))
...
"""
UpdateJob(JobId) = snowball("UpdateJob", Dict{String, Any}("JobId"=>JobId))
UpdateJob(JobId, args::AbstractDict{String, <:Any}) = snowball("UpdateJob", Dict{String, Any}("JobId"=>JobId, args...))
