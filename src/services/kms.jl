...
"""
CancelKeyDeletion(KeyId) = kms("CancelKeyDeletion", Dict{String, Any}("KeyId"=>KeyId))
CancelKeyDeletion(KeyId, args::AbstractDict{String, <:Any}) = kms("CancelKeyDeletion", Dict{String, Any}("KeyId"=>KeyId, args...))
...
"""
ConnectCustomKeyStore(CustomKeyStoreId) = kms("ConnectCustomKeyStore", Dict{String, Any}("CustomKeyStoreId"=>CustomKeyStoreId))
ConnectCustomKeyStore(CustomKeyStoreId, args::AbstractDict{String, <:Any}) = kms("ConnectCustomKeyStore", Dict{String, Any}("CustomKeyStoreId"=>CustomKeyStoreId, args...))
...
"""
CreateAlias(AliasName, TargetKeyId) = kms("CreateAlias", Dict{String, Any}("AliasName"=>AliasName, "TargetKeyId"=>TargetKeyId))
CreateAlias(AliasName, TargetKeyId, args::AbstractDict{String, <:Any}) = kms("CreateAlias", Dict{String, Any}("AliasName"=>AliasName, "TargetKeyId"=>TargetKeyId, args...))
...
"""
CreateCustomKeyStore(CloudHsmClusterId, CustomKeyStoreName, KeyStorePassword, TrustAnchorCertificate) = kms("CreateCustomKeyStore", Dict{String, Any}("CloudHsmClusterId"=>CloudHsmClusterId, "CustomKeyStoreName"=>CustomKeyStoreName, "KeyStorePassword"=>KeyStorePassword, "TrustAnchorCertificate"=>TrustAnchorCertificate))
CreateCustomKeyStore(CloudHsmClusterId, CustomKeyStoreName, KeyStorePassword, TrustAnchorCertificate, args::AbstractDict{String, <:Any}) = kms("CreateCustomKeyStore", Dict{String, Any}("CloudHsmClusterId"=>CloudHsmClusterId, "CustomKeyStoreName"=>CustomKeyStoreName, "KeyStorePassword"=>KeyStorePassword, "TrustAnchorCertificate"=>TrustAnchorCertificate, args...))
...
"""
CreateGrant(GranteePrincipal, KeyId, Operations) = kms("CreateGrant", Dict{String, Any}("GranteePrincipal"=>GranteePrincipal, "KeyId"=>KeyId, "Operations"=>Operations))
CreateGrant(GranteePrincipal, KeyId, Operations, args::AbstractDict{String, <:Any}) = kms("CreateGrant", Dict{String, Any}("GranteePrincipal"=>GranteePrincipal, "KeyId"=>KeyId, "Operations"=>Operations, args...))
...
CreateKey(args::AbstractDict{String, <:Any}) = kms("CreateKey", args)
...
"""
Decrypt(CiphertextBlob) = kms("Decrypt", Dict{String, Any}("CiphertextBlob"=>CiphertextBlob))
Decrypt(CiphertextBlob, args::AbstractDict{String, <:Any}) = kms("Decrypt", Dict{String, Any}("CiphertextBlob"=>CiphertextBlob, args...))
...
"""
DeleteAlias(AliasName) = kms("DeleteAlias", Dict{String, Any}("AliasName"=>AliasName))
DeleteAlias(AliasName, args::AbstractDict{String, <:Any}) = kms("DeleteAlias", Dict{String, Any}("AliasName"=>AliasName, args...))
...
"""
DeleteCustomKeyStore(CustomKeyStoreId) = kms("DeleteCustomKeyStore", Dict{String, Any}("CustomKeyStoreId"=>CustomKeyStoreId))
DeleteCustomKeyStore(CustomKeyStoreId, args::AbstractDict{String, <:Any}) = kms("DeleteCustomKeyStore", Dict{String, Any}("CustomKeyStoreId"=>CustomKeyStoreId, args...))
...
"""
DeleteImportedKeyMaterial(KeyId) = kms("DeleteImportedKeyMaterial", Dict{String, Any}("KeyId"=>KeyId))
DeleteImportedKeyMaterial(KeyId, args::AbstractDict{String, <:Any}) = kms("DeleteImportedKeyMaterial", Dict{String, Any}("KeyId"=>KeyId, args...))
...
DescribeCustomKeyStores(args::AbstractDict{String, <:Any}) = kms("DescribeCustomKeyStores", args)
...
- `GrantTokens`: A list of grant tokens. For more information, see Grant Tokens in the AWS Key Management Service Developer Guide.
"""
DescribeKey(KeyId) = kms("DescribeKey", Dict{String, Any}("KeyId"=>KeyId))
DescribeKey(KeyId, args::AbstractDict{String, <:Any}) = kms("DescribeKey", Dict{String, Any}("KeyId"=>KeyId, args...))
...
"""
DisableKey(KeyId) = kms("DisableKey", Dict{String, Any}("KeyId"=>KeyId))
DisableKey(KeyId, args::AbstractDict{String, <:Any}) = kms("DisableKey", Dict{String, Any}("KeyId"=>KeyId, args...))
...
"""
DisableKeyRotation(KeyId) = kms("DisableKeyRotation", Dict{String, Any}("KeyId"=>KeyId))
DisableKeyRotation(KeyId, args::AbstractDict{String, <:Any}) = kms("DisableKeyRotation", Dict{String, Any}("KeyId"=>KeyId, args...))
...
"""
DisconnectCustomKeyStore(CustomKeyStoreId) = kms("DisconnectCustomKeyStore", Dict{String, Any}("CustomKeyStoreId"=>CustomKeyStoreId))
DisconnectCustomKeyStore(CustomKeyStoreId, args::AbstractDict{String, <:Any}) = kms("DisconnectCustomKeyStore", Dict{String, Any}("CustomKeyStoreId"=>CustomKeyStoreId, args...))
...
"""
EnableKey(KeyId) = kms("EnableKey", Dict{String, Any}("KeyId"=>KeyId))
EnableKey(KeyId, args::AbstractDict{String, <:Any}) = kms("EnableKey", Dict{String, Any}("KeyId"=>KeyId, args...))
...
"""
EnableKeyRotation(KeyId) = kms("EnableKeyRotation", Dict{String, Any}("KeyId"=>KeyId))
EnableKeyRotation(KeyId, args::AbstractDict{String, <:Any}) = kms("EnableKeyRotation", Dict{String, Any}("KeyId"=>KeyId, args...))
...
- `GrantTokens`: A list of grant tokens. For more information, see Grant Tokens in the AWS Key Management Service Developer Guide.
"""
Encrypt(KeyId, Plaintext) = kms("Encrypt", Dict{String, Any}("KeyId"=>KeyId, "Plaintext"=>Plaintext))
Encrypt(KeyId, Plaintext, args::AbstractDict{String, <:Any}) = kms("Encrypt", Dict{String, Any}("KeyId"=>KeyId, "Plaintext"=>Plaintext, args...))
...
"""
GenerateDataKey(KeyId) = kms("GenerateDataKey", Dict{String, Any}("KeyId"=>KeyId))
GenerateDataKey(KeyId, args::AbstractDict{String, <:Any}) = kms("GenerateDataKey", Dict{String, Any}("KeyId"=>KeyId, args...))
...
- `GrantTokens`: A list of grant tokens. For more information, see Grant Tokens in the AWS Key Management Service Developer Guide.
"""
GenerateDataKeyPair(KeyId, KeyPairSpec) = kms("GenerateDataKeyPair", Dict{String, Any}("KeyId"=>KeyId, "KeyPairSpec"=>KeyPairSpec))
GenerateDataKeyPair(KeyId, KeyPairSpec, args::AbstractDict{String, <:Any}) = kms("GenerateDataKeyPair", Dict{String, Any}("KeyId"=>KeyId, "KeyPairSpec"=>KeyPairSpec, args...))
...
- `GrantTokens`: A list of grant tokens. For more information, see Grant Tokens in the AWS Key Management Service Developer Guide.
"""
GenerateDataKeyPairWithoutPlaintext(KeyId, KeyPairSpec) = kms("GenerateDataKeyPairWithoutPlaintext", Dict{String, Any}("KeyId"=>KeyId, "KeyPairSpec"=>KeyPairSpec))
GenerateDataKeyPairWithoutPlaintext(KeyId, KeyPairSpec, args::AbstractDict{String, <:Any}) = kms("GenerateDataKeyPairWithoutPlaintext", Dict{String, Any}("KeyId"=>KeyId, "KeyPairSpec"=>KeyPairSpec, args...))
...
"""
GenerateDataKeyWithoutPlaintext(KeyId) = kms("GenerateDataKeyWithoutPlaintext", Dict{String, Any}("KeyId"=>KeyId))
GenerateDataKeyWithoutPlaintext(KeyId, args::AbstractDict{String, <:Any}) = kms("GenerateDataKeyWithoutPlaintext", Dict{String, Any}("KeyId"=>KeyId, args...))
...
GenerateRandom(args::AbstractDict{String, <:Any}) = kms("GenerateRandom", args)
...
"""
GetKeyPolicy(KeyId, PolicyName) = kms("GetKeyPolicy", Dict{String, Any}("KeyId"=>KeyId, "PolicyName"=>PolicyName))
GetKeyPolicy(KeyId, PolicyName, args::AbstractDict{String, <:Any}) = kms("GetKeyPolicy", Dict{String, Any}("KeyId"=>KeyId, "PolicyName"=>PolicyName, args...))
...
"""
GetKeyRotationStatus(KeyId) = kms("GetKeyRotationStatus", Dict{String, Any}("KeyId"=>KeyId))
GetKeyRotationStatus(KeyId, args::AbstractDict{String, <:Any}) = kms("GetKeyRotationStatus", Dict{String, Any}("KeyId"=>KeyId, args...))
...
"""
GetParametersForImport(KeyId, WrappingAlgorithm, WrappingKeySpec) = kms("GetParametersForImport", Dict{String, Any}("KeyId"=>KeyId, "WrappingAlgorithm"=>WrappingAlgorithm, "WrappingKeySpec"=>WrappingKeySpec))
GetParametersForImport(KeyId, WrappingAlgorithm, WrappingKeySpec, args::AbstractDict{String, <:Any}) = kms("GetParametersForImport", Dict{String, Any}("KeyId"=>KeyId, "WrappingAlgorithm"=>WrappingAlgorithm, "WrappingKeySpec"=>WrappingKeySpec, args...))
...
- `GrantTokens`: A list of grant tokens. For more information, see Grant Tokens in the AWS Key Management Service Developer Guide.
"""
GetPublicKey(KeyId) = kms("GetPublicKey", Dict{String, Any}("KeyId"=>KeyId))
GetPublicKey(KeyId, args::AbstractDict{String, <:Any}) = kms("GetPublicKey", Dict{String, Any}("KeyId"=>KeyId, args...))
...
"""
ImportKeyMaterial(EncryptedKeyMaterial, ImportToken, KeyId) = kms("ImportKeyMaterial", Dict{String, Any}("EncryptedKeyMaterial"=>EncryptedKeyMaterial, "ImportToken"=>ImportToken, "KeyId"=>KeyId))
ImportKeyMaterial(EncryptedKeyMaterial, ImportToken, KeyId, args::AbstractDict{String, <:Any}) = kms("ImportKeyMaterial", Dict{String, Any}("EncryptedKeyMaterial"=>EncryptedKeyMaterial, "ImportToken"=>ImportToken, "KeyId"=>KeyId, args...))
...
ListAliases(args::AbstractDict{String, <:Any}) = kms("ListAliases", args)
...
- `Marker`: Use this parameter in a subsequent request after you receive a response with truncated results. Set it to the value of NextMarker from the truncated response you just received.
"""
ListGrants(KeyId) = kms("ListGrants", Dict{String, Any}("KeyId"=>KeyId))
ListGrants(KeyId, args::AbstractDict{String, <:Any}) = kms("ListGrants", Dict{String, Any}("KeyId"=>KeyId, args...))
...
- `Marker`: Use this parameter in a subsequent request after you receive a response with truncated results. Set it to the value of NextMarker from the truncated response you just received.
"""
ListKeyPolicies(KeyId) = kms("ListKeyPolicies", Dict{String, Any}("KeyId"=>KeyId))
ListKeyPolicies(KeyId, args::AbstractDict{String, <:Any}) = kms("ListKeyPolicies", Dict{String, Any}("KeyId"=>KeyId, args...))
...
ListKeys(args::AbstractDict{String, <:Any}) = kms("ListKeys", args)
...
"""
ListResourceTags(KeyId) = kms("ListResourceTags", Dict{String, Any}("KeyId"=>KeyId))
ListResourceTags(KeyId, args::AbstractDict{String, <:Any}) = kms("ListResourceTags", Dict{String, Any}("KeyId"=>KeyId, args...))
...
- `Marker`: Use this parameter in a subsequent request after you receive a response with truncated results. Set it to the value of NextMarker from the truncated response you just received.
"""
ListRetirableGrants(RetiringPrincipal) = kms("ListRetirableGrants", Dict{String, Any}("RetiringPrincipal"=>RetiringPrincipal))
ListRetirableGrants(RetiringPrincipal, args::AbstractDict{String, <:Any}) = kms("ListRetirableGrants", Dict{String, Any}("RetiringPrincipal"=>RetiringPrincipal, args...))
...
"""
PutKeyPolicy(KeyId, Policy, PolicyName) = kms("PutKeyPolicy", Dict{String, Any}("KeyId"=>KeyId, "Policy"=>Policy, "PolicyName"=>PolicyName))
PutKeyPolicy(KeyId, Policy, PolicyName, args::AbstractDict{String, <:Any}) = kms("PutKeyPolicy", Dict{String, Any}("KeyId"=>KeyId, "Policy"=>Policy, "PolicyName"=>PolicyName, args...))
...
"""
ReEncrypt(CiphertextBlob, DestinationKeyId) = kms("ReEncrypt", Dict{String, Any}("CiphertextBlob"=>CiphertextBlob, "DestinationKeyId"=>DestinationKeyId))
ReEncrypt(CiphertextBlob, DestinationKeyId, args::AbstractDict{String, <:Any}) = kms("ReEncrypt", Dict{String, Any}("CiphertextBlob"=>CiphertextBlob, "DestinationKeyId"=>DestinationKeyId, args...))
...
RetireGrant(args::AbstractDict{String, <:Any}) = kms("RetireGrant", args)
...
"""
RevokeGrant(GrantId, KeyId) = kms("RevokeGrant", Dict{String, Any}("GrantId"=>GrantId, "KeyId"=>KeyId))
RevokeGrant(GrantId, KeyId, args::AbstractDict{String, <:Any}) = kms("RevokeGrant", Dict{String, Any}("GrantId"=>GrantId, "KeyId"=>KeyId, args...))
...
"""
ScheduleKeyDeletion(KeyId) = kms("ScheduleKeyDeletion", Dict{String, Any}("KeyId"=>KeyId))
ScheduleKeyDeletion(KeyId, args::AbstractDict{String, <:Any}) = kms("ScheduleKeyDeletion", Dict{String, Any}("KeyId"=>KeyId, args...))
...
"""
Sign(KeyId, Message, SigningAlgorithm) = kms("Sign", Dict{String, Any}("KeyId"=>KeyId, "Message"=>Message, "SigningAlgorithm"=>SigningAlgorithm))
Sign(KeyId, Message, SigningAlgorithm, args::AbstractDict{String, <:Any}) = kms("Sign", Dict{String, Any}("KeyId"=>KeyId, "Message"=>Message, "SigningAlgorithm"=>SigningAlgorithm, args...))
...
"""
TagResource(KeyId, Tags) = kms("TagResource", Dict{String, Any}("KeyId"=>KeyId, "Tags"=>Tags))
TagResource(KeyId, Tags, args::AbstractDict{String, <:Any}) = kms("TagResource", Dict{String, Any}("KeyId"=>KeyId, "Tags"=>Tags, args...))
...
"""
UntagResource(KeyId, TagKeys) = kms("UntagResource", Dict{String, Any}("KeyId"=>KeyId, "TagKeys"=>TagKeys))
UntagResource(KeyId, TagKeys, args::AbstractDict{String, <:Any}) = kms("UntagResource", Dict{String, Any}("KeyId"=>KeyId, "TagKeys"=>TagKeys, args...))
...
"""
UpdateAlias(AliasName, TargetKeyId) = kms("UpdateAlias", Dict{String, Any}("AliasName"=>AliasName, "TargetKeyId"=>TargetKeyId))
UpdateAlias(AliasName, TargetKeyId, args::AbstractDict{String, <:Any}) = kms("UpdateAlias", Dict{String, Any}("AliasName"=>AliasName, "TargetKeyId"=>TargetKeyId, args...))
...
"""
UpdateCustomKeyStore(CustomKeyStoreId) = kms("UpdateCustomKeyStore", Dict{String, Any}("CustomKeyStoreId"=>CustomKeyStoreId))
UpdateCustomKeyStore(CustomKeyStoreId, args::AbstractDict{String, <:Any}) = kms("UpdateCustomKeyStore", Dict{String, Any}("CustomKeyStoreId"=>CustomKeyStoreId, args...))
...
"""
UpdateKeyDescription(Description, KeyId) = kms("UpdateKeyDescription", Dict{String, Any}("Description"=>Description, "KeyId"=>KeyId))
UpdateKeyDescription(Description, KeyId, args::AbstractDict{String, <:Any}) = kms("UpdateKeyDescription", Dict{String, Any}("Description"=>Description, "KeyId"=>KeyId, args...))
...
"""
Verify(KeyId, Message, Signature, SigningAlgorithm) = kms("Verify", Dict{String, Any}("KeyId"=>KeyId, "Message"=>Message, "Signature"=>Signature, "SigningAlgorithm"=>SigningAlgorithm))
Verify(KeyId, Message, Signature, SigningAlgorithm, args::AbstractDict{String, <:Any}) = kms("Verify", Dict{String, Any}("KeyId"=>KeyId, "Message"=>Message, "Signature"=>Signature, "SigningAlgorithm"=>SigningAlgorithm, args...))
