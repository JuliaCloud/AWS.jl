...
"""
AssociateVPCWithHostedZone(Id, VPC) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/associatevpc", Dict{String, Any}("VPC"=>VPC))
AssociateVPCWithHostedZone(Id, VPC, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/associatevpc", Dict{String, Any}("VPC"=>VPC, args...))
...
"""
ChangeResourceRecordSets(ChangeBatch, Id) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/rrset/", Dict{String, Any}("ChangeBatch"=>ChangeBatch))
ChangeResourceRecordSets(ChangeBatch, Id, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/rrset/", Dict{String, Any}("ChangeBatch"=>ChangeBatch, args...))
...
ChangeTagsForResource(ResourceId, ResourceType, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/tags/$(ResourceType)/$(ResourceId)", args)
...
"""
CreateHealthCheck(CallerReference, HealthCheckConfig) = route_53("POST", "/2013-04-01/healthcheck", Dict{String, Any}("CallerReference"=>CallerReference, "HealthCheckConfig"=>HealthCheckConfig))
CreateHealthCheck(CallerReference, HealthCheckConfig, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/healthcheck", Dict{String, Any}("CallerReference"=>CallerReference, "HealthCheckConfig"=>HealthCheckConfig, args...))
...
"""
CreateHostedZone(CallerReference, Name) = route_53("POST", "/2013-04-01/hostedzone", Dict{String, Any}("CallerReference"=>CallerReference, "Name"=>Name))
CreateHostedZone(CallerReference, Name, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/hostedzone", Dict{String, Any}("CallerReference"=>CallerReference, "Name"=>Name, args...))
...
"""
CreateQueryLoggingConfig(CloudWatchLogsLogGroupArn, HostedZoneId) = route_53("POST", "/2013-04-01/queryloggingconfig", Dict{String, Any}("CloudWatchLogsLogGroupArn"=>CloudWatchLogsLogGroupArn, "HostedZoneId"=>HostedZoneId))
CreateQueryLoggingConfig(CloudWatchLogsLogGroupArn, HostedZoneId, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/queryloggingconfig", Dict{String, Any}("CloudWatchLogsLogGroupArn"=>CloudWatchLogsLogGroupArn, "HostedZoneId"=>HostedZoneId, args...))
...
"""
CreateReusableDelegationSet(CallerReference) = route_53("POST", "/2013-04-01/delegationset", Dict{String, Any}("CallerReference"=>CallerReference))
CreateReusableDelegationSet(CallerReference, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/delegationset", Dict{String, Any}("CallerReference"=>CallerReference, args...))
...
"""
CreateTrafficPolicy(Document, Name) = route_53("POST", "/2013-04-01/trafficpolicy", Dict{String, Any}("Document"=>Document, "Name"=>Name))
CreateTrafficPolicy(Document, Name, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/trafficpolicy", Dict{String, Any}("Document"=>Document, "Name"=>Name, args...))
...
"""
CreateTrafficPolicyInstance(HostedZoneId, Name, TTL, TrafficPolicyId, TrafficPolicyVersion) = route_53("POST", "/2013-04-01/trafficpolicyinstance", Dict{String, Any}("HostedZoneId"=>HostedZoneId, "Name"=>Name, "TTL"=>TTL, "TrafficPolicyId"=>TrafficPolicyId, "TrafficPolicyVersion"=>TrafficPolicyVersion))
CreateTrafficPolicyInstance(HostedZoneId, Name, TTL, TrafficPolicyId, TrafficPolicyVersion, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/trafficpolicyinstance", Dict{String, Any}("HostedZoneId"=>HostedZoneId, "Name"=>Name, "TTL"=>TTL, "TrafficPolicyId"=>TrafficPolicyId, "TrafficPolicyVersion"=>TrafficPolicyVersion, args...))
...
"""
CreateTrafficPolicyVersion(Document, Id) = route_53("POST", "/2013-04-01/trafficpolicy/$(Id)", Dict{String, Any}("Document"=>Document))
CreateTrafficPolicyVersion(Document, Id, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/trafficpolicy/$(Id)", Dict{String, Any}("Document"=>Document, args...))
...
"""
CreateVPCAssociationAuthorization(Id, VPC) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/authorizevpcassociation", Dict{String, Any}("VPC"=>VPC))
CreateVPCAssociationAuthorization(Id, VPC, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/authorizevpcassociation", Dict{String, Any}("VPC"=>VPC, args...))
...
DeleteHealthCheck(HealthCheckId, args::AbstractDict{String, <: Any}) = route_53("DELETE", "/2013-04-01/healthcheck/$(HealthCheckId)", args)
...
DeleteHostedZone(Id, args::AbstractDict{String, <: Any}) = route_53("DELETE", "/2013-04-01/hostedzone/$(Id)", args)
...
DeleteQueryLoggingConfig(Id, args::AbstractDict{String, <: Any}) = route_53("DELETE", "/2013-04-01/queryloggingconfig/$(Id)", args)
...
DeleteReusableDelegationSet(Id, args::AbstractDict{String, <: Any}) = route_53("DELETE", "/2013-04-01/delegationset/$(Id)", args)
...
DeleteTrafficPolicy(Id, Version, args::AbstractDict{String, <: Any}) = route_53("DELETE", "/2013-04-01/trafficpolicy/$(Id)/$(Version)", args)
...
DeleteTrafficPolicyInstance(Id, args::AbstractDict{String, <: Any}) = route_53("DELETE", "/2013-04-01/trafficpolicyinstance/$(Id)", args)
...
"""
DeleteVPCAssociationAuthorization(Id, VPC) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/deauthorizevpcassociation", Dict{String, Any}("VPC"=>VPC))
DeleteVPCAssociationAuthorization(Id, VPC, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/deauthorizevpcassociation", Dict{String, Any}("VPC"=>VPC, args...))
...
"""
DisassociateVPCFromHostedZone(Id, VPC) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/disassociatevpc", Dict{String, Any}("VPC"=>VPC))
DisassociateVPCFromHostedZone(Id, VPC, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/disassociatevpc", Dict{String, Any}("VPC"=>VPC, args...))
...
GetAccountLimit(Type, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/accountlimit/$(Type)", args)
...
GetChange(Id, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/change/$(Id)", args)
...
GetCheckerIpRanges(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/checkeripranges", args)
...
GetGeoLocation(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/geolocation", args)
...
GetHealthCheck(HealthCheckId, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/healthcheck/$(HealthCheckId)", args)
...
GetHealthCheckCount(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/healthcheckcount", args)
...
GetHealthCheckLastFailureReason(HealthCheckId, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/healthcheck/$(HealthCheckId)/lastfailurereason", args)
...
GetHealthCheckStatus(HealthCheckId, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/healthcheck/$(HealthCheckId)/status", args)
...
GetHostedZone(Id, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/hostedzone/$(Id)", args)
...
GetHostedZoneCount(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/hostedzonecount", args)
...
"""
GetHostedZoneLimit(Id, Type) = route_53("GET", "/2013-04-01/hostedzonelimit/$(Id)/$(Type)")
GetHostedZoneLimit(Id, Type, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/hostedzonelimit/$(Id)/$(Type)", args)
...
GetQueryLoggingConfig(Id, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/queryloggingconfig/$(Id)", args)
...
GetReusableDelegationSet(Id, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/delegationset/$(Id)", args)
...
"""
GetReusableDelegationSetLimit(Id, Type) = route_53("GET", "/2013-04-01/reusabledelegationsetlimit/$(Id)/$(Type)")
GetReusableDelegationSetLimit(Id, Type, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/reusabledelegationsetlimit/$(Id)/$(Type)", args)
...
GetTrafficPolicy(Id, Version, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/trafficpolicy/$(Id)/$(Version)", args)
...
GetTrafficPolicyInstance(Id, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/trafficpolicyinstance/$(Id)", args)
...
GetTrafficPolicyInstanceCount(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/trafficpolicyinstancecount", args)
...
ListGeoLocations(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/geolocations", args)
...
ListHealthChecks(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/healthcheck", args)
...
ListHostedZones(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/hostedzone", args)
...
ListHostedZonesByName(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/hostedzonesbyname", args)
...
"""
ListHostedZonesByVPC(vpcid, vpcregion) = route_53("GET", "/2013-04-01/hostedzonesbyvpc", Dict{String, Any}("vpcid"=>vpcid, "vpcregion"=>vpcregion))
ListHostedZonesByVPC(vpcid, vpcregion, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/hostedzonesbyvpc", Dict{String, Any}("vpcid"=>vpcid, "vpcregion"=>vpcregion, args...))
...
ListQueryLoggingConfigs(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/queryloggingconfig", args)
...
"""
ListResourceRecordSets(Id) = route_53("GET", "/2013-04-01/hostedzone/$(Id)/rrset")
ListResourceRecordSets(Id, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/hostedzone/$(Id)/rrset", args)
...
ListReusableDelegationSets(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/delegationset", args)
...
ListTagsForResource(ResourceId, ResourceType, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/tags/$(ResourceType)/$(ResourceId)", args)
...
"""
ListTagsForResources(ResourceId, ResourceType) = route_53("POST", "/2013-04-01/tags/$(ResourceType)", Dict{String, Any}("ResourceId"=>ResourceId))
ListTagsForResources(ResourceId, ResourceType, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/tags/$(ResourceType)", Dict{String, Any}("ResourceId"=>ResourceId, args...))
...
ListTrafficPolicies(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/trafficpolicies", args)
...
ListTrafficPolicyInstances(args::AbstractDict{String, Any}) = route_53("GET", "/2013-04-01/trafficpolicyinstances", args)
...
"""
ListTrafficPolicyInstancesByHostedZone(id) = route_53("GET", "/2013-04-01/trafficpolicyinstances/hostedzone", Dict{String, Any}("id"=>id))
ListTrafficPolicyInstancesByHostedZone(id, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/trafficpolicyinstances/hostedzone", Dict{String, Any}("id"=>id, args...))
...
"""
ListTrafficPolicyInstancesByPolicy(id, version) = route_53("GET", "/2013-04-01/trafficpolicyinstances/trafficpolicy", Dict{String, Any}("id"=>id, "version"=>version))
ListTrafficPolicyInstancesByPolicy(id, version, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/trafficpolicyinstances/trafficpolicy", Dict{String, Any}("id"=>id, "version"=>version, args...))
...
ListTrafficPolicyVersions(Id, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/trafficpolicies/$(Id)/versions", args)
...
"""
ListVPCAssociationAuthorizations(Id) = route_53("GET", "/2013-04-01/hostedzone/$(Id)/authorizevpcassociation")
ListVPCAssociationAuthorizations(Id, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/hostedzone/$(Id)/authorizevpcassociation", args)
...
"""
TestDNSAnswer(hostedzoneid, recordname, recordtype) = route_53("GET", "/2013-04-01/testdnsanswer", Dict{String, Any}("hostedzoneid"=>hostedzoneid, "recordname"=>recordname, "recordtype"=>recordtype))
TestDNSAnswer(hostedzoneid, recordname, recordtype, args::AbstractDict{String, <: Any}) = route_53("GET", "/2013-04-01/testdnsanswer", Dict{String, Any}("hostedzoneid"=>hostedzoneid, "recordname"=>recordname, "recordtype"=>recordtype, args...))
...
UpdateHealthCheck(HealthCheckId, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/healthcheck/$(HealthCheckId)", args)
...
UpdateHostedZoneComment(Id, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/hostedzone/$(Id)", args)
...
"""
UpdateTrafficPolicyComment(Comment, Id, Version) = route_53("POST", "/2013-04-01/trafficpolicy/$(Id)/$(Version)", Dict{String, Any}("Comment"=>Comment))
UpdateTrafficPolicyComment(Comment, Id, Version, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/trafficpolicy/$(Id)/$(Version)", Dict{String, Any}("Comment"=>Comment, args...))
...
"""
UpdateTrafficPolicyInstance(Id, TTL, TrafficPolicyId, TrafficPolicyVersion) = route_53("POST", "/2013-04-01/trafficpolicyinstance/$(Id)", Dict{String, Any}("TTL"=>TTL, "TrafficPolicyId"=>TrafficPolicyId, "TrafficPolicyVersion"=>TrafficPolicyVersion))
UpdateTrafficPolicyInstance(Id, TTL, TrafficPolicyId, TrafficPolicyVersion, args::AbstractDict{String, <: Any}) = route_53("POST", "/2013-04-01/trafficpolicyinstance/$(Id)", Dict{String, Any}("TTL"=>TTL, "TrafficPolicyId"=>TrafficPolicyId, "TrafficPolicyVersion"=>TrafficPolicyVersion, args...))
