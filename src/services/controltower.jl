...
# Arguments
- `manifest`: The manifest.yaml file is a text file that describes your Amazon Web Services
...
resources specified by the Baseline to the specified Target.
...
by the corresponding Baseline or Target of the EnabledBaseline resources.
