...
function list_profile_associations(; aws_config::AbstractAWSConfig=current_aws_config())
    return route53profiles(
        "GET", "/profileassociations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_profile_associations(
    ...
    return route53profiles(
        "GET", "/profileassociations", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_profiles(; aws_config::AbstractAWSConfig=current_aws_config())
    return route53profiles("GET", "/profiles"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
