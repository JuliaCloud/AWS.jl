...
"""
function get_metric_policy(ContainerName; aws_config::AbstractAWSConfig=current_aws_config())
    return mediastore(
        "GetMetricPolicy",
        Dict{String,Any}("ContainerName" => ContainerName);
        aws_config=aws_config,
...
"""
function list_tags_for_resource(Resource; aws_config::AbstractAWSConfig=current_aws_config())
    return mediastore(
        "ListTagsForResource",
