...
"""
CreateChannel() = medialive("POST", "/prod/channels", Dict{String, Any}("requestId"=>string(uuid4())))
CreateChannel(args::AbstractDict{String, <:Any}) = medialive("POST", "/prod/channels", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("requestId"=>string(uuid4())), args...)))
...
- `vpc`: 
"""
CreateInput() = medialive("POST", "/prod/inputs", Dict{String, Any}("requestId"=>string(uuid4())))
CreateInput(args::AbstractDict{String, <:Any}) = medialive("POST", "/prod/inputs", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("requestId"=>string(uuid4())), args...)))
...
DescribeInputDeviceThumbnail(accept, inputDeviceId, args::AbstractDict{String, <:Any}) = medialive("GET", "/prod/inputDevices/$(inputDeviceId)/thumbnailData", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("accept"=>accept)), args...)))
...
- `tags`: A collection of key-value pairs
"""
PurchaseOffering(count, offeringId) = medialive("POST", "/prod/offerings/$(offeringId)/purchase", Dict{String, Any}("count"=>count, "requestId"=>string(uuid4())))
PurchaseOffering(count, offeringId, args::AbstractDict{String, <:Any}) = medialive("POST", "/prod/offerings/$(offeringId)/purchase", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("count"=>count, "requestId"=>string(uuid4())), args...)))
