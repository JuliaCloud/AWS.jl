...
- `projectRole`: The AWS CodeStar project role that will apply to this user. This role
  determines what actions a user can take in an AWS CodeStar project.
- `userArn`: The Amazon Resource Name (ARN) for the IAM user you want to add to the AWS
  CodeStar project.
...
# Required Parameters
- `displayName`: The name that will be displayed as the friendly name for the user in AWS
  CodeStar.
- `emailAddress`: The email address that will be displayed as part of the user's profile in
  AWS CodeStar.
- `userArn`: The Amazon Resource Name (ARN) of the user in IAM.

# Optional Parameters
- `sshPublicKey`: The SSH public key associated with the user in AWS CodeStar. If a project
  owner allows the user remote access to project resources, this public key will be used
...
# Required Parameters
- `projectId`: The ID of the AWS CodeStar project from which you want to remove a team
  member.
- `userArn`: The Amazon Resource Name (ARN) of the IAM user or group whom you want to
...
# Optional Parameters
- `maxResults`: The maximum amount of data that can be contained in a single set of results.
- `nextToken`: The continuation token for the next set of results, if the results cannot be
...
# Required Parameters
- `projectId`: The ID of the project.
- `userArn`: The Amazon Resource Name (ARN) of the user for whom you want to change team
  membership attributes.

# Optional Parameters
- `projectRole`: The role assigned to the user in the project. Project roles have different
  levels of access. For more information, see Working with Teams in the AWS CodeStar User
  Guide.
...
# Required Parameters
- `userArn`: The name that will be displayed as the friendly name for the user in AWS
  CodeStar.
