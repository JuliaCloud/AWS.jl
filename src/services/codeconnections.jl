...
"""
function delete_connection(ConnectionArn; aws_config::AbstractAWSConfig=current_aws_config())
    return codeconnections(
        "DeleteConnection",
...
function delete_host(
    HostArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return codeconnections(
        "DeleteHost",
