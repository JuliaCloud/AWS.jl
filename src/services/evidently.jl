...
"""
function delete_feature(feature, project; aws_config::AbstractAWSConfig=current_aws_config())
    return evidently(
        "DELETE",
...
function delete_project(
    project, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return evidently(
        "DELETE",
        "/projects/$(project)",
...
function delete_segment(
    segment, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return evidently(
        "DELETE",
        "/segments/$(segment)",
...
"""
function update_feature(feature, project; aws_config::AbstractAWSConfig=current_aws_config())
    return evidently(
        "PATCH",
        "/projects/$(project)/features/$(feature)";
        aws_config=aws_config,
