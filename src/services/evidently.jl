...
const SERVICE_PARAMETER_MAP = AWS.LittleDict("description" => "description", "evaluation_context" => "evaluationContext", "max_results" => "maxResults", "next_token" => "nextToken", "data_delivery" => "dataDelivery", "tags" => "tags", "cloud_watch_logs" => "cloudWatchLogs", "s3_destination" => "s3Destination", "metric_goals" => "metricGoals", "online_ab_config" => "onlineAbConfig", "randomization_salt" => "randomizationSalt", "sampling_rate" => "samplingRate", "treatments" => "treatments", "metric_monitors" => "metricMonitors", "scheduled_splits_config" => "scheduledSplitsConfig", "base_stat" => "baseStat", "end_time" => "endTime", "period" => "period", "report_names" => "reportNames", "result_stats" => "resultStats", "start_time" => "startTime", "groups" => "groups", "default_variation" => "defaultVariation", "entity_overrides" => "entityOverrides", "evaluation_strategy" => "evaluationStrategy", "desired_state" => "desiredState", "reason" => "reason", "add_or_update_variations" => "addOrUpdateVariations", "remove_variations" => "removeVariations")

"""
    batch_evaluate_feature(project, requests; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function batch_evaluate_feature(project, requests; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/projects/$(project)/evaluations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("requests"=>requests), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    create_experiment(metric_goals, name, project, treatments; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
- `online_ab_config`: A structure that contains the configuration of which variation to use
  ...
  variation.
- `randomization_salt`: When Evidently assigns a particular user session to an experiment,
...
- `sampling_rate`: The portion of the available audience that you want to allocate to this
...
"""
function create_experiment(metricGoals, name, project, treatments; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/projects/$(project)/experiments", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("metricGoals"=>metricGoals, "name"=>name, "treatments"=>treatments), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    create_feature(name, project, variations; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
# Keyword Parameters
- `default_variation`: The name of the variation to use as the default variation. The
...
- `entity_overrides`: Specify users that should always be served a specific variation of a
...
- `evaluation_strategy`: Specify ALL_RULES to activate the traffic allocation specified by
...
- `tags`: Assigns one or more tags (key-value pairs) to the feature. Tags can help you
  ...
  Amazon Web Services resources&lt;/a&gt;.&lt;/p&gt;
"""
function create_feature(name, project, variations; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/projects/$(project)/features", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("name"=>name, "variations"=>variations), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    create_launch(groups, name, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
- `metric_monitors`: An array of structures that define the metrics that will be used to
  monitor the launch performance.
- `randomization_salt`: When Evidently assigns a particular user session to a launch, it
...
- `scheduled_splits_config`: An array of structures that define the traffic allocation
...
- `tags`: Assigns one or more tags (key-value pairs) to the launch. Tags can help you
  ...
  Amazon Web Services resources&lt;/a&gt;.&lt;/p&gt;
"""
function create_launch(groups, name, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/projects/$(project)/launches", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("groups"=>groups, "name"=>name), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
# Keyword Parameters
- `data_delivery`: A structure that contains information about where Evidently is to store
...
function create_project(name; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/projects", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("name"=>name), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    delete_experiment(experiment, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function delete_experiment(experiment, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("DELETE", "/projects/$(project)/experiments/$(experiment)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    delete_feature(feature, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function delete_feature(feature, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("DELETE", "/projects/$(project)/features/$(feature)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    delete_launch(launch, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function delete_launch(launch, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("DELETE", "/projects/$(project)/launches/$(launch)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    delete_project(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function delete_project(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("DELETE", "/projects/$(project)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    evaluate_feature(entity_id, feature, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
# Keyword Parameters
- `evaluation_context`: A JSON block of attributes that you can optionally pass in. This
  JSON block is included in the evaluation events sent to Evidently from the user session.
"""
function evaluate_feature(entityId, feature, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/projects/$(project)/evaluations/$(feature)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("entityId"=>entityId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    get_experiment(experiment, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function get_experiment(experiment, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("GET", "/projects/$(project)/experiments/$(experiment)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    get_experiment_results(experiment, metric_names, project, treatment_names; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
# Keyword Parameters
- `base_stat`: The statistic used to calculate experiment results. Currently the only valid
  value is mean, which uses the mean of the collected values as the statistic.
- `end_time`: The date and time that the experiment ended, if it is completed.
- `period`: In seconds, the amount of time to aggregate results together.
- `report_names`: The names of the report types that you want to see. Currently,
  BayesianInference is the only valid value.
- `result_stats`: The statistics that you want to see in the returned results.    PValue
...
- `start_time`: The date and time that the experiment started.
"""
function get_experiment_results(experiment, metricNames, project, treatmentNames; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/projects/$(project)/experiments/$(experiment)/results", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("metricNames"=>metricNames, "treatmentNames"=>treatmentNames), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    get_feature(feature, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function get_feature(feature, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("GET", "/projects/$(project)/features/$(feature)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    get_launch(launch, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function get_launch(launch, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("GET", "/projects/$(project)/launches/$(launch)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    get_project(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function get_project(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("GET", "/projects/$(project)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    list_experiments(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function list_experiments(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("GET", "/projects/$(project)/experiments", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    list_features(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function list_features(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("GET", "/projects/$(project)/features", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    list_launches(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function list_launches(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("GET", "/projects/$(project)/launches", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_projects(; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("GET", "/projects", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_tags_for_resource(resourceArn; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("GET", "/tags/$(resourceArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    put_project_events(events, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function put_project_events(events, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/events/projects/$(project)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("events"=>events), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    start_experiment(analysis_complete_time, experiment, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function start_experiment(analysisCompleteTime, experiment, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/projects/$(project)/experiments/$(experiment)/start", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("analysisCompleteTime"=>analysisCompleteTime), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    start_launch(launch, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
"""
function start_launch(launch, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/projects/$(project)/launches/$(launch)/start", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    stop_experiment(experiment, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
# Keyword Parameters
- `desired_state`: Specify whether the experiment is to be considered COMPLETED or
  CANCELLED after it stops.
- `reason`: A string that describes why you are stopping the experiment.
"""
function stop_experiment(experiment, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/projects/$(project)/experiments/$(experiment)/cancel", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    stop_launch(launch, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
# Keyword Parameters
- `desired_state`: Specify whether to consider the launch as COMPLETED or CANCELLED after
  it stops.
- `reason`: A string that describes why you are stopping the launch.
"""
function stop_launch(launch, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/projects/$(project)/launches/$(launch)/cancel", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function tag_resource(resourceArn, tags; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("POST", "/tags/$(resourceArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("tags"=>tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function untag_resource(resourceArn, tagKeys; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("DELETE", "/tags/$(resourceArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("tagKeys"=>tagKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    update_experiment(experiment, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
- `metric_goals`: An array of structures that defines the metrics used for the experiment,
  and whether a higher or lower value for each metric is the goal.
- `online_ab_config`: A structure that contains the configuration of which variation o use
...
- `treatments`: An array of structures that define the variations being tested in the
  experiment.
"""
function update_experiment(experiment, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("PATCH", "/projects/$(project)/experiments/$(experiment)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    update_feature(feature, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
# Keyword Parameters
- `add_or_update_variations`: To update variation configurations for this feature, or add
...
- `description`: An optional description of the feature.
- `entity_overrides`: Specified users that should always be served a specific variation of
...
- `evaluation_strategy`: Specify ALL_RULES to activate the traffic allocation specified by
  any ongoing launches or experiments. Specify DEFAULT_VARIATION to serve the default
  variation to all users instead.
- `remove_variations`: Removes a variation from the feature. If the variation you specify
...
"""
function update_feature(feature, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("PATCH", "/projects/$(project)/features/$(feature)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    update_launch(launch, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
- `scheduled_splits_config`: An array of structures that define the traffic allocation
  percentages among the feature variations during each step of the launch.
"""
function update_launch(launch, project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("PATCH", "/projects/$(project)/launches/$(launch)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    update_project(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
- `description`: An optional description of the project.
"""
function update_project(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("PATCH", "/projects/$(project)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end

"""
    update_project_data_delivery(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
...
# Keyword Parameters
- `cloud_watch_logs`: A structure containing the CloudWatch Logs log group where you want
  to store evaluation events.
- `s3_destination`: A structure containing the S3 bucket name and bucket prefix where you
  want to store evaluation events.
"""
function update_project_data_delivery(project; aws_config::AbstractAWSConfig=global_aws_config(), kwargs...)
    params = amazonify(SERVICE_PARAMETER_MAP, kwargs)
    return evidently("PATCH", "/projects/$(project)/data-delivery", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
end
