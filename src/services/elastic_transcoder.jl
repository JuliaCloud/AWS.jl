...
CancelJob(Id, args::AbstractDict{String, <: Any}) = elastic_transcoder("DELETE", "/2012-09-25/jobs/$(Id)", args)
...
"""
CreateJob(PipelineId) = elastic_transcoder("POST", "/2012-09-25/jobs", Dict{String, Any}("PipelineId"=>PipelineId))
CreateJob(PipelineId, args::AbstractDict{String, <: Any}) = elastic_transcoder("POST", "/2012-09-25/jobs", Dict{String, Any}("PipelineId"=>PipelineId, args...))
...
"""
CreatePipeline(InputBucket, Name, Role) = elastic_transcoder("POST", "/2012-09-25/pipelines", Dict{String, Any}("InputBucket"=>InputBucket, "Name"=>Name, "Role"=>Role))
CreatePipeline(InputBucket, Name, Role, args::AbstractDict{String, <: Any}) = elastic_transcoder("POST", "/2012-09-25/pipelines", Dict{String, Any}("InputBucket"=>InputBucket, "Name"=>Name, "Role"=>Role, args...))
...
"""
CreatePreset(Container, Name) = elastic_transcoder("POST", "/2012-09-25/presets", Dict{String, Any}("Container"=>Container, "Name"=>Name))
CreatePreset(Container, Name, args::AbstractDict{String, <: Any}) = elastic_transcoder("POST", "/2012-09-25/presets", Dict{String, Any}("Container"=>Container, "Name"=>Name, args...))
...
DeletePipeline(Id, args::AbstractDict{String, <: Any}) = elastic_transcoder("DELETE", "/2012-09-25/pipelines/$(Id)", args)
...
DeletePreset(Id, args::AbstractDict{String, <: Any}) = elastic_transcoder("DELETE", "/2012-09-25/presets/$(Id)", args)
...
ListJobsByPipeline(PipelineId, args::AbstractDict{String, <: Any}) = elastic_transcoder("GET", "/2012-09-25/jobsByPipeline/$(PipelineId)", args)
...
ListJobsByStatus(Status, args::AbstractDict{String, <: Any}) = elastic_transcoder("GET", "/2012-09-25/jobsByStatus/$(Status)", args)
...
ListPipelines(args::AbstractDict{String, Any}) = elastic_transcoder("GET", "/2012-09-25/pipelines", args)
...
ListPresets(args::AbstractDict{String, Any}) = elastic_transcoder("GET", "/2012-09-25/presets", args)
...
ReadJob(Id, args::AbstractDict{String, <: Any}) = elastic_transcoder("GET", "/2012-09-25/jobs/$(Id)", args)
...
ReadPipeline(Id, args::AbstractDict{String, <: Any}) = elastic_transcoder("GET", "/2012-09-25/pipelines/$(Id)", args)
...
ReadPreset(Id, args::AbstractDict{String, <: Any}) = elastic_transcoder("GET", "/2012-09-25/presets/$(Id)", args)
...
"""
TestRole(InputBucket, OutputBucket, Role, Topics) = elastic_transcoder("POST", "/2012-09-25/roleTests", Dict{String, Any}("InputBucket"=>InputBucket, "OutputBucket"=>OutputBucket, "Role"=>Role, "Topics"=>Topics))
TestRole(InputBucket, OutputBucket, Role, Topics, args::AbstractDict{String, <: Any}) = elastic_transcoder("POST", "/2012-09-25/roleTests", Dict{String, Any}("InputBucket"=>InputBucket, "OutputBucket"=>OutputBucket, "Role"=>Role, "Topics"=>Topics, args...))
...
UpdatePipeline(Id, args::AbstractDict{String, <: Any}) = elastic_transcoder("PUT", "/2012-09-25/pipelines/$(Id)", args)
...
"""
UpdatePipelineNotifications(Id, Notifications) = elastic_transcoder("POST", "/2012-09-25/pipelines/$(Id)/notifications", Dict{String, Any}("Notifications"=>Notifications))
UpdatePipelineNotifications(Id, Notifications, args::AbstractDict{String, <: Any}) = elastic_transcoder("POST", "/2012-09-25/pipelines/$(Id)/notifications", Dict{String, Any}("Notifications"=>Notifications, args...))
...
"""
UpdatePipelineStatus(Id, Status) = elastic_transcoder("POST", "/2012-09-25/pipelines/$(Id)/status", Dict{String, Any}("Status"=>Status))
UpdatePipelineStatus(Id, Status, args::AbstractDict{String, <: Any}) = elastic_transcoder("POST", "/2012-09-25/pipelines/$(Id)/status", Dict{String, Any}("Status"=>Status, args...))
