...
"""
CancelJob(Id; aws::AWSConfig=AWSConfig()) = elastic_transcoder("DELETE", "/2012-09-25/jobs/$(Id)"; aws=aws)
CancelJob(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("DELETE", "/2012-09-25/jobs/$(Id)", args; aws=aws)
...
"""
CreateJob(PipelineId; aws::AWSConfig=AWSConfig()) = elastic_transcoder("POST", "/2012-09-25/jobs", Dict{String, Any}("PipelineId"=>PipelineId))
CreateJob(PipelineId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("POST", "/2012-09-25/jobs", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PipelineId"=>PipelineId), args)); aws=aws)
...
"""
CreatePipeline(InputBucket, Name, Role; aws::AWSConfig=AWSConfig()) = elastic_transcoder("POST", "/2012-09-25/pipelines", Dict{String, Any}("InputBucket"=>InputBucket, "Name"=>Name, "Role"=>Role))
CreatePipeline(InputBucket, Name, Role, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("POST", "/2012-09-25/pipelines", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InputBucket"=>InputBucket, "Name"=>Name, "Role"=>Role), args)); aws=aws)
...
"""
CreatePreset(Container, Name; aws::AWSConfig=AWSConfig()) = elastic_transcoder("POST", "/2012-09-25/presets", Dict{String, Any}("Container"=>Container, "Name"=>Name))
CreatePreset(Container, Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("POST", "/2012-09-25/presets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Container"=>Container, "Name"=>Name), args)); aws=aws)
...
"""
DeletePipeline(Id; aws::AWSConfig=AWSConfig()) = elastic_transcoder("DELETE", "/2012-09-25/pipelines/$(Id)"; aws=aws)
DeletePipeline(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("DELETE", "/2012-09-25/pipelines/$(Id)", args; aws=aws)
...
"""
DeletePreset(Id; aws::AWSConfig=AWSConfig()) = elastic_transcoder("DELETE", "/2012-09-25/presets/$(Id)"; aws=aws)
DeletePreset(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("DELETE", "/2012-09-25/presets/$(Id)", args; aws=aws)
...
"""
ListJobsByPipeline(PipelineId; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/jobsByPipeline/$(PipelineId)"; aws=aws)
ListJobsByPipeline(PipelineId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/jobsByPipeline/$(PipelineId)", args; aws=aws)
...
- `PageToken`:  When Elastic Transcoder returns more than one page of results, use pageToken in subsequent GET requests to get each successive page of results. 
"""
ListJobsByStatus(Status; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/jobsByStatus/$(Status)"; aws=aws)
ListJobsByStatus(Status, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/jobsByStatus/$(Status)", args; aws=aws)
...
- `PageToken`: When Elastic Transcoder returns more than one page of results, use pageToken in subsequent GET requests to get each successive page of results. 
"""
ListPipelines(; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/pipelines"; aws=aws)
ListPipelines(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/pipelines", args; aws=aws)
...
- `PageToken`: When Elastic Transcoder returns more than one page of results, use pageToken in subsequent GET requests to get each successive page of results. 
"""
ListPresets(; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/presets"; aws=aws)
ListPresets(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/presets", args; aws=aws)
...
"""
ReadJob(Id; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/jobs/$(Id)"; aws=aws)
ReadJob(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/jobs/$(Id)", args; aws=aws)
...
"""
ReadPipeline(Id; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/pipelines/$(Id)"; aws=aws)
ReadPipeline(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/pipelines/$(Id)", args; aws=aws)
...
"""
ReadPreset(Id; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/presets/$(Id)"; aws=aws)
ReadPreset(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("GET", "/2012-09-25/presets/$(Id)", args; aws=aws)
...
"""
TestRole(InputBucket, OutputBucket, Role, Topics; aws::AWSConfig=AWSConfig()) = elastic_transcoder("POST", "/2012-09-25/roleTests", Dict{String, Any}("InputBucket"=>InputBucket, "OutputBucket"=>OutputBucket, "Role"=>Role, "Topics"=>Topics))
TestRole(InputBucket, OutputBucket, Role, Topics, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("POST", "/2012-09-25/roleTests", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InputBucket"=>InputBucket, "OutputBucket"=>OutputBucket, "Role"=>Role, "Topics"=>Topics), args)); aws=aws)
...
- `ThumbnailConfig`: The ThumbnailConfig object specifies several values, including the Amazon S3 bucket in which you want Elastic Transcoder to save thumbnail files, which users you want to have access to the files, the type of access you want users to have, and the storage class that you want to assign to the files. If you specify values for ContentConfig, you must also specify values for ThumbnailConfig even if you don't want to create thumbnails. If you specify values for ContentConfig and ThumbnailConfig, omit the OutputBucket object.    Bucket: The Amazon S3 bucket in which you want Elastic Transcoder to save thumbnail files.    Permissions (Optional): The Permissions object specifies which users and/or predefined Amazon S3 groups you want to have access to thumbnail files, and the type of access you want them to have. You can grant permissions to a maximum of 30 users and/or predefined Amazon S3 groups.    GranteeType: Specify the type of value that appears in the Grantee object:    Canonical: The value in the Grantee object is either the canonical user ID for an AWS account or an origin access identity for an Amazon CloudFront distribution.  A canonical user ID is not the same as an AWS account number.     Email: The value in the Grantee object is the registered email address of an AWS account.    Group: The value in the Grantee object is one of the following predefined Amazon S3 groups: AllUsers, AuthenticatedUsers, or LogDelivery.      Grantee: The AWS user or group that you want to have access to thumbnail files. To identify the user or group, you can specify the canonical user ID for an AWS account, an origin access identity for a CloudFront distribution, the registered email address of an AWS account, or a predefined Amazon S3 group.     Access: The permission that you want to give to the AWS user that you specified in Grantee. Permissions are granted on the thumbnail files that Elastic Transcoder adds to the bucket. Valid values include:     READ: The grantee can read the thumbnails and metadata for objects that Elastic Transcoder adds to the Amazon S3 bucket.    READ_ACP: The grantee can read the object ACL for thumbnails that Elastic Transcoder adds to the Amazon S3 bucket.    WRITE_ACP: The grantee can write the ACL for the thumbnails that Elastic Transcoder adds to the Amazon S3 bucket.    FULL_CONTROL: The grantee has READ, READ_ACP, and WRITE_ACP permissions for the thumbnails that Elastic Transcoder adds to the Amazon S3 bucket.       StorageClass: The Amazon S3 storage class, Standard or ReducedRedundancy, that you want Elastic Transcoder to assign to the thumbnails that it stores in your Amazon S3 bucket.  
"""
UpdatePipeline(Id; aws::AWSConfig=AWSConfig()) = elastic_transcoder("PUT", "/2012-09-25/pipelines/$(Id)"; aws=aws)
UpdatePipeline(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("PUT", "/2012-09-25/pipelines/$(Id)", args; aws=aws)
...
"""
UpdatePipelineNotifications(Id, Notifications; aws::AWSConfig=AWSConfig()) = elastic_transcoder("POST", "/2012-09-25/pipelines/$(Id)/notifications", Dict{String, Any}("Notifications"=>Notifications))
UpdatePipelineNotifications(Id, Notifications, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("POST", "/2012-09-25/pipelines/$(Id)/notifications", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Notifications"=>Notifications), args)); aws=aws)
...
"""
UpdatePipelineStatus(Id, Status; aws::AWSConfig=AWSConfig()) = elastic_transcoder("POST", "/2012-09-25/pipelines/$(Id)/status", Dict{String, Any}("Status"=>Status))
UpdatePipelineStatus(Id, Status, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = elastic_transcoder("POST", "/2012-09-25/pipelines/$(Id)/status", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Status"=>Status), args)); aws=aws)
