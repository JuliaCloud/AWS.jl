...
function cancel_job(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return elastic_transcoder(
        "DELETE", "/2012-09-25/jobs/$(Id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"OutputKeyPrefix"`: The value, if any, that you want Elastic Transcoder to prepend to the
  names of all files that this job creates, including output files, thumbnails, and
  playlists.
...
- `"AwsKmsKeyArn"`: The AWS Key Management Service (AWS KMS) key that you want to use with
  ...
  you automatically. You need to provide an AWS-KMS key only if you want to use a non-
...
- `"ContentConfig"`: The optional `ContentConfig` object specifies information about the
  ...
  - **Grantee Type**: Specify the type of value that appears in the `Grantee` object:
    - **Canonical**: The value in the `Grantee` object is either the canonical user ID for
      ...
      more information about canonical user IDs, see Access Control List (ACL) Overview in
  ...
  - **Grantee**: The AWS user or group that you want to have access to transcoded files and
    playlists. To identify the user or group, you can specify the canonical user ID for an
  ...
  - **Access**: The permission that you want to give to the AWS user that you specified in
    ...
    bucket, including playlists and video files. Valid values include:
  ...
  - **StorageClass**: The Amazon S3 storage class, `Standard` or `ReducedRedundancy`, that
    you want Elastic Transcoder to assign to the video files and playlists that it stores in
...
- `"Notifications"`: The Amazon Simple Notification Service (Amazon SNS) topic that you want
  ...
  - **Progressing**: The topic ARN for the Amazon Simple Notification Service (Amazon SNS)
    topic that you want to notify when Elastic Transcoder has started to process a job in
    this pipeline. This is the ARN that Amazon SNS returned when you created the topic. For
    more information, see Create a Topic in the Amazon Simple Notification Service Developer
    Guide.
  ...
  - **Warning**: The topic ARN for the Amazon SNS topic that you want to notify when Elastic
    Transcoder encounters a warning condition while processing a job in this pipeline. This
...
- `"OutputBucket"`: The Amazon S3 bucket in which you want Elastic Transcoder to save the
  ...
  have, or change the Amazon S3 storage class, omit `OutputBucket` and specify values for
...
!!! important
    ...
    400 response (`ValidationException`) and does not create the preset. If the settings are
valid for Elastic Transcoder but aren't strictly compliant with the H.264 standard, Elastic
...
function delete_pipeline(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return elastic_transcoder(
        "DELETE", "/2012-09-25/pipelines/$(Id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_preset(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return elastic_transcoder(
        "DELETE", "/2012-09-25/presets/$(Id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
Elastic Transcoder returns all of the jobs currently in the specified pipeline. The response
...
- `status`: To get information about all of the jobs associated with the current AWS account
...
function list_pipelines(; aws_config::AbstractAWSConfig=current_aws_config())
    return elastic_transcoder(
        "GET", "/2012-09-25/pipelines"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_pipelines(
    ...
    return elastic_transcoder(
        "GET", "/2012-09-25/pipelines", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_presets(; aws_config::AbstractAWSConfig=current_aws_config())
    return elastic_transcoder(
        "GET", "/2012-09-25/presets"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_presets(
    ...
    return elastic_transcoder(
        "GET", "/2012-09-25/presets", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function read_job(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return elastic_transcoder(
        "GET", "/2012-09-25/jobs/$(Id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function read_job(
    ...
    return elastic_transcoder(
        "GET", "/2012-09-25/jobs/$(Id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function read_pipeline(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return elastic_transcoder(
        "GET", "/2012-09-25/pipelines/$(Id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function read_preset(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return elastic_transcoder(
        "GET", "/2012-09-25/presets/$(Id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
permissions to let Elastic Transcoder perform tasks associated with the transcoding process.
The action attempts to assume the specified IAM role, checks read access to the input and
output buckets, and tries to send a test notification to Amazon SNS topics that you specify.
...
- `"Notifications"`: The topic ARN for the Amazon Simple Notification Service (Amazon SNS)
  ...
  - **Progressing**: The topic ARN for the Amazon Simple Notification Service (Amazon SNS)
    topic that you want to notify when Elastic Transcoder has started to process jobs that
    are added to this pipeline. This is the ARN that Amazon SNS returned when you created
    the topic.
  - **Complete**: The topic ARN for the Amazon SNS topic that you want to notify when
    Elastic Transcoder has finished processing a job. This is the ARN that Amazon SNS
    returned when you created the topic.
  - **Warning**: The topic ARN for the Amazon SNS topic that you want to notify when Elastic
    Transcoder encounters a warning condition. This is the ARN that Amazon SNS returned when
...
function update_pipeline(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return elastic_transcoder(
        "PUT", "/2012-09-25/pipelines/$(Id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
When you update notifications for a pipeline, Elastic Transcoder returns the values that you
...
to which you submitted the jobs, you have more time to get the job IDs for the jobs that you
want to cancel, and to send a [`cancel_job`](@ref) request.
