...
function delete_schema_mapping(
    ...
    return entityresolution(
        "DELETE", "/schemas/$(schemaName)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_policy(arn; aws_config::AbstractAWSConfig=current_aws_config())
    return entityresolution(
        "GET", "/policies/$(arn)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_policy(
    ...
    return entityresolution(
        "GET", "/policies/$(arn)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_schema_mapping(schemaName; aws_config::AbstractAWSConfig=current_aws_config())
    return entityresolution(
        "GET", "/schemas/$(schemaName)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_schema_mapping(
    ...
    return entityresolution(
        "GET", "/schemas/$(schemaName)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_id_mapping_workflows(; aws_config::AbstractAWSConfig=current_aws_config())
    return entityresolution(
        "GET", "/idmappingworkflows"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_id_mapping_workflows(
    ...
    return entityresolution(
        "GET", "/idmappingworkflows", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_id_namespaces(; aws_config::AbstractAWSConfig=current_aws_config())
    return entityresolution(
        "GET", "/idnamespaces"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_id_namespaces(
    ...
    return entityresolution(
        "GET", "/idnamespaces", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_matching_workflows(; aws_config::AbstractAWSConfig=current_aws_config())
    return entityresolution(
        "GET", "/matchingworkflows"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_matching_workflows(
    ...
    return entityresolution(
        "GET", "/matchingworkflows", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_provider_services(; aws_config::AbstractAWSConfig=current_aws_config())
    return entityresolution(
        "GET", "/providerservices"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_provider_services(
    ...
    return entityresolution(
        "GET", "/providerservices", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_schema_mappings(; aws_config::AbstractAWSConfig=current_aws_config())
    return entityresolution("GET", "/schemas"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_schema_mappings(
    ...
    return entityresolution(
        "GET", "/schemas", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
