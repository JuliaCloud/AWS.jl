...
operations such as [EncryptData](https://docs.aws.amazon.com/payment-cryptography/latest/DataAPIReference/API_EncryptData.html)
or [DecryptData](https://docs.aws.amazon.com/payment-cryptography/latest/DataAPIReference/API_DecryptData.html).

You can associate the alias with any key in the same Amazon Web Services Region. Each alias
is associated with only one key at a time, but a key can have multiple aliases. You can't
create an alias without a key. The alias must be unique in the account and Amazon Web
Services Region, but you can create another alias with the same name in a different Amazon
Web Services Region.
...
These operations don't affect the underlying key. To get the alias that you created, call [ListAliases](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_ListAliases.html).

 **Cross-account use**: This operation can't be used across different Amazon Web Services
accounts.

 **Related operations:**  - [DeleteAlias](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_DeleteAlias.html)
...
"""
create_alias(AliasName; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("CreateAlias", Dict{String, Any}("AliasName"=>AliasName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_alias(AliasName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("CreateAlias", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AliasName"=>AliasName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
keys for cryptographic functions such as encryption and decryption.
 ...
 **Related operations:**  - [DeleteKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_DeleteKey.html)
...
- `"KeyCheckValueAlgorithm"`: The algorithm that Amazon Web Services Payment Cryptography
  uses to calculate the key check value (KCV). It is used to validate the key integrity.
  ...
  of zero and retaining the 3 highest order bytes of the encrypted result.
- `"Tags"`: Assigns one or more tags to the Amazon Web Services Payment Cryptography key.
  Use this parameter to tag a key when it is created. To tag an existing Amazon Web
  Services Payment Cryptography key, use the [TagResource](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_TagResource.html)
  operation.
...
"""
create_key(Exportable, KeyAttributes; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("CreateKey", Dict{String, Any}("Exportable"=>Exportable, "KeyAttributes"=>KeyAttributes); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_key(Exportable, KeyAttributes, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("CreateKey", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Exportable"=>Exportable, "KeyAttributes"=>KeyAttributes), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Each key can have multiple aliases. To get the aliases of all keys, use the [UpdateAlias](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_UpdateAlias.html)
...
to create a new alias. To associate an existing alias with a different key, call [UpdateAlias](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_UpdateAlias.html).

 **Cross-account use:** This operation can't be used across different Amazon Web Services
accounts.

 **Related operations:**  - [CreateAlias](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_CreateAlias.html)
 - [GetAlias](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_GetAlias.html)
 - [ListAliases](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_ListAliases.html)
 - [UpdateAlias](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_UpdateAlias.html)
...
- `alias_name`: A friendly name that you can use to refer Amazon Web Services Payment
  ...
  `alias/ExampleAlias`.
"""
delete_alias(AliasName; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("DeleteAlias", Dict{String, Any}("AliasName"=>AliasName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_alias(AliasName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("DeleteAlias", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AliasName"=>AliasName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
operations using the key. For example, you can't decrypt data that was encrypted by a
deleted Amazon Web Services Payment Cryptography key, and the data may become
unrecoverable. Because key deletion is destructive, Amazon Web Services Payment
...
waiting period is 7 days. During the waiting period, the `KeyState` is `DELETE_PENDING`.
...
other parties are utilizing this key. If you aren't sure, consider deactivating it instead
by calling [StopKeyUsage](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_StopKeyUsage.html).

 **Cross-account use:** This operation can't be used across different Amazon Web Services
accounts.

 **Related operations:**  - [RestoreKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_RestoreKey.html)
...
"""
delete_key(KeyIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("DeleteKey", Dict{String, Any}("KeyIdentifier"=>KeyIdentifier); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_key(KeyIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("DeleteKey", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("KeyIdentifier"=>KeyIdentifier), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
`ExportDukptInitialKey` attribute KSN (`KeySerialNumber`). The generated IPEK does not
persist within Amazon Web Services Payment Cryptography and has to be re-generated each
time during export.

For key exchange using TR-31 or TR-34 key blocks, you can also export optional blocks
within the key block header which contain additional attribute information about the key.
The `KeyVersion` within `KeyBlockHeaders` indicates the version of the key within the key
block. Furthermore, `KeyExportability` within `KeyBlockHeaders` can be used to further
restrict exportability of the key after export from Amazon Web Services Payment
Cryptography.

The `OptionalBlocks` contain the additional data related to the key. For information on
data type that can be included within optional blocks, refer to [ASC X9.143-2022](https://webstore.ansi.org/standards/ascx9/ansix91432022).</p>

!!! note
    Data included in key block headers is signed but transmitted in clear text. Sensitive
or confidential information should not be included in optional blocks. Refer to ASC X9.143-
2022 standard for information on allowed data type. **To export initial keys (KEK) or IPEK
using TR-34**
...
To initiate TR-34 key export, the KRD must obtain an export token by calling [GetParametersForExport](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_GetParametersForExport.html).
...
provides the public key cerificate (also known as KRD wrapping certificate) back to KDH.
...
for `RootCertificatePublicKey`. The KDH, Amazon Web Services Payment Cryptography, will use
the KRD wrapping cerificate to encrypt (wrap) the key under export and signs it with
signing private key to generate a TR-34 WrappedKeyBlock. For more information on TR-34 key
export, see section [Exporting symmetric keys](https://docs.aws.amazon.com/payment-cryptography/latest/userguide/keys-export.html)
in the *Amazon Web Services Payment Cryptography User Guide*.

Set the following parameters: - `ExportAttributes`: Specify export attributes in case of
...
signed the KRD wrapping key certificate.
 ...
 - `WrappingKeyCertificate`: The public key certificate in PEM format (base64 encoded) of
the KRD wrapping key Amazon Web Services Payment Cryptography uses for encryption of the TR-
34 export payload. This certificate must be signed by the root certificate
...
exchange method. To initiate export, generate an asymmetric key pair on the receiving HSM
and obtain the public key certificate in PEM format (base64 encoded) for the purpose of
wrapping and the root certifiate chain. Import the root certificate into Amazon Web
...
signed wrapping key certificate.
 ...
 - `WrappingKeyCertificate`: The public key certificate in PEM format (base64 encoded)
obtained by the receiving HSM and signed by the root certificate
(CertificateAuthorityPublicKeyIdentifier) imported into Amazon Web Services Payment
...
exchange. In TR-31, you must use an initial key such as KEK to encrypt or wrap the key
under export. To establish a KEK, you can use [CreateKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_CreateKey.html)
...
accounts.
 ...
 <p> **Related operations:**  - [GetParametersForExport](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_GetParametersForExport.html)
...
"""
export_key(ExportKeyIdentifier, KeyMaterial; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("ExportKey", Dict{String, Any}("ExportKeyIdentifier"=>ExportKeyIdentifier, "KeyMaterial"=>KeyMaterial); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
export_key(ExportKeyIdentifier, KeyMaterial, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("ExportKey", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ExportKeyIdentifier"=>ExportKeyIdentifier, "KeyMaterial"=>KeyMaterial), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_alias(AliasName; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("GetAlias", Dict{String, Any}("AliasName"=>AliasName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_alias(AliasName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("GetAlias", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AliasName"=>AliasName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
 ...
 **Related operations:**  - [CreateKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_CreateKey.html)
...
"""
get_key(KeyIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("GetKey", Dict{String, Any}("KeyIdentifier"=>KeyIdentifier); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_key(KeyIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("GetKey", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("KeyIdentifier"=>KeyIdentifier), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
before calling [ExportKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_ExportKey.html).
 ...
 **Related operations:**  - [ExportKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_ExportKey.html)
...
- `signing_key_algorithm`: The signing key algorithm to generate a signing key certificate.
  This certificate signs the wrapped key under export within the TR-34 key block.
  `RSA_2048` is the only signing key algorithm allowed.
"""
get_parameters_for_export(KeyMaterialType, SigningKeyAlgorithm; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("GetParametersForExport", Dict{String, Any}("KeyMaterialType"=>KeyMaterialType, "SigningKeyAlgorithm"=>SigningKeyAlgorithm); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_parameters_for_export(KeyMaterialType, SigningKeyAlgorithm, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("GetParametersForExport", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("KeyMaterialType"=>KeyMaterialType, "SigningKeyAlgorithm"=>SigningKeyAlgorithm), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
 ...
 **Related operations:**  - [GetParametersForExport](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_GetParametersForExport.html)
 - [ImportKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_ImportKey.html)
...
- `wrapping_key_algorithm`: The wrapping key algorithm to generate a wrapping key
  certificate. This certificate wraps the key under import.
...
"""
get_parameters_for_import(KeyMaterialType, WrappingKeyAlgorithm; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("GetParametersForImport", Dict{String, Any}("KeyMaterialType"=>KeyMaterialType, "WrappingKeyAlgorithm"=>WrappingKeyAlgorithm); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_parameters_for_import(KeyMaterialType, WrappingKeyAlgorithm, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("GetParametersForImport", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("KeyMaterialType"=>KeyMaterialType, "WrappingKeyAlgorithm"=>WrappingKeyAlgorithm), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Cryptography unencrypted, callers with `GetPublicKeyCertificate` permission can download
the public key certificate of the asymmetric key. You can share the public key certificate
to allow others to encrypt messages and verify signatures outside of Amazon Web Services
Payment Cryptography
...
"""
get_public_key_certificate(KeyIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("GetPublicKeyCertificate", Dict{String, Any}("KeyIdentifier"=>KeyIdentifier); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_public_key_certificate(KeyIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("GetPublicKeyCertificate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("KeyIdentifier"=>KeyIdentifier), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
certificates, or a *trusted public key certificate* under an already established root
...
Web Services Payment Cryptography account.

Set the following parameters:</p> - `KeyMaterial`: `RootCertificatePublicKey`
 - `KeyClass`: `PUBLIC_KEY`
 - `KeyModesOfUse`: `Verify`
 - `KeyUsage`: `TR31_S0_ASYMMETRIC_KEY_FOR_DIGITAL_SIGNATURE`
 - `PublicKeyCertificate`: The public key certificate in PEM format (base64 encoded) of the
private root key under import.
...
`TrustedCertificatePublicKey`
 ...
 - `KeyModesOfUse` and `KeyUsage`: Corresponding to the cryptographic operations such as
wrap, sign, or encrypt that you will allow the trusted public key certificate to perform.
...
34 terminology, the sending party of the key is called Key Distribution Host (KDH) and the
...
To initiate TR-34 key import, the KDH must obtain an import token by calling [GetParametersForImport](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_GetParametersForImport.html).
This operation generates an encryption keypair for the purpose of key import, signs the key
...
signing certificate by calling `ImportKey` for `RootCertificatePublicKey`. For more
...
Set the following parameters: - `KeyMaterial`: Use `Tr34KeyBlock` parameters.
 - `CertificateAuthorityPublicKeyIdentifier`: The `KeyARN` of the certificate chain that
signed the KDH signing key certificate.
 ...
 - `WrappedKeyBlock`: The TR-34 wrapped key material from KDH. It contains the KDH key
under import, wrapped with KRD wrapping certificate and signed by KDH signing private key.
This TR-34 key block is typically generated by the KDH Hardware Security Module (HSM)
outside of Amazon Web Services Payment Cryptography.
 - `SigningKeyCertificate`: The public key certificate in PEM format (base64 encoded) of
the KDH signing key generated under the root certificate
...
exchange method. To initiate import, call [GetParametersForImport](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_GetParametersForImport.html)
...
Next call `ImportKey` with `KeyMaterial` set to `KEY_CRYPTOGRAM` and provide the
`ImportToken` and `KeyAttributes` for the key under import.

 **To import working keys using TR-31**

Amazon Web Services Payment Cryptography uses TR-31 symmetric key exchange norm to import
working keys. A KEK must be established within Amazon Web Services Payment Cryptography by
using TR-34 key import or by using [CreateKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_CreateKey.html).
To initiate a TR-31 key import, set the following parameters: - `KeyMaterial`: Use
`Tr31KeyBlock` parameters.
...
accounts.
 ...
 <p> **Related operations:**  - [ExportKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_ExportKey.html)
 - [GetParametersForImport](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_GetParametersForImport.html)
...
- `"Tags"`: Assigns one or more tags to the Amazon Web Services Payment Cryptography key.
  ...
  deny permission to the key.
"""
import_key(KeyMaterial; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("ImportKey", Dict{String, Any}("KeyMaterial"=>KeyMaterial); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
import_key(KeyMaterial, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("ImportKey", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("KeyMaterial"=>KeyMaterial), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
of all the aliases. When the response contains only a subset of aliases, it includes a
`NextToken` value. Use this value in a subsequent `ListAliases` request to get more
aliases. When you receive a response with no NextToken (or an empty or null value), that
...
- `"NextToken"`: Use this parameter in a subsequent request after you receive a response
  with truncated results. Set it to the value of `NextToken` from the truncated response
  you just received.
"""
list_aliases(; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("ListAliases"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_aliases(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("ListAliases", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
This is a paginated operation, which means that each response might contain only a subset
of all the keys. When the response contains only a subset of keys, it includes a
`NextToken` value. Use this value in a subsequent `ListKeys` request to get more keys. When
you receive a response with no NextToken (or an empty or null value), that means there are
no more keys to get.
...
- `"NextToken"`: Use this parameter in a subsequent request after you receive a response
  ...
  you just received.
"""
list_keys(; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("ListKeys"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_keys(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("ListKeys", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
`NextToken` value. Use this value in a subsequent `ListTagsForResource` request to get more
tags. When you receive a response with no NextToken (or an empty or null value), that means
there are no more tags to get.

 **Cross-account use:** This operation can't be used across different Amazon Web Services
accounts.

 **Related operations:**  - [TagResource](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_TagResource.html)
...
- `"NextToken"`: Use this parameter in a subsequent request after you receive a response
  ...
  you just received.
"""
list_tags_for_resource(ResourceArn; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_tags_for_resource(ResourceArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
contains the date and time after which the `Key` will be deleted. After `Key` is restored,
the `KeyState` is `CREATE_COMPLETE`, and the value for `deletePendingTimestamp` is removed.
...
- `key_identifier`: The `KeyARN` of the key to be restored within Amazon Web Services
  Payment Cryptography.
"""
restore_key(KeyIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("RestoreKey", Dict{String, Any}("KeyIdentifier"=>KeyIdentifier); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
restore_key(KeyIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("RestoreKey", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("KeyIdentifier"=>KeyIdentifier), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
 ...
 **Related operations:**  - [StopKeyUsage](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_StopKeyUsage.html)

# Arguments

- `key_identifier`: The `KeyArn` of the key.
"""
start_key_usage(KeyIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("StartKeyUsage", Dict{String, Any}("KeyIdentifier"=>KeyIdentifier); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_key_usage(KeyIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("StartKeyUsage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("KeyIdentifier"=>KeyIdentifier), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
to deactivate a key. You can enable the key in the future by calling [StartKeyUsage](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_StartKeyUsage.html).
...
- `key_identifier`: The `KeyArn` of the key.
"""
stop_key_usage(KeyIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("StopKeyUsage", Dict{String, Any}("KeyIdentifier"=>KeyIdentifier); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
stop_key_usage(KeyIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("StopKeyUsage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("KeyIdentifier"=>KeyIdentifier), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)

"""
    tag_resource(resource_arn, tags)
    tag_resource(resource_arn, tags, params::Dict{String,<:Any})

Adds or edits tags on an Amazon Web Services Payment Cryptography key.</p>

!!! note
    Tagging or untagging an Amazon Web Services Payment Cryptography key can allow or deny
permission to the key.Each tag consists of a tag key and a tag value, both of which are
...
value. You can also add tags to an Amazon Web Services Payment Cryptography key when you
create it with [CreateKey](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_CreateKey.html).

 **Cross-account use:** This operation can't be used across different Amazon Web Services
accounts.

 <p> **Related operations:**  - [ListTagsForResource](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_ListTagsForResource.html)
 - [UntagResource](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_UntagResource.html)
...
- `tags`: One or more tags. Each tag consists of a tag key and a tag value. The tag value
  ...
  !!! important
      Don't include personal, confidential or sensitive information in this field. This
  field may be displayed in plaintext in CloudTrail logs and other output.To use this
  ...
  field may be displayed in plaintext in CloudTrail logs and other output.
"""
tag_resource(ResourceArn, Tags; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
tag_resource(ResourceArn, Tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)

"""
    untag_resource(resource_arn, tag_keys)
    untag_resource(resource_arn, tag_keys, params::Dict{String,<:Any})

Deletes a tag from an Amazon Web Services Payment Cryptography key.</p>

!!! note
    Tagging or untagging an Amazon Web Services Payment Cryptography key can allow or deny
permission to the key. **Cross-account use:** This operation can't be used across different
...
- `tag_keys`: One or more tag keys. Don't include the tag values.
  ...
  To confirm that the operation succeeded, use the [ListTagsForResource](https://docs.aws.amazon.com/payment-cryptography/latest/APIReference/API_ListTagsForResource.html)
  operation.
"""
untag_resource(ResourceArn, TagKeys; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
untag_resource(ResourceArn, TagKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_alias(AliasName; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("UpdateAlias", Dict{String, Any}("AliasName"=>AliasName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_alias(AliasName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = payment_cryptography("UpdateAlias", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AliasName"=>AliasName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
