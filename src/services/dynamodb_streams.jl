...
"""
DescribeStream(StreamArn) = dynamodb_streams("DescribeStream", Dict{String, Any}("StreamArn"=>StreamArn))
DescribeStream(StreamArn, args::AbstractDict{String, <:Any}) = dynamodb_streams("DescribeStream", Dict{String, Any}("StreamArn"=>StreamArn, args...))
...
"""
GetRecords(ShardIterator) = dynamodb_streams("GetRecords", Dict{String, Any}("ShardIterator"=>ShardIterator))
GetRecords(ShardIterator, args::AbstractDict{String, <:Any}) = dynamodb_streams("GetRecords", Dict{String, Any}("ShardIterator"=>ShardIterator, args...))
...
"""
GetShardIterator(ShardId, ShardIteratorType, StreamArn) = dynamodb_streams("GetShardIterator", Dict{String, Any}("ShardId"=>ShardId, "ShardIteratorType"=>ShardIteratorType, "StreamArn"=>StreamArn))
GetShardIterator(ShardId, ShardIteratorType, StreamArn, args::AbstractDict{String, <:Any}) = dynamodb_streams("GetShardIterator", Dict{String, Any}("ShardId"=>ShardId, "ShardIteratorType"=>ShardIteratorType, "StreamArn"=>StreamArn, args...))
...
ListStreams(args::AbstractDict{String, <:Any}) = dynamodb_streams("ListStreams", args)
