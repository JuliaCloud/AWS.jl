...
"""
AnalyzeDocument(Document, FeatureTypes) = textract("AnalyzeDocument", Dict{String, Any}("Document"=>Document, "FeatureTypes"=>FeatureTypes))
AnalyzeDocument(Document, FeatureTypes, args::AbstractDict{String, <: Any}) = textract("AnalyzeDocument", Dict{String, Any}("Document"=>Document, "FeatureTypes"=>FeatureTypes, args...))
...
"""
DetectDocumentText(Document) = textract("DetectDocumentText", Dict{String, Any}("Document"=>Document))
DetectDocumentText(Document, args::AbstractDict{String, <: Any}) = textract("DetectDocumentText", Dict{String, Any}("Document"=>Document, args...))
...
"""
GetDocumentAnalysis(JobId) = textract("GetDocumentAnalysis", Dict{String, Any}("JobId"=>JobId))
GetDocumentAnalysis(JobId, args::AbstractDict{String, <: Any}) = textract("GetDocumentAnalysis", Dict{String, Any}("JobId"=>JobId, args...))
...
NextToken => If the previous response was incomplete (because there are more blocks to retrieve), Amazon Textract returns a pagination token in the response. You can use this pagination token to retrieve the next set of blocks.
"""
GetDocumentTextDetection(JobId) = textract("GetDocumentTextDetection", Dict{String, Any}("JobId"=>JobId))
GetDocumentTextDetection(JobId, args::AbstractDict{String, <: Any}) = textract("GetDocumentTextDetection", Dict{String, Any}("JobId"=>JobId, args...))
...
"""
StartDocumentAnalysis(DocumentLocation, FeatureTypes) = textract("StartDocumentAnalysis", Dict{String, Any}("DocumentLocation"=>DocumentLocation, "FeatureTypes"=>FeatureTypes))
StartDocumentAnalysis(DocumentLocation, FeatureTypes, args::AbstractDict{String, <: Any}) = textract("StartDocumentAnalysis", Dict{String, Any}("DocumentLocation"=>DocumentLocation, "FeatureTypes"=>FeatureTypes, args...))
...
NotificationChannel => The Amazon SNS topic ARN that you want Amazon Textract to publish the completion status of the operation to. 
"""
StartDocumentTextDetection(DocumentLocation) = textract("StartDocumentTextDetection", Dict{String, Any}("DocumentLocation"=>DocumentLocation))
StartDocumentTextDetection(DocumentLocation, args::AbstractDict{String, <: Any}) = textract("StartDocumentTextDetection", Dict{String, Any}("DocumentLocation"=>DocumentLocation, args...))
