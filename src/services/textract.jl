...
AnalyzeDocument(Document, FeatureTypes; aws_config::AWSConfig=AWS.aws_config) = textract("AnalyzeDocument", Dict{String, Any}("Document"=>Document, "FeatureTypes"=>FeatureTypes); aws_config=aws_config)
AnalyzeDocument(Document, FeatureTypes, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = textract("AnalyzeDocument", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Document"=>Document, "FeatureTypes"=>FeatureTypes), args)); aws_config=aws_config)
...
DetectDocumentText(Document; aws_config::AWSConfig=AWS.aws_config) = textract("DetectDocumentText", Dict{String, Any}("Document"=>Document); aws_config=aws_config)
DetectDocumentText(Document, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = textract("DetectDocumentText", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Document"=>Document), args)); aws_config=aws_config)
...
GetDocumentAnalysis(JobId; aws_config::AWSConfig=AWS.aws_config) = textract("GetDocumentAnalysis", Dict{String, Any}("JobId"=>JobId); aws_config=aws_config)
GetDocumentAnalysis(JobId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = textract("GetDocumentAnalysis", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("JobId"=>JobId), args)); aws_config=aws_config)
...
GetDocumentTextDetection(JobId; aws_config::AWSConfig=AWS.aws_config) = textract("GetDocumentTextDetection", Dict{String, Any}("JobId"=>JobId); aws_config=aws_config)
GetDocumentTextDetection(JobId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = textract("GetDocumentTextDetection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("JobId"=>JobId), args)); aws_config=aws_config)
...
StartDocumentAnalysis(DocumentLocation, FeatureTypes; aws_config::AWSConfig=AWS.aws_config) = textract("StartDocumentAnalysis", Dict{String, Any}("DocumentLocation"=>DocumentLocation, "FeatureTypes"=>FeatureTypes); aws_config=aws_config)
StartDocumentAnalysis(DocumentLocation, FeatureTypes, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = textract("StartDocumentAnalysis", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DocumentLocation"=>DocumentLocation, "FeatureTypes"=>FeatureTypes), args)); aws_config=aws_config)
...
StartDocumentTextDetection(DocumentLocation; aws_config::AWSConfig=AWS.aws_config) = textract("StartDocumentTextDetection", Dict{String, Any}("DocumentLocation"=>DocumentLocation); aws_config=aws_config)
StartDocumentTextDetection(DocumentLocation, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = textract("StartDocumentTextDetection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DocumentLocation"=>DocumentLocation), args)); aws_config=aws_config)
