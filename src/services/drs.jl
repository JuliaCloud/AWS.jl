...
function describe_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return drs("POST", "/DescribeJobs"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function describe_jobs(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return drs("POST", "/DescribeJobs", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
"""
function describe_recovery_instances end

function describe_recovery_instances(; aws_config::AbstractAWSConfig=current_aws_config())
    return drs(
        "POST", "/DescribeRecoveryInstances"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
"""
function describe_recovery_snapshots end
...
"""
function describe_source_networks end

function describe_source_networks(; aws_config::AbstractAWSConfig=current_aws_config())
    return drs(
        "POST", "/DescribeSourceNetworks"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function initialize_service(; aws_config::AbstractAWSConfig=current_aws_config())
    return drs("POST", "/InitializeService"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
"""
function list_extensible_source_servers end
...
"""
function list_launch_actions end
...
"""
function list_staging_accounts end

function list_staging_accounts(; aws_config::AbstractAWSConfig=current_aws_config())
    return drs("GET", "/ListStagingAccounts"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_staging_accounts(
    ...
    return drs(
        "GET", "/ListStagingAccounts", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_tags_for_resource(
    ...
    return drs("GET", "/tags/$(resourceArn)"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
"""
function start_source_network_recovery end
...
- `"usePrivateIP"`: Whether to use Private IP for the failback replication of the Recovery
  Instance.
"""
function update_failback_replication_configuration end
