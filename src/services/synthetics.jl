...
"""
associate_resource(ResourceArn, groupIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("PATCH", "/group/$(groupIdentifier)/associate", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
associate_resource(ResourceArn, groupIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("PATCH", "/group/$(groupIdentifier)/associate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
creating a new IAM role for the canary, you also need the `iam:CreateRole`,
`iam:CreatePolicy` and `iam:AttachRolePolicy` permissions. For more information, see [Necessary Roles and Permissions](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries_Roles).
...
outbound calls over the internet. For more information, see [Security Considerations for Synthetics Canaries](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/servicelens_canaries_security.html).
...
Creates a group which you can use to associate canaries with each other, including cross-
Region canaries. Using groups can help you with managing and automating your canaries, and
you can also view aggregated run results and statistics for all canaries in a group.

Groups are global resources. When you create a group, it is replicated across Amazon Web
Services Regions, and you can view it and add canaries to it from any Region. Although the
group ARN format reflects the Region name where it was created, a group is not constrained
to any Region. This means that you can put canaries from multiple Regions into the same
...
- `"Tags"`: A list of key-value pairs to associate with the group. You can associate as
  ...
  that have certain tag values.
"""
create_group(Name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/group", Dict{String, Any}("Name"=>Name); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_group(Name, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/group", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
delete these resources after you delete the canary.
...
Type: Boolean
"""
delete_canary(name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("DELETE", "/canary/$(name)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_canary(name, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("DELETE", "/canary/$(name)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_group(groupIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("DELETE", "/group/$(groupIdentifier)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_group(groupIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("DELETE", "/group/$(groupIdentifier)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
have authorization to view all the canaries that you specify in your request. If you do not
...
"""
describe_canaries(; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/canaries"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_canaries(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/canaries", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: A token that indicates that there is more data available. You can use this
  ...
  results.
"""
describe_canaries_last_run(; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/canaries/last-run"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_canaries_last_run(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/canaries/last-run", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: A token that indicates that there is more data available. You can use this
  ...
  results.
"""
describe_runtime_versions(; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/runtime-versions"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_runtime_versions(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/runtime-versions", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `group_identifier`: Specifies the group. You can specify the group name, the ARN, or the
  group ID as the `GroupIdentifier`.
"""
disassociate_resource(ResourceArn, groupIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("PATCH", "/group/$(groupIdentifier)/disassociate", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
disassociate_resource(ResourceArn, groupIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("PATCH", "/group/$(groupIdentifier)/disassociate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
that you want. To get a list of canaries and their names, use [DescribeCanaries](https://docs.aws.amazon.com/AmazonSynthetics/latest/APIReference/API_DescribeCanaries.html).

# Arguments

- `name`: The name of the canary that you want details for.
"""
get_canary(name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("GET", "/canary/$(name)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_canary(name, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("GET", "/canary/$(name)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_canary_runs(name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/canary/$(name)/runs"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_canary_runs(name, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/canary/$(name)/runs", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_group(groupIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("GET", "/group/$(groupIdentifier)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_group(groupIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("GET", "/group/$(groupIdentifier)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"MaxResults"`: Specify this parameter to limit how many groups are returned each time
  you use the `ListAssociatedGroups` operation. If you omit this parameter, the default of
  20 is used.
- `"NextToken"`: A token that indicates that there is more data available. You can use this
  token in a subsequent operation to retrieve the next set of results.
"""
list_associated_groups(resourceArn; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/resource/$(resourceArn)/groups"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_associated_groups(resourceArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/resource/$(resourceArn)/groups", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: A token that indicates that there is more data available. You can use this
  token in a subsequent operation to retrieve the next set of results.
"""
list_group_resources(groupIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/group/$(groupIdentifier)/resources"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_group_resources(groupIdentifier, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/group/$(groupIdentifier)/resources", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: A token that indicates that there is more data available. You can use this
  token in a subsequent operation to retrieve the next set of results.
"""
list_groups(; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/groups"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_groups(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/groups", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `resource_arn`: The ARN of the canary or group that you want to view tags for.

  The ARN format of a canary is `arn:aws:synthetics:*Region*:*account-id*:canary:*canary-
  name* `.

  The ARN format of a group is `arn:aws:synthetics:*Region*:*account-id*:group:*group-name*
  `
"""
list_tags_for_resource(resourceArn; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("GET", "/tags/$(resourceArn)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_tags_for_resource(resourceArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("GET", "/tags/$(resourceArn)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
schedule, use [GetCanary](https://docs.aws.amazon.com/AmazonSynthetics/latest/APIReference/API_GetCanary.html).

# Arguments

- `name`: The name of the canary that you want to run. To find canary names, use [DescribeCanaries](https://docs.aws.amazon.com/AmazonSynthetics/latest/APIReference/API_DescribeCanaries.html).
"""
start_canary(name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/canary/$(name)/start"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_canary(name, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/canary/$(name)/start", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
stop_canary(name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/canary/$(name)/stop"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
stop_canary(name, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/canary/$(name)/stop", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `resource_arn`: The ARN of the canary or group that you're adding tags to.
  ...
  `
"""
tag_resource(Tags, resourceArn; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/tags/$(resourceArn)", Dict{String, Any}("Tags"=>Tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
tag_resource(Tags, resourceArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("POST", "/tags/$(resourceArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Tags"=>Tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `resource_arn`: The ARN of the canary or group that you're removing tags from.
...
"""
untag_resource(resourceArn, tagKeys; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("DELETE", "/tags/$(resourceArn)", Dict{String, Any}("tagKeys"=>tagKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
untag_resource(resourceArn, tagKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("DELETE", "/tags/$(resourceArn)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("tagKeys"=>tagKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"VpcConfig"`: If this canary is to test an endpoint in a VPC, this structure contains
  ...
  information, see [ Running a Canary in a VPC](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries_VPC.html).
"""
update_canary(name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("PATCH", "/canary/$(name)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_canary(name, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics("PATCH", "/canary/$(name)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
