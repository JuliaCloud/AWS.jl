...
- `"Tags"`: A list of key-value pairs to associate with the group. You can associate as
  ...
  that have certain tag values.
"""
create_group(Name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics(
    "POST",
    "/group",
...
Type: Boolean
"""
delete_canary(name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics(
...
"""
delete_group(groupIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) =
    synthetics(
        "DELETE",
...
"""
describe_canaries(; aws_config::AbstractAWSConfig=current_aws_config()) =
...
- `"NextToken"`: A token that indicates that there is more data available. You can use this
  ...
  results.
"""
describe_canaries_last_run(; aws_config::AbstractAWSConfig=current_aws_config()) =
    synthetics(
...
- `"NextToken"`: A token that indicates that there is more data available. You can use this
  ...
  results.
"""
describe_runtime_versions(; aws_config::AbstractAWSConfig=current_aws_config()) =
    synthetics(
...
"""
get_canary(name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics(
...
"""
get_canary_runs(name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics(
    "POST",
    "/canary/$(name)/runs";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
get_group(groupIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics(
    "GET",
    "/group/$(groupIdentifier)";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"NextToken"`: A token that indicates that there is more data available. You can use this
  token in a subsequent operation to retrieve the next set of results.
"""
list_associated_groups(resourceArn; aws_config::AbstractAWSConfig=current_aws_config()) =
    synthetics(
        "POST",
...
- `"NextToken"`: A token that indicates that there is more data available. You can use this
  token in a subsequent operation to retrieve the next set of results.
"""
list_group_resources(groupIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) =
    synthetics(
        "POST",
...
"""
start_canary(name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics(
    "POST",
    "/canary/$(name)/start";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
stop_canary(name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics(
    "POST",
    "/canary/$(name)/stop";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"VpcConfig"`: If this canary is to test an endpoint in a VPC, this structure contains
  ...
  information, see [ Running a Canary in a VPC](https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/CloudWatch_Synthetics_Canaries_VPC.html).
"""
update_canary(name; aws_config::AbstractAWSConfig=current_aws_config()) = synthetics(
