...
"""
approve_assignment(AssignmentId; aws_config::AbstractAWSConfig=global_aws_config()) = mturk(
    "ApproveAssignment",
...
associate_qualification_with_worker(
    ...
    Dict{String,Any}("QualificationTypeId" => QualificationTypeId, "WorkerId" => WorkerId);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
)
...
- `"UniqueRequestToken"`:  A unique identifier for this request which allows you to retry
  ...
  made after the 24 hour limit could create duplicate HITs.
"""
create_hitwith_hittype(
    HITTypeId, LifetimeInSeconds; aws_config::AbstractAWSConfig=global_aws_config()
) = mturk(
    "CreateHITWithHITType",
    Dict{String,Any}("HITTypeId" => HITTypeId, "LifetimeInSeconds" => LifetimeInSeconds);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
)
...
"""
create_worker_block(Reason, WorkerId; aws_config::AbstractAWSConfig=global_aws_config()) =
    mturk(
        "CreateWorkerBlock",
...
"""
delete_hit(HITId; aws_config::AbstractAWSConfig=global_aws_config()) = mturk(
    "DeleteHIT",
...
"""
delete_worker_block(WorkerId; aws_config::AbstractAWSConfig=global_aws_config()) = mturk(
    "DeleteWorkerBlock",
...
"""
get_account_balance(; aws_config::AbstractAWSConfig=global_aws_config()) =
    mturk("GetAccountBalance"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_assignment(AssignmentId; aws_config::AbstractAWSConfig=global_aws_config()) = mturk(
    "GetAssignment",
    Dict{String,Any}("AssignmentId" => AssignmentId);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
get_hit(HITId; aws_config::AbstractAWSConfig=global_aws_config()) = mturk(
    "GetHIT",
    Dict{String,Any}("HITId" => HITId);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
list_assignments_for_hit(HITId; aws_config::AbstractAWSConfig=global_aws_config()) = mturk(
...
- `"NextToken"`: Pagination token
"""
list_bonus_payments(; aws_config::AbstractAWSConfig=global_aws_config()) =
    mturk("ListBonusPayments"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: Pagination token
"""
list_hits(; aws_config::AbstractAWSConfig=global_aws_config()) =
    mturk("ListHITs"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
function list_hits(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=global_aws_config()
)
...
"""
list_qualification_requests(; aws_config::AbstractAWSConfig=global_aws_config()) = mturk(
...
"""
list_reviewable_hits(; aws_config::AbstractAWSConfig=global_aws_config()) =
    mturk("ListReviewableHITs"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: Pagination token
"""
list_worker_blocks(; aws_config::AbstractAWSConfig=global_aws_config()) =
    mturk("ListWorkerBlocks"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_hitreview_status(HITId; aws_config::AbstractAWSConfig=global_aws_config()) = mturk(
...
"""
update_hittype_of_hit(HITId, HITTypeId; aws_config::AbstractAWSConfig=global_aws_config()) =
    mturk(
        "UpdateHITTypeOfHIT",
...
"""
update_notification_settings(HITTypeId; aws_config::AbstractAWSConfig=global_aws_config()) =
    mturk(
