...
"""
AcceptQualificationRequest(QualificationRequestId; aws::AWSConfig=AWSConfig()) = mturk("AcceptQualificationRequest", Dict{String, Any}("QualificationRequestId"=>QualificationRequestId); aws=aws)
AcceptQualificationRequest(QualificationRequestId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("AcceptQualificationRequest", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QualificationRequestId"=>QualificationRequestId), args)); aws=aws)
...
"""
ApproveAssignment(AssignmentId; aws::AWSConfig=AWSConfig()) = mturk("ApproveAssignment", Dict{String, Any}("AssignmentId"=>AssignmentId); aws=aws)
ApproveAssignment(AssignmentId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("ApproveAssignment", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AssignmentId"=>AssignmentId), args)); aws=aws)
...
"""
AssociateQualificationWithWorker(QualificationTypeId, WorkerId; aws::AWSConfig=AWSConfig()) = mturk("AssociateQualificationWithWorker", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, "WorkerId"=>WorkerId); aws=aws)
AssociateQualificationWithWorker(QualificationTypeId, WorkerId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("AssociateQualificationWithWorker", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, "WorkerId"=>WorkerId), args)); aws=aws)
...
"""
CreateAdditionalAssignmentsForHIT(HITId, NumberOfAdditionalAssignments; aws::AWSConfig=AWSConfig()) = mturk("CreateAdditionalAssignmentsForHIT", Dict{String, Any}("HITId"=>HITId, "NumberOfAdditionalAssignments"=>NumberOfAdditionalAssignments); aws=aws)
CreateAdditionalAssignmentsForHIT(HITId, NumberOfAdditionalAssignments, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("CreateAdditionalAssignmentsForHIT", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HITId"=>HITId, "NumberOfAdditionalAssignments"=>NumberOfAdditionalAssignments), args)); aws=aws)
...
"""
CreateHIT(AssignmentDurationInSeconds, Description, LifetimeInSeconds, Reward, Title; aws::AWSConfig=AWSConfig()) = mturk("CreateHIT", Dict{String, Any}("AssignmentDurationInSeconds"=>AssignmentDurationInSeconds, "Description"=>Description, "LifetimeInSeconds"=>LifetimeInSeconds, "Reward"=>Reward, "Title"=>Title); aws=aws)
CreateHIT(AssignmentDurationInSeconds, Description, LifetimeInSeconds, Reward, Title, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("CreateHIT", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AssignmentDurationInSeconds"=>AssignmentDurationInSeconds, "Description"=>Description, "LifetimeInSeconds"=>LifetimeInSeconds, "Reward"=>Reward, "Title"=>Title), args)); aws=aws)
...
- `QualificationRequirements`:  Conditions that a Worker's Qualifications must meet in order to accept the HIT. A HIT can have between zero and ten Qualification requirements. All requirements must be met in order for a Worker to accept the HIT. Additionally, other actions can be restricted using the ActionsGuarded field on each QualificationRequirement structure. 
"""
CreateHITType(AssignmentDurationInSeconds, Description, Reward, Title; aws::AWSConfig=AWSConfig()) = mturk("CreateHITType", Dict{String, Any}("AssignmentDurationInSeconds"=>AssignmentDurationInSeconds, "Description"=>Description, "Reward"=>Reward, "Title"=>Title); aws=aws)
CreateHITType(AssignmentDurationInSeconds, Description, Reward, Title, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("CreateHITType", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AssignmentDurationInSeconds"=>AssignmentDurationInSeconds, "Description"=>Description, "Reward"=>Reward, "Title"=>Title), args)); aws=aws)
...
- `UniqueRequestToken`:  A unique identifier for this request which allows you to retry the call on error without creating duplicate HITs. This is useful in cases such as network timeouts where it is unclear whether or not the call succeeded on the server. If the HIT already exists in the system from a previous call using the same UniqueRequestToken, subsequent calls will return a AWS.MechanicalTurk.HitAlreadyExists error with a message containing the HITId.    Note: It is your responsibility to ensure uniqueness of the token. The unique token expires after 24 hours. Subsequent calls using the same UniqueRequestToken made after the 24 hour limit could create duplicate HITs.  
"""
CreateHITWithHITType(HITTypeId, LifetimeInSeconds; aws::AWSConfig=AWSConfig()) = mturk("CreateHITWithHITType", Dict{String, Any}("HITTypeId"=>HITTypeId, "LifetimeInSeconds"=>LifetimeInSeconds); aws=aws)
CreateHITWithHITType(HITTypeId, LifetimeInSeconds, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("CreateHITWithHITType", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HITTypeId"=>HITTypeId, "LifetimeInSeconds"=>LifetimeInSeconds), args)); aws=aws)
...
"""
CreateQualificationType(Description, Name, QualificationTypeStatus; aws::AWSConfig=AWSConfig()) = mturk("CreateQualificationType", Dict{String, Any}("Description"=>Description, "Name"=>Name, "QualificationTypeStatus"=>QualificationTypeStatus); aws=aws)
CreateQualificationType(Description, Name, QualificationTypeStatus, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("CreateQualificationType", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Description"=>Description, "Name"=>Name, "QualificationTypeStatus"=>QualificationTypeStatus), args)); aws=aws)
...
"""
CreateWorkerBlock(Reason, WorkerId; aws::AWSConfig=AWSConfig()) = mturk("CreateWorkerBlock", Dict{String, Any}("Reason"=>Reason, "WorkerId"=>WorkerId); aws=aws)
CreateWorkerBlock(Reason, WorkerId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("CreateWorkerBlock", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Reason"=>Reason, "WorkerId"=>WorkerId), args)); aws=aws)
...
"""
DeleteHIT(HITId; aws::AWSConfig=AWSConfig()) = mturk("DeleteHIT", Dict{String, Any}("HITId"=>HITId); aws=aws)
DeleteHIT(HITId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("DeleteHIT", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HITId"=>HITId), args)); aws=aws)
...
"""
DeleteQualificationType(QualificationTypeId; aws::AWSConfig=AWSConfig()) = mturk("DeleteQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId); aws=aws)
DeleteQualificationType(QualificationTypeId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("DeleteQualificationType", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QualificationTypeId"=>QualificationTypeId), args)); aws=aws)
...
"""
DeleteWorkerBlock(WorkerId; aws::AWSConfig=AWSConfig()) = mturk("DeleteWorkerBlock", Dict{String, Any}("WorkerId"=>WorkerId); aws=aws)
DeleteWorkerBlock(WorkerId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("DeleteWorkerBlock", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("WorkerId"=>WorkerId), args)); aws=aws)
...
"""
DisassociateQualificationFromWorker(QualificationTypeId, WorkerId; aws::AWSConfig=AWSConfig()) = mturk("DisassociateQualificationFromWorker", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, "WorkerId"=>WorkerId); aws=aws)
DisassociateQualificationFromWorker(QualificationTypeId, WorkerId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("DisassociateQualificationFromWorker", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, "WorkerId"=>WorkerId), args)); aws=aws)
...
"""
GetAccountBalance(; aws::AWSConfig=AWSConfig()) = mturk("GetAccountBalance"; aws=aws)
GetAccountBalance(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("GetAccountBalance", args; aws=aws)
...
"""
GetAssignment(AssignmentId; aws::AWSConfig=AWSConfig()) = mturk("GetAssignment", Dict{String, Any}("AssignmentId"=>AssignmentId); aws=aws)
GetAssignment(AssignmentId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("GetAssignment", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AssignmentId"=>AssignmentId), args)); aws=aws)
...
"""
GetFileUploadURL(AssignmentId, QuestionIdentifier; aws::AWSConfig=AWSConfig()) = mturk("GetFileUploadURL", Dict{String, Any}("AssignmentId"=>AssignmentId, "QuestionIdentifier"=>QuestionIdentifier); aws=aws)
GetFileUploadURL(AssignmentId, QuestionIdentifier, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("GetFileUploadURL", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AssignmentId"=>AssignmentId, "QuestionIdentifier"=>QuestionIdentifier), args)); aws=aws)
...
"""
GetHIT(HITId; aws::AWSConfig=AWSConfig()) = mturk("GetHIT", Dict{String, Any}("HITId"=>HITId); aws=aws)
GetHIT(HITId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("GetHIT", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HITId"=>HITId), args)); aws=aws)
...
"""
GetQualificationScore(QualificationTypeId, WorkerId; aws::AWSConfig=AWSConfig()) = mturk("GetQualificationScore", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, "WorkerId"=>WorkerId); aws=aws)
GetQualificationScore(QualificationTypeId, WorkerId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("GetQualificationScore", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, "WorkerId"=>WorkerId), args)); aws=aws)
...
"""
GetQualificationType(QualificationTypeId; aws::AWSConfig=AWSConfig()) = mturk("GetQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId); aws=aws)
GetQualificationType(QualificationTypeId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("GetQualificationType", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QualificationTypeId"=>QualificationTypeId), args)); aws=aws)
...
"""
ListAssignmentsForHIT(HITId; aws::AWSConfig=AWSConfig()) = mturk("ListAssignmentsForHIT", Dict{String, Any}("HITId"=>HITId); aws=aws)
ListAssignmentsForHIT(HITId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("ListAssignmentsForHIT", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HITId"=>HITId), args)); aws=aws)
...
- `NextToken`: Pagination token
"""
ListBonusPayments(; aws::AWSConfig=AWSConfig()) = mturk("ListBonusPayments"; aws=aws)
ListBonusPayments(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("ListBonusPayments", args; aws=aws)
...
- `NextToken`: Pagination token
"""
ListHITs(; aws::AWSConfig=AWSConfig()) = mturk("ListHITs"; aws=aws)
ListHITs(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("ListHITs", args; aws=aws)
...
- `NextToken`: Pagination Token
"""
ListHITsForQualificationType(QualificationTypeId; aws::AWSConfig=AWSConfig()) = mturk("ListHITsForQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId); aws=aws)
ListHITsForQualificationType(QualificationTypeId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("ListHITsForQualificationType", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QualificationTypeId"=>QualificationTypeId), args)); aws=aws)
...
- `QualificationTypeId`: The ID of the QualificationType.
"""
ListQualificationRequests(; aws::AWSConfig=AWSConfig()) = mturk("ListQualificationRequests"; aws=aws)
ListQualificationRequests(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("ListQualificationRequests", args; aws=aws)
...
"""
ListQualificationTypes(MustBeRequestable; aws::AWSConfig=AWSConfig()) = mturk("ListQualificationTypes", Dict{String, Any}("MustBeRequestable"=>MustBeRequestable); aws=aws)
ListQualificationTypes(MustBeRequestable, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("ListQualificationTypes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MustBeRequestable"=>MustBeRequestable), args)); aws=aws)
...
"""
ListReviewPolicyResultsForHIT(HITId; aws::AWSConfig=AWSConfig()) = mturk("ListReviewPolicyResultsForHIT", Dict{String, Any}("HITId"=>HITId); aws=aws)
ListReviewPolicyResultsForHIT(HITId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("ListReviewPolicyResultsForHIT", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HITId"=>HITId), args)); aws=aws)
...
"""
ListReviewableHITs(; aws::AWSConfig=AWSConfig()) = mturk("ListReviewableHITs"; aws=aws)
ListReviewableHITs(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("ListReviewableHITs", args; aws=aws)
...
- `NextToken`: Pagination token
"""
ListWorkerBlocks(; aws::AWSConfig=AWSConfig()) = mturk("ListWorkerBlocks"; aws=aws)
ListWorkerBlocks(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("ListWorkerBlocks", args; aws=aws)
...
"""
ListWorkersWithQualificationType(QualificationTypeId; aws::AWSConfig=AWSConfig()) = mturk("ListWorkersWithQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId); aws=aws)
ListWorkersWithQualificationType(QualificationTypeId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("ListWorkersWithQualificationType", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QualificationTypeId"=>QualificationTypeId), args)); aws=aws)
...
"""
NotifyWorkers(MessageText, Subject, WorkerIds; aws::AWSConfig=AWSConfig()) = mturk("NotifyWorkers", Dict{String, Any}("MessageText"=>MessageText, "Subject"=>Subject, "WorkerIds"=>WorkerIds); aws=aws)
NotifyWorkers(MessageText, Subject, WorkerIds, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("NotifyWorkers", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MessageText"=>MessageText, "Subject"=>Subject, "WorkerIds"=>WorkerIds), args)); aws=aws)
...
"""
RejectAssignment(AssignmentId, RequesterFeedback; aws::AWSConfig=AWSConfig()) = mturk("RejectAssignment", Dict{String, Any}("AssignmentId"=>AssignmentId, "RequesterFeedback"=>RequesterFeedback); aws=aws)
RejectAssignment(AssignmentId, RequesterFeedback, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("RejectAssignment", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AssignmentId"=>AssignmentId, "RequesterFeedback"=>RequesterFeedback), args)); aws=aws)
...
"""
RejectQualificationRequest(QualificationRequestId; aws::AWSConfig=AWSConfig()) = mturk("RejectQualificationRequest", Dict{String, Any}("QualificationRequestId"=>QualificationRequestId); aws=aws)
RejectQualificationRequest(QualificationRequestId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("RejectQualificationRequest", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QualificationRequestId"=>QualificationRequestId), args)); aws=aws)
...
"""
SendBonus(AssignmentId, BonusAmount, Reason, WorkerId; aws::AWSConfig=AWSConfig()) = mturk("SendBonus", Dict{String, Any}("AssignmentId"=>AssignmentId, "BonusAmount"=>BonusAmount, "Reason"=>Reason, "WorkerId"=>WorkerId); aws=aws)
SendBonus(AssignmentId, BonusAmount, Reason, WorkerId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("SendBonus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AssignmentId"=>AssignmentId, "BonusAmount"=>BonusAmount, "Reason"=>Reason, "WorkerId"=>WorkerId), args)); aws=aws)
...
"""
SendTestEventNotification(Notification, TestEventType; aws::AWSConfig=AWSConfig()) = mturk("SendTestEventNotification", Dict{String, Any}("Notification"=>Notification, "TestEventType"=>TestEventType); aws=aws)
SendTestEventNotification(Notification, TestEventType, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("SendTestEventNotification", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Notification"=>Notification, "TestEventType"=>TestEventType), args)); aws=aws)
...
"""
UpdateExpirationForHIT(ExpireAt, HITId; aws::AWSConfig=AWSConfig()) = mturk("UpdateExpirationForHIT", Dict{String, Any}("ExpireAt"=>ExpireAt, "HITId"=>HITId); aws=aws)
UpdateExpirationForHIT(ExpireAt, HITId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("UpdateExpirationForHIT", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ExpireAt"=>ExpireAt, "HITId"=>HITId), args)); aws=aws)
...
"""
UpdateHITReviewStatus(HITId; aws::AWSConfig=AWSConfig()) = mturk("UpdateHITReviewStatus", Dict{String, Any}("HITId"=>HITId); aws=aws)
UpdateHITReviewStatus(HITId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("UpdateHITReviewStatus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HITId"=>HITId), args)); aws=aws)
...
"""
UpdateHITTypeOfHIT(HITId, HITTypeId; aws::AWSConfig=AWSConfig()) = mturk("UpdateHITTypeOfHIT", Dict{String, Any}("HITId"=>HITId, "HITTypeId"=>HITTypeId); aws=aws)
UpdateHITTypeOfHIT(HITId, HITTypeId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("UpdateHITTypeOfHIT", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HITId"=>HITId, "HITTypeId"=>HITTypeId), args)); aws=aws)
...
"""
UpdateNotificationSettings(HITTypeId; aws::AWSConfig=AWSConfig()) = mturk("UpdateNotificationSettings", Dict{String, Any}("HITTypeId"=>HITTypeId); aws=aws)
UpdateNotificationSettings(HITTypeId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("UpdateNotificationSettings", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HITTypeId"=>HITTypeId), args)); aws=aws)
...
- `TestDurationInSeconds`: The number of seconds the Worker has to complete the Qualification test, starting from the time the Worker requests the Qualification.
"""
UpdateQualificationType(QualificationTypeId; aws::AWSConfig=AWSConfig()) = mturk("UpdateQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId); aws=aws)
UpdateQualificationType(QualificationTypeId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mturk("UpdateQualificationType", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QualificationTypeId"=>QualificationTypeId), args)); aws=aws)
