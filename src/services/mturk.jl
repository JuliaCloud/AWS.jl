...
"""
AcceptQualificationRequest(QualificationRequestId) = mturk("AcceptQualificationRequest", Dict{String, Any}("QualificationRequestId"=>QualificationRequestId))
AcceptQualificationRequest(QualificationRequestId, args::AbstractDict{String, <:Any}) = mturk("AcceptQualificationRequest", Dict{String, Any}("QualificationRequestId"=>QualificationRequestId, args...))
...
"""
ApproveAssignment(AssignmentId) = mturk("ApproveAssignment", Dict{String, Any}("AssignmentId"=>AssignmentId))
ApproveAssignment(AssignmentId, args::AbstractDict{String, <:Any}) = mturk("ApproveAssignment", Dict{String, Any}("AssignmentId"=>AssignmentId, args...))
...
"""
AssociateQualificationWithWorker(QualificationTypeId, WorkerId) = mturk("AssociateQualificationWithWorker", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, "WorkerId"=>WorkerId))
AssociateQualificationWithWorker(QualificationTypeId, WorkerId, args::AbstractDict{String, <:Any}) = mturk("AssociateQualificationWithWorker", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, "WorkerId"=>WorkerId, args...))
...
"""
CreateAdditionalAssignmentsForHIT(HITId, NumberOfAdditionalAssignments) = mturk("CreateAdditionalAssignmentsForHIT", Dict{String, Any}("HITId"=>HITId, "NumberOfAdditionalAssignments"=>NumberOfAdditionalAssignments))
CreateAdditionalAssignmentsForHIT(HITId, NumberOfAdditionalAssignments, args::AbstractDict{String, <:Any}) = mturk("CreateAdditionalAssignmentsForHIT", Dict{String, Any}("HITId"=>HITId, "NumberOfAdditionalAssignments"=>NumberOfAdditionalAssignments, args...))
...
"""
CreateHIT(AssignmentDurationInSeconds, Description, LifetimeInSeconds, Reward, Title) = mturk("CreateHIT", Dict{String, Any}("AssignmentDurationInSeconds"=>AssignmentDurationInSeconds, "Description"=>Description, "LifetimeInSeconds"=>LifetimeInSeconds, "Reward"=>Reward, "Title"=>Title))
CreateHIT(AssignmentDurationInSeconds, Description, LifetimeInSeconds, Reward, Title, args::AbstractDict{String, <:Any}) = mturk("CreateHIT", Dict{String, Any}("AssignmentDurationInSeconds"=>AssignmentDurationInSeconds, "Description"=>Description, "LifetimeInSeconds"=>LifetimeInSeconds, "Reward"=>Reward, "Title"=>Title, args...))
...
- `QualificationRequirements`:  Conditions that a Worker's Qualifications must meet in order to accept the HIT. A HIT can have between zero and ten Qualification requirements. All requirements must be met in order for a Worker to accept the HIT. Additionally, other actions can be restricted using the ActionsGuarded field on each QualificationRequirement structure. 
"""
CreateHITType(AssignmentDurationInSeconds, Description, Reward, Title) = mturk("CreateHITType", Dict{String, Any}("AssignmentDurationInSeconds"=>AssignmentDurationInSeconds, "Description"=>Description, "Reward"=>Reward, "Title"=>Title))
CreateHITType(AssignmentDurationInSeconds, Description, Reward, Title, args::AbstractDict{String, <:Any}) = mturk("CreateHITType", Dict{String, Any}("AssignmentDurationInSeconds"=>AssignmentDurationInSeconds, "Description"=>Description, "Reward"=>Reward, "Title"=>Title, args...))
...
- `UniqueRequestToken`:  A unique identifier for this request which allows you to retry the call on error without creating duplicate HITs. This is useful in cases such as network timeouts where it is unclear whether or not the call succeeded on the server. If the HIT already exists in the system from a previous call using the same UniqueRequestToken, subsequent calls will return a AWS.MechanicalTurk.HitAlreadyExists error with a message containing the HITId.    Note: It is your responsibility to ensure uniqueness of the token. The unique token expires after 24 hours. Subsequent calls using the same UniqueRequestToken made after the 24 hour limit could create duplicate HITs.  
"""
CreateHITWithHITType(HITTypeId, LifetimeInSeconds) = mturk("CreateHITWithHITType", Dict{String, Any}("HITTypeId"=>HITTypeId, "LifetimeInSeconds"=>LifetimeInSeconds))
CreateHITWithHITType(HITTypeId, LifetimeInSeconds, args::AbstractDict{String, <:Any}) = mturk("CreateHITWithHITType", Dict{String, Any}("HITTypeId"=>HITTypeId, "LifetimeInSeconds"=>LifetimeInSeconds, args...))
...
"""
CreateQualificationType(Description, Name, QualificationTypeStatus) = mturk("CreateQualificationType", Dict{String, Any}("Description"=>Description, "Name"=>Name, "QualificationTypeStatus"=>QualificationTypeStatus))
CreateQualificationType(Description, Name, QualificationTypeStatus, args::AbstractDict{String, <:Any}) = mturk("CreateQualificationType", Dict{String, Any}("Description"=>Description, "Name"=>Name, "QualificationTypeStatus"=>QualificationTypeStatus, args...))
...
"""
CreateWorkerBlock(Reason, WorkerId) = mturk("CreateWorkerBlock", Dict{String, Any}("Reason"=>Reason, "WorkerId"=>WorkerId))
CreateWorkerBlock(Reason, WorkerId, args::AbstractDict{String, <:Any}) = mturk("CreateWorkerBlock", Dict{String, Any}("Reason"=>Reason, "WorkerId"=>WorkerId, args...))
...
"""
DeleteHIT(HITId) = mturk("DeleteHIT", Dict{String, Any}("HITId"=>HITId))
DeleteHIT(HITId, args::AbstractDict{String, <:Any}) = mturk("DeleteHIT", Dict{String, Any}("HITId"=>HITId, args...))
...
"""
DeleteQualificationType(QualificationTypeId) = mturk("DeleteQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId))
DeleteQualificationType(QualificationTypeId, args::AbstractDict{String, <:Any}) = mturk("DeleteQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, args...))
...
"""
DeleteWorkerBlock(WorkerId) = mturk("DeleteWorkerBlock", Dict{String, Any}("WorkerId"=>WorkerId))
DeleteWorkerBlock(WorkerId, args::AbstractDict{String, <:Any}) = mturk("DeleteWorkerBlock", Dict{String, Any}("WorkerId"=>WorkerId, args...))
...
"""
DisassociateQualificationFromWorker(QualificationTypeId, WorkerId) = mturk("DisassociateQualificationFromWorker", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, "WorkerId"=>WorkerId))
DisassociateQualificationFromWorker(QualificationTypeId, WorkerId, args::AbstractDict{String, <:Any}) = mturk("DisassociateQualificationFromWorker", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, "WorkerId"=>WorkerId, args...))
...
GetAccountBalance(args::AbstractDict{String, <:Any}) = mturk("GetAccountBalance", args)
...
"""
GetAssignment(AssignmentId) = mturk("GetAssignment", Dict{String, Any}("AssignmentId"=>AssignmentId))
GetAssignment(AssignmentId, args::AbstractDict{String, <:Any}) = mturk("GetAssignment", Dict{String, Any}("AssignmentId"=>AssignmentId, args...))
...
"""
GetFileUploadURL(AssignmentId, QuestionIdentifier) = mturk("GetFileUploadURL", Dict{String, Any}("AssignmentId"=>AssignmentId, "QuestionIdentifier"=>QuestionIdentifier))
GetFileUploadURL(AssignmentId, QuestionIdentifier, args::AbstractDict{String, <:Any}) = mturk("GetFileUploadURL", Dict{String, Any}("AssignmentId"=>AssignmentId, "QuestionIdentifier"=>QuestionIdentifier, args...))
...
"""
GetHIT(HITId) = mturk("GetHIT", Dict{String, Any}("HITId"=>HITId))
GetHIT(HITId, args::AbstractDict{String, <:Any}) = mturk("GetHIT", Dict{String, Any}("HITId"=>HITId, args...))
...
"""
GetQualificationScore(QualificationTypeId, WorkerId) = mturk("GetQualificationScore", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, "WorkerId"=>WorkerId))
GetQualificationScore(QualificationTypeId, WorkerId, args::AbstractDict{String, <:Any}) = mturk("GetQualificationScore", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, "WorkerId"=>WorkerId, args...))
...
"""
GetQualificationType(QualificationTypeId) = mturk("GetQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId))
GetQualificationType(QualificationTypeId, args::AbstractDict{String, <:Any}) = mturk("GetQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, args...))
...
"""
ListAssignmentsForHIT(HITId) = mturk("ListAssignmentsForHIT", Dict{String, Any}("HITId"=>HITId))
ListAssignmentsForHIT(HITId, args::AbstractDict{String, <:Any}) = mturk("ListAssignmentsForHIT", Dict{String, Any}("HITId"=>HITId, args...))
...
ListBonusPayments(args::AbstractDict{String, <:Any}) = mturk("ListBonusPayments", args)
...
ListHITs(args::AbstractDict{String, <:Any}) = mturk("ListHITs", args)
...
- `NextToken`: Pagination Token
"""
ListHITsForQualificationType(QualificationTypeId) = mturk("ListHITsForQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId))
ListHITsForQualificationType(QualificationTypeId, args::AbstractDict{String, <:Any}) = mturk("ListHITsForQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, args...))
...
ListQualificationRequests(args::AbstractDict{String, <:Any}) = mturk("ListQualificationRequests", args)
...
"""
ListQualificationTypes(MustBeRequestable) = mturk("ListQualificationTypes", Dict{String, Any}("MustBeRequestable"=>MustBeRequestable))
ListQualificationTypes(MustBeRequestable, args::AbstractDict{String, <:Any}) = mturk("ListQualificationTypes", Dict{String, Any}("MustBeRequestable"=>MustBeRequestable, args...))
...
"""
ListReviewPolicyResultsForHIT(HITId) = mturk("ListReviewPolicyResultsForHIT", Dict{String, Any}("HITId"=>HITId))
ListReviewPolicyResultsForHIT(HITId, args::AbstractDict{String, <:Any}) = mturk("ListReviewPolicyResultsForHIT", Dict{String, Any}("HITId"=>HITId, args...))
...
ListReviewableHITs(args::AbstractDict{String, <:Any}) = mturk("ListReviewableHITs", args)
...
ListWorkerBlocks(args::AbstractDict{String, <:Any}) = mturk("ListWorkerBlocks", args)
...
"""
ListWorkersWithQualificationType(QualificationTypeId) = mturk("ListWorkersWithQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId))
ListWorkersWithQualificationType(QualificationTypeId, args::AbstractDict{String, <:Any}) = mturk("ListWorkersWithQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, args...))
...
"""
NotifyWorkers(MessageText, Subject, WorkerIds) = mturk("NotifyWorkers", Dict{String, Any}("MessageText"=>MessageText, "Subject"=>Subject, "WorkerIds"=>WorkerIds))
NotifyWorkers(MessageText, Subject, WorkerIds, args::AbstractDict{String, <:Any}) = mturk("NotifyWorkers", Dict{String, Any}("MessageText"=>MessageText, "Subject"=>Subject, "WorkerIds"=>WorkerIds, args...))
...
"""
RejectAssignment(AssignmentId, RequesterFeedback) = mturk("RejectAssignment", Dict{String, Any}("AssignmentId"=>AssignmentId, "RequesterFeedback"=>RequesterFeedback))
RejectAssignment(AssignmentId, RequesterFeedback, args::AbstractDict{String, <:Any}) = mturk("RejectAssignment", Dict{String, Any}("AssignmentId"=>AssignmentId, "RequesterFeedback"=>RequesterFeedback, args...))
...
"""
RejectQualificationRequest(QualificationRequestId) = mturk("RejectQualificationRequest", Dict{String, Any}("QualificationRequestId"=>QualificationRequestId))
RejectQualificationRequest(QualificationRequestId, args::AbstractDict{String, <:Any}) = mturk("RejectQualificationRequest", Dict{String, Any}("QualificationRequestId"=>QualificationRequestId, args...))
...
"""
SendBonus(AssignmentId, BonusAmount, Reason, WorkerId) = mturk("SendBonus", Dict{String, Any}("AssignmentId"=>AssignmentId, "BonusAmount"=>BonusAmount, "Reason"=>Reason, "WorkerId"=>WorkerId))
SendBonus(AssignmentId, BonusAmount, Reason, WorkerId, args::AbstractDict{String, <:Any}) = mturk("SendBonus", Dict{String, Any}("AssignmentId"=>AssignmentId, "BonusAmount"=>BonusAmount, "Reason"=>Reason, "WorkerId"=>WorkerId, args...))
...
"""
SendTestEventNotification(Notification, TestEventType) = mturk("SendTestEventNotification", Dict{String, Any}("Notification"=>Notification, "TestEventType"=>TestEventType))
SendTestEventNotification(Notification, TestEventType, args::AbstractDict{String, <:Any}) = mturk("SendTestEventNotification", Dict{String, Any}("Notification"=>Notification, "TestEventType"=>TestEventType, args...))
...
"""
UpdateExpirationForHIT(ExpireAt, HITId) = mturk("UpdateExpirationForHIT", Dict{String, Any}("ExpireAt"=>ExpireAt, "HITId"=>HITId))
UpdateExpirationForHIT(ExpireAt, HITId, args::AbstractDict{String, <:Any}) = mturk("UpdateExpirationForHIT", Dict{String, Any}("ExpireAt"=>ExpireAt, "HITId"=>HITId, args...))
...
"""
UpdateHITReviewStatus(HITId) = mturk("UpdateHITReviewStatus", Dict{String, Any}("HITId"=>HITId))
UpdateHITReviewStatus(HITId, args::AbstractDict{String, <:Any}) = mturk("UpdateHITReviewStatus", Dict{String, Any}("HITId"=>HITId, args...))
...
"""
UpdateHITTypeOfHIT(HITId, HITTypeId) = mturk("UpdateHITTypeOfHIT", Dict{String, Any}("HITId"=>HITId, "HITTypeId"=>HITTypeId))
UpdateHITTypeOfHIT(HITId, HITTypeId, args::AbstractDict{String, <:Any}) = mturk("UpdateHITTypeOfHIT", Dict{String, Any}("HITId"=>HITId, "HITTypeId"=>HITTypeId, args...))
...
"""
UpdateNotificationSettings(HITTypeId) = mturk("UpdateNotificationSettings", Dict{String, Any}("HITTypeId"=>HITTypeId))
UpdateNotificationSettings(HITTypeId, args::AbstractDict{String, <:Any}) = mturk("UpdateNotificationSettings", Dict{String, Any}("HITTypeId"=>HITTypeId, args...))
...
- `TestDurationInSeconds`: The number of seconds the Worker has to complete the Qualification test, starting from the time the Worker requests the Qualification.
"""
UpdateQualificationType(QualificationTypeId) = mturk("UpdateQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId))
UpdateQualificationType(QualificationTypeId, args::AbstractDict{String, <:Any}) = mturk("UpdateQualificationType", Dict{String, Any}("QualificationTypeId"=>QualificationTypeId, args...))
