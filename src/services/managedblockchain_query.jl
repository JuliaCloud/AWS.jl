...
function get_transaction(
    network, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return managedblockchain_query(
        "POST",
        "/get-transaction",
...
"""
function list_token_balances(tokenFilter; aws_config::AbstractAWSConfig=current_aws_config())
    return managedblockchain_query(
        "POST",
        "/list-token-balances",
...
- `"transactionId"`: The identifier of a Bitcoin transaction. It is generated when a
  transaction is created.   transactionId is only supported on the Bitcoin networks.
"""
function list_transaction_events(network; aws_config::AbstractAWSConfig=current_aws_config())
    return managedblockchain_query(
        "POST",
