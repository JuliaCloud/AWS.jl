...
"""
CreateEnvironmentEC2(instanceType, name) = cloud9("CreateEnvironmentEC2", Dict{String, Any}("instanceType"=>instanceType, "name"=>name))
CreateEnvironmentEC2(instanceType, name, args::AbstractDict{String, <:Any}) = cloud9("CreateEnvironmentEC2", Dict{String, Any}("instanceType"=>instanceType, "name"=>name, args...))
...
"""
CreateEnvironmentMembership(environmentId, permissions, userArn) = cloud9("CreateEnvironmentMembership", Dict{String, Any}("environmentId"=>environmentId, "permissions"=>permissions, "userArn"=>userArn))
CreateEnvironmentMembership(environmentId, permissions, userArn, args::AbstractDict{String, <:Any}) = cloud9("CreateEnvironmentMembership", Dict{String, Any}("environmentId"=>environmentId, "permissions"=>permissions, "userArn"=>userArn, args...))
...
"""
DeleteEnvironment(environmentId) = cloud9("DeleteEnvironment", Dict{String, Any}("environmentId"=>environmentId))
DeleteEnvironment(environmentId, args::AbstractDict{String, <:Any}) = cloud9("DeleteEnvironment", Dict{String, Any}("environmentId"=>environmentId, args...))
...
"""
DeleteEnvironmentMembership(environmentId, userArn) = cloud9("DeleteEnvironmentMembership", Dict{String, Any}("environmentId"=>environmentId, "userArn"=>userArn))
DeleteEnvironmentMembership(environmentId, userArn, args::AbstractDict{String, <:Any}) = cloud9("DeleteEnvironmentMembership", Dict{String, Any}("environmentId"=>environmentId, "userArn"=>userArn, args...))
...
DescribeEnvironmentMemberships(args::AbstractDict{String, <:Any}) = cloud9("DescribeEnvironmentMemberships", args)
...
"""
DescribeEnvironmentStatus(environmentId) = cloud9("DescribeEnvironmentStatus", Dict{String, Any}("environmentId"=>environmentId))
DescribeEnvironmentStatus(environmentId, args::AbstractDict{String, <:Any}) = cloud9("DescribeEnvironmentStatus", Dict{String, Any}("environmentId"=>environmentId, args...))
...
"""
DescribeEnvironments(environmentIds) = cloud9("DescribeEnvironments", Dict{String, Any}("environmentIds"=>environmentIds))
DescribeEnvironments(environmentIds, args::AbstractDict{String, <:Any}) = cloud9("DescribeEnvironments", Dict{String, Any}("environmentIds"=>environmentIds, args...))
...
ListEnvironments(args::AbstractDict{String, <:Any}) = cloud9("ListEnvironments", args)
...
"""
ListTagsForResource(ResourceARN) = cloud9("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN))
ListTagsForResource(ResourceARN, args::AbstractDict{String, <:Any}) = cloud9("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN, args...))
...
"""
TagResource(ResourceARN, Tags) = cloud9("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags))
TagResource(ResourceARN, Tags, args::AbstractDict{String, <:Any}) = cloud9("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceARN, TagKeys) = cloud9("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys))
UntagResource(ResourceARN, TagKeys, args::AbstractDict{String, <:Any}) = cloud9("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys, args...))
...
"""
UpdateEnvironment(environmentId) = cloud9("UpdateEnvironment", Dict{String, Any}("environmentId"=>environmentId))
UpdateEnvironment(environmentId, args::AbstractDict{String, <:Any}) = cloud9("UpdateEnvironment", Dict{String, Any}("environmentId"=>environmentId, args...))
...
"""
UpdateEnvironmentMembership(environmentId, permissions, userArn) = cloud9("UpdateEnvironmentMembership", Dict{String, Any}("environmentId"=>environmentId, "permissions"=>permissions, "userArn"=>userArn))
UpdateEnvironmentMembership(environmentId, permissions, userArn, args::AbstractDict{String, <:Any}) = cloud9("UpdateEnvironmentMembership", Dict{String, Any}("environmentId"=>environmentId, "permissions"=>permissions, "userArn"=>userArn, args...))
