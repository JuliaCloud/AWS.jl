...
function create_aws_log_source(
    sources, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return securitylake(
        "POST",
        "/v1/datalake/logsources/aws",
...
function delete_data_lake(
    regions, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return securitylake(
        "POST",
        "/v1/datalake/delete",
...
"""
function update_data_lake(configurations; aws_config::AbstractAWSConfig=current_aws_config())
    return securitylake(
        "PUT",
        "/v1/datalake",
