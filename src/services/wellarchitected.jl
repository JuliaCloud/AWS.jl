...
Up to 10 lenses can be associated with a workload in a single API operation. A maximum of 20
lenses can be associated with a workload.
...
!!! note
    **Disclaimer**
    ...
    Those other accounts may continue to access and use your shared custom lenses even if
    you delete the custom lenses from your own Amazon Web Services account or terminate your
...
!!! note
    **Disclaimer**
    ...
    applicable law, providing adequate privacy notices, and obtaining necessary consents for
...
Shared access to a review template is not removed until the review template share invitation
is deleted.
...
!!! note
    **Disclaimer**
    ...
    that Amazon Web Services will make your review template available to those other
    accounts.
...
!!! note
    **Disclaimer**
    ...
    other accounts may continue to access and use your shared profile even if you delete the
    profile from your own Amazon Web Services account or terminate your Amazon Web Services
    account.
...
!!! note
    **Disclaimer**
    ...
    providing adequate privacy notices, and obtaining necessary consents for processing such
    data.
...
function export_lens(LensAlias; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET", "/lenses/$(LensAlias)/export"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_global_settings(; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET", "/global-settings"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_lens(LensAlias; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET", "/lenses/$(LensAlias)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_lens(
    ...
    return wellarchitected(
        "GET", "/lenses/$(LensAlias)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_profile(ProfileArn; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET", "/profiles/$(ProfileArn)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_profile_template(; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET", "/profileTemplate"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_profile_template(
    ...
    return wellarchitected(
        "GET", "/profileTemplate", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_workload(WorkloadId; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET", "/workloads/$(WorkloadId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_lens_shares(LensAlias; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET", "/lenses/$(LensAlias)/shares"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_lenses(; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected("GET", "/lenses"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_lenses(
    ...
    return wellarchitected(
        "GET", "/lenses", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_notifications(; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "POST", "/notifications"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_notifications(
    ...
    return wellarchitected(
        "POST", "/notifications", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_profile_shares(ProfileArn; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET", "/profiles/$(ProfileArn)/shares"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_profiles(; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET", "/profileSummaries"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_profiles(
    ...
    return wellarchitected(
        "GET", "/profileSummaries", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_review_templates(; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET", "/reviewTemplates"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_review_templates(
    ...
    return wellarchitected(
        "GET", "/reviewTemplates", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_share_invitations(; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET", "/shareInvitations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_share_invitations(
    ...
    return wellarchitected(
        "GET", "/shareInvitations", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_tags_for_resource(
    ...
    return wellarchitected(
        "GET", "/tags/$(WorkloadArn)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_tags_for_resource(
    ...
    return wellarchitected(
        "GET", "/tags/$(WorkloadArn)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_workloads(; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "POST", "/workloadsSummaries"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_workloads(
    ...
    return wellarchitected(
        "POST", "/workloadsSummaries", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_global_settings(; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "PATCH", "/global-settings"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_global_settings(
    ...
    return wellarchitected(
        "PATCH", "/global-settings", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_profile(ProfileArn; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "PATCH", "/profiles/$(ProfileArn)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"DiscoveryConfig"`: Well-Architected discovery configuration settings to associate to the
  workload.
...
function update_workload(WorkloadId; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "PATCH", "/workloads/$(WorkloadId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
