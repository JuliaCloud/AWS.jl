...
"""
function get_review_template(TemplateArn; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET",
        "/reviewTemplates/$(TemplateArn)";
        aws_config=aws_config,
...
- `"Status"`:
"""
function list_workload_shares(WorkloadId; aws_config::AbstractAWSConfig=current_aws_config())
    return wellarchitected(
        "GET",
        "/workloads/$(WorkloadId)/shares";
        aws_config=aws_config,
