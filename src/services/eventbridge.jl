...
"""
ActivateEventSource(Name; aws::AWSConfig=AWSConfig()) = eventbridge("ActivateEventSource", Dict{String, Any}("Name"=>Name); aws=aws)
ActivateEventSource(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("ActivateEventSource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
CreateEventBus(Name; aws::AWSConfig=AWSConfig()) = eventbridge("CreateEventBus", Dict{String, Any}("Name"=>Name); aws=aws)
CreateEventBus(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("CreateEventBus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
CreatePartnerEventSource(Account, Name; aws::AWSConfig=AWSConfig()) = eventbridge("CreatePartnerEventSource", Dict{String, Any}("Account"=>Account, "Name"=>Name); aws=aws)
CreatePartnerEventSource(Account, Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("CreatePartnerEventSource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Account"=>Account, "Name"=>Name), args)); aws=aws)
...
"""
DeactivateEventSource(Name; aws::AWSConfig=AWSConfig()) = eventbridge("DeactivateEventSource", Dict{String, Any}("Name"=>Name); aws=aws)
DeactivateEventSource(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("DeactivateEventSource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
DeleteEventBus(Name; aws::AWSConfig=AWSConfig()) = eventbridge("DeleteEventBus", Dict{String, Any}("Name"=>Name); aws=aws)
DeleteEventBus(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("DeleteEventBus", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
DeletePartnerEventSource(Account, Name; aws::AWSConfig=AWSConfig()) = eventbridge("DeletePartnerEventSource", Dict{String, Any}("Account"=>Account, "Name"=>Name); aws=aws)
DeletePartnerEventSource(Account, Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("DeletePartnerEventSource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Account"=>Account, "Name"=>Name), args)); aws=aws)
...
"""
DeleteRule(Name; aws::AWSConfig=AWSConfig()) = eventbridge("DeleteRule", Dict{String, Any}("Name"=>Name); aws=aws)
DeleteRule(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("DeleteRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
DescribeEventBus(; aws::AWSConfig=AWSConfig()) = eventbridge("DescribeEventBus"; aws=aws)
DescribeEventBus(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("DescribeEventBus", args; aws=aws)
...
"""
DescribeEventSource(Name; aws::AWSConfig=AWSConfig()) = eventbridge("DescribeEventSource", Dict{String, Any}("Name"=>Name); aws=aws)
DescribeEventSource(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("DescribeEventSource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
DescribePartnerEventSource(Name; aws::AWSConfig=AWSConfig()) = eventbridge("DescribePartnerEventSource", Dict{String, Any}("Name"=>Name); aws=aws)
DescribePartnerEventSource(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("DescribePartnerEventSource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
- `EventBusName`: The event bus associated with the rule. If you omit this, the default event bus is used.
"""
DescribeRule(Name; aws::AWSConfig=AWSConfig()) = eventbridge("DescribeRule", Dict{String, Any}("Name"=>Name); aws=aws)
DescribeRule(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("DescribeRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
- `EventBusName`: The event bus associated with the rule. If you omit this, the default event bus is used.
"""
DisableRule(Name; aws::AWSConfig=AWSConfig()) = eventbridge("DisableRule", Dict{String, Any}("Name"=>Name); aws=aws)
DisableRule(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("DisableRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
- `EventBusName`: The event bus associated with the rule. If you omit this, the default event bus is used.
"""
EnableRule(Name; aws::AWSConfig=AWSConfig()) = eventbridge("EnableRule", Dict{String, Any}("Name"=>Name); aws=aws)
EnableRule(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("EnableRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
ListEventBuses(; aws::AWSConfig=AWSConfig()) = eventbridge("ListEventBuses"; aws=aws)
ListEventBuses(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("ListEventBuses", args; aws=aws)
...
- `NextToken`: The token returned by a previous call to retrieve the next set of results.
"""
ListEventSources(; aws::AWSConfig=AWSConfig()) = eventbridge("ListEventSources"; aws=aws)
ListEventSources(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("ListEventSources", args; aws=aws)
...
"""
ListPartnerEventSourceAccounts(EventSourceName; aws::AWSConfig=AWSConfig()) = eventbridge("ListPartnerEventSourceAccounts", Dict{String, Any}("EventSourceName"=>EventSourceName); aws=aws)
ListPartnerEventSourceAccounts(EventSourceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("ListPartnerEventSourceAccounts", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EventSourceName"=>EventSourceName), args)); aws=aws)
...
- `NextToken`: The token returned by a previous call to this operation. Specifying this retrieves the next set of results.
"""
ListPartnerEventSources(NamePrefix; aws::AWSConfig=AWSConfig()) = eventbridge("ListPartnerEventSources", Dict{String, Any}("NamePrefix"=>NamePrefix); aws=aws)
ListPartnerEventSources(NamePrefix, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("ListPartnerEventSources", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("NamePrefix"=>NamePrefix), args)); aws=aws)
...
- `NextToken`: The token returned by a previous call to retrieve the next set of results.
"""
ListRuleNamesByTarget(TargetArn; aws::AWSConfig=AWSConfig()) = eventbridge("ListRuleNamesByTarget", Dict{String, Any}("TargetArn"=>TargetArn); aws=aws)
ListRuleNamesByTarget(TargetArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("ListRuleNamesByTarget", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TargetArn"=>TargetArn), args)); aws=aws)
...
- `NextToken`: The token returned by a previous call to retrieve the next set of results.
"""
ListRules(; aws::AWSConfig=AWSConfig()) = eventbridge("ListRules"; aws=aws)
ListRules(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("ListRules", args; aws=aws)
...
"""
ListTagsForResource(ResourceARN; aws::AWSConfig=AWSConfig()) = eventbridge("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN); aws=aws)
ListTagsForResource(ResourceARN, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN), args)); aws=aws)
...
- `NextToken`: The token returned by a previous call to retrieve the next set of results.
"""
ListTargetsByRule(Rule; aws::AWSConfig=AWSConfig()) = eventbridge("ListTargetsByRule", Dict{String, Any}("Rule"=>Rule); aws=aws)
ListTargetsByRule(Rule, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("ListTargetsByRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Rule"=>Rule), args)); aws=aws)
...
"""
PutEvents(Entries; aws::AWSConfig=AWSConfig()) = eventbridge("PutEvents", Dict{String, Any}("Entries"=>Entries); aws=aws)
PutEvents(Entries, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("PutEvents", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Entries"=>Entries), args)); aws=aws)
...
"""
PutPartnerEvents(Entries; aws::AWSConfig=AWSConfig()) = eventbridge("PutPartnerEvents", Dict{String, Any}("Entries"=>Entries); aws=aws)
PutPartnerEvents(Entries, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("PutPartnerEvents", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Entries"=>Entries), args)); aws=aws)
...
- `EventBusName`: The event bus associated with the rule. If you omit this, the default event bus is used.
"""
PutPermission(Action, Principal, StatementId; aws::AWSConfig=AWSConfig()) = eventbridge("PutPermission", Dict{String, Any}("Action"=>Action, "Principal"=>Principal, "StatementId"=>StatementId); aws=aws)
PutPermission(Action, Principal, StatementId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("PutPermission", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Action"=>Action, "Principal"=>Principal, "StatementId"=>StatementId), args)); aws=aws)
...
"""
PutRule(Name; aws::AWSConfig=AWSConfig()) = eventbridge("PutRule", Dict{String, Any}("Name"=>Name); aws=aws)
PutRule(Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("PutRule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name), args)); aws=aws)
...
"""
PutTargets(Rule, Targets; aws::AWSConfig=AWSConfig()) = eventbridge("PutTargets", Dict{String, Any}("Rule"=>Rule, "Targets"=>Targets); aws=aws)
PutTargets(Rule, Targets, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("PutTargets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Rule"=>Rule, "Targets"=>Targets), args)); aws=aws)
...
"""
RemovePermission(StatementId; aws::AWSConfig=AWSConfig()) = eventbridge("RemovePermission", Dict{String, Any}("StatementId"=>StatementId); aws=aws)
RemovePermission(StatementId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("RemovePermission", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StatementId"=>StatementId), args)); aws=aws)
...
"""
RemoveTargets(Ids, Rule; aws::AWSConfig=AWSConfig()) = eventbridge("RemoveTargets", Dict{String, Any}("Ids"=>Ids, "Rule"=>Rule); aws=aws)
RemoveTargets(Ids, Rule, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("RemoveTargets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Ids"=>Ids, "Rule"=>Rule), args)); aws=aws)
...
"""
TagResource(ResourceARN, Tags; aws::AWSConfig=AWSConfig()) = eventbridge("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags); aws=aws)
TagResource(ResourceARN, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags), args)); aws=aws)
...
"""
TestEventPattern(Event, EventPattern; aws::AWSConfig=AWSConfig()) = eventbridge("TestEventPattern", Dict{String, Any}("Event"=>Event, "EventPattern"=>EventPattern); aws=aws)
TestEventPattern(Event, EventPattern, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("TestEventPattern", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Event"=>Event, "EventPattern"=>EventPattern), args)); aws=aws)
...
"""
UntagResource(ResourceARN, TagKeys; aws::AWSConfig=AWSConfig()) = eventbridge("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys); aws=aws)
UntagResource(ResourceARN, TagKeys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = eventbridge("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys), args)); aws=aws)
