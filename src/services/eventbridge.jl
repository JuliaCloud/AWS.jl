...
"""
ActivateEventSource(Name) = eventbridge("ActivateEventSource", Dict{String, Any}("Name"=>Name))
ActivateEventSource(Name, args::AbstractDict{String, <:Any}) = eventbridge("ActivateEventSource", Dict{String, Any}("Name"=>Name, args...))
...
"""
CreateEventBus(Name) = eventbridge("CreateEventBus", Dict{String, Any}("Name"=>Name))
CreateEventBus(Name, args::AbstractDict{String, <:Any}) = eventbridge("CreateEventBus", Dict{String, Any}("Name"=>Name, args...))
...
"""
CreatePartnerEventSource(Account, Name) = eventbridge("CreatePartnerEventSource", Dict{String, Any}("Account"=>Account, "Name"=>Name))
CreatePartnerEventSource(Account, Name, args::AbstractDict{String, <:Any}) = eventbridge("CreatePartnerEventSource", Dict{String, Any}("Account"=>Account, "Name"=>Name, args...))
...
"""
DeactivateEventSource(Name) = eventbridge("DeactivateEventSource", Dict{String, Any}("Name"=>Name))
DeactivateEventSource(Name, args::AbstractDict{String, <:Any}) = eventbridge("DeactivateEventSource", Dict{String, Any}("Name"=>Name, args...))
...
"""
DeleteEventBus(Name) = eventbridge("DeleteEventBus", Dict{String, Any}("Name"=>Name))
DeleteEventBus(Name, args::AbstractDict{String, <:Any}) = eventbridge("DeleteEventBus", Dict{String, Any}("Name"=>Name, args...))
...
"""
DeletePartnerEventSource(Account, Name) = eventbridge("DeletePartnerEventSource", Dict{String, Any}("Account"=>Account, "Name"=>Name))
DeletePartnerEventSource(Account, Name, args::AbstractDict{String, <:Any}) = eventbridge("DeletePartnerEventSource", Dict{String, Any}("Account"=>Account, "Name"=>Name, args...))
...
"""
DeleteRule(Name) = eventbridge("DeleteRule", Dict{String, Any}("Name"=>Name))
DeleteRule(Name, args::AbstractDict{String, <:Any}) = eventbridge("DeleteRule", Dict{String, Any}("Name"=>Name, args...))
...
DescribeEventBus(args::AbstractDict{String, <:Any}) = eventbridge("DescribeEventBus", args)
...
"""
DescribeEventSource(Name) = eventbridge("DescribeEventSource", Dict{String, Any}("Name"=>Name))
DescribeEventSource(Name, args::AbstractDict{String, <:Any}) = eventbridge("DescribeEventSource", Dict{String, Any}("Name"=>Name, args...))
...
"""
DescribePartnerEventSource(Name) = eventbridge("DescribePartnerEventSource", Dict{String, Any}("Name"=>Name))
DescribePartnerEventSource(Name, args::AbstractDict{String, <:Any}) = eventbridge("DescribePartnerEventSource", Dict{String, Any}("Name"=>Name, args...))
...
- `EventBusName`: The event bus associated with the rule. If you omit this, the default event bus is used.
"""
DescribeRule(Name) = eventbridge("DescribeRule", Dict{String, Any}("Name"=>Name))
DescribeRule(Name, args::AbstractDict{String, <:Any}) = eventbridge("DescribeRule", Dict{String, Any}("Name"=>Name, args...))
...
- `EventBusName`: The event bus associated with the rule. If you omit this, the default event bus is used.
"""
DisableRule(Name) = eventbridge("DisableRule", Dict{String, Any}("Name"=>Name))
DisableRule(Name, args::AbstractDict{String, <:Any}) = eventbridge("DisableRule", Dict{String, Any}("Name"=>Name, args...))
...
- `EventBusName`: The event bus associated with the rule. If you omit this, the default event bus is used.
"""
EnableRule(Name) = eventbridge("EnableRule", Dict{String, Any}("Name"=>Name))
EnableRule(Name, args::AbstractDict{String, <:Any}) = eventbridge("EnableRule", Dict{String, Any}("Name"=>Name, args...))
...
ListEventBuses(args::AbstractDict{String, <:Any}) = eventbridge("ListEventBuses", args)
...
ListEventSources(args::AbstractDict{String, <:Any}) = eventbridge("ListEventSources", args)
...
"""
ListPartnerEventSourceAccounts(EventSourceName) = eventbridge("ListPartnerEventSourceAccounts", Dict{String, Any}("EventSourceName"=>EventSourceName))
ListPartnerEventSourceAccounts(EventSourceName, args::AbstractDict{String, <:Any}) = eventbridge("ListPartnerEventSourceAccounts", Dict{String, Any}("EventSourceName"=>EventSourceName, args...))
...
- `NextToken`: The token returned by a previous call to this operation. Specifying this retrieves the next set of results.
"""
ListPartnerEventSources(NamePrefix) = eventbridge("ListPartnerEventSources", Dict{String, Any}("NamePrefix"=>NamePrefix))
ListPartnerEventSources(NamePrefix, args::AbstractDict{String, <:Any}) = eventbridge("ListPartnerEventSources", Dict{String, Any}("NamePrefix"=>NamePrefix, args...))
...
- `NextToken`: The token returned by a previous call to retrieve the next set of results.
"""
ListRuleNamesByTarget(TargetArn) = eventbridge("ListRuleNamesByTarget", Dict{String, Any}("TargetArn"=>TargetArn))
ListRuleNamesByTarget(TargetArn, args::AbstractDict{String, <:Any}) = eventbridge("ListRuleNamesByTarget", Dict{String, Any}("TargetArn"=>TargetArn, args...))
...
ListRules(args::AbstractDict{String, <:Any}) = eventbridge("ListRules", args)
...
"""
ListTagsForResource(ResourceARN) = eventbridge("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN))
ListTagsForResource(ResourceARN, args::AbstractDict{String, <:Any}) = eventbridge("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN, args...))
...
- `NextToken`: The token returned by a previous call to retrieve the next set of results.
"""
ListTargetsByRule(Rule) = eventbridge("ListTargetsByRule", Dict{String, Any}("Rule"=>Rule))
ListTargetsByRule(Rule, args::AbstractDict{String, <:Any}) = eventbridge("ListTargetsByRule", Dict{String, Any}("Rule"=>Rule, args...))
...
"""
PutEvents(Entries) = eventbridge("PutEvents", Dict{String, Any}("Entries"=>Entries))
PutEvents(Entries, args::AbstractDict{String, <:Any}) = eventbridge("PutEvents", Dict{String, Any}("Entries"=>Entries, args...))
...
"""
PutPartnerEvents(Entries) = eventbridge("PutPartnerEvents", Dict{String, Any}("Entries"=>Entries))
PutPartnerEvents(Entries, args::AbstractDict{String, <:Any}) = eventbridge("PutPartnerEvents", Dict{String, Any}("Entries"=>Entries, args...))
...
- `EventBusName`: The event bus associated with the rule. If you omit this, the default event bus is used.
"""
PutPermission(Action, Principal, StatementId) = eventbridge("PutPermission", Dict{String, Any}("Action"=>Action, "Principal"=>Principal, "StatementId"=>StatementId))
PutPermission(Action, Principal, StatementId, args::AbstractDict{String, <:Any}) = eventbridge("PutPermission", Dict{String, Any}("Action"=>Action, "Principal"=>Principal, "StatementId"=>StatementId, args...))
...
"""
PutRule(Name) = eventbridge("PutRule", Dict{String, Any}("Name"=>Name))
PutRule(Name, args::AbstractDict{String, <:Any}) = eventbridge("PutRule", Dict{String, Any}("Name"=>Name, args...))
...
"""
PutTargets(Rule, Targets) = eventbridge("PutTargets", Dict{String, Any}("Rule"=>Rule, "Targets"=>Targets))
PutTargets(Rule, Targets, args::AbstractDict{String, <:Any}) = eventbridge("PutTargets", Dict{String, Any}("Rule"=>Rule, "Targets"=>Targets, args...))
...
"""
RemovePermission(StatementId) = eventbridge("RemovePermission", Dict{String, Any}("StatementId"=>StatementId))
RemovePermission(StatementId, args::AbstractDict{String, <:Any}) = eventbridge("RemovePermission", Dict{String, Any}("StatementId"=>StatementId, args...))
...
"""
RemoveTargets(Ids, Rule) = eventbridge("RemoveTargets", Dict{String, Any}("Ids"=>Ids, "Rule"=>Rule))
RemoveTargets(Ids, Rule, args::AbstractDict{String, <:Any}) = eventbridge("RemoveTargets", Dict{String, Any}("Ids"=>Ids, "Rule"=>Rule, args...))
...
"""
TagResource(ResourceARN, Tags) = eventbridge("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags))
TagResource(ResourceARN, Tags, args::AbstractDict{String, <:Any}) = eventbridge("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags, args...))
...
"""
TestEventPattern(Event, EventPattern) = eventbridge("TestEventPattern", Dict{String, Any}("Event"=>Event, "EventPattern"=>EventPattern))
TestEventPattern(Event, EventPattern, args::AbstractDict{String, <:Any}) = eventbridge("TestEventPattern", Dict{String, Any}("Event"=>Event, "EventPattern"=>EventPattern, args...))
...
"""
UntagResource(ResourceARN, TagKeys) = eventbridge("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys))
UntagResource(ResourceARN, TagKeys, args::AbstractDict{String, <:Any}) = eventbridge("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys, args...))
