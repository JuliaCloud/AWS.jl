...
put_permission(Action, Principal, StatementId; aws_config::AWSConfig=global_aws_config()) = eventbridge("PutPermission", Dict{String, Any}("Action"=>Action, "Principal"=>Principal, "StatementId"=>StatementId); aws_config=aws_config)
put_permission(Action, Principal, StatementId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = eventbridge("PutPermission", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Action"=>Action, "Principal"=>Principal, "StatementId"=>StatementId), args)); aws_config=aws_config)
...
remove_permission(StatementId; aws_config::AWSConfig=global_aws_config()) = eventbridge("RemovePermission", Dict{String, Any}("StatementId"=>StatementId); aws_config=aws_config)
remove_permission(StatementId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = eventbridge("RemovePermission", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StatementId"=>StatementId), args)); aws_config=aws_config)
