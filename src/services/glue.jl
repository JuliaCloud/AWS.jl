...
"""
function batch_get_crawlers(CrawlerNames; aws_config::AbstractAWSConfig=current_aws_config())
    return glue(
        "BatchGetCrawlers",
...
"""
function batch_get_triggers(TriggerNames; aws_config::AbstractAWSConfig=current_aws_config())
    return glue(
        "BatchGetTriggers",
...
function delete_job(
    JobName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return glue(
        "DeleteJob",
...
- `"TransactionId"`: The transaction ID at which to delete the table contents.
"""
function delete_table(DatabaseName, Name; aws_config::AbstractAWSConfig=current_aws_config())
    return glue(
        "DeleteTable",
...
"""
function get_security_configuration(Name; aws_config::AbstractAWSConfig=current_aws_config())
    return glue(
...
function get_user_defined_functions(
    Pattern, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return glue(
        "GetUserDefinedFunctions",
...
"""
function update_job_from_source_control(; aws_config::AbstractAWSConfig=current_aws_config())
    return glue(
...
- `"RepositoryOwner"`: The owner of the remote repository that contains the job artifacts.
"""
function update_source_control_from_job(; aws_config::AbstractAWSConfig=current_aws_config())
    return glue(
