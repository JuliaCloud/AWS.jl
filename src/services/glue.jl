...
- `NodeIds`: A list of the node IDs for the nodes you want to restart. The nodes that are to be restarted must have an execution attempt in the original run.
- `RunId`: The ID of the workflow run to resume.

"""
ResumeWorkflowRun(Name, NodeIds, RunId) = glue("ResumeWorkflowRun", Dict{String, Any}("Name"=>Name, "NodeIds"=>NodeIds, "RunId"=>RunId))
ResumeWorkflowRun(Name, NodeIds, RunId, args::AbstractDict{String, <:Any}) = glue("ResumeWorkflowRun", Dict{String, Any}("Name"=>Name, "NodeIds"=>NodeIds, "RunId"=>RunId, args...))
