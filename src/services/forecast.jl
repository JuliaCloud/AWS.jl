...
function create_what_if_forecast(
    WhatIfAnalysisArn, WhatIfForecastName; aws_config::AbstractAWSConfig=current_aws_config()
)
    return forecast(
...
"""
function describe_predictor(PredictorArn; aws_config::AbstractAWSConfig=current_aws_config())
    return forecast(
        "DescribePredictor",
        Dict{String,Any}("PredictorArn" => PredictorArn);
        aws_config=aws_config,
