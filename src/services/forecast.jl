...
CreateDataset(DatasetName, DatasetType, Domain, Schema; aws_config::AWSConfig=AWS.aws_config) = forecast("CreateDataset", Dict{String, Any}("DatasetName"=>DatasetName, "DatasetType"=>DatasetType, "Domain"=>Domain, "Schema"=>Schema); aws_config=aws_config)
CreateDataset(DatasetName, DatasetType, Domain, Schema, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("CreateDataset", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DatasetName"=>DatasetName, "DatasetType"=>DatasetType, "Domain"=>Domain, "Schema"=>Schema), args)); aws_config=aws_config)
...
CreateDatasetGroup(DatasetGroupName, Domain; aws_config::AWSConfig=AWS.aws_config) = forecast("CreateDatasetGroup", Dict{String, Any}("DatasetGroupName"=>DatasetGroupName, "Domain"=>Domain); aws_config=aws_config)
CreateDatasetGroup(DatasetGroupName, Domain, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("CreateDatasetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DatasetGroupName"=>DatasetGroupName, "Domain"=>Domain), args)); aws_config=aws_config)
...
CreateDatasetImportJob(DataSource, DatasetArn, DatasetImportJobName; aws_config::AWSConfig=AWS.aws_config) = forecast("CreateDatasetImportJob", Dict{String, Any}("DataSource"=>DataSource, "DatasetArn"=>DatasetArn, "DatasetImportJobName"=>DatasetImportJobName); aws_config=aws_config)
CreateDatasetImportJob(DataSource, DatasetArn, DatasetImportJobName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("CreateDatasetImportJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DataSource"=>DataSource, "DatasetArn"=>DatasetArn, "DatasetImportJobName"=>DatasetImportJobName), args)); aws_config=aws_config)
...
CreateForecast(ForecastName, PredictorArn; aws_config::AWSConfig=AWS.aws_config) = forecast("CreateForecast", Dict{String, Any}("ForecastName"=>ForecastName, "PredictorArn"=>PredictorArn); aws_config=aws_config)
CreateForecast(ForecastName, PredictorArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("CreateForecast", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ForecastName"=>ForecastName, "PredictorArn"=>PredictorArn), args)); aws_config=aws_config)
...
CreateForecastExportJob(Destination, ForecastArn, ForecastExportJobName; aws_config::AWSConfig=AWS.aws_config) = forecast("CreateForecastExportJob", Dict{String, Any}("Destination"=>Destination, "ForecastArn"=>ForecastArn, "ForecastExportJobName"=>ForecastExportJobName); aws_config=aws_config)
CreateForecastExportJob(Destination, ForecastArn, ForecastExportJobName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("CreateForecastExportJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Destination"=>Destination, "ForecastArn"=>ForecastArn, "ForecastExportJobName"=>ForecastExportJobName), args)); aws_config=aws_config)
...
CreatePredictor(FeaturizationConfig, ForecastHorizon, InputDataConfig, PredictorName; aws_config::AWSConfig=AWS.aws_config) = forecast("CreatePredictor", Dict{String, Any}("FeaturizationConfig"=>FeaturizationConfig, "ForecastHorizon"=>ForecastHorizon, "InputDataConfig"=>InputDataConfig, "PredictorName"=>PredictorName); aws_config=aws_config)
CreatePredictor(FeaturizationConfig, ForecastHorizon, InputDataConfig, PredictorName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("CreatePredictor", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FeaturizationConfig"=>FeaturizationConfig, "ForecastHorizon"=>ForecastHorizon, "InputDataConfig"=>InputDataConfig, "PredictorName"=>PredictorName), args)); aws_config=aws_config)
...
DeleteDataset(DatasetArn; aws_config::AWSConfig=AWS.aws_config) = forecast("DeleteDataset", Dict{String, Any}("DatasetArn"=>DatasetArn); aws_config=aws_config)
DeleteDataset(DatasetArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("DeleteDataset", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DatasetArn"=>DatasetArn), args)); aws_config=aws_config)
...
DeleteDatasetGroup(DatasetGroupArn; aws_config::AWSConfig=AWS.aws_config) = forecast("DeleteDatasetGroup", Dict{String, Any}("DatasetGroupArn"=>DatasetGroupArn); aws_config=aws_config)
DeleteDatasetGroup(DatasetGroupArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("DeleteDatasetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DatasetGroupArn"=>DatasetGroupArn), args)); aws_config=aws_config)
...
DeleteDatasetImportJob(DatasetImportJobArn; aws_config::AWSConfig=AWS.aws_config) = forecast("DeleteDatasetImportJob", Dict{String, Any}("DatasetImportJobArn"=>DatasetImportJobArn); aws_config=aws_config)
DeleteDatasetImportJob(DatasetImportJobArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("DeleteDatasetImportJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DatasetImportJobArn"=>DatasetImportJobArn), args)); aws_config=aws_config)
...
DeleteForecast(ForecastArn; aws_config::AWSConfig=AWS.aws_config) = forecast("DeleteForecast", Dict{String, Any}("ForecastArn"=>ForecastArn); aws_config=aws_config)
DeleteForecast(ForecastArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("DeleteForecast", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ForecastArn"=>ForecastArn), args)); aws_config=aws_config)
...
DeleteForecastExportJob(ForecastExportJobArn; aws_config::AWSConfig=AWS.aws_config) = forecast("DeleteForecastExportJob", Dict{String, Any}("ForecastExportJobArn"=>ForecastExportJobArn); aws_config=aws_config)
DeleteForecastExportJob(ForecastExportJobArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("DeleteForecastExportJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ForecastExportJobArn"=>ForecastExportJobArn), args)); aws_config=aws_config)
...
DeletePredictor(PredictorArn; aws_config::AWSConfig=AWS.aws_config) = forecast("DeletePredictor", Dict{String, Any}("PredictorArn"=>PredictorArn); aws_config=aws_config)
DeletePredictor(PredictorArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("DeletePredictor", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PredictorArn"=>PredictorArn), args)); aws_config=aws_config)
...
DescribeDataset(DatasetArn; aws_config::AWSConfig=AWS.aws_config) = forecast("DescribeDataset", Dict{String, Any}("DatasetArn"=>DatasetArn); aws_config=aws_config)
DescribeDataset(DatasetArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("DescribeDataset", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DatasetArn"=>DatasetArn), args)); aws_config=aws_config)
...
DescribeDatasetGroup(DatasetGroupArn; aws_config::AWSConfig=AWS.aws_config) = forecast("DescribeDatasetGroup", Dict{String, Any}("DatasetGroupArn"=>DatasetGroupArn); aws_config=aws_config)
DescribeDatasetGroup(DatasetGroupArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("DescribeDatasetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DatasetGroupArn"=>DatasetGroupArn), args)); aws_config=aws_config)
...
DescribeDatasetImportJob(DatasetImportJobArn; aws_config::AWSConfig=AWS.aws_config) = forecast("DescribeDatasetImportJob", Dict{String, Any}("DatasetImportJobArn"=>DatasetImportJobArn); aws_config=aws_config)
DescribeDatasetImportJob(DatasetImportJobArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("DescribeDatasetImportJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DatasetImportJobArn"=>DatasetImportJobArn), args)); aws_config=aws_config)
...
DescribeForecast(ForecastArn; aws_config::AWSConfig=AWS.aws_config) = forecast("DescribeForecast", Dict{String, Any}("ForecastArn"=>ForecastArn); aws_config=aws_config)
DescribeForecast(ForecastArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("DescribeForecast", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ForecastArn"=>ForecastArn), args)); aws_config=aws_config)
...
DescribeForecastExportJob(ForecastExportJobArn; aws_config::AWSConfig=AWS.aws_config) = forecast("DescribeForecastExportJob", Dict{String, Any}("ForecastExportJobArn"=>ForecastExportJobArn); aws_config=aws_config)
DescribeForecastExportJob(ForecastExportJobArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("DescribeForecastExportJob", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ForecastExportJobArn"=>ForecastExportJobArn), args)); aws_config=aws_config)
...
DescribePredictor(PredictorArn; aws_config::AWSConfig=AWS.aws_config) = forecast("DescribePredictor", Dict{String, Any}("PredictorArn"=>PredictorArn); aws_config=aws_config)
DescribePredictor(PredictorArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("DescribePredictor", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PredictorArn"=>PredictorArn), args)); aws_config=aws_config)
...
GetAccuracyMetrics(PredictorArn; aws_config::AWSConfig=AWS.aws_config) = forecast("GetAccuracyMetrics", Dict{String, Any}("PredictorArn"=>PredictorArn); aws_config=aws_config)
GetAccuracyMetrics(PredictorArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("GetAccuracyMetrics", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PredictorArn"=>PredictorArn), args)); aws_config=aws_config)
...
ListDatasetGroups(; aws_config::AWSConfig=AWS.aws_config) = forecast("ListDatasetGroups"; aws_config=aws_config)
ListDatasetGroups(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("ListDatasetGroups", args; aws_config=aws_config)
...
ListDatasetImportJobs(; aws_config::AWSConfig=AWS.aws_config) = forecast("ListDatasetImportJobs"; aws_config=aws_config)
ListDatasetImportJobs(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("ListDatasetImportJobs", args; aws_config=aws_config)
...
ListDatasets(; aws_config::AWSConfig=AWS.aws_config) = forecast("ListDatasets"; aws_config=aws_config)
ListDatasets(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("ListDatasets", args; aws_config=aws_config)
...
ListForecastExportJobs(; aws_config::AWSConfig=AWS.aws_config) = forecast("ListForecastExportJobs"; aws_config=aws_config)
ListForecastExportJobs(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("ListForecastExportJobs", args; aws_config=aws_config)
...
ListForecasts(; aws_config::AWSConfig=AWS.aws_config) = forecast("ListForecasts"; aws_config=aws_config)
ListForecasts(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("ListForecasts", args; aws_config=aws_config)
...
ListPredictors(; aws_config::AWSConfig=AWS.aws_config) = forecast("ListPredictors"; aws_config=aws_config)
ListPredictors(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("ListPredictors", args; aws_config=aws_config)
...
ListTagsForResource(ResourceArn; aws_config::AWSConfig=AWS.aws_config) = forecast("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config)
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), args)); aws_config=aws_config)
...
TagResource(ResourceArn, Tags; aws_config::AWSConfig=AWS.aws_config) = forecast("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags); aws_config=aws_config)
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags), args)); aws_config=aws_config)
...
UntagResource(ResourceArn, TagKeys; aws_config::AWSConfig=AWS.aws_config) = forecast("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys); aws_config=aws_config)
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), args)); aws_config=aws_config)
...
UpdateDatasetGroup(DatasetArns, DatasetGroupArn; aws_config::AWSConfig=AWS.aws_config) = forecast("UpdateDatasetGroup", Dict{String, Any}("DatasetArns"=>DatasetArns, "DatasetGroupArn"=>DatasetGroupArn); aws_config=aws_config)
UpdateDatasetGroup(DatasetArns, DatasetGroupArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = forecast("UpdateDatasetGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DatasetArns"=>DatasetArns, "DatasetGroupArn"=>DatasetGroupArn), args)); aws_config=aws_config)
