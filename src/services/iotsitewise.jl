...
function delete_asset(
    assetId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return iotsitewise(
        "DELETE",
        "/assets/$(assetId)",
...
- `"clientToken"`: A unique case-sensitive identifier that you can provide to ensure the
  ...
  required.
"""
function delete_asset_model(assetModelId; aws_config::AbstractAWSConfig=current_aws_config())
    return iotsitewise(
        "DELETE",
...
"""
function describe_storage_configuration(; aws_config::AbstractAWSConfig=current_aws_config())
    return iotsitewise(
        "GET",
...
- `"clientToken"`: A unique case-sensitive identifier that you can provide to ensure the
  ...
  required.
"""
function update_asset(assetId, assetName; aws_config::AbstractAWSConfig=current_aws_config())
    return iotsitewise(
        "PUT",
        "/assets/$(assetId)",
