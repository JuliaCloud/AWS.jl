...
"""
AssociateAssets(assetId, childAssetId, hierarchyId) = iotsitewise("POST", "/assets/$(assetId)/associate", Dict{String, Any}("childAssetId"=>childAssetId, "hierarchyId"=>hierarchyId, "clientToken"=>string(uuid4())))
AssociateAssets(assetId, childAssetId, hierarchyId, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/assets/$(assetId)/associate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("childAssetId"=>childAssetId, "hierarchyId"=>hierarchyId, "clientToken"=>string(uuid4())), args...)))
...
- `clientToken`: A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
BatchAssociateProjectAssets(assetIds, projectId) = iotsitewise("POST", "/projects/$(projectId)/assets/associate", Dict{String, Any}("assetIds"=>assetIds, "clientToken"=>string(uuid4())))
BatchAssociateProjectAssets(assetIds, projectId, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/projects/$(projectId)/assets/associate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("assetIds"=>assetIds, "clientToken"=>string(uuid4())), args...)))
...
- `clientToken`: A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
BatchDisassociateProjectAssets(assetIds, projectId) = iotsitewise("POST", "/projects/$(projectId)/assets/disassociate", Dict{String, Any}("assetIds"=>assetIds, "clientToken"=>string(uuid4())))
BatchDisassociateProjectAssets(assetIds, projectId, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/projects/$(projectId)/assets/disassociate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("assetIds"=>assetIds, "clientToken"=>string(uuid4())), args...)))
...
"""
BatchPutAssetPropertyValue(entries) = iotsitewise("POST", "/properties", Dict{String, Any}("entries"=>entries))
BatchPutAssetPropertyValue(entries, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/properties", Dict{String, Any}("entries"=>entries, args...))
...
"""
CreateAccessPolicy(accessPolicyIdentity, accessPolicyPermission, accessPolicyResource) = iotsitewise("POST", "/access-policies", Dict{String, Any}("accessPolicyIdentity"=>accessPolicyIdentity, "accessPolicyPermission"=>accessPolicyPermission, "accessPolicyResource"=>accessPolicyResource, "clientToken"=>string(uuid4())))
CreateAccessPolicy(accessPolicyIdentity, accessPolicyPermission, accessPolicyResource, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/access-policies", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("accessPolicyIdentity"=>accessPolicyIdentity, "accessPolicyPermission"=>accessPolicyPermission, "accessPolicyResource"=>accessPolicyResource, "clientToken"=>string(uuid4())), args...)))
...
"""
CreateAsset(assetModelId, assetName) = iotsitewise("POST", "/assets", Dict{String, Any}("assetModelId"=>assetModelId, "assetName"=>assetName, "clientToken"=>string(uuid4())))
CreateAsset(assetModelId, assetName, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/assets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("assetModelId"=>assetModelId, "assetName"=>assetName, "clientToken"=>string(uuid4())), args...)))
...
"""
CreateAssetModel(assetModelName) = iotsitewise("POST", "/asset-models", Dict{String, Any}("assetModelName"=>assetModelName, "clientToken"=>string(uuid4())))
CreateAssetModel(assetModelName, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/asset-models", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("assetModelName"=>assetModelName, "clientToken"=>string(uuid4())), args...)))
...
"""
CreateDashboard(dashboardDefinition, dashboardName, projectId) = iotsitewise("POST", "/dashboards", Dict{String, Any}("dashboardDefinition"=>dashboardDefinition, "dashboardName"=>dashboardName, "projectId"=>projectId, "clientToken"=>string(uuid4())))
CreateDashboard(dashboardDefinition, dashboardName, projectId, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/dashboards", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("dashboardDefinition"=>dashboardDefinition, "dashboardName"=>dashboardName, "projectId"=>projectId, "clientToken"=>string(uuid4())), args...)))
...
"""
CreateGateway(gatewayName, gatewayPlatform) = iotsitewise("POST", "/20200301/gateways", Dict{String, Any}("gatewayName"=>gatewayName, "gatewayPlatform"=>gatewayPlatform))
CreateGateway(gatewayName, gatewayPlatform, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/20200301/gateways", Dict{String, Any}("gatewayName"=>gatewayName, "gatewayPlatform"=>gatewayPlatform, args...))
...
"""
CreatePortal(portalContactEmail, portalName, roleArn) = iotsitewise("POST", "/portals", Dict{String, Any}("portalContactEmail"=>portalContactEmail, "portalName"=>portalName, "roleArn"=>roleArn, "clientToken"=>string(uuid4())))
CreatePortal(portalContactEmail, portalName, roleArn, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/portals", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("portalContactEmail"=>portalContactEmail, "portalName"=>portalName, "roleArn"=>roleArn, "clientToken"=>string(uuid4())), args...)))
...
"""
CreateProject(portalId, projectName) = iotsitewise("POST", "/projects", Dict{String, Any}("portalId"=>portalId, "projectName"=>projectName, "clientToken"=>string(uuid4())))
CreateProject(portalId, projectName, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/projects", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("portalId"=>portalId, "projectName"=>projectName, "clientToken"=>string(uuid4())), args...)))
...
- `clientToken`: A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
DeleteAccessPolicy(accessPolicyId) = iotsitewise("DELETE", "/access-policies/$(accessPolicyId)", Dict{String, Any}("clientToken"=>string(uuid4())))
DeleteAccessPolicy(accessPolicyId, args::AbstractDict{String, <:Any}) = iotsitewise("DELETE", "/access-policies/$(accessPolicyId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientToken"=>string(uuid4())), args...)))
...
- `clientToken`: A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
DeleteAsset(assetId) = iotsitewise("DELETE", "/assets/$(assetId)", Dict{String, Any}("clientToken"=>string(uuid4())))
DeleteAsset(assetId, args::AbstractDict{String, <:Any}) = iotsitewise("DELETE", "/assets/$(assetId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientToken"=>string(uuid4())), args...)))
...
- `clientToken`: A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
DeleteAssetModel(assetModelId) = iotsitewise("DELETE", "/asset-models/$(assetModelId)", Dict{String, Any}("clientToken"=>string(uuid4())))
DeleteAssetModel(assetModelId, args::AbstractDict{String, <:Any}) = iotsitewise("DELETE", "/asset-models/$(assetModelId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientToken"=>string(uuid4())), args...)))
...
- `clientToken`: A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
DeleteDashboard(dashboardId) = iotsitewise("DELETE", "/dashboards/$(dashboardId)", Dict{String, Any}("clientToken"=>string(uuid4())))
DeleteDashboard(dashboardId, args::AbstractDict{String, <:Any}) = iotsitewise("DELETE", "/dashboards/$(dashboardId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientToken"=>string(uuid4())), args...)))
...
DeleteGateway(gatewayId, args::AbstractDict{String, <:Any}) = iotsitewise("DELETE", "/20200301/gateways/$(gatewayId)", args)
...
- `clientToken`: A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
DeletePortal(portalId) = iotsitewise("DELETE", "/portals/$(portalId)", Dict{String, Any}("clientToken"=>string(uuid4())))
DeletePortal(portalId, args::AbstractDict{String, <:Any}) = iotsitewise("DELETE", "/portals/$(portalId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientToken"=>string(uuid4())), args...)))
...
- `clientToken`: A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
DeleteProject(projectId) = iotsitewise("DELETE", "/projects/$(projectId)", Dict{String, Any}("clientToken"=>string(uuid4())))
DeleteProject(projectId, args::AbstractDict{String, <:Any}) = iotsitewise("DELETE", "/projects/$(projectId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientToken"=>string(uuid4())), args...)))
...
DescribeAccessPolicy(accessPolicyId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/access-policies/$(accessPolicyId)", args)
...
DescribeAsset(assetId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/assets/$(assetId)", args)
...
DescribeAssetModel(assetModelId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/asset-models/$(assetModelId)", args)
...
DescribeAssetProperty(assetId, propertyId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/assets/$(assetId)/properties/$(propertyId)", args)
...
DescribeDashboard(dashboardId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/dashboards/$(dashboardId)", args)
...
DescribeGateway(gatewayId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/20200301/gateways/$(gatewayId)", args)
...
DescribeGatewayCapabilityConfiguration(capabilityNamespace, gatewayId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/20200301/gateways/$(gatewayId)/capability/$(capabilityNamespace)", args)
...
DescribeLoggingOptions(args::AbstractDict{String, Any}) = iotsitewise("GET", "/logging", args)
...
DescribePortal(portalId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/portals/$(portalId)", args)
...
DescribeProject(projectId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/projects/$(projectId)", args)
...
- `clientToken`: A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
DisassociateAssets(assetId, childAssetId, hierarchyId) = iotsitewise("POST", "/assets/$(assetId)/disassociate", Dict{String, Any}("childAssetId"=>childAssetId, "hierarchyId"=>hierarchyId, "clientToken"=>string(uuid4())))
DisassociateAssets(assetId, childAssetId, hierarchyId, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/assets/$(assetId)/disassociate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("childAssetId"=>childAssetId, "hierarchyId"=>hierarchyId, "clientToken"=>string(uuid4())), args...)))
...
"""
GetAssetPropertyAggregates(aggregateTypes, endDate, resolution, startDate) = iotsitewise("GET", "/properties/aggregates", Dict{String, Any}("aggregateTypes"=>aggregateTypes, "endDate"=>endDate, "resolution"=>resolution, "startDate"=>startDate))
GetAssetPropertyAggregates(aggregateTypes, endDate, resolution, startDate, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/properties/aggregates", Dict{String, Any}("aggregateTypes"=>aggregateTypes, "endDate"=>endDate, "resolution"=>resolution, "startDate"=>startDate, args...))
...
GetAssetPropertyValue(args::AbstractDict{String, Any}) = iotsitewise("GET", "/properties/latest", args)
...
GetAssetPropertyValueHistory(args::AbstractDict{String, Any}) = iotsitewise("GET", "/properties/history", args)
...
ListAccessPolicies(args::AbstractDict{String, Any}) = iotsitewise("GET", "/access-policies", args)
...
ListAssetModels(args::AbstractDict{String, Any}) = iotsitewise("GET", "/asset-models", args)
...
ListAssets(args::AbstractDict{String, Any}) = iotsitewise("GET", "/assets", args)
...
- `nextToken`: The token to be used for the next set of paginated results.
"""
ListAssociatedAssets(assetId, hierarchyId) = iotsitewise("GET", "/assets/$(assetId)/hierarchies", Dict{String, Any}("hierarchyId"=>hierarchyId))
ListAssociatedAssets(assetId, hierarchyId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/assets/$(assetId)/hierarchies", Dict{String, Any}("hierarchyId"=>hierarchyId, args...))
...
- `nextToken`: The token to be used for the next set of paginated results.
"""
ListDashboards(projectId) = iotsitewise("GET", "/dashboards", Dict{String, Any}("projectId"=>projectId))
ListDashboards(projectId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/dashboards", Dict{String, Any}("projectId"=>projectId, args...))
...
ListGateways(args::AbstractDict{String, Any}) = iotsitewise("GET", "/20200301/gateways", args)
...
ListPortals(args::AbstractDict{String, Any}) = iotsitewise("GET", "/portals", args)
...
ListProjectAssets(projectId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/projects/$(projectId)/assets", args)
...
- `nextToken`: The token to be used for the next set of paginated results.
"""
ListProjects(portalId) = iotsitewise("GET", "/projects", Dict{String, Any}("portalId"=>portalId))
ListProjects(portalId, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/projects", Dict{String, Any}("portalId"=>portalId, args...))
...
"""
ListTagsForResource(resourceArn) = iotsitewise("GET", "/tags", Dict{String, Any}("resourceArn"=>resourceArn))
ListTagsForResource(resourceArn, args::AbstractDict{String, <:Any}) = iotsitewise("GET", "/tags", Dict{String, Any}("resourceArn"=>resourceArn, args...))
...
"""
PutLoggingOptions(loggingOptions) = iotsitewise("PUT", "/logging", Dict{String, Any}("loggingOptions"=>loggingOptions))
PutLoggingOptions(loggingOptions, args::AbstractDict{String, <:Any}) = iotsitewise("PUT", "/logging", Dict{String, Any}("loggingOptions"=>loggingOptions, args...))
...
"""
TagResource(resourceArn, tags) = iotsitewise("POST", "/tags", Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags))
TagResource(resourceArn, tags, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/tags", Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags, args...))
...
"""
UntagResource(resourceArn, tagKeys) = iotsitewise("DELETE", "/tags", Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys))
UntagResource(resourceArn, tagKeys, args::AbstractDict{String, <:Any}) = iotsitewise("DELETE", "/tags", Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys, args...))
...
- `clientToken`: A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
UpdateAccessPolicy(accessPolicyId, accessPolicyIdentity, accessPolicyPermission, accessPolicyResource) = iotsitewise("PUT", "/access-policies/$(accessPolicyId)", Dict{String, Any}("accessPolicyIdentity"=>accessPolicyIdentity, "accessPolicyPermission"=>accessPolicyPermission, "accessPolicyResource"=>accessPolicyResource, "clientToken"=>string(uuid4())))
UpdateAccessPolicy(accessPolicyId, accessPolicyIdentity, accessPolicyPermission, accessPolicyResource, args::AbstractDict{String, <:Any}) = iotsitewise("PUT", "/access-policies/$(accessPolicyId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("accessPolicyIdentity"=>accessPolicyIdentity, "accessPolicyPermission"=>accessPolicyPermission, "accessPolicyResource"=>accessPolicyResource, "clientToken"=>string(uuid4())), args...)))
...
- `clientToken`: A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
UpdateAsset(assetId, assetName) = iotsitewise("PUT", "/assets/$(assetId)", Dict{String, Any}("assetName"=>assetName, "clientToken"=>string(uuid4())))
UpdateAsset(assetId, assetName, args::AbstractDict{String, <:Any}) = iotsitewise("PUT", "/assets/$(assetId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("assetName"=>assetName, "clientToken"=>string(uuid4())), args...)))
...
- `clientToken`: A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
UpdateAssetModel(assetModelId, assetModelName) = iotsitewise("PUT", "/asset-models/$(assetModelId)", Dict{String, Any}("assetModelName"=>assetModelName, "clientToken"=>string(uuid4())))
UpdateAssetModel(assetModelId, assetModelName, args::AbstractDict{String, <:Any}) = iotsitewise("PUT", "/asset-models/$(assetModelId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("assetModelName"=>assetModelName, "clientToken"=>string(uuid4())), args...)))
...
"""
UpdateAssetProperty(assetId, propertyId) = iotsitewise("PUT", "/assets/$(assetId)/properties/$(propertyId)", Dict{String, Any}("clientToken"=>string(uuid4())))
UpdateAssetProperty(assetId, propertyId, args::AbstractDict{String, <:Any}) = iotsitewise("PUT", "/assets/$(assetId)/properties/$(propertyId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("clientToken"=>string(uuid4())), args...)))
...
"""
UpdateDashboard(dashboardDefinition, dashboardId, dashboardName) = iotsitewise("PUT", "/dashboards/$(dashboardId)", Dict{String, Any}("dashboardDefinition"=>dashboardDefinition, "dashboardName"=>dashboardName, "clientToken"=>string(uuid4())))
UpdateDashboard(dashboardDefinition, dashboardId, dashboardName, args::AbstractDict{String, <:Any}) = iotsitewise("PUT", "/dashboards/$(dashboardId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("dashboardDefinition"=>dashboardDefinition, "dashboardName"=>dashboardName, "clientToken"=>string(uuid4())), args...)))
...
"""
UpdateGateway(gatewayId, gatewayName) = iotsitewise("PUT", "/20200301/gateways/$(gatewayId)", Dict{String, Any}("gatewayName"=>gatewayName))
UpdateGateway(gatewayId, gatewayName, args::AbstractDict{String, <:Any}) = iotsitewise("PUT", "/20200301/gateways/$(gatewayId)", Dict{String, Any}("gatewayName"=>gatewayName, args...))
...
"""
UpdateGatewayCapabilityConfiguration(capabilityConfiguration, capabilityNamespace, gatewayId) = iotsitewise("POST", "/20200301/gateways/$(gatewayId)/capability", Dict{String, Any}("capabilityConfiguration"=>capabilityConfiguration, "capabilityNamespace"=>capabilityNamespace))
UpdateGatewayCapabilityConfiguration(capabilityConfiguration, capabilityNamespace, gatewayId, args::AbstractDict{String, <:Any}) = iotsitewise("POST", "/20200301/gateways/$(gatewayId)/capability", Dict{String, Any}("capabilityConfiguration"=>capabilityConfiguration, "capabilityNamespace"=>capabilityNamespace, args...))
...
- `portalLogoImage`: 
"""
UpdatePortal(portalContactEmail, portalId, portalName, roleArn) = iotsitewise("PUT", "/portals/$(portalId)", Dict{String, Any}("portalContactEmail"=>portalContactEmail, "portalName"=>portalName, "roleArn"=>roleArn, "clientToken"=>string(uuid4())))
UpdatePortal(portalContactEmail, portalId, portalName, roleArn, args::AbstractDict{String, <:Any}) = iotsitewise("PUT", "/portals/$(portalId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("portalContactEmail"=>portalContactEmail, "portalName"=>portalName, "roleArn"=>roleArn, "clientToken"=>string(uuid4())), args...)))
...
"""
UpdateProject(projectId, projectName) = iotsitewise("PUT", "/projects/$(projectId)", Dict{String, Any}("projectName"=>projectName, "clientToken"=>string(uuid4())))
UpdateProject(projectId, projectName, args::AbstractDict{String, <:Any}) = iotsitewise("PUT", "/projects/$(projectId)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("projectName"=>projectName, "clientToken"=>string(uuid4())), args...)))
