...
function delete_campaign(id; aws_config::AbstractAWSConfig=current_aws_config())
    return connectcampaigns(
        "DELETE", "/campaigns/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_campaign(
    ...
    return connectcampaigns(
        "DELETE", "/campaigns/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_campaign(id; aws_config::AbstractAWSConfig=current_aws_config())
    return connectcampaigns(
        "GET", "/campaigns/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_campaign(
    ...
    return connectcampaigns(
        "GET", "/campaigns/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_campaign_state(id; aws_config::AbstractAWSConfig=current_aws_config())
    return connectcampaigns(
        "GET", "/campaigns/$(id)/state"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_campaign_state(
    ...
    return connectcampaigns(
        "GET", "/campaigns/$(id)/state", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_campaigns(; aws_config::AbstractAWSConfig=current_aws_config())
    return connectcampaigns(
        "POST", "/campaigns-summary"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_campaigns(
    ...
    return connectcampaigns(
        "POST", "/campaigns-summary", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function pause_campaign(id; aws_config::AbstractAWSConfig=current_aws_config())
    return connectcampaigns(
        "POST", "/campaigns/$(id)/pause"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function resume_campaign(id; aws_config::AbstractAWSConfig=current_aws_config())
    return connectcampaigns(
        "POST", "/campaigns/$(id)/resume"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function start_campaign(id; aws_config::AbstractAWSConfig=current_aws_config())
    return connectcampaigns(
        "POST", "/campaigns/$(id)/start"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function stop_campaign(id; aws_config::AbstractAWSConfig=current_aws_config())
    return connectcampaigns(
        "POST", "/campaigns/$(id)/stop"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function stop_campaign(
    ...
    return connectcampaigns(
        "POST", "/campaigns/$(id)/stop", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
