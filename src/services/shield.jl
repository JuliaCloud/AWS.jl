...
"""
AssociateDRTLogBucket(LogBucket) = shield("AssociateDRTLogBucket", Dict{String, Any}("LogBucket"=>LogBucket))
AssociateDRTLogBucket(LogBucket, args::AbstractDict{String, <:Any}) = shield("AssociateDRTLogBucket", Dict{String, Any}("LogBucket"=>LogBucket, args...))
...
"""
AssociateDRTRole(RoleArn) = shield("AssociateDRTRole", Dict{String, Any}("RoleArn"=>RoleArn))
AssociateDRTRole(RoleArn, args::AbstractDict{String, <:Any}) = shield("AssociateDRTRole", Dict{String, Any}("RoleArn"=>RoleArn, args...))
...
"""
AssociateHealthCheck(HealthCheckArn, ProtectionId) = shield("AssociateHealthCheck", Dict{String, Any}("HealthCheckArn"=>HealthCheckArn, "ProtectionId"=>ProtectionId))
AssociateHealthCheck(HealthCheckArn, ProtectionId, args::AbstractDict{String, <:Any}) = shield("AssociateHealthCheck", Dict{String, Any}("HealthCheckArn"=>HealthCheckArn, "ProtectionId"=>ProtectionId, args...))
...
"""
AssociateProactiveEngagementDetails(EmergencyContactList) = shield("AssociateProactiveEngagementDetails", Dict{String, Any}("EmergencyContactList"=>EmergencyContactList))
AssociateProactiveEngagementDetails(EmergencyContactList, args::AbstractDict{String, <:Any}) = shield("AssociateProactiveEngagementDetails", Dict{String, Any}("EmergencyContactList"=>EmergencyContactList, args...))
...
"""
CreateProtection(Name, ResourceArn) = shield("CreateProtection", Dict{String, Any}("Name"=>Name, "ResourceArn"=>ResourceArn))
CreateProtection(Name, ResourceArn, args::AbstractDict{String, <:Any}) = shield("CreateProtection", Dict{String, Any}("Name"=>Name, "ResourceArn"=>ResourceArn, args...))
...
CreateSubscription(args::AbstractDict{String, <:Any}) = shield("CreateSubscription", args)
...
"""
DeleteProtection(ProtectionId) = shield("DeleteProtection", Dict{String, Any}("ProtectionId"=>ProtectionId))
DeleteProtection(ProtectionId, args::AbstractDict{String, <:Any}) = shield("DeleteProtection", Dict{String, Any}("ProtectionId"=>ProtectionId, args...))
...
DeleteSubscription(args::AbstractDict{String, <:Any}) = shield("DeleteSubscription", args)
...
"""
DescribeAttack(AttackId) = shield("DescribeAttack", Dict{String, Any}("AttackId"=>AttackId))
DescribeAttack(AttackId, args::AbstractDict{String, <:Any}) = shield("DescribeAttack", Dict{String, Any}("AttackId"=>AttackId, args...))
...
DescribeDRTAccess(args::AbstractDict{String, <:Any}) = shield("DescribeDRTAccess", args)
...
DescribeEmergencyContactSettings(args::AbstractDict{String, <:Any}) = shield("DescribeEmergencyContactSettings", args)
...
DescribeProtection(args::AbstractDict{String, <:Any}) = shield("DescribeProtection", args)
...
DescribeSubscription(args::AbstractDict{String, <:Any}) = shield("DescribeSubscription", args)
...
DisableProactiveEngagement(args::AbstractDict{String, <:Any}) = shield("DisableProactiveEngagement", args)
...
"""
DisassociateDRTLogBucket(LogBucket) = shield("DisassociateDRTLogBucket", Dict{String, Any}("LogBucket"=>LogBucket))
DisassociateDRTLogBucket(LogBucket, args::AbstractDict{String, <:Any}) = shield("DisassociateDRTLogBucket", Dict{String, Any}("LogBucket"=>LogBucket, args...))
...
DisassociateDRTRole(args::AbstractDict{String, <:Any}) = shield("DisassociateDRTRole", args)
...
"""
DisassociateHealthCheck(HealthCheckArn, ProtectionId) = shield("DisassociateHealthCheck", Dict{String, Any}("HealthCheckArn"=>HealthCheckArn, "ProtectionId"=>ProtectionId))
DisassociateHealthCheck(HealthCheckArn, ProtectionId, args::AbstractDict{String, <:Any}) = shield("DisassociateHealthCheck", Dict{String, Any}("HealthCheckArn"=>HealthCheckArn, "ProtectionId"=>ProtectionId, args...))
...
EnableProactiveEngagement(args::AbstractDict{String, <:Any}) = shield("EnableProactiveEngagement", args)
...
GetSubscriptionState(args::AbstractDict{String, <:Any}) = shield("GetSubscriptionState", args)
...
ListAttacks(args::AbstractDict{String, <:Any}) = shield("ListAttacks", args)
...
ListProtections(args::AbstractDict{String, <:Any}) = shield("ListProtections", args)
...
UpdateEmergencyContactSettings(args::AbstractDict{String, <:Any}) = shield("UpdateEmergencyContactSettings", args)
...
UpdateSubscription(args::AbstractDict{String, <:Any}) = shield("UpdateSubscription", args)
