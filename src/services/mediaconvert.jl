...
"""
CreateJob(role, settings) = mediaconvert("POST", "/2017-08-29/jobs", Dict{String, Any}("role"=>role, "settings"=>settings))
CreateJob(role, settings, args::AbstractDict{String, <: Any}) = mediaconvert("POST", "/2017-08-29/jobs", Dict{String, Any}("role"=>role, "settings"=>settings, args...))
