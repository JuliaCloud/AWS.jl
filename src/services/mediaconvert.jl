...
"""
AssociateCertificate(arn) = mediaconvert("POST", "/2017-08-29/certificates", Dict{String, Any}("arn"=>arn))
AssociateCertificate(arn, args::AbstractDict{String, <:Any}) = mediaconvert("POST", "/2017-08-29/certificates", Dict{String, Any}("arn"=>arn, args...))
...
CancelJob(id, args::AbstractDict{String, <:Any}) = mediaconvert("DELETE", "/2017-08-29/jobs/$(id)", args)
...
"""
CreateJob(role, settings) = mediaconvert("POST", "/2017-08-29/jobs", Dict{String, Any}("role"=>role, "settings"=>settings, "clientRequestToken"=>string(uuid4())))
CreateJob(role, settings, args::AbstractDict{String, <:Any}) = mediaconvert("POST", "/2017-08-29/jobs", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("role"=>role, "settings"=>settings, "clientRequestToken"=>string(uuid4())), args...)))
...
"""
CreateJobTemplate(name, settings) = mediaconvert("POST", "/2017-08-29/jobTemplates", Dict{String, Any}("name"=>name, "settings"=>settings))
CreateJobTemplate(name, settings, args::AbstractDict{String, <:Any}) = mediaconvert("POST", "/2017-08-29/jobTemplates", Dict{String, Any}("name"=>name, "settings"=>settings, args...))
...
- `tags`: The tags that you want to add to the resource. You can tag resources with a key-value pair or with only a key.
"""
CreatePreset(name, settings) = mediaconvert("POST", "/2017-08-29/presets", Dict{String, Any}("name"=>name, "settings"=>settings))
CreatePreset(name, settings, args::AbstractDict{String, <:Any}) = mediaconvert("POST", "/2017-08-29/presets", Dict{String, Any}("name"=>name, "settings"=>settings, args...))
...
- `tags`: The tags that you want to add to the resource. You can tag resources with a key-value pair or with only a key.
"""
CreateQueue(name) = mediaconvert("POST", "/2017-08-29/queues", Dict{String, Any}("name"=>name))
CreateQueue(name, args::AbstractDict{String, <:Any}) = mediaconvert("POST", "/2017-08-29/queues", Dict{String, Any}("name"=>name, args...))
...
DeleteJobTemplate(name, args::AbstractDict{String, <:Any}) = mediaconvert("DELETE", "/2017-08-29/jobTemplates/$(name)", args)
...
DeletePreset(name, args::AbstractDict{String, <:Any}) = mediaconvert("DELETE", "/2017-08-29/presets/$(name)", args)
...
DeleteQueue(name, args::AbstractDict{String, <:Any}) = mediaconvert("DELETE", "/2017-08-29/queues/$(name)", args)
...
DescribeEndpoints(args::AbstractDict{String, Any}) = mediaconvert("POST", "/2017-08-29/endpoints", args)
...
DisassociateCertificate(arn, args::AbstractDict{String, <:Any}) = mediaconvert("DELETE", "/2017-08-29/certificates/$(arn)", args)
...
GetJob(id, args::AbstractDict{String, <:Any}) = mediaconvert("GET", "/2017-08-29/jobs/$(id)", args)
...
GetJobTemplate(name, args::AbstractDict{String, <:Any}) = mediaconvert("GET", "/2017-08-29/jobTemplates/$(name)", args)
...
GetPreset(name, args::AbstractDict{String, <:Any}) = mediaconvert("GET", "/2017-08-29/presets/$(name)", args)
...
GetQueue(name, args::AbstractDict{String, <:Any}) = mediaconvert("GET", "/2017-08-29/queues/$(name)", args)
...
ListJobTemplates(args::AbstractDict{String, Any}) = mediaconvert("GET", "/2017-08-29/jobTemplates", args)
...
ListJobs(args::AbstractDict{String, Any}) = mediaconvert("GET", "/2017-08-29/jobs", args)
...
ListPresets(args::AbstractDict{String, Any}) = mediaconvert("GET", "/2017-08-29/presets", args)
...
ListQueues(args::AbstractDict{String, Any}) = mediaconvert("GET", "/2017-08-29/queues", args)
...
ListTagsForResource(arn, args::AbstractDict{String, <:Any}) = mediaconvert("GET", "/2017-08-29/tags/$(arn)", args)
...
"""
TagResource(arn, tags) = mediaconvert("POST", "/2017-08-29/tags", Dict{String, Any}("arn"=>arn, "tags"=>tags))
TagResource(arn, tags, args::AbstractDict{String, <:Any}) = mediaconvert("POST", "/2017-08-29/tags", Dict{String, Any}("arn"=>arn, "tags"=>tags, args...))
...
UntagResource(arn, args::AbstractDict{String, <:Any}) = mediaconvert("PUT", "/2017-08-29/tags/$(arn)", args)
...
UpdateJobTemplate(name, args::AbstractDict{String, <:Any}) = mediaconvert("PUT", "/2017-08-29/jobTemplates/$(name)", args)
...
UpdatePreset(name, args::AbstractDict{String, <:Any}) = mediaconvert("PUT", "/2017-08-29/presets/$(name)", args)
...
UpdateQueue(name, args::AbstractDict{String, <:Any}) = mediaconvert("PUT", "/2017-08-29/queues/$(name)", args)
