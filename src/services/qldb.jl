...
# Optional Parameters
- `DeletionProtection`: The flag that prevents a ledger from being deleted by any user. If
...
# Required Parameters
- `ExclusiveEndTime`: The exclusive end date and time for the range of journal contents
...
- `InclusiveStartTime`: The inclusive start date and time for the range of journal contents
  that you want to export. The InclusiveStartTime must be in ISO 8601 date and time format
  ...
  CreationDateTime.
- `RoleArn`: The Amazon Resource Name (ARN) of the IAM role that grants QLDB permissions
...
- `S3ExportConfiguration`: The configuration settings of the Amazon S3 bucket destination
...
# Required Parameters
- `BlockAddress`: The location of the block that you want to request. An address is an
...
# Required Parameters
- `BlockAddress`: The block location of the document revision to be verified. An address is
  an Amazon Ion structure that has two fields: strandId and sequenceNo. For example:
  {strandId:\"BlFTjlSXze9BIh1KOszcE3\",sequenceNo:14}
...
# Required Parameters
- `resourceArn`: The Amazon Resource Name (ARN) for which you want to list the tags. For
...
# Required Parameters
- `InclusiveStartTime`: The inclusive start date and time from which to start streaming
  ...
  CreationDateTime.
- `KinesisConfiguration`: The configuration settings of the Kinesis Data Streams
  destination for your stream request.
- `RoleArn`: The Amazon Resource Name (ARN) of the IAM role that grants QLDB permissions
  for a journal stream to write data records to a Kinesis Data Streams resource.
- `StreamName`: The name that you want to assign to the QLDB journal stream. User-defined
...
- `resourceArn`: The Amazon Resource Name (ARN) to which you want to add the tags. For
  example:  arn:aws:qldb:us-east-1:123456789012:ledger/exampleLedger
...
# Required Parameters
- `resourceArn`: The Amazon Resource Name (ARN) from which you want to remove the tags. For
  example:  arn:aws:qldb:us-east-1:123456789012:ledger/exampleLedger
