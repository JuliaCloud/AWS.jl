...
for all pull requests that meet the conditions of the template. For more information, see [`associate_approval_rule_template_with_repository`](@ref).
...
!!! note
    ...
    git commands such as git fetch. To retrieve this commit, you must specify its commit ID
    or otherwise reference it.
...
function get_branch(; aws_config::AbstractAWSConfig=current_aws_config())
    return codecommit("GetBranch"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_branch(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return codecommit("GetBranch", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_approval_rule_templates(; aws_config::AbstractAWSConfig=current_aws_config())
    return codecommit(
        "ListApprovalRuleTemplates"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_approval_rule_templates(
    ...
    return codecommit(
        "ListApprovalRuleTemplates", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_repositories(; aws_config::AbstractAWSConfig=current_aws_config())
    return codecommit("ListRepositories"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_repositories(
    ...
    return codecommit(
        "ListRepositories", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
