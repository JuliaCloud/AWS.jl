...
"""
function get_blob(blobId, repositoryName; aws_config::AbstractAWSConfig=current_aws_config())
    return codecommit(
        "GetBlob",
...
"""
function get_comment_reactions(commentId; aws_config::AbstractAWSConfig=current_aws_config())
    return codecommit(
        "GetCommentReactions",
        Dict{String,Any}("commentId" => commentId);
        aws_config=aws_config,
