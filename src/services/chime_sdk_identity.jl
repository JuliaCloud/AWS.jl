...
const SERVICE_PARAMETER_MAP = AWS.LittleDict("allow_messages" => "AllowMessages", "name" => "Name", "metadata" => "Metadata", "tags" => "Tags", "max_results" => "max-results", "next_token" => "next-token")
