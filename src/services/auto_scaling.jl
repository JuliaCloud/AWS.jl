...
function attach_load_balancer_target_groups(
    AutoScalingGroupName, TargetGroupARNs; aws_config::AbstractAWSConfig=current_aws_config()
)
    return auto_scaling(
...
- `"NextToken"`: The token for the next set of items to return. (You received this token
  from a previous call.)
"""
function describe_launch_configurations(; aws_config::AbstractAWSConfig=current_aws_config())
    return auto_scaling(
...
"""
function describe_scaling_process_types(; aws_config::AbstractAWSConfig=current_aws_config())
    return auto_scaling(
...
function set_desired_capacity(
    AutoScalingGroupName, DesiredCapacity; aws_config::AbstractAWSConfig=current_aws_config()
)
    return auto_scaling(
        "SetDesiredCapacity",
        Dict{String,Any}(
