...
"""
AttachInstances(AutoScalingGroupName) = auto_scaling("AttachInstances", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
AttachInstances(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("AttachInstances", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
...
"""
AttachLoadBalancerTargetGroups(AutoScalingGroupName, TargetGroupARNs) = auto_scaling("AttachLoadBalancerTargetGroups", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "TargetGroupARNs"=>TargetGroupARNs))
AttachLoadBalancerTargetGroups(AutoScalingGroupName, TargetGroupARNs, args::AbstractDict{String, <: Any}) = auto_scaling("AttachLoadBalancerTargetGroups", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "TargetGroupARNs"=>TargetGroupARNs, args...))
...
"""
AttachLoadBalancers(AutoScalingGroupName, LoadBalancerNames) = auto_scaling("AttachLoadBalancers", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LoadBalancerNames"=>LoadBalancerNames))
AttachLoadBalancers(AutoScalingGroupName, LoadBalancerNames, args::AbstractDict{String, <: Any}) = auto_scaling("AttachLoadBalancers", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LoadBalancerNames"=>LoadBalancerNames, args...))
...
"""
BatchDeleteScheduledAction(AutoScalingGroupName, ScheduledActionNames) = auto_scaling("BatchDeleteScheduledAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledActionNames"=>ScheduledActionNames))
BatchDeleteScheduledAction(AutoScalingGroupName, ScheduledActionNames, args::AbstractDict{String, <: Any}) = auto_scaling("BatchDeleteScheduledAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledActionNames"=>ScheduledActionNames, args...))
...
"""
BatchPutScheduledUpdateGroupAction(AutoScalingGroupName, ScheduledUpdateGroupActions) = auto_scaling("BatchPutScheduledUpdateGroupAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledUpdateGroupActions"=>ScheduledUpdateGroupActions))
BatchPutScheduledUpdateGroupAction(AutoScalingGroupName, ScheduledUpdateGroupActions, args::AbstractDict{String, <: Any}) = auto_scaling("BatchPutScheduledUpdateGroupAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledUpdateGroupActions"=>ScheduledUpdateGroupActions, args...))
...
"""
CancelInstanceRefresh(AutoScalingGroupName) = auto_scaling("CancelInstanceRefresh", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
CancelInstanceRefresh(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("CancelInstanceRefresh", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
...
"""
CompleteLifecycleAction(AutoScalingGroupName, LifecycleActionResult, LifecycleHookName) = auto_scaling("CompleteLifecycleAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleActionResult"=>LifecycleActionResult, "LifecycleHookName"=>LifecycleHookName))
CompleteLifecycleAction(AutoScalingGroupName, LifecycleActionResult, LifecycleHookName, args::AbstractDict{String, <: Any}) = auto_scaling("CompleteLifecycleAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleActionResult"=>LifecycleActionResult, "LifecycleHookName"=>LifecycleHookName, args...))
...
"""
CreateAutoScalingGroup(AutoScalingGroupName, MaxSize, MinSize) = auto_scaling("CreateAutoScalingGroup", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "MaxSize"=>MaxSize, "MinSize"=>MinSize))
CreateAutoScalingGroup(AutoScalingGroupName, MaxSize, MinSize, args::AbstractDict{String, <: Any}) = auto_scaling("CreateAutoScalingGroup", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "MaxSize"=>MaxSize, "MinSize"=>MinSize, args...))
...
"""
CreateLaunchConfiguration(LaunchConfigurationName) = auto_scaling("CreateLaunchConfiguration", Dict{String, Any}("LaunchConfigurationName"=>LaunchConfigurationName))
CreateLaunchConfiguration(LaunchConfigurationName, args::AbstractDict{String, <: Any}) = auto_scaling("CreateLaunchConfiguration", Dict{String, Any}("LaunchConfigurationName"=>LaunchConfigurationName, args...))
...
"""
CreateOrUpdateTags(Tags) = auto_scaling("CreateOrUpdateTags", Dict{String, Any}("Tags"=>Tags))
CreateOrUpdateTags(Tags, args::AbstractDict{String, <: Any}) = auto_scaling("CreateOrUpdateTags", Dict{String, Any}("Tags"=>Tags, args...))
...
"""
DeleteAutoScalingGroup(AutoScalingGroupName) = auto_scaling("DeleteAutoScalingGroup", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
DeleteAutoScalingGroup(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("DeleteAutoScalingGroup", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
...
"""
DeleteLaunchConfiguration(LaunchConfigurationName) = auto_scaling("DeleteLaunchConfiguration", Dict{String, Any}("LaunchConfigurationName"=>LaunchConfigurationName))
DeleteLaunchConfiguration(LaunchConfigurationName, args::AbstractDict{String, <: Any}) = auto_scaling("DeleteLaunchConfiguration", Dict{String, Any}("LaunchConfigurationName"=>LaunchConfigurationName, args...))
...
"""
DeleteLifecycleHook(AutoScalingGroupName, LifecycleHookName) = auto_scaling("DeleteLifecycleHook", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleHookName"=>LifecycleHookName))
DeleteLifecycleHook(AutoScalingGroupName, LifecycleHookName, args::AbstractDict{String, <: Any}) = auto_scaling("DeleteLifecycleHook", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleHookName"=>LifecycleHookName, args...))
...
"""
DeleteNotificationConfiguration(AutoScalingGroupName, TopicARN) = auto_scaling("DeleteNotificationConfiguration", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "TopicARN"=>TopicARN))
DeleteNotificationConfiguration(AutoScalingGroupName, TopicARN, args::AbstractDict{String, <: Any}) = auto_scaling("DeleteNotificationConfiguration", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "TopicARN"=>TopicARN, args...))
...
AutoScalingGroupName => The name of the Auto Scaling group.
"""
DeletePolicy(PolicyName) = auto_scaling("DeletePolicy", Dict{String, Any}("PolicyName"=>PolicyName))
DeletePolicy(PolicyName, args::AbstractDict{String, <: Any}) = auto_scaling("DeletePolicy", Dict{String, Any}("PolicyName"=>PolicyName, args...))
...
"""
DeleteScheduledAction(AutoScalingGroupName, ScheduledActionName) = auto_scaling("DeleteScheduledAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledActionName"=>ScheduledActionName))
DeleteScheduledAction(AutoScalingGroupName, ScheduledActionName, args::AbstractDict{String, <: Any}) = auto_scaling("DeleteScheduledAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledActionName"=>ScheduledActionName, args...))
...
"""
DeleteTags(Tags) = auto_scaling("DeleteTags", Dict{String, Any}("Tags"=>Tags))
DeleteTags(Tags, args::AbstractDict{String, <: Any}) = auto_scaling("DeleteTags", Dict{String, Any}("Tags"=>Tags, args...))
...
DescribeAccountLimits(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeAccountLimits", args)
...
DescribeAdjustmentTypes(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeAdjustmentTypes", args)
...
DescribeAutoScalingGroups(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeAutoScalingGroups", args)
...
DescribeAutoScalingInstances(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeAutoScalingInstances", args)
...
DescribeAutoScalingNotificationTypes(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeAutoScalingNotificationTypes", args)
...
NextToken => The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeInstanceRefreshes(AutoScalingGroupName) = auto_scaling("DescribeInstanceRefreshes", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
DescribeInstanceRefreshes(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("DescribeInstanceRefreshes", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
...
DescribeLaunchConfigurations(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeLaunchConfigurations", args)
...
DescribeLifecycleHookTypes(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeLifecycleHookTypes", args)
...
"""
DescribeLifecycleHooks(AutoScalingGroupName) = auto_scaling("DescribeLifecycleHooks", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
DescribeLifecycleHooks(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("DescribeLifecycleHooks", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
...
NextToken => The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeLoadBalancerTargetGroups(AutoScalingGroupName) = auto_scaling("DescribeLoadBalancerTargetGroups", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
DescribeLoadBalancerTargetGroups(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("DescribeLoadBalancerTargetGroups", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
...
NextToken => The token for the next set of items to return. (You received this token from a previous call.)
"""
DescribeLoadBalancers(AutoScalingGroupName) = auto_scaling("DescribeLoadBalancers", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
DescribeLoadBalancers(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("DescribeLoadBalancers", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
...
DescribeMetricCollectionTypes(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeMetricCollectionTypes", args)
...
DescribeNotificationConfigurations(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeNotificationConfigurations", args)
...
DescribePolicies(args::AbstractDict{String, <: Any}) = auto_scaling("DescribePolicies", args)
...
DescribeScalingActivities(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeScalingActivities", args)
...
DescribeScalingProcessTypes(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeScalingProcessTypes", args)
...
DescribeScheduledActions(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeScheduledActions", args)
...
DescribeTags(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeTags", args)
...
DescribeTerminationPolicyTypes(args::AbstractDict{String, <: Any}) = auto_scaling("DescribeTerminationPolicyTypes", args)
...
InstanceIds => The IDs of the instances. You can specify up to 20 instances.
"""
DetachInstances(AutoScalingGroupName, ShouldDecrementDesiredCapacity) = auto_scaling("DetachInstances", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ShouldDecrementDesiredCapacity"=>ShouldDecrementDesiredCapacity))
DetachInstances(AutoScalingGroupName, ShouldDecrementDesiredCapacity, args::AbstractDict{String, <: Any}) = auto_scaling("DetachInstances", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ShouldDecrementDesiredCapacity"=>ShouldDecrementDesiredCapacity, args...))
...
"""
DetachLoadBalancerTargetGroups(AutoScalingGroupName, TargetGroupARNs) = auto_scaling("DetachLoadBalancerTargetGroups", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "TargetGroupARNs"=>TargetGroupARNs))
DetachLoadBalancerTargetGroups(AutoScalingGroupName, TargetGroupARNs, args::AbstractDict{String, <: Any}) = auto_scaling("DetachLoadBalancerTargetGroups", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "TargetGroupARNs"=>TargetGroupARNs, args...))
...
"""
DetachLoadBalancers(AutoScalingGroupName, LoadBalancerNames) = auto_scaling("DetachLoadBalancers", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LoadBalancerNames"=>LoadBalancerNames))
DetachLoadBalancers(AutoScalingGroupName, LoadBalancerNames, args::AbstractDict{String, <: Any}) = auto_scaling("DetachLoadBalancers", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LoadBalancerNames"=>LoadBalancerNames, args...))
...
"""
DisableMetricsCollection(AutoScalingGroupName) = auto_scaling("DisableMetricsCollection", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
DisableMetricsCollection(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("DisableMetricsCollection", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
...
"""
EnableMetricsCollection(AutoScalingGroupName, Granularity) = auto_scaling("EnableMetricsCollection", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "Granularity"=>Granularity))
EnableMetricsCollection(AutoScalingGroupName, Granularity, args::AbstractDict{String, <: Any}) = auto_scaling("EnableMetricsCollection", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "Granularity"=>Granularity, args...))
...
InstanceIds => The IDs of the instances. You can specify up to 20 instances.
"""
EnterStandby(AutoScalingGroupName, ShouldDecrementDesiredCapacity) = auto_scaling("EnterStandby", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ShouldDecrementDesiredCapacity"=>ShouldDecrementDesiredCapacity))
EnterStandby(AutoScalingGroupName, ShouldDecrementDesiredCapacity, args::AbstractDict{String, <: Any}) = auto_scaling("EnterStandby", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ShouldDecrementDesiredCapacity"=>ShouldDecrementDesiredCapacity, args...))
...
"""
ExecutePolicy(PolicyName) = auto_scaling("ExecutePolicy", Dict{String, Any}("PolicyName"=>PolicyName))
ExecutePolicy(PolicyName, args::AbstractDict{String, <: Any}) = auto_scaling("ExecutePolicy", Dict{String, Any}("PolicyName"=>PolicyName, args...))
...
InstanceIds => The IDs of the instances. You can specify up to 20 instances.
"""
ExitStandby(AutoScalingGroupName) = auto_scaling("ExitStandby", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
ExitStandby(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("ExitStandby", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
...
"""
PutLifecycleHook(AutoScalingGroupName, LifecycleHookName) = auto_scaling("PutLifecycleHook", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleHookName"=>LifecycleHookName))
PutLifecycleHook(AutoScalingGroupName, LifecycleHookName, args::AbstractDict{String, <: Any}) = auto_scaling("PutLifecycleHook", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleHookName"=>LifecycleHookName, args...))
...
"""
PutNotificationConfiguration(AutoScalingGroupName, NotificationTypes, TopicARN) = auto_scaling("PutNotificationConfiguration", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "NotificationTypes"=>NotificationTypes, "TopicARN"=>TopicARN))
PutNotificationConfiguration(AutoScalingGroupName, NotificationTypes, TopicARN, args::AbstractDict{String, <: Any}) = auto_scaling("PutNotificationConfiguration", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "NotificationTypes"=>NotificationTypes, "TopicARN"=>TopicARN, args...))
...
Optional Parameters
AdjustmentType => Specifies how the scaling adjustment is interpreted (either an absolute number or a percentage). The valid values are ChangeInCapacity, ExactCapacity, and PercentChangeInCapacity. Required if the policy type is StepScaling or SimpleScaling. For more information, see Scaling Adjustment Types in the Amazon EC2 Auto Scaling User Guide.
...
"""
PutScalingPolicy(AutoScalingGroupName, PolicyName) = auto_scaling("PutScalingPolicy", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "PolicyName"=>PolicyName))
PutScalingPolicy(AutoScalingGroupName, PolicyName, args::AbstractDict{String, <: Any}) = auto_scaling("PutScalingPolicy", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "PolicyName"=>PolicyName, args...))
...
"""
PutScheduledUpdateGroupAction(AutoScalingGroupName, ScheduledActionName) = auto_scaling("PutScheduledUpdateGroupAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledActionName"=>ScheduledActionName))
PutScheduledUpdateGroupAction(AutoScalingGroupName, ScheduledActionName, args::AbstractDict{String, <: Any}) = auto_scaling("PutScheduledUpdateGroupAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledActionName"=>ScheduledActionName, args...))
...
"""
RecordLifecycleActionHeartbeat(AutoScalingGroupName, LifecycleHookName) = auto_scaling("RecordLifecycleActionHeartbeat", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleHookName"=>LifecycleHookName))
RecordLifecycleActionHeartbeat(AutoScalingGroupName, LifecycleHookName, args::AbstractDict{String, <: Any}) = auto_scaling("RecordLifecycleActionHeartbeat", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleHookName"=>LifecycleHookName, args...))
...
"""
ResumeProcesses(AutoScalingGroupName) = auto_scaling("ResumeProcesses", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
ResumeProcesses(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("ResumeProcesses", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
...
"""
SetDesiredCapacity(AutoScalingGroupName, DesiredCapacity) = auto_scaling("SetDesiredCapacity", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "DesiredCapacity"=>DesiredCapacity))
SetDesiredCapacity(AutoScalingGroupName, DesiredCapacity, args::AbstractDict{String, <: Any}) = auto_scaling("SetDesiredCapacity", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "DesiredCapacity"=>DesiredCapacity, args...))
...
"""
SetInstanceHealth(HealthStatus, InstanceId) = auto_scaling("SetInstanceHealth", Dict{String, Any}("HealthStatus"=>HealthStatus, "InstanceId"=>InstanceId))
SetInstanceHealth(HealthStatus, InstanceId, args::AbstractDict{String, <: Any}) = auto_scaling("SetInstanceHealth", Dict{String, Any}("HealthStatus"=>HealthStatus, "InstanceId"=>InstanceId, args...))
...
"""
SetInstanceProtection(AutoScalingGroupName, InstanceIds, ProtectedFromScaleIn) = auto_scaling("SetInstanceProtection", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "InstanceIds"=>InstanceIds, "ProtectedFromScaleIn"=>ProtectedFromScaleIn))
SetInstanceProtection(AutoScalingGroupName, InstanceIds, ProtectedFromScaleIn, args::AbstractDict{String, <: Any}) = auto_scaling("SetInstanceProtection", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "InstanceIds"=>InstanceIds, "ProtectedFromScaleIn"=>ProtectedFromScaleIn, args...))
...
"""
StartInstanceRefresh(AutoScalingGroupName) = auto_scaling("StartInstanceRefresh", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
StartInstanceRefresh(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("StartInstanceRefresh", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
...
ScalingProcesses => One or more of the following processes:    Launch     Terminate     AddToLoadBalancer     AlarmNotification     AZRebalance     HealthCheck     InstanceRefresh     ReplaceUnhealthy     ScheduledActions    If you omit this parameter, all processes are specified.
"""
SuspendProcesses(AutoScalingGroupName) = auto_scaling("SuspendProcesses", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
SuspendProcesses(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("SuspendProcesses", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
...
"""
TerminateInstanceInAutoScalingGroup(InstanceId, ShouldDecrementDesiredCapacity) = auto_scaling("TerminateInstanceInAutoScalingGroup", Dict{String, Any}("InstanceId"=>InstanceId, "ShouldDecrementDesiredCapacity"=>ShouldDecrementDesiredCapacity))
TerminateInstanceInAutoScalingGroup(InstanceId, ShouldDecrementDesiredCapacity, args::AbstractDict{String, <: Any}) = auto_scaling("TerminateInstanceInAutoScalingGroup", Dict{String, Any}("InstanceId"=>InstanceId, "ShouldDecrementDesiredCapacity"=>ShouldDecrementDesiredCapacity, args...))
...
"""
UpdateAutoScalingGroup(AutoScalingGroupName) = auto_scaling("UpdateAutoScalingGroup", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName))
UpdateAutoScalingGroup(AutoScalingGroupName, args::AbstractDict{String, <: Any}) = auto_scaling("UpdateAutoScalingGroup", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, args...))
