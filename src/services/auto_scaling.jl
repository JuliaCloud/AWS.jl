...
AttachInstances(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("AttachInstances", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
AttachInstances(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("AttachInstances", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
...
AttachLoadBalancerTargetGroups(AutoScalingGroupName, TargetGroupARNs; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("AttachLoadBalancerTargetGroups", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "TargetGroupARNs"=>TargetGroupARNs); aws_config=aws_config)
AttachLoadBalancerTargetGroups(AutoScalingGroupName, TargetGroupARNs, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("AttachLoadBalancerTargetGroups", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "TargetGroupARNs"=>TargetGroupARNs), args)); aws_config=aws_config)
...
AttachLoadBalancers(AutoScalingGroupName, LoadBalancerNames; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("AttachLoadBalancers", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LoadBalancerNames"=>LoadBalancerNames); aws_config=aws_config)
AttachLoadBalancers(AutoScalingGroupName, LoadBalancerNames, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("AttachLoadBalancers", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LoadBalancerNames"=>LoadBalancerNames), args)); aws_config=aws_config)
...
BatchDeleteScheduledAction(AutoScalingGroupName, ScheduledActionNames; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("BatchDeleteScheduledAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledActionNames"=>ScheduledActionNames); aws_config=aws_config)
BatchDeleteScheduledAction(AutoScalingGroupName, ScheduledActionNames, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("BatchDeleteScheduledAction", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledActionNames"=>ScheduledActionNames), args)); aws_config=aws_config)
...
CancelInstanceRefresh(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("CancelInstanceRefresh", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
CancelInstanceRefresh(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("CancelInstanceRefresh", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
...
CompleteLifecycleAction(AutoScalingGroupName, LifecycleActionResult, LifecycleHookName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("CompleteLifecycleAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleActionResult"=>LifecycleActionResult, "LifecycleHookName"=>LifecycleHookName); aws_config=aws_config)
CompleteLifecycleAction(AutoScalingGroupName, LifecycleActionResult, LifecycleHookName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("CompleteLifecycleAction", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleActionResult"=>LifecycleActionResult, "LifecycleHookName"=>LifecycleHookName), args)); aws_config=aws_config)
...
CreateAutoScalingGroup(AutoScalingGroupName, MaxSize, MinSize; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("CreateAutoScalingGroup", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "MaxSize"=>MaxSize, "MinSize"=>MinSize); aws_config=aws_config)
CreateAutoScalingGroup(AutoScalingGroupName, MaxSize, MinSize, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("CreateAutoScalingGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "MaxSize"=>MaxSize, "MinSize"=>MinSize), args)); aws_config=aws_config)
...
CreateLaunchConfiguration(LaunchConfigurationName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("CreateLaunchConfiguration", Dict{String, Any}("LaunchConfigurationName"=>LaunchConfigurationName); aws_config=aws_config)
CreateLaunchConfiguration(LaunchConfigurationName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("CreateLaunchConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LaunchConfigurationName"=>LaunchConfigurationName), args)); aws_config=aws_config)
...
CreateOrUpdateTags(Tags; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("CreateOrUpdateTags", Dict{String, Any}("Tags"=>Tags); aws_config=aws_config)
CreateOrUpdateTags(Tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("CreateOrUpdateTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Tags"=>Tags), args)); aws_config=aws_config)
...
DeleteAutoScalingGroup(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeleteAutoScalingGroup", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
DeleteAutoScalingGroup(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeleteAutoScalingGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
...
DeleteLaunchConfiguration(LaunchConfigurationName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeleteLaunchConfiguration", Dict{String, Any}("LaunchConfigurationName"=>LaunchConfigurationName); aws_config=aws_config)
DeleteLaunchConfiguration(LaunchConfigurationName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeleteLaunchConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LaunchConfigurationName"=>LaunchConfigurationName), args)); aws_config=aws_config)
...
DeleteLifecycleHook(AutoScalingGroupName, LifecycleHookName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeleteLifecycleHook", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleHookName"=>LifecycleHookName); aws_config=aws_config)
DeleteLifecycleHook(AutoScalingGroupName, LifecycleHookName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeleteLifecycleHook", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleHookName"=>LifecycleHookName), args)); aws_config=aws_config)
...
DeleteNotificationConfiguration(AutoScalingGroupName, TopicARN; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeleteNotificationConfiguration", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "TopicARN"=>TopicARN); aws_config=aws_config)
DeleteNotificationConfiguration(AutoScalingGroupName, TopicARN, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeleteNotificationConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "TopicARN"=>TopicARN), args)); aws_config=aws_config)
...
DeletePolicy(PolicyName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeletePolicy", Dict{String, Any}("PolicyName"=>PolicyName); aws_config=aws_config)
DeletePolicy(PolicyName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeletePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PolicyName"=>PolicyName), args)); aws_config=aws_config)
...
DeleteScheduledAction(AutoScalingGroupName, ScheduledActionName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeleteScheduledAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledActionName"=>ScheduledActionName); aws_config=aws_config)
DeleteScheduledAction(AutoScalingGroupName, ScheduledActionName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeleteScheduledAction", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledActionName"=>ScheduledActionName), args)); aws_config=aws_config)
...
DeleteTags(Tags; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeleteTags", Dict{String, Any}("Tags"=>Tags); aws_config=aws_config)
DeleteTags(Tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DeleteTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Tags"=>Tags), args)); aws_config=aws_config)
...
DescribeAccountLimits(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeAccountLimits"; aws_config=aws_config)
DescribeAccountLimits(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeAccountLimits", args; aws_config=aws_config)
...
DescribeAdjustmentTypes(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeAdjustmentTypes"; aws_config=aws_config)
DescribeAdjustmentTypes(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeAdjustmentTypes", args; aws_config=aws_config)
...
DescribeAutoScalingGroups(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeAutoScalingGroups"; aws_config=aws_config)
DescribeAutoScalingGroups(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeAutoScalingGroups", args; aws_config=aws_config)
...
DescribeAutoScalingInstances(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeAutoScalingInstances"; aws_config=aws_config)
DescribeAutoScalingInstances(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeAutoScalingInstances", args; aws_config=aws_config)
...
DescribeAutoScalingNotificationTypes(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeAutoScalingNotificationTypes"; aws_config=aws_config)
DescribeAutoScalingNotificationTypes(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeAutoScalingNotificationTypes", args; aws_config=aws_config)
...
DescribeInstanceRefreshes(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeInstanceRefreshes", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
DescribeInstanceRefreshes(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeInstanceRefreshes", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
...
DescribeLaunchConfigurations(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeLaunchConfigurations"; aws_config=aws_config)
DescribeLaunchConfigurations(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeLaunchConfigurations", args; aws_config=aws_config)
...
DescribeLifecycleHookTypes(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeLifecycleHookTypes"; aws_config=aws_config)
DescribeLifecycleHookTypes(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeLifecycleHookTypes", args; aws_config=aws_config)
...
DescribeLifecycleHooks(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeLifecycleHooks", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
DescribeLifecycleHooks(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeLifecycleHooks", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
...
DescribeLoadBalancerTargetGroups(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeLoadBalancerTargetGroups", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
DescribeLoadBalancerTargetGroups(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeLoadBalancerTargetGroups", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
...
DescribeLoadBalancers(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeLoadBalancers", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
DescribeLoadBalancers(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeLoadBalancers", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
...
DescribeMetricCollectionTypes(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeMetricCollectionTypes"; aws_config=aws_config)
DescribeMetricCollectionTypes(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeMetricCollectionTypes", args; aws_config=aws_config)
...
DescribeNotificationConfigurations(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeNotificationConfigurations"; aws_config=aws_config)
DescribeNotificationConfigurations(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeNotificationConfigurations", args; aws_config=aws_config)
...
DescribePolicies(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribePolicies"; aws_config=aws_config)
DescribePolicies(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribePolicies", args; aws_config=aws_config)
...
DescribeScalingActivities(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeScalingActivities"; aws_config=aws_config)
DescribeScalingActivities(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeScalingActivities", args; aws_config=aws_config)
...
DescribeScalingProcessTypes(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeScalingProcessTypes"; aws_config=aws_config)
DescribeScalingProcessTypes(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeScalingProcessTypes", args; aws_config=aws_config)
...
DescribeScheduledActions(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeScheduledActions"; aws_config=aws_config)
DescribeScheduledActions(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeScheduledActions", args; aws_config=aws_config)
...
DescribeTags(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeTags"; aws_config=aws_config)
DescribeTags(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeTags", args; aws_config=aws_config)
...
DescribeTerminationPolicyTypes(; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeTerminationPolicyTypes"; aws_config=aws_config)
DescribeTerminationPolicyTypes(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DescribeTerminationPolicyTypes", args; aws_config=aws_config)
...
DetachInstances(AutoScalingGroupName, ShouldDecrementDesiredCapacity; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DetachInstances", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ShouldDecrementDesiredCapacity"=>ShouldDecrementDesiredCapacity); aws_config=aws_config)
DetachInstances(AutoScalingGroupName, ShouldDecrementDesiredCapacity, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DetachInstances", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ShouldDecrementDesiredCapacity"=>ShouldDecrementDesiredCapacity), args)); aws_config=aws_config)
...
DetachLoadBalancerTargetGroups(AutoScalingGroupName, TargetGroupARNs; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DetachLoadBalancerTargetGroups", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "TargetGroupARNs"=>TargetGroupARNs); aws_config=aws_config)
DetachLoadBalancerTargetGroups(AutoScalingGroupName, TargetGroupARNs, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DetachLoadBalancerTargetGroups", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "TargetGroupARNs"=>TargetGroupARNs), args)); aws_config=aws_config)
...
DetachLoadBalancers(AutoScalingGroupName, LoadBalancerNames; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DetachLoadBalancers", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LoadBalancerNames"=>LoadBalancerNames); aws_config=aws_config)
DetachLoadBalancers(AutoScalingGroupName, LoadBalancerNames, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DetachLoadBalancers", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LoadBalancerNames"=>LoadBalancerNames), args)); aws_config=aws_config)
...
DisableMetricsCollection(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DisableMetricsCollection", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
DisableMetricsCollection(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("DisableMetricsCollection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
...
EnableMetricsCollection(AutoScalingGroupName, Granularity; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("EnableMetricsCollection", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "Granularity"=>Granularity); aws_config=aws_config)
EnableMetricsCollection(AutoScalingGroupName, Granularity, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("EnableMetricsCollection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "Granularity"=>Granularity), args)); aws_config=aws_config)
...
EnterStandby(AutoScalingGroupName, ShouldDecrementDesiredCapacity; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("EnterStandby", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ShouldDecrementDesiredCapacity"=>ShouldDecrementDesiredCapacity); aws_config=aws_config)
EnterStandby(AutoScalingGroupName, ShouldDecrementDesiredCapacity, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("EnterStandby", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ShouldDecrementDesiredCapacity"=>ShouldDecrementDesiredCapacity), args)); aws_config=aws_config)
...
ExecutePolicy(PolicyName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("ExecutePolicy", Dict{String, Any}("PolicyName"=>PolicyName); aws_config=aws_config)
ExecutePolicy(PolicyName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("ExecutePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PolicyName"=>PolicyName), args)); aws_config=aws_config)
...
ExitStandby(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("ExitStandby", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
ExitStandby(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("ExitStandby", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
...
PutLifecycleHook(AutoScalingGroupName, LifecycleHookName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("PutLifecycleHook", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleHookName"=>LifecycleHookName); aws_config=aws_config)
PutLifecycleHook(AutoScalingGroupName, LifecycleHookName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("PutLifecycleHook", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleHookName"=>LifecycleHookName), args)); aws_config=aws_config)
...
PutNotificationConfiguration(AutoScalingGroupName, NotificationTypes, TopicARN; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("PutNotificationConfiguration", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "NotificationTypes"=>NotificationTypes, "TopicARN"=>TopicARN); aws_config=aws_config)
PutNotificationConfiguration(AutoScalingGroupName, NotificationTypes, TopicARN, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("PutNotificationConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "NotificationTypes"=>NotificationTypes, "TopicARN"=>TopicARN), args)); aws_config=aws_config)
...
PutScalingPolicy(AutoScalingGroupName, PolicyName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("PutScalingPolicy", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "PolicyName"=>PolicyName); aws_config=aws_config)
PutScalingPolicy(AutoScalingGroupName, PolicyName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("PutScalingPolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "PolicyName"=>PolicyName), args)); aws_config=aws_config)
...
PutScheduledUpdateGroupAction(AutoScalingGroupName, ScheduledActionName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("PutScheduledUpdateGroupAction", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledActionName"=>ScheduledActionName); aws_config=aws_config)
PutScheduledUpdateGroupAction(AutoScalingGroupName, ScheduledActionName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("PutScheduledUpdateGroupAction", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "ScheduledActionName"=>ScheduledActionName), args)); aws_config=aws_config)
...
RecordLifecycleActionHeartbeat(AutoScalingGroupName, LifecycleHookName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("RecordLifecycleActionHeartbeat", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleHookName"=>LifecycleHookName); aws_config=aws_config)
RecordLifecycleActionHeartbeat(AutoScalingGroupName, LifecycleHookName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("RecordLifecycleActionHeartbeat", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "LifecycleHookName"=>LifecycleHookName), args)); aws_config=aws_config)
...
ResumeProcesses(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("ResumeProcesses", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
ResumeProcesses(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("ResumeProcesses", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
...
SetDesiredCapacity(AutoScalingGroupName, DesiredCapacity; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("SetDesiredCapacity", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "DesiredCapacity"=>DesiredCapacity); aws_config=aws_config)
SetDesiredCapacity(AutoScalingGroupName, DesiredCapacity, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("SetDesiredCapacity", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "DesiredCapacity"=>DesiredCapacity), args)); aws_config=aws_config)
...
SetInstanceHealth(HealthStatus, InstanceId; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("SetInstanceHealth", Dict{String, Any}("HealthStatus"=>HealthStatus, "InstanceId"=>InstanceId); aws_config=aws_config)
SetInstanceHealth(HealthStatus, InstanceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("SetInstanceHealth", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HealthStatus"=>HealthStatus, "InstanceId"=>InstanceId), args)); aws_config=aws_config)
...
SetInstanceProtection(AutoScalingGroupName, InstanceIds, ProtectedFromScaleIn; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("SetInstanceProtection", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "InstanceIds"=>InstanceIds, "ProtectedFromScaleIn"=>ProtectedFromScaleIn); aws_config=aws_config)
SetInstanceProtection(AutoScalingGroupName, InstanceIds, ProtectedFromScaleIn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("SetInstanceProtection", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName, "InstanceIds"=>InstanceIds, "ProtectedFromScaleIn"=>ProtectedFromScaleIn), args)); aws_config=aws_config)
...
StartInstanceRefresh(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("StartInstanceRefresh", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
StartInstanceRefresh(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("StartInstanceRefresh", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
...
SuspendProcesses(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("SuspendProcesses", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
SuspendProcesses(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("SuspendProcesses", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
...
TerminateInstanceInAutoScalingGroup(InstanceId, ShouldDecrementDesiredCapacity; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("TerminateInstanceInAutoScalingGroup", Dict{String, Any}("InstanceId"=>InstanceId, "ShouldDecrementDesiredCapacity"=>ShouldDecrementDesiredCapacity); aws_config=aws_config)
TerminateInstanceInAutoScalingGroup(InstanceId, ShouldDecrementDesiredCapacity, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("TerminateInstanceInAutoScalingGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceId"=>InstanceId, "ShouldDecrementDesiredCapacity"=>ShouldDecrementDesiredCapacity), args)); aws_config=aws_config)
...
UpdateAutoScalingGroup(AutoScalingGroupName; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("UpdateAutoScalingGroup", Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName); aws_config=aws_config)
UpdateAutoScalingGroup(AutoScalingGroupName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = auto_scaling("UpdateAutoScalingGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AutoScalingGroupName"=>AutoScalingGroupName), args)); aws_config=aws_config)
