...
"""
function cancel_world_generation_job(job; aws_config::AbstractAWSConfig=current_aws_config())
    return robomaker(
        "POST",
...
function create_robot(
    architecture, greengrassGroupId, name; aws_config::AbstractAWSConfig=current_aws_config()
)
    return robomaker(
        "POST",
        "/createRobot",
