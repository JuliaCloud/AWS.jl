...
"""
create_endpoint(OutpostId, SecurityGroupId, SubnetId; aws_config::AbstractAWSConfig=current_aws_config()) = s3outposts("POST", "/S3Outposts/CreateEndpoint", Dict{String, Any}("OutpostId"=>OutpostId, "SecurityGroupId"=>SecurityGroupId, "SubnetId"=>SubnetId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `outpost_id`: The ID of the Outposts.
"""
delete_endpoint(endpointId, outpostId; aws_config::AbstractAWSConfig=current_aws_config()) = s3outposts("DELETE", "/S3Outposts/DeleteEndpoint", Dict{String, Any}("endpointId"=>endpointId, "outpostId"=>outpostId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_endpoint(endpointId, outpostId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = s3outposts("DELETE", "/S3Outposts/DeleteEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("endpointId"=>endpointId, "outpostId"=>outpostId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_endpoints(; aws_config::AbstractAWSConfig=current_aws_config()) = s3outposts("GET", "/S3Outposts/ListEndpoints"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_endpoints(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = s3outposts("GET", "/S3Outposts/ListEndpoints", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_outposts_with_s3(; aws_config::AbstractAWSConfig=current_aws_config()) = s3outposts("GET", "/S3Outposts/ListOutpostsWithS3"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_outposts_with_s3(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = s3outposts("GET", "/S3Outposts/ListOutpostsWithS3", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_shared_endpoints(outpostId; aws_config::AbstractAWSConfig=current_aws_config()) = s3outposts("GET", "/S3Outposts/ListSharedEndpoints", Dict{String, Any}("outpostId"=>outpostId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_shared_endpoints(outpostId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = s3outposts("GET", "/S3Outposts/ListSharedEndpoints", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("outpostId"=>outpostId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
