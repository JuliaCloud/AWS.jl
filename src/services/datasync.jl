...
- `Tags`: The key-value pair that represents the tag that you want to add to the location. The value can be an empty string. We recommend using tags to name your resources.
"""
CreateLocationObjectStorage(AgentArns, BucketName, ServerHostname) = datasync("CreateLocationObjectStorage", Dict{String, Any}("AgentArns"=>AgentArns, "BucketName"=>BucketName, "ServerHostname"=>ServerHostname))
CreateLocationObjectStorage(AgentArns, BucketName, ServerHostname, args::AbstractDict{String, <:Any}) = datasync("CreateLocationObjectStorage", Dict{String, Any}("AgentArns"=>AgentArns, "BucketName"=>BucketName, "ServerHostname"=>ServerHostname, args...))
...
"""
DescribeLocationObjectStorage(LocationArn) = datasync("DescribeLocationObjectStorage", Dict{String, Any}("LocationArn"=>LocationArn))
DescribeLocationObjectStorage(LocationArn, args::AbstractDict{String, <:Any}) = datasync("DescribeLocationObjectStorage", Dict{String, Any}("LocationArn"=>LocationArn, args...))
