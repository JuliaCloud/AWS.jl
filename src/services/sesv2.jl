...
# Required Parameters
- `EmailIdentity`: The email address or domain that you want to associate with a configuration set.

# Optional Parameters
- `ConfigurationSetName`: The configuration set that you want to associate with an email identity.
"""
