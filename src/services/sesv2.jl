...
"""
CreateConfigurationSet(ConfigurationSetName; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/configuration-sets", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName))
CreateConfigurationSet(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/configuration-sets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName), args)); aws=aws)
...
"""
CreateConfigurationSetEventDestination(ConfigurationSetName, EventDestination, EventDestinationName; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations", Dict{String, Any}("EventDestination"=>EventDestination, "EventDestinationName"=>EventDestinationName))
CreateConfigurationSetEventDestination(ConfigurationSetName, EventDestination, EventDestinationName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EventDestination"=>EventDestination, "EventDestinationName"=>EventDestinationName), args)); aws=aws)
...
"""
CreateDedicatedIpPool(PoolName; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/dedicated-ip-pools", Dict{String, Any}("PoolName"=>PoolName))
CreateDedicatedIpPool(PoolName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/dedicated-ip-pools", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PoolName"=>PoolName), args)); aws=aws)
...
"""
CreateDeliverabilityTestReport(Content, FromEmailAddress; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/deliverability-dashboard/test", Dict{String, Any}("Content"=>Content, "FromEmailAddress"=>FromEmailAddress))
CreateDeliverabilityTestReport(Content, FromEmailAddress, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/deliverability-dashboard/test", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Content"=>Content, "FromEmailAddress"=>FromEmailAddress), args)); aws=aws)
...
"""
CreateEmailIdentity(EmailIdentity; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/identities", Dict{String, Any}("EmailIdentity"=>EmailIdentity))
CreateEmailIdentity(EmailIdentity, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/identities", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EmailIdentity"=>EmailIdentity), args)); aws=aws)
...
"""
CreateEmailIdentityPolicy(EmailIdentity, Policy, PolicyName; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/identities/$(EmailIdentity)/policies/$(PolicyName)", Dict{String, Any}("Policy"=>Policy))
CreateEmailIdentityPolicy(EmailIdentity, Policy, PolicyName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/identities/$(EmailIdentity)/policies/$(PolicyName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Policy"=>Policy), args)); aws=aws)
...
"""
CreateEmailTemplate(TemplateContent, TemplateName; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/templates", Dict{String, Any}("TemplateContent"=>TemplateContent, "TemplateName"=>TemplateName))
CreateEmailTemplate(TemplateContent, TemplateName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/templates", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TemplateContent"=>TemplateContent, "TemplateName"=>TemplateName), args)); aws=aws)
...
"""
DeleteConfigurationSet(ConfigurationSetName; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/configuration-sets/$(ConfigurationSetName)"; aws=aws)
DeleteConfigurationSet(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/configuration-sets/$(ConfigurationSetName)", args; aws=aws)
...
"""
DeleteConfigurationSetEventDestination(ConfigurationSetName, EventDestinationName; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations/$(EventDestinationName)"; aws=aws)
DeleteConfigurationSetEventDestination(ConfigurationSetName, EventDestinationName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations/$(EventDestinationName)", args; aws=aws)
...
"""
DeleteCustomVerificationEmailTemplate(TemplateName; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/custom-verification-email-templates/$(TemplateName)"; aws=aws)
DeleteCustomVerificationEmailTemplate(TemplateName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/custom-verification-email-templates/$(TemplateName)", args; aws=aws)
...
"""
DeleteDedicatedIpPool(PoolName; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/dedicated-ip-pools/$(PoolName)"; aws=aws)
DeleteDedicatedIpPool(PoolName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/dedicated-ip-pools/$(PoolName)", args; aws=aws)
...
"""
DeleteEmailIdentity(EmailIdentity; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/identities/$(EmailIdentity)"; aws=aws)
DeleteEmailIdentity(EmailIdentity, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/identities/$(EmailIdentity)", args; aws=aws)
...
"""
DeleteEmailIdentityPolicy(EmailIdentity, PolicyName; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/identities/$(EmailIdentity)/policies/$(PolicyName)"; aws=aws)
DeleteEmailIdentityPolicy(EmailIdentity, PolicyName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/identities/$(EmailIdentity)/policies/$(PolicyName)", args; aws=aws)
...
"""
DeleteEmailTemplate(TemplateName; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/templates/$(TemplateName)"; aws=aws)
DeleteEmailTemplate(TemplateName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/templates/$(TemplateName)", args; aws=aws)
...
"""
DeleteSuppressedDestination(EmailAddress; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/suppression/addresses/$(EmailAddress)"; aws=aws)
DeleteSuppressedDestination(EmailAddress, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/suppression/addresses/$(EmailAddress)", args; aws=aws)
...
"""
GetAccount(; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/account"; aws=aws)
GetAccount(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/account", args; aws=aws)
...
"""
GetBlacklistReports(BlacklistItemNames; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard/blacklist-report", Dict{String, Any}("BlacklistItemNames"=>BlacklistItemNames))
GetBlacklistReports(BlacklistItemNames, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard/blacklist-report", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BlacklistItemNames"=>BlacklistItemNames), args)); aws=aws)
...
"""
GetConfigurationSet(ConfigurationSetName; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/configuration-sets/$(ConfigurationSetName)"; aws=aws)
GetConfigurationSet(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/configuration-sets/$(ConfigurationSetName)", args; aws=aws)
...
"""
GetConfigurationSetEventDestinations(ConfigurationSetName; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations"; aws=aws)
GetConfigurationSetEventDestinations(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations", args; aws=aws)
...
"""
GetCustomVerificationEmailTemplate(TemplateName; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/custom-verification-email-templates/$(TemplateName)"; aws=aws)
GetCustomVerificationEmailTemplate(TemplateName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/custom-verification-email-templates/$(TemplateName)", args; aws=aws)
...
"""
GetDedicatedIp(IP; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/dedicated-ips/$(IP)"; aws=aws)
GetDedicatedIp(IP, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/dedicated-ips/$(IP)", args; aws=aws)
...
"""
GetDedicatedIps(; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/dedicated-ips"; aws=aws)
GetDedicatedIps(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/dedicated-ips", args; aws=aws)
...
"""
GetDeliverabilityDashboardOptions(; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard"; aws=aws)
GetDeliverabilityDashboardOptions(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard", args; aws=aws)
...
"""
GetDeliverabilityTestReport(ReportId; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard/test-reports/$(ReportId)"; aws=aws)
GetDeliverabilityTestReport(ReportId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard/test-reports/$(ReportId)", args; aws=aws)
...
"""
GetDomainDeliverabilityCampaign(CampaignId; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard/campaigns/$(CampaignId)"; aws=aws)
GetDomainDeliverabilityCampaign(CampaignId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard/campaigns/$(CampaignId)", args; aws=aws)
...
"""
GetDomainStatisticsReport(Domain, EndDate, StartDate; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard/statistics-report/$(Domain)", Dict{String, Any}("EndDate"=>EndDate, "StartDate"=>StartDate))
GetDomainStatisticsReport(Domain, EndDate, StartDate, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard/statistics-report/$(Domain)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EndDate"=>EndDate, "StartDate"=>StartDate), args)); aws=aws)
...
"""
GetEmailIdentity(EmailIdentity; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/identities/$(EmailIdentity)"; aws=aws)
GetEmailIdentity(EmailIdentity, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/identities/$(EmailIdentity)", args; aws=aws)
...
"""
GetEmailIdentityPolicies(EmailIdentity; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/identities/$(EmailIdentity)/policies"; aws=aws)
GetEmailIdentityPolicies(EmailIdentity, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/identities/$(EmailIdentity)/policies", args; aws=aws)
...
"""
GetEmailTemplate(TemplateName; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/templates/$(TemplateName)"; aws=aws)
GetEmailTemplate(TemplateName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/templates/$(TemplateName)", args; aws=aws)
...
"""
GetSuppressedDestination(EmailAddress; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/suppression/addresses/$(EmailAddress)"; aws=aws)
GetSuppressedDestination(EmailAddress, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/suppression/addresses/$(EmailAddress)", args; aws=aws)
...
"""
ListConfigurationSets(; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/configuration-sets"; aws=aws)
ListConfigurationSets(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/configuration-sets", args; aws=aws)
...
"""
ListCustomVerificationEmailTemplates(; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/custom-verification-email-templates"; aws=aws)
ListCustomVerificationEmailTemplates(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/custom-verification-email-templates", args; aws=aws)
...
"""
ListDedicatedIpPools(; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/dedicated-ip-pools"; aws=aws)
ListDedicatedIpPools(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/dedicated-ip-pools", args; aws=aws)
...
"""
ListDeliverabilityTestReports(; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard/test-reports"; aws=aws)
ListDeliverabilityTestReports(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard/test-reports", args; aws=aws)
...
"""
ListDomainDeliverabilityCampaigns(EndDate, StartDate, SubscribedDomain; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard/domains/$(SubscribedDomain)/campaigns", Dict{String, Any}("EndDate"=>EndDate, "StartDate"=>StartDate))
ListDomainDeliverabilityCampaigns(EndDate, StartDate, SubscribedDomain, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/deliverability-dashboard/domains/$(SubscribedDomain)/campaigns", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EndDate"=>EndDate, "StartDate"=>StartDate), args)); aws=aws)
...
"""
ListEmailIdentities(; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/identities"; aws=aws)
ListEmailIdentities(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/identities", args; aws=aws)
...
"""
ListEmailTemplates(; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/templates"; aws=aws)
ListEmailTemplates(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/templates", args; aws=aws)
...
"""
ListSuppressedDestinations(; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/suppression/addresses"; aws=aws)
ListSuppressedDestinations(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/suppression/addresses", args; aws=aws)
...
"""
ListTagsForResource(ResourceArn; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/tags", Dict{String, Any}("ResourceArn"=>ResourceArn))
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("GET", "/v2/email/tags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), args)); aws=aws)
...
"""
PutAccountDedicatedIpWarmupAttributes(; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/account/dedicated-ips/warmup"; aws=aws)
PutAccountDedicatedIpWarmupAttributes(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/account/dedicated-ips/warmup", args; aws=aws)
...
"""
PutAccountDetails(MailType, UseCaseDescription, WebsiteURL; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/account/details", Dict{String, Any}("MailType"=>MailType, "UseCaseDescription"=>UseCaseDescription, "WebsiteURL"=>WebsiteURL))
PutAccountDetails(MailType, UseCaseDescription, WebsiteURL, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/account/details", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MailType"=>MailType, "UseCaseDescription"=>UseCaseDescription, "WebsiteURL"=>WebsiteURL), args)); aws=aws)
...
"""
PutAccountSendingAttributes(; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/account/sending"; aws=aws)
PutAccountSendingAttributes(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/account/sending", args; aws=aws)
...
"""
PutAccountSuppressionAttributes(; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/account/suppression"; aws=aws)
PutAccountSuppressionAttributes(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/account/suppression", args; aws=aws)
...
"""
PutConfigurationSetDeliveryOptions(ConfigurationSetName; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/delivery-options"; aws=aws)
PutConfigurationSetDeliveryOptions(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/delivery-options", args; aws=aws)
...
"""
PutConfigurationSetReputationOptions(ConfigurationSetName; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/reputation-options"; aws=aws)
PutConfigurationSetReputationOptions(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/reputation-options", args; aws=aws)
...
"""
PutConfigurationSetSendingOptions(ConfigurationSetName; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/sending"; aws=aws)
PutConfigurationSetSendingOptions(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/sending", args; aws=aws)
...
"""
PutConfigurationSetSuppressionOptions(ConfigurationSetName; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/suppression-options"; aws=aws)
PutConfigurationSetSuppressionOptions(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/suppression-options", args; aws=aws)
...
"""
PutConfigurationSetTrackingOptions(ConfigurationSetName; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/tracking-options"; aws=aws)
PutConfigurationSetTrackingOptions(ConfigurationSetName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/tracking-options", args; aws=aws)
...
"""
PutDedicatedIpInPool(DestinationPoolName, IP; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/dedicated-ips/$(IP)/pool", Dict{String, Any}("DestinationPoolName"=>DestinationPoolName))
PutDedicatedIpInPool(DestinationPoolName, IP, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/dedicated-ips/$(IP)/pool", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DestinationPoolName"=>DestinationPoolName), args)); aws=aws)
...
"""
PutDedicatedIpWarmupAttributes(IP, WarmupPercentage; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/dedicated-ips/$(IP)/warmup", Dict{String, Any}("WarmupPercentage"=>WarmupPercentage))
PutDedicatedIpWarmupAttributes(IP, WarmupPercentage, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/dedicated-ips/$(IP)/warmup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("WarmupPercentage"=>WarmupPercentage), args)); aws=aws)
...
"""
PutDeliverabilityDashboardOption(DashboardEnabled; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/deliverability-dashboard", Dict{String, Any}("DashboardEnabled"=>DashboardEnabled))
PutDeliverabilityDashboardOption(DashboardEnabled, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/deliverability-dashboard", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DashboardEnabled"=>DashboardEnabled), args)); aws=aws)
...
"""
PutEmailIdentityDkimAttributes(EmailIdentity; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/identities/$(EmailIdentity)/dkim"; aws=aws)
PutEmailIdentityDkimAttributes(EmailIdentity, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/identities/$(EmailIdentity)/dkim", args; aws=aws)
...
"""
PutEmailIdentityDkimSigningAttributes(EmailIdentity, SigningAttributesOrigin; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v1/email/identities/$(EmailIdentity)/dkim/signing", Dict{String, Any}("SigningAttributesOrigin"=>SigningAttributesOrigin))
PutEmailIdentityDkimSigningAttributes(EmailIdentity, SigningAttributesOrigin, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v1/email/identities/$(EmailIdentity)/dkim/signing", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SigningAttributesOrigin"=>SigningAttributesOrigin), args)); aws=aws)
...
"""
PutEmailIdentityFeedbackAttributes(EmailIdentity; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/identities/$(EmailIdentity)/feedback"; aws=aws)
PutEmailIdentityFeedbackAttributes(EmailIdentity, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/identities/$(EmailIdentity)/feedback", args; aws=aws)
...
"""
PutEmailIdentityMailFromAttributes(EmailIdentity; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/identities/$(EmailIdentity)/mail-from"; aws=aws)
PutEmailIdentityMailFromAttributes(EmailIdentity, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/identities/$(EmailIdentity)/mail-from", args; aws=aws)
...
"""
PutSuppressedDestination(EmailAddress, Reason; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/suppression/addresses", Dict{String, Any}("EmailAddress"=>EmailAddress, "Reason"=>Reason))
PutSuppressedDestination(EmailAddress, Reason, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/suppression/addresses", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EmailAddress"=>EmailAddress, "Reason"=>Reason), args)); aws=aws)
...
"""
SendBulkEmail(BulkEmailEntries, DefaultContent; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/outbound-bulk-emails", Dict{String, Any}("BulkEmailEntries"=>BulkEmailEntries, "DefaultContent"=>DefaultContent))
SendBulkEmail(BulkEmailEntries, DefaultContent, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/outbound-bulk-emails", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BulkEmailEntries"=>BulkEmailEntries, "DefaultContent"=>DefaultContent), args)); aws=aws)
...
"""
SendCustomVerificationEmail(EmailAddress, TemplateName; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/outbound-custom-verification-emails", Dict{String, Any}("EmailAddress"=>EmailAddress, "TemplateName"=>TemplateName))
SendCustomVerificationEmail(EmailAddress, TemplateName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/outbound-custom-verification-emails", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EmailAddress"=>EmailAddress, "TemplateName"=>TemplateName), args)); aws=aws)
...
- `ReplyToAddresses`: The \"Reply-to\" email addresses for the message. When the recipient replies to the message, each Reply-to address receives the reply.
"""
SendEmail(Content; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/outbound-emails", Dict{String, Any}("Content"=>Content))
SendEmail(Content, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/outbound-emails", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Content"=>Content), args)); aws=aws)
...
"""
TagResource(ResourceArn, Tags; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/tags", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags))
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/tags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags), args)); aws=aws)
...
"""
TestRenderEmailTemplate(TemplateData, TemplateName; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/templates/$(TemplateName)/render", Dict{String, Any}("TemplateData"=>TemplateData))
TestRenderEmailTemplate(TemplateData, TemplateName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("POST", "/v2/email/templates/$(TemplateName)/render", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TemplateData"=>TemplateData), args)); aws=aws)
...
"""
UntagResource(ResourceArn, TagKeys; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/tags", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys))
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("DELETE", "/v2/email/tags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), args)); aws=aws)
...
"""
UpdateConfigurationSetEventDestination(ConfigurationSetName, EventDestination, EventDestinationName; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations/$(EventDestinationName)", Dict{String, Any}("EventDestination"=>EventDestination))
UpdateConfigurationSetEventDestination(ConfigurationSetName, EventDestination, EventDestinationName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations/$(EventDestinationName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EventDestination"=>EventDestination), args)); aws=aws)
...
"""
UpdateEmailIdentityPolicy(EmailIdentity, Policy, PolicyName; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/identities/$(EmailIdentity)/policies/$(PolicyName)", Dict{String, Any}("Policy"=>Policy))
UpdateEmailIdentityPolicy(EmailIdentity, Policy, PolicyName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/identities/$(EmailIdentity)/policies/$(PolicyName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Policy"=>Policy), args)); aws=aws)
...
"""
UpdateEmailTemplate(TemplateContent, TemplateName; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/templates/$(TemplateName)", Dict{String, Any}("TemplateContent"=>TemplateContent))
UpdateEmailTemplate(TemplateContent, TemplateName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sesv2("PUT", "/v2/email/templates/$(TemplateName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TemplateContent"=>TemplateContent), args)); aws=aws)
