...
"""
CreateConfigurationSet(ConfigurationSetName) = sesv2("POST", "/v2/email/configuration-sets", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName))
CreateConfigurationSet(ConfigurationSetName, args::AbstractDict{String, <:Any}) = sesv2("POST", "/v2/email/configuration-sets", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName, args...))
...
"""
CreateConfigurationSetEventDestination(ConfigurationSetName, EventDestination, EventDestinationName) = sesv2("POST", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations", Dict{String, Any}("EventDestination"=>EventDestination, "EventDestinationName"=>EventDestinationName))
CreateConfigurationSetEventDestination(ConfigurationSetName, EventDestination, EventDestinationName, args::AbstractDict{String, <:Any}) = sesv2("POST", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations", Dict{String, Any}("EventDestination"=>EventDestination, "EventDestinationName"=>EventDestinationName, args...))
...
"""
CreateDedicatedIpPool(PoolName) = sesv2("POST", "/v2/email/dedicated-ip-pools", Dict{String, Any}("PoolName"=>PoolName))
CreateDedicatedIpPool(PoolName, args::AbstractDict{String, <:Any}) = sesv2("POST", "/v2/email/dedicated-ip-pools", Dict{String, Any}("PoolName"=>PoolName, args...))
...
"""
CreateDeliverabilityTestReport(Content, FromEmailAddress) = sesv2("POST", "/v2/email/deliverability-dashboard/test", Dict{String, Any}("Content"=>Content, "FromEmailAddress"=>FromEmailAddress))
CreateDeliverabilityTestReport(Content, FromEmailAddress, args::AbstractDict{String, <:Any}) = sesv2("POST", "/v2/email/deliverability-dashboard/test", Dict{String, Any}("Content"=>Content, "FromEmailAddress"=>FromEmailAddress, args...))
...
"""
CreateEmailIdentity(EmailIdentity) = sesv2("POST", "/v2/email/identities", Dict{String, Any}("EmailIdentity"=>EmailIdentity))
CreateEmailIdentity(EmailIdentity, args::AbstractDict{String, <:Any}) = sesv2("POST", "/v2/email/identities", Dict{String, Any}("EmailIdentity"=>EmailIdentity, args...))
...
DeleteConfigurationSet(ConfigurationSetName, args::AbstractDict{String, <:Any}) = sesv2("DELETE", "/v2/email/configuration-sets/$(ConfigurationSetName)", args)
...
DeleteConfigurationSetEventDestination(ConfigurationSetName, EventDestinationName, args::AbstractDict{String, <:Any}) = sesv2("DELETE", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations/$(EventDestinationName)", args)
...
DeleteDedicatedIpPool(PoolName, args::AbstractDict{String, <:Any}) = sesv2("DELETE", "/v2/email/dedicated-ip-pools/$(PoolName)", args)
...
DeleteEmailIdentity(EmailIdentity, args::AbstractDict{String, <:Any}) = sesv2("DELETE", "/v2/email/identities/$(EmailIdentity)", args)
...
DeleteSuppressedDestination(EmailAddress, args::AbstractDict{String, <:Any}) = sesv2("DELETE", "/v2/email/suppression/addresses/$(EmailAddress)", args)
...
GetAccount(args::AbstractDict{String, Any}) = sesv2("GET", "/v2/email/account", args)
...
"""
GetBlacklistReports(BlacklistItemNames) = sesv2("GET", "/v2/email/deliverability-dashboard/blacklist-report", Dict{String, Any}("BlacklistItemNames"=>BlacklistItemNames))
GetBlacklistReports(BlacklistItemNames, args::AbstractDict{String, <:Any}) = sesv2("GET", "/v2/email/deliverability-dashboard/blacklist-report", Dict{String, Any}("BlacklistItemNames"=>BlacklistItemNames, args...))
...
GetConfigurationSet(ConfigurationSetName, args::AbstractDict{String, <:Any}) = sesv2("GET", "/v2/email/configuration-sets/$(ConfigurationSetName)", args)
...
GetConfigurationSetEventDestinations(ConfigurationSetName, args::AbstractDict{String, <:Any}) = sesv2("GET", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations", args)
...
GetDedicatedIp(IP, args::AbstractDict{String, <:Any}) = sesv2("GET", "/v2/email/dedicated-ips/$(IP)", args)
...
GetDedicatedIps(args::AbstractDict{String, Any}) = sesv2("GET", "/v2/email/dedicated-ips", args)
...
GetDeliverabilityDashboardOptions(args::AbstractDict{String, Any}) = sesv2("GET", "/v2/email/deliverability-dashboard", args)
...
GetDeliverabilityTestReport(ReportId, args::AbstractDict{String, <:Any}) = sesv2("GET", "/v2/email/deliverability-dashboard/test-reports/$(ReportId)", args)
...
GetDomainDeliverabilityCampaign(CampaignId, args::AbstractDict{String, <:Any}) = sesv2("GET", "/v2/email/deliverability-dashboard/campaigns/$(CampaignId)", args)
...
"""
GetDomainStatisticsReport(Domain, EndDate, StartDate) = sesv2("GET", "/v2/email/deliverability-dashboard/statistics-report/$(Domain)", Dict{String, Any}("EndDate"=>EndDate, "StartDate"=>StartDate))
GetDomainStatisticsReport(Domain, EndDate, StartDate, args::AbstractDict{String, <:Any}) = sesv2("GET", "/v2/email/deliverability-dashboard/statistics-report/$(Domain)", Dict{String, Any}("EndDate"=>EndDate, "StartDate"=>StartDate, args...))
...
GetEmailIdentity(EmailIdentity, args::AbstractDict{String, <:Any}) = sesv2("GET", "/v2/email/identities/$(EmailIdentity)", args)
...
GetSuppressedDestination(EmailAddress, args::AbstractDict{String, <:Any}) = sesv2("GET", "/v2/email/suppression/addresses/$(EmailAddress)", args)
...
ListConfigurationSets(args::AbstractDict{String, Any}) = sesv2("GET", "/v2/email/configuration-sets", args)
...
ListDedicatedIpPools(args::AbstractDict{String, Any}) = sesv2("GET", "/v2/email/dedicated-ip-pools", args)
...
ListDeliverabilityTestReports(args::AbstractDict{String, Any}) = sesv2("GET", "/v2/email/deliverability-dashboard/test-reports", args)
...
"""
ListDomainDeliverabilityCampaigns(EndDate, StartDate, SubscribedDomain) = sesv2("GET", "/v2/email/deliverability-dashboard/domains/$(SubscribedDomain)/campaigns", Dict{String, Any}("EndDate"=>EndDate, "StartDate"=>StartDate))
ListDomainDeliverabilityCampaigns(EndDate, StartDate, SubscribedDomain, args::AbstractDict{String, <:Any}) = sesv2("GET", "/v2/email/deliverability-dashboard/domains/$(SubscribedDomain)/campaigns", Dict{String, Any}("EndDate"=>EndDate, "StartDate"=>StartDate, args...))
...
ListEmailIdentities(args::AbstractDict{String, Any}) = sesv2("GET", "/v2/email/identities", args)
...
ListSuppressedDestinations(args::AbstractDict{String, Any}) = sesv2("GET", "/v2/email/suppression/addresses", args)
...
"""
ListTagsForResource(ResourceArn) = sesv2("GET", "/v2/email/tags", Dict{String, Any}("ResourceArn"=>ResourceArn))
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}) = sesv2("GET", "/v2/email/tags", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
PutAccountDedicatedIpWarmupAttributes(args::AbstractDict{String, Any}) = sesv2("PUT", "/v2/email/account/dedicated-ips/warmup", args)
...
PutAccountSendingAttributes(args::AbstractDict{String, Any}) = sesv2("PUT", "/v2/email/account/sending", args)
...
PutAccountSuppressionAttributes(args::AbstractDict{String, Any}) = sesv2("PUT", "/v2/email/account/suppression", args)
...
PutConfigurationSetDeliveryOptions(ConfigurationSetName, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/delivery-options", args)
...
PutConfigurationSetReputationOptions(ConfigurationSetName, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/reputation-options", args)
...
PutConfigurationSetSendingOptions(ConfigurationSetName, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/sending", args)
...
PutConfigurationSetSuppressionOptions(ConfigurationSetName, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/suppression-options", args)
...
PutConfigurationSetTrackingOptions(ConfigurationSetName, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/tracking-options", args)
...
"""
PutDedicatedIpInPool(DestinationPoolName, IP) = sesv2("PUT", "/v2/email/dedicated-ips/$(IP)/pool", Dict{String, Any}("DestinationPoolName"=>DestinationPoolName))
PutDedicatedIpInPool(DestinationPoolName, IP, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/dedicated-ips/$(IP)/pool", Dict{String, Any}("DestinationPoolName"=>DestinationPoolName, args...))
...
"""
PutDedicatedIpWarmupAttributes(IP, WarmupPercentage) = sesv2("PUT", "/v2/email/dedicated-ips/$(IP)/warmup", Dict{String, Any}("WarmupPercentage"=>WarmupPercentage))
PutDedicatedIpWarmupAttributes(IP, WarmupPercentage, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/dedicated-ips/$(IP)/warmup", Dict{String, Any}("WarmupPercentage"=>WarmupPercentage, args...))
...
"""
PutDeliverabilityDashboardOption(DashboardEnabled) = sesv2("PUT", "/v2/email/deliverability-dashboard", Dict{String, Any}("DashboardEnabled"=>DashboardEnabled))
PutDeliverabilityDashboardOption(DashboardEnabled, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/deliverability-dashboard", Dict{String, Any}("DashboardEnabled"=>DashboardEnabled, args...))
...
PutEmailIdentityDkimAttributes(EmailIdentity, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/identities/$(EmailIdentity)/dkim", args)
...
"""
PutEmailIdentityDkimSigningAttributes(EmailIdentity, SigningAttributesOrigin) = sesv2("PUT", "/v1/email/identities/$(EmailIdentity)/dkim/signing", Dict{String, Any}("SigningAttributesOrigin"=>SigningAttributesOrigin))
PutEmailIdentityDkimSigningAttributes(EmailIdentity, SigningAttributesOrigin, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v1/email/identities/$(EmailIdentity)/dkim/signing", Dict{String, Any}("SigningAttributesOrigin"=>SigningAttributesOrigin, args...))
...
PutEmailIdentityFeedbackAttributes(EmailIdentity, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/identities/$(EmailIdentity)/feedback", args)
...
PutEmailIdentityMailFromAttributes(EmailIdentity, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/identities/$(EmailIdentity)/mail-from", args)
...
"""
PutSuppressedDestination(EmailAddress, Reason) = sesv2("PUT", "/v2/email/suppression/addresses", Dict{String, Any}("EmailAddress"=>EmailAddress, "Reason"=>Reason))
PutSuppressedDestination(EmailAddress, Reason, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/suppression/addresses", Dict{String, Any}("EmailAddress"=>EmailAddress, "Reason"=>Reason, args...))
...
"""
SendEmail(Content, Destination) = sesv2("POST", "/v2/email/outbound-emails", Dict{String, Any}("Content"=>Content, "Destination"=>Destination))
SendEmail(Content, Destination, args::AbstractDict{String, <:Any}) = sesv2("POST", "/v2/email/outbound-emails", Dict{String, Any}("Content"=>Content, "Destination"=>Destination, args...))
...
"""
TagResource(ResourceArn, Tags) = sesv2("POST", "/v2/email/tags", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags))
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}) = sesv2("POST", "/v2/email/tags", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceArn, TagKeys) = sesv2("DELETE", "/v2/email/tags", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys))
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}) = sesv2("DELETE", "/v2/email/tags", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys, args...))
...
"""
UpdateConfigurationSetEventDestination(ConfigurationSetName, EventDestination, EventDestinationName) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations/$(EventDestinationName)", Dict{String, Any}("EventDestination"=>EventDestination))
UpdateConfigurationSetEventDestination(ConfigurationSetName, EventDestination, EventDestinationName, args::AbstractDict{String, <:Any}) = sesv2("PUT", "/v2/email/configuration-sets/$(ConfigurationSetName)/event-destinations/$(EventDestinationName)", Dict{String, Any}("EventDestination"=>EventDestination, args...))
