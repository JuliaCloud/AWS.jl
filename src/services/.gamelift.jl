...
"""
AcceptMatch(AcceptanceType, PlayerIds, TicketId) = gamelift("AcceptMatch", Dict{String, Any}("AcceptanceType"=>AcceptanceType, "PlayerIds"=>PlayerIds, "TicketId"=>TicketId))
AcceptMatch(AcceptanceType, PlayerIds, TicketId, args::AbstractDict{String, <: Any}) = gamelift("AcceptMatch", Dict{String, Any}("AcceptanceType"=>AcceptanceType, "PlayerIds"=>PlayerIds, "TicketId"=>TicketId, args...))
...
"""
ClaimGameServer(GameServerGroupName) = gamelift("ClaimGameServer", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName))
ClaimGameServer(GameServerGroupName, args::AbstractDict{String, <: Any}) = gamelift("ClaimGameServer", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, args...))
...
"""
CreateAlias(Name, RoutingStrategy) = gamelift("CreateAlias", Dict{String, Any}("Name"=>Name, "RoutingStrategy"=>RoutingStrategy))
CreateAlias(Name, RoutingStrategy, args::AbstractDict{String, <: Any}) = gamelift("CreateAlias", Dict{String, Any}("Name"=>Name, "RoutingStrategy"=>RoutingStrategy, args...))
...
CreateBuild(args::AbstractDict{String, <: Any}) = gamelift("CreateBuild", args)
...
"""
CreateFleet(EC2InstanceType, Name) = gamelift("CreateFleet", Dict{String, Any}("EC2InstanceType"=>EC2InstanceType, "Name"=>Name))
CreateFleet(EC2InstanceType, Name, args::AbstractDict{String, <: Any}) = gamelift("CreateFleet", Dict{String, Any}("EC2InstanceType"=>EC2InstanceType, "Name"=>Name, args...))
...
"""
CreateGameServerGroup(GameServerGroupName, InstanceDefinitions, LaunchTemplate, MaxSize, MinSize, RoleArn) = gamelift("CreateGameServerGroup", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "InstanceDefinitions"=>InstanceDefinitions, "LaunchTemplate"=>LaunchTemplate, "MaxSize"=>MaxSize, "MinSize"=>MinSize, "RoleArn"=>RoleArn))
CreateGameServerGroup(GameServerGroupName, InstanceDefinitions, LaunchTemplate, MaxSize, MinSize, RoleArn, args::AbstractDict{String, <: Any}) = gamelift("CreateGameServerGroup", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "InstanceDefinitions"=>InstanceDefinitions, "LaunchTemplate"=>LaunchTemplate, "MaxSize"=>MaxSize, "MinSize"=>MinSize, "RoleArn"=>RoleArn, args...))
...
"""
CreateGameSession(MaximumPlayerSessionCount) = gamelift("CreateGameSession", Dict{String, Any}("MaximumPlayerSessionCount"=>MaximumPlayerSessionCount))
CreateGameSession(MaximumPlayerSessionCount, args::AbstractDict{String, <: Any}) = gamelift("CreateGameSession", Dict{String, Any}("MaximumPlayerSessionCount"=>MaximumPlayerSessionCount, args...))
...
"""
CreateGameSessionQueue(Name) = gamelift("CreateGameSessionQueue", Dict{String, Any}("Name"=>Name))
CreateGameSessionQueue(Name, args::AbstractDict{String, <: Any}) = gamelift("CreateGameSessionQueue", Dict{String, Any}("Name"=>Name, args...))
...
"""
CreateMatchmakingConfiguration(AcceptanceRequired, GameSessionQueueArns, Name, RequestTimeoutSeconds, RuleSetName) = gamelift("CreateMatchmakingConfiguration", Dict{String, Any}("AcceptanceRequired"=>AcceptanceRequired, "GameSessionQueueArns"=>GameSessionQueueArns, "Name"=>Name, "RequestTimeoutSeconds"=>RequestTimeoutSeconds, "RuleSetName"=>RuleSetName))
CreateMatchmakingConfiguration(AcceptanceRequired, GameSessionQueueArns, Name, RequestTimeoutSeconds, RuleSetName, args::AbstractDict{String, <: Any}) = gamelift("CreateMatchmakingConfiguration", Dict{String, Any}("AcceptanceRequired"=>AcceptanceRequired, "GameSessionQueueArns"=>GameSessionQueueArns, "Name"=>Name, "RequestTimeoutSeconds"=>RequestTimeoutSeconds, "RuleSetName"=>RuleSetName, args...))
...
"""
CreateMatchmakingRuleSet(Name, RuleSetBody) = gamelift("CreateMatchmakingRuleSet", Dict{String, Any}("Name"=>Name, "RuleSetBody"=>RuleSetBody))
CreateMatchmakingRuleSet(Name, RuleSetBody, args::AbstractDict{String, <: Any}) = gamelift("CreateMatchmakingRuleSet", Dict{String, Any}("Name"=>Name, "RuleSetBody"=>RuleSetBody, args...))
...
"""
CreatePlayerSession(GameSessionId, PlayerId) = gamelift("CreatePlayerSession", Dict{String, Any}("GameSessionId"=>GameSessionId, "PlayerId"=>PlayerId))
CreatePlayerSession(GameSessionId, PlayerId, args::AbstractDict{String, <: Any}) = gamelift("CreatePlayerSession", Dict{String, Any}("GameSessionId"=>GameSessionId, "PlayerId"=>PlayerId, args...))
...
"""
CreatePlayerSessions(GameSessionId, PlayerIds) = gamelift("CreatePlayerSessions", Dict{String, Any}("GameSessionId"=>GameSessionId, "PlayerIds"=>PlayerIds))
CreatePlayerSessions(GameSessionId, PlayerIds, args::AbstractDict{String, <: Any}) = gamelift("CreatePlayerSessions", Dict{String, Any}("GameSessionId"=>GameSessionId, "PlayerIds"=>PlayerIds, args...))
...
CreateScript(args::AbstractDict{String, <: Any}) = gamelift("CreateScript", args)
...
"""
CreateVpcPeeringAuthorization(GameLiftAwsAccountId, PeerVpcId) = gamelift("CreateVpcPeeringAuthorization", Dict{String, Any}("GameLiftAwsAccountId"=>GameLiftAwsAccountId, "PeerVpcId"=>PeerVpcId))
CreateVpcPeeringAuthorization(GameLiftAwsAccountId, PeerVpcId, args::AbstractDict{String, <: Any}) = gamelift("CreateVpcPeeringAuthorization", Dict{String, Any}("GameLiftAwsAccountId"=>GameLiftAwsAccountId, "PeerVpcId"=>PeerVpcId, args...))
...
"""
CreateVpcPeeringConnection(FleetId, PeerVpcAwsAccountId, PeerVpcId) = gamelift("CreateVpcPeeringConnection", Dict{String, Any}("FleetId"=>FleetId, "PeerVpcAwsAccountId"=>PeerVpcAwsAccountId, "PeerVpcId"=>PeerVpcId))
CreateVpcPeeringConnection(FleetId, PeerVpcAwsAccountId, PeerVpcId, args::AbstractDict{String, <: Any}) = gamelift("CreateVpcPeeringConnection", Dict{String, Any}("FleetId"=>FleetId, "PeerVpcAwsAccountId"=>PeerVpcAwsAccountId, "PeerVpcId"=>PeerVpcId, args...))
...
"""
DeleteAlias(AliasId) = gamelift("DeleteAlias", Dict{String, Any}("AliasId"=>AliasId))
DeleteAlias(AliasId, args::AbstractDict{String, <: Any}) = gamelift("DeleteAlias", Dict{String, Any}("AliasId"=>AliasId, args...))
...
"""
DeleteBuild(BuildId) = gamelift("DeleteBuild", Dict{String, Any}("BuildId"=>BuildId))
DeleteBuild(BuildId, args::AbstractDict{String, <: Any}) = gamelift("DeleteBuild", Dict{String, Any}("BuildId"=>BuildId, args...))
...
"""
DeleteFleet(FleetId) = gamelift("DeleteFleet", Dict{String, Any}("FleetId"=>FleetId))
DeleteFleet(FleetId, args::AbstractDict{String, <: Any}) = gamelift("DeleteFleet", Dict{String, Any}("FleetId"=>FleetId, args...))
...
"""
DeleteGameServerGroup(GameServerGroupName) = gamelift("DeleteGameServerGroup", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName))
DeleteGameServerGroup(GameServerGroupName, args::AbstractDict{String, <: Any}) = gamelift("DeleteGameServerGroup", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, args...))
...
"""
DeleteGameSessionQueue(Name) = gamelift("DeleteGameSessionQueue", Dict{String, Any}("Name"=>Name))
DeleteGameSessionQueue(Name, args::AbstractDict{String, <: Any}) = gamelift("DeleteGameSessionQueue", Dict{String, Any}("Name"=>Name, args...))
...
"""
DeleteMatchmakingConfiguration(Name) = gamelift("DeleteMatchmakingConfiguration", Dict{String, Any}("Name"=>Name))
DeleteMatchmakingConfiguration(Name, args::AbstractDict{String, <: Any}) = gamelift("DeleteMatchmakingConfiguration", Dict{String, Any}("Name"=>Name, args...))
...
"""
DeleteMatchmakingRuleSet(Name) = gamelift("DeleteMatchmakingRuleSet", Dict{String, Any}("Name"=>Name))
DeleteMatchmakingRuleSet(Name, args::AbstractDict{String, <: Any}) = gamelift("DeleteMatchmakingRuleSet", Dict{String, Any}("Name"=>Name, args...))
...
"""
DeleteScalingPolicy(FleetId, Name) = gamelift("DeleteScalingPolicy", Dict{String, Any}("FleetId"=>FleetId, "Name"=>Name))
DeleteScalingPolicy(FleetId, Name, args::AbstractDict{String, <: Any}) = gamelift("DeleteScalingPolicy", Dict{String, Any}("FleetId"=>FleetId, "Name"=>Name, args...))
...
"""
DeleteScript(ScriptId) = gamelift("DeleteScript", Dict{String, Any}("ScriptId"=>ScriptId))
DeleteScript(ScriptId, args::AbstractDict{String, <: Any}) = gamelift("DeleteScript", Dict{String, Any}("ScriptId"=>ScriptId, args...))
...
"""
DeleteVpcPeeringAuthorization(GameLiftAwsAccountId, PeerVpcId) = gamelift("DeleteVpcPeeringAuthorization", Dict{String, Any}("GameLiftAwsAccountId"=>GameLiftAwsAccountId, "PeerVpcId"=>PeerVpcId))
DeleteVpcPeeringAuthorization(GameLiftAwsAccountId, PeerVpcId, args::AbstractDict{String, <: Any}) = gamelift("DeleteVpcPeeringAuthorization", Dict{String, Any}("GameLiftAwsAccountId"=>GameLiftAwsAccountId, "PeerVpcId"=>PeerVpcId, args...))
...
"""
DeleteVpcPeeringConnection(FleetId, VpcPeeringConnectionId) = gamelift("DeleteVpcPeeringConnection", Dict{String, Any}("FleetId"=>FleetId, "VpcPeeringConnectionId"=>VpcPeeringConnectionId))
DeleteVpcPeeringConnection(FleetId, VpcPeeringConnectionId, args::AbstractDict{String, <: Any}) = gamelift("DeleteVpcPeeringConnection", Dict{String, Any}("FleetId"=>FleetId, "VpcPeeringConnectionId"=>VpcPeeringConnectionId, args...))
...
"""
DeregisterGameServer(GameServerGroupName, GameServerId) = gamelift("DeregisterGameServer", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "GameServerId"=>GameServerId))
DeregisterGameServer(GameServerGroupName, GameServerId, args::AbstractDict{String, <: Any}) = gamelift("DeregisterGameServer", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "GameServerId"=>GameServerId, args...))
...
"""
DescribeAlias(AliasId) = gamelift("DescribeAlias", Dict{String, Any}("AliasId"=>AliasId))
DescribeAlias(AliasId, args::AbstractDict{String, <: Any}) = gamelift("DescribeAlias", Dict{String, Any}("AliasId"=>AliasId, args...))
...
"""
DescribeBuild(BuildId) = gamelift("DescribeBuild", Dict{String, Any}("BuildId"=>BuildId))
DescribeBuild(BuildId, args::AbstractDict{String, <: Any}) = gamelift("DescribeBuild", Dict{String, Any}("BuildId"=>BuildId, args...))
...
DescribeEC2InstanceLimits(args::AbstractDict{String, <: Any}) = gamelift("DescribeEC2InstanceLimits", args)
...
DescribeFleetAttributes(args::AbstractDict{String, <: Any}) = gamelift("DescribeFleetAttributes", args)
...
DescribeFleetCapacity(args::AbstractDict{String, <: Any}) = gamelift("DescribeFleetCapacity", args)
...
"""
DescribeFleetEvents(FleetId) = gamelift("DescribeFleetEvents", Dict{String, Any}("FleetId"=>FleetId))
DescribeFleetEvents(FleetId, args::AbstractDict{String, <: Any}) = gamelift("DescribeFleetEvents", Dict{String, Any}("FleetId"=>FleetId, args...))
...
"""
DescribeFleetPortSettings(FleetId) = gamelift("DescribeFleetPortSettings", Dict{String, Any}("FleetId"=>FleetId))
DescribeFleetPortSettings(FleetId, args::AbstractDict{String, <: Any}) = gamelift("DescribeFleetPortSettings", Dict{String, Any}("FleetId"=>FleetId, args...))
...
DescribeFleetUtilization(args::AbstractDict{String, <: Any}) = gamelift("DescribeFleetUtilization", args)
...
"""
DescribeGameServer(GameServerGroupName, GameServerId) = gamelift("DescribeGameServer", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "GameServerId"=>GameServerId))
DescribeGameServer(GameServerGroupName, GameServerId, args::AbstractDict{String, <: Any}) = gamelift("DescribeGameServer", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "GameServerId"=>GameServerId, args...))
...
"""
DescribeGameServerGroup(GameServerGroupName) = gamelift("DescribeGameServerGroup", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName))
DescribeGameServerGroup(GameServerGroupName, args::AbstractDict{String, <: Any}) = gamelift("DescribeGameServerGroup", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, args...))
...
DescribeGameSessionDetails(args::AbstractDict{String, <: Any}) = gamelift("DescribeGameSessionDetails", args)
...
"""
DescribeGameSessionPlacement(PlacementId) = gamelift("DescribeGameSessionPlacement", Dict{String, Any}("PlacementId"=>PlacementId))
DescribeGameSessionPlacement(PlacementId, args::AbstractDict{String, <: Any}) = gamelift("DescribeGameSessionPlacement", Dict{String, Any}("PlacementId"=>PlacementId, args...))
...
DescribeGameSessionQueues(args::AbstractDict{String, <: Any}) = gamelift("DescribeGameSessionQueues", args)
...
DescribeGameSessions(args::AbstractDict{String, <: Any}) = gamelift("DescribeGameSessions", args)
...
NextToken => Token that indicates the start of the next sequential page of results. Use the token that is returned with a previous call to this action. To start at the beginning of the result set, do not specify a value.
"""
DescribeInstances(FleetId) = gamelift("DescribeInstances", Dict{String, Any}("FleetId"=>FleetId))
DescribeInstances(FleetId, args::AbstractDict{String, <: Any}) = gamelift("DescribeInstances", Dict{String, Any}("FleetId"=>FleetId, args...))
...
"""
DescribeMatchmaking(TicketIds) = gamelift("DescribeMatchmaking", Dict{String, Any}("TicketIds"=>TicketIds))
DescribeMatchmaking(TicketIds, args::AbstractDict{String, <: Any}) = gamelift("DescribeMatchmaking", Dict{String, Any}("TicketIds"=>TicketIds, args...))
...
DescribeMatchmakingConfigurations(args::AbstractDict{String, <: Any}) = gamelift("DescribeMatchmakingConfigurations", args)
...
DescribeMatchmakingRuleSets(args::AbstractDict{String, <: Any}) = gamelift("DescribeMatchmakingRuleSets", args)
...
DescribePlayerSessions(args::AbstractDict{String, <: Any}) = gamelift("DescribePlayerSessions", args)
...
"""
DescribeRuntimeConfiguration(FleetId) = gamelift("DescribeRuntimeConfiguration", Dict{String, Any}("FleetId"=>FleetId))
DescribeRuntimeConfiguration(FleetId, args::AbstractDict{String, <: Any}) = gamelift("DescribeRuntimeConfiguration", Dict{String, Any}("FleetId"=>FleetId, args...))
...
"""
DescribeScalingPolicies(FleetId) = gamelift("DescribeScalingPolicies", Dict{String, Any}("FleetId"=>FleetId))
DescribeScalingPolicies(FleetId, args::AbstractDict{String, <: Any}) = gamelift("DescribeScalingPolicies", Dict{String, Any}("FleetId"=>FleetId, args...))
...
"""
DescribeScript(ScriptId) = gamelift("DescribeScript", Dict{String, Any}("ScriptId"=>ScriptId))
DescribeScript(ScriptId, args::AbstractDict{String, <: Any}) = gamelift("DescribeScript", Dict{String, Any}("ScriptId"=>ScriptId, args...))
...
DescribeVpcPeeringAuthorizations(args::AbstractDict{String, <: Any}) = gamelift("DescribeVpcPeeringAuthorizations", args)
...
DescribeVpcPeeringConnections(args::AbstractDict{String, <: Any}) = gamelift("DescribeVpcPeeringConnections", args)
...
"""
GetGameSessionLogUrl(GameSessionId) = gamelift("GetGameSessionLogUrl", Dict{String, Any}("GameSessionId"=>GameSessionId))
GetGameSessionLogUrl(GameSessionId, args::AbstractDict{String, <: Any}) = gamelift("GetGameSessionLogUrl", Dict{String, Any}("GameSessionId"=>GameSessionId, args...))
...
"""
GetInstanceAccess(FleetId, InstanceId) = gamelift("GetInstanceAccess", Dict{String, Any}("FleetId"=>FleetId, "InstanceId"=>InstanceId))
GetInstanceAccess(FleetId, InstanceId, args::AbstractDict{String, <: Any}) = gamelift("GetInstanceAccess", Dict{String, Any}("FleetId"=>FleetId, "InstanceId"=>InstanceId, args...))
...
ListAliases(args::AbstractDict{String, <: Any}) = gamelift("ListAliases", args)
...
ListBuilds(args::AbstractDict{String, <: Any}) = gamelift("ListBuilds", args)
...
ListFleets(args::AbstractDict{String, <: Any}) = gamelift("ListFleets", args)
...
ListGameServerGroups(args::AbstractDict{String, <: Any}) = gamelift("ListGameServerGroups", args)
...
"""
ListGameServers(GameServerGroupName) = gamelift("ListGameServers", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName))
ListGameServers(GameServerGroupName, args::AbstractDict{String, <: Any}) = gamelift("ListGameServers", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, args...))
...
ListScripts(args::AbstractDict{String, <: Any}) = gamelift("ListScripts", args)
...
"""
ListTagsForResource(ResourceARN) = gamelift("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN))
ListTagsForResource(ResourceARN, args::AbstractDict{String, <: Any}) = gamelift("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN, args...))
...
"""
PutScalingPolicy(FleetId, MetricName, Name) = gamelift("PutScalingPolicy", Dict{String, Any}("FleetId"=>FleetId, "MetricName"=>MetricName, "Name"=>Name))
PutScalingPolicy(FleetId, MetricName, Name, args::AbstractDict{String, <: Any}) = gamelift("PutScalingPolicy", Dict{String, Any}("FleetId"=>FleetId, "MetricName"=>MetricName, "Name"=>Name, args...))
...
"""
RegisterGameServer(GameServerGroupName, GameServerId, InstanceId) = gamelift("RegisterGameServer", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "GameServerId"=>GameServerId, "InstanceId"=>InstanceId))
RegisterGameServer(GameServerGroupName, GameServerId, InstanceId, args::AbstractDict{String, <: Any}) = gamelift("RegisterGameServer", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "GameServerId"=>GameServerId, "InstanceId"=>InstanceId, args...))
...
"""
RequestUploadCredentials(BuildId) = gamelift("RequestUploadCredentials", Dict{String, Any}("BuildId"=>BuildId))
RequestUploadCredentials(BuildId, args::AbstractDict{String, <: Any}) = gamelift("RequestUploadCredentials", Dict{String, Any}("BuildId"=>BuildId, args...))
...
"""
ResolveAlias(AliasId) = gamelift("ResolveAlias", Dict{String, Any}("AliasId"=>AliasId))
ResolveAlias(AliasId, args::AbstractDict{String, <: Any}) = gamelift("ResolveAlias", Dict{String, Any}("AliasId"=>AliasId, args...))
...
"""
ResumeGameServerGroup(GameServerGroupName, ResumeActions) = gamelift("ResumeGameServerGroup", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "ResumeActions"=>ResumeActions))
ResumeGameServerGroup(GameServerGroupName, ResumeActions, args::AbstractDict{String, <: Any}) = gamelift("ResumeGameServerGroup", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "ResumeActions"=>ResumeActions, args...))
...
SearchGameSessions(args::AbstractDict{String, <: Any}) = gamelift("SearchGameSessions", args)
...
"""
StartFleetActions(Actions, FleetId) = gamelift("StartFleetActions", Dict{String, Any}("Actions"=>Actions, "FleetId"=>FleetId))
StartFleetActions(Actions, FleetId, args::AbstractDict{String, <: Any}) = gamelift("StartFleetActions", Dict{String, Any}("Actions"=>Actions, "FleetId"=>FleetId, args...))
...
"""
StartGameSessionPlacement(GameSessionQueueName, MaximumPlayerSessionCount, PlacementId) = gamelift("StartGameSessionPlacement", Dict{String, Any}("GameSessionQueueName"=>GameSessionQueueName, "MaximumPlayerSessionCount"=>MaximumPlayerSessionCount, "PlacementId"=>PlacementId))
StartGameSessionPlacement(GameSessionQueueName, MaximumPlayerSessionCount, PlacementId, args::AbstractDict{String, <: Any}) = gamelift("StartGameSessionPlacement", Dict{String, Any}("GameSessionQueueName"=>GameSessionQueueName, "MaximumPlayerSessionCount"=>MaximumPlayerSessionCount, "PlacementId"=>PlacementId, args...))
...
"""
StartMatchBackfill(ConfigurationName, GameSessionArn, Players) = gamelift("StartMatchBackfill", Dict{String, Any}("ConfigurationName"=>ConfigurationName, "GameSessionArn"=>GameSessionArn, "Players"=>Players))
StartMatchBackfill(ConfigurationName, GameSessionArn, Players, args::AbstractDict{String, <: Any}) = gamelift("StartMatchBackfill", Dict{String, Any}("ConfigurationName"=>ConfigurationName, "GameSessionArn"=>GameSessionArn, "Players"=>Players, args...))
...
"""
StartMatchmaking(ConfigurationName, Players) = gamelift("StartMatchmaking", Dict{String, Any}("ConfigurationName"=>ConfigurationName, "Players"=>Players))
StartMatchmaking(ConfigurationName, Players, args::AbstractDict{String, <: Any}) = gamelift("StartMatchmaking", Dict{String, Any}("ConfigurationName"=>ConfigurationName, "Players"=>Players, args...))
...
"""
StopFleetActions(Actions, FleetId) = gamelift("StopFleetActions", Dict{String, Any}("Actions"=>Actions, "FleetId"=>FleetId))
StopFleetActions(Actions, FleetId, args::AbstractDict{String, <: Any}) = gamelift("StopFleetActions", Dict{String, Any}("Actions"=>Actions, "FleetId"=>FleetId, args...))
...
"""
StopGameSessionPlacement(PlacementId) = gamelift("StopGameSessionPlacement", Dict{String, Any}("PlacementId"=>PlacementId))
StopGameSessionPlacement(PlacementId, args::AbstractDict{String, <: Any}) = gamelift("StopGameSessionPlacement", Dict{String, Any}("PlacementId"=>PlacementId, args...))
...
"""
StopMatchmaking(TicketId) = gamelift("StopMatchmaking", Dict{String, Any}("TicketId"=>TicketId))
StopMatchmaking(TicketId, args::AbstractDict{String, <: Any}) = gamelift("StopMatchmaking", Dict{String, Any}("TicketId"=>TicketId, args...))
...
"""
SuspendGameServerGroup(GameServerGroupName, SuspendActions) = gamelift("SuspendGameServerGroup", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "SuspendActions"=>SuspendActions))
SuspendGameServerGroup(GameServerGroupName, SuspendActions, args::AbstractDict{String, <: Any}) = gamelift("SuspendGameServerGroup", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "SuspendActions"=>SuspendActions, args...))
...
"""
TagResource(ResourceARN, Tags) = gamelift("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags))
TagResource(ResourceARN, Tags, args::AbstractDict{String, <: Any}) = gamelift("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceARN, TagKeys) = gamelift("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys))
UntagResource(ResourceARN, TagKeys, args::AbstractDict{String, <: Any}) = gamelift("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys, args...))
...
RoutingStrategy => The routing configuration, including routing type and fleet target, for the alias.
"""
UpdateAlias(AliasId) = gamelift("UpdateAlias", Dict{String, Any}("AliasId"=>AliasId))
UpdateAlias(AliasId, args::AbstractDict{String, <: Any}) = gamelift("UpdateAlias", Dict{String, Any}("AliasId"=>AliasId, args...))
...
"""
UpdateBuild(BuildId) = gamelift("UpdateBuild", Dict{String, Any}("BuildId"=>BuildId))
UpdateBuild(BuildId, args::AbstractDict{String, <: Any}) = gamelift("UpdateBuild", Dict{String, Any}("BuildId"=>BuildId, args...))
...
"""
UpdateFleetAttributes(FleetId) = gamelift("UpdateFleetAttributes", Dict{String, Any}("FleetId"=>FleetId))
UpdateFleetAttributes(FleetId, args::AbstractDict{String, <: Any}) = gamelift("UpdateFleetAttributes", Dict{String, Any}("FleetId"=>FleetId, args...))
...
"""
UpdateFleetCapacity(FleetId) = gamelift("UpdateFleetCapacity", Dict{String, Any}("FleetId"=>FleetId))
UpdateFleetCapacity(FleetId, args::AbstractDict{String, <: Any}) = gamelift("UpdateFleetCapacity", Dict{String, Any}("FleetId"=>FleetId, args...))
...
"""
UpdateFleetPortSettings(FleetId) = gamelift("UpdateFleetPortSettings", Dict{String, Any}("FleetId"=>FleetId))
UpdateFleetPortSettings(FleetId, args::AbstractDict{String, <: Any}) = gamelift("UpdateFleetPortSettings", Dict{String, Any}("FleetId"=>FleetId, args...))
...
"""
UpdateGameServer(GameServerGroupName, GameServerId) = gamelift("UpdateGameServer", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "GameServerId"=>GameServerId))
UpdateGameServer(GameServerGroupName, GameServerId, args::AbstractDict{String, <: Any}) = gamelift("UpdateGameServer", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, "GameServerId"=>GameServerId, args...))
...
RoleArn => The Amazon Resource Name (ARN) for an IAM role that allows Amazon GameLift to access your EC2 Auto Scaling groups. The submitted role is validated to ensure that it contains the necessary permissions for game server groups.
"""
UpdateGameServerGroup(GameServerGroupName) = gamelift("UpdateGameServerGroup", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName))
UpdateGameServerGroup(GameServerGroupName, args::AbstractDict{String, <: Any}) = gamelift("UpdateGameServerGroup", Dict{String, Any}("GameServerGroupName"=>GameServerGroupName, args...))
...
"""
UpdateGameSession(GameSessionId) = gamelift("UpdateGameSession", Dict{String, Any}("GameSessionId"=>GameSessionId))
UpdateGameSession(GameSessionId, args::AbstractDict{String, <: Any}) = gamelift("UpdateGameSession", Dict{String, Any}("GameSessionId"=>GameSessionId, args...))
...
TimeoutInSeconds => The maximum time, in seconds, that a new game session placement request remains in the queue. When a request exceeds this time, the game session placement changes to a TIMED_OUT status.
"""
UpdateGameSessionQueue(Name) = gamelift("UpdateGameSessionQueue", Dict{String, Any}("Name"=>Name))
UpdateGameSessionQueue(Name, args::AbstractDict{String, <: Any}) = gamelift("UpdateGameSessionQueue", Dict{String, Any}("Name"=>Name, args...))
...
RuleSetName => A unique identifier for a matchmaking rule set to use with this configuration. You can use either the rule set name or ARN value. A matchmaking configuration can only use rule sets that are defined in the same Region.
"""
UpdateMatchmakingConfiguration(Name) = gamelift("UpdateMatchmakingConfiguration", Dict{String, Any}("Name"=>Name))
UpdateMatchmakingConfiguration(Name, args::AbstractDict{String, <: Any}) = gamelift("UpdateMatchmakingConfiguration", Dict{String, Any}("Name"=>Name, args...))
...
"""
UpdateRuntimeConfiguration(FleetId, RuntimeConfiguration) = gamelift("UpdateRuntimeConfiguration", Dict{String, Any}("FleetId"=>FleetId, "RuntimeConfiguration"=>RuntimeConfiguration))
UpdateRuntimeConfiguration(FleetId, RuntimeConfiguration, args::AbstractDict{String, <: Any}) = gamelift("UpdateRuntimeConfiguration", Dict{String, Any}("FleetId"=>FleetId, "RuntimeConfiguration"=>RuntimeConfiguration, args...))
...
ZipFile => A data object containing your Realtime scripts and dependencies as a zip file. The zip file can have one or multiple files. Maximum size of a zip file is 5 MB. When using the AWS CLI tool to create a script, this parameter is set to the zip file name. It must be prepended with the string "fileb://" to indicate that the file data is a binary object. For example: --zip-file fileb://myRealtimeScript.zip.
"""
UpdateScript(ScriptId) = gamelift("UpdateScript", Dict{String, Any}("ScriptId"=>ScriptId))
UpdateScript(ScriptId, args::AbstractDict{String, <: Any}) = gamelift("UpdateScript", Dict{String, Any}("ScriptId"=>ScriptId, args...))
...
"""
ValidateMatchmakingRuleSet(RuleSetBody) = gamelift("ValidateMatchmakingRuleSet", Dict{String, Any}("RuleSetBody"=>RuleSetBody))
ValidateMatchmakingRuleSet(RuleSetBody, args::AbstractDict{String, <: Any}) = gamelift("ValidateMatchmakingRuleSet", Dict{String, Any}("RuleSetBody"=>RuleSetBody, args...))
