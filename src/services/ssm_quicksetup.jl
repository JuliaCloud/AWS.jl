...
"""
    ...
    get_configuration(configuration_id, params::Dict{String,<:Any})

Returns details about the specified configuration.

# Arguments

- `configuration_id`: A service generated identifier for the configuration.
"""
...
function get_service_settings(; aws_config::AbstractAWSConfig=current_aws_config())
    return ssm_quicksetup(
        "GET", "/serviceSettings"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_service_settings(
    ...
    return ssm_quicksetup(
        "GET", "/serviceSettings", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_configuration_managers(; aws_config::AbstractAWSConfig=current_aws_config())
    return ssm_quicksetup(
        "POST", "/listConfigurationManagers"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
Returns configurations deployed by Quick Setup in the requesting Amazon Web Services account
and Amazon Web Services Region.
...
- `"MaxItems"`: Specifies the maximum number of configurations that are returned by the
  request.
- `"StartingToken"`: The token to use when requesting a specific set of items from a list.
"""
...
function list_configurations(; aws_config::AbstractAWSConfig=current_aws_config())
    return ssm_quicksetup(
        "POST", "/listConfigurations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_configurations(
    ...
    return ssm_quicksetup(
        "POST", "/listConfigurations", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_quick_setup_types(; aws_config::AbstractAWSConfig=current_aws_config())
    return ssm_quicksetup(
        "GET", "/listQuickSetupTypes"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_quick_setup_types(
    ...
    return ssm_quicksetup(
        "GET", "/listQuickSetupTypes", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_service_settings(; aws_config::AbstractAWSConfig=current_aws_config())
    return ssm_quicksetup(
        "PUT", "/serviceSettings"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_service_settings(
    ...
    return ssm_quicksetup(
        "PUT", "/serviceSettings", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
