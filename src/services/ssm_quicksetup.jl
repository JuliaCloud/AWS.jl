...
"""
function list_configuration_managers(; aws_config::AbstractAWSConfig=global_aws_config())
    return ssm_quicksetup(
        "POST",
...
"""
function list_quick_setup_types(; aws_config::AbstractAWSConfig=global_aws_config())
    return ssm_quicksetup(
        "GET",
        "/listQuickSetupTypes";
        aws_config=aws_config,
