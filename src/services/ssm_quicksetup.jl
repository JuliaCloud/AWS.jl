...
"""
get_configuration_manager(ManagerArn; aws_config::AbstractAWSConfig=current_aws_config()) =
    ssm_quicksetup(
        "GET",
        "/configurationManager/$(ManagerArn)";
        aws_config=aws_config,
...
"""
get_service_settings(; aws_config::AbstractAWSConfig=current_aws_config()) = ssm_quicksetup(
...
"""
list_configuration_managers(; aws_config::AbstractAWSConfig=current_aws_config()) =
    ssm_quicksetup(
        "POST",
...
"""
list_quick_setup_types(; aws_config::AbstractAWSConfig=current_aws_config()) =
    ssm_quicksetup(
        "GET",
        "/listQuickSetupTypes";
        aws_config=aws_config,
