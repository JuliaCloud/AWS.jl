...
"""
CreateCanary(ArtifactS3Location, Code, ExecutionRoleArn, Name, RuntimeVersion, Schedule) = synthetics("POST", "/canary", Dict{String, Any}("ArtifactS3Location"=>ArtifactS3Location, "Code"=>Code, "ExecutionRoleArn"=>ExecutionRoleArn, "Name"=>Name, "RuntimeVersion"=>RuntimeVersion, "Schedule"=>Schedule))
CreateCanary(ArtifactS3Location, Code, ExecutionRoleArn, Name, RuntimeVersion, Schedule, args::AbstractDict{String, <: Any}) = synthetics("POST", "/canary", Dict{String, Any}("ArtifactS3Location"=>ArtifactS3Location, "Code"=>Code, "ExecutionRoleArn"=>ExecutionRoleArn, "Name"=>Name, "RuntimeVersion"=>RuntimeVersion, "Schedule"=>Schedule, args...))
...
DeleteCanary(name, args::AbstractDict{String, <: Any}) = synthetics("DELETE", "/canary/$(name)", args)
...
DescribeCanaries(args::AbstractDict{String, Any}) = synthetics("POST", "/canaries", args)
...
DescribeCanariesLastRun(args::AbstractDict{String, Any}) = synthetics("POST", "/canaries/last-run", args)
...
DescribeRuntimeVersions(args::AbstractDict{String, Any}) = synthetics("POST", "/runtime-versions", args)
...
GetCanary(name, args::AbstractDict{String, <: Any}) = synthetics("GET", "/canary/$(name)", args)
...
GetCanaryRuns(name, args::AbstractDict{String, <: Any}) = synthetics("POST", "/canary/$(name)/runs", args)
...
ListTagsForResource(resourceArn, args::AbstractDict{String, <: Any}) = synthetics("GET", "/tags/$(resourceArn)", args)
...
StartCanary(name, args::AbstractDict{String, <: Any}) = synthetics("POST", "/canary/$(name)/start", args)
...
StopCanary(name, args::AbstractDict{String, <: Any}) = synthetics("POST", "/canary/$(name)/stop", args)
...
"""
TagResource(Tags, resourceArn) = synthetics("POST", "/tags/$(resourceArn)", Dict{String, Any}("Tags"=>Tags))
TagResource(Tags, resourceArn, args::AbstractDict{String, <: Any}) = synthetics("POST", "/tags/$(resourceArn)", Dict{String, Any}("Tags"=>Tags, args...))
...
"""
UntagResource(resourceArn, tagKeys) = synthetics("DELETE", "/tags/$(resourceArn)", Dict{String, Any}("tagKeys"=>tagKeys))
UntagResource(resourceArn, tagKeys, args::AbstractDict{String, <: Any}) = synthetics("DELETE", "/tags/$(resourceArn)", Dict{String, Any}("tagKeys"=>tagKeys, args...))
...
UpdateCanary(name, args::AbstractDict{String, <: Any}) = synthetics("PATCH", "/canary/$(name)", args)
