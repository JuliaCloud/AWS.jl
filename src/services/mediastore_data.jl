...
"""
DeleteObject(Path; aws::AWSConfig=AWSConfig()) = mediastore_data("DELETE", "/$(Path)"; aws=aws)
DeleteObject(Path, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mediastore_data("DELETE", "/$(Path)", args; aws=aws)
...
"""
DescribeObject(Path; aws::AWSConfig=AWSConfig()) = mediastore_data("HEAD", "/$(Path)"; aws=aws)
DescribeObject(Path, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mediastore_data("HEAD", "/$(Path)", args; aws=aws)
...
"""
GetObject(Path; aws::AWSConfig=AWSConfig()) = mediastore_data("GET", "/$(Path)"; aws=aws)
GetObject(Path, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mediastore_data("GET", "/$(Path)", args; aws=aws)
...
"""
ListItems(; aws::AWSConfig=AWSConfig()) = mediastore_data("GET", "/"; aws=aws)
ListItems(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = mediastore_data("GET", "/", args; aws=aws)
...
"""
PutObject(Body, Path; aws::AWSConfig=AWSConfig()) = mediastore_data("PUT", "/$(Path)", Dict{String, Any}("Body"=>Body))
PutObject(Body, Path, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = mediastore_data("PUT", "/$(Path)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Body"=>Body), args)); aws=aws)
