...
"""
delete_alarm_model(alarmModelName; aws_config::AbstractAWSConfig=current_aws_config()) =
    iot_events(
        "DELETE",
...
"""
delete_input(inputName; aws_config::AbstractAWSConfig=current_aws_config()) = iot_events(
    "DELETE",
    "/inputs/$(inputName)";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
"""
describe_alarm_model(alarmModelName; aws_config::AbstractAWSConfig=current_aws_config()) =
    iot_events(
        "GET",
        "/alarm-models/$(alarmModelName)";
        aws_config=aws_config,
...
"""
describe_input(inputName; aws_config::AbstractAWSConfig=current_aws_config()) = iot_events(
    "GET",
    "/inputs/$(inputName)";
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
...
- `"nextToken"`: The token that you can use to return the next set of results.
"""
list_alarm_models(; aws_config::AbstractAWSConfig=current_aws_config()) = iot_events(
...
- `"nextToken"`: The token that you can use to return the next set of results.
"""
list_detector_models(; aws_config::AbstractAWSConfig=current_aws_config()) = iot_events(
...
- `"nextToken"`:  The token that you can use to return the next set of results.
"""
list_input_routings(inputIdentifier; aws_config::AbstractAWSConfig=current_aws_config()) =
    iot_events(
        "POST",
        "/input-routings",
