...
"""
GetMedia(StartSelector) = kinesis_video_media("POST", "/getMedia", Dict{String, Any}("StartSelector"=>StartSelector))
GetMedia(StartSelector, args::AbstractDict{String, <: Any}) = kinesis_video_media("POST", "/getMedia", Dict{String, Any}("StartSelector"=>StartSelector, args...))
