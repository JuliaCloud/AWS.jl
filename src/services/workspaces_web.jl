...
certificate authority (CA) certificates. Once associated with a web portal, the browser in a
streaming session will recognize certificates that have been issued using any of the CAs in
the trust store. If your organization has internal websites that use certificates issued by
private CAs, you should add the private CA certificate to the trust store.
...
- `copy_allowed`: Specifies whether the user can copy text from the streaming session to the
  local device.
...
- `upload_allowed`: Specifies whether the user can upload files from the local device to the
  streaming session.
...
function delete_portal(portalArn; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_web(
        "DELETE", "/portals/$(portalArn)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_portal(portalArn; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_web(
        "GET", "/portals/$(portalArn)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_portal(
    ...
    return workspaces_web(
        "GET", "/portals/$(portalArn)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_portal_service_provider_metadata(
    ...
    return workspaces_web(
        "GET", "/portalIdp/$(portalArn)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_trust_store(trustStoreArn; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_web(
        "GET", "/trustStores/$(trustStoreArn)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_browser_settings(; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_web(
        "GET", "/browserSettings"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_browser_settings(
    ...
    return workspaces_web(
        "GET", "/browserSettings", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_ip_access_settings(; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_web(
        "GET", "/ipAccessSettings"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_ip_access_settings(
    ...
    return workspaces_web(
        "GET", "/ipAccessSettings", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_network_settings(; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_web(
        "GET", "/networkSettings"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_network_settings(
    ...
    return workspaces_web(
        "GET", "/networkSettings", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_portals(; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_web("GET", "/portals"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_trust_stores(; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_web(
        "GET", "/trustStores"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_trust_stores(
    ...
    return workspaces_web(
        "GET", "/trustStores", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_user_access_logging_settings(;
    ...
    return workspaces_web(
        "GET", "/userAccessLoggingSettings"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_user_settings(; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_web(
        "GET", "/userSettings"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_user_settings(
    ...
    return workspaces_web(
        "GET", "/userSettings", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_portal(portalArn; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_web(
        "PUT", "/portals/$(portalArn)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
