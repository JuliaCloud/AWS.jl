...
function create_authorizer(
    authorizerFunctionArn, authorizerName; aws_config::AbstractAWSConfig=current_aws_config()
)
    return iot(
        "POST",
...
"""
function create_thing_type(thingTypeName; aws_config::AbstractAWSConfig=current_aws_config())
    return iot(
        "POST",
...
"""
function delete_custom_metric(metricName; aws_config::AbstractAWSConfig=current_aws_config())
    return iot(
        "DELETE",
        "/custom-metric/$(metricName)";
        aws_config=aws_config,
...
"""
function delete_thing_type(thingTypeName; aws_config::AbstractAWSConfig=current_aws_config())
    return iot(
        "DELETE",
        "/thing-types/$(thingTypeName)";
        aws_config=aws_config,
...
"""
function list_policy_versions(policyName; aws_config::AbstractAWSConfig=current_aws_config())
    return iot(
        "GET",
        "/policies/$(policyName)/version";
        aws_config=aws_config,
...
- `"nextToken"`: To retrieve the next set of results, the nextToken value from a previous
  response; otherwise null to receive the first set of results.
"""
function list_thing_principals(thingName; aws_config::AbstractAWSConfig=current_aws_config())
    return iot(
        "GET",
        "/things/$(thingName)/principals";
        aws_config=aws_config,
