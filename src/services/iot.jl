...
AcceptCertificateTransfer(certificateId, args::AbstractDict{String, <:Any}) = iot("PATCH", "/accept-certificate-transfer/$(certificateId)", args)
...
AddThingToBillingGroup(args::AbstractDict{String, Any}) = iot("PUT", "/billing-groups/addThingToBillingGroup", args)
...
AddThingToThingGroup(args::AbstractDict{String, Any}) = iot("PUT", "/thing-groups/addThingToThingGroup", args)
...
"""
AssociateTargetsWithJob(jobId, targets) = iot("POST", "/jobs/$(jobId)/targets", Dict{String, Any}("targets"=>targets))
AssociateTargetsWithJob(jobId, targets, args::AbstractDict{String, <:Any}) = iot("POST", "/jobs/$(jobId)/targets", Dict{String, Any}("targets"=>targets, args...))
...
"""
AttachPolicy(policyName, target) = iot("PUT", "/target-policies/$(policyName)", Dict{String, Any}("target"=>target))
AttachPolicy(policyName, target, args::AbstractDict{String, <:Any}) = iot("PUT", "/target-policies/$(policyName)", Dict{String, Any}("target"=>target, args...))
...
"""
AttachPrincipalPolicy(policyName, x_amzn_iot_principal) = iot("PUT", "/principal-policies/$(policyName)", Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-iot-principal"=>x_amzn_iot_principal)))
AttachPrincipalPolicy(policyName, x_amzn_iot_principal, args::AbstractDict{String, <:Any}) = iot("PUT", "/principal-policies/$(policyName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-iot-principal"=>x_amzn_iot_principal)), args...)))
...
"""
AttachSecurityProfile(securityProfileName, securityProfileTargetArn) = iot("PUT", "/security-profiles/$(securityProfileName)/targets", Dict{String, Any}("securityProfileTargetArn"=>securityProfileTargetArn))
AttachSecurityProfile(securityProfileName, securityProfileTargetArn, args::AbstractDict{String, <:Any}) = iot("PUT", "/security-profiles/$(securityProfileName)/targets", Dict{String, Any}("securityProfileTargetArn"=>securityProfileTargetArn, args...))
...
"""
AttachThingPrincipal(thingName, x_amzn_principal) = iot("PUT", "/things/$(thingName)/principals", Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-principal"=>x_amzn_principal)))
AttachThingPrincipal(thingName, x_amzn_principal, args::AbstractDict{String, <:Any}) = iot("PUT", "/things/$(thingName)/principals", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-principal"=>x_amzn_principal)), args...)))
...
CancelAuditMitigationActionsTask(taskId, args::AbstractDict{String, <:Any}) = iot("PUT", "/audit/mitigationactions/tasks/$(taskId)/cancel", args)
...
CancelAuditTask(taskId, args::AbstractDict{String, <:Any}) = iot("PUT", "/audit/tasks/$(taskId)/cancel", args)
...
CancelCertificateTransfer(certificateId, args::AbstractDict{String, <:Any}) = iot("PATCH", "/cancel-certificate-transfer/$(certificateId)", args)
...
CancelJob(jobId, args::AbstractDict{String, <:Any}) = iot("PUT", "/jobs/$(jobId)/cancel", args)
...
CancelJobExecution(jobId, thingName, args::AbstractDict{String, <:Any}) = iot("PUT", "/things/$(thingName)/jobs/$(jobId)/cancel", args)
...
ClearDefaultAuthorizer(args::AbstractDict{String, Any}) = iot("DELETE", "/default-authorizer", args)
...
ConfirmTopicRuleDestination(confirmationToken, args::AbstractDict{String, <:Any}) = iot("GET", "/confirmdestination/$(confirmationToken)", args)
...
"""
CreateAuthorizer(authorizerFunctionArn, authorizerName) = iot("POST", "/authorizer/$(authorizerName)", Dict{String, Any}("authorizerFunctionArn"=>authorizerFunctionArn))
CreateAuthorizer(authorizerFunctionArn, authorizerName, args::AbstractDict{String, <:Any}) = iot("POST", "/authorizer/$(authorizerName)", Dict{String, Any}("authorizerFunctionArn"=>authorizerFunctionArn, args...))
...
CreateBillingGroup(billingGroupName, args::AbstractDict{String, <:Any}) = iot("POST", "/billing-groups/$(billingGroupName)", args)
...
- `setAsActive`: Specifies whether the certificate is active.
"""
CreateCertificateFromCsr(certificateSigningRequest) = iot("POST", "/certificates", Dict{String, Any}("certificateSigningRequest"=>certificateSigningRequest))
CreateCertificateFromCsr(certificateSigningRequest, args::AbstractDict{String, <:Any}) = iot("POST", "/certificates", Dict{String, Any}("certificateSigningRequest"=>certificateSigningRequest, args...))
...
"""
CreateDimension(clientRequestToken, name, stringValues, type) = iot("POST", "/dimensions/$(name)", Dict{String, Any}("clientRequestToken"=>clientRequestToken, "stringValues"=>stringValues, "type"=>type))
CreateDimension(clientRequestToken, name, stringValues, type, args::AbstractDict{String, <:Any}) = iot("POST", "/dimensions/$(name)", Dict{String, Any}("clientRequestToken"=>clientRequestToken, "stringValues"=>stringValues, "type"=>type, args...))
...
CreateDomainConfiguration(domainConfigurationName, args::AbstractDict{String, <:Any}) = iot("POST", "/domainConfigurations/$(domainConfigurationName)", args)
...
"""
CreateDynamicThingGroup(queryString, thingGroupName) = iot("POST", "/dynamic-thing-groups/$(thingGroupName)", Dict{String, Any}("queryString"=>queryString))
CreateDynamicThingGroup(queryString, thingGroupName, args::AbstractDict{String, <:Any}) = iot("POST", "/dynamic-thing-groups/$(thingGroupName)", Dict{String, Any}("queryString"=>queryString, args...))
...
"""
CreateJob(jobId, targets) = iot("PUT", "/jobs/$(jobId)", Dict{String, Any}("targets"=>targets))
CreateJob(jobId, targets, args::AbstractDict{String, <:Any}) = iot("PUT", "/jobs/$(jobId)", Dict{String, Any}("targets"=>targets, args...))
...
CreateKeysAndCertificate(args::AbstractDict{String, Any}) = iot("POST", "/keys-and-certificate", args)
...
"""
CreateMitigationAction(actionName, actionParams, roleArn) = iot("POST", "/mitigationactions/actions/$(actionName)", Dict{String, Any}("actionParams"=>actionParams, "roleArn"=>roleArn))
CreateMitigationAction(actionName, actionParams, roleArn, args::AbstractDict{String, <:Any}) = iot("POST", "/mitigationactions/actions/$(actionName)", Dict{String, Any}("actionParams"=>actionParams, "roleArn"=>roleArn, args...))
...
"""
CreateOTAUpdate(files, otaUpdateId, roleArn, targets) = iot("POST", "/otaUpdates/$(otaUpdateId)", Dict{String, Any}("files"=>files, "roleArn"=>roleArn, "targets"=>targets))
CreateOTAUpdate(files, otaUpdateId, roleArn, targets, args::AbstractDict{String, <:Any}) = iot("POST", "/otaUpdates/$(otaUpdateId)", Dict{String, Any}("files"=>files, "roleArn"=>roleArn, "targets"=>targets, args...))
...
"""
CreatePolicy(policyDocument, policyName) = iot("POST", "/policies/$(policyName)", Dict{String, Any}("policyDocument"=>policyDocument))
CreatePolicy(policyDocument, policyName, args::AbstractDict{String, <:Any}) = iot("POST", "/policies/$(policyName)", Dict{String, Any}("policyDocument"=>policyDocument, args...))
...
"""
CreatePolicyVersion(policyDocument, policyName) = iot("POST", "/policies/$(policyName)/version", Dict{String, Any}("policyDocument"=>policyDocument))
CreatePolicyVersion(policyDocument, policyName, args::AbstractDict{String, <:Any}) = iot("POST", "/policies/$(policyName)/version", Dict{String, Any}("policyDocument"=>policyDocument, args...))
...
CreateProvisioningClaim(templateName, args::AbstractDict{String, <:Any}) = iot("POST", "/provisioning-templates/$(templateName)/provisioning-claim", args)
...
"""
CreateProvisioningTemplate(provisioningRoleArn, templateBody, templateName) = iot("POST", "/provisioning-templates", Dict{String, Any}("provisioningRoleArn"=>provisioningRoleArn, "templateBody"=>templateBody, "templateName"=>templateName))
CreateProvisioningTemplate(provisioningRoleArn, templateBody, templateName, args::AbstractDict{String, <:Any}) = iot("POST", "/provisioning-templates", Dict{String, Any}("provisioningRoleArn"=>provisioningRoleArn, "templateBody"=>templateBody, "templateName"=>templateName, args...))
...
"""
CreateProvisioningTemplateVersion(templateBody, templateName) = iot("POST", "/provisioning-templates/$(templateName)/versions", Dict{String, Any}("templateBody"=>templateBody))
CreateProvisioningTemplateVersion(templateBody, templateName, args::AbstractDict{String, <:Any}) = iot("POST", "/provisioning-templates/$(templateName)/versions", Dict{String, Any}("templateBody"=>templateBody, args...))
...
"""
CreateRoleAlias(roleAlias, roleArn) = iot("POST", "/role-aliases/$(roleAlias)", Dict{String, Any}("roleArn"=>roleArn))
CreateRoleAlias(roleAlias, roleArn, args::AbstractDict{String, <:Any}) = iot("POST", "/role-aliases/$(roleAlias)", Dict{String, Any}("roleArn"=>roleArn, args...))
...
"""
CreateScheduledAudit(frequency, scheduledAuditName, targetCheckNames) = iot("POST", "/audit/scheduledaudits/$(scheduledAuditName)", Dict{String, Any}("frequency"=>frequency, "targetCheckNames"=>targetCheckNames))
CreateScheduledAudit(frequency, scheduledAuditName, targetCheckNames, args::AbstractDict{String, <:Any}) = iot("POST", "/audit/scheduledaudits/$(scheduledAuditName)", Dict{String, Any}("frequency"=>frequency, "targetCheckNames"=>targetCheckNames, args...))
...
CreateSecurityProfile(securityProfileName, args::AbstractDict{String, <:Any}) = iot("POST", "/security-profiles/$(securityProfileName)", args)
...
"""
CreateStream(files, roleArn, streamId) = iot("POST", "/streams/$(streamId)", Dict{String, Any}("files"=>files, "roleArn"=>roleArn))
CreateStream(files, roleArn, streamId, args::AbstractDict{String, <:Any}) = iot("POST", "/streams/$(streamId)", Dict{String, Any}("files"=>files, "roleArn"=>roleArn, args...))
...
CreateThing(thingName, args::AbstractDict{String, <:Any}) = iot("POST", "/things/$(thingName)", args)
...
CreateThingGroup(thingGroupName, args::AbstractDict{String, <:Any}) = iot("POST", "/thing-groups/$(thingGroupName)", args)
...
CreateThingType(thingTypeName, args::AbstractDict{String, <:Any}) = iot("POST", "/thing-types/$(thingTypeName)", args)
...
"""
CreateTopicRule(ruleName, topicRulePayload) = iot("POST", "/rules/$(ruleName)", Dict{String, Any}("topicRulePayload"=>topicRulePayload))
CreateTopicRule(ruleName, topicRulePayload, args::AbstractDict{String, <:Any}) = iot("POST", "/rules/$(ruleName)", Dict{String, Any}("topicRulePayload"=>topicRulePayload, args...))
...
"""
CreateTopicRuleDestination(destinationConfiguration) = iot("POST", "/destinations", Dict{String, Any}("destinationConfiguration"=>destinationConfiguration))
CreateTopicRuleDestination(destinationConfiguration, args::AbstractDict{String, <:Any}) = iot("POST", "/destinations", Dict{String, Any}("destinationConfiguration"=>destinationConfiguration, args...))
...
DeleteAccountAuditConfiguration(args::AbstractDict{String, Any}) = iot("DELETE", "/audit/configuration", args)
...
DeleteAuthorizer(authorizerName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/authorizer/$(authorizerName)", args)
...
DeleteBillingGroup(billingGroupName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/billing-groups/$(billingGroupName)", args)
...
"""
DeleteCACertificate(caCertificateId) = iot("DELETE", "/cacertificate/$(caCertificateId)")
DeleteCACertificate(caCertificateId, args::AbstractDict{String, <:Any}) = iot("DELETE", "/cacertificate/$(caCertificateId)", args)
...
DeleteCertificate(certificateId, args::AbstractDict{String, <:Any}) = iot("DELETE", "/certificates/$(certificateId)", args)
...
DeleteDimension(name, args::AbstractDict{String, <:Any}) = iot("DELETE", "/dimensions/$(name)", args)
...
DeleteDomainConfiguration(domainConfigurationName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/domainConfigurations/$(domainConfigurationName)", args)
...
DeleteDynamicThingGroup(thingGroupName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/dynamic-thing-groups/$(thingGroupName)", args)
...
DeleteJob(jobId, args::AbstractDict{String, <:Any}) = iot("DELETE", "/jobs/$(jobId)", args)
...
DeleteJobExecution(executionNumber, jobId, thingName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/things/$(thingName)/jobs/$(jobId)/executionNumber/$(executionNumber)", args)
...
DeleteMitigationAction(actionName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/mitigationactions/actions/$(actionName)", args)
...
DeleteOTAUpdate(otaUpdateId, args::AbstractDict{String, <:Any}) = iot("DELETE", "/otaUpdates/$(otaUpdateId)", args)
...
DeletePolicy(policyName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/policies/$(policyName)", args)
...
DeletePolicyVersion(policyName, policyVersionId, args::AbstractDict{String, <:Any}) = iot("DELETE", "/policies/$(policyName)/version/$(policyVersionId)", args)
...
DeleteProvisioningTemplate(templateName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/provisioning-templates/$(templateName)", args)
...
DeleteProvisioningTemplateVersion(templateName, versionId, args::AbstractDict{String, <:Any}) = iot("DELETE", "/provisioning-templates/$(templateName)/versions/$(versionId)", args)
...
DeleteRegistrationCode(args::AbstractDict{String, Any}) = iot("DELETE", "/registrationcode", args)
...
DeleteRoleAlias(roleAlias, args::AbstractDict{String, <:Any}) = iot("DELETE", "/role-aliases/$(roleAlias)", args)
...
DeleteScheduledAudit(scheduledAuditName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/audit/scheduledaudits/$(scheduledAuditName)", args)
...
DeleteSecurityProfile(securityProfileName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/security-profiles/$(securityProfileName)", args)
...
DeleteStream(streamId, args::AbstractDict{String, <:Any}) = iot("DELETE", "/streams/$(streamId)", args)
...
DeleteThing(thingName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/things/$(thingName)", args)
...
DeleteThingGroup(thingGroupName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/thing-groups/$(thingGroupName)", args)
...
DeleteThingType(thingTypeName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/thing-types/$(thingTypeName)", args)
...
DeleteTopicRule(ruleName, args::AbstractDict{String, <:Any}) = iot("DELETE", "/rules/$(ruleName)", args)
...
DeleteTopicRuleDestination(arn, args::AbstractDict{String, <:Any}) = iot("DELETE", "/destinations/$(arn)", args)
...
"""
DeleteV2LoggingLevel(targetName, targetType) = iot("DELETE", "/v2LoggingLevel", Dict{String, Any}("targetName"=>targetName, "targetType"=>targetType))
DeleteV2LoggingLevel(targetName, targetType, args::AbstractDict{String, <:Any}) = iot("DELETE", "/v2LoggingLevel", Dict{String, Any}("targetName"=>targetName, "targetType"=>targetType, args...))
...
DeprecateThingType(thingTypeName, args::AbstractDict{String, <:Any}) = iot("POST", "/thing-types/$(thingTypeName)/deprecate", args)
...
DescribeAccountAuditConfiguration(args::AbstractDict{String, Any}) = iot("GET", "/audit/configuration", args)
...
DescribeAuditFinding(findingId, args::AbstractDict{String, <:Any}) = iot("GET", "/audit/findings/$(findingId)", args)
...
DescribeAuditMitigationActionsTask(taskId, args::AbstractDict{String, <:Any}) = iot("GET", "/audit/mitigationactions/tasks/$(taskId)", args)
...
DescribeAuditTask(taskId, args::AbstractDict{String, <:Any}) = iot("GET", "/audit/tasks/$(taskId)", args)
...
DescribeAuthorizer(authorizerName, args::AbstractDict{String, <:Any}) = iot("GET", "/authorizer/$(authorizerName)", args)
...
DescribeBillingGroup(billingGroupName, args::AbstractDict{String, <:Any}) = iot("GET", "/billing-groups/$(billingGroupName)", args)
...
"""
DescribeCACertificate(caCertificateId) = iot("GET", "/cacertificate/$(caCertificateId)")
DescribeCACertificate(caCertificateId, args::AbstractDict{String, <:Any}) = iot("GET", "/cacertificate/$(caCertificateId)", args)
...
DescribeCertificate(certificateId, args::AbstractDict{String, <:Any}) = iot("GET", "/certificates/$(certificateId)", args)
...
DescribeDefaultAuthorizer(args::AbstractDict{String, Any}) = iot("GET", "/default-authorizer", args)
...
DescribeDimension(name, args::AbstractDict{String, <:Any}) = iot("GET", "/dimensions/$(name)", args)
...
DescribeDomainConfiguration(domainConfigurationName, args::AbstractDict{String, <:Any}) = iot("GET", "/domainConfigurations/$(domainConfigurationName)", args)
...
DescribeEndpoint(args::AbstractDict{String, Any}) = iot("GET", "/endpoint", args)
...
DescribeEventConfigurations(args::AbstractDict{String, Any}) = iot("GET", "/event-configurations", args)
...
DescribeIndex(indexName, args::AbstractDict{String, <:Any}) = iot("GET", "/indices/$(indexName)", args)
...
DescribeJob(jobId, args::AbstractDict{String, <:Any}) = iot("GET", "/jobs/$(jobId)", args)
...
DescribeJobExecution(jobId, thingName, args::AbstractDict{String, <:Any}) = iot("GET", "/things/$(thingName)/jobs/$(jobId)", args)
...
DescribeMitigationAction(actionName, args::AbstractDict{String, <:Any}) = iot("GET", "/mitigationactions/actions/$(actionName)", args)
...
DescribeProvisioningTemplate(templateName, args::AbstractDict{String, <:Any}) = iot("GET", "/provisioning-templates/$(templateName)", args)
...
DescribeProvisioningTemplateVersion(templateName, versionId, args::AbstractDict{String, <:Any}) = iot("GET", "/provisioning-templates/$(templateName)/versions/$(versionId)", args)
...
DescribeRoleAlias(roleAlias, args::AbstractDict{String, <:Any}) = iot("GET", "/role-aliases/$(roleAlias)", args)
...
DescribeScheduledAudit(scheduledAuditName, args::AbstractDict{String, <:Any}) = iot("GET", "/audit/scheduledaudits/$(scheduledAuditName)", args)
...
DescribeSecurityProfile(securityProfileName, args::AbstractDict{String, <:Any}) = iot("GET", "/security-profiles/$(securityProfileName)", args)
...
DescribeStream(streamId, args::AbstractDict{String, <:Any}) = iot("GET", "/streams/$(streamId)", args)
...
DescribeThing(thingName, args::AbstractDict{String, <:Any}) = iot("GET", "/things/$(thingName)", args)
...
DescribeThingGroup(thingGroupName, args::AbstractDict{String, <:Any}) = iot("GET", "/thing-groups/$(thingGroupName)", args)
...
DescribeThingRegistrationTask(taskId, args::AbstractDict{String, <:Any}) = iot("GET", "/thing-registration-tasks/$(taskId)", args)
...
DescribeThingType(thingTypeName, args::AbstractDict{String, <:Any}) = iot("GET", "/thing-types/$(thingTypeName)", args)
...
"""
DetachPolicy(policyName, target) = iot("POST", "/target-policies/$(policyName)", Dict{String, Any}("target"=>target))
DetachPolicy(policyName, target, args::AbstractDict{String, <:Any}) = iot("POST", "/target-policies/$(policyName)", Dict{String, Any}("target"=>target, args...))
...
- `x-amzn-iot-principal`: The principal. If the principal is a certificate, specify the certificate ARN. If the principal is an Amazon Cognito identity, specify the identity ID.

"""
DetachPrincipalPolicy(policyName, x_amzn_iot_principal) = iot("DELETE", "/principal-policies/$(policyName)", Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-iot-principal"=>x_amzn_iot_principal)))
DetachPrincipalPolicy(policyName, x_amzn_iot_principal, args::AbstractDict{String, <:Any}) = iot("DELETE", "/principal-policies/$(policyName)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-iot-principal"=>x_amzn_iot_principal)), args...)))
...
"""
DetachSecurityProfile(securityProfileName, securityProfileTargetArn) = iot("DELETE", "/security-profiles/$(securityProfileName)/targets", Dict{String, Any}("securityProfileTargetArn"=>securityProfileTargetArn))
DetachSecurityProfile(securityProfileName, securityProfileTargetArn, args::AbstractDict{String, <:Any}) = iot("DELETE", "/security-profiles/$(securityProfileName)/targets", Dict{String, Any}("securityProfileTargetArn"=>securityProfileTargetArn, args...))
...
"""
DetachThingPrincipal(thingName, x_amzn_principal) = iot("DELETE", "/things/$(thingName)/principals", Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-principal"=>x_amzn_principal)))
DetachThingPrincipal(thingName, x_amzn_principal, args::AbstractDict{String, <:Any}) = iot("DELETE", "/things/$(thingName)/principals", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-principal"=>x_amzn_principal)), args...)))
...
DisableTopicRule(ruleName, args::AbstractDict{String, <:Any}) = iot("POST", "/rules/$(ruleName)/disable", args)
...
EnableTopicRule(ruleName, args::AbstractDict{String, <:Any}) = iot("POST", "/rules/$(ruleName)/enable", args)
...
"""
GetCardinality(queryString) = iot("POST", "/indices/cardinality", Dict{String, Any}("queryString"=>queryString))
GetCardinality(queryString, args::AbstractDict{String, <:Any}) = iot("POST", "/indices/cardinality", Dict{String, Any}("queryString"=>queryString, args...))
...
GetEffectivePolicies(args::AbstractDict{String, Any}) = iot("POST", "/effective-policies", args)
...
GetIndexingConfiguration(args::AbstractDict{String, Any}) = iot("GET", "/indexing/config", args)
...
GetJobDocument(jobId, args::AbstractDict{String, <:Any}) = iot("GET", "/jobs/$(jobId)/job-document", args)
...
GetLoggingOptions(args::AbstractDict{String, Any}) = iot("GET", "/loggingOptions", args)
...
GetOTAUpdate(otaUpdateId, args::AbstractDict{String, <:Any}) = iot("GET", "/otaUpdates/$(otaUpdateId)", args)
...
- `queryVersion`: The query version.
"""
GetPercentiles(queryString) = iot("POST", "/indices/percentiles", Dict{String, Any}("queryString"=>queryString))
GetPercentiles(queryString, args::AbstractDict{String, <:Any}) = iot("POST", "/indices/percentiles", Dict{String, Any}("queryString"=>queryString, args...))
...
GetPolicy(policyName, args::AbstractDict{String, <:Any}) = iot("GET", "/policies/$(policyName)", args)
...
GetPolicyVersion(policyName, policyVersionId, args::AbstractDict{String, <:Any}) = iot("GET", "/policies/$(policyName)/version/$(policyVersionId)", args)
...
GetRegistrationCode(args::AbstractDict{String, Any}) = iot("GET", "/registrationcode", args)
...
"""
GetStatistics(queryString) = iot("POST", "/indices/statistics", Dict{String, Any}("queryString"=>queryString))
GetStatistics(queryString, args::AbstractDict{String, <:Any}) = iot("POST", "/indices/statistics", Dict{String, Any}("queryString"=>queryString, args...))
...
GetTopicRule(ruleName, args::AbstractDict{String, <:Any}) = iot("GET", "/rules/$(ruleName)", args)
...
GetTopicRuleDestination(arn, args::AbstractDict{String, <:Any}) = iot("GET", "/destinations/$(arn)", args)
...
GetV2LoggingOptions(args::AbstractDict{String, Any}) = iot("GET", "/v2LoggingOptions", args)
...
ListActiveViolations(args::AbstractDict{String, Any}) = iot("GET", "/active-violations", args)
...
ListAttachedPolicies(target, args::AbstractDict{String, <:Any}) = iot("POST", "/attached-policies/$(target)", args)
...
ListAuditFindings(args::AbstractDict{String, Any}) = iot("POST", "/audit/findings", args)
...
- `nextToken`: The token for the next set of results.
"""
ListAuditMitigationActionsExecutions(findingId, taskId) = iot("GET", "/audit/mitigationactions/executions", Dict{String, Any}("findingId"=>findingId, "taskId"=>taskId))
ListAuditMitigationActionsExecutions(findingId, taskId, args::AbstractDict{String, <:Any}) = iot("GET", "/audit/mitigationactions/executions", Dict{String, Any}("findingId"=>findingId, "taskId"=>taskId, args...))
...
"""
ListAuditMitigationActionsTasks(endTime, startTime) = iot("GET", "/audit/mitigationactions/tasks", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime))
ListAuditMitigationActionsTasks(endTime, startTime, args::AbstractDict{String, <:Any}) = iot("GET", "/audit/mitigationactions/tasks", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime, args...))
...
"""
ListAuditTasks(endTime, startTime) = iot("GET", "/audit/tasks", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime))
ListAuditTasks(endTime, startTime, args::AbstractDict{String, <:Any}) = iot("GET", "/audit/tasks", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime, args...))
...
ListAuthorizers(args::AbstractDict{String, Any}) = iot("GET", "/authorizers/", args)
...
ListBillingGroups(args::AbstractDict{String, Any}) = iot("GET", "/billing-groups", args)
...
ListCACertificates(args::AbstractDict{String, Any}) = iot("GET", "/cacertificates", args)
...
ListCertificates(args::AbstractDict{String, Any}) = iot("GET", "/certificates", args)
...
ListCertificatesByCA(caCertificateId, args::AbstractDict{String, <:Any}) = iot("GET", "/certificates-by-ca/$(caCertificateId)", args)
...
ListDimensions(args::AbstractDict{String, Any}) = iot("GET", "/dimensions", args)
...
ListDomainConfigurations(args::AbstractDict{String, Any}) = iot("GET", "/domainConfigurations", args)
...
ListIndices(args::AbstractDict{String, Any}) = iot("GET", "/indices", args)
...
ListJobExecutionsForJob(jobId, args::AbstractDict{String, <:Any}) = iot("GET", "/jobs/$(jobId)/things", args)
...
ListJobExecutionsForThing(thingName, args::AbstractDict{String, <:Any}) = iot("GET", "/things/$(thingName)/jobs", args)
...
ListJobs(args::AbstractDict{String, Any}) = iot("GET", "/jobs", args)
...
ListMitigationActions(args::AbstractDict{String, Any}) = iot("GET", "/mitigationactions/actions", args)
...
ListOTAUpdates(args::AbstractDict{String, Any}) = iot("GET", "/otaUpdates", args)
...
ListOutgoingCertificates(args::AbstractDict{String, Any}) = iot("GET", "/certificates-out-going", args)
...
ListPolicies(args::AbstractDict{String, Any}) = iot("GET", "/policies", args)
...
- `pageSize`: The result page size.
"""
ListPolicyPrincipals(x_amzn_iot_policy) = iot("GET", "/policy-principals", Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-iot-policy"=>x_amzn_iot_policy)))
ListPolicyPrincipals(x_amzn_iot_policy, args::AbstractDict{String, <:Any}) = iot("GET", "/policy-principals", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-iot-policy"=>x_amzn_iot_policy)), args...)))
...
ListPolicyVersions(policyName, args::AbstractDict{String, <:Any}) = iot("GET", "/policies/$(policyName)/version", args)
...
- `pageSize`: The result page size.
"""
ListPrincipalPolicies(x_amzn_iot_principal) = iot("GET", "/principal-policies", Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-iot-principal"=>x_amzn_iot_principal)))
ListPrincipalPolicies(x_amzn_iot_principal, args::AbstractDict{String, <:Any}) = iot("GET", "/principal-policies", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-iot-principal"=>x_amzn_iot_principal)), args...)))
...
- `nextToken`: The token to retrieve the next set of results.
"""
ListPrincipalThings(x_amzn_principal) = iot("GET", "/principals/things", Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-principal"=>x_amzn_principal)))
ListPrincipalThings(x_amzn_principal, args::AbstractDict{String, <:Any}) = iot("GET", "/principals/things", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amzn-principal"=>x_amzn_principal)), args...)))
...
ListProvisioningTemplateVersions(templateName, args::AbstractDict{String, <:Any}) = iot("GET", "/provisioning-templates/$(templateName)/versions", args)
...
ListProvisioningTemplates(args::AbstractDict{String, Any}) = iot("GET", "/provisioning-templates", args)
...
ListRoleAliases(args::AbstractDict{String, Any}) = iot("GET", "/role-aliases", args)
...
ListScheduledAudits(args::AbstractDict{String, Any}) = iot("GET", "/audit/scheduledaudits", args)
...
ListSecurityProfiles(args::AbstractDict{String, Any}) = iot("GET", "/security-profiles", args)
...
"""
ListSecurityProfilesForTarget(securityProfileTargetArn) = iot("GET", "/security-profiles-for-target", Dict{String, Any}("securityProfileTargetArn"=>securityProfileTargetArn))
ListSecurityProfilesForTarget(securityProfileTargetArn, args::AbstractDict{String, <:Any}) = iot("GET", "/security-profiles-for-target", Dict{String, Any}("securityProfileTargetArn"=>securityProfileTargetArn, args...))
...
ListStreams(args::AbstractDict{String, Any}) = iot("GET", "/streams", args)
...
- `nextToken`: The token to retrieve the next set of results.
"""
ListTagsForResource(resourceArn) = iot("GET", "/tags", Dict{String, Any}("resourceArn"=>resourceArn))
ListTagsForResource(resourceArn, args::AbstractDict{String, <:Any}) = iot("GET", "/tags", Dict{String, Any}("resourceArn"=>resourceArn, args...))
...
ListTargetsForPolicy(policyName, args::AbstractDict{String, <:Any}) = iot("POST", "/policy-targets/$(policyName)", args)
...
ListTargetsForSecurityProfile(securityProfileName, args::AbstractDict{String, <:Any}) = iot("GET", "/security-profiles/$(securityProfileName)/targets", args)
...
ListThingGroups(args::AbstractDict{String, Any}) = iot("GET", "/thing-groups", args)
...
ListThingGroupsForThing(thingName, args::AbstractDict{String, <:Any}) = iot("GET", "/things/$(thingName)/thing-groups", args)
...
ListThingPrincipals(thingName, args::AbstractDict{String, <:Any}) = iot("GET", "/things/$(thingName)/principals", args)
...
- `nextToken`: The token to retrieve the next set of results.
"""
ListThingRegistrationTaskReports(reportType, taskId) = iot("GET", "/thing-registration-tasks/$(taskId)/reports", Dict{String, Any}("reportType"=>reportType))
ListThingRegistrationTaskReports(reportType, taskId, args::AbstractDict{String, <:Any}) = iot("GET", "/thing-registration-tasks/$(taskId)/reports", Dict{String, Any}("reportType"=>reportType, args...))
...
ListThingRegistrationTasks(args::AbstractDict{String, Any}) = iot("GET", "/thing-registration-tasks", args)
...
ListThingTypes(args::AbstractDict{String, Any}) = iot("GET", "/thing-types", args)
...
ListThings(args::AbstractDict{String, Any}) = iot("GET", "/things", args)
...
ListThingsInBillingGroup(billingGroupName, args::AbstractDict{String, <:Any}) = iot("GET", "/billing-groups/$(billingGroupName)/things", args)
...
ListThingsInThingGroup(thingGroupName, args::AbstractDict{String, <:Any}) = iot("GET", "/thing-groups/$(thingGroupName)/things", args)
...
ListTopicRuleDestinations(args::AbstractDict{String, Any}) = iot("GET", "/destinations", args)
...
ListTopicRules(args::AbstractDict{String, Any}) = iot("GET", "/rules", args)
...
ListV2LoggingLevels(args::AbstractDict{String, Any}) = iot("GET", "/v2LoggingLevel", args)
...
"""
ListViolationEvents(endTime, startTime) = iot("GET", "/violation-events", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime))
ListViolationEvents(endTime, startTime, args::AbstractDict{String, <:Any}) = iot("GET", "/violation-events", Dict{String, Any}("endTime"=>endTime, "startTime"=>startTime, args...))
...
"""
RegisterCACertificate(caCertificate, verificationCertificate) = iot("POST", "/cacertificate", Dict{String, Any}("caCertificate"=>caCertificate, "verificationCertificate"=>verificationCertificate))
RegisterCACertificate(caCertificate, verificationCertificate, args::AbstractDict{String, <:Any}) = iot("POST", "/cacertificate", Dict{String, Any}("caCertificate"=>caCertificate, "verificationCertificate"=>verificationCertificate, args...))
...
"""
RegisterCertificate(certificatePem) = iot("POST", "/certificate/register", Dict{String, Any}("certificatePem"=>certificatePem))
RegisterCertificate(certificatePem, args::AbstractDict{String, <:Any}) = iot("POST", "/certificate/register", Dict{String, Any}("certificatePem"=>certificatePem, args...))
...
- `status`: The status of the register certificate request.
"""
RegisterCertificateWithoutCA(certificatePem) = iot("POST", "/certificate/register-no-ca", Dict{String, Any}("certificatePem"=>certificatePem))
RegisterCertificateWithoutCA(certificatePem, args::AbstractDict{String, <:Any}) = iot("POST", "/certificate/register-no-ca", Dict{String, Any}("certificatePem"=>certificatePem, args...))
...
"""
RegisterThing(templateBody) = iot("POST", "/things", Dict{String, Any}("templateBody"=>templateBody))
RegisterThing(templateBody, args::AbstractDict{String, <:Any}) = iot("POST", "/things", Dict{String, Any}("templateBody"=>templateBody, args...))
...
RejectCertificateTransfer(certificateId, args::AbstractDict{String, <:Any}) = iot("PATCH", "/reject-certificate-transfer/$(certificateId)", args)
...
RemoveThingFromBillingGroup(args::AbstractDict{String, Any}) = iot("PUT", "/billing-groups/removeThingFromBillingGroup", args)
...
RemoveThingFromThingGroup(args::AbstractDict{String, Any}) = iot("PUT", "/thing-groups/removeThingFromThingGroup", args)
...
"""
ReplaceTopicRule(ruleName, topicRulePayload) = iot("PATCH", "/rules/$(ruleName)", Dict{String, Any}("topicRulePayload"=>topicRulePayload))
ReplaceTopicRule(ruleName, topicRulePayload, args::AbstractDict{String, <:Any}) = iot("PATCH", "/rules/$(ruleName)", Dict{String, Any}("topicRulePayload"=>topicRulePayload, args...))
...
- `queryVersion`: The query version.
"""
SearchIndex(queryString) = iot("POST", "/indices/search", Dict{String, Any}("queryString"=>queryString))
SearchIndex(queryString, args::AbstractDict{String, <:Any}) = iot("POST", "/indices/search", Dict{String, Any}("queryString"=>queryString, args...))
...
"""
SetDefaultAuthorizer(authorizerName) = iot("POST", "/default-authorizer", Dict{String, Any}("authorizerName"=>authorizerName))
SetDefaultAuthorizer(authorizerName, args::AbstractDict{String, <:Any}) = iot("POST", "/default-authorizer", Dict{String, Any}("authorizerName"=>authorizerName, args...))
...
SetDefaultPolicyVersion(policyName, policyVersionId, args::AbstractDict{String, <:Any}) = iot("PATCH", "/policies/$(policyName)/version/$(policyVersionId)", args)
...
"""
SetLoggingOptions(loggingOptionsPayload) = iot("POST", "/loggingOptions", Dict{String, Any}("loggingOptionsPayload"=>loggingOptionsPayload))
SetLoggingOptions(loggingOptionsPayload, args::AbstractDict{String, <:Any}) = iot("POST", "/loggingOptions", Dict{String, Any}("loggingOptionsPayload"=>loggingOptionsPayload, args...))
...
"""
SetV2LoggingLevel(logLevel, logTarget) = iot("POST", "/v2LoggingLevel", Dict{String, Any}("logLevel"=>logLevel, "logTarget"=>logTarget))
SetV2LoggingLevel(logLevel, logTarget, args::AbstractDict{String, <:Any}) = iot("POST", "/v2LoggingLevel", Dict{String, Any}("logLevel"=>logLevel, "logTarget"=>logTarget, args...))
...
SetV2LoggingOptions(args::AbstractDict{String, Any}) = iot("POST", "/v2LoggingOptions", args)
...
"""
StartAuditMitigationActionsTask(auditCheckToActionsMapping, clientRequestToken, target, taskId) = iot("POST", "/audit/mitigationactions/tasks/$(taskId)", Dict{String, Any}("auditCheckToActionsMapping"=>auditCheckToActionsMapping, "clientRequestToken"=>clientRequestToken, "target"=>target))
StartAuditMitigationActionsTask(auditCheckToActionsMapping, clientRequestToken, target, taskId, args::AbstractDict{String, <:Any}) = iot("POST", "/audit/mitigationactions/tasks/$(taskId)", Dict{String, Any}("auditCheckToActionsMapping"=>auditCheckToActionsMapping, "clientRequestToken"=>clientRequestToken, "target"=>target, args...))
...
"""
StartOnDemandAuditTask(targetCheckNames) = iot("POST", "/audit/tasks", Dict{String, Any}("targetCheckNames"=>targetCheckNames))
StartOnDemandAuditTask(targetCheckNames, args::AbstractDict{String, <:Any}) = iot("POST", "/audit/tasks", Dict{String, Any}("targetCheckNames"=>targetCheckNames, args...))
...
"""
StartThingRegistrationTask(inputFileBucket, inputFileKey, roleArn, templateBody) = iot("POST", "/thing-registration-tasks", Dict{String, Any}("inputFileBucket"=>inputFileBucket, "inputFileKey"=>inputFileKey, "roleArn"=>roleArn, "templateBody"=>templateBody))
StartThingRegistrationTask(inputFileBucket, inputFileKey, roleArn, templateBody, args::AbstractDict{String, <:Any}) = iot("POST", "/thing-registration-tasks", Dict{String, Any}("inputFileBucket"=>inputFileBucket, "inputFileKey"=>inputFileKey, "roleArn"=>roleArn, "templateBody"=>templateBody, args...))
...
StopThingRegistrationTask(taskId, args::AbstractDict{String, <:Any}) = iot("PUT", "/thing-registration-tasks/$(taskId)/cancel", args)
...
"""
TagResource(resourceArn, tags) = iot("POST", "/tags", Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags))
TagResource(resourceArn, tags, args::AbstractDict{String, <:Any}) = iot("POST", "/tags", Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags, args...))
...
- `principal`: The principal.
"""
TestAuthorization(authInfos) = iot("POST", "/test-authorization", Dict{String, Any}("authInfos"=>authInfos))
TestAuthorization(authInfos, args::AbstractDict{String, <:Any}) = iot("POST", "/test-authorization", Dict{String, Any}("authInfos"=>authInfos, args...))
...
TestInvokeAuthorizer(authorizerName, args::AbstractDict{String, <:Any}) = iot("POST", "/authorizer/$(authorizerName)/test", args)
...
"""
TransferCertificate(certificateId, targetAwsAccount) = iot("PATCH", "/transfer-certificate/$(certificateId)", Dict{String, Any}("targetAwsAccount"=>targetAwsAccount))
TransferCertificate(certificateId, targetAwsAccount, args::AbstractDict{String, <:Any}) = iot("PATCH", "/transfer-certificate/$(certificateId)", Dict{String, Any}("targetAwsAccount"=>targetAwsAccount, args...))
...
"""
UntagResource(resourceArn, tagKeys) = iot("POST", "/untag", Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys))
UntagResource(resourceArn, tagKeys, args::AbstractDict{String, <:Any}) = iot("POST", "/untag", Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys, args...))
...
UpdateAccountAuditConfiguration(args::AbstractDict{String, Any}) = iot("PATCH", "/audit/configuration", args)
...
UpdateAuthorizer(authorizerName, args::AbstractDict{String, <:Any}) = iot("PUT", "/authorizer/$(authorizerName)", args)
...
"""
UpdateBillingGroup(billingGroupName, billingGroupProperties) = iot("PATCH", "/billing-groups/$(billingGroupName)", Dict{String, Any}("billingGroupProperties"=>billingGroupProperties))
UpdateBillingGroup(billingGroupName, billingGroupProperties, args::AbstractDict{String, <:Any}) = iot("PATCH", "/billing-groups/$(billingGroupName)", Dict{String, Any}("billingGroupProperties"=>billingGroupProperties, args...))
...
"""
UpdateCACertificate(caCertificateId) = iot("PUT", "/cacertificate/$(caCertificateId)")
UpdateCACertificate(caCertificateId, args::AbstractDict{String, <:Any}) = iot("PUT", "/cacertificate/$(caCertificateId)", args)
...
"""
UpdateCertificate(certificateId, newStatus) = iot("PUT", "/certificates/$(certificateId)", Dict{String, Any}("newStatus"=>newStatus))
UpdateCertificate(certificateId, newStatus, args::AbstractDict{String, <:Any}) = iot("PUT", "/certificates/$(certificateId)", Dict{String, Any}("newStatus"=>newStatus, args...))
...
"""
UpdateDimension(name, stringValues) = iot("PATCH", "/dimensions/$(name)", Dict{String, Any}("stringValues"=>stringValues))
UpdateDimension(name, stringValues, args::AbstractDict{String, <:Any}) = iot("PATCH", "/dimensions/$(name)", Dict{String, Any}("stringValues"=>stringValues, args...))
...
UpdateDomainConfiguration(domainConfigurationName, args::AbstractDict{String, <:Any}) = iot("PUT", "/domainConfigurations/$(domainConfigurationName)", args)
...
"""
UpdateDynamicThingGroup(thingGroupName, thingGroupProperties) = iot("PATCH", "/dynamic-thing-groups/$(thingGroupName)", Dict{String, Any}("thingGroupProperties"=>thingGroupProperties))
UpdateDynamicThingGroup(thingGroupName, thingGroupProperties, args::AbstractDict{String, <:Any}) = iot("PATCH", "/dynamic-thing-groups/$(thingGroupName)", Dict{String, Any}("thingGroupProperties"=>thingGroupProperties, args...))
...
UpdateEventConfigurations(args::AbstractDict{String, Any}) = iot("PATCH", "/event-configurations", args)
...
UpdateIndexingConfiguration(args::AbstractDict{String, Any}) = iot("POST", "/indexing/config", args)
...
UpdateJob(jobId, args::AbstractDict{String, <:Any}) = iot("PATCH", "/jobs/$(jobId)", args)
...
UpdateMitigationAction(actionName, args::AbstractDict{String, <:Any}) = iot("PATCH", "/mitigationactions/actions/$(actionName)", args)
...
UpdateProvisioningTemplate(templateName, args::AbstractDict{String, <:Any}) = iot("PATCH", "/provisioning-templates/$(templateName)", args)
...
UpdateRoleAlias(roleAlias, args::AbstractDict{String, <:Any}) = iot("PUT", "/role-aliases/$(roleAlias)", args)
...
UpdateScheduledAudit(scheduledAuditName, args::AbstractDict{String, <:Any}) = iot("PATCH", "/audit/scheduledaudits/$(scheduledAuditName)", args)
...
UpdateSecurityProfile(securityProfileName, args::AbstractDict{String, <:Any}) = iot("PATCH", "/security-profiles/$(securityProfileName)", args)
...
UpdateStream(streamId, args::AbstractDict{String, <:Any}) = iot("PUT", "/streams/$(streamId)", args)
...
UpdateThing(thingName, args::AbstractDict{String, <:Any}) = iot("PATCH", "/things/$(thingName)", args)
...
"""
UpdateThingGroup(thingGroupName, thingGroupProperties) = iot("PATCH", "/thing-groups/$(thingGroupName)", Dict{String, Any}("thingGroupProperties"=>thingGroupProperties))
UpdateThingGroup(thingGroupName, thingGroupProperties, args::AbstractDict{String, <:Any}) = iot("PATCH", "/thing-groups/$(thingGroupName)", Dict{String, Any}("thingGroupProperties"=>thingGroupProperties, args...))
...
UpdateThingGroupsForThing(args::AbstractDict{String, Any}) = iot("PUT", "/thing-groups/updateThingGroupsForThing", args)
...
"""
UpdateTopicRuleDestination(arn, status) = iot("PATCH", "/destinations", Dict{String, Any}("arn"=>arn, "status"=>status))
UpdateTopicRuleDestination(arn, status, args::AbstractDict{String, <:Any}) = iot("PATCH", "/destinations", Dict{String, Any}("arn"=>arn, "status"=>status, args...))
...
"""
ValidateSecurityProfileBehaviors(behaviors) = iot("POST", "/security-profile-behaviors/validate", Dict{String, Any}("behaviors"=>behaviors))
ValidateSecurityProfileBehaviors(behaviors, args::AbstractDict{String, <:Any}) = iot("POST", "/security-profile-behaviors/validate", Dict{String, Any}("behaviors"=>behaviors, args...))
