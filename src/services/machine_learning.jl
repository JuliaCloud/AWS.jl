...
"""
create_realtime_endpoint(MLModelId; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
...
"""
delete_data_source(DataSourceId; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
        "DeleteDataSource",
...
"""
delete_evaluation(EvaluationId; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
        "DeleteEvaluation",
...
"""
delete_mlmodel(MLModelId; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
        "DeleteMLModel",
        Dict{String,Any}("MLModelId" => MLModelId);
        aws_config=aws_config,
...
"""
delete_realtime_endpoint(MLModelId; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
...
"""
describe_batch_predictions(; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
...
- `"SortOrder"`: A two-value parameter that determines the sequence of the resulting list
  ...
  the list in descending order (Z-A, 9-0).   Results are sorted by FilterVariable.
"""
describe_data_sources(; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
...
- `"SortOrder"`: A two-value parameter that determines the sequence of the resulting list
  ...
  the list in descending order (Z-A, 9-0).   Results are sorted by FilterVariable.
"""
describe_evaluations(; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
...
"""
describe_mlmodels(; aws_config::AbstractAWSConfig=global_aws_config()) = machine_learning(
...
"""
describe_tags(ResourceId, ResourceType; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
        "DescribeTags",
...
"""
get_batch_prediction(BatchPredictionId; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
        "GetBatchPrediction",
        Dict{String,Any}("BatchPredictionId" => BatchPredictionId);
        aws_config=aws_config,
...
- `"Verbose"`: Specifies whether the GetDataSource operation should return
  ...
  returned.
"""
get_data_source(DataSourceId; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
        "GetDataSource",
        Dict{String,Any}("DataSourceId" => DataSourceId);
        aws_config=aws_config,
...
"""
get_evaluation(EvaluationId; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
        "GetEvaluation",
        Dict{String,Any}("EvaluationId" => EvaluationId);
        aws_config=aws_config,
...
"""
get_mlmodel(MLModelId; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
        "GetMLModel",
        Dict{String,Any}("MLModelId" => MLModelId);
        aws_config=aws_config,
...
update_data_source(
    ...
    "UpdateDataSource",
    Dict{String,Any}("DataSourceId" => DataSourceId, "DataSourceName" => DataSourceName);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
)
...
update_evaluation(
    ...
    "UpdateEvaluation",
    Dict{String,Any}("EvaluationId" => EvaluationId, "EvaluationName" => EvaluationName);
    aws_config=aws_config,
    feature_set=SERVICE_FEATURE_SET,
)
...
"""
update_mlmodel(MLModelId; aws_config::AbstractAWSConfig=global_aws_config()) =
    machine_learning(
        "UpdateMLModel",
        Dict{String,Any}("MLModelId" => MLModelId);
        aws_config=aws_config,
