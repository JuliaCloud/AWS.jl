...
"""
AddTags(ResourceId, ResourceType, Tags; aws::AWSConfig=AWSConfig()) = machine_learning("AddTags", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, "Tags"=>Tags); aws=aws)
AddTags(ResourceId, ResourceType, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("AddTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, "Tags"=>Tags), args)); aws=aws)
...
"""
CreateBatchPrediction(BatchPredictionDataSourceId, BatchPredictionId, MLModelId, OutputUri; aws::AWSConfig=AWSConfig()) = machine_learning("CreateBatchPrediction", Dict{String, Any}("BatchPredictionDataSourceId"=>BatchPredictionDataSourceId, "BatchPredictionId"=>BatchPredictionId, "MLModelId"=>MLModelId, "OutputUri"=>OutputUri); aws=aws)
CreateBatchPrediction(BatchPredictionDataSourceId, BatchPredictionId, MLModelId, OutputUri, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("CreateBatchPrediction", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BatchPredictionDataSourceId"=>BatchPredictionDataSourceId, "BatchPredictionId"=>BatchPredictionId, "MLModelId"=>MLModelId, "OutputUri"=>OutputUri), args)); aws=aws)
...
"""
CreateDataSourceFromRDS(DataSourceId, RDSData, RoleARN; aws::AWSConfig=AWSConfig()) = machine_learning("CreateDataSourceFromRDS", Dict{String, Any}("DataSourceId"=>DataSourceId, "RDSData"=>RDSData, "RoleARN"=>RoleARN); aws=aws)
CreateDataSourceFromRDS(DataSourceId, RDSData, RoleARN, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("CreateDataSourceFromRDS", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DataSourceId"=>DataSourceId, "RDSData"=>RDSData, "RoleARN"=>RoleARN), args)); aws=aws)
...
- `DataSourceName`: A user-supplied name or description of the DataSource. 
"""
CreateDataSourceFromRedshift(DataSourceId, DataSpec, RoleARN; aws::AWSConfig=AWSConfig()) = machine_learning("CreateDataSourceFromRedshift", Dict{String, Any}("DataSourceId"=>DataSourceId, "DataSpec"=>DataSpec, "RoleARN"=>RoleARN); aws=aws)
CreateDataSourceFromRedshift(DataSourceId, DataSpec, RoleARN, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("CreateDataSourceFromRedshift", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DataSourceId"=>DataSourceId, "DataSpec"=>DataSpec, "RoleARN"=>RoleARN), args)); aws=aws)
...
- `DataSourceName`: A user-supplied name or description of the DataSource. 
"""
CreateDataSourceFromS3(DataSourceId, DataSpec; aws::AWSConfig=AWSConfig()) = machine_learning("CreateDataSourceFromS3", Dict{String, Any}("DataSourceId"=>DataSourceId, "DataSpec"=>DataSpec); aws=aws)
CreateDataSourceFromS3(DataSourceId, DataSpec, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("CreateDataSourceFromS3", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DataSourceId"=>DataSourceId, "DataSpec"=>DataSpec), args)); aws=aws)
...
"""
CreateEvaluation(EvaluationDataSourceId, EvaluationId, MLModelId; aws::AWSConfig=AWSConfig()) = machine_learning("CreateEvaluation", Dict{String, Any}("EvaluationDataSourceId"=>EvaluationDataSourceId, "EvaluationId"=>EvaluationId, "MLModelId"=>MLModelId); aws=aws)
CreateEvaluation(EvaluationDataSourceId, EvaluationId, MLModelId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("CreateEvaluation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EvaluationDataSourceId"=>EvaluationDataSourceId, "EvaluationId"=>EvaluationId, "MLModelId"=>MLModelId), args)); aws=aws)
...
"""
CreateMLModel(MLModelId, MLModelType, TrainingDataSourceId; aws::AWSConfig=AWSConfig()) = machine_learning("CreateMLModel", Dict{String, Any}("MLModelId"=>MLModelId, "MLModelType"=>MLModelType, "TrainingDataSourceId"=>TrainingDataSourceId); aws=aws)
CreateMLModel(MLModelId, MLModelType, TrainingDataSourceId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("CreateMLModel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MLModelId"=>MLModelId, "MLModelType"=>MLModelType, "TrainingDataSourceId"=>TrainingDataSourceId), args)); aws=aws)
...
"""
CreateRealtimeEndpoint(MLModelId; aws::AWSConfig=AWSConfig()) = machine_learning("CreateRealtimeEndpoint", Dict{String, Any}("MLModelId"=>MLModelId); aws=aws)
CreateRealtimeEndpoint(MLModelId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("CreateRealtimeEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MLModelId"=>MLModelId), args)); aws=aws)
...
"""
DeleteBatchPrediction(BatchPredictionId; aws::AWSConfig=AWSConfig()) = machine_learning("DeleteBatchPrediction", Dict{String, Any}("BatchPredictionId"=>BatchPredictionId); aws=aws)
DeleteBatchPrediction(BatchPredictionId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("DeleteBatchPrediction", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BatchPredictionId"=>BatchPredictionId), args)); aws=aws)
...
"""
DeleteDataSource(DataSourceId; aws::AWSConfig=AWSConfig()) = machine_learning("DeleteDataSource", Dict{String, Any}("DataSourceId"=>DataSourceId); aws=aws)
DeleteDataSource(DataSourceId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("DeleteDataSource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DataSourceId"=>DataSourceId), args)); aws=aws)
...
"""
DeleteEvaluation(EvaluationId; aws::AWSConfig=AWSConfig()) = machine_learning("DeleteEvaluation", Dict{String, Any}("EvaluationId"=>EvaluationId); aws=aws)
DeleteEvaluation(EvaluationId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("DeleteEvaluation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EvaluationId"=>EvaluationId), args)); aws=aws)
...
"""
DeleteMLModel(MLModelId; aws::AWSConfig=AWSConfig()) = machine_learning("DeleteMLModel", Dict{String, Any}("MLModelId"=>MLModelId); aws=aws)
DeleteMLModel(MLModelId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("DeleteMLModel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MLModelId"=>MLModelId), args)); aws=aws)
...
"""
DeleteRealtimeEndpoint(MLModelId; aws::AWSConfig=AWSConfig()) = machine_learning("DeleteRealtimeEndpoint", Dict{String, Any}("MLModelId"=>MLModelId); aws=aws)
DeleteRealtimeEndpoint(MLModelId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("DeleteRealtimeEndpoint", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MLModelId"=>MLModelId), args)); aws=aws)
...
"""
DeleteTags(ResourceId, ResourceType, TagKeys; aws::AWSConfig=AWSConfig()) = machine_learning("DeleteTags", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, "TagKeys"=>TagKeys); aws=aws)
DeleteTags(ResourceId, ResourceType, TagKeys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("DeleteTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, "TagKeys"=>TagKeys), args)); aws=aws)
...
"""
DescribeBatchPredictions(; aws::AWSConfig=AWSConfig()) = machine_learning("DescribeBatchPredictions"; aws=aws)
DescribeBatchPredictions(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("DescribeBatchPredictions", args; aws=aws)
...
"""
DescribeDataSources(; aws::AWSConfig=AWSConfig()) = machine_learning("DescribeDataSources"; aws=aws)
DescribeDataSources(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("DescribeDataSources", args; aws=aws)
...
"""
DescribeEvaluations(; aws::AWSConfig=AWSConfig()) = machine_learning("DescribeEvaluations"; aws=aws)
DescribeEvaluations(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("DescribeEvaluations", args; aws=aws)
...
"""
DescribeMLModels(; aws::AWSConfig=AWSConfig()) = machine_learning("DescribeMLModels"; aws=aws)
DescribeMLModels(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("DescribeMLModels", args; aws=aws)
...
"""
DescribeTags(ResourceId, ResourceType; aws::AWSConfig=AWSConfig()) = machine_learning("DescribeTags", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType); aws=aws)
DescribeTags(ResourceId, ResourceType, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("DescribeTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType), args)); aws=aws)
...
"""
GetBatchPrediction(BatchPredictionId; aws::AWSConfig=AWSConfig()) = machine_learning("GetBatchPrediction", Dict{String, Any}("BatchPredictionId"=>BatchPredictionId); aws=aws)
GetBatchPrediction(BatchPredictionId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("GetBatchPrediction", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BatchPredictionId"=>BatchPredictionId), args)); aws=aws)
...
"""
GetDataSource(DataSourceId; aws::AWSConfig=AWSConfig()) = machine_learning("GetDataSource", Dict{String, Any}("DataSourceId"=>DataSourceId); aws=aws)
GetDataSource(DataSourceId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("GetDataSource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DataSourceId"=>DataSourceId), args)); aws=aws)
...
"""
GetEvaluation(EvaluationId; aws::AWSConfig=AWSConfig()) = machine_learning("GetEvaluation", Dict{String, Any}("EvaluationId"=>EvaluationId); aws=aws)
GetEvaluation(EvaluationId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("GetEvaluation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EvaluationId"=>EvaluationId), args)); aws=aws)
...
"""
GetMLModel(MLModelId; aws::AWSConfig=AWSConfig()) = machine_learning("GetMLModel", Dict{String, Any}("MLModelId"=>MLModelId); aws=aws)
GetMLModel(MLModelId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("GetMLModel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MLModelId"=>MLModelId), args)); aws=aws)
...
"""
Predict(MLModelId, PredictEndpoint, Record; aws::AWSConfig=AWSConfig()) = machine_learning("Predict", Dict{String, Any}("MLModelId"=>MLModelId, "PredictEndpoint"=>PredictEndpoint, "Record"=>Record); aws=aws)
Predict(MLModelId, PredictEndpoint, Record, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("Predict", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MLModelId"=>MLModelId, "PredictEndpoint"=>PredictEndpoint, "Record"=>Record), args)); aws=aws)
...
"""
UpdateBatchPrediction(BatchPredictionId, BatchPredictionName; aws::AWSConfig=AWSConfig()) = machine_learning("UpdateBatchPrediction", Dict{String, Any}("BatchPredictionId"=>BatchPredictionId, "BatchPredictionName"=>BatchPredictionName); aws=aws)
UpdateBatchPrediction(BatchPredictionId, BatchPredictionName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("UpdateBatchPrediction", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("BatchPredictionId"=>BatchPredictionId, "BatchPredictionName"=>BatchPredictionName), args)); aws=aws)
...
"""
UpdateDataSource(DataSourceId, DataSourceName; aws::AWSConfig=AWSConfig()) = machine_learning("UpdateDataSource", Dict{String, Any}("DataSourceId"=>DataSourceId, "DataSourceName"=>DataSourceName); aws=aws)
UpdateDataSource(DataSourceId, DataSourceName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("UpdateDataSource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DataSourceId"=>DataSourceId, "DataSourceName"=>DataSourceName), args)); aws=aws)
...
"""
UpdateEvaluation(EvaluationId, EvaluationName; aws::AWSConfig=AWSConfig()) = machine_learning("UpdateEvaluation", Dict{String, Any}("EvaluationId"=>EvaluationId, "EvaluationName"=>EvaluationName); aws=aws)
UpdateEvaluation(EvaluationId, EvaluationName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("UpdateEvaluation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EvaluationId"=>EvaluationId, "EvaluationName"=>EvaluationName), args)); aws=aws)
...
"""
UpdateMLModel(MLModelId; aws::AWSConfig=AWSConfig()) = machine_learning("UpdateMLModel", Dict{String, Any}("MLModelId"=>MLModelId); aws=aws)
UpdateMLModel(MLModelId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = machine_learning("UpdateMLModel", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("MLModelId"=>MLModelId), args)); aws=aws)
