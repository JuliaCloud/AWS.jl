...
"""
AddTags(ResourceId, ResourceType, Tags) = machine_learning("AddTags", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, "Tags"=>Tags))
AddTags(ResourceId, ResourceType, Tags, args::AbstractDict{String, <: Any}) = machine_learning("AddTags", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, "Tags"=>Tags, args...))
...
"""
CreateBatchPrediction(BatchPredictionDataSourceId, BatchPredictionId, MLModelId, OutputUri) = machine_learning("CreateBatchPrediction", Dict{String, Any}("BatchPredictionDataSourceId"=>BatchPredictionDataSourceId, "BatchPredictionId"=>BatchPredictionId, "MLModelId"=>MLModelId, "OutputUri"=>OutputUri))
CreateBatchPrediction(BatchPredictionDataSourceId, BatchPredictionId, MLModelId, OutputUri, args::AbstractDict{String, <: Any}) = machine_learning("CreateBatchPrediction", Dict{String, Any}("BatchPredictionDataSourceId"=>BatchPredictionDataSourceId, "BatchPredictionId"=>BatchPredictionId, "MLModelId"=>MLModelId, "OutputUri"=>OutputUri, args...))
...
"""
CreateDataSourceFromRDS(DataSourceId, RDSData, RoleARN) = machine_learning("CreateDataSourceFromRDS", Dict{String, Any}("DataSourceId"=>DataSourceId, "RDSData"=>RDSData, "RoleARN"=>RoleARN))
CreateDataSourceFromRDS(DataSourceId, RDSData, RoleARN, args::AbstractDict{String, <: Any}) = machine_learning("CreateDataSourceFromRDS", Dict{String, Any}("DataSourceId"=>DataSourceId, "RDSData"=>RDSData, "RoleARN"=>RoleARN, args...))
...
DataSourceName => A user-supplied name or description of the DataSource. 
"""
CreateDataSourceFromRedshift(DataSourceId, DataSpec, RoleARN) = machine_learning("CreateDataSourceFromRedshift", Dict{String, Any}("DataSourceId"=>DataSourceId, "DataSpec"=>DataSpec, "RoleARN"=>RoleARN))
CreateDataSourceFromRedshift(DataSourceId, DataSpec, RoleARN, args::AbstractDict{String, <: Any}) = machine_learning("CreateDataSourceFromRedshift", Dict{String, Any}("DataSourceId"=>DataSourceId, "DataSpec"=>DataSpec, "RoleARN"=>RoleARN, args...))
...
DataSourceName => A user-supplied name or description of the DataSource. 
"""
CreateDataSourceFromS3(DataSourceId, DataSpec) = machine_learning("CreateDataSourceFromS3", Dict{String, Any}("DataSourceId"=>DataSourceId, "DataSpec"=>DataSpec))
CreateDataSourceFromS3(DataSourceId, DataSpec, args::AbstractDict{String, <: Any}) = machine_learning("CreateDataSourceFromS3", Dict{String, Any}("DataSourceId"=>DataSourceId, "DataSpec"=>DataSpec, args...))
...
"""
CreateEvaluation(EvaluationDataSourceId, EvaluationId, MLModelId) = machine_learning("CreateEvaluation", Dict{String, Any}("EvaluationDataSourceId"=>EvaluationDataSourceId, "EvaluationId"=>EvaluationId, "MLModelId"=>MLModelId))
CreateEvaluation(EvaluationDataSourceId, EvaluationId, MLModelId, args::AbstractDict{String, <: Any}) = machine_learning("CreateEvaluation", Dict{String, Any}("EvaluationDataSourceId"=>EvaluationDataSourceId, "EvaluationId"=>EvaluationId, "MLModelId"=>MLModelId, args...))
...
"""
CreateMLModel(MLModelId, MLModelType, TrainingDataSourceId) = machine_learning("CreateMLModel", Dict{String, Any}("MLModelId"=>MLModelId, "MLModelType"=>MLModelType, "TrainingDataSourceId"=>TrainingDataSourceId))
CreateMLModel(MLModelId, MLModelType, TrainingDataSourceId, args::AbstractDict{String, <: Any}) = machine_learning("CreateMLModel", Dict{String, Any}("MLModelId"=>MLModelId, "MLModelType"=>MLModelType, "TrainingDataSourceId"=>TrainingDataSourceId, args...))
...
"""
CreateRealtimeEndpoint(MLModelId) = machine_learning("CreateRealtimeEndpoint", Dict{String, Any}("MLModelId"=>MLModelId))
CreateRealtimeEndpoint(MLModelId, args::AbstractDict{String, <: Any}) = machine_learning("CreateRealtimeEndpoint", Dict{String, Any}("MLModelId"=>MLModelId, args...))
...
"""
DeleteBatchPrediction(BatchPredictionId) = machine_learning("DeleteBatchPrediction", Dict{String, Any}("BatchPredictionId"=>BatchPredictionId))
DeleteBatchPrediction(BatchPredictionId, args::AbstractDict{String, <: Any}) = machine_learning("DeleteBatchPrediction", Dict{String, Any}("BatchPredictionId"=>BatchPredictionId, args...))
...
"""
DeleteDataSource(DataSourceId) = machine_learning("DeleteDataSource", Dict{String, Any}("DataSourceId"=>DataSourceId))
DeleteDataSource(DataSourceId, args::AbstractDict{String, <: Any}) = machine_learning("DeleteDataSource", Dict{String, Any}("DataSourceId"=>DataSourceId, args...))
...
"""
DeleteEvaluation(EvaluationId) = machine_learning("DeleteEvaluation", Dict{String, Any}("EvaluationId"=>EvaluationId))
DeleteEvaluation(EvaluationId, args::AbstractDict{String, <: Any}) = machine_learning("DeleteEvaluation", Dict{String, Any}("EvaluationId"=>EvaluationId, args...))
...
"""
DeleteMLModel(MLModelId) = machine_learning("DeleteMLModel", Dict{String, Any}("MLModelId"=>MLModelId))
DeleteMLModel(MLModelId, args::AbstractDict{String, <: Any}) = machine_learning("DeleteMLModel", Dict{String, Any}("MLModelId"=>MLModelId, args...))
...
"""
DeleteRealtimeEndpoint(MLModelId) = machine_learning("DeleteRealtimeEndpoint", Dict{String, Any}("MLModelId"=>MLModelId))
DeleteRealtimeEndpoint(MLModelId, args::AbstractDict{String, <: Any}) = machine_learning("DeleteRealtimeEndpoint", Dict{String, Any}("MLModelId"=>MLModelId, args...))
...
"""
DeleteTags(ResourceId, ResourceType, TagKeys) = machine_learning("DeleteTags", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, "TagKeys"=>TagKeys))
DeleteTags(ResourceId, ResourceType, TagKeys, args::AbstractDict{String, <: Any}) = machine_learning("DeleteTags", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, "TagKeys"=>TagKeys, args...))
...
DescribeBatchPredictions(args::AbstractDict{String, <: Any}) = machine_learning("DescribeBatchPredictions", args)
...
DescribeDataSources(args::AbstractDict{String, <: Any}) = machine_learning("DescribeDataSources", args)
...
DescribeEvaluations(args::AbstractDict{String, <: Any}) = machine_learning("DescribeEvaluations", args)
...
DescribeMLModels(args::AbstractDict{String, <: Any}) = machine_learning("DescribeMLModels", args)
...
"""
DescribeTags(ResourceId, ResourceType) = machine_learning("DescribeTags", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType))
DescribeTags(ResourceId, ResourceType, args::AbstractDict{String, <: Any}) = machine_learning("DescribeTags", Dict{String, Any}("ResourceId"=>ResourceId, "ResourceType"=>ResourceType, args...))
...
"""
GetBatchPrediction(BatchPredictionId) = machine_learning("GetBatchPrediction", Dict{String, Any}("BatchPredictionId"=>BatchPredictionId))
GetBatchPrediction(BatchPredictionId, args::AbstractDict{String, <: Any}) = machine_learning("GetBatchPrediction", Dict{String, Any}("BatchPredictionId"=>BatchPredictionId, args...))
...
"""
GetDataSource(DataSourceId) = machine_learning("GetDataSource", Dict{String, Any}("DataSourceId"=>DataSourceId))
GetDataSource(DataSourceId, args::AbstractDict{String, <: Any}) = machine_learning("GetDataSource", Dict{String, Any}("DataSourceId"=>DataSourceId, args...))
...
"""
GetEvaluation(EvaluationId) = machine_learning("GetEvaluation", Dict{String, Any}("EvaluationId"=>EvaluationId))
GetEvaluation(EvaluationId, args::AbstractDict{String, <: Any}) = machine_learning("GetEvaluation", Dict{String, Any}("EvaluationId"=>EvaluationId, args...))
...
"""
GetMLModel(MLModelId) = machine_learning("GetMLModel", Dict{String, Any}("MLModelId"=>MLModelId))
GetMLModel(MLModelId, args::AbstractDict{String, <: Any}) = machine_learning("GetMLModel", Dict{String, Any}("MLModelId"=>MLModelId, args...))
...
"""
Predict(MLModelId, PredictEndpoint, Record) = machine_learning("Predict", Dict{String, Any}("MLModelId"=>MLModelId, "PredictEndpoint"=>PredictEndpoint, "Record"=>Record))
Predict(MLModelId, PredictEndpoint, Record, args::AbstractDict{String, <: Any}) = machine_learning("Predict", Dict{String, Any}("MLModelId"=>MLModelId, "PredictEndpoint"=>PredictEndpoint, "Record"=>Record, args...))
...
"""
UpdateBatchPrediction(BatchPredictionId, BatchPredictionName) = machine_learning("UpdateBatchPrediction", Dict{String, Any}("BatchPredictionId"=>BatchPredictionId, "BatchPredictionName"=>BatchPredictionName))
UpdateBatchPrediction(BatchPredictionId, BatchPredictionName, args::AbstractDict{String, <: Any}) = machine_learning("UpdateBatchPrediction", Dict{String, Any}("BatchPredictionId"=>BatchPredictionId, "BatchPredictionName"=>BatchPredictionName, args...))
...
"""
UpdateDataSource(DataSourceId, DataSourceName) = machine_learning("UpdateDataSource", Dict{String, Any}("DataSourceId"=>DataSourceId, "DataSourceName"=>DataSourceName))
UpdateDataSource(DataSourceId, DataSourceName, args::AbstractDict{String, <: Any}) = machine_learning("UpdateDataSource", Dict{String, Any}("DataSourceId"=>DataSourceId, "DataSourceName"=>DataSourceName, args...))
...
"""
UpdateEvaluation(EvaluationId, EvaluationName) = machine_learning("UpdateEvaluation", Dict{String, Any}("EvaluationId"=>EvaluationId, "EvaluationName"=>EvaluationName))
UpdateEvaluation(EvaluationId, EvaluationName, args::AbstractDict{String, <: Any}) = machine_learning("UpdateEvaluation", Dict{String, Any}("EvaluationId"=>EvaluationId, "EvaluationName"=>EvaluationName, args...))
...
"""
UpdateMLModel(MLModelId) = machine_learning("UpdateMLModel", Dict{String, Any}("MLModelId"=>MLModelId))
UpdateMLModel(MLModelId, args::AbstractDict{String, <: Any}) = machine_learning("UpdateMLModel", Dict{String, Any}("MLModelId"=>MLModelId, args...))
