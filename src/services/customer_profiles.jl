...
"""
function get_integration(DomainName, Uri; aws_config::AbstractAWSConfig=current_aws_config())
    return customer_profiles(
        "POST",
...
function list_profile_objects(
    DomainName, ObjectTypeName, ProfileId; aws_config::AbstractAWSConfig=current_aws_config()
)
    return customer_profiles(
        "POST",
