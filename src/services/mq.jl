...
"""
CreateBroker() = mq("POST", "/v1/brokers", Dict{String, Any}("creatorRequestId"=>string(uuid4())))
CreateBroker(args::AbstractDict{String, <:Any}) = mq("POST", "/v1/brokers", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("creatorRequestId"=>string(uuid4())), args...)))
