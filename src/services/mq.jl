...
"""
function delete_user(broker_id, username; aws_config::AbstractAWSConfig=current_aws_config())
    return mq(
        "DELETE",
        "/v1/brokers/$(broker-id)/users/$(username)";
        aws_config=aws_config,
...
"""
function update_user(broker_id, username; aws_config::AbstractAWSConfig=current_aws_config())
    return mq(
        "PUT",
        "/v1/brokers/$(broker-id)/users/$(username)";
        aws_config=aws_config,
