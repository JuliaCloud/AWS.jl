...
CopyObject(Bucket, Key, x_amz_copy_source, args::AbstractDict{String, <: Any}) = s3("PUT", "/$(Bucket)/$(Key)", Dict{String, Any}(mergewith(merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-copy-source"=>x_amz_copy_source)), args...)))
...
UploadPartCopy(Bucket, Key, partNumber, uploadId, x_amz_copy_source, args::AbstractDict{String, <: Any}) = s3("PUT", "/$(Bucket)/$(Key)", Dict{String, Any}(mergewith(merge, Dict{String, Any}("partNumber"=>partNumber, "uploadId"=>uploadId, "headers"=>Dict{String, Any}("x-amz-copy-source"=>x_amz_copy_source)), args...)))
