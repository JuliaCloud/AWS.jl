...
"""
delete_bucket_intelligent_tiering_configuration(Bucket, id; aws_config::AWSConfig=global_aws_config()) = s3("DELETE", "/$(Bucket)?intelligent-tiering", Dict{String, Any}("id"=>id); aws_config=aws_config)
delete_bucket_intelligent_tiering_configuration(Bucket, id, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = s3("DELETE", "/$(Bucket)?intelligent-tiering", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("id"=>id), args)); aws_config=aws_config)
...
- `x-amz-expected-bucket-owner`: The account id of the expected bucket owner. If the bucket is owned by a different account, the request will fail with an HTTP 403 (Access Denied) error.
"""
delete_bucket_ownership_controls(Bucket; aws_config::AWSConfig=global_aws_config()) = s3("DELETE", "/$(Bucket)?ownershipControls"; aws_config=aws_config)
delete_bucket_ownership_controls(Bucket, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = s3("DELETE", "/$(Bucket)?ownershipControls", args; aws_config=aws_config)
...
"""
get_bucket_intelligent_tiering_configuration(Bucket, id; aws_config::AWSConfig=global_aws_config()) = s3("GET", "/$(Bucket)?intelligent-tiering", Dict{String, Any}("id"=>id); aws_config=aws_config)
get_bucket_intelligent_tiering_configuration(Bucket, id, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = s3("GET", "/$(Bucket)?intelligent-tiering", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("id"=>id), args)); aws_config=aws_config)
...
- `x-amz-expected-bucket-owner`: The account id of the expected bucket owner. If the bucket is owned by a different account, the request will fail with an HTTP 403 (Access Denied) error.
"""
get_bucket_ownership_controls(Bucket; aws_config::AWSConfig=global_aws_config()) = s3("GET", "/$(Bucket)?ownershipControls"; aws_config=aws_config)
get_bucket_ownership_controls(Bucket, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = s3("GET", "/$(Bucket)?ownershipControls", args; aws_config=aws_config)
...
- `continuation-token`: The ContinuationToken that represents a placeholder from where this request should begin.
"""
list_bucket_intelligent_tiering_configurations(Bucket; aws_config::AWSConfig=global_aws_config()) = s3("GET", "/$(Bucket)?intelligent-tiering"; aws_config=aws_config)
list_bucket_intelligent_tiering_configurations(Bucket, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = s3("GET", "/$(Bucket)?intelligent-tiering", args; aws_config=aws_config)
...
"""
put_bucket_intelligent_tiering_configuration(Bucket, IntelligentTieringConfiguration, id; aws_config::AWSConfig=global_aws_config()) = s3("PUT", "/$(Bucket)?intelligent-tiering", Dict{String, Any}("IntelligentTieringConfiguration"=>IntelligentTieringConfiguration, "id"=>id); aws_config=aws_config)
...
- `x-amz-expected-bucket-owner`: The account id of the expected bucket owner. If the bucket is owned by a different account, the request will fail with an HTTP 403 (Access Denied) error.
"""
put_bucket_ownership_controls(Bucket, OwnershipControls; aws_config::AWSConfig=global_aws_config()) = s3("PUT", "/$(Bucket)?ownershipControls", Dict{String, Any}("OwnershipControls"=>OwnershipControls); aws_config=aws_config)
put_bucket_ownership_controls(Bucket, OwnershipControls, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = s3("PUT", "/$(Bucket)?ownershipControls", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("OwnershipControls"=>OwnershipControls), args)); aws_config=aws_config)
