...
- `x-amz-request-payer`: 
"""
AbortMultipartUpload(Bucket, Key, uploadId) = s3("DELETE", "/$(Bucket)/$(Key)", Dict{String, Any}("uploadId"=>uploadId))
AbortMultipartUpload(Bucket, Key, uploadId, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)/$(Key)", Dict{String, Any}("uploadId"=>uploadId, args...))
...
- `x-amz-request-payer`: 
"""
CompleteMultipartUpload(Bucket, Key, uploadId) = s3("POST", "/$(Bucket)/$(Key)", Dict{String, Any}("uploadId"=>uploadId))
CompleteMultipartUpload(Bucket, Key, uploadId, args::AbstractDict{String, <:Any}) = s3("POST", "/$(Bucket)/$(Key)", Dict{String, Any}("uploadId"=>uploadId, args...))
...
"""
CopyObject(Bucket, Key, x_amz_copy_source) = s3("PUT", "/$(Bucket)/$(Key)", Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-copy-source"=>x_amz_copy_source)))
CopyObject(Bucket, Key, x_amz_copy_source, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)/$(Key)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("headers"=>Dict{String, Any}("x-amz-copy-source"=>x_amz_copy_source)), args...)))
...
CreateBucket(Bucket, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)", args)
...
CreateMultipartUpload(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("POST", "/$(Bucket)/$(Key)?uploads", args)
...
DeleteBucket(Bucket, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)", args)
...
"""
DeleteBucketAnalyticsConfiguration(Bucket, id) = s3("DELETE", "/$(Bucket)?analytics", Dict{String, Any}("id"=>id))
DeleteBucketAnalyticsConfiguration(Bucket, id, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)?analytics", Dict{String, Any}("id"=>id, args...))
...
DeleteBucketCors(Bucket, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)?cors", args)
...
DeleteBucketEncryption(Bucket, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)?encryption", args)
...
"""
DeleteBucketInventoryConfiguration(Bucket, id) = s3("DELETE", "/$(Bucket)?inventory", Dict{String, Any}("id"=>id))
DeleteBucketInventoryConfiguration(Bucket, id, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)?inventory", Dict{String, Any}("id"=>id, args...))
...
DeleteBucketLifecycle(Bucket, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)?lifecycle", args)
...
"""
DeleteBucketMetricsConfiguration(Bucket, id) = s3("DELETE", "/$(Bucket)?metrics", Dict{String, Any}("id"=>id))
DeleteBucketMetricsConfiguration(Bucket, id, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)?metrics", Dict{String, Any}("id"=>id, args...))
...
DeleteBucketPolicy(Bucket, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)?policy", args)
...
DeleteBucketReplication(Bucket, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)?replication", args)
...
DeleteBucketTagging(Bucket, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)?tagging", args)
...
DeleteBucketWebsite(Bucket, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)?website", args)
...
DeleteObject(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)/$(Key)", args)
...
DeleteObjectTagging(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)/$(Key)?tagging", args)
...
- `x-amz-request-payer`: 
"""
DeleteObjects(Bucket, Delete) = s3("POST", "/$(Bucket)?delete", Dict{String, Any}("Delete"=>Delete))
DeleteObjects(Bucket, Delete, args::AbstractDict{String, <:Any}) = s3("POST", "/$(Bucket)?delete", Dict{String, Any}("Delete"=>Delete, args...))
...
DeletePublicAccessBlock(Bucket, args::AbstractDict{String, <:Any}) = s3("DELETE", "/$(Bucket)?publicAccessBlock", args)
...
GetBucketAccelerateConfiguration(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?accelerate", args)
...
GetBucketAcl(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?acl", args)
...
"""
GetBucketAnalyticsConfiguration(Bucket, id) = s3("GET", "/$(Bucket)?analytics", Dict{String, Any}("id"=>id))
GetBucketAnalyticsConfiguration(Bucket, id, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?analytics", Dict{String, Any}("id"=>id, args...))
...
GetBucketCors(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?cors", args)
...
GetBucketEncryption(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?encryption", args)
...
"""
GetBucketInventoryConfiguration(Bucket, id) = s3("GET", "/$(Bucket)?inventory", Dict{String, Any}("id"=>id))
GetBucketInventoryConfiguration(Bucket, id, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?inventory", Dict{String, Any}("id"=>id, args...))
...
GetBucketLifecycle(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?lifecycle", args)
...
GetBucketLifecycleConfiguration(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?lifecycle", args)
...
GetBucketLocation(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?location", args)
...
GetBucketLogging(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?logging", args)
...
"""
GetBucketMetricsConfiguration(Bucket, id) = s3("GET", "/$(Bucket)?metrics", Dict{String, Any}("id"=>id))
GetBucketMetricsConfiguration(Bucket, id, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?metrics", Dict{String, Any}("id"=>id, args...))
...
GetBucketNotification(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?notification", args)
...
GetBucketNotificationConfiguration(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?notification", args)
...
GetBucketPolicy(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?policy", args)
...
GetBucketPolicyStatus(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?policyStatus", args)
...
GetBucketReplication(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?replication", args)
...
GetBucketRequestPayment(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?requestPayment", args)
...
GetBucketTagging(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?tagging", args)
...
GetBucketVersioning(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?versioning", args)
...
GetBucketWebsite(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?website", args)
...
GetObject(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)/$(Key)", args)
...
GetObjectAcl(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)/$(Key)?acl", args)
...
GetObjectLegalHold(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)/$(Key)?legal-hold", args)
...
GetObjectLockConfiguration(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?object-lock", args)
...
GetObjectRetention(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)/$(Key)?retention", args)
...
GetObjectTagging(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)/$(Key)?tagging", args)
...
GetObjectTorrent(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)/$(Key)?torrent", args)
...
GetPublicAccessBlock(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?publicAccessBlock", args)
...
HeadBucket(Bucket, args::AbstractDict{String, <:Any}) = s3("HEAD", "/$(Bucket)", args)
...
HeadObject(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("HEAD", "/$(Bucket)/$(Key)", args)
...
ListBucketAnalyticsConfigurations(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?analytics", args)
...
ListBucketInventoryConfigurations(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?inventory", args)
...
ListBucketMetricsConfigurations(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?metrics", args)
...
"""
ListBuckets() = s3("GET", "/")
ListBuckets(args::AbstractDict{String, Any}) = s3("GET", "/", args)
...
ListMultipartUploads(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?uploads", args)
...
ListObjectVersions(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?versions", args)
...
ListObjects(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)", args)
...
ListObjectsV2(Bucket, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)?list-type=2", args)
...
- `x-amz-request-payer`: 
"""
ListParts(Bucket, Key, uploadId) = s3("GET", "/$(Bucket)/$(Key)", Dict{String, Any}("uploadId"=>uploadId))
ListParts(Bucket, Key, uploadId, args::AbstractDict{String, <:Any}) = s3("GET", "/$(Bucket)/$(Key)", Dict{String, Any}("uploadId"=>uploadId, args...))
...
"""
PutBucketAccelerateConfiguration(AccelerateConfiguration, Bucket) = s3("PUT", "/$(Bucket)?accelerate", Dict{String, Any}("AccelerateConfiguration"=>AccelerateConfiguration))
PutBucketAccelerateConfiguration(AccelerateConfiguration, Bucket, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?accelerate", Dict{String, Any}("AccelerateConfiguration"=>AccelerateConfiguration, args...))
...
PutBucketAcl(Bucket, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?acl", args)
...
"""
PutBucketAnalyticsConfiguration(AnalyticsConfiguration, Bucket, id) = s3("PUT", "/$(Bucket)?analytics", Dict{String, Any}("AnalyticsConfiguration"=>AnalyticsConfiguration, "id"=>id))
PutBucketAnalyticsConfiguration(AnalyticsConfiguration, Bucket, id, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?analytics", Dict{String, Any}("AnalyticsConfiguration"=>AnalyticsConfiguration, "id"=>id, args...))
...
- `Content-MD5`: The base64-encoded 128-bit MD5 digest of the data. This header must be used as a message integrity check to verify that the request body was not corrupted in transit. For more information, go to RFC 1864. 
"""
PutBucketCors(Bucket, CORSConfiguration) = s3("PUT", "/$(Bucket)?cors", Dict{String, Any}("CORSConfiguration"=>CORSConfiguration))
PutBucketCors(Bucket, CORSConfiguration, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?cors", Dict{String, Any}("CORSConfiguration"=>CORSConfiguration, args...))
...
"""
PutBucketEncryption(Bucket, ServerSideEncryptionConfiguration) = s3("PUT", "/$(Bucket)?encryption", Dict{String, Any}("ServerSideEncryptionConfiguration"=>ServerSideEncryptionConfiguration))
PutBucketEncryption(Bucket, ServerSideEncryptionConfiguration, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?encryption", Dict{String, Any}("ServerSideEncryptionConfiguration"=>ServerSideEncryptionConfiguration, args...))
...
"""
PutBucketInventoryConfiguration(Bucket, InventoryConfiguration, id) = s3("PUT", "/$(Bucket)?inventory", Dict{String, Any}("InventoryConfiguration"=>InventoryConfiguration, "id"=>id))
PutBucketInventoryConfiguration(Bucket, InventoryConfiguration, id, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?inventory", Dict{String, Any}("InventoryConfiguration"=>InventoryConfiguration, "id"=>id, args...))
...
PutBucketLifecycle(Bucket, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?lifecycle", args)
...
PutBucketLifecycleConfiguration(Bucket, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?lifecycle", args)
...
"""
PutBucketLogging(Bucket, BucketLoggingStatus) = s3("PUT", "/$(Bucket)?logging", Dict{String, Any}("BucketLoggingStatus"=>BucketLoggingStatus))
PutBucketLogging(Bucket, BucketLoggingStatus, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?logging", Dict{String, Any}("BucketLoggingStatus"=>BucketLoggingStatus, args...))
...
"""
PutBucketMetricsConfiguration(Bucket, MetricsConfiguration, id) = s3("PUT", "/$(Bucket)?metrics", Dict{String, Any}("MetricsConfiguration"=>MetricsConfiguration, "id"=>id))
PutBucketMetricsConfiguration(Bucket, MetricsConfiguration, id, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?metrics", Dict{String, Any}("MetricsConfiguration"=>MetricsConfiguration, "id"=>id, args...))
...
"""
PutBucketNotification(Bucket, NotificationConfiguration) = s3("PUT", "/$(Bucket)?notification", Dict{String, Any}("NotificationConfiguration"=>NotificationConfiguration))
PutBucketNotification(Bucket, NotificationConfiguration, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?notification", Dict{String, Any}("NotificationConfiguration"=>NotificationConfiguration, args...))
...
"""
PutBucketNotificationConfiguration(Bucket, NotificationConfiguration) = s3("PUT", "/$(Bucket)?notification", Dict{String, Any}("NotificationConfiguration"=>NotificationConfiguration))
PutBucketNotificationConfiguration(Bucket, NotificationConfiguration, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?notification", Dict{String, Any}("NotificationConfiguration"=>NotificationConfiguration, args...))
...
"""
PutBucketPolicy(Bucket, Policy) = s3("PUT", "/$(Bucket)?policy", Dict{String, Any}("Policy"=>Policy))
PutBucketPolicy(Bucket, Policy, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?policy", Dict{String, Any}("Policy"=>Policy, args...))
...
"""
PutBucketReplication(Bucket, ReplicationConfiguration) = s3("PUT", "/$(Bucket)?replication", Dict{String, Any}("ReplicationConfiguration"=>ReplicationConfiguration))
PutBucketReplication(Bucket, ReplicationConfiguration, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?replication", Dict{String, Any}("ReplicationConfiguration"=>ReplicationConfiguration, args...))
...
- `Content-MD5`: &gt;The base64-encoded 128-bit MD5 digest of the data. You must use this header as a message integrity check to verify that the request body was not corrupted in transit. For more information, see RFC 1864.
"""
PutBucketRequestPayment(Bucket, RequestPaymentConfiguration) = s3("PUT", "/$(Bucket)?requestPayment", Dict{String, Any}("RequestPaymentConfiguration"=>RequestPaymentConfiguration))
PutBucketRequestPayment(Bucket, RequestPaymentConfiguration, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?requestPayment", Dict{String, Any}("RequestPaymentConfiguration"=>RequestPaymentConfiguration, args...))
...
- `Content-MD5`: The base64-encoded 128-bit MD5 digest of the data. You must use this header as a message integrity check to verify that the request body was not corrupted in transit. For more information, see RFC 1864.
"""
PutBucketTagging(Bucket, Tagging) = s3("PUT", "/$(Bucket)?tagging", Dict{String, Any}("Tagging"=>Tagging))
PutBucketTagging(Bucket, Tagging, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?tagging", Dict{String, Any}("Tagging"=>Tagging, args...))
...
"""
PutBucketVersioning(Bucket, VersioningConfiguration) = s3("PUT", "/$(Bucket)?versioning", Dict{String, Any}("VersioningConfiguration"=>VersioningConfiguration))
PutBucketVersioning(Bucket, VersioningConfiguration, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?versioning", Dict{String, Any}("VersioningConfiguration"=>VersioningConfiguration, args...))
...
- `Content-MD5`: The base64-encoded 128-bit MD5 digest of the data. You must use this header as a message integrity check to verify that the request body was not corrupted in transit. For more information, see RFC 1864.
"""
PutBucketWebsite(Bucket, WebsiteConfiguration) = s3("PUT", "/$(Bucket)?website", Dict{String, Any}("WebsiteConfiguration"=>WebsiteConfiguration))
PutBucketWebsite(Bucket, WebsiteConfiguration, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?website", Dict{String, Any}("WebsiteConfiguration"=>WebsiteConfiguration, args...))
...
PutObject(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)/$(Key)", args)
...
PutObjectAcl(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)/$(Key)?acl", args)
...
PutObjectLegalHold(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)/$(Key)?legal-hold", args)
...
PutObjectLockConfiguration(Bucket, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?object-lock", args)
...
PutObjectRetention(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)/$(Key)?retention", args)
...
"""
PutObjectTagging(Bucket, Key, Tagging) = s3("PUT", "/$(Bucket)/$(Key)?tagging", Dict{String, Any}("Tagging"=>Tagging))
PutObjectTagging(Bucket, Key, Tagging, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)/$(Key)?tagging", Dict{String, Any}("Tagging"=>Tagging, args...))
...
- `Content-MD5`: The MD5 hash of the PutPublicAccessBlock request body. 
"""
PutPublicAccessBlock(Bucket, PublicAccessBlockConfiguration) = s3("PUT", "/$(Bucket)?publicAccessBlock", Dict{String, Any}("PublicAccessBlockConfiguration"=>PublicAccessBlockConfiguration))
PutPublicAccessBlock(Bucket, PublicAccessBlockConfiguration, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)?publicAccessBlock", Dict{String, Any}("PublicAccessBlockConfiguration"=>PublicAccessBlockConfiguration, args...))
...
RestoreObject(Bucket, Key, args::AbstractDict{String, <:Any}) = s3("POST", "/$(Bucket)/$(Key)?restore", args)
...
"""
SelectObjectContent(Bucket, Expression, ExpressionType, InputSerialization, Key, OutputSerialization) = s3("POST", "/$(Bucket)/$(Key)?select&select-type=2", Dict{String, Any}("Expression"=>Expression, "ExpressionType"=>ExpressionType, "InputSerialization"=>InputSerialization, "OutputSerialization"=>OutputSerialization))
SelectObjectContent(Bucket, Expression, ExpressionType, InputSerialization, Key, OutputSerialization, args::AbstractDict{String, <:Any}) = s3("POST", "/$(Bucket)/$(Key)?select&select-type=2", Dict{String, Any}("Expression"=>Expression, "ExpressionType"=>ExpressionType, "InputSerialization"=>InputSerialization, "OutputSerialization"=>OutputSerialization, args...))
...
- `x-amz-server-side-encryption-customer-key-MD5`: Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. Amazon S3 uses this header for a message integrity check to ensure that the encryption key was transmitted without error.
"""
UploadPart(Bucket, Key, partNumber, uploadId) = s3("PUT", "/$(Bucket)/$(Key)", Dict{String, Any}("partNumber"=>partNumber, "uploadId"=>uploadId))
UploadPart(Bucket, Key, partNumber, uploadId, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)/$(Key)", Dict{String, Any}("partNumber"=>partNumber, "uploadId"=>uploadId, args...))
...
- `x-amz-server-side-encryption-customer-key-MD5`: Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. Amazon S3 uses this header for a message integrity check to ensure that the encryption key was transmitted without error.
"""
UploadPartCopy(Bucket, Key, partNumber, uploadId, x_amz_copy_source) = s3("PUT", "/$(Bucket)/$(Key)", Dict{String, Any}("partNumber"=>partNumber, "uploadId"=>uploadId, "headers"=>Dict{String, Any}("x-amz-copy-source"=>x_amz_copy_source)))
UploadPartCopy(Bucket, Key, partNumber, uploadId, x_amz_copy_source, args::AbstractDict{String, <:Any}) = s3("PUT", "/$(Bucket)/$(Key)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("partNumber"=>partNumber, "uploadId"=>uploadId, "headers"=>Dict{String, Any}("x-amz-copy-source"=>x_amz_copy_source)), args...)))
