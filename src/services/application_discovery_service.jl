...
"""
AssociateConfigurationItemsToApplication(applicationConfigurationId, configurationIds) = application_discovery_service("AssociateConfigurationItemsToApplication", Dict{String, Any}("applicationConfigurationId"=>applicationConfigurationId, "configurationIds"=>configurationIds))
AssociateConfigurationItemsToApplication(applicationConfigurationId, configurationIds, args::AbstractDict{String, <:Any}) = application_discovery_service("AssociateConfigurationItemsToApplication", Dict{String, Any}("applicationConfigurationId"=>applicationConfigurationId, "configurationIds"=>configurationIds, args...))
...
"""
BatchDeleteImportData(importTaskIds) = application_discovery_service("BatchDeleteImportData", Dict{String, Any}("importTaskIds"=>importTaskIds))
BatchDeleteImportData(importTaskIds, args::AbstractDict{String, <:Any}) = application_discovery_service("BatchDeleteImportData", Dict{String, Any}("importTaskIds"=>importTaskIds, args...))
...
"""
CreateApplication(name) = application_discovery_service("CreateApplication", Dict{String, Any}("name"=>name))
CreateApplication(name, args::AbstractDict{String, <:Any}) = application_discovery_service("CreateApplication", Dict{String, Any}("name"=>name, args...))
...
"""
CreateTags(configurationIds, tags) = application_discovery_service("CreateTags", Dict{String, Any}("configurationIds"=>configurationIds, "tags"=>tags))
CreateTags(configurationIds, tags, args::AbstractDict{String, <:Any}) = application_discovery_service("CreateTags", Dict{String, Any}("configurationIds"=>configurationIds, "tags"=>tags, args...))
...
"""
DeleteApplications(configurationIds) = application_discovery_service("DeleteApplications", Dict{String, Any}("configurationIds"=>configurationIds))
DeleteApplications(configurationIds, args::AbstractDict{String, <:Any}) = application_discovery_service("DeleteApplications", Dict{String, Any}("configurationIds"=>configurationIds, args...))
...
"""
DeleteTags(configurationIds) = application_discovery_service("DeleteTags", Dict{String, Any}("configurationIds"=>configurationIds))
DeleteTags(configurationIds, args::AbstractDict{String, <:Any}) = application_discovery_service("DeleteTags", Dict{String, Any}("configurationIds"=>configurationIds, args...))
...
DescribeAgents(args::AbstractDict{String, <:Any}) = application_discovery_service("DescribeAgents", args)
...
"""
DescribeConfigurations(configurationIds) = application_discovery_service("DescribeConfigurations", Dict{String, Any}("configurationIds"=>configurationIds))
DescribeConfigurations(configurationIds, args::AbstractDict{String, <:Any}) = application_discovery_service("DescribeConfigurations", Dict{String, Any}("configurationIds"=>configurationIds, args...))
...
DescribeContinuousExports(args::AbstractDict{String, <:Any}) = application_discovery_service("DescribeContinuousExports", args)
...
DescribeExportConfigurations(args::AbstractDict{String, <:Any}) = application_discovery_service("DescribeExportConfigurations", args)
...
DescribeExportTasks(args::AbstractDict{String, <:Any}) = application_discovery_service("DescribeExportTasks", args)
...
DescribeImportTasks(args::AbstractDict{String, <:Any}) = application_discovery_service("DescribeImportTasks", args)
...
DescribeTags(args::AbstractDict{String, <:Any}) = application_discovery_service("DescribeTags", args)
...
"""
DisassociateConfigurationItemsFromApplication(applicationConfigurationId, configurationIds) = application_discovery_service("DisassociateConfigurationItemsFromApplication", Dict{String, Any}("applicationConfigurationId"=>applicationConfigurationId, "configurationIds"=>configurationIds))
DisassociateConfigurationItemsFromApplication(applicationConfigurationId, configurationIds, args::AbstractDict{String, <:Any}) = application_discovery_service("DisassociateConfigurationItemsFromApplication", Dict{String, Any}("applicationConfigurationId"=>applicationConfigurationId, "configurationIds"=>configurationIds, args...))
...
ExportConfigurations(args::AbstractDict{String, <:Any}) = application_discovery_service("ExportConfigurations", args)
...
GetDiscoverySummary(args::AbstractDict{String, <:Any}) = application_discovery_service("GetDiscoverySummary", args)
...
"""
ListConfigurations(configurationType) = application_discovery_service("ListConfigurations", Dict{String, Any}("configurationType"=>configurationType))
ListConfigurations(configurationType, args::AbstractDict{String, <:Any}) = application_discovery_service("ListConfigurations", Dict{String, Any}("configurationType"=>configurationType, args...))
...
"""
ListServerNeighbors(configurationId) = application_discovery_service("ListServerNeighbors", Dict{String, Any}("configurationId"=>configurationId))
ListServerNeighbors(configurationId, args::AbstractDict{String, <:Any}) = application_discovery_service("ListServerNeighbors", Dict{String, Any}("configurationId"=>configurationId, args...))
...
StartContinuousExport(args::AbstractDict{String, <:Any}) = application_discovery_service("StartContinuousExport", args)
...
"""
StartDataCollectionByAgentIds(agentIds) = application_discovery_service("StartDataCollectionByAgentIds", Dict{String, Any}("agentIds"=>agentIds))
StartDataCollectionByAgentIds(agentIds, args::AbstractDict{String, <:Any}) = application_discovery_service("StartDataCollectionByAgentIds", Dict{String, Any}("agentIds"=>agentIds, args...))
...
StartExportTask(args::AbstractDict{String, <:Any}) = application_discovery_service("StartExportTask", args)
...
"""
StartImportTask(importUrl, name) = application_discovery_service("StartImportTask", Dict{String, Any}("importUrl"=>importUrl, "name"=>name, "clientRequestToken"=>string(uuid4())))
StartImportTask(importUrl, name, args::AbstractDict{String, <:Any}) = application_discovery_service("StartImportTask", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("importUrl"=>importUrl, "name"=>name, "clientRequestToken"=>string(uuid4())), args)))
...
"""
StopContinuousExport(exportId) = application_discovery_service("StopContinuousExport", Dict{String, Any}("exportId"=>exportId))
StopContinuousExport(exportId, args::AbstractDict{String, <:Any}) = application_discovery_service("StopContinuousExport", Dict{String, Any}("exportId"=>exportId, args...))
...
"""
StopDataCollectionByAgentIds(agentIds) = application_discovery_service("StopDataCollectionByAgentIds", Dict{String, Any}("agentIds"=>agentIds))
StopDataCollectionByAgentIds(agentIds, args::AbstractDict{String, <:Any}) = application_discovery_service("StopDataCollectionByAgentIds", Dict{String, Any}("agentIds"=>agentIds, args...))
...
"""
UpdateApplication(configurationId) = application_discovery_service("UpdateApplication", Dict{String, Any}("configurationId"=>configurationId))
UpdateApplication(configurationId, args::AbstractDict{String, <:Any}) = application_discovery_service("UpdateApplication", Dict{String, Any}("configurationId"=>configurationId, args...))
