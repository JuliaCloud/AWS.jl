...
"""
batch_delete_agents(deleteAgents; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("BatchDeleteAgents", Dict{String, Any}("deleteAgents"=>deleteAgents); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_delete_agents(deleteAgents, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("BatchDeleteAgents", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("deleteAgents"=>deleteAgents), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
the information for the already-existing discovered server is updated. When you delete an
...
"""
batch_delete_import_data(importTaskIds; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("BatchDeleteImportData", Dict{String, Any}("importTaskIds"=>importTaskIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
batch_delete_import_data(importTaskIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("BatchDeleteImportData", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("importTaskIds"=>importTaskIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_application(name; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("CreateApplication", Dict{String, Any}("name"=>name); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_application(name, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("CreateApplication", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("name"=>name), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_tags(configurationIds, tags; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("CreateTags", Dict{String, Any}("configurationIds"=>configurationIds, "tags"=>tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_tags(configurationIds, tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("CreateTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("configurationIds"=>configurationIds, "tags"=>tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_applications(configurationIds; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DeleteApplications", Dict{String, Any}("configurationIds"=>configurationIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_applications(configurationIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DeleteApplications", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("configurationIds"=>configurationIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"tags"`: Tags that you want to delete from one or more configuration items. Specify the
 ...
 `{"key": "serverType", "value": "webServer"}`
"""
delete_tags(configurationIds; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DeleteTags", Dict{String, Any}("configurationIds"=>configurationIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_tags(configurationIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DeleteTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("configurationIds"=>configurationIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_agents(; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeAgents"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_agents(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeAgents", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_batch_delete_configuration_task(taskId; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeBatchDeleteConfigurationTask", Dict{String, Any}("taskId"=>taskId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_batch_delete_configuration_task(taskId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeBatchDeleteConfigurationTask", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("taskId"=>taskId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)

"""
    describe_configurations(configuration_ids)
    describe_configurations(configuration_ids, params::Dict{String,<:Any})

Retrieves attributes for a list of configuration item IDs.</p>
...
name, operating system, number of network cards, etc.
 ...
 <p>For a complete list of outputs for each asset type, see [Using the DescribeConfigurations Action](https://docs.aws.amazon.com/application-discovery/latest/userguide/discovery-api-queries.html#DescribeConfigurations)
...
"""
describe_configurations(configurationIds; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeConfigurations", Dict{String, Any}("configurationIds"=>configurationIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_configurations(configurationIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeConfigurations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("configurationIds"=>configurationIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_continuous_exports(; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeContinuousExports"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_continuous_exports(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeContinuousExports", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_export_configurations(; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeExportConfigurations"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_export_configurations(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeExportConfigurations", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"nextToken"`: The `nextToken` value returned from a previous paginated
  ...
  return.
"""
describe_export_tasks(; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeExportTasks"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_export_tasks(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeExportTasks", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_import_tasks(; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeImportTasks"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_import_tasks(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeImportTasks", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
There are three valid tag filter names: - tagKey
 - tagValue
 - configurationId
...
"""
describe_tags(; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeTags"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_tags(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("DescribeTags", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
export_configurations(; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("ExportConfigurations"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
export_configurations(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("ExportConfigurations", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_discovery_summary(; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("GetDiscoverySummary"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_discovery_summary(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("GetDiscoverySummary", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"orderBy"`: Certain filter criteria return output that can be sorted in ascending or
  ...
  in the *Amazon Web Services Application Discovery Service User Guide*.
"""
list_configurations(configurationType; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("ListConfigurations", Dict{String, Any}("configurationType"=>configurationType); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_configurations(configurationType, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("ListConfigurations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("configurationType"=>configurationType), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"nextToken"`: Token to retrieve the next set of results. For example, if you previously
  specified 100 IDs for `ListServerNeighborsRequest$neighborConfigurationIds` but set
...
"""
list_server_neighbors(configurationId; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("ListServerNeighbors", Dict{String, Any}("configurationId"=>configurationId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_server_neighbors(configurationId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("ListServerNeighbors", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("configurationId"=>configurationId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
start_continuous_export(; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("StartContinuousExport"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_continuous_export(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("StartContinuousExport", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
start_data_collection_by_agent_ids(agentIds; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("StartDataCollectionByAgentIds", Dict{String, Any}("agentIds"=>agentIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_data_collection_by_agent_ids(agentIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("StartDataCollectionByAgentIds", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("agentIds"=>agentIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
savings depend on a variety of factors, including your actual usage of Amazon Web Services
services, which might vary from the estimates provided in this report.If you do not specify
`preferences` or `agentIds` in the filter, a summary of all servers, applications, tags,
and performance is generated. This data is an aggregation of all server data collected
...
exports. Export of detailed agent data is limited to two exports per day.
 ...
 <p>If you enable `ec2RecommendationsPreferences` in `preferences` , an Amazon EC2 instance
...
"""
start_export_task(; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("StartExportTask"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_export_task(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("StartExportTask", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
To start an import request, do this: 1. Download the specially formatted comma separated
value (CSV) import template, which you can find here: [https://s3.us-west-2.amazonaws.com/templates-7cffcf56-bd96-4b1c-b45b-a5b42f282e46/import_template.csv](https://s3.us-west-2.amazonaws.com/templates-7cffcf56-bd96-4b1c-b45b-a5b42f282e46/import_template.csv).
 2. Fill out the template with your server and application data.
 3. Upload your import file to an Amazon S3 bucket, and make a note of it's Object URL.
Your import file must be in the CSV format.
 4. Use the console or the `StartImportTask` command with the Amazon Web Services CLI or
one of the Amazon Web Services SDKs to import the records from your file.
...
Web Services account. For more information, see [Amazon Web Services Application Discovery Service Limits](https://docs.aws.amazon.com/application-discovery/latest/userguide/ads_service_limits.html)
in the *Amazon Web Services Application Discovery Service User Guide*.

# Arguments

- `import_url`: The URL for your import file that you've uploaded to Amazon S3.
...
"""
start_import_task(importUrl, name; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("StartImportTask", Dict{String, Any}("importUrl"=>importUrl, "name"=>name, "clientRequestToken"=>string(uuid4())); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
start_import_task(importUrl, name, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("StartImportTask", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("importUrl"=>importUrl, "name"=>name, "clientRequestToken"=>string(uuid4())), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
stop_continuous_export(exportId; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("StopContinuousExport", Dict{String, Any}("exportId"=>exportId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
stop_continuous_export(exportId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("StopContinuousExport", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("exportId"=>exportId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
stop_data_collection_by_agent_ids(agentIds; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("StopDataCollectionByAgentIds", Dict{String, Any}("agentIds"=>agentIds); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
stop_data_collection_by_agent_ids(agentIds, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("StopDataCollectionByAgentIds", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("agentIds"=>agentIds), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_application(configurationId; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("UpdateApplication", Dict{String, Any}("configurationId"=>configurationId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_application(configurationId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = application_discovery_service("UpdateApplication", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("configurationId"=>configurationId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
