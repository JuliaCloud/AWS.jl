...
function delete_layer(
    LayerId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return opsworks(
        "DeleteLayer",
...
function delete_stack(
    StackId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return opsworks(
        "DeleteStack",
...
"""
function deregister_elastic_ip(ElasticIp; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks(
        "DeregisterElasticIp",
        Dict{String,Any}("ElasticIp" => ElasticIp);
        aws_config=aws_config,
...
"""
function get_hostname_suggestion(LayerId; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks(
