...
must first be registered with the stack by calling [`register_volume`](@ref). After you
register the volume, you must call [`update_volume`](@ref) to specify a mount point before
...
address must first be registered with the stack by calling [`register_elastic_ip`](@ref).
...
explicitly grants permissions. For more information about user permissions, see [Managing User Permissions](https://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html).
...
- `service_role_arn`: The stack Identity and Access Management (IAM) role, which allows
  ...
  !!! note
      ...
      is no default value. You can specify the source stack's service role ARN, if you
...
- `"AgentVersion"`: The default OpsWorks Stacks agent version. You have the following
  ...
  - Auto-update - Set this parameter to `LATEST`. OpsWorks Stacks automatically installs new
  ...
  - Fixed version - Set this parameter to your preferred agent version. To update the agent
    version, you must edit the stack configuration and specify a new version. OpsWorks
...
- `"DefaultRootDeviceType"`: The default root device type. This value is used by default for
  all instances in the cloned stack, but you can override it when you create an instance.
...
- `"UseOpsworksSecurityGroups"`: Whether to associate the OpsWorks Stacks built-in security
  ...
  - True - OpsWorks Stacks automatically associates the appropriate built-in security group
...
- `instance_type`: The instance type, such as `t2.micro`. For a list of supported instance
  ...
  **Size** list contains the currently supported types. For more information, see [Instance Families and Types](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html).
...
- `"AgentVersion"`: The default OpsWorks Stacks agent version. You have the following
  ...
  - *version_number* - Use the specified agent version. This value overrides the stack's
    ...
    specify a new version. OpsWorks Stacks installs that version on the instance.
...
- `"Hostname"`: The instance host name. The following are character limits for instance host
  names.
...
- `shortname`: For custom layers only, use this parameter to specify the layer's short name,
  which is used internally by OpsWorks Stacks and by Chef recipes. The short name is also
...
- `type`: The layer type. A stack cannot have more than one built-in layer of the same type.
  It can have any number of custom layers. Built-in layers are not available in Chef 12
  stacks.
...
- `"CustomJson"`: A JSON-formatted string containing custom stack configuration and
  deployment attributes to be installed on the layer's instances. For more information, see [Using Custom JSON](https://docs.aws.amazon.com/opsworks/latest/userguide/workingcookbook-json-override.html).
...
- `region`: The stack's Amazon Web Services Region, such as `ap-south-1`. For more
  ...
  !!! note
      ...
      parameter is set to one of the following, then the stack uses a legacy or *classic*
      region:
      `us-west-1, us-west-2, sa-east-1, eu-central-1, eu-west-1, ap-northeast-1, ap-southeast-1, ap-southeast-2`.
      In this case, the actual API endpoint of the stack is in `us-east-1`. Only the
      preceding regions are supported as classic regions in the `us-east-1` API endpoint.
      ...
      stacks. The CLI common `--region` parameter always specifies a regional API endpoint;
      it cannot be used to specify a classic OpsWorks Stacks region.

- `service_role_arn`: The stack's IAM role, which allows OpsWorks Stacks to work with Amazon
  Web Services resources on your behalf. You must set this parameter to the Amazon Resource
  Name (ARN) for an existing IAM role. For more information about IAM ARNs, see [Using Identifiers](https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html).
...
- `"AllowSelfManagement"`: Whether users can specify their own SSH public key through the My
  Settings page. For more information, see [Setting an IAM User's Public SSH Key](https://docs.aws.amazon.com/opsworks/latest/userguide/security-settingsshkey.html).
...
function describe_agent_versions(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeAgentVersions"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_agent_versions(
    ...
    return opsworks(
        "DescribeAgentVersions", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_apps(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeApps"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function describe_apps(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return opsworks("DescribeApps", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_commands(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeCommands"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function describe_commands(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return opsworks("DescribeCommands", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_deployments(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeDeployments"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_deployments(
    ...
    return opsworks(
        "DescribeDeployments", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"MaxResults"`: To receive a paginated response, use this parameter to specify the maximum
  ...
  `next_token` request parameter to get the next set of results.
...
function describe_ecs_clusters(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeEcsClusters"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_ecs_clusters(
    ...
    return opsworks(
        "DescribeEcsClusters", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_elastic_ips(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeElasticIps"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_elastic_ips(
    ...
    return opsworks(
        "DescribeElasticIps", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_elastic_load_balancers(;
    ...
    return opsworks(
        "DescribeElasticLoadBalancers"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_elastic_load_balancers(
    ...
    return opsworks(
        "DescribeElasticLoadBalancers", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_instances(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeInstances"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_instances(
    ...
    return opsworks(
        "DescribeInstances", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_layers(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeLayers"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function describe_layers(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return opsworks("DescribeLayers", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
or an attached policy that explicitly grants permissions. For more information about user
...
function describe_my_user_profile(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeMyUserProfile"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_my_user_profile(
    ...
    return opsworks(
        "DescribeMyUserProfile", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_operating_systems(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeOperatingSystems"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_operating_systems(
    ...
    return opsworks(
        "DescribeOperatingSystems", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_permissions(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribePermissions"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_permissions(
    ...
    return opsworks(
        "DescribePermissions", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_raid_arrays(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeRaidArrays"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_raid_arrays(
    ...
    return opsworks(
        "DescribeRaidArrays", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_service_errors(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeServiceErrors"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_service_errors(
    ...
    return opsworks(
        "DescribeServiceErrors", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"StackIds"`: An array of stack IDs that specify the stacks to be described. If you omit
  ...
  the user must specify a stack ARN that is allowed by the policy. Otherwise,
  `DescribeStacks` returns an `AccessDenied` error.
"""
function describe_stacks end

function describe_stacks(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeStacks"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function describe_stacks(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return opsworks("DescribeStacks", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_user_profiles(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeUserProfiles"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_user_profiles(
    ...
    return opsworks(
        "DescribeUserProfiles", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function describe_volumes(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("DescribeVolumes"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function describe_volumes(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return opsworks("DescribeVolumes", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
by calling [`deregister_elastic_ip`](@ref). For more information, see [Resource Management](https://docs.aws.amazon.com/opsworks/latest/userguide/resources.html).
...
!!! note
    ...
    registering the instance with the stack. `RegisterInstance` handles only the second
    step. You should instead use the CLI `register` command, which performs the entire
    registration operation. For more information, see [Registering an Instance with an OpsWorks Stacks Stack](https://docs.aws.amazon.com/opsworks/latest/userguide/registered-instances-register.html).

Registered instances have the same requirements as instances that are created by using the [`create_instance`](@ref)
API. For example, registered instances must be running a supported Linux-based operating
system, and they must have a supported instance type. For more information about
requirements for instances that you want to register, see [Preparing the Instance](https://docs.aws.amazon.com/opsworks/latest/userguide/registered-instances-register-registering-preparer.html).
...
calling [`deregister_volume`](@ref). For more information, see [Resource Management](https://docs.aws.amazon.com/opsworks/latest/userguide/resources.html).
...
- `"Os"`: The instance's operating system, which must be set to one of the following. You
  ...
  The default option is the current Amazon Linux version. If you set this parameter to
  `Custom`, you must use the AmiId parameter to specify the custom AMI that you want to use.
  For more information about how to use custom AMIs with OpsWorks, see [Using Custom AMIs](https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-custom-ami.html).
...
- `"Shortname"`: For custom layers only, use this parameter to specify the layer's short
  ...
  32 characters and must be in the following format: /\\A[a-z0-9\\-\\_\\.]+\\Z/.
...
function update_my_user_profile(; aws_config::AbstractAWSConfig=current_aws_config())
    return opsworks("UpdateMyUserProfile"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function update_my_user_profile(
    ...
    return opsworks(
        "UpdateMyUserProfile", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `"AllowSelfManagement"`: Whether users can specify their own SSH public key through the My
  Settings page. For more information, see [Managing User Permissions](https://docs.aws.amazon.com/opsworks/latest/userguide/security-settingsshkey.html).
