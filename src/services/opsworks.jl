...
"""
AssignInstance(InstanceId, LayerIds) = opsworks("AssignInstance", Dict{String, Any}("InstanceId"=>InstanceId, "LayerIds"=>LayerIds))
AssignInstance(InstanceId, LayerIds, args::AbstractDict{String, <:Any}) = opsworks("AssignInstance", Dict{String, Any}("InstanceId"=>InstanceId, "LayerIds"=>LayerIds, args...))
...
- `InstanceId`: The instance ID.
"""
AssignVolume(VolumeId) = opsworks("AssignVolume", Dict{String, Any}("VolumeId"=>VolumeId))
AssignVolume(VolumeId, args::AbstractDict{String, <:Any}) = opsworks("AssignVolume", Dict{String, Any}("VolumeId"=>VolumeId, args...))
...
- `InstanceId`: The instance ID.
"""
AssociateElasticIp(ElasticIp) = opsworks("AssociateElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp))
AssociateElasticIp(ElasticIp, args::AbstractDict{String, <:Any}) = opsworks("AssociateElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp, args...))
...
"""
AttachElasticLoadBalancer(ElasticLoadBalancerName, LayerId) = opsworks("AttachElasticLoadBalancer", Dict{String, Any}("ElasticLoadBalancerName"=>ElasticLoadBalancerName, "LayerId"=>LayerId))
AttachElasticLoadBalancer(ElasticLoadBalancerName, LayerId, args::AbstractDict{String, <:Any}) = opsworks("AttachElasticLoadBalancer", Dict{String, Any}("ElasticLoadBalancerName"=>ElasticLoadBalancerName, "LayerId"=>LayerId, args...))
...
"""
CloneStack(ServiceRoleArn, SourceStackId) = opsworks("CloneStack", Dict{String, Any}("ServiceRoleArn"=>ServiceRoleArn, "SourceStackId"=>SourceStackId))
CloneStack(ServiceRoleArn, SourceStackId, args::AbstractDict{String, <:Any}) = opsworks("CloneStack", Dict{String, Any}("ServiceRoleArn"=>ServiceRoleArn, "SourceStackId"=>SourceStackId, args...))
...
"""
CreateApp(Name, StackId, Type) = opsworks("CreateApp", Dict{String, Any}("Name"=>Name, "StackId"=>StackId, "Type"=>Type))
CreateApp(Name, StackId, Type, args::AbstractDict{String, <:Any}) = opsworks("CreateApp", Dict{String, Any}("Name"=>Name, "StackId"=>StackId, "Type"=>Type, args...))
...
"""
CreateDeployment(Command, StackId) = opsworks("CreateDeployment", Dict{String, Any}("Command"=>Command, "StackId"=>StackId))
CreateDeployment(Command, StackId, args::AbstractDict{String, <:Any}) = opsworks("CreateDeployment", Dict{String, Any}("Command"=>Command, "StackId"=>StackId, args...))
...
"""
CreateInstance(InstanceType, LayerIds, StackId) = opsworks("CreateInstance", Dict{String, Any}("InstanceType"=>InstanceType, "LayerIds"=>LayerIds, "StackId"=>StackId))
CreateInstance(InstanceType, LayerIds, StackId, args::AbstractDict{String, <:Any}) = opsworks("CreateInstance", Dict{String, Any}("InstanceType"=>InstanceType, "LayerIds"=>LayerIds, "StackId"=>StackId, args...))
...
"""
CreateLayer(Name, Shortname, StackId, Type) = opsworks("CreateLayer", Dict{String, Any}("Name"=>Name, "Shortname"=>Shortname, "StackId"=>StackId, "Type"=>Type))
CreateLayer(Name, Shortname, StackId, Type, args::AbstractDict{String, <:Any}) = opsworks("CreateLayer", Dict{String, Any}("Name"=>Name, "Shortname"=>Shortname, "StackId"=>StackId, "Type"=>Type, args...))
...
"""
CreateStack(DefaultInstanceProfileArn, Name, Region, ServiceRoleArn) = opsworks("CreateStack", Dict{String, Any}("DefaultInstanceProfileArn"=>DefaultInstanceProfileArn, "Name"=>Name, "Region"=>Region, "ServiceRoleArn"=>ServiceRoleArn))
CreateStack(DefaultInstanceProfileArn, Name, Region, ServiceRoleArn, args::AbstractDict{String, <:Any}) = opsworks("CreateStack", Dict{String, Any}("DefaultInstanceProfileArn"=>DefaultInstanceProfileArn, "Name"=>Name, "Region"=>Region, "ServiceRoleArn"=>ServiceRoleArn, args...))
...
"""
CreateUserProfile(IamUserArn) = opsworks("CreateUserProfile", Dict{String, Any}("IamUserArn"=>IamUserArn))
CreateUserProfile(IamUserArn, args::AbstractDict{String, <:Any}) = opsworks("CreateUserProfile", Dict{String, Any}("IamUserArn"=>IamUserArn, args...))
...
"""
DeleteApp(AppId) = opsworks("DeleteApp", Dict{String, Any}("AppId"=>AppId))
DeleteApp(AppId, args::AbstractDict{String, <:Any}) = opsworks("DeleteApp", Dict{String, Any}("AppId"=>AppId, args...))
...
"""
DeleteInstance(InstanceId) = opsworks("DeleteInstance", Dict{String, Any}("InstanceId"=>InstanceId))
DeleteInstance(InstanceId, args::AbstractDict{String, <:Any}) = opsworks("DeleteInstance", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
"""
DeleteLayer(LayerId) = opsworks("DeleteLayer", Dict{String, Any}("LayerId"=>LayerId))
DeleteLayer(LayerId, args::AbstractDict{String, <:Any}) = opsworks("DeleteLayer", Dict{String, Any}("LayerId"=>LayerId, args...))
...
"""
DeleteStack(StackId) = opsworks("DeleteStack", Dict{String, Any}("StackId"=>StackId))
DeleteStack(StackId, args::AbstractDict{String, <:Any}) = opsworks("DeleteStack", Dict{String, Any}("StackId"=>StackId, args...))
...
"""
DeleteUserProfile(IamUserArn) = opsworks("DeleteUserProfile", Dict{String, Any}("IamUserArn"=>IamUserArn))
DeleteUserProfile(IamUserArn, args::AbstractDict{String, <:Any}) = opsworks("DeleteUserProfile", Dict{String, Any}("IamUserArn"=>IamUserArn, args...))
...
"""
DeregisterEcsCluster(EcsClusterArn) = opsworks("DeregisterEcsCluster", Dict{String, Any}("EcsClusterArn"=>EcsClusterArn))
DeregisterEcsCluster(EcsClusterArn, args::AbstractDict{String, <:Any}) = opsworks("DeregisterEcsCluster", Dict{String, Any}("EcsClusterArn"=>EcsClusterArn, args...))
...
"""
DeregisterElasticIp(ElasticIp) = opsworks("DeregisterElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp))
DeregisterElasticIp(ElasticIp, args::AbstractDict{String, <:Any}) = opsworks("DeregisterElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp, args...))
...
"""
DeregisterInstance(InstanceId) = opsworks("DeregisterInstance", Dict{String, Any}("InstanceId"=>InstanceId))
DeregisterInstance(InstanceId, args::AbstractDict{String, <:Any}) = opsworks("DeregisterInstance", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
"""
DeregisterRdsDbInstance(RdsDbInstanceArn) = opsworks("DeregisterRdsDbInstance", Dict{String, Any}("RdsDbInstanceArn"=>RdsDbInstanceArn))
DeregisterRdsDbInstance(RdsDbInstanceArn, args::AbstractDict{String, <:Any}) = opsworks("DeregisterRdsDbInstance", Dict{String, Any}("RdsDbInstanceArn"=>RdsDbInstanceArn, args...))
...
"""
DeregisterVolume(VolumeId) = opsworks("DeregisterVolume", Dict{String, Any}("VolumeId"=>VolumeId))
DeregisterVolume(VolumeId, args::AbstractDict{String, <:Any}) = opsworks("DeregisterVolume", Dict{String, Any}("VolumeId"=>VolumeId, args...))
...
DescribeAgentVersions(args::AbstractDict{String, <:Any}) = opsworks("DescribeAgentVersions", args)
...
DescribeApps(args::AbstractDict{String, <:Any}) = opsworks("DescribeApps", args)
...
DescribeCommands(args::AbstractDict{String, <:Any}) = opsworks("DescribeCommands", args)
...
DescribeDeployments(args::AbstractDict{String, <:Any}) = opsworks("DescribeDeployments", args)
...
DescribeEcsClusters(args::AbstractDict{String, <:Any}) = opsworks("DescribeEcsClusters", args)
...
DescribeElasticIps(args::AbstractDict{String, <:Any}) = opsworks("DescribeElasticIps", args)
...
DescribeElasticLoadBalancers(args::AbstractDict{String, <:Any}) = opsworks("DescribeElasticLoadBalancers", args)
...
DescribeInstances(args::AbstractDict{String, <:Any}) = opsworks("DescribeInstances", args)
...
DescribeLayers(args::AbstractDict{String, <:Any}) = opsworks("DescribeLayers", args)
...
"""
DescribeLoadBasedAutoScaling(LayerIds) = opsworks("DescribeLoadBasedAutoScaling", Dict{String, Any}("LayerIds"=>LayerIds))
DescribeLoadBasedAutoScaling(LayerIds, args::AbstractDict{String, <:Any}) = opsworks("DescribeLoadBasedAutoScaling", Dict{String, Any}("LayerIds"=>LayerIds, args...))
...
DescribeMyUserProfile(args::AbstractDict{String, <:Any}) = opsworks("DescribeMyUserProfile", args)
...
DescribeOperatingSystems(args::AbstractDict{String, <:Any}) = opsworks("DescribeOperatingSystems", args)
...
DescribePermissions(args::AbstractDict{String, <:Any}) = opsworks("DescribePermissions", args)
...
DescribeRaidArrays(args::AbstractDict{String, <:Any}) = opsworks("DescribeRaidArrays", args)
...
"""
DescribeRdsDbInstances(StackId) = opsworks("DescribeRdsDbInstances", Dict{String, Any}("StackId"=>StackId))
DescribeRdsDbInstances(StackId, args::AbstractDict{String, <:Any}) = opsworks("DescribeRdsDbInstances", Dict{String, Any}("StackId"=>StackId, args...))
...
DescribeServiceErrors(args::AbstractDict{String, <:Any}) = opsworks("DescribeServiceErrors", args)
...
"""
DescribeStackProvisioningParameters(StackId) = opsworks("DescribeStackProvisioningParameters", Dict{String, Any}("StackId"=>StackId))
DescribeStackProvisioningParameters(StackId, args::AbstractDict{String, <:Any}) = opsworks("DescribeStackProvisioningParameters", Dict{String, Any}("StackId"=>StackId, args...))
...
"""
DescribeStackSummary(StackId) = opsworks("DescribeStackSummary", Dict{String, Any}("StackId"=>StackId))
DescribeStackSummary(StackId, args::AbstractDict{String, <:Any}) = opsworks("DescribeStackSummary", Dict{String, Any}("StackId"=>StackId, args...))
...
DescribeStacks(args::AbstractDict{String, <:Any}) = opsworks("DescribeStacks", args)
...
"""
DescribeTimeBasedAutoScaling(InstanceIds) = opsworks("DescribeTimeBasedAutoScaling", Dict{String, Any}("InstanceIds"=>InstanceIds))
DescribeTimeBasedAutoScaling(InstanceIds, args::AbstractDict{String, <:Any}) = opsworks("DescribeTimeBasedAutoScaling", Dict{String, Any}("InstanceIds"=>InstanceIds, args...))
...
DescribeUserProfiles(args::AbstractDict{String, <:Any}) = opsworks("DescribeUserProfiles", args)
...
DescribeVolumes(args::AbstractDict{String, <:Any}) = opsworks("DescribeVolumes", args)
...
"""
DetachElasticLoadBalancer(ElasticLoadBalancerName, LayerId) = opsworks("DetachElasticLoadBalancer", Dict{String, Any}("ElasticLoadBalancerName"=>ElasticLoadBalancerName, "LayerId"=>LayerId))
DetachElasticLoadBalancer(ElasticLoadBalancerName, LayerId, args::AbstractDict{String, <:Any}) = opsworks("DetachElasticLoadBalancer", Dict{String, Any}("ElasticLoadBalancerName"=>ElasticLoadBalancerName, "LayerId"=>LayerId, args...))
...
"""
DisassociateElasticIp(ElasticIp) = opsworks("DisassociateElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp))
DisassociateElasticIp(ElasticIp, args::AbstractDict{String, <:Any}) = opsworks("DisassociateElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp, args...))
...
"""
GetHostnameSuggestion(LayerId) = opsworks("GetHostnameSuggestion", Dict{String, Any}("LayerId"=>LayerId))
GetHostnameSuggestion(LayerId, args::AbstractDict{String, <:Any}) = opsworks("GetHostnameSuggestion", Dict{String, Any}("LayerId"=>LayerId, args...))
...
"""
GrantAccess(InstanceId) = opsworks("GrantAccess", Dict{String, Any}("InstanceId"=>InstanceId))
GrantAccess(InstanceId, args::AbstractDict{String, <:Any}) = opsworks("GrantAccess", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
"""
ListTags(ResourceArn) = opsworks("ListTags", Dict{String, Any}("ResourceArn"=>ResourceArn))
ListTags(ResourceArn, args::AbstractDict{String, <:Any}) = opsworks("ListTags", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
"""
RebootInstance(InstanceId) = opsworks("RebootInstance", Dict{String, Any}("InstanceId"=>InstanceId))
RebootInstance(InstanceId, args::AbstractDict{String, <:Any}) = opsworks("RebootInstance", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
"""
RegisterEcsCluster(EcsClusterArn, StackId) = opsworks("RegisterEcsCluster", Dict{String, Any}("EcsClusterArn"=>EcsClusterArn, "StackId"=>StackId))
RegisterEcsCluster(EcsClusterArn, StackId, args::AbstractDict{String, <:Any}) = opsworks("RegisterEcsCluster", Dict{String, Any}("EcsClusterArn"=>EcsClusterArn, "StackId"=>StackId, args...))
...
"""
RegisterElasticIp(ElasticIp, StackId) = opsworks("RegisterElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp, "StackId"=>StackId))
RegisterElasticIp(ElasticIp, StackId, args::AbstractDict{String, <:Any}) = opsworks("RegisterElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp, "StackId"=>StackId, args...))
...
"""
RegisterInstance(StackId) = opsworks("RegisterInstance", Dict{String, Any}("StackId"=>StackId))
RegisterInstance(StackId, args::AbstractDict{String, <:Any}) = opsworks("RegisterInstance", Dict{String, Any}("StackId"=>StackId, args...))
...
"""
RegisterRdsDbInstance(DbPassword, DbUser, RdsDbInstanceArn, StackId) = opsworks("RegisterRdsDbInstance", Dict{String, Any}("DbPassword"=>DbPassword, "DbUser"=>DbUser, "RdsDbInstanceArn"=>RdsDbInstanceArn, "StackId"=>StackId))
RegisterRdsDbInstance(DbPassword, DbUser, RdsDbInstanceArn, StackId, args::AbstractDict{String, <:Any}) = opsworks("RegisterRdsDbInstance", Dict{String, Any}("DbPassword"=>DbPassword, "DbUser"=>DbUser, "RdsDbInstanceArn"=>RdsDbInstanceArn, "StackId"=>StackId, args...))
...
"""
RegisterVolume(StackId) = opsworks("RegisterVolume", Dict{String, Any}("StackId"=>StackId))
RegisterVolume(StackId, args::AbstractDict{String, <:Any}) = opsworks("RegisterVolume", Dict{String, Any}("StackId"=>StackId, args...))
...
"""
SetLoadBasedAutoScaling(LayerId) = opsworks("SetLoadBasedAutoScaling", Dict{String, Any}("LayerId"=>LayerId))
SetLoadBasedAutoScaling(LayerId, args::AbstractDict{String, <:Any}) = opsworks("SetLoadBasedAutoScaling", Dict{String, Any}("LayerId"=>LayerId, args...))
...
"""
SetPermission(IamUserArn, StackId) = opsworks("SetPermission", Dict{String, Any}("IamUserArn"=>IamUserArn, "StackId"=>StackId))
SetPermission(IamUserArn, StackId, args::AbstractDict{String, <:Any}) = opsworks("SetPermission", Dict{String, Any}("IamUserArn"=>IamUserArn, "StackId"=>StackId, args...))
...
"""
SetTimeBasedAutoScaling(InstanceId) = opsworks("SetTimeBasedAutoScaling", Dict{String, Any}("InstanceId"=>InstanceId))
SetTimeBasedAutoScaling(InstanceId, args::AbstractDict{String, <:Any}) = opsworks("SetTimeBasedAutoScaling", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
"""
StartInstance(InstanceId) = opsworks("StartInstance", Dict{String, Any}("InstanceId"=>InstanceId))
StartInstance(InstanceId, args::AbstractDict{String, <:Any}) = opsworks("StartInstance", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
"""
StartStack(StackId) = opsworks("StartStack", Dict{String, Any}("StackId"=>StackId))
StartStack(StackId, args::AbstractDict{String, <:Any}) = opsworks("StartStack", Dict{String, Any}("StackId"=>StackId, args...))
...
"""
StopInstance(InstanceId) = opsworks("StopInstance", Dict{String, Any}("InstanceId"=>InstanceId))
StopInstance(InstanceId, args::AbstractDict{String, <:Any}) = opsworks("StopInstance", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
"""
StopStack(StackId) = opsworks("StopStack", Dict{String, Any}("StackId"=>StackId))
StopStack(StackId, args::AbstractDict{String, <:Any}) = opsworks("StopStack", Dict{String, Any}("StackId"=>StackId, args...))
...
"""
TagResource(ResourceArn, Tags) = opsworks("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags))
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}) = opsworks("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags, args...))
...
"""
UnassignInstance(InstanceId) = opsworks("UnassignInstance", Dict{String, Any}("InstanceId"=>InstanceId))
UnassignInstance(InstanceId, args::AbstractDict{String, <:Any}) = opsworks("UnassignInstance", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
"""
UnassignVolume(VolumeId) = opsworks("UnassignVolume", Dict{String, Any}("VolumeId"=>VolumeId))
UnassignVolume(VolumeId, args::AbstractDict{String, <:Any}) = opsworks("UnassignVolume", Dict{String, Any}("VolumeId"=>VolumeId, args...))
...
"""
UntagResource(ResourceArn, TagKeys) = opsworks("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys))
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}) = opsworks("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys, args...))
...
- `Type`: The app type.
"""
UpdateApp(AppId) = opsworks("UpdateApp", Dict{String, Any}("AppId"=>AppId))
UpdateApp(AppId, args::AbstractDict{String, <:Any}) = opsworks("UpdateApp", Dict{String, Any}("AppId"=>AppId, args...))
...
- `Name`: The new name.
"""
UpdateElasticIp(ElasticIp) = opsworks("UpdateElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp))
UpdateElasticIp(ElasticIp, args::AbstractDict{String, <:Any}) = opsworks("UpdateElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp, args...))
...
"""
UpdateInstance(InstanceId) = opsworks("UpdateInstance", Dict{String, Any}("InstanceId"=>InstanceId))
UpdateInstance(InstanceId, args::AbstractDict{String, <:Any}) = opsworks("UpdateInstance", Dict{String, Any}("InstanceId"=>InstanceId, args...))
...
- `VolumeConfigurations`: A VolumeConfigurations object that describes the layer's Amazon EBS volumes.
"""
UpdateLayer(LayerId) = opsworks("UpdateLayer", Dict{String, Any}("LayerId"=>LayerId))
UpdateLayer(LayerId, args::AbstractDict{String, <:Any}) = opsworks("UpdateLayer", Dict{String, Any}("LayerId"=>LayerId, args...))
...
UpdateMyUserProfile(args::AbstractDict{String, <:Any}) = opsworks("UpdateMyUserProfile", args)
...
"""
UpdateRdsDbInstance(RdsDbInstanceArn) = opsworks("UpdateRdsDbInstance", Dict{String, Any}("RdsDbInstanceArn"=>RdsDbInstanceArn))
UpdateRdsDbInstance(RdsDbInstanceArn, args::AbstractDict{String, <:Any}) = opsworks("UpdateRdsDbInstance", Dict{String, Any}("RdsDbInstanceArn"=>RdsDbInstanceArn, args...))
...
"""
UpdateStack(StackId) = opsworks("UpdateStack", Dict{String, Any}("StackId"=>StackId))
UpdateStack(StackId, args::AbstractDict{String, <:Any}) = opsworks("UpdateStack", Dict{String, Any}("StackId"=>StackId, args...))
...
- `SshUsername`: The user's SSH user name. The allowable characters are [a-z], [A-Z], [0-9], '-', and '_'. If the specified name includes other punctuation marks, AWS OpsWorks Stacks removes them. For example, my.name will be changed to myname. If you do not specify an SSH user name, AWS OpsWorks Stacks generates one from the IAM user name. 
"""
UpdateUserProfile(IamUserArn) = opsworks("UpdateUserProfile", Dict{String, Any}("IamUserArn"=>IamUserArn))
UpdateUserProfile(IamUserArn, args::AbstractDict{String, <:Any}) = opsworks("UpdateUserProfile", Dict{String, Any}("IamUserArn"=>IamUserArn, args...))
...
- `Name`: The new name.
"""
UpdateVolume(VolumeId) = opsworks("UpdateVolume", Dict{String, Any}("VolumeId"=>VolumeId))
UpdateVolume(VolumeId, args::AbstractDict{String, <:Any}) = opsworks("UpdateVolume", Dict{String, Any}("VolumeId"=>VolumeId, args...))
