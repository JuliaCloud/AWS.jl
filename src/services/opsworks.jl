...
AssignInstance(InstanceId, LayerIds; aws_config::AWSConfig=AWS.aws_config) = opsworks("AssignInstance", Dict{String, Any}("InstanceId"=>InstanceId, "LayerIds"=>LayerIds); aws_config=aws_config)
AssignInstance(InstanceId, LayerIds, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("AssignInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceId"=>InstanceId, "LayerIds"=>LayerIds), args)); aws_config=aws_config)
...
AssignVolume(VolumeId; aws_config::AWSConfig=AWS.aws_config) = opsworks("AssignVolume", Dict{String, Any}("VolumeId"=>VolumeId); aws_config=aws_config)
AssignVolume(VolumeId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("AssignVolume", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VolumeId"=>VolumeId), args)); aws_config=aws_config)
...
AssociateElasticIp(ElasticIp; aws_config::AWSConfig=AWS.aws_config) = opsworks("AssociateElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp); aws_config=aws_config)
AssociateElasticIp(ElasticIp, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("AssociateElasticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ElasticIp"=>ElasticIp), args)); aws_config=aws_config)
...
AttachElasticLoadBalancer(ElasticLoadBalancerName, LayerId; aws_config::AWSConfig=AWS.aws_config) = opsworks("AttachElasticLoadBalancer", Dict{String, Any}("ElasticLoadBalancerName"=>ElasticLoadBalancerName, "LayerId"=>LayerId); aws_config=aws_config)
AttachElasticLoadBalancer(ElasticLoadBalancerName, LayerId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("AttachElasticLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ElasticLoadBalancerName"=>ElasticLoadBalancerName, "LayerId"=>LayerId), args)); aws_config=aws_config)
...
CloneStack(ServiceRoleArn, SourceStackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("CloneStack", Dict{String, Any}("ServiceRoleArn"=>ServiceRoleArn, "SourceStackId"=>SourceStackId); aws_config=aws_config)
CloneStack(ServiceRoleArn, SourceStackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("CloneStack", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ServiceRoleArn"=>ServiceRoleArn, "SourceStackId"=>SourceStackId), args)); aws_config=aws_config)
...
CreateApp(Name, StackId, Type; aws_config::AWSConfig=AWS.aws_config) = opsworks("CreateApp", Dict{String, Any}("Name"=>Name, "StackId"=>StackId, "Type"=>Type); aws_config=aws_config)
CreateApp(Name, StackId, Type, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("CreateApp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name, "StackId"=>StackId, "Type"=>Type), args)); aws_config=aws_config)
...
CreateDeployment(Command, StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("CreateDeployment", Dict{String, Any}("Command"=>Command, "StackId"=>StackId); aws_config=aws_config)
CreateDeployment(Command, StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("CreateDeployment", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Command"=>Command, "StackId"=>StackId), args)); aws_config=aws_config)
...
CreateInstance(InstanceType, LayerIds, StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("CreateInstance", Dict{String, Any}("InstanceType"=>InstanceType, "LayerIds"=>LayerIds, "StackId"=>StackId); aws_config=aws_config)
CreateInstance(InstanceType, LayerIds, StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("CreateInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceType"=>InstanceType, "LayerIds"=>LayerIds, "StackId"=>StackId), args)); aws_config=aws_config)
...
CreateLayer(Name, Shortname, StackId, Type; aws_config::AWSConfig=AWS.aws_config) = opsworks("CreateLayer", Dict{String, Any}("Name"=>Name, "Shortname"=>Shortname, "StackId"=>StackId, "Type"=>Type); aws_config=aws_config)
CreateLayer(Name, Shortname, StackId, Type, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("CreateLayer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name, "Shortname"=>Shortname, "StackId"=>StackId, "Type"=>Type), args)); aws_config=aws_config)
...
CreateStack(DefaultInstanceProfileArn, Name, Region, ServiceRoleArn; aws_config::AWSConfig=AWS.aws_config) = opsworks("CreateStack", Dict{String, Any}("DefaultInstanceProfileArn"=>DefaultInstanceProfileArn, "Name"=>Name, "Region"=>Region, "ServiceRoleArn"=>ServiceRoleArn); aws_config=aws_config)
CreateStack(DefaultInstanceProfileArn, Name, Region, ServiceRoleArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("CreateStack", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DefaultInstanceProfileArn"=>DefaultInstanceProfileArn, "Name"=>Name, "Region"=>Region, "ServiceRoleArn"=>ServiceRoleArn), args)); aws_config=aws_config)
...
CreateUserProfile(IamUserArn; aws_config::AWSConfig=AWS.aws_config) = opsworks("CreateUserProfile", Dict{String, Any}("IamUserArn"=>IamUserArn); aws_config=aws_config)
CreateUserProfile(IamUserArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("CreateUserProfile", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IamUserArn"=>IamUserArn), args)); aws_config=aws_config)
...
DeleteApp(AppId; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeleteApp", Dict{String, Any}("AppId"=>AppId); aws_config=aws_config)
DeleteApp(AppId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeleteApp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AppId"=>AppId), args)); aws_config=aws_config)
...
DeleteInstance(InstanceId; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeleteInstance", Dict{String, Any}("InstanceId"=>InstanceId); aws_config=aws_config)
DeleteInstance(InstanceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeleteInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceId"=>InstanceId), args)); aws_config=aws_config)
...
DeleteLayer(LayerId; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeleteLayer", Dict{String, Any}("LayerId"=>LayerId); aws_config=aws_config)
DeleteLayer(LayerId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeleteLayer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LayerId"=>LayerId), args)); aws_config=aws_config)
...
DeleteStack(StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeleteStack", Dict{String, Any}("StackId"=>StackId); aws_config=aws_config)
DeleteStack(StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeleteStack", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StackId"=>StackId), args)); aws_config=aws_config)
...
DeleteUserProfile(IamUserArn; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeleteUserProfile", Dict{String, Any}("IamUserArn"=>IamUserArn); aws_config=aws_config)
DeleteUserProfile(IamUserArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeleteUserProfile", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IamUserArn"=>IamUserArn), args)); aws_config=aws_config)
...
DeregisterEcsCluster(EcsClusterArn; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeregisterEcsCluster", Dict{String, Any}("EcsClusterArn"=>EcsClusterArn); aws_config=aws_config)
DeregisterEcsCluster(EcsClusterArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeregisterEcsCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EcsClusterArn"=>EcsClusterArn), args)); aws_config=aws_config)
...
DeregisterElasticIp(ElasticIp; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeregisterElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp); aws_config=aws_config)
DeregisterElasticIp(ElasticIp, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeregisterElasticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ElasticIp"=>ElasticIp), args)); aws_config=aws_config)
...
DeregisterInstance(InstanceId; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeregisterInstance", Dict{String, Any}("InstanceId"=>InstanceId); aws_config=aws_config)
DeregisterInstance(InstanceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeregisterInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceId"=>InstanceId), args)); aws_config=aws_config)
...
DeregisterRdsDbInstance(RdsDbInstanceArn; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeregisterRdsDbInstance", Dict{String, Any}("RdsDbInstanceArn"=>RdsDbInstanceArn); aws_config=aws_config)
DeregisterRdsDbInstance(RdsDbInstanceArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeregisterRdsDbInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RdsDbInstanceArn"=>RdsDbInstanceArn), args)); aws_config=aws_config)
...
DeregisterVolume(VolumeId; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeregisterVolume", Dict{String, Any}("VolumeId"=>VolumeId); aws_config=aws_config)
DeregisterVolume(VolumeId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DeregisterVolume", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VolumeId"=>VolumeId), args)); aws_config=aws_config)
...
DescribeAgentVersions(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeAgentVersions"; aws_config=aws_config)
DescribeAgentVersions(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeAgentVersions", args; aws_config=aws_config)
...
DescribeApps(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeApps"; aws_config=aws_config)
DescribeApps(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeApps", args; aws_config=aws_config)
...
DescribeCommands(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeCommands"; aws_config=aws_config)
DescribeCommands(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeCommands", args; aws_config=aws_config)
...
DescribeDeployments(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeDeployments"; aws_config=aws_config)
DescribeDeployments(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeDeployments", args; aws_config=aws_config)
...
DescribeEcsClusters(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeEcsClusters"; aws_config=aws_config)
DescribeEcsClusters(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeEcsClusters", args; aws_config=aws_config)
...
DescribeElasticIps(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeElasticIps"; aws_config=aws_config)
DescribeElasticIps(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeElasticIps", args; aws_config=aws_config)
...
DescribeElasticLoadBalancers(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeElasticLoadBalancers"; aws_config=aws_config)
DescribeElasticLoadBalancers(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeElasticLoadBalancers", args; aws_config=aws_config)
...
DescribeInstances(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeInstances"; aws_config=aws_config)
DescribeInstances(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeInstances", args; aws_config=aws_config)
...
DescribeLayers(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeLayers"; aws_config=aws_config)
DescribeLayers(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeLayers", args; aws_config=aws_config)
...
DescribeLoadBasedAutoScaling(LayerIds; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeLoadBasedAutoScaling", Dict{String, Any}("LayerIds"=>LayerIds); aws_config=aws_config)
DescribeLoadBasedAutoScaling(LayerIds, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeLoadBasedAutoScaling", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LayerIds"=>LayerIds), args)); aws_config=aws_config)
...
DescribeMyUserProfile(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeMyUserProfile"; aws_config=aws_config)
DescribeMyUserProfile(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeMyUserProfile", args; aws_config=aws_config)
...
DescribeOperatingSystems(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeOperatingSystems"; aws_config=aws_config)
DescribeOperatingSystems(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeOperatingSystems", args; aws_config=aws_config)
...
DescribePermissions(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribePermissions"; aws_config=aws_config)
DescribePermissions(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribePermissions", args; aws_config=aws_config)
...
DescribeRaidArrays(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeRaidArrays"; aws_config=aws_config)
DescribeRaidArrays(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeRaidArrays", args; aws_config=aws_config)
...
DescribeRdsDbInstances(StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeRdsDbInstances", Dict{String, Any}("StackId"=>StackId); aws_config=aws_config)
DescribeRdsDbInstances(StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeRdsDbInstances", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StackId"=>StackId), args)); aws_config=aws_config)
...
DescribeServiceErrors(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeServiceErrors"; aws_config=aws_config)
DescribeServiceErrors(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeServiceErrors", args; aws_config=aws_config)
...
DescribeStackProvisioningParameters(StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeStackProvisioningParameters", Dict{String, Any}("StackId"=>StackId); aws_config=aws_config)
DescribeStackProvisioningParameters(StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeStackProvisioningParameters", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StackId"=>StackId), args)); aws_config=aws_config)
...
DescribeStackSummary(StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeStackSummary", Dict{String, Any}("StackId"=>StackId); aws_config=aws_config)
DescribeStackSummary(StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeStackSummary", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StackId"=>StackId), args)); aws_config=aws_config)
...
DescribeStacks(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeStacks"; aws_config=aws_config)
DescribeStacks(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeStacks", args; aws_config=aws_config)
...
DescribeTimeBasedAutoScaling(InstanceIds; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeTimeBasedAutoScaling", Dict{String, Any}("InstanceIds"=>InstanceIds); aws_config=aws_config)
DescribeTimeBasedAutoScaling(InstanceIds, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeTimeBasedAutoScaling", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceIds"=>InstanceIds), args)); aws_config=aws_config)
...
DescribeUserProfiles(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeUserProfiles"; aws_config=aws_config)
DescribeUserProfiles(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeUserProfiles", args; aws_config=aws_config)
...
DescribeVolumes(; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeVolumes"; aws_config=aws_config)
DescribeVolumes(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DescribeVolumes", args; aws_config=aws_config)
...
DetachElasticLoadBalancer(ElasticLoadBalancerName, LayerId; aws_config::AWSConfig=AWS.aws_config) = opsworks("DetachElasticLoadBalancer", Dict{String, Any}("ElasticLoadBalancerName"=>ElasticLoadBalancerName, "LayerId"=>LayerId); aws_config=aws_config)
DetachElasticLoadBalancer(ElasticLoadBalancerName, LayerId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DetachElasticLoadBalancer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ElasticLoadBalancerName"=>ElasticLoadBalancerName, "LayerId"=>LayerId), args)); aws_config=aws_config)
...
DisassociateElasticIp(ElasticIp; aws_config::AWSConfig=AWS.aws_config) = opsworks("DisassociateElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp); aws_config=aws_config)
DisassociateElasticIp(ElasticIp, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("DisassociateElasticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ElasticIp"=>ElasticIp), args)); aws_config=aws_config)
...
GetHostnameSuggestion(LayerId; aws_config::AWSConfig=AWS.aws_config) = opsworks("GetHostnameSuggestion", Dict{String, Any}("LayerId"=>LayerId); aws_config=aws_config)
GetHostnameSuggestion(LayerId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("GetHostnameSuggestion", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LayerId"=>LayerId), args)); aws_config=aws_config)
...
GrantAccess(InstanceId; aws_config::AWSConfig=AWS.aws_config) = opsworks("GrantAccess", Dict{String, Any}("InstanceId"=>InstanceId); aws_config=aws_config)
GrantAccess(InstanceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("GrantAccess", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceId"=>InstanceId), args)); aws_config=aws_config)
...
ListTags(ResourceArn; aws_config::AWSConfig=AWS.aws_config) = opsworks("ListTags", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config)
ListTags(ResourceArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("ListTags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), args)); aws_config=aws_config)
...
RebootInstance(InstanceId; aws_config::AWSConfig=AWS.aws_config) = opsworks("RebootInstance", Dict{String, Any}("InstanceId"=>InstanceId); aws_config=aws_config)
RebootInstance(InstanceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("RebootInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceId"=>InstanceId), args)); aws_config=aws_config)
...
RegisterEcsCluster(EcsClusterArn, StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("RegisterEcsCluster", Dict{String, Any}("EcsClusterArn"=>EcsClusterArn, "StackId"=>StackId); aws_config=aws_config)
RegisterEcsCluster(EcsClusterArn, StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("RegisterEcsCluster", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EcsClusterArn"=>EcsClusterArn, "StackId"=>StackId), args)); aws_config=aws_config)
...
RegisterElasticIp(ElasticIp, StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("RegisterElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp, "StackId"=>StackId); aws_config=aws_config)
RegisterElasticIp(ElasticIp, StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("RegisterElasticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ElasticIp"=>ElasticIp, "StackId"=>StackId), args)); aws_config=aws_config)
...
RegisterInstance(StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("RegisterInstance", Dict{String, Any}("StackId"=>StackId); aws_config=aws_config)
RegisterInstance(StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("RegisterInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StackId"=>StackId), args)); aws_config=aws_config)
...
RegisterRdsDbInstance(DbPassword, DbUser, RdsDbInstanceArn, StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("RegisterRdsDbInstance", Dict{String, Any}("DbPassword"=>DbPassword, "DbUser"=>DbUser, "RdsDbInstanceArn"=>RdsDbInstanceArn, "StackId"=>StackId); aws_config=aws_config)
RegisterRdsDbInstance(DbPassword, DbUser, RdsDbInstanceArn, StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("RegisterRdsDbInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DbPassword"=>DbPassword, "DbUser"=>DbUser, "RdsDbInstanceArn"=>RdsDbInstanceArn, "StackId"=>StackId), args)); aws_config=aws_config)
...
RegisterVolume(StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("RegisterVolume", Dict{String, Any}("StackId"=>StackId); aws_config=aws_config)
RegisterVolume(StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("RegisterVolume", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StackId"=>StackId), args)); aws_config=aws_config)
...
SetLoadBasedAutoScaling(LayerId; aws_config::AWSConfig=AWS.aws_config) = opsworks("SetLoadBasedAutoScaling", Dict{String, Any}("LayerId"=>LayerId); aws_config=aws_config)
SetLoadBasedAutoScaling(LayerId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("SetLoadBasedAutoScaling", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LayerId"=>LayerId), args)); aws_config=aws_config)
...
SetPermission(IamUserArn, StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("SetPermission", Dict{String, Any}("IamUserArn"=>IamUserArn, "StackId"=>StackId); aws_config=aws_config)
SetPermission(IamUserArn, StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("SetPermission", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IamUserArn"=>IamUserArn, "StackId"=>StackId), args)); aws_config=aws_config)
...
SetTimeBasedAutoScaling(InstanceId; aws_config::AWSConfig=AWS.aws_config) = opsworks("SetTimeBasedAutoScaling", Dict{String, Any}("InstanceId"=>InstanceId); aws_config=aws_config)
SetTimeBasedAutoScaling(InstanceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("SetTimeBasedAutoScaling", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceId"=>InstanceId), args)); aws_config=aws_config)
...
StartInstance(InstanceId; aws_config::AWSConfig=AWS.aws_config) = opsworks("StartInstance", Dict{String, Any}("InstanceId"=>InstanceId); aws_config=aws_config)
StartInstance(InstanceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("StartInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceId"=>InstanceId), args)); aws_config=aws_config)
...
StartStack(StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("StartStack", Dict{String, Any}("StackId"=>StackId); aws_config=aws_config)
StartStack(StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("StartStack", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StackId"=>StackId), args)); aws_config=aws_config)
...
StopInstance(InstanceId; aws_config::AWSConfig=AWS.aws_config) = opsworks("StopInstance", Dict{String, Any}("InstanceId"=>InstanceId); aws_config=aws_config)
StopInstance(InstanceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("StopInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceId"=>InstanceId), args)); aws_config=aws_config)
...
StopStack(StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("StopStack", Dict{String, Any}("StackId"=>StackId); aws_config=aws_config)
StopStack(StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("StopStack", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StackId"=>StackId), args)); aws_config=aws_config)
...
TagResource(ResourceArn, Tags; aws_config::AWSConfig=AWS.aws_config) = opsworks("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags); aws_config=aws_config)
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags), args)); aws_config=aws_config)
...
UnassignInstance(InstanceId; aws_config::AWSConfig=AWS.aws_config) = opsworks("UnassignInstance", Dict{String, Any}("InstanceId"=>InstanceId); aws_config=aws_config)
UnassignInstance(InstanceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("UnassignInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceId"=>InstanceId), args)); aws_config=aws_config)
...
UnassignVolume(VolumeId; aws_config::AWSConfig=AWS.aws_config) = opsworks("UnassignVolume", Dict{String, Any}("VolumeId"=>VolumeId); aws_config=aws_config)
UnassignVolume(VolumeId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("UnassignVolume", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VolumeId"=>VolumeId), args)); aws_config=aws_config)
...
UntagResource(ResourceArn, TagKeys; aws_config::AWSConfig=AWS.aws_config) = opsworks("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys); aws_config=aws_config)
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), args)); aws_config=aws_config)
...
UpdateApp(AppId; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateApp", Dict{String, Any}("AppId"=>AppId); aws_config=aws_config)
UpdateApp(AppId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateApp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AppId"=>AppId), args)); aws_config=aws_config)
...
UpdateElasticIp(ElasticIp; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateElasticIp", Dict{String, Any}("ElasticIp"=>ElasticIp); aws_config=aws_config)
UpdateElasticIp(ElasticIp, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateElasticIp", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ElasticIp"=>ElasticIp), args)); aws_config=aws_config)
...
UpdateInstance(InstanceId; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateInstance", Dict{String, Any}("InstanceId"=>InstanceId); aws_config=aws_config)
UpdateInstance(InstanceId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InstanceId"=>InstanceId), args)); aws_config=aws_config)
...
UpdateLayer(LayerId; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateLayer", Dict{String, Any}("LayerId"=>LayerId); aws_config=aws_config)
UpdateLayer(LayerId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateLayer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("LayerId"=>LayerId), args)); aws_config=aws_config)
...
UpdateMyUserProfile(; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateMyUserProfile"; aws_config=aws_config)
UpdateMyUserProfile(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateMyUserProfile", args; aws_config=aws_config)
...
UpdateRdsDbInstance(RdsDbInstanceArn; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateRdsDbInstance", Dict{String, Any}("RdsDbInstanceArn"=>RdsDbInstanceArn); aws_config=aws_config)
UpdateRdsDbInstance(RdsDbInstanceArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateRdsDbInstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RdsDbInstanceArn"=>RdsDbInstanceArn), args)); aws_config=aws_config)
...
UpdateStack(StackId; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateStack", Dict{String, Any}("StackId"=>StackId); aws_config=aws_config)
UpdateStack(StackId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateStack", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("StackId"=>StackId), args)); aws_config=aws_config)
...
UpdateUserProfile(IamUserArn; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateUserProfile", Dict{String, Any}("IamUserArn"=>IamUserArn); aws_config=aws_config)
UpdateUserProfile(IamUserArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateUserProfile", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("IamUserArn"=>IamUserArn), args)); aws_config=aws_config)
...
UpdateVolume(VolumeId; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateVolume", Dict{String, Any}("VolumeId"=>VolumeId); aws_config=aws_config)
UpdateVolume(VolumeId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = opsworks("UpdateVolume", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VolumeId"=>VolumeId), args)); aws_config=aws_config)
