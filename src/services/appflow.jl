...
# Required Parameters
- `connectionMode`:  Indicates the connection mode and specifies whether it is public or
...
# Required Parameters
- `destinationFlowConfigList`:  The configuration that controls how Amazon AppFlow places
  data in the destination connector.
- `flowName`:  The specified name of the flow. Spaces are not allowed. Use underscores (_)
  or hyphens (-) only.
- `sourceFlowConfig`:  The configuration that controls how Amazon AppFlow retrieves data
...
- `connectorProfileConfig`:  Defines the connector-specific profile configuration and
  credentials.
- `connectorProfileName`:  The name of the connector profile and is unique for each
  ConnectorProfile in the AWS Account.
...
# Required Parameters
- `destinationFlowConfigList`:  The configuration that controls how Amazon AppFlow
