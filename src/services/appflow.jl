...
"""
function cancel_flow_executions(flowName; aws_config::AbstractAWSConfig=current_aws_config())
    return appflow(
        "POST",
...
"""
function reset_connector_metadata_cache(; aws_config::AbstractAWSConfig=current_aws_config())
    return appflow(
        "POST",
