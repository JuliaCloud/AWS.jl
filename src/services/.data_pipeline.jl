...
"""
ActivatePipeline(pipelineId) = data_pipeline("ActivatePipeline", Dict{String, Any}("pipelineId"=>pipelineId))
ActivatePipeline(pipelineId, args::AbstractDict{String, <: Any}) = data_pipeline("ActivatePipeline", Dict{String, Any}("pipelineId"=>pipelineId, args...))
...
"""
AddTags(pipelineId, tags) = data_pipeline("AddTags", Dict{String, Any}("pipelineId"=>pipelineId, "tags"=>tags))
AddTags(pipelineId, tags, args::AbstractDict{String, <: Any}) = data_pipeline("AddTags", Dict{String, Any}("pipelineId"=>pipelineId, "tags"=>tags, args...))
...
"""
CreatePipeline(name, uniqueId) = data_pipeline("CreatePipeline", Dict{String, Any}("name"=>name, "uniqueId"=>uniqueId))
CreatePipeline(name, uniqueId, args::AbstractDict{String, <: Any}) = data_pipeline("CreatePipeline", Dict{String, Any}("name"=>name, "uniqueId"=>uniqueId, args...))
...
"""
DeactivatePipeline(pipelineId) = data_pipeline("DeactivatePipeline", Dict{String, Any}("pipelineId"=>pipelineId))
DeactivatePipeline(pipelineId, args::AbstractDict{String, <: Any}) = data_pipeline("DeactivatePipeline", Dict{String, Any}("pipelineId"=>pipelineId, args...))
...
"""
DeletePipeline(pipelineId) = data_pipeline("DeletePipeline", Dict{String, Any}("pipelineId"=>pipelineId))
DeletePipeline(pipelineId, args::AbstractDict{String, <: Any}) = data_pipeline("DeletePipeline", Dict{String, Any}("pipelineId"=>pipelineId, args...))
...
"""
DescribeObjects(objectIds, pipelineId) = data_pipeline("DescribeObjects", Dict{String, Any}("objectIds"=>objectIds, "pipelineId"=>pipelineId))
DescribeObjects(objectIds, pipelineId, args::AbstractDict{String, <: Any}) = data_pipeline("DescribeObjects", Dict{String, Any}("objectIds"=>objectIds, "pipelineId"=>pipelineId, args...))
...
"""
DescribePipelines(pipelineIds) = data_pipeline("DescribePipelines", Dict{String, Any}("pipelineIds"=>pipelineIds))
DescribePipelines(pipelineIds, args::AbstractDict{String, <: Any}) = data_pipeline("DescribePipelines", Dict{String, Any}("pipelineIds"=>pipelineIds, args...))
...
"""
EvaluateExpression(expression, objectId, pipelineId) = data_pipeline("EvaluateExpression", Dict{String, Any}("expression"=>expression, "objectId"=>objectId, "pipelineId"=>pipelineId))
EvaluateExpression(expression, objectId, pipelineId, args::AbstractDict{String, <: Any}) = data_pipeline("EvaluateExpression", Dict{String, Any}("expression"=>expression, "objectId"=>objectId, "pipelineId"=>pipelineId, args...))
...
"""
GetPipelineDefinition(pipelineId) = data_pipeline("GetPipelineDefinition", Dict{String, Any}("pipelineId"=>pipelineId))
GetPipelineDefinition(pipelineId, args::AbstractDict{String, <: Any}) = data_pipeline("GetPipelineDefinition", Dict{String, Any}("pipelineId"=>pipelineId, args...))
...
ListPipelines(args::AbstractDict{String, <: Any}) = data_pipeline("ListPipelines", args)
...
"""
PollForTask(workerGroup) = data_pipeline("PollForTask", Dict{String, Any}("workerGroup"=>workerGroup))
PollForTask(workerGroup, args::AbstractDict{String, <: Any}) = data_pipeline("PollForTask", Dict{String, Any}("workerGroup"=>workerGroup, args...))
...
"""
PutPipelineDefinition(pipelineId, pipelineObjects) = data_pipeline("PutPipelineDefinition", Dict{String, Any}("pipelineId"=>pipelineId, "pipelineObjects"=>pipelineObjects))
PutPipelineDefinition(pipelineId, pipelineObjects, args::AbstractDict{String, <: Any}) = data_pipeline("PutPipelineDefinition", Dict{String, Any}("pipelineId"=>pipelineId, "pipelineObjects"=>pipelineObjects, args...))
...
"""
QueryObjects(pipelineId, sphere) = data_pipeline("QueryObjects", Dict{String, Any}("pipelineId"=>pipelineId, "sphere"=>sphere))
QueryObjects(pipelineId, sphere, args::AbstractDict{String, <: Any}) = data_pipeline("QueryObjects", Dict{String, Any}("pipelineId"=>pipelineId, "sphere"=>sphere, args...))
...
"""
RemoveTags(pipelineId, tagKeys) = data_pipeline("RemoveTags", Dict{String, Any}("pipelineId"=>pipelineId, "tagKeys"=>tagKeys))
RemoveTags(pipelineId, tagKeys, args::AbstractDict{String, <: Any}) = data_pipeline("RemoveTags", Dict{String, Any}("pipelineId"=>pipelineId, "tagKeys"=>tagKeys, args...))
...
"""
ReportTaskProgress(taskId) = data_pipeline("ReportTaskProgress", Dict{String, Any}("taskId"=>taskId))
ReportTaskProgress(taskId, args::AbstractDict{String, <: Any}) = data_pipeline("ReportTaskProgress", Dict{String, Any}("taskId"=>taskId, args...))
...
"""
ReportTaskRunnerHeartbeat(taskrunnerId) = data_pipeline("ReportTaskRunnerHeartbeat", Dict{String, Any}("taskrunnerId"=>taskrunnerId))
ReportTaskRunnerHeartbeat(taskrunnerId, args::AbstractDict{String, <: Any}) = data_pipeline("ReportTaskRunnerHeartbeat", Dict{String, Any}("taskrunnerId"=>taskrunnerId, args...))
...
"""
SetStatus(objectIds, pipelineId, status) = data_pipeline("SetStatus", Dict{String, Any}("objectIds"=>objectIds, "pipelineId"=>pipelineId, "status"=>status))
SetStatus(objectIds, pipelineId, status, args::AbstractDict{String, <: Any}) = data_pipeline("SetStatus", Dict{String, Any}("objectIds"=>objectIds, "pipelineId"=>pipelineId, "status"=>status, args...))
...
"""
SetTaskStatus(taskId, taskStatus) = data_pipeline("SetTaskStatus", Dict{String, Any}("taskId"=>taskId, "taskStatus"=>taskStatus))
SetTaskStatus(taskId, taskStatus, args::AbstractDict{String, <: Any}) = data_pipeline("SetTaskStatus", Dict{String, Any}("taskId"=>taskId, "taskStatus"=>taskStatus, args...))
...
parameterValues => The parameter values used with the pipeline.
"""
ValidatePipelineDefinition(pipelineId, pipelineObjects) = data_pipeline("ValidatePipelineDefinition", Dict{String, Any}("pipelineId"=>pipelineId, "pipelineObjects"=>pipelineObjects))
ValidatePipelineDefinition(pipelineId, pipelineObjects, args::AbstractDict{String, <: Any}) = data_pipeline("ValidatePipelineDefinition", Dict{String, Any}("pipelineId"=>pipelineId, "pipelineObjects"=>pipelineObjects, args...))
