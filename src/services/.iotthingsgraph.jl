...
"""
AssociateEntityToThing(entityId, thingName) = iotthingsgraph("AssociateEntityToThing", Dict{String, Any}("entityId"=>entityId, "thingName"=>thingName))
AssociateEntityToThing(entityId, thingName, args::AbstractDict{String, <: Any}) = iotthingsgraph("AssociateEntityToThing", Dict{String, Any}("entityId"=>entityId, "thingName"=>thingName, args...))
...
"""
CreateFlowTemplate(definition) = iotthingsgraph("CreateFlowTemplate", Dict{String, Any}("definition"=>definition))
CreateFlowTemplate(definition, args::AbstractDict{String, <: Any}) = iotthingsgraph("CreateFlowTemplate", Dict{String, Any}("definition"=>definition, args...))
...
"""
CreateSystemInstance(definition, target) = iotthingsgraph("CreateSystemInstance", Dict{String, Any}("definition"=>definition, "target"=>target))
CreateSystemInstance(definition, target, args::AbstractDict{String, <: Any}) = iotthingsgraph("CreateSystemInstance", Dict{String, Any}("definition"=>definition, "target"=>target, args...))
...
"""
CreateSystemTemplate(definition) = iotthingsgraph("CreateSystemTemplate", Dict{String, Any}("definition"=>definition))
CreateSystemTemplate(definition, args::AbstractDict{String, <: Any}) = iotthingsgraph("CreateSystemTemplate", Dict{String, Any}("definition"=>definition, args...))
...
"""
DeleteFlowTemplate(id) = iotthingsgraph("DeleteFlowTemplate", Dict{String, Any}("id"=>id))
DeleteFlowTemplate(id, args::AbstractDict{String, <: Any}) = iotthingsgraph("DeleteFlowTemplate", Dict{String, Any}("id"=>id, args...))
...
DeleteNamespace(args::AbstractDict{String, <: Any}) = iotthingsgraph("DeleteNamespace", args)
...
DeleteSystemInstance(args::AbstractDict{String, <: Any}) = iotthingsgraph("DeleteSystemInstance", args)
...
"""
DeleteSystemTemplate(id) = iotthingsgraph("DeleteSystemTemplate", Dict{String, Any}("id"=>id))
DeleteSystemTemplate(id, args::AbstractDict{String, <: Any}) = iotthingsgraph("DeleteSystemTemplate", Dict{String, Any}("id"=>id, args...))
...
DeploySystemInstance(args::AbstractDict{String, <: Any}) = iotthingsgraph("DeploySystemInstance", args)
...
"""
DeprecateFlowTemplate(id) = iotthingsgraph("DeprecateFlowTemplate", Dict{String, Any}("id"=>id))
DeprecateFlowTemplate(id, args::AbstractDict{String, <: Any}) = iotthingsgraph("DeprecateFlowTemplate", Dict{String, Any}("id"=>id, args...))
...
"""
DeprecateSystemTemplate(id) = iotthingsgraph("DeprecateSystemTemplate", Dict{String, Any}("id"=>id))
DeprecateSystemTemplate(id, args::AbstractDict{String, <: Any}) = iotthingsgraph("DeprecateSystemTemplate", Dict{String, Any}("id"=>id, args...))
...
DescribeNamespace(args::AbstractDict{String, <: Any}) = iotthingsgraph("DescribeNamespace", args)
...
"""
DissociateEntityFromThing(entityType, thingName) = iotthingsgraph("DissociateEntityFromThing", Dict{String, Any}("entityType"=>entityType, "thingName"=>thingName))
DissociateEntityFromThing(entityType, thingName, args::AbstractDict{String, <: Any}) = iotthingsgraph("DissociateEntityFromThing", Dict{String, Any}("entityType"=>entityType, "thingName"=>thingName, args...))
...
namespaceVersion => The version of the user's namespace. Defaults to the latest version of the user's namespace.
"""
GetEntities(ids) = iotthingsgraph("GetEntities", Dict{String, Any}("ids"=>ids))
GetEntities(ids, args::AbstractDict{String, <: Any}) = iotthingsgraph("GetEntities", Dict{String, Any}("ids"=>ids, args...))
...
"""
GetFlowTemplate(id) = iotthingsgraph("GetFlowTemplate", Dict{String, Any}("id"=>id))
GetFlowTemplate(id, args::AbstractDict{String, <: Any}) = iotthingsgraph("GetFlowTemplate", Dict{String, Any}("id"=>id, args...))
...
"""
GetFlowTemplateRevisions(id) = iotthingsgraph("GetFlowTemplateRevisions", Dict{String, Any}("id"=>id))
GetFlowTemplateRevisions(id, args::AbstractDict{String, <: Any}) = iotthingsgraph("GetFlowTemplateRevisions", Dict{String, Any}("id"=>id, args...))
...
GetNamespaceDeletionStatus(args::AbstractDict{String, <: Any}) = iotthingsgraph("GetNamespaceDeletionStatus", args)
...
"""
GetSystemInstance(id) = iotthingsgraph("GetSystemInstance", Dict{String, Any}("id"=>id))
GetSystemInstance(id, args::AbstractDict{String, <: Any}) = iotthingsgraph("GetSystemInstance", Dict{String, Any}("id"=>id, args...))
...
"""
GetSystemTemplate(id) = iotthingsgraph("GetSystemTemplate", Dict{String, Any}("id"=>id))
GetSystemTemplate(id, args::AbstractDict{String, <: Any}) = iotthingsgraph("GetSystemTemplate", Dict{String, Any}("id"=>id, args...))
...
nextToken => The string that specifies the next page of results. Use this when you're paginating results.
"""
GetSystemTemplateRevisions(id) = iotthingsgraph("GetSystemTemplateRevisions", Dict{String, Any}("id"=>id))
GetSystemTemplateRevisions(id, args::AbstractDict{String, <: Any}) = iotthingsgraph("GetSystemTemplateRevisions", Dict{String, Any}("id"=>id, args...))
...
"""
GetUploadStatus(uploadId) = iotthingsgraph("GetUploadStatus", Dict{String, Any}("uploadId"=>uploadId))
GetUploadStatus(uploadId, args::AbstractDict{String, <: Any}) = iotthingsgraph("GetUploadStatus", Dict{String, Any}("uploadId"=>uploadId, args...))
...
nextToken => The string that specifies the next page of results. Use this when you're paginating results.
"""
ListFlowExecutionMessages(flowExecutionId) = iotthingsgraph("ListFlowExecutionMessages", Dict{String, Any}("flowExecutionId"=>flowExecutionId))
ListFlowExecutionMessages(flowExecutionId, args::AbstractDict{String, <: Any}) = iotthingsgraph("ListFlowExecutionMessages", Dict{String, Any}("flowExecutionId"=>flowExecutionId, args...))
...
"""
ListTagsForResource(resourceArn) = iotthingsgraph("ListTagsForResource", Dict{String, Any}("resourceArn"=>resourceArn))
ListTagsForResource(resourceArn, args::AbstractDict{String, <: Any}) = iotthingsgraph("ListTagsForResource", Dict{String, Any}("resourceArn"=>resourceArn, args...))
...
nextToken => The string that specifies the next page of results. Use this when you're paginating results.
"""
SearchEntities(entityTypes) = iotthingsgraph("SearchEntities", Dict{String, Any}("entityTypes"=>entityTypes))
SearchEntities(entityTypes, args::AbstractDict{String, <: Any}) = iotthingsgraph("SearchEntities", Dict{String, Any}("entityTypes"=>entityTypes, args...))
...
"""
SearchFlowExecutions(systemInstanceId) = iotthingsgraph("SearchFlowExecutions", Dict{String, Any}("systemInstanceId"=>systemInstanceId))
SearchFlowExecutions(systemInstanceId, args::AbstractDict{String, <: Any}) = iotthingsgraph("SearchFlowExecutions", Dict{String, Any}("systemInstanceId"=>systemInstanceId, args...))
...
SearchFlowTemplates(args::AbstractDict{String, <: Any}) = iotthingsgraph("SearchFlowTemplates", args)
...
SearchSystemInstances(args::AbstractDict{String, <: Any}) = iotthingsgraph("SearchSystemInstances", args)
...
SearchSystemTemplates(args::AbstractDict{String, <: Any}) = iotthingsgraph("SearchSystemTemplates", args)
...
nextToken => The string that specifies the next page of results. Use this when you're paginating results.
"""
SearchThings(entityId) = iotthingsgraph("SearchThings", Dict{String, Any}("entityId"=>entityId))
SearchThings(entityId, args::AbstractDict{String, <: Any}) = iotthingsgraph("SearchThings", Dict{String, Any}("entityId"=>entityId, args...))
...
"""
TagResource(resourceArn, tags) = iotthingsgraph("TagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags))
TagResource(resourceArn, tags, args::AbstractDict{String, <: Any}) = iotthingsgraph("TagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags, args...))
...
UndeploySystemInstance(args::AbstractDict{String, <: Any}) = iotthingsgraph("UndeploySystemInstance", args)
...
"""
UntagResource(resourceArn, tagKeys) = iotthingsgraph("UntagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys))
UntagResource(resourceArn, tagKeys, args::AbstractDict{String, <: Any}) = iotthingsgraph("UntagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys, args...))
...
"""
UpdateFlowTemplate(definition, id) = iotthingsgraph("UpdateFlowTemplate", Dict{String, Any}("definition"=>definition, "id"=>id))
UpdateFlowTemplate(definition, id, args::AbstractDict{String, <: Any}) = iotthingsgraph("UpdateFlowTemplate", Dict{String, Any}("definition"=>definition, "id"=>id, args...))
...
"""
UpdateSystemTemplate(definition, id) = iotthingsgraph("UpdateSystemTemplate", Dict{String, Any}("definition"=>definition, "id"=>id))
UpdateSystemTemplate(definition, id, args::AbstractDict{String, <: Any}) = iotthingsgraph("UpdateSystemTemplate", Dict{String, Any}("definition"=>definition, "id"=>id, args...))
...
UploadEntityDefinitions(args::AbstractDict{String, <: Any}) = iotthingsgraph("UploadEntityDefinitions", args)
