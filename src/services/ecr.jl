...
- `image_ids`: A list of image ID references that correspond to images to delete. The format
...
"""
function batch_get_repository_scanning_configuration end
...
- `ecr_repository_prefix`: The Amazon ECR repository prefix associated with the pull through
...
- `"registryId"`: The Amazon Web Services account ID associated with the registry that
  ...
  registry is assumed.
"""
function delete_pull_through_cache_rule end
...
"""
function delete_registry_policy end

function delete_registry_policy(; aws_config::AbstractAWSConfig=current_aws_config())
    return ecr("DeleteRegistryPolicy"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function delete_registry_policy(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return ecr("DeleteRegistryPolicy", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"registryId"`: The Amazon Web Services account ID associated with the registry. If you do
  not specify a registry, the default registry is assumed.
"""
function describe_image_replication_status end
...
"""
function describe_image_scan_findings end
...
- `"maxResults"`: The maximum number of pull through cache rules returned by
  ...
  returned `nextToken` value. This value can be between 1 and 1000. If this parameter is not
  used, then `DescribePullThroughCacheRulesRequest` returns up to 100 results and a
...
function describe_pull_through_cache_rules(;
    ...
    return ecr("DescribePullThroughCacheRules"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_pull_through_cache_rules(
    ...
    return ecr(
        "DescribePullThroughCacheRules", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
created or updated with the [`put_replication_configuration`](@ref) API action.
"""
function describe_registry end

function describe_registry(; aws_config::AbstractAWSConfig=current_aws_config())
    return ecr("DescribeRegistry"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function describe_registry(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return ecr("DescribeRegistry", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function describe_repositories(; aws_config::AbstractAWSConfig=current_aws_config())
    return ecr("DescribeRepositories"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function describe_repositories(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return ecr("DescribeRepositories", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
The `authorizationToken` returned is a base64 encoded string that can be decoded and used in
a `docker login` command to authenticate to a registry. The CLI offers an
...
function get_authorization_token(; aws_config::AbstractAWSConfig=current_aws_config())
    return ecr("GetAuthorizationToken"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_authorization_token(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return ecr("GetAuthorizationToken", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
- `"registryId"`: The Amazon Web Services account ID associated with the registry that
  ...
  registry is assumed.
"""
function get_download_url_for_layer end
...
- `"registryId"`: The Amazon Web Services account ID associated with the registry that
  ...
  assumed.
"""
function get_lifecycle_policy_preview end
...
"""
function get_registry_policy end

function get_registry_policy(; aws_config::AbstractAWSConfig=current_aws_config())
    return ecr("GetRegistryPolicy"; aws_config, feature_set=SERVICE_FEATURE_SET)
end

function get_registry_policy(
    params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return ecr("GetRegistryPolicy", params; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
"""
function get_registry_scanning_configuration end

function get_registry_scanning_configuration(;
    aws_config::AbstractAWSConfig=current_aws_config()
)
    return ecr(
        "GetRegistryScanningConfiguration"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
not already been uploaded. Whether or not an image layer has been uploaded is determined by
...
filter and specifying either `TAGGED`, `UNTAGGED` or `ANY`. For example, you can filter your
results to return only `UNTAGGED` images and then pipe that result to a [`batch_delete_image`](@ref)
...
function list_images(repositoryName; aws_config::AbstractAWSConfig=current_aws_config())
    return ecr(
        "ListImages",
        Dict{String,Any}("repositoryName" => repositoryName);
        aws_config,
...
"""
function put_image_scanning_configuration end
...
- `"registryId"`: The Amazon Web Services account ID associated with the registry that
  ...
  not specify a registry, the default registry is assumed.
"""
function put_image_tag_mutability end

function put_image_tag_mutability(
    imageTagMutability, repositoryName; aws_config::AbstractAWSConfig=current_aws_config()
)
    return ecr(
...
function put_lifecycle_policy(
    lifecyclePolicyText, repositoryName; aws_config::AbstractAWSConfig=current_aws_config()
)
    return ecr(
        "PutLifecyclePolicy",
        Dict{String,Any}(
...
is used when configuring cross-account replication. For more information, see [Registry permissions](https://docs.aws.amazon.com/AmazonECR/latest/userguide/registry-permissions.html)
in the *Amazon Elastic Container Registry User Guide*.

# Arguments

- `policy_text`: The JSON policy text to apply to your registry. The policy text follows the
  ...
  in the *Amazon Elastic Container Registry User Guide*.
"""
function put_registry_policy end

function put_registry_policy(policyText; aws_config::AbstractAWSConfig=current_aws_config())
    return ecr(
        "PutRegistryPolicy",
...
- `"scanType"`: The scanning type to set for the registry.
  ...
  used. When basic scanning is used, you may specify filters to determine which individual
  repositories, or all repositories, are scanned when new images are pushed to those
...
function put_registry_scanning_configuration(;
    ...
    return ecr(
        "PutRegistryScanningConfiguration"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
- `replication_configuration`: An object representing the replication configuration for a
  registry.
"""
function put_replication_configuration end

function put_replication_configuration(
    replicationConfiguration; aws_config::AbstractAWSConfig=current_aws_config()
)
    return ecr(
...
- `"registryId"`: The Amazon Web Services account ID associated with the registry that
  ...
  assumed.
"""
function start_lifecycle_policy_preview end
...
image layer part can be 20971520 bytes (or about 20MB). The UploadLayerPart API is called
...
- `ecr_repository_prefix`: The repository name prefix associated with the pull through cache
  rule.
...
- `"registryId"`: The registry ID associated with the pull through cache rule. If you do not
  specify a registry, the default registry is assumed.
"""
function validate_pull_through_cache_rule end
