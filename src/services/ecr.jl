...
BatchCheckLayerAvailability(layerDigests, repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("BatchCheckLayerAvailability", Dict{String, Any}("layerDigests"=>layerDigests, "repositoryName"=>repositoryName); aws_config=aws_config)
BatchCheckLayerAvailability(layerDigests, repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("BatchCheckLayerAvailability", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("layerDigests"=>layerDigests, "repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
BatchDeleteImage(imageIds, repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("BatchDeleteImage", Dict{String, Any}("imageIds"=>imageIds, "repositoryName"=>repositoryName); aws_config=aws_config)
BatchDeleteImage(imageIds, repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("BatchDeleteImage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageIds"=>imageIds, "repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
BatchGetImage(imageIds, repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("BatchGetImage", Dict{String, Any}("imageIds"=>imageIds, "repositoryName"=>repositoryName); aws_config=aws_config)
BatchGetImage(imageIds, repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("BatchGetImage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageIds"=>imageIds, "repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
CompleteLayerUpload(layerDigests, repositoryName, uploadId; aws_config::AWSConfig=AWS.aws_config) = ecr("CompleteLayerUpload", Dict{String, Any}("layerDigests"=>layerDigests, "repositoryName"=>repositoryName, "uploadId"=>uploadId); aws_config=aws_config)
CompleteLayerUpload(layerDigests, repositoryName, uploadId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("CompleteLayerUpload", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("layerDigests"=>layerDigests, "repositoryName"=>repositoryName, "uploadId"=>uploadId), args)); aws_config=aws_config)
...
CreateRepository(repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("CreateRepository", Dict{String, Any}("repositoryName"=>repositoryName); aws_config=aws_config)
CreateRepository(repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("CreateRepository", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
DeleteLifecyclePolicy(repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("DeleteLifecyclePolicy", Dict{String, Any}("repositoryName"=>repositoryName); aws_config=aws_config)
DeleteLifecyclePolicy(repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("DeleteLifecyclePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
DeleteRepository(repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("DeleteRepository", Dict{String, Any}("repositoryName"=>repositoryName); aws_config=aws_config)
DeleteRepository(repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("DeleteRepository", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
DeleteRepositoryPolicy(repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("DeleteRepositoryPolicy", Dict{String, Any}("repositoryName"=>repositoryName); aws_config=aws_config)
DeleteRepositoryPolicy(repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("DeleteRepositoryPolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
DescribeImageScanFindings(imageId, repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("DescribeImageScanFindings", Dict{String, Any}("imageId"=>imageId, "repositoryName"=>repositoryName); aws_config=aws_config)
DescribeImageScanFindings(imageId, repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("DescribeImageScanFindings", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageId"=>imageId, "repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
DescribeImages(repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("DescribeImages", Dict{String, Any}("repositoryName"=>repositoryName); aws_config=aws_config)
DescribeImages(repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("DescribeImages", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
DescribeRepositories(; aws_config::AWSConfig=AWS.aws_config) = ecr("DescribeRepositories"; aws_config=aws_config)
DescribeRepositories(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("DescribeRepositories", args; aws_config=aws_config)
...
GetAuthorizationToken(; aws_config::AWSConfig=AWS.aws_config) = ecr("GetAuthorizationToken"; aws_config=aws_config)
GetAuthorizationToken(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("GetAuthorizationToken", args; aws_config=aws_config)
...
GetDownloadUrlForLayer(layerDigest, repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("GetDownloadUrlForLayer", Dict{String, Any}("layerDigest"=>layerDigest, "repositoryName"=>repositoryName); aws_config=aws_config)
GetDownloadUrlForLayer(layerDigest, repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("GetDownloadUrlForLayer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("layerDigest"=>layerDigest, "repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
GetLifecyclePolicy(repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("GetLifecyclePolicy", Dict{String, Any}("repositoryName"=>repositoryName); aws_config=aws_config)
GetLifecyclePolicy(repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("GetLifecyclePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
GetLifecyclePolicyPreview(repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("GetLifecyclePolicyPreview", Dict{String, Any}("repositoryName"=>repositoryName); aws_config=aws_config)
GetLifecyclePolicyPreview(repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("GetLifecyclePolicyPreview", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
GetRepositoryPolicy(repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("GetRepositoryPolicy", Dict{String, Any}("repositoryName"=>repositoryName); aws_config=aws_config)
GetRepositoryPolicy(repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("GetRepositoryPolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
InitiateLayerUpload(repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("InitiateLayerUpload", Dict{String, Any}("repositoryName"=>repositoryName); aws_config=aws_config)
InitiateLayerUpload(repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("InitiateLayerUpload", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
ListImages(repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("ListImages", Dict{String, Any}("repositoryName"=>repositoryName); aws_config=aws_config)
ListImages(repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("ListImages", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
ListTagsForResource(resourceArn; aws_config::AWSConfig=AWS.aws_config) = ecr("ListTagsForResource", Dict{String, Any}("resourceArn"=>resourceArn); aws_config=aws_config)
ListTagsForResource(resourceArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceArn"=>resourceArn), args)); aws_config=aws_config)
...
PutImage(imageManifest, repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("PutImage", Dict{String, Any}("imageManifest"=>imageManifest, "repositoryName"=>repositoryName); aws_config=aws_config)
PutImage(imageManifest, repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("PutImage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageManifest"=>imageManifest, "repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
PutImageScanningConfiguration(imageScanningConfiguration, repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("PutImageScanningConfiguration", Dict{String, Any}("imageScanningConfiguration"=>imageScanningConfiguration, "repositoryName"=>repositoryName); aws_config=aws_config)
PutImageScanningConfiguration(imageScanningConfiguration, repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("PutImageScanningConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageScanningConfiguration"=>imageScanningConfiguration, "repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
PutImageTagMutability(imageTagMutability, repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("PutImageTagMutability", Dict{String, Any}("imageTagMutability"=>imageTagMutability, "repositoryName"=>repositoryName); aws_config=aws_config)
PutImageTagMutability(imageTagMutability, repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("PutImageTagMutability", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageTagMutability"=>imageTagMutability, "repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
PutLifecyclePolicy(lifecyclePolicyText, repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("PutLifecyclePolicy", Dict{String, Any}("lifecyclePolicyText"=>lifecyclePolicyText, "repositoryName"=>repositoryName); aws_config=aws_config)
PutLifecyclePolicy(lifecyclePolicyText, repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("PutLifecyclePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("lifecyclePolicyText"=>lifecyclePolicyText, "repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
SetRepositoryPolicy(policyText, repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("SetRepositoryPolicy", Dict{String, Any}("policyText"=>policyText, "repositoryName"=>repositoryName); aws_config=aws_config)
SetRepositoryPolicy(policyText, repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("SetRepositoryPolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("policyText"=>policyText, "repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
StartImageScan(imageId, repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("StartImageScan", Dict{String, Any}("imageId"=>imageId, "repositoryName"=>repositoryName); aws_config=aws_config)
StartImageScan(imageId, repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("StartImageScan", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageId"=>imageId, "repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
StartLifecyclePolicyPreview(repositoryName; aws_config::AWSConfig=AWS.aws_config) = ecr("StartLifecyclePolicyPreview", Dict{String, Any}("repositoryName"=>repositoryName); aws_config=aws_config)
StartLifecyclePolicyPreview(repositoryName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("StartLifecyclePolicyPreview", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws_config=aws_config)
...
TagResource(resourceArn, tags; aws_config::AWSConfig=AWS.aws_config) = ecr("TagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags); aws_config=aws_config)
TagResource(resourceArn, tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags), args)); aws_config=aws_config)
...
UntagResource(resourceArn, tagKeys; aws_config::AWSConfig=AWS.aws_config) = ecr("UntagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys); aws_config=aws_config)
UntagResource(resourceArn, tagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = ecr("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys), args)); aws_config=aws_config)
