...
"""
BatchCheckLayerAvailability(layerDigests, repositoryName; aws::AWSConfig=AWSConfig()) = ecr("BatchCheckLayerAvailability", Dict{String, Any}("layerDigests"=>layerDigests, "repositoryName"=>repositoryName); aws=aws)
BatchCheckLayerAvailability(layerDigests, repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("BatchCheckLayerAvailability", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("layerDigests"=>layerDigests, "repositoryName"=>repositoryName), args)); aws=aws)
...
"""
BatchDeleteImage(imageIds, repositoryName; aws::AWSConfig=AWSConfig()) = ecr("BatchDeleteImage", Dict{String, Any}("imageIds"=>imageIds, "repositoryName"=>repositoryName); aws=aws)
BatchDeleteImage(imageIds, repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("BatchDeleteImage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageIds"=>imageIds, "repositoryName"=>repositoryName), args)); aws=aws)
...
"""
BatchGetImage(imageIds, repositoryName; aws::AWSConfig=AWSConfig()) = ecr("BatchGetImage", Dict{String, Any}("imageIds"=>imageIds, "repositoryName"=>repositoryName); aws=aws)
BatchGetImage(imageIds, repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("BatchGetImage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageIds"=>imageIds, "repositoryName"=>repositoryName), args)); aws=aws)
...
"""
CompleteLayerUpload(layerDigests, repositoryName, uploadId; aws::AWSConfig=AWSConfig()) = ecr("CompleteLayerUpload", Dict{String, Any}("layerDigests"=>layerDigests, "repositoryName"=>repositoryName, "uploadId"=>uploadId); aws=aws)
CompleteLayerUpload(layerDigests, repositoryName, uploadId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("CompleteLayerUpload", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("layerDigests"=>layerDigests, "repositoryName"=>repositoryName, "uploadId"=>uploadId), args)); aws=aws)
...
"""
CreateRepository(repositoryName; aws::AWSConfig=AWSConfig()) = ecr("CreateRepository", Dict{String, Any}("repositoryName"=>repositoryName); aws=aws)
CreateRepository(repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("CreateRepository", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws=aws)
...
"""
DeleteLifecyclePolicy(repositoryName; aws::AWSConfig=AWSConfig()) = ecr("DeleteLifecyclePolicy", Dict{String, Any}("repositoryName"=>repositoryName); aws=aws)
DeleteLifecyclePolicy(repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("DeleteLifecyclePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws=aws)
...
"""
DeleteRepository(repositoryName; aws::AWSConfig=AWSConfig()) = ecr("DeleteRepository", Dict{String, Any}("repositoryName"=>repositoryName); aws=aws)
DeleteRepository(repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("DeleteRepository", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws=aws)
...
"""
DeleteRepositoryPolicy(repositoryName; aws::AWSConfig=AWSConfig()) = ecr("DeleteRepositoryPolicy", Dict{String, Any}("repositoryName"=>repositoryName); aws=aws)
DeleteRepositoryPolicy(repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("DeleteRepositoryPolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws=aws)
...
"""
DescribeImageScanFindings(imageId, repositoryName; aws::AWSConfig=AWSConfig()) = ecr("DescribeImageScanFindings", Dict{String, Any}("imageId"=>imageId, "repositoryName"=>repositoryName); aws=aws)
DescribeImageScanFindings(imageId, repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("DescribeImageScanFindings", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageId"=>imageId, "repositoryName"=>repositoryName), args)); aws=aws)
...
"""
DescribeImages(repositoryName; aws::AWSConfig=AWSConfig()) = ecr("DescribeImages", Dict{String, Any}("repositoryName"=>repositoryName); aws=aws)
DescribeImages(repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("DescribeImages", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws=aws)
...
"""
DescribeRepositories(; aws::AWSConfig=AWSConfig()) = ecr("DescribeRepositories"; aws=aws)
DescribeRepositories(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("DescribeRepositories", args; aws=aws)
...
"""
GetAuthorizationToken(; aws::AWSConfig=AWSConfig()) = ecr("GetAuthorizationToken"; aws=aws)
GetAuthorizationToken(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("GetAuthorizationToken", args; aws=aws)
...
"""
GetDownloadUrlForLayer(layerDigest, repositoryName; aws::AWSConfig=AWSConfig()) = ecr("GetDownloadUrlForLayer", Dict{String, Any}("layerDigest"=>layerDigest, "repositoryName"=>repositoryName); aws=aws)
GetDownloadUrlForLayer(layerDigest, repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("GetDownloadUrlForLayer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("layerDigest"=>layerDigest, "repositoryName"=>repositoryName), args)); aws=aws)
...
- `registryId`: The AWS account ID associated with the registry that contains the repository. If you do not specify a registry, the default registry is assumed.
"""
GetLifecyclePolicy(repositoryName; aws::AWSConfig=AWSConfig()) = ecr("GetLifecyclePolicy", Dict{String, Any}("repositoryName"=>repositoryName); aws=aws)
GetLifecyclePolicy(repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("GetLifecyclePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws=aws)
...
- `registryId`: The AWS account ID associated with the registry that contains the repository. If you do not specify a registry, the default registry is assumed.
"""
GetLifecyclePolicyPreview(repositoryName; aws::AWSConfig=AWSConfig()) = ecr("GetLifecyclePolicyPreview", Dict{String, Any}("repositoryName"=>repositoryName); aws=aws)
GetLifecyclePolicyPreview(repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("GetLifecyclePolicyPreview", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws=aws)
...
- `registryId`: The AWS account ID associated with the registry that contains the repository. If you do not specify a registry, the default registry is assumed.
"""
GetRepositoryPolicy(repositoryName; aws::AWSConfig=AWSConfig()) = ecr("GetRepositoryPolicy", Dict{String, Any}("repositoryName"=>repositoryName); aws=aws)
GetRepositoryPolicy(repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("GetRepositoryPolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws=aws)
...
"""
InitiateLayerUpload(repositoryName; aws::AWSConfig=AWSConfig()) = ecr("InitiateLayerUpload", Dict{String, Any}("repositoryName"=>repositoryName); aws=aws)
InitiateLayerUpload(repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("InitiateLayerUpload", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws=aws)
...
"""
ListImages(repositoryName; aws::AWSConfig=AWSConfig()) = ecr("ListImages", Dict{String, Any}("repositoryName"=>repositoryName); aws=aws)
ListImages(repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("ListImages", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws=aws)
...
"""
ListTagsForResource(resourceArn; aws::AWSConfig=AWSConfig()) = ecr("ListTagsForResource", Dict{String, Any}("resourceArn"=>resourceArn); aws=aws)
ListTagsForResource(resourceArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceArn"=>resourceArn), args)); aws=aws)
...
"""
PutImage(imageManifest, repositoryName; aws::AWSConfig=AWSConfig()) = ecr("PutImage", Dict{String, Any}("imageManifest"=>imageManifest, "repositoryName"=>repositoryName); aws=aws)
PutImage(imageManifest, repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("PutImage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageManifest"=>imageManifest, "repositoryName"=>repositoryName), args)); aws=aws)
...
"""
PutImageScanningConfiguration(imageScanningConfiguration, repositoryName; aws::AWSConfig=AWSConfig()) = ecr("PutImageScanningConfiguration", Dict{String, Any}("imageScanningConfiguration"=>imageScanningConfiguration, "repositoryName"=>repositoryName); aws=aws)
PutImageScanningConfiguration(imageScanningConfiguration, repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("PutImageScanningConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageScanningConfiguration"=>imageScanningConfiguration, "repositoryName"=>repositoryName), args)); aws=aws)
...
"""
PutImageTagMutability(imageTagMutability, repositoryName; aws::AWSConfig=AWSConfig()) = ecr("PutImageTagMutability", Dict{String, Any}("imageTagMutability"=>imageTagMutability, "repositoryName"=>repositoryName); aws=aws)
PutImageTagMutability(imageTagMutability, repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("PutImageTagMutability", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageTagMutability"=>imageTagMutability, "repositoryName"=>repositoryName), args)); aws=aws)
...
- `registryId`: The AWS account ID associated with the registry that contains the repository. If you do&#x2028; not specify a registry, the default registry is assumed.
"""
PutLifecyclePolicy(lifecyclePolicyText, repositoryName; aws::AWSConfig=AWSConfig()) = ecr("PutLifecyclePolicy", Dict{String, Any}("lifecyclePolicyText"=>lifecyclePolicyText, "repositoryName"=>repositoryName); aws=aws)
PutLifecyclePolicy(lifecyclePolicyText, repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("PutLifecyclePolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("lifecyclePolicyText"=>lifecyclePolicyText, "repositoryName"=>repositoryName), args)); aws=aws)
...
- `registryId`: The AWS account ID associated with the registry that contains the repository. If you do not specify a registry, the default registry is assumed.
"""
SetRepositoryPolicy(policyText, repositoryName; aws::AWSConfig=AWSConfig()) = ecr("SetRepositoryPolicy", Dict{String, Any}("policyText"=>policyText, "repositoryName"=>repositoryName); aws=aws)
SetRepositoryPolicy(policyText, repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("SetRepositoryPolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("policyText"=>policyText, "repositoryName"=>repositoryName), args)); aws=aws)
...
"""
StartImageScan(imageId, repositoryName; aws::AWSConfig=AWSConfig()) = ecr("StartImageScan", Dict{String, Any}("imageId"=>imageId, "repositoryName"=>repositoryName); aws=aws)
StartImageScan(imageId, repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("StartImageScan", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("imageId"=>imageId, "repositoryName"=>repositoryName), args)); aws=aws)
...
- `registryId`: The AWS account ID associated with the registry that contains the repository. If you do not specify a registry, the default registry is assumed.
"""
StartLifecyclePolicyPreview(repositoryName; aws::AWSConfig=AWSConfig()) = ecr("StartLifecyclePolicyPreview", Dict{String, Any}("repositoryName"=>repositoryName); aws=aws)
StartLifecyclePolicyPreview(repositoryName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("StartLifecyclePolicyPreview", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("repositoryName"=>repositoryName), args)); aws=aws)
...
"""
TagResource(resourceArn, tags; aws::AWSConfig=AWSConfig()) = ecr("TagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags); aws=aws)
TagResource(resourceArn, tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceArn"=>resourceArn, "tags"=>tags), args)); aws=aws)
...
"""
UntagResource(resourceArn, tagKeys; aws::AWSConfig=AWSConfig()) = ecr("UntagResource", Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys); aws=aws)
UntagResource(resourceArn, tagKeys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("resourceArn"=>resourceArn, "tagKeys"=>tagKeys), args)); aws=aws)
...
"""
UploadLayerPart(layerPartBlob, partFirstByte, partLastByte, repositoryName, uploadId; aws::AWSConfig=AWSConfig()) = ecr("UploadLayerPart", Dict{String, Any}("layerPartBlob"=>layerPartBlob, "partFirstByte"=>partFirstByte, "partLastByte"=>partLastByte, "repositoryName"=>repositoryName, "uploadId"=>uploadId); aws=aws)
UploadLayerPart(layerPartBlob, partFirstByte, partLastByte, repositoryName, uploadId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ecr("UploadLayerPart", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("layerPartBlob"=>layerPartBlob, "partFirstByte"=>partFirstByte, "partLastByte"=>partLastByte, "repositoryName"=>repositoryName, "uploadId"=>uploadId), args)); aws=aws)
