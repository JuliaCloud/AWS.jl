...
function get_device(id; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_thin_client(
        "GET", "/devices/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_device(
    ...
    return workspaces_thin_client(
        "GET", "/devices/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_environment(id; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_thin_client(
        "GET", "/environments/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_environment(
    ...
    return workspaces_thin_client(
        "GET", "/environments/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_software_set(id; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_thin_client(
        "GET", "/softwaresets/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_software_set(
    ...
    return workspaces_thin_client(
        "GET", "/softwaresets/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_environments(; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_thin_client(
        "GET", "/environments"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_environments(
    ...
    return workspaces_thin_client(
        "GET", "/environments", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_software_sets(; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_thin_client(
        "GET", "/softwaresets"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_software_sets(
    ...
    return workspaces_thin_client(
        "GET", "/softwaresets", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_device(id; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_thin_client(
        "PATCH", "/devices/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_device(
    ...
    return workspaces_thin_client(
        "PATCH", "/devices/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_environment(id; aws_config::AbstractAWSConfig=current_aws_config())
    return workspaces_thin_client(
        "PATCH", "/environments/$(id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_environment(
    ...
    return workspaces_thin_client(
        "PATCH", "/environments/$(id)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
