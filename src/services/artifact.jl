...
function get_account_settings(; aws_config::AbstractAWSConfig=current_aws_config())
    return artifact(
        "GET", "/v1/account-settings/get"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_reports(; aws_config::AbstractAWSConfig=current_aws_config())
    return artifact("GET", "/v1/report/list"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_reports(
    ...
    return artifact(
        "GET", "/v1/report/list", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function put_account_settings(; aws_config::AbstractAWSConfig=current_aws_config())
    return artifact(
        "PUT", "/v1/account-settings/put"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
