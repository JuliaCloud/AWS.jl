...
"""
AssociateExternalConnection(domain, externalConnection, repository) = codeartifact("POST", "/v1/repository/external-connection")
AssociateExternalConnection(domain, externalConnection, repository, args) = codeartifact("POST", "/v1/repository/external-connection", args)
...
"""
CopyPackageVersions(destinationRepository, domain, format, package, sourceRepository) = codeartifact("POST", "/v1/package/versions/copy")
CopyPackageVersions(destinationRepository, domain, format, package, sourceRepository, args) = codeartifact("POST", "/v1/package/versions/copy", args)
...
"""
CreateDomain(domain) = codeartifact("POST", "/v1/domain")
CreateDomain(domain, args) = codeartifact("POST", "/v1/domain", args)
...
"""
CreateRepository(domain, repository) = codeartifact("POST", "/v1/repository")
CreateRepository(domain, repository, args) = codeartifact("POST", "/v1/repository", args)
...
"""
DeleteDomain(domain) = codeartifact("DELETE", "/v1/domain")
DeleteDomain(domain, args) = codeartifact("DELETE", "/v1/domain", args)
...
"""
DeleteDomainPermissionsPolicy(domain) = codeartifact("DELETE", "/v1/domain/permissions/policy")
DeleteDomainPermissionsPolicy(domain, args) = codeartifact("DELETE", "/v1/domain/permissions/policy", args)
...
"""
DeletePackageVersions(domain, format, package, repository, versions) = codeartifact("POST", "/v1/package/versions/delete")
DeletePackageVersions(domain, format, package, repository, versions, args) = codeartifact("POST", "/v1/package/versions/delete", args)
...
"""
DeleteRepository(domain, repository) = codeartifact("DELETE", "/v1/repository")
DeleteRepository(domain, repository, args) = codeartifact("DELETE", "/v1/repository", args)
...
"""
DeleteRepositoryPermissionsPolicy(domain, repository) = codeartifact("DELETE", "/v1/repository/permissions/policies")
DeleteRepositoryPermissionsPolicy(domain, repository, args) = codeartifact("DELETE", "/v1/repository/permissions/policies", args)
...
"""
DescribeDomain(domain) = codeartifact("GET", "/v1/domain")
DescribeDomain(domain, args) = codeartifact("GET", "/v1/domain", args)
...
"""
DescribePackageVersion(domain, format, package, packageVersion, repository) = codeartifact("GET", "/v1/package/version")
DescribePackageVersion(domain, format, package, packageVersion, repository, args) = codeartifact("GET", "/v1/package/version", args)
...
"""
DescribeRepository(domain, repository) = codeartifact("GET", "/v1/repository")
DescribeRepository(domain, repository, args) = codeartifact("GET", "/v1/repository", args)
...
"""
DisassociateExternalConnection(domain, externalConnection, repository) = codeartifact("DELETE", "/v1/repository/external-connection")
DisassociateExternalConnection(domain, externalConnection, repository, args) = codeartifact("DELETE", "/v1/repository/external-connection", args)
...
"""
DisposePackageVersions(domain, format, package, repository, versions) = codeartifact("POST", "/v1/package/versions/dispose")
DisposePackageVersions(domain, format, package, repository, versions, args) = codeartifact("POST", "/v1/package/versions/dispose", args)
...
"""
GetAuthorizationToken(domain) = codeartifact("POST", "/v1/authorization-token")
GetAuthorizationToken(domain, args) = codeartifact("POST", "/v1/authorization-token", args)
...
"""
GetDomainPermissionsPolicy(domain) = codeartifact("GET", "/v1/domain/permissions/policy")
GetDomainPermissionsPolicy(domain, args) = codeartifact("GET", "/v1/domain/permissions/policy", args)
...
"""
GetPackageVersionAsset(asset, domain, format, package, packageVersion, repository) = codeartifact("GET", "/v1/package/version/asset")
GetPackageVersionAsset(asset, domain, format, package, packageVersion, repository, args) = codeartifact("GET", "/v1/package/version/asset", args)
...
"""
GetPackageVersionReadme(domain, format, package, packageVersion, repository) = codeartifact("GET", "/v1/package/version/readme")
GetPackageVersionReadme(domain, format, package, packageVersion, repository, args) = codeartifact("GET", "/v1/package/version/readme", args)
...
"""
GetRepositoryEndpoint(domain, format, repository) = codeartifact("GET", "/v1/repository/endpoint")
GetRepositoryEndpoint(domain, format, repository, args) = codeartifact("GET", "/v1/repository/endpoint", args)
...
"""
GetRepositoryPermissionsPolicy(domain, repository) = codeartifact("GET", "/v1/repository/permissions/policy")
GetRepositoryPermissionsPolicy(domain, repository, args) = codeartifact("GET", "/v1/repository/permissions/policy", args)
...
"""
ListPackageVersionAssets(domain, format, package, packageVersion, repository) = codeartifact("POST", "/v1/package/version/assets")
ListPackageVersionAssets(domain, format, package, packageVersion, repository, args) = codeartifact("POST", "/v1/package/version/assets", args)
...
"""
ListPackageVersionDependencies(domain, format, package, packageVersion, repository) = codeartifact("POST", "/v1/package/version/dependencies")
ListPackageVersionDependencies(domain, format, package, packageVersion, repository, args) = codeartifact("POST", "/v1/package/version/dependencies", args)
...
"""
ListPackageVersions(domain, format, package, repository) = codeartifact("POST", "/v1/package/versions")
ListPackageVersions(domain, format, package, repository, args) = codeartifact("POST", "/v1/package/versions", args)
...
"""
ListPackages(domain, repository) = codeartifact("POST", "/v1/packages")
ListPackages(domain, repository, args) = codeartifact("POST", "/v1/packages", args)
...
"""
ListRepositoriesInDomain(domain) = codeartifact("POST", "/v1/domain/repositories")
ListRepositoriesInDomain(domain, args) = codeartifact("POST", "/v1/domain/repositories", args)
...
"""
PutDomainPermissionsPolicy(domain, policyDocument) = codeartifact("PUT", "/v1/domain/permissions/policy")
PutDomainPermissionsPolicy(domain, policyDocument, args) = codeartifact("PUT", "/v1/domain/permissions/policy", args)
...
"""
PutRepositoryPermissionsPolicy(domain, policyDocument, repository) = codeartifact("PUT", "/v1/repository/permissions/policy")
PutRepositoryPermissionsPolicy(domain, policyDocument, repository, args) = codeartifact("PUT", "/v1/repository/permissions/policy", args)
...
"""
UpdatePackageVersionsStatus(domain, format, package, repository, targetStatus, versions) = codeartifact("POST", "/v1/package/versions/update_status")
UpdatePackageVersionsStatus(domain, format, package, repository, targetStatus, versions, args) = codeartifact("POST", "/v1/package/versions/update_status", args)
...
"""
UpdateRepository(domain, repository) = codeartifact("PUT", "/v1/repository")
UpdateRepository(domain, repository, args) = codeartifact("PUT", "/v1/repository", args)
