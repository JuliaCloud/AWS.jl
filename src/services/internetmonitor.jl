...
function get_internet_event(
    EventId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return internetmonitor(
        "GET",
        "/v20210603/InternetEvents/$(EventId)",
...
"""
function stop_query(MonitorName, QueryId; aws_config::AbstractAWSConfig=current_aws_config())
    return internetmonitor(
        "DELETE",
