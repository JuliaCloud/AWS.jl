...
"""
AddTagsToOnPremisesInstances(instanceNames, tags) = codedeploy("AddTagsToOnPremisesInstances", Dict{String, Any}("instanceNames"=>instanceNames, "tags"=>tags))
AddTagsToOnPremisesInstances(instanceNames, tags, args::AbstractDict{String, <:Any}) = codedeploy("AddTagsToOnPremisesInstances", Dict{String, Any}("instanceNames"=>instanceNames, "tags"=>tags, args...))
...
"""
BatchGetApplicationRevisions(applicationName, revisions) = codedeploy("BatchGetApplicationRevisions", Dict{String, Any}("applicationName"=>applicationName, "revisions"=>revisions))
BatchGetApplicationRevisions(applicationName, revisions, args::AbstractDict{String, <:Any}) = codedeploy("BatchGetApplicationRevisions", Dict{String, Any}("applicationName"=>applicationName, "revisions"=>revisions, args...))
...
"""
BatchGetApplications(applicationNames) = codedeploy("BatchGetApplications", Dict{String, Any}("applicationNames"=>applicationNames))
BatchGetApplications(applicationNames, args::AbstractDict{String, <:Any}) = codedeploy("BatchGetApplications", Dict{String, Any}("applicationNames"=>applicationNames, args...))
...
"""
BatchGetDeploymentGroups(applicationName, deploymentGroupNames) = codedeploy("BatchGetDeploymentGroups", Dict{String, Any}("applicationName"=>applicationName, "deploymentGroupNames"=>deploymentGroupNames))
BatchGetDeploymentGroups(applicationName, deploymentGroupNames, args::AbstractDict{String, <:Any}) = codedeploy("BatchGetDeploymentGroups", Dict{String, Any}("applicationName"=>applicationName, "deploymentGroupNames"=>deploymentGroupNames, args...))
...
"""
BatchGetDeploymentInstances(deploymentId, instanceIds) = codedeploy("BatchGetDeploymentInstances", Dict{String, Any}("deploymentId"=>deploymentId, "instanceIds"=>instanceIds))
BatchGetDeploymentInstances(deploymentId, instanceIds, args::AbstractDict{String, <:Any}) = codedeploy("BatchGetDeploymentInstances", Dict{String, Any}("deploymentId"=>deploymentId, "instanceIds"=>instanceIds, args...))
...
BatchGetDeploymentTargets(args::AbstractDict{String, <:Any}) = codedeploy("BatchGetDeploymentTargets", args)
...
"""
BatchGetDeployments(deploymentIds) = codedeploy("BatchGetDeployments", Dict{String, Any}("deploymentIds"=>deploymentIds))
BatchGetDeployments(deploymentIds, args::AbstractDict{String, <:Any}) = codedeploy("BatchGetDeployments", Dict{String, Any}("deploymentIds"=>deploymentIds, args...))
...
"""
BatchGetOnPremisesInstances(instanceNames) = codedeploy("BatchGetOnPremisesInstances", Dict{String, Any}("instanceNames"=>instanceNames))
BatchGetOnPremisesInstances(instanceNames, args::AbstractDict{String, <:Any}) = codedeploy("BatchGetOnPremisesInstances", Dict{String, Any}("instanceNames"=>instanceNames, args...))
...
ContinueDeployment(args::AbstractDict{String, <:Any}) = codedeploy("ContinueDeployment", args)
...
"""
CreateApplication(applicationName) = codedeploy("CreateApplication", Dict{String, Any}("applicationName"=>applicationName))
CreateApplication(applicationName, args::AbstractDict{String, <:Any}) = codedeploy("CreateApplication", Dict{String, Any}("applicationName"=>applicationName, args...))
...
"""
CreateDeployment(applicationName) = codedeploy("CreateDeployment", Dict{String, Any}("applicationName"=>applicationName))
CreateDeployment(applicationName, args::AbstractDict{String, <:Any}) = codedeploy("CreateDeployment", Dict{String, Any}("applicationName"=>applicationName, args...))
...
"""
CreateDeploymentConfig(deploymentConfigName) = codedeploy("CreateDeploymentConfig", Dict{String, Any}("deploymentConfigName"=>deploymentConfigName))
CreateDeploymentConfig(deploymentConfigName, args::AbstractDict{String, <:Any}) = codedeploy("CreateDeploymentConfig", Dict{String, Any}("deploymentConfigName"=>deploymentConfigName, args...))
...
"""
CreateDeploymentGroup(applicationName, deploymentGroupName, serviceRoleArn) = codedeploy("CreateDeploymentGroup", Dict{String, Any}("applicationName"=>applicationName, "deploymentGroupName"=>deploymentGroupName, "serviceRoleArn"=>serviceRoleArn))
CreateDeploymentGroup(applicationName, deploymentGroupName, serviceRoleArn, args::AbstractDict{String, <:Any}) = codedeploy("CreateDeploymentGroup", Dict{String, Any}("applicationName"=>applicationName, "deploymentGroupName"=>deploymentGroupName, "serviceRoleArn"=>serviceRoleArn, args...))
...
"""
DeleteApplication(applicationName) = codedeploy("DeleteApplication", Dict{String, Any}("applicationName"=>applicationName))
DeleteApplication(applicationName, args::AbstractDict{String, <:Any}) = codedeploy("DeleteApplication", Dict{String, Any}("applicationName"=>applicationName, args...))
...
"""
DeleteDeploymentConfig(deploymentConfigName) = codedeploy("DeleteDeploymentConfig", Dict{String, Any}("deploymentConfigName"=>deploymentConfigName))
DeleteDeploymentConfig(deploymentConfigName, args::AbstractDict{String, <:Any}) = codedeploy("DeleteDeploymentConfig", Dict{String, Any}("deploymentConfigName"=>deploymentConfigName, args...))
...
"""
DeleteDeploymentGroup(applicationName, deploymentGroupName) = codedeploy("DeleteDeploymentGroup", Dict{String, Any}("applicationName"=>applicationName, "deploymentGroupName"=>deploymentGroupName))
DeleteDeploymentGroup(applicationName, deploymentGroupName, args::AbstractDict{String, <:Any}) = codedeploy("DeleteDeploymentGroup", Dict{String, Any}("applicationName"=>applicationName, "deploymentGroupName"=>deploymentGroupName, args...))
...
DeleteGitHubAccountToken(args::AbstractDict{String, <:Any}) = codedeploy("DeleteGitHubAccountToken", args)
...
DeleteResourcesByExternalId(args::AbstractDict{String, <:Any}) = codedeploy("DeleteResourcesByExternalId", args)
...
"""
DeregisterOnPremisesInstance(instanceName) = codedeploy("DeregisterOnPremisesInstance", Dict{String, Any}("instanceName"=>instanceName))
DeregisterOnPremisesInstance(instanceName, args::AbstractDict{String, <:Any}) = codedeploy("DeregisterOnPremisesInstance", Dict{String, Any}("instanceName"=>instanceName, args...))
...
"""
GetApplication(applicationName) = codedeploy("GetApplication", Dict{String, Any}("applicationName"=>applicationName))
GetApplication(applicationName, args::AbstractDict{String, <:Any}) = codedeploy("GetApplication", Dict{String, Any}("applicationName"=>applicationName, args...))
...
"""
GetApplicationRevision(applicationName, revision) = codedeploy("GetApplicationRevision", Dict{String, Any}("applicationName"=>applicationName, "revision"=>revision))
GetApplicationRevision(applicationName, revision, args::AbstractDict{String, <:Any}) = codedeploy("GetApplicationRevision", Dict{String, Any}("applicationName"=>applicationName, "revision"=>revision, args...))
...
"""
GetDeployment(deploymentId) = codedeploy("GetDeployment", Dict{String, Any}("deploymentId"=>deploymentId))
GetDeployment(deploymentId, args::AbstractDict{String, <:Any}) = codedeploy("GetDeployment", Dict{String, Any}("deploymentId"=>deploymentId, args...))
...
"""
GetDeploymentConfig(deploymentConfigName) = codedeploy("GetDeploymentConfig", Dict{String, Any}("deploymentConfigName"=>deploymentConfigName))
GetDeploymentConfig(deploymentConfigName, args::AbstractDict{String, <:Any}) = codedeploy("GetDeploymentConfig", Dict{String, Any}("deploymentConfigName"=>deploymentConfigName, args...))
...
"""
GetDeploymentGroup(applicationName, deploymentGroupName) = codedeploy("GetDeploymentGroup", Dict{String, Any}("applicationName"=>applicationName, "deploymentGroupName"=>deploymentGroupName))
GetDeploymentGroup(applicationName, deploymentGroupName, args::AbstractDict{String, <:Any}) = codedeploy("GetDeploymentGroup", Dict{String, Any}("applicationName"=>applicationName, "deploymentGroupName"=>deploymentGroupName, args...))
...
"""
GetDeploymentInstance(deploymentId, instanceId) = codedeploy("GetDeploymentInstance", Dict{String, Any}("deploymentId"=>deploymentId, "instanceId"=>instanceId))
GetDeploymentInstance(deploymentId, instanceId, args::AbstractDict{String, <:Any}) = codedeploy("GetDeploymentInstance", Dict{String, Any}("deploymentId"=>deploymentId, "instanceId"=>instanceId, args...))
...
GetDeploymentTarget(args::AbstractDict{String, <:Any}) = codedeploy("GetDeploymentTarget", args)
...
"""
GetOnPremisesInstance(instanceName) = codedeploy("GetOnPremisesInstance", Dict{String, Any}("instanceName"=>instanceName))
GetOnPremisesInstance(instanceName, args::AbstractDict{String, <:Any}) = codedeploy("GetOnPremisesInstance", Dict{String, Any}("instanceName"=>instanceName, args...))
...
"""
ListApplicationRevisions(applicationName) = codedeploy("ListApplicationRevisions", Dict{String, Any}("applicationName"=>applicationName))
ListApplicationRevisions(applicationName, args::AbstractDict{String, <:Any}) = codedeploy("ListApplicationRevisions", Dict{String, Any}("applicationName"=>applicationName, args...))
...
ListApplications(args::AbstractDict{String, <:Any}) = codedeploy("ListApplications", args)
...
ListDeploymentConfigs(args::AbstractDict{String, <:Any}) = codedeploy("ListDeploymentConfigs", args)
...
"""
ListDeploymentGroups(applicationName) = codedeploy("ListDeploymentGroups", Dict{String, Any}("applicationName"=>applicationName))
ListDeploymentGroups(applicationName, args::AbstractDict{String, <:Any}) = codedeploy("ListDeploymentGroups", Dict{String, Any}("applicationName"=>applicationName, args...))
...
"""
ListDeploymentInstances(deploymentId) = codedeploy("ListDeploymentInstances", Dict{String, Any}("deploymentId"=>deploymentId))
ListDeploymentInstances(deploymentId, args::AbstractDict{String, <:Any}) = codedeploy("ListDeploymentInstances", Dict{String, Any}("deploymentId"=>deploymentId, args...))
...
ListDeploymentTargets(args::AbstractDict{String, <:Any}) = codedeploy("ListDeploymentTargets", args)
...
ListDeployments(args::AbstractDict{String, <:Any}) = codedeploy("ListDeployments", args)
...
ListGitHubAccountTokenNames(args::AbstractDict{String, <:Any}) = codedeploy("ListGitHubAccountTokenNames", args)
...
ListOnPremisesInstances(args::AbstractDict{String, <:Any}) = codedeploy("ListOnPremisesInstances", args)
...
"""
ListTagsForResource(ResourceArn) = codedeploy("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn))
ListTagsForResource(ResourceArn, args::AbstractDict{String, <:Any}) = codedeploy("ListTagsForResource", Dict{String, Any}("ResourceArn"=>ResourceArn, args...))
...
PutLifecycleEventHookExecutionStatus(args::AbstractDict{String, <:Any}) = codedeploy("PutLifecycleEventHookExecutionStatus", args)
...
"""
RegisterApplicationRevision(applicationName, revision) = codedeploy("RegisterApplicationRevision", Dict{String, Any}("applicationName"=>applicationName, "revision"=>revision))
RegisterApplicationRevision(applicationName, revision, args::AbstractDict{String, <:Any}) = codedeploy("RegisterApplicationRevision", Dict{String, Any}("applicationName"=>applicationName, "revision"=>revision, args...))
...
"""
RegisterOnPremisesInstance(instanceName) = codedeploy("RegisterOnPremisesInstance", Dict{String, Any}("instanceName"=>instanceName))
RegisterOnPremisesInstance(instanceName, args::AbstractDict{String, <:Any}) = codedeploy("RegisterOnPremisesInstance", Dict{String, Any}("instanceName"=>instanceName, args...))
...
"""
RemoveTagsFromOnPremisesInstances(instanceNames, tags) = codedeploy("RemoveTagsFromOnPremisesInstances", Dict{String, Any}("instanceNames"=>instanceNames, "tags"=>tags))
RemoveTagsFromOnPremisesInstances(instanceNames, tags, args::AbstractDict{String, <:Any}) = codedeploy("RemoveTagsFromOnPremisesInstances", Dict{String, Any}("instanceNames"=>instanceNames, "tags"=>tags, args...))
...
SkipWaitTimeForInstanceTermination(args::AbstractDict{String, <:Any}) = codedeploy("SkipWaitTimeForInstanceTermination", args)
...
"""
StopDeployment(deploymentId) = codedeploy("StopDeployment", Dict{String, Any}("deploymentId"=>deploymentId))
StopDeployment(deploymentId, args::AbstractDict{String, <:Any}) = codedeploy("StopDeployment", Dict{String, Any}("deploymentId"=>deploymentId, args...))
...
"""
TagResource(ResourceArn, Tags) = codedeploy("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags))
TagResource(ResourceArn, Tags, args::AbstractDict{String, <:Any}) = codedeploy("TagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceArn, TagKeys) = codedeploy("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys))
UntagResource(ResourceArn, TagKeys, args::AbstractDict{String, <:Any}) = codedeploy("UntagResource", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys, args...))
...
UpdateApplication(args::AbstractDict{String, <:Any}) = codedeploy("UpdateApplication", args)
...
"""
UpdateDeploymentGroup(applicationName, currentDeploymentGroupName) = codedeploy("UpdateDeploymentGroup", Dict{String, Any}("applicationName"=>applicationName, "currentDeploymentGroupName"=>currentDeploymentGroupName))
UpdateDeploymentGroup(applicationName, currentDeploymentGroupName, args::AbstractDict{String, <:Any}) = codedeploy("UpdateDeploymentGroup", Dict{String, Any}("applicationName"=>applicationName, "currentDeploymentGroupName"=>currentDeploymentGroupName, args...))
