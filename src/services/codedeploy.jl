...
with EC2/On-premises and Lambda compute platforms. The newer `BatchGetDeploymentTargets`
works with all compute platforms. The maximum number of instances that can be returned is
25.
...
function continue_deployment(; aws_config::AbstractAWSConfig=current_aws_config())
    return codedeploy("ContinueDeployment"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function continue_deployment(
    ...
    return codedeploy(
        "ContinueDeployment", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_git_hub_account_token(; aws_config::AbstractAWSConfig=current_aws_config())
    return codedeploy(
        "DeleteGitHubAccountToken"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_git_hub_account_token(
    ...
    return codedeploy(
        "DeleteGitHubAccountToken", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_resources_by_external_id(;
    ...
    return codedeploy(
        "DeleteResourcesByExternalId"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_resources_by_external_id(
    ...
    return codedeploy(
        "DeleteResourcesByExternalId", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_applications(; aws_config::AbstractAWSConfig=current_aws_config())
    return codedeploy("ListApplications"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_deployment_configs(; aws_config::AbstractAWSConfig=current_aws_config())
    return codedeploy("ListDeploymentConfigs"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_deployment_configs(
    ...
    return codedeploy(
        "ListDeploymentConfigs", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_deployments(; aws_config::AbstractAWSConfig=current_aws_config())
    return codedeploy("ListDeployments"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_deployments(
    ...
    return codedeploy(
        "ListDeployments", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_git_hub_account_token_names(;
    ...
    return codedeploy(
        "ListGitHubAccountTokenNames"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_git_hub_account_token_names(
    ...
    return codedeploy(
        "ListGitHubAccountTokenNames", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_on_premises_instances(; aws_config::AbstractAWSConfig=current_aws_config())
    return codedeploy(
        "ListOnPremisesInstances"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_on_premises_instances(
    ...
    return codedeploy(
        "ListOnPremisesInstances", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function put_lifecycle_event_hook_execution_status(;
    ...
    return codedeploy(
        "PutLifecycleEventHookExecutionStatus"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function skip_wait_time_for_instance_termination(;
    ...
    return codedeploy(
        "SkipWaitTimeForInstanceTermination"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_application(; aws_config::AbstractAWSConfig=current_aws_config())
    return codedeploy("UpdateApplication"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function update_application(
    ...
    return codedeploy(
        "UpdateApplication", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
