...
function batch_get_deployment_groups(
    applicationName, deploymentGroupNames; aws_config::AbstractAWSConfig=current_aws_config()
)
    return codedeploy(
...
"""
function get_application(applicationName; aws_config::AbstractAWSConfig=current_aws_config())
    return codedeploy(
        "GetApplication",
        Dict{String,Any}("applicationName" => applicationName);
        aws_config=aws_config,
