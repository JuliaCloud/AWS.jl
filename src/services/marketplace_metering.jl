...
"""
BatchMeterUsage(ProductCode, UsageRecords) = marketplace_metering("BatchMeterUsage", Dict{String, Any}("ProductCode"=>ProductCode, "UsageRecords"=>UsageRecords))
BatchMeterUsage(ProductCode, UsageRecords, args::AbstractDict{String, <: Any}) = marketplace_metering("BatchMeterUsage", Dict{String, Any}("ProductCode"=>ProductCode, "UsageRecords"=>UsageRecords, args...))
...
"""
MeterUsage(ProductCode, Timestamp, UsageDimension) = marketplace_metering("MeterUsage", Dict{String, Any}("ProductCode"=>ProductCode, "Timestamp"=>Timestamp, "UsageDimension"=>UsageDimension))
MeterUsage(ProductCode, Timestamp, UsageDimension, args::AbstractDict{String, <: Any}) = marketplace_metering("MeterUsage", Dict{String, Any}("ProductCode"=>ProductCode, "Timestamp"=>Timestamp, "UsageDimension"=>UsageDimension, args...))
...
"""
RegisterUsage(ProductCode, PublicKeyVersion) = marketplace_metering("RegisterUsage", Dict{String, Any}("ProductCode"=>ProductCode, "PublicKeyVersion"=>PublicKeyVersion))
RegisterUsage(ProductCode, PublicKeyVersion, args::AbstractDict{String, <: Any}) = marketplace_metering("RegisterUsage", Dict{String, Any}("ProductCode"=>ProductCode, "PublicKeyVersion"=>PublicKeyVersion, args...))
...
"""
ResolveCustomer(RegistrationToken) = marketplace_metering("ResolveCustomer", Dict{String, Any}("RegistrationToken"=>RegistrationToken))
ResolveCustomer(RegistrationToken, args::AbstractDict{String, <: Any}) = marketplace_metering("ResolveCustomer", Dict{String, Any}("RegistrationToken"=>RegistrationToken, args...))
