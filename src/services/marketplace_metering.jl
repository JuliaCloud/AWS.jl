...
"""
BatchMeterUsage(ProductCode, UsageRecords; aws::AWSConfig=AWSConfig()) = marketplace_metering("BatchMeterUsage", Dict{String, Any}("ProductCode"=>ProductCode, "UsageRecords"=>UsageRecords); aws=aws)
BatchMeterUsage(ProductCode, UsageRecords, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = marketplace_metering("BatchMeterUsage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProductCode"=>ProductCode, "UsageRecords"=>UsageRecords), args)); aws=aws)
...
"""
MeterUsage(ProductCode, Timestamp, UsageDimension; aws::AWSConfig=AWSConfig()) = marketplace_metering("MeterUsage", Dict{String, Any}("ProductCode"=>ProductCode, "Timestamp"=>Timestamp, "UsageDimension"=>UsageDimension); aws=aws)
MeterUsage(ProductCode, Timestamp, UsageDimension, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = marketplace_metering("MeterUsage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProductCode"=>ProductCode, "Timestamp"=>Timestamp, "UsageDimension"=>UsageDimension), args)); aws=aws)
...
"""
RegisterUsage(ProductCode, PublicKeyVersion; aws::AWSConfig=AWSConfig()) = marketplace_metering("RegisterUsage", Dict{String, Any}("ProductCode"=>ProductCode, "PublicKeyVersion"=>PublicKeyVersion); aws=aws)
RegisterUsage(ProductCode, PublicKeyVersion, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = marketplace_metering("RegisterUsage", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProductCode"=>ProductCode, "PublicKeyVersion"=>PublicKeyVersion), args)); aws=aws)
...
"""
ResolveCustomer(RegistrationToken; aws::AWSConfig=AWSConfig()) = marketplace_metering("ResolveCustomer", Dict{String, Any}("RegistrationToken"=>RegistrationToken); aws=aws)
ResolveCustomer(RegistrationToken, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = marketplace_metering("ResolveCustomer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RegistrationToken"=>RegistrationToken), args)); aws=aws)
