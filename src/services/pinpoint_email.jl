...
- `"TrackingOptions"`: An object that defines the open and click tracking options for
  emails that you send using the configuration set.
"""
create_configuration_set(ConfigurationSetName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("POST", "/v1/email/configuration-sets", Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_configuration_set(ConfigurationSetName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("POST", "/v1/email/configuration-sets", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConfigurationSetName"=>ConfigurationSetName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"Tags"`: An object that defines the tags (keys and values) that you want to associate
  with the pool.
"""
create_dedicated_ip_pool(PoolName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("POST", "/v1/email/dedicated-ip-pools", Dict{String, Any}("PoolName"=>PoolName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_dedicated_ip_pool(PoolName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("POST", "/v1/email/dedicated-ip-pools", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("PoolName"=>PoolName), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_deliverability_test_report(Content, FromEmailAddress; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("POST", "/v1/email/deliverability-dashboard/test", Dict{String, Any}("Content"=>Content, "FromEmailAddress"=>FromEmailAddress); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
create_email_identity(EmailIdentity; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("POST", "/v1/email/identities", Dict{String, Any}("EmailIdentity"=>EmailIdentity); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
create_email_identity(EmailIdentity, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("POST", "/v1/email/identities", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("EmailIdentity"=>EmailIdentity), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_configuration_set(ConfigurationSetName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("DELETE", "/v1/email/configuration-sets/$(ConfigurationSetName)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_configuration_set(ConfigurationSetName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("DELETE", "/v1/email/configuration-sets/$(ConfigurationSetName)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_configuration_set_event_destination(ConfigurationSetName, EventDestinationName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("DELETE", "/v1/email/configuration-sets/$(ConfigurationSetName)/event-destinations/$(EventDestinationName)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_dedicated_ip_pool(PoolName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("DELETE", "/v1/email/dedicated-ip-pools/$(PoolName)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_dedicated_ip_pool(PoolName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("DELETE", "/v1/email/dedicated-ip-pools/$(PoolName)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_email_identity(EmailIdentity; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("DELETE", "/v1/email/identities/$(EmailIdentity)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_email_identity(EmailIdentity, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("DELETE", "/v1/email/identities/$(EmailIdentity)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_account(; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/account"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_account(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/account", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_blacklist_reports(BlacklistItemNames; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/deliverability-dashboard/blacklist-report", Dict{String, Any}("BlacklistItemNames"=>BlacklistItemNames); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `configuration_set_name`: The name of the configuration set that you want to obtain more
  information about.
"""
get_configuration_set(ConfigurationSetName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/configuration-sets/$(ConfigurationSetName)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_configuration_set(ConfigurationSetName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/configuration-sets/$(ConfigurationSetName)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `configuration_set_name`: The name of the configuration set that contains the event
  destination.
"""
get_configuration_set_event_destinations(ConfigurationSetName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/configuration-sets/$(ConfigurationSetName)/event-destinations"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_configuration_set_event_destinations(ConfigurationSetName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/configuration-sets/$(ConfigurationSetName)/event-destinations", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `ip`: The IP address that you want to obtain more information about. The value you
  ...
  account.
"""
get_dedicated_ip(IP; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/dedicated-ips/$(IP)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_dedicated_ip(IP, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/dedicated-ips/$(IP)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_dedicated_ips(; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/dedicated-ips"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_dedicated_ips(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/dedicated-ips", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_deliverability_dashboard_options(; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/deliverability-dashboard"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_deliverability_dashboard_options(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/deliverability-dashboard", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_deliverability_test_report(ReportId; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/deliverability-dashboard/test-reports/$(ReportId)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_deliverability_test_report(ReportId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/deliverability-dashboard/test-reports/$(ReportId)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_domain_deliverability_campaign(CampaignId; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/deliverability-dashboard/campaigns/$(CampaignId)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_domain_deliverability_campaign(CampaignId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/deliverability-dashboard/campaigns/$(CampaignId)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `start_date`: The first day (in Unix time) that you want to obtain domain deliverability
  metrics for.
"""
get_domain_statistics_report(Domain, EndDate, StartDate; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/deliverability-dashboard/statistics-report/$(Domain)", Dict{String, Any}("EndDate"=>EndDate, "StartDate"=>StartDate); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
get_email_identity(EmailIdentity; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/identities/$(EmailIdentity)"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
get_email_identity(EmailIdentity, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/identities/$(EmailIdentity)", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"PageSize"`: The number of results to show in a single call to `ListConfigurationSets`.
  ...
  results.
"""
list_configuration_sets(; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/configuration-sets"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_configuration_sets(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/configuration-sets", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"PageSize"`: The number of results to show in a single call to `ListDedicatedIpPools`.
  ...
  results.
"""
list_dedicated_ip_pools(; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/dedicated-ip-pools"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_dedicated_ip_pools(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/dedicated-ip-pools", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_deliverability_test_reports(; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/deliverability-dashboard/test-reports"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_deliverability_test_reports(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/deliverability-dashboard/test-reports", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
The value you specify has to be at least 0, and can be no more than 1000.
"""
list_email_identities(; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/identities"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_email_identities(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/identities", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `resource_arn`: The Amazon Resource Name (ARN) of the resource that you want to retrieve
  tag information for.
"""
list_tags_for_resource(ResourceArn; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/tags", Dict{String, Any}("ResourceArn"=>ResourceArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_tags_for_resource(ResourceArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("GET", "/v1/email/tags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"AutoWarmupEnabled"`: Enables or disables the automatic warm-up feature for dedicated IP
  ...
  disable it.
"""
put_account_dedicated_ip_warmup_attributes(; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/account/dedicated-ips/warmup"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_account_dedicated_ip_warmup_attributes(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/account/dedicated-ips/warmup", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
put_account_sending_attributes(; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/account/sending"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_account_sending_attributes(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/account/sending", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
put_configuration_set_delivery_options(ConfigurationSetName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/configuration-sets/$(ConfigurationSetName)/delivery-options"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_configuration_set_delivery_options(ConfigurationSetName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/configuration-sets/$(ConfigurationSetName)/delivery-options", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"ReputationMetricsEnabled"`: If `true`, tracking of reputation metrics is enabled for
  ...
  configuration set.
"""
put_configuration_set_reputation_options(ConfigurationSetName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/configuration-sets/$(ConfigurationSetName)/reputation-options"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_configuration_set_reputation_options(ConfigurationSetName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/configuration-sets/$(ConfigurationSetName)/reputation-options", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
put_configuration_set_sending_options(ConfigurationSetName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/configuration-sets/$(ConfigurationSetName)/sending"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_configuration_set_sending_options(ConfigurationSetName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/configuration-sets/$(ConfigurationSetName)/sending", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
put_configuration_set_tracking_options(ConfigurationSetName; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/configuration-sets/$(ConfigurationSetName)/tracking-options"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_configuration_set_tracking_options(ConfigurationSetName, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/configuration-sets/$(ConfigurationSetName)/tracking-options", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `ip`: The IP address that you want to move to the dedicated IP pool. The value you
  ...
  account.
"""
put_dedicated_ip_in_pool(DestinationPoolName, IP; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/dedicated-ips/$(IP)/pool", Dict{String, Any}("DestinationPoolName"=>DestinationPoolName); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `warmup_percentage`: The warm-up percentage that you want to associate with the dedicated
  IP address.
"""
put_dedicated_ip_warmup_attributes(IP, WarmupPercentage; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/dedicated-ips/$(IP)/warmup", Dict{String, Any}("WarmupPercentage"=>WarmupPercentage); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_dedicated_ip_warmup_attributes(IP, WarmupPercentage, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/dedicated-ips/$(IP)/warmup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("WarmupPercentage"=>WarmupPercentage), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
put_deliverability_dashboard_option(DashboardEnabled; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/deliverability-dashboard", Dict{String, Any}("DashboardEnabled"=>DashboardEnabled); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_deliverability_dashboard_option(DashboardEnabled, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/deliverability-dashboard", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DashboardEnabled"=>DashboardEnabled), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
put_email_identity_dkim_attributes(EmailIdentity; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/identities/$(EmailIdentity)/dkim"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_email_identity_dkim_attributes(EmailIdentity, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/identities/$(EmailIdentity)/dkim", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
put_email_identity_feedback_attributes(EmailIdentity; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/identities/$(EmailIdentity)/feedback"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_email_identity_feedback_attributes(EmailIdentity, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/identities/$(EmailIdentity)/feedback", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
put_email_identity_mail_from_attributes(EmailIdentity; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/identities/$(EmailIdentity)/mail-from"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
put_email_identity_mail_from_attributes(EmailIdentity, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("PUT", "/v1/email/identities/$(EmailIdentity)/mail-from", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
send_email(Content, Destination; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("POST", "/v1/email/outbound-emails", Dict{String, Any}("Content"=>Content, "Destination"=>Destination); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
send_email(Content, Destination, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("POST", "/v1/email/outbound-emails", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Content"=>Content, "Destination"=>Destination), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
tag_resource(ResourceArn, Tags; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("POST", "/v1/email/tags", Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
tag_resource(ResourceArn, Tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("POST", "/v1/email/tags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "Tags"=>Tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
untag_resource(ResourceArn, TagKeys; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("DELETE", "/v1/email/tags", Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
untag_resource(ResourceArn, TagKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = pinpoint_email("DELETE", "/v1/email/tags", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceArn"=>ResourceArn, "TagKeys"=>TagKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
