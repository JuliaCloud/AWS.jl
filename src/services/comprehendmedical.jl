...
function list_entities_detection_v2_jobs(;
    ...
    return comprehendmedical(
        "ListEntitiesDetectionV2Jobs"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_entities_detection_v2_jobs(
    ...
    return comprehendmedical(
        "ListEntitiesDetectionV2Jobs", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_icd10_cminference_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return comprehendmedical(
        "ListICD10CMInferenceJobs"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_icd10_cminference_jobs(
    ...
    return comprehendmedical(
        "ListICD10CMInferenceJobs", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_phidetection_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return comprehendmedical(
        "ListPHIDetectionJobs"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_phidetection_jobs(
    ...
    return comprehendmedical(
        "ListPHIDetectionJobs", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_rx_norm_inference_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return comprehendmedical(
        "ListRxNormInferenceJobs"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_rx_norm_inference_jobs(
    ...
    return comprehendmedical(
        "ListRxNormInferenceJobs", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_snomedctinference_jobs(; aws_config::AbstractAWSConfig=current_aws_config())
    return comprehendmedical(
        "ListSNOMEDCTInferenceJobs"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_snomedctinference_jobs(
    ...
    return comprehendmedical(
        "ListSNOMEDCTInferenceJobs", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
