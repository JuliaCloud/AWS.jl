...
"""
StartImportTask(importUrl, name) = application_discovery_service("StartImportTask", Dict{String, Any}("importUrl"=>importUrl, "name"=>name))
StartImportTask(importUrl, name, args::AbstractDict{String, <: Any}) = application_discovery_service("StartImportTask", Dict{String, Any}("importUrl"=>importUrl, "name"=>name, args...))
