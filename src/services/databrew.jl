...
- `"Timeout"`: The job's timeout in minutes. A job that attempts to run longer than this
  timeout period ends with a status of TIMEOUT.
"""
function create_recipe_job(Name, RoleArn; aws_config::AbstractAWSConfig=current_aws_config())
    return databrew(
        "POST",
        "/recipeJobs",
...
- `"Timeout"`: The job's timeout in minutes. A job that attempts to run longer than this
  timeout period ends with a status of TIMEOUT.
"""
function update_recipe_job(RoleArn, name; aws_config::AbstractAWSConfig=current_aws_config())
    return databrew(
        "PUT",
        "/recipeJobs/$(name)",
        Dict{String,Any}("RoleArn" => RoleArn);
