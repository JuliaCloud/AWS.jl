...
- `query_id`:  The ID of the query that needs to be cancelled. `QueryID` is returned as
  part of the query result.
"""
cancel_query(QueryId; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("CancelQuery", Dict{String, Any}("QueryId"=>QueryId); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
cancel_query(QueryId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("CancelQuery", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QueryId"=>QueryId), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
delete_scheduled_query(ScheduledQueryArn; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("DeleteScheduledQuery", Dict{String, Any}("ScheduledQueryArn"=>ScheduledQueryArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
delete_scheduled_query(ScheduledQueryArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("DeleteScheduledQuery", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ScheduledQueryArn"=>ScheduledQueryArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
describe_account_settings(; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("DescribeAccountSettings"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_account_settings(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("DescribeAccountSettings", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
architecture, including the management and mapping of the service endpoints, *it is not
recommended that you use this API unless*: - You are using [VPC endpoints (Amazon Web Services PrivateLink) with Timestream ](https://docs.aws.amazon.com/timestream/latest/developerguide/VPCEndpoints)
...
"""
describe_endpoints(; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("DescribeEndpoints"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_endpoints(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("DescribeEndpoints", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `scheduled_query_arn`: The ARN of the scheduled query.
"""
describe_scheduled_query(ScheduledQueryArn; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("DescribeScheduledQuery", Dict{String, Any}("ScheduledQueryArn"=>ScheduledQueryArn); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
describe_scheduled_query(ScheduledQueryArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("DescribeScheduledQuery", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ScheduledQueryArn"=>ScheduledQueryArn), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
execute_scheduled_query(InvocationTime, ScheduledQueryArn, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("ExecuteScheduledQuery", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("InvocationTime"=>InvocationTime, "ScheduledQueryArn"=>ScheduledQueryArn, "ClientToken"=>string(uuid4())), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
list_scheduled_queries(; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("ListScheduledQueries"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_scheduled_queries(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("ListScheduledQueries", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"NextToken"`: A pagination token to resume pagination.
"""
list_tags_for_resource(ResourceARN; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
list_tags_for_resource(ResourceARN, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
prepare_query(QueryString; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("PrepareQuery", Dict{String, Any}("QueryString"=>QueryString); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
prepare_query(QueryString, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("PrepareQuery", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QueryString"=>QueryString), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
Your query request will fail in the following cases:</p> - If you submit a `Query` request
with the same client token outside of the 5-minute idempotency window.
 - If you submit a `Query` request with the same client token, but change other parameters,
within the 5-minute idempotency window.
 - If the size of the row (including the query metadata) exceeds 1 MB, then the query will
fail with the following error message:

 <p> `Query aborted as max page response size has been exceeded by the output result row`
 - If the IAM principal of the query initiator and the result reader are not the same
and/or the query initiator and the result reader do not have the same query string in the
query requests, the query will fail with an `Invalid pagination token` error.
...
- `"ClientToken"`:  Unique, case-sensitive string of up to 64 ASCII characters specified
  ...
  *idempotent*. This means that running the same query repeatedly will produce the same
  ...
  making a single request. When using `ClientToken` in a query, note the following:  - If
  the Query API is instantiated without a `ClientToken`, the Query SDK generates a
...
- `"MaxRows"`:  The total number of rows to be returned in the `Query` output. The initial
  ...
  in two cases: </p> - The size of the result is less than `1MB`.
  ...
  `NextToken` value in the subsequent command.
   ...
   <p>If the row size is large (e.g. a row has many columns), Timestream may return fewer
...
- `"NextToken"`:  A pagination token used to return a set of results. When the `Query` API
  ...
  Note the following when using NextToken in a query: - A pagination token can be used for
  up to five `Query` invocations, OR for a duration of up to 1 hour – whichever comes
  first.
  ...
  query requests, the query will fail with an `Invalid pagination token` error.
"""
query(QueryString; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("Query", Dict{String, Any}("QueryString"=>QueryString, "ClientToken"=>string(uuid4())); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
query(QueryString, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("Query", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("QueryString"=>QueryString, "ClientToken"=>string(uuid4())), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
tag_resource(ResourceARN, Tags; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
tag_resource(ResourceARN, Tags, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
untag_resource(ResourceARN, TagKeys; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
untag_resource(ResourceARN, TagKeys, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
- `"MaxQueryTCU"`: The maximum number of compute units the service will use at any point in
  ...
  can set the maximum number of TCU in multiples of 4, for example, 4, 8, 16, 32, and so
  on.
  ...
  for maxQueryTCU, see [Default quotas](https://docs.aws.amazon.com/timestream/latest/developerguide/ts-limits.html#limits.default).
- `"QueryPricingModel"`: The pricing model for queries in an account.
  ...
  `COMPUTE_UNITS`.
"""
update_account_settings(; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("UpdateAccountSettings"; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_account_settings(params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("UpdateAccountSettings", params; aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
...
"""
update_scheduled_query(ScheduledQueryArn, State; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("UpdateScheduledQuery", Dict{String, Any}("ScheduledQueryArn"=>ScheduledQueryArn, "State"=>State); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
update_scheduled_query(ScheduledQueryArn, State, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()) = timestream_query("UpdateScheduledQuery", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ScheduledQueryArn"=>ScheduledQueryArn, "State"=>State), params)); aws_config=aws_config, feature_set=SERVICE_FEATURE_SET)
