...
CreateDeliveryStream(DeliveryStreamName; aws_config::AWSConfig=AWS.aws_config) = firehose("CreateDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName); aws_config=aws_config)
CreateDeliveryStream(DeliveryStreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = firehose("CreateDeliveryStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName), args)); aws_config=aws_config)
...
DeleteDeliveryStream(DeliveryStreamName; aws_config::AWSConfig=AWS.aws_config) = firehose("DeleteDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName); aws_config=aws_config)
DeleteDeliveryStream(DeliveryStreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = firehose("DeleteDeliveryStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName), args)); aws_config=aws_config)
...
DescribeDeliveryStream(DeliveryStreamName; aws_config::AWSConfig=AWS.aws_config) = firehose("DescribeDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName); aws_config=aws_config)
DescribeDeliveryStream(DeliveryStreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = firehose("DescribeDeliveryStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName), args)); aws_config=aws_config)
...
ListDeliveryStreams(; aws_config::AWSConfig=AWS.aws_config) = firehose("ListDeliveryStreams"; aws_config=aws_config)
ListDeliveryStreams(args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = firehose("ListDeliveryStreams", args; aws_config=aws_config)
...
ListTagsForDeliveryStream(DeliveryStreamName; aws_config::AWSConfig=AWS.aws_config) = firehose("ListTagsForDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName); aws_config=aws_config)
ListTagsForDeliveryStream(DeliveryStreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = firehose("ListTagsForDeliveryStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName), args)); aws_config=aws_config)
...
PutRecord(DeliveryStreamName, Record; aws_config::AWSConfig=AWS.aws_config) = firehose("PutRecord", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "Record"=>Record); aws_config=aws_config)
PutRecord(DeliveryStreamName, Record, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = firehose("PutRecord", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "Record"=>Record), args)); aws_config=aws_config)
...
PutRecordBatch(DeliveryStreamName, Records; aws_config::AWSConfig=AWS.aws_config) = firehose("PutRecordBatch", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "Records"=>Records); aws_config=aws_config)
PutRecordBatch(DeliveryStreamName, Records, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = firehose("PutRecordBatch", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "Records"=>Records), args)); aws_config=aws_config)
...
StartDeliveryStreamEncryption(DeliveryStreamName; aws_config::AWSConfig=AWS.aws_config) = firehose("StartDeliveryStreamEncryption", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName); aws_config=aws_config)
StartDeliveryStreamEncryption(DeliveryStreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = firehose("StartDeliveryStreamEncryption", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName), args)); aws_config=aws_config)
...
StopDeliveryStreamEncryption(DeliveryStreamName; aws_config::AWSConfig=AWS.aws_config) = firehose("StopDeliveryStreamEncryption", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName); aws_config=aws_config)
StopDeliveryStreamEncryption(DeliveryStreamName, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = firehose("StopDeliveryStreamEncryption", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName), args)); aws_config=aws_config)
...
TagDeliveryStream(DeliveryStreamName, Tags; aws_config::AWSConfig=AWS.aws_config) = firehose("TagDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "Tags"=>Tags); aws_config=aws_config)
TagDeliveryStream(DeliveryStreamName, Tags, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = firehose("TagDeliveryStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "Tags"=>Tags), args)); aws_config=aws_config)
...
UntagDeliveryStream(DeliveryStreamName, TagKeys; aws_config::AWSConfig=AWS.aws_config) = firehose("UntagDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "TagKeys"=>TagKeys); aws_config=aws_config)
UntagDeliveryStream(DeliveryStreamName, TagKeys, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = firehose("UntagDeliveryStream", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "TagKeys"=>TagKeys), args)); aws_config=aws_config)
...
UpdateDestination(CurrentDeliveryStreamVersionId, DeliveryStreamName, DestinationId; aws_config::AWSConfig=AWS.aws_config) = firehose("UpdateDestination", Dict{String, Any}("CurrentDeliveryStreamVersionId"=>CurrentDeliveryStreamVersionId, "DeliveryStreamName"=>DeliveryStreamName, "DestinationId"=>DestinationId); aws_config=aws_config)
UpdateDestination(CurrentDeliveryStreamVersionId, DeliveryStreamName, DestinationId, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = firehose("UpdateDestination", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CurrentDeliveryStreamVersionId"=>CurrentDeliveryStreamVersionId, "DeliveryStreamName"=>DeliveryStreamName, "DestinationId"=>DestinationId), args)); aws_config=aws_config)
