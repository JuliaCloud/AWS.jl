...
manage the grant. For the KMS grant creation to be successful, Firehose APIs
...
- `"SnowflakeDestinationUpdate"`: Update to the Snowflake destination condiguration settings
