...
"""
CreateDeliveryStream(DeliveryStreamName) = firehose("CreateDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName))
CreateDeliveryStream(DeliveryStreamName, args::AbstractDict{String, <:Any}) = firehose("CreateDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, args...))
...
"""
DeleteDeliveryStream(DeliveryStreamName) = firehose("DeleteDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName))
DeleteDeliveryStream(DeliveryStreamName, args::AbstractDict{String, <:Any}) = firehose("DeleteDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, args...))
...
"""
DescribeDeliveryStream(DeliveryStreamName) = firehose("DescribeDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName))
DescribeDeliveryStream(DeliveryStreamName, args::AbstractDict{String, <:Any}) = firehose("DescribeDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, args...))
...
ListDeliveryStreams(args::AbstractDict{String, <:Any}) = firehose("ListDeliveryStreams", args)
...
"""
ListTagsForDeliveryStream(DeliveryStreamName) = firehose("ListTagsForDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName))
ListTagsForDeliveryStream(DeliveryStreamName, args::AbstractDict{String, <:Any}) = firehose("ListTagsForDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, args...))
...
"""
PutRecord(DeliveryStreamName, Record) = firehose("PutRecord", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "Record"=>Record))
PutRecord(DeliveryStreamName, Record, args::AbstractDict{String, <:Any}) = firehose("PutRecord", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "Record"=>Record, args...))
...
"""
PutRecordBatch(DeliveryStreamName, Records) = firehose("PutRecordBatch", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "Records"=>Records))
PutRecordBatch(DeliveryStreamName, Records, args::AbstractDict{String, <:Any}) = firehose("PutRecordBatch", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "Records"=>Records, args...))
...
- `DeliveryStreamEncryptionConfigurationInput`: Used to specify the type and Amazon Resource Name (ARN) of the KMS key needed for Server-Side Encryption (SSE).
"""
StartDeliveryStreamEncryption(DeliveryStreamName) = firehose("StartDeliveryStreamEncryption", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName))
StartDeliveryStreamEncryption(DeliveryStreamName, args::AbstractDict{String, <:Any}) = firehose("StartDeliveryStreamEncryption", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, args...))
...
"""
StopDeliveryStreamEncryption(DeliveryStreamName) = firehose("StopDeliveryStreamEncryption", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName))
StopDeliveryStreamEncryption(DeliveryStreamName, args::AbstractDict{String, <:Any}) = firehose("StopDeliveryStreamEncryption", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, args...))
...
"""
TagDeliveryStream(DeliveryStreamName, Tags) = firehose("TagDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "Tags"=>Tags))
TagDeliveryStream(DeliveryStreamName, Tags, args::AbstractDict{String, <:Any}) = firehose("TagDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "Tags"=>Tags, args...))
...
"""
UntagDeliveryStream(DeliveryStreamName, TagKeys) = firehose("UntagDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "TagKeys"=>TagKeys))
UntagDeliveryStream(DeliveryStreamName, TagKeys, args::AbstractDict{String, <:Any}) = firehose("UntagDeliveryStream", Dict{String, Any}("DeliveryStreamName"=>DeliveryStreamName, "TagKeys"=>TagKeys, args...))
...
"""
UpdateDestination(CurrentDeliveryStreamVersionId, DeliveryStreamName, DestinationId) = firehose("UpdateDestination", Dict{String, Any}("CurrentDeliveryStreamVersionId"=>CurrentDeliveryStreamVersionId, "DeliveryStreamName"=>DeliveryStreamName, "DestinationId"=>DestinationId))
UpdateDestination(CurrentDeliveryStreamVersionId, DeliveryStreamName, DestinationId, args::AbstractDict{String, <:Any}) = firehose("UpdateDestination", Dict{String, Any}("CurrentDeliveryStreamVersionId"=>CurrentDeliveryStreamVersionId, "DeliveryStreamName"=>DeliveryStreamName, "DestinationId"=>DestinationId, args...))
