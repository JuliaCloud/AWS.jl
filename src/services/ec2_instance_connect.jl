...
"""
SendSSHPublicKey(AvailabilityZone, InstanceId, InstanceOSUser, SSHPublicKey; aws::AWSConfig=AWSConfig()) = ec2_instance_connect("SendSSHPublicKey", Dict{String, Any}("AvailabilityZone"=>AvailabilityZone, "InstanceId"=>InstanceId, "InstanceOSUser"=>InstanceOSUser, "SSHPublicKey"=>SSHPublicKey); aws=aws)
SendSSHPublicKey(AvailabilityZone, InstanceId, InstanceOSUser, SSHPublicKey, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = ec2_instance_connect("SendSSHPublicKey", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AvailabilityZone"=>AvailabilityZone, "InstanceId"=>InstanceId, "InstanceOSUser"=>InstanceOSUser, "SSHPublicKey"=>SSHPublicKey), args)); aws=aws)
