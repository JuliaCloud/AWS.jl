...
SendSSHPublicKey(AvailabilityZone, InstanceId, InstanceOSUser, SSHPublicKey; aws_config::AWSConfig=global_aws_config()) = ec2_instance_connect("SendSSHPublicKey", Dict{String, Any}("AvailabilityZone"=>AvailabilityZone, "InstanceId"=>InstanceId, "InstanceOSUser"=>InstanceOSUser, "SSHPublicKey"=>SSHPublicKey); aws_config=aws_config)
SendSSHPublicKey(AvailabilityZone, InstanceId, InstanceOSUser, SSHPublicKey, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=global_aws_config()) = ec2_instance_connect("SendSSHPublicKey", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AvailabilityZone"=>AvailabilityZone, "InstanceId"=>InstanceId, "InstanceOSUser"=>InstanceOSUser, "SSHPublicKey"=>SSHPublicKey), args)); aws_config=aws_config)
