...
function list_deployments(; aws_config::AbstractAWSConfig=current_aws_config())
    return launch_wizard(
        "POST", "/listDeployments"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_deployments(
    ...
    return launch_wizard(
        "POST", "/listDeployments", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_workloads(; aws_config::AbstractAWSConfig=current_aws_config())
    return launch_wizard(
        "POST", "/listWorkloads"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_workloads(
    ...
    return launch_wizard(
        "POST", "/listWorkloads", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
