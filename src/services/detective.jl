...
# Keyword Parameters
- `tags`: The tags to assign to the new behavior graph. You can add up to 50 tags. For each
...
- `next_token`: For requests to get the next page of results, the pagination token that was
