...
"""
AcceptInvitation(GraphArn) = detective("PUT", "/invitation", Dict{String, Any}("GraphArn"=>GraphArn))
AcceptInvitation(GraphArn, args::AbstractDict{String, <:Any}) = detective("PUT", "/invitation", Dict{String, Any}("GraphArn"=>GraphArn, args...))
...
CreateGraph(args::AbstractDict{String, Any}) = detective("POST", "/graph", args)
...
"""
CreateMembers(Accounts, GraphArn) = detective("POST", "/graph/members", Dict{String, Any}("Accounts"=>Accounts, "GraphArn"=>GraphArn))
CreateMembers(Accounts, GraphArn, args::AbstractDict{String, <:Any}) = detective("POST", "/graph/members", Dict{String, Any}("Accounts"=>Accounts, "GraphArn"=>GraphArn, args...))
...
"""
DeleteGraph(GraphArn) = detective("POST", "/graph/removal", Dict{String, Any}("GraphArn"=>GraphArn))
DeleteGraph(GraphArn, args::AbstractDict{String, <:Any}) = detective("POST", "/graph/removal", Dict{String, Any}("GraphArn"=>GraphArn, args...))
...
"""
DeleteMembers(AccountIds, GraphArn) = detective("POST", "/graph/members/removal", Dict{String, Any}("AccountIds"=>AccountIds, "GraphArn"=>GraphArn))
DeleteMembers(AccountIds, GraphArn, args::AbstractDict{String, <:Any}) = detective("POST", "/graph/members/removal", Dict{String, Any}("AccountIds"=>AccountIds, "GraphArn"=>GraphArn, args...))
...
"""
DisassociateMembership(GraphArn) = detective("POST", "/membership/removal", Dict{String, Any}("GraphArn"=>GraphArn))
DisassociateMembership(GraphArn, args::AbstractDict{String, <:Any}) = detective("POST", "/membership/removal", Dict{String, Any}("GraphArn"=>GraphArn, args...))
...
"""
GetMembers(AccountIds, GraphArn) = detective("POST", "/graph/members/get", Dict{String, Any}("AccountIds"=>AccountIds, "GraphArn"=>GraphArn))
GetMembers(AccountIds, GraphArn, args::AbstractDict{String, <:Any}) = detective("POST", "/graph/members/get", Dict{String, Any}("AccountIds"=>AccountIds, "GraphArn"=>GraphArn, args...))
...
ListGraphs(args::AbstractDict{String, Any}) = detective("POST", "/graphs/list", args)
...
ListInvitations(args::AbstractDict{String, Any}) = detective("POST", "/invitations/list", args)
...
"""
ListMembers(GraphArn) = detective("POST", "/graph/members/list", Dict{String, Any}("GraphArn"=>GraphArn))
ListMembers(GraphArn, args::AbstractDict{String, <:Any}) = detective("POST", "/graph/members/list", Dict{String, Any}("GraphArn"=>GraphArn, args...))
...
"""
RejectInvitation(GraphArn) = detective("POST", "/invitation/removal", Dict{String, Any}("GraphArn"=>GraphArn))
RejectInvitation(GraphArn, args::AbstractDict{String, <:Any}) = detective("POST", "/invitation/removal", Dict{String, Any}("GraphArn"=>GraphArn, args...))
...
"""
StartMonitoringMember(AccountId, GraphArn) = detective("POST", "/graph/member/monitoringstate", Dict{String, Any}("AccountId"=>AccountId, "GraphArn"=>GraphArn))
StartMonitoringMember(AccountId, GraphArn, args::AbstractDict{String, <:Any}) = detective("POST", "/graph/member/monitoringstate", Dict{String, Any}("AccountId"=>AccountId, "GraphArn"=>GraphArn, args...))
