...
"""
AcceptInvitation(GraphArn; aws::AWSConfig=AWSConfig()) = detective("PUT", "/invitation", Dict{String, Any}("GraphArn"=>GraphArn))
AcceptInvitation(GraphArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = detective("PUT", "/invitation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("GraphArn"=>GraphArn), args)); aws=aws)
...
"""
CreateGraph(; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph"; aws=aws)
CreateGraph(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph", args; aws=aws)
...
"""
CreateMembers(Accounts, GraphArn; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph/members", Dict{String, Any}("Accounts"=>Accounts, "GraphArn"=>GraphArn))
CreateMembers(Accounts, GraphArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph/members", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Accounts"=>Accounts, "GraphArn"=>GraphArn), args)); aws=aws)
...
"""
DeleteGraph(GraphArn; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph/removal", Dict{String, Any}("GraphArn"=>GraphArn))
DeleteGraph(GraphArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph/removal", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("GraphArn"=>GraphArn), args)); aws=aws)
...
"""
DeleteMembers(AccountIds, GraphArn; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph/members/removal", Dict{String, Any}("AccountIds"=>AccountIds, "GraphArn"=>GraphArn))
DeleteMembers(AccountIds, GraphArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph/members/removal", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds, "GraphArn"=>GraphArn), args)); aws=aws)
...
"""
DisassociateMembership(GraphArn; aws::AWSConfig=AWSConfig()) = detective("POST", "/membership/removal", Dict{String, Any}("GraphArn"=>GraphArn))
DisassociateMembership(GraphArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = detective("POST", "/membership/removal", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("GraphArn"=>GraphArn), args)); aws=aws)
...
"""
GetMembers(AccountIds, GraphArn; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph/members/get", Dict{String, Any}("AccountIds"=>AccountIds, "GraphArn"=>GraphArn))
GetMembers(AccountIds, GraphArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph/members/get", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds, "GraphArn"=>GraphArn), args)); aws=aws)
...
"""
ListGraphs(; aws::AWSConfig=AWSConfig()) = detective("POST", "/graphs/list"; aws=aws)
ListGraphs(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = detective("POST", "/graphs/list", args; aws=aws)
...
"""
ListInvitations(; aws::AWSConfig=AWSConfig()) = detective("POST", "/invitations/list"; aws=aws)
ListInvitations(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = detective("POST", "/invitations/list", args; aws=aws)
...
"""
ListMembers(GraphArn; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph/members/list", Dict{String, Any}("GraphArn"=>GraphArn))
ListMembers(GraphArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph/members/list", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("GraphArn"=>GraphArn), args)); aws=aws)
...
"""
RejectInvitation(GraphArn; aws::AWSConfig=AWSConfig()) = detective("POST", "/invitation/removal", Dict{String, Any}("GraphArn"=>GraphArn))
RejectInvitation(GraphArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = detective("POST", "/invitation/removal", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("GraphArn"=>GraphArn), args)); aws=aws)
...
"""
StartMonitoringMember(AccountId, GraphArn; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph/member/monitoringstate", Dict{String, Any}("AccountId"=>AccountId, "GraphArn"=>GraphArn))
StartMonitoringMember(AccountId, GraphArn, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = detective("POST", "/graph/member/monitoringstate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountId"=>AccountId, "GraphArn"=>GraphArn), args)); aws=aws)
