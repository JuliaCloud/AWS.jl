...
AcceptInvitation(GraphArn; aws_config::AWSConfig=AWS.aws_config) = detective("PUT", "/invitation", Dict{String, Any}("GraphArn"=>GraphArn); aws_config=aws_config)
AcceptInvitation(GraphArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = detective("PUT", "/invitation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("GraphArn"=>GraphArn), args)); aws_config=aws_config)
...
CreateGraph(; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph"; aws_config=aws_config)
CreateGraph(args::AbstractDict{String, Any}; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph", args; aws_config=aws_config)
...
CreateMembers(Accounts, GraphArn; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph/members", Dict{String, Any}("Accounts"=>Accounts, "GraphArn"=>GraphArn); aws_config=aws_config)
CreateMembers(Accounts, GraphArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph/members", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Accounts"=>Accounts, "GraphArn"=>GraphArn), args)); aws_config=aws_config)
...
DeleteGraph(GraphArn; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph/removal", Dict{String, Any}("GraphArn"=>GraphArn); aws_config=aws_config)
DeleteGraph(GraphArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph/removal", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("GraphArn"=>GraphArn), args)); aws_config=aws_config)
...
DeleteMembers(AccountIds, GraphArn; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph/members/removal", Dict{String, Any}("AccountIds"=>AccountIds, "GraphArn"=>GraphArn); aws_config=aws_config)
DeleteMembers(AccountIds, GraphArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph/members/removal", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds, "GraphArn"=>GraphArn), args)); aws_config=aws_config)
...
DisassociateMembership(GraphArn; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/membership/removal", Dict{String, Any}("GraphArn"=>GraphArn); aws_config=aws_config)
DisassociateMembership(GraphArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/membership/removal", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("GraphArn"=>GraphArn), args)); aws_config=aws_config)
...
GetMembers(AccountIds, GraphArn; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph/members/get", Dict{String, Any}("AccountIds"=>AccountIds, "GraphArn"=>GraphArn); aws_config=aws_config)
GetMembers(AccountIds, GraphArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph/members/get", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountIds"=>AccountIds, "GraphArn"=>GraphArn), args)); aws_config=aws_config)
...
ListGraphs(; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graphs/list"; aws_config=aws_config)
ListGraphs(args::AbstractDict{String, Any}; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graphs/list", args; aws_config=aws_config)
...
ListInvitations(; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/invitations/list"; aws_config=aws_config)
ListInvitations(args::AbstractDict{String, Any}; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/invitations/list", args; aws_config=aws_config)
...
ListMembers(GraphArn; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph/members/list", Dict{String, Any}("GraphArn"=>GraphArn); aws_config=aws_config)
ListMembers(GraphArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph/members/list", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("GraphArn"=>GraphArn), args)); aws_config=aws_config)
...
RejectInvitation(GraphArn; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/invitation/removal", Dict{String, Any}("GraphArn"=>GraphArn); aws_config=aws_config)
RejectInvitation(GraphArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/invitation/removal", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("GraphArn"=>GraphArn), args)); aws_config=aws_config)
...
StartMonitoringMember(AccountId, GraphArn; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph/member/monitoringstate", Dict{String, Any}("AccountId"=>AccountId, "GraphArn"=>GraphArn); aws_config=aws_config)
StartMonitoringMember(AccountId, GraphArn, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = detective("POST", "/graph/member/monitoringstate", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("AccountId"=>AccountId, "GraphArn"=>GraphArn), args)); aws_config=aws_config)
