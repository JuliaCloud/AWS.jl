...
function delete_space(
    spaceId, params::AbstractDict{String}; aws_config::AbstractAWSConfig=current_aws_config()
)
    return repostspace(
        "DELETE",
        "/spaces/$(spaceId)",
...
"""
function register_admin(adminId, spaceId; aws_config::AbstractAWSConfig=current_aws_config())
    return repostspace(
        "POST",
        "/spaces/$(spaceId)/admins/$(adminId)";
        aws_config=aws_config,
