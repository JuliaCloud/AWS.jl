...
function delete_space(spaceId; aws_config::AbstractAWSConfig=current_aws_config())
    return repostspace(
        "DELETE", "/spaces/$(spaceId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function delete_space(
    ...
    return repostspace(
        "DELETE", "/spaces/$(spaceId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_space(spaceId; aws_config::AbstractAWSConfig=current_aws_config())
    return repostspace(
        "GET", "/spaces/$(spaceId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_spaces(; aws_config::AbstractAWSConfig=current_aws_config())
    return repostspace("GET", "/spaces"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_spaces(
    ...
    return repostspace(
        "GET", "/spaces", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_space(spaceId; aws_config::AbstractAWSConfig=current_aws_config())
    return repostspace(
        "PUT", "/spaces/$(spaceId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function update_space(
    ...
    return repostspace(
        "PUT", "/spaces/$(spaceId)", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
