...
!!! note
    ...
    batch, Route 53 returns an `InvalidChangeBatch` error.
...
For information about the limits on a `ChangeResourceRecordSets` request, see [Limits](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DNSLimitations.html)
in the *Amazon Route 53 Developer Guide*.
...
1. Create a CloudWatch Logs log group, and make note of the ARN, which you specify when you
...
For a list of the values in each query log and the format of each value, see [Logging DNS Queries](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/query-logs.html)
in the *Amazon Route 53 Developer Guide*.
...
!!! note
    ...
    policy definition. Use `GetTrafficPolicyInstance` with the `id` of new traffic policy
...
!!! important
    ...
    check is associated with one or more resource record sets. If you delete a health check
    and you don't update the associated resource record sets, the future status of the
    health check can't be predicted and may change. This will affect the routing of DNS
    queries for your DNS failover configuration. For more information, see [Replacing and Deleting Health Checks](https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/health-checks-creating-deleting.html#health-checks-deleting.html)
    in the *Amazon Route 53 Developer Guide*.

If you're using Cloud Map and you configured Cloud Map to create a Route 53 health check
when you register an instance, you can't use the Route 53 `DeleteHealthCheck` command to
delete the health check. The health check is deleted automatically when you deregister the
instance; there can be a delay of several hours before the health check is deleted from
Route 53.
...
!!! important
    ...
    and update the name servers for your domain registration, which can require up to 48
    hours to take effect. (If you delegated responsibility for a subdomain to a hosted zone
    and you delete the child hosted zone, you must update the name servers in the parent
    hosted zone.) In addition, if you delete a hosted zone, someone could hijack the domain
...
!!! important
    ...
    from associating the VPC with the Amazon Route 53 hosted zone in the future. If the VPC
    is already associated with the hosted zone, `DeleteVPCAssociationAuthorization` won't
...
- `PENDING` indicates that the changes in this request have not propagated to all Amazon
  Route 53 DNS servers managing the hosted zone. This is the initial status of all change
  batch requests.
...
function get_change(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/change/$(Id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_checker_ip_ranges(; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/checkeripranges"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_geo_location(; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/geolocation"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_health_check_count(; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/healthcheckcount"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_hosted_zone(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/hostedzone/$(Id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_hosted_zone_count(; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/hostedzonecount"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_cidr_collections(; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/cidrcollection"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_geo_locations(; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/geolocations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_health_checks(; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/healthcheck"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_hosted_zones(; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/hostedzone"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_hosted_zones(
    ...
    return route_53(
        "GET", "/2013-04-01/hostedzone", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
with the current account. The `NextDNSName` element and `NextHostedZoneId` elements are
omitted from the response.
- The `NextDNSName` and `NextHostedZoneId` elements in the response contain the domain name
  and the hosted zone ID of the next hosted zone that is associated with the current Amazon
  Web Services account. If you want to list more hosted zones, make another call to
...
function list_hosted_zones_by_name(; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/hostedzonesbyname"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_query_logging_configs(; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/queryloggingconfig"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_reusable_delegation_sets(; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/delegationset"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_traffic_policies(; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "GET", "/2013-04-01/trafficpolicies"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
policy instances, you can use the `MaxItems` parameter to list them in groups of up to 100.
...
function update_hosted_zone_comment(Id; aws_config::AbstractAWSConfig=current_aws_config())
    return route_53(
        "POST", "/2013-04-01/hostedzone/$(Id)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
!!! note
    ...
    definition. Use `GetTrafficPolicyInstance` with the `id` of updated traffic policy
    instance confirm that the `UpdateTrafficPolicyInstance` request completed successfully.
