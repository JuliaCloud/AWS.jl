...
"""
AssociateVPCWithHostedZone(Id, VPC; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/associatevpc", Dict{String, Any}("VPC"=>VPC))
AssociateVPCWithHostedZone(Id, VPC, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/associatevpc", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VPC"=>VPC), args)); aws=aws)
...
"""
ChangeResourceRecordSets(ChangeBatch, Id; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/rrset/", Dict{String, Any}("ChangeBatch"=>ChangeBatch))
ChangeResourceRecordSets(ChangeBatch, Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/rrset/", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ChangeBatch"=>ChangeBatch), args)); aws=aws)
...
"""
ChangeTagsForResource(ResourceId, ResourceType; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/tags/$(ResourceType)/$(ResourceId)"; aws=aws)
ChangeTagsForResource(ResourceId, ResourceType, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/tags/$(ResourceType)/$(ResourceId)", args; aws=aws)
...
"""
CreateHealthCheck(CallerReference, HealthCheckConfig; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/healthcheck", Dict{String, Any}("CallerReference"=>CallerReference, "HealthCheckConfig"=>HealthCheckConfig))
CreateHealthCheck(CallerReference, HealthCheckConfig, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/healthcheck", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CallerReference"=>CallerReference, "HealthCheckConfig"=>HealthCheckConfig), args)); aws=aws)
...
"""
CreateHostedZone(CallerReference, Name; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone", Dict{String, Any}("CallerReference"=>CallerReference, "Name"=>Name))
CreateHostedZone(CallerReference, Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CallerReference"=>CallerReference, "Name"=>Name), args)); aws=aws)
...
"""
CreateQueryLoggingConfig(CloudWatchLogsLogGroupArn, HostedZoneId; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/queryloggingconfig", Dict{String, Any}("CloudWatchLogsLogGroupArn"=>CloudWatchLogsLogGroupArn, "HostedZoneId"=>HostedZoneId))
CreateQueryLoggingConfig(CloudWatchLogsLogGroupArn, HostedZoneId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/queryloggingconfig", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CloudWatchLogsLogGroupArn"=>CloudWatchLogsLogGroupArn, "HostedZoneId"=>HostedZoneId), args)); aws=aws)
...
"""
CreateReusableDelegationSet(CallerReference; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/delegationset", Dict{String, Any}("CallerReference"=>CallerReference))
CreateReusableDelegationSet(CallerReference, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/delegationset", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("CallerReference"=>CallerReference), args)); aws=aws)
...
"""
CreateTrafficPolicy(Document, Name; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/trafficpolicy", Dict{String, Any}("Document"=>Document, "Name"=>Name))
CreateTrafficPolicy(Document, Name, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/trafficpolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Document"=>Document, "Name"=>Name), args)); aws=aws)
...
"""
CreateTrafficPolicyInstance(HostedZoneId, Name, TTL, TrafficPolicyId, TrafficPolicyVersion; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/trafficpolicyinstance", Dict{String, Any}("HostedZoneId"=>HostedZoneId, "Name"=>Name, "TTL"=>TTL, "TrafficPolicyId"=>TrafficPolicyId, "TrafficPolicyVersion"=>TrafficPolicyVersion))
CreateTrafficPolicyInstance(HostedZoneId, Name, TTL, TrafficPolicyId, TrafficPolicyVersion, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/trafficpolicyinstance", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("HostedZoneId"=>HostedZoneId, "Name"=>Name, "TTL"=>TTL, "TrafficPolicyId"=>TrafficPolicyId, "TrafficPolicyVersion"=>TrafficPolicyVersion), args)); aws=aws)
...
"""
CreateTrafficPolicyVersion(Document, Id; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/trafficpolicy/$(Id)", Dict{String, Any}("Document"=>Document))
CreateTrafficPolicyVersion(Document, Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/trafficpolicy/$(Id)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Document"=>Document), args)); aws=aws)
...
"""
CreateVPCAssociationAuthorization(Id, VPC; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/authorizevpcassociation", Dict{String, Any}("VPC"=>VPC))
CreateVPCAssociationAuthorization(Id, VPC, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/authorizevpcassociation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VPC"=>VPC), args)); aws=aws)
...
"""
DeleteHealthCheck(HealthCheckId; aws::AWSConfig=AWSConfig()) = route_53("DELETE", "/2013-04-01/healthcheck/$(HealthCheckId)"; aws=aws)
DeleteHealthCheck(HealthCheckId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("DELETE", "/2013-04-01/healthcheck/$(HealthCheckId)", args; aws=aws)
...
"""
DeleteHostedZone(Id; aws::AWSConfig=AWSConfig()) = route_53("DELETE", "/2013-04-01/hostedzone/$(Id)"; aws=aws)
DeleteHostedZone(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("DELETE", "/2013-04-01/hostedzone/$(Id)", args; aws=aws)
...
"""
DeleteQueryLoggingConfig(Id; aws::AWSConfig=AWSConfig()) = route_53("DELETE", "/2013-04-01/queryloggingconfig/$(Id)"; aws=aws)
DeleteQueryLoggingConfig(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("DELETE", "/2013-04-01/queryloggingconfig/$(Id)", args; aws=aws)
...
"""
DeleteReusableDelegationSet(Id; aws::AWSConfig=AWSConfig()) = route_53("DELETE", "/2013-04-01/delegationset/$(Id)"; aws=aws)
DeleteReusableDelegationSet(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("DELETE", "/2013-04-01/delegationset/$(Id)", args; aws=aws)
...
"""
DeleteTrafficPolicy(Id, Version; aws::AWSConfig=AWSConfig()) = route_53("DELETE", "/2013-04-01/trafficpolicy/$(Id)/$(Version)"; aws=aws)
DeleteTrafficPolicy(Id, Version, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("DELETE", "/2013-04-01/trafficpolicy/$(Id)/$(Version)", args; aws=aws)
...
"""
DeleteTrafficPolicyInstance(Id; aws::AWSConfig=AWSConfig()) = route_53("DELETE", "/2013-04-01/trafficpolicyinstance/$(Id)"; aws=aws)
DeleteTrafficPolicyInstance(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("DELETE", "/2013-04-01/trafficpolicyinstance/$(Id)", args; aws=aws)
...
"""
DeleteVPCAssociationAuthorization(Id, VPC; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/deauthorizevpcassociation", Dict{String, Any}("VPC"=>VPC))
DeleteVPCAssociationAuthorization(Id, VPC, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/deauthorizevpcassociation", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VPC"=>VPC), args)); aws=aws)
...
"""
DisassociateVPCFromHostedZone(Id, VPC; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/disassociatevpc", Dict{String, Any}("VPC"=>VPC))
DisassociateVPCFromHostedZone(Id, VPC, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone/$(Id)/disassociatevpc", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("VPC"=>VPC), args)); aws=aws)
...
"""
GetAccountLimit(Type; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/accountlimit/$(Type)"; aws=aws)
GetAccountLimit(Type, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/accountlimit/$(Type)", args; aws=aws)
...
"""
GetChange(Id; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/change/$(Id)"; aws=aws)
GetChange(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/change/$(Id)", args; aws=aws)
...
"""
GetCheckerIpRanges(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/checkeripranges"; aws=aws)
GetCheckerIpRanges(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/checkeripranges", args; aws=aws)
...
"""
GetGeoLocation(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/geolocation"; aws=aws)
GetGeoLocation(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/geolocation", args; aws=aws)
...
"""
GetHealthCheck(HealthCheckId; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/healthcheck/$(HealthCheckId)"; aws=aws)
GetHealthCheck(HealthCheckId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/healthcheck/$(HealthCheckId)", args; aws=aws)
...
"""
GetHealthCheckCount(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/healthcheckcount"; aws=aws)
GetHealthCheckCount(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/healthcheckcount", args; aws=aws)
...
"""
GetHealthCheckLastFailureReason(HealthCheckId; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/healthcheck/$(HealthCheckId)/lastfailurereason"; aws=aws)
GetHealthCheckLastFailureReason(HealthCheckId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/healthcheck/$(HealthCheckId)/lastfailurereason", args; aws=aws)
...
"""
GetHealthCheckStatus(HealthCheckId; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/healthcheck/$(HealthCheckId)/status"; aws=aws)
GetHealthCheckStatus(HealthCheckId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/healthcheck/$(HealthCheckId)/status", args; aws=aws)
...
"""
GetHostedZone(Id; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzone/$(Id)"; aws=aws)
GetHostedZone(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzone/$(Id)", args; aws=aws)
...
"""
GetHostedZoneCount(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzonecount"; aws=aws)
GetHostedZoneCount(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzonecount", args; aws=aws)
...
"""
GetHostedZoneLimit(Id, Type; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzonelimit/$(Id)/$(Type)"; aws=aws)
GetHostedZoneLimit(Id, Type, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzonelimit/$(Id)/$(Type)", args; aws=aws)
...
"""
GetQueryLoggingConfig(Id; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/queryloggingconfig/$(Id)"; aws=aws)
GetQueryLoggingConfig(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/queryloggingconfig/$(Id)", args; aws=aws)
...
"""
GetReusableDelegationSet(Id; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/delegationset/$(Id)"; aws=aws)
GetReusableDelegationSet(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/delegationset/$(Id)", args; aws=aws)
...
"""
GetReusableDelegationSetLimit(Id, Type; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/reusabledelegationsetlimit/$(Id)/$(Type)"; aws=aws)
GetReusableDelegationSetLimit(Id, Type, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/reusabledelegationsetlimit/$(Id)/$(Type)", args; aws=aws)
...
"""
GetTrafficPolicy(Id, Version; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicy/$(Id)/$(Version)"; aws=aws)
GetTrafficPolicy(Id, Version, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicy/$(Id)/$(Version)", args; aws=aws)
...
"""
GetTrafficPolicyInstance(Id; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicyinstance/$(Id)"; aws=aws)
GetTrafficPolicyInstance(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicyinstance/$(Id)", args; aws=aws)
...
"""
GetTrafficPolicyInstanceCount(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicyinstancecount"; aws=aws)
GetTrafficPolicyInstanceCount(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicyinstancecount", args; aws=aws)
...
"""
ListGeoLocations(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/geolocations"; aws=aws)
ListGeoLocations(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/geolocations", args; aws=aws)
...
"""
ListHealthChecks(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/healthcheck"; aws=aws)
ListHealthChecks(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/healthcheck", args; aws=aws)
...
"""
ListHostedZones(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzone"; aws=aws)
ListHostedZones(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzone", args; aws=aws)
...
"""
ListHostedZonesByName(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzonesbyname"; aws=aws)
ListHostedZonesByName(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzonesbyname", args; aws=aws)
...
"""
ListHostedZonesByVPC(vpcid, vpcregion; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzonesbyvpc", Dict{String, Any}("vpcid"=>vpcid, "vpcregion"=>vpcregion))
ListHostedZonesByVPC(vpcid, vpcregion, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzonesbyvpc", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("vpcid"=>vpcid, "vpcregion"=>vpcregion), args)); aws=aws)
...
"""
ListQueryLoggingConfigs(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/queryloggingconfig"; aws=aws)
ListQueryLoggingConfigs(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/queryloggingconfig", args; aws=aws)
...
"""
ListResourceRecordSets(Id; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzone/$(Id)/rrset"; aws=aws)
ListResourceRecordSets(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzone/$(Id)/rrset", args; aws=aws)
...
"""
ListReusableDelegationSets(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/delegationset"; aws=aws)
ListReusableDelegationSets(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/delegationset", args; aws=aws)
...
"""
ListTagsForResource(ResourceId, ResourceType; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/tags/$(ResourceType)/$(ResourceId)"; aws=aws)
ListTagsForResource(ResourceId, ResourceType, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/tags/$(ResourceType)/$(ResourceId)", args; aws=aws)
...
"""
ListTagsForResources(ResourceId, ResourceType; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/tags/$(ResourceType)", Dict{String, Any}("ResourceId"=>ResourceId))
ListTagsForResources(ResourceId, ResourceType, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/tags/$(ResourceType)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceId"=>ResourceId), args)); aws=aws)
...
"""
ListTrafficPolicies(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicies"; aws=aws)
ListTrafficPolicies(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicies", args; aws=aws)
...
"""
ListTrafficPolicyInstances(; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicyinstances"; aws=aws)
ListTrafficPolicyInstances(args::AbstractDict{String, Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicyinstances", args; aws=aws)
...
"""
ListTrafficPolicyInstancesByHostedZone(id; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicyinstances/hostedzone", Dict{String, Any}("id"=>id))
ListTrafficPolicyInstancesByHostedZone(id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicyinstances/hostedzone", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("id"=>id), args)); aws=aws)
...
"""
ListTrafficPolicyInstancesByPolicy(id, version; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicyinstances/trafficpolicy", Dict{String, Any}("id"=>id, "version"=>version))
ListTrafficPolicyInstancesByPolicy(id, version, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicyinstances/trafficpolicy", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("id"=>id, "version"=>version), args)); aws=aws)
...
"""
ListTrafficPolicyVersions(Id; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicies/$(Id)/versions"; aws=aws)
ListTrafficPolicyVersions(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/trafficpolicies/$(Id)/versions", args; aws=aws)
...
"""
ListVPCAssociationAuthorizations(Id; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzone/$(Id)/authorizevpcassociation"; aws=aws)
ListVPCAssociationAuthorizations(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/hostedzone/$(Id)/authorizevpcassociation", args; aws=aws)
...
"""
TestDNSAnswer(hostedzoneid, recordname, recordtype; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/testdnsanswer", Dict{String, Any}("hostedzoneid"=>hostedzoneid, "recordname"=>recordname, "recordtype"=>recordtype))
TestDNSAnswer(hostedzoneid, recordname, recordtype, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("GET", "/2013-04-01/testdnsanswer", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("hostedzoneid"=>hostedzoneid, "recordname"=>recordname, "recordtype"=>recordtype), args)); aws=aws)
...
"""
UpdateHealthCheck(HealthCheckId; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/healthcheck/$(HealthCheckId)"; aws=aws)
UpdateHealthCheck(HealthCheckId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/healthcheck/$(HealthCheckId)", args; aws=aws)
...
"""
UpdateHostedZoneComment(Id; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone/$(Id)"; aws=aws)
UpdateHostedZoneComment(Id, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/hostedzone/$(Id)", args; aws=aws)
...
"""
UpdateTrafficPolicyComment(Comment, Id, Version; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/trafficpolicy/$(Id)/$(Version)", Dict{String, Any}("Comment"=>Comment))
UpdateTrafficPolicyComment(Comment, Id, Version, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/trafficpolicy/$(Id)/$(Version)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Comment"=>Comment), args)); aws=aws)
...
"""
UpdateTrafficPolicyInstance(Id, TTL, TrafficPolicyId, TrafficPolicyVersion; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/trafficpolicyinstance/$(Id)", Dict{String, Any}("TTL"=>TTL, "TrafficPolicyId"=>TrafficPolicyId, "TrafficPolicyVersion"=>TrafficPolicyVersion))
UpdateTrafficPolicyInstance(Id, TTL, TrafficPolicyId, TrafficPolicyVersion, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = route_53("POST", "/2013-04-01/trafficpolicyinstance/$(Id)", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("TTL"=>TTL, "TrafficPolicyId"=>TrafficPolicyId, "TrafficPolicyVersion"=>TrafficPolicyVersion), args)); aws=aws)
