...
"""
CreateHostedZone(CallerReference, Name) = route_53("POST", "/2013-04-01/hostedzone")
CreateHostedZone(CallerReference, Name, args) = route_53("POST", "/2013-04-01/hostedzone", args)
...
"""
CreateQueryLoggingConfig(CloudWatchLogsLogGroupArn, HostedZoneId) = route_53("POST", "/2013-04-01/queryloggingconfig")
CreateQueryLoggingConfig(CloudWatchLogsLogGroupArn, HostedZoneId, args) = route_53("POST", "/2013-04-01/queryloggingconfig", args)
...
"""
CreateTrafficPolicy(Document, Name) = route_53("POST", "/2013-04-01/trafficpolicy")
CreateTrafficPolicy(Document, Name, args) = route_53("POST", "/2013-04-01/trafficpolicy", args)
