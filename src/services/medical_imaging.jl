...
function delete_datastore(datastoreId; aws_config::AbstractAWSConfig=current_aws_config())
    return medical_imaging(
        "DELETE", "/datastore/$(datastoreId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function get_datastore(datastoreId; aws_config::AbstractAWSConfig=current_aws_config())
    return medical_imaging(
        "GET", "/datastore/$(datastoreId)"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_datastores(; aws_config::AbstractAWSConfig=current_aws_config())
    return medical_imaging("GET", "/datastore"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_datastores(
    ...
    return medical_imaging(
        "GET", "/datastore", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
