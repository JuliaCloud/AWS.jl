...
"""
AddClientIDToOpenIDConnectProvider(ClientID, OpenIDConnectProviderArn) = iam("AddClientIDToOpenIDConnectProvider", Dict{String, Any}("ClientID"=>ClientID, "OpenIDConnectProviderArn"=>OpenIDConnectProviderArn))
AddClientIDToOpenIDConnectProvider(ClientID, OpenIDConnectProviderArn, args::AbstractDict{String, <:Any}) = iam("AddClientIDToOpenIDConnectProvider", Dict{String, Any}("ClientID"=>ClientID, "OpenIDConnectProviderArn"=>OpenIDConnectProviderArn, args...))
...
"""
AddRoleToInstanceProfile(InstanceProfileName, RoleName) = iam("AddRoleToInstanceProfile", Dict{String, Any}("InstanceProfileName"=>InstanceProfileName, "RoleName"=>RoleName))
AddRoleToInstanceProfile(InstanceProfileName, RoleName, args::AbstractDict{String, <:Any}) = iam("AddRoleToInstanceProfile", Dict{String, Any}("InstanceProfileName"=>InstanceProfileName, "RoleName"=>RoleName, args...))
...
"""
AddUserToGroup(GroupName, UserName) = iam("AddUserToGroup", Dict{String, Any}("GroupName"=>GroupName, "UserName"=>UserName))
AddUserToGroup(GroupName, UserName, args::AbstractDict{String, <:Any}) = iam("AddUserToGroup", Dict{String, Any}("GroupName"=>GroupName, "UserName"=>UserName, args...))
...
"""
AttachGroupPolicy(GroupName, PolicyArn) = iam("AttachGroupPolicy", Dict{String, Any}("GroupName"=>GroupName, "PolicyArn"=>PolicyArn))
AttachGroupPolicy(GroupName, PolicyArn, args::AbstractDict{String, <:Any}) = iam("AttachGroupPolicy", Dict{String, Any}("GroupName"=>GroupName, "PolicyArn"=>PolicyArn, args...))
...
"""
AttachRolePolicy(PolicyArn, RoleName) = iam("AttachRolePolicy", Dict{String, Any}("PolicyArn"=>PolicyArn, "RoleName"=>RoleName))
AttachRolePolicy(PolicyArn, RoleName, args::AbstractDict{String, <:Any}) = iam("AttachRolePolicy", Dict{String, Any}("PolicyArn"=>PolicyArn, "RoleName"=>RoleName, args...))
...
"""
AttachUserPolicy(PolicyArn, UserName) = iam("AttachUserPolicy", Dict{String, Any}("PolicyArn"=>PolicyArn, "UserName"=>UserName))
AttachUserPolicy(PolicyArn, UserName, args::AbstractDict{String, <:Any}) = iam("AttachUserPolicy", Dict{String, Any}("PolicyArn"=>PolicyArn, "UserName"=>UserName, args...))
...
"""
ChangePassword(NewPassword, OldPassword) = iam("ChangePassword", Dict{String, Any}("NewPassword"=>NewPassword, "OldPassword"=>OldPassword))
ChangePassword(NewPassword, OldPassword, args::AbstractDict{String, <:Any}) = iam("ChangePassword", Dict{String, Any}("NewPassword"=>NewPassword, "OldPassword"=>OldPassword, args...))
...
CreateAccessKey(args::AbstractDict{String, <:Any}) = iam("CreateAccessKey", args)
...
"""
CreateAccountAlias(AccountAlias) = iam("CreateAccountAlias", Dict{String, Any}("AccountAlias"=>AccountAlias))
CreateAccountAlias(AccountAlias, args::AbstractDict{String, <:Any}) = iam("CreateAccountAlias", Dict{String, Any}("AccountAlias"=>AccountAlias, args...))
...
"""
CreateGroup(GroupName) = iam("CreateGroup", Dict{String, Any}("GroupName"=>GroupName))
CreateGroup(GroupName, args::AbstractDict{String, <:Any}) = iam("CreateGroup", Dict{String, Any}("GroupName"=>GroupName, args...))
...
"""
CreateInstanceProfile(InstanceProfileName) = iam("CreateInstanceProfile", Dict{String, Any}("InstanceProfileName"=>InstanceProfileName))
CreateInstanceProfile(InstanceProfileName, args::AbstractDict{String, <:Any}) = iam("CreateInstanceProfile", Dict{String, Any}("InstanceProfileName"=>InstanceProfileName, args...))
...
"""
CreateLoginProfile(Password, UserName) = iam("CreateLoginProfile", Dict{String, Any}("Password"=>Password, "UserName"=>UserName))
CreateLoginProfile(Password, UserName, args::AbstractDict{String, <:Any}) = iam("CreateLoginProfile", Dict{String, Any}("Password"=>Password, "UserName"=>UserName, args...))
...
"""
CreateOpenIDConnectProvider(ThumbprintList, Url) = iam("CreateOpenIDConnectProvider", Dict{String, Any}("ThumbprintList"=>ThumbprintList, "Url"=>Url))
CreateOpenIDConnectProvider(ThumbprintList, Url, args::AbstractDict{String, <:Any}) = iam("CreateOpenIDConnectProvider", Dict{String, Any}("ThumbprintList"=>ThumbprintList, "Url"=>Url, args...))
...
"""
CreatePolicy(PolicyDocument, PolicyName) = iam("CreatePolicy", Dict{String, Any}("PolicyDocument"=>PolicyDocument, "PolicyName"=>PolicyName))
CreatePolicy(PolicyDocument, PolicyName, args::AbstractDict{String, <:Any}) = iam("CreatePolicy", Dict{String, Any}("PolicyDocument"=>PolicyDocument, "PolicyName"=>PolicyName, args...))
...
"""
CreatePolicyVersion(PolicyArn, PolicyDocument) = iam("CreatePolicyVersion", Dict{String, Any}("PolicyArn"=>PolicyArn, "PolicyDocument"=>PolicyDocument))
CreatePolicyVersion(PolicyArn, PolicyDocument, args::AbstractDict{String, <:Any}) = iam("CreatePolicyVersion", Dict{String, Any}("PolicyArn"=>PolicyArn, "PolicyDocument"=>PolicyDocument, args...))
...
"""
CreateRole(AssumeRolePolicyDocument, RoleName) = iam("CreateRole", Dict{String, Any}("AssumeRolePolicyDocument"=>AssumeRolePolicyDocument, "RoleName"=>RoleName))
CreateRole(AssumeRolePolicyDocument, RoleName, args::AbstractDict{String, <:Any}) = iam("CreateRole", Dict{String, Any}("AssumeRolePolicyDocument"=>AssumeRolePolicyDocument, "RoleName"=>RoleName, args...))
...
"""
CreateSAMLProvider(Name, SAMLMetadataDocument) = iam("CreateSAMLProvider", Dict{String, Any}("Name"=>Name, "SAMLMetadataDocument"=>SAMLMetadataDocument))
CreateSAMLProvider(Name, SAMLMetadataDocument, args::AbstractDict{String, <:Any}) = iam("CreateSAMLProvider", Dict{String, Any}("Name"=>Name, "SAMLMetadataDocument"=>SAMLMetadataDocument, args...))
...
"""
CreateServiceLinkedRole(AWSServiceName) = iam("CreateServiceLinkedRole", Dict{String, Any}("AWSServiceName"=>AWSServiceName))
CreateServiceLinkedRole(AWSServiceName, args::AbstractDict{String, <:Any}) = iam("CreateServiceLinkedRole", Dict{String, Any}("AWSServiceName"=>AWSServiceName, args...))
...
"""
CreateServiceSpecificCredential(ServiceName, UserName) = iam("CreateServiceSpecificCredential", Dict{String, Any}("ServiceName"=>ServiceName, "UserName"=>UserName))
CreateServiceSpecificCredential(ServiceName, UserName, args::AbstractDict{String, <:Any}) = iam("CreateServiceSpecificCredential", Dict{String, Any}("ServiceName"=>ServiceName, "UserName"=>UserName, args...))
...
"""
CreateUser(UserName) = iam("CreateUser", Dict{String, Any}("UserName"=>UserName))
CreateUser(UserName, args::AbstractDict{String, <:Any}) = iam("CreateUser", Dict{String, Any}("UserName"=>UserName, args...))
...
"""
CreateVirtualMFADevice(VirtualMFADeviceName) = iam("CreateVirtualMFADevice", Dict{String, Any}("VirtualMFADeviceName"=>VirtualMFADeviceName))
CreateVirtualMFADevice(VirtualMFADeviceName, args::AbstractDict{String, <:Any}) = iam("CreateVirtualMFADevice", Dict{String, Any}("VirtualMFADeviceName"=>VirtualMFADeviceName, args...))
...
"""
DeactivateMFADevice(SerialNumber, UserName) = iam("DeactivateMFADevice", Dict{String, Any}("SerialNumber"=>SerialNumber, "UserName"=>UserName))
DeactivateMFADevice(SerialNumber, UserName, args::AbstractDict{String, <:Any}) = iam("DeactivateMFADevice", Dict{String, Any}("SerialNumber"=>SerialNumber, "UserName"=>UserName, args...))
...
"""
DeleteAccessKey(AccessKeyId) = iam("DeleteAccessKey", Dict{String, Any}("AccessKeyId"=>AccessKeyId))
DeleteAccessKey(AccessKeyId, args::AbstractDict{String, <:Any}) = iam("DeleteAccessKey", Dict{String, Any}("AccessKeyId"=>AccessKeyId, args...))
...
"""
DeleteAccountAlias(AccountAlias) = iam("DeleteAccountAlias", Dict{String, Any}("AccountAlias"=>AccountAlias))
DeleteAccountAlias(AccountAlias, args::AbstractDict{String, <:Any}) = iam("DeleteAccountAlias", Dict{String, Any}("AccountAlias"=>AccountAlias, args...))
...
DeleteAccountPasswordPolicy(args::AbstractDict{String, <:Any}) = iam("DeleteAccountPasswordPolicy", args)
...
"""
DeleteGroup(GroupName) = iam("DeleteGroup", Dict{String, Any}("GroupName"=>GroupName))
DeleteGroup(GroupName, args::AbstractDict{String, <:Any}) = iam("DeleteGroup", Dict{String, Any}("GroupName"=>GroupName, args...))
...
"""
DeleteGroupPolicy(GroupName, PolicyName) = iam("DeleteGroupPolicy", Dict{String, Any}("GroupName"=>GroupName, "PolicyName"=>PolicyName))
DeleteGroupPolicy(GroupName, PolicyName, args::AbstractDict{String, <:Any}) = iam("DeleteGroupPolicy", Dict{String, Any}("GroupName"=>GroupName, "PolicyName"=>PolicyName, args...))
...
"""
DeleteInstanceProfile(InstanceProfileName) = iam("DeleteInstanceProfile", Dict{String, Any}("InstanceProfileName"=>InstanceProfileName))
DeleteInstanceProfile(InstanceProfileName, args::AbstractDict{String, <:Any}) = iam("DeleteInstanceProfile", Dict{String, Any}("InstanceProfileName"=>InstanceProfileName, args...))
...
"""
DeleteLoginProfile(UserName) = iam("DeleteLoginProfile", Dict{String, Any}("UserName"=>UserName))
DeleteLoginProfile(UserName, args::AbstractDict{String, <:Any}) = iam("DeleteLoginProfile", Dict{String, Any}("UserName"=>UserName, args...))
...
"""
DeleteOpenIDConnectProvider(OpenIDConnectProviderArn) = iam("DeleteOpenIDConnectProvider", Dict{String, Any}("OpenIDConnectProviderArn"=>OpenIDConnectProviderArn))
DeleteOpenIDConnectProvider(OpenIDConnectProviderArn, args::AbstractDict{String, <:Any}) = iam("DeleteOpenIDConnectProvider", Dict{String, Any}("OpenIDConnectProviderArn"=>OpenIDConnectProviderArn, args...))
...
"""
DeletePolicy(PolicyArn) = iam("DeletePolicy", Dict{String, Any}("PolicyArn"=>PolicyArn))
DeletePolicy(PolicyArn, args::AbstractDict{String, <:Any}) = iam("DeletePolicy", Dict{String, Any}("PolicyArn"=>PolicyArn, args...))
...
"""
DeletePolicyVersion(PolicyArn, VersionId) = iam("DeletePolicyVersion", Dict{String, Any}("PolicyArn"=>PolicyArn, "VersionId"=>VersionId))
DeletePolicyVersion(PolicyArn, VersionId, args::AbstractDict{String, <:Any}) = iam("DeletePolicyVersion", Dict{String, Any}("PolicyArn"=>PolicyArn, "VersionId"=>VersionId, args...))
...
"""
DeleteRole(RoleName) = iam("DeleteRole", Dict{String, Any}("RoleName"=>RoleName))
DeleteRole(RoleName, args::AbstractDict{String, <:Any}) = iam("DeleteRole", Dict{String, Any}("RoleName"=>RoleName, args...))
...
"""
DeleteRolePermissionsBoundary(RoleName) = iam("DeleteRolePermissionsBoundary", Dict{String, Any}("RoleName"=>RoleName))
DeleteRolePermissionsBoundary(RoleName, args::AbstractDict{String, <:Any}) = iam("DeleteRolePermissionsBoundary", Dict{String, Any}("RoleName"=>RoleName, args...))
...
"""
DeleteRolePolicy(PolicyName, RoleName) = iam("DeleteRolePolicy", Dict{String, Any}("PolicyName"=>PolicyName, "RoleName"=>RoleName))
DeleteRolePolicy(PolicyName, RoleName, args::AbstractDict{String, <:Any}) = iam("DeleteRolePolicy", Dict{String, Any}("PolicyName"=>PolicyName, "RoleName"=>RoleName, args...))
...
"""
DeleteSAMLProvider(SAMLProviderArn) = iam("DeleteSAMLProvider", Dict{String, Any}("SAMLProviderArn"=>SAMLProviderArn))
DeleteSAMLProvider(SAMLProviderArn, args::AbstractDict{String, <:Any}) = iam("DeleteSAMLProvider", Dict{String, Any}("SAMLProviderArn"=>SAMLProviderArn, args...))
...
"""
DeleteSSHPublicKey(SSHPublicKeyId, UserName) = iam("DeleteSSHPublicKey", Dict{String, Any}("SSHPublicKeyId"=>SSHPublicKeyId, "UserName"=>UserName))
DeleteSSHPublicKey(SSHPublicKeyId, UserName, args::AbstractDict{String, <:Any}) = iam("DeleteSSHPublicKey", Dict{String, Any}("SSHPublicKeyId"=>SSHPublicKeyId, "UserName"=>UserName, args...))
...
"""
DeleteServerCertificate(ServerCertificateName) = iam("DeleteServerCertificate", Dict{String, Any}("ServerCertificateName"=>ServerCertificateName))
DeleteServerCertificate(ServerCertificateName, args::AbstractDict{String, <:Any}) = iam("DeleteServerCertificate", Dict{String, Any}("ServerCertificateName"=>ServerCertificateName, args...))
...
"""
DeleteServiceLinkedRole(RoleName) = iam("DeleteServiceLinkedRole", Dict{String, Any}("RoleName"=>RoleName))
DeleteServiceLinkedRole(RoleName, args::AbstractDict{String, <:Any}) = iam("DeleteServiceLinkedRole", Dict{String, Any}("RoleName"=>RoleName, args...))
...
"""
DeleteServiceSpecificCredential(ServiceSpecificCredentialId) = iam("DeleteServiceSpecificCredential", Dict{String, Any}("ServiceSpecificCredentialId"=>ServiceSpecificCredentialId))
DeleteServiceSpecificCredential(ServiceSpecificCredentialId, args::AbstractDict{String, <:Any}) = iam("DeleteServiceSpecificCredential", Dict{String, Any}("ServiceSpecificCredentialId"=>ServiceSpecificCredentialId, args...))
...
"""
DeleteSigningCertificate(CertificateId) = iam("DeleteSigningCertificate", Dict{String, Any}("CertificateId"=>CertificateId))
DeleteSigningCertificate(CertificateId, args::AbstractDict{String, <:Any}) = iam("DeleteSigningCertificate", Dict{String, Any}("CertificateId"=>CertificateId, args...))
...
"""
DeleteUser(UserName) = iam("DeleteUser", Dict{String, Any}("UserName"=>UserName))
DeleteUser(UserName, args::AbstractDict{String, <:Any}) = iam("DeleteUser", Dict{String, Any}("UserName"=>UserName, args...))
...
"""
DeleteUserPermissionsBoundary(UserName) = iam("DeleteUserPermissionsBoundary", Dict{String, Any}("UserName"=>UserName))
DeleteUserPermissionsBoundary(UserName, args::AbstractDict{String, <:Any}) = iam("DeleteUserPermissionsBoundary", Dict{String, Any}("UserName"=>UserName, args...))
...
"""
DeleteUserPolicy(PolicyName, UserName) = iam("DeleteUserPolicy", Dict{String, Any}("PolicyName"=>PolicyName, "UserName"=>UserName))
DeleteUserPolicy(PolicyName, UserName, args::AbstractDict{String, <:Any}) = iam("DeleteUserPolicy", Dict{String, Any}("PolicyName"=>PolicyName, "UserName"=>UserName, args...))
...
"""
DeleteVirtualMFADevice(SerialNumber) = iam("DeleteVirtualMFADevice", Dict{String, Any}("SerialNumber"=>SerialNumber))
DeleteVirtualMFADevice(SerialNumber, args::AbstractDict{String, <:Any}) = iam("DeleteVirtualMFADevice", Dict{String, Any}("SerialNumber"=>SerialNumber, args...))
...
"""
DetachGroupPolicy(GroupName, PolicyArn) = iam("DetachGroupPolicy", Dict{String, Any}("GroupName"=>GroupName, "PolicyArn"=>PolicyArn))
DetachGroupPolicy(GroupName, PolicyArn, args::AbstractDict{String, <:Any}) = iam("DetachGroupPolicy", Dict{String, Any}("GroupName"=>GroupName, "PolicyArn"=>PolicyArn, args...))
...
"""
DetachRolePolicy(PolicyArn, RoleName) = iam("DetachRolePolicy", Dict{String, Any}("PolicyArn"=>PolicyArn, "RoleName"=>RoleName))
DetachRolePolicy(PolicyArn, RoleName, args::AbstractDict{String, <:Any}) = iam("DetachRolePolicy", Dict{String, Any}("PolicyArn"=>PolicyArn, "RoleName"=>RoleName, args...))
...
"""
DetachUserPolicy(PolicyArn, UserName) = iam("DetachUserPolicy", Dict{String, Any}("PolicyArn"=>PolicyArn, "UserName"=>UserName))
DetachUserPolicy(PolicyArn, UserName, args::AbstractDict{String, <:Any}) = iam("DetachUserPolicy", Dict{String, Any}("PolicyArn"=>PolicyArn, "UserName"=>UserName, args...))
...
"""
EnableMFADevice(AuthenticationCode1, AuthenticationCode2, SerialNumber, UserName) = iam("EnableMFADevice", Dict{String, Any}("AuthenticationCode1"=>AuthenticationCode1, "AuthenticationCode2"=>AuthenticationCode2, "SerialNumber"=>SerialNumber, "UserName"=>UserName))
EnableMFADevice(AuthenticationCode1, AuthenticationCode2, SerialNumber, UserName, args::AbstractDict{String, <:Any}) = iam("EnableMFADevice", Dict{String, Any}("AuthenticationCode1"=>AuthenticationCode1, "AuthenticationCode2"=>AuthenticationCode2, "SerialNumber"=>SerialNumber, "UserName"=>UserName, args...))
...
GenerateCredentialReport(args::AbstractDict{String, <:Any}) = iam("GenerateCredentialReport", args)
...
"""
GenerateOrganizationsAccessReport(EntityPath) = iam("GenerateOrganizationsAccessReport", Dict{String, Any}("EntityPath"=>EntityPath))
GenerateOrganizationsAccessReport(EntityPath, args::AbstractDict{String, <:Any}) = iam("GenerateOrganizationsAccessReport", Dict{String, Any}("EntityPath"=>EntityPath, args...))
...
"""
GenerateServiceLastAccessedDetails(Arn) = iam("GenerateServiceLastAccessedDetails", Dict{String, Any}("Arn"=>Arn))
GenerateServiceLastAccessedDetails(Arn, args::AbstractDict{String, <:Any}) = iam("GenerateServiceLastAccessedDetails", Dict{String, Any}("Arn"=>Arn, args...))
...
"""
GetAccessKeyLastUsed(AccessKeyId) = iam("GetAccessKeyLastUsed", Dict{String, Any}("AccessKeyId"=>AccessKeyId))
GetAccessKeyLastUsed(AccessKeyId, args::AbstractDict{String, <:Any}) = iam("GetAccessKeyLastUsed", Dict{String, Any}("AccessKeyId"=>AccessKeyId, args...))
...
GetAccountAuthorizationDetails(args::AbstractDict{String, <:Any}) = iam("GetAccountAuthorizationDetails", args)
...
GetAccountPasswordPolicy(args::AbstractDict{String, <:Any}) = iam("GetAccountPasswordPolicy", args)
...
GetAccountSummary(args::AbstractDict{String, <:Any}) = iam("GetAccountSummary", args)
...
"""
GetContextKeysForCustomPolicy(PolicyInputList) = iam("GetContextKeysForCustomPolicy", Dict{String, Any}("PolicyInputList"=>PolicyInputList))
GetContextKeysForCustomPolicy(PolicyInputList, args::AbstractDict{String, <:Any}) = iam("GetContextKeysForCustomPolicy", Dict{String, Any}("PolicyInputList"=>PolicyInputList, args...))
...
"""
GetContextKeysForPrincipalPolicy(PolicySourceArn) = iam("GetContextKeysForPrincipalPolicy", Dict{String, Any}("PolicySourceArn"=>PolicySourceArn))
GetContextKeysForPrincipalPolicy(PolicySourceArn, args::AbstractDict{String, <:Any}) = iam("GetContextKeysForPrincipalPolicy", Dict{String, Any}("PolicySourceArn"=>PolicySourceArn, args...))
...
GetCredentialReport(args::AbstractDict{String, <:Any}) = iam("GetCredentialReport", args)
...
- `MaxItems`: Use this only when paginating results to indicate the maximum number of items you want in the response. If additional items exist beyond the maximum you specify, the IsTruncated response element is true. If you do not include this parameter, the number of items defaults to 100. Note that IAM might return fewer results, even when there are more results available. In that case, the IsTruncated response element returns true, and Marker contains a value to include in the subsequent call that tells the service where to continue from.
"""
GetGroup(GroupName) = iam("GetGroup", Dict{String, Any}("GroupName"=>GroupName))
GetGroup(GroupName, args::AbstractDict{String, <:Any}) = iam("GetGroup", Dict{String, Any}("GroupName"=>GroupName, args...))
...
"""
GetGroupPolicy(GroupName, PolicyName) = iam("GetGroupPolicy", Dict{String, Any}("GroupName"=>GroupName, "PolicyName"=>PolicyName))
GetGroupPolicy(GroupName, PolicyName, args::AbstractDict{String, <:Any}) = iam("GetGroupPolicy", Dict{String, Any}("GroupName"=>GroupName, "PolicyName"=>PolicyName, args...))
...
"""
GetInstanceProfile(InstanceProfileName) = iam("GetInstanceProfile", Dict{String, Any}("InstanceProfileName"=>InstanceProfileName))
GetInstanceProfile(InstanceProfileName, args::AbstractDict{String, <:Any}) = iam("GetInstanceProfile", Dict{String, Any}("InstanceProfileName"=>InstanceProfileName, args...))
...
"""
GetLoginProfile(UserName) = iam("GetLoginProfile", Dict{String, Any}("UserName"=>UserName))
GetLoginProfile(UserName, args::AbstractDict{String, <:Any}) = iam("GetLoginProfile", Dict{String, Any}("UserName"=>UserName, args...))
...
"""
GetOpenIDConnectProvider(OpenIDConnectProviderArn) = iam("GetOpenIDConnectProvider", Dict{String, Any}("OpenIDConnectProviderArn"=>OpenIDConnectProviderArn))
GetOpenIDConnectProvider(OpenIDConnectProviderArn, args::AbstractDict{String, <:Any}) = iam("GetOpenIDConnectProvider", Dict{String, Any}("OpenIDConnectProviderArn"=>OpenIDConnectProviderArn, args...))
...
"""
GetOrganizationsAccessReport(JobId) = iam("GetOrganizationsAccessReport", Dict{String, Any}("JobId"=>JobId))
GetOrganizationsAccessReport(JobId, args::AbstractDict{String, <:Any}) = iam("GetOrganizationsAccessReport", Dict{String, Any}("JobId"=>JobId, args...))
...
"""
GetPolicy(PolicyArn) = iam("GetPolicy", Dict{String, Any}("PolicyArn"=>PolicyArn))
GetPolicy(PolicyArn, args::AbstractDict{String, <:Any}) = iam("GetPolicy", Dict{String, Any}("PolicyArn"=>PolicyArn, args...))
...
"""
GetPolicyVersion(PolicyArn, VersionId) = iam("GetPolicyVersion", Dict{String, Any}("PolicyArn"=>PolicyArn, "VersionId"=>VersionId))
GetPolicyVersion(PolicyArn, VersionId, args::AbstractDict{String, <:Any}) = iam("GetPolicyVersion", Dict{String, Any}("PolicyArn"=>PolicyArn, "VersionId"=>VersionId, args...))
...
"""
GetRole(RoleName) = iam("GetRole", Dict{String, Any}("RoleName"=>RoleName))
GetRole(RoleName, args::AbstractDict{String, <:Any}) = iam("GetRole", Dict{String, Any}("RoleName"=>RoleName, args...))
...
"""
GetRolePolicy(PolicyName, RoleName) = iam("GetRolePolicy", Dict{String, Any}("PolicyName"=>PolicyName, "RoleName"=>RoleName))
GetRolePolicy(PolicyName, RoleName, args::AbstractDict{String, <:Any}) = iam("GetRolePolicy", Dict{String, Any}("PolicyName"=>PolicyName, "RoleName"=>RoleName, args...))
...
"""
GetSAMLProvider(SAMLProviderArn) = iam("GetSAMLProvider", Dict{String, Any}("SAMLProviderArn"=>SAMLProviderArn))
GetSAMLProvider(SAMLProviderArn, args::AbstractDict{String, <:Any}) = iam("GetSAMLProvider", Dict{String, Any}("SAMLProviderArn"=>SAMLProviderArn, args...))
...
"""
GetSSHPublicKey(Encoding, SSHPublicKeyId, UserName) = iam("GetSSHPublicKey", Dict{String, Any}("Encoding"=>Encoding, "SSHPublicKeyId"=>SSHPublicKeyId, "UserName"=>UserName))
GetSSHPublicKey(Encoding, SSHPublicKeyId, UserName, args::AbstractDict{String, <:Any}) = iam("GetSSHPublicKey", Dict{String, Any}("Encoding"=>Encoding, "SSHPublicKeyId"=>SSHPublicKeyId, "UserName"=>UserName, args...))
...
"""
GetServerCertificate(ServerCertificateName) = iam("GetServerCertificate", Dict{String, Any}("ServerCertificateName"=>ServerCertificateName))
GetServerCertificate(ServerCertificateName, args::AbstractDict{String, <:Any}) = iam("GetServerCertificate", Dict{String, Any}("ServerCertificateName"=>ServerCertificateName, args...))
...
- `MaxItems`: Use this only when paginating results to indicate the maximum number of items you want in the response. If additional items exist beyond the maximum you specify, the IsTruncated response element is true. If you do not include this parameter, the number of items defaults to 100. Note that IAM might return fewer results, even when there are more results available. In that case, the IsTruncated response element returns true, and Marker contains a value to include in the subsequent call that tells the service where to continue from.
"""
GetServiceLastAccessedDetails(JobId) = iam("GetServiceLastAccessedDetails", Dict{String, Any}("JobId"=>JobId))
GetServiceLastAccessedDetails(JobId, args::AbstractDict{String, <:Any}) = iam("GetServiceLastAccessedDetails", Dict{String, Any}("JobId"=>JobId, args...))
...
- `MaxItems`: Use this only when paginating results to indicate the maximum number of items you want in the response. If additional items exist beyond the maximum you specify, the IsTruncated response element is true. If you do not include this parameter, the number of items defaults to 100. Note that IAM might return fewer results, even when there are more results available. In that case, the IsTruncated response element returns true, and Marker contains a value to include in the subsequent call that tells the service where to continue from.
"""
GetServiceLastAccessedDetailsWithEntities(JobId, ServiceNamespace) = iam("GetServiceLastAccessedDetailsWithEntities", Dict{String, Any}("JobId"=>JobId, "ServiceNamespace"=>ServiceNamespace))
GetServiceLastAccessedDetailsWithEntities(JobId, ServiceNamespace, args::AbstractDict{String, <:Any}) = iam("GetServiceLastAccessedDetailsWithEntities", Dict{String, Any}("JobId"=>JobId, "ServiceNamespace"=>ServiceNamespace, args...))
...
"""
GetServiceLinkedRoleDeletionStatus(DeletionTaskId) = iam("GetServiceLinkedRoleDeletionStatus", Dict{String, Any}("DeletionTaskId"=>DeletionTaskId))
GetServiceLinkedRoleDeletionStatus(DeletionTaskId, args::AbstractDict{String, <:Any}) = iam("GetServiceLinkedRoleDeletionStatus", Dict{String, Any}("DeletionTaskId"=>DeletionTaskId, args...))
...
"""
GetUser() = iam("GetUser")
GetUser(args::AbstractDict{String, <:Any}) = iam("GetUser", args)
...
"""
GetUserPolicy(PolicyName, UserName) = iam("GetUserPolicy", Dict{String, Any}("PolicyName"=>PolicyName, "UserName"=>UserName))
GetUserPolicy(PolicyName, UserName, args::AbstractDict{String, <:Any}) = iam("GetUserPolicy", Dict{String, Any}("PolicyName"=>PolicyName, "UserName"=>UserName, args...))
...
ListAccessKeys(args::AbstractDict{String, <:Any}) = iam("ListAccessKeys", args)
...
ListAccountAliases(args::AbstractDict{String, <:Any}) = iam("ListAccountAliases", args)
...
"""
ListAttachedGroupPolicies(GroupName) = iam("ListAttachedGroupPolicies", Dict{String, Any}("GroupName"=>GroupName))
ListAttachedGroupPolicies(GroupName, args::AbstractDict{String, <:Any}) = iam("ListAttachedGroupPolicies", Dict{String, Any}("GroupName"=>GroupName, args...))
...
- `PathPrefix`: The path prefix for filtering the results. This parameter is optional. If it is not included, it defaults to a slash (/), listing all policies. This parameter allows (through its regex pattern) a string of characters consisting of either a forward slash (/) by itself or a string that must begin and end with forward slashes. In addition, it can contain any ASCII character from the ! ( u0021) through the DEL character ( u007F), including most punctuation characters, digits, and upper and lowercased letters.
"""
ListAttachedRolePolicies(RoleName) = iam("ListAttachedRolePolicies", Dict{String, Any}("RoleName"=>RoleName))
ListAttachedRolePolicies(RoleName, args::AbstractDict{String, <:Any}) = iam("ListAttachedRolePolicies", Dict{String, Any}("RoleName"=>RoleName, args...))
...
- `PathPrefix`: The path prefix for filtering the results. This parameter is optional. If it is not included, it defaults to a slash (/), listing all policies. This parameter allows (through its regex pattern) a string of characters consisting of either a forward slash (/) by itself or a string that must begin and end with forward slashes. In addition, it can contain any ASCII character from the ! ( u0021) through the DEL character ( u007F), including most punctuation characters, digits, and upper and lowercased letters.
"""
ListAttachedUserPolicies(UserName) = iam("ListAttachedUserPolicies", Dict{String, Any}("UserName"=>UserName))
ListAttachedUserPolicies(UserName, args::AbstractDict{String, <:Any}) = iam("ListAttachedUserPolicies", Dict{String, Any}("UserName"=>UserName, args...))
...
"""
ListEntitiesForPolicy(PolicyArn) = iam("ListEntitiesForPolicy", Dict{String, Any}("PolicyArn"=>PolicyArn))
ListEntitiesForPolicy(PolicyArn, args::AbstractDict{String, <:Any}) = iam("ListEntitiesForPolicy", Dict{String, Any}("PolicyArn"=>PolicyArn, args...))
...
- `MaxItems`: Use this only when paginating results to indicate the maximum number of items you want in the response. If additional items exist beyond the maximum you specify, the IsTruncated response element is true. If you do not include this parameter, the number of items defaults to 100. Note that IAM might return fewer results, even when there are more results available. In that case, the IsTruncated response element returns true, and Marker contains a value to include in the subsequent call that tells the service where to continue from.
"""
ListGroupPolicies(GroupName) = iam("ListGroupPolicies", Dict{String, Any}("GroupName"=>GroupName))
ListGroupPolicies(GroupName, args::AbstractDict{String, <:Any}) = iam("ListGroupPolicies", Dict{String, Any}("GroupName"=>GroupName, args...))
...
ListGroups(args::AbstractDict{String, <:Any}) = iam("ListGroups", args)
...
- `MaxItems`: Use this only when paginating results to indicate the maximum number of items you want in the response. If additional items exist beyond the maximum you specify, the IsTruncated response element is true. If you do not include this parameter, the number of items defaults to 100. Note that IAM might return fewer results, even when there are more results available. In that case, the IsTruncated response element returns true, and Marker contains a value to include in the subsequent call that tells the service where to continue from.
"""
ListGroupsForUser(UserName) = iam("ListGroupsForUser", Dict{String, Any}("UserName"=>UserName))
ListGroupsForUser(UserName, args::AbstractDict{String, <:Any}) = iam("ListGroupsForUser", Dict{String, Any}("UserName"=>UserName, args...))
...
ListInstanceProfiles(args::AbstractDict{String, <:Any}) = iam("ListInstanceProfiles", args)
...
- `MaxItems`: Use this only when paginating results to indicate the maximum number of items you want in the response. If additional items exist beyond the maximum you specify, the IsTruncated response element is true. If you do not include this parameter, the number of items defaults to 100. Note that IAM might return fewer results, even when there are more results available. In that case, the IsTruncated response element returns true, and Marker contains a value to include in the subsequent call that tells the service where to continue from.
"""
ListInstanceProfilesForRole(RoleName) = iam("ListInstanceProfilesForRole", Dict{String, Any}("RoleName"=>RoleName))
ListInstanceProfilesForRole(RoleName, args::AbstractDict{String, <:Any}) = iam("ListInstanceProfilesForRole", Dict{String, Any}("RoleName"=>RoleName, args...))
...
ListMFADevices(args::AbstractDict{String, <:Any}) = iam("ListMFADevices", args)
...
ListOpenIDConnectProviders(args::AbstractDict{String, <:Any}) = iam("ListOpenIDConnectProviders", args)
...
ListPolicies(args::AbstractDict{String, <:Any}) = iam("ListPolicies", args)
...
- `Marker`: Use this parameter only when paginating results and only after you receive a response indicating that the results are truncated. Set it to the value of the Marker element in the response that you received to indicate where the next call should start.
"""
ListPoliciesGrantingServiceAccess(Arn, ServiceNamespaces) = iam("ListPoliciesGrantingServiceAccess", Dict{String, Any}("Arn"=>Arn, "ServiceNamespaces"=>ServiceNamespaces))
ListPoliciesGrantingServiceAccess(Arn, ServiceNamespaces, args::AbstractDict{String, <:Any}) = iam("ListPoliciesGrantingServiceAccess", Dict{String, Any}("Arn"=>Arn, "ServiceNamespaces"=>ServiceNamespaces, args...))
...
- `MaxItems`: Use this only when paginating results to indicate the maximum number of items you want in the response. If additional items exist beyond the maximum you specify, the IsTruncated response element is true. If you do not include this parameter, the number of items defaults to 100. Note that IAM might return fewer results, even when there are more results available. In that case, the IsTruncated response element returns true, and Marker contains a value to include in the subsequent call that tells the service where to continue from.
"""
ListPolicyVersions(PolicyArn) = iam("ListPolicyVersions", Dict{String, Any}("PolicyArn"=>PolicyArn))
ListPolicyVersions(PolicyArn, args::AbstractDict{String, <:Any}) = iam("ListPolicyVersions", Dict{String, Any}("PolicyArn"=>PolicyArn, args...))
...
- `MaxItems`: Use this only when paginating results to indicate the maximum number of items you want in the response. If additional items exist beyond the maximum you specify, the IsTruncated response element is true. If you do not include this parameter, the number of items defaults to 100. Note that IAM might return fewer results, even when there are more results available. In that case, the IsTruncated response element returns true, and Marker contains a value to include in the subsequent call that tells the service where to continue from.
"""
ListRolePolicies(RoleName) = iam("ListRolePolicies", Dict{String, Any}("RoleName"=>RoleName))
ListRolePolicies(RoleName, args::AbstractDict{String, <:Any}) = iam("ListRolePolicies", Dict{String, Any}("RoleName"=>RoleName, args...))
...
"""
ListRoleTags(RoleName) = iam("ListRoleTags", Dict{String, Any}("RoleName"=>RoleName))
ListRoleTags(RoleName, args::AbstractDict{String, <:Any}) = iam("ListRoleTags", Dict{String, Any}("RoleName"=>RoleName, args...))
...
ListRoles(args::AbstractDict{String, <:Any}) = iam("ListRoles", args)
...
ListSAMLProviders(args::AbstractDict{String, <:Any}) = iam("ListSAMLProviders", args)
...
ListSSHPublicKeys(args::AbstractDict{String, <:Any}) = iam("ListSSHPublicKeys", args)
...
ListServerCertificates(args::AbstractDict{String, <:Any}) = iam("ListServerCertificates", args)
...
ListServiceSpecificCredentials(args::AbstractDict{String, <:Any}) = iam("ListServiceSpecificCredentials", args)
...
ListSigningCertificates(args::AbstractDict{String, <:Any}) = iam("ListSigningCertificates", args)
...
- `MaxItems`: Use this only when paginating results to indicate the maximum number of items you want in the response. If additional items exist beyond the maximum you specify, the IsTruncated response element is true. If you do not include this parameter, the number of items defaults to 100. Note that IAM might return fewer results, even when there are more results available. In that case, the IsTruncated response element returns true, and Marker contains a value to include in the subsequent call that tells the service where to continue from.
"""
ListUserPolicies(UserName) = iam("ListUserPolicies", Dict{String, Any}("UserName"=>UserName))
ListUserPolicies(UserName, args::AbstractDict{String, <:Any}) = iam("ListUserPolicies", Dict{String, Any}("UserName"=>UserName, args...))
...
- `MaxItems`: (Optional) Use this only when paginating results to indicate the maximum number of items that you want in the response. If additional items exist beyond the maximum that you specify, the IsTruncated response element is true. If you do not include this parameter, it defaults to 100. Note that IAM might return fewer results, even when more results are available. In that case, the IsTruncated response element returns true, and Marker contains a value to include in the subsequent call that tells the service where to continue from.
"""
ListUserTags(UserName) = iam("ListUserTags", Dict{String, Any}("UserName"=>UserName))
ListUserTags(UserName, args::AbstractDict{String, <:Any}) = iam("ListUserTags", Dict{String, Any}("UserName"=>UserName, args...))
...
ListUsers(args::AbstractDict{String, <:Any}) = iam("ListUsers", args)
...
ListVirtualMFADevices(args::AbstractDict{String, <:Any}) = iam("ListVirtualMFADevices", args)
...
"""
PutGroupPolicy(GroupName, PolicyDocument, PolicyName) = iam("PutGroupPolicy", Dict{String, Any}("GroupName"=>GroupName, "PolicyDocument"=>PolicyDocument, "PolicyName"=>PolicyName))
PutGroupPolicy(GroupName, PolicyDocument, PolicyName, args::AbstractDict{String, <:Any}) = iam("PutGroupPolicy", Dict{String, Any}("GroupName"=>GroupName, "PolicyDocument"=>PolicyDocument, "PolicyName"=>PolicyName, args...))
...
"""
PutRolePermissionsBoundary(PermissionsBoundary, RoleName) = iam("PutRolePermissionsBoundary", Dict{String, Any}("PermissionsBoundary"=>PermissionsBoundary, "RoleName"=>RoleName))
PutRolePermissionsBoundary(PermissionsBoundary, RoleName, args::AbstractDict{String, <:Any}) = iam("PutRolePermissionsBoundary", Dict{String, Any}("PermissionsBoundary"=>PermissionsBoundary, "RoleName"=>RoleName, args...))
...
"""
PutRolePolicy(PolicyDocument, PolicyName, RoleName) = iam("PutRolePolicy", Dict{String, Any}("PolicyDocument"=>PolicyDocument, "PolicyName"=>PolicyName, "RoleName"=>RoleName))
PutRolePolicy(PolicyDocument, PolicyName, RoleName, args::AbstractDict{String, <:Any}) = iam("PutRolePolicy", Dict{String, Any}("PolicyDocument"=>PolicyDocument, "PolicyName"=>PolicyName, "RoleName"=>RoleName, args...))
...
"""
PutUserPermissionsBoundary(PermissionsBoundary, UserName) = iam("PutUserPermissionsBoundary", Dict{String, Any}("PermissionsBoundary"=>PermissionsBoundary, "UserName"=>UserName))
PutUserPermissionsBoundary(PermissionsBoundary, UserName, args::AbstractDict{String, <:Any}) = iam("PutUserPermissionsBoundary", Dict{String, Any}("PermissionsBoundary"=>PermissionsBoundary, "UserName"=>UserName, args...))
...
"""
PutUserPolicy(PolicyDocument, PolicyName, UserName) = iam("PutUserPolicy", Dict{String, Any}("PolicyDocument"=>PolicyDocument, "PolicyName"=>PolicyName, "UserName"=>UserName))
PutUserPolicy(PolicyDocument, PolicyName, UserName, args::AbstractDict{String, <:Any}) = iam("PutUserPolicy", Dict{String, Any}("PolicyDocument"=>PolicyDocument, "PolicyName"=>PolicyName, "UserName"=>UserName, args...))
...
"""
RemoveClientIDFromOpenIDConnectProvider(ClientID, OpenIDConnectProviderArn) = iam("RemoveClientIDFromOpenIDConnectProvider", Dict{String, Any}("ClientID"=>ClientID, "OpenIDConnectProviderArn"=>OpenIDConnectProviderArn))
RemoveClientIDFromOpenIDConnectProvider(ClientID, OpenIDConnectProviderArn, args::AbstractDict{String, <:Any}) = iam("RemoveClientIDFromOpenIDConnectProvider", Dict{String, Any}("ClientID"=>ClientID, "OpenIDConnectProviderArn"=>OpenIDConnectProviderArn, args...))
...
"""
RemoveRoleFromInstanceProfile(InstanceProfileName, RoleName) = iam("RemoveRoleFromInstanceProfile", Dict{String, Any}("InstanceProfileName"=>InstanceProfileName, "RoleName"=>RoleName))
RemoveRoleFromInstanceProfile(InstanceProfileName, RoleName, args::AbstractDict{String, <:Any}) = iam("RemoveRoleFromInstanceProfile", Dict{String, Any}("InstanceProfileName"=>InstanceProfileName, "RoleName"=>RoleName, args...))
...
"""
RemoveUserFromGroup(GroupName, UserName) = iam("RemoveUserFromGroup", Dict{String, Any}("GroupName"=>GroupName, "UserName"=>UserName))
RemoveUserFromGroup(GroupName, UserName, args::AbstractDict{String, <:Any}) = iam("RemoveUserFromGroup", Dict{String, Any}("GroupName"=>GroupName, "UserName"=>UserName, args...))
...
- `UserName`: The name of the IAM user associated with the service-specific credential. If this value is not specified, then the operation assumes the user whose credentials are used to call the operation. This parameter allows (through its regex pattern) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-
"""
ResetServiceSpecificCredential(ServiceSpecificCredentialId) = iam("ResetServiceSpecificCredential", Dict{String, Any}("ServiceSpecificCredentialId"=>ServiceSpecificCredentialId))
ResetServiceSpecificCredential(ServiceSpecificCredentialId, args::AbstractDict{String, <:Any}) = iam("ResetServiceSpecificCredential", Dict{String, Any}("ServiceSpecificCredentialId"=>ServiceSpecificCredentialId, args...))
...
"""
ResyncMFADevice(AuthenticationCode1, AuthenticationCode2, SerialNumber, UserName) = iam("ResyncMFADevice", Dict{String, Any}("AuthenticationCode1"=>AuthenticationCode1, "AuthenticationCode2"=>AuthenticationCode2, "SerialNumber"=>SerialNumber, "UserName"=>UserName))
ResyncMFADevice(AuthenticationCode1, AuthenticationCode2, SerialNumber, UserName, args::AbstractDict{String, <:Any}) = iam("ResyncMFADevice", Dict{String, Any}("AuthenticationCode1"=>AuthenticationCode1, "AuthenticationCode2"=>AuthenticationCode2, "SerialNumber"=>SerialNumber, "UserName"=>UserName, args...))
...
"""
SetDefaultPolicyVersion(PolicyArn, VersionId) = iam("SetDefaultPolicyVersion", Dict{String, Any}("PolicyArn"=>PolicyArn, "VersionId"=>VersionId))
SetDefaultPolicyVersion(PolicyArn, VersionId, args::AbstractDict{String, <:Any}) = iam("SetDefaultPolicyVersion", Dict{String, Any}("PolicyArn"=>PolicyArn, "VersionId"=>VersionId, args...))
...
"""
SetSecurityTokenServicePreferences(GlobalEndpointTokenVersion) = iam("SetSecurityTokenServicePreferences", Dict{String, Any}("GlobalEndpointTokenVersion"=>GlobalEndpointTokenVersion))
SetSecurityTokenServicePreferences(GlobalEndpointTokenVersion, args::AbstractDict{String, <:Any}) = iam("SetSecurityTokenServicePreferences", Dict{String, Any}("GlobalEndpointTokenVersion"=>GlobalEndpointTokenVersion, args...))
...
"""
SimulateCustomPolicy(ActionNames, PolicyInputList) = iam("SimulateCustomPolicy", Dict{String, Any}("ActionNames"=>ActionNames, "PolicyInputList"=>PolicyInputList))
SimulateCustomPolicy(ActionNames, PolicyInputList, args::AbstractDict{String, <:Any}) = iam("SimulateCustomPolicy", Dict{String, Any}("ActionNames"=>ActionNames, "PolicyInputList"=>PolicyInputList, args...))
...
- `ResourcePolicy`: A resource-based policy to include in the simulation provided as a string. Each resource in the simulation is treated as if it had this policy attached. You can include only one resource-based policy in a simulation. The regex pattern used to validate this parameter is a string of characters consisting of the following:   Any printable ASCII character ranging from the space character ( u0020) through the end of the ASCII character range   The printable characters in the Basic Latin and Latin-1 Supplement character set (through  u00FF)   The special characters tab ( u0009), line feed ( u000A), and carriage return ( u000D)  
"""
SimulatePrincipalPolicy(ActionNames, PolicySourceArn) = iam("SimulatePrincipalPolicy", Dict{String, Any}("ActionNames"=>ActionNames, "PolicySourceArn"=>PolicySourceArn))
SimulatePrincipalPolicy(ActionNames, PolicySourceArn, args::AbstractDict{String, <:Any}) = iam("SimulatePrincipalPolicy", Dict{String, Any}("ActionNames"=>ActionNames, "PolicySourceArn"=>PolicySourceArn, args...))
...
"""
TagRole(RoleName, Tags) = iam("TagRole", Dict{String, Any}("RoleName"=>RoleName, "Tags"=>Tags))
TagRole(RoleName, Tags, args::AbstractDict{String, <:Any}) = iam("TagRole", Dict{String, Any}("RoleName"=>RoleName, "Tags"=>Tags, args...))
...
"""
TagUser(Tags, UserName) = iam("TagUser", Dict{String, Any}("Tags"=>Tags, "UserName"=>UserName))
TagUser(Tags, UserName, args::AbstractDict{String, <:Any}) = iam("TagUser", Dict{String, Any}("Tags"=>Tags, "UserName"=>UserName, args...))
...
"""
UntagRole(RoleName, TagKeys) = iam("UntagRole", Dict{String, Any}("RoleName"=>RoleName, "TagKeys"=>TagKeys))
UntagRole(RoleName, TagKeys, args::AbstractDict{String, <:Any}) = iam("UntagRole", Dict{String, Any}("RoleName"=>RoleName, "TagKeys"=>TagKeys, args...))
...
"""
UntagUser(TagKeys, UserName) = iam("UntagUser", Dict{String, Any}("TagKeys"=>TagKeys, "UserName"=>UserName))
UntagUser(TagKeys, UserName, args::AbstractDict{String, <:Any}) = iam("UntagUser", Dict{String, Any}("TagKeys"=>TagKeys, "UserName"=>UserName, args...))
...
"""
UpdateAccessKey(AccessKeyId, Status) = iam("UpdateAccessKey", Dict{String, Any}("AccessKeyId"=>AccessKeyId, "Status"=>Status))
UpdateAccessKey(AccessKeyId, Status, args::AbstractDict{String, <:Any}) = iam("UpdateAccessKey", Dict{String, Any}("AccessKeyId"=>AccessKeyId, "Status"=>Status, args...))
...
UpdateAccountPasswordPolicy(args::AbstractDict{String, <:Any}) = iam("UpdateAccountPasswordPolicy", args)
...
"""
UpdateAssumeRolePolicy(PolicyDocument, RoleName) = iam("UpdateAssumeRolePolicy", Dict{String, Any}("PolicyDocument"=>PolicyDocument, "RoleName"=>RoleName))
UpdateAssumeRolePolicy(PolicyDocument, RoleName, args::AbstractDict{String, <:Any}) = iam("UpdateAssumeRolePolicy", Dict{String, Any}("PolicyDocument"=>PolicyDocument, "RoleName"=>RoleName, args...))
...
"""
UpdateGroup(GroupName) = iam("UpdateGroup", Dict{String, Any}("GroupName"=>GroupName))
UpdateGroup(GroupName, args::AbstractDict{String, <:Any}) = iam("UpdateGroup", Dict{String, Any}("GroupName"=>GroupName, args...))
...
"""
UpdateLoginProfile(UserName) = iam("UpdateLoginProfile", Dict{String, Any}("UserName"=>UserName))
UpdateLoginProfile(UserName, args::AbstractDict{String, <:Any}) = iam("UpdateLoginProfile", Dict{String, Any}("UserName"=>UserName, args...))
...
"""
UpdateOpenIDConnectProviderThumbprint(OpenIDConnectProviderArn, ThumbprintList) = iam("UpdateOpenIDConnectProviderThumbprint", Dict{String, Any}("OpenIDConnectProviderArn"=>OpenIDConnectProviderArn, "ThumbprintList"=>ThumbprintList))
UpdateOpenIDConnectProviderThumbprint(OpenIDConnectProviderArn, ThumbprintList, args::AbstractDict{String, <:Any}) = iam("UpdateOpenIDConnectProviderThumbprint", Dict{String, Any}("OpenIDConnectProviderArn"=>OpenIDConnectProviderArn, "ThumbprintList"=>ThumbprintList, args...))
...
- `MaxSessionDuration`: The maximum session duration (in seconds) that you want to set for the specified role. If you do not specify a value for this setting, the default maximum of one hour is applied. This setting can have a value from 1 hour to 12 hours. Anyone who assumes the role from the AWS CLI or API can use the DurationSeconds API parameter or the duration-seconds CLI parameter to request a longer session. The MaxSessionDuration setting determines the maximum duration that can be requested using the DurationSeconds parameter. If users don't specify a value for the DurationSeconds parameter, their security credentials are valid for one hour by default. This applies when you use the AssumeRole* API operations or the assume-role* CLI operations but does not apply when you use those operations to create a console URL. For more information, see Using IAM Roles in the IAM User Guide.
"""
UpdateRole(RoleName) = iam("UpdateRole", Dict{String, Any}("RoleName"=>RoleName))
UpdateRole(RoleName, args::AbstractDict{String, <:Any}) = iam("UpdateRole", Dict{String, Any}("RoleName"=>RoleName, args...))
...
"""
UpdateRoleDescription(Description, RoleName) = iam("UpdateRoleDescription", Dict{String, Any}("Description"=>Description, "RoleName"=>RoleName))
UpdateRoleDescription(Description, RoleName, args::AbstractDict{String, <:Any}) = iam("UpdateRoleDescription", Dict{String, Any}("Description"=>Description, "RoleName"=>RoleName, args...))
...
"""
UpdateSAMLProvider(SAMLMetadataDocument, SAMLProviderArn) = iam("UpdateSAMLProvider", Dict{String, Any}("SAMLMetadataDocument"=>SAMLMetadataDocument, "SAMLProviderArn"=>SAMLProviderArn))
UpdateSAMLProvider(SAMLMetadataDocument, SAMLProviderArn, args::AbstractDict{String, <:Any}) = iam("UpdateSAMLProvider", Dict{String, Any}("SAMLMetadataDocument"=>SAMLMetadataDocument, "SAMLProviderArn"=>SAMLProviderArn, args...))
...
"""
UpdateSSHPublicKey(SSHPublicKeyId, Status, UserName) = iam("UpdateSSHPublicKey", Dict{String, Any}("SSHPublicKeyId"=>SSHPublicKeyId, "Status"=>Status, "UserName"=>UserName))
UpdateSSHPublicKey(SSHPublicKeyId, Status, UserName, args::AbstractDict{String, <:Any}) = iam("UpdateSSHPublicKey", Dict{String, Any}("SSHPublicKeyId"=>SSHPublicKeyId, "Status"=>Status, "UserName"=>UserName, args...))
...
"""
UpdateServerCertificate(ServerCertificateName) = iam("UpdateServerCertificate", Dict{String, Any}("ServerCertificateName"=>ServerCertificateName))
UpdateServerCertificate(ServerCertificateName, args::AbstractDict{String, <:Any}) = iam("UpdateServerCertificate", Dict{String, Any}("ServerCertificateName"=>ServerCertificateName, args...))
...
"""
UpdateServiceSpecificCredential(ServiceSpecificCredentialId, Status) = iam("UpdateServiceSpecificCredential", Dict{String, Any}("ServiceSpecificCredentialId"=>ServiceSpecificCredentialId, "Status"=>Status))
UpdateServiceSpecificCredential(ServiceSpecificCredentialId, Status, args::AbstractDict{String, <:Any}) = iam("UpdateServiceSpecificCredential", Dict{String, Any}("ServiceSpecificCredentialId"=>ServiceSpecificCredentialId, "Status"=>Status, args...))
...
"""
UpdateSigningCertificate(CertificateId, Status) = iam("UpdateSigningCertificate", Dict{String, Any}("CertificateId"=>CertificateId, "Status"=>Status))
UpdateSigningCertificate(CertificateId, Status, args::AbstractDict{String, <:Any}) = iam("UpdateSigningCertificate", Dict{String, Any}("CertificateId"=>CertificateId, "Status"=>Status, args...))
...
"""
UpdateUser(UserName) = iam("UpdateUser", Dict{String, Any}("UserName"=>UserName))
UpdateUser(UserName, args::AbstractDict{String, <:Any}) = iam("UpdateUser", Dict{String, Any}("UserName"=>UserName, args...))
...
"""
UploadSSHPublicKey(SSHPublicKeyBody, UserName) = iam("UploadSSHPublicKey", Dict{String, Any}("SSHPublicKeyBody"=>SSHPublicKeyBody, "UserName"=>UserName))
UploadSSHPublicKey(SSHPublicKeyBody, UserName, args::AbstractDict{String, <:Any}) = iam("UploadSSHPublicKey", Dict{String, Any}("SSHPublicKeyBody"=>SSHPublicKeyBody, "UserName"=>UserName, args...))
...
"""
UploadServerCertificate(CertificateBody, PrivateKey, ServerCertificateName) = iam("UploadServerCertificate", Dict{String, Any}("CertificateBody"=>CertificateBody, "PrivateKey"=>PrivateKey, "ServerCertificateName"=>ServerCertificateName))
UploadServerCertificate(CertificateBody, PrivateKey, ServerCertificateName, args::AbstractDict{String, <:Any}) = iam("UploadServerCertificate", Dict{String, Any}("CertificateBody"=>CertificateBody, "PrivateKey"=>PrivateKey, "ServerCertificateName"=>ServerCertificateName, args...))
...
"""
UploadSigningCertificate(CertificateBody) = iam("UploadSigningCertificate", Dict{String, Any}("CertificateBody"=>CertificateBody))
UploadSigningCertificate(CertificateBody, args::AbstractDict{String, <:Any}) = iam("UploadSigningCertificate", Dict{String, Any}("CertificateBody"=>CertificateBody, args...))
