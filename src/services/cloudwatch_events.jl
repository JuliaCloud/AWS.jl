...
"""
ActivateEventSource(Name) = cloudwatch_events("ActivateEventSource", Dict{String, Any}("Name"=>Name))
ActivateEventSource(Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("ActivateEventSource", Dict{String, Any}("Name"=>Name, args...))
...
"""
CreateEventBus(Name) = cloudwatch_events("CreateEventBus", Dict{String, Any}("Name"=>Name))
CreateEventBus(Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("CreateEventBus", Dict{String, Any}("Name"=>Name, args...))
...
"""
CreatePartnerEventSource(Account, Name) = cloudwatch_events("CreatePartnerEventSource", Dict{String, Any}("Account"=>Account, "Name"=>Name))
CreatePartnerEventSource(Account, Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("CreatePartnerEventSource", Dict{String, Any}("Account"=>Account, "Name"=>Name, args...))
...
"""
DeactivateEventSource(Name) = cloudwatch_events("DeactivateEventSource", Dict{String, Any}("Name"=>Name))
DeactivateEventSource(Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("DeactivateEventSource", Dict{String, Any}("Name"=>Name, args...))
...
"""
DeleteEventBus(Name) = cloudwatch_events("DeleteEventBus", Dict{String, Any}("Name"=>Name))
DeleteEventBus(Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("DeleteEventBus", Dict{String, Any}("Name"=>Name, args...))
...
"""
DeletePartnerEventSource(Account, Name) = cloudwatch_events("DeletePartnerEventSource", Dict{String, Any}("Account"=>Account, "Name"=>Name))
DeletePartnerEventSource(Account, Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("DeletePartnerEventSource", Dict{String, Any}("Account"=>Account, "Name"=>Name, args...))
...
"""
DeleteRule(Name) = cloudwatch_events("DeleteRule", Dict{String, Any}("Name"=>Name))
DeleteRule(Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("DeleteRule", Dict{String, Any}("Name"=>Name, args...))
...
DescribeEventBus(args::AbstractDict{String, <:Any}) = cloudwatch_events("DescribeEventBus", args)
...
"""
DescribeEventSource(Name) = cloudwatch_events("DescribeEventSource", Dict{String, Any}("Name"=>Name))
DescribeEventSource(Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("DescribeEventSource", Dict{String, Any}("Name"=>Name, args...))
...
"""
DescribePartnerEventSource(Name) = cloudwatch_events("DescribePartnerEventSource", Dict{String, Any}("Name"=>Name))
DescribePartnerEventSource(Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("DescribePartnerEventSource", Dict{String, Any}("Name"=>Name, args...))
...
- `EventBusName`: The event bus associated with the rule. If you omit this, the default event bus is used.
"""
DescribeRule(Name) = cloudwatch_events("DescribeRule", Dict{String, Any}("Name"=>Name))
DescribeRule(Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("DescribeRule", Dict{String, Any}("Name"=>Name, args...))
...
- `EventBusName`: The event bus associated with the rule. If you omit this, the default event bus is used.
"""
DisableRule(Name) = cloudwatch_events("DisableRule", Dict{String, Any}("Name"=>Name))
DisableRule(Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("DisableRule", Dict{String, Any}("Name"=>Name, args...))
...
- `EventBusName`: The event bus associated with the rule. If you omit this, the default event bus is used.
"""
EnableRule(Name) = cloudwatch_events("EnableRule", Dict{String, Any}("Name"=>Name))
EnableRule(Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("EnableRule", Dict{String, Any}("Name"=>Name, args...))
...
ListEventBuses(args::AbstractDict{String, <:Any}) = cloudwatch_events("ListEventBuses", args)
...
ListEventSources(args::AbstractDict{String, <:Any}) = cloudwatch_events("ListEventSources", args)
...
"""
ListPartnerEventSourceAccounts(EventSourceName) = cloudwatch_events("ListPartnerEventSourceAccounts", Dict{String, Any}("EventSourceName"=>EventSourceName))
ListPartnerEventSourceAccounts(EventSourceName, args::AbstractDict{String, <:Any}) = cloudwatch_events("ListPartnerEventSourceAccounts", Dict{String, Any}("EventSourceName"=>EventSourceName, args...))
...
- `NextToken`: The token returned by a previous call to this operation. Specifying this retrieves the next set of results.
"""
ListPartnerEventSources(NamePrefix) = cloudwatch_events("ListPartnerEventSources", Dict{String, Any}("NamePrefix"=>NamePrefix))
ListPartnerEventSources(NamePrefix, args::AbstractDict{String, <:Any}) = cloudwatch_events("ListPartnerEventSources", Dict{String, Any}("NamePrefix"=>NamePrefix, args...))
...
- `NextToken`: The token returned by a previous call to retrieve the next set of results.
"""
ListRuleNamesByTarget(TargetArn) = cloudwatch_events("ListRuleNamesByTarget", Dict{String, Any}("TargetArn"=>TargetArn))
ListRuleNamesByTarget(TargetArn, args::AbstractDict{String, <:Any}) = cloudwatch_events("ListRuleNamesByTarget", Dict{String, Any}("TargetArn"=>TargetArn, args...))
...
ListRules(args::AbstractDict{String, <:Any}) = cloudwatch_events("ListRules", args)
...
"""
ListTagsForResource(ResourceARN) = cloudwatch_events("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN))
ListTagsForResource(ResourceARN, args::AbstractDict{String, <:Any}) = cloudwatch_events("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN, args...))
...
- `NextToken`: The token returned by a previous call to retrieve the next set of results.
"""
ListTargetsByRule(Rule) = cloudwatch_events("ListTargetsByRule", Dict{String, Any}("Rule"=>Rule))
ListTargetsByRule(Rule, args::AbstractDict{String, <:Any}) = cloudwatch_events("ListTargetsByRule", Dict{String, Any}("Rule"=>Rule, args...))
...
"""
PutEvents(Entries) = cloudwatch_events("PutEvents", Dict{String, Any}("Entries"=>Entries))
PutEvents(Entries, args::AbstractDict{String, <:Any}) = cloudwatch_events("PutEvents", Dict{String, Any}("Entries"=>Entries, args...))
...
"""
PutPartnerEvents(Entries) = cloudwatch_events("PutPartnerEvents", Dict{String, Any}("Entries"=>Entries))
PutPartnerEvents(Entries, args::AbstractDict{String, <:Any}) = cloudwatch_events("PutPartnerEvents", Dict{String, Any}("Entries"=>Entries, args...))
...
- `EventBusName`: The event bus associated with the rule. If you omit this, the default event bus is used.
"""
PutPermission(Action, Principal, StatementId) = cloudwatch_events("PutPermission", Dict{String, Any}("Action"=>Action, "Principal"=>Principal, "StatementId"=>StatementId))
PutPermission(Action, Principal, StatementId, args::AbstractDict{String, <:Any}) = cloudwatch_events("PutPermission", Dict{String, Any}("Action"=>Action, "Principal"=>Principal, "StatementId"=>StatementId, args...))
...
"""
PutRule(Name) = cloudwatch_events("PutRule", Dict{String, Any}("Name"=>Name))
PutRule(Name, args::AbstractDict{String, <:Any}) = cloudwatch_events("PutRule", Dict{String, Any}("Name"=>Name, args...))
...
"""
PutTargets(Rule, Targets) = cloudwatch_events("PutTargets", Dict{String, Any}("Rule"=>Rule, "Targets"=>Targets))
PutTargets(Rule, Targets, args::AbstractDict{String, <:Any}) = cloudwatch_events("PutTargets", Dict{String, Any}("Rule"=>Rule, "Targets"=>Targets, args...))
...
"""
RemovePermission(StatementId) = cloudwatch_events("RemovePermission", Dict{String, Any}("StatementId"=>StatementId))
RemovePermission(StatementId, args::AbstractDict{String, <:Any}) = cloudwatch_events("RemovePermission", Dict{String, Any}("StatementId"=>StatementId, args...))
...
"""
RemoveTargets(Ids, Rule) = cloudwatch_events("RemoveTargets", Dict{String, Any}("Ids"=>Ids, "Rule"=>Rule))
RemoveTargets(Ids, Rule, args::AbstractDict{String, <:Any}) = cloudwatch_events("RemoveTargets", Dict{String, Any}("Ids"=>Ids, "Rule"=>Rule, args...))
...
"""
TagResource(ResourceARN, Tags) = cloudwatch_events("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags))
TagResource(ResourceARN, Tags, args::AbstractDict{String, <:Any}) = cloudwatch_events("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags, args...))
...
"""
TestEventPattern(Event, EventPattern) = cloudwatch_events("TestEventPattern", Dict{String, Any}("Event"=>Event, "EventPattern"=>EventPattern))
TestEventPattern(Event, EventPattern, args::AbstractDict{String, <:Any}) = cloudwatch_events("TestEventPattern", Dict{String, Any}("Event"=>Event, "EventPattern"=>EventPattern, args...))
...
"""
UntagResource(ResourceARN, TagKeys) = cloudwatch_events("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys))
UntagResource(ResourceARN, TagKeys, args::AbstractDict{String, <:Any}) = cloudwatch_events("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys, args...))
