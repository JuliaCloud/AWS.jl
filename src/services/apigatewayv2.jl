...
- `"tags"`: A list of tags.
"""
function create_vpc_link(name, subnetIds; aws_config::AbstractAWSConfig=current_aws_config())
    return apigatewayv2(
        "POST",
        "/v2/vpclinks",
...
"""
function delete_cors_configuration(apiId; aws_config::AbstractAWSConfig=current_aws_config())
    return apigatewayv2(
        "DELETE",
        "/v2/apis/$(apiId)/cors";
        aws_config=aws_config,
