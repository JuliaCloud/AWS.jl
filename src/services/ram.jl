...
- `"clientToken"`: Specifies a unique, case-sensitive identifier that you provide to ensure
  ...
  IdempotentParameterMismatch error.
"""
function delete_permission(permissionArn; aws_config::AbstractAWSConfig=current_aws_config())
    return ram(
        "DELETE",
        "/deletepermission",
...
"""
function get_resource_share_invitations(; aws_config::AbstractAWSConfig=current_aws_config())
    return ram(
        "POST",
