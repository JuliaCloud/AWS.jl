...
function get_resource_share_invitations(;
    ...
    return ram(
        "POST", "/getresourceshareinvitations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_permission_associations(; aws_config::AbstractAWSConfig=current_aws_config())
    return ram(
        "POST", "/listpermissionassociations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_permissions(; aws_config::AbstractAWSConfig=current_aws_config())
    return ram("POST", "/listpermissions"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_permissions(
    ...
    return ram(
        "POST", "/listpermissions", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_resource_types(; aws_config::AbstractAWSConfig=current_aws_config())
    return ram("POST", "/listresourcetypes"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_resource_types(
    ...
    return ram(
        "POST", "/listresourcetypes", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
be associated with the promoted resource share.
