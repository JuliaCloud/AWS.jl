...
"""
ApproveSkill(SkillId) = alexa_for_business("ApproveSkill", Dict{String, Any}("SkillId"=>SkillId))
ApproveSkill(SkillId, args::AbstractDict{String, <:Any}) = alexa_for_business("ApproveSkill", Dict{String, Any}("SkillId"=>SkillId, args...))
...
"""
AssociateContactWithAddressBook(AddressBookArn, ContactArn) = alexa_for_business("AssociateContactWithAddressBook", Dict{String, Any}("AddressBookArn"=>AddressBookArn, "ContactArn"=>ContactArn))
AssociateContactWithAddressBook(AddressBookArn, ContactArn, args::AbstractDict{String, <:Any}) = alexa_for_business("AssociateContactWithAddressBook", Dict{String, Any}("AddressBookArn"=>AddressBookArn, "ContactArn"=>ContactArn, args...))
...
"""
AssociateDeviceWithNetworkProfile(DeviceArn, NetworkProfileArn) = alexa_for_business("AssociateDeviceWithNetworkProfile", Dict{String, Any}("DeviceArn"=>DeviceArn, "NetworkProfileArn"=>NetworkProfileArn))
AssociateDeviceWithNetworkProfile(DeviceArn, NetworkProfileArn, args::AbstractDict{String, <:Any}) = alexa_for_business("AssociateDeviceWithNetworkProfile", Dict{String, Any}("DeviceArn"=>DeviceArn, "NetworkProfileArn"=>NetworkProfileArn, args...))
...
AssociateDeviceWithRoom(args::AbstractDict{String, <:Any}) = alexa_for_business("AssociateDeviceWithRoom", args)
...
AssociateSkillGroupWithRoom(args::AbstractDict{String, <:Any}) = alexa_for_business("AssociateSkillGroupWithRoom", args)
...
"""
AssociateSkillWithSkillGroup(SkillId) = alexa_for_business("AssociateSkillWithSkillGroup", Dict{String, Any}("SkillId"=>SkillId))
AssociateSkillWithSkillGroup(SkillId, args::AbstractDict{String, <:Any}) = alexa_for_business("AssociateSkillWithSkillGroup", Dict{String, Any}("SkillId"=>SkillId, args...))
...
"""
AssociateSkillWithUsers(SkillId) = alexa_for_business("AssociateSkillWithUsers", Dict{String, Any}("SkillId"=>SkillId))
AssociateSkillWithUsers(SkillId, args::AbstractDict{String, <:Any}) = alexa_for_business("AssociateSkillWithUsers", Dict{String, Any}("SkillId"=>SkillId, args...))
...
"""
CreateAddressBook(Name) = alexa_for_business("CreateAddressBook", Dict{String, Any}("Name"=>Name, "ClientRequestToken"=>string(uuid4())))
CreateAddressBook(Name, args::AbstractDict{String, <:Any}) = alexa_for_business("CreateAddressBook", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Name"=>Name, "ClientRequestToken"=>string(uuid4())), args)))
...
"""
CreateBusinessReportSchedule(ContentRange, Format) = alexa_for_business("CreateBusinessReportSchedule", Dict{String, Any}("ContentRange"=>ContentRange, "Format"=>Format, "ClientRequestToken"=>string(uuid4())))
CreateBusinessReportSchedule(ContentRange, Format, args::AbstractDict{String, <:Any}) = alexa_for_business("CreateBusinessReportSchedule", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ContentRange"=>ContentRange, "Format"=>Format, "ClientRequestToken"=>string(uuid4())), args)))
...
"""
CreateConferenceProvider(ConferenceProviderName, ConferenceProviderType, MeetingSetting) = alexa_for_business("CreateConferenceProvider", Dict{String, Any}("ConferenceProviderName"=>ConferenceProviderName, "ConferenceProviderType"=>ConferenceProviderType, "MeetingSetting"=>MeetingSetting, "ClientRequestToken"=>string(uuid4())))
CreateConferenceProvider(ConferenceProviderName, ConferenceProviderType, MeetingSetting, args::AbstractDict{String, <:Any}) = alexa_for_business("CreateConferenceProvider", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ConferenceProviderName"=>ConferenceProviderName, "ConferenceProviderType"=>ConferenceProviderType, "MeetingSetting"=>MeetingSetting, "ClientRequestToken"=>string(uuid4())), args)))
...
"""
CreateContact(FirstName) = alexa_for_business("CreateContact", Dict{String, Any}("FirstName"=>FirstName, "ClientRequestToken"=>string(uuid4())))
CreateContact(FirstName, args::AbstractDict{String, <:Any}) = alexa_for_business("CreateContact", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("FirstName"=>FirstName, "ClientRequestToken"=>string(uuid4())), args)))
...
"""
CreateGatewayGroup(ClientRequestToken, Name) = alexa_for_business("CreateGatewayGroup", Dict{String, Any}("ClientRequestToken"=>ClientRequestToken, "Name"=>Name))
CreateGatewayGroup(ClientRequestToken, Name, args::AbstractDict{String, <:Any}) = alexa_for_business("CreateGatewayGroup", Dict{String, Any}("ClientRequestToken"=>ClientRequestToken, "Name"=>Name, args...))
...
"""
CreateNetworkProfile(ClientRequestToken, NetworkProfileName, SecurityType, Ssid) = alexa_for_business("CreateNetworkProfile", Dict{String, Any}("ClientRequestToken"=>ClientRequestToken, "NetworkProfileName"=>NetworkProfileName, "SecurityType"=>SecurityType, "Ssid"=>Ssid))
CreateNetworkProfile(ClientRequestToken, NetworkProfileName, SecurityType, Ssid, args::AbstractDict{String, <:Any}) = alexa_for_business("CreateNetworkProfile", Dict{String, Any}("ClientRequestToken"=>ClientRequestToken, "NetworkProfileName"=>NetworkProfileName, "SecurityType"=>SecurityType, "Ssid"=>Ssid, args...))
...
"""
CreateProfile(Address, DistanceUnit, ProfileName, TemperatureUnit, Timezone, WakeWord) = alexa_for_business("CreateProfile", Dict{String, Any}("Address"=>Address, "DistanceUnit"=>DistanceUnit, "ProfileName"=>ProfileName, "TemperatureUnit"=>TemperatureUnit, "Timezone"=>Timezone, "WakeWord"=>WakeWord, "ClientRequestToken"=>string(uuid4())))
CreateProfile(Address, DistanceUnit, ProfileName, TemperatureUnit, Timezone, WakeWord, args::AbstractDict{String, <:Any}) = alexa_for_business("CreateProfile", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Address"=>Address, "DistanceUnit"=>DistanceUnit, "ProfileName"=>ProfileName, "TemperatureUnit"=>TemperatureUnit, "Timezone"=>Timezone, "WakeWord"=>WakeWord, "ClientRequestToken"=>string(uuid4())), args)))
...
"""
CreateRoom(RoomName) = alexa_for_business("CreateRoom", Dict{String, Any}("RoomName"=>RoomName, "ClientRequestToken"=>string(uuid4())))
CreateRoom(RoomName, args::AbstractDict{String, <:Any}) = alexa_for_business("CreateRoom", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("RoomName"=>RoomName, "ClientRequestToken"=>string(uuid4())), args)))
...
"""
CreateSkillGroup(SkillGroupName) = alexa_for_business("CreateSkillGroup", Dict{String, Any}("SkillGroupName"=>SkillGroupName, "ClientRequestToken"=>string(uuid4())))
CreateSkillGroup(SkillGroupName, args::AbstractDict{String, <:Any}) = alexa_for_business("CreateSkillGroup", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("SkillGroupName"=>SkillGroupName, "ClientRequestToken"=>string(uuid4())), args)))
...
"""
CreateUser(UserId) = alexa_for_business("CreateUser", Dict{String, Any}("UserId"=>UserId, "ClientRequestToken"=>string(uuid4())))
CreateUser(UserId, args::AbstractDict{String, <:Any}) = alexa_for_business("CreateUser", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("UserId"=>UserId, "ClientRequestToken"=>string(uuid4())), args)))
...
"""
DeleteAddressBook(AddressBookArn) = alexa_for_business("DeleteAddressBook", Dict{String, Any}("AddressBookArn"=>AddressBookArn))
DeleteAddressBook(AddressBookArn, args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteAddressBook", Dict{String, Any}("AddressBookArn"=>AddressBookArn, args...))
...
"""
DeleteBusinessReportSchedule(ScheduleArn) = alexa_for_business("DeleteBusinessReportSchedule", Dict{String, Any}("ScheduleArn"=>ScheduleArn))
DeleteBusinessReportSchedule(ScheduleArn, args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteBusinessReportSchedule", Dict{String, Any}("ScheduleArn"=>ScheduleArn, args...))
...
"""
DeleteConferenceProvider(ConferenceProviderArn) = alexa_for_business("DeleteConferenceProvider", Dict{String, Any}("ConferenceProviderArn"=>ConferenceProviderArn))
DeleteConferenceProvider(ConferenceProviderArn, args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteConferenceProvider", Dict{String, Any}("ConferenceProviderArn"=>ConferenceProviderArn, args...))
...
"""
DeleteContact(ContactArn) = alexa_for_business("DeleteContact", Dict{String, Any}("ContactArn"=>ContactArn))
DeleteContact(ContactArn, args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteContact", Dict{String, Any}("ContactArn"=>ContactArn, args...))
...
"""
DeleteDevice(DeviceArn) = alexa_for_business("DeleteDevice", Dict{String, Any}("DeviceArn"=>DeviceArn))
DeleteDevice(DeviceArn, args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteDevice", Dict{String, Any}("DeviceArn"=>DeviceArn, args...))
...
"""
DeleteDeviceUsageData(DeviceArn, DeviceUsageType) = alexa_for_business("DeleteDeviceUsageData", Dict{String, Any}("DeviceArn"=>DeviceArn, "DeviceUsageType"=>DeviceUsageType))
DeleteDeviceUsageData(DeviceArn, DeviceUsageType, args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteDeviceUsageData", Dict{String, Any}("DeviceArn"=>DeviceArn, "DeviceUsageType"=>DeviceUsageType, args...))
...
"""
DeleteGatewayGroup(GatewayGroupArn) = alexa_for_business("DeleteGatewayGroup", Dict{String, Any}("GatewayGroupArn"=>GatewayGroupArn))
DeleteGatewayGroup(GatewayGroupArn, args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteGatewayGroup", Dict{String, Any}("GatewayGroupArn"=>GatewayGroupArn, args...))
...
"""
DeleteNetworkProfile(NetworkProfileArn) = alexa_for_business("DeleteNetworkProfile", Dict{String, Any}("NetworkProfileArn"=>NetworkProfileArn))
DeleteNetworkProfile(NetworkProfileArn, args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteNetworkProfile", Dict{String, Any}("NetworkProfileArn"=>NetworkProfileArn, args...))
...
DeleteProfile(args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteProfile", args)
...
DeleteRoom(args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteRoom", args)
...
"""
DeleteRoomSkillParameter(ParameterKey, SkillId) = alexa_for_business("DeleteRoomSkillParameter", Dict{String, Any}("ParameterKey"=>ParameterKey, "SkillId"=>SkillId))
DeleteRoomSkillParameter(ParameterKey, SkillId, args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteRoomSkillParameter", Dict{String, Any}("ParameterKey"=>ParameterKey, "SkillId"=>SkillId, args...))
...
"""
DeleteSkillAuthorization(SkillId) = alexa_for_business("DeleteSkillAuthorization", Dict{String, Any}("SkillId"=>SkillId))
DeleteSkillAuthorization(SkillId, args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteSkillAuthorization", Dict{String, Any}("SkillId"=>SkillId, args...))
...
DeleteSkillGroup(args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteSkillGroup", args)
...
"""
DeleteUser(EnrollmentId) = alexa_for_business("DeleteUser", Dict{String, Any}("EnrollmentId"=>EnrollmentId))
DeleteUser(EnrollmentId, args::AbstractDict{String, <:Any}) = alexa_for_business("DeleteUser", Dict{String, Any}("EnrollmentId"=>EnrollmentId, args...))
...
"""
DisassociateContactFromAddressBook(AddressBookArn, ContactArn) = alexa_for_business("DisassociateContactFromAddressBook", Dict{String, Any}("AddressBookArn"=>AddressBookArn, "ContactArn"=>ContactArn))
DisassociateContactFromAddressBook(AddressBookArn, ContactArn, args::AbstractDict{String, <:Any}) = alexa_for_business("DisassociateContactFromAddressBook", Dict{String, Any}("AddressBookArn"=>AddressBookArn, "ContactArn"=>ContactArn, args...))
...
DisassociateDeviceFromRoom(args::AbstractDict{String, <:Any}) = alexa_for_business("DisassociateDeviceFromRoom", args)
...
"""
DisassociateSkillFromSkillGroup(SkillId) = alexa_for_business("DisassociateSkillFromSkillGroup", Dict{String, Any}("SkillId"=>SkillId))
DisassociateSkillFromSkillGroup(SkillId, args::AbstractDict{String, <:Any}) = alexa_for_business("DisassociateSkillFromSkillGroup", Dict{String, Any}("SkillId"=>SkillId, args...))
...
"""
DisassociateSkillFromUsers(SkillId) = alexa_for_business("DisassociateSkillFromUsers", Dict{String, Any}("SkillId"=>SkillId))
DisassociateSkillFromUsers(SkillId, args::AbstractDict{String, <:Any}) = alexa_for_business("DisassociateSkillFromUsers", Dict{String, Any}("SkillId"=>SkillId, args...))
...
DisassociateSkillGroupFromRoom(args::AbstractDict{String, <:Any}) = alexa_for_business("DisassociateSkillGroupFromRoom", args)
...
"""
ForgetSmartHomeAppliances(RoomArn) = alexa_for_business("ForgetSmartHomeAppliances", Dict{String, Any}("RoomArn"=>RoomArn))
ForgetSmartHomeAppliances(RoomArn, args::AbstractDict{String, <:Any}) = alexa_for_business("ForgetSmartHomeAppliances", Dict{String, Any}("RoomArn"=>RoomArn, args...))
...
"""
GetAddressBook(AddressBookArn) = alexa_for_business("GetAddressBook", Dict{String, Any}("AddressBookArn"=>AddressBookArn))
GetAddressBook(AddressBookArn, args::AbstractDict{String, <:Any}) = alexa_for_business("GetAddressBook", Dict{String, Any}("AddressBookArn"=>AddressBookArn, args...))
...
GetConferencePreference(args::AbstractDict{String, <:Any}) = alexa_for_business("GetConferencePreference", args)
...
"""
GetConferenceProvider(ConferenceProviderArn) = alexa_for_business("GetConferenceProvider", Dict{String, Any}("ConferenceProviderArn"=>ConferenceProviderArn))
GetConferenceProvider(ConferenceProviderArn, args::AbstractDict{String, <:Any}) = alexa_for_business("GetConferenceProvider", Dict{String, Any}("ConferenceProviderArn"=>ConferenceProviderArn, args...))
...
"""
GetContact(ContactArn) = alexa_for_business("GetContact", Dict{String, Any}("ContactArn"=>ContactArn))
GetContact(ContactArn, args::AbstractDict{String, <:Any}) = alexa_for_business("GetContact", Dict{String, Any}("ContactArn"=>ContactArn, args...))
...
GetDevice(args::AbstractDict{String, <:Any}) = alexa_for_business("GetDevice", args)
...
"""
GetGateway(GatewayArn) = alexa_for_business("GetGateway", Dict{String, Any}("GatewayArn"=>GatewayArn))
GetGateway(GatewayArn, args::AbstractDict{String, <:Any}) = alexa_for_business("GetGateway", Dict{String, Any}("GatewayArn"=>GatewayArn, args...))
...
"""
GetGatewayGroup(GatewayGroupArn) = alexa_for_business("GetGatewayGroup", Dict{String, Any}("GatewayGroupArn"=>GatewayGroupArn))
GetGatewayGroup(GatewayGroupArn, args::AbstractDict{String, <:Any}) = alexa_for_business("GetGatewayGroup", Dict{String, Any}("GatewayGroupArn"=>GatewayGroupArn, args...))
...
GetInvitationConfiguration(args::AbstractDict{String, <:Any}) = alexa_for_business("GetInvitationConfiguration", args)
...
"""
GetNetworkProfile(NetworkProfileArn) = alexa_for_business("GetNetworkProfile", Dict{String, Any}("NetworkProfileArn"=>NetworkProfileArn))
GetNetworkProfile(NetworkProfileArn, args::AbstractDict{String, <:Any}) = alexa_for_business("GetNetworkProfile", Dict{String, Any}("NetworkProfileArn"=>NetworkProfileArn, args...))
...
GetProfile(args::AbstractDict{String, <:Any}) = alexa_for_business("GetProfile", args)
...
GetRoom(args::AbstractDict{String, <:Any}) = alexa_for_business("GetRoom", args)
...
"""
GetRoomSkillParameter(ParameterKey, SkillId) = alexa_for_business("GetRoomSkillParameter", Dict{String, Any}("ParameterKey"=>ParameterKey, "SkillId"=>SkillId))
GetRoomSkillParameter(ParameterKey, SkillId, args::AbstractDict{String, <:Any}) = alexa_for_business("GetRoomSkillParameter", Dict{String, Any}("ParameterKey"=>ParameterKey, "SkillId"=>SkillId, args...))
...
GetSkillGroup(args::AbstractDict{String, <:Any}) = alexa_for_business("GetSkillGroup", args)
...
ListBusinessReportSchedules(args::AbstractDict{String, <:Any}) = alexa_for_business("ListBusinessReportSchedules", args)
...
ListConferenceProviders(args::AbstractDict{String, <:Any}) = alexa_for_business("ListConferenceProviders", args)
...
"""
ListDeviceEvents(DeviceArn) = alexa_for_business("ListDeviceEvents", Dict{String, Any}("DeviceArn"=>DeviceArn))
ListDeviceEvents(DeviceArn, args::AbstractDict{String, <:Any}) = alexa_for_business("ListDeviceEvents", Dict{String, Any}("DeviceArn"=>DeviceArn, args...))
...
ListGatewayGroups(args::AbstractDict{String, <:Any}) = alexa_for_business("ListGatewayGroups", args)
...
ListGateways(args::AbstractDict{String, <:Any}) = alexa_for_business("ListGateways", args)
...
ListSkills(args::AbstractDict{String, <:Any}) = alexa_for_business("ListSkills", args)
...
ListSkillsStoreCategories(args::AbstractDict{String, <:Any}) = alexa_for_business("ListSkillsStoreCategories", args)
...
- `NextToken`: The tokens used for pagination.
"""
ListSkillsStoreSkillsByCategory(CategoryId) = alexa_for_business("ListSkillsStoreSkillsByCategory", Dict{String, Any}("CategoryId"=>CategoryId))
ListSkillsStoreSkillsByCategory(CategoryId, args::AbstractDict{String, <:Any}) = alexa_for_business("ListSkillsStoreSkillsByCategory", Dict{String, Any}("CategoryId"=>CategoryId, args...))
...
- `NextToken`: The tokens used for pagination.
"""
ListSmartHomeAppliances(RoomArn) = alexa_for_business("ListSmartHomeAppliances", Dict{String, Any}("RoomArn"=>RoomArn))
ListSmartHomeAppliances(RoomArn, args::AbstractDict{String, <:Any}) = alexa_for_business("ListSmartHomeAppliances", Dict{String, Any}("RoomArn"=>RoomArn, args...))
...
- `NextToken`: An optional token returned from a prior request. Use this token for pagination of results from this action. If this parameter is specified, the response includes only results beyond the token, up to the value specified by MaxResults. 
"""
ListTags(Arn) = alexa_for_business("ListTags", Dict{String, Any}("Arn"=>Arn))
ListTags(Arn, args::AbstractDict{String, <:Any}) = alexa_for_business("ListTags", Dict{String, Any}("Arn"=>Arn, args...))
...
"""
PutConferencePreference(ConferencePreference) = alexa_for_business("PutConferencePreference", Dict{String, Any}("ConferencePreference"=>ConferencePreference))
PutConferencePreference(ConferencePreference, args::AbstractDict{String, <:Any}) = alexa_for_business("PutConferencePreference", Dict{String, Any}("ConferencePreference"=>ConferencePreference, args...))
...
"""
PutInvitationConfiguration(OrganizationName) = alexa_for_business("PutInvitationConfiguration", Dict{String, Any}("OrganizationName"=>OrganizationName))
PutInvitationConfiguration(OrganizationName, args::AbstractDict{String, <:Any}) = alexa_for_business("PutInvitationConfiguration", Dict{String, Any}("OrganizationName"=>OrganizationName, args...))
...
"""
PutRoomSkillParameter(RoomSkillParameter, SkillId) = alexa_for_business("PutRoomSkillParameter", Dict{String, Any}("RoomSkillParameter"=>RoomSkillParameter, "SkillId"=>SkillId))
PutRoomSkillParameter(RoomSkillParameter, SkillId, args::AbstractDict{String, <:Any}) = alexa_for_business("PutRoomSkillParameter", Dict{String, Any}("RoomSkillParameter"=>RoomSkillParameter, "SkillId"=>SkillId, args...))
...
- `RoomArn`: The room that the skill is authorized for.
"""
PutSkillAuthorization(AuthorizationResult, SkillId) = alexa_for_business("PutSkillAuthorization", Dict{String, Any}("AuthorizationResult"=>AuthorizationResult, "SkillId"=>SkillId))
PutSkillAuthorization(AuthorizationResult, SkillId, args::AbstractDict{String, <:Any}) = alexa_for_business("PutSkillAuthorization", Dict{String, Any}("AuthorizationResult"=>AuthorizationResult, "SkillId"=>SkillId, args...))
...
"""
RegisterAVSDevice(AmazonId, ClientId, ProductId, UserCode) = alexa_for_business("RegisterAVSDevice", Dict{String, Any}("AmazonId"=>AmazonId, "ClientId"=>ClientId, "ProductId"=>ProductId, "UserCode"=>UserCode))
RegisterAVSDevice(AmazonId, ClientId, ProductId, UserCode, args::AbstractDict{String, <:Any}) = alexa_for_business("RegisterAVSDevice", Dict{String, Any}("AmazonId"=>AmazonId, "ClientId"=>ClientId, "ProductId"=>ProductId, "UserCode"=>UserCode, args...))
...
"""
RejectSkill(SkillId) = alexa_for_business("RejectSkill", Dict{String, Any}("SkillId"=>SkillId))
RejectSkill(SkillId, args::AbstractDict{String, <:Any}) = alexa_for_business("RejectSkill", Dict{String, Any}("SkillId"=>SkillId, args...))
...
"""
ResolveRoom(SkillId, UserId) = alexa_for_business("ResolveRoom", Dict{String, Any}("SkillId"=>SkillId, "UserId"=>UserId))
ResolveRoom(SkillId, UserId, args::AbstractDict{String, <:Any}) = alexa_for_business("ResolveRoom", Dict{String, Any}("SkillId"=>SkillId, "UserId"=>UserId, args...))
...
RevokeInvitation(args::AbstractDict{String, <:Any}) = alexa_for_business("RevokeInvitation", args)
...
SearchAddressBooks(args::AbstractDict{String, <:Any}) = alexa_for_business("SearchAddressBooks", args)
...
SearchContacts(args::AbstractDict{String, <:Any}) = alexa_for_business("SearchContacts", args)
...
SearchDevices(args::AbstractDict{String, <:Any}) = alexa_for_business("SearchDevices", args)
...
SearchNetworkProfiles(args::AbstractDict{String, <:Any}) = alexa_for_business("SearchNetworkProfiles", args)
...
SearchProfiles(args::AbstractDict{String, <:Any}) = alexa_for_business("SearchProfiles", args)
...
SearchRooms(args::AbstractDict{String, <:Any}) = alexa_for_business("SearchRooms", args)
...
SearchSkillGroups(args::AbstractDict{String, <:Any}) = alexa_for_business("SearchSkillGroups", args)
...
SearchUsers(args::AbstractDict{String, <:Any}) = alexa_for_business("SearchUsers", args)
...
"""
SendAnnouncement(ClientRequestToken, Content, RoomFilters) = alexa_for_business("SendAnnouncement", Dict{String, Any}("ClientRequestToken"=>ClientRequestToken, "Content"=>Content, "RoomFilters"=>RoomFilters))
SendAnnouncement(ClientRequestToken, Content, RoomFilters, args::AbstractDict{String, <:Any}) = alexa_for_business("SendAnnouncement", Dict{String, Any}("ClientRequestToken"=>ClientRequestToken, "Content"=>Content, "RoomFilters"=>RoomFilters, args...))
...
SendInvitation(args::AbstractDict{String, <:Any}) = alexa_for_business("SendInvitation", args)
...
"""
StartDeviceSync(Features) = alexa_for_business("StartDeviceSync", Dict{String, Any}("Features"=>Features))
StartDeviceSync(Features, args::AbstractDict{String, <:Any}) = alexa_for_business("StartDeviceSync", Dict{String, Any}("Features"=>Features, args...))
...
"""
StartSmartHomeApplianceDiscovery(RoomArn) = alexa_for_business("StartSmartHomeApplianceDiscovery", Dict{String, Any}("RoomArn"=>RoomArn))
StartSmartHomeApplianceDiscovery(RoomArn, args::AbstractDict{String, <:Any}) = alexa_for_business("StartSmartHomeApplianceDiscovery", Dict{String, Any}("RoomArn"=>RoomArn, args...))
...
"""
TagResource(Arn, Tags) = alexa_for_business("TagResource", Dict{String, Any}("Arn"=>Arn, "Tags"=>Tags))
TagResource(Arn, Tags, args::AbstractDict{String, <:Any}) = alexa_for_business("TagResource", Dict{String, Any}("Arn"=>Arn, "Tags"=>Tags, args...))
...
"""
UntagResource(Arn, TagKeys) = alexa_for_business("UntagResource", Dict{String, Any}("Arn"=>Arn, "TagKeys"=>TagKeys))
UntagResource(Arn, TagKeys, args::AbstractDict{String, <:Any}) = alexa_for_business("UntagResource", Dict{String, Any}("Arn"=>Arn, "TagKeys"=>TagKeys, args...))
...
"""
UpdateAddressBook(AddressBookArn) = alexa_for_business("UpdateAddressBook", Dict{String, Any}("AddressBookArn"=>AddressBookArn))
UpdateAddressBook(AddressBookArn, args::AbstractDict{String, <:Any}) = alexa_for_business("UpdateAddressBook", Dict{String, Any}("AddressBookArn"=>AddressBookArn, args...))
...
- `ScheduleName`: The name identifier of the schedule.
"""
UpdateBusinessReportSchedule(ScheduleArn) = alexa_for_business("UpdateBusinessReportSchedule", Dict{String, Any}("ScheduleArn"=>ScheduleArn))
UpdateBusinessReportSchedule(ScheduleArn, args::AbstractDict{String, <:Any}) = alexa_for_business("UpdateBusinessReportSchedule", Dict{String, Any}("ScheduleArn"=>ScheduleArn, args...))
...
- `PSTNDialIn`: The information for PSTN conferencing.
"""
UpdateConferenceProvider(ConferenceProviderArn, ConferenceProviderType, MeetingSetting) = alexa_for_business("UpdateConferenceProvider", Dict{String, Any}("ConferenceProviderArn"=>ConferenceProviderArn, "ConferenceProviderType"=>ConferenceProviderType, "MeetingSetting"=>MeetingSetting))
UpdateConferenceProvider(ConferenceProviderArn, ConferenceProviderType, MeetingSetting, args::AbstractDict{String, <:Any}) = alexa_for_business("UpdateConferenceProvider", Dict{String, Any}("ConferenceProviderArn"=>ConferenceProviderArn, "ConferenceProviderType"=>ConferenceProviderType, "MeetingSetting"=>MeetingSetting, args...))
...
- `SipAddresses`: The list of SIP addresses for the contact.
"""
UpdateContact(ContactArn) = alexa_for_business("UpdateContact", Dict{String, Any}("ContactArn"=>ContactArn))
UpdateContact(ContactArn, args::AbstractDict{String, <:Any}) = alexa_for_business("UpdateContact", Dict{String, Any}("ContactArn"=>ContactArn, args...))
...
UpdateDevice(args::AbstractDict{String, <:Any}) = alexa_for_business("UpdateDevice", args)
...
"""
UpdateGateway(GatewayArn) = alexa_for_business("UpdateGateway", Dict{String, Any}("GatewayArn"=>GatewayArn))
UpdateGateway(GatewayArn, args::AbstractDict{String, <:Any}) = alexa_for_business("UpdateGateway", Dict{String, Any}("GatewayArn"=>GatewayArn, args...))
...
"""
UpdateGatewayGroup(GatewayGroupArn) = alexa_for_business("UpdateGatewayGroup", Dict{String, Any}("GatewayGroupArn"=>GatewayGroupArn))
UpdateGatewayGroup(GatewayGroupArn, args::AbstractDict{String, <:Any}) = alexa_for_business("UpdateGatewayGroup", Dict{String, Any}("GatewayGroupArn"=>GatewayGroupArn, args...))
...
"""
UpdateNetworkProfile(NetworkProfileArn) = alexa_for_business("UpdateNetworkProfile", Dict{String, Any}("NetworkProfileArn"=>NetworkProfileArn))
UpdateNetworkProfile(NetworkProfileArn, args::AbstractDict{String, <:Any}) = alexa_for_business("UpdateNetworkProfile", Dict{String, Any}("NetworkProfileArn"=>NetworkProfileArn, args...))
...
UpdateProfile(args::AbstractDict{String, <:Any}) = alexa_for_business("UpdateProfile", args)
...
UpdateRoom(args::AbstractDict{String, <:Any}) = alexa_for_business("UpdateRoom", args)
...
UpdateSkillGroup(args::AbstractDict{String, <:Any}) = alexa_for_business("UpdateSkillGroup", args)
