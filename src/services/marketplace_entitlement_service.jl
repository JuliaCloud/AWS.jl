...
"""
GetEntitlements(ProductCode; aws::AWSConfig=AWSConfig()) = marketplace_entitlement_service("GetEntitlements", Dict{String, Any}("ProductCode"=>ProductCode); aws=aws)
GetEntitlements(ProductCode, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = marketplace_entitlement_service("GetEntitlements", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProductCode"=>ProductCode), args)); aws=aws)
