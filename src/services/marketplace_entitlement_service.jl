...
GetEntitlements(ProductCode; aws_config::AWSConfig=AWS.aws_config) = marketplace_entitlement_service("GetEntitlements", Dict{String, Any}("ProductCode"=>ProductCode); aws_config=aws_config)
GetEntitlements(ProductCode, args::AbstractDict{String, <:Any}; aws_config::AWSConfig=AWS.aws_config) = marketplace_entitlement_service("GetEntitlements", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ProductCode"=>ProductCode), args)); aws_config=aws_config)
