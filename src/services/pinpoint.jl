...
"""
function get_apns_channel(application_id; aws_config::AbstractAWSConfig=current_aws_config())
    return pinpoint(
        "GET",
        "/v1/apps/$(application-id)/channels/apns";
        aws_config=aws_config,
...
function get_campaign_date_range_kpi(
    application_id, campaign_id, kpi_name; aws_config::AbstractAWSConfig=current_aws_config()
)
    return pinpoint(
        "GET",
...
"""
function get_event_stream(application_id; aws_config::AbstractAWSConfig=current_aws_config())
    return pinpoint(
        "GET",
        "/v1/apps/$(application-id)/eventstream";
        aws_config=aws_config,
...
- `"version"`: The unique identifier for the version of the message template to update,
  ...
  deletes the template, including all versions of the template.
"""
function get_push_template(template_name; aws_config::AbstractAWSConfig=current_aws_config())
    return pinpoint(
        "GET",
        "/v1/templates/$(template-name)/push";
        aws_config=aws_config,
...
- `"token"`: The NextToken string that specifies which page of results to return in a
  paginated response.
"""
function get_recommender_configurations(; aws_config::AbstractAWSConfig=current_aws_config())
    return pinpoint(
