...
"""
function list_imported_models(; aws_config::AbstractAWSConfig=global_aws_config())
    return bedrock(
...
- `"nextToken"`: If the total number of results is greater than the maxResults value
  ...
  this field to return the next batch of results.
"""
function list_inference_profiles(; aws_config::AbstractAWSConfig=global_aws_config())
    return bedrock(
...
"""
function list_model_import_jobs(; aws_config::AbstractAWSConfig=global_aws_config())
    return bedrock(
...
"""
function list_model_invocation_jobs(; aws_config::AbstractAWSConfig=global_aws_config())
    return bedrock(
        "GET",
