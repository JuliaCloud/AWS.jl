...
"""
function finalize_cutover(sourceServerID; aws_config::AbstractAWSConfig=current_aws_config())
    return mgn(
        "POST",
        "/FinalizeCutover",
        Dict{String,Any}("sourceServerID" => sourceServerID);
...
"""
function mark_as_archived(sourceServerID; aws_config::AbstractAWSConfig=current_aws_config())
    return mgn(
        "POST",
        "/MarkAsArchived",
        Dict{String,Any}("sourceServerID" => sourceServerID);
...
"""
function stop_replication(sourceServerID; aws_config::AbstractAWSConfig=current_aws_config())
    return mgn(
        "POST",
        "/StopReplication",
        Dict{String,Any}("sourceServerID" => sourceServerID);
