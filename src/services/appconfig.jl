...
function delete_configuration_profile(
    ApplicationId, ConfigurationProfileId; aws_config::AbstractAWSConfig=current_aws_config()
)
    return appconfig(
        "DELETE",
...
- `"next_token"`: A token to start the list. Use this token to get the next set of results.
"""
function list_environments(ApplicationId; aws_config::AbstractAWSConfig=current_aws_config())
    return appconfig(
        "GET",
        "/applications/$(ApplicationId)/environments";
        aws_config=aws_config,
