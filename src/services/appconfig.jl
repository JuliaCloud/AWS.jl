...
configuration source. Valid configuration sources include the following:
...
- A validator for the configuration data. Available validators include either a JSON Schema
  or an Amazon Web Services Lambda function.
...
- `"client_configuration_version"`: The configuration version returned in the most recent
  ...
  !!! important
      ...
      `ClientConfigurationVersion` value with every call to `GetConfiguration`. The value to
      use for `ClientConfigurationVersion` comes from the `ConfigurationVersion` attribute
...
function list_applications(; aws_config::AbstractAWSConfig=current_aws_config())
    return appconfig("GET", "/applications"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_deployment_strategies(; aws_config::AbstractAWSConfig=current_aws_config())
    return appconfig(
        "GET", "/deploymentstrategies"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_deployment_strategies(
    ...
    return appconfig(
        "GET", "/deploymentstrategies", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_extension_associations(; aws_config::AbstractAWSConfig=current_aws_config())
    return appconfig(
        "GET", "/extensionassociations"; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_extension_associations(
    ...
    return appconfig(
        "GET", "/extensionassociations", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
...
function list_extensions(; aws_config::AbstractAWSConfig=current_aws_config())
    return appconfig("GET", "/extensions"; aws_config, feature_set=SERVICE_FEATURE_SET)
end
...
function list_extensions(
    ...
    return appconfig(
        "GET", "/extensions", params; aws_config, feature_set=SERVICE_FEATURE_SET
    )
end
