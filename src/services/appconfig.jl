...
"""
CreateApplication(Name) = appconfig("POST", "/applications", Dict{String, Any}("Name"=>Name))
CreateApplication(Name, args::AbstractDict{String, <: Any}) = appconfig("POST", "/applications", Dict{String, Any}("Name"=>Name, args...))
...
"""
CreateConfigurationProfile(ApplicationId, LocationUri, Name) = appconfig("POST", "/applications/$(ApplicationId)/configurationprofiles", Dict{String, Any}("LocationUri"=>LocationUri, "Name"=>Name))
CreateConfigurationProfile(ApplicationId, LocationUri, Name, args::AbstractDict{String, <: Any}) = appconfig("POST", "/applications/$(ApplicationId)/configurationprofiles", Dict{String, Any}("LocationUri"=>LocationUri, "Name"=>Name, args...))
...
"""
CreateDeploymentStrategy(DeploymentDurationInMinutes, GrowthFactor, Name, ReplicateTo) = appconfig("POST", "/deploymentstrategies", Dict{String, Any}("DeploymentDurationInMinutes"=>DeploymentDurationInMinutes, "GrowthFactor"=>GrowthFactor, "Name"=>Name, "ReplicateTo"=>ReplicateTo))
CreateDeploymentStrategy(DeploymentDurationInMinutes, GrowthFactor, Name, ReplicateTo, args::AbstractDict{String, <: Any}) = appconfig("POST", "/deploymentstrategies", Dict{String, Any}("DeploymentDurationInMinutes"=>DeploymentDurationInMinutes, "GrowthFactor"=>GrowthFactor, "Name"=>Name, "ReplicateTo"=>ReplicateTo, args...))
...
"""
CreateEnvironment(ApplicationId, Name) = appconfig("POST", "/applications/$(ApplicationId)/environments", Dict{String, Any}("Name"=>Name))
CreateEnvironment(ApplicationId, Name, args::AbstractDict{String, <: Any}) = appconfig("POST", "/applications/$(ApplicationId)/environments", Dict{String, Any}("Name"=>Name, args...))
...
"""
CreateHostedConfigurationVersion(ApplicationId, ConfigurationProfileId, Content, Content_Type) = appconfig("POST", "/applications/$(ApplicationId)/configurationprofiles/$(ConfigurationProfileId)/hostedconfigurationversions", Dict{String, Any}("Content"=>Content, "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)))
CreateHostedConfigurationVersion(ApplicationId, ConfigurationProfileId, Content, Content_Type, args::AbstractDict{String, <: Any}) = appconfig("POST", "/applications/$(ApplicationId)/configurationprofiles/$(ConfigurationProfileId)/hostedconfigurationversions", Dict{String, Any}(mergewith(merge, Dict{String, Any}("Content"=>Content, "headers"=>Dict{String, Any}("Content-Type"=>Content_Type)), args...)))
...
DeleteApplication(ApplicationId, args::AbstractDict{String, <: Any}) = appconfig("DELETE", "/applications/$(ApplicationId)", args)
...
DeleteConfigurationProfile(ApplicationId, ConfigurationProfileId, args::AbstractDict{String, <: Any}) = appconfig("DELETE", "/applications/$(ApplicationId)/configurationprofiles/$(ConfigurationProfileId)", args)
...
DeleteDeploymentStrategy(DeploymentStrategyId, args::AbstractDict{String, <: Any}) = appconfig("DELETE", "/deployementstrategies/$(DeploymentStrategyId)", args)
...
DeleteEnvironment(ApplicationId, EnvironmentId, args::AbstractDict{String, <: Any}) = appconfig("DELETE", "/applications/$(ApplicationId)/environments/$(EnvironmentId)", args)
...
DeleteHostedConfigurationVersion(ApplicationId, ConfigurationProfileId, VersionNumber, args::AbstractDict{String, <: Any}) = appconfig("DELETE", "/applications/$(ApplicationId)/configurationprofiles/$(ConfigurationProfileId)/hostedconfigurationversions/$(VersionNumber)", args)
...
GetApplication(ApplicationId, args::AbstractDict{String, <: Any}) = appconfig("GET", "/applications/$(ApplicationId)", args)
...
"""
GetConfiguration(Application, Configuration, Environment, client_id) = appconfig("GET", "/applications/$(Application)/environments/$(Environment)/configurations/$(Configuration)", Dict{String, Any}("client_id"=>client_id))
GetConfiguration(Application, Configuration, Environment, client_id, args::AbstractDict{String, <: Any}) = appconfig("GET", "/applications/$(Application)/environments/$(Environment)/configurations/$(Configuration)", Dict{String, Any}("client_id"=>client_id, args...))
...
GetConfigurationProfile(ApplicationId, ConfigurationProfileId, args::AbstractDict{String, <: Any}) = appconfig("GET", "/applications/$(ApplicationId)/configurationprofiles/$(ConfigurationProfileId)", args)
...
GetDeployment(ApplicationId, DeploymentNumber, EnvironmentId, args::AbstractDict{String, <: Any}) = appconfig("GET", "/applications/$(ApplicationId)/environments/$(EnvironmentId)/deployments/$(DeploymentNumber)", args)
...
GetDeploymentStrategy(DeploymentStrategyId, args::AbstractDict{String, <: Any}) = appconfig("GET", "/deploymentstrategies/$(DeploymentStrategyId)", args)
...
GetEnvironment(ApplicationId, EnvironmentId, args::AbstractDict{String, <: Any}) = appconfig("GET", "/applications/$(ApplicationId)/environments/$(EnvironmentId)", args)
...
GetHostedConfigurationVersion(ApplicationId, ConfigurationProfileId, VersionNumber, args::AbstractDict{String, <: Any}) = appconfig("GET", "/applications/$(ApplicationId)/configurationprofiles/$(ConfigurationProfileId)/hostedconfigurationversions/$(VersionNumber)", args)
...
ListApplications(args::AbstractDict{String, Any}) = appconfig("GET", "/applications", args)
...
ListConfigurationProfiles(ApplicationId, args::AbstractDict{String, <: Any}) = appconfig("GET", "/applications/$(ApplicationId)/configurationprofiles", args)
...
ListDeploymentStrategies(args::AbstractDict{String, Any}) = appconfig("GET", "/deploymentstrategies", args)
...
ListDeployments(ApplicationId, EnvironmentId, args::AbstractDict{String, <: Any}) = appconfig("GET", "/applications/$(ApplicationId)/environments/$(EnvironmentId)/deployments", args)
...
ListEnvironments(ApplicationId, args::AbstractDict{String, <: Any}) = appconfig("GET", "/applications/$(ApplicationId)/environments", args)
...
ListHostedConfigurationVersions(ApplicationId, ConfigurationProfileId, args::AbstractDict{String, <: Any}) = appconfig("GET", "/applications/$(ApplicationId)/configurationprofiles/$(ConfigurationProfileId)/hostedconfigurationversions", args)
...
ListTagsForResource(ResourceArn, args::AbstractDict{String, <: Any}) = appconfig("GET", "/tags/$(ResourceArn)", args)
...
"""
StartDeployment(ApplicationId, ConfigurationProfileId, ConfigurationVersion, DeploymentStrategyId, EnvironmentId) = appconfig("POST", "/applications/$(ApplicationId)/environments/$(EnvironmentId)/deployments", Dict{String, Any}("ConfigurationProfileId"=>ConfigurationProfileId, "ConfigurationVersion"=>ConfigurationVersion, "DeploymentStrategyId"=>DeploymentStrategyId))
StartDeployment(ApplicationId, ConfigurationProfileId, ConfigurationVersion, DeploymentStrategyId, EnvironmentId, args::AbstractDict{String, <: Any}) = appconfig("POST", "/applications/$(ApplicationId)/environments/$(EnvironmentId)/deployments", Dict{String, Any}("ConfigurationProfileId"=>ConfigurationProfileId, "ConfigurationVersion"=>ConfigurationVersion, "DeploymentStrategyId"=>DeploymentStrategyId, args...))
...
StopDeployment(ApplicationId, DeploymentNumber, EnvironmentId, args::AbstractDict{String, <: Any}) = appconfig("DELETE", "/applications/$(ApplicationId)/environments/$(EnvironmentId)/deployments/$(DeploymentNumber)", args)
...
"""
TagResource(ResourceArn, Tags) = appconfig("POST", "/tags/$(ResourceArn)", Dict{String, Any}("Tags"=>Tags))
TagResource(ResourceArn, Tags, args::AbstractDict{String, <: Any}) = appconfig("POST", "/tags/$(ResourceArn)", Dict{String, Any}("Tags"=>Tags, args...))
...
"""
UntagResource(ResourceArn, tagKeys) = appconfig("DELETE", "/tags/$(ResourceArn)", Dict{String, Any}("tagKeys"=>tagKeys))
UntagResource(ResourceArn, tagKeys, args::AbstractDict{String, <: Any}) = appconfig("DELETE", "/tags/$(ResourceArn)", Dict{String, Any}("tagKeys"=>tagKeys, args...))
...
UpdateApplication(ApplicationId, args::AbstractDict{String, <: Any}) = appconfig("PATCH", "/applications/$(ApplicationId)", args)
...
UpdateConfigurationProfile(ApplicationId, ConfigurationProfileId, args::AbstractDict{String, <: Any}) = appconfig("PATCH", "/applications/$(ApplicationId)/configurationprofiles/$(ConfigurationProfileId)", args)
...
UpdateDeploymentStrategy(DeploymentStrategyId, args::AbstractDict{String, <: Any}) = appconfig("PATCH", "/deploymentstrategies/$(DeploymentStrategyId)", args)
...
UpdateEnvironment(ApplicationId, EnvironmentId, args::AbstractDict{String, <: Any}) = appconfig("PATCH", "/applications/$(ApplicationId)/environments/$(EnvironmentId)", args)
...
"""
ValidateConfiguration(ApplicationId, ConfigurationProfileId, configuration_version) = appconfig("POST", "/applications/$(ApplicationId)/configurationprofiles/$(ConfigurationProfileId)/validators", Dict{String, Any}("configuration_version"=>configuration_version))
ValidateConfiguration(ApplicationId, ConfigurationProfileId, configuration_version, args::AbstractDict{String, <: Any}) = appconfig("POST", "/applications/$(ApplicationId)/configurationprofiles/$(ConfigurationProfileId)/validators", Dict{String, Any}("configuration_version"=>configuration_version, args...))
