...
"""
AddApplicationInput(ApplicationName, CurrentApplicationVersionId, Input) = kinesis_analytics("AddApplicationInput", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "Input"=>Input))
AddApplicationInput(ApplicationName, CurrentApplicationVersionId, Input, args::AbstractDict{String, <: Any}) = kinesis_analytics("AddApplicationInput", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "Input"=>Input, args...))
...
"""
AddApplicationOutput(ApplicationName, CurrentApplicationVersionId, Output) = kinesis_analytics("AddApplicationOutput", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "Output"=>Output))
AddApplicationOutput(ApplicationName, CurrentApplicationVersionId, Output, args::AbstractDict{String, <: Any}) = kinesis_analytics("AddApplicationOutput", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "Output"=>Output, args...))
...
"""
AddApplicationReferenceDataSource(ApplicationName, CurrentApplicationVersionId, ReferenceDataSource) = kinesis_analytics("AddApplicationReferenceDataSource", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "ReferenceDataSource"=>ReferenceDataSource))
AddApplicationReferenceDataSource(ApplicationName, CurrentApplicationVersionId, ReferenceDataSource, args::AbstractDict{String, <: Any}) = kinesis_analytics("AddApplicationReferenceDataSource", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "ReferenceDataSource"=>ReferenceDataSource, args...))
...
"""
CreateApplication(ApplicationName) = kinesis_analytics("CreateApplication", Dict{String, Any}("ApplicationName"=>ApplicationName))
CreateApplication(ApplicationName, args::AbstractDict{String, <: Any}) = kinesis_analytics("CreateApplication", Dict{String, Any}("ApplicationName"=>ApplicationName, args...))
...
"""
DeleteApplication(ApplicationName, CreateTimestamp) = kinesis_analytics("DeleteApplication", Dict{String, Any}("ApplicationName"=>ApplicationName, "CreateTimestamp"=>CreateTimestamp))
DeleteApplication(ApplicationName, CreateTimestamp, args::AbstractDict{String, <: Any}) = kinesis_analytics("DeleteApplication", Dict{String, Any}("ApplicationName"=>ApplicationName, "CreateTimestamp"=>CreateTimestamp, args...))
...
"""
DeleteApplicationCloudWatchLoggingOption(ApplicationName, CloudWatchLoggingOptionId, CurrentApplicationVersionId) = kinesis_analytics("DeleteApplicationCloudWatchLoggingOption", Dict{String, Any}("ApplicationName"=>ApplicationName, "CloudWatchLoggingOptionId"=>CloudWatchLoggingOptionId, "CurrentApplicationVersionId"=>CurrentApplicationVersionId))
DeleteApplicationCloudWatchLoggingOption(ApplicationName, CloudWatchLoggingOptionId, CurrentApplicationVersionId, args::AbstractDict{String, <: Any}) = kinesis_analytics("DeleteApplicationCloudWatchLoggingOption", Dict{String, Any}("ApplicationName"=>ApplicationName, "CloudWatchLoggingOptionId"=>CloudWatchLoggingOptionId, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, args...))
...
"""
DeleteApplicationInputProcessingConfiguration(ApplicationName, CurrentApplicationVersionId, InputId) = kinesis_analytics("DeleteApplicationInputProcessingConfiguration", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "InputId"=>InputId))
DeleteApplicationInputProcessingConfiguration(ApplicationName, CurrentApplicationVersionId, InputId, args::AbstractDict{String, <: Any}) = kinesis_analytics("DeleteApplicationInputProcessingConfiguration", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "InputId"=>InputId, args...))
...
"""
DeleteApplicationOutput(ApplicationName, CurrentApplicationVersionId, OutputId) = kinesis_analytics("DeleteApplicationOutput", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "OutputId"=>OutputId))
DeleteApplicationOutput(ApplicationName, CurrentApplicationVersionId, OutputId, args::AbstractDict{String, <: Any}) = kinesis_analytics("DeleteApplicationOutput", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "OutputId"=>OutputId, args...))
...
"""
DeleteApplicationReferenceDataSource(ApplicationName, CurrentApplicationVersionId, ReferenceId) = kinesis_analytics("DeleteApplicationReferenceDataSource", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "ReferenceId"=>ReferenceId))
DeleteApplicationReferenceDataSource(ApplicationName, CurrentApplicationVersionId, ReferenceId, args::AbstractDict{String, <: Any}) = kinesis_analytics("DeleteApplicationReferenceDataSource", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "ReferenceId"=>ReferenceId, args...))
...
"""
DescribeApplication(ApplicationName) = kinesis_analytics("DescribeApplication", Dict{String, Any}("ApplicationName"=>ApplicationName))
DescribeApplication(ApplicationName, args::AbstractDict{String, <: Any}) = kinesis_analytics("DescribeApplication", Dict{String, Any}("ApplicationName"=>ApplicationName, args...))
...
DiscoverInputSchema(args::AbstractDict{String, <: Any}) = kinesis_analytics("DiscoverInputSchema", args)
...
ListApplications(args::AbstractDict{String, <: Any}) = kinesis_analytics("ListApplications", args)
...
"""
ListTagsForResource(ResourceARN) = kinesis_analytics("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN))
ListTagsForResource(ResourceARN, args::AbstractDict{String, <: Any}) = kinesis_analytics("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN, args...))
...
"""
StartApplication(ApplicationName, InputConfigurations) = kinesis_analytics("StartApplication", Dict{String, Any}("ApplicationName"=>ApplicationName, "InputConfigurations"=>InputConfigurations))
StartApplication(ApplicationName, InputConfigurations, args::AbstractDict{String, <: Any}) = kinesis_analytics("StartApplication", Dict{String, Any}("ApplicationName"=>ApplicationName, "InputConfigurations"=>InputConfigurations, args...))
...
"""
StopApplication(ApplicationName) = kinesis_analytics("StopApplication", Dict{String, Any}("ApplicationName"=>ApplicationName))
StopApplication(ApplicationName, args::AbstractDict{String, <: Any}) = kinesis_analytics("StopApplication", Dict{String, Any}("ApplicationName"=>ApplicationName, args...))
...
"""
TagResource(ResourceARN, Tags) = kinesis_analytics("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags))
TagResource(ResourceARN, Tags, args::AbstractDict{String, <: Any}) = kinesis_analytics("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags, args...))
...
"""
UntagResource(ResourceARN, TagKeys) = kinesis_analytics("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys))
UntagResource(ResourceARN, TagKeys, args::AbstractDict{String, <: Any}) = kinesis_analytics("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys, args...))
...
"""
UpdateApplication(ApplicationName, ApplicationUpdate, CurrentApplicationVersionId) = kinesis_analytics("UpdateApplication", Dict{String, Any}("ApplicationName"=>ApplicationName, "ApplicationUpdate"=>ApplicationUpdate, "CurrentApplicationVersionId"=>CurrentApplicationVersionId))
UpdateApplication(ApplicationName, ApplicationUpdate, CurrentApplicationVersionId, args::AbstractDict{String, <: Any}) = kinesis_analytics("UpdateApplication", Dict{String, Any}("ApplicationName"=>ApplicationName, "ApplicationUpdate"=>ApplicationUpdate, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, args...))
