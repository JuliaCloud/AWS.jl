...
"""
AddApplicationCloudWatchLoggingOption(ApplicationName, CloudWatchLoggingOption, CurrentApplicationVersionId; aws::AWSConfig=AWSConfig()) = kinesis_analytics("AddApplicationCloudWatchLoggingOption", Dict{String, Any}("ApplicationName"=>ApplicationName, "CloudWatchLoggingOption"=>CloudWatchLoggingOption, "CurrentApplicationVersionId"=>CurrentApplicationVersionId); aws=aws)
AddApplicationCloudWatchLoggingOption(ApplicationName, CloudWatchLoggingOption, CurrentApplicationVersionId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("AddApplicationCloudWatchLoggingOption", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName, "CloudWatchLoggingOption"=>CloudWatchLoggingOption, "CurrentApplicationVersionId"=>CurrentApplicationVersionId), args)); aws=aws)
...
"""
AddApplicationInput(ApplicationName, CurrentApplicationVersionId, Input; aws::AWSConfig=AWSConfig()) = kinesis_analytics("AddApplicationInput", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "Input"=>Input); aws=aws)
AddApplicationInput(ApplicationName, CurrentApplicationVersionId, Input, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("AddApplicationInput", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "Input"=>Input), args)); aws=aws)
...
"""
AddApplicationInputProcessingConfiguration(ApplicationName, CurrentApplicationVersionId, InputId, InputProcessingConfiguration; aws::AWSConfig=AWSConfig()) = kinesis_analytics("AddApplicationInputProcessingConfiguration", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "InputId"=>InputId, "InputProcessingConfiguration"=>InputProcessingConfiguration); aws=aws)
AddApplicationInputProcessingConfiguration(ApplicationName, CurrentApplicationVersionId, InputId, InputProcessingConfiguration, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("AddApplicationInputProcessingConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "InputId"=>InputId, "InputProcessingConfiguration"=>InputProcessingConfiguration), args)); aws=aws)
...
"""
AddApplicationOutput(ApplicationName, CurrentApplicationVersionId, Output; aws::AWSConfig=AWSConfig()) = kinesis_analytics("AddApplicationOutput", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "Output"=>Output); aws=aws)
AddApplicationOutput(ApplicationName, CurrentApplicationVersionId, Output, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("AddApplicationOutput", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "Output"=>Output), args)); aws=aws)
...
"""
AddApplicationReferenceDataSource(ApplicationName, CurrentApplicationVersionId, ReferenceDataSource; aws::AWSConfig=AWSConfig()) = kinesis_analytics("AddApplicationReferenceDataSource", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "ReferenceDataSource"=>ReferenceDataSource); aws=aws)
AddApplicationReferenceDataSource(ApplicationName, CurrentApplicationVersionId, ReferenceDataSource, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("AddApplicationReferenceDataSource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "ReferenceDataSource"=>ReferenceDataSource), args)); aws=aws)
...
"""
CreateApplication(ApplicationName; aws::AWSConfig=AWSConfig()) = kinesis_analytics("CreateApplication", Dict{String, Any}("ApplicationName"=>ApplicationName); aws=aws)
CreateApplication(ApplicationName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("CreateApplication", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName), args)); aws=aws)
...
"""
DeleteApplication(ApplicationName, CreateTimestamp; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DeleteApplication", Dict{String, Any}("ApplicationName"=>ApplicationName, "CreateTimestamp"=>CreateTimestamp); aws=aws)
DeleteApplication(ApplicationName, CreateTimestamp, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DeleteApplication", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName, "CreateTimestamp"=>CreateTimestamp), args)); aws=aws)
...
"""
DeleteApplicationCloudWatchLoggingOption(ApplicationName, CloudWatchLoggingOptionId, CurrentApplicationVersionId; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DeleteApplicationCloudWatchLoggingOption", Dict{String, Any}("ApplicationName"=>ApplicationName, "CloudWatchLoggingOptionId"=>CloudWatchLoggingOptionId, "CurrentApplicationVersionId"=>CurrentApplicationVersionId); aws=aws)
DeleteApplicationCloudWatchLoggingOption(ApplicationName, CloudWatchLoggingOptionId, CurrentApplicationVersionId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DeleteApplicationCloudWatchLoggingOption", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName, "CloudWatchLoggingOptionId"=>CloudWatchLoggingOptionId, "CurrentApplicationVersionId"=>CurrentApplicationVersionId), args)); aws=aws)
...
"""
DeleteApplicationInputProcessingConfiguration(ApplicationName, CurrentApplicationVersionId, InputId; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DeleteApplicationInputProcessingConfiguration", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "InputId"=>InputId); aws=aws)
DeleteApplicationInputProcessingConfiguration(ApplicationName, CurrentApplicationVersionId, InputId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DeleteApplicationInputProcessingConfiguration", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "InputId"=>InputId), args)); aws=aws)
...
"""
DeleteApplicationOutput(ApplicationName, CurrentApplicationVersionId, OutputId; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DeleteApplicationOutput", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "OutputId"=>OutputId); aws=aws)
DeleteApplicationOutput(ApplicationName, CurrentApplicationVersionId, OutputId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DeleteApplicationOutput", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "OutputId"=>OutputId), args)); aws=aws)
...
"""
DeleteApplicationReferenceDataSource(ApplicationName, CurrentApplicationVersionId, ReferenceId; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DeleteApplicationReferenceDataSource", Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "ReferenceId"=>ReferenceId); aws=aws)
DeleteApplicationReferenceDataSource(ApplicationName, CurrentApplicationVersionId, ReferenceId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DeleteApplicationReferenceDataSource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName, "CurrentApplicationVersionId"=>CurrentApplicationVersionId, "ReferenceId"=>ReferenceId), args)); aws=aws)
...
"""
DescribeApplication(ApplicationName; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DescribeApplication", Dict{String, Any}("ApplicationName"=>ApplicationName); aws=aws)
DescribeApplication(ApplicationName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DescribeApplication", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName), args)); aws=aws)
...
"""
DiscoverInputSchema(; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DiscoverInputSchema"; aws=aws)
DiscoverInputSchema(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("DiscoverInputSchema", args; aws=aws)
...
"""
ListApplications(; aws::AWSConfig=AWSConfig()) = kinesis_analytics("ListApplications"; aws=aws)
ListApplications(args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("ListApplications", args; aws=aws)
...
"""
ListTagsForResource(ResourceARN; aws::AWSConfig=AWSConfig()) = kinesis_analytics("ListTagsForResource", Dict{String, Any}("ResourceARN"=>ResourceARN); aws=aws)
ListTagsForResource(ResourceARN, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("ListTagsForResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN), args)); aws=aws)
...
"""
StartApplication(ApplicationName, InputConfigurations; aws::AWSConfig=AWSConfig()) = kinesis_analytics("StartApplication", Dict{String, Any}("ApplicationName"=>ApplicationName, "InputConfigurations"=>InputConfigurations); aws=aws)
StartApplication(ApplicationName, InputConfigurations, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("StartApplication", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName, "InputConfigurations"=>InputConfigurations), args)); aws=aws)
...
"""
StopApplication(ApplicationName; aws::AWSConfig=AWSConfig()) = kinesis_analytics("StopApplication", Dict{String, Any}("ApplicationName"=>ApplicationName); aws=aws)
StopApplication(ApplicationName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("StopApplication", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName), args)); aws=aws)
...
"""
TagResource(ResourceARN, Tags; aws::AWSConfig=AWSConfig()) = kinesis_analytics("TagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags); aws=aws)
TagResource(ResourceARN, Tags, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("TagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN, "Tags"=>Tags), args)); aws=aws)
...
"""
UntagResource(ResourceARN, TagKeys; aws::AWSConfig=AWSConfig()) = kinesis_analytics("UntagResource", Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys); aws=aws)
UntagResource(ResourceARN, TagKeys, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("UntagResource", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ResourceARN"=>ResourceARN, "TagKeys"=>TagKeys), args)); aws=aws)
...
"""
UpdateApplication(ApplicationName, ApplicationUpdate, CurrentApplicationVersionId; aws::AWSConfig=AWSConfig()) = kinesis_analytics("UpdateApplication", Dict{String, Any}("ApplicationName"=>ApplicationName, "ApplicationUpdate"=>ApplicationUpdate, "CurrentApplicationVersionId"=>CurrentApplicationVersionId); aws=aws)
UpdateApplication(ApplicationName, ApplicationUpdate, CurrentApplicationVersionId, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = kinesis_analytics("UpdateApplication", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("ApplicationName"=>ApplicationName, "ApplicationUpdate"=>ApplicationUpdate, "CurrentApplicationVersionId"=>CurrentApplicationVersionId), args)); aws=aws)
