...
AbortMultipartUpload(accountId, uploadId, vaultName, args::AbstractDict{String, <:Any}) = glacier("DELETE", "/$(accountId)/vaults/$(vaultName)/multipart-uploads/$(uploadId)", args)
...
AbortVaultLock(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("DELETE", "/$(accountId)/vaults/$(vaultName)/lock-policy", args)
...
AddTagsToVault(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("POST", "/$(accountId)/vaults/$(vaultName)/tags?operation=add", args)
...
CompleteMultipartUpload(accountId, uploadId, vaultName, args::AbstractDict{String, <:Any}) = glacier("POST", "/$(accountId)/vaults/$(vaultName)/multipart-uploads/$(uploadId)", args)
...
CompleteVaultLock(accountId, lockId, vaultName, args::AbstractDict{String, <:Any}) = glacier("POST", "/$(accountId)/vaults/$(vaultName)/lock-policy/$(lockId)", args)
...
CreateVault(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("PUT", "/$(accountId)/vaults/$(vaultName)", args)
...
DeleteArchive(accountId, archiveId, vaultName, args::AbstractDict{String, <:Any}) = glacier("DELETE", "/$(accountId)/vaults/$(vaultName)/archives/$(archiveId)", args)
...
DeleteVault(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("DELETE", "/$(accountId)/vaults/$(vaultName)", args)
...
DeleteVaultAccessPolicy(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("DELETE", "/$(accountId)/vaults/$(vaultName)/access-policy", args)
...
DeleteVaultNotifications(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("DELETE", "/$(accountId)/vaults/$(vaultName)/notification-configuration", args)
...
DescribeJob(accountId, jobId, vaultName, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/vaults/$(vaultName)/jobs/$(jobId)", args)
...
DescribeVault(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/vaults/$(vaultName)", args)
...
GetDataRetrievalPolicy(accountId, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/policies/data-retrieval", args)
...
GetJobOutput(accountId, jobId, vaultName, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/vaults/$(vaultName)/jobs/$(jobId)/output", args)
...
GetVaultAccessPolicy(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/vaults/$(vaultName)/access-policy", args)
...
GetVaultLock(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/vaults/$(vaultName)/lock-policy", args)
...
GetVaultNotifications(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/vaults/$(vaultName)/notification-configuration", args)
...
InitiateJob(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("POST", "/$(accountId)/vaults/$(vaultName)/jobs", args)
...
InitiateMultipartUpload(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("POST", "/$(accountId)/vaults/$(vaultName)/multipart-uploads", args)
...
InitiateVaultLock(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("POST", "/$(accountId)/vaults/$(vaultName)/lock-policy", args)
...
ListJobs(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/vaults/$(vaultName)/jobs", args)
...
ListMultipartUploads(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/vaults/$(vaultName)/multipart-uploads", args)
...
ListParts(accountId, uploadId, vaultName, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/vaults/$(vaultName)/multipart-uploads/$(uploadId)", args)
...
ListProvisionedCapacity(accountId, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/provisioned-capacity", args)
...
ListTagsForVault(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/vaults/$(vaultName)/tags", args)
...
ListVaults(accountId, args::AbstractDict{String, <:Any}) = glacier("GET", "/$(accountId)/vaults", args)
...
PurchaseProvisionedCapacity(accountId, args::AbstractDict{String, <:Any}) = glacier("POST", "/$(accountId)/provisioned-capacity", args)
...
RemoveTagsFromVault(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("POST", "/$(accountId)/vaults/$(vaultName)/tags?operation=remove", args)
...
SetDataRetrievalPolicy(accountId, args::AbstractDict{String, <:Any}) = glacier("PUT", "/$(accountId)/policies/data-retrieval", args)
...
SetVaultAccessPolicy(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("PUT", "/$(accountId)/vaults/$(vaultName)/access-policy", args)
...
SetVaultNotifications(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("PUT", "/$(accountId)/vaults/$(vaultName)/notification-configuration", args)
...
UploadArchive(accountId, vaultName, args::AbstractDict{String, <:Any}) = glacier("POST", "/$(accountId)/vaults/$(vaultName)/archives", args)
...
UploadMultipartPart(accountId, uploadId, vaultName, args::AbstractDict{String, <:Any}) = glacier("PUT", "/$(accountId)/vaults/$(vaultName)/multipart-uploads/$(uploadId)", args)
