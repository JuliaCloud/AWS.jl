...
"""
InvokeEndpoint(Body, EndpointName; aws::AWSConfig=AWSConfig()) = sagemaker_runtime("POST", "/endpoints/$(EndpointName)/invocations", Dict{String, Any}("Body"=>Body))
InvokeEndpoint(Body, EndpointName, args::AbstractDict{String, <:Any}; aws::AWSConfig=AWSConfig()) = sagemaker_runtime("POST", "/endpoints/$(EndpointName)/invocations", Dict{String, Any}(mergewith(_merge, Dict{String, Any}("Body"=>Body), args)); aws=aws)
