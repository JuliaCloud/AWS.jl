...
"""
InvokeEndpoint(Body, EndpointName) = sagemaker_runtime("POST", "/endpoints/$(EndpointName)/invocations", Dict{String, Any}("Body"=>Body))
InvokeEndpoint(Body, EndpointName, args::AbstractDict{String, <: Any}) = sagemaker_runtime("POST", "/endpoints/$(EndpointName)/invocations", Dict{String, Any}("Body"=>Body, args...))
