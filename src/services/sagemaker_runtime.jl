...
"""
InvokeEndpoint(Body, EndpointName) = sagemaker_runtime("POST", "/endpoints/$(EndpointName)/invocations")
InvokeEndpoint(Body, EndpointName, args) = sagemaker_runtime("POST", "/endpoints/$(EndpointName)/invocations", args)
