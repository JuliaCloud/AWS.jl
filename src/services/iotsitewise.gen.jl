...
"""
AssociateAssets(assetId, childAssetId, hierarchyId) = iotsitewise("POST", "/assets/$(assetId)/associate", Dict{String, Any}("childAssetId"=>childAssetId, "hierarchyId"=>hierarchyId))
AssociateAssets(assetId, childAssetId, hierarchyId, args::AbstractDict{String, <: Any}) = iotsitewise("POST", "/assets/$(assetId)/associate", Dict{String, Any}("childAssetId"=>childAssetId, "hierarchyId"=>hierarchyId, args...))
...
clientToken => A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
BatchAssociateProjectAssets(assetIds, projectId) = iotsitewise("POST", "/projects/$(projectId)/assets/associate", Dict{String, Any}("assetIds"=>assetIds))
BatchAssociateProjectAssets(assetIds, projectId, args::AbstractDict{String, <: Any}) = iotsitewise("POST", "/projects/$(projectId)/assets/associate", Dict{String, Any}("assetIds"=>assetIds, args...))
...
clientToken => A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
BatchDisassociateProjectAssets(assetIds, projectId) = iotsitewise("POST", "/projects/$(projectId)/assets/disassociate", Dict{String, Any}("assetIds"=>assetIds))
BatchDisassociateProjectAssets(assetIds, projectId, args::AbstractDict{String, <: Any}) = iotsitewise("POST", "/projects/$(projectId)/assets/disassociate", Dict{String, Any}("assetIds"=>assetIds, args...))
...
"""
CreateAccessPolicy(accessPolicyIdentity, accessPolicyPermission, accessPolicyResource) = iotsitewise("POST", "/access-policies", Dict{String, Any}("accessPolicyIdentity"=>accessPolicyIdentity, "accessPolicyPermission"=>accessPolicyPermission, "accessPolicyResource"=>accessPolicyResource))
CreateAccessPolicy(accessPolicyIdentity, accessPolicyPermission, accessPolicyResource, args::AbstractDict{String, <: Any}) = iotsitewise("POST", "/access-policies", Dict{String, Any}("accessPolicyIdentity"=>accessPolicyIdentity, "accessPolicyPermission"=>accessPolicyPermission, "accessPolicyResource"=>accessPolicyResource, args...))
...
"""
CreateAsset(assetModelId, assetName) = iotsitewise("POST", "/assets", Dict{String, Any}("assetModelId"=>assetModelId, "assetName"=>assetName))
CreateAsset(assetModelId, assetName, args::AbstractDict{String, <: Any}) = iotsitewise("POST", "/assets", Dict{String, Any}("assetModelId"=>assetModelId, "assetName"=>assetName, args...))
...
"""
CreateAssetModel(assetModelName) = iotsitewise("POST", "/asset-models", Dict{String, Any}("assetModelName"=>assetModelName))
CreateAssetModel(assetModelName, args::AbstractDict{String, <: Any}) = iotsitewise("POST", "/asset-models", Dict{String, Any}("assetModelName"=>assetModelName, args...))
...
"""
CreateDashboard(dashboardDefinition, dashboardName, projectId) = iotsitewise("POST", "/dashboards", Dict{String, Any}("dashboardDefinition"=>dashboardDefinition, "dashboardName"=>dashboardName, "projectId"=>projectId))
CreateDashboard(dashboardDefinition, dashboardName, projectId, args::AbstractDict{String, <: Any}) = iotsitewise("POST", "/dashboards", Dict{String, Any}("dashboardDefinition"=>dashboardDefinition, "dashboardName"=>dashboardName, "projectId"=>projectId, args...))
...
"""
CreatePortal(portalContactEmail, portalName, roleArn) = iotsitewise("POST", "/portals", Dict{String, Any}("portalContactEmail"=>portalContactEmail, "portalName"=>portalName, "roleArn"=>roleArn))
CreatePortal(portalContactEmail, portalName, roleArn, args::AbstractDict{String, <: Any}) = iotsitewise("POST", "/portals", Dict{String, Any}("portalContactEmail"=>portalContactEmail, "portalName"=>portalName, "roleArn"=>roleArn, args...))
...
"""
CreateProject(portalId, projectName) = iotsitewise("POST", "/projects", Dict{String, Any}("portalId"=>portalId, "projectName"=>projectName))
CreateProject(portalId, projectName, args::AbstractDict{String, <: Any}) = iotsitewise("POST", "/projects", Dict{String, Any}("portalId"=>portalId, "projectName"=>projectName, args...))
...
DeleteAccessPolicy(accessPolicyId, args::AbstractDict{String, <: Any}) = iotsitewise("DELETE", "/access-policies/$(accessPolicyId)", args)
...
DeleteAsset(assetId, args::AbstractDict{String, <: Any}) = iotsitewise("DELETE", "/assets/$(assetId)", args)
...
DeleteAssetModel(assetModelId, args::AbstractDict{String, <: Any}) = iotsitewise("DELETE", "/asset-models/$(assetModelId)", args)
...
DeleteDashboard(dashboardId, args::AbstractDict{String, <: Any}) = iotsitewise("DELETE", "/dashboards/$(dashboardId)", args)
...
DeletePortal(portalId, args::AbstractDict{String, <: Any}) = iotsitewise("DELETE", "/portals/$(portalId)", args)
...
DeleteProject(projectId, args::AbstractDict{String, <: Any}) = iotsitewise("DELETE", "/projects/$(projectId)", args)
...
clientToken => A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
DisassociateAssets(assetId, childAssetId, hierarchyId) = iotsitewise("POST", "/assets/$(assetId)/disassociate", Dict{String, Any}("childAssetId"=>childAssetId, "hierarchyId"=>hierarchyId))
DisassociateAssets(assetId, childAssetId, hierarchyId, args::AbstractDict{String, <: Any}) = iotsitewise("POST", "/assets/$(assetId)/disassociate", Dict{String, Any}("childAssetId"=>childAssetId, "hierarchyId"=>hierarchyId, args...))
...
clientToken => A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
UpdateAccessPolicy(accessPolicyId, accessPolicyIdentity, accessPolicyPermission, accessPolicyResource) = iotsitewise("PUT", "/access-policies/$(accessPolicyId)", Dict{String, Any}("accessPolicyIdentity"=>accessPolicyIdentity, "accessPolicyPermission"=>accessPolicyPermission, "accessPolicyResource"=>accessPolicyResource))
UpdateAccessPolicy(accessPolicyId, accessPolicyIdentity, accessPolicyPermission, accessPolicyResource, args::AbstractDict{String, <: Any}) = iotsitewise("PUT", "/access-policies/$(accessPolicyId)", Dict{String, Any}("accessPolicyIdentity"=>accessPolicyIdentity, "accessPolicyPermission"=>accessPolicyPermission, "accessPolicyResource"=>accessPolicyResource, args...))
...
clientToken => A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
UpdateAsset(assetId, assetName) = iotsitewise("PUT", "/assets/$(assetId)", Dict{String, Any}("assetName"=>assetName))
UpdateAsset(assetId, assetName, args::AbstractDict{String, <: Any}) = iotsitewise("PUT", "/assets/$(assetId)", Dict{String, Any}("assetName"=>assetName, args...))
...
clientToken => A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.
"""
UpdateAssetModel(assetModelId, assetModelName) = iotsitewise("PUT", "/asset-models/$(assetModelId)", Dict{String, Any}("assetModelName"=>assetModelName))
UpdateAssetModel(assetModelId, assetModelName, args::AbstractDict{String, <: Any}) = iotsitewise("PUT", "/asset-models/$(assetModelId)", Dict{String, Any}("assetModelName"=>assetModelName, args...))
...
UpdateAssetProperty(assetId, propertyId, args::AbstractDict{String, <: Any}) = iotsitewise("PUT", "/assets/$(assetId)/properties/$(propertyId)", args)
...
"""
UpdateDashboard(dashboardDefinition, dashboardId, dashboardName) = iotsitewise("PUT", "/dashboards/$(dashboardId)", Dict{String, Any}("dashboardDefinition"=>dashboardDefinition, "dashboardName"=>dashboardName))
UpdateDashboard(dashboardDefinition, dashboardId, dashboardName, args::AbstractDict{String, <: Any}) = iotsitewise("PUT", "/dashboards/$(dashboardId)", Dict{String, Any}("dashboardDefinition"=>dashboardDefinition, "dashboardName"=>dashboardName, args...))
...
portalLogoImage => 
"""
UpdatePortal(portalContactEmail, portalId, portalName, roleArn) = iotsitewise("PUT", "/portals/$(portalId)", Dict{String, Any}("portalContactEmail"=>portalContactEmail, "portalName"=>portalName, "roleArn"=>roleArn))
UpdatePortal(portalContactEmail, portalId, portalName, roleArn, args::AbstractDict{String, <: Any}) = iotsitewise("PUT", "/portals/$(portalId)", Dict{String, Any}("portalContactEmail"=>portalContactEmail, "portalName"=>portalName, "roleArn"=>roleArn, args...))
...
"""
UpdateProject(projectId, projectName) = iotsitewise("PUT", "/projects/$(projectId)", Dict{String, Any}("projectName"=>projectName))
UpdateProject(projectId, projectName, args::AbstractDict{String, <: Any}) = iotsitewise("PUT", "/projects/$(projectId)", Dict{String, Any}("projectName"=>projectName, args...))
