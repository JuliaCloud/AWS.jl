...
parse_from_xml{T<:AbstractAWSType}(::Type{T}, types::Dict{Symbol,Vector{Pair{Symbol,DataType}}}, pd::Union{LightXML.XMLElement,Void}) = _parse_from_xml(T, types, pd; member_pfx="member.")
prep_params{T<:AbstractAWSType}(obj::T) = _prep_params(obj; member_pfx="member.")
