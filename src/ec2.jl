...
parse_from_xml(::Type{T}, types::Dict{Symbol,Vector{Pair{Symbol,DataType}}}, pd::Union{LightXML.XMLElement,Void}) where {T<:AbstractAWSType} = _parse_from_xml(T, types, pd; member_pfx="item")
