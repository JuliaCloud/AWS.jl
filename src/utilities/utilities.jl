...
# Defaults for AWS's `standard` retry mode. Note: these can be overridden eleswhere.
AWSExponentialBackoff(; max_attempts=3, max_backoff=20.0) = AWSExponentialBackoff(max_attempts, max_backoff)
