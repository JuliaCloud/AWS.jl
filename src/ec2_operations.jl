...
const ValidRqstMsgs = Set([
    ...
    "DescriveVpcEndpointServicesType",
    "DescribeVpcEndpointsType",
    "DescriveVpcPeeringConnectionType",
    "DescribeVpcsType",
