...
const chime_sdk_identity = AWS.RestJSONService("identity-chime", "2021-04-20")
const chime_sdk_messaging = AWS.RestJSONService("messaging-chime", "2021-05-15")
...
const iot_wireless = AWS.RestJSONService("api.iotwireless", "2020-11-22")
const iotanalytics = AWS.RestJSONService("iotanalytics", "2017-11-27")
const iotdeviceadvisor = AWS.RestJSONService("api.iotdeviceadvisor", "2020-09-18")
const iotfleethub = AWS.RestJSONService("api.fleethub.iot", "2020-11-03")
...
const lex_models_v2 = AWS.RestJSONService("models-v2-lex", "2020-08-07")
const lex_runtime_service = AWS.RestJSONService("runtime.lex", "2016-11-28")
const lex_runtime_v2 = AWS.RestJSONService("runtime-v2-lex", "2020-08-07")
...
const route53_recovery_cluster = AWS.JSONService("route53-recovery-cluster", "2019-12-02", "1.0", "ToggleCustomerAPI")
const route53_recovery_control_config = AWS.RestJSONService("route53-recovery-control-config", "2020-11-02")
const route53_recovery_readiness = AWS.RestJSONService("route53-recovery-readiness", "2019-12-02")
